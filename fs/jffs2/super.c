...
suffix:semicolon
DECL|function|jffs2_blk_fill_super
r_static
r_int
id|jffs2_blk_fill_super
c_func
(paren
r_struct
id|super_block
...
(paren
id|KERN_DEBUG
l_string|&quot;jffs2: blk_read_super for device %s&bslash;n&quot;
comma
id|sb-&gt;s_id
)paren
)paren

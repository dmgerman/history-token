...
(paren
id|KERN_WARNING
l_string|&quot;dwmw2 is stupid. j_a_f_d_t_f should never happen with -&gt;raw == NULL&bslash;n&quot;
)paren
suffix:semicolon
id|BUG
c_func

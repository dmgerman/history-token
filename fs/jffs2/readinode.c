...
(paren
id|KERN_DEBUG
l_string|&quot;getting inocache&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|init_MUTEX
...
(paren
id|KERN_DEBUG
l_string|&quot;jffs2_read_inode(): Got inocache at %p&bslash;n&quot;
comma
id|f-&gt;inocache
)paren
)paren
...
(paren
id|KERN_CRIT
l_string|&quot;jffs2_read_inode(): Cannot allocate inocache for root inode&bslash;n&quot;
)paren
suffix:semicolon
id|make_bad_inode
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;jffs2_read_inode(): Creating inocache for root inode&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|memset
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_read_inode() on nonexistent ino %lu&bslash;n&quot;
comma
(paren
r_int
r_int
...
(paren
id|KERN_DEBUG
l_string|&quot;jffs2_read_inode(): ino #%lu nlink is %d&bslash;n&quot;
comma
(paren
r_int
r_int
...
(paren
id|KERN_CRIT
l_string|&quot;jffs2_get_inode_nodes() for ino %lu returned %d&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|ret
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_read_inode(): No data nodes found for ino #%lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_read_inode(): But it has children so we fake some modes for it&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|inode-&gt;i_mode
...
(paren
id|KERN_NOTICE
l_string|&quot;MTD read in jffs2_read_inode() failed: Returned %d, %ld of %d bytes read&bslash;n&quot;
comma
id|ret
comma
(paren
...
(paren
id|KERN_NOTICE
l_string|&quot;CRC failed for read_inode of inode %ld at physical location 0x%x&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|fn-&gt;raw-&gt;flash_offset
...
multiline_comment|/* OK, now the special cases. Certain inode types should&n;&t;   have only one data node, and it&squot;s kept as the metadata&n;&t;   node */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;Argh. Special inode #%lu with mode 0%o had metadata node&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|inode-&gt;i_mode
...
(paren
id|KERN_WARNING
l_string|&quot;Argh. Special inode #%lu with mode 0%o has no fragments&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|inode-&gt;i_mode
...
(paren
id|KERN_WARNING
l_string|&quot;Argh. Special inode #%lu had more than one node&bslash;n&quot;
comma
id|inode-&gt;i_ino
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_read_inode(): Bogus imode %o for ino %lu&quot;
comma
id|inode-&gt;i_mode
comma
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;jffs2_clear_inode: frag at 0x%x-0x%x: node %p, frags %d--&bslash;n&quot;
comma
id|frag-&gt;ofs
comma
id|frag-&gt;ofs
...
singleline_comment|//&t;if (!f-&gt;inocache-&gt;nlink) {
singleline_comment|//&t;&t;D1(printk(KERN_DEBUG &quot;jffs2_clear_inode() deleting inode #%lu&bslash;n&quot;, inode-&gt;i_ino));
singleline_comment|//&t;&t;jffs2_del_ino_cache(JFFS2_SB_INFO(inode-&gt;i_sb), f-&gt;inocache);
singleline_comment|//&t;&t;jffs2_free_inode_cache(f-&gt;inocache);

multiline_comment|/*&n; * JFFS2 -- Journalling Flash File System, Version 2.&n; *&n; * Copyright (C) 2001, 2002 Red Hat, Inc.&n; *&n; * Created by David Woodhouse &lt;dwmw2@cambridge.redhat.com&gt;&n; *&n; * For licensing information, see the file &squot;LICENCE&squot; in this directory.&n; *&n; * $Id: fs.c,v 1.13 2002/07/02 22:48:24 dwmw2 Exp $&n; *&n; */
...
suffix:semicolon
multiline_comment|/* Eep. If we lock this here, we deadlock with jffs2_reserve_space() when&n;&t; * it locks the alloc_sem and jffs2_do_reserve_space() waits for erases&n;&t; * to happen. I think the erases and/or the flush_wbuf want doing from&n;&t; *&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
singleline_comment|// else it stays dirty. FIXME.
)brace
...
suffix:semicolon
multiline_comment|/* Initialize timer for timed wbuf flush */
id|init_timer
c_func
(paren
op_amp

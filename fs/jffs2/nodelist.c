...
macro_line|#if 0
multiline_comment|/**&n; *&t;jffs2_add_raw_node_ref - Add a jffs2_raw_node_ref to the cached&n; *&t;&t;&t;&t;node list for the filesystem&n; *&t;@sb: Pointer to filesystem information structure&n; *&t;@ref: New node to add&n; *&n; *&t;Adds a new node reference to the filesystem&bslash;&squot;s node cache, which&n; *&t;is the only permanent storage required for the filesystem.&n; */
r_void
id|jffs2_add_raw_node_ref
c_func
(paren
r_struct
id|jffs2_sb_info
...
(brace
multiline_comment|/* Sort the list, hash it or do _something_ useful with it */
id|spin_lock
c_func
(paren
op_amp

...
l_int|NULL
suffix:semicolon
singleline_comment|//&t;jffs2_del_ino_cache(c, ic);
singleline_comment|//&t;jffs2_free_inode_cache(ic);
r_return
id|ret
suffix:semicolon
)brace

...
(paren
id|KERN_WARNING
l_string|&quot;deflateInit alloc of workspace failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_WARNING
l_string|&quot;inflateInit alloc of workspace failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

multiline_comment|/*&n; * JFFS2 -- Journalling Flash File System, Version 2.&n; *&n; * Copyright (C) 2001-2003 Red Hat, Inc.&n; *&n; * Created by David Woodhouse &lt;dwmw2@infradead.org&gt;&n; *&n; * For licensing information, see the file &squot;LICENCE&squot; in this directory.&n; *&n; * $Id: dir.c,v 1.84 2004/11/16 20:36:11 dwmw2 Exp $&n; *&n; */
...
id|type
suffix:semicolon
multiline_comment|/* Don&squot;t let people make hard links to bad inodes. */
r_if
c_cond
(paren
op_logical_neg
...
id|jffs2_dir_operations
suffix:semicolon
multiline_comment|/* Directories get nlink 2 at start */
id|inode-&gt;i_nlink
op_assign
l_int|2
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We don&squot;t touch inode-&gt;i_nlink */
r_if
c_cond
(paren
id|ret

multiline_comment|/*&n; * JFFS2 -- Journalling Flash File System, Version 2.&n; *&n; * Copyright (C) 2001, 2002 Red Hat, Inc.&n; *&n; * Created by David Woodhouse &lt;dwmw2@cambridge.redhat.com&gt;&n; *&n; * For licensing information, see the file &squot;LICENCE&squot; in this directory.&n; *&n; * $Id: gc.c,v 1.88 2002/10/08 16:56:08 dwmw2 Exp $&n; *&n; */
...
(brace
multiline_comment|/* We can&squot;t start doing GC yet. We haven&squot;t finished checking&n;&t;&t;   the node CRCs etc. Do it now and wait for it. */
r_struct
...
(paren
id|KERN_DEBUG
l_string|&quot;Skipping check of ino #%d already in state %d&bslash;n&quot;
comma
id|ic-&gt;ino
comma
id|ic-&gt;state
...
suffix:semicolon
(brace
multiline_comment|/* XXX: This wants doing more sensibly -- split the core of jffs2_do_read_inode up */
r_struct
id|inode
op_star
id|i
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_g_c_deletion_dirent(): Short read (%d not %d) reading header from obsolete node at %08x&bslash;n&quot;
comma
id|retlen
comma
r_sizeof
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_g_c_deletion_dirent(): Short read (%d not %d) reading from obsolete node at %08x&bslash;n&quot;
comma
id|retlen
comma
r_sizeof
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_g_c_deletion_dirent(): Short read (%d not %d) reading name from obsolete node at %08x&bslash;n&quot;
comma
id|retlen
comma
id|name_len
...
(paren
id|KERN_WARNING
l_string|&quot;Node read failed in jffs2_garbage_collect_hole. Ret %d, retlen %d. Data will be lost by writing new hole node&bslash;n&quot;
comma
id|ret
comma
id|readlen

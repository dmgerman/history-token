...
multiline_comment|/* These probably ought to be somewhere central. */
singleline_comment|//#define min(x,y) ({ typeof((x)) _x = (x); typeof((y)) _y = (y); (_x&gt;_y)?_y:_x; })
singleline_comment|//#define max(x,y) ({ typeof((x)) _x = (x); typeof((y)) _y = (y); (_x&gt;_y)?_x:_y; })

multiline_comment|/*&n; * JFFS2 -- Journalling Flash File System, Version 2.&n; *&n; * Copyright (C) 2001-2003 Red Hat, Inc.&n; *&n; * Created by David Woodhouse &lt;dwmw2@redhat.com&gt;&n; *&n; * For licensing information, see the file &squot;LICENCE&squot; in this directory.&n; *&n; * $Id: wbuf.c,v 1.53 2003/10/11 11:46:09 dwmw2 Exp $&n; *&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;jffs2_check_nand_cleanmarker(): Bad block at %08x (has %02x %02x in badblock_pos %d&bslash;n&quot;
comma
id|jeb-&gt;offset
comma
id|buf
...
DECL|variable|jffs2_oobinfo_swecc
r_static
r_struct
id|nand_oobinfo
id|jffs2_oobinfo_swecc
op_assign
(brace
dot
id|useecc
...
l_int|0xFFFFFFFF
suffix:semicolon
multiline_comment|/* FIXME: If we had a generic way of describing the hardware&squot;s&n;&t;   use of OOB area, we could perhaps make this generic too. */
r_switch
c_cond
(paren
id|c-&gt;mtd-&gt;ecctype
...
(paren
id|KERN_DEBUG
l_string|&quot;JFFS2 using software ECC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|c-&gt;oobinfo
...
(paren
id|KERN_DEBUG
l_string|&quot;JFFS2 using DiskOnChip hardware ECC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|c-&gt;oobinfo
...
c_func
(paren
l_string|&quot;JFFS2 doesn&squot;t yet know how to handle ECC type %d&bslash;n&quot;
comma
id|c-&gt;mtd-&gt;ecctype
)paren
suffix:semicolon

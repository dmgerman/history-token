...
c_func
(paren
l_string|&quot;NFSD: expire client. dp %p, fp %p&bslash;n&quot;
comma
id|dp
comma
id|dp-&gt;dl_flock
...
c_func
(paren
l_string|&quot;NFSD nfsd_release_deleg_cb: fl %p dp %p dl_count %d&bslash;n&quot;
comma
id|fl
comma
id|dp
...
multiline_comment|/*&n; * Called from __setlease() with lock_kernel() held&n; */
r_static
DECL|function|nfsd_same_client_deleg_cb
r_int
id|nfsd_same_client_deleg_cb
c_func
(paren
r_struct
id|file_lock
...
suffix:semicolon
r_return
id|onlistd-&gt;dl_client
op_eq
id|tryd-&gt;dl_client
suffix:semicolon
)brace
r_static
DECL|function|nfsd_change_deleg_cb
r_int
id|nfsd_change_deleg_cb
c_func
(paren
r_struct
id|file_lock
...
id|current-&gt;tgid
suffix:semicolon
multiline_comment|/* setlease checks to see if delegation should be handed out.&n;&t; * the lock_manager callbacks fl_mylease and fl_change are used&n;&t; */
r_if
c_cond
(paren
(paren

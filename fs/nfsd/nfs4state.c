...
op_assign
op_amp
id|stp-&gt;st_stateowner-&gt;so_client-&gt;cl_callback
suffix:semicolon
id|dprintk
c_func
(paren
...
c_func
(paren
l_string|&quot;nfsd4: out of memory while initializing nfsv4&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;NFSD: nfs4_check_deleg_recall returns %d with flag %d&bslash;n&quot;
comma
id|status
comma
op_star
...
(brace
multiline_comment|/* We assume the client took too long to RENEW. */
id|dprintk
c_func
(paren
...
(brace
multiline_comment|/* Trying to call delegreturn with a special stateid? Yuch: */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Answer in remaining cases depends on existance of&n;&t;&t; * conflicting state; so we must wait out the grace period. */
r_return
id|nfserr_grace
suffix:semicolon
)brace
...
suffix:semicolon
r_else
multiline_comment|/* (flags &amp; RD_STATE) &amp;&amp; ZERO_STATEID(stateid) */
r_return
id|nfs4_share_conflict
c_func
(paren
...
multiline_comment|/*&n; * Allow READ/WRITE during grace period on recovered state only for files&n; * that are not able to provide mandatory locking.&n; */
r_static
r_inline
r_int
...
c_func
(paren
l_string|&quot;NFSD nfs4_client_to_reclaim NAME: %.*s&bslash;n&quot;
comma
id|namlen
comma
id|name
...
c_func
(paren
l_string|&quot;NFSD: nfs4_find_reclaim_client for %.*s&bslash;n&quot;
comma
id|clp-&gt;cl_name.len
comma
id|clp-&gt;cl_name.data

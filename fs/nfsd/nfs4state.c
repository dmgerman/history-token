...
id|open-&gt;op_seqid
suffix:semicolon
multiline_comment|/* until open_confirm is coded, pretend it happened! */
id|sop-&gt;so_confirmed
op_assign
l_int|1
suffix:semicolon
...
id|renew
suffix:colon
multiline_comment|/* XXX implement LRU and state recovery thread &n;&t; * renew will place nfs4_client at end of LRU &n;&t; */
id|out
suffix:colon
id|up
c_func

...
id|FL_POSIX
suffix:semicolon
id|file_lock.fl_notify
op_assign
l_int|NULL
suffix:semicolon
id|file_lock.fl_insert
op_assign
l_int|NULL
suffix:semicolon
id|file_lock.fl_remove
op_assign
l_int|NULL
suffix:semicolon
...
c_func
(paren
l_string|&quot;NFSD: nfsd4_lock: posix_test_lock passed. posix_lock_file status %d&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* find the lockowner */
id|status
op_assign
id|nfs_ok
suffix:semicolon

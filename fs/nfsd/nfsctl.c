...
multiline_comment|/*&n; *&t;We have a single directory with 9 nodes in it.&n; */
r_enum
(brace
...
id|NFSD_Threads
comma
DECL|enumerator|NFSD_Leasetime
id|NFSD_Leasetime
comma
)brace
suffix:semicolon
...
(brace
multiline_comment|/* if size &gt; 10 seconds, call&n;&t; * nfs4_reset_lease() then write out the new lease (seconds) as reply&n;&t; */
r_char
op_star
id|mesg
op_assign

...
multiline_comment|/* this routine finds the dentry of the parent of a given directory&n; * it assumes lookup(&quot;..&quot;) works.&n; */
...
multiline_comment|/*&n;&t; * Security: Check that the export is valid for dentry &lt;gam3@acm.org&gt;&n;&t; *  This is only needed with subtree_check, and if export_operations is&n;&t; *  not being used -  export_operations does the check via  the &quot;acceptable&quot;&n;&t; *  callback&n;&t; */
id|error
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/* ref_fh is a reference file handle.&n;&t; * if it is non-null, then we should compose a filehandle which is&n;&t; * of the same version, where possible.&n;&t; * Currently, that means that if ref_fh-&gt;fh_handle.fh_version == 0xca&n;&t; * Then create a 32byte filehandle using nfs_fhbase_old&n;&t; * But only do this if dentry_to_fh is not available&n;&t; *&n;&t; */
r_struct
id|inode
op_star
id|inode

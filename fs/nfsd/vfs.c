...
multiline_comment|/*&n; * linux/fs/nfsd/vfs.c&n; *&n; * File operations used by nfsd. Some of these have been ripped from&n; * other parts of the kernel because they weren&squot;t exported, others&n; * are partial duplicates with added or changed functionality.&n; *&n; * Note that several functions dget() the dentry upon which they want&n; * to act, most notably those that create directory entries. Response&n; * dentry&squot;s are dput()&squot;d if necessary in the release callback.&n; * So if you notice code paths that apparently fail to dput() the&n; * dentry, don&squot;t worry--they have been taken care of.&n; *&n; * Copyright (C) 1995-1999 Olaf Kirch &lt;okir@monad.swb.de&gt;&n; * Zerocpy NFS support (C) 2002 Hirokazu Takahashi &lt;taka@valinux.co.jp&gt;&n; */
...
id|raparm_cache
suffix:semicolon
multiline_comment|/* &n; * Called from nfsd_lookup and encode_dirent. Check if we have crossed &n; * a mount point.&n; * Returns -EAGAIN leaving *dpp and *expp unchanged, &n; *  or nfs_ok having possibly changed *dpp and *expp&n; */
r_int
DECL|function|nfsd_cross_mnt
id|nfsd_cross_mnt
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|set_nfsv4_acl_one
id|set_nfsv4_acl_one
c_func
(paren
r_struct
id|dentry
...
r_int
DECL|function|nfsd4_set_nfs4_acl
...
r_int
DECL|function|nfsd4_get_nfs4_acl
...
macro_line|#endif /* defined(CONFIG_NFS_V4) */
macro_line|#ifdef CONFIG_NFSD_V3
...
(brace
multiline_comment|/* in nfsv4, we need to treat this case a little&n;&t;&t;&t;&t; * differently.  we don&squot;t want to truncate the&n;&t;&t;&t;&t; * file now; this would be wrong if the OPEN&n;&t;&t;&t;&t; * fails for some other reason.  furthermore,&n;&t;&t;&t;&t; * if the size is nonzero, we should ignore it&n;&t;&t;&t;&t; * according to spec!&n;&t;&t;&t;&t; */
op_star
id|truncp
op_assign
(paren
...
id|S_IALLUGO
suffix:semicolon
multiline_comment|/* Only the MODE ATTRibute is even vaguely meaningful */
r_if
c_cond
(paren
id|iap
...
multiline_comment|/*&n; * Read entries from a directory.&n; * The  NFSv3/4 verifier we ignore for now.&n; */
r_int
...
id|nfserr_eof
suffix:semicolon
multiline_comment|/* will be cleared on successful read */
id|err
op_assign
id|vfs_readdir
c_func
...
id|nfs_ok
suffix:semicolon
multiline_comment|/* can still be found in -&gt;err */
id|out_close
suffix:colon
id|nfsd_close
c_func

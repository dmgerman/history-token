...
id|EIO
suffix:colon
multiline_comment|/* Network partition? */
r_case
op_minus
id|EBADHANDLE
suffix:colon
...
suffix:colon
multiline_comment|/* Race: client probably got cb_recall&n;&t;&t;&t;&t; * before open reply granting delegation */
r_break
suffix:semicolon
r_default
suffix:colon
...
c_func
(paren
l_string|&quot;NFSD: nfs4_cb_recall: dp %p dl_flock %p dl_count %d&bslash;n&quot;
comma
id|dp
comma
id|dp-&gt;dl_flock

...
multiline_comment|/*&n; * Convert the NT UTC (based 1601-01-01, in hundred nanosecond units)&n; * into Unix UTC (based 1970-01-01, in seconds).&n; *&n; * This is very gross because&n; * 1: We must do 64-bit division on a 32-bit machine&n; * 2: We can&squot;t use libgcc for long long operations in the kernel&n; * 3: Floating point math in the kernel would corrupt user data&n; */
r_static
id|time_t
...
id|result
suffix:semicolon
multiline_comment|/*&n;&t; * It is best to subtract 0x019db1ded53e8000 first.&n;&t; * Then the 1601-based date becomes a 1970-based date.&n;&t; */
r_if
c_cond
(paren
id|L
...
suffix:semicolon
multiline_comment|/* Make sure we can fit a message of the negotiated size in our&n;&t;   packet buffer. */
r_if
c_cond
(paren
id|server-&gt;opt.max_xmit
...
r_else
(brace
multiline_comment|/* else continue with the too small buffer? */
id|PARANOIA
c_func
(paren
l_string|&quot;Failed to allocate new packet buffer: &quot;
l_string|&quot;max_xmit=%d, packet_size=%d&bslash;n&quot;
comma
id|server-&gt;opt.max_xmit
comma
id|server-&gt;packet_size

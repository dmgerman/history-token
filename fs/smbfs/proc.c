...
suffix:semicolon
multiline_comment|/* maxlen is at least 1 */
id|test_name_and_out
suffix:colon
r_if
c_cond
...
multiline_comment|/*&n;&t; * Check for server errors.&n;&t; */
r_if
c_cond
(paren
id|s-&gt;rcls
...
macro_line|#if 0
multiline_comment|/* flags we will test for other patches ... */
r_if
c_cond
(paren
id|server-&gt;opt.capabilities
...
id|data_off
suffix:semicolon
multiline_comment|/* we can NOT simply trust the info given by the server ... */
r_if
c_cond
(paren
id|data_len
...
l_int|0
suffix:semicolon
multiline_comment|/* FIXME: pad to short or long ... change +2 above also */
op_star
id|p
op_increment
op_assign

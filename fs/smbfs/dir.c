...
suffix:semicolon
DECL|variable|smb_dir_inode_operations_unix
r_struct
id|inode_operations
...
(brace
multiline_comment|/* Set attributes for new file */
id|attr.ia_valid
op_assign
id|ATTR_MODE
suffix:semicolon
...
(brace
multiline_comment|/* Set attributes for new directory */
id|attr.ia_valid
op_assign
id|ATTR_MODE
suffix:semicolon
...
multiline_comment|/*&n; * FIXME: samba servers won&squot;t let you create device nodes unless uid/gid&n; * matches the connection credentials (and we don&squot;t know which those are ...)&n; */
r_static
r_int
DECL|function|smb_make_node
id|smb_make_node
c_func
(paren
r_struct
...
multiline_comment|/*&n; * dentry = existing file&n; * new_dentry = new file&n; */
r_static
r_int
DECL|function|smb_link
id|smb_link
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;smb_link old=%s/%s new=%s/%s&bslash;n&quot;
comma
id|DENTRY_PATH
c_func
(paren

...
mdefine_line|#define UFS_TEST_FREE_SPACE_CG &bslash;&n;&t;ucg = (struct ufs_cylinder_group *) sb-&gt;u.ufs_sb.s_ucg[cgno]-&gt;b_data; &bslash;&n;&t;if (fs32_to_cpu(sb, ucg-&gt;cg_cs.cs_nbfree)) &bslash;&n;&t;&t;goto cg_found; &bslash;&n;&t;for (k = count; k &lt; uspi-&gt;s_fpb; k++) &bslash;&n;&t;&t;if (fs32_to_cpu(sb, ucg-&gt;cg_frsum[k])) &bslash;&n;&t;&t;&t;goto cg_found; 

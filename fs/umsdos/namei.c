...
id|printk
(paren
l_string|&quot;UMSDOS: UMSDOS_I(dir)-&gt;dir_info.creating &lt; 0: %d&quot;
comma
id|UMSDOS_I
c_func
(paren
...
id|printk
(paren
l_string|&quot;UMSDOS: UMSDOS_I(dir)-&gt;dir_info.looking &lt; 0: %d&quot;
comma
id|UMSDOS_I
c_func
(paren
...
id|ENOENT
suffix:semicolon
multiline_comment|/*&n;&t; * note: for hardlinks they will be different!&n;&t; *  old_inode will contain inode of .LINKxxx file containing data, and&n;&t; *  old-&gt;d_inode will contain inode of file containing path to .LINKxxx file&n;&t; */
r_if
c_cond
(paren
op_logical_neg

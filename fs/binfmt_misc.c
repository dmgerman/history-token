...
DECL|macro|MISC_FMT_OPEN_BINARY
mdefine_line|#define MISC_FMT_OPEN_BINARY (1&lt;&lt;30)
DECL|macro|MISC_FMT_CREDENTIALS
mdefine_line|#define MISC_FMT_CREDENTIALS (1&lt;&lt;29)
r_typedef
r_struct
(brace
DECL|member|list
...
multiline_comment|/* if the binary should be opened on behalf of the&n;&t;&t; * interpreter than keep it open and assign descriptor&n;&t;&t; * to it */
id|fd_binary
op_assign
id|get_unused_fd
c_func
...
suffix:semicolon
multiline_comment|/* if the binary is not readable than enforce mm-&gt;dumpable=0&n;&t;&t;   regardless of the interpreter&squot;s permissions */
r_if
c_cond
(paren
id|permission
...
id|fmt-&gt;flags
op_amp
id|MISC_FMT_CREDENTIALS
)paren
(brace
multiline_comment|/*&n;&t;&t; * No need to call prepare_binprm(), it&squot;s already been&n;&t;&t; * done.  bprm-&gt;buf is stale, update from interp_file.&n;&t;&t; */
id|memset
c_func
(paren
id|bprm-&gt;buf
...
DECL|function|check_special_flags
r_static
r_inline
r_char
op_star
id|check_special_flags
(paren
r_char
op_star
id|sfs
...
l_int|1
suffix:semicolon
multiline_comment|/* special flags */
r_while
c_loop
(paren
id|cont
...
op_increment
suffix:semicolon
multiline_comment|/* this flags also implies the&n;&t;&t;&t;&t;   open-binary flag */
id|e-&gt;flags
op_or_assign
(paren
id|MISC_FMT_CREDENTIALS
...
multiline_comment|/*&n; * This registers a new binary format, it recognises the syntax&n; * &squot;:name:type:offset:magic:mask:interpreter:flags&squot;&n; * where the &squot;:&squot; is the IFS, that can be chosen with the first char&n; */
...
suffix:semicolon
multiline_comment|/* print the special flags */
id|sprintf
(paren
id|dp
comma

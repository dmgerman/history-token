...
id|permission
(paren
id|binary_file-&gt;f_dentry-&gt;d_inode
comma
id|MAY_READ
comma
l_int|NULL
...
multiline_comment|/* install the binary&squot;s fd. it is done at the latest possible point&n;&t; &t; * because once it is installed it will need to be sys_close()ed&n;&t; &t; * in case of error.&n;&t; &t; */
id|fd_install
(paren
id|fd_binary
comma

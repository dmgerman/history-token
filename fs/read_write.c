...
suffix:semicolon
multiline_comment|/* A write operation does a read from user space and vice versa */
DECL|macro|vrfy_dir
mdefine_line|#define vrfy_dir(type) ((type) == READ ? VERIFY_WRITE : VERIFY_READ)

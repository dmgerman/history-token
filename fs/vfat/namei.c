...
multiline_comment|/* returns the length of a struct qstr, ignoring trailing dots */
DECL|function|vfat_striptail_len
r_static
r_int
r_int
...
DECL|function|vfat_replace_char
r_static
r_inline
m_wchar_t
id|vfat_replace_char
c_func
(paren
m_wchar_t
id|w
...
c_func
(paren
l_string|&quot;VFAT filesystem support&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
l_string|&quot;Gordon Chaffee&quot;
)paren
suffix:semicolon
id|module_init
c_func

...
macro_line|#if 0 /* not used functions */
r_static
r_inline
r_int
r_char
...
op_assign
(brace
multiline_comment|/*  `*&squot;     `?&squot;     `&lt;&squot;    `&gt;&squot;      `|&squot;     `&quot;&squot;     `:&squot;     `/&squot;     `&bslash;&squot; */
l_int|0x002A
comma
l_int|0x003F
comma
...
multiline_comment|/* Given a valid longname, create a unique shortname.  Make sure the&n; * shortname does not exist&n; * Returns negative number on error, 0 for a normal&n; * return, and 1 for valid shortname&n; */
...
id|is_shortname
suffix:semicolon
multiline_comment|/* &n;&t; * 1) Valid characters for the 8.3 format alias are any&n;&t; * combination of letters, uppercase alphabets, digits, any of&n;&t; * the following special characters:&n;&t; *     $ % &squot; ` - @ { } ~ ! # ( ) &amp; _ ^&n;&t; * In this case Longfilename is not stored in disk.&n;&t; *     &n;&t; * 2) File name is 8.3 format, but it contain the lowercase&n;&t; * alphabet etc. In this case numtail is not added, but&n;&t; * Longfilename is stored.&n;&t; * &n;&t; * 3) When the one except for the above, or the following special&n;&t; * character are contained:&n;&t; *        .   [ ] ; , + =&n;&t; * numtail is added, and Longfilename must be stored in disk .&n;&t; */
id|is_uppercase
op_assign
l_int|1
suffix:semicolon

...
multiline_comment|/* Setup the structure that is used as key for the rb-tree */
DECL|macro|EP_SET_FFD
mdefine_line|#define EP_SET_FFD(p, f, d) do { (p)-&gt;file = (f); (p)-&gt;fd = (d); } while (0)
multiline_comment|/* Compare rb-tree keys */
DECL|macro|EP_CMP_FFD
mdefine_line|#define EP_CMP_FFD(p1, p2) ((p1)-&gt;file &gt; (p2)-&gt;file ? +1: &bslash;&n;&t;&t;&t;    ((p1)-&gt;file &lt; (p2)-&gt;file ? -1: (p1)-&gt;fd - (p2)-&gt;fd))
multiline_comment|/* Special initialization for the rb-tree node to detect linkage */
DECL|macro|EP_RB_INITNODE
mdefine_line|#define EP_RB_INITNODE(n) (n)-&gt;rb_parent = (n)
multiline_comment|/* Removes a node from the rb-tree and marks it for a fast is-linked check */
DECL|macro|EP_RB_ERASE
mdefine_line|#define EP_RB_ERASE(n, r) do { rb_erase(n, r); (n)-&gt;rb_parent = (n); } while (0)
multiline_comment|/* Fast check to verify that the item is linked to the main rb-tree */
DECL|macro|EP_RB_LINKED
mdefine_line|#define EP_RB_LINKED(n) ((n)-&gt;rb_parent != (n))
...
id|rdllist
suffix:semicolon
multiline_comment|/* RB-Tree root used to store monitored fd structs */
DECL|member|rbr
r_struct
id|rb_root
id|rbr
...
id|epitem
(brace
multiline_comment|/* RB-Tree node used to link this structure to the eventpoll rb-tree */
DECL|member|rbn
r_struct
id|rb_node
id|rbn
...
id|rdllink
suffix:semicolon
multiline_comment|/* The file descriptor information this item refers to */
DECL|member|ffd
r_struct
id|epoll_filefd
id|ffd
...
suffix:semicolon
multiline_comment|/*&n;&t; * Walks through the whole tree by unregistering poll callbacks.&n;&t; */
r_for
c_loop
(paren
id|rbp
...
DECL|function|ep_rbtree_insert
r_static
r_void
id|ep_rbtree_insert
c_func
...
suffix:semicolon
multiline_comment|/* Add the current item to the rb-tree */
id|ep_rbtree_insert
c_func
(paren
id|ep
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * At this point is safe to do the job, unlink the item from our rb-tree.&n;&t; * This operation togheter with the above check closes the door to&n;&t; * double unlinks.&n;&t; */
id|EP_RB_ERASE
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;eventpoll_init() failed&bslash;n&quot;
)paren
suffix:semicolon
)brace

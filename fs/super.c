...
suffix:semicolon
multiline_comment|/**&n; *&t;remove_super&t;-&t;makes superblock unreachable&n; *&t;@s:&t;superblock in question&n; *&n; *&t;Removes superblock from the lists, unlocks it and drop the reference&n; *&t;@s should have no active references by that time and after&n; *&t;remove_super() it&squot;s essentially&t;in rundown mode - all remaining&n; *&t;references are temporary, no new reference of any sort are going&n; *&t;to appear and all holders of temporary ones will eventually drop them.&n; *&t;At that point superblock itself will be destroyed; all its contents&n; *&t;is already gone.&n; */

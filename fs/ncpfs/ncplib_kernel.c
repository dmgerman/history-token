multiline_comment|/*&n; *  ncplib_kernel.c&n; *&n; *  Copyright (C) 1995, 1996 by Volker Lendecke&n; *  Modified for big endian by J.F. Chadima and David S. Miller&n; *  Modified 1997 Peter Waltenberg, Bill Hawes, David Woodhouse for 2.1 dcache&n; *  Modified 1999 Wolfram Pienkoss for NLS&n; *  Modified 2000 Ben Harris, University of Cambridge for NFS NS meta-info&n; *&n; */
...
DECL|function|ncp_add_dword_lh
r_static
r_inline
r_void
id|ncp_add_dword_lh
...
DECL|function|ncp_reply_dword_lh
r_static
r_inline
id|__u32
id|ncp_reply_dword_lh
c_func
(paren
r_struct
id|ncp_server
...
DECL|function|ncp_get_directory_info
r_int
...
DECL|function|ncp_dirhandle_alloc
r_int
...
DECL|function|ncp_dirhandle_free
r_int
...
DECL|function|ncp_extract_nfs_info
r_static
r_inline
r_void
id|ncp_extract_nfs_info
c_func
(paren
r_int
r_char
...
macro_line|#endif
DECL|function|ncp_obtain_nfs_info
r_int
...
suffix:semicolon
multiline_comment|/* We must retrieve both nlinks and rdev, otherwise some server versions&n;&t;&t;   report zeroes instead of valid data */
id|ncp_add_dword_lh
c_func
(paren
id|server
...
(paren
id|KERN_DEBUG
l_string|&quot;ncp_obtain_nfs_info: (%s) mode=0%o, rdev=0x%x&bslash;n&quot;
comma
id|target-&gt;entryName
comma
id|target-&gt;nfs.mode
...
r_int
DECL|function|ncp_get_volume_root
...
c_func
(paren
l_string|&quot;ncp_get_volume_root: looking up vol %s&bslash;n&quot;
comma
id|volname
)paren
suffix:semicolon
...
macro_line|#ifdef CONFIG_NCPFS_NFS_NS
DECL|function|ncp_modify_nfs_info
r_int
...
suffix:semicolon
multiline_comment|/* we must always operate on both nlinks and rdev, otherwise&n;&t;&t;   rdev is not set */
id|ncp_add_dword_lh
c_func
(paren
id|server
...
DECL|function|ncp_search_for_fileset
r_int

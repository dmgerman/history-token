...
multiline_comment|/*&n; * does the right thing for deciding when to lock a buffer and&n; * mark it for io during a writepage.  make sure the buffer is&n; * dirty before sending it here though.&n; */
DECL|function|lock_buffer_for_writepage
r_static
r_void
id|lock_buffer_for_writepage
c_func
(paren
r_struct
id|page
...
(brace
multiline_comment|/* buffer mapped to an unformatted node */
id|lock_buffer_for_writepage
c_func
(paren
id|page
...
r_else
(brace
multiline_comment|/* not mapped yet, or it points to a direct item, search&n;&t;&t; * the btree for the mapping info, and log any direct&n;&t;&t; * items found&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* very conservative, leave the buffer pinned if anyone might need it.&n;&t;** this should be changed to drop the buffer if it is only in the&n;&t;** current transaction&n;&t;*/
r_if
c_cond
(paren
id|buffer_journaled

...
id|le64_to_cpu
(paren
id|from-&gt;u.k_offset_v2.k_offset
)paren
suffix:semicolon
...
id|le16_to_cpu
(paren
id|p_s_path_item-&gt;u.ih_entry_count
)paren
op_ne
id|p_cpu_ih-&gt;u.ih_entry_count
op_logical_or
id|le16_to_cpu
(paren
id|p_s_path_item-&gt;ih_item_len
)paren
op_ne
id|p_cpu_ih-&gt;ih_item_len
op_logical_or
id|le16_to_cpu
(paren
id|p_s_path_item-&gt;ih_item_location
)paren
op_ne
id|p_cpu_ih-&gt;ih_item_location
)paren
r_return
l_int|1
suffix:semicolon
...
(brace
multiline_comment|/* we&squot;ve converted from indirect to direct, we must remove&n;&t;** ourselves from the list of pages that need flushing before&n;&t;** this transaction can commit&n;&t;*/
...
id|IH_SIZE
op_plus
id|p_s_ih-&gt;ih_item_len
)paren
suffix:semicolon
multiline_comment|/*&n;    if (p_c_body == 0)&n;      n_zeros_num = p_s_ih-&gt;ih_item_len;&n;    */

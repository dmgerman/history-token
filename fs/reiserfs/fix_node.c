...
suffix:semicolon
macro_line|#endif
macro_line|#else&t;/* REISERFS_FSCK */
multiline_comment|/* we can delete any directory item in fsck (if it is unreachable) */
r_if
c_cond
(paren
id|ih-&gt;ih_key.k_offset
op_ne
id|DOT_OFFSET
)paren
(brace
multiline_comment|/* must get left neighbor here to make sure, that left&n;&t;&t;   neighbor is of the same directory */
r_struct
id|buffer_head
op_star
id|left
...
id|tb-&gt;tb_sb
comma
l_string|&quot;vs-8135: are_leaves_removable: &quot;
l_string|&quot;empty node in the tree&quot;
)paren
suffix:semicolon
id|last
op_assign
...
id|p_s_tb-&gt;tb_sb
comma
l_string|&quot;PAP-8200: get_parents: rdkey in S0 %k, rdkey in CFR0 %k do not match&quot;
comma
id|B_PRIGHT_DELIM_KEY
(paren
id|PATH_H_PBUFFER
...
suffix:semicolon
macro_line|#ifdef REISERFS_FSCK
multiline_comment|/* special mode for insert pointer to the most low internal node */
r_if
c_cond
(paren
id|h
...
(brace
multiline_comment|/* blk_num == 2 is to get pointer inserted to the next level */
id|set_parameters
(paren
id|tb
comma
...
id|p_s_tb-&gt;tb_sb
comma
l_string|&quot;PAP-8310: fix_nodes: all buffers must be hold once in one thread processing&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
id|p_s_tb-&gt;tb_sb
comma
l_string|&quot;PAP-8325: fix_nodes: Incorrect item number %d (in S0 - %d) in case of insert&quot;
comma
id|n_item_num
comma
id|B_NR_ITEMS
...
macro_line|#if 0 /* shouldn&squot;t this be in CONFIG_REISERFS_CHECK??? */
multiline_comment|/* make sure, that all we have released got really freed */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* the log will have the count at one and the buffers marked */
r_if
c_cond
(paren
id|atomic_read
...
id|printk
(paren
l_string|&quot;unfix_nodes: Waiting...(block %lu, count %d)&bslash;n&quot;
comma
id|tb-&gt;thrown
(braket
id|i
...
id|printk
(paren
l_string|&quot;unfix_nodes: Done (block %lu, count %d)&bslash;n&quot;
comma
id|tb-&gt;thrown
(braket
id|i
...
macro_line|#ifndef REISERFS_FSCK
singleline_comment|// is_left_mergeable is now one of the item methods
macro_line|#else
singleline_comment|// this works only in fsck
DECL|function|are_items_mergeable
r_int
...
l_int|0
comma
l_string|&quot;vs-16070: are_items_mergeable: left %k, right %k&quot;
comma
op_amp
(paren
id|left-&gt;ih_key
...
multiline_comment|/* get left neighbor of the leaf node */
...
suffix:semicolon
multiline_comment|/*  init_path (&amp;path_to_left_neighbor);*/
id|search_by_key
(paren
id|s
comma
...
suffix:semicolon
singleline_comment|// FIXME: fsck is to handle I/O failures somehow as well
r_if
c_cond
(paren
id|PATH_LAST_POSITION
...
id|MIN_KEY
suffix:semicolon
DECL|function|get_right_neighbor
r_static
r_struct
id|buffer_head
op_star
id|get_right_neighbor
(paren
r_struct
id|super_block
op_star
...
id|s
comma
l_string|&quot;vs-16080: get_right_neighbor: get_rkey returned min key (path has changed)&quot;
)paren
suffix:semicolon
id|copy_key
(paren
...
suffix:semicolon
multiline_comment|/*init_path (&amp;path_to_right_neighbor);*/
id|search_by_key
(paren
id|s
comma
...
DECL|function|is_left_mergeable
r_int
id|is_left_mergeable
(paren
r_struct
...
DECL|function|is_right_mergeable
r_int
id|is_right_mergeable
(paren
r_struct
...
macro_line|#endif /* REISERFS_FSCK */
eof

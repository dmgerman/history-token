...
id|panic
(paren
l_string|&quot;REISERFS: panic (device %s): Panic forced after error&bslash;n&quot;
comma
id|reiserfs_bdevname
(paren
id|sb
...
(paren
id|KERN_CRIT
l_string|&quot;REISERFS: error (device %s): Re-mounting fs &quot;
l_string|&quot;readonly&bslash;n&quot;
comma
id|reiserfs_bdevname
(paren
id|sb
...
(paren
id|KERN_CRIT
l_string|&quot;REISERFS: error (device %s): %s&bslash;n&quot;
comma
id|reiserfs_bdevname
(paren
id|sb
...
(paren
id|KERN_CRIT
l_string|&quot;REISERFS: abort (device %s): %s&bslash;n&quot;
comma
id|reiserfs_bdevname
(paren
id|sb
...
DECL|function|reiserfs_hashname
r_char
op_star

...
mdefine_line|#define do_reiserfs_warning &bslash;&n;{&bslash;&n;  char * fmt1 = fmt_buf;&bslash;&n;  va_list args;&bslash;&n;  int i, j;&bslash;&n;  char * k;&bslash;&n;  char * p = error_buf;&bslash;&n;  int what, skip;&bslash;&n;&bslash;&n;  strcpy (fmt1, fmt);&bslash;&n;  va_start(args, fmt);&bslash;&n;&bslash;&n;  while (1) {&bslash;&n;    k = is_there_reiserfs_struct (fmt1, &amp;what, &amp;skip);&bslash;&n;    if (k != 0) {&bslash;&n;      *k = 0;&bslash;&n;      p += vsprintf (p, fmt1, args);&bslash;&n;&bslash;&n;      for (i = 0; i &lt; skip; i ++)&bslash;&n;&t;j = va_arg (args, int);&bslash;&n;&bslash;&n;      switch (what) {&bslash;&n;      case &squot;k&squot;:&bslash;&n;&t;sprintf_le_key (p, va_arg(args, struct key *));&bslash;&n;&t;break;&bslash;&n;      case &squot;K&squot;:&bslash;&n;&t;sprintf_cpu_key (p, va_arg(args, struct cpu_key *));&bslash;&n;&t;break;&bslash;&n;      case &squot;h&squot;:&bslash;&n;&t;sprintf_item_head (p, va_arg(args, struct item_head *));&bslash;&n;&t;break;&bslash;&n;      case &squot;t&squot;:&bslash;&n;&t;sprintf_direntry (p, va_arg(args, struct reiserfs_dir_entry *));&bslash;&n;&t;break;&bslash;&n;      case &squot;y&squot;:&bslash;&n;&t;sprintf_disk_child (p, va_arg(args, struct disk_child *));&bslash;&n;&t;break;&bslash;&n;      case &squot;z&squot;:&bslash;&n;&t;sprintf_block_head (p, va_arg(args, struct buffer_head *));&bslash;&n;&t;break;&bslash;&n;      case &squot;b&squot;:&bslash;&n;&t;sprintf_buffer_head (p, va_arg(args, struct buffer_head *));&bslash;&n;&t;break;&bslash;&n;      }&bslash;&n;      p += strlen (p);&bslash;&n;      fmt1 = k + 2;&bslash;&n;    } else {&bslash;&n;      i = vsprintf (p, fmt1, args);&bslash;&n;      break;&bslash;&n;    }&bslash;&n;  }&bslash;&n;&bslash;&n;  va_end(args);&bslash;&n;}
...
DECL|function|reiserfs_version
r_static
r_char
op_star
id|reiserfs_version
...
id|printk
(paren
l_string|&quot;Busy blocks (skipped %d, bitmaps - %d, journal blocks - %d&bslash;n&quot;
l_string|&quot;1 super blocks, %d data blocks&bslash;n&quot;
comma
id|skipped
comma
id|le16_to_cpu
...
id|printk
(paren
l_string|&quot;Filesystem state %s&bslash;n&quot;
comma
(paren
id|le16_to_cpu
(paren
...
DECL|function|print_bmap_block
r_void
id|print_bmap_block
(paren
r_int
...
(brace
multiline_comment|/* first block addressed by this bitmap block is used */
id|ones
op_increment
suffix:semicolon
r_if
...
r_else
(brace
multiline_comment|/* first block addressed by this bitmap is free */
id|zeros
op_increment
suffix:semicolon
r_if
...
multiline_comment|/* if silent == 1, do not print details */
DECL|function|print_bmap
r_void
id|print_bmap
(paren
r_struct
...
id|printf
(paren
l_string|&quot;Bitmap blocks are:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
DECL|function|print_objectid_map
r_void
...
id|printk
(paren
l_string|&quot;Map of objectids&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|printk
(paren
l_string|&quot;Object id array has size %d (max %d):&quot;
comma
id|rs-&gt;s_oid_cursize
comma
id|rs-&gt;s_oid_maxsize
...
macro_line|#endif&t;/* #ifndef __KERNEL__ */
...
(brace
multiline_comment|/*&n;  printk (&quot;reiserfs_put_super: session statistics: balances %d, fix_nodes %d, preserve list freeings %d, &bslash;&n;bmap with search %d, without %d, dir2ind %d, ind2dir %d&bslash;n&quot;,&n;&t;  s-&gt;u.reiserfs_sb.s_do_balance, s-&gt;u.reiserfs_sb.s_fix_nodes, s-&gt;u.reiserfs_sb.s_preserve_list_freeings,&n;&t;  s-&gt;u.reiserfs_sb.s_bmaps, s-&gt;u.reiserfs_sb.s_bmaps_without_search,&n;&t;  s-&gt;u.reiserfs_sb.s_direct2indirect, s-&gt;u.reiserfs_sb.s_indirect2direct);&n;  */
)brace
eof

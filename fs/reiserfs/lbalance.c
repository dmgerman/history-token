...
comma
l_string|&quot;vs-10030: merge to left: last unformatted node of non-last indirect item %h must have zerto free space&quot;
comma
id|ih
)paren
suffix:semicolon
...
id|ih-&gt;ih_version
suffix:semicolon
multiline_comment|/* JDM Endian safe, both le */
id|leaf_insert_into_buf
(paren
id|dest_bi
comma
...
id|IH_SIZE
comma
l_string|&quot;vs-10170: not enough free space in block %z, new item %h&quot;
comma
id|bh
comma
id|inserted_item_ih
...
id|paste_size
comma
l_string|&quot;vs-10175: not enough free space: needed %d, available %d&quot;
comma
id|paste_size
comma
id|free_space

...
id|s
comma
l_string|&quot;reiserfs: cannot turn on journalled quota: error %d&quot;
comma
id|ret
)paren
suffix:semicolon
...
multiline_comment|/* Restore the flag back */
id|s-&gt;s_flags
op_and_assign
op_complement
id|MS_ACTIVE
...
suffix:semicolon
DECL|variable|reiserfs_quota_operations
r_static
r_struct
id|dquot_operations
id|reiserfs_quota_operations
op_assign
(brace
dot
id|initialize
...
suffix:semicolon
DECL|variable|reiserfs_qctl_operations
r_static
r_struct
id|quotactl_ops
id|reiserfs_qctl_operations
op_assign
(brace
dot
id|quota_on
...
id|arg_desc_t
suffix:semicolon
multiline_comment|/* Set this bit in arg_required to allow empty arguments */
DECL|macro|REISERFS_OPT_ALLOWEMPTY
mdefine_line|#define REISERFS_OPT_ALLOWEMPTY 31
...
(brace
multiline_comment|/* this catches &quot;option=,&quot; if not allowed */
id|reiserfs_warning
(paren
id|s
comma
...
id|s
comma
l_string|&quot;reiserfs_parse_options: cannot change journalled quota options when quota turned on.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(brace
multiline_comment|/* Some filename specified? */
r_if
c_cond
(paren
id|REISERFS_SB
...
id|s
comma
l_string|&quot;reiserfs_parse_options: %s quota file already specified.&quot;
comma
id|QTYPE2NAME
c_func
(paren
...
id|s
comma
l_string|&quot;reiserfs_parse_options: quotafile must be on filesystem root.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|s
comma
l_string|&quot;reiserfs_parse_options: not enough memory for storing quotafile name.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|s
comma
l_string|&quot;reiserfs_parse_options: unknown quota format specified.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|s
comma
l_string|&quot;reiserfs_parse_options: journalled quota options not supported.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|s
comma
l_string|&quot;reiserfs_parse_options: journalled quota format not specified.&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
macro_line|#ifdef CONFIG_QUOTA
DECL|function|reiserfs_dquot_initialize
r_static
r_int
id|reiserfs_dquot_initialize
c_func
...
DECL|function|reiserfs_dquot_drop
r_static
r_int
id|reiserfs_dquot_drop
c_func
...
DECL|function|reiserfs_write_dquot
r_static
r_int
id|reiserfs_write_dquot
c_func
...
DECL|function|reiserfs_acquire_dquot
r_static
r_int
id|reiserfs_acquire_dquot
c_func
...
DECL|function|reiserfs_release_dquot
r_static
r_int
id|reiserfs_release_dquot
c_func
...
DECL|function|reiserfs_mark_dquot_dirty
r_static
r_int
id|reiserfs_mark_dquot_dirty
c_func
...
DECL|function|reiserfs_write_info
r_static
r_int
id|reiserfs_write_info
c_func
...
DECL|function|reiserfs_quota_on_mount
r_static
r_int
id|reiserfs_quota_on_mount
c_func
...
suffix:semicolon
multiline_comment|/* Now invalidate and put the dentry - quota got its own reference&n;     * to inode and dentry has at least wrong hash so we had better&n;     * throw it away */
id|d_invalidate
c_func
(paren
id|dentry
...
DECL|function|reiserfs_quota_on
r_static
r_int
id|reiserfs_quota_on
c_func
...
multiline_comment|/* We must not pack tails for quota files on reiserfs for quota IO to work */
r_if
c_cond
(paren
op_logical_neg
...
id|sb
comma
l_string|&quot;reiserfs: Quota file must have tail packing disabled.&quot;
)paren
suffix:semicolon
id|path_release
c_func
...
multiline_comment|/* Not journalling quota? No more tests needed... */
r_if
c_cond
(paren
op_logical_neg
...
id|sb
comma
l_string|&quot;reiserfs: Quota file not on filesystem root. &quot;
l_string|&quot;Journalled quota will not work.&quot;
)paren
suffix:semicolon
id|path_release
c_func
...
DECL|function|reiserfs_quota_read
r_static
id|ssize_t
id|reiserfs_quota_read
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Quota files are without tails so we can safely use this function */
id|err
op_assign
...
DECL|function|reiserfs_quota_write
r_static
id|ssize_t
id|reiserfs_quota_write
c_func

...
DECL|function|is_reiserfs_super
r_int
...
id|bitmask
suffix:semicolon
multiline_comment|/* bit which is to be set in mount_options bitmask when this&n;                    value is found, 0 is no bits are to be set */
...
id|bitmask
suffix:semicolon
multiline_comment|/* bit which is to be set in mount_options bitmask when this&n;&t;&t;     option is selected, 0 is not bits are to be set */
...
(brace
multiline_comment|/* *opt_arg contains pointer to argument */
op_star
id|opt_arg
op_assign
id|p
...
comma
multiline_comment|/* Compatibility stuff, so that -o notail&n;for old setups still work */
(brace
l_string|&quot;conv&quot;
comma
l_int|0
...
suffix:semicolon
r_else
multiline_comment|/* Drop defaults to zeroes */
op_star
id|mount_options
op_assign
l_int|0

...
multiline_comment|/* &n;** looks up the dentry of the parent directory for child.&n;** taken from ext2_get_parent&n;*/
DECL|function|reiserfs_get_parent
r_struct
id|dentry
op_star
...
(brace
multiline_comment|/* the quota init calls have to know who to charge the quota to, so&n;    ** we have to set uid and gid here&n;    */
id|inode-&gt;i_uid
op_assign
id|current-&gt;fsuid
suffix:semicolon

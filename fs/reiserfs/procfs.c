...
DECL|function|show_on_disk_super
r_static
r_int
id|show_on_disk_super
c_func
(paren
r_struct
id|seq_file
...
id|size
op_assign
id|sb_info-&gt;oidmap.mapf-&gt;f_dentry-&gt;d_inode-&gt;i_size
suffix:semicolon
id|total_used
op_add_assign
id|size
...
id|m
comma
l_string|&quot;total: &bslash;t%i [%i/%i] used: %lu [exact]&bslash;n&quot;
comma
id|mapsize
comma
id|mapsize
...
DECL|variable|r_file_operations
r_static
r_struct
id|file_operations
id|r_file_operations
op_assign
(brace
dot
id|open

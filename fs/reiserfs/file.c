...
multiline_comment|/* If the file have grown so much that tail packing is no longer possible, reset&n;&t;   &quot;need to pack&quot; flag */
r_if
c_cond
(paren
(paren
...
(brace
singleline_comment|// Direct IO needs some special threating.
r_int
id|result
comma
id|after_file_end

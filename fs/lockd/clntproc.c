...
DECL|function|nlm_get_lockowner
r_static
r_struct
id|nlm_lockowner
op_star
id|nlm_get_lockowner
c_func
(paren
r_struct
id|nlm_lockowner
...
DECL|function|nlm_put_lockowner
r_static
r_void
id|nlm_put_lockowner
c_func
(paren
r_struct
id|nlm_lockowner
...
DECL|function|__nlm_find_lockowner
r_static
r_struct
id|nlm_lockowner
op_star
id|__nlm_find_lockowner
c_func
(paren
r_struct
id|nlm_host
...
DECL|function|nlm_find_lockowner
r_static
r_struct
id|nlm_lockowner
op_star
id|nlm_find_lockowner
c_func
(paren
r_struct
id|nlm_host
...
DECL|function|nlmclnt_release_lockargs
r_static
r_void
id|nlmclnt_release_lockargs
c_func
(paren
r_struct
id|nlm_rqst
...
DECL|function|nlm_wait_on_grace
r_static
r_int
id|nlm_wait_on_grace
c_func
(paren
...
(brace
multiline_comment|/* We appear to be out of the grace period */
id|wake_up_all
c_func
(paren
op_amp
...
id|in_grace_period
suffix:colon
multiline_comment|/*&n;&t;&t; * The server has rebooted and appears to be in the grace&n;&t;&t; * period during which locks are only allowed to be&n;&t;&t; * reclaimed.&n;&t;&t; * We can only back off and try again later.&n;&t;&t; */
id|status
op_assign
id|nlm_wait_on_grace
c_func
...
(brace
multiline_comment|/*&n;&t;&t; * Report the conflicting lock back to the application.&n;&t;&t; */
id|locks_copy_lock
c_func
(paren
id|fl
...
DECL|function|nlmclnt_locks_copy_lock
r_static
r_void
id|nlmclnt_locks_copy_lock
c_func
(paren
r_struct
id|file_lock
...
r_new
op_member_access_from_pointer
id|fl_u.nfs_fl.owner
)paren
suffix:semicolon
)brace
DECL|function|nlmclnt_locks_release_private
r_static
r_void
id|nlmclnt_locks_release_private
c_func
(paren
r_struct
id|file_lock
...
DECL|variable|nlmclnt_lock_ops
r_static
r_struct
...
suffix:semicolon
DECL|function|nlmclnt_locks_init_private
r_static
r_void
id|nlmclnt_locks_init_private
c_func
...
suffix:semicolon
multiline_comment|/* Hrmf... Do the unlock early since locks_remove_posix()&n;&t;&t; * really expects us to free the lock synchronously */
id|posix_lock_file
c_func
(paren
id|fl-&gt;fl_file

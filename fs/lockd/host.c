...
(brace
multiline_comment|/* find a nlm_host for a client for which h_killed == 0.&n;&t; * and return it&n;&t; */
r_int
id|hash
suffix:semicolon
id|down
...
id|host-&gt;h_next
suffix:semicolon
multiline_comment|/* Don&squot;t unmonitor hosts that have been invalidated */
r_if
c_cond
(paren
id|host-&gt;h_monitored

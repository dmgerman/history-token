...
op_member_access_from_pointer
id|sb-&gt;RootDir.di_first_xtnt.xtnt_blk
)paren
op_minus
l_int|1
suffix:semicolon
...
op_member_access_from_pointer
id|sb-&gt;RootDir.di_first_xtnt.xtnt_size
)paren
suffix:semicolon
r_for
c_loop
...
suffix:semicolon
r_return
l_string|&quot;not enough memory for bitmap inode&quot;
suffix:semicolon
)brace
id|memcpy
c_func
...
suffix:semicolon
multiline_comment|/* Check the superblock signature. Since the qnx4 code is&n;&t;   dangerous, we should leave as quickly as possible&n;&t;   if we don&squot;t belong here... */
id|bh
op_assign
id|sb_bread
c_func
...
c_func
(paren
l_string|&quot;qnx4: wrong fsid in superblock.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out
...
c_func
(paren
l_string|&quot;QNX4 filesystem 0.2.3 registered.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

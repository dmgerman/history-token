...
suffix:semicolon
multiline_comment|/* list of free filps for root */
r_static
id|LIST_HEAD
c_func
(paren
...
id|RW_LOCK_UNLOCKED
suffix:semicolon
multiline_comment|/* f-&gt;f_version, f-&gt;f_list.next: 0 */
r_return
id|f
suffix:semicolon
)brace
)brace
multiline_comment|/* Use a reserved one if we&squot;re the superuser */
id|file_list_lock
c_func
(paren
)paren

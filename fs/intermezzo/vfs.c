...
id|presto_sym_iops
suffix:semicolon
multiline_comment|/* Write the last_rcvd values to the last_rcvd file.  We don&squot;t know what the&n; * UUID or last_ctime values are, so we have to read from the file first&n; * (sigh). &n; * exported for branch_reinter in kml_reint.c*/
...
(brace
multiline_comment|/* izo_rcvd_write returns negative errors and non-negative&n;                 * offsets */
id|CERROR
c_func
(paren
l_string|&quot;InterMezzo: izo_rcvd_write failed: %d&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
DECL|function|izo_get_rollback_data
r_void
...
c_func
(paren
l_string|&quot;presto_close: cannot journal last_rcvd&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out
...
c_func
(paren
l_string|&quot;izo_mark_dentry(inode %ld, ~PRESTO_DATA) &quot;
...
id|S_IFREG
suffix:semicolon
singleline_comment|//        down(&amp;dir-&gt;d_inode-&gt;i_zombie);
id|error
op_assign
id|presto_reserve_space
c_func
...
id|EXIT
suffix:semicolon
singleline_comment|//                up(&amp;dir-&gt;d_inode-&gt;i_zombie);
r_return
id|error
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* add inode dentry */
r_if
c_cond
(paren
id|fset-&gt;fset_cache-&gt;cache_filter-&gt;o_trops-&gt;tr_add_ilookup
)paren
(brace
r_struct
id|dentry
...
multiline_comment|/* link dd data to that of existing dentry */
id|old_dentry-&gt;d_op
op_member_access_from_pointer
id|d_release
c_func
...
c_func
(paren
l_string|&quot;InterMezzo %s: no readlink iops.&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;InterMezzo: readlink failed: %ld&bslash;n&quot;
comma
id|PTR_ERR
c_func
(paren
...
(brace
multiline_comment|/* FIXME: Combine this with the next call? */
id|error
op_assign
id|presto_settime
c_func
...
suffix:semicolon
singleline_comment|//        double_down(&amp;dir-&gt;d_inode-&gt;i_zombie, &amp;dentry-&gt;d_inode-&gt;i_zombie);
id|d_unhash
c_func
(paren
id|dentry
...
c_func
(paren
l_string|&quot;foo: d_mountpoint(dentry): ino %ld&bslash;n&quot;
comma
id|dentry-&gt;d_inode-&gt;i_ino
)paren
suffix:semicolon
...
singleline_comment|//        double_up(&amp;dir-&gt;d_inode-&gt;i_zombie, &amp;dentry-&gt;d_inode-&gt;i_zombie);
r_if
c_cond
(paren
op_logical_neg
...
singleline_comment|//                triple_down(&amp;old_dir-&gt;i_zombie,
singleline_comment|//                            &amp;new_dir-&gt;i_zombie,
singleline_comment|//                            &amp;target-&gt;i_zombie);
id|d_unhash
c_func
(paren
id|new_dentry
...
r_else
singleline_comment|//                double_down(&amp;old_dir-&gt;i_zombie,
singleline_comment|//                            &amp;new_dir-&gt;i_zombie);
r_if
c_cond
(paren
...
id|S_DEAD
suffix:semicolon
singleline_comment|//                triple_up(&amp;old_dir-&gt;i_zombie,
singleline_comment|//                          &amp;new_dir-&gt;i_zombie,
singleline_comment|//                          &amp;target-&gt;i_zombie);
r_if
c_cond
...
r_else
singleline_comment|//                double_up(&amp;old_dir-&gt;i_zombie,
singleline_comment|//                          &amp;new_dir-&gt;i_zombie);
r_if
c_cond
(paren
...
suffix:semicolon
singleline_comment|//        double_down(&amp;old_dir-&gt;i_zombie, &amp;new_dir-&gt;i_zombie);
r_if
c_cond
(paren
id|d_mountpoint
...
suffix:semicolon
singleline_comment|//        double_up(&amp;old_dir-&gt;i_zombie, &amp;new_dir-&gt;i_zombie);
r_if
c_cond
(paren
id|error
...
l_int|0
suffix:semicolon
singleline_comment|//f-&gt;f_reada = 0;
id|f-&gt;f_op
op_assign
l_int|NULL
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: create file by inode number (%ld) not allowed&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ino

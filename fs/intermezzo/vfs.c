...
l_int|0
suffix:semicolon
singleline_comment|// we suppose no error, Arthur
id|inode_setattr
c_func
(paren
id|dentry-&gt;d_inode
...
DECL|function|presto_do_statfs
r_int
id|presto_do_statfs
(paren
r_struct
...
(paren
op_logical_neg
id|fset-&gt;fset_cache-&gt;cache_mtde-&gt;d_inode
)paren
(brace
id|EXIT
suffix:semicolon
...
(paren
op_logical_neg
id|fset-&gt;fset_cache-&gt;cache_mtde-&gt;d_inode-&gt;i_sb
)paren
(brace
id|EXIT
suffix:semicolon

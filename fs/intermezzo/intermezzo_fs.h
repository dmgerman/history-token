...
id|group_info
suffix:semicolon
multiline_comment|/*&t;int              ngroups;&n;&t;gid_t&t;         groups[NGROUPS];*/
)brace
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*      save-&gt;ngroups = current-&gt;ngroups;&n;        for (i = 0; i&lt; current-&gt;ngroups; i++) &n;                save-&gt;groups[i] = current-&gt;groups[i];*/
id|set_fs
c_func
(paren
r_new
...
id|fsgid
suffix:semicolon
multiline_comment|/*if (new-&gt;ngroups &gt; 0) {&n;                current-&gt;ngroups = new-&gt;ngroups;&n;                for (i = 0; i&lt; new-&gt;ngroups; i++) &n;                        current-&gt;groups[i] = new-&gt;groups[i];&n;        }*/
id|current-&gt;group_info
op_assign
r_new
op_member_access_from_pointer
...
id|saved-&gt;group_info
suffix:semicolon
multiline_comment|/*&n;        current-&gt;ngroups = saved-&gt;ngroups;&n;        for (i = 0; i&lt; saved-&gt;ngroups; i++) &n;                current-&gt;groups[i] = saved-&gt;groups[i];&n;*/
id|mntput
c_func
(paren
id|saved-&gt;pwdmnt

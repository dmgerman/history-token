...
multiline_comment|/**&n; *&t;sysfs_create_symlink - make a symlink&n; *&t;@kobj:&t;object who&squot;s directory we&squot;re creating in. &n; *&t;@name:&t;name of the symlink.&n; *&t;@target:&t;path we&squot;re pointing to.&n; */

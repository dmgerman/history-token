...
id|buf
comma
l_string|&quot;&bslash;n%d) Name: %s  Domain: %s HowManyMounts: %d LocalUsersToSameServer: %d&bslash;n&bslash;t ServerOS: %s  ServerNOS: %s  Capabilities: 0x%x &quot;
comma
id|i
comma
id|ses-&gt;serverName

...
l_int|0
suffix:semicolon
multiline_comment|/* check for plausible wct, bcc and possible t2 data and parm sizes */
...
(brace
multiline_comment|/* decode response */
multiline_comment|/* BB fixme - Add safety check parm and data fields &n;&t;&t;and do it for all transact SMBs - &n;&t;&t;and remember to free buffer if error BB */
r_if
c_cond
(paren
id|pSMBr-&gt;hdr.Flags2

...
multiline_comment|/* All SMB/CIFS PDU handling routines go here - except for a few leftovers in connect.c */
...
suffix:semicolon
multiline_comment|/* one byte - no need to convert this or EncryptionKeyLen field from le,  */
id|ses-&gt;maxReq
op_assign
id|le16_to_cpu
c_func
...
suffix:semicolon
multiline_comment|/* BB le_to_host needed around here and ff */
id|cFYI
c_func
(paren
l_int|1
...
suffix:semicolon
multiline_comment|/* BB what are these? BB */
...
multiline_comment|/* if(pSMBr-&gt;DataOffset &lt; pSMBr-&gt;ByteCount + sizeof(READ_RSP) - 1 */
multiline_comment|/* BB fix this length check */
r_if
c_cond
(paren
id|pSMBr-&gt;DataLength
...
comma
(paren
l_string|&quot;&bslash;nIn QPathSymLinkInfo (Unix) the path %s&quot;
comma
id|searchName
)paren
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/* just in case so the calling code does not go off the end of the buffer */
)brace
)brace
r_if
c_cond
...
id|CIFS_SEARCH_CLOSE_AT_END
op_or
id|CIFS_SEARCH_CONTINUE_FROM_LAST
)paren
suffix:semicolon
id|pSMB-&gt;hdr.smb_buf_length
op_add_assign
...
comma
(paren
l_string|&quot;&bslash;nUid = %lld from %lld &quot;
comma
id|data_offset-&gt;Uid
comma
id|uid
...
comma
(paren
l_string|&quot;&bslash;nGid = %lld from %lld &quot;
comma
id|data_offset-&gt;Gid
comma
id|gid

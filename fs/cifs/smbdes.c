...
id|rl
suffix:semicolon
multiline_comment|/* Have to reduce stack usage */
id|pk1
op_assign
id|kmalloc
c_func
...
id|er
suffix:semicolon
multiline_comment|/* er[48]  */
r_char
op_star
id|erk
suffix:semicolon
multiline_comment|/* erk[48] */
r_char
id|b
(braket
l_int|8
...
id|cb
suffix:semicolon
multiline_comment|/* cb[32]  */
r_char
op_star
id|pcb
suffix:semicolon
multiline_comment|/* pcb[32] */
r_char
op_star
id|r2
suffix:semicolon
multiline_comment|/* r2[32]  */
id|er
op_assign
id|kmalloc
c_func
...
id|outb
suffix:semicolon
multiline_comment|/* outb[64] */
r_char
op_star
id|inb
suffix:semicolon
multiline_comment|/* inb[64]  */
r_char
op_star
id|keyb
suffix:semicolon
multiline_comment|/* keyb[64] */
r_int
r_char
id|key2
(braket

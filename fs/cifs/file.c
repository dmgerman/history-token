...
multiline_comment|/* reopen files */
id|list_for_each_safe
c_func
(paren
id|tmp
...
(brace
multiline_comment|/* BB need to fix above to check list end and skip entries we do not need to reopen */
id|open_file
op_assign
id|list_entry
c_func
...
comma
(paren
l_string|&quot;No bytes read cleaning remaining pages off readahead list&quot;
)paren
)paren
suffix:semicolon

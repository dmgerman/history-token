...
multiline_comment|/* BB add code to refresh inode by passing in file_info buf on open &n;&t;   and calling get_inode_info with returned buf (at least &n;&t;   helps non-Unix server case */
id|rc
op_assign
id|CIFSSMBOpen
c_func

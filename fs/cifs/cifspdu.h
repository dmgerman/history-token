...
multiline_comment|/* The following three structures are needed only for&n;&t;setting time to NT4 and some older servers via&n;&t;the primitive DOS time format */
r_typedef
r_struct
(brace
DECL|member|Day
...
id|CreationDate
suffix:semicolon
multiline_comment|/* SMB Date see above */
DECL|member|CreationTime
id|__le16
id|CreationTime
suffix:semicolon
multiline_comment|/* SMB Time */

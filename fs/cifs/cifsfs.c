...
multiline_comment|/* if not then check whether we can use the page cache at all */
r_if
c_cond
(paren
id|CIFS_I
...
(brace
multiline_comment|/* no need to invalidate the local copy */
)brace
r_else
id|invalidate_remote_inode
c_func
...
suffix:semicolon
multiline_comment|/* since we can not cache writes, need to sync the data */
r_return
id|written
suffix:semicolon
)brace

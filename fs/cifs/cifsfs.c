...
id|oplockThread
suffix:semicolon
multiline_comment|/* remove sparse warning */
...
suffix:semicolon
DECL|variable|cifs_file_direct_ops
r_struct
id|file_operations
id|cifs_file_direct_ops
op_assign
(brace
multiline_comment|/* no mmap, no aio, no readv - &n;&t;   BB reevaluate whether they can be done with directio, no cache */
dot
id|read
op_assign
id|cifs_user_read

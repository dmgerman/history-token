...
r_else
(brace
multiline_comment|/* BB spinlock protect this against races with demux thread */
id|spin_lock
c_func
(paren
op_amp
...
comma
(paren
l_string|&quot;retrying after setting session need reconnectd&quot;
)paren
)paren
suffix:semicolon
r_goto

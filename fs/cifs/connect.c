...
id|UNCip
suffix:semicolon
DECL|member|in6_addr
r_char
op_star
id|in6_addr
suffix:semicolon
multiline_comment|/* ipv6 address as human readable form of in6_addr */
...
DECL|member|no_xattr
r_int
id|no_xattr
suffix:colon
l_int|1
suffix:semicolon
multiline_comment|/* set if xattr (EA) support should be disabled*/
...
comma
l_int|0
multiline_comment|/* BB see socket.h flags */
)paren
suffix:semicolon
r_if
c_cond
...
comma
(paren
l_string|&quot;rfc1002 length(big endian)0x%x)&quot;
comma
id|pdu_length
op_plus
l_int|4
...
comma
(paren
l_string|&quot;Invalid size SMB length %d and pdu_length %d&quot;
comma
id|length
comma
id|pdu_length
...
l_int|4
suffix:semicolon
multiline_comment|/* account for rfc1002 hdr */
)brace
id|dump_smb
c_func
(paren
...
(brace
multiline_comment|/*parse before user*/
id|vol-&gt;no_xattr
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;CIFS: ip v6 address not 48 characters long&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
c_cond
(paren
id|volume_info.no_xattr
)paren
(brace
id|cifs_sb-&gt;mnt_cifs_flags
op_or_assign
id|CIFS_MOUNT_NO_XATTR
suffix:semicolon
)brace
r_if
c_cond

...
(brace
multiline_comment|/* BB are there cases in which a comma can be &n;&t;&t;&t;&t;valid in the workstation name (and need special&n;&t;&t;&t;&t;case handling)? */
id|strncpy
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;CIFS: netbiosname too long (more than 15)&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace

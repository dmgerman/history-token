...
suffix:semicolon
multiline_comment|/* inode-&gt;i_mode = S_IRWXUGO;  */
multiline_comment|/* 777 perms */
...
id|cifs_sb-&gt;tcon
suffix:semicolon
multiline_comment|/* BB Should we close the file if it is already open from our client? */
id|full_path
op_assign
...
r_else
(brace
multiline_comment|/* BB to be implemented - via Windows security descriptors */
...
(brace
multiline_comment|/* BB handle errors better if one attribute not set &n;            (such as size) but time setting works */
...
l_int|0
suffix:semicolon
multiline_comment|/* BB is this ignored by server?  &n;                        or do I have to query and reset anyway BB */
id|rc
op_assign
id|CIFSSMBSetTimes
c_func

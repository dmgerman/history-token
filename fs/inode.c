...
(brace
multiline_comment|/* &n;&t;&t;&t; * We&squot;re under PF_MEMALLOC here, and syncing the &n;&t;&t;&t; * inode may have to allocate memory. To avoid&n;&t;&t;&t; * running into a OOM deadlock, we write one &n;&t;&t;&t; * inode synchronously and stop syncing in case &n;&t;&t;&t; * we&squot;re under freepages.low&n;&t;&t;&t; */
r_int
id|sync
op_assign
id|nr_free_pages
...
suffix:semicolon
multiline_comment|/* &n;&t; * If we freed enough clean inodes, avoid writing &n;&t; * dirty ones. Also giveup if we already tried to&n;&t; * sync dirty inodes.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

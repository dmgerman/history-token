...
id|CURRENT_TIME
suffix:semicolon
multiline_comment|/* Can later do this more lazily with a per superblock interval */
r_if
c_cond
(paren
id|timespec_equal
...
multiline_comment|/**&n; *&t;inode_update_time&t;-&t;update mtime and ctime time&n; *&t;@inode: inode accessed&n; *&t;@ctime_too: update ctime too&n; *&n; *&t;Update the mtime time on an inode and mark it for writeback.&n; *&t;This function automatically handles read only file systems and media.&n; *&t;When ctime_too is specified update the ctime too.&n; */

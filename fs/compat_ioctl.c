...
suffix:semicolon
multiline_comment|/* should the size be limited? -arnd */
id|ifc.ifc_buf
op_assign
id|kmalloc
(paren
...
id|iov
suffix:semicolon
multiline_comment|/* FIXME: dereferencing user pointer? */
r_return
l_int|0
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* In usbdevice_fs, it limits the control buffer to a page,&n;         * for simplicity so do we.&n;         */
r_if
c_cond
(paren
op_logical_neg

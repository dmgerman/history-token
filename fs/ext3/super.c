...
c_func
(paren
l_string|&quot;EXT3-fs: invalid s_free_blocks_count %u (real %lu)&bslash;n&quot;
comma
id|le32_to_cpu
c_func
(paren
...
multiline_comment|/* distribute reserved blocks over groups -bzzz */
r_for
c_loop
(paren
id|i
...
l_string|&quot;ext3_check_descriptors&quot;
comma
l_string|&quot;cant get descriptor for group %d&quot;
comma
id|i
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;EXT3-fs: invalid s_free_inodes_count %u (real %lu)&bslash;n&quot;
comma
id|le32_to_cpu
c_func
(paren
...
c_func
(paren
l_string|&quot;EXT3-fs: not enough memory to allocate s_bgi&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|failed_mount2

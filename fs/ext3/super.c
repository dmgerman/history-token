...
(paren
id|KERN_ERR
l_string|&quot;%s: aborting transaction: %s in %s&bslash;n&quot;
comma
id|caller
comma
id|errstr
...
id|EXT3_NDIR_BLOCKS
suffix:semicolon
multiline_comment|/* This constant is calculated to be the largest file size for a&n;&t; * dense, 4k-blocksize file such that the total number of&n;&t; * sectors in the file, including data and all indirect blocks,&n;&t; * does not exceed 2^32. */
r_const
id|loff_t
id|upper_limit
op_assign
l_int|0x1ff7fffd000LL
suffix:semicolon
id|res
op_add_assign
l_int|1LL
...
(paren
id|KERN_WARNING
l_string|&quot;EXT3-fs: Ignoring nobh option &quot;
l_string|&quot;since filesystem blocksize doesn&squot;t match &quot;
l_string|&quot;pagesize&bslash;n&quot;
)paren
suffix:semicolon
id|clear_opt
c_func
...
id|KERN_WARNING
l_string|&quot;EXT3-fs: Ignoring nobh option - &quot;
l_string|&quot;its supported only with writeback mode&bslash;n&quot;
)paren
suffix:semicolon
id|clear_opt
c_func
...
suffix:semicolon
multiline_comment|/* Now invalidate and put the dentry - quota got its own reference&n;&t; * to inode and dentry has at least wrong hash so we had better&n;&t; * throw it away */
id|d_invalidate
c_func
(paren
id|dentry
...
multiline_comment|/* Read data from quotafile - avoid pagecache and such because we cannot afford&n; * acquiring the locks... As quota files are never truncated and quota code&n; * itself serializes the operations (and noone else should touch the files)&n; * we don&squot;t have to be afraid of races */
DECL|function|ext3_quota_read
r_static
id|ssize_t
id|ext3_quota_read
c_func
...
multiline_comment|/* Write to quotafile (we know the transaction is already started and has&n; * enough credits) */
DECL|function|ext3_quota_write
r_static
id|ssize_t
id|ext3_quota_write
c_func
...
r_else
(brace
multiline_comment|/* Always do at least ordered writes for quotas */
id|err
op_assign

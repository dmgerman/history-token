multiline_comment|/*&n; * linux/fs/ext3/acl.c&n; *&n; * Copyright (C) 2001 by Andreas Gruenbacher, &lt;a.gruenbacher@computer.org&gt;&n; */
...
id|posix_acl
op_star
DECL|function|ext3_acl_from_disk
id|ext3_acl_from_disk
c_func
(paren
r_const
r_void
...
r_void
op_star
DECL|function|ext3_acl_to_disk
id|ext3_acl_to_disk
c_func
(paren
r_const
...
multiline_comment|/*&n; * Inode operation get_posix_acl().&n; *&n; * inode-&gt;i_sem: down&n; */
r_static
r_struct
id|posix_acl
op_star
DECL|function|ext3_get_acl
id|ext3_get_acl
c_func
(paren
r_struct
...
multiline_comment|/*&n; * Set the access or default ACL of an inode.&n; *&n; * inode-&gt;i_sem: down unless called from ext3_new_inode&n; */
r_static
r_int
DECL|function|ext3_set_acl
id|ext3_set_acl
c_func
(paren
id|handle_t
...
r_static
r_int
DECL|function|__ext3_permission
id|__ext3_permission
c_func
(paren
r_struct
id|inode
...
multiline_comment|/*&n; * Inode operation permission().&n; *&n; * inode-&gt;i_sem: up&n; */
r_int
DECL|function|ext3_permission
id|ext3_permission
c_func
(paren
r_struct
...
r_int
DECL|function|ext3_permission_locked
...
multiline_comment|/*&n; * Initialize the ACLs of a new inode. Called from ext3_new_inode.&n; *&n; * dir-&gt;i_sem: down&n; * inode-&gt;i_sem: up (access to inode is still exclusive)&n; */
r_int
...
multiline_comment|/*&n; * Extended attribute handlers&n; */
r_static
r_int
DECL|function|ext3_xattr_list_acl_access
id|ext3_xattr_list_acl_access
c_func
(paren
r_char
op_star
...
r_static
r_int
DECL|function|ext3_xattr_list_acl_default
id|ext3_xattr_list_acl_default
c_func
(paren
r_char
op_star
...
r_static
r_int
DECL|function|ext3_xattr_get_acl
id|ext3_xattr_get_acl
c_func
(paren
r_struct
id|inode
...
r_static
r_int
DECL|function|ext3_xattr_get_acl_access
id|ext3_xattr_get_acl_access
c_func
(paren
r_struct
id|inode
...
r_static
r_int
DECL|function|ext3_xattr_get_acl_default
id|ext3_xattr_get_acl_default
c_func
(paren
r_struct
id|inode
...
r_static
r_int
DECL|function|ext3_xattr_set_acl
id|ext3_xattr_set_acl
c_func
(paren
r_struct
id|inode
...
r_static
r_int
DECL|function|ext3_xattr_set_acl_access
id|ext3_xattr_set_acl_access
c_func
(paren
r_struct
id|inode
...
r_static
r_int
DECL|function|ext3_xattr_set_acl_default
id|ext3_xattr_set_acl_default
c_func
(paren
r_struct
id|inode
...
DECL|variable|ext3_xattr_acl_access_handler
r_struct
...
suffix:semicolon
DECL|variable|ext3_xattr_acl_default_handler
r_struct
id|ext3_xattr_handler

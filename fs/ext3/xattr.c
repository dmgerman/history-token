...
suffix:semicolon
DECL|macro|header
mdefine_line|#define header ((struct ext3_xattr_header *)(s.base))
multiline_comment|/*&n;&t; * header -- Points either into bh, or to a temporarily&n;&t; *           allocated buffer.&n;&t; */
id|ea_idebug
c_func
(paren
id|inode
...
(brace
multiline_comment|/* assert(header == BHDR(old_bh)); */
id|ce
op_assign
id|mb_cache_entry_get
c_func

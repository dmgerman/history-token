...
(paren
op_amp
id|inode-&gt;u.ext3_i.truncate_sem
)paren
suffix:semicolon
id|lock_super
(paren
...
id|inode-&gt;u.ext3_i.i_faddr
op_assign
l_int|0
suffix:semicolon
id|inode-&gt;u.ext3_i.i_frag_no
op_assign
l_int|0
suffix:semicolon
id|inode-&gt;u.ext3_i.i_frag_size
op_assign
l_int|0
suffix:semicolon
macro_line|#endif
id|inode-&gt;u.ext3_i.i_file_acl
op_assign
l_int|0
suffix:semicolon
id|inode-&gt;u.ext3_i.i_dir_acl
op_assign
l_int|0
suffix:semicolon
id|inode-&gt;u.ext3_i.i_dtime
op_assign
l_int|0
suffix:semicolon
id|INIT_LIST_HEAD
...
(paren
op_amp
id|inode-&gt;u.ext3_i.i_orphan
)paren
suffix:semicolon
macro_line|#ifdef EXT3_PREALLOCATE
id|inode-&gt;u.ext3_i.i_prealloc_count
op_assign
l_int|0
suffix:semicolon
macro_line|#endif
id|inode-&gt;u.ext3_i.i_block_group
op_assign
id|i
suffix:semicolon
r_if

...
id|ngroups
suffix:semicolon
multiline_comment|/*&n;&t; * Use a quadratic hash to find a group with a free inode and some free&n;&t; * blocks.&n;&t; */
r_for
c_loop
(paren
id|i
...
(paren
op_amp
id|ei-&gt;i_rsv_window.rsv_alloc_hit
comma
l_int|0
)paren
suffix:semicolon

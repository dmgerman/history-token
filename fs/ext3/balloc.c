...
id|error_out
suffix:colon
id|sb-&gt;u.ext3_sb.s_block_bitmap_number
(braket
id|bitmap_nr
)braket
op_assign
id|block_group
suffix:semicolon
id|sb-&gt;u.ext3_sb.s_block_bitmap
(braket
id|bitmap_nr
)braket
op_assign
...
id|i
OL
id|sb-&gt;u.ext3_sb.s_loaded_block_bitmaps
op_logical_and
id|sb-&gt;u.ext3_sb.s_block_bitmap_number
(braket
id|i
...
comma
id|sb-&gt;u.ext3_sb.s_itb_per_group
)paren
op_logical_or
id|in_range
(paren
...
id|bitmap_bh
comma
l_string|&quot;clear in b_committed_data&quot;
)paren
suffix:semicolon
id|J_ASSERT_BH
c_func
...
id|ret
suffix:semicolon
multiline_comment|/* And the superblock */
id|BUFFER_TRACE
c_func
(paren
id|sb-&gt;u.ext3_sb.s_sbh
comma
l_string|&quot;dirtied superblock&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
(paren
(paren
id|sb-&gt;u.ext3_sb.s_resuid
op_ne
id|current-&gt;fsuid
)paren
op_logical_and
(paren
id|sb-&gt;u.ext3_sb.s_resgid
op_eq
l_int|0
op_logical_or
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Make sure we use undo access for the bitmap, because it is&n;           critical that we do the frozen_data COW on bitmap buffers in&n;           all cases even if the buffer is in BJ_Forget state in the&n;           committing transaction.  */
id|BUFFER_TRACE
c_func
(paren
id|bh
comma
l_string|&quot;get undo access for marking new block&quot;
)paren
suffix:semicolon
id|fatal
op_assign
...
suffix:semicolon
multiline_comment|/* The superblock lock should guard against anybody else beating&n;&t; * us to this point! */
id|J_ASSERT_BH
c_func
(paren
id|bh
...
multiline_comment|/*&n;&t; * akpm: this is not enabled for ext3.  Need to use&n;&t; * ext3_test_allocatable()&n;&t; */
...
id|es-&gt;s_prealloc_blocks
suffix:colon
id|EXT3_DEFAULT_PREALLOC_BLOCKS
suffix:semicolon
op_star
id|prealloc_block
op_assign
...
id|bh
comma
l_string|&quot;journal_dirty_metadata for superblock&quot;
)paren
suffix:semicolon
id|err
op_assign
...
c_func
(paren
id|sb-&gt;u.ext3_sb.s_es-&gt;s_first_data_block
)paren
)paren
op_mod
id|EXT3_BLOCKS_PER_GROUP

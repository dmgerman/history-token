...
id|bdev-&gt;bd_inode-&gt;i_data.backing_dev_info
op_assign
id|bdev-&gt;bd_contains-&gt;bd_inode-&gt;i_data.backing_dev_info
suffix:semicolon
r_if
c_cond
(paren
...
(brace
multiline_comment|/*&n;&t; * deprecated, use the /proc/iosched interface instead&n;&t; */
r_case
id|BLKELVGET
suffix:colon
r_case

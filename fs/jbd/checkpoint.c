...
multiline_comment|/*&n;&t;&t; * This is foul&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If someone cleaned up this transaction while we slept, we&squot;re&n;&t;&t; * done&n;&t;&t; */
r_if
c_cond
(paren
id|journal-&gt;j_checkpoint_transactions
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Maybe it&squot;s a new transaction, but it fell at the same&n;&t;&t; * address&n;&t;&t; */
r_if
c_cond
(paren
id|transaction-&gt;t_tid
...
id|jh-&gt;b_cpnext
suffix:semicolon
multiline_comment|/* Use trylock because of the ranknig */
r_if
c_cond
(paren
id|jbd_trylock_bh_state
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * This function only frees up some memory&n;&t;&t;&t;&t; * if possible so we dont have an obligation&n;&t;&t;&t;&t; * to finish processing. Bail out if preemption&n;&t;&t;&t;&t; * requested:&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|need_resched

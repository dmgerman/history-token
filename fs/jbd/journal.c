...
multiline_comment|/* Quick version for internal journal use (doesn&squot;t lock the journal) */
DECL|function|__journal_abort
r_void
id|__journal_abort
(paren
id|journal_t

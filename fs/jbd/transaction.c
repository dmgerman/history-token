...
multiline_comment|/*&n;&t; * We need to mark the buffer dirty and refile it inside the lock to&n;&t; * protect it from release by journal_try_to_free_buffer()&n;&t; *&n;&t; * We set -&gt;b_flushtime to something small enough to typically keep&n;&t; * kupdate away from the buffer.&n;&t; *&n;&t; * We don&squot;t need to do a balance_dirty() - __block_commit_write()&n;&t; * does that.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

...
multiline_comment|/*&n; * UniStrncpy_to_le:  Copy length limited string with pad to little-endian&n; */
DECL|function|UniStrncpy_to_le
r_static
r_inline
id|__le16
op_star
...
multiline_comment|/*&n; * UniStrncpy_from_le:  Copy length limited string with pad from little-endian&n; */
DECL|function|UniStrncpy_from_le
r_static
r_inline
m_wchar_t
op_star

...
multiline_comment|/*&n; *&t;read_index_page()&n; *&n; *&t;Reads a page of a directory&squot;s index table.&n; *&t;Having metadata mapped into the directory inode&squot;s address space&n; *&t;presents a multitude of problems.  We avoid this by mapping to&n; *&t;the absolute address space outside of the *_metapage routines&n; */
DECL|function|read_index_page
r_static
r_struct
id|metapage
op_star
...
suffix:semicolon
multiline_comment|/* Free quota allocation. */
id|DQUOT_FREE_BLOCK
c_func
(paren
id|ip
...
multiline_comment|/*&n; *&t;add_missing_indices()&n; *&n; * function: Fix dtree page in which one or more entries has an invalid index.&n; *&t;     fsck.jfs should really fix this, but it currently does not.&n; *&t;     Called from jfs_readdir when bad index is detected.&n; */
DECL|function|add_missing_indices
r_static
r_void
id|add_missing_indices
c_func
(paren
r_struct
id|inode
...
(paren
id|KERN_ERR
l_string|&quot;DT_GETPAGE failed!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|end
...
multiline_comment|/*&n; * Buffer to hold directory entry info while traversing a dtree page&n; * before being fed to the filldir function&n; */
DECL|struct|jfs_dirent
r_struct
id|jfs_dirent
(brace
...
id|dtpos
suffix:semicolon
multiline_comment|/* legacy OS/2 style position */
r_struct
id|dtoffset
(brace
id|s16
...
l_int|2
suffix:semicolon
multiline_comment|/* If we can&squot;t fix broken index */
r_if
c_cond
(paren
id|filp-&gt;f_pos
...
(brace
multiline_comment|/* Stale position.  Directory has shrunk */
id|filp-&gt;f_pos
op_assign
id|DIREND
suffix:semicolon
...
(brace
multiline_comment|/* DBCS codepages could overrun dirent_buf */
id|index
op_assign
id|i
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * d-&gt;index should always be valid, but it&n;&t;&t;&t;&t; * isn&squot;t.  fsck.jfs doesn&squot;t create the&n;&t;&t;&t;&t; * directory index for the lost+found&n;&t;&t;&t;&t; * directory.  Rather than let it go,&n;&t;&t;&t;&t; * we can try to fix it.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t; * setting overflow and setting&n;&t;&t;&t;&t;&t;&t; * index to i will cause the&n;&t;&t;&t;&t;&t;&t; * same page to be processed&n;&t;&t;&t;&t;&t;&t; * again starting here&n;&t;&t;&t;&t;&t;&t; */
id|overflow
op_assign
l_int|1
suffix:semicolon
...
(brace
multiline_comment|/* Point to next leaf page */
r_if
c_cond
(paren
id|p-&gt;header.flag
...
multiline_comment|/*&n; *&t;ciGetLeafPrefixKey()&n; *&n; * function: compute prefix of suffix compression&n; *&t;     from two adjacent leaf entries&n; *&t;     across page boundary&n; *&n; * return: non-zero on error&n; *&t;&n; */

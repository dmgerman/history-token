...
(brace
multiline_comment|/*&n;&t;&t; * There is an open file actively growing.  We want to&n;&t;&t; * allocate new inodes from a different ag to avoid&n;&t;&t; * fragmentation problems.&n;&t;&t; */
id|agno
op_assign
id|dbNextAG
c_func
...
multiline_comment|/*&n;&t; *      process each iag page of the map.&n;&t; *&n;&t; * rebuild AG Free Inode List, AG Free Inode Extent List;&n;&t; */
r_for
c_loop
(paren
id|i

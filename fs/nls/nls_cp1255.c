multiline_comment|/*&n; * linux/fs/nls_cp1255.c&n; *&n; * Charset cp1255 translation tables.&n; * The Unicode to charset table has only exact mappings.&n; */

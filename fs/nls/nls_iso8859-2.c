multiline_comment|/*&n; * linux/fs/nls_iso8859-2.c&n; *&n; * Charset iso8859-2 translation tables.&n; * Generated automatically from the Unicode and charset&n; * tables from the Unicode Organization (www.unicode.org).&n; * The Unicode to charset table has only exact mappings.&n; */
...
suffix:semicolon
DECL|function|init_nls_iso8859_2
r_static
r_int
id|__init
...
DECL|function|exit_nls_iso8859_2
r_static
r_void
id|__exit
id|exit_nls_iso8859_2
c_func
(paren
r_void
)paren

multiline_comment|/*&n; * linux/fs/nls_koi8-u.c&n; *&n; * Charset koi8-u translation tables.&n; * The Unicode to charset table has only exact mappings.&n; */

...
multiline_comment|/*&n; * Remove lock from the lock lists&n; */
DECL|function|_unhash_lock
r_static
r_inline
r_void
id|_unhash_lock
...
multiline_comment|/*&n; * Wake up processes that are blocked waiting for this lock,&n; * notify the FS that the lock has been cleared and&n; * finally free the lock.&n; */
DECL|function|_delete_lock
r_static
r_inline
r_void
id|_delete_lock
...
multiline_comment|/*&n; * Delete a lock and then free it.&n; */

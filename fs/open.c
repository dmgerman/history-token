...
id|EOVERFLOW
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * f_files and f_ffree may be -1; it&squot;s okay to stuff&n;&t;&t;&t; * that into 32 bits&n;&t;&t;&t; */
r_if
c_cond
(paren
id|st.f_files
...
id|out
suffix:semicolon
multiline_comment|/* Do we need to expand the fd array or fd set?  */
id|error
op_assign
id|expand_files
c_func
...
(brace
multiline_comment|/*&n;&t; &t; * If we needed to expand the fs array we&n;&t;&t; * might have blocked - try again.&n;&t;&t; */
id|error
op_assign
op_minus
id|EMFILE
...
id|retval
suffix:semicolon
multiline_comment|/* Report and clear outstanding errors */
id|retval
op_assign
id|filp-&gt;f_error
suffix:semicolon
...
DECL|variable|generic_file_open
id|EXPORT_SYMBOL
c_func
(paren
id|generic_file_open
...
suffix:semicolon
multiline_comment|/*&n; * This is used by subsystems that don&squot;t want seekable&n; * file descriptors&n; */
DECL|function|nonseekable_open
r_int
id|nonseekable_open
c_func
(paren
...
DECL|variable|nonseekable_open
id|EXPORT_SYMBOL
c_func
(paren
id|nonseekable_open

...
id|clean
suffix:semicolon
multiline_comment|/*&n;&t; * If we are going to write out the super block,&n;&t; * then attach current time stamp.&n;&t; * But if the filesystem was marked clean, keep it clean.&n;&t; */
id|old_time
op_assign
id|fs32_to_cpu
c_func

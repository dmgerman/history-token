multiline_comment|/* $Id: inode.c,v 1.15 2001/11/12 09:43:39 davem Exp $&n; * openpromfs.c: /proc/openprom handling routines&n; *&n; * Copyright (C) 1996-1999 Jakub Jelinek  (jakub@redhat.com)&n; * Copyright (C) 1998      Eddie C. Dost  (ecd@skynet.be)&n; */
...
DECL|function|openprom_remount
r_static
r_int
id|openprom_remount
c_func
...
suffix:semicolon
DECL|function|openprom_fill_super
r_static
r_int
id|openprom_fill_super
c_func
(paren
r_struct
id|super_block
...
c_func
(paren
l_string|&quot;openprom_fill_super: get root inode failed&bslash;n&quot;
)paren
suffix:semicolon
id|iput
c_func

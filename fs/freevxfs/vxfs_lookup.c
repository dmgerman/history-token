...
macro_line|#ident &quot;$Id: vxfs_lookup.c,v 1.11 2001/04/24 19:28:36 hch Exp hch $&quot;
...
id|fail
suffix:semicolon
multiline_comment|/** if (!PageChecked(page)) **/
multiline_comment|/** vxfs_check_page(page); **/
r_if
c_cond
(paren
id|PageError
...
multiline_comment|/*&n; * NOTE! unlike strncmp, vxfs_match returns 1 for success, 0 for failure.&n; *&n; * len &lt;= VXFS_NAME_LEN and de != NULL are guaranteed by caller.&n; */
r_static
id|__inline__
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * The magic number 48 stands for the reclen offset&n;&t;&t;&t; * in the direct plus the size of reclen.&n;&t;&t;&t; */
id|lim
op_assign
(paren
r_char

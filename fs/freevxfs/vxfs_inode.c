...
multiline_comment|/**&n; * vxfs_fake_inode - get fake inode structure&n; * @sbp:&t;&t;filesystem superblock&n; * @vip:&t;&t;fspriv inode&n; *&n; * Description:&n; *  vxfs_fake_inode gets a fake inode (not in the inode hash) for a&n; *  superblock, vxfs_inode pair.&n; *  Returns the filled VFS inode.&n; */
r_struct
id|inode
op_star

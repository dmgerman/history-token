...
suffix:semicolon
macro_line|#else
multiline_comment|/* Getting filesystem while it&squot;s starting up?  We&squot;re&n;                   already supposed to have a reference. */
id|BUG
c_func
(paren
)paren
...
multiline_comment|/* define fs_subsys */
r_static
id|decl_subsys
c_func
(paren
...
suffix:semicolon
multiline_comment|/**&n; *&t;fs_subsys_init - initialize sysfs and fs subsystem.&n; *&n; *&t;In order to register filesystems in sysfs, it has to be &n; *&t;initialized. Also, we need the base fs filesystem, so the &n; *&t;registered filesystems have a home.&n; *&t;&n; *&t;During sysfs_init(), the registration of sysfs into itself&n; *&t;will fail, since it&squot;s not mounted yet. To make sure that &n; *&t;sysfs does show up, we re-register sysfs&squot;s embedded subsystem,&n; *&t;which will get added, since sysfs is now mounted.&n; */
DECL|function|fs_subsys_init
r_void
id|__init
id|fs_subsys_init
c_func
...
id|p
suffix:semicolon
multiline_comment|/* make sure sysfs is up and running */
id|sysfs_init
c_func
(paren
)paren
suffix:semicolon
multiline_comment|/* register fs_subsys */
id|subsystem_register
c_func
(paren
op_amp
...
multiline_comment|/* make sure it&squot;s registered */
id|register_fs_subsys
c_func
(paren
op_star

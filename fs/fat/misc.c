...
mdefine_line|#define RSS_START /* search for start cluster */ &bslash;&n;    done = !IS_FREE(data[entry].name) &bslash;&n;      &amp;&amp; ( &bslash;&n;           ( &bslash;&n;             (sbi-&gt;fat_bits != 32) ? 0 : (CF_LE_W(data[entry].starthi) &lt;&lt; 16) &bslash;&n;           ) &bslash;&n;           | CF_LE_W(data[entry].start) &bslash;&n;         ) == *number;
DECL|macro|RSS_FREE

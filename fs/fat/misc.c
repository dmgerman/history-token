...
multiline_comment|/*&n; * fat_chain_add() adds a new cluster to the chain of clusters represented&n; * by inode.&n; */
DECL|function|fat_chain_add
r_int
id|fat_chain_add
c_func
(paren
...
id|last
suffix:semicolon
multiline_comment|/*&n;&t; * We must locate the last cluster of the file to add this new&n;&t; * one (new_dclus) to the end of the link list (the FAT).&n;&t; */
id|last
op_assign
id|new_fclus
op_assign
...
id|new_dclus
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Since generic_osync_inode() synchronize later if&n;&t;&t; * this is not directory, we don&squot;t here.&n;&t;&t; */
r_if
c_cond
(paren
id|S_ISDIR
...
id|secs
suffix:semicolon
multiline_comment|/*&n;&t; * first subtract and mask after that... Otherwise, if&n;&t; * date == 0, bad things happen&n;&t; */
id|month
op_assign
(paren
(paren

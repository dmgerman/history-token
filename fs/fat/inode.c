...
multiline_comment|/*&n;&t;&t; * FIXME: utf8 is using iocharset for upper/lower conversion&n;&t;&t; * UTF8 doesn&squot;t provide FAT semantics&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_string|&quot; for FAT filesystem,&quot;
l_string|&quot; filesystem will be case sensitive!&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|sbi-&gt;nls_io
...
(paren
id|KERN_INFO
l_string|&quot;FAT: %s option didn&squot;t specified&bslash;n&quot;
l_string|&quot;     File name can not access proper%s&bslash;n&quot;
comma
id|opts-&gt;isvfat
ques
c_cond
l_string|&quot;codepage or iocharset&quot;
suffix:colon
l_string|&quot;codepage&quot;
comma
id|not_ro

...
c_func
(paren
l_string|&quot;FAT: Directory %ld: bad FAT&bslash;n&quot;
comma
id|inode-&gt;i_ino
)paren
suffix:semicolon
...
DECL|function|fat_fh_to_dentry
r_struct
id|dentry
op_star
id|fat_fh_to_dentry
...
suffix:semicolon
multiline_comment|/* now to find a dentry.&n;&t; * If possible, get a well-connected one&n;&t; *&n;&t; * Given the way that we found the inode, it *MUST* be&n;&t; * well-connected, but it is easiest to just copy the&n;&t; * code.&n;&t; */
id|spin_lock
c_func
(paren
op_amp
...
DECL|function|fat_dentry_to_fh
r_int
id|fat_dentry_to_fh
c_func
(paren

...
c_func
(paren
l_string|&quot;kAFS: no root cell specified&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * purge in-memory cell database on module unload&n; * - the timeout daemon is stopped before calling this&n; */
...
suffix:semicolon
multiline_comment|/* TODO: race if move to use krxtimod instead of kafstimod */
id|spin_lock
c_func
(paren
op_amp

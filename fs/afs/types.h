...
suffix:semicolon
DECL|typedef|afs_async_op_t
r_typedef
r_struct
id|afs_async_op
id|afs_async_op_t
suffix:semicolon
DECL|typedef|afs_callback_t
r_typedef
r_struct
id|afs_callback
id|afs_callback_t
suffix:semicolon
DECL|typedef|afs_cell_t
r_typedef
r_struct
id|afs_cell
id|afs_cell_t
suffix:semicolon
DECL|typedef|afs_fid_t
r_typedef
r_struct
id|afs_fid
id|afs_fid_t
suffix:semicolon
DECL|typedef|afs_file_status_t
r_typedef
r_struct
id|afs_file_status
id|afs_file_status_t
suffix:semicolon
DECL|typedef|afs_server_t
r_typedef
r_struct
id|afs_server
id|afs_server_t
suffix:semicolon
DECL|typedef|afs_timer_t
r_typedef
r_struct
id|afs_timer
id|afs_timer_t
suffix:semicolon
DECL|typedef|afs_vlocation_t
r_typedef
r_struct
id|afs_vlocation
id|afs_vlocation_t
suffix:semicolon
DECL|typedef|afs_vnode_t
r_typedef
r_struct
id|afs_vnode
id|afs_vnode_t
suffix:semicolon
DECL|typedef|afs_volsync_t
r_typedef
r_struct
id|afs_volsync
id|afs_volsync_t
suffix:semicolon
DECL|typedef|afs_volume_t
r_typedef
r_struct
id|afs_volume
id|afs_volume_t
suffix:semicolon
DECL|typedef|afs_volume_info_t
r_typedef
r_struct
id|afs_volume_info
id|afs_volume_info_t
suffix:semicolon
DECL|typedef|afsc_cache_t
r_typedef
r_struct
id|afsc_cache
id|afsc_cache_t
suffix:semicolon
DECL|typedef|afsc_cache_cell_t
r_typedef
r_struct
id|afsc_cache_cell
id|afsc_cache_cell_t
suffix:semicolon
DECL|typedef|afsc_cache_vldb_t
r_typedef
r_struct
id|afsc_cache_vldb
id|afsc_cache_vldb_t
suffix:semicolon
DECL|typedef|afsc_cell_record_t
r_typedef
r_struct
id|afsc_cell_record
id|afsc_cell_record_t
suffix:semicolon
DECL|typedef|afsc_inode_t
r_typedef
r_struct
id|afsc_inode
id|afsc_inode_t
suffix:semicolon
DECL|typedef|afsc_io_t
r_typedef
r_struct
id|afsc_io
id|afsc_io_t
suffix:semicolon
DECL|typedef|afsc_io_subop_t
r_typedef
r_struct
id|afsc_io_subop
id|afsc_io_subop_t
suffix:semicolon
DECL|typedef|afsc_io_queue_t
r_typedef
r_struct
id|afsc_io_queue
id|afsc_io_queue_t
suffix:semicolon
DECL|typedef|afsc_super_block_t
r_typedef
r_struct
id|afsc_super_block
id|afsc_super_block_t
suffix:semicolon
DECL|typedef|afsc_vldb_record_t
r_typedef
r_struct
id|afsc_vldb_record
id|afsc_vldb_record_t
suffix:semicolon
DECL|typedef|afsc_vnode_catalogue_t
r_typedef
r_struct
id|afsc_vnode_catalogue
id|afsc_vnode_catalogue_t
suffix:semicolon
DECL|typedef|afsc_vnode_meta_t
r_typedef
r_struct
id|afsc_vnode_meta
id|afsc_vnode_meta_t
suffix:semicolon
DECL|typedef|afsvl_dbentry_t
r_typedef
r_struct
id|afsvl_dbentry
id|afsvl_dbentry_t

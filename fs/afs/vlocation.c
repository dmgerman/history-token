...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* search local cache if wasn&squot;t in memory */
id|ret
op_assign
id|afsc_lookup_vlocation
c_func
(paren
id|vlocation
)paren
...
r_break
suffix:semicolon
multiline_comment|/* not in local cache */
)brace
macro_line|#endif
...
l_int|1
suffix:semicolon
multiline_comment|/* found_in_cache: */

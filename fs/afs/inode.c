...
DECL|member|new_vnode
id|afs_vnode_t
op_star
id|new_vnode
suffix:semicolon
multiline_comment|/* new vnode record */
macro_line|#endif
)brace
suffix:semicolon
multiline_comment|/*****************************************************************************/
...
c_func
(paren
l_string|&quot;FS: ft=%d lk=%d sz=%u ver=%Lu mod=%hu&quot;
comma
...
macro_line|#endif
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * iget4() comparator&n; */
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,5,0)
DECL|function|afs_iget4_test
r_static
r_int
id|afs_iget4_test
c_func
...
multiline_comment|/* end afs_iget4_test() */
macro_line|#endif
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * read an inode (2.4 only)&n; */
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,5,0)
DECL|function|afs_read_inode2
r_void
id|afs_read_inode2
c_func
(paren
...
suffix:semicolon
multiline_comment|/* attach a pre-allocated vnode record */
id|inode-&gt;u.generic_ip
op_assign
id|vnode
op_assign
...
id|data-&gt;fid
suffix:semicolon
multiline_comment|/* ask the server for a status check */
id|ret
op_assign
id|afs_vnode_fetch_status
c_func
...
multiline_comment|/* end afs_read_inode2() */
macro_line|#endif
multiline_comment|/*****************************************************************************/
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* find a cache entry for it */
id|ret
op_assign
id|afs_cache_lookup_vnode
c_func
(paren
id|as-&gt;volume
comma
...
suffix:semicolon
macro_line|#else
multiline_comment|/* pre-allocate a vnode record so that afs_read_inode2() doesn&squot;t have to return an inode&n;&t; * without one attached&n;&t; */
id|data.new_vnode
op_assign
id|kmalloc
c_func
...
macro_line|#endif
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * revalidate the inode&n; */
macro_line|#if LINUX_VERSION_CODE &lt;= KERNEL_VERSION(2,5,0)
DECL|function|afs_inode_revalidate
r_int
...
multiline_comment|/* end afs_inode_revalidate() */
macro_line|#endif
multiline_comment|/*****************************************************************************/

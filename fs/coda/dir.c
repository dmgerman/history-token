...
id|cinode
op_assign
id|cii-&gt;c_container-&gt;f_dentry-&gt;d_inode
suffix:semicolon
r_if
c_cond
(paren
...
multiline_comment|/* support routines */
multiline_comment|/* instantiate a fake file to pass to coda_venus_readdir */

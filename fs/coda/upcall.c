...
DECL|macro|upc_alloc
mdefine_line|#define upc_alloc() kmalloc(sizeof(struct upc_req), GFP_KERNEL)
DECL|macro|upc_free
...
c_func
(paren
l_string|&quot;CODA: store without valid file creds.&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:semicolon
id|inp-&gt;coda_release.VFid
op_assign
op_star
id|fid
suffix:semicolon
id|inp-&gt;coda_release.flags
op_assign
id|flags
suffix:semicolon
id|error
...
c_func
(paren
l_string|&quot;Failed to allocate upc_req structure&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

...
c_func
(paren
l_string|&quot;%s: dio_refill_pages returns %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ret
...
multiline_comment|/*&n; * Walk the user pages, and the file, mapping blocks to disk and emitting BIOs.&n; */
...
c_func
(paren
l_string|&quot;%s: get_block returns %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ret

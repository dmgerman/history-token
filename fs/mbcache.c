...
suffix:semicolon
DECL|variable|mb_cache_entry_takeout
id|EXPORT_SYMBOL
c_func
(paren
...
suffix:semicolon
DECL|variable|mb_cache_entry_dup
id|EXPORT_SYMBOL
c_func
(paren
...
r_inline
r_void
DECL|function|__mb_cache_entry_takeout_lru
id|__mb_cache_entry_takeout_lru
c_func
(paren
r_struct
id|mb_cache_entry
...
r_inline
r_void
DECL|function|__mb_cache_entry_into_lru
id|__mb_cache_entry_into_lru
c_func
(paren
r_struct
id|mb_cache_entry
...
r_inline
r_int
DECL|function|__mb_cache_entry_in_lru
id|__mb_cache_entry_in_lru
c_func
(paren
r_struct
id|mb_cache_entry
...
multiline_comment|/*&n; * Insert the cache entry into all hashes.&n; */
r_static
r_inline
r_void
DECL|function|__mb_cache_entry_link
id|__mb_cache_entry_link
c_func
(paren
r_struct
id|mb_cache_entry
...
multiline_comment|/*&n; * Remove the cache entry from all hashes.&n; */
r_static
r_inline
r_void
DECL|function|__mb_cache_entry_unlink
id|__mb_cache_entry_unlink
c_func
(paren
r_struct
id|mb_cache_entry
...
r_inline
r_int
DECL|function|__mb_cache_entry_is_linked
id|__mb_cache_entry_is_linked
c_func
(paren
r_struct
id|mb_cache_entry
...
id|mb_cache_entry
op_star
DECL|function|__mb_cache_entry_read
id|__mb_cache_entry_read
c_func
(paren
r_struct
id|mb_cache_entry
...
(paren
id|KERN_ERR
l_string|&quot;%s: already have a shrinker!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/*&n; * mb_cache_entry_takeout()&n; *&n; * Take a cache entry out of the cache, making it invalid. The entry can later&n; * be re-inserted using mb_cache_entry_insert(), or released using&n; * mb_cache_entry_release().&n; */
r_void
DECL|function|mb_cache_entry_takeout
id|mb_cache_entry_takeout
c_func
(paren
r_struct
...
multiline_comment|/*&n; * mb_cache_entry_dup()&n; *&n; * Duplicate a handle to a cache entry (does not duplicate the cache entry&n; * itself). After the call, both the old and the new handle must be released.&n; */
r_struct
id|mb_cache_entry
op_star
DECL|function|mb_cache_entry_dup
id|mb_cache_entry_dup
c_func
(paren
r_struct

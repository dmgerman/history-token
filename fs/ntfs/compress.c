...
l_int|0x8000
comma
multiline_comment|/*&n;&t; * The maximum compression block size is by definition 16 * the cluster&n;&t; * size, with the maximum supported cluster size being 4kiB. Thus the&n;&t; * maximum compression buffer size is 64kiB, so we use this when&n;&t; * initializing the compression buffer.&n;&t; */
...
multiline_comment|/**&n; * zero_partial_compressed_page - zero out of bounds compressed page region&n; */
DECL|function|zero_partial_compressed_page
r_static
r_void
id|zero_partial_compressed_page
c_func
(paren
id|ntfs_inode
op_star
...
c_func
(paren
l_string|&quot;Zeroing page region outside initialized size.&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(brace
multiline_comment|/*&n;&t;&t; * FIXME: Using clear_page() will become wrong when we get&n;&t;&t; * PAGE_CACHE_SIZE != PAGE_SIZE but for now there is no problem.&n;&t;&t; */
id|clear_page
c_func
(paren
id|kp
...
multiline_comment|/**&n; * handle_bounds_compressed_page - test for&amp;handle out of bounds compressed page&n; */
DECL|function|handle_bounds_compressed_page
r_static
r_inline
r_void
id|handle_bounds_compressed_page
c_func
(paren
id|ntfs_inode
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * Have we reached the end of the compression block or the end of the&n;&t; * decompressed data?  The latter can happen for example if the current&n;&t; * position in the compression block is one byte before its end so the&n;&t; * first two checks do not detect it.&n;&t; */
r_if
c_cond
(paren
id|cb
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * If we are outside the initialized size, zero&n;&t;&t;&t;&t; * the out of bounds page range.&n;&t;&t;&t;&t; */
id|handle_bounds_compressed_page
c_func
(paren
id|ni

...
multiline_comment|/**&n; * ntfs_extend_attr - extend allocated size of an attribute&n; * @ino:&t;ntfs inode containing the attribute to extend&n; * @attr:&t;attribute which to extend&n; * @len:&t;desired new length for @attr (_not_ the amount to extend by)&n; *&n; * Extends an attribute. Allocate clusters on the volume which @ino belongs to.&n; * Extends the run list accordingly, preferably by extending the last run of&n; * the existing run list, first.&n; *&n; * Only modifies attr-&gt;allocated, i.e. doesn&squot;t touch attr-&gt;size, nor&n; * attr-&gt;initialized.&n; */
...
id|EOPNOTSUPP
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME: Don&squot;t make non-resident if the attribute type is not right.&n;&t; * For example cannot make index attribute non-resident! (AIA)&n;&t; */
r_if
c_cond
(paren
id|attr-&gt;resident
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Calculate the extra space we need, and round up to multiple of&n;&t; * cluster size to get number of new clusters needed.&n;&t; */
id|clen
op_assign
(paren
id|len
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * -&gt;allocated is updated by ntfs_extend_attr(), while -&gt;initialized&n;&t; * and -&gt;size are updated by ntfs_readwrite_attr(). (AIA)&n;&t; */
id|attr-&gt;allocated
op_assign
id|attr-&gt;initialized
op_assign
...
multiline_comment|/*&n; * Resize the attribute to a newsize. attr-&gt;allocated and attr-&gt;size are&n; * updated, but attr-&gt;initialized is not changed unless it becomes bigger than&n; * attr-&gt;size, in which case it is set to attr-&gt;size.&n; */
...
id|rl_size
suffix:semicolon
multiline_comment|/*&n;&t;&t; * FIXME: We might be going awfully wrong for newsize = 0,&n;&t;&t; * possibly even leaking memory really badly. But considering&n;&t;&t; * in that case there is more breakage due to -EOPNOTSUPP stuff&n;&t;&t; * further down the code path, who cares for the moment... (AIA)&n;&t;&t; */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* FIXME: Incomplete operation. */
multiline_comment|/*&n;&t;&t; * Free space for extra runs in memory if enough memory left&n;&t;&t; * to do so. FIXME: Only do it if it would free memory. (AIA)&n;&t;&t; */
id|rl_size
op_assign
(paren
(paren
...
multiline_comment|/* Tried to insert an already inserted runlist. */
r_return
l_int|0
suffix:semicolon
)brace

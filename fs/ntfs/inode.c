...
(brace
id|continue_after_loading_mft_data
suffix:colon
id|last_mft
op_assign
id|mftno
...
r_goto
id|force_load_mft_data
suffix:semicolon
id|failed_reading_mft_data
suffix:colon
id|ntfs_debug
c_func
(paren
...
id|alist
suffix:semicolon
multiline_comment|/*&n;&t; * We only get here if $DATA wasn&squot;t found in $MFT which only happens&n;&t; * on volume mount when $MFT has an attribute list and there are&n;&t; * attributes before $DATA which are inside extent mft records. So&n;&t; * we just skip forward to the $DATA attribute and read that. Then we&n;&t; * restart which is safe as an attribute will not be inserted twice.&n;&t; *&n;&t; * This still will not fix the case where the attribute list is non-&n;&t; * resident, larger than 1024 bytes, and the $DATA attribute list entry&n;&t; * is not in the first 1024 bytes. FIXME: This should be implemented&n;&t; * somehow! Perhaps by passing special error code up to&n;&t; * ntfs_load_attributes() so it keeps going trying to get to $DATA&n;&t; * regardless. Then it would have to restart just like we do here.&n;&t; */
id|mft2
op_assign
id|ntfs_malloc
c_func
...
r_break
suffix:semicolon
multiline_comment|/* Uh-oh! It really isn&squot;t there! */
id|ntfs_error
c_func
(paren
l_string|&quot;Either the $MFT is corrupt or, equally &quot;
l_string|&quot;likely, the $MFT is too complex for &quot;
l_string|&quot;the current driver to handle. Please &quot;
l_string|&quot;email the ntfs maintainer that you &quot;
l_string|&quot;saw this message. Thank you.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|failed_reading_mft_data
...
multiline_comment|/* Process attribute description. */
id|mftno2
op_assign
id|NTFS_GETU32
c_func
...
comma
l_string|&quot;parse_attributes: &quot;
l_string|&quot;ntfs_read_mft_record(mftno2 = 0x%x) &quot;
l_string|&quot;failed&bslash;n&quot;
comma
id|mftno2
)paren
...
comma
l_string|&quot;parse_attributes: &quot;
l_string|&quot;ntfs_insert_mft_attribute(mftno2 0x%x, &quot;
l_string|&quot;attribute2 type 0x%x) failed&bslash;n&quot;
comma
id|mftno2
comma
id|NTFS_GETU32

...
multiline_comment|/**&n; * ntfs_put_inode - handler for when the inode reference count is decremented&n; * @vi:&t;&t;vfs inode&n; *&n; * The VFS calls ntfs_put_inode() every time the inode reference count (i_count)&n; * is about to be decremented (but before the decrement itself.&n; *&n; * If the inode @vi is a directory with a single reference, we need to put the&n; * attribute inode for the directory index bitmap, if it is present, otherwise&n; * the directory inode would remain pinned for ever (or rather until umount()&n; * time.&n; */
...
id|vi-&gt;i_sb
comma
l_string|&quot;Changes in i_size are not supported &quot;
l_string|&quot;yet. Sorry.&quot;
)paren
suffix:semicolon
singleline_comment|// TODO: Implement...
...
suffix:semicolon
multiline_comment|/*&n;&t; * Dirty attribute inodes are written via their real inodes so just&n;&t; * clean them here.&n;&t; */
r_if
c_cond
(paren
id|NInoAttr
...
id|vi-&gt;i_sb
comma
l_string|&quot;Cleaning dirty inode 0x%lx without &quot;
l_string|&quot;writing to disk as this is not yet &quot;
l_string|&quot;implemented.&quot;
comma
id|vi-&gt;i_ino
)paren
suffix:semicolon
...
id|vi-&gt;i_sb
comma
l_string|&quot;Cleaning dirty extent &quot;
l_string|&quot;inode 0x%lx without writing &quot;
l_string|&quot;to disk as this is not yet &quot;
l_string|&quot;implemented.&quot;
comma
id|tni-&gt;mft_no
)paren

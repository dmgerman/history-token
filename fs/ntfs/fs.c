...
DECL|variable|ntfs_inode_cachep
r_static
id|kmem_cache_t
op_star
id|ntfs_inode_cachep
suffix:semicolon
DECL|function|__ntfs_alloc_inode
r_static
r_struct
id|inode
op_star
id|__ntfs_alloc_inode
c_func
(paren
r_struct
id|super_block
...
(paren
id|KERN_INFO
l_string|&quot;ntfs_inode_cache: not all structures were freed&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;Unable to set blocksize.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|ntfs_read_super_vol

multiline_comment|/*&n; * fs.c - NTFS driver for Linux 2.4.x&n; *&n; * Development has as of recently (since June &squot;01) been sponsored&n; * by Legato Systems, Inc. (http://www.legato.com)&n; *&n; * Copyright (C) 1995-1997, 1999 Martin von L&#xfffd;wis&n; * Copyright (C) 1996 Richard Russon&n; * Copyright (C) 1996-1997 R&#xfffd;gis Duchesne&n; * Copyright (C) 2000-2001, Anton Altaparmakov (AIA)&n; */

...
suffix:semicolon
multiline_comment|/*&n;&t; * If the index block is the same size as the page cache page, set all&n;&t; * the buffers in the page, as well as the page itself, dirty.&n;&t; */
r_if
c_cond
(paren
...
multiline_comment|/* Set only the buffers in which the index block is located dirty. */
id|rec_start
op_assign
(paren
r_int
...
suffix:semicolon
multiline_comment|/* Finally, set the page itself dirty, too. */

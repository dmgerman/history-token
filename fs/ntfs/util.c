...
multiline_comment|/*&n; * Converts a single wide character to a sequence of utf8 bytes.&n; * The character is represented in host byte order.&n; * Returns the number of bytes, or 0 on error.&n; */
...
multiline_comment|/*&n; * Decodes a sequence of utf8 bytes into a single wide character.&n; * The character is returned in host byte order.&n; * Returns the number of bytes consumed, or 0 on error.&n; */
...
multiline_comment|/*&n; * Converts wide string to UTF-8. Expects two in- and two out-parameters.&n; * Returns 0 on success, or error code. &n; * The caller has to free the result string.&n; */
...
multiline_comment|/*&n; * Converts an UTF-8 sequence to a wide string. Same conventions as the&n; * previous function.&n; */
...
multiline_comment|/* Encodings dispatchers. */
...
mdefine_line|#define NTFS_TIME_OFFSET ((ntfs_time64_t)(369*365 + 89) * 24 * 3600 * 10000000)
...
DECL|macro|NTFS_TIME_OFFSET
macro_line|#undef NTFS_TIME_OFFSET

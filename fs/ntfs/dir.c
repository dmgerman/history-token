...
multiline_comment|/*&n;&t; * We are done with the index root and the mft record for that matter.&n;&t; * We need to release it, otherwise we deadlock on ntfs_attr_iget()&n;&t; * and/or ntfs_read_page().&n;&t; */
id|put_attr_search_ctx
c_func
(paren
id|ctx

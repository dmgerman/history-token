...
multiline_comment|/**&n; * Use the&n; *&n; */
r_enum
(brace
...
(paren
id|KERN_ERR
l_string|&quot;BeFS: Invalid uid %d, &quot;
l_string|&quot;using default&bslash;n&quot;
comma
id|option
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;BeFS: allocation failure for &quot;
l_string|&quot;iocharset string&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_ERR
l_string|&quot;BeFS: Unrecognized mount option &bslash;&quot;%s&bslash;&quot; &quot;

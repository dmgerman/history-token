multiline_comment|/*&n; *  linux/fs/hfsplus/btree.c&n; *&n; * Copyright (C) 2001&n; * Brad Boyer (flar@allandria.com)&n; * (C) 2003 Ardis Technologies &lt;roman@ardistech.com&gt;&n; *&n; * Handle opening/closing btree&n; */
...
c_func
(paren
l_string|&quot;HFS+-fs: unknown B*Tree requested&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|free_tree
...
c_func
(paren
l_string|&quot;unexpected idx %u (%u)&bslash;n&quot;
comma
id|idx
comma
id|node-&gt;this

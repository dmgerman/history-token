multiline_comment|/*&n; *  linux/fs/hfsplus/bfind.c&n; *&n; * Copyright (C) 2001&n; * Brad Boyer (flar@allandria.com)&n; * (C) 2003 Ardis Technologies &lt;roman@ardistech.com&gt;&n; *&n; * Search routines for btrees&n; */
...
c_func
(paren
l_string|&quot;HFS+-fs: inconsistency in B*Tree (%d,%d,%d,%u,%u)&bslash;n&quot;
comma
id|height
comma
id|bnode-&gt;height

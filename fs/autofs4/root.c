...
DECL|function|autofs4_check_pwd
r_static
r_void
id|autofs4_check_pwd
c_func
(paren
r_struct
id|file
...
id|fp-&gt;f_vfsmnt
suffix:semicolon
multiline_comment|/* dentry is a pwd of mountpoint so move to it */
r_if
c_cond
(paren
id|current-&gt;fs-&gt;pwd
...
suffix:semicolon
multiline_comment|/* dentry is root of a chrooted mountpoint so move to it */
r_if
c_cond
(paren
id|current-&gt;fs-&gt;root
...
suffix:semicolon
multiline_comment|/* alternate os ABI not supported  */
multiline_comment|/* set_fs_altroot(); */
)brace
)brace
...
multiline_comment|/* also for chdir or chroot so subsequent path walks work properly */
)brace
r_else
r_if
c_cond

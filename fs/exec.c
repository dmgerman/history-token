...
suffix:semicolon
multiline_comment|/*&n;&t; * See if we need to allocate a new signal structure&n;&t; */
id|newsig
op_assign
l_int|NULL
suffix:semicolon
...
suffix:semicolon
id|newsig-&gt;group_exit
op_assign
l_int|0
suffix:semicolon
id|newsig-&gt;group_exit_code
op_assign
l_int|0
suffix:semicolon

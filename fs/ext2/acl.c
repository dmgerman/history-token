multiline_comment|/*&n; * linux/fs/ext2/acl.c&n; *&n; * Copyright (C) 2001 by Andreas Gruenbacher, &lt;a.gruenbacher@computer.org&gt;&n; */
...
r_static
r_int
DECL|function|__ext2_permission
id|__ext2_permission
c_func
(paren
r_struct
id|inode
...
multiline_comment|/*&n; * Inode operation permission().&n; *&n; * inode-&gt;i_sem: up&n; * BKL held [before 2.5.x]&n; */
r_int
...
multiline_comment|/*&n; * Used internally if i_sem is already down.&n; */
r_int
DECL|function|ext2_permission_locked
...
multiline_comment|/*&n; * Initialize the ACLs of a new inode. Called from ext2_new_inode.&n; *&n; * dir-&gt;i_sem: down&n; * inode-&gt;i_sem: up (access to inode is still exclusive)&n; * BKL held [before 2.5.x] &n; */
r_int

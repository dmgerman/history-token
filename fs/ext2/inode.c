...
DECL|function|ext2_inode_is_fast_symlink
r_static
r_inline
r_int
id|ext2_inode_is_fast_symlink
c_func
(paren
r_struct
id|inode
...
suffix:semicolon
multiline_comment|/* We used to sync bh here if IS_SYNC(inode).&n;&t;&t; * But we now rely upon generic_osync_inode()&n;&t;&t; * and b_inode_buffers.  But not for directories.&n;&t;&t; */
r_if
c_cond
(paren
id|S_ISDIR
...
r_static
r_int
DECL|function|ext2_nobh_prepare_write
id|ext2_nobh_prepare_write
c_func
(paren
r_struct
id|file
...
DECL|function|ext2_nobh_writepage
r_static
r_int
id|ext2_nobh_writepage
c_func
(paren
r_struct
id|page
...
DECL|function|ext2_set_inode_flags
r_void

multiline_comment|/*&n; * linux/fs/ext2/xattr.c&n; *&n; * Copyright (C) 2001-2003 Andreas Gruenbacher &lt;agruen@suse.de&gt;&n; *&n; * Fix by Harrison Xing &lt;harrison@mountainviewdata.com&gt;.&n; * Extended attributes for symlinks and special files added per&n; *  suggestion of Luka Renko &lt;luka.renko@hermes.si&gt;.&n; * xattr consolidation Copyright (c) 2004 James Morris &lt;jmorris@redhat.com&gt;,&n; *  Red Hat Inc.&n; *&n; */
...
DECL|macro|ENTRY
mdefine_line|#define ENTRY(ptr) ((struct ext2_xattr_entry *)(ptr))
...
suffix:semicolon
DECL|variable|ext2_xattr_cache
r_static
r_struct
id|mb_cache
op_star
id|ext2_xattr_cache
suffix:semicolon
DECL|variable|ext2_xattr_handler_map
r_static
r_struct
id|xattr_handler
op_star
id|ext2_xattr_handler_map
(braket
id|EXT2_XATTR_INDEX_MAX
)braket
op_assign
(brace
(braket
id|EXT2_XATTR_INDEX_USER
)braket
op_assign
op_amp
...
comma
macro_line|#ifdef CONFIG_EXT2_FS_SECURITY
(braket
...
id|xattr_handler
op_star
DECL|function|ext2_xattr_handler
...
DECL|function|ext2_xattr_update_super_block
r_static
r_void
id|ext2_xattr_update_super_block
c_func
(paren
r_struct
id|super_block
...
multiline_comment|/*&n; * Second half of ext2_xattr_set(): Update the file system.&n; */
r_static
r_int
DECL|function|ext2_xattr_set2
id|ext2_xattr_set2
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/* We let our caller release old_bh, so we&n;&t;&t;&t; * need to duplicate the buffer before. */
id|get_bh
c_func
(paren
id|old_bh
...
multiline_comment|/*&n; * ext2_xattr_delete_inode()&n; *&n; * Free extended attribute resources associated with this inode. This&n; * is called immediately before an inode is freed.&n; */
r_void
...
id|inode-&gt;i_sb
comma
l_string|&quot;ext2_xattr_delete_inode&quot;
comma
...
multiline_comment|/*&n; * ext2_xattr_put_super()&n; *&n; * This is called when a file system is unmounted.&n; */
r_void
...
multiline_comment|/*&n; * ext2_xattr_cache_insert()&n; *&n; * Create a new entry in the extended attribute cache, and insert&n; * it unless such an entry is already in the cache.&n; *&n; * Returns 0, or a negative error number on failure.&n; */
r_static
r_int
DECL|function|ext2_xattr_cache_insert
id|ext2_xattr_cache_insert
c_func
(paren
r_struct
...
(paren
op_amp
id|ext2_xattr_cache-&gt;c_entry_count
)paren
)paren
suffix:semicolon
id|error
...
multiline_comment|/*&n; * ext2_xattr_cmp()&n; *&n; * Compare two extended attribute blocks for equality.&n; *&n; * Returns 0 if the blocks are equal, 1 if they differ, and&n; * a negative error number on errors.&n; */
r_static
r_int
DECL|function|ext2_xattr_cmp
id|ext2_xattr_cmp
c_func
(paren
r_struct
...
id|buffer_head
op_star
DECL|function|ext2_xattr_cache_find
id|ext2_xattr_cache_find
c_func
(paren
r_struct
...
id|inode-&gt;i_sb
comma
l_string|&quot;ext2_xattr_cache_find&quot;
comma
...
multiline_comment|/*&n; * ext2_xattr_cache_remove()&n; *&n; * Remove the cache entry of a block from the cache. Called when a&n; * block becomes invalid.&n; */
r_static
r_void
DECL|function|ext2_xattr_cache_remove
id|ext2_xattr_cache_remove
c_func
(paren
r_struct
...
multiline_comment|/*&n; * ext2_xattr_hash_entry()&n; *&n; * Compute the hash of an extended attribute.&n; */
DECL|function|ext2_xattr_hash_entry
r_static
r_inline
r_void
id|ext2_xattr_hash_entry
c_func
(paren
r_struct
id|ext2_xattr_header
...
multiline_comment|/*&n; * ext2_xattr_rehash()&n; *&n; * Re-compute the extended attribute hash value after an entry has changed.&n; */
DECL|function|ext2_xattr_rehash
r_static
r_void
id|ext2_xattr_rehash
c_func

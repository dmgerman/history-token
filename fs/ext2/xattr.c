...
suffix:semicolon
multiline_comment|/* In case sync failed due to ENOSPC the inode was actually&n;&t;&t; * written (only some dirty data were not) so we just proceed&n;&t;&t; * as if nothing happened and cleanup the unused block */
r_if
c_cond
(paren
id|error

...
multiline_comment|/*&n; * Set up the nfspage struct with the right credentials&n; */
r_static
r_void
DECL|function|nfs_request_init
id|nfs_request_init
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|nfs_request_compatible

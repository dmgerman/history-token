...
suffix:semicolon
multiline_comment|/* Has the clientid already been initialized? */
r_if
c_cond
(paren
id|clp-&gt;cl_state
...
(brace
multiline_comment|/* Yep, so just read the root attributes and the lease time. */
id|fattr-&gt;valid
op_assign
l_int|0
suffix:semicolon
...
id|no_setclientid
suffix:colon
multiline_comment|/*&n;&t; * Now that we have instantiated the clientid and determined&n;&t; * the lease time, we can initialize the renew daemon for this&n;&t; * server.&n;&t; * FIXME: we only need one renewd daemon per server.&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;* We have already opened the file &quot;O_EXCL&quot; in nfs4_proc_create!!&n;* This ugliness will go away with lookup-intent...&n;*/
id|cred
op_assign
id|rpcauth_lookupcred
c_func

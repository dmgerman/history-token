...
DECL|function|update_open_stateid
r_static
r_void
id|update_open_stateid
c_func
(paren
r_struct
id|nfs4_state
...
id|open_flags
suffix:semicolon
multiline_comment|/* NB! List reordering - see the reclaim code for why.  */
r_if
c_cond
(paren
(paren
...
id|status
suffix:semicolon
multiline_comment|/* Update sequence id. The caller must serialize! */
id|o_arg-&gt;seqid
op_assign
id|sp-&gt;so_seqid
suffix:semicolon
...
multiline_comment|/*&n; * OPEN_EXPIRED:&n; * &t;reclaim state on the server after a network partition.&n; * &t;Assumes caller holds the appropriate lock&n; */
DECL|function|_nfs4_open_expired
r_static
r_int
id|_nfs4_open_expired
c_func
(paren
r_struct
id|nfs4_state_owner
...
id|out_nodeleg
suffix:semicolon
multiline_comment|/* Check if files differ */
r_if
c_cond
(paren
(paren
...
id|out_stale
suffix:semicolon
multiline_comment|/* Has the file handle changed? */
r_if
c_cond
(paren
id|nfs_compare_fh
...
(brace
multiline_comment|/* Verify if the change attributes are the same */
r_if
c_cond
(paren
id|f_attr.change_attr
op_ne
id|NFS_I
c_func
(paren
...
id|out_stale
suffix:semicolon
multiline_comment|/* Lets just pretend that this is the same file */
id|nfs_copy_fh
c_func
(paren
id|NFS_FH
...
id|ESTALE
suffix:semicolon
multiline_comment|/* Invalidate the state owner so we don&squot;t ever use it again */
...
suffix:semicolon
multiline_comment|/* Should we be trying to close that stateid? */
r_goto
id|out_nodeleg
suffix:semicolon
)brace
DECL|function|nfs4_open_expired
r_static
r_int
id|nfs4_open_expired
c_func
(paren
r_struct
id|nfs4_state_owner
...
DECL|function|nfs4_lock_expired
r_static
r_int
id|nfs4_lock_expired
c_func
(paren
r_struct
id|nfs4_state
...
DECL|variable|nfs4_reboot_recovery_ops
r_struct
...
suffix:semicolon
DECL|variable|nfs4_network_partition_recovery_ops
r_struct
id|nfs4_state_recovery_ops

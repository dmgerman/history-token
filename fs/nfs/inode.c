...
l_int|0
suffix:semicolon
multiline_comment|/* Force an attribute cache update if inode-&gt;i_count == 0 */
r_if
c_cond
(paren
op_logical_neg
...
id|fattr-&gt;ctime
suffix:semicolon
id|nfsi-&gt;read_cache_mtime
op_assign
id|fattr-&gt;mtime
suffix:semicolon
id|nfsi-&gt;cache_mtime_jiffies
op_assign
id|fattr-&gt;timestamp
suffix:semicolon
id|nfsi-&gt;read_cache_isize
op_assign
id|fattr-&gt;size
suffix:semicolon
r_if
...
id|out
suffix:semicolon
multiline_comment|/* Optimize away unnecessary truncates */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Force an attribute cache update */
id|NFS_CACHEINV
c_func
(paren
id|inode
...
id|VFS
comma
l_string|&quot;NFS: not revalidating fake root&bslash;n&quot;
)paren
suffix:semicolon
id|status
op_assign
...
multiline_comment|/*&n; * nfs_fattr_obsolete - Test if attribute data is newer than cached data&n; * @inode: inode&n; * @fattr: attributes to test&n; *&n; * Avoid stuffing the attribute cache with obsolete information.&n; * We always accept updates if the attribute cache timed out, or if&n; * fattr-&gt;ctime is newer than our cached value.&n; * If fattr-&gt;ctime matches the cached value, we still accept the update&n; * if it increases the file size.&n; */
r_static
r_inline
DECL|function|nfs_fattr_obsolete
r_int
id|nfs_fattr_obsolete
c_func
(paren
r_struct
id|inode
...
id|cdif
op_assign
id|fattr-&gt;ctime.tv_sec
op_minus
id|nfsi-&gt;read_cache_ctime.tv_sec
suffix:semicolon
r_if
c_cond
(paren
...
id|cdif
op_assign
id|fattr-&gt;ctime.tv_nsec
op_minus
id|nfsi-&gt;read_cache_ctime.tv_nsec
suffix:semicolon
r_if
c_cond
(paren
...
r_int
DECL|function|__nfs_refresh_inode

...
(brace
multiline_comment|/*&n;&t;&t; * Some authentication types (gss/krb5, most notably)&n;&t;&t; * are such that root won&squot;t be able to present a&n;&t;&t; * credential for GETATTR (ie, getroot()).&n;&t;&t; *&n;&t;&t; * We still want the mount to succeed.&n;&t;&t; * &n;&t;&t; * So we fake the attr values and mark the inode as such.&n;&t;&t; * On the first succesful traversal, we fix everything.&n;&t;&t; * The auth type test isn&squot;t quite correct, but whatever.&n;&t;&t; */
id|dfprintk
c_func
(paren
id|VFS
comma
l_string|&quot;NFS: faking root inode&bslash;n&quot;
)paren
suffix:semicolon
id|fattr.fileid
op_assign
...
l_int|2
suffix:semicolon
multiline_comment|/* minimum for a dir */
id|fattr.type
op_assign
id|NFDIR
suffix:semicolon
...
l_int|NULL
suffix:semicolon
multiline_comment|/* superfluous ... but safe */
r_return
id|error
suffix:semicolon
)brace
...
l_int|0
suffix:semicolon
multiline_comment|/* First successful call after mount, fill real data. */
r_if
c_cond
(paren
id|NFS_FAKE_ROOT
...
id|VFS
comma
l_string|&quot;NFS: updating fake root&bslash;n&quot;
)paren
suffix:semicolon
id|nfsi-&gt;fileid
op_assign
...
multiline_comment|/* Now call standard NFS clear_inode() code */
id|nfs_clear_inode
c_func
(paren
id|inode

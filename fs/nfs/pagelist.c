...
multiline_comment|/**&n; * nfs_release_request - Release the count on an NFS read/write request&n; * @req: request to release&n; *&n; * Release all resources associated with a write request after it&n; * has been committed to stable storage&n; *&n; * Note: Should never be called with the spinlock held!&n; */
r_void

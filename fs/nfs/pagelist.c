...
multiline_comment|/**&n; * nfs_unlock_request - Unlock request and wake up sleepers.&n; * @req:&n; */
...
multiline_comment|/**&n; * nfs_clear_request - Free up all resources allocated to the request&n; * @req:&n; *&n; * Release page resources associated with a write request after it&n; * has completed.&n; */

...
multiline_comment|/**&n; * nfs_scan_lru_dirty_timeout - Scan LRU list for timed out dirty requests&n; * @server: NFS superblock data&n; * @dst: destination list&n; *&n; * Moves a maximum of &squot;wpages&squot; requests from the NFS dirty page LRU list.&n; * The elements are checked to ensure that they form a contiguous set&n; * of pages, and that they originated from the same file.&n; */
r_int
DECL|function|nfs_scan_lru_dirty_timeout
...
multiline_comment|/**&n; * nfs_scan_lru_dirty - Scan LRU list for dirty requests&n; * @server: NFS superblock data&n; * @dst: destination list&n; *&n; * Moves a maximum of &squot;wpages&squot; requests from the NFS dirty page LRU list.&n; * The elements are checked to ensure that they form a contiguous set&n; * of pages, and that they originated from the same file.&n; */
r_int
DECL|function|nfs_scan_lru_dirty
...
multiline_comment|/**&n; * nfs_scan_lru_commit_timeout - Scan LRU list for timed out commit requests&n; * @server: NFS superblock data&n; * @dst: destination list&n; *&n; * Finds the first request in the NFS commit LRU list and moves it&n; * to the list dst. If such an element is found, we move all other commit&n; * requests that apply to the same inode.&n; * The assumption is that doing everything in a single commit-to-disk is&n; * the cheaper alternative.&n; */
r_int
DECL|function|nfs_scan_lru_commit
...
id|req-&gt;wb_offset
suffix:semicolon
id|data-&gt;u.v3.args.count
op_assign
id|count
suffix:semicolon
id|data-&gt;u.v3.res.fattr
op_assign
op_amp
id|data-&gt;fattr
suffix:semicolon
id|data-&gt;u.v3.res.count
op_assign
id|count
suffix:semicolon
id|data-&gt;u.v3.res.verf
op_assign
op_amp
id|data-&gt;verf
suffix:semicolon

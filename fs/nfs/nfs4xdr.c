...
c_func
(paren
id|open-&gt;op_client_state-&gt;cl_clientid
)paren
suffix:semicolon
id|WRITE32
c_func
...
DECL|macro|READ_BUF
mdefine_line|#define READ_BUF(nbytes)  do { &bslash;&n;&t;p = xdr_inline_decode(xdr, nbytes); &bslash;&n;&t;if (!p) { &bslash;&n;&t;&t;printk(KERN_WARNING &quot;%s: reply buffer overflowed in line %d.&quot;, &bslash;&n;&t;&t;&t;&t;__FUNCTION__, __LINE__); &bslash;&n;&t;&t;&t;return -EIO; &bslash;&n;&t;} &bslash;&n;} while (0)

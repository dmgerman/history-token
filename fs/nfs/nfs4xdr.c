...
DECL|macro|NFS4_CLIENTID
mdefine_line|#define NFS4_CLIENTID(server)&t;((server)-&gt;nfs4_state-&gt;cl_clientid)
...
mdefine_line|#define ENCODE_HEAD&t;&t;&t;&t;&t;&t;&bslash;&n;&t;u32 *p;
DECL|macro|ENCODE_TAIL
mdefine_line|#define ENCODE_TAIL&t;&t;&t;&t;&t;&t;&bslash;&n;&t;return 0
DECL|macro|WRITE32
...
mdefine_line|#define RESERVE_SPACE(nbytes)&t;do { BUG_ON(cp-&gt;p + XDR_QUADLEN(nbytes) &gt; cp-&gt;end); p = cp-&gt;p; } while (0)
DECL|macro|ADJUST_ARGS
mdefine_line|#define ADJUST_ARGS()           cp-&gt;p = p
r_static
r_inline
...
id|ENCODE_HEAD
suffix:semicolon
multiline_comment|/* seqid, share_access, share_deny, clientid, ownerlen, owner, opentype */
id|RESERVE_SPACE
c_func
(paren
l_int|52
...
suffix:semicolon
multiline_comment|/* for us, share_deny== 0 always */
id|WRITE64
c_func
(paren
id|NFS4_CLIENTID
...
id|ENCODE_HEAD
suffix:semicolon
multiline_comment|/*&n;&t; * Note: In this &quot;stateless&quot; implementation, the OPEN_CONFIRM&n;&t; * seqid is always equal to 1.&n;&t; */
id|RESERVE_SPACE
c_func
(paren
l_int|24
...
suffix:semicolon
multiline_comment|/* all-zero stateid! */
id|WRITE32
c_func
(paren
l_int|0
...
suffix:semicolon
multiline_comment|/* set up reply iovec&n;&t; *    toplevel status + taglen + rescount + OP_PUTFH + status&n;&t; *       + OP_READ + status + eof + datalen = 9&n;&t; */
id|replen
op_assign
(paren
id|RPC_REPHDRSIZE
...
c_func
(paren
id|cp-&gt;server-&gt;nfs4_state-&gt;cl_clientid
)paren
suffix:semicolon
id|WRITEMEM
c_func
(paren
id|cp-&gt;server-&gt;nfs4_state-&gt;cl_confirm
comma
r_sizeof
(paren
id|nfs4_verifier
...
suffix:semicolon
multiline_comment|/* magic stateid -1 */
id|WRITE32
c_func
(paren
l_int|0xffffffff
...
DECL|macro|READ_BUF
mdefine_line|#define READ_BUF(nbytes)  do {&t;&t;&t;&bslash;&n;&t;if (nbytes &gt; (u32)((char *)cp-&gt;end - (char *)cp-&gt;p))  &bslash;&n;&t;&t;goto xdr_error;&t;&t;&t;&bslash;&n;&t;p = cp-&gt;p;&t;&t;&t;&t;&bslash;&n;&t;cp-&gt;p += XDR_QUADLEN(nbytes);&t;&t;&bslash;&n;} while (0)
...
c_func
(paren
id|commit-&gt;co_verifier-&gt;verifier
comma
l_int|8
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;read_attrs: rdev=%d&bslash;n&quot;
comma
id|nfp-&gt;rdev
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * The XDR encode routine has set things up so that&n;&t;&t; * the link text will be copied directly into the&n;&t;&t; * buffer.  We just have to do overflow-checking,&n;&t;&t; * and and null-terminate the text (the VFS expects&n;&t;&t; * null-termination).&n;&t;&t; */
id|strlen
op_assign
(paren
id|u32
...
c_func
(paren
id|write-&gt;wr_verf-&gt;committed
)paren
suffix:semicolon
id|COPYMEM
c_func
(paren
id|write-&gt;wr_verf-&gt;verifier
comma
l_int|8
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;nfs4: operation mismatch!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|xdr_error
...
c_func
(paren
l_string|&quot;nfs4: status mismatch!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|xdr_error
...
c_func
(paren
l_string|&quot;nfs4: intermediate status nonzero!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|xdr_error
...
id|rqstp-&gt;rq_rvec-&gt;iov_base
op_plus
id|rqstp-&gt;rq_rvec-&gt;iov_len
)paren
suffix:semicolon
r_if
c_cond

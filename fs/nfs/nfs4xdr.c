...
mdefine_line|#define encode_remove_maxsz&t;(op_encode_hdr_maxsz + &bslash;&n;&t;&t;&t;&t;1 + ((3 + NFS4_MAXNAMLEN) &gt;&gt; 2))
DECL|macro|encode_rename_maxsz
mdefine_line|#define encode_rename_maxsz&t;(op_encode_hdr_maxsz + &bslash;&n;&t;&t;&t;&t;2 * (1 + ((3 + NFS4_MAXNAMLEN) &gt;&gt; 2)))
...
mdefine_line|#define encode_link_maxsz&t;(op_encode_hdr_maxsz + &bslash;&n;&t;&t;&t;&t;1 + ((3 + NFS4_MAXNAMLEN) &gt;&gt; 2))
...
c_func
(paren
l_string|&quot;read_attrs: name-to-uid mapping failed!&bslash;n&quot;
)paren
suffix:semicolon
id|nfp-&gt;uid
op_assign
...
c_func
(paren
l_string|&quot;read_attrs: group-to-gid mapping failed!&bslash;n&quot;
)paren
suffix:semicolon
id|nfp-&gt;gid
op_assign
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: server attribute length %u does not match bitmap 0x%x/0x%x&bslash;n&quot;
comma
id|__FUNCTION__
comma
(paren
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: server returned bad attribute bitmap 0x%x/0x%x&bslash;n&quot;
comma
id|__FUNCTION__
comma
(paren

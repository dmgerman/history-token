...
r_continue
suffix:semicolon
multiline_comment|/* Add the state to the head of the inode&squot;s list */
id|list_move
c_func
(paren
op_amp
...
r_static
r_void
DECL|function|__nfs4_put_open_state
id|__nfs4_put_open_state
c_func
(paren
r_struct
id|nfs4_state
...
multiline_comment|/*&n;* Called with state-&gt;lock_sema held.&n;*/
r_void
...
(paren
id|KERN_WARNING
l_string|&quot;Error: state recovery failed on NFSv4 server %u.%u.%u.%u&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren

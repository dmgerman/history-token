...
macro_line|#endif
DECL|macro|nfs_invalid_flags
mdefine_line|#define nfs_invalid_flags&t;(O_APPEND | O_DIRECT)
multiline_comment|/*&n; * Check for special cases that NFS doesn&squot;t support, and&n; * pass the rest to the generic fcntl function.&n; */
r_static
r_int
DECL|function|nfs_file_fcntl
id|nfs_file_fcntl
c_func
(paren
r_int

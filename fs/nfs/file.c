...
c_func
(paren
l_string|&quot;NFS: nfs_flock(f=%s/%ld, t=%x, fl=%x)&bslash;n&quot;
comma
id|inode-&gt;i_sb-&gt;s_id
comma
id|inode-&gt;i_ino
...
id|ENOLCK
suffix:semicolon
multiline_comment|/* We&squot;re simulating flock() locks using posix locks on the server */
id|fl-&gt;fl_owner
op_assign
(paren
id|fl_owner_t

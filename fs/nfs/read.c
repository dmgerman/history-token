...
c_func
(paren
l_string|&quot;NFS: nfs_proc_read(%s, (%s/%Ld), %Ld, %d, %p)&bslash;n&quot;
comma
id|NFS_SERVER
c_func
(paren
...
c_func
(paren
l_string|&quot;NFS: %4d initiated read call (req %s/%Ld count %d nriov %d.&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|inode-&gt;i_sb-&gt;s_id
...
multiline_comment|/**&n; * nfs_scan_lru_read_timeout - Scan LRU list for timed out read requests&n; * @server: NFS superblock data&n; * @dst: destination list&n; *&n; * Moves a maximum of &squot;rpages&squot; timed out requests from the NFS read LRU list.&n; * The elements are checked to ensure that they form a contiguous set&n; * of pages, and that they originated from the same file.&n; */
r_int
DECL|function|nfs_scan_lru_read_timeout
...
multiline_comment|/**&n; * nfs_scan_lru_read - Scan LRU list for read requests&n; * @server: NFS superblock data&n; * @dst: destination list&n; *&n; * Moves a maximum of &squot;rpages&squot; requests from the NFS read LRU list.&n; * The elements are checked to ensure that they form a contiguous set&n; * of pages, and that they originated from the same file.&n; */
r_int
DECL|function|nfs_scan_lru_read
...
multiline_comment|/*&n; * nfs_scan_read - Scan an inode for read requests&n; * @inode: NFS inode to scan&n; * @dst: destination list&n; * @idx_start: lower bound of page-&gt;index to scan&n; * @npages: idx_start + npages sets the upper bound to scan&n; *&n; * Moves requests from the inode&squot;s read list.&n; * The requests are *not* checked to ensure that they form a contiguous set.&n; */
r_static
r_int

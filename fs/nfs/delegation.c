...
DECL|function|nfs_inode_reclaim_delegation
r_void
...
multiline_comment|/*&n; * Return all delegations following an NFS4ERR_CB_PATH_DOWN error.&n; */
DECL|function|nfs_handle_cb_pathdown
r_void
...
multiline_comment|/*&n; * Mark all delegations as needing to be reclaimed&n; */
DECL|function|nfs_delegation_mark_reclaim
r_void
...
multiline_comment|/*&n; * Reap all unclaimed delegations after reboot recovery is done&n; */
DECL|function|nfs_delegation_reap_unclaimed
r_void

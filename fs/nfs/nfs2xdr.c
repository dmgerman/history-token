...
mdefine_line|#define NFS_readlinkres_sz&t;(2)
...
id|u32
op_star
DECL|function|xdr_encode_current_server_time
id|xdr_encode_current_server_time
c_func
(paren
id|u32
op_star
...
(brace
multiline_comment|/*&n;&t; * Passing the invalid value useconds=1000000 is a&n;&t; * Sun convention for &quot;set to current server time&quot;.&n;&t; * It&squot;s needed to make permissions checks for the&n;&t; * &quot;touch&quot; program across v2 mounts to Solaris and&n;&t; * Irix boxes work correctly. See description of&n;&t; * sattr in section 6.1 of &quot;NFS Illustrated&quot; by&n;&t; * Brent Callaghan, Addison-Wesley, ISBN 0-201-32750-5&n;&t; */
op_star
id|p
op_increment
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;NFS: READLINK reply header overflowed:&quot;
l_string|&quot;length %d &gt; %Zu&bslash;n&quot;
comma
id|hdrlen
comma

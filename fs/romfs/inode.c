...
suffix:semicolon
multiline_comment|/* instead of private superblock data */
DECL|function|romfs_maxsize
r_static
r_inline
r_int
r_int
...
id|romfs_ops
suffix:semicolon
DECL|function|romfs_fill_super
r_static
r_int
id|romfs_fill_super
c_func
...
l_int|0
suffix:semicolon
id|i-&gt;i_mtime.tv_nsec
op_assign
id|i-&gt;i_atime.tv_nsec
op_assign
id|i-&gt;i_ctime.tv_nsec
op_assign
l_int|0
suffix:semicolon
id|i-&gt;i_uid
...
DECL|variable|romfs_inode_cachep
r_static
id|kmem_cache_t
op_star
id|romfs_inode_cachep
suffix:semicolon
DECL|function|romfs_alloc_inode
r_static
r_struct
id|inode
op_star
id|romfs_alloc_inode
c_func
(paren
r_struct
id|super_block
...
DECL|function|romfs_destroy_inode
r_static
r_void
id|romfs_destroy_inode
c_func
(paren
r_struct
id|inode
...
(paren
id|KERN_INFO
l_string|&quot;romfs_inode_cache: not all structures were freed&bslash;n&quot;
)paren
suffix:semicolon
)brace
DECL|function|romfs_remount
r_static
r_int
id|romfs_remount
c_func

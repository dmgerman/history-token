...
(brace
multiline_comment|/* grab the lru lock here so that &quot;b_count&quot; is stable */
id|spin_lock
c_func
(paren
op_amp
...
id|in_use
suffix:semicolon
multiline_comment|/* Mark it clean */
id|clear_bit
c_func
(paren
id|BH_Dirty
...
suffix:semicolon
multiline_comment|/* After which we can remove it from all queues */
id|remove_inode_queue
c_func
(paren
id|buf

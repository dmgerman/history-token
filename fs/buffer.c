...
suffix:semicolon
multiline_comment|/* we might be here because some of the buffers on this page are&n;&t; * not mapped.  This is due to various races between&n;&t; * file io on the block device and getblk.  It gets dealt with&n;&t; * elsewhere, don&squot;t buffer_error if we had some unmapped buffers&n;&t; */
r_if
c_cond
(paren
id|all_mapped
...
suffix:semicolon
multiline_comment|/*&n; * nobh_writepage() - based on block_full_write_page() except&n; * that it tries to operate without attaching bufferheads to&n; * the page.&n; */
DECL|function|nobh_writepage
r_int
id|nobh_writepage
c_func
(paren
...
macro_line|#if 0
multiline_comment|/* Not really sure about this  - do we need this ? */
r_if
c_cond
(paren

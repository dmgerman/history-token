...
DECL|macro|get_bh
mdefine_line|#define get_bh(bh)&t;atomic_inc(&amp;(bh)-&gt;b_count)
DECL|macro|put_bh
mdefine_line|#define put_bh(bh)&t;atomic_dec(&amp;(bh)-&gt;b_count)
...
multiline_comment|/* End-of-write handler.. Just mark it up-to-date and unlock the buffer. */
DECL|function|end_buffer_write
r_static
r_void
id|end_buffer_write
c_func

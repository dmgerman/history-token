...
multiline_comment|/*&n; * Called when truncating a buffer on a page completely.&n; *&n; * We can avoid IO by marking it clean.&n; * FIXME!! FIXME!! FIXME!! We need to unmap it too,&n; * so that the filesystem won&squot;t write to it. There&squot;s&n; * some bug somewhere..&n; */
...
DECL|function|truncate_buffers
r_static
r_void
id|truncate_buffers
c_func

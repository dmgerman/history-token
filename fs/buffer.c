...
DECL|function|fsync_inode_data_buffers
r_int
...
c_func
(paren
id|tmp.i_dirty_data_buffers.prev
)paren
suffix:semicolon
id|remove_inode_queue
c_func
...
DECL|function|osync_inode_data_buffers
r_int
id|osync_inode_data_buffers
c_func
(paren
...
id|list
op_assign
id|inode-&gt;i_dirty_data_buffers.prev
suffix:semicolon
id|bh
op_assign
id|BH_ENTRY
...
suffix:semicolon
multiline_comment|/* This is &quot;wrong&quot; - talk to Al Viro */
id|atomic_dec
c_func
(paren
op_amp

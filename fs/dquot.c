...
multiline_comment|/* FIXME: Here we should also sync all file info */
id|dqstats.syncs
op_increment
suffix:semicolon
id|unlock_kernel
...
id|len
comma
l_string|&quot;&bslash;n%u %u %u %u %u %u %u %u&bslash;n&quot;
comma
id|dqstats.lookups
comma
id|dqstats.drops

...
multiline_comment|/*&n; * For fast path lookup while holding the dcache_lock. &n; * SMP-safe&n; */
DECL|function|cached_lookup_nd
r_static
r_struct
id|dentry
op_star
...
suffix:semicolon
multiline_comment|/*to avoid cacheline bouncing with d_count*/
id|nd-&gt;mnt
op_assign
id|current-&gt;fs-&gt;rootmnt
suffix:semicolon

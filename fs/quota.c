...
multiline_comment|/* Check validity of generic quotactl commands */
DECL|function|generic_quotactl_valid
r_static
r_int
id|generic_quotactl_valid
c_func
(paren
r_struct
id|super_block
...
multiline_comment|/* Check validity of XFS Quota Manager commands */
DECL|function|xqm_quotactl_valid
r_static
r_int
id|xqm_quotactl_valid
c_func
(paren
r_struct
id|super_block

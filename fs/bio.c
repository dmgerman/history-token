...
suffix:semicolon
DECL|variable|bio_hash_table
r_struct
id|bio_hash_bucket
op_star
id|bio_hash_table
suffix:semicolon
DECL|variable|bio_hash_bits
DECL|variable|bio_hash_mask
r_int
r_int
id|bio_hash_bits
comma
...
macro_line|#ifdef BIO_HASH_PROFILING
DECL|variable|bio_stats
r_static
r_struct
id|bio_hash_stats
id|bio_stats
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n; * optimized for 2^BIO_HASH_SCALE kB block size&n; */
DECL|macro|BIO_HASH_SCALE
mdefine_line|#define BIO_HASH_SCALE&t;3
DECL|macro|BIO_HASH_BLOCK
mdefine_line|#define BIO_HASH_BLOCK(sector)&t;((sector) &gt;&gt; BIO_HASH_SCALE)
multiline_comment|/*&n; * pending further testing, grabbed from fs/buffer.c hash so far...&n; */
DECL|macro|__bio_hash
mdefine_line|#define __bio_hash(dev,block)&t;&bslash;&n;&t;(((((dev)&lt;&lt;(bio_hash_bits - 6)) ^ ((dev)&lt;&lt;(bio_hash_bits - 9))) ^ &bslash;&n;&t; (((block)&lt;&lt;(bio_hash_bits - 6)) ^ ((block) &gt;&gt; 13) ^ &bslash;&n;&t;  ((block) &lt;&lt; (bio_hash_bits - 12)))) &amp; bio_hash_mask)
DECL|macro|bio_hash
mdefine_line|#define bio_hash(dev, sector) &amp;((bio_hash_table + __bio_hash(dev, BIO_HASH_BLOCK((sector))))-&gt;hash)
DECL|macro|bio_hash_bucket
mdefine_line|#define bio_hash_bucket(dev, sector) (bio_hash_table + __bio_hash(dev, BIO_HASH_BLOCK((sector))))
DECL|macro|__BIO_HASH_RWLOCK
mdefine_line|#define __BIO_HASH_RWLOCK(dev, sector)&t;&bslash;&n;&t;&amp;((bio_hash_table + __bio_hash((dev), BIO_HASH_BLOCK((sector))))-&gt;lock)
DECL|macro|BIO_HASH_RWLOCK
mdefine_line|#define BIO_HASH_RWLOCK(bio)&t;&t;&bslash;&n;&t;__BIO_HASH_RWLOCK((bio)-&gt;bi_dev, (bio)-&gt;bi_sector)
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * need to experiment on size of hash&n;&t; */
id|mempages
op_rshift_assign
l_int|2
suffix:semicolon
...
c_func
(paren
l_string|&quot;Bio-cache hash table entries: %ld (order: %ld, %ld bytes)&bslash;n&quot;
comma
id|BIO_HASH_SIZE
comma
id|order
...
DECL|function|__bio_hash_remove
r_inline
r_void
id|__bio_hash_remove
c_func
(paren
r_struct
id|bio
...
(paren
op_amp
id|bio_stats.nr_entries
)paren
suffix:semicolon
macro_line|#endif
)brace
)brace
DECL|function|bio_hash_remove
r_inline
r_void
id|bio_hash_remove
c_func
...
DECL|function|__bio_hash_add_unique
r_inline
r_int
id|__bio_hash_add_unique
c_func
(paren
r_struct
id|bio
...
multiline_comment|/*&n;&t; * release reference to alias&n;&t; */
id|bio_put
c_func
(paren
id|alias
...
DECL|function|bio_hash_add_unique
r_inline
r_int
...
multiline_comment|/*&n; * increment validity counter on barrier inserts. if it wraps, we must&n; * prune all existing entries for this device to be completely safe&n; *&n; * q-&gt;queue_lock must be held by caller&n; */
DECL|function|bio_hash_invalidate
r_void
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * it wrapped...&n;&t; */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*&n;&t; * entries pruned, reset validity counter&n;&t; */
id|q-&gt;hash_valid_counter
op_assign
l_int|1
suffix:semicolon
...
multiline_comment|/*&n;&t; * we use bvl_max as index into bvec_pool_sizes, non-slab originated&n;&t; * bvecs may use it for something else if they use their own&n;&t; * destructor&n;&t; */
r_if
c_cond
(paren
id|bvl
...
multiline_comment|/**&n; *&t;bio_copy&t;-&t;create copy of a bio&n; *&t;@bio: bio to copy&n; *&t;@gfp_mask: allocation priority&n; *&n; *&t;Create a copy of a &amp;bio. Caller will own the returned bio and&n; *&t;the actual data it points to. Reference count of returned&n; * &t;bio will be one.&n; */
...
id|bio-&gt;bi_rw
suffix:semicolon
id|b-&gt;bi_io_vec-&gt;bvl_cnt
op_assign
id|bio-&gt;bi_io_vec-&gt;bvl_cnt
suffix:semicolon
id|b-&gt;bi_io_vec-&gt;bvl_size
op_assign
...
suffix:semicolon
DECL|variable|bio_hash_add_unique
id|EXPORT_SYMBOL
c_func
(paren
id|bio_hash_add_unique

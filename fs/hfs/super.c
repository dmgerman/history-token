...
DECL|enumerator|opt_file_umask
DECL|enumerator|opt_dir_umask
id|opt_uid
comma
id|opt_gid
comma
...
id|opt_file_umask
comma
l_string|&quot;file_umask=%o&quot;
)brace
comma
(brace
id|opt_dir_umask
comma
l_string|&quot;dir_umask=%o&quot;
)brace
comma
(brace
id|opt_part
...
c_func
(paren
l_string|&quot;HFS: uid requires an argument&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: gid requires an argument&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: umask requires a value&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: file_umask requires a value&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: dir_umask requires a value&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: part requires an argument&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;HFS: session requires an argument&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

multiline_comment|/*&n; * linux/fs/hfs/bitops.c&n; *&n; * Copyright (C) 1996  Paul H. Hargrove&n; * This file may be distributed under the terms of the GNU General Public License.&n; *&n; * This file contains functions to handle bitmaps in &quot;left-to-right&quot;&n; * bit-order such that the MSB of a 32-bit big-endian word is bit 0.&n; * (This corresponds to bit 7 of a 32-bit little-endian word.)&n; *&n; * I have tested and confirmed that the results are identical on the&n; * Intel x86, PowerPC and DEC Alpha processors.&n; *&n; * &quot;XXX&quot; in a comment is a note to myself to consider changing something.&n; */

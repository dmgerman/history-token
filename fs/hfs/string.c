multiline_comment|/*&n; *  linux/fs/hfs/string.c&n; *&n; * Copyright (C) 1995-1997  Paul H. Hargrove&n; * (C) 2003 Ardis Technologies &lt;roman@ardistech.com&gt;&n; * This file may be distributed under the terms of the GNU General Public License.&n; *&n; * This file contains the string comparison function for the&n; * Macintosh character set.&n; *&n; * The code in this file is derived from code which is copyright&n; * 1986, 1989, 1990 by Abacus Research and Development, Inc. (ARDI)&n; * It is used here by the permission of ARDI&squot;s president Cliff Matthews.&n; */
...
multiline_comment|/*&n; * Test for equality of two strings in the HFS filename character ordering.&n; * return 1 on failure and 0 on success&n; */

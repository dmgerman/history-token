multiline_comment|/*&n; * linux/fs/hfs/bitmap.c&n; *&n; * Copyright (C) 1996-1997  Paul H. Hargrove&n; * This file may be distributed under the terms of the GNU General Public License.&n; *&n; * Based on GPLed code Copyright (C) 1995  Michael Dreher&n; *&n; * This file contains the code to modify the volume bitmap:&n; * search/set/clear bits.&n; *&n; * &quot;XXX&quot; in a comment is a note to myself to consider changing something.&n; *&n; * In function preconditions the term &quot;valid&quot; applied to a pointer to&n; * a structure means that the pointer is non-NULL and the structure it&n; * points to has all fields initialized to consistent values.&n; */

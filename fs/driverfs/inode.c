...
c_func
(paren
l_string|&quot;%s: no read callback&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: no write callback&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
DECL|function|driverfs_sync_file
r_static
r_int
id|driverfs_sync_file
(paren
r_struct
id|file
op_star
...
multiline_comment|/* When the dentry goes away (the refcount hits 0), free the&n; * driver_file_entry for it.&n; */
...
multiline_comment|/* Similar to above - if this dentry goes away, free the&n; * driver_dir_entry associated with it..&n; */
DECL|function|driverfs_d_delete_dir
r_static
r_int
id|driverfs_d_delete_dir
(paren
r_struct
id|dentry
op_star
...
id|super_block
op_star
DECL|function|driverfs_read_super
id|driverfs_read_super
c_func
(paren
r_struct
id|super_block
...
c_func
(paren
l_string|&quot;%s: registering filesystem.&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: register_filesystem failed with %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|error
...
DECL|function|exit_driverfs_fs
r_static
r_void
id|__exit
id|exit_driverfs_fs
...
c_func
(paren
l_string|&quot;The device driver filesystem&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
suffix:semicolon
multiline_comment|/**&n; * driverfs_create_dir_entry - allocate and initialise directory entry&n; * @name:&t;name of the directory&n; * @mode:&t;permissions of the dir&n; */
r_struct
id|driver_dir_entry
op_star
DECL|function|driverfs_create_dir_entry
...
multiline_comment|/* make sure daddy doesn&squot;t run out on us again... */
id|parent_dentry
op_assign
id|dget
c_func
...
multiline_comment|/**&n; * __remove_file - remove a regular file in the filesystem&n; * @dentry:&t;dentry of file to remove&n; *&n; * Call unlink to remove the file, and dput on the dentry to drop&n; * the refcount.&n; */
DECL|function|__remove_file
r_static
r_void
id|__remove_file
c_func
...
suffix:semicolon
multiline_comment|/* remove reference count from when file was created */
id|dput
c_func
(paren
id|dentry
...
id|done
suffix:semicolon
multiline_comment|/* lock the directory while we remove the files */
id|dentry
op_assign
id|dget
c_func
...
multiline_comment|/* now lock the parent, so we can remove this directory */
id|lock_parent
c_func
(paren
id|dentry
...
suffix:semicolon
multiline_comment|/* remove reference count from when directory was created */
id|dput
c_func
(paren
id|dentry
...
multiline_comment|/**&n; * driverfs_create_entry - allocate and initialise a struct driver_file_entry&n; * @name:&t;name of the file&n; * @mode:&t;permissions of the file&n; * @ops:&t;Operations for the file&n; * @data:&t;data that will be passed back to the callback&n; *&n; */
r_struct
id|driver_file_entry
op_star
DECL|function|driverfs_create_entry

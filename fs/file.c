...
multiline_comment|/*&n; * Expand files.&n; * Return &lt;0 on error; 0 nothing done; 1 files expanded, we may have blocked.&n; * Should be called with the files-&gt;file_lock spinlock held for write.&n; */

...
id|parent
suffix:semicolon
multiline_comment|/* If dentry was on d_lru list&n;&t;&t; * delete it from there&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We found an inuse dentry which was not removed from&n;&t;&t; * dentry_unused because of laziness during lookup.  Do not free&n;&t;&t; * it - just keep it off the dentry_unused list.&n;&t;&t; */
r_if
c_cond
(paren
id|atomic_read
...
multiline_comment|/**&n; * d_instantiate_unique - instantiate a non-aliased dentry&n; * @entry: dentry to instantiate&n; * @inode: inode to attach to this dentry&n; *&n; * Fill in inode information in the entry. On success, it returns NULL.&n; * If an unhashed alias of &quot;entry&quot; already exists, then we return the&n; * aliased dentry instead.&n; *&n; * Note that in order to avoid conflicts with rename() etc, the caller&n; * had better be holding the parent directory semaphore.&n; */
DECL|function|d_instantiate_unique
r_struct
id|dentry
op_star
id|d_instantiate_unique
c_func
(paren
r_struct
id|dentry
...
DECL|variable|d_instantiate_unique
id|EXPORT_SYMBOL
c_func
(paren
id|d_instantiate_unique
...
id|lhp
suffix:semicolon
multiline_comment|/* Check whether the ptr might be valid at all.. */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Both external: swap the pointers&n;&t;&t;&t; */
id|do_switch
c_func
(paren
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * dentry:internal, target:external.  Steal target&squot;s&n;&t;&t;&t; * storage and make target internal.&n;&t;&t;&t; */
id|dentry-&gt;d_name.name
op_assign
id|target-&gt;d_name.name
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t;&t; * dentry:external, target:internal.  Give dentry&squot;s&n;&t;&t;&t; * storage to target and make dentry internal&n;&t;&t;&t; */
id|memcpy
c_func
(paren
id|dentry-&gt;d_iname
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * Both are internal.  Just copy target to dentry&n;&t;&t;&t; */
id|memcpy
c_func
(paren
id|dentry-&gt;d_iname
...
suffix:semicolon
multiline_comment|/*&n;&t; * XXXX: do we really need to take target-&gt;d_lock?&n;&t; */
r_if
c_cond
(paren
id|target
...
multiline_comment|/* Move the dentry to the target hash queue, if on different bucket */
r_if
c_cond
(paren
id|dentry-&gt;d_flags
...
id|dhash_entries
suffix:semicolon
DECL|function|set_dhash_entries
r_static
r_int
id|__init
id|set_dhash_entries
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;dhash_entries=&quot;
comma
id|set_dhash_entries
)paren
suffix:semicolon
DECL|function|dcache_init_early
r_static
r_void
id|__init
id|dcache_init_early
c_func
(paren
r_void
)paren
...
suffix:semicolon
multiline_comment|/* Hash may have been set up in dcache_init_early */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
DECL|function|vfs_caches_init_early
r_void
id|__init

...
mdefine_line|#define&t;__XFS_DIR_SF_H__
...
suffix:semicolon
multiline_comment|/*&n; * We generate this then sort it, so that readdirs are returned in&n; * hash-order.  Else seekdir won&squot;t work.&n; */
...
mdefine_line|#define&t;XFS_DIR_KTRACE_G_DUB&t;2&t;/* dp, uio, bno */
DECL|macro|XFS_DIR_KTRACE_G_DUN
mdefine_line|#define&t;XFS_DIR_KTRACE_G_DUN&t;3&t;/* dp, uio, node */
DECL|macro|XFS_DIR_KTRACE_G_DUL
mdefine_line|#define&t;XFS_DIR_KTRACE_G_DUL&t;4&t;/* dp, uio, leaf */
...
mdefine_line|#define&t;xfs_dir_trace_g_du(w,d,u)
DECL|macro|xfs_dir_trace_g_dub
mdefine_line|#define&t;xfs_dir_trace_g_dub(w,d,u,b)
DECL|macro|xfs_dir_trace_g_dun
mdefine_line|#define&t;xfs_dir_trace_g_dun(w,d,u,n)
DECL|macro|xfs_dir_trace_g_dul
mdefine_line|#define&t;xfs_dir_trace_g_dul(w,d,u,l)
DECL|macro|xfs_dir_trace_g_due
mdefine_line|#define&t;xfs_dir_trace_g_due(w,d,u,e)
DECL|macro|xfs_dir_trace_g_duc
mdefine_line|#define&t;xfs_dir_trace_g_duc(w,d,u,c)

...
mdefine_line|#define&t;__XFS_RTALLOC_H__
r_struct
id|xfs_mount
suffix:semicolon
r_struct
...
mdefine_line|#define&t;XFS_MAX_RTEXTSIZE&t;(1024 * 1024 * 1024)&t;/* 1GB */
DECL|macro|XFS_DFL_RTEXTSIZE
mdefine_line|#define&t;XFS_DFL_RTEXTSIZE&t;(64 * 1024)&t;        /* 64KB */
DECL|macro|XFS_MIN_RTEXTSIZE
mdefine_line|#define&t;XFS_MIN_RTEXTSIZE&t;(4 * 1024)&t;&t;/* 4KB */
multiline_comment|/*&n; * Constants for bit manipulations.&n; */
DECL|macro|XFS_NBBYLOG
mdefine_line|#define&t;XFS_NBBYLOG&t;3&t;&t;/* log2(NBBY) */
DECL|macro|XFS_WORDLOG
mdefine_line|#define&t;XFS_WORDLOG&t;2&t;&t;/* log2(sizeof(xfs_rtword_t)) */
DECL|macro|XFS_NBWORDLOG
mdefine_line|#define&t;XFS_NBWORDLOG&t;(XFS_NBBYLOG + XFS_WORDLOG)
DECL|macro|XFS_NBWORD
mdefine_line|#define&t;XFS_NBWORD&t;(1 &lt;&lt; XFS_NBWORDLOG)
DECL|macro|XFS_WORDMASK
mdefine_line|#define&t;XFS_WORDMASK&t;((1 &lt;&lt; XFS_WORDLOG) - 1)
DECL|macro|XFS_BLOCKSIZE
mdefine_line|#define&t;XFS_BLOCKSIZE(mp)&t;((mp)-&gt;m_sb.sb_blocksize)
DECL|macro|XFS_BLOCKMASK
mdefine_line|#define&t;XFS_BLOCKMASK(mp)&t;((mp)-&gt;m_blockmask)
DECL|macro|XFS_BLOCKWSIZE
mdefine_line|#define&t;XFS_BLOCKWSIZE(mp)&t;((mp)-&gt;m_blockwsize)
DECL|macro|XFS_BLOCKWMASK
mdefine_line|#define&t;XFS_BLOCKWMASK(mp)&t;((mp)-&gt;m_blockwmask)
multiline_comment|/*&n; * Summary and bit manipulation macros.&n; */
DECL|macro|XFS_SUMOFFS
mdefine_line|#define&t;XFS_SUMOFFS(mp,ls,bb)&t;((int)((ls) * (mp)-&gt;m_sb.sb_rbmblocks + (bb)))
DECL|macro|XFS_SUMOFFSTOBLOCK
mdefine_line|#define&t;XFS_SUMOFFSTOBLOCK(mp,s)&t;&bslash;&n;&t;(((s) * (uint)sizeof(xfs_suminfo_t)) &gt;&gt; (mp)-&gt;m_sb.sb_blocklog)
DECL|macro|XFS_SUMPTR
mdefine_line|#define&t;XFS_SUMPTR(mp,bp,so)&t;&bslash;&n;&t;((xfs_suminfo_t *)((char *)XFS_BUF_PTR(bp) + &bslash;&n;&t;&t;(((so) * (uint)sizeof(xfs_suminfo_t)) &amp; XFS_BLOCKMASK(mp))))
DECL|macro|XFS_BITTOBLOCK
mdefine_line|#define&t;XFS_BITTOBLOCK(mp,bi)&t;((bi) &gt;&gt; (mp)-&gt;m_blkbit_log)
DECL|macro|XFS_BLOCKTOBIT
mdefine_line|#define&t;XFS_BLOCKTOBIT(mp,bb)&t;((bb) &lt;&lt; (mp)-&gt;m_blkbit_log)
DECL|macro|XFS_BITTOWORD
mdefine_line|#define&t;XFS_BITTOWORD(mp,bi)&t;&bslash;&n;&t;((int)(((bi) &gt;&gt; XFS_NBWORDLOG) &amp; XFS_BLOCKWMASK(mp)))
DECL|macro|XFS_RTMIN
mdefine_line|#define&t;XFS_RTMIN(a,b)&t;((a) &lt; (b) ? (a) : (b))
DECL|macro|XFS_RTMAX
mdefine_line|#define&t;XFS_RTMAX(a,b)&t;((a) &gt; (b) ? (a) : (b))
...
macro_line|#else
DECL|macro|XFS_RTBLOCKLOG
mdefine_line|#define&t;XFS_RTBLOCKLOG(b)&t;xfs_highbit32(b)
macro_line|#endif
...
macro_line|# define xfs_rtallocate_extent(t,b,min,max,l,a,f,p,rb)  (ENOSYS)
DECL|macro|xfs_rtfree_extent
macro_line|# define xfs_rtfree_extent(t,b,l)                       (ENOSYS)
DECL|macro|xfs_rtpick_extent
macro_line|# define xfs_rtpick_extent(m,t,l,rb)                    (ENOSYS)
DECL|macro|xfs_growfs_rt
macro_line|# define xfs_growfs_rt(mp,in)                           (ENOSYS)
DECL|macro|xfs_rtmount_init
macro_line|# define xfs_rtmount_init(m)    (((mp)-&gt;m_sb.sb_rblocks == 0)? 0 : (ENOSYS))
DECL|macro|xfs_rtmount_inodes
macro_line|# define xfs_rtmount_inodes(m)  (((mp)-&gt;m_sb.sb_rblocks == 0)? 0 : (ENOSYS))

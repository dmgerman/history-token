...
mdefine_line|#define&t;__XFS_BIT_H__
...
mdefine_line|#define&t;XFS_MASK32HI(n)&t;&t;xfs_mask32hi(n)
macro_line|#else
DECL|macro|XFS_MASK32HI
mdefine_line|#define&t;XFS_MASK32HI(n)&t;&t;((__uint32_t)-1 &lt;&lt; (32 - (n)))
macro_line|#endif
...
mdefine_line|#define&t;XFS_MASK64HI(n)&t;&t;xfs_mask64hi(n)
macro_line|#else
DECL|macro|XFS_MASK64HI
mdefine_line|#define&t;XFS_MASK64HI(n)&t;&t;((__uint64_t)-1 &lt;&lt; (64 - (n)))
macro_line|#endif
...
mdefine_line|#define&t;XFS_MASK32LO(n)&t;&t;xfs_mask32lo(n)
macro_line|#else
DECL|macro|XFS_MASK32LO
mdefine_line|#define&t;XFS_MASK32LO(n)&t;&t;(((__uint32_t)1 &lt;&lt; (n)) - 1)
macro_line|#endif
...
mdefine_line|#define&t;XFS_MASK64LO(n)&t;&t;xfs_mask64lo(n)
macro_line|#else
DECL|macro|XFS_MASK64LO
mdefine_line|#define&t;XFS_MASK64LO(n)&t;&t;(((__uint64_t)1 &lt;&lt; (n)) - 1)
macro_line|#endif

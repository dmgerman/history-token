...
c_func
(paren
id|xfsstats.xs_allocx
)paren
suffix:semicolon
id|XFS_STATS_ADD
c_func
(paren
id|xfsstats.xs_allocb
comma
id|args-&gt;len
)paren
suffix:semicolon
...
c_func
(paren
id|xfsstats.xs_freex
)paren
suffix:semicolon
id|XFS_STATS_ADD
c_func
(paren
id|xfsstats.xs_freeb
comma
id|len
)paren
suffix:semicolon
...
id|CE_NOTE
comma
l_string|&quot;xfs_alloc_read_agf: error in &lt;%s&gt; AG %d&quot;
comma
id|mp-&gt;m_fsname
comma
id|agno
...
id|CE_NOTE
comma
l_string|&quot;bad agf_magicnum 0x%x&quot;
comma
id|INT_GET
c_func
(paren
...
id|CE_NOTE
comma
l_string|&quot;Bad version number 0x%x&quot;
comma
id|INT_GET
c_func
(paren

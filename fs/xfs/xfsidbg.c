...
c_func
(paren
l_string|&quot;blockcount %Ld flag %d&bslash;n&quot;
comma
id|c
comma
id|fl
...
multiline_comment|/*&n; * Convert an external extent descriptor to internal form.&n; */
r_static
r_void
DECL|function|xfs_convert_extent
id|xfs_convert_extent
c_func
(paren
id|xfs_bmbt_rec_64_t
...
c_func
(paren
l_string|&quot;ip 0x%p not write locked&bslash;n&quot;
comma
id|ip
)paren
suffix:semicolon

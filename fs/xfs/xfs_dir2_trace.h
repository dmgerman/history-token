...
mdefine_line|#define&t;XFS_DIR2_KTRACE_ARGS_B&t;&t;2&t;/* args + buffer */
DECL|macro|XFS_DIR2_KTRACE_ARGS_BB
mdefine_line|#define&t;XFS_DIR2_KTRACE_ARGS_BB&t;&t;3&t;/* args + 2 buffers */
DECL|macro|XFS_DIR2_KTRACE_ARGS_DB
mdefine_line|#define&t;XFS_DIR2_KTRACE_ARGS_DB&t;&t;4&t;/* args, db, buffer */
DECL|macro|XFS_DIR2_KTRACE_ARGS_I
mdefine_line|#define&t;XFS_DIR2_KTRACE_ARGS_I&t;&t;5&t;/* args, inum */
DECL|macro|XFS_DIR2_KTRACE_ARGS_S
mdefine_line|#define&t;XFS_DIR2_KTRACE_ARGS_S&t;&t;6&t;/* args, int */
...
mdefine_line|#define&t;xfs_dir2_trace_args(where, args)
DECL|macro|xfs_dir2_trace_args_b
mdefine_line|#define&t;xfs_dir2_trace_args_b(where, args, bp)
DECL|macro|xfs_dir2_trace_args_bb
mdefine_line|#define&t;xfs_dir2_trace_args_bb(where, args, lbp, dbp)
DECL|macro|xfs_dir2_trace_args_bibii
mdefine_line|#define&t;xfs_dir2_trace_args_bibii(where, args, bs, ss, bd, sd, c)
DECL|macro|xfs_dir2_trace_args_db
mdefine_line|#define&t;xfs_dir2_trace_args_db(where, args, db, bp)
DECL|macro|xfs_dir2_trace_args_i
mdefine_line|#define&t;xfs_dir2_trace_args_i(where, args, i)
DECL|macro|xfs_dir2_trace_args_s
mdefine_line|#define&t;xfs_dir2_trace_args_s(where, args, s)

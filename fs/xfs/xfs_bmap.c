...
suffix:semicolon
macro_line|#else&t;/* additional, temporary, debugging code */
r_if
c_cond
(paren
op_logical_neg
...
id|CE_NOTE
comma
l_string|&quot;xfs_bmap_read_extents: FSB Sanity Check:&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|CE_NOTE
comma
l_string|&quot;bad AG count %d &lt; agcount %d&quot;
comma
id|XFS_FSB_TO_AGNO
c_func
(paren
...
id|CE_NOTE
comma
l_string|&quot;xfs_bmap_read_extents: BMAP Sanity Check:&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|CE_NOTE
comma
l_string|&quot;bb_numrecs %d &lt; m_bmap_dmxr[] %d&quot;
comma
id|INT_GET
c_func
(paren
...
suffix:semicolon
r_else
id|xfs_trans_unreserve_rtblkquota
c_func
(paren
l_int|NULL
comma
...
c_func
(paren
l_string|&quot;xfs_check_block: thispa(%d) == pp(%d) %Ld&bslash;n&quot;
comma
id|j
comma
id|i
...
c_func
(paren
l_string|&quot;xfs_check_block: ptrs are equal in node&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
c_func
(paren
l_string|&quot;xfs_bmap_check_leaf_extents: BAD after btree leaves for %d extents&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;xfs_bmap_check_leaf_extents: CORRUPTED BTREE OR SOMETHING&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

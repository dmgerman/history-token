...
mdefine_line|#define&t;XFS_ILOG_CORE&t;0x001&t;/* log standard inode fields */
DECL|macro|XFS_ILOG_DDATA
mdefine_line|#define&t;XFS_ILOG_DDATA&t;0x002&t;/* log i_df.if_data */
DECL|macro|XFS_ILOG_DEXT
mdefine_line|#define&t;XFS_ILOG_DEXT&t;0x004&t;/* log i_df.if_extents */
DECL|macro|XFS_ILOG_DBROOT
mdefine_line|#define&t;XFS_ILOG_DBROOT&t;0x008&t;/* log i_df.i_broot */
DECL|macro|XFS_ILOG_DEV
mdefine_line|#define&t;XFS_ILOG_DEV&t;0x010&t;/* log the dev field */
DECL|macro|XFS_ILOG_UUID
mdefine_line|#define&t;XFS_ILOG_UUID&t;0x020&t;/* log the uuid field */
DECL|macro|XFS_ILOG_ADATA
mdefine_line|#define&t;XFS_ILOG_ADATA&t;0x040&t;/* log i_af.if_data */
DECL|macro|XFS_ILOG_AEXT
mdefine_line|#define&t;XFS_ILOG_AEXT&t;0x080&t;/* log i_af.if_extents */
DECL|macro|XFS_ILOG_ABROOT
mdefine_line|#define&t;XFS_ILOG_ABROOT&t;0x100&t;/* log i_af.i_broot */
DECL|macro|XFS_ILOG_NONCORE
mdefine_line|#define&t;XFS_ILOG_NONCORE&t;(XFS_ILOG_DDATA | XFS_ILOG_DEXT | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_DBROOT | XFS_ILOG_DEV | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_UUID | XFS_ILOG_ADATA | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_AEXT | XFS_ILOG_ABROOT)
DECL|macro|XFS_ILOG_DFORK
mdefine_line|#define&t;XFS_ILOG_DFORK&t;&t;(XFS_ILOG_DDATA | XFS_ILOG_DEXT | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_DBROOT)
DECL|macro|XFS_ILOG_AFORK
mdefine_line|#define&t;XFS_ILOG_AFORK&t;&t;(XFS_ILOG_ADATA | XFS_ILOG_AEXT | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_ABROOT)
DECL|macro|XFS_ILOG_ALL
mdefine_line|#define&t;XFS_ILOG_ALL&t;&t;(XFS_ILOG_CORE | XFS_ILOG_DDATA | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_DEXT | XFS_ILOG_DBROOT | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_DEV | XFS_ILOG_UUID | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_ADATA | XFS_ILOG_AEXT | &bslash;&n;&t;&t;&t;&t; XFS_ILOG_ABROOT)
DECL|macro|XFS_ILI_HOLD
mdefine_line|#define&t;XFS_ILI_HOLD&t;&t;0x1
DECL|macro|XFS_ILI_IOLOCKED_EXCL
mdefine_line|#define&t;XFS_ILI_IOLOCKED_EXCL&t;0x2
DECL|macro|XFS_ILI_IOLOCKED_SHARED
mdefine_line|#define&t;XFS_ILI_IOLOCKED_SHARED&t;0x4
DECL|macro|XFS_ILI_IOLOCKED_ANY
mdefine_line|#define&t;XFS_ILI_IOLOCKED_ANY   (XFS_ILI_IOLOCKED_EXCL | XFS_ILI_IOLOCKED_SHARED)
...
mdefine_line|#define&t;XFS_ILOG_FDATA(w)&t;xfs_ilog_fdata(w)
macro_line|#else
DECL|macro|XFS_ILOG_FDATA
mdefine_line|#define&t;XFS_ILOG_FDATA(w)&t;&bslash;&n;&t;((w) == XFS_DATA_FORK ? XFS_ILOG_DDATA : XFS_ILOG_ADATA)
macro_line|#endif
...
mdefine_line|#define&t;XFS_ILOG_FBROOT(w)&t;xfs_ilog_fbroot(w)
macro_line|#else
DECL|macro|XFS_ILOG_FBROOT
mdefine_line|#define&t;XFS_ILOG_FBROOT(w)&t;&bslash;&n;&t;((w) == XFS_DATA_FORK ? XFS_ILOG_DBROOT : XFS_ILOG_ABROOT)
macro_line|#endif
...
mdefine_line|#define&t;XFS_ILOG_FEXT(w)&t;xfs_ilog_fext(w)
macro_line|#else
DECL|macro|XFS_ILOG_FEXT
mdefine_line|#define&t;XFS_ILOG_FEXT(w)&t;&bslash;&n;&t;((w) == XFS_DATA_FORK ? XFS_ILOG_DEXT : XFS_ILOG_AEXT)
macro_line|#endif
macro_line|#ifdef __KERNEL__
r_void

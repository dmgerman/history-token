...
(brace
multiline_comment|/*&n;&t;&t; * Timelimits for the super user set the relative time&n;&t;&t; * the other users can be over quota for this file system.&n;&t;&t; * If it is zero a default is used.&n;&t;&t; */
r_if
c_cond
(paren
id|newlim-&gt;d_fieldmask

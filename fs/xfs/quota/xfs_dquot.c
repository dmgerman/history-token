...
DECL|variable|xfs_dqerror_target
id|xfs_buftarg_t
op_star
id|xfs_dqerror_target
suffix:semicolon
...
macro_line|#endif
multiline_comment|/*&n; * If default limits are in force, push them into the dquot now.&n; * We overwrite the dquot limits only if they are zero and this&n; * is not the root dquot.&n; */
r_void
DECL|function|xfs_qm_adjust_dqlimits

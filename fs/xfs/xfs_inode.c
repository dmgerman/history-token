...
multiline_comment|/*&n; * xfs_xlate_dinode_core - translate an xfs_inode_core_t between ondisk&n; * and native format&n; *&n; * buf  = on-disk representation&n; * dip  = native representation&n; * dir  = direction - +ve -&gt; disk to native&n; *                    -ve -&gt; native to disk&n; */
r_void

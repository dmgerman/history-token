...
multiline_comment|/*&n; * xfs_cmountfs&n; *&n; * This function is the common mount file system function for XFS.&n; */
id|STATIC
r_int
DECL|function|xfs_cmountfs
id|xfs_cmountfs
c_func
(paren
id|vfs_t
...
suffix:semicolon
multiline_comment|/*&n;&t; * Open data, real time, and log devices now - order is important.&n;&t; */
id|mp-&gt;m_ddev_targp
op_assign
...
r_else
(brace
multiline_comment|/* Set the log device&squot;s block size */
id|set_blocksize
c_func
(paren
...
id|CE_WARN
comma
l_string|&quot;XFS: Cannot mount filesystem with identical rtdev and logdev.&quot;
)paren
suffix:semicolon
id|error
op_assign
...
r_else
(brace
multiline_comment|/* Set the realtime device&squot;s block size */
id|set_blocksize
c_func
(paren
...
multiline_comment|/*&n;&t;&t; * no recovery flag requires a read-only mount&n;&t;&t; */
r_if
c_cond
(paren
id|ap-&gt;flags
...
multiline_comment|/*&n;&t; * read in superblock to check read-only flags and shared&n;&t; * mount status&n;&t; */
r_if
c_cond
(paren
(paren
...
comma
l_string|&quot;XFS: &quot;
l_string|&quot;logbuf size must be greater than or equal to log stripe size&quot;
)paren
suffix:semicolon
id|xfs_freesb
c_func
...
comma
l_string|&quot;XFS: &quot;
l_string|&quot;cannot mount a read-only filesystem as read-write&quot;
)paren
suffix:semicolon
id|error
op_assign
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Be careful not to clobber the value of &squot;error&squot; here.&n;&t; */
id|error3
suffix:colon
multiline_comment|/* It&squot;s impossible to get here before buftargs are filled */
id|xfs_binval
c_func
(paren
id|mp-&gt;m_ddev_targp
...
multiline_comment|/*&n; * xfs_mount&n; *&n; * The file system configurations are:&n; *&t;(1) device (partition) with data and internal log&n; *&t;(2) logical volume with data and log subvolumes.&n; *&t;(3) logical volume with data, log, and realtime subvolumes.&n; */
id|STATIC
r_int

...
multiline_comment|/* This structure must be a power of 2 long for the hash to work */
r_typedef
r_struct
(brace
DECL|member|pb_hash
...
id|pbhash
suffix:semicolon
DECL|variable|pb_hash_mask
r_static
r_int
r_int
id|pb_hash_mask
suffix:semicolon
DECL|variable|pb_hash_shift
r_static
r_int
r_int
id|pb_hash_shift
suffix:semicolon
DECL|variable|pb_order
r_static
r_int
r_int
id|pb_order
...
multiline_comment|/*&n; * This hash is the same one as used on the Linux buffer cache,&n; * see fs/buffer.c&n; */
DECL|macro|_hashfn
mdefine_line|#define _hashfn(dev,block)      &bslash;&n;        ((((dev)&lt;&lt;(pb_hash_shift - 6)) ^ ((dev)&lt;&lt;(pb_hash_shift - 9))) ^ &bslash;&n;         (((block)&lt;&lt;(pb_hash_shift - 6)) ^ ((block) &gt;&gt; 13) ^ &bslash;&n;          ((block) &lt;&lt; (pb_hash_shift - 12))))
r_static
r_inline
r_int
...
l_int|3
suffix:semicolon
multiline_comment|/* cap us at 2K buckets */
r_do
(brace
r_int
r_int
...
c_func
(paren
l_string|&quot;pagebuf cache hash table entries: %d (order: %d, %ld bytes)&bslash;n&quot;
comma
id|nr_hash
comma
id|order

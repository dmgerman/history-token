...
multiline_comment|/*&n; *&t;page_buf.c&n; *&n; *&t;The page_buf module provides an abstract buffer cache model on top of&n; *&t;the Linux page cache.  Cached blocks for a file are hashed to the&n; *&t;inode for that file, and can be held dirty in delayed write mode in&n; *&t;the page cache.&t; Cached metadata blocks for a file system are hashed&n; *&t;to the inode for the mounted device.  The page_buf module assembles&n; *&t;buffer (page_buf_t) objects on demand to aggregate such cached pages&n; *&t;for I/O.&n; *&n; *&n; *&t;Written by Steve Lord, Jim Mostek, Russell Cattelan&n; *&t;&t;    and Rajagopal Ananthanarayanan (&quot;ananth&quot;) at SGI.&n; *&n; */
...
id|pagebuf_cache
suffix:semicolon
DECL|variable|pb_daemon
id|STATIC
id|pagebuf_daemon_t
op_star
id|pb_daemon
suffix:semicolon
DECL|variable|pagebuf_iodone_tq
id|STATIC
r_struct
id|list_head
id|pagebuf_iodone_tq
(braket
id|NR_CPUS
)braket
suffix:semicolon
DECL|variable|pagebuf_iodone_wait
id|STATIC
id|wait_queue_head_t
id|pagebuf_iodone_wait
(braket
id|NR_CPUS
)braket
suffix:semicolon
...
multiline_comment|/*&n; * Create a pagebuf and populate it with pages from the address&n; * space of the passed in inode.&n; */
id|page_buf_t
op_star
...
r_void
DECL|function|pagebuf_queue_task
...
multiline_comment|/*&n; *&t;pagebuf_segment&n; *&n; *&t;pagebuf_segment is used to retrieve the various contiguous&n; *&t;segments of a buffer.  The variable addressed by the&n; *&t;loff_t * should be initialized to 0, and successive&n; *&t;calls will update to point to the segment following the one&n; *&t;returned.&n; */
id|STATIC
r_void
DECL|function|pagebuf_segment
id|pagebuf_segment
c_func
(paren
id|page_buf_t
...
id|pb
comma
multiline_comment|/* buffer to examine&t;&t;*/
id|loff_t
op_star
id|boff_p
comma
multiline_comment|/* offset in buffer of next&t;*/
multiline_comment|/* next segment (updated)&t;*/
r_struct
id|page
op_star
op_star
id|spage_p
comma
multiline_comment|/* page (updated)&t;&t;*/
multiline_comment|/* (NULL if not in page array)&t;*/
r_int
op_star
id|soff_p
comma
multiline_comment|/* offset in page (updated)&t;*/
r_int
op_star
id|ssize_p
)paren
multiline_comment|/* segment length (updated)&t;*/
(brace
id|loff_t
id|kpboff
suffix:semicolon
multiline_comment|/* offset in pagebuf&t;&t;*/
r_int
id|kpi
suffix:semicolon
multiline_comment|/* page index in pagebuf&t;*/
r_int
id|slen
suffix:semicolon
multiline_comment|/* segment length&t;&t;*/
id|kpboff
op_assign
op_star
id|boff_p
...
multiline_comment|/*&n; * The pagebuf iodone daemon&n; */
DECL|variable|pb_daemons
id|STATIC
r_int
id|pb_daemons
(braket
...
id|STATIC
r_int
DECL|function|pagebuf_iodone_daemon
id|pagebuf_iodone_daemon
c_func
(paren
r_void
op_star
...
suffix:semicolon
multiline_comment|/* Avoid signals */
id|spin_lock_irq
c_func
(paren
op_amp
...
suffix:semicolon
id|pb_daemon_timer.expires
op_assign
id|jiffies
op_plus
id|pb_params.p_un.flush_interval
suffix:semicolon
id|add_timer
c_func
(paren
...
c_func
(paren
l_string|&quot;pagebuf_daemon_start failed&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else

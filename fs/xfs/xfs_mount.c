...
mdefine_line|#define EVMS_MAJOR&t;117
macro_line|#endif
id|STATIC
r_void
...
suffix:semicolon
multiline_comment|/* Init freeze sync structures */
id|spinlock_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t; * Allocate a (locked) buffer to hold the superblock.&n;&t; * This will be kept around at all time to optimize&n;&t; * access to the superblock.&n;&t; */
id|bp
op_assign
...
id|CE_WARN
comma
l_string|&quot;XFS: device %s is read-only, cannot change &quot;
l_string|&quot;quota state.  Please mount with%s quota option.&quot;
comma
id|mp-&gt;m_fsname
comma
id|quotaondisk
...
id|B_FALSE
suffix:semicolon
multiline_comment|/*&n;&t; * Figure out if we&squot;ll need to do a quotacheck.&n;&t; * The requirements are a little different depending on whether&n;&t; * this fs is root or not.&n;&t; */
id|rootqcheck
op_assign
(paren
id|mp-&gt;m_dev
...
id|bp
suffix:semicolon
multiline_comment|/*&n;&t; * Use xfs_getsb() so that the buffer will be locked&n;&t; * when we call nfreerbuf().&n;&t; */
id|bp
op_assign
id|xfs_getsb
c_func
...
multiline_comment|/* Functions to lock access out of the filesystem for forced&n; * shutdown or snapshot.&n; */
r_void
DECL|function|xfs_start_freeze
id|xfs_start_freeze
c_func
(paren
id|xfs_mount_t
...
r_void
DECL|function|xfs_finish_freeze
...
r_void
DECL|function|xfs_check_frozen
id|xfs_check_frozen
c_func
(paren
id|xfs_mount_t

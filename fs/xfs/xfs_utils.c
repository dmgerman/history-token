...
multiline_comment|/*&n; * Wrapper around xfs_dir_lookup.&n; *&n; * If DLF_IGET is set, then this routine will also return the inode.&n; * Note that the inode will not be locked. Note, however, that the&n; * vnode will have an additional reference in this case.&n; */
r_int
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * If all else fails, call the directory code.&n;&t; */
id|error
op_assign
id|XFS_DIR_LOOKUP
c_func
...
(brace
multiline_comment|/* The only time we should get here is if the dir_lookup&n;&t;&t; * failed.&n;&t;&t; */
id|ASSERT
c_func
(paren
id|error

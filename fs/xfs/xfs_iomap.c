...
r_void
DECL|function|xfs_iomap_enter_trace
id|xfs_iomap_enter_trace
c_func
(paren
r_int
id|tag
...
r_void
DECL|function|xfs_iomap_map_trace
id|xfs_iomap_map_trace
c_func
(paren
r_int
id|tag
...
macro_line|#else
DECL|macro|xfs_iomap_enter_trace
mdefine_line|#define xfs_iomap_enter_trace(tag, io, offset, count)
DECL|macro|xfs_iomap_map_trace
mdefine_line|#define xfs_iomap_map_trace(tag, io, offset, count, iomapp, imapp, flags)
macro_line|#endif
...
id|start_fsb
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If there are any real blocks past eof, then don&squot;t&n;&t;&t; * do any speculative allocation.&n;&t;&t; */
id|start_fsb
op_assign
id|XFS_B_TO_FSBT
c_func
...
id|CE_PANIC
comma
l_string|&quot;Access to block &quot;
l_string|&quot;zero:  fs &lt;%s&gt; inode: %lld &quot;
l_string|&quot;start_block : %llx start_off &quot;
l_string|&quot;: %llx blkcnt : %llx &quot;
l_string|&quot;extent-state : %x &bslash;n&quot;
comma
(paren
id|ip-&gt;i_mount
...
id|NULLFSBLOCK
suffix:semicolon
multiline_comment|/*&n;&t; * If mounted with the &quot;-o swalloc&quot; option, roundup the allocation&n;&t; * request to a stripe width boundary if the file size is &gt;=&n;&t; * stripe width and we are allocating past the allocation eof.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t; * Round up the allocation request to a real-time extent boundary&n;&t; * if the file is on the real-time subvolume.&n;&t; */
)brace
r_else
r_if
c_cond
...
id|CE_PANIC
comma
l_string|&quot;Access to block zero:  &quot;
l_string|&quot;fs &lt;%s&gt; inode: %lld &quot;
l_string|&quot;start_block : %llx start_off : %llx &quot;
l_string|&quot;blkcnt : %llx extent-state : %x &bslash;n&quot;
comma
(paren
id|ip-&gt;i_mount
)paren
...
id|CE_PANIC
comma
l_string|&quot;Access to block zero:  fs &lt;%s&gt; &quot;
l_string|&quot;inode: %lld start_block : %llx start_off : &quot;
l_string|&quot;%llx blkcnt : %llx extent-state : %x &bslash;n&quot;
comma
(paren
id|ip-&gt;i_mount
)paren

...
id|xfs_gap_t
suffix:semicolon
multiline_comment|/*&n; * This structure is used to hold common pieces of the buffer&n; * and file for xfs_dio_write and xfs_dio_read.&n; */
DECL|struct|xfs_dio
r_typedef
r_struct
id|xfs_dio
...
id|xd_pmp
suffix:semicolon
DECL|member|xd_blkalgn
r_int
id|xd_blkalgn
suffix:semicolon
DECL|member|xd_ioflag
r_int
id|xd_ioflag
suffix:semicolon
DECL|member|xd_start
id|xfs_off_t
id|xd_start
suffix:semicolon
DECL|member|xd_length
r_int
id|xd_length
suffix:semicolon
DECL|typedef|xfs_dio_t
)brace
id|xfs_dio_t
suffix:semicolon
...
DECL|macro|XFS_IOCORE_ISXFS
mdefine_line|#define XFS_IOCORE_ISXFS&t;0x01
DECL|macro|XFS_IOCORE_ISCXFS
mdefine_line|#define XFS_IOCORE_ISCXFS&t;0x02
DECL|macro|XFS_IOCORE_RT
mdefine_line|#define XFS_IOCORE_RT&t;&t;0x04
DECL|macro|IO_IS_XFS
mdefine_line|#define IO_IS_XFS(io)&t;((io)-&gt;io_flags &amp; XFS_IOCORE_ISXFS)

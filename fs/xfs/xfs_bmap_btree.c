...
multiline_comment|/*&n; * Extract the blockcount field from a bmap extent record.&n; */
id|xfs_filblks_t
...
multiline_comment|/*&n; * Extract the startblock field from a bmap extent record.&n; */
id|xfs_fsblock_t
...
multiline_comment|/*&n; * Extract the startoff field from a bmap extent record.&n; */
id|xfs_fileoff_t

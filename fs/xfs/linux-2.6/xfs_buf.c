...
multiline_comment|/*&n;&t; * Disallow mounts with 64K pages and 512 byte sectors,&n;&t; * until the complete fix has been implemented.&n;&t; */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;XFS: Cannot use a 512-byte-sector filesystem (%s) with 64KB pagesize (yet)&bslash;n&quot;
comma
id|XFS_BUFTARG_NAME
c_func
(paren
...
id|STATIC
r_int
DECL|function|block_releasepage
id|block_releasepage
c_func
(paren
r_struct
id|page
...
c_func
(paren
l_string|&quot;XFS: hey, what the...?  Where&squot;d my hold on this page go!?&bslash;n&quot;
)paren
suffix:semicolon
id|dump_stack
c_func

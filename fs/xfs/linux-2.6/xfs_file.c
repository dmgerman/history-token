...
id|STATIC
id|ssize_t
DECL|function|linvfs_aio_read_invis
id|linvfs_aio_read_invis
c_func
(paren
r_struct
id|kiocb
...
id|STATIC
id|ssize_t
DECL|function|linvfs_aio_write
id|linvfs_aio_write
c_func
(paren
r_struct
...
id|STATIC
id|ssize_t
DECL|function|linvfs_aio_write_invis
id|linvfs_aio_write_invis
c_func
(paren
r_struct
id|kiocb
...
macro_line|#ifdef HAVE_FOP_OPEN_EXEC
multiline_comment|/* If the user is attempting to execute a file that is offline then&n; * we have to trigger a DMAPI READ event before the file is marked as busy&n; * otherwise the invisible I/O will not be able to write to the file to bring&n; * it back online.&n; */
id|STATIC
r_int
DECL|function|linvfs_open_exec
id|linvfs_open_exec
c_func
(paren
r_struct
...
macro_line|#endif /* HAVE_FOP_OPEN_EXEC */

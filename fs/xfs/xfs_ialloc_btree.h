...
mdefine_line|#define&t;__XFS_IALLOC_BTREE_H__
...
mdefine_line|#define&t;XFS_IBT_MAGIC&t;0x49414254&t;/* &squot;IABT&squot; */
...
mdefine_line|#define&t;XFS_INODES_PER_CHUNK&t;(NBBY * sizeof(xfs_inofree_t))
DECL|macro|XFS_INODES_PER_CHUNK_LOG
mdefine_line|#define&t;XFS_INODES_PER_CHUNK_LOG&t;(XFS_NBBYLOG + 3)
DECL|macro|XFS_INOBT_ALL_FREE
mdefine_line|#define&t;XFS_INOBT_ALL_FREE&t;((xfs_inofree_t)-1)
...
mdefine_line|#define&t;XFS_INOBT_MASKN(i,n)&t;&t;xfs_inobt_maskn(i,n)
macro_line|#else
DECL|macro|XFS_INOBT_MASKN
mdefine_line|#define&t;XFS_INOBT_MASKN(i,n)&t;&bslash;&n;&t;((((n) &gt;= XFS_INODES_PER_CHUNK ? &bslash;&n;&t;&t;(xfs_inofree_t)0 : ((xfs_inofree_t)1 &lt;&lt; (n))) - 1) &lt;&lt; (i))
macro_line|#endif
...
mdefine_line|#define&t;XFS_BUF_TO_INOBT_BLOCK(bp)&t;xfs_buf_to_inobt_block(bp)
macro_line|#else
DECL|macro|XFS_BUF_TO_INOBT_BLOCK
mdefine_line|#define&t;XFS_BUF_TO_INOBT_BLOCK(bp) ((xfs_inobt_block_t *)(XFS_BUF_PTR(bp)))
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_MASK(i)&t;&t;xfs_inobt_mask(i)
macro_line|#else
DECL|macro|XFS_INOBT_MASK
mdefine_line|#define&t;XFS_INOBT_MASK(i)&t;&t;((xfs_inofree_t)1 &lt;&lt; (i))
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_BLOCK_SIZE(lev,cur)&t;xfs_inobt_block_size(lev,cur)
macro_line|#else
DECL|macro|XFS_INOBT_BLOCK_SIZE
mdefine_line|#define&t;XFS_INOBT_BLOCK_SIZE(lev,cur)&t;(1 &lt;&lt; (cur)-&gt;bc_blocklog)
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_BLOCK_MAXRECS(lev,cur)&t;xfs_inobt_block_maxrecs(lev,cur)
macro_line|#else
DECL|macro|XFS_INOBT_BLOCK_MAXRECS
mdefine_line|#define&t;XFS_INOBT_BLOCK_MAXRECS(lev,cur)&t;&bslash;&n;&t;((cur)-&gt;bc_mp-&gt;m_inobt_mxr[lev != 0])
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_BLOCK_MINRECS(lev,cur)&t;xfs_inobt_block_minrecs(lev,cur)
macro_line|#else
DECL|macro|XFS_INOBT_BLOCK_MINRECS
mdefine_line|#define&t;XFS_INOBT_BLOCK_MINRECS(lev,cur)&t;&bslash;&n;&t;((cur)-&gt;bc_mp-&gt;m_inobt_mnr[lev != 0])
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_IS_LAST_REC(cur)&t;xfs_inobt_is_last_rec(cur)
macro_line|#else
DECL|macro|XFS_INOBT_IS_LAST_REC
mdefine_line|#define&t;XFS_INOBT_IS_LAST_REC(cur)&t;&bslash;&n;&t;((cur)-&gt;bc_ptrs[0] == &bslash;&n;&t;&t;INT_GET(XFS_BUF_TO_INOBT_BLOCK((cur)-&gt;bc_bufs[0])-&gt;bb_numrecs, ARCH_CONVERT))
macro_line|#endif
...
mdefine_line|#define&t;XFS_IN_MAXLEVELS(mp)&t;&t;xfs_in_maxlevels(mp)
macro_line|#else
DECL|macro|XFS_IN_MAXLEVELS
mdefine_line|#define&t;XFS_IN_MAXLEVELS(mp)&t;&t;((mp)-&gt;m_in_maxlevels)
macro_line|#endif
...
mdefine_line|#define&t;XFS_IBT_BLOCK(mp)&t;&t;xfs_ibt_block(mp)
macro_line|#else
DECL|macro|XFS_IBT_BLOCK
mdefine_line|#define&t;XFS_IBT_BLOCK(mp)&t;((xfs_agblock_t)(XFS_CNT_BLOCK(mp) + 1))
macro_line|#endif
...
mdefine_line|#define&t;XFS_PREALLOC_BLOCKS(mp)&t;&t;xfs_prealloc_blocks(mp)
macro_line|#else
DECL|macro|XFS_PREALLOC_BLOCKS
mdefine_line|#define&t;XFS_PREALLOC_BLOCKS(mp)&t;((xfs_agblock_t)(XFS_IBT_BLOCK(mp) + 1))
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_REC_ADDR(bb,i,cur)&t;xfs_inobt_rec_addr(bb,i,cur)
macro_line|#else
DECL|macro|XFS_INOBT_REC_ADDR
mdefine_line|#define&t;XFS_INOBT_REC_ADDR(bb,i,cur)&t;&bslash;&n;&t;XFS_BTREE_REC_ADDR(XFS_INOBT_BLOCK_SIZE(0,cur), xfs_inobt, bb, i, &bslash;&n;&t;&t;XFS_INOBT_BLOCK_MAXRECS(0, cur))
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_KEY_ADDR(bb,i,cur)&t;xfs_inobt_key_addr(bb,i,cur)
macro_line|#else
DECL|macro|XFS_INOBT_KEY_ADDR
mdefine_line|#define&t;XFS_INOBT_KEY_ADDR(bb,i,cur)&t;&bslash;&n;&t;XFS_BTREE_KEY_ADDR(XFS_INOBT_BLOCK_SIZE(1,cur), xfs_inobt, bb, i, &bslash;&n;&t;&t;XFS_INOBT_BLOCK_MAXRECS(1, cur))
macro_line|#endif
...
mdefine_line|#define&t;XFS_INOBT_PTR_ADDR(bb,i,cur)&t;xfs_inobt_ptr_addr(bb,i,cur)
macro_line|#else
DECL|macro|XFS_INOBT_PTR_ADDR
mdefine_line|#define&t;XFS_INOBT_PTR_ADDR(bb,i,cur)&t;&bslash;&n;&t;XFS_BTREE_PTR_ADDR(XFS_INOBT_BLOCK_SIZE(1,cur), xfs_inobt, bb, i, &bslash;&n;&t;&t;XFS_INOBT_BLOCK_MAXRECS(1, cur))
macro_line|#endif

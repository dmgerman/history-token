...
macro_line|#ifndef&t;__XFS_LOG_RECOVER_H__
...
mdefine_line|#define XLOG_RHASH_BITS  4
DECL|macro|XLOG_RHASH_SIZE
mdefine_line|#define XLOG_RHASH_SIZE&t;16
DECL|macro|XLOG_RHASH_SHIFT
mdefine_line|#define XLOG_RHASH_SHIFT 2
DECL|macro|XLOG_RHASH
mdefine_line|#define XLOG_RHASH(tid)&t;&bslash;&n;&t;((((__uint32_t)tid)&gt;&gt;XLOG_RHASH_SHIFT) &amp; (XLOG_RHASH_SIZE-1))
...
mdefine_line|#define&t;XLOG_BC_TABLE_SIZE&t;64
DECL|macro|XLOG_RECOVER_PASS1
mdefine_line|#define&t;XLOG_RECOVER_PASS1&t;1
DECL|macro|XLOG_RECOVER_PASS2
mdefine_line|#define&t;XLOG_RECOVER_PASS2&t;2

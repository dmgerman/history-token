...
mdefine_line|#define&t;__XFS_DIR2_DATA_H__
...
mdefine_line|#define&t;XFS_DIR2_DATA_MAGIC&t;0x58443244&t;/* XD2D: for multiblock dirs */
DECL|macro|XFS_DIR2_DATA_ALIGN_LOG
mdefine_line|#define&t;XFS_DIR2_DATA_ALIGN_LOG&t;3&t;&t;/* i.e., 8 bytes */
DECL|macro|XFS_DIR2_DATA_ALIGN
mdefine_line|#define&t;XFS_DIR2_DATA_ALIGN&t;(1 &lt;&lt; XFS_DIR2_DATA_ALIGN_LOG)
DECL|macro|XFS_DIR2_DATA_FREE_TAG
mdefine_line|#define&t;XFS_DIR2_DATA_FREE_TAG&t;0xffff
DECL|macro|XFS_DIR2_DATA_FD_COUNT
mdefine_line|#define&t;XFS_DIR2_DATA_FD_COUNT&t;3
...
mdefine_line|#define&t;XFS_DIR2_SPACE_SIZE&t;(1ULL &lt;&lt; (32 + XFS_DIR2_DATA_ALIGN_LOG))
DECL|macro|XFS_DIR2_DATA_SPACE
mdefine_line|#define&t;XFS_DIR2_DATA_SPACE&t;0
DECL|macro|XFS_DIR2_DATA_OFFSET
mdefine_line|#define&t;XFS_DIR2_DATA_OFFSET&t;(XFS_DIR2_DATA_SPACE * XFS_DIR2_SPACE_SIZE)
DECL|macro|XFS_DIR2_DATA_FIRSTDB
mdefine_line|#define&t;XFS_DIR2_DATA_FIRSTDB(mp)&t;&bslash;&n;&t;XFS_DIR2_BYTE_TO_DB(mp, XFS_DIR2_DATA_OFFSET)
multiline_comment|/*&n; * Offsets of . and .. in data space (always block 0)&n; */
DECL|macro|XFS_DIR2_DATA_DOT_OFFSET
mdefine_line|#define&t;XFS_DIR2_DATA_DOT_OFFSET&t;&bslash;&n;&t;((xfs_dir2_data_aoff_t)sizeof(xfs_dir2_data_hdr_t))
DECL|macro|XFS_DIR2_DATA_DOTDOT_OFFSET
mdefine_line|#define&t;XFS_DIR2_DATA_DOTDOT_OFFSET&t;&bslash;&n;&t;(XFS_DIR2_DATA_DOT_OFFSET + XFS_DIR2_DATA_ENTSIZE(1))
DECL|macro|XFS_DIR2_DATA_FIRST_OFFSET
mdefine_line|#define&t;XFS_DIR2_DATA_FIRST_OFFSET&t;&t;&bslash;&n;&t;(XFS_DIR2_DATA_DOTDOT_OFFSET + XFS_DIR2_DATA_ENTSIZE(2))
...
macro_line|#else
DECL|macro|XFS_DIR2_DATA_ENTSIZE
mdefine_line|#define&t;XFS_DIR2_DATA_ENTSIZE(n)&t;&bslash;&n;&t;((int)(roundup(offsetof(xfs_dir2_data_entry_t, name[0]) + (n) + &bslash;&n;&t;&t; (uint)sizeof(xfs_dir2_data_off_t), XFS_DIR2_DATA_ALIGN)))
macro_line|#endif
...
mdefine_line|#define&t;XFS_DIR2_DATA_ENTRY_TAG_P(dep)&t;xfs_dir2_data_entry_tag_p(dep)
macro_line|#else
DECL|macro|XFS_DIR2_DATA_ENTRY_TAG_P
mdefine_line|#define&t;XFS_DIR2_DATA_ENTRY_TAG_P(dep)&t;&bslash;&n;&t;((xfs_dir2_data_off_t *)&bslash;&n;&t; ((char *)(dep) + XFS_DIR2_DATA_ENTSIZE((dep)-&gt;namelen) - &bslash;&n;&t;  (uint)sizeof(xfs_dir2_data_off_t)))
macro_line|#endif
...
mdefine_line|#define&t;xfs_dir2_data_check(dp,bp)
macro_line|#endif
r_extern
id|xfs_dir2_data_free_t
op_star

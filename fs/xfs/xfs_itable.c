...
id|STATIC
r_int
DECL|function|xfs_bulkstat_one_iget
id|xfs_bulkstat_one_iget
c_func
(paren
id|xfs_mount_t
op_star
...
id|ip-&gt;i_d
suffix:semicolon
multiline_comment|/* xfs_iget returns the following without needing&n;&t; * further change.&n;&t; */
id|buf-&gt;bs_nlink
op_assign
id|dic-&gt;di_nlink
suffix:semicolon
...
id|STATIC
r_int
DECL|function|xfs_bulkstat_one_dinode
id|xfs_bulkstat_one_dinode
c_func
(paren
id|xfs_mount_t
op_star

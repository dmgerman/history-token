...
suffix:semicolon
multiline_comment|/* linvfs_revalidate_core returns (-) errors */
id|error
op_assign
op_minus
...
multiline_comment|/* Brute force approach for now - copy data into linux inode&n; * from the results of a getattr. This gets called out of things&n; * like stat.&n; */
r_int
DECL|function|linvfs_revalidate_core
id|linvfs_revalidate_core
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/* vn_revalidate returns (-) error so this is ok */
r_return
id|vn_revalidate
c_func
(paren

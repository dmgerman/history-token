...
suffix:semicolon
multiline_comment|/*&n;&t; * Someone grabbed a reference while we weren&squot;t looking,&n;&t; * try again later.&n;&t; */
r_if
c_cond
(paren
id|unlikely
...
(paren
id|KERN_ERR
l_string|&quot;XFS: freeing inuse buffer!&bslash;n&quot;
)paren
suffix:semicolon
id|dump_stack
c_func

...
(brace
multiline_comment|/*&n;&t;&t;&t;&t;  * XXX: bp-&gt;pb_count_desired might be incorrect&n;&t;&t;&t;&t;  * (see pagebuf_associate_memory for details),&n;&t;&t;&t;&t;  * but fortunately the Linux version of&n;&t;&t;&t;&t;  * kmem_free ignores the len argument..&n;&t;&t;&t;&t;  */
id|kmem_free
c_func
(paren
id|pb-&gt;pb_addr
...
id|ENOMEM
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * This could deadlock.  But until all the&n;&t;&t;&t;&t; * XFS lowlevel code is revamped to handle&n;&t;&t;&t;&t; * buffer allocation failures we can&squot;t do&n;&t;&t;&t;&t; * much.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;possibly deadlocking in %s&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;pagebuf_get: warning, failed to lookup pages&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|no_buffer
...
multiline_comment|/* ok found all the items that can be worked on &n;&t; * drop the lock and process the private list */
id|spin_unlock
c_func
(paren
op_amp

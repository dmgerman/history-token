...
id|err
suffix:semicolon
multiline_comment|/* Use negative errors in this f&squot;n */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* We allow multiple direct writers in, there is no&n;&t; * potential call to vmtruncate in that path.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
DECL|macro|nextdp
mdefine_line|#define nextdp(dp)&t;((struct xfs_dirent *)((char *)(dp) + (dp)-&gt;d_reclen))
id|STATIC
r_int

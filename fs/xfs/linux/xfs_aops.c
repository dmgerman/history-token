...
multiline_comment|/*&n;&t;&t; * First case, allocate space for delalloc buffer head&n;&t;&t; * we can return EAGAIN here in the release page case.&n;&t;&t; */
r_if
c_cond
(paren
id|buffer_delay
...
id|page-&gt;mapping-&gt;host
suffix:semicolon
multiline_comment|/*&n;&t; * We need a transaction if:&n;&t; *  1. There are delalloc buffers on the page&n;&t; *  2. The page is upto date and we have unmapped buffers&n;&t; *  3. The page is upto date and we have no buffers&n;&t; */
r_if
c_cond
(paren
op_logical_neg

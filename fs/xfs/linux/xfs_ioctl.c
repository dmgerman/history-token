...
id|error
suffix:semicolon
multiline_comment|/* we need the path */
id|path
op_assign
id|getname
c_func
...
suffix:semicolon
multiline_comment|/* traverse the path */
id|error
op_assign
id|path_lookup
c_func
...
id|parinode
comma
multiline_comment|/* parent inode pointer&t;   */
r_int
id|cap
comma
...
suffix:semicolon
multiline_comment|/* this error is (-) but our callers expect + */
r_return
id|XFS_ERROR
c_func
(paren

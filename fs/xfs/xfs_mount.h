...
suffix:semicolon
DECL|typedef|xfs_strat_write_t
r_typedef
r_int
(paren
op_star
id|xfs_strat_write_t
)paren
(paren
r_struct
id|xfs_iocore
...
DECL|macro|XFS_MOUNT_IRIXSGID
mdefine_line|#define XFS_MOUNT_IRIXSGID&t;0x00010000&t;/* Irix-style sgid inheritance */

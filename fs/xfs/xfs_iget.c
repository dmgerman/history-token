...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * m_chash size is based on m_ihash&n;&t; * with a minimum of 37 entries&n;&t; */
id|mp-&gt;m_chsize
op_assign
(paren
id|XFS_BUCKETS
...
r_inline
r_void
DECL|function|xfs_iget_vnode_init
id|xfs_iget_vnode_init
c_func
(paren
id|xfs_mount_t
op_star
...
(brace
multiline_comment|/* If IRECLAIM is set this inode is&n;&t;&t;&t;&t; * on its way out of the system,&n;&t;&t;&t;&t; * we need to pause and try again.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|ip-&gt;i_flags
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Make sure the vnode and the inode are hooked up&n;&t;&t;&t; */
id|xfs_iget_vnode_init
c_func
(paren
id|mp
...
multiline_comment|/*&n;&t; * Vnode provided by vn_initialize.&n;&t; */
id|xfs_iget_vnode_init
c_func
(paren
id|mp
...
multiline_comment|/*&n; * A &squot;special&squot; interface to xfs_iget, where the&n; * vnode is already allocated.&n; */
r_int
DECL|function|xfs_vn_iget
id|xfs_vn_iget
c_func
(paren
id|vfs_t

...
id|uio_iovcnt
suffix:semicolon
multiline_comment|/* number of iovecs in array */
DECL|member|uio_offset
id|xfs_off_t
id|uio_offset
suffix:semicolon
multiline_comment|/* offset in file this uio corresponds to */

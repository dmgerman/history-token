...
mdefine_line|#define DM_EVENT_ENABLED_IO(vfsp, io, event) ( &bslash;&n;&t;unlikely ((vfsp)-&gt;vfs_flag &amp; VFS_DMI) &amp;&amp; &bslash;&n;&t;&t;( ((io)-&gt;io_dmevmask &amp; (1 &lt;&lt; event)) || &bslash;&n;&t;&t;  ((ip)-&gt;i_mount-&gt;m_dmevmask &amp; (1 &lt;&lt; event)) ) &bslash;&n;&t;)

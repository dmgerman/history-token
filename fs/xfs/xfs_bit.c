...
op_increment
suffix:semicolon
multiline_comment|/* set to one first offset bits prior to start */
id|tmp
op_or_assign
(paren
op_complement
...
multiline_comment|/*&n; * This takes the bit number to start looking from and&n; * returns the next set bit from there.  It returns -1&n; * if there are no more bits set or the start bit is&n; * beyond the end of the bitmap.&n; *&n; * Size is the number of words, not bytes, in the bitmap.&n; */
...
op_increment
suffix:semicolon
multiline_comment|/* set to zero first offset bits prior to start */
id|tmp
op_and_assign
(paren
op_complement

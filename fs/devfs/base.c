...
mdefine_line|#define DEVFS_VERSION            &quot;0.120 (20011103)&quot;
...
mdefine_line|#define IS_HIDDEN(de) (( ((de)-&gt;hide &amp;&amp; !is_devfsd_or_child(fs_info)) || !(de)-&gt;registered))
...
mdefine_line|#define DEBUG_I_GET        0x00080
DECL|macro|DEBUG_I_CHANGE
mdefine_line|#define DEBUG_I_CHANGE     0x00100
...
mdefine_line|#define DEBUG_ALL          0xfffff
...
(paren
id|__FUNCTION__
l_string|&quot;(): NULL de for inode %ld&bslash;n&quot;
comma
id|inode-&gt;i_ino
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;%s: devfs_do_symlink(%s): entry already exists&bslash;n&quot;
comma
id|DEVFS_NAME
comma
id|name
...
id|printk
(paren
l_string|&quot;%s: mknod(): existing entry&bslash;n&quot;
comma
id|DEVFS_NAME
)paren
suffix:semicolon

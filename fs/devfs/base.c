...
l_int|1
suffix:semicolon
multiline_comment|/*  Whether created by driver or VFS        */
DECL|member|name
r_char
id|name
(braket
...
id|EPERM
suffix:semicolon
multiline_comment|/*  First ensure the directory is empty and will stay thay way  */
id|write_lock
(paren
op_amp
id|de-&gt;u.dir.lock

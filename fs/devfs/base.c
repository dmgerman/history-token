...
mdefine_line|#define DEVFS_VERSION            &quot;0.116 (20010919)&quot;
...
id|lock
suffix:semicolon
multiline_comment|/*  Lock around the registered flag         */
DECL|member|length
r_int
r_int
id|length

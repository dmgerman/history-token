...
id|lock
suffix:semicolon
multiline_comment|/*  Lock for changes                         */
...
multiline_comment|/*  End Function devfs_find_and_unregister  */
...
id|TRUE
suffix:semicolon
multiline_comment|/*  Was not already open    */
id|spin_unlock
(paren
op_amp
id|df-&gt;lock
...
l_int|0
suffix:semicolon
multiline_comment|/*  Was already open        */
r_if
c_cond
(paren
id|df-&gt;aopen_notify

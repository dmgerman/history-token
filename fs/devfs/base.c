...
(paren
id|KERN_WARNING
l_string|&quot;%s: invalid format string&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
id|devfs_lookup_struct
op_star
DECL|function|new_devfs_lookup_struct
id|new_devfs_lookup_struct
c_func
(paren
r_void
)paren
...
r_static
r_void
DECL|function|get_devfs_lookup_struct
id|get_devfs_lookup_struct
c_func
(paren
r_struct
id|devfs_lookup_struct
...
(paren
id|KERN_ERR
l_string|&quot;null devfs_lookup_struct pointer&bslash;n&quot;
)paren
suffix:semicolon
id|dump_stack
c_func
...
r_static
r_void
DECL|function|put_devfs_lookup_struct
id|put_devfs_lookup_struct
c_func
(paren
r_struct
id|devfs_lookup_struct

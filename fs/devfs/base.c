...
mdefine_line|#define DEVFS_VERSION            &quot;1.21 (20020820)&quot;
...
mdefine_line|#define IS_HIDDEN(de) ( (de)-&gt;hide &amp;&amp; !is_devfsd_or_child(fs_info) )
...
id|num_removable
suffix:semicolon
multiline_comment|/*  Lock for writing but not reading    */
...
multiline_comment|/**&n; *&t;_devfs_get_root_entry - Get the root devfs entry.&n; *&n; *&t;Returns the root devfs entry on success, else %NULL.&n; */
...
multiline_comment|/**&n; *&t;check_disc_changed - Check if a removable disc was changed.&n; *&t;@de: The device.&n; *&n; *&t;Returns 1 if the media was changed, else 0.&n; *&n; *&t;This function may block, and may indirectly cause the parent directory&n; *&t;contents to be changed due to partition re-reading.&n; */
...
multiline_comment|/**&n; *&t;scan_dir_for_removable - Scan a directory for removable media devices and check media.&n; *&t;@dir: The directory.&n; *&n; *&t;This function may block, and may indirectly cause the directory&n; *&t;contents to be changed due to partition re-reading. The directory will&n; *&t;be locked for reading.&n; */
...
multiline_comment|/**&n; *&t;get_removable_partition - Get removable media partition.&n; *&t;@dir: The parent directory.&n; *&t;@name: The name of the entry.&n; *&t;@namelen: The number of characters in &lt;&lt;name&gt;&gt;.&n; *&n; *&t;Returns 1 if the media was changed, else 0.&n; *&n; *&t;This function may block, and may indirectly cause the directory&n; *&t;contents to be changed due to partition re-reading. The directory must&n; *&t;be locked for reading upon entry, and will be unlocked upon exit.&n; */
...
DECL|function|devfs_clear_inode
r_static
r_void
id|devfs_clear_inode
(paren
r_struct
id|inode
op_star
...
multiline_comment|/*  End Function devfs_clear_inode  */
...
suffix:semicolon
multiline_comment|/*  Now have module refcount  */
r_if
c_cond
(paren
id|S_ISBLK
...
suffix:semicolon
multiline_comment|/* Module refcount unchanged */
)brace
r_else
(brace
id|file-&gt;f_op
...
r_else
(brace
multiline_comment|/*  Fallback to legacy scheme (I don&squot;t have a module refcount)  */
r_if
c_cond
(paren
id|S_ISCHR
...
(brace
multiline_comment|/*  Change the ownership/protection to what driver specified  */
id|inode-&gt;i_mode
op_assign
id|de-&gt;mode
suffix:semicolon
...
r_else
(brace
multiline_comment|/*  Try re-reading the partition (media may have changed)  */
r_if
c_cond
(paren
id|get_removable_partition
...
multiline_comment|/*  Unlocks  */
(brace
multiline_comment|/*  Media did change  */
id|read_lock
(paren
op_amp
id|parent-&gt;u.dir.lock

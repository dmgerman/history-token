...
suffix:semicolon
multiline_comment|/**&n; *&t;devfs_dealloc_devnum - Dellocate a device number.&n; *&t;@type: The type (DEVFS_SPECIAL_CHR or DEVFS_SPECIAL_BLK).&n; *&t;@devnum: The device number.&n; *&n; *&t;This routine is thread safe and may block.&n; */

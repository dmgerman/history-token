...
multiline_comment|/*if (!tstbits(bmp, nr + n, n + forward)) {&n;&t;&t;ret = bs + nr + n;&n;&t;&t;goto rt;&n;&t;}*/
id|q
op_assign
id|nr
op_plus
...
l_int|5
suffix:semicolon
multiline_comment|/*for (i = nr + 1; i != nr; i++, i &amp;= 0x1ff) {*/
id|i
op_assign
id|nr
suffix:semicolon
...
l_int|2
suffix:semicolon
multiline_comment|/*&n;&t;if (b != -1) {&n;&t;&t;if ((sec = alloc_in_bmp(s, b&lt;&lt;14, n, f_p ? forward : forward/2))) {&n;&t;&t;&t;b &amp;= 0x0fffffff;&n;&t;&t;&t;goto ret;&n;&t;&t;}&n;&t;&t;if (b &gt; 0x10000000) if ((sec = alloc_in_bmp(s, (b&amp;0xfffffff)&lt;&lt;14, n, f_p ? forward : 0))) goto ret;&n;&t;*/
r_if
c_cond
(paren
op_logical_neg

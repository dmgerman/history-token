...
(brace
macro_line|#ifndef CONFIG_ZISOFS&t;&t;/* No flag for SF or ZF */
r_case
id|SIG
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;isofs: Can&squot;t handle ZF block size of 2^%d&bslash;n&quot;
comma
id|block_shift
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Note: we don&squot;t change i_blocks here */
id|ISOFS_I
c_func
(paren
id|inode
...
suffix:semicolon
multiline_comment|/* Parameters to compression algorithm (header size, block size) */
id|ISOFS_I
c_func
(paren
id|inode
...
(paren
id|KERN_WARNING
l_string|&quot;isofs: Unknown ZF compression algorithm: %c%c&bslash;n&quot;
comma
id|rr-&gt;u.ZF.algorithm
(braket
l_int|0

...
(brace
multiline_comment|/* Check if there is any size limit. */
id|spin_lock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t; * If the huge page allocation has failed then increment free_blocks.&n;&t; */
r_if
c_cond
(paren
(paren
...
DECL|function|hugetlbfs_unlink
r_static
r_int
id|hugetlbfs_unlink
c_func
...
DECL|function|hugetlbfs_rename
r_static
r_int
id|hugetlbfs_rename
c_func
...
DECL|function|hugetlbfs_kill_super
r_static
r_void
id|hugetlbfs_kill_super
c_func
(paren
r_struct
id|super_block

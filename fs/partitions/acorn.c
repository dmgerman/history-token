...
suffix:semicolon
multiline_comment|/*&n; * Purpose: initialise all the partitions on an ADFS drive.&n; *          These may be other ADFS partitions or a Linux/RiscBSD/RISCiX&n; *&t;    partition.&n; *&n; * Params : hd&t;&t;- pointer to gendisk structure&n; *          dev&t;&t;- device number to access&n; *&n; * Returns: -1 on error, 0 if not ADFS format, 1 if ok.&n; */

...
DECL|macro|UNUSED_ENTRY_GUID
mdefine_line|#define UNUSED_ENTRY_GUID    &bslash;&n;    ((efi_guid_t) { 0x00000000, 0x0000, 0x0000, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }})
DECL|macro|PARTITION_SYSTEM_GUID
mdefine_line|#define PARTITION_SYSTEM_GUID &bslash;&n;((efi_guid_t) { 0xC12A7328, 0xF81F, 0x11d2, { 0xBA, 0x4B, 0x00, 0xA0, 0xC9, 0x3E, 0xC9, 0x3B }})
DECL|macro|LEGACY_MBR_PARTITION_GUID
mdefine_line|#define LEGACY_MBR_PARTITION_GUID &bslash;&n;    ((efi_guid_t) { 0x024DEE41, 0x33E7, 0x11d3, { 0x9D, 0x69, 0x00, 0x08, 0xC7, 0x81, 0xF3, 0x9F }})
DECL|macro|PARTITION_MSFT_RESERVED_GUID
mdefine_line|#define PARTITION_MSFT_RESERVED_GUID &bslash;&n;    ((efi_guid_t) { 0xE3C9E316, 0x0B5C, 0x4DB8, { 0x81, 0x7D, 0xF9, 0x2D, 0xF0, 0x02, 0x15, 0xAE }})
DECL|macro|PARTITION_BASIC_DATA_GUID
mdefine_line|#define PARTITION_BASIC_DATA_GUID &bslash;&n;    ((efi_guid_t) { 0xEBD0A0A2, 0xB9E5, 0x4433, { 0x87, 0xC0, 0x68, 0xB6, 0xB7, 0x26, 0x99, 0xC7 }})
DECL|macro|PARTITION_LINUX_RAID_GUID
mdefine_line|#define PARTITION_LINUX_RAID_GUID &bslash;&n;    ((efi_guid_t) { 0xa19d880f, 0x05fc, 0x4d3b, { 0xa0, 0x06, 0x74, 0x3f, 0x0f, 0x84, 0x91, 0x1e  }})
DECL|macro|PARTITION_LINUX_SWAP_GUID
mdefine_line|#define PARTITION_LINUX_SWAP_GUID &bslash;&n;    ((efi_guid_t) { 0x0657fd6d, 0xa4ab, 0x43c4, { 0x84, 0xe5, 0x09, 0x33, 0xc8, 0x4b, 0x4f, 0x4f  }})
DECL|macro|PARTITION_LINUX_LVM_GUID
mdefine_line|#define PARTITION_LINUX_LVM_GUID &bslash;&n;    ((efi_guid_t) { 0xe6d6d379, 0xf507, 0x44c2, { 0xa2, 0x3c, 0x23, 0x8f, 0x2a, 0x3d, 0xf9, 0x28 }})

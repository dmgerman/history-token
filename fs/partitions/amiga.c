...
l_int|1
suffix:semicolon
multiline_comment|/* Multiplier for disk block size */
r_int
id|slot
op_assign
l_int|1
...
multiline_comment|/* blksize is blocks per 512 byte standard block */
id|blksize
op_assign
id|be32_to_cpu
c_func
(paren
id|rdb-&gt;rdb_BlockBytes
)paren
op_div
l_int|512
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Be more informative */
id|blk
op_assign
id|be32_to_cpu
c_func
...
id|blksize
suffix:semicolon
multiline_comment|/* Read in terms partition table understands */
id|data
op_assign
id|read_dev_sector
c_func
...
suffix:semicolon
(brace
multiline_comment|/* Be even more informative to aid mounting */
r_char
id|dostype
(braket
l_int|4

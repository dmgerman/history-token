...
c_func
(paren
l_string|&quot;Found basic MS-DOS partition, not a dynamic disk.&bslash;n&quot;
)paren
suffix:semicolon
id|no_msdos_partition
suffix:colon
...
(brace
multiline_comment|/* 1024 bytes */
id|ldm_debug
c_func
(paren
l_string|&quot;Expected a blocksize of %d bytes, got %d instead.&bslash;n&quot;
comma
id|LDM_BLOCKSIZE
comma
id|get_ptable_blocksize
...
c_func
(paren
l_string|&quot;Expected a sector size of %d bytes, got %d &quot;
...
id|out
suffix:semicolon
multiline_comment|/* For convenience, work with the LDM database device from now on. */
id|devdb
op_assign
id|MKDEV
c_func

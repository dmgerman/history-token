...
multiline_comment|/**&n; * find_db_partition - find our database&n; * @dev:&t;device of which to create partition&n; * @ph:&t;&t;@dev&squot;s LDM database private header&n; *&n; * Find the primary private header and the LDM database&n; * partition to wrap it.&n; *&n; * Return 1 on succes, 0 if device is not a dynamic disk and -1 on error.&n; */
DECL|function|find_db_partition
r_static
r_int
id|find_db_partition
c_func
(paren
r_struct
id|block_device

...
multiline_comment|/* some places do blksize_size[major][minor] = 1024,&n;&t;   as preparation for reading partition table - superfluous */
multiline_comment|/* sd.c used to set blksize_size to 2048 in case&n;&t;   rscsi_disks[target].device-&gt;sector_size == 2048 */
r_return
l_int|0
suffix:semicolon
)brace

...
DECL|macro|__PRIPTR_PREFIX
macro_line|#  define __PRIPTR_PREFIX&t;&quot;l&quot;
macro_line|# else
DECL|macro|__PRI64_PREFIX
macro_line|#  define __PRI64_PREFIX&t;&quot;ll&quot;
DECL|macro|__PRIPTR_PREFIX
macro_line|#  define __PRIPTR_PREFIX
macro_line|# endif
DECL|macro|PRIx64
...
suffix:semicolon
multiline_comment|/**&n; * le_efi_guid_to_cpus()&n; * @guid&n; *&n; * Description: modifies @guid in situ&n; *&n; * This function converts a little endian efi_guid_t to the&n; * native cpu representation.  The EFI Spec. declares that all &n; * on-disk structures are stored in little endian format.&n; */
r_static
r_void
DECL|function|le_efi_guid_to_cpus
id|le_efi_guid_to_cpus
c_func
(paren
id|efi_guid_t
op_star
...
suffix:semicolon
multiline_comment|/* no need to change the rest. It&squot;s already an array of chars */
r_return
suffix:semicolon
)brace
...
multiline_comment|/**&n; * le_part_attributes_to_cpus(): converts LE attributes to CPU type in situ&n; * @attributes - ptr to partition attributes&n; * &n; * Description:  modifies attributes in situ, returns nothing.&n; * Converts a little endian partition attributes struct to the&n; * native cpu representation.  Good for reading attributes off of a disk.&n; */
r_static
r_void
DECL|function|le_part_attributes_to_cpus
id|le_part_attributes_to_cpus
c_func
(paren
...
multiline_comment|/**&n; * print_gpt_header(): unparses gpt header to console&n; * @gpt: gpt header&n; */
r_static
r_void
DECL|function|print_gpt_header
id|print_gpt_header
c_func
(paren
id|gpt_header
...
c_func
(paren
l_string|&quot;GUID Partition Table Header&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;header_size                 : %x&bslash;n&quot;
comma
id|gpt-&gt;header_size
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;header_crc32                : %x&bslash;n&quot;
comma
id|gpt-&gt;header_crc32
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;alternate_lba               : %&quot;
id|PRIx64
l_string|&quot;&bslash;n&quot;
comma
id|gpt-&gt;alternate_lba
)paren
suffix:semicolon
id|Dprintk
c_func
(paren
l_string|&quot;first_usable_lba            : %&quot;
id|PRIx64
l_string|&quot;&bslash;n&quot;
comma
id|gpt-&gt;first_usable_lba
)paren
suffix:semicolon
id|Dprintk
c_func
(paren
l_string|&quot;last_usable_lba             : %&quot;
id|PRIx64
l_string|&quot;&bslash;n&quot;
comma
id|gpt-&gt;last_usable_lba
)paren
suffix:semicolon
id|Dprintk
c_func
(paren
l_string|&quot;partition_entry_lba         : %&quot;
id|PRIx64
l_string|&quot;&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;num_partition_entries       : %x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;sizeof_partition_entry      : %x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;partition_entry_array_crc32 : %x&bslash;n&quot;
comma
id|gpt-&gt;partition_entry_array_crc32
)paren
suffix:semicolon
r_return
suffix:semicolon
...
multiline_comment|/* Fixup endianness */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* Check the Primary GPT */
id|good_pgpt
op_assign
id|is_gpt_valid
c_func
...
(brace
multiline_comment|/* Primary GPT is OK, check the alternate and warn if bad */
id|good_agpt
op_assign
id|is_gpt_valid
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;Alternate GPT is invalid, using primary GPT.&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|compare_gpts
...
multiline_comment|/* if primary is valid */
r_else
(brace
multiline_comment|/* Primary GPT is bad, check the Alternate GPT */
id|good_agpt
op_assign
id|is_gpt_valid
c_func
...
(brace
multiline_comment|/* Primary is bad, alternate is good.&n;&t;&t;&t;   Return values from the alternate and warn.&n;&t;&t;&t; */
id|printk
c_func
(paren
id|KERN_WARNING
...
multiline_comment|/* Now test for valid PMBR */
...
id|printk
(paren
l_string|&quot; Warning: Disk has a valid GPT signature but invalid PMBR.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;  Use gpt kernel option to override.  Use GNU Parted to correct disk.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/* Both primary and alternate GPTs are bad, and/or PMBR is invalid.&n;&t; * This isn&squot;t our disk, return 0.&n;&t; */
r_if
c_cond
(paren
id|pgpt

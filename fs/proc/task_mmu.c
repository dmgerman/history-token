...
suffix:semicolon
multiline_comment|/*&n;&t; * Print the dentry name for named mappings, and a&n;&t; * special [heap] marker for the heap:&n;&t; */
r_if
c_cond
(paren
id|map-&gt;vm_file
...
multiline_comment|/* map is copied successfully */
id|m-&gt;version
op_assign
(paren
id|map
...
id|pos
suffix:semicolon
multiline_comment|/*&n;&t; * We remember last_addr rather than next_addr to hit with&n;&t; * mmap_cache most of the time. We have zero last_addr at&n;&t; * the begining and also after lseek. We will have -1 last_addr&n;&t; * after the end of the maps.&n;&t; */
r_if
c_cond
(paren
id|last_addr
...
suffix:semicolon
multiline_comment|/* Start with last addr hint */
r_if
c_cond
(paren
id|last_addr
...
multiline_comment|/*&n;&t; * Check the map index is within the range and do&n;&t; * sequential scan until m_index.&n;&t; */
id|map
op_assign
l_int|NULL
suffix:semicolon
...
l_int|NULL
suffix:semicolon
multiline_comment|/* After gate map */
id|out
suffix:colon
r_if
c_cond
...
id|map
suffix:semicolon
multiline_comment|/* End of maps has reached */
id|m-&gt;version
op_assign
(paren
id|tail_map

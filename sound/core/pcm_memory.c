...
l_int|16384
suffix:semicolon
multiline_comment|/*&n; * allocate pages on the specified bus&n; */
DECL|function|alloc_pcm_pages
r_static
r_int
id|alloc_pcm_pages
c_func
...
DECL|function|alloc_pcm_pages_fallback
r_static
r_int
id|alloc_pcm_pages_fallback
c_func
(paren
id|snd_pcm_substream_t
op_star
...
multiline_comment|/*&n; * release the pages on the specified bus&n; */
DECL|function|free_pcm_pages
r_static
r_void
id|free_pcm_pages
c_func

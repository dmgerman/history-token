...
DECL|function|snd_rawmidi_event_tasklet
r_static
r_void
id|snd_rawmidi_event_tasklet
c_func
(paren
r_int
r_int
...
DECL|function|snd_rawmidi_trigger
r_static
r_void
id|snd_rawmidi_trigger
c_func
(paren
id|snd_rawmidi_substream_t
op_star
...
(paren
op_amp
id|substream-&gt;runtime-&gt;event_tasklet
)paren
suffix:semicolon
)brace

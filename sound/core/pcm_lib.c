...
multiline_comment|/*&n; * fill ring buffer with silence&n; * runtime-&gt;silenced_start: starting pointer to silence area&n; * runtime-&gt;silenced_size: size filled with silence&n; * runtime-&gt;silence_threshold: threshold from application&n; * runtime-&gt;silence_size: maximal size from application&n; *&n; * when runtime-&gt;silence_size &gt;= runtime-&gt;boundary - fill processed area with silence immediately&n; */

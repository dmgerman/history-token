...
r_static
r_void
id|snd_generic_device_unregister
c_func
(paren
r_struct
...
macro_line|#ifdef CONFIG_SND_GENERIC_PM
multiline_comment|/*&n; * use platform_device for generic power-management without a proper bus&n; * (e.g. ISA)&n; */
DECL|struct|snd_generic_device
r_struct
id|snd_generic_device
(brace
DECL|member|pdev
...
suffix:semicolon
DECL|macro|get_snd_generic_card
mdefine_line|#define get_snd_generic_card(dev)&t;container_of(to_platform_device(dev), struct snd_generic_device, pdev)-&gt;card
DECL|macro|SND_GENERIC_NAME
mdefine_line|#define SND_GENERIC_NAME&t;&quot;snd_generic_pm&quot;
r_static
r_int
id|snd_generic_suspend
c_func
(paren
r_struct
id|device
...
suffix:semicolon
DECL|variable|snd_generic_driver
r_static
r_struct
id|device_driver
id|snd_generic_driver
op_assign
(brace
dot
id|name
...
suffix:semicolon
DECL|variable|generic_driver_registered
r_static
r_int
id|generic_driver_registered
suffix:semicolon
DECL|function|generic_driver_unregister
r_static
r_void
id|generic_driver_unregister
c_func
(paren
r_void
)paren
...
DECL|function|snd_generic_device_register
r_static
r_struct
id|snd_generic_device
op_star
id|snd_generic_device_register
c_func
(paren
id|snd_card_t
op_star
...
DECL|function|snd_generic_device_unregister
r_static
r_void
id|snd_generic_device_unregister
c_func
...
multiline_comment|/* suspend/resume callbacks for snd_generic platform device */
DECL|function|snd_generic_suspend
r_static
r_int
id|snd_generic_suspend
c_func
...
DECL|function|snd_generic_resume
r_static
r_int
id|snd_generic_resume
c_func
...
multiline_comment|/**&n; * snd_card_set_generic_pm_callback - set the generic power-management callbacks&n; * @card: soundcard structure&n; * @suspend: suspend callback function&n; * @resume: resume callback function&n; * @private_data: private data to pass to the callback functions&n; *&n; * Registers the power-management and sets the lowlevel callbacks for&n; * the given card.  These callbacks are called from the ALSA&squot;s common&n; * PM handler and from the control API.&n; */
DECL|function|snd_card_set_generic_pm_callback
r_int
...
macro_line|#endif /* CONFIG_SND_GENERIC_PM */

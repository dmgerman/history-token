...
multiline_comment|/**&n; * snd_dma_free_pages - release the allocated buffer&n; * @dev: the buffer device info&n; * @dmab: the buffer allocation record to release&n; *&n; * Releases the allocated buffer via snd_dma_alloc_pages().&n; */

...
multiline_comment|/*&n; * delete the timer instance from active list.&n; *&n; * call this from the timer callback only!&n; */
DECL|function|snd_timer_del
r_int
id|snd_timer_del
c_func
(paren

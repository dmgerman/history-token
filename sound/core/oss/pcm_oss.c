...
mdefine_line|#define OSS_ALSAEMULVER&t;&t;_SIOR (&squot;M&squot;, 249, int)
...
suffix:semicolon
DECL|variable|SNDRV_MINOR_OSS_PCM1
id|MODULE_ALIAS_SNDRV_MINOR
c_func
(paren
...
DECL|function|snd_pcm_alsa_frames
r_static
r_int
id|snd_pcm_alsa_frames
c_func
(paren
id|snd_pcm_substream_t
op_star
...
suffix:semicolon
multiline_comment|/* try multiples of the best rate */
id|rate
op_assign
id|best_rate
suffix:semicolon
...
id|substream-&gt;oss.setup
op_logical_and
id|substream-&gt;oss.setup-&gt;nosilence
)paren
)paren
(brace
...
DECL|function|snd_pcm_oss_capture_position_fixup
r_static
r_int
id|snd_pcm_oss_capture_position_fixup
c_func
(paren
id|snd_pcm_substream_t
op_star
...
r_break
suffix:semicolon
multiline_comment|/* in case of overrun, skip whole periods like OSS/Linux driver does */
multiline_comment|/* until avail(delay) &lt;= buffer_size */
id|frames
op_assign
(paren
op_star
...
c_func
(paren
l_string|&quot;pcm_oss: write: recovering from XRUN&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|printk
c_func
(paren
l_string|&quot;pcm_oss: write: recovering from SUSPEND&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|ret
...
c_func
(paren
l_string|&quot;pcm_oss: read: recovering from XRUN&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|printk
c_func
(paren
l_string|&quot;pcm_oss: read: recovering from SUSPEND&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|ret
...
c_func
(paren
l_string|&quot;pcm_oss: writev: recovering from XRUN&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|printk
c_func
(paren
l_string|&quot;pcm_oss: writev: recovering from SUSPEND&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|ret
...
c_func
(paren
l_string|&quot;pcm_oss: readv: recovering from XRUN&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|printk
c_func
(paren
l_string|&quot;pcm_oss: readv: recovering from SUSPEND&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|ret
...
l_int|NULL
op_logical_and
id|substream-&gt;oss.setup-&gt;partialfrag
)paren
op_logical_or
id|runtime-&gt;oss.buffer_used
op_eq
...
DECL|function|snd_pcm_oss_post
r_static
r_int
id|snd_pcm_oss_post
c_func
...
multiline_comment|/* note: all errors from the start action are ignored */
multiline_comment|/* OSS apps do not know, how to handle them */
r_return
l_int|0
suffix:semicolon
)brace
DECL|function|snd_pcm_oss_sync1
r_static
r_int
id|snd_pcm_oss_sync1
c_func
(paren
id|snd_pcm_substream_t
op_star
...
c_func
(paren
l_string|&quot;sync1: size = %li&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;OSS sync error - DMA timeout&bslash;n&quot;
)paren
suffix:semicolon
id|result
op_assign
...
c_func
(paren
l_string|&quot;sync: buffer_used&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|size
...
c_func
(paren
l_string|&quot;sync: period_ptr&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|size
...
multiline_comment|/*&n;&t;&t; * The ALSA&squot;s period might be a bit large than OSS one.&n;&t;&t; * Fill the remain portion of ALSA period with zeros.&n;&t;&t; */
id|size
op_assign
...
multiline_comment|/*&n;&t;&t; * finish sync: drain the buffer&n;&t;&t; */
id|__direct
suffix:colon
id|saved_f_flags
op_assign
...
c_func
(paren
l_string|&quot;pcm_oss: trigger = 0x%x&bslash;n&quot;
comma
id|trigger
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;pcm_oss: space: bytes = %i, fragments = %i, fragstotal = %i, fragsize = %i&bslash;n&quot;
comma
id|info.bytes
comma
id|info.fragments
...
c_func
(paren
l_string|&quot;pcm_oss: ioctl = 0x%x&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
DECL|macro|snd_pcm_oss_ioctl_compat
mdefine_line|#define snd_pcm_oss_ioctl_compat&t;snd_pcm_oss_ioctl
macro_line|#else
DECL|macro|snd_pcm_oss_ioctl_compat
mdefine_line|#define snd_pcm_oss_ioctl_compat&t;NULL
macro_line|#endif
...
c_func
(paren
l_string|&quot;pcm_oss: read %li bytes (returned %li bytes)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;pcm_oss: write %li bytes (wrote %li bytes)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;pcm_oss: mmap begin&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|pcm_oss_file
...
c_func
(paren
l_string|&quot;pcm_oss: mmap ok, bytes = 0x%x&bslash;n&quot;
comma
id|runtime-&gt;oss.mmap_bytes
)paren
suffix:semicolon
...
id|buffer
comma
l_string|&quot;%s %u %u%s%s%s%s%s%s&bslash;n&quot;
comma
id|setup-&gt;task_name
comma
id|setup-&gt;periods
...
l_string|&quot;&quot;
comma
id|setup-&gt;partialfrag
ques
c_cond
l_string|&quot; partial-frag&quot;
suffix:colon
l_string|&quot;&quot;
comma
id|setup-&gt;nosilence
...
DECL|function|snd_pcm_oss_disconnect_minor
r_static
r_int
id|snd_pcm_oss_disconnect_minor
c_func
(paren
id|snd_pcm_t
op_star

...
id|s1
suffix:semicolon
multiline_comment|/* unlock all streams */
id|snd_pcm_group_for_each
c_func
(paren
id|pos
...
multiline_comment|/*&n; *  Note: call with stream lock&n; *&n; * NB2: this won&squot;t handle the non-atomic callbacks&n; */
...
multiline_comment|/*&n; *  Note: don&squot;t use any locks before&n; *&n; * NB2: this can handle the non-atomic callbacks if allow_nonatomic = 1&n; *      when the pcm-&gt;info_flags has NONATOMIC_OPS bit, it&squot;s handled&n; *      ouside the lock to allow sleep in the callback.&n; */
...
(brace
multiline_comment|/* now process the non-atomic substreams separately&n;&t;&t;&t; * outside the lock&n;&t;&t;&t; */
DECL|macro|MAX_LINKED_STREAMS
mdefine_line|#define MAX_LINKED_STREAMS&t;16&t;/* FIXME: should be variable */
r_struct
id|list_head
op_star
id|pos
...
l_int|0
suffix:semicolon
multiline_comment|/* don&squot;t proceed */
r_break
suffix:semicolon
)brace
id|s
...
suffix:semicolon
multiline_comment|/* process outside the lock */
r_return
id|snd_pcm_action_single
c_func
(paren
...
suffix:semicolon
multiline_comment|/**&n; * snd_pcm_start&n; */
...
suffix:semicolon
multiline_comment|/* allow sleep if specified */
id|snd_power_unlock
c_func
(paren
id|card

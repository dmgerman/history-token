...
suffix:semicolon
DECL|variable|snd_compat_mem_region
id|EXPORT_SYMBOL
c_func
(paren
id|snd_compat_mem_region
)paren
suffix:semicolon
DECL|variable|snd_compat_request_region
id|EXPORT_SYMBOL
c_func
(paren
id|snd_compat_request_region
)paren
suffix:semicolon
DECL|variable|snd_compat_release_resource
id|EXPORT_SYMBOL
c_func
(paren
id|snd_compat_release_resource
)paren
suffix:semicolon
macro_line|#endif
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,3,0) &amp;&amp; defined(CONFIG_PCI)
DECL|variable|snd_pci_compat_match_device
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_match_device
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_register_driver
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_register_driver
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_unregister_driver
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_unregister_driver
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_get_size
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_get_size
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_get_flags
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_get_flags
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_set_power_state
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_set_power_state
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_enable_device
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_enable_device
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_find_capability
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_find_capability
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_alloc_consistent
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_alloc_consistent
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_free_consistent
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_free_consistent
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_dma_supported
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_dma_supported
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_get_dma_mask
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_get_dma_mask
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_set_dma_mask
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_set_dma_mask
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_get_driver_data
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_get_driver_data
)paren
suffix:semicolon
DECL|variable|snd_pci_compat_set_driver_data
id|EXPORT_SYMBOL
c_func
(paren
id|snd_pci_compat_set_driver_data
)paren
suffix:semicolon
macro_line|#endif
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,3,0) &amp;&amp; defined(CONFIG_PM)
...
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,3,0)
DECL|variable|snd_wrapper_kill_fasync
id|EXPORT_SYMBOL
c_func
(paren
id|snd_wrapper_kill_fasync
)paren
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_SND_DEBUG_MEMORY

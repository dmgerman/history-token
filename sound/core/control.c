...
multiline_comment|/**&n; * snd_ctl_add - add the control instance to the card&n; * @card: the card instance&n; * @kcontrol: the control instance to add&n; *&n; * Adds the control instance created via snd_ctl_new() or&n; * snd_ctl_new1() to the given card.&n; *&n; * Returns zero if successful, or a negative error code on failure.&n; *&n; * It frees automatically the control which cannot be added.&n; */
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* FIXME: find a hole */
)brace
id|list_add_tail
c_func
(paren

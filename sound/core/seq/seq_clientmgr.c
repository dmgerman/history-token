...
multiline_comment|/*&n; * expand a quoted event.&n; */
DECL|function|expand_quoted_event
r_static
r_int
id|expand_quoted_event
c_func
(paren
id|snd_seq_event_t
op_star
...
id|quoted-&gt;source
suffix:semicolon
multiline_comment|/* don&squot;t use quoted destination */
id|event-&gt;data
op_assign
id|quoted-&gt;data
suffix:semicolon
multiline_comment|/* use quoted timestamp only if subscription/port didn&squot;t update it */
r_if
c_cond
(paren
id|event-&gt;queue

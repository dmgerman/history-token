...
r_static
r_int
id|snd_seq_device_dev_disconnect
c_func
(paren
id|snd_device_t
op_star
...
multiline_comment|/*&n; * disconnect the device&n; */
DECL|function|snd_seq_device_dev_disconnect
r_static
r_int
id|snd_seq_device_dev_disconnect
c_func

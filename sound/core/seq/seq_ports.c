...
suffix:semicolon
multiline_comment|/* timestamping */
id|port-&gt;timestamping
op_assign
(paren
id|info-&gt;flags
op_amp
id|SNDRV_SEQ_PORT_FLG_TIMESTAMP
)paren
ques
c_cond
l_int|1
...
id|info-&gt;flags
op_amp
id|SNDRV_SEQ_PORT_FLG_TIME_REAL
)paren
ques
c_cond
l_int|1

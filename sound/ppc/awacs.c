...
c_func
(paren
l_string|&quot;snd_pmac_screamer_wait timeout&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
mdefine_line|#define AWACS_VOLUME(xname, xreg, xshift, xinverted) &bslash;&n;{ .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = 0, &bslash;&n;  .info = snd_pmac_awacs_info_volume, &bslash;&n;  .get = snd_pmac_awacs_get_volume, &bslash;&n;  .put = snd_pmac_awacs_put_volume, &bslash;&n;  .private_value = (xreg) | ((xshift) &lt;&lt; 8) | ((xinverted) &lt;&lt; 16) }
...
(brace
multiline_comment|/* reset power bits in reg 6 */
id|mdelay
c_func
(paren
l_int|5

...
id|flags
suffix:semicolon
multiline_comment|/* this function is supposed to be called atomically,&n;&t; * so we check the lock.  if it&squot;s busy, just returns 0 to&n;&t; * tell the caller the busy state&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp

...
(paren
id|KERN_ERR
l_string|&quot;cannot add control&bslash;n&quot;
)paren
suffix:semicolon
id|snd_ctl_free_one
c_func
...
(paren
id|KERN_ERR
l_string|&quot;cannot malloc kcontrol&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%d:%d: cannot get min/max values for control %d&bslash;n&quot;
comma
id|cval-&gt;id
comma
id|cval-&gt;ctrlif
...
(paren
id|KERN_INFO
l_string|&quot;[%d] FU [%s] ch = %d, val = %d/%d&bslash;n&quot;
comma
id|cval-&gt;id
comma
id|kctl-&gt;id.name
...
(paren
id|KERN_ERR
l_string|&quot;cannot get min/max values for mixer&bslash;n&quot;
)paren
suffix:semicolon
id|snd_magic_kfree
c_func
...
(paren
id|KERN_ERR
l_string|&quot;invalid %s descriptor %d&bslash;n&quot;
comma
id|name
comma
id|unitid
...
(paren
id|KERN_ERR
l_string|&quot;cannot get min/max values for proc/ext unit&bslash;n&quot;
)paren
suffix:semicolon
id|snd_magic_kfree
c_func

...
(paren
id|KERN_ERR
l_string|&quot;invalid MIXER UNIT descriptor %d&bslash;n&quot;
comma
id|unitid
)paren
suffix:semicolon
...
multiline_comment|/* no bmControls field (e.g. Maya44) -&gt; ignore */
r_if
c_cond
(paren
id|desc
...
(paren
id|KERN_INFO
l_string|&quot;MU %d has no bmControls field&bslash;n&quot;
comma
id|unitid
)paren
suffix:semicolon

...
(paren
id|KERN_ERR
l_string|&quot;cannot get min/max values for mixer (id %d)&bslash;n&quot;
comma
id|unitid
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cannot get min/max values for proc/ext control=%d, id=%d&bslash;n&quot;
comma
id|cval-&gt;control
comma
id|unitid
...
(paren
id|KERN_ERR
l_string|&quot;invalid min/max values (%d/%d) for proc/ext unit control=%d, id=%d&bslash;n&quot;
comma
id|cval-&gt;min
comma
id|cval-&gt;max

...
DECL|member|next_urb_complete
r_int
id|next_urb_complete
suffix:semicolon
...
c_func
(paren
l_string|&quot;activ frame status %i&bslash;n&quot;
comma
id|urb-&gt;iso_frame_desc
(braket
id|i
...
DECL|function|usX2Y_subs_set_next_urb_complete
r_static
r_void
id|usX2Y_subs_set_next_urb_complete
c_func
(paren
id|snd_usX2Y_substream_t
op_star
...
c_func
(paren
id|subs-&gt;completed_urb-&gt;start_frame
comma
id|subs-&gt;urb
(braket
id|next_urb_complete
...
c_func
(paren
l_string|&quot;distance %i not set_nuc %i %i %i &bslash;n&quot;
comma
id|distance
comma
id|subs-&gt;endpoint
...
id|playbacksubs-&gt;urb
(braket
id|playbacksubs-&gt;next_urb_complete
op_plus
l_int|1
)braket
suffix:semicolon
...
id|substream
op_logical_and
id|substream-&gt;running
)paren
id|snd_pcm_stop
c_func
(paren
id|substream-&gt;pcm_substream
comma
id|SNDRV_PCM_STATE_XRUN
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Sequence Error!(ep=%i;nuc=%i,frame=%i)&bslash;n&quot;
comma
id|subs-&gt;endpoint
comma
id|subs-&gt;next_urb_complete
...
l_int|0
op_logical_or
singleline_comment|// other expected later
id|playbacksubs-&gt;stalled
)paren
)paren
)paren
)paren
...
DECL|function|usX2Y_urbs_capt_start
r_static
r_int
id|usX2Y_urbs_capt_start
c_func
(paren
id|snd_usX2Y_substream_t
op_star
...
DECL|function|usX2Y_urbs_wait_clear
r_static
r_int
id|usX2Y_urbs_wait_clear
c_func
(paren
id|snd_usX2Y_substream_t
op_star
...
c_func
(paren
l_string|&quot;snd_usX2Y_urbs_wait_clear waiting&bslash;n&quot;
)paren
suffix:semicolon
id|schedule_timeout
c_func
...
DECL|function|usX2Y_substream_prepare
r_static
r_void
id|usX2Y_substream_prepare
c_func
(paren
id|snd_usX2Y_substream_t
op_star
...
c_func
(paren
l_string|&quot;usX2Y_substream_prepare() ep=%i urb0=%p urb1=%p&bslash;n&quot;
comma
id|subs-&gt;endpoint
comma
id|subs-&gt;urb
...
c_func
(paren
l_string|&quot;starting capture pipe for playpipe&bslash;n&quot;
)paren
suffix:semicolon
id|usX2Y_urbs_allocate
c_func
...
c_func
(paren
l_string|&quot;ep=%i waiting for urb=%p status=%i hcpriv=%p&bslash;n&quot;
comma
id|subs-&gt;endpoint
comma
id|subs-&gt;urb
...
DECL|function|snd_usX2Y_device_dev_free
r_static
r_int
id|snd_usX2Y_device_dev_free
c_func
(paren
id|snd_device_t
op_star
...
(brace
singleline_comment|//&t;&t;snd_usX2Y_audio_free(usX2Y(card));
r_return
id|err
suffix:semicolon
)brace

...
multiline_comment|/* this code is not exported from USB core anymore */
DECL|function|local_usb_ifnum_to_if
r_struct
id|usb_interface
op_star
id|local_usb_ifnum_to_if
c_func
(paren
r_struct
id|usb_device
...
macro_line|#else
DECL|macro|local_usb_ifnum_to_if
mdefine_line|#define local_usb_ifnum_to_if usb_ifnum_to_if
macro_line|#endif

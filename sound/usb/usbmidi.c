...
suffix:semicolon
DECL|member|init_out_endpoint
r_void
(paren
op_star
id|init_out_endpoint
)paren
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
suffix:semicolon
DECL|member|finish_out_endpoint
r_void
(paren
op_star
id|finish_out_endpoint
)paren
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
multiline_comment|/*&n; * Receives a chunk of MIDI data.&n; */
DECL|function|snd_usbmidi_input_data
r_static
r_void
id|snd_usbmidi_input_data
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
multiline_comment|/* helper function to send static data that may not DMA-able */
DECL|function|send_bulk_static_data
r_static
r_int
id|send_bulk_static_data
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
multiline_comment|/*&n; * Standard USB MIDI protocol: see the spec.&n; * Midiman protocol: like the standard protocol, but the control byte is the&n; * fourth byte in each packet, and uses length instead of CIN.&n; */
DECL|function|snd_usbmidi_standard_input
r_static
r_void
id|snd_usbmidi_standard_input
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
DECL|function|snd_usbmidi_midiman_input
r_static
r_void
id|snd_usbmidi_midiman_input
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
DECL|function|snd_usbmidi_output_standard_packet
r_static
r_void
id|snd_usbmidi_output_standard_packet
c_func
(paren
r_struct
id|urb
...
multiline_comment|/*&n; * Adds one Midiman packet to the output buffer.&n; */
DECL|function|snd_usbmidi_output_midiman_packet
r_static
r_void
id|snd_usbmidi_output_midiman_packet
c_func
(paren
r_struct
id|urb
...
op_assign
id|port-&gt;ep-&gt;umidi-&gt;usb_protocol_ops-&gt;output_packet
suffix:semicolon
r_if
c_cond
(paren
...
DECL|function|snd_usbmidi_standard_output
r_static
r_void
id|snd_usbmidi_standard_output
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
id|p
suffix:semicolon
multiline_comment|/* FIXME: lower-numbered ports can starve higher-numbered ports */
r_for
c_loop
(paren
id|p
...
DECL|variable|snd_usbmidi_standard_ops
r_static
r_struct
id|usb_protocol_ops
id|snd_usbmidi_standard_ops
op_assign
(brace
dot
id|input
...
suffix:semicolon
DECL|variable|snd_usbmidi_midiman_ops
r_static
r_struct
id|usb_protocol_ops
id|snd_usbmidi_midiman_ops
op_assign
(brace
dot
id|input
...
suffix:semicolon
multiline_comment|/*&n; * Novation USB MIDI protocol: number of data bytes is in the first byte&n; * (when receiving) (+1!) or in the second byte (when sending); data begins&n; * at the third byte.&n; */
DECL|function|snd_usbmidi_novation_input
r_static
r_void
id|snd_usbmidi_novation_input
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
DECL|function|snd_usbmidi_novation_output
r_static
r_void
id|snd_usbmidi_novation_output
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
DECL|variable|snd_usbmidi_novation_ops
r_static
r_struct
id|usb_protocol_ops
id|snd_usbmidi_novation_ops
op_assign
(brace
dot
id|input
...
suffix:semicolon
multiline_comment|/*&n; * Mark of the Unicorn USB MIDI protocol: raw MIDI.&n; */
DECL|function|snd_usbmidi_motu_input
r_static
r_void
id|snd_usbmidi_motu_input
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
DECL|function|snd_usbmidi_motu_output
r_static
r_void
id|snd_usbmidi_motu_output
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
DECL|variable|snd_usbmidi_motu_ops
r_static
r_struct
id|usb_protocol_ops
id|snd_usbmidi_motu_ops
op_assign
(brace
dot
id|input
...
suffix:semicolon
multiline_comment|/*&n; * Emagic USB MIDI protocol: raw MIDI with &quot;F5 xx&quot; port switching.&n; */
DECL|function|snd_usbmidi_emagic_init_out
r_static
r_void
id|snd_usbmidi_emagic_init_out
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
op_assign
(brace
multiline_comment|/* initialization magic: &quot;get version&quot; */
l_int|0xf0
comma
l_int|0x00
comma
...
l_int|0x31
comma
multiline_comment|/* Emagic */
l_int|0x64
comma
multiline_comment|/* Unitor8 */
l_int|0x0b
comma
multiline_comment|/* version number request */
l_int|0x00
comma
multiline_comment|/* command version */
l_int|0x00
comma
multiline_comment|/* EEPROM, box 0 */
l_int|0xf7
)brace
suffix:semicolon
id|send_bulk_static_data
...
suffix:semicolon
multiline_comment|/* while we&squot;re at it, pour on more magic */
id|send_bulk_static_data
c_func
(paren
id|ep
...
DECL|function|snd_usbmidi_emagic_finish_out
r_static
r_void
id|snd_usbmidi_emagic_finish_out
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
op_assign
(brace
multiline_comment|/* switch to patch mode with last preset */
l_int|0xf0
comma
l_int|0x00
comma
...
l_int|0x10
comma
multiline_comment|/* patch switch command */
l_int|0x00
comma
multiline_comment|/* command version */
l_int|0x7f
comma
multiline_comment|/* to all boxes */
l_int|0x40
comma
multiline_comment|/* last preset in EEPROM */
l_int|0xf7
)brace
suffix:semicolon
id|send_bulk_static_data
...
DECL|function|snd_usbmidi_emagic_input
r_static
r_void
id|snd_usbmidi_emagic_input
c_func
(paren
id|snd_usb_midi_in_endpoint_t
op_star
...
id|i
suffix:semicolon
multiline_comment|/* determine size of data until next F5 */
r_for
c_loop
(paren
id|i
...
r_break
suffix:semicolon
multiline_comment|/* assert(buffer[0] == 0xf5); */
id|ep-&gt;seen_f5
op_assign
l_int|1
suffix:semicolon
...
DECL|function|snd_usbmidi_emagic_output
r_static
r_void
id|snd_usbmidi_emagic_output
c_func
(paren
id|snd_usb_midi_out_endpoint_t
op_star
...
(brace
multiline_comment|/* round-robin, starting at the last current port */
r_int
id|portnum
op_assign
(paren
...
DECL|variable|snd_usbmidi_emagic_ops
r_static
r_struct
id|usb_protocol_ops
id|snd_usbmidi_emagic_ops
op_assign
(brace
dot
id|input
...
multiline_comment|/* we never use interrupt output pipes */
id|pipe
op_assign
id|usb_sndbulkpipe
c_func
...
c_cond
(paren
id|umidi-&gt;usb_protocol_ops-&gt;init_out_endpoint
)paren
id|umidi-&gt;usb_protocol_ops
op_member_access_from_pointer
id|init_out_endpoint
c_func
(paren
...
c_cond
(paren
id|umidi-&gt;usb_protocol_ops-&gt;finish_out_endpoint
)paren
id|umidi-&gt;usb_protocol_ops
op_member_access_from_pointer
id|finish_out_endpoint
...
comma
multiline_comment|/* MOTU Fastlane */
(brace
l_int|0x07fd
comma
l_int|0x0001
...
comma
multiline_comment|/* Emagic Unitor8/AMT8/MT4 */
(brace
l_int|0x086a
comma
l_int|0x0001
...
multiline_comment|/*&n; * On Roland devices, use the second alternate setting to be able to use&n; * the interrupt input endpoint.&n; */
DECL|function|snd_usbmidi_switch_roland_altsetting
r_static
r_void
id|snd_usbmidi_switch_roland_altsetting
c_func
(paren
id|snd_usb_midi_t
op_star
...
multiline_comment|/*&n; * Try to find any usable endpoints in the interface.&n; */
DECL|function|snd_usbmidi_detect_endpoints
r_static
r_int
id|snd_usbmidi_detect_endpoints
c_func
(paren
id|snd_usb_midi_t
op_star
...
multiline_comment|/*&n; * Detects the endpoints for one-port-per-endpoint protocols.&n; */
DECL|function|snd_usbmidi_detect_per_port_endpoints
r_static
r_int
id|snd_usbmidi_detect_per_port_endpoints
c_func
(paren
id|snd_usb_midi_t
op_star

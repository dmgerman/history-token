...
multiline_comment|/*&n; * Creates a sequencer port for an input/output cable pair.&n; */
DECL|function|snd_usbmidi_create_port
r_static
r_int
id|snd_usbmidi_create_port
c_func
(paren
id|snd_usb_midi_t
op_star
...
multiline_comment|/*&n; * Creates a virmidi port emulating rawmidi for the sequencer port.&n; */
DECL|function|snd_usbmidi_create_virmidi
r_static
r_int
id|snd_usbmidi_create_virmidi
c_func
(paren
id|snd_usb_midi_t
op_star
...
id|umidi-&gt;seq_client
suffix:semicolon
multiline_comment|/* set the client name */
id|memset
c_func
(paren
op_amp

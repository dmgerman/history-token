...
DECL|function|snd_usb_boot_quirk
r_static
r_int
id|snd_usb_boot_quirk
c_func
(paren
r_struct
id|usb_device
...
id|dev-&gt;actconfig
suffix:semicolon
multiline_comment|/* FIXME: we need to handle composite type quirks later.. */
r_switch
c_cond
(paren
id|quirk-&gt;type
...
(paren
id|KERN_INFO
l_string|&quot;extigy_boot: boot length = %d&bslash;n&quot;
comma
id|get_cfg_desc
c_func
(paren
...
l_int|1
suffix:semicolon
multiline_comment|/* continue as the normal device */
r_switch
c_cond
(paren
id|quirk-&gt;type
...
multiline_comment|/* add device path to longname */
id|len
op_assign
id|strlen
c_func
...
(brace
multiline_comment|/* try to check the boot quirk */
r_if
c_cond
(paren
id|snd_usb_boot_quirk

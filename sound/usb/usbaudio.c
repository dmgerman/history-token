...
multiline_comment|/*&n; * Create a stream for an Edirol UA-700 interface.  The only way&n; * to detect the sample rate is by looking at wMaxPacketSize.&n; */
DECL|function|create_ua700_quirk
r_static
r_int
id|create_ua700_quirk
c_func
(paren
id|snd_usb_audio_t
op_star

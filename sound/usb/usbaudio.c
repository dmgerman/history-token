...
multiline_comment|/*&n; * parse the audio format type descriptor&n; * and returns the corresponding pcm format&n; */
DECL|function|parse_audio_format_type
r_static
r_int
id|parse_audio_format_type
c_func
(paren
r_struct
id|usb_device
...
DECL|function|snd_usb_roland_ua100_hack_intf
r_static
r_int
id|snd_usb_roland_ua100_hack_intf
c_func
(paren
id|snd_usb_audio_t
op_star
...
DECL|function|snd_usb_roland_ua100_hack
r_static
r_int
id|snd_usb_roland_ua100_hack
c_func
(paren
id|snd_usb_audio_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;invalid UA-100 descriptor&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(brace
multiline_comment|/* USB audio interface */
r_int
r_char
op_star
id|buffer
...
r_else
(brace
multiline_comment|/* USB midi interface */
r_if
c_cond
(paren
id|snd_usb_create_quirk
...
macro_line|#ifdef OLD_USB
multiline_comment|/*&n; * 2.4 USB kernel API&n; */
...
multiline_comment|/*&n; * format is snd-usb-audio=enable,index,id,vid,pid&n; */

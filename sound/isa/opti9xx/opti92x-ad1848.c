...
singleline_comment|//static int enable = SNDRV_DEFAULT_ENABLE1;&t;/* Enable this card */
...
suffix:semicolon
singleline_comment|//MODULE_PARM(enable, &quot;i&quot;);
...
suffix:semicolon
DECL|variable|snd_opti9xx_first_hit
r_static
r_int
id|snd_opti9xx_first_hit
op_assign
l_int|1
suffix:semicolon
DECL|variable|snd_opti9xx_legacy
r_static
id|snd_card_t
op_star
id|snd_opti9xx_legacy
op_assign
...
macro_line|#ifdef CONFIG_PNP
DECL|function|snd_card_opti9xx_pnp
r_static
r_int
id|__devinit
id|snd_card_opti9xx_pnp
c_func
(paren
id|opti9xx_t
op_star
...
id|opl4
suffix:semicolon
multiline_comment|/* assume we have an OPL4 */
id|snd_opti9xx_write_mask
c_func
(paren
id|chip
...
(brace
multiline_comment|/* no luck, use OPL3 instead */
id|snd_opti9xx_write_mask
c_func
(paren
id|chip
...
macro_line|#ifdef CONFIG_PNP
DECL|function|snd_opti9xx_pnp_remove
r_static
r_void
id|__devexit
id|snd_opti9xx_pnp_remove
c_func
(paren
r_struct
id|pnp_card_link
...
DECL|variable|opti9xx_pnpc_driver
r_static
r_struct
id|pnp_card_driver
...
multiline_comment|/* format is: snd-opti9xx=enable,index,id,isapnp,&n;&t;&t;&t;  port,mpu_port,fm_port,&n;&t;&t;&t;  irq,mpu_irq,&n;&t;&t;&t;  dma1,[dma2] */

...
suffix:semicolon
DECL|macro|DT019X_CONTROLS
mdefine_line|#define DT019X_CONTROLS (sizeof(snd_dt019x_controls)/sizeof(snd_kcontrol_new_t *))
...
suffix:semicolon
DECL|macro|DT019X_INIT_VALUES
mdefine_line|#define DT019X_INIT_VALUES (sizeof(snd_dt019x_init_values)/sizeof(unsigned char)/2)
...
suffix:semicolon
macro_line|#endif
DECL|macro|ALS4000_CONTROLS
mdefine_line|#define ALS4000_CONTROLS (sizeof(snd_als4000_controls)/sizeof(snd_kcontrol_new_t *))
...
suffix:semicolon
DECL|macro|ALS4000_INIT_VALUES
mdefine_line|#define ALS4000_INIT_VALUES (sizeof(snd_als4000_init_values)/sizeof(unsigned char)/2)

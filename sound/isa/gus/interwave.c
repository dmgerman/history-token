...
suffix:semicolon
DECL|variable|snd_interwave_legacy
r_static
id|snd_card_t
op_star
id|snd_interwave_legacy
(braket
id|SNDRV_CARDS
)braket
op_assign
...
macro_line|#ifdef CONFIG_PNP
DECL|function|snd_interwave_pnp
r_static
r_int
id|__devinit
id|snd_interwave_pnp
c_func
(paren
r_int
id|dev
...
(paren
id|KERN_ERR
l_string|&quot;InterWave - Synth - the requested resources are invalid, using auto config&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;InterWave PnP configure failure (out of resources?)&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
(paren
id|KERN_ERR
l_string|&quot;PnP configure failure (wrong ports)&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;InterWave - ToneControl - the requested resources are invalid, using auto config&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;InterWave ToneControl PnP configure failure (out of resources?)&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
macro_line|#ifdef CONFIG_PNP
DECL|function|snd_interwave_pnp_detect
r_static
r_int
id|__devinit
id|snd_interwave_pnp_detect
c_func
(paren
r_struct
id|pnp_card_link
...
DECL|function|snd_interwave_pnp_remove
r_static
r_void
id|__devexit
id|snd_interwave_pnp_remove
c_func
(paren
r_struct
id|pnp_card_link
...
DECL|variable|interwave_pnpc_driver
r_static
r_struct
id|pnp_card_driver

...
macro_line|#if !defined(EBUS_SUPPORT) &amp;&amp; !defined(SBUS_SUPPORT)
DECL|macro|__CS4231_INLINE__
mdefine_line|#define __CS4231_INLINE__ inline
macro_line|#else
DECL|macro|__CS4231_INLINE__
mdefine_line|#define __CS4231_INLINE__ /* nothing */
macro_line|#endif
DECL|function|cs4231_outb
r_static
id|__CS4231_INLINE__
r_void
id|cs4231_outb
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Fixes audible clicks at least on GUS MAX */
id|full_calib
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* lowlevel suspend callback for CS4231 */
...
multiline_comment|/* lowlevel resume callback for CS4231 */
...
DECL|function|snd_cs4231_pm_suspend
r_static
r_int
id|snd_cs4231_pm_suspend
c_func
(paren
id|snd_card_t
op_star
...
DECL|function|snd_cs4231_pm_resume
r_static
r_int
id|snd_cs4231_pm_resume
c_func
(paren
id|snd_card_t
op_star

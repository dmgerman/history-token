...
c_func
(paren
l_string|&quot;ALSA driver for Turtle Beach WaveFront ICS2215 Synth&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
r_int
DECL|function|snd_wavefront_detect_irq
...
suffix:semicolon
multiline_comment|/* Note: according to the PnP dump, 7 and 11 are possible too, but the&n;&t;   WaveFront SDK doesn&squot;t tell us how to set the card to use them.  &n;&t;*/
id|snd_printk
(paren
...
id|snd_printk
(paren
l_string|&quot;autodetected IRQ %d&bslash;n&quot;
comma
id|possible_irqs
(braket
id|i
...
r_int
DECL|function|snd_wavefront_check_irq
id|snd_wavefront_check_irq
(paren
id|snd_wavefront_t
op_star
...
suffix:semicolon
multiline_comment|/* wavefront_midi.c */
id|EXPORT_SYMBOL
c_func
(paren

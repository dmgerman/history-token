...
id|CS8427_REG_AUTOINC
comma
multiline_comment|/* CS8427_REG_CONTROL1: RMCK to OMCK, valid PCM audio, disable mutes, TCBL=output */
id|CS8427_SWCLK
op_or
id|CS8427_TCBLDIR
comma
...
comma
multiline_comment|/* CS8427_REG_CLOCKSOURCE: Run off, CMCK=256*Fs, output time base = OMCK, input time base =&n;&t;     recovered input clock, recovered input clock source is ILRCK changed to AES3INPUT (workaround, see snd_cs8427_reset) */
id|CS8427_RXDILRCK
comma
...
multiline_comment|/* CS8427_UNLOCK | CS8427_V | CS8427_CONF | CS8427_BIP | CS8427_PAR, */
l_int|0xff
comma
multiline_comment|/* set everything */
...
c_func
(paren
l_string|&quot;reg[0x%x] = 0x%x&bslash;n&quot;
comma
id|xx
op_plus
l_int|1
...
multiline_comment|/*&n; * Reset the chip using run bit, also lock PLL using ILRCK and&n; * put back AES3INPUT. This workaround is described in latest&n; * CS8427 datasheet, otherwise TXDSERIAL will not work.&n; */
DECL|function|snd_cs8427_reset
r_void
id|snd_cs8427_reset
c_func
(paren
...
DECL|function|snd_cs8427_qsubcode_info
r_static
r_int
id|snd_cs8427_qsubcode_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_cs8427_qsubcode_get
r_static
r_int
id|snd_cs8427_qsubcode_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
c_func
(paren
l_string|&quot;unable to read Q-subcode bytes from CS8427&bslash;n&quot;
)paren
suffix:semicolon
id|snd_i2c_unlock
c_func
...
ques
c_cond
id|chip-&gt;playback.substream-&gt;runtime
suffix:colon
l_int|NULL
suffix:semicolon
r_int
...
id|name
op_assign
l_string|&quot;IEC958 CS8427 Error Status&quot;
comma
dot
id|access
op_assign
...
suffix:semicolon
DECL|variable|snd_cs8427_reset
id|EXPORT_SYMBOL
c_func
(paren
id|snd_cs8427_reset

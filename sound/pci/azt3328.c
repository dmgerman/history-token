...
(paren
id|KERN_WARNING
l_string|&quot;azt3328: cannot reserve joystick ports&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;azt3328: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
DECL|function|snd_azf3328_free_joystick
r_static
r_void
id|snd_azf3328_free_joystick
c_func
(paren
id|azf3328_t
op_star

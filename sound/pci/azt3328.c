...
DECL|function|snd_azf3328_mixer_read
r_int
r_int
id|snd_azf3328_mixer_read
c_func
(paren
id|azf3328_t
op_star
...
c_func
(paren
l_string|&quot;unable to grab I/O port at 0x%lx-0x%lx&bslash;n&quot;
comma
id|chip-&gt;codec_port
comma
id|chip-&gt;codec_port
...
c_func
(paren
l_string|&quot;unable to grab I/O 2 port at 0x%lx-0x%lx&bslash;n&quot;
comma
id|chip-&gt;io2_port
comma
id|chip-&gt;io2_port
...
l_int|0x04
comma
l_string|&quot;Aztech AZF3328 MPU401&quot;
)paren
)paren
op_eq
l_int|NULL
...
c_func
(paren
l_string|&quot;unable to grab MPU401 port at 0x%lx-0x%lx&bslash;n&quot;
comma
id|chip-&gt;mpu_port
comma
id|chip-&gt;mpu_port
...
c_func
(paren
l_string|&quot;unable to grab OPL3 port at 0x%lx-0x%lx&bslash;n&quot;
comma
id|chip-&gt;synth_port
comma
id|chip-&gt;synth_port
...
c_func
(paren
l_string|&quot;unable to grab mixer port at 0x%lx-0x%lx&bslash;n&quot;
comma
id|chip-&gt;mixer_port
comma
id|chip-&gt;mixer_port
...
(paren
id|KERN_ERR
l_string|&quot;azt3328: no AZF3328 based soundcards found or device busy&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return

...
(brace
multiline_comment|/* Some mobos report count = 0 on the DMA boundary,&n;&t;&t;&t; * i.e. count = size indeed.&n;&t;&t;&t; * Let&squot;s check whether this step is above the expected size.&n;&t;&t;&t; */
r_int
id|delta
op_assign
id|res
...
suffix:semicolon
multiline_comment|/* some mobos read 0 count */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;zero position is read&bslash;n&quot;
)paren
suffix:semicolon
id|idx
op_assign
...
DECL|function|snd_via686_create_gameport
r_static
r_int
id|__devinit
id|snd_via686_create_gameport
c_func
(paren
id|via82xx_t
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;via82xx: cannot reserve joystick port 0x%#x&bslash;n&quot;
comma
id|JOYSTICK_ADDR
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;via82xx: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
id|r
suffix:semicolon
multiline_comment|/* Enable legacy joystick port */
op_star
id|legacy
op_or_assign
...
DECL|function|snd_via686_free_gameport
r_static
r_void
id|snd_via686_free_gameport
c_func
(paren
id|via82xx_t
op_star
...
(brace
multiline_comment|/* when no h/w PCM volume control is found, use DXS volume control&n;&t;&t; * as the PCM vol control&n;&t;&t; */

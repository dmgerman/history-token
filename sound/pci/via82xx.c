...
c_func
(paren
l_string|&quot;{{VIA,VT82C686A/B/C,pci},{VIA,VT8233A/B/C}}&quot;
)paren
suffix:semicolon
DECL|variable|index
r_static
...
DECL|function|snd_via82xx_trigger
r_static
r_int
id|snd_via82xx_trigger
c_func
(paren
id|via82xx_t
op_star
...
DECL|function|snd_via82xx_set_format
r_static
r_int
id|snd_via82xx_set_format
c_func
(paren
id|via82xx_t
op_star
...
DECL|function|snd_via82xx_update
r_static
r_inline
r_void
id|snd_via82xx_update
c_func
(paren
id|via82xx_t
op_star
...
DECL|function|snd_via82xx_playback_trigger
r_static
r_int
id|snd_via82xx_playback_trigger
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_capture_trigger
r_static
r_int
id|snd_via82xx_capture_trigger
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_playback_prepare
r_static
r_int
id|snd_via82xx_playback_prepare
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_capture_prepare
r_static
r_int
id|snd_via82xx_capture_prepare
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_cur_ptr
r_static
r_inline
r_int
r_int
id|snd_via82xx_cur_ptr
c_func
(paren
id|via82xx_t
op_star
...
l_int|0xffffff
suffix:semicolon
multiline_comment|/* The via686a does not have the current index register,&n;&t;&t; * so we need to calculate the index from CURR_PTR.&n;&t;&t; */
id|ptr
op_assign
id|inl
c_func
...
multiline_comment|/* convert to the linear position */
id|ptr
op_assign
id|viadev-&gt;idx_table
(braket
...
c_func
(paren
l_string|&quot;fail: val = %i/%i, lastpos = 0x%x, bufsize2 = 0x%x, offsize = 0x%x, size = 0x%x, count = 0x%x&bslash;n&quot;
comma
id|val
comma
id|viadev-&gt;tbl_entries
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* VIA8233 count register returns full size when end of buffer is reached */
r_if
c_cond
(paren
id|ptr
...
DECL|function|snd_via82xx_playback_pointer
r_static
id|snd_pcm_uframes_t
id|snd_via82xx_playback_pointer
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_capture_pointer
r_static
id|snd_pcm_uframes_t
id|snd_via82xx_capture_pointer
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|variable|snd_via82xx_playback
r_static
id|snd_pcm_hardware_t
id|snd_via82xx_playback
op_assign
(brace
dot
id|info
...
suffix:semicolon
DECL|variable|snd_via82xx_capture
r_static
id|snd_pcm_hardware_t
id|snd_via82xx_capture
op_assign
(brace
dot
id|info
...
DECL|function|snd_via82xx_playback_close
r_static
r_int
id|snd_via82xx_playback_close
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|snd_via82xx_capture_close
r_static
r_int
id|snd_via82xx_capture_close
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|variable|snd_via82xx_playback_ops
r_static
id|snd_pcm_ops_t
id|snd_via82xx_playback_ops
op_assign
(brace
dot
id|open
...
suffix:semicolon
DECL|variable|snd_via82xx_capture_ops
r_static
id|snd_pcm_ops_t
id|snd_via82xx_capture_ops
op_assign
(brace
dot
id|open
...
suffix:semicolon
DECL|function|snd_via82xx_pcm_free
r_static
r_void
id|snd_via82xx_pcm_free
c_func
(paren
id|snd_pcm_t
op_star
...
DECL|function|snd_via82xx_mixer
r_static
r_int
id|__devinit
id|snd_via82xx_mixer
c_func
(paren
id|via82xx_t
op_star
...
id|TYPE_VIA8233
suffix:colon
multiline_comment|/* we use multi-channel playback mode, since this mode is supported&n;&t;&t; * by all VIA8233 models (and obviously suitable for our purpose).&n;&t;&t; */
id|chip-&gt;playback.reg_offset
op_assign
id|VIA_REG_MULTPLAY_STATUS
suffix:semicolon

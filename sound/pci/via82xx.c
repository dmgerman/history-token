...
id|port
op_plus
id|VIA_REG_OFS_PLAYBACK_VOLUME_R
)paren
suffix:semicolon
)brace
r_return
...
DECL|function|snd_via82xx_joystick_info
r_static
r_int
id|snd_via82xx_joystick_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_via82xx_joystick_get
r_static
r_int
id|snd_via82xx_joystick_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_via82xx_joystick_put
r_static
r_int
id|snd_via82xx_joystick_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
r_static
id|snd_kcontrol_new_t
id|snd_via82xx_joystick_control
id|__devinitdata
op_assign
(brace
dot
...
op_assign
(brace
singleline_comment|// { .vendor = xxxx, .device = yyyy, .action = x },
(brace
)brace
multiline_comment|/* terminator */
)brace

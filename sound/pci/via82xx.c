...
(paren
id|KERN_ERR
l_string|&quot;VIA 82xx soundcard not found or device busy&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
multiline_comment|/* format is: snd-via82xx=enable,index,id,&n;&t;&t;&t;  mpu_port,joystick,&n;&t;&t;&t;  ac97_quirk,ac97_clock,dxs_support */
DECL|function|alsa_card_via82xx_setup
r_static
r_int
id|__init
id|alsa_card_via82xx_setup
c_func
(paren
r_char
op_star

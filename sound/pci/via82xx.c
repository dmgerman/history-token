...
DECL|function|snd_via82xx_setup_periods
r_static
r_int
id|snd_via82xx_setup_periods
c_func
(paren
id|via82xx_t
op_star
...
r_default
suffix:colon
multiline_comment|/* ah, this register makes life easier for us here. */
id|val
op_assign
id|inb
c_func
...
multiline_comment|/* format is: snd-via82xx=snd_enable,snd_index,snd_id,&n;&t;&t;&t;  snd_mpu_port,snd_ac97_clock */

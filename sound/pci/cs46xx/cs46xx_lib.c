...
id|chip
comma
id|cpcm-&gt;pcm_channel-&gt;pcm_reader_scb
comma
...
(brace
multiline_comment|/* if this is the only PCMReaderSCB child under current&n;&t;   SrcTask then there no need to re-create pcm-channel */
r_if
c_cond
(paren
...
id|sample_rate
op_logical_and
multiline_comment|/* never set a 0 khz sample rate */
id|sample_rate
)paren
(brace
...
multiline_comment|/* if there is more then 1 PCMReaderSCB child&squot;s under current&n;&t;   SrcTask then we must recreate channel */
r_if
c_cond
(paren
id|cpcm-&gt;pcm_channel-&gt;sample_rate
...
id|cpcm-&gt;hw_addr
comma
id|cpcm-&gt;pcm_channel-&gt;pcm_channel_id
)paren
)paren
op_eq
l_int|NULL
...
suffix:semicolon
multiline_comment|/* if IEC958 is opened in AC3 mode dont adjust SRCTask is not&n;&t;   used so dont adjust sample rate */
r_if
c_cond
(paren
id|cpcm-&gt;pcm_channel-&gt;pcm_channel_id
...
DECL|function|snd_cs46xx_vol_iec958_get
r_static
r_int
...
DECL|function|snd_cs46xx_vol_iec958_put
r_static
r_int
...
DECL|function|snd_cs46xx_iec958_ac3_mode_get
r_static
r_int
id|snd_cs46xx_iec958_ac3_mode_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_cs46xx_iec958_ac3_mode_put
r_static
r_int
id|snd_cs46xx_iec958_ac3_mode_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
id|name
op_assign
l_string|&quot;IEC 958 Output Switch&quot;
comma
dot
id|info
op_assign
...
id|name
op_assign
l_string|&quot;IEC 958 AC3 Mode Switch&quot;
comma
dot
id|info
op_assign
...
suffix:semicolon
DECL|function|snd_cs46xx_sec_codec_reset
r_static
r_void
id|snd_cs46xx_sec_codec_reset
(paren
id|ac97_t
op_star
id|ac97
...
suffix:semicolon
multiline_comment|/* set codec in extended mode */
id|snd_cs46xx_ac97_write
c_func
(paren
id|ac97
...
id|_ok2
suffix:colon
multiline_comment|/* set secondary codec in extended mode */
multiline_comment|/* use custom reset to set secondary codec in&n;&t;   extended mode */
id|ac97.reset
op_assign
id|snd_cs46xx_sec_codec_reset
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Initialize cs46xx SPDIF controller&n;&t; */

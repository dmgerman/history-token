...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|snd_cs46xx_remove_gameport
r_static
r_inline
r_void
id|snd_cs46xx_remove_gameport
c_func
(paren
id|cs46xx_t
op_star

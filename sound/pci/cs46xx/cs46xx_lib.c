multiline_comment|/*&n; *  Copyright (c) by Jaroslav Kysela &lt;perex@suse.cz&gt;&n; *                   Abramo Bagnara &lt;abramo@alsa-project.org&gt;&n; *                   Cirrus Logic, Inc.&n; *  Routines for control of Cirrus Logic CS461x chips&n; *&n; *  BUGS:&n; *    --&n; *&n; *  TODO:&n; *    SPDIF input.&n; *    Secondary CODEC on some soundcards&n; *&n; *  NOTE: with CONFIG_SND_CS46XX_NEW_DSP unset uses old DSP image (which&n; *        is default configuration), no SPDIF, no secondary codec, no&n; *        multi channel PCM.  But known to work.&n; *&n; *   This program is free software; you can redistribute it and/or modify&n; *   it under the terms of the GNU General Public License as published by&n; *   the Free Software Foundation; either version 2 of the License, or&n; *   (at your option) any later version.&n; *&n; *   This program is distributed in the hope that it will be useful,&n; *   but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *   GNU General Public License for more details.&n; *&n; *   You should have received a copy of the GNU General Public License&n; *   along with this program; if not, write to the Free Software&n; *   Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307 USA&n; *&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* UGGLY: nr_ac97_codecs == 0 primery codec detection is in progress */
r_if
c_cond
(paren
id|ac97
...
id|CS46XX_PRIMARY_CODEC_INDEX
suffix:semicolon
multiline_comment|/* UGGLY: nr_ac97_codecs == 1 secondary codec detection is in progress */
r_else
r_if
c_cond
(paren
...
id|CS46XX_PRIMARY_CODEC_INDEX
suffix:semicolon
multiline_comment|/* UGGLY: nr_ac97_codecs == 0 secondary codec detection is in progress */
r_else
r_if
c_cond
(paren
...
c_cond
(paren
id|cpcm-&gt;pcm_channel-&gt;src_scb-&gt;ref_count
op_eq
l_int|1
op_logical_and
...
(brace
multiline_comment|/* sample rate not set or we can reuse&n;&t;&t;   the same SRC*/
id|cs46xx_dsp_set_src_sample_rate
(paren
id|chip
comma
id|cpcm-&gt;pcm_channel-&gt;src_scb
comma
id|runtime-&gt;rate
)paren
suffix:semicolon
...
macro_line|#ifdef CONFIG_SND_CS46XX_NEW_DSP
DECL|function|snd_cs46xx_iec958_info
r_static
r_int
id|snd_cs46xx_iec958_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
c_func
(paren
l_string|&quot;snd_cs46xx: primary codec phase one&bslash;n&quot;
)paren
suffix:semicolon
id|chip-&gt;nr_ac97_codecs
op_assign
...
c_func
(paren
l_string|&quot;snd_cs46xx: secondary codec did not respond ...&bslash;n&quot;
)paren
suffix:semicolon
id|chip-&gt;ac97
(braket
...
l_int|1
suffix:semicolon
multiline_comment|/* well, one codec only ... */
r_goto
id|_end
suffix:semicolon
id|_ok2
...
suffix:semicolon
multiline_comment|/*&n;     * Set GPIO pin&squot;s 7 and 8 so that they are configured for output.&n;     */
id|pin_config
op_assign
id|snd_cs46xx_codec_read
(paren
...
suffix:semicolon
multiline_comment|/*&n;     * Set GPIO pin&squot;s 7 and 8 so that they are compatible with CMOS logic.&n;     */
id|logic_type
op_assign
id|snd_cs46xx_codec_read
c_func
...
suffix:semicolon
multiline_comment|/*&n;     * Fill slots 12 with the correct value for the GPIO pins. &n;     */
r_for
c_loop
(paren
id|idx
...
(brace
multiline_comment|/*&n;       * Initialize the fifo so that bits 7 and 8 are on.&n;       *&n;       * Remember that the GPIO pins in bonzo are shifted by 4 bits to&n;       * the left.  0x1800 corresponds to bits 7 and 8.&n;       */
id|snd_cs46xx_pokeBA0
c_func
(paren
id|chip
...
suffix:semicolon
multiline_comment|/*&n;       * Make sure the previous FIFO write operation has completed.&n;       */
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: cs46xx_setup_eapd_slot() &quot;
"&bslash;"
l_string|&quot;Failure to write the GPIO pins for slot 12.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/*&n;       * Write the serial port FIFO index.&n;       */
id|snd_cs46xx_pokeBA0
c_func
(paren
id|chip
...
suffix:semicolon
multiline_comment|/*&n;       * Tell the serial port to load the new value into the FIFO location.&n;       */
id|snd_cs46xx_pokeBA0
c_func
(paren
id|chip

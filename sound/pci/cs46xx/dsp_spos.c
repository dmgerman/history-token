...
macro_line|#if 0
multiline_comment|/* OBSOLETE NOW */
r_static
r_void
id|handle_goto
(paren
...
id|dsp_opcode_desc_t
suffix:semicolon
multiline_comment|/* NOTE: theese opcodes are known needed to be reallocated,&n;   there may be more. */
id|dsp_opcode_desc_t
id|dsp_opcodes
(braket
)braket
...
id|handle_goto
comma
l_string|&quot;tb = Z, if(!Z) goto %s after&quot;
)brace
comma
(brace
l_int|0x01000
...
c_func
(paren
l_string|&quot;handle_goto[1]: %05x:%05x addr %04x&bslash;n&quot;
comma
op_star
id|hival
comma
...
c_func
(paren
l_string|&quot;handle_goto[1]: ROM symbol not reallocated&bslash;n&quot;
)paren
suffix:semicolon
)brace
op_star
...
c_func
(paren
l_string|&quot;handle_goto:[2] %05x:%05x addr %04x&bslash;n&quot;
comma
op_star
id|hival
comma
...
suffix:semicolon
multiline_comment|/* right and left validate bit &n;&t;   NOTE: 0x80000000 and enables the SCMC protection on stream &n;&t;*/
id|cs46xx_poke_via_dsp
(paren
id|chip
comma

...
macro_line|#ifdef SUPPORT_JOYSTICK
macro_line|#ifdef CHIP1371
DECL|function|snd_ensoniq_get_joystick_port
r_static
r_int
id|__devinit
id|snd_ensoniq_get_joystick_port
c_func
(paren
r_int
id|dev
...
(paren
id|KERN_ERR
l_string|&quot;ens1371: invalid joystick port %#x&quot;
comma
id|joystick_port
(braket
id|dev
...
macro_line|#endif
DECL|function|snd_ensoniq_create_gameport
r_static
r_int
id|__devinit
id|snd_ensoniq_create_gameport
c_func
(paren
id|ensoniq_t
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;ens137x: no gameport ports available&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_WARNING
l_string|&quot;ens137x: gameport io port 0x%#x in use&bslash;n&quot;
comma
id|io_port
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ens137x: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
DECL|function|snd_ensoniq_free_gameport
r_static
r_void
id|snd_ensoniq_free_gameport
c_func
(paren
id|ensoniq_t
op_star

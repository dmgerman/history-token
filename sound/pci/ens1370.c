...
macro_line|#if defined(CHIP1370) || defined(CONFIG_GAMEPORT) || (defined(MODULE) &amp;&amp; defined(CONFIG_GAMEPORT_MODULE))
...
DECL|function|snd_ensoniq_joy_enable
r_static
r_int
id|snd_ensoniq_joy_enable
c_func
(paren
id|ensoniq_t
op_star
...
(brace
DECL|macro|ES___GAMEPORT_LOG_DELAY
mdefine_line|#define ES___GAMEPORT_LOG_DELAY (30*HZ)
singleline_comment|// avoid log pollution: limit to 2 infos per minute
r_if
c_cond
(paren
id|time_after
...
DECL|function|snd_ensoniq_joy_disable
r_static
r_int
id|snd_ensoniq_joy_disable
c_func
(paren
id|ensoniq_t
op_star
...
DECL|function|snd_ensoniq_joy_control_put
r_static
r_int
id|snd_ensoniq_joy_control_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
id|nval
suffix:semicolon
singleline_comment|// spinlock shouldn&squot;t be needed because of joy_sem
r_if
c_cond
(paren
id|change
...
id|no_change
suffix:semicolon
singleline_comment|// FIXME: now we allow change only when joystick is disabled
id|change
op_assign
(paren
id|ensoniq-&gt;ctrl

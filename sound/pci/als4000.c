...
macro_line|#ifdef SUPPORT_JOYSTICK
DECL|function|snd_als4000_create_gameport
r_static
r_int
id|__devinit
id|snd_als4000_create_gameport
c_func
(paren
id|snd_card_als4000_t
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;als4000: cannot reserve joystick ports&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;als4000: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
DECL|function|snd_als4000_free_gameport
r_static
r_void
id|snd_als4000_free_gameport
c_func
(paren
id|snd_card_als4000_t
op_star
...
id|snd_card_als4000_free
suffix:semicolon
multiline_comment|/* disable all legacy ISA stuff */
id|snd_als4000_set_addr
c_func
(paren
id|acard-&gt;gcr

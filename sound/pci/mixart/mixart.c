...
suffix:semicolon
id|streaming_group_req.stream_count
op_assign
id|stream_count
suffix:semicolon
id|streaming_group_req.channel_count
op_assign
l_int|2
suffix:semicolon
id|streaming_group_req.latency
op_assign
l_int|256
suffix:semicolon
id|streaming_group_req.connector
op_assign
...
id|streaming_group_req.stream_info
(braket
id|i
)braket
dot
...
id|streaming_group_req.flow_entry
(braket
id|i
)braket
op_assign
...
id|chip-&gt;mgr-&gt;bufferinfo_physaddr
op_plus
(paren
id|j
op_star
...
op_logical_or
(paren
id|streaming_group_resp.status
op_ne
l_int|0
)paren
)paren
...
id|pipe-&gt;group_uid
op_assign
id|streaming_group_resp.group
suffix:semicolon
multiline_comment|/* id of the pipe, as returned by embedded */
id|pipe-&gt;stream_count
op_assign
id|streaming_group_resp.stream_count
suffix:semicolon
multiline_comment|/* pipe-&gt;stream_uid[i] = streaming_group_resp.stream[i].stream_uid; */
id|pipe-&gt;status
op_assign
id|PIPE_STOPPED
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;unable to grab memory 0x%lx&bslash;n&quot;
comma
id|mgr-&gt;mem
(braket
id|i
...
(paren
id|KERN_ERR
l_string|&quot;Digigram miXart soundcard not found or device busy&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
multiline_comment|/* format is: snd-mixart=enable,index,id */
DECL|function|alsa_card_mixart_setup
r_static
r_int
id|__init
id|alsa_card_mixart_setup
c_func
(paren
r_char
op_star

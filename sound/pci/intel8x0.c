...
mdefine_line|#define ALI_INT_CPRAIS&t;&t;(1&lt;&lt;7)
DECL|macro|ALI_INT_SPRAIS
mdefine_line|#define ALI_INT_SPRAIS&t;&t;(1&lt;&lt;5)
...
DECL|macro|ALI_PCM_CH4
mdefine_line|#define ALI_PCM_CH4&t;&t;0x100
DECL|macro|ALI_PCM_CH6
mdefine_line|#define ALI_PCM_CH6&t;&t;0x200
DECL|macro|ALI_PCM_MASK
mdefine_line|#define ALI_PCM_MASK&t;&t;(ALI_PCM_CH4 | ALI_PCM_CH6)
...
(paren
id|KERN_WARNING
l_string|&quot;intel8x0: AC97 codec semaphore timeout.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_WARNING
l_string|&quot;intel8x0: AC97 read not completed?&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|__err
...
DECL|function|snd_intel8x0_ali_spdifout_open
r_static
r_int
...
DECL|function|snd_intel8x0_ali_spdifout_close
r_static
r_int
...
suffix:semicolon
DECL|variable|snd_intel8x0_ali_spdifout_ops
r_static
id|snd_pcm_ops_t
...
multiline_comment|/*&n; *  PCM code - MIC2&n; */
DECL|function|snd_intel8x0_pcm_mic2_free
r_static
r_void
id|snd_intel8x0_pcm_mic2_free
c_func
(paren
id|snd_pcm_t
op_star
...
DECL|function|snd_intel8x0_pcm_mic2
r_static
r_int
id|__devinit
id|snd_intel8x0_pcm_mic2
c_func
(paren
id|intel8x0_t
op_star
...
multiline_comment|/*&n; *  PCM code - capture2&n; */
DECL|function|snd_intel8x0_pcm_capture2_free
r_static
r_void
id|snd_intel8x0_pcm_capture2_free
c_func
(paren
id|snd_pcm_t
op_star
...
DECL|function|snd_intel8x0_pcm_capture2
r_static
r_int
id|__devinit
id|snd_intel8x0_pcm_capture2
c_func
(paren
id|intel8x0_t
op_star
...
multiline_comment|/*&n; *  PCM code - S/PDIF&n; */
DECL|function|snd_intel8x0_pcm_spdif_free
r_static
r_void
id|snd_intel8x0_pcm_spdif_free
c_func
(paren
id|snd_pcm_t
op_star
...
DECL|function|snd_intel8x0_pcm_spdif
r_static
r_int
id|__devinit
id|snd_intel8x0_pcm_spdif
c_func
(paren
id|intel8x0_t
op_star
...
multiline_comment|/*&n; *  PCM code - ALI S/PDIF&n; */
DECL|function|snd_intel8x0_ali_spdif_free
r_static
r_void
id|snd_intel8x0_ali_spdif_free
c_func
(paren
id|snd_pcm_t
op_star
...
DECL|function|snd_intel8x0_ali_spdif
r_static
r_int
id|__devinit
id|snd_intel8x0_ali_spdif
c_func
(paren
id|intel8x0_t
op_star
...
multiline_comment|/*&n; *  PCM code - ALI AC&squot;97 S/PDIF&n; */
DECL|function|snd_intel8x0_ali_ac97spdif_free
r_static
r_void
id|snd_intel8x0_ali_ac97spdif_free
c_func
(paren
id|snd_pcm_t
op_star
...
suffix:semicolon
id|chip-&gt;pcm_ac97spdif
op_assign
l_int|NULL
suffix:semicolon
)brace
DECL|function|snd_intel8x0_ali_ac97spdif
r_static
r_int
id|__devinit
id|snd_intel8x0_ali_ac97spdif
c_func
(paren
id|intel8x0_t
op_star
...
suffix:semicolon
DECL|struct|_ac97_ali_rate_regs
r_static
r_struct
id|_ac97_ali_rate_regs
(brace
DECL|member|ichd
r_int
r_int
...
id|rates_idx
suffix:semicolon
DECL|variable|ac97_ali_rate_regs
)brace
id|ac97_ali_rate_regs
(braket
)braket
op_assign
(brace
...
suffix:semicolon
multiline_comment|/* can we have more AC&squot;97 codecs with ALI chipset? */
r_if
c_cond
(paren
id|chip-&gt;device_type
...
DECL|function|snd_intel8x0_proc_done
r_static
r_void
id|snd_intel8x0_proc_done
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/* is this right for last three devices? --jk */
)brace
)brace
...
multiline_comment|/* activate MIC PCM only when associated AC&squot;97 codec */
r_if
c_cond
(paren
id|chip-&gt;ichd
...
multiline_comment|/* activate AC&squot;97 S/PDIF only when associated AC&squot;97 codec */
r_if
c_cond
(paren
id|chip-&gt;bdbars_count
...
(brace
multiline_comment|/* activate MIC2 only when associated AC&squot;97 codec */
r_if
c_cond
(paren
id|chip-&gt;ichd
...
multiline_comment|/* activate PCM2IN only when associated AC&squot;97 codec */
r_if
c_cond
(paren
id|chip-&gt;ichd

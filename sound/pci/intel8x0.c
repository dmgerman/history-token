...
(brace
multiline_comment|/* FIXME: ICH4 may have no PCR and SCR bits...  */
id|snd_printd
c_func
(paren
id|KERN_INFO
l_string|&quot;intel8x0: no codec is probed, perhaps PCR and SCR bits are deactivated.&bslash;n&quot;
)paren
suffix:semicolon
id|chip-&gt;no_codec_check
op_assign
...
multiline_comment|/* check a bit longer... */
id|end_time
op_assign
id|jiffies
op_plus

...
multiline_comment|/* convert from SPDIF status bits to HDA SPDIF bits&n; * bit 0 (DigEn) is always set zero (to be filled later)&n; */
DECL|function|convert_from_spdif_status
r_static
r_int
r_int
id|convert_from_spdif_status
c_func
(paren
r_int
r_int
...
multiline_comment|/* convert to SPDIF status bits from HDA SPDIF bits&n; */
DECL|function|convert_to_spdif_status
r_static
r_int
r_int
id|convert_to_spdif_status
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/**&n; * snd_hda_create_spdif_out_ctls - create Output SPDIF-related controls&n; * @codec: the HDA codec&n; * @nid: audio out widget NID&n; *&n; * Creates controls related with the SPDIF output.&n; * Called from each patch supporting the SPDIF out.&n; *&n; * Returns 0 if successful, or a negative error code.&n; */
...
multiline_comment|/*&n; * SPDIF input&n; */
DECL|macro|snd_hda_spdif_in_switch_info
mdefine_line|#define snd_hda_spdif_in_switch_info&t;snd_hda_spdif_out_switch_info
DECL|function|snd_hda_spdif_in_switch_get
r_static
r_int
id|snd_hda_spdif_in_switch_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
op_assign
id|codec-&gt;spdif_in_enable
suffix:semicolon
r_return
l_int|0
suffix:semicolon
)brace
DECL|function|snd_hda_spdif_in_switch_put
r_static
r_int
id|snd_hda_spdif_in_switch_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_hda_spdif_in_status_get
r_static
r_int
id|snd_hda_spdif_in_status_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
id|info
op_assign
id|snd_hda_spdif_in_switch_info
comma
dot
id|get
op_assign
...
suffix:semicolon
multiline_comment|/**&n; * snd_hda_create_spdif_in_ctls - create Input SPDIF-related controls&n; * @codec: the HDA codec&n; * @nid: audio in widget NID&n; *&n; * Creates controls related with the SPDIF input.&n; * Called from each patch supporting the SPDIF in.&n; *&n; * Returns 0 if successful, or a negative error code.&n; */
DECL|function|snd_hda_create_spdif_in_ctls
r_int
...
multiline_comment|/**&n; * snd_hda_resume_spdif_out - resume the digital out&n; * @codec: the HDA codec&n; */
...
multiline_comment|/**&n; * snd_hda_resume_spdif_in - resume the digital in&n; * @codec: the HDA codec&n; */
DECL|function|snd_hda_resume_spdif_in
r_int

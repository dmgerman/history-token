...
DECL|function|snd_trident_create_gameport
r_int
id|__devinit
...
(paren
id|KERN_ERR
l_string|&quot;trident: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|snd_trident_free_gameport
r_static
r_inline
r_void
id|snd_trident_free_gameport
c_func
(paren
id|trident_t
op_star
...
multiline_comment|/*---------------------------------------------------------------------------&n;   snd_trident_free&n;  &n;   Description: This routine will free the device specific class for&n;                the 4DWave card. &n;                &n;   Paramters:   trident  - device specific private data for 4DWave card&n;&n;   Returns:     None.&n;  &n;  ---------------------------------------------------------------------------*/

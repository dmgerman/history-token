...
mdefine_line|#define set_silent_tlb(trident,page)&t;__set_tlb_bus(trident, page, (unsigned long)trident-&gt;tlb.silent_page.area, trident-&gt;tlb.silent_page.addr)
...
multiline_comment|/*&n; * page allocation for DMA (Scatter-Gather version)&n; */
r_static
id|snd_util_memblk_t
op_star
DECL|function|snd_trident_alloc_sg_pages
id|snd_trident_alloc_sg_pages
c_func
(paren
id|trident_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;page calculation doesn&squot;t match: allocated pages = %d, trident = %d/%d&bslash;n&quot;
comma
id|sgbuf-&gt;pages
comma
id|firstpg
...
multiline_comment|/*&n; * page allocation for DMA (contiguous version)&n; */
r_static
id|snd_util_memblk_t
op_star
DECL|function|snd_trident_alloc_cont_pages
id|snd_trident_alloc_cont_pages
c_func
(paren
id|trident_t
op_star

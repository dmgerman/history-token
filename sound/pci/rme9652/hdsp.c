...
suffix:semicolon
multiline_comment|/* Force firmware reload */
id|MODULE_PARM
c_func
(paren
id|snd_index
...
id|snd_printk
(paren
l_string|&quot;timeout waiting for firmware setup&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
r_else
(brace
multiline_comment|/* firmware already loaded, but we need to know what type&n;&t;&t;   of I/O box is connected.&n;&t;&t;*/
r_if
c_cond
(paren
id|hdsp_read
...
id|snd_printk
(paren
l_string|&quot;I/O Box is a Digiface&bslash;n&quot;
)paren
suffix:semicolon
id|hdsp-&gt;card_name
op_assign
...
id|snd_printk
(paren
l_string|&quot;I/O Box is a Multiface&bslash;n&quot;
)paren
suffix:semicolon
id|hdsp-&gt;card_name
op_assign

...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: loading firmware&bslash;n&quot;
)paren
suffix:semicolon
id|hdsp_write
(paren
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: timeout waiting for download preparation&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: timeout during firmware loading&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: timeout at end of firmware loading&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: finished firmware loading&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: firmware loaded from cache, restoring defaults&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: firmware not present.&bslash;n&quot;
)paren
suffix:semicolon
id|hdsp-&gt;state
op_and_assign
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: wait for FIFO status &lt;= %d failed after %d iterations&bslash;n&quot;
comma
id|count
comma
id|timeout
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: unknown spdif frequency status; bits = 0x%x, status = 0x%x&bslash;n&quot;
comma
id|rate_bits
comma
id|status
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: device is not running as a clock master: cannot set sample rate.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Detected ADAT in double speed mode&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Detected ADAT in quad speed mode&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: No AutoSync source for requested rate&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|snd_printk
(paren
l_string|&quot;Hammerfall-DSP: cannot change speed mode (capture PID = %d, playback PID = %d)&bslash;n&quot;
comma
id|hdsp-&gt;capture_pid
comma
id|hdsp-&gt;playback_pid
...
DECL|macro|HDSP_PRECISE_POINTER
mdefine_line|#define HDSP_PRECISE_POINTER(xname, xindex) &bslash;&n;{ .iface = SNDRV_CTL_ELEM_IFACE_HWDEP, &bslash;&n;  .name = xname, &bslash;&n;  .index = xindex, &bslash;&n;  .info = snd_hdsp_info_precise_pointer, &bslash;&n;  .get = snd_hdsp_get_precise_pointer, &bslash;&n;  .put = snd_hdsp_put_precise_pointer &bslash;&n;}
DECL|function|hdsp_set_precise_pointer
r_static
r_int
id|hdsp_set_precise_pointer
c_func
(paren
id|hdsp_t
op_star
...
DECL|function|snd_hdsp_info_precise_pointer
r_static
r_int
id|snd_hdsp_info_precise_pointer
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_hdsp_get_precise_pointer
r_static
r_int
id|snd_hdsp_get_precise_pointer
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_hdsp_put_precise_pointer
r_static
r_int
id|snd_hdsp_put_precise_pointer
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|macro|HDSP_USE_MIDI_TASKLET
mdefine_line|#define HDSP_USE_MIDI_TASKLET(xname, xindex) &bslash;&n;{ .iface = SNDRV_CTL_ELEM_IFACE_HWDEP, &bslash;&n;  .name = xname, &bslash;&n;  .index = xindex, &bslash;&n;  .info = snd_hdsp_info_use_midi_tasklet, &bslash;&n;  .get = snd_hdsp_get_use_midi_tasklet, &bslash;&n;  .put = snd_hdsp_put_use_midi_tasklet &bslash;&n;}
DECL|function|hdsp_set_use_midi_tasklet
r_static
r_int
id|hdsp_set_use_midi_tasklet
c_func
(paren
id|hdsp_t
op_star
...
DECL|function|snd_hdsp_info_use_midi_tasklet
r_static
r_int
id|snd_hdsp_info_use_midi_tasklet
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_hdsp_get_use_midi_tasklet
r_static
r_int
id|snd_hdsp_get_use_midi_tasklet
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_hdsp_put_use_midi_tasklet
r_static
r_int
id|snd_hdsp_put_use_midi_tasklet
c_func
(paren
id|snd_kcontrol_t
op_star
...
comma
id|HDSP_PRECISE_POINTER
c_func
(paren
l_string|&quot;Precise Pointer&quot;
comma
l_int|0
)paren
comma
id|HDSP_USE_MIDI_TASKLET
c_func
(paren
l_string|&quot;Use Midi Tasklet&quot;
comma
l_int|0
)paren
comma
...
id|buffer
comma
l_string|&quot;Use Midi Tasklet: %s&bslash;n&quot;
comma
id|hdsp-&gt;use_midi_tasklet
ques
c_cond
...
id|buffer
comma
l_string|&quot;Precise pointer: %s&bslash;n&quot;
comma
id|hdsp-&gt;precise_ptr
ques
c_cond
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Firmware loading from cache failed, please upload manually.&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: No firmware loaded nor cached, please upload firmware.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return
...
(paren
id|KERN_ERR
l_string|&quot;Hammerfall-DSP: firmware needs to be uploaded to the card.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: initializing firmware upload&bslash;n&quot;
)paren
suffix:semicolon
id|firmware
op_assign
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: error creating alsa devices&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: enable_io fifo_wait failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Error creating pcm interface&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Error creating first midi interface&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Error creating second midi interface&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Error creating ctl interface&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Error setting default values&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: error registering card&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
(paren
id|KERN_ERR
l_string|&quot;Hammerfall-DSP: invalid io_type %d&bslash;n&quot;
comma
id|hdsp-&gt;io_type
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Hammerfall-DSP: cannot load firmware %s&bslash;n&quot;
comma
id|fwfile
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Hammerfall-DSP: too short firmware size %d (expected %d)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: error creating hwdep device&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: unable to remap region 0x%lx-0x%lx&bslash;n&quot;
comma
id|hdsp-&gt;port
comma
id|hdsp-&gt;port
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: unable to use IRQ %d&bslash;n&quot;
comma
id|pci-&gt;irq
)paren
suffix:semicolon
...
(brace
multiline_comment|/* we wait 2 seconds to let freshly inserted cardbus cards do their hardware init */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* we don&squot;t fail as this can happen&n;&t;&t;&t;&t;   if userspace is not ready for&n;&t;&t;&t;&t;   firmware upload&n;&t;&t;&t;&t;*/
id|snd_printk
c_func
(paren
l_string|&quot;Hammerfall-DSP: couldn&squot;t get firmware from userspace. try using hdsploader&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
(brace
multiline_comment|/* init is complete, we return */
r_return
l_int|0
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: card initialization pending : waiting for firmware&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;Hammerfall-DSP: Firmware already present, initializing card.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond

...
id|rate_bits
suffix:semicolon
multiline_comment|/* ASSUMPTION: hdsp-&gt;lock is either help, or&n;&t;   there is no need for it (e.g. during module&n;&t;   initialization).&n;&t;*/
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;hardware metering isn&squot;t supported yet for hdsp9652 cards&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

...
mdefine_line|#define HDSP_Frequency0           (1&lt;&lt;6)  /* 0=44.1kHz/88.2kHz 1=48kHz/96kHz */
DECL|macro|HDSP_Frequency1
mdefine_line|#define HDSP_Frequency1           (1&lt;&lt;7)  /* 0=32kHz/64kHz */
...
mdefine_line|#define HDSP_SYNC_FROM_ADAT_SYNC 1
DECL|macro|HDSP_SYNC_FROM_SPDIF
mdefine_line|#define HDSP_SYNC_FROM_SPDIF     2
DECL|macro|HDSP_SYNC_FROM_ADAT1
mdefine_line|#define HDSP_SYNC_FROM_ADAT1     3
...
suffix:semicolon
multiline_comment|/* for information reporting */
DECL|member|last_external_sample_rate
r_int
id|last_external_sample_rate
suffix:semicolon
DECL|member|last_internal_sample_rate
r_int
id|last_internal_sample_rate
suffix:semicolon
...
id|spdif_ctl
suffix:semicolon
DECL|member|playback_mixer_ctls
id|snd_kcontrol_t
op_star
id|playback_mixer_ctls
(braket
...
r_inline
r_int
id|snd_hdsp_initialize_input_enable
(paren
id|hdsp_t
op_star
id|hdsp
...
r_static
r_int
id|hdsp_update_simple_mixer_controls
c_func
(paren
id|hdsp_t
op_star
...
(brace
multiline_comment|/* from martin bj&#xfffd;rnsen:&n;&n;&t;&t;&t;   &quot;You can only write dwords to the&n;&t;&t;&t;   mixer memory which contain two&n;&t;&t;&t;   mixer values in the low and high&n;&t;&t;&t;   word. So if you want to change&n;&t;&t;&t;   value 0 you have to read value 1&n;&t;&t;&t;   from the cache and write both to&n;&t;&t;&t;   the first dword in the mixer&n;&t;&t;&t;   memory.&quot;&n;&t;&t;&t;*/
id|hdsp-&gt;mixer_matrix
(braket
id|addr
)braket
...
id|HDSP_ADAT_SYNC_CHECK
suffix:semicolon
DECL|function|hdsp_update_simple_mixer_controls
r_static
r_int
id|hdsp_update_simple_mixer_controls
c_func
...
DECL|function|snd_hdsp_initialize_input_enable
r_static
r_inline
r_int
id|snd_hdsp_initialize_input_enable
...
l_int|1
suffix:semicolon
id|hdsp-&gt;last_external_sample_rate
op_assign
op_minus
l_int|1
suffix:semicolon
id|hdsp-&gt;last_internal_sample_rate
op_assign
op_minus
l_int|1
suffix:semicolon

...
(paren
id|KERN_ERR
l_string|&quot;invalid i/o resource %d&bslash;n&quot;
comma
id|i
op_plus
l_int|1
...
(paren
id|KERN_ERR
l_string|&quot;unable to grab port 0x%lx&bslash;n&quot;
comma
id|vx-&gt;port
(braket
id|i
...
(paren
id|KERN_ERR
l_string|&quot;Digigram VX222 soundcard not found or device busy&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
multiline_comment|/* format is: snd-vx222=enable,index,id */
DECL|function|alsa_card_vx222_setup
r_static
r_int
id|__init
id|alsa_card_vx222_setup
c_func
(paren
r_char
op_star

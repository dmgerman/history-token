...
DECL|variable|wm9713_mic_mixer
r_static
r_const
r_char
op_star
...
suffix:semicolon
DECL|variable|wm9713_rec_src_l
r_static
r_const
r_char
op_star
...
suffix:semicolon
DECL|variable|wm9713_rec_src_r
r_static
r_const
r_char
op_star
...
suffix:semicolon
DECL|variable|wm13_snd_ac97_controls_line_in
r_static
r_const
id|snd_kcontrol_new_t
id|wm13_snd_ac97_controls_line_in
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;Line In to Headphone Mute&quot;
comma
id|AC97_PC_BEEP
comma
l_int|15
...
c_func
(paren
l_string|&quot;Line In to Speaker Mute&quot;
comma
id|AC97_PC_BEEP
comma
l_int|14
...
suffix:semicolon
DECL|variable|wm13_snd_ac97_controls_dac
r_static
r_const
id|snd_kcontrol_new_t
id|wm13_snd_ac97_controls_dac
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;DAC to Headphone Mute&quot;
comma
id|AC97_PHONE
comma
l_int|15
...
suffix:semicolon
DECL|variable|wm13_snd_ac97_controls_mic
r_static
r_const
id|snd_kcontrol_new_t
id|wm13_snd_ac97_controls_mic
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;MIC Headphone Routing&quot;
comma
id|wm9713_enum
(braket
l_int|0
...
c_func
(paren
l_string|&quot;MIC Headphone Mixer Volume&quot;
comma
id|AC97_LINE
comma
l_int|0
...
suffix:semicolon
DECL|variable|wm13_snd_ac97_controls_adc
r_static
r_const
id|snd_kcontrol_new_t
id|wm13_snd_ac97_controls_adc
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;Gain Step Size (1.5dB/0.75dB)&quot;
comma
id|AC97_CD
comma
l_int|14
...
suffix:semicolon
DECL|variable|wm13_snd_ac97_controls_recsel
r_static
r_const
id|snd_kcontrol_new_t
id|wm13_snd_ac97_controls_recsel
(braket
)braket
op_assign
(brace
...
c_func
(paren
l_string|&quot;Record to Headphone Path&quot;
comma
id|wm9713_enum
(braket
l_int|1
...
c_func
(paren
l_string|&quot;Record to Headphone Volume&quot;
comma
id|AC97_VIDEO
comma
l_int|11
...
c_func
(paren
l_string|&quot;Record to Mono Boost (+20dB)&quot;
comma
id|AC97_VIDEO
comma
l_int|8
...
c_func
(paren
l_string|&quot;Record ADC Boost (+20dB)&quot;
comma
id|AC97_VIDEO
comma
l_int|6
...
suffix:semicolon
DECL|function|patch_wolfson_wm9713_specific
r_static
r_int
id|patch_wolfson_wm9713_specific
c_func
(paren
id|ac97_t
op_star
...
DECL|function|patch_wolfson_wm9713_suspend
r_static
r_void
id|patch_wolfson_wm9713_suspend
(paren
id|ac97_t
op_star
id|ac97
...
DECL|function|patch_wolfson_wm9713_resume
r_static
r_void
id|patch_wolfson_wm9713_resume
(paren
id|ac97_t
op_star
id|ac97
...
macro_line|#endif
DECL|variable|patch_wolfson_wm9713_ops
r_static
r_struct
id|snd_ac97_build_ops
id|patch_wolfson_wm9713_ops
op_assign
(brace
dot
id|build_specific
...
DECL|function|snd_ac97_stac9708_put_bias
r_static
r_int
id|snd_ac97_stac9708_put_bias
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|variable|snd_ac97_stac9708_bias_control
r_static
r_const
id|snd_kcontrol_new_t
id|snd_ac97_stac9708_bias_control
op_assign
(brace
dot
id|iface
...
id|name
op_assign
l_string|&quot;Sigmatel Output Bias Switch&quot;
comma
dot
id|info
op_assign
...
suffix:semicolon
DECL|function|check_ad1981_hp_jack_sense
r_static
r_void
id|check_ad1981_hp_jack_sense
c_func
(paren
id|ac97_t
op_star
...
id|patch_cm9738_ops
suffix:semicolon
multiline_comment|/* FIXME: can anyone confirm below? */
multiline_comment|/* CM9738 has no PCM volume although the register reacts */
id|ac97-&gt;flags
op_or_assign
...
id|patch_cm9739_ops
suffix:semicolon
multiline_comment|/* CM9739/A has no Master and PCM volume although the register reacts */
id|ac97-&gt;flags
op_or_assign
...
suffix:semicolon
multiline_comment|/* Special exception for ASUS W1000/CMI9739. It does not have an SPDIF in. */
r_if
c_cond
(paren
id|ac97-&gt;pci

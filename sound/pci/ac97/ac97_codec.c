...
DECL|macro|SPDIF_CS4205
mdefine_line|#define SPDIF_CS4205            0x68
DECL|macro|MODE_CS4205
mdefine_line|#define MODE_CS4205            0x5e
...
suffix:semicolon
DECL|variable|snd_ac97_cs4205_controls_spdif
r_static
r_const
id|snd_kcontrol_new_t
id|snd_ac97_cs4205_controls_spdif
(braket
l_int|2
)braket
op_assign
...
DECL|function|patch_cirrus_cs4205
r_static
r_int
id|patch_cirrus_cs4205
c_func
...
(brace
multiline_comment|/* Basically, the cs4205 has non-standard sp/dif registers.&n;     WHY CAN&squot;T ANYONE FOLLOW THE BLOODY SPEC?  *sigh*&n;      - sp/dif EA ID is not set, but sp/dif is always present.&n;        - enable/disable is spdif register bit 15.&n;      - sp/dif control register is 0x68.  differs from AC97:&n;        - valid is bit 14 (vs 15)&n;&t;- no DRS&n;&t;- only 44.1/48k [00 = 48, 01=44,1] (AC97 is 00=44.1, 10=48)&n;      - sp/dif ssource select is in 0x5e bits 0,1.&n;  */
id|ac97-&gt;flags
op_or_assign
id|AC97_CS_SPDIF
suffix:semicolon
...
suffix:semicolon
singleline_comment|// XXXX update spdif rate here too?
id|snd_ac97_update_bits
c_func
(paren
id|ac97

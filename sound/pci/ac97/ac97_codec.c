...
multiline_comment|/* AC97 audio codec chip revision detection. */
multiline_comment|/* Currently only Realtek ALC650 detection implemented. */
r_switch
c_cond
(paren
id|ac97-&gt;id

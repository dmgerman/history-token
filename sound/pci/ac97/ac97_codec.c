...
suffix:semicolon
singleline_comment|// signed long end_time;
r_int
r_int
id|tmp
suffix:semicolon
...
c_func
(paren
l_string|&quot;AC&squot;97 %d:%d access is not valid [0x%x], removing modem controls.&bslash;n&quot;
comma
id|ac97-&gt;num
comma
id|ac97-&gt;addr
...
(brace
macro_line|#if 0 /* FIXME - add modem powerup */
multiline_comment|/* nothing should be in powerdown mode */
id|snd_ac97_write_cache_test
c_func
(paren

...
mdefine_line|#define AC97_PAGE_SINGLE_VALUE(reg,shift,mask,invert,page) ((reg) | ((shift) &lt;&lt; 8) | ((mask) &lt;&lt; 16) | ((invert) &lt;&lt; 24) | ((page) &lt;&lt; 25))
...
mdefine_line|#define AC97_PAGE_SINGLE(xname, reg, shift, mask, invert, page)&t;&t;&bslash;&n;{ .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .info = snd_ac97_info_single, &bslash;&n;  .get = snd_ac97_page_get_single, .put = snd_ac97_page_put_single, &bslash;&n;  .private_value =  AC97_PAGE_SINGLE_VALUE(reg, shift, mask, invert, page) }

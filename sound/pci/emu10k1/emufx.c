...
id|_gctl
op_assign
id|icode-&gt;gpr_list_controls
suffix:semicolon
id|i
OL
id|icode-&gt;gpr_list_control_count
suffix:semicolon
id|i
op_increment
comma
...
(brace
multiline_comment|/* FIXME: we need to check the WRITE access */
r_if
c_cond
(paren
id|copy_from_user
...
suffix:semicolon
multiline_comment|/* inverted, we want to write new value in gpr_ctl_put() */
...
id|icode-&gt;gpr_list_control_total
op_assign
id|total
suffix:semicolon
id|kfree
...
mdefine_line|#define SND_EMU10K1_PLAYBACK_CHANNELS&t;8
...
suffix:semicolon
multiline_comment|/* PCM front Playback Volume (independent from stereo mix) */
id|A_OP
c_func
(paren
id|icode
...
l_int|2
suffix:semicolon
multiline_comment|/* PCM Surround Playback (independent from stereo mix) */
id|A_OP
c_func
(paren
id|icode
...
comma
l_string|&quot;PCM Surround Playback Volume&quot;
comma
id|gpr
comma
l_int|100
...
l_int|2
suffix:semicolon
multiline_comment|/* PCM Side Playback (independent from stereo mix) */
r_if
c_cond
(paren
id|emu-&gt;spk71
...
comma
l_string|&quot;PCM Side Playback Volume&quot;
comma
id|gpr
comma
l_int|100
...
multiline_comment|/* PCM Center Playback (independent from stereo mix) */
id|A_OP
c_func
(paren
id|icode
...
comma
l_string|&quot;PCM Center Playback Volume&quot;
comma
id|gpr
comma
l_int|100
...
op_increment
suffix:semicolon
multiline_comment|/* PCM LFE Playback (independent from stereo mix) */
id|A_OP
c_func
(paren
id|icode
...
comma
l_string|&quot;PCM LFE Playback Volume&quot;
comma
id|gpr
comma
l_int|100
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * Stereo Mix&n;&t; */
multiline_comment|/* Wave (PCM) Playback Volume (will be renamed later) */
id|A_OP
c_func
(paren
id|icode
...
l_int|2
suffix:semicolon
multiline_comment|/* Stereo Mix Front Playback Volume */
id|A_OP
c_func
(paren
id|icode
...
l_int|2
suffix:semicolon
multiline_comment|/* Stereo Mix Surround Playback */
id|A_OP
c_func
(paren
id|icode
...
l_int|2
suffix:semicolon
multiline_comment|/* Stereo Mix Center Playback */
...
op_increment
suffix:semicolon
multiline_comment|/* Stereo Mix LFE Playback */
id|A_OP
c_func
(paren
id|icode
...
(brace
multiline_comment|/* Stereo Mix Side Playback */
id|A_OP
c_func
(paren
id|icode
...
DECL|macro|_A_SWITCH
mdefine_line|#define _A_SWITCH(icode, ptr, dst, src, sw) &bslash;&n;&t;A_OP((icode), ptr, iMACINT0, dst, A_C_00000000, src, sw);
DECL|macro|A_SWITCH
mdefine_line|#define A_SWITCH(icode, ptr, dst, src, sw) &bslash;&n;&t;&t;_A_SWITCH(icode, ptr, A_GPR(dst), A_GPR(src), A_GPR(sw))
DECL|macro|_A_SWITCH_NEG
mdefine_line|#define _A_SWITCH_NEG(icode, ptr, dst, src) &bslash;&n;&t;A_OP((icode), ptr, iANDXOR, dst, src, A_C_00000001, A_C_00000001);
DECL|macro|A_SWITCH_NEG
mdefine_line|#define A_SWITCH_NEG(icode, ptr, dst, src) &bslash;&n;&t;&t;_A_SWITCH_NEG(icode, ptr, A_GPR(dst), A_GPR(src))
...
(brace
multiline_comment|/* front/rear/center-lfe/side */
r_int
id|j
comma
id|k
...
l_int|2
suffix:semicolon
multiline_comment|/* Master volume (will be renamed later) */
id|A_OP
c_func
(paren
id|icode
...
multiline_comment|/* A_PUT_STEREO_OUTPUT(A_EXTOUT_FRONT_L, A_EXTOUT_FRONT_R, playback + SND_EMU10K1_PLAYBACK_CHANNELS); */
...
op_logical_and
(paren
id|emu-&gt;card_capabilities-&gt;spdif_bug
)paren
)paren
(brace
multiline_comment|/* Due to a SPDIF output bug on some Audigy cards, this code delays the Right channel by 1 sample */
id|snd_printk
c_func
(paren
l_string|&quot;Installing spdif_bug patch: %s&bslash;n&quot;
comma

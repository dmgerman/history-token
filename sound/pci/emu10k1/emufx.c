...
mdefine_line|#define A_GPR_ACCU 0xd6
DECL|macro|A_GPR_COND
mdefine_line|#define A_GPR_COND 0xd7
...
l_int|2
suffix:semicolon
multiline_comment|/* Master volume for audigy2 */
r_if
c_cond
(paren
id|emu-&gt;revision
...
singleline_comment|//&t;A_PUT_STEREO_OUTPUT(A_EXTOUT_FRONT_L, A_EXTOUT_FRONT_R, playback + SND_EMU10K1_PLAYBACK_CHANNELS);

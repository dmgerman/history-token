...
multiline_comment|/* vendor, device, subsystem, emu10k1_chip, emu10k2_chip, ca0102_chip, ca0108_chip, ca0151_chip, spk71, spdif_bug, ac97_chip, ecard, driver, name */
DECL|variable|emu_chip_details
r_static
...
op_assign
(brace
multiline_comment|/* Audigy 2 Value AC3 out does not work yet. Need to find out how to turn off interpolators.*/
(brace
dot
id|vendor
op_assign
...
id|name
op_assign
l_string|&quot;Audigy 2 Value [SB0400]&quot;
comma
dot
id|emu10k2_chip
op_assign
...
id|name
op_assign
l_string|&quot;Audigy 2 Value [Unknown]&quot;
comma
dot
id|emu10k2_chip
op_assign
...
id|name
op_assign
l_string|&quot;Audigy 2 Platinum [SB0240P]&quot;
comma
dot
id|emu10k2_chip
op_assign
...
id|name
op_assign
l_string|&quot;Audigy 1 or 2 [Unknown]&quot;
comma
dot
id|emu10k2_chip
op_assign
...
c_func
(paren
l_string|&quot;vendor=0x%x, device=0x%x, subsystem_vendor_id=0x%x, subsystem_id=0x%x&bslash;n&quot;
comma
id|pci-&gt;vendor
comma
id|pci-&gt;device
...
(paren
id|KERN_ERR
l_string|&quot;emu10k1: Card not recognised&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
c_func
(paren
l_string|&quot;Sound card name=%s&bslash;n&quot;
comma
id|c-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Sound card name=%s, vendor=0x%x, device=0x%x, subsystem=0x%x&bslash;n&quot;
comma
id|c-&gt;name
comma
id|pci-&gt;vendor

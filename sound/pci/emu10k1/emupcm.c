multiline_comment|/*&n; *  Copyright (c) by Jaroslav Kysela &lt;perex@suse.cz&gt;&n; *                   Creative Labs, Inc.&n; *  Routines for control of EMU10K1 chips / PCM routines&n; *  Multichannel PCM support Copyright (c) Lee Revell &lt;rlrevell@joe-job.com&gt;&n; *&n; *  BUGS:&n; *    --&n; *&n; *  TODO:&n; *    --&n; *&n; *   This program is free software; you can redistribute it and/or modify&n; *   it under the terms of the GNU General Public License as published by&n; *   the Free Software Foundation; either version 2 of the License, or&n; *   (at your option) any later version.&n; *&n; *   This program is distributed in the hope that it will be useful,&n; *   but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *   GNU General Public License for more details.&n; *&n; *   You should have received a copy of the GNU General Public License&n; *   along with this program; if not, write to the Free Software&n; *   Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307 USA&n; *&n; */
...
multiline_comment|/*&n; * calculate cache invalidate size &n; *&n; * stereo: channel is stereo&n; * w_16: using 16bit samples&n; *&n; * returns: cache invalidate size in samples&n; */
DECL|function|emu10k1_ccis
r_static
r_int
r_inline
id|emu10k1_ccis
...
suffix:semicolon
singleline_comment|// set cs to 2 * number of cache registers beside the invalidated
id|cs
op_assign
(paren
id|sample

...
DECL|function|snd_audigy_spdif_output_rate_info
r_static
r_int
id|snd_audigy_spdif_output_rate_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_audigy_spdif_output_rate_get
r_static
r_int
id|snd_audigy_spdif_output_rate_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_audigy_spdif_output_rate_put
r_static
r_int
id|snd_audigy_spdif_output_rate_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|variable|snd_audigy_spdif_output_rate
r_static
id|snd_kcontrol_new_t
id|snd_audigy_spdif_output_rate
op_assign
(brace
dot
id|access
...
id|name
op_assign
l_string|&quot;Audigy SPDIF Output Sample Rate&quot;
comma
dot
id|count
op_assign
...
multiline_comment|/* PCM stream controls */
...
suffix:semicolon
multiline_comment|/* Mutichannel PCM stream controls */
DECL|function|snd_emu10k1_efx_send_routing_info
r_static
r_int
id|snd_emu10k1_efx_send_routing_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_send_routing_get
r_static
r_int
id|snd_emu10k1_efx_send_routing_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_send_routing_put
r_static
r_int
id|snd_emu10k1_efx_send_routing_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|variable|snd_emu10k1_efx_send_routing_control
r_static
id|snd_kcontrol_new_t
id|snd_emu10k1_efx_send_routing_control
op_assign
(brace
dot
id|access
...
id|name
op_assign
l_string|&quot;Multichannel PCM Send Routing&quot;
comma
dot
id|count
op_assign
...
suffix:semicolon
DECL|function|snd_emu10k1_efx_send_volume_info
r_static
r_int
id|snd_emu10k1_efx_send_volume_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_send_volume_get
r_static
r_int
id|snd_emu10k1_efx_send_volume_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_send_volume_put
r_static
r_int
id|snd_emu10k1_efx_send_volume_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|variable|snd_emu10k1_efx_send_volume_control
r_static
id|snd_kcontrol_new_t
id|snd_emu10k1_efx_send_volume_control
op_assign
(brace
dot
id|access
...
id|name
op_assign
l_string|&quot;Multichannel PCM Send Volume&quot;
comma
dot
id|count
op_assign
...
suffix:semicolon
DECL|function|snd_emu10k1_efx_attn_info
r_static
r_int
id|snd_emu10k1_efx_attn_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_attn_get
r_static
r_int
id|snd_emu10k1_efx_attn_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_emu10k1_efx_attn_put
r_static
r_int
id|snd_emu10k1_efx_attn_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|variable|snd_emu10k1_efx_attn_control
r_static
id|snd_kcontrol_new_t
id|snd_emu10k1_efx_attn_control
op_assign
(brace
dot
id|access
...
id|name
op_assign
l_string|&quot;Multichannel PCM Volume&quot;
comma
dot
id|count
op_assign
...
id|err
suffix:semicolon
multiline_comment|/* initialize the routing and volume table for each pcm playback stream */
r_for
c_loop
(paren
id|pcm
...
multiline_comment|/* initialize the routing and volume table for the multichannel playback stream */
r_for
c_loop
(paren
id|pcm

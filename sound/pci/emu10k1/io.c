...
multiline_comment|/*&n; *  Returns an attenuation based upon a cumulative volume value&n; *  Algorithm calculates 0x200 - 0x10 log2 (input)&n; */
DECL|function|snd_emu10k1_sum_vol_attn
r_int
r_char

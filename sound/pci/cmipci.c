...
DECL|macro|CM_CHIP_055
mdefine_line|#define CM_CHIP_055&t;&t;0x08000000
DECL|macro|CM_CHIP_8768
mdefine_line|#define CM_CHIP_8768&t;&t;0x20000000
...
DECL|macro|CM_REG_MISC_CTRL_8768
mdefine_line|#define CM_REG_MISC_CTRL_8768&t;0x92&t;/* reg. name the same as 0x18 */
DECL|macro|CM_CHB3D8C
mdefine_line|#define CM_CHB3D8C&t;&t;0x20&t;/* 7.1 channels support */
DECL|macro|CM_SPD32FMT
mdefine_line|#define CM_SPD32FMT&t;&t;0x10&t;/* SPDIF/IN 32k */
DECL|macro|CM_ADC2SPDIF
mdefine_line|#define CM_ADC2SPDIF&t;&t;0x08&t;/* ADC output to SPDIF/OUT */
DECL|macro|CM_SHAREADC
mdefine_line|#define CM_SHAREADC&t;&t;0x04&t;/* DAC in ADC as Center/LFE */
DECL|macro|CM_REALTCMP
mdefine_line|#define CM_REALTCMP&t;&t;0x02&t;/* monitor the CMPL/CMPR of ADC */
DECL|macro|CM_INVLRCK
mdefine_line|#define CM_INVLRCK&t;&t;0x01&t;/* invert ZVPORT&squot;s LRCK */
...
suffix:semicolon
DECL|variable|hw_constraints_channels_8
r_static
id|snd_pcm_hw_constraint_list_t
id|hw_constraints_channels_8
op_assign
(brace
dot
id|count
...
suffix:semicolon
multiline_comment|/* spdif playback on channel A (32bit, IEC958 subframes) */
DECL|variable|snd_cmipci_playback_iec958_subframe
r_static
id|snd_pcm_hardware_t
id|snd_cmipci_playback_iec958_subframe
op_assign
(brace
dot
id|info
...
(brace
singleline_comment|// 8768 only supports 44k/48k recording
...
(brace
singleline_comment|// 8768 has no PCM volume
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;chip %x version not supported&bslash;n&quot;
comma
id|detect
)paren
suffix:semicolon
...
macro_line|#ifdef SUPPORT_JOYSTICK
DECL|function|snd_cmipci_create_gameport
r_static
r_int
id|__devinit
id|snd_cmipci_create_gameport
c_func
(paren
id|cmipci_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;cmipci: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
DECL|function|snd_cmipci_free_gameport
r_static
r_void
id|snd_cmipci_free_gameport
c_func
(paren
id|cmipci_t
op_star

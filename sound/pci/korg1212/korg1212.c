...
multiline_comment|/*&n;        if (params_format(params) != SNDRV_PCM_FORMAT_S16_LE) {&n;                spin_unlock_irqrestore(&amp;korg1212-&gt;lock, flags);&n;                return -EINVAL;&n;        }&n;*/
id|korg1212-&gt;channels
op_assign
id|params_channels
c_func
...
multiline_comment|/* format is: snd-korg1212=enable,index,id */

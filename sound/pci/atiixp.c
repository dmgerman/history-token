...
(paren
id|KERN_WARNING
l_string|&quot;atiixp: codec read timeout&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0xffff
...
op_amp
id|ATI_REG_MODEM_MIRROR_RUNNING
)paren
r_return
op_minus
id|EBUSY
...
(paren
id|KERN_ERR
l_string|&quot;ATI IXP AC97 controller not found or device busy&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
multiline_comment|/* format is: snd-atiixp=enable,index,id,ac97_clock,spdif_aclink */
DECL|function|alsa_card_atiixp_setup
r_static
r_int
id|__init
id|alsa_card_atiixp_setup
c_func
(paren
r_char
op_star

...
DECL|macro|ESM_MEM_ALIGN
mdefine_line|#define ESM_MEM_ALIGN&t;&t;0x1000
DECL|macro|ESM_MIXBUF_SIZE
mdefine_line|#define ESM_MIXBUF_SIZE&t;&t;0x400
...
multiline_comment|/* for clock measurement */
...
l_int|1
suffix:semicolon
DECL|member|measure_apu
r_int
r_int
id|measure_apu
suffix:semicolon
DECL|member|measure_lastpos
r_int
r_int
id|measure_lastpos
suffix:semicolon
DECL|member|measure_count
r_int
r_int
id|measure_count
suffix:semicolon
...
multiline_comment|/* call with substream spinlock */
...
(brace
multiline_comment|/* set the APU mode */
id|__apu_set_register
c_func
(paren
id|esm
...
DECL|function|init_capture_apu
r_static
r_void
id|init_capture_apu
c_func
...
suffix:semicolon
multiline_comment|/* words */
multiline_comment|/* base offset of dma calcs when reading the pointer&n;&t;   on this left one */
id|es-&gt;base
(braket
id|channel
)braket
...
suffix:semicolon
multiline_comment|/* need to enable subgroups.. and we should probably&n;&t;   have different groups for different /dev/dsps..  */
id|apu_set_register
c_func
(paren
id|chip
...
id|es-&gt;wav_shift
suffix:semicolon
multiline_comment|/* APU assignments:&n;&t;   0 = mono/left SRC&n;&t;   1 = right SRC&n;&t;   2 = mono/left Input Mixer&n;&t;   3 = right Input Mixer&n;&t;*/
multiline_comment|/* data seems to flow from the codec, through an apu into&n;&t;   the &squot;mixbuf&squot; bit of page, then through the SRC apu&n;&t;   and out to the real &squot;buffer&squot;.  ok.  sure.  */
multiline_comment|/* input mixer (left/mono) */
...
id|ESM_APU_INPUTMIXER
comma
l_int|0x14
)paren
suffix:semicolon
multiline_comment|/* SRC (left/mono); get input from inputing apu */
id|init_capture_apu
c_func
(paren
id|chip
...
(brace
multiline_comment|/* input mixer (right) */
id|init_capture_apu
c_func
(paren
id|chip
...
l_int|1024
suffix:semicolon
multiline_comment|/* keep MIXBUF size */
macro_line|#if 0
id|snd_pcm_hw_constraint_step
c_func
(paren
...
r_return
suffix:semicolon
multiline_comment|/* FIXME: we can&squot;t call snd_ac97_* functions since here is in tasklet. */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
DECL|function|snd_es1968_create_gameport
r_static
r_int
id|__devinit
id|snd_es1968_create_gameport
c_func
(paren
id|es1968_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;es1968: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
DECL|function|snd_es1968_free_gameport
r_static
r_void
id|snd_es1968_free_gameport
c_func
(paren
id|es1968_t
op_star
...
comma
multiline_comment|/* HP omnibook 4150 */
)brace
suffix:semicolon
DECL|variable|__devinitdata
r_static
...
(brace
multiline_comment|/* disable power-management if not on the whitelist */
r_int
r_int
id|vend
suffix:semicolon
...
(brace
multiline_comment|/* not matched; disabling pm */
id|printk
c_func
(paren
id|KERN_INFO
...
(brace
multiline_comment|/* check the black list */
r_int
r_int
id|vend
suffix:semicolon

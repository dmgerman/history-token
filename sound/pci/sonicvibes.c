...
suffix:semicolon
DECL|function|snd_sonicvibes_create_gameport
r_static
r_int
id|__devinit
id|snd_sonicvibes_create_gameport
c_func
(paren
id|sonicvibes_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;sonicvibes: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|snd_sonicvibes_free_gameport
r_static
r_void
id|snd_sonicvibes_free_gameport
c_func
(paren
id|sonicvibes_t
op_star

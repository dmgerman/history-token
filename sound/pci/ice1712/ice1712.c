...
multiline_comment|/*&n; */
multiline_comment|/*&n;&t;the VT1724 has 23 GPIO pins, so need 3 bytes for direction and 3 bytes for write mask&n; */
...
c_cond
(paren
id|ice-&gt;ak4524.ops.set_rate_val
)paren
id|ice-&gt;ak4524.ops
dot
id|set_rate_val
...
l_int|0x7ffff0
comma
multiline_comment|/* we have 18bits for the buffer size, in dwords */
dot
id|period_bytes_min
op_assign
l_int|8
...
l_int|131040
comma
multiline_comment|/* do we have 18bits for terminal count? &n;&t;&t;&t;&t;&t;&t;&t;&t;&t;&t;Datasheets says bits 18:0 but only has 2 byte registers (1C-1Dh ) */
dot
id|periods_min
op_assign
l_int|1
...
suffix:semicolon
DECL|variable|snd_ice1724_capture_pro
r_static
id|snd_pcm_hardware_t
id|snd_ice1724_capture_pro
op_assign
(brace
dot
id|info
...
DECL|variable|snd_ice1712_pro_internal_clock
r_static
id|snd_kcontrol_new_t
...
l_int|5
suffix:semicolon
singleline_comment|//kcontrol-&gt;id.index &lt; 2 ? 12 : 11;
r_if
c_cond
(paren
id|uinfo-&gt;value.enumerated.item
...
l_int|3
suffix:semicolon
singleline_comment|//I hope this is right
id|val
op_and_assign
l_int|7
suffix:semicolon
...
id|ICE1712_CFG_NO_CON_AC97
suffix:semicolon
multiline_comment|/* little hack here */
id|ice-&gt;eeprom.aclink
op_assign
id|snd_ice1712_read_i2c
c_func
...
id|err
suffix:semicolon
multiline_comment|/* VT1724 does not have 28bit DMA transfer limit */
r_if
c_cond
(paren
id|pci-&gt;device

...
id|chn
suffix:semicolon
multiline_comment|/* EZ8 Hack: Change shortname and subvendor id, Recall functions called in&n;&t; * snd_ice1712_chip_init when it still thinks it is a Hoontech DSP24 card.&n;&t; */
r_if
c_cond
(paren
id|ice-&gt;ez8

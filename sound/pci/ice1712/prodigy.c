...
suffix:semicolon
multiline_comment|/*snd_printk(&quot;Prodigy set headphone amplifier: %d&bslash;n&quot;,ucontrol-&gt;value.integer.value[0]);*/
id|prodigy_set_headphone_amp
c_func
(paren
id|ice
...
id|err
suffix:semicolon
singleline_comment|// if (ice-&gt;eeprom.subvendor == VT1724_SUBDEVICE_PRODIGY71)
id|err
op_assign
id|snd_ctl_add
c_func

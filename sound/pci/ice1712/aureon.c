...
DECL|macro|wm_dac_mute_info
mdefine_line|#define wm_dac_mute_info&t;aureon_mono_bool_info
DECL|function|wm_dac_mute_get
r_static
r_int
id|wm_dac_mute_get
c_func
...
comma
multiline_comment|/* model not needed - identical with 7.1-Space */
dot
id|chip_init
op_assign
id|aureon_init

...
suffix:semicolon
DECL|function|snd_ymfpci_get_joystick_port
r_static
r_int
id|snd_ymfpci_get_joystick_port
c_func
(paren
id|ymfpci_t
op_star
...
DECL|function|snd_ymfpci_enable_joystick
r_static
r_int
id|snd_ymfpci_enable_joystick
c_func
(paren
id|ymfpci_t
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;gameport port %#x in use&bslash;n&quot;
comma
id|chip-&gt;gameport.io
)paren
suffix:semicolon
...
DECL|function|snd_ymfpci_disable_joystick
r_static
r_int
id|snd_ymfpci_disable_joystick
c_func
(paren
id|ymfpci_t
op_star

...
suffix:semicolon
singleline_comment|// snd_ymfpci_irq_wait(chip);
r_if
c_cond
(paren
id|chip-&gt;ac3_tmp_base.area
)paren
(brace
...
DECL|function|snd_ymfpci_playback_open_1
r_static
r_int
id|snd_ymfpci_playback_open_1
c_func
(paren
id|snd_pcm_substream_t
op_star
...
DECL|function|ymfpci_open_extension
r_static
r_void
id|ymfpci_open_extension
c_func
(paren
id|ymfpci_t
op_star
...
(paren
op_logical_neg
id|chip-&gt;spdif_opened
)paren
multiline_comment|/* set AC3 */
id|snd_ymfpci_writel
c_func
(paren
id|chip
...
suffix:semicolon
multiline_comment|/* enable second codec (4CHEN) */
id|snd_ymfpci_writew
c_func
(paren
id|chip
...
multiline_comment|/* call with spinlock held */
DECL|function|ymfpci_close_extension
r_static
r_void
id|ymfpci_close_extension
c_func
(paren
id|ymfpci_t
op_star
...
DECL|function|snd_ymfpci_playback_close_1
r_static
r_int
id|snd_ymfpci_playback_close_1
c_func
(paren
id|snd_pcm_substream_t
op_star
...
ques
c_cond
l_string|&quot;Direct Recording&quot;
suffix:colon
l_string|&quot;AC&squot;97&quot;
)paren
suffix:semicolon
id|chip-&gt;pcm2
op_assign
...
suffix:semicolon
DECL|function|snd_ymfpci_drec_source_info
r_static
r_int
id|snd_ymfpci_drec_source_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_drec_source_get
r_static
r_int
id|snd_ymfpci_drec_source_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_drec_source_put
r_static
r_int
id|snd_ymfpci_drec_source_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
id|name
op_assign
l_string|&quot;Direct Recording Source&quot;
comma
dot
id|info
op_assign
...
multiline_comment|/*&n; * 4ch duplication&n; */
DECL|function|snd_ymfpci_info_dup4ch
r_static
r_int
id|snd_ymfpci_info_dup4ch
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_get_dup4ch
r_static
r_int
id|snd_ymfpci_get_dup4ch
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_put_dup4ch
r_static
r_int
id|snd_ymfpci_put_dup4ch
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_get_gpio_out
r_static
r_int
id|snd_ymfpci_get_gpio_out
c_func
(paren
id|ymfpci_t
op_star
...
suffix:semicolon
multiline_comment|/* set the level mode for input line */
id|mode
op_assign
id|snd_ymfpci_readw
c_func
...
DECL|function|snd_ymfpci_set_gpio_out
r_static
r_int
id|snd_ymfpci_set_gpio_out
c_func
(paren
id|ymfpci_t
op_star
...
DECL|function|snd_ymfpci_gpio_sw_info
r_static
r_int
id|snd_ymfpci_gpio_sw_info
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_gpio_sw_get
r_static
r_int
id|snd_ymfpci_gpio_sw_get
c_func
(paren
id|snd_kcontrol_t
op_star
...
DECL|function|snd_ymfpci_gpio_sw_put
r_static
r_int
id|snd_ymfpci_gpio_sw_put
c_func
(paren
id|snd_kcontrol_t
op_star
...
id|name
op_assign
l_string|&quot;Shared Rear/Line-In Switch&quot;
comma
dot
id|iface
op_assign
...
DECL|function|snd_ymfpci_mixer_free_ac97_bus
r_static
r_void
...
id|kctl
suffix:semicolon
multiline_comment|/* direct recording source */
r_if
c_cond
(paren
id|chip-&gt;device_id
...
id|err
suffix:semicolon
multiline_comment|/*&n;&t; * shared rear/line-in&n;&t; */
r_if
c_cond
(paren
id|rear_switch
...
DECL|function|snd_ymfpci_timer_start
r_static
r_int
id|snd_ymfpci_timer_start
c_func
(paren
id|snd_timer_t
op_star
...
multiline_comment|/* minimum time is 20.8 us */
id|count
op_assign
l_int|1
suffix:semicolon
...
DECL|function|snd_ymfpci_timer_stop
r_static
r_int
id|snd_ymfpci_timer_stop
c_func
(paren
id|snd_timer_t
op_star
...
DECL|function|snd_ymfpci_timer_precise_resolution
r_static
r_int
id|snd_ymfpci_timer_precise_resolution
c_func
(paren
id|snd_timer_t
op_star
...
DECL|variable|snd_ymfpci_timer_hw
r_static
r_struct
id|_snd_timer_hardware
id|snd_ymfpci_timer_hw
op_assign
(brace
dot
id|flags
...
l_int|10417
comma
multiline_comment|/* 1/2fs = 10.41666...us */
dot
id|ticks
op_assign
l_int|65536
...
suffix:semicolon
DECL|function|snd_ymfpci_timer
r_int
id|__devinit
id|snd_ymfpci_timer
c_func
...
id|ptr
op_assign
id|chip-&gt;work_ptr.area
suffix:semicolon
id|ptr_addr
op_assign
id|chip-&gt;work_ptr.addr
suffix:semicolon
id|memset
c_func
(paren
...
macro_line|#if 0
multiline_comment|/* FIXME: temporarily disabled, otherwise we cannot fire up&n;&t; * the chip again unless reboot.  ACPI bug?&n;&t; */

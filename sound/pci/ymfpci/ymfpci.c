...
(paren
id|KERN_ERR
l_string|&quot;ymfpci: no gameport ports available&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;ymfpci: invalid joystick port %#x&quot;
comma
id|io_port
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ymfpci: joystick port %#x is in use.&bslash;n&quot;
comma
id|io_port
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ymfpci: cannot allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_resource
c_func
...
DECL|function|snd_ymfpci_free_gameport
r_void

...
mdefine_line|#define HARMONY_BUF_SIZE&t;4096
DECL|macro|MAX_BUFS
mdefine_line|#define MAX_BUFS&t;&t;10
DECL|macro|MAX_BUFFER_SIZE
mdefine_line|#define MAX_BUFFER_SIZE&t;&t;(MAX_BUFS * HARMONY_BUF_SIZE)
...
multiline_comment|/* bits corresponding to the entries of snd_card_harmony_rates */
...
multiline_comment|/* re-initialize silence buffer if needed */
r_if
c_cond
(paren
id|old_format
...
(brace
multiline_comment|/* use continuous buffers */
id|harmony-&gt;dma_dev.type
op_assign
id|SNDRV_DMA_TYPE_CONTINUOUS
suffix:semicolon
...
id|KERN_ERR
id|PFX
l_string|&quot;can&squot;t allocate graveyard buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
id|KERN_ERR
id|PFX
l_string|&quot;can&squot;t allocate silence buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err

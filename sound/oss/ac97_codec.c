...
id|d
suffix:semicolon
multiline_comment|/* wait for codec-ready state */
r_if
c_cond
(paren
id|codec-&gt;codec_wait
...
suffix:semicolon
multiline_comment|/* will the codec power down if register reset ? */
id|id1
op_assign
id|codec
op_member_access_from_pointer
...
(brace
multiline_comment|/* reset codec and wait for the ready bit before we continue */
id|codec
op_member_access_from_pointer
id|codec_write
c_func
...
multiline_comment|/* WM9713 */
DECL|function|wolfson_init13
r_static
r_int
id|wolfson_init13
c_func

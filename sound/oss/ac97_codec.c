...
l_int|0x574D4C03
comma
l_string|&quot;Wolfson WM9703/WM9707&quot;
comma
op_amp
id|wolfson_ops03
)brace
...
(brace
multiline_comment|/* This initialization is suspect, but not known to be wrong.&n;&t;   It was copied from the initialization for the WM9704Q, but&n;&t;   that same sequence is known to fail for the WM9707.  Thus&n;&t;   this warning may help someone with hardware to test&n;&t;   this code. */
id|codec
op_member_access_from_pointer
id|codec_write
c_func

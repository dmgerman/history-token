...
macro_line|#ifdef CONFIG_SOUND_CMPCI_JOYSTICK
DECL|function|cm_create_gameport
r_static
r_int
id|__devinit
id|cm_create_gameport
c_func
(paren
r_struct
id|cm_state
...
(paren
id|KERN_ERR
l_string|&quot;cmpci: gameport io ports 0x%#x in use&bslash;n&quot;
comma
id|io_port
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cmpci: can not allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
DECL|function|cm_free_gameport
r_static
r_void
id|__devexit
id|cm_free_gameport
...
suffix:colon
macro_line|#endif
multiline_comment|/* disable joystick port */
id|maskb
c_func
(paren
id|s-&gt;iobase

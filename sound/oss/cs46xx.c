...
id|lock
suffix:semicolon
multiline_comment|/* Keep AC97 sane */
...
multiline_comment|/*&n;&t; * granularity is byte boundary, good part.&n;&t; */
r_if
c_cond
(paren
id|dmabuf-&gt;enable
...
singleline_comment|// remap_pfn_range() in cs46xx_mmap doesn&squot;t work.
...
(paren
id|KERN_INFO
l_string|&quot;cs_copy_to_user()+ fmt=0x%x cnt=%d dest=%p&bslash;n&quot;
comma
id|dmabuf-&gt;fmt
comma
(paren
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: cs_copy_to_user()- fault dest=%p src=%p cnt=%d&bslash;n&quot;
comma
id|dest
comma
id|src
...
id|name
op_assign
l_string|&quot;Hercules Fortissimo II&quot;
comma
dot
id|amp
op_assign

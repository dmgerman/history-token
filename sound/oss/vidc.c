...
DECL|macro|VIDC_SOUND_CLOCK_EXT
mdefine_line|#define VIDC_SOUND_CLOCK_EXT&t;(176400)
...
DECL|macro|my_abs
mdefine_line|#define my_abs(i) ((i)&lt;0 ? -(i) : (i))
...
l_int|0x00000003
suffix:semicolon
multiline_comment|/* Using internal clock */
id|hwrate
op_assign
(paren
(paren
...
l_int|255
suffix:semicolon
multiline_comment|/* Using exernal clock */
id|hwrate_ext
op_assign
(paren
(paren
(paren
id|VIDC_SOUND_CLOCK_EXT
op_star
l_int|2
)paren
op_div
...
id|hwrate_ext
suffix:semicolon
multiline_comment|/* Chose between external and internal clock */
id|diff_int
op_assign
id|my_abs
c_func
...
(brace
multiline_comment|/*printk(&quot;VIDC: external %d %d %d&bslash;n&quot;, rate, rate_ext, hwrate_ext);*/
id|hwrate
op_assign
id|hwrate_ext
suffix:semicolon
...
l_int|0x00000002
suffix:semicolon
multiline_comment|/* Allow roughly 0.4% tolerance */
r_if
c_cond
(paren
id|diff_ext
...
r_else
(brace
multiline_comment|/*printk(&quot;VIDC: internal %d %d %d&bslash;n&quot;, rate, rate_int, hwrate);*/
id|hwctrl
op_assign
l_int|0x00000003
suffix:semicolon
multiline_comment|/* Allow rougly 0.4% tolerance */
r_if
c_cond
(paren
id|diff_int
...
multiline_comment|/*printk(&quot;VIDC: dma size %d&bslash;n&quot;, new2size);*/
id|dma_bufsize
op_assign
id|new2size
suffix:semicolon

...
macro_line|#endif
macro_line|#ifndef PCI_DEVICE_ID_CREATIVE_AUDIGY
DECL|macro|PCI_DEVICE_ID_CREATIVE_AUDIGY
mdefine_line|#define PCI_DEVICE_ID_CREATIVE_AUDIGY 0x0004
macro_line|#endif
...
id|PCI_VENDOR_ID_CREATIVE
comma
id|PCI_DEVICE_ID_CREATIVE_AUDIGY
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
l_int|0x03020100
suffix:semicolon
singleline_comment|// Regular pcm
...
l_int|0x3f3f3d3c
suffix:semicolon
singleline_comment|// Passthrough
id|card-&gt;waveout.send_routing2
(braket
id|ROUTE_PT
)braket
...
DECL|function|emu10k1_register_devices
r_static
r_int
id|__devinit
id|emu10k1_register_devices
c_func
(paren
r_struct
id|emu10k1_card
...
l_int|1
suffix:semicolon
multiline_comment|/* return without error */
)brace
r_else
(brace
id|memcpy
...
DECL|function|emu10k1_unregister_devices
r_static
r_void
id|emu10k1_unregister_devices
c_func
(paren
r_struct
id|emu10k1_card
...
id|len
comma
l_string|&quot;IO             : %#06lx-%#06lx&bslash;n&quot;
comma
id|card-&gt;iobase
comma
id|card-&gt;iobase
...
id|len
comma
l_string|&quot;IRQ            : %d&bslash;n&bslash;n&quot;
comma
id|card-&gt;irq
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;Registered /dev Entries:&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
id|len
comma
l_string|&quot;/dev/sequencer&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
DECL|function|emu10k1_proc_init
r_static
r_int
id|__devinit
id|emu10k1_proc_init
c_func
(paren
r_struct
id|emu10k1_card
...
id|s
comma
l_string|&quot;driver/emu10k1/%s/info&quot;
comma
id|pci_name
c_func
(paren
...
DECL|function|emu10k1_proc_cleanup
r_static
r_void
id|emu10k1_proc_cleanup
c_func
(paren
r_struct
id|emu10k1_card
...
suffix:semicolon
r_else
multiline_comment|/* !! The number below must equal the number of patches, currently 11 !! */
id|mgr-&gt;current_pages
op_assign
(paren
l_int|11
...
l_int|0
suffix:semicolon
singleline_comment|//Pcm input volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|//CD-Digital input Volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Front Output + Master Volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Add-in analog inputs for other speakers
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
singleline_comment|// Digital Front + Master Volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Rear Output + Rear Volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Digital Rear Output + Rear Volume
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Audigy Drive, Headphone out
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
singleline_comment|// ac97 Recording
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
singleline_comment|// Center = sub = Left/2 + Right/2
id|OP
c_func
(paren
l_int|0xe
...
suffix:semicolon
singleline_comment|// center/sub  Volume (master)
id|OP
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|// Digital center/sub  Volume (master)
id|OP
c_func
(paren
l_int|0
...
l_int|0
suffix:semicolon
singleline_comment|//first free GPR = 0x11b
multiline_comment|/* FX volume correction and Volume control*/
...
suffix:semicolon
singleline_comment|// CD-Digital In Volume control&t;
id|INPUT_PATCH_START
c_func
(paren
id|patch
comma
l_string|&quot;CD-Digital Vol L&quot;
comma
l_int|0x12
comma
l_int|0
...
suffix:semicolon
singleline_comment|//Volume Correction for Multi-channel Inputs&t;
id|INPUT_PATCH_START
c_func
(paren
id|patch
comma
l_string|&quot;Multi-Channel Gain&quot;
comma
l_int|0x08
comma
l_int|0
...
suffix:semicolon
singleline_comment|//Routing patch start&t;
id|ROUTING_PATCH_START
c_func
(paren
id|rpatch
...
suffix:semicolon
multiline_comment|/* Digital In + PCM + MULTI_FRONT-&gt; AC97 out (front speakers)*/
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
multiline_comment|/* Digital In + PCM + AC97 In + PCM1 + MULTI_REAR --&gt; Rear Channel */
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
multiline_comment|/* Digital In + PCM + AC97 In + MULTI_FRONT --&gt; Digital out */
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
multiline_comment|/* fx12:Analog-Center */
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
multiline_comment|/* fx11:Analog-LFE */
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
multiline_comment|/* fx12:Digital-Center */
id|OP
c_func
(paren
l_int|6
...
suffix:semicolon
singleline_comment|// Rear volume control&t;
...
suffix:semicolon
singleline_comment|//Master volume control on front-digital&t;
id|OUTPUT_PATCH_START
c_func
(paren
id|patch
...
suffix:semicolon
singleline_comment|//CD-Digital Volume
id|mgr-&gt;ctrl_gpr
(braket
...
suffix:semicolon
singleline_comment|//hard wire the ac97&squot;s pcm, pcm volume is done above using dsp code.
r_if
c_cond
(paren
id|card-&gt;is_audigy
)paren
singleline_comment|//for Audigy, we mute it and use the philips 6 channel DAC instead
id|emu10k1_ac97_write
c_func
(paren
id|card-&gt;ac97
...
suffix:semicolon
r_else
singleline_comment|//For the Live we hardwire it to full volume
id|emu10k1_ac97_write
c_func
(paren
id|card-&gt;ac97
...
suffix:semicolon
singleline_comment|//remove it from the ac97_codec&squot;s control
id|card-&gt;ac97_supported_mixers
op_and_assign
op_complement
id|SOUND_MASK_PCM
...
id|SOUND_MASK_PCM
suffix:semicolon
singleline_comment|//set Igain to 0dB by default, maybe consider hardwiring it here.
id|emu10k1_ac97_write
c_func
(paren
id|card-&gt;ac97
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;  Audigy FXRT initialization&n;&t;&t;  reversed eng&squot;d, may not be accurate.&n;&t;&t; */
r_if
c_cond
(paren
id|card-&gt;is_audigy
...
(brace
multiline_comment|/* Unmute Analog now.  Set GPO6 to 1 for Apollo.&n;&t;&t; * This has to be done after init ALice3 I2SOut beyond 48KHz.&n;&t;&t; * So, sequence is important. */
id|u32
id|tmp
op_assign
id|emu10k1_readfn0
...
id|err_register
suffix:semicolon
multiline_comment|/* proc entries must be created after registering devices, as&n;&t; * emu10k1_info_proc prints card-&gt;audio_dev &amp;co. */
id|ret
op_assign
id|emu10k1_proc_init
c_func
...
(paren
id|KERN_ERR
l_string|&quot;emu10k1: cannot initialize proc directory&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_proc

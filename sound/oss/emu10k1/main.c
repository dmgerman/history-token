...
suffix:semicolon
multiline_comment|/* !! The number bellow must equal the number of patches, currently 11 !! */
id|mgr-&gt;current_pages
op_assign
(paren
l_int|11
...
suffix:semicolon
singleline_comment|// CD-Digital In Volume control
id|INPUT_PATCH_START
c_func
(paren
id|patch
...
suffix:semicolon
singleline_comment|//Volume Correction for Multi-channel Inputs
id|INPUT_PATCH_START
c_func
(paren
id|patch
...
suffix:semicolon
singleline_comment|//Routing patch start
...
suffix:semicolon
singleline_comment|// Rear volume control
...
suffix:semicolon
singleline_comment|//hard wire the ac97&squot;s pcm, we&squot;ll do that in dsp code instead.
id|emu10k1_ac97_write
c_func
(paren
op_amp

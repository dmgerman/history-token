...
singleline_comment|// This is for emu10k1 revs less than 7, we need to go through tram
r_if
c_cond
(paren
...
op_logical_neg
(paren
singleline_comment|//any register allowed raw access to users goes here:
(paren
id|buf-&gt;offs
op_eq
id|DBG
...
l_int|2
comma
l_string|&quot;vma_start: %#lx, vma_end: %#lx, vma_offset: %ld&bslash;n&quot;
comma
id|vma-&gt;vm_start
comma
id|vma-&gt;vm_end
...
l_int|2
comma
l_string|&quot;n_pages: %ld, max_pages: %ld&bslash;n&quot;
comma
id|n_pages
comma
id|max_pages
...
l_int|1
suffix:semicolon
multiline_comment|/* now we are sure that:&n;&t; (2^WAVEOUT_MINFRAGSHIFT) &lt;= (fragment_size = 2^n) &lt;= (WAVEOUT_MAXBUFSIZE / WAVEOUT_MINFRAGS)&n;&t;*/
r_if
c_cond
(paren
op_logical_neg
...
l_int|1
suffix:semicolon
multiline_comment|/* now we are sure that:&n;&t;   (2^WAVEIN_MINFRAGSHIFT) &lt;= (fragment_size = 2^n) &lt;= (WAVEIN_MAXBUFSIZE / WAVEIN_MINFRAGS)&n;        */
r_if
c_cond
(paren
op_logical_neg
...
id|buffer-&gt;numfrags
suffix:semicolon
multiline_comment|/* the buffer size for recording is restricted to certain values, adjust it now */
r_if
c_cond
(paren
id|bufsize
...
multiline_comment|/* adjust the fragment size so that buffer size is an integer multiple */
r_while
c_loop
(paren
id|buffer-&gt;size

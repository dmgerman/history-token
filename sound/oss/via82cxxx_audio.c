...
multiline_comment|/**&n; *      via_chan_init - Initialize PCM channel&n; *      @card: Private audio chip info&n; *      @chan: Channel to be initialized&n; *&n; *      Performs some of the preparations necessary to begin&n; *      using a PCM channel.&n; *&n; *      Currently the preparations consist in&n; *      setting the&n; *      PCM channel to a known state.&n; */
...
r_return
suffix:semicolon
multiline_comment|/* If we are recording, then n_frags represents the number&n;&t; * of fragments waiting to be handled by userspace.&n;&t; * If we are playback, then n_frags represents the number&n;&t; * of fragments remaining to be filled by userspace.&n;&t; * We increment here.  If we reach max number of fragments,&n;&t; * this indicates an underrun/overrun.  For this case under OSS,&n;&t; * we stop the record/playback process.&n;&t; */
r_if
c_cond
(paren
id|atomic_read
...
id|DPRINTK
(paren
l_string|&quot;%s intr, channel n_frags == %d&bslash;n&quot;
comma
id|chan-&gt;name
comma
id|atomic_read

...
DECL|macro|GAMEPORT_EXTENT
mdefine_line|#define GAMEPORT_EXTENT&t;&t;  4
...
id|flags
suffix:semicolon
multiline_comment|/* the local_irq_save stunt is to send the data within the command window */
r_for
c_loop
(paren
id|i
...
DECL|function|solo1_register_gameport
r_static
r_int
id|__devinit
id|solo1_register_gameport
c_func
(paren
r_struct
id|solo1_state
...
(paren
id|KERN_ERR
l_string|&quot;solo1: gameport io ports are in use&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;solo1: can not allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
(paren
id|KERN_INFO
l_string|&quot;solo1: version v0.20 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;

...
id|portc
suffix:semicolon
multiline_comment|/* here we don&squot;t have to protect against intr */
id|spin_lock
c_func
(paren
op_amp
...
comma
multiline_comment|/* The main driver for this card is opl3sa2&n;        {       ISAPNP_ANY_ID, ISAPNP_ANY_ID,&n;&t;&t;ISAPNP_VENDOR(&squot;Y&squot;,&squot;M&squot;,&squot;H&squot;), ISAPNP_FUNCTION(0x0021), 0 },&n;&t;*/
(brace
id|ISAPNP_VENDOR
c_func
(paren
...
(paren
id|KERN_NOTICE
l_string|&quot;ad1848: PnP reports &squot;%s&squot; at i/o %#x, irq %d, dma %d, %d&bslash;n&quot;
comma
id|busname
comma
id|hw_config-&gt;io_base

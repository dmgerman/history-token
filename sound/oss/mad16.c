...
(paren
id|KERN_ERR
l_string|&quot;MAD16/Mozart: Bad IRQ %d&bslash;n&quot;
comma
id|hw_config-&gt;irq
)paren
suffix:semicolon
...
suffix:semicolon
DECL|function|mad16_register_gameport
r_static
r_int
id|__devinit
id|mad16_register_gameport
c_func
(paren
r_int
id|io_port
...
(paren
id|KERN_ERR
l_string|&quot;mad16: gameport address 0x%#x already in use&bslash;n&quot;
comma
id|io_port
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;mad16: can not allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func

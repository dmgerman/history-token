...
multiline_comment|/*&n; * Changelog:&n; * Aug 18, 2003, Adam Belay &lt;ambx1@neo.rr.com&gt;&n; * - detection code rewrite&n; */
...
multiline_comment|/*&n; * Core Device Management Functions&n; */
...
DECL|function|awe_attach_device
r_static
r_int
id|awe_attach_device
c_func
(paren
r_void
)paren
...
DECL|function|awe_dettach_device
r_static
r_void
id|awe_dettach_device
c_func
(paren
r_void
)paren
...
multiline_comment|/*&n; * Legacy device Probing&n; */
...
DECL|function|awe_detect_legacy_devices
r_static
r_int
id|__init
id|awe_detect_legacy_devices
c_func
(paren
r_void
)paren
...
c_func
(paren
l_string|&quot;AWE32 Legacy detection failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
multiline_comment|/*&n; * PnP device Probing&n; */
DECL|variable|awe_pnp_ids
r_static
r_struct
id|pnp_device_id
id|awe_pnp_ids
...
comma
multiline_comment|/* AWE32 WaveTable */
(brace
dot
id|id
op_assign
...
comma
multiline_comment|/* AWE64 WaveTable */
(brace
dot
id|id
op_assign
...
comma
multiline_comment|/* AWE64 Gold WaveTable */
(brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;AWE32: This driver only supports one AWE32 device, skipping.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
(paren
id|KERN_ERR
l_string|&quot;AWE32: The PnP device does not have the required resources.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;AWE32: A PnP Wave Table was detected at IO&squot;s %#x,%#x,%#x&bslash;n.&quot;
comma
id|io1
comma
id|io2
...
suffix:semicolon
DECL|function|awe_detect_pnp_devices
r_static
r_int
id|__init
id|awe_detect_pnp_devices
c_func
(paren
r_void
)paren
...
(paren
id|KERN_ERR
l_string|&quot;AWE32: PnP support is unavailable.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ret
...
(paren
id|KERN_INFO
l_string|&quot;AWE32: Probing for WaveTable...&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_INFO
l_string|&quot;AWE32: Skipping PnP detection.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond

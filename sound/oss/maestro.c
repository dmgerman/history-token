...
(brace
multiline_comment|/* log conversion seems bad for them */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Turn off hardware volume control interrupt.&n;&t;   This has to come before we leave the IRQ below,&n;&t;   or a crash results if a button is pressed ! */
id|n
op_assign
id|inw
c_func

...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Clean-up stack: this is what needs (un)doing if&n;&t; * we can&squot;t open the audio device ...&n;&t; */
id|error_2
suffix:colon
r_if
c_cond

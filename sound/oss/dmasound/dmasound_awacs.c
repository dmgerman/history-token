...
DECL|macro|AWACS_SNAPPER
mdefine_line|#define AWACS_SNAPPER   110&t;/* fake revision # for snapper */
...
multiline_comment|/*** AE - TUMBLER / SNAPPER START ************************************************/
...
multiline_comment|/*&n; * Headphone interrupt via GPIO (Tumbler, Snapper, DACA)&n; */
r_static
id|irqreturn_t
...
r_static
r_int
DECL|function|tas_dmasound_init
id|tas_dmasound_init
c_func
(paren
r_void
)paren
...
r_static
r_int
DECL|function|tas_dmasound_cleanup
id|tas_dmasound_cleanup
c_func
(paren
r_void
)paren
...
multiline_comment|/* We don&squot;t support 48k yet */
DECL|variable|tas_freqs
r_static
r_int
id|tas_freqs
(braket
...
r_static
r_int
DECL|function|tas_set_frame_rate
id|tas_set_frame_rate
c_func
(paren
r_void
)paren
...
r_void
id|__init
DECL|function|tas_init_frame_rates
id|tas_init_frame_rates
c_func
(paren
r_int
r_int
...
multiline_comment|/*** AE - TUMBLER / SNAPPER END ************************************************/
multiline_comment|/*** Low level stuff *********************************************************/
...
(paren
id|KERN_WARNING
l_string|&quot;Bogus call to PMacSetVolume !&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
DECL|function|awacs_setup_for_beep
r_static
r_void
id|awacs_setup_for_beep
c_func
(paren
r_int
id|speed
...
(brace
multiline_comment|/* tested on Screamer, should work on others too */
r_if
c_cond
(paren
id|awacs_revision
...
suffix:semicolon
multiline_comment|/* Chip specific sleep code */
r_switch
c_cond
(paren
id|awacs_revision
...
c_func
(paren
l_string|&quot;AE-Init snapper mixer&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
r_void
id|__init
DECL|function|awacs_init_frame_rates
id|awacs_init_frame_rates
c_func
(paren
r_int
r_int
...
r_void
id|__init
DECL|function|burgundy_init_frame_rates
id|burgundy_init_frame_rates
c_func
(paren
r_int
r_int
...
r_void
id|__init
DECL|function|daca_init_frame_rates
id|daca_init_frame_rates
c_func
(paren
r_int
r_int
...
id|line
suffix:semicolon
multiline_comment|/* Hack for legacy crap that will be killed someday */
id|awacs_node
op_assign
id|io
suffix:semicolon
...
c_func
(paren
id|I2C_DRIVERID_TAS3001C
comma
id|I2C_DRIVERNAME_TAS3001C
)paren
suffix:semicolon
id|tas_dmasound_init
c_func
...
c_func
(paren
id|I2C_DRIVERID_TAS3004
comma
id|I2C_DRIVERNAME_TAS3004
)paren
suffix:semicolon
id|tas_dmasound_init
c_func

...
DECL|macro|DMASOUND_Q40_REVISION
mdefine_line|#define DMASOUND_Q40_REVISION 0
DECL|macro|DMASOUND_Q40_EDITION
mdefine_line|#define DMASOUND_Q40_EDITION 3
...
multiline_comment|/* compressing versions */
DECL|function|q40_ctc_law
r_static
id|ssize_t
id|q40_ctc_law
c_func
...
suffix:semicolon
DECL|variable|transQ40Compressing
r_static
id|TRANS
id|transQ40Compressing
op_assign
(brace
id|q40_ctc_law
comma
...
(brace
multiline_comment|/* squeeze the sound, we do that */
id|dmasound.hard.speed
op_assign
l_int|20000
suffix:semicolon
...
(paren
(paren
id|DMASOUND_Q40_REVISION
op_lshift
l_int|8
)paren
op_or
id|DMASOUND_Q40_EDITION
)paren
comma
id|hardware_afmts
suffix:colon

multiline_comment|/*&n; *  linux/sound/oss/dmasound/dmasound_paula.c&n; *&n; *  Amiga `Paula&squot; DMA Sound Driver&n; *&n; *  See linux/sound/oss/dmasound/dmasound_core.c for copyright and credits&n; *  prior to 28/01/2001&n; *&n; *  28/01/2001 [0.1] Iain Sandoe&n; *&t;&t;     - added versioning&n; *&t;&t;     - put in and populated the hardware_afmts field.&n; *             [0.2] - put in SNDCTL_DSP_GETCAPS value.&n; *&t;       [0.3] - put in constraint on state buffer usage.&n; *&t;       [0.4] - put in default hard/soft settings&n;*/

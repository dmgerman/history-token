...
multiline_comment|/* MUST not hold the spinlock */
...
multiline_comment|/* MUST be called with holding the dmap-&gt;lock */
...
multiline_comment|/* still holding the lock */
r_if
c_cond
(paren
...
multiline_comment|/* called with dmap-&gt;lock dold */
...
multiline_comment|/* aquires lock */
...
multiline_comment|/* MUST be called with dmap-&gt;lock hold */
...
multiline_comment|/* via poll called without a lock ?*/
...
multiline_comment|/* MUST not hold the spinlock  - this function may sleep */
...
multiline_comment|/* called with the lock held */
...
multiline_comment|/* has to aquire dmap-&gt;lock */
...
id|ptr
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Let the low level driver perform some postprocessing to&n;&t; *&t;the written data.&n;&t; */
r_if
c_cond
(paren
...
multiline_comment|/* called with dmap-&gt;lock held in irq context*/

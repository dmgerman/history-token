...
DECL|function|sv_register_gameport
r_static
r_int
id|__devinit
id|sv_register_gameport
c_func
(paren
r_struct
id|sv_state
...
id|SV_EXTENT_GAME
comma
l_string|&quot;S3 SonicVibes Gameport&quot;
)paren
)paren
(brace
id|printk
...
(paren
id|KERN_ERR
l_string|&quot;sv: gameport io ports are in use&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;sv: can not allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
(paren
id|KERN_INFO
l_string|&quot;sv: version v0.31 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;

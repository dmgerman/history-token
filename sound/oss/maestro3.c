...
mdefine_line|#define DRIVER_VERSION      &quot;1.23&quot;
...
l_int|0x1100
suffix:semicolon
multiline_comment|/* Panasonic toughbook CF72 has to be different... */
r_if
c_cond
(paren
id|card-&gt;pcidev-&gt;subsystem_vendor
op_eq
l_int|0x10F7
op_logical_and
id|card-&gt;pcidev-&gt;subsystem_device
op_eq
l_int|0x833D
)paren
(brace

multiline_comment|/*&n; *&n; * AD1816 lowlevel sound driver for Linux 2.6.0 and above&n; *&n; * Copyright (C) 1998-2003 by Thorsten Knabe &lt;linux@thorsten-knabe.de&gt;&n; *&n; * Based on the CS4232/AD1848 driver Copyright (C) by Hannu Savolainen 1993-1996&n; *&n; *&n; * version: 1.5&n; * status: beta&n; * date: 2003/07/15&n; *&n; * Changes:&n; *&t;Oleg Drokin: Some cleanup of load/unload functions.&t;1998/11/24&n; *&t;&n; *&t;Thorsten Knabe: attach and unload rewritten, &n; *&t;some argument checks added&t;&t;&t;&t;1998/11/30&n; *&n; *&t;Thorsten Knabe: Buggy isa bridge workaround added&t;1999/01/16&n; *&t;&n; *&t;David Moews/Thorsten Knabe: Introduced options &n; *&t;parameter. Added slightly modified patch from &n; *&t;David Moews to disable dsp audio sources by setting &n; *&t;bit 0 of options parameter. This seems to be&n; *&t;required by some Aztech/Newcom SC-16 cards.&t;&t;1999/04/18&n; *&n; *&t;Christoph Hellwig: Adapted to module_init/module_exit.&t;2000/03/03&n; *&n; *&t;Christoph Hellwig: Added isapnp support&t;&t;&t;2000/03/15&n; *&n; *&t;Arnaldo Carvalho de Melo: get rid of check_region&t;2001/10/07&n; *      &n; *      Thorsten Knabe: Compiling with CONFIG_PNP enabled&n; *&t;works again. It is now possible to use more than one &n; *&t;AD1816 sound card. Sample rate now may be changed during&n; *&t;playback/capture. printk() uses log levels everywhere.&n; *&t;SMP fixes. DMA handling fixes.&n; *&t;Other minor code cleanup.&t;&t;&t;&t;2003/07/15&n; *&n; */
...
id|pnpdev
suffix:semicolon
multiline_comment|/* configured via pnp */
DECL|member|dev_no
r_int
id|dev_no
suffix:semicolon
...
id|arg
suffix:semicolon
multiline_comment|/* change speed during playback */
id|freq
op_assign
(paren
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;ad1816: interrupt: Got interrupt, but no source.&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|spin_unlock
...
suffix:semicolon
multiline_comment|/* ------------------------------------------------------------------- */
multiline_comment|/* stuff for card recognition, init and unloading PNP ...*/
multiline_comment|/* check if AD1816 present at specified hw_config and register device with OS &n; * return 1 if initialization was successful, 0 otherwise&n; */
DECL|function|ad1816_init_card
r_static
r_int
id|__init
id|ad1816_init_card
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: initializing card: io=0x%x, irq=%d, dma=%d, &quot;
l_string|&quot;dma2=%d, clockfreq=%d, options=%d isadmabug=%d &quot;
l_string|&quot;%s&bslash;n&quot;
comma
...
suffix:semicolon
multiline_comment|/* ad1816_info structure remaining ? */
r_if
c_cond
(paren
id|nr_ad1816_devs
...
(paren
id|KERN_WARNING
l_string|&quot;ad1816: no more ad1816_info structures &quot;
l_string|&quot;left&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: Examining AD1816 at address 0x%03x.&bslash;n&quot;
comma
id|devc-&gt;base
)paren
suffix:semicolon
multiline_comment|/* tests for ad1816 */
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: Chip is not an AD1816 or chip &quot;
l_string|&quot;is not active (Test 0)&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: AD1816 (version %d) successfully detected!&bslash;n&quot;
comma
id|ad_read
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;ad1816: Only one DMA channel &quot;
l_string|&quot;available/configured. No duplex operation possible&bslash;n&quot;
)paren
suffix:semicolon
id|devc-&gt;audio_mode
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;Can&squot;t install mixer&bslash;n&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/* make ad1816_info active */
id|nr_ad1816_devs
op_increment
suffix:semicolon
id|printk
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: card successfully installed!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
c_func
(paren
l_string|&quot;ad1816: Unloading card at address 0x%03x&bslash;n&quot;
comma
id|devc-&gt;base
)paren
suffix:semicolon
...
multiline_comment|/* unreg audiodev */
...
suffix:semicolon
macro_line|#ifdef __ISAPNP__
multiline_comment|/* use isapnp for configuration */
...
(paren
id|KERN_WARNING
l_string|&quot;ad1816: Failed to attach PnP device&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;ad1816: Failed to activate PnP device&bslash;n&quot;
)paren
suffix:semicolon
id|pnp_device_detach
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;ad1816: Valid range for isapnpjump is 0-%d. &quot;
l_string|&quot;Adjusted to 0.&bslash;n&quot;
comma
id|nr_pnp_cfg
op_minus
l_int|1
...
l_int|NULL
suffix:semicolon
multiline_comment|/* iterate over all pnp cards */
r_while
c_loop
(paren
(paren
...
l_string|&quot;Copyright (C) 1998-2003 by Thorsten Knabe and &quot;
l_string|&quot;others&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#ifdef AD1816_CLOCK 
multiline_comment|/* set ad1816_clockfreq if set during compilation */
id|ad1816_clockfreq
op_assign
id|AD1816_CLOCK
suffix:semicolon
...
macro_line|#ifdef __ISAPNP__
multiline_comment|/* configure PnP cards */
r_if
c_cond
(paren
id|isapnp
...
macro_line|#endif
multiline_comment|/* configure card by module params */
r_if
c_cond
(paren
id|io
...
multiline_comment|/* module cleanup */
...
(paren
id|KERN_INFO
l_string|&quot;ad1816: driver unloaded!&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* kernel command line parameter evaluation */

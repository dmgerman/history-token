...
DECL|macro|MAX_MONITOR_LEVEL
mdefine_line|#define MAX_MONITOR_LEVEL (GAIN_MA_MASK &gt;&gt; GAIN_MA_SHIFT)
DECL|macro|MIXER_INTERNAL
mdefine_line|#define MIXER_INTERNAL   SOUND_MIXER_LINE1
DECL|macro|MIXER_LINEOUT
mdefine_line|#define MIXER_LINEOUT    SOUND_MIXER_LINE2
DECL|macro|MIXER_HEADPHONES
mdefine_line|#define MIXER_HEADPHONES SOUND_MIXER_LINE3
DECL|macro|MASK_INTERNAL
mdefine_line|#define MASK_INTERNAL   SOUND_MASK_LINE1
DECL|macro|MASK_LINEOUT
mdefine_line|#define MASK_LINEOUT    SOUND_MASK_LINE2
DECL|macro|MASK_HEADPHONES
mdefine_line|#define MASK_HEADPHONES SOUND_MASK_LINE3

...
id|KERN_ERR
id|PFX
l_string|&quot;can not allocate memory for gameport&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
multiline_comment|/* format is: es1371=[spdif,[nomix,[amplifier]]] */

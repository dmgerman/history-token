...
macro_line|#endif
macro_line|#ifdef EBUS_SUPPORT
DECL|function|snd_cs4231_ebus_play_interrupt
r_static
r_void
id|snd_cs4231_ebus_play_interrupt
c_func
(paren
r_int
id|irq
...
id|csr
op_amp
id|EBUS_DCSR_INT_PEND
)paren
)paren
r_return
suffix:semicolon
multiline_comment|/* ACK the EBUS playback DMA interrupt. */
id|writel
c_func
(paren
id|csr
...
DECL|function|snd_cs4231_ebus_capture_interrupt
r_static
r_void
id|snd_cs4231_ebus_capture_interrupt
c_func
(paren
r_int
id|irq
...
r_return
suffix:semicolon
multiline_comment|/* ACK the EBUS capture DMA interrupt. */
id|writel
c_func
(paren
id|csr
...
c_func
(paren
l_string|&quot;cs4231-%d: Unable to grab EBUS capture IRQ %s&bslash;n&quot;
comma
id|dev
comma
id|__irq_itoa
...
c_func
(paren
l_string|&quot;cs4231-%d: Unable to grab EBUS play IRQ %s&bslash;n&quot;
comma
id|dev
comma
id|__irq_itoa
...
multiline_comment|/* format is: snd-sun-cs4231=snd_index,snd_id,snd_enable */
DECL|function|alsa_card_sun_cs4231_setup
r_static
r_int
id|__init
id|alsa_card_sun_cs4231_setup
c_func
(paren
r_char
op_star

...
suffix:semicolon
singleline_comment|//printk(&quot;DS=%u&bslash;n&quot;, crypto_tfm_alg_digestsize(tfm));
singleline_comment|//printk(&quot;K=&quot;);
id|hexdump
c_func
(paren
id|hmac_sha256_tv
...
suffix:semicolon
singleline_comment|//printk(&quot;P=%s&bslash;n&quot;, hmac_sha256_tv[i].plaintext);
id|crypto_hmac
c_func
(paren
id|tfm

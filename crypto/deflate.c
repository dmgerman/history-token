...
DECL|function|deflate_comp_exit
r_static
r_void
id|deflate_comp_exit
c_func
(paren
r_struct
id|deflate_ctx
...
c_func
(paren
id|ctx-&gt;comp_stream.workspace
)paren
suffix:semicolon
)brace
DECL|function|deflate_decomp_exit
r_static
r_void
id|deflate_decomp_exit
c_func
(paren
r_struct
id|deflate_ctx
...
c_func
(paren
id|ctx-&gt;decomp_stream.workspace
)paren
suffix:semicolon
)brace

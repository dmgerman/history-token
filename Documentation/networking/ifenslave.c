...
mdefine_line|#define APP_VERSION&t;&quot;1.0.12&quot;
DECL|macro|APP_RELDATE
mdefine_line|#define APP_RELDATE&t;&quot;June 30, 2003&quot;
DECL|macro|APP_NAME
...
id|APP_RELDATE
l_string|&quot;) &quot;
l_string|&quot;&bslash;nDonald Becker (becker@cesdis.gsfc.nasa.gov).&bslash;n&quot;
...
multiline_comment|/* exchange abi version with bonding driver */
id|abi_ver
op_assign
id|get_abi_ver
c_func
...
id|stderr
comma
l_string|&quot;Illegal operation; the specified master interface &squot;%s&squot; is not up.&bslash;n&quot;
comma
id|master_ifname
)paren
suffix:semicolon
...
(brace
multiline_comment|/* The driver is using an old ABI, so we&squot;ll set the interface&n;&t;&t;&t;&t; * down to avoid any conflicts due to same IP/MAC&n;&t;&t;&t;&t; */
id|strncpy
c_func
(paren
id|ifr2.ifr_name
...
(brace
multiline_comment|/* change primary slave */
id|strncpy
c_func
(paren
id|if_flags.ifr_name
...
id|stderr
comma
l_string|&quot;%s is already a slave&bslash;n&quot;
comma
id|slave_ifname
)paren
suffix:semicolon
...
multiline_comment|/* if hwaddr_notset, assign the slave hw address to the master */
r_if
c_cond
(paren
id|hwaddr_notset
...
(brace
multiline_comment|/* In ABI versions older than 1, the&n;&t;&t;&t;&t;&t;&t; * master&squot;s set_mac routine couldn&squot;t&n;&t;&t;&t;&t;&t;&t; * work if it was up, because it&n;&t;&t;&t;&t;&t;&t; * used the default ethernet set_mac&n;&t;&t;&t;&t;&t;&t; * function.&n;&t;&t;&t;&t;&t;&t; */
multiline_comment|/* bring master down */
id|if_flags.ifr_flags
op_and_assign
op_complement
id|IFF_UP
...
(brace
multiline_comment|/* bring master back up */
id|if_flags.ifr_flags
op_or_assign
id|IFF_UP
suffix:semicolon
...
(brace
multiline_comment|/* if (hwaddr_notset) */
multiline_comment|/* The driver is using an old ABI, so we&squot;ll set the interface&n;&t;&t;&t;&t; * down and assign the master&squot;s hwaddr to it&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|ifr2.ifr_flags
...
(brace
multiline_comment|/* The driver is using an old ABI, so we&squot;ll set the interface&n;&t;&t;&t;&t; * up before enslaving it&n;&t;&t;&t;&t; */
id|ifr2.ifr_flags
op_or_assign
id|IFF_UP
suffix:semicolon
...
r_else
(brace
multiline_comment|/* the bonding module takes care of setting the slave&squot;s mac address&n;&t;&t;&t; &t; * and opening its interface&n;&t;&t;&t; &t; */
r_if
c_cond
(paren
id|ifr2.ifr_flags
...
(brace
multiline_comment|/* the interface will need to be down */
id|ifr2.ifr_flags
op_and_assign
op_complement
id|IFF_UP
...
id|stderr
comma
l_string|&quot;Error: got invalid string as an ABI &quot;

...
id|dest
comma
l_string|&quot;%s/host%d/bus%d/target%d/lun%d&quot;
comma
id|prefix
comma
id|host
...
id|dest
comma
l_string|&quot;%s/host%d/bus%d/target%d/lun%d/part%s&quot;
comma
id|prefix
comma
id|host
...
id|dest
comma
l_string|&quot;%s/host%d/bus%d/target%d/lun%d/disc&quot;
comma
id|prefix
comma
id|host

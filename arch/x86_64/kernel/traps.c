multiline_comment|/*&n; *  linux/arch/x86-64/traps.c&n; *&n; *  Copyright (C) 1991, 1992  Linus Torvalds&n; *  Copyright (C) 2000, 2001, 2002 Andi Kleen, SuSE Labs&n; *&n; *  Pentium III FXSR, SSE support&n; *&t;Gareth Hughes &lt;gareth@valinux.com&gt;, May 2000&n; */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* We really need to get rid of F0 0F workaround. Setting up new idts&n;   is not an option */
...
l_string|&quot;&bslash;n&quot;
id|KERN_DEBUG
l_string|&quot;no stack at the end of irqstack; stack:%p, cur:%p/%p&bslash;n&quot;
comma
id|stack
comma
id|current
...
c_func
(paren
l_string|&quot;Process %s (pid: %d, thread_info:%p task:%p)&bslash;n&quot;
comma
id|cur-&gt;comm
comma
id|cur-&gt;pid
...
c_func
(paren
l_string|&quot;Kernel BUG at %.30s:%d&bslash;n&quot;
comma
id|f.filename
comma
id|f.line
...
c_func
(paren
l_string|&quot;%d/%s trap %d sig %d %s rip:%lx rsp:%lx error_code:%lx&bslash;n&quot;
comma
id|current-&gt;pid
comma
id|current-&gt;comm
...
multiline_comment|/* XXX: add die_chain here */
id|tsk-&gt;thread.trap_no
op_assign
l_int|1
suffix:semicolon

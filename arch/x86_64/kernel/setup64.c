...
suffix:semicolon
multiline_comment|/* parsed early actually */
DECL|variable|force_personality32
r_int
id|force_personality32
op_assign
id|READ_IMPLIES_EXEC
suffix:semicolon
multiline_comment|/* noexec32=on|off&n;Control non executable heap for 32bit processes.&n;To control the stack too use noexec=off&n;&n;on&t;PROT_READ does not imply PROT_EXEC for 32bit processes&n;off&t;PROT_READ implies PROT_EXEC (default)&n;*/

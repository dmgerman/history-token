...
multiline_comment|/*&n; *  If we have a IRQ routing table, use it to search for peer host&n; *  bridges.  It&squot;s a gross hack, but since there are no other known&n; *  ways how to get a list of buses, we have to go this way.&n; *&n; *  [maybe x86-64 architecture should define way to query this info in&n; more reasonable way?]&n; */

...
(paren
id|KERN_ERR
l_string|&quot;    ECC error syndrome %x&bslash;n&quot;
comma
(paren
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;    bus error %s, %s&bslash;n    %s&bslash;n    %s, %s&bslash;n&quot;
comma
id|partproc
(braket
(paren
...
multiline_comment|/* mce=off disable machine check&n;   mce=nok8 disable k8 specific features&n;   mce=disable&lt;NUMBER&gt; disable bank NUMBER&n;   mce=enable&lt;NUMBER&gt; enable bank number&n;   mce=NUMBER mcheck timer interval number seconds. &n;   Can be also comma separated in a single mce= */

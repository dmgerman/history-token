...
id|end
suffix:semicolon
multiline_comment|/* count all types of areas for now to map ACPI easily */
id|start
op_assign
id|round_up
c_func
...
r_else
(brace
multiline_comment|/* If the user specifies memory size, we&n;&t;&t; * blow away any automatically generated&n;&t;&t; * size&n;&t;&t; */
r_int
r_int
r_int
id|start_at
...
(brace
multiline_comment|/* first time in: zap the whitelist&n;&t;&t;&t; * and reinitialize it with the&n;&t;&t;&t; * standard low-memory region.&n;&t;&t;&t; */
id|e820.nr_map
op_assign
l_int|0
suffix:semicolon

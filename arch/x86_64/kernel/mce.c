...
suffix:semicolon
DECL|variable|console_logged
r_static
r_int
r_int
id|console_logged
suffix:semicolon
DECL|variable|notify_user
r_static
r_int
id|notify_user
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * It&squot;s ok to read stale data here for notify_user and&n;&t; * console_logged as we&squot;ll simply get the updated versions&n;&t; * on the next mcheck_timer execution and atomic operations&n;&t; * on console_logged act as synchronization for notify_user&n;&t; * writes.&n;&t; */
r_if
c_cond
(paren
id|notify_user
...
(paren
id|KERN_INFO
l_string|&quot;Machine check events logged&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
DECL|function|mce_cpu_features
r_static
r_void
id|__init
id|mce_cpu_features

...
c_func
(paren
l_string|&quot;Uncorrected machine check in kernel&quot;
comma
op_amp
id|m
comma
...
id|mce_ioctl
comma
singleline_comment|//.write = mce_write
)brace
suffix:semicolon

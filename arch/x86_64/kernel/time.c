...
DECL|variable|__section_delay_at_last_interrupt
r_int
id|__delay_at_last_interrupt
id|__section_delay_at_last_interrupt
suffix:semicolon
DECL|variable|__section_last_tsc_low
r_int
r_int
id|__last_tsc_low
id|__section_last_tsc_low
suffix:semicolon
...
DECL|variable|__section_fast_gettimeoffset_quotient
r_int
r_int
id|__fast_gettimeoffset_quotient
id|__section_fast_gettimeoffset_quotient
suffix:semicolon
r_extern
id|rwlock_t
id|xtime_lock
...
multiline_comment|/* Could use 64bit arithmetic on x86-64, but the code is too fragile */
...
c_func
(paren
l_string|&quot;Detected %u.%03u MHz processor.&bslash;n&quot;
comma
id|cpu_khz
op_div
l_int|1000

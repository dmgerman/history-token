...
c_func
(paren
l_string|&quot;I/O APIC #%d Version %d at 0x%X.&bslash;n&quot;
comma
id|m-&gt;mpc_apicid
comma
id|m-&gt;mpc_apicver
...
multiline_comment|/*&n; * - Intel MP Configuration Table&n; */
...
id|mpc_apicid
suffix:semicolon
multiline_comment|/* &n;&t; * Use the default configuration for the IRQs 0-15.  Unless&n;&t; * overridden by (MADT) interrupt source override entries.&n;&t; */
r_for
c_loop
(paren
id|i

...
id|val
suffix:semicolon
multiline_comment|/* XXX: for cmd==SETVAL the manpage says ptr is the value directly. i386&n;&t;   seems to always get it via a pointer. Follow i386 here. Check this. */
r_if
c_cond
(paren
id|get_user

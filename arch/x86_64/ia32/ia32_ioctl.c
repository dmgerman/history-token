...
multiline_comment|/* SuSE extension */
...
suffix:semicolon
multiline_comment|/* serial driver */
id|HANDLE_IOCTL
c_func
(paren
id|TIOCGSERIAL
...
multiline_comment|/* Problem: &n;   This function cannot unregister duplicate ioctls, because they are not&n;   unique.&n;   When they happen we need to extend the prototype to pass handler too. */

...
DECL|function|generic_long_put
r_static
r_int
id|generic_long_put
c_func
...
DECL|function|generic_long_get
r_static
r_int
id|generic_long_get
c_func
...
mdefine_line|#define RTC_EPOCH_READ32&t;_IOR(&squot;p&squot;, 0x0d, unsigned long)&t; /* Read epoch      */
DECL|macro|RTC_EPOCH_SET32
mdefine_line|#define RTC_EPOCH_SET32&t;&t;_IOW(&squot;p&squot;, 0x0e, unsigned long)&t; /* Set epoch       */
id|HANDLE_IOCTL
c_func
(paren
id|RTC_EPOCH_READ32

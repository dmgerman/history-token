...
DECL|macro|AA
mdefine_line|#define AA(__x)&t;A(__x)
...
multiline_comment|/* AK: dev_t/kdev_t use here is somewhat dubious */
r_typedef
r_struct
(brace
DECL|member|vg_name
...
id|lv
suffix:semicolon
DECL|typedef|lv_status_bydev_req32_t
)brace
id|lv_status_bydev_req32_t
suffix:semicolon
r_typedef
r_struct
(brace
...
multiline_comment|/* &squot;proc&squot; field is unused, just NULL it out. */
id|v-&gt;proc
op_assign
l_int|NULL
suffix:semicolon
...
mdefine_line|#define BLKELVGET_32   _IOR(0x12,106,int)
DECL|macro|BLKELVSET_32
mdefine_line|#define BLKELVSET_32   _IOW(0x12,107,int)
...
mdefine_line|#define HANDLE_IOCTL2(cmd,handler) REF_SYMBOL(handler);  asm volatile(&quot;.quad %c0, &quot; #handler &quot;,0&quot;::&quot;i&quot; (cmd)); 
...
mdefine_line|#define IOCTL_TABLE_START void ioctl_dummy(void) { asm volatile(&quot;&bslash;nioctl_start:&bslash;n&bslash;t&quot; );

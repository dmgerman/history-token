multiline_comment|/*&n; *  a.out loader for x86-64&n; *&n; *  Copyright (C) 1991, 1992, 1996  Linus Torvalds&n; *  Hacked together by Andi Kleen&n; */
...
suffix:semicolon
multiline_comment|/* start thread */
id|asm
r_volatile
(paren
l_string|&quot;movl %0,%%fs&quot;

...
macro_line|#if 0 /* reenable when noexec works */
r_if
c_cond
(paren
id|a.prot
...
multiline_comment|/* later add PROT_EXEC for PROT_READ here */
id|down_write
c_func
(paren
op_amp

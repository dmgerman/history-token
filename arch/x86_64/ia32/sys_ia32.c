...
multiline_comment|/* the set_fs is safe because futex doesn&squot;t use the seg limit &n;&t;   for valid page checking of uaddr. */
id|set_fs
c_func
(paren
id|KERNEL_DS
...
multiline_comment|/* should check cmd */
suffix:semicolon
r_else
r_if
c_cond
...
id|EFAULT
suffix:semicolon
multiline_comment|/* paranoia check - remove it when you are sure they&n;&t;&t;   are not pointers */
r_if
c_cond
(paren
id|get_user
...
multiline_comment|/* XXX aio getevents */

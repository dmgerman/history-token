...
id|ret
suffix:semicolon
multiline_comment|/* sys_fcntl() is by default 64 bit and so don&squot;t know anything&n;&t; * about F_xxxx64 commands&n;&t; */
r_switch
c_cond
(paren
id|cmd
...
singleline_comment|// XXX: fix limit.
r_if
c_cond
(paren
id|dst

...
(brace
multiline_comment|/* the only field that&squot;s different is the alignment&n;&t;&t;   of the pointer in sigval_t. Move that 4 bytes down including&n;&t;&t;   padding. */
id|memmove
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* last 4 bytes stay the same */
r_return
id|__copy_to_user
c_func
(paren

...
c_func
(paren
id|from-&gt;_sifields._rt._pid
comma
op_amp
id|to-&gt;_sifields._rt._pid
)paren
suffix:semicolon
id|err
op_or_assign
...
c_func
(paren
id|from-&gt;_sifields._rt._uid
comma
op_amp
id|to-&gt;_sifields._rt._uid
)paren
suffix:semicolon
id|err
op_or_assign
...
id|from-&gt;_sifields._rt._sigval.sival_ptr
comma
op_amp
id|to-&gt;_sifields._rt._sigval.sival_ptr
)paren
suffix:semicolon
)brace
r_else

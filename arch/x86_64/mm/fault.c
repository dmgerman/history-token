multiline_comment|/*&n; *  linux/arch/x86-64/mm/fault.c&n; *&n; *  Copyright (C) 1995  Linus Torvalds&n; */
...
c_func
(paren
l_string|&quot;fault at %lx rip:%lx rsp:%lx err:%lx thr:%x &quot;
comma
id|address
comma
id|regs-&gt;rip
...
c_func
(paren
l_string|&quot;vma %lx-%lx prot:%lx flags:%lx&quot;
comma
id|vma-&gt;vm_start
comma
id|vma-&gt;vm_end
...
(paren
id|KERN_ERR
l_string|&quot;%.20s[%d] segfaulted rip:%lx rsp:%lx adr:%lx err:%lx&bslash;n&quot;
comma
id|tsk-&gt;comm
comma
id|tsk-&gt;pid
...
suffix:colon
(brace
multiline_comment|/*&n;&t;&t; * Synchronize the kernel space top level page-table&n;&t;&t; * with the &squot;reference&squot; page table.&n;&t;&t; * Currently it only works for first and last 512 GB of&n;&t;&t; * kernel memory FIXME&n;&t;&t; *&n;&t;&t; */
id|level4_t
op_star
id|l4pd
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;fatal - no entry in level4_page for %lx&bslash;n&quot;
comma
id|address
)paren
suffix:semicolon

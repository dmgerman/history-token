...
multiline_comment|/*&n; * Handle a fault on the vmalloc or module mapping area&n; */
DECL|function|vmalloc_fault
r_static
r_int
id|vmalloc_fault
c_func
...
id|pte_ref
suffix:semicolon
multiline_comment|/* Copy kernel mappings over when needed. This can also&n;&t;   happen within a race in page table update. In the later&n;&t;   case just flush. */
id|pgd
op_assign
id|pgd_offset
c_func
...
suffix:semicolon
multiline_comment|/* Below here mismatches are bugs because these lower tables&n;&t;   are shared */
id|pud
op_assign
id|pud_offset
c_func

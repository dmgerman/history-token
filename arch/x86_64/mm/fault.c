...
suffix:semicolon
multiline_comment|/* Work around K8 erratum #100&n;&t;   K8 in compat mode occasionally jumps to illegal addresses &gt;4GB.&n;&t;   We catch this here in the page fault handler because these&n;&t;   addresses are not reachable. Just detect this case and return.&n;&t;   Any code segment in LDT is compatibility mode. */
r_if
c_cond
(paren
(paren

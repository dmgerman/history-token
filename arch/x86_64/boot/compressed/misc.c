...
id|isamd
suffix:semicolon
multiline_comment|/* check if the CPU supports CPUID. This is done by testing if the CPU&n;&t;   supports changing the ID bit (21) in EFLAGS. */
id|asm
c_func
(paren
l_string|&quot;pushfl ; &quot;
l_string|&quot;popl %0 ; &quot;
multiline_comment|/* get EFLAGS */
l_string|&quot;movl  %0,%1 ; &quot;
l_string|&quot;xorl  $(1&lt;&lt;21),%0 ; &quot;
multiline_comment|/* toggle bit 21 */
l_string|&quot;pushl %0 ; &quot;
l_string|&quot;popfl ; &quot;
l_string|&quot;pushfl ; &quot;
multiline_comment|/* get EFLAGS again */
l_string|&quot;popl %0 &quot;
suffix:colon
l_string|&quot;=r&quot;
(paren
...
c_func
(paren
l_string|&quot;Your CPU doesn&squot;t support CPUID.&quot;
)paren
suffix:semicolon
multiline_comment|/* check if it supports AMD extended cpuid reporting */
id|asm
c_func
(paren
l_string|&quot;cpuid&quot;
...
c_func
(paren
l_string|&quot;Your CPU doesn&squot;t support AMD extended CPUIDs.&quot;
)paren
suffix:semicolon
multiline_comment|/* AuthenticAMD */
id|isamd
op_assign
(paren
id|b
...
suffix:semicolon
multiline_comment|/* check required feature flags */
multiline_comment|/* see http://www.x86-64.org/lists/discuss/msg02971.html */
DECL|macro|REQUIRED_MASK1
mdefine_line|#define REQUIRED_MASK1 ((1&lt;&lt;0)|(1&lt;&lt;3)|(1&lt;&lt;4)|(1&lt;&lt;5)|(1&lt;&lt;6)|(1&lt;&lt;8)|(1&lt;&lt;11)| &bslash;&n;                                           (1&lt;&lt;13)|(1&lt;&lt;15)|(1&lt;&lt;24))
id|asm
c_func
(paren
l_string|&quot;cpuid&quot;
...
c_func
(paren
l_string|&quot;WARNING: non APIC mode for long mode kernel is untested.&quot;
)paren
suffix:semicolon
id|puts
c_func
(paren
l_string|&quot;In case of trouble use 32bit kernel or enable APIC.&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support page size extension (PSE)&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU misses an time stamp counter&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU misses AMD style MSRs&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU misses physical address extension (PAE)&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support SYSCALL/SYSRET&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support PGE&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support CMOV&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support FXSAVE/FXRSTOR&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support long mode&quot;
)paren
suffix:semicolon
DECL|macro|SSE_MASK
mdefine_line|#define SSE_MASK ((1&lt;&lt;25)|(1&lt;&lt;26))&t;
id|asm
c_func
(paren
l_string|&quot;cpuid&quot;
...
(brace
multiline_comment|/* Only try this on AMD CPUs. */
multiline_comment|/* Enable SSE in HWCFG MSR */
id|asm
r_volatile
(paren
l_string|&quot;rdmsr&quot;
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support SSE1&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;CPU doesn&squot;t support SSE2&quot;
)paren
suffix:semicolon
)brace

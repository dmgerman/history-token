...
id|b
suffix:semicolon
multiline_comment|/*&n;&t; * We know this is a new root bus we haven&squot;t seen before, so&n;&t; * scan it, even if we&squot;ve seen the same bus number in a different&n;&t; * segment.&n;&t; */
id|b
op_assign
id|kmalloc
c_func

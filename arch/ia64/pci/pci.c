...
r_void
id|__devinit
DECL|function|pcibios_setup_root_windows
id|pcibios_setup_root_windows
c_func
(paren
r_struct
id|pci_bus
...
id|resource
suffix:semicolon
multiline_comment|/* HP&squot;s firmware has a hack to work around a Windows bug.&n;&t;&t; * Ignore these tiny memory ranges */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;Ignoring range [%lx-%lx] (%lx)&bslash;n&quot;
comma
id|res-&gt;start
comma
id|res-&gt;end

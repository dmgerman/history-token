...
suffix:semicolon
DECL|variable|hp_simserial_driver
r_struct
id|tty_driver
...
l_string|&quot;simserial&quot;
suffix:semicolon
id|hp_simserial_driver.name
op_assign
l_string|&quot;ttyS&quot;
suffix:semicolon
id|hp_simserial_driver.major
op_assign
id|TTY_MAJOR
suffix:semicolon
id|hp_simserial_driver.minor_start
op_assign
l_int|64
suffix:semicolon
id|hp_simserial_driver.num
op_assign
l_int|1
suffix:semicolon
id|hp_simserial_driver.type
op_assign
id|TTY_DRIVER_TYPE_SERIAL
suffix:semicolon
id|hp_simserial_driver.subtype
op_assign
id|SERIAL_TYPE_NORMAL
suffix:semicolon
id|hp_simserial_driver.init_termios
op_assign
id|tty_std_termios
suffix:semicolon
id|hp_simserial_driver.init_termios.c_cflag
op_assign
id|B9600
op_or
id|CS8
...
id|serial_table
suffix:semicolon
id|hp_simserial_driver.termios
op_assign
id|serial_termios
suffix:semicolon
id|hp_simserial_driver.termios_locked
op_assign
id|serial_termios_locked
suffix:semicolon
id|hp_simserial_driver.open
op_assign
id|rs_open
suffix:semicolon
id|hp_simserial_driver.close
op_assign
id|rs_close
suffix:semicolon
id|hp_simserial_driver.write
op_assign
id|rs_write
suffix:semicolon
id|hp_simserial_driver.put_char
op_assign
id|rs_put_char
suffix:semicolon
id|hp_simserial_driver.flush_chars
op_assign
id|rs_flush_chars
suffix:semicolon
id|hp_simserial_driver.write_room
op_assign
id|rs_write_room
suffix:semicolon
id|hp_simserial_driver.chars_in_buffer
op_assign
id|rs_chars_in_buffer
suffix:semicolon
id|hp_simserial_driver.flush_buffer
op_assign
id|rs_flush_buffer
suffix:semicolon
id|hp_simserial_driver.ioctl
op_assign
id|rs_ioctl
suffix:semicolon
id|hp_simserial_driver.throttle
op_assign
id|rs_throttle
suffix:semicolon
id|hp_simserial_driver.unthrottle
op_assign
id|rs_unthrottle
suffix:semicolon
id|hp_simserial_driver.send_xchar
op_assign
id|rs_send_xchar
suffix:semicolon
id|hp_simserial_driver.set_termios
op_assign
id|rs_set_termios
suffix:semicolon
id|hp_simserial_driver.stop
op_assign
id|rs_stop
suffix:semicolon
id|hp_simserial_driver.start
op_assign
id|rs_start
suffix:semicolon
id|hp_simserial_driver.hangup
op_assign
id|rs_hangup
suffix:semicolon
id|hp_simserial_driver.break_ctl
op_assign
id|rs_break
suffix:semicolon
id|hp_simserial_driver.wait_until_sent
op_assign
id|rs_wait_until_sent
suffix:semicolon
id|hp_simserial_driver.read_proc
op_assign
id|rs_read_proc
suffix:semicolon

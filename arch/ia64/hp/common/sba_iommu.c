...
c_func
(paren
l_string|&quot;WARNING: IBASE is zero; setting to 0x%lx&bslash;n&quot;
comma
id|ioc-&gt;ibase
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;WARNING: IOV space overlaps local config and interrupt message, &quot;
l_string|&quot;truncating&bslash;n&quot;
)paren
suffix:semicolon
id|ioc-&gt;iov_size
op_div_assign
...
r_static
r_int
DECL|function|sba_proc_info_one
id|sba_proc_info_one
c_func
(paren
r_char
op_star
...
r_static
r_int
DECL|function|sba_resource_map_one
id|sba_resource_map_one
c_func
(paren
r_char
op_star

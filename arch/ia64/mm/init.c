...
suffix:semicolon
multiline_comment|/*&n;         * The MCA info structure was allocated earlier and a physical address pointer&n;         * saved in __per_cpu_mca[cpu].  Move that pointer into the cpuinfo structure.&n;         */
...
suffix:semicolon
multiline_comment|/*&n;         * Set pal_base and pal_paddr in cpuinfo structure.&n;         */
id|efi_get_pal_addr
c_func
(paren
)paren

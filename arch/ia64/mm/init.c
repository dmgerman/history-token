...
macro_line|# define LARGE_GAP&t;0x40000000&t;/* Use virtual mem map if hole is &gt; than this */
...
suffix:semicolon
multiline_comment|/*&n;&t; * Install the gate pages: one read-only page containing the ELF headers etc. and&n;&t; * one execute-only page, which enables privilege-promotion via &quot;epc&quot;:&n;&t; */
id|page0
op_assign
id|virt_to_page
c_func

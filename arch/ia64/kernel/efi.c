...
(brace
multiline_comment|/*&n;&t;&t;&t; * Search for the next run of contiguous WB memory.  Start search&n;&t;&t;&t; * at first granule boundary covered by md.&n;&t;&t;&t; */
id|granule_addr
op_assign
(paren
(paren
...
r_break
suffix:semicolon
multiline_comment|/* hit a non-WB region; stop search */
r_if
c_cond
(paren
id|check_md-&gt;phys_addr
...
r_break
suffix:semicolon
multiline_comment|/* hit a memory hole; stop search */
id|first_non_wb_addr
op_add_assign
...
multiline_comment|/* round it down to the previous granule-boundary: */
id|first_non_wb_addr
op_and_assign
op_minus
id|IA64_GRANULE_SIZE

...
DECL|macro|SHMLBA_HPAGE
macro_line|# define SHMLBA_HPAGE&t;&t;HPAGE_SIZE
DECL|macro|COLOR_HALIGN
macro_line|# define COLOR_HALIGN(addr)&t;(((addr) + SHMLBA_HPAGE - 1) &amp; ~(SHMLBA_HPAGE - 1))
DECL|macro|TASK_HPAGE_BASE
macro_line|# define TASK_HPAGE_BASE&t;((REGION_HPAGE &lt;&lt; REGION_SHIFT) | HPAGE_SIZE)
macro_line|#endif
r_int
r_int

...
id|cmc_poll_timer
suffix:semicolon
multiline_comment|/*&n; * Start with this in the wrong state so we won&squot;t play w/ timers&n; * before the system is ready.&n; */
...
DECL|variable|tr_val
DECL|variable|tr_idx
r_int
r_int
id|tr_val
(braket
...
(brace
multiline_comment|/*&n;&t;&t;&t; * CMC threshold exceeded, clear the history&n;&t;&t;&t; * so we have a fresh start when we return&n;&t;&t;&t; */
r_for
c_loop
(paren
id|index
...
l_int|0
suffix:semicolon
multiline_comment|/* Switch to polling mode */
id|cmc_polling_enabled
op_assign
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Unlock &amp; enable interrupts  before&n;&t;&t;&t; * smp_call_function or risk deadlock&n;&t;&t;&t; */
id|spin_unlock
c_func
(paren
op_amp
...
(paren
id|KERN_WARNING
l_string|&quot;ia64_mca_cmc_int_handler: WARNING: Switching to polling CMC handler, error records may be lost&bslash;n&quot;
)paren
suffix:semicolon
id|mod_timer
c_func
...
multiline_comment|/*&n; *  ia64_mca_cmc_int_caller&n; *&n; * &t;Call CMC interrupt handler, only purpose is to have a&n; * &t;smp_call_function callable entry.&n; *&n; * Inputs   :&t;dummy(unused)&n; * Outputs  :&t;None&n; * */
r_static
r_void
...
suffix:semicolon
multiline_comment|/* Call the interrupt handler */
id|smp_call_function
c_func
(paren
id|ia64_mca_cmc_int_caller
...
suffix:semicolon
multiline_comment|/*&n;&t; * If no log recored, switch out of polling mode.&n;&t; */
r_if
c_cond
(paren
id|start_count
...
(paren
id|KERN_WARNING
l_string|&quot;ia64_mca_cmc_poll: Returning to interrupt driven CMC handler&bslash;n&quot;
)paren
suffix:semicolon
id|cmc_polling_enabled
op_assign
...
multiline_comment|/*&n; *  ia64_mca_cpe_int_caller&n; *&n; * &t;Call CPE interrupt handler, only purpose is to have a&n; * &t;smp_call_function callable entry.&n; *&n; * Inputs   :&t;dummy(unused)&n; * Outputs  :&t;None&n; * */
r_static
r_void
...
suffix:semicolon
multiline_comment|/*&n;&t; * If a log was recorded, increase our polling frequency,&n;&t; * otherwise, backoff.&n;&t; */
r_if
c_cond
(paren
id|start_count
...
c_func
(paren
l_string|&quot;+Time: %02x/%02x/%02x%02x %02x:%02x:%02x    Severity %d&bslash;n&quot;
comma

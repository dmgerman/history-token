...
r_else
(brace
multiline_comment|/* If no log recored, switch out of polling mode */
r_if
c_cond
(paren
id|start_count
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * If a log was recorded, increase our polling frequency,&n;&t;&t; * otherwise, backoff.&n;&t;&t; */
r_if
c_cond
(paren
id|start_count

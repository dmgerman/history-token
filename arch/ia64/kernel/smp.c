...
macro_line|# define IPI_FLUSH_TLB&t;&t;2
...
id|flush_nbits
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Current CPU may be running with different RID so we need to&n;&t;&t;&t; * reload the RID of flushed address.  Purging the translation&n;&t;&t;&t; * also needs ALAT invalidation; we do not need &quot;invala&quot; here&n;&t;&t;&t; * since it is done in ia64_leave_kernel.&n;&t;&t;&t; */
id|ia64_srlz_d
c_func
(paren
)paren
...
l_int|1
suffix:semicolon
macro_line|#if (defined(CONFIG_ITANIUM_B0_SPECIFIC) &bslash;&n;     || defined(CONFIG_ITANIUM_B1_SPECIFIC) || defined(CONFIG_ITANIUM_B2_SPECIFIC))
r_int
r_int
id|timeout
suffix:semicolon

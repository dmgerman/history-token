...
id|order
suffix:semicolon
multiline_comment|/*&n;&t; * If NUMA is configured, the cpu_data array is not preallocated. The boot cpu&n;&t; * allocates entries for every possible cpu. As the remaining cpus come online,&n;&t; * they reallocate a new cpu_data structure on their local node. This extra work&n;&t; * is required because some boot code references all cpu_data structures&n;&t; * before the cpus are actually started.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

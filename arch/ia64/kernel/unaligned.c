...
(brace
DECL|macro|F
macro_line|#&t;define F(reg)&t;case reg: ia64_invala_gr(reg); break
r_switch
c_cond
(paren
id|regno
...
(brace
DECL|macro|F
macro_line|#&t;define F(reg)&t;case reg: ia64_invala_fr(reg); break
r_switch
c_cond
(paren
id|regno
...
c_func
(paren
l_string|&quot;r%lu, sw.bspstore=%lx pt.bspstore=%lx sof=%ld sol=%ld ridx=%ld&bslash;n&quot;
comma
id|r1
comma
id|sw-&gt;ar_bspstore
...
(brace
multiline_comment|/* read of out-of-frame register returns an undefined value; 0 in our case.  */
id|DPRINT
c_func
(paren
...
multiline_comment|/*&n; * Return the (rotated) index for floating point register REGNUM (REGNUM must be in the&n; * range from 32-127, result is in the range from 0-95.&n; */
r_static
r_inline
r_int
r_int
DECL|function|fph_index
id|fph_index
(paren
r_struct
id|pt_regs
...
(paren
id|KERN_ERR
l_string|&quot;%s: register update on speculative load, error&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t; * ldX.a we will emulate load and also invalidate the ALAT entry.&n;&t; * See comment below for explanation on how we handle ldX.a&n;&t; */
r_if
c_cond
(paren
id|len
...
suffix:semicolon
multiline_comment|/*&n;&t; * fr0 &amp; fr1 don&squot;t need to be checked because Illegal Instruction faults have&n;&t; * higher priority than unaligned faults.&n;&t; *&n;&t; * r0 cannot be found as the base as it would never generate an unaligned&n;&t; * reference.&n;&t; */
...
(brace
multiline_comment|/*&n;&t;&t; * This assumes little-endian byte-order.  Note that there is no &quot;ldfpe&quot;&n;&t;&t; * instruction:&n;&t;&t; */
r_if
c_cond
(paren
id|copy_from_user

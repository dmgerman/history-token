multiline_comment|/*&n; * palinfo.c&n; *&n; * Prints processor specific information reported by PAL.&n; * This code is based on specification of PAL as of the&n; * Intel IA-64 Architecture Software Developer&squot;s Manual v1.0.&n; *&n; *&n; * Copyright (C) 2000-2001, 2003 Hewlett-Packard Co&n; *&t;Stephane Eranian &lt;eranian@hpl.hp.com&gt;&n; * Copyright (C) 2004 Intel Corporation&n; *  Ashok Raj &lt;ashok.raj@intel.com&gt;&n; *&n; * 05/26/2000&t;S.Eranian&t;initial release&n; * 08/21/2000&t;S.Eranian&t;updated to July 2000 PAL specs&n; * 02/05/2001   S.Eranian&t;fixed module support&n; * 10/23/2001&t;S.Eranian&t;updated pal_perf_mon_info bug fixes&n; * 03/24/2004&t;Ashok Raj&t;updated to work with CPU Hotplug&n; */
...
multiline_comment|/*&n; * this array is used to keep track of the proc entries we create. This is&n; * required in the module mode when we need to remove all entries. The procfs code&n; * does not do recursion of deletion&n; *&n; * Notes:&n; *&t;- +1 accounts for the cpuN directory entry in /proc/pal&n; */
DECL|macro|NR_PALINFO_PROC_ENTRIES
mdefine_line|#define NR_PALINFO_PROC_ENTRIES&t;(NR_CPUS*(NR_PALINFO_ENTRIES+1))
...
r_static
r_void
DECL|function|create_palinfo_proc_entries
id|create_palinfo_proc_entries
c_func
(paren
r_int
r_int
...
id|cpu
suffix:semicolon
multiline_comment|/*&n;&t; * Compute the location to store per cpu entries&n;&t; * We dont store the top level entry in this list, but&n;&t; * remove it finally after removing all cpu entries.&n;&t; */
id|pdir
op_assign
op_amp
id|palinfo_proc_entries
...
r_static
r_void
DECL|function|remove_palinfo_proc_entries
id|remove_palinfo_proc_entries
c_func
(paren
r_int
r_int
...
DECL|function|palinfo_cpu_callback
r_static
r_int
id|__devinit
id|palinfo_cpu_callback
c_func
(paren
r_struct
id|notifier_block
...
DECL|variable|palinfo_cpu_notifier
r_static
r_struct
id|notifier_block
id|palinfo_cpu_notifier
op_assign
(brace
dot
id|notifier_call
...
suffix:semicolon
multiline_comment|/* Create palinfo dirs in /proc for all online cpus */
...
multiline_comment|/* Register for future delivery via notify registration */
...
multiline_comment|/*&n;&t; * Remove the top level entry finally&n;&t; */
id|remove_proc_entry
c_func
(paren
id|palinfo_dir-&gt;name
...
suffix:semicolon
multiline_comment|/*&n;&t; * Unregister from cpu notifier callbacks&n;&t; */

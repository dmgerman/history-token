...
r_void
DECL|function|acpi_get_crs_addr
id|acpi_get_crs_addr
(paren
r_struct
id|acpi_buffer
op_star
...
id|type
op_eq
id|addr16-&gt;resource_type
)paren
(brace
op_star
id|base
op_assign
id|addr16-&gt;min_address_range
suffix:semicolon
op_star
id|size
op_assign
id|addr16-&gt;address_length
suffix:semicolon
op_star
id|tra
op_assign
id|addr16-&gt;address_translation_offset
suffix:semicolon
r_return
suffix:semicolon
)brace
...
id|size
op_assign
id|addr32-&gt;address_length
suffix:semicolon
op_star
id|tra
op_assign
id|addr32-&gt;address_translation_offset
suffix:semicolon
r_return
suffix:semicolon
)brace
...
id|type
op_eq
id|addr64-&gt;resource_type
)paren
(brace
op_star
id|base
op_assign
id|addr64-&gt;min_address_range
suffix:semicolon
op_star
id|size
op_assign
id|addr64-&gt;address_length
suffix:semicolon
op_star
id|tra
op_assign
id|addr64-&gt;address_translation_offset
suffix:semicolon
r_return
suffix:semicolon
)brace
...
r_int
DECL|function|acpi_get_addr_space

...
suffix:semicolon
multiline_comment|/* for CONFIG_PREEMPT, this must come after irq_enter()! */
id|kstat_cpu
c_func
(paren
id|cpu
...
mdefine_line|#define HEX_DIGITS (2*sizeof(cpumask_t))
...
id|tmp
suffix:semicolon
DECL|macro|R_PREFIX_LEN
macro_line|#&t;define R_PREFIX_LEN 16
r_char
id|rbuf
(braket
id|R_PREFIX_LEN
...
id|EIO
suffix:semicolon
multiline_comment|/*&n;&t; * If string being written starts with a prefix of &squot;r&squot; or &squot;R&squot;&n;&t; * and some limited number of spaces, set IA64_IRQ_REDIRECTED.&n;&t; * If more than (R_PREFIX_LEN - 2) spaces are passed, they won&squot;t&n;&t; * all be trimmed as part of prelen, the untrimmed spaces will&n;&t; * cause the hex parsing to fail, and this write() syscall will&n;&t; * fail with EINVAL.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

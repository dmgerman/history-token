...
id|delivery
suffix:semicolon
multiline_comment|/*&n;&t; * In override, it does not provide addr/base_irq.  global_vector is enough to&n;&t; * locate iosapic addr, base_irq and pin by examining base_irq and max_pin of&n;&t; * registered iosapics (tbd)&n;&t; */
...
c_func
(paren
l_string|&quot;WARN: register_irq: diff IOSAPIC ADDRESS for gv %x, v %x&bslash;n&quot;
comma
id|global_vector
comma
id|vector
...
c_func
(paren
l_string|&quot;WARN: register_irq: diff BASE IRQ %x for gv %x, v %x&bslash;n&quot;
comma
id|base_irq
comma
id|global_vector
...
c_func
(paren
l_string|&quot;WARN: register_irq: invalid override for gv %x, v %x&bslash;n&quot;
comma
id|global_vector
comma
id|vector
...
c_func
(paren
l_string|&quot;register_irq(): changing vector 0x%02x from &quot;
...
c_func
(paren
l_string|&quot;IOSAPIC 0x%x(%s,%s) -&gt; Vector 0x%x&bslash;n&quot;
comma
id|global_vector
comma
(paren
...
c_func
(paren
l_string|&quot;PLATFORM int 0x%x: IOSAPIC 0x%x(%s,%s) -&gt; Vector 0x%x CPU %.02u:%.02u&bslash;n&quot;
comma
id|int_type
comma
id|global_vector
...
multiline_comment|/*&n; * ACPI calls this when it finds an entry for a legacy ISA interrupt.&n; * Note that the irq_base and IOSAPIC address must be set in iosapic_init().&n; */
r_void
...
suffix:semicolon
multiline_comment|/* ignored for override */
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t;&t;&t; * Direct the interrupt vector to the current cpu,&n;&t;&t;&t;&t;&t; * platform redirection will distribute them.&n;&t;&t;&t;&t;&t; */
id|set_rte
c_func
(paren
id|vector

...
c_func
(paren
l_string|&quot;%s: ubspstore=%p urnat_addr=%p&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ubspstore
...
c_func
(paren
l_string|&quot;%s: rnat0=%016lx, m=%016lx, rnat0_kaddr=%p kbsp=%p&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|rnat0
...
c_func
(paren
l_string|&quot;%s: rnat1=%016lx, m=%016lx, rnat1_kaddr=%p kbsp=%p&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|rnat1

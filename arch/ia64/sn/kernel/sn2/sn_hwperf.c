...
multiline_comment|/* map SAL hwperf error code to system error code */
DECL|function|sn_hwperf_map_err
r_static
r_int
id|sn_hwperf_map_err
c_func
(paren
r_int
id|hwperf_err
...
suffix:semicolon
r_case
id|SN_HWPERF_OP_BUSY
suffix:colon
r_case
id|SN_HWPERF_OP_RECONFIGURE
suffix:colon
id|e
op_assign
op_minus

...
(brace
multiline_comment|/* XXX: need a better way than this ... */
r_if
c_cond
(paren
id|sscanf
...
id|hwg_node_name
comma
l_string|&quot;hw/module/%03dc%02d/slab/%d&quot;
comma
op_amp
id|cmod
comma
...
macro_line|#ifndef MODULE_IOBRICK 
multiline_comment|/* this will be available when ioif TIO support is added */
DECL|macro|MODULE_IOBRICK
mdefine_line|#define MODULE_IOBRICK (MODULE_OPUSBRICK+1)
macro_line|#endif

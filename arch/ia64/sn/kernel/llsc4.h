...
DECL|macro|LLSC_MAXCPUS
mdefine_line|#define LLSC_MAXCPUS&t;&t;64
...
DECL|macro|ZEROLOCK
mdefine_line|#define ZEROLOCK(i)&t;init_lock(LOCKADDR(i))
DECL|macro|CACHEALIGN
mdefine_line|#define CACHEALIGN(a)&t;((char*)((long)(a) &amp; ~127L))
DECL|typedef|guard_t
r_typedef
id|uint
id|guard_t
suffix:semicolon

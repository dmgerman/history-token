...
multiline_comment|/**&n; * sn1_mmiob - I/O space memory barrier&n; *&n; * Acts as a memory mapped I/O barrier for platforms that queue writes to &n; * I/O space.  This ensures that subsequent writes to I/O space arrive after&n; * all previous writes.  For most ia64 platforms, this is a simple&n; * &squot;mf.a&squot; instruction.  For other platforms, mmiob() may have to read&n; * a chipset register to ensure ordering.&n; *&n; * On SN1, we wait for the PIO_WRITE_STATUS Bedrock register to clear.&n; */
r_void
DECL|function|sn1_mmiob
id|sn1_mmiob
(paren
r_void
)paren

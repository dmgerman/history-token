...
suffix:semicolon
DECL|variable|sn_sharing_domain_size
id|u8
id|sn_sharing_domain_size
suffix:semicolon
DECL|variable|sn_sharing_domain_size
id|EXPORT_SYMBOL
c_func
...
c_cond
(paren
id|ia64_sn_get_sn_info
c_func
(paren
l_int|0
comma
op_amp
id|sn_hub_info-&gt;shub2
comma
op_amp
id|sn_hub_info-&gt;nasid_bitmask
comma
op_amp
id|sn_hub_info-&gt;nasid_shift
comma
op_amp
id|sn_system_size
comma

...
DECL|macro|TO_NODE
mdefine_line|#define TO_NODE(_n, _x)&t;&t;(((long)_n&lt;&lt;33L) | (long)_x)
...
id|NODE0_HOLE_SIZE
suffix:semicolon
multiline_comment|/*&n;                                 * UGLY hack - we must skip overr the kernel and&n;                                 * PROM runtime services but we dont exactly where it is.&n;                                 * So lets just reserve 0-12MB.&n;                                 */
r_if
c_cond
(paren
id|bank

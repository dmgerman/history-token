...
multiline_comment|/*&n; * Delete this when atomic_clear is part of atomic.h.&n; */
r_static
id|__inline__
r_int
DECL|function|atomic_clear
id|atomic_clear
(paren
r_int
id|i
...
DECL|macro|LOCK_HUB
mdefine_line|#define LOCK_HUB&t;REMOTE_HUB_ADDR
...
mdefine_line|#define UART_FIFO_DEPTH&t;&t;0xf0
...
macro_line|#ifdef BRINGUP
DECL|macro|FORCE_CONSOLE_NASID
mdefine_line|#define FORCE_CONSOLE_NASID
macro_line|#endif
DECL|macro|HUB_LOCK
...
mdefine_line|#define UART_PUTC_READY(n)      ( (READ_L1_UART_REG((n), REG_LSR) &amp; LSR_XHRE) &amp;&amp; (READ_L1_UART_REG((n), REG_MSR) &amp; MSR_CTS) )
r_static
r_int
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef FORCE_CONSOLE_NASID
multiline_comment|/* We need this for the console write path _elscuart_flush() -&gt; brl1_send() */
id|sc-&gt;nasid
op_assign
l_int|0
suffix:semicolon
...
mdefine_line|#define SUBCH_LOCK(sc)&t;&t;&t;spin_lock_irq( &amp;((sc)-&gt;subch_lock) )
DECL|macro|SUBCH_UNLOCK
mdefine_line|#define SUBCH_UNLOCK(sc)&t;&t;spin_unlock_irq( &amp;((sc)-&gt;subch_lock) )
DECL|macro|SUBCH_DATA_LOCK
mdefine_line|#define SUBCH_DATA_LOCK(sbch) &t;&t;spin_lock_irq( &amp;((sbch)-&gt;data_lock) )
DECL|macro|SUBCH_DATA_UNLOCK
mdefine_line|#define SUBCH_DATA_UNLOCK(sbch)&t;&t;spin_unlock_irq( &amp;((sbch)-&gt;data_lock) )
macro_line|#else
DECL|macro|SUBCH_LOCK
mdefine_line|#define SUBCH_LOCK(sc)
DECL|macro|SUBCH_UNLOCK
mdefine_line|#define SUBCH_UNLOCK(sc)
DECL|macro|SUBCH_DATA_LOCK
mdefine_line|#define SUBCH_DATA_LOCK(sbch)
DECL|macro|SUBCH_DATA_UNLOCK
mdefine_line|#define SUBCH_DATA_UNLOCK(sbch)
macro_line|#endif
...
suffix:semicolon
macro_line|#ifdef BRINGUP
multiline_comment|/* We want to be sure that we are sending the entire packet before returning */
id|wait
op_assign
l_int|1
suffix:semicolon
...
l_int|0
suffix:semicolon
singleline_comment|//(get_elsc())-&gt;nasid;
id|WRITE_L1_UART_REG
c_func
(paren
id|nasid

...
suffix:semicolon
DECL|variable|hwgraph_debug_mask
r_int
r_int
id|hwgraph_debug_mask
suffix:semicolon
...
multiline_comment|/*&n;&t; * Persistent Naming.&n;&t; */
id|init_ioconfig_bus
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;HWGRAPH_DEBUG kmalloc fails at %d &quot;
comma
id|__LINE__
)paren
suffix:semicolon

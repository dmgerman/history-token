...
c_func
(paren
l_string|&quot;ioconfig_bus_table tabel empty&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot;build_moduleid_table(): Unabled to allocate memmory&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;ioconfig_bus_init : cannot allocate memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;ioconfig_bus_table table is empty&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

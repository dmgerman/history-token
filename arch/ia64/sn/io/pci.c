...
suffix:semicolon
multiline_comment|/*&n; * snia64_read - Read from the config area of the device.&n; */
DECL|function|snia64_read
r_static
r_int
id|snia64_read
(paren
...
multiline_comment|/*&n; * snia64_write - Writes to the config area of the device.&n; */
DECL|function|snia64_write
r_static
r_int
id|snia64_write
(paren
...
multiline_comment|/* Starting 2.5.32 struct pci_dev is not passed down */
multiline_comment|/*if (dev-&gt;vendor == PCI_VENDOR_ID_SGI &amp;&amp; &n;&t;    dev-&gt;device == PCI_DEVICE_ID_SGI_IOC3 )&n;&t;&t;return PCIBIOS_SUCCESSFUL;&n;&t;*/
id|device_vertex
op_assign
id|devfn_to_vertex
c_func

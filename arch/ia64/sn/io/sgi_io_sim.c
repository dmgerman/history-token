...
c_func
(paren
l_string|&quot;pciba_init : no-op&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;set_master_bridge_base: SIMULATED_KLGRAPH FIXME hardwired master.&bslash;n&quot;
)paren
suffix:semicolon
id|console_nasid
op_assign
...
id|cnodeid_t
DECL|function|nasid_to_compact_nodeid
id|nasid_to_compact_nodeid
c_func
(paren
id|nasid_t
...
id|nasid_t
DECL|function|compact_to_nasid_nodeid

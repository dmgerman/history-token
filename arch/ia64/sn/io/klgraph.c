...
(paren
(paren
l_string|&quot;klhwg_add_rps: adding %s to vertex 0x%x&bslash;n&quot;
comma
id|EDGE_LBL_RPS
comma
id|node_vertex
...
r_return
suffix:semicolon
id|rps_invent-&gt;ir_xbox
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* not an xbox RPS */
r_if
c_cond
(paren
id|flag
)paren
id|rps_invent-&gt;ir_gen.ig_flag
op_assign
id|INVENT_ENABLED
suffix:semicolon
r_else
...
multiline_comment|/*&n; * klhwg_update_rps gets invoked when the system controller sends an &n; * interrupt indicating the power supply has lost/regained the redundancy.&n; * It&squot;s responsible for updating the Hardware graph information.&n; *&t;rps_state = 0 -&gt; if the rps lost the redundancy&n; *&t;&t;  = 1 -&gt; If it is redundant. &n; */
r_void
DECL|function|klhwg_update_rps
id|klhwg_update_rps
c_func
(paren
id|cnodeid_t
...
r_void
DECL|function|klhwg_add_xbox_rps
id|klhwg_add_xbox_rps
c_func
(paren
id|devfs_handle_t
id|node_vertex
...
multiline_comment|/*&n; * klhwg_update_xbox_rps gets invoked when the xbox system controller&n; * polls the status register and discovers that the power supply has &n; * lost/regained the redundancy.&n; * It&squot;s responsible for updating the Hardware graph information.&n; *&t;rps_state = 0 -&gt; if the rps lost the redundancy&n; *&t;&t;  = 1 -&gt; If it is redundant. &n; */
r_void
DECL|function|klhwg_update_xbox_rps
id|klhwg_update_xbox_rps
c_func
(paren
id|cnodeid_t
id|cnode
...
id|err
suffix:semicolon
macro_line|#if CONFIG_SGI_IP35 || CONFIG_IA64_SGI_SN1 || defined(CONFIG_IA64_GENERIC)
r_if
c_cond
(paren
(paren

...
id|mask_reg
suffix:semicolon
singleline_comment|// nasid_t nasid = COMPACT_TO_NASID_NODEID(cpuid_to_cnodeid(cpu));
id|nasid_t
id|nasid
op_assign
id|cpuid_to_nasid
...
(paren
id|KERN_WARNING
l_string|&quot;Cannot target interrupts to closest node(%d): (0x%lx)&bslash;n&quot;
comma
id|master_node_get
c_func
(paren
...
(brace
multiline_comment|/*&n;&t; * Do a stupid round-robin assignment of the node.&n;&t; *  (Should do a &quot;nearest neighbor&quot; but not for SN1.&n;&t; */
r_static
id|cnodeid_t
id|last_node
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;Cannot target interrupts: (0x%lx)&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;intr_reserve_hardwired: Can&squot;t reserve level %d, cpu %ld.&quot;
comma
id|level
comma
id|cpu

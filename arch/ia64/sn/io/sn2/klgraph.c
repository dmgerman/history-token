...
multiline_comment|/*&n; * Add detailed disabled cpu inventory info to the hardware graph.&n; */
r_void
DECL|function|klhwg_disabled_cpu_invent_info
...
r_return
suffix:semicolon
multiline_comment|/* Diag information on this processor */
id|diag_invent
op_assign
(paren
id|diag_inv_t
...
r_return
suffix:semicolon
multiline_comment|/* Disabled CPU */
id|cpu_invent-&gt;ic_gen.ig_flag
op_assign
l_int|0x0
suffix:semicolon
id|cpu_invent-&gt;ic_gen.ig_slot
op_assign
id|slot
suffix:semicolon
id|cpu_invent-&gt;ic_cpu_info.cpuflavor
op_assign
id|cpu-&gt;cpu_prid
suffix:semicolon
id|cpu_invent-&gt;ic_cpu_info.cpufq
op_assign
id|cpu-&gt;cpu_speed
suffix:semicolon
id|cpu_invent-&gt;ic_cpu_info.sdfreq
op_assign
id|cpu-&gt;cpu_scachespeed
suffix:semicolon
id|cpu_invent-&gt;ic_cpu_info.sdsize
op_assign
id|cpu-&gt;cpu_scachesz
suffix:semicolon
id|cpu_invent-&gt;ic_cpuid
op_assign
id|cpu-&gt;cpu_info.virtid
suffix:semicolon
id|cpu_invent-&gt;ic_slice
op_assign
id|cpu-&gt;cpu_info.physid
suffix:semicolon
multiline_comment|/* Disabled CPU label */
...
suffix:semicolon
multiline_comment|/* Diagval label - stores reason for disable +{virt,phys}id +diagval*/
id|hwgraph_info_add_LBL
c_func
(paren
id|cpuv
...
r_void
DECL|function|klhwg_cpu_invent_info

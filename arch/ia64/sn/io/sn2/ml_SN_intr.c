...
multiline_comment|/* Dont enable any ints from II. We will poll for interrupts. */
id|ii_int_enable.sh_ii_int0_enable_s.ii_enable
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Enable IPIs. We use them ONLY for send INITs to hung cpus */
op_star
(paren
r_volatile
r_int

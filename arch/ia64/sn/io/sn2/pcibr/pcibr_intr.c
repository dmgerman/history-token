...
id|pcibr_intr
suffix:semicolon
id|intr_entry-&gt;il_soft
op_assign
id|pcibr_soft
suffix:semicolon
id|intr_entry-&gt;il_slot
op_assign
id|pciio_slot
suffix:semicolon
id|intr_list_p
...
suffix:semicolon
multiline_comment|/* bus and int_bits are stored in sfarg, bus bit3, int_bits bit2:0 */
id|pcibr_int_bit
op_assign
op_star
(paren
...
id|pcibr_intr-&gt;bi_dev
comma
l_string|&quot;pcibr_setpciint: int_addr=0x%lx, *int_addr=0x%lx, &quot;

...
r_static
r_uint64
DECL|function|pcibr_disable_mst_timeout
id|pcibr_disable_mst_timeout
c_func
(paren
id|pcibr_soft_t
id|pcibr_soft
...
l_int|0
suffix:semicolon
multiline_comment|/* was already disabled */
)brace
r_else
(brace
r_return
...
r_static
r_int
DECL|function|pcibr_enable_mst_timeout
id|pcibr_enable_mst_timeout
c_func
(paren
id|pcibr_soft_t
id|pcibr_soft
...
l_int|0
suffix:semicolon
multiline_comment|/* was alread enabled */
)brace
r_else
(brace
r_return

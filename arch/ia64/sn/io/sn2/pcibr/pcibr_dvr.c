...
comma
l_string|&quot;pcibr_try_set_device: mod blocked by %x&bslash;n&quot;
comma
id|bad
comma
id|device_bits
...
(brace
multiline_comment|/*&n;&t; * If flashprom write was enabled, disable it, as&n;&t; * this is the last unmap.&n;&t; */
r_if
c_cond
(paren
id|IS_BRIDGE_SOFT
...
id|s
suffix:semicolon
multiline_comment|/*&n;&t;&t; * ensure that we write and read without any interruption.&n;&t;&t; * The read following the write is required for the Bridge war&n;&t;&t; */
id|s
op_assign
id|splhi
c_func
...
id|s
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * ensure that we write and read without any interruption.&n;&t;&t;&t; * The read following the write is required for the Bridge war&n;&t;&t;&t; */
id|s
op_assign
id|splhi
c_func
...
id|s
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * ensure that we write and read without any interruption.&n;&t;&t;&t;&t; * The read following the write is required for the Bridge war&n;&t;&t;&t;&t; */
id|s
op_assign
id|splhi
c_func
...
suffix:semicolon
multiline_comment|/* set whether it is a PIC or not */
id|Is_pic_on_this_nasid
(braket
id|nasid
)braket
...
macro_line|#ifdef PIC_LATER
singleline_comment|// This probably needs to be addressed - pfg
id|node_val
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;Invalid hwgraph node path specified:&bslash;n&quot;
l_string|&quot;    DEVICE_ADMIN: %s %s=%s&bslash;n&quot;
comma
id|vname
comma
id|ADMIN_LBL_DMATRANS_NODE
...
suffix:semicolon
macro_line|#ifdef BUS_INT_WAR_NOT_YET
id|request_irq
c_func
(paren
...
multiline_comment|/* WAR panic for Rev B silent data corruption.&n;     * PIOERR turned off here because there is a problem&n;     * with not re-arming it in pcibr_error_intr_handler.&n;     * We don&squot;t get LLP error interrupts if we don&squot;t&n;     * re-arm PIOERR interrupts! Just disable them here&n;     */
r_if
c_cond
(paren
id|pcibr_soft-&gt;bs_rev_num
...
id|pcibr_vhdl
comma
l_string|&quot;Turning on LLP_REC_CBERR for Rev B Bridge.&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
id|win_map_p
comma
id|PCIBR_BUS_SWIN_MAX
op_plus
l_int|1
comma
id|PCIBR_BUS_SWIN_PAGE
)paren
suffix:semicolon
id|pciio_device_win_populate
c_func
...
id|win_map_p
comma
id|PCIBR_BUS_MEM_MAX
op_plus
l_int|1
comma
id|PCIBR_BUS_MEM_PAGE
)paren
suffix:semicolon
id|pciio_device_win_populate
c_func
...
suffix:semicolon
macro_line|#ifdef PIC_LATER
macro_line|#if (defined(USS302_TIMEOUT_WAR))
multiline_comment|/*&n;     * If this bridge holds a Lucent USS-302 or USS-312 pci/usb controller,&n;     * increase the Bridge PCI retry backoff interval.  This part seems&n;     * to go away for long periods of time if a DAC appears on the bus during&n;     * a read command that is being retried.&n;     */
(brace
id|ii_ixtt_u_t
id|ixtt
suffix:semicolon
...
id|bss_device_id
op_eq
id|LUCENT_USBHC302_DEVICE_ID_NUM
op_logical_or
id|pcibr_soft-&gt;bs_slot
(braket
id|slot
...
id|bss_device_id
op_eq
id|LUCENT_USBHC312_DEVICE_ID_NUM
)paren
)paren
(brace
id|printk
...
(paren
id|KERN_NOTICE
l_string|&quot;pcibr_attach: %x Bus holds a usb part - setting&quot;
l_string|&quot;bridge PCI_RETRY_HLD to %d&bslash;n&quot;
comma
id|pcibr_vhdl
comma
id|USS302_BRIDGE_TIMEOUT_HLD
)paren
suffix:semicolon
id|bridge-&gt;b_bus_timeout
op_and_assign
op_complement
id|BRIDGE_BUS_PCI_RETRY_HLD_MASK
suffix:semicolon
id|bridge-&gt;b_bus_timeout
op_or_assign
...
suffix:semicolon
multiline_comment|/*&n;&t;     * Have to consider the read response timer in the hub II as well&n;&t;     */
id|hubii_ixtt_get
c_func
(paren
id|xconn_vhdl
...
suffix:semicolon
multiline_comment|/*&n;&t;     * bump rrsp_ps to allow at least 1ms for read&n; &t;     * responses from this widget&n;&t;     */
id|ixtt.ii_ixtt_fld_s.i_rrsp_ps
op_assign
l_int|20000
suffix:semicolon
id|hubii_ixtt_set
...
suffix:semicolon
multiline_comment|/*&n;&t;     * print the current setting&n;&t;     */
id|hubii_ixtt_get
c_func
(paren
id|xconn_vhdl
...
c_func
(paren
l_string|&quot;Setting hub ixtt.rrsp_ps field to 0x%x&bslash;n&quot;
comma
id|ixtt.ii_ixtt_fld_s.i_rrsp_ps
)paren
suffix:semicolon
r_break
suffix:semicolon
multiline_comment|/* only need to do it once */
)brace
)brace
)brace
macro_line|#endif&t;/* (defined(USS302_TIMEOUT_WAR)) */
macro_line|#else
id|FIXME
c_func
(paren
...
id|tmp_str
comma
l_string|&quot;pcibr_addr_pci_to_xio: map to %x[%x..%x] for &quot;
l_string|&quot;slot %d allocates DevIO(%d) Device(%d) set to %x&bslash;n&quot;
comma
id|space
comma
id|space_desc
...
comma
l_string|&quot;pcibr_addr_pci_to_xio: map to %x[%x..%x] for &quot;
l_string|&quot;slot %d uses DevIO(%d)&bslash;n&quot;
comma
id|space
comma
id|space_desc
...
id|tmp_str
comma
l_string|&quot;pcibr_addr_pci_to_xio: swap conflict in %x, &quot;
...
id|tmp_str
comma
l_string|&quot;pcibr_addr_pci_to_xio: swap for %x set &quot;
l_string|&quot;to%s%s&bslash;n&quot;
comma
id|space
comma
id|space_desc
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: xtalk_dmamap_list() failed, &quot;
l_string|&quot;pcibr_dmamap=0x%x&bslash;n&quot;
comma
id|pcibr_dmamap
)paren
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: alenlist_create() failed, &quot;
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: pcibr_addr_xio_to_pci failed, &quot;
l_string|&quot;pcibr_dmamap=0x%x&bslash;n&quot;
comma
id|pcibr_dmamap
)paren
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: alenlist_replace() failed, &quot;
l_string|&quot;pcibr_dmamap=0x%x&bslash;n&quot;
comma
id|pcibr_dmamap
)paren
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: alenlist_append() failed, &quot;
l_string|&quot;pcibr_dmamap=0x%x&bslash;n&quot;
comma
id|pcibr_dmamap
)paren
...
id|pcibr_dmamap-&gt;bd_dev
comma
l_string|&quot;pcibr_dmamap_list: pcibr_dmamap=0x%x, pciio_alenlist=0x%x&bslash;n&quot;
comma
id|pcibr_dmamap
comma
id|pciio_alenlist
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: DMA configuration conflict &quot;
l_string|&quot;for direct64, flags=0x%x&bslash;n&quot;
comma
id|flags
)paren
)paren
...
comma
l_string|&quot;pcibr_dmatrans_list: DMA configuration conflict &quot;
l_string|&quot;for direct32, flags=0x%x&bslash;n&quot;
comma
id|flags
)paren
)paren
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: xtalk_dmatrans_list failed &quot;
l_string|&quot;xtalk_alenlist=0x%x&bslash;n&quot;
comma
id|xtalk_alenlist
)paren
)paren
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: alenlist_create failed with &quot;
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: xio_addr == XIO_NOWHERE&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: pcibr_addr_xio_to_pci failed &quot;
l_string|&quot;xio_addr=0x%x, xio_size=0x%x&bslash;n&quot;
comma
id|xio_addr
comma
id|xio_size
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: xio_size &gt; map_size fail&bslash;n&quot;
l_string|&quot;xio_addr=0x%x, xio_size=0x%x. map_size=0x%x, &quot;
l_string|&quot;xio_port=0x%x, endoff=0x%x&bslash;n&quot;
comma
id|xio_addr
comma
id|xio_size
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: alenlist_replace failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_goto
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: alenlist_append failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_goto
...
id|pconn_vhdl
comma
l_string|&quot;pcibr_dmatrans_list: pciio_alenlist=0x%x&bslash;n&quot;
comma
id|pciio_alenlist
)paren
)paren
...
id|conn
comma
l_string|&quot;pcibr_reset unimplemented for slot %d&bslash;n&quot;
comma
id|conn
comma
id|pciio_slot
...
(brace
multiline_comment|/* strtok_r() wipes out string, use a copy */
(paren
r_void
)paren
id|strcpy

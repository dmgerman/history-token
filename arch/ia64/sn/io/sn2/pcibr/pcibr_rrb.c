...
mdefine_line|#define NUM_PDEV_BITS(bridge)&t;&t;(is_pic((bridge)) ? 1 : 2)
DECL|macro|NUM_VDEV_BITS
mdefine_line|#define NUM_VDEV_BITS(bridge)&t;&t;(is_pic((bridge)) ? 2 : 1)
DECL|macro|NUMBER_VCHANNELS
mdefine_line|#define NUMBER_VCHANNELS(bridge)&t;(is_pic((bridge)) ? 4 : 2)
...
mdefine_line|#define VALIDATE_SLOT_n_VCHAN(bridge, s, v) &bslash;&n;  (is_pic((bridge)) ? &bslash;&n;    (((((s) != PCIIO_SLOT_NONE) &amp;&amp; ((s) &lt;= (pciio_slot_t)3)) &amp;&amp; (((v) &gt;= 0) &amp;&amp; ((v) &lt;= 3))) ? 1 : 0) : &bslash;&n;    (((((s) != PCIIO_SLOT_NONE) &amp;&amp; ((s) &lt;= (pciio_slot_t)7)) &amp;&amp; (((v) &gt;= 0) &amp;&amp; ((v) &lt;= 1))) ? 1 : 0))
...
r_else
(brace
multiline_comment|/* io_get_sh_swapper(NASID_GET(bridge)) */
r_while
c_loop
(paren
(paren

...
multiline_comment|/*&n;     * Save this information in the correct slab number of the node in the &n;     * module.&n;     */
id|slab_number
op_assign
id|geo_slab
c_func
...
c_func
(paren
l_string|&quot;slab number added 0x%x&bslash;n&quot;
comma
id|slab_number
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;module_add_node .. slab previously found&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;     * First pass just scan for compute node boards KLTYPE_SNIA.&n;     * We do not support memoryless compute nodes.&n;     */
r_for
c_loop
(paren
id|node
...
l_int|NULL
comma
l_string|&quot;Found Shub lboard 0x%lx nasid 0x%x cnode 0x%x &bslash;n&quot;
comma
(paren
r_int
r_int
...
multiline_comment|/*&n;     * Second scan, look for headless/memless board hosted by compute nodes.&n;     */
r_for
c_loop
(paren
id|node
...
l_int|NULL
comma
l_string|&quot;Found headless/memless lboard 0x%lx node %d nasid %d cnode %d&bslash;n&quot;
comma
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * Get and initialize the serial number.&n;&t; */
id|board_serial_number_get
c_func
(paren
id|board

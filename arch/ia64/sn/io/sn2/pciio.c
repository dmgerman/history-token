...
multiline_comment|/*&n; *  XXX: should probably be called __sn2_pci_rrb_alloc&n; */
multiline_comment|/* used by qla1280 */
r_int
...
suffix:semicolon
multiline_comment|/* &n; * XXX: interface should be more like&n; *&n; *&t;int __sn2_pci_enable_bwswap(struct pci_dev *dev);&n; *&t;void __sn2_pci_disable_bswap(struct pci_dev *dev);&n; */

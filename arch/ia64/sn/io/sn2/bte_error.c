...
multiline_comment|/*&n; * Second part error handler.  Wait until all BTE related CRBs are completed&n; * and then reset the interfaces.&n; */
r_void
...
suffix:semicolon
multiline_comment|/* Clear IBLS0/1 error bits */

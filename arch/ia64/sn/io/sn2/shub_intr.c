...
r_else
(brace
multiline_comment|/* ICE does not have widget id. */
r_return
op_minus
l_int|1
suffix:semicolon
...
multiline_comment|/* &n; * Redirect an interrupt to another cpu.&n; */
r_void
DECL|function|sn_shub_redirect_intr
...
c_func
(paren
l_string|&quot;smp_affinity WARNING: SHUB 1.1 present: cannot target cpu %d, targeting cpu %d instead.&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
multiline_comment|/* Reset Host address (Interrupt destination) */
...
suffix:semicolon
multiline_comment|/* Force an interrupt, just in case. */

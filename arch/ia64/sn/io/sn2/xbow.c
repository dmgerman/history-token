...
multiline_comment|/*&n; * This file supports the Xbow chip.  Main functions: initializtion,&n; * error handling.&n; */
...
mdefine_line|#define xbow_soft_get(v)&t;((struct xbow_soft_s *)hwgraph_fastinfo_get((v)))
...
c_func
(paren
l_string|&quot;%s: xbow_attach&bslash;n&quot;
comma
id|vertex_to_name
c_func
(paren
...
(brace
multiline_comment|/* for opus the present bit doesn&squot;t work on port 0xb */
r_return
l_int|1
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* WAR for opus this is missing on 0xb */
r_else
r_if
c_cond
(paren

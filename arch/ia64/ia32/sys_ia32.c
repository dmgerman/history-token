...
suffix:semicolon
multiline_comment|/* we may be exec&squot;ing a 64-bit process: reset map base &amp; task-size: */
id|current-&gt;thread.map_base
op_assign
id|DEFAULT_MAP_BASE
suffix:semicolon
...
(brace
multiline_comment|/* oops, execve failed, switch back to old map base &amp; task-size: */
id|current-&gt;thread.map_base
op_assign
id|old_map_base
suffix:semicolon
...
macro_line|#ifdef&t;CONFIG_IA64_PAGE_SIZE_4KB
r_if
c_cond
(paren
(paren
...
suffix:semicolon
macro_line|#else&t;
singleline_comment|// CONFIG_IA64_PAGE_SIZE_4KB
r_if
c_cond
(paren
id|prot
...
mdefine_line|#define __CMSG32_NXTHDR(ctl, len, cmsg, cmsglen) &bslash;&n;&t;__cmsg32_nxthdr((ctl),(len),(cmsg),(cmsglen))
DECL|macro|CMSG32_NXTHDR
mdefine_line|#define CMSG32_NXTHDR(mhdr, cmsg, cmsglen) &bslash;&n;&t;cmsg32_nxthdr((mhdr), (cmsg), (cmsglen))

...
suffix:semicolon
multiline_comment|/* XXX: can this be done in a cleaner way ? */
id|load_TLS
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Copy from the boot cpu&squot;s GDT */
id|memcpy
c_func
(paren
id|cpu_gdt_table
...
r_static
r_void
DECL|function|ia32_boot_gdt_init
...
r_static
r_void
DECL|function|ia32_gate_page_init
id|ia32_gate_page_init
c_func
(paren
r_void
)paren

...
suffix:semicolon
DECL|typedef|debug_sprintf_entry_t
)brace
id|debug_sprintf_entry_t
suffix:semicolon
r_extern
r_void
id|tod_to_timeval
...
multiline_comment|/*&n; * debug_finish_entry:&n; * - set timestamp, caller address, cpu number etc.&n; */
DECL|function|debug_finish_entry
r_extern
r_inline
r_void
id|debug_finish_entry
c_func
(paren
id|debug_info_t
op_star
...
l_int|1
suffix:semicolon
DECL|macro|CTL_S390DBF
mdefine_line|#define CTL_S390DBF 5677
DECL|macro|CTL_S390DBF_STOPPABLE
mdefine_line|#define CTL_S390DBF_STOPPABLE 5678
DECL|macro|CTL_S390DBF_ACTIVE
mdefine_line|#define CTL_S390DBF_ACTIVE 5679
multiline_comment|/*&n; * proc handler for the running debug_active sysctl&n; * always allow read, allow write only if debug_stoppable is set or&n; * if debug_active is already off&n; */
DECL|function|s390dbf_procactive
r_static
r_int
id|s390dbf_procactive
c_func
(paren
id|ctl_table
op_star
...
id|ctl_name
op_assign
id|CTL_S390DBF_STOPPABLE
comma
dot
id|procname
op_assign
l_string|&quot;debug_stoppable&quot;
comma
dot
id|data
op_assign
...
id|ctl_name
op_assign
id|CTL_S390DBF_ACTIVE
comma
dot
id|procname
op_assign
l_string|&quot;debug_active&quot;
comma
dot
id|data
op_assign
...
suffix:semicolon
DECL|variable|s390dbf_dir_table
r_static
r_struct
id|ctl_table
id|s390dbf_dir_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|s390dbf_sysctl_header
r_struct
id|ctl_table_header
op_star
id|s390dbf_sysctl_header
suffix:semicolon
DECL|function|debug_stop_all
r_void
id|debug_stop_all
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;debug: create_proc_entry() failed! Cannot register view %s/%s&bslash;n&quot;
comma
id|id-&gt;name
comma
id|view-&gt;name

...
comma
l_string|&quot;task: %08x ksp: %08x pt_regs: %08x&bslash;n&quot;
comma
(paren
id|addr_t
)paren
...
multiline_comment|/*&n; * This should be safe even if called from tq_scheduler&n; * A typical mask would be sigmask(SIGKILL)|sigmask(SIGINT)|sigmask(SIGTERM) or 0.&n; *&n; */
DECL|function|s390_daemonize
r_void
id|s390_daemonize
c_func
(paren
...
suffix:semicolon
id|this_process-&gt;session
op_assign
l_int|1
suffix:semicolon
id|this_process-&gt;pgrp
op_assign
l_int|1
suffix:semicolon
r_if
...
l_int|0
suffix:semicolon
multiline_comment|/* set signal mask to what we want to respond */
id|siginitsetinv
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* exit_signal isn&squot;t set up */
multiline_comment|/* if we inherit from cpu idle  */
id|this_process-&gt;exit_signal
op_assign
id|SIGCHLD
suffix:semicolon
multiline_comment|/* if priority=0 schedule can go into a tight loop */
id|this_process-&gt;policy
op_assign
id|SCHED_OTHER
suffix:semicolon
multiline_comment|/* nice goes priority=20-nice; */
id|this_process-&gt;nice
op_assign
l_int|10
suffix:semicolon
r_if
...
suffix:semicolon
multiline_comment|/* We want init as our parent */
id|REMOVE_LINKS
c_func
(paren
id|this_process
...
suffix:semicolon
id|this_process-&gt;p_opptr
op_assign
id|this_process-&gt;p_pptr
op_assign
id|child_reaper
suffix:semicolon
id|SET_LINKS

...
multiline_comment|/*&n; *&t;Cycle through the processors sending sigp_restart to boot each.&n; */
...
c_func
(paren
l_string|&quot;smp_boot_cpus failed to &quot;
l_string|&quot;allocate prefix memory&bslash;n&quot;
)paren
suffix:semicolon
id|async_stack
op_assign
...
c_func
(paren
l_string|&quot;smp_boot_cpus failed to allocate &quot;
l_string|&quot;asyncronous interrupt stack&bslash;n&quot;
)paren
suffix:semicolon
id|memcpy
c_func
...
multiline_comment|/* if this gets troublesome I&squot;ll have to do&n;&t;&t;&t;&t; * something about it. */
id|printk
c_func
(paren

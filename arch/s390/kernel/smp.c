...
suffix:semicolon
multiline_comment|/*&n;&t; * Finally call reipl. Because we waited for all other&n;&t; * cpus to enter this function we know that they do&n;&t; * not hold any s390irq-locks (the cpus have been&n;&t; * interrupted by an external interrupt and s390irq&n;&t; * locks are always held disabled).&n;&t; */
r_if
c_cond
(paren
id|MACHINE_IS_VM

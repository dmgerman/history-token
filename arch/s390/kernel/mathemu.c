...
mdefine_line|#define mathemu_put_user(x, ptr) &bslash;&n;{                                &bslash;&n;&t;if(put_user((x),(ptr)))  &bslash;&n;&t;&t;return 1;        &bslash;&n;}
DECL|macro|mathemu_get_user
mdefine_line|#define mathemu_get_user(x, ptr) &bslash;&n;{                                &bslash;&n;&t;if(get_user((x),(ptr)))  &bslash;&n;&t;&t;return 1;        &bslash;&n;}
DECL|macro|mathemu_copy_from_user
mdefine_line|#define mathemu_copy_from_user(to,from,n)                 &bslash;&n;{                                                         &bslash;&n;&t;if(copy_from_user((to),(from),(n))==-EFAULT)      &bslash;&n;&t;&t;return 1;                                 &bslash;&n;}
DECL|macro|mathemu_copy_to_user
mdefine_line|#define mathemu_copy_to_user(to, from, n)                 &bslash;&n;{                                                         &bslash;&n;&t;if(copy_to_user((to),(from),(n))==-EFAULT)      &bslash;&n;&t;&t;return 1;                                 &bslash;&n;}
...
c_func
(paren
l_string|&quot;%s ieee fpu instruction not emulated process name: %s pid: %d &bslash;n&quot;
comma
id|instr
comma
id|current-&gt;comm
...
suffix:semicolon
multiline_comment|/* FIXME: how to react if mathemu_put_user fails ? */
id|mem
op_assign
(paren
id|__u32

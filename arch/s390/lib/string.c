...
suffix:semicolon
multiline_comment|/**&n; * bcopy - Copy one area of memory to another&n; * @src: Where to copy from&n; * @dest: Where to copy to&n; * @n: The size of the area.&n; *&n; * Note that this is the same as memcpy(), with the arguments reversed.&n; * memcpy() is the standard, bcopy() is a legacy BSD function.&n; */
DECL|function|bcopy
r_void
id|bcopy
c_func
...
suffix:semicolon
multiline_comment|/*&n; * missing exports for string functions defined in lib/string.c&n; */

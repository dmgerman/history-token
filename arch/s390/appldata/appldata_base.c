...
suffix:semicolon
DECL|struct|appldata_mod_vtimer_args
r_static
r_struct
...
id|expires
suffix:semicolon
DECL|variable|appldata_mod_vtimer_args
)brace
id|appldata_mod_vtimer_args
suffix:semicolon
...
c_func
(paren
l_string|&quot;CPU: %i, expire: %i&bslash;n&quot;
comma
id|smp_processor_id
c_func
(paren
...
DECL|function|appldata_mod_vtimer_wrap
r_static
r_void
...
(brace
id|appldata_mod_vtimer_args.timer
op_assign
op_amp
id|per_cpu
c_func
...
suffix:semicolon
id|appldata_mod_vtimer_args.expires
op_assign
id|per_cpu_interval
suffix:semicolon
id|smp_call_function_on

...
multiline_comment|/*&n; * Swap in a new request to external call queue &n; */
DECL|function|smp_add_ext_call
r_static
r_inline
r_void
id|smp_add_ext_call
...
id|info
suffix:semicolon
multiline_comment|/* swap in new request to external call queue */
id|smp_add_ext_call
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;stctg 0,15,%0&bslash;n&bslash;t&quot;

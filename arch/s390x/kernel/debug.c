...
DECL|macro|DEBUG_PROC_HEADER_SIZE
mdefine_line|#define DEBUG_PROC_HEADER_SIZE 46
macro_line|#else
DECL|macro|DEBUG_PROC_HEADER_SIZE
mdefine_line|#define DEBUG_PROC_HEADER_SIZE 38
macro_line|#endif
DECL|macro|ADD_BUFFER
mdefine_line|#define ADD_BUFFER 1000
...
id|len
suffix:semicolon
multiline_comment|/* length of output in byte */
DECL|member|size
r_int
id|size
suffix:semicolon
multiline_comment|/* size of buffer for output */
DECL|member|data
r_char
op_star
id|data
...
DECL|member|debug_info
id|debug_info_t
op_star
id|debug_info
suffix:semicolon
multiline_comment|/* the debug information struct */
DECL|member|view
r_struct
id|debug_view
op_star
...
multiline_comment|/*&n; * debug_output:&n; * - called for user read()&n; * - copies formated output form private_data of the file&n; *   handle to the user buffer&n; */
...
multiline_comment|/*&n; * debug_format_output:&n; * - calls prolog, header and format functions of view to format output&n; */
DECL|function|debug_format_output
r_static
r_int
id|debug_format_output
c_func
...
suffix:semicolon
multiline_comment|/* print debug records */
r_if
c_cond
(paren
op_logical_neg
...
id|PAGE_SIZE
op_div
id|debug_area-&gt;entry_size
op_lshift
id|debug_area-&gt;page_order
suffix:semicolon
r_for
c_loop
(paren
...
(paren
id|KERN_ERR
l_string|&quot;debug: error -- memory exceeded for (%s/%s)&bslash;n&quot;
comma
id|debug_area-&gt;name
comma
id|view-&gt;name
...
(paren
id|KERN_ERR
l_string|&quot;debug: fix view %s!!&bslash;n&quot;
comma
id|view-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;debug: area: %i (0 - %i) entry: %i (0 - %i)&bslash;n&quot;
comma
id|i
comma
id|debug_area-&gt;nr_areas
...
id|file-&gt;private_data
suffix:semicolon
multiline_comment|/*&n;&t; * the size for the formated output is calculated&n;&t; * with the following formula:&n;&t; *&n;&t; *   prolog-size&n;&t; *   +&n;&t; *   (record header size + record data field size)&n;&t; *   * number of entries per page&n;&t; *   * number of pages per area&n;&t; *   * number of areas&n;&t; */
r_if
c_cond
(paren
id|debug_info-&gt;views
...
id|PAGE_SIZE
op_div
id|debug_info-&gt;entry_size
op_lshift
id|debug_info-&gt;page_order
)paren
op_star
id|debug_info-&gt;nr_areas
op_plus
l_int|1
suffix:semicolon
multiline_comment|/* terminating &bslash;0 */
macro_line|#ifdef DEBUG
id|printk
c_func
(paren
l_string|&quot;debug_open: size: %i&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
macro_line|#endif
multiline_comment|/* alloc some bytes more to be safe against bad views */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;debug_open: vmalloc failed&bslash;n&quot;
)paren
suffix:semicolon
id|vfree
c_func
...
c_func
(paren
l_string|&quot;debug_open: len: %i&bslash;n&quot;
comma
id|ilen
)paren
suffix:semicolon
...
multiline_comment|/*&n; * debug_event:&n; */
...
multiline_comment|/*&n; * debug_int_event:&n; */
...
multiline_comment|/*&n; * debug_text_event:&n; */
...
multiline_comment|/*&n; * debug_exception:&n; */
...
multiline_comment|/*&n; * debug_int_exception:&n; */
...
multiline_comment|/*&n; * debug_text_exception:&n; */
...
id|out_buf
comma
l_string|&quot;%02i %011lu:%06lu %1s %02i %016lx  &quot;
comma
id|area
comma
id|time_val.tv_sec
...
id|out_buf
comma
l_string|&quot;%02i %011lu:%06lu %1s %02i %08lx  &quot;
comma
id|area
comma
id|time_val.tv_sec

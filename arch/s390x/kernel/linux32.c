...
suffix:semicolon
DECL|typedef|comp_dqblk_t
r_typedef
r_struct
id|v1c_mem_dqblk
id|comp_dqblk_t
suffix:semicolon
DECL|macro|Q_COMP_GETQUOTA
mdefine_line|#define Q_COMP_GETQUOTA Q_V1_GETQUOTA
DECL|macro|Q_COMP_SETQUOTA
mdefine_line|#define Q_COMP_SETQUOTA Q_V1_SETQUOTA
DECL|macro|Q_COMP_SETQLIM
mdefine_line|#define Q_COMP_SETQLIM Q_V1_SETQLIM
DECL|macro|Q_COMP_SETUSE
mdefine_line|#define Q_COMP_SETUSE Q_V1_SETUSE
macro_line|#else
DECL|struct|user_dqblk32
r_struct
id|user_dqblk32
...
suffix:semicolon
DECL|macro|Q_COMP_GETQUOTA
mdefine_line|#define Q_COMP_GETQUOTA Q_V2_GETQUOTA
DECL|macro|Q_COMP_SETQUOTA
mdefine_line|#define Q_COMP_SETQUOTA Q_V2_SETQUOTA
DECL|macro|Q_COMP_SETQLIM
mdefine_line|#define Q_COMP_SETQLIM Q_V2_SETQLIM
DECL|macro|Q_COMP_SETUSE
mdefine_line|#define Q_COMP_SETUSE Q_V2_SETUSE
macro_line|#endif
...
macro_line|#else
multiline_comment|/* No conversion needed for new interface */
DECL|function|sys32_quotactl
id|asmlinkage
r_int
id|sys32_quotactl

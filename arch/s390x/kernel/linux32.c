...
r_else
(brace
multiline_comment|/* If recvmsg processing itself placed some&n;&t;&t; * control messages into user space, it&squot;s is&n;&t;&t; * using 64-bit CMSG processing, so we need&n;&t;&t; * to fix it up before we tack on more stuff.&n;&t;&t; */
r_if
c_cond
(paren
(paren

...
DECL|macro|RLIM_OLD_INFINITY32
mdefine_line|#define RLIM_OLD_INFINITY32&t;0x7fffffff
DECL|macro|RLIM_INFINITY32
mdefine_line|#define RLIM_INFINITY32&t;&t;0xffffffff
DECL|macro|RESOURCE32_OLD
mdefine_line|#define RESOURCE32_OLD(x)&t;((x &gt; RLIM_OLD_INFINITY32) ? RLIM_OLD_INFINITY32 : x)
DECL|macro|RESOURCE32
mdefine_line|#define RESOURCE32(x) &t;&t;((x &gt; RLIM_INFINITY32) ? RLIM_INFINITY32 : x)
...
(brace
multiline_comment|/*&n;&t;&t;&t; * The timestamp type&squot;s data needs to be converted&n;&t;&t;&t; * from 64-bit time values to 32-bit time values&n;&t;&t;&t;*/
r_case
id|SO_TIMESTAMP
suffix:colon
(brace
...
(brace
multiline_comment|/* to get same error message as on 31 bit native */
id|err
op_assign
id|EOPNOTSUPP
suffix:semicolon
...
id|out_freectl
suffix:semicolon
singleline_comment|//&t;&t;msg_sys.msg_control = ctl_buf;
)brace
...
multiline_comment|/* If recvmsg processing itself placed some&n;&t; * control messages into user space, it&squot;s is&n;&t; * using 64-bit CMSG processing, so we need&n;&t; * to fix it up before we tack on more stuff.&n;&t; */
r_if
c_cond
(paren
(paren
...
l_int|NULL
op_logical_and
multiline_comment|/* in order to get same error message as on native 31 bit */
...
id|out_file
suffix:semicolon
multiline_comment|/* init_new_context is empty for s390x. */
id|bprm.argc
op_assign
id|count32
c_func
...
multiline_comment|/*&n;asmlinkage long sys_ni_syscall(void); &n;*/
...
id|pid
comma
multiline_comment|/* XXX Nice api... */
r_sizeof
(paren
id|kernel_mask
)paren

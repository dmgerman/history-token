multiline_comment|/*&n; *  linux/arch/s390x/kernel/semaphore.c&n; *&n; *  S390 version&n; *    Copyright (C) 1998-2000 IBM Corporation&n; *    Author(s): Martin Schwidefsky&n; *&n; *  Derived from &quot;linux/arch/i386/kernel/semaphore.c&n; *    Copyright (C) 1999, Linus Torvalds&n; *&n; */

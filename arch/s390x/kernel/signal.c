...
mdefine_line|#define SIGFRAME_COMMON &bslash;&n;__u8     callee_used_stack[__SIGNAL_FRAMESIZE]; &bslash;&n;struct sigcontext sc; &bslash;&n;_sigregs sregs; &bslash;&n;__u8 retcode[S390_SYSCALL_SIZE];
r_typedef
r_struct
(brace
id|SIGFRAME_COMMON

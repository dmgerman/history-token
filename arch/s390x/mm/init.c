...
id|totalram_pages
suffix:semicolon
multiline_comment|/*&n; * empty_bad_page is the page that is used for page faults when linux&n; * is out-of-memory. Older versions of linux just did a&n; * do_exit(), but using this instead means there is less risk&n; * for a process dying in kernel mode, possibly leaving an inode&n; * unused etc..&n; *&n; * empty_bad_pte_table is the accompanying page-table: it is initialized&n; * to point to BAD_PAGE entries.&n; *&n; * empty_bad_pmd_table is the accompanying segment table: it is initialized&n; * to point to empty_bad_pte_table page tables.&n; *&n; * ZERO_PAGE is a special page that is used for zero-initialized&n; * data and COW.&n; */
...
c_func
(paren
l_string|&quot;2M Segment 0x%016lX not available&bslash;n&quot;
comma
id|tmp
op_star
id|PAGE_SIZE

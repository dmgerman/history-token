...
(paren
id|KERN_ERR
l_string|&quot;Device &squot;%s&squot; read returned %d, shutting it &quot;
...
id|close
suffix:colon
id|device-&gt;user-&gt;close
comma
id|remove
suffix:colon
id|device-&gt;user-&gt;remove
comma
id|read
suffix:colon
id|device-&gt;kern-&gt;read
...
id|write
suffix:colon
id|device-&gt;kern-&gt;write
comma
id|add_address
suffix:colon
id|device-&gt;user-&gt;add_address
comma
id|delete_address
suffix:colon
id|device-&gt;user-&gt;delete_address
comma
id|set_mtu
suffix:colon
id|device-&gt;user-&gt;set_mtu
comma
id|user
suffix:colon
(brace
...
(paren
id|KERN_ERR
l_string|&quot;eth_setup: device %d out of range&bslash;n&quot;
comma
id|n
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ethertap_setup: expected &squot;,&squot; after &squot;%s&squot;&bslash;n&quot;
comma
id|type
)paren
suffix:semicolon

...
c_func
(paren
l_string|&quot;port_connection returned %d&bslash;n&quot;
comma
op_minus
id|fd
)paren
...
c_func
(paren
l_string|&quot;port_interrupt : failed to allocate connection&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_close
...
(paren
id|KERN_ERR
l_string|&quot;Failed to get IRQ for telnetd&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_free

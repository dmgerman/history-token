...
(brace
multiline_comment|/*__u64 can be a long on AMD64 and with %lu GCC complains; so&n;&t;&t; * the typecast.*/
id|printk
c_func
(paren
l_string|&quot;Size mismatch (%llu vs %llu) of COW header vs backing &quot;

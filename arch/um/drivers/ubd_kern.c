...
multiline_comment|/* number of bytes per sector */
...
mdefine_line|#define INIT_GENDISK(maj, name, parts, shift, blops) &bslash;&n;{ &bslash;&n;&t;major :&t;&t;maj, &bslash;&n;&t;major_name : &t;name, &bslash;&n;&t;minor_shift :&t;shift, &bslash;&n;&t;part : &t;&t;parts, &bslash;&n;&t;next : &t;&t;NULL, &bslash;&n;&t;fops : &t;&t;blops, &bslash;&n;&t;flags : &t;0 &bslash;&n;}
...
(paren
id|KERN_INFO
l_string|&quot;fakehd : Changing ubd_gendisk.major_name to &bslash;&quot;hd&bslash;&quot;.&bslash;n&quot;
)paren
suffix:semicolon
id|ubd_gendisk.major_name
op_assign
l_string|&quot;hd&quot;
suffix:semicolon
r_return
...
suffix:semicolon
multiline_comment|/* clear all old partition counts */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* If it already has been opened we can check the partitions &n;&t; * directly &n;&t; */
r_if
c_cond
(paren
id|dev-&gt;count
...
(paren
id|KERN_ERR
l_string|&quot;unable to open %s for validation&bslash;n&quot;
comma
id|dev-&gt;file
)paren
suffix:semicolon
...
multiline_comment|/* have to recompute sizes since we opened it */
id|err
op_assign
id|ubd_file_size
c_func
...
suffix:semicolon
multiline_comment|/* we are done so close it */
id|ubd_close
c_func
(paren
id|dev

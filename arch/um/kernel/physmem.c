...
macro_line|#include &quot;linux/ghash.h&quot;
...
macro_line|#endif
DECL|macro|PHYS_HASHSIZE
mdefine_line|#define PHYS_HASHSIZE (8192)
r_struct
id|phys_desc
suffix:semicolon
id|DEF_HASH_STRUCTS
...
suffix:semicolon
DECL|variable|virtmem_hash
r_struct
id|virtmem_table
id|virtmem_hash
suffix:semicolon
DECL|function|virt_cmp
r_static
r_int
id|virt_cmp
c_func

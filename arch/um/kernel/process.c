...
c_func
(paren
l_string|&quot;Checking advanced syscall emulation patch for ptrace...&quot;
)paren
suffix:semicolon
id|pid
op_assign
...
c_func
(paren
l_string|&quot;check_ptrace : expected (SIGTRAP|SYSCALL_TRAP), &quot;
l_string|&quot;got status = %d&quot;
comma
id|status
)paren
...
c_func
(paren
l_string|&quot;check_ptrace : SYSEMU_SINGLESTEP doesn&squot;t singlestep&quot;
)paren
suffix:semicolon
id|n
op_assign

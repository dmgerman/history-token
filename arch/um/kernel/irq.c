...
(brace
multiline_comment|/* &n;&t; * 0 return value means that this irq is already being&n;&t; * handled by some other CPU. (or is disabled)&n;&t; */
r_int
id|cpu
op_assign
id|smp_processor_id
...
(paren
id|KERN_ERR
l_string|&quot;Bad boy: %s (at 0x%x) called us &quot;
l_string|&quot;without a dev_id!&bslash;n&quot;
comma
id|devname
comma
(paren
...
suffix:semicolon
multiline_comment|/* These are read and written as longs, so a read won&squot;t see a partial write&n; * even during a race.&n; */
...
multiline_comment|/* Read and written as a long */
...
DECL|function|shutdown_SIGIO_irq
r_static
r_void
id|shutdown_SIGIO_irq
c_func
(paren
r_int
r_int
...
DECL|function|enable_SIGIO_irq
r_static
r_void
id|enable_SIGIO_irq
c_func
...
DECL|function|disable_SIGIO_irq
r_static
r_void
id|disable_SIGIO_irq
c_func
(paren
r_int
r_int
...
DECL|function|mask_and_ack_SIGIO
r_static
r_void
id|mask_and_ack_SIGIO
c_func
(paren
r_int
r_int
...
DECL|function|startup_SIGVTALRM_irq
r_static
r_int
r_int
id|startup_SIGVTALRM_irq
c_func
(paren
r_int
r_int
...
DECL|function|shutdown_SIGVTALRM_irq
r_static
r_void
id|shutdown_SIGVTALRM_irq
c_func
(paren
r_int
r_int
...
DECL|function|enable_SIGVTALRM_irq
r_static
r_void
id|enable_SIGVTALRM_irq
c_func
(paren
r_int
r_int
...
DECL|function|disable_SIGVTALRM_irq
r_static
r_void
id|disable_SIGVTALRM_irq
c_func
(paren
r_int
r_int
...
DECL|function|mask_and_ack_SIGVTALRM
r_static
r_void
id|mask_and_ack_SIGVTALRM
c_func
(paren
r_int
r_int
...
DECL|function|end_SIGVTALRM_irq
r_static
r_void
id|end_SIGVTALRM_irq
c_func
(paren
r_int
r_int

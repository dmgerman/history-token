multiline_comment|/*&n; * MIPS floating point support&n; *&n; * This program is free software; you can distribute it and/or modify it&n; * under the terms of the GNU General Public License (Version 2) as&n; * published by the Free Software Foundation.&n; *&n; * This program is distributed in the hope it will be useful, but WITHOUT&n; * ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or&n; * FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License&n; * for more details.&n; *&n; * You should have received a copy of the GNU General Public License along&n; * with this program; if not, write to the Free Software Foundation, Inc.,&n; * 59 Temple Place - Suite 330, Boston MA 02111-1307, USA.&n; *&n; * cp1emu.c: a MIPS coprocessor 1 (fpu) instruction emulator&n; * &n; * A complete emulator for MIPS coprocessor 1 instructions.  This is&n; * required for #float(switch) or #float(trap), where it catches all&n; * COP1 instructions via the &quot;CoProcessor Unusable&quot; exception.  &n; *&n; * More surprisingly it is also required for #float(ieee), to help out&n; * the hardware fpu at the boundaries of the IEEE-754 representation&n; * (denormalised values, infinities, underflow, etc).  It is made&n; * quite nasty because emulation of some non-COP1 instructions is&n; * required, e.g. in branch delay slots.&n; * &n; * Notes: &n; *  1) the IEEE754 library (-le) performs the actual arithmetic;&n; *  2) if you know that you won&squot;t have an fpu, then you&squot;ll get much &n; *     better performance by compiling with -msoft-float!&n; *&n; *  Nov 7, 2000&n; *  Massive changes to integrate with Linux kernel.&n; *&n; *  Replace use of kernel data area with use of user stack &n; *  for execution of instructions in branch delay slots.&n; *&n; *  Replace use of static kernel variables with thread_struct elements.&n; *&n; * Copyright (C) 1994-2000 Algorithmics Ltd.  All rights reserved.&n; * http://www.algor.co.uk&n; *&n; * Kevin D. Kissell, kevink@mips.com and Carsten Langgaard, carstenl@mips.com&n; * Copyright (C) 2000  MIPS Technologies, Inc.  All rights reserved.&n; */

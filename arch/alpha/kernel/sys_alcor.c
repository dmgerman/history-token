...
suffix:semicolon
multiline_comment|/*&n;&t; * Now we can look to see if we are really running on an XLT-type&n;&t; * motherboard, by looking for a 21040 TULIP in slot 6, which is&n;&t; * built into XLT and BRET/MAVERICK, but not available on ALCOR.&n;&t; */
id|dev
op_assign
id|pci_find_device
c_func
...
(brace
id|alpha_mv.sys.cia.gru_int_req_bits
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;%s: Detected AS500 or XLT motherboard.&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

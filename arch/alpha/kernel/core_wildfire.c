...
r_static
r_int
DECL|function|wildfire_read_config
id|wildfire_read_config
c_func
(paren
r_struct
id|pci_bus
...
r_static
r_int
DECL|function|wildfire_write_config
id|wildfire_write_config
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|wildfire_pa_to_nid
r_int
...
DECL|function|wildfire_cpuid_to_nid
r_int
...
(brace
multiline_comment|/* assume 4 CPUs per node */
r_return
id|cpuid
op_rshift
l_int|2
...
DECL|function|wildfire_node_mem_start
r_int
r_int
...
(brace
multiline_comment|/* 64GB per node */
r_return
(paren
r_int
r_int
...
DECL|function|wildfire_node_mem_size
r_int
r_int

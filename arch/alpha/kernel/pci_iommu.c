...
r_void
id|__init
DECL|function|iommu_arena_fixup
id|iommu_arena_fixup
c_func
(paren
r_struct
id|pci_iommu_arena
...
id|size
suffix:semicolon
multiline_comment|/*&n;&t; * The Cypress chip has a quirk, it get confused by addresses&n;&t; * above -1M so reserve the pagetables that maps pci addresses&n;&t; * above -1M.&n;&t; */
id|base
op_assign
id|arena-&gt;dma_base
suffix:semicolon

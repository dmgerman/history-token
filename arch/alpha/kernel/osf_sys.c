...
suffix:semicolon
multiline_comment|/* If any exceptions set by this call, and are unmasked,&n;&t;&t;   send a signal.  Old exceptions are not signaled.  */
id|fex
op_assign
(paren
id|exc
...
id|r.ru_minflt
op_assign
id|current-&gt;signal-&gt;cmin_flt
suffix:semicolon
id|r.ru_majflt
op_assign
id|current-&gt;signal-&gt;cmaj_flt
suffix:semicolon
r_break
suffix:semicolon
)brace
...
multiline_comment|/* Get an address range which is currently unmapped.  Similar to the&n;   generic version except that we know how to honor ADDR_LIMIT_32BIT.  */
r_static
r_int
r_int
DECL|function|arch_get_unmapped_area_1
id|arch_get_unmapped_area_1
c_func
(paren
r_int
r_int
...
id|limit
suffix:semicolon
multiline_comment|/* &quot;32 bit&quot; actually means 31 bit, since pointers sign extend.  */
r_if
c_cond
(paren
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* First, see if the given suggestion fits.&n;&n;&t;   The OSF/1 loader (/sbin/loader) relies on us returning an&n;&t;   address larger than the requested if one exists, which is&n;&t;   a terribly broken way to program.&n;&n;&t;   That said, I can see the use in being able to suggest not&n;&t;   merely specific addresses, but regions of memory -- perhaps&n;&t;   this feature should be incorporated into all ports?  */
r_if
c_cond
(paren
id|addr
...
multiline_comment|/* Next, try allocating at TASK_UNMAPPED_BASE.  */
id|addr
op_assign
id|arch_get_unmapped_area_1
(paren
...
id|addr
suffix:semicolon
multiline_comment|/* Finally, try allocating in low memory.  */
id|addr
op_assign
id|arch_get_unmapped_area_1
(paren

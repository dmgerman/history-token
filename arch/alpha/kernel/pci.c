...
multiline_comment|/*&n; * Another &quot;feature&quot;: Cypress bridge responds on the PCI bus&n; * in the address range 0xffff0000-0xffffffff (conventional&n; * x86 BIOS ROM). No way to turn this off, so if we use&n; * large SG window, we must avoid these addresses.&n; */
r_if
c_cond
(paren
id|dev

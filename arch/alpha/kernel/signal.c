...
r_int
r_int
DECL|function|do_osf_sigprocmask
id|do_osf_sigprocmask
c_func
(paren
r_int
id|how
...
macro_line|# error &quot;Non SA_SIGINFO frame needs rearranging&quot;
macro_line|#endif
...
multiline_comment|/* Note that this syscall is also used by setcontext(3) to install&n;   a given sigcontext.  This because it&squot;s impossible to set *all*&n;   registers and transfer control from userland.  */
id|asmlinkage
r_void
...
id|set
suffix:semicolon
multiline_comment|/* Verify that it&squot;s a good ucontext_t before using it */
r_if
c_cond
(paren
id|verify_area
...
id|ERESTART_RESTARTBLOCK
suffix:colon
multiline_comment|/* Force v0 to the restart syscall and reply.  */
id|regs-&gt;r0
op_assign

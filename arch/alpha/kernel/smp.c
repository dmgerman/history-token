...
multiline_comment|/* Data for IPI_MIGRATION.  */
DECL|variable|migration_task
r_static
id|task_t
op_star
id|migration_task
...
(paren
id|KERN_WARNING
l_string|&quot;smp_migrate_task: Sending IPI to self.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
multiline_comment|/* Acquire the migration_task mutex.  */
id|pointer_lock
c_func
(paren
op_amp

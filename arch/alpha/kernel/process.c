...
multiline_comment|/* Set a new TLS for the child thread?  Peek back into the&n;&t;   syscall arguments that we saved on syscall entry.  Oops,&n;&t;   except we&squot;d have clobbered it with the parent/child set&n;&t;   of r20.  Read the saved copy.  */
...
multiline_comment|/*&n; * Fill in the user structure for an ECOFF core dump.&n; */
r_void
...
multiline_comment|/*&n; * Fill in the user structure for a ELF core dump.&n; */
r_void
DECL|function|dump_elf_thread
id|dump_elf_thread
c_func
(paren
id|elf_greg_t
...
id|pt-&gt;pc
suffix:semicolon
multiline_comment|/* Once upon a time this was the PS value.  Which is stupid&n;&t;   since that is always 8 for usermode.  Usurped for the more&n;&t;   useful value of the thread&squot;s UNIQUE field.  */
id|dest
(braket
l_int|32
)braket
...
r_int
DECL|function|dump_elf_task_fp
id|dump_elf_task_fp
c_func
(paren
id|elf_fpreg_t

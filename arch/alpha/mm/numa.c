...
suffix:semicolon
multiline_comment|/* find the bounds of this node (node_min_pfn/node_max_pfn) */
id|node_min_pfn
op_assign
op_complement
l_int|0UL
...
c_func
(paren
l_string|&quot;Initializing bootmem allocator on Node ID %d&bslash;n&quot;
comma
id|nid
)paren
suffix:semicolon
...
r_return
suffix:semicolon
multiline_comment|/* Update global {min,max}_low_pfn from node information. */
r_if
c_cond
(paren
id|node_min_pfn
...
id|node_min_pfn
suffix:semicolon
macro_line|#if 0 /* we&squot;ll try this one again in a little while */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Quasi-mark the pg_data_t as in-use */
id|node_min_pfn
op_add_assign
id|node_datasz
suffix:semicolon
...
c_func
(paren
l_string|&quot; not enough mem to reserve NODE_DATA&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot; DISCONTIG: node_data[%d]   is at 0x%p&bslash;n&quot;
comma
id|nid
comma
id|NODE_DATA

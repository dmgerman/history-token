multiline_comment|/* $Id: cache-sh4.c,v 1.24 2003/10/12 19:40:12 lethal Exp $&n; *&n; *  linux/arch/sh/mm/cache-sh4.c&n; *&n; * Copyright (C) 1999, 2000, 2002  Niibe Yutaka&n; * Copyright (C) 2001, 2002, 2003  Paul Mundt&n; */
...
id|CPU_SH7750S
suffix:semicolon
multiline_comment|/* &n;&t;&t; * FIXME: This is needed for 7750, but do we need it for the&n;&t;&t; * 7750S and 7750R too? For now, assume we do.. -- PFM&n;&t;&t; */
id|set_bit
c_func
(paren
id|CPU_HAS_P2_FLUSH_BUG
...
l_int|0x700
suffix:colon
multiline_comment|/* XXX: Add proper CVR probing */
id|cpu_data-&gt;type
op_assign
id|CPU_SH4_501
suffix:semicolon

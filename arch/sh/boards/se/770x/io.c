multiline_comment|/* $Id: io.c,v 1.1.2.2 2002/01/20 05:03:25 mrbrown Exp $&n; *&n; * linux/arch/sh/kernel/io_se.c&n; *&n; * Copyright (C) 2000  Kazumoto Kojima&n; *&n; * I/O routine for Hitachi SolutionEngine.&n; *&n; */

...
multiline_comment|/*&n;    * Set the MBR so PCI address is one-to-one with window,&n;    * meaning all calls go straight through... use BUG_ON to&n;    * catch erroneous assumption.&n;    */
id|BUG_ON
c_func
(paren
id|PCIBIOS_MIN_MEM

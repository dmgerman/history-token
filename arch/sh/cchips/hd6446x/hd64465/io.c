multiline_comment|/*&n; * $Id: io.c,v 1.1.2.2 2002/01/20 05:03:25 mrbrown Exp $&n; * by Greg Banks &lt;gbanks@pocketpenguins.com&gt;&n; * (c) 2000 PocketPenguins Inc&n; *&n; * Derived from io_hd64461.c, which bore the message:&n; * Copyright (C) 2000 YAEGASHI Takeshi&n; *&n; * Typical I/O routines for HD64465 system.&n; */

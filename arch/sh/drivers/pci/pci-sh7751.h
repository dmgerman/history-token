multiline_comment|/*&n; *&t;Low-Level PCI Support for SH7751 targets&n; *&n; *  Dustin McIntire (dustin@sensoria.com) (c) 2001&n; *  Paul Mundt (lethal@linux-sh.org) (c) 2003&n; *&t;&n; *  May be copied or modified under the terms of the GNU General Public&n; *  License.  See linux/COPYING for more information.&n; *&n; */
...
DECL|macro|SH7751R_DEVICE_ID
mdefine_line|#define SH7751R_DEVICE_ID            0x350e
...
suffix:semicolon
DECL|struct|sh7751_pci_address_space
r_struct
...
suffix:semicolon
DECL|struct|sh7751_pci_address_map
r_struct
...
suffix:semicolon
multiline_comment|/* arch/sh/drivers/pci/pci-sh7751.c */
r_extern
r_int
id|sh7751_pcic_init
c_func

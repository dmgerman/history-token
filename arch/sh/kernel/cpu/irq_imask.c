multiline_comment|/* $Id: irq_imask.c,v 1.1.2.1 2002/11/17 10:53:43 mrbrown Exp $&n; *&n; * linux/arch/sh/kernel/irq_imask.c&n; *&n; * Copyright (C) 1999, 2000  Niibe Yutaka&n; *&n; * Simple interrupt handling using IMASK of SR register.&n; *&n; */

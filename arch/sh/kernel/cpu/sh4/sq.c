multiline_comment|/*&n; * arch/sh/kernel/cpu/sq.c&n; *&n; * General management API for SH-4 integrated Store Queues&n; *&n; * Copyright (C) 2001, 2002, 2003  Paul Mundt&n; * Copyright (C) 2001, 2002  M. R. Brown&n; *&n; * Some of this code has been adopted directly from the old arch/sh/mm/sq.c&n; * hack that was part of the LinuxDC project. For all intensive purposes, this&n; * is a completely new interface that really doesn&squot;t have much in common with&n; * the old zone-based approach at all. Infact, I&squot;m only listing it here for&n; * general completeness.&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; */
...
(brace
multiline_comment|/*&n;&t; * First check the MMU status..&n;&t; */

...
multiline_comment|/*&n; * Changed to only care about tv_sec, and not the full timespec struct&n; * (i.e. tv_nsec).  It can easily be switched to timespec for future cpus&n; * that support setting usec or nsec RTC values.&n; */

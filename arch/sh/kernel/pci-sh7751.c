...
macro_line|#endif
multiline_comment|/*&n; * BIOS32 and PCI BIOS handling.&n; * &n; * The BIOS version of the pci functions is not yet implemented but it is left&n; * in for completeness.  Currently an error will be genereated at compile time. &n; */
...
l_int|3
comma
l_string|&quot;PCI: Update IRQ for %s on irq %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|irq

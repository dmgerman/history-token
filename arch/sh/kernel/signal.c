...
DECL|macro|MOVW
mdefine_line|#define MOVW(n)&t; (0x9300|((n)-2))&t;/* Move mem word at PC+n to R3 */
DECL|macro|TRAP16
mdefine_line|#define TRAP16&t; 0xc310&t;&t;&t;/* Syscall w/no args (NR in R3) */
DECL|macro|OR_R0_R0
mdefine_line|#define OR_R0_R0 0x200b&t;&t;&t;/* or r0,r0 (insert to avoid hardware bug) */
...
r_else
(brace
multiline_comment|/* Generate return code (system call to sigreturn) */
id|err
op_or_assign
id|__put_user
c_func
...
r_else
(brace
multiline_comment|/* Generate return code (system call to rt_sigreturn) */
id|err
op_or_assign
id|__put_user
c_func

multiline_comment|/* $Id: setup.c,v 1.17 2003/05/20 01:51:37 lethal Exp $&n; *&n; *  linux/arch/sh/kernel/setup.c&n; *&n; *  Copyright (C) 1999  Niibe Yutaka&n; *  Copyright (C) 2002, 2003  Paul Mundt&n; */
...
id|m
comma
l_string|&quot;cache size&bslash;t: %dK-bytes&quot;
comma
id|icachesz
op_rshift
l_int|10
...
suffix:semicolon
multiline_comment|/*&n;&t; * SH-2 and SH-3 have a combined cache, thus there&squot;s no real&n;&t; * I/D distinction ..  so don&squot;t inadvertently double&n;&t; * up the output.&n;&t; */
r_if
c_cond
(paren
id|strcmp

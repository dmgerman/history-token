multiline_comment|/*!**************************************************************************&n;*!&n;*! FILE NAME  : kgdb.c&n;*!&n;*! DESCRIPTION: Implementation of the gdb stub with respect to ETRAX 100.&n;*!              It is a mix of arch/m68k/kernel/kgdb.c and cris_stub.c.&n;*!&n;*!---------------------------------------------------------------------------&n;*! HISTORY&n;*!&n;*! DATE         NAME            CHANGES&n;*! ----         ----            -------&n;*! Apr 26 1999  Hendrik Ruijter Initial version.&n;*! May  6 1999  Hendrik Ruijter Removed call to strlen in libc and removed&n;*!                              struct assignment as it generates calls to&n;*!                              memcpy in libc.&n;*! Jun 17 1999  Hendrik Ruijter Added gdb 4.18 support. &squot;X&squot;, &squot;qC&squot; and &squot;qL&squot;.&n;*! Jul 21 1999  Bjorn Wesen     eLinux port&n;*!&n;*! $Log: kgdb.c,v $&n;*! Revision 1.2  2001/01/12 14:22:25  orjanf&n;*! Updated kernel debugging support to work with ETRAX 100LX.&n;*!&n;*! Revision 1.1  2000/07/10 16:25:21  bjornw&n;*! Initial revision&n;*!&n;*! Revision 1.1.1.1  1999/12/03 14:57:31  bjornw&n;*! * Initial version of arch/cris, the latest CRIS architecture with an MMU.&n;*!   Mostly copied from arch/etrax100 with appropriate renames of files.&n;*!   The mm/ subdir is copied from arch/i386.&n;*!   This does not compile yet at all.&n;*!&n;*!&n;*! Revision 1.4  1999/07/22 17:25:25  bjornw&n;*! Dont wait for + in putpacket if we havent hit the initial breakpoint yet. Added a kgdb_init function which sets up the break and irq vectors.&n;*!&n;*! Revision 1.3  1999/07/21 19:51:18  bjornw&n;*! Check if the interrupting char is a ctrl-C, ignore otherwise.&n;*!&n;*! Revision 1.2  1999/07/21 18:09:39  bjornw&n;*! Ported to eLinux architecture, and added some kgdb documentation.&n;*!&n;*!&n;*!---------------------------------------------------------------------------&n;*!&n;*! $Id: kgdb.c,v 1.2 2001/01/12 14:22:25 orjanf Exp $&n;*!&n;*! (C) Copyright 1999, Axis Communications AB, LUND, SWEDEN&n;*!&n;*!**************************************************************************/

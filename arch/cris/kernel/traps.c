multiline_comment|/* $Id: traps.c,v 1.3 2000/10/04 16:50:06 bjornw Exp $&n; *&n; *  linux/arch/cris/traps.c&n; *&n; *  Etrax100 does not have any hardware traps, only IRQ&squot;s, which we setup&n; *  in irq.c instead. Here we just define the die_if_kernel Oops&squot;er.&n; *&n; *  Copyright (C) 2000 Axis Communications AB&n; *&n; *  Authors:   Bjorn Wesen&n; *&n; */

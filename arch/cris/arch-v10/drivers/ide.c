multiline_comment|/* $Id: ide.c,v 1.1 2004/01/22 08:22:58 starvik Exp $&n; *&n; * Etrax specific IDE functions, like init and PIO-mode setting etc.&n; * Almost the entire ide.c is used for the rest of the Etrax ATA driver.&n; * Copyright (c) 2000-2004 Axis Communications AB&n; *&n; * Authors:    Bjorn Wesen        (initial version)&n; *             Mikael Starvik     (pio setup stuff, Linux 2.6 port)&n; */
...
DECL|function|e100_dma_verbose
r_static
r_int
id|e100_dma_verbose
(paren
...
(brace
multiline_comment|/* begin DMA, used by ATAPI devices which want to issue the&n;&t; * appropriate IDE command themselves.&n;&t; *&n;&t; * they have already called ide_dma_read/write to set the&n;&t; * static reading flag, now they call ide_dma_begin to do&n;&t; * the real stuff. we tell our code below not to issue&n;&t; * any IDE commands itself and jump into it.&n;&t; */
r_return
id|e100_start_dma
c_func
(paren

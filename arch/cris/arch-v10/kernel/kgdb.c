multiline_comment|/*!**************************************************************************&n;*!&n;*! FILE NAME  : kgdb.c&n;*!&n;*! DESCRIPTION: Implementation of the gdb stub with respect to ETRAX 100.&n;*!              It is a mix of arch/m68k/kernel/kgdb.c and cris_stub.c.&n;*!&n;*!---------------------------------------------------------------------------&n;*! HISTORY&n;*!&n;*! DATE         NAME            CHANGES&n;*! ----         ----            -------&n;*! Apr 26 1999  Hendrik Ruijter Initial version.&n;*! May  6 1999  Hendrik Ruijter Removed call to strlen in libc and removed&n;*!                              struct assignment as it generates calls to&n;*!                              memcpy in libc.&n;*! Jun 17 1999  Hendrik Ruijter Added gdb 4.18 support. &squot;X&squot;, &squot;qC&squot; and &squot;qL&squot;.&n;*! Jul 21 1999  Bjorn Wesen     eLinux port&n;*!&n;*! $Log: kgdb.c,v $&n;*! Revision 1.5  2004/10/07 13:59:08  starvik&n;*! Corrected call to set_int_vector&n;*!&n;*! Revision 1.4  2003/04/09 05:20:44  starvik&n;*! Merge of Linux 2.5.67&n;*!&n;*! Revision 1.3  2003/01/21 19:11:08  starvik&n;*! Modified include path for new dir layout&n;*!&n;*! Revision 1.2  2002/11/19 14:35:24  starvik&n;*! Changes from linux 2.4&n;*! Changed struct initializer syntax to the currently prefered notation&n;*!&n;*! Revision 1.1  2001/12/17 13:59:27  bjornw&n;*! Initial revision&n;*!&n;*! Revision 1.6  2001/10/09 13:10:03  matsfg&n;*! Added $ on registers and removed some underscores&n;*!&n;*! Revision 1.5  2001/04/17 13:58:39  orjanf&n;*! * Renamed CONFIG_KGDB to CONFIG_ETRAX_KGDB.&n;*!&n;*! Revision 1.4  2001/02/23 13:45:19  bjornw&n;*! config.h check&n;*!&n;*! Revision 1.3  2001/01/31 18:08:23  orjanf&n;*! Removed kgdb_handle_breakpoint from being the break 8 handler.&n;*!&n;*! Revision 1.2  2001/01/12 14:22:25  orjanf&n;*! Updated kernel debugging support to work with ETRAX 100LX.&n;*!&n;*! Revision 1.1  2000/07/10 16:25:21  bjornw&n;*! Initial revision&n;*!&n;*! Revision 1.1.1.1  1999/12/03 14:57:31  bjornw&n;*! * Initial version of arch/cris, the latest CRIS architecture with an MMU.&n;*!   Mostly copied from arch/etrax100 with appropriate renames of files.&n;*!   The mm/ subdir is copied from arch/i386.&n;*!   This does not compile yet at all.&n;*!&n;*!&n;*! Revision 1.4  1999/07/22 17:25:25  bjornw&n;*! Dont wait for + in putpacket if we havent hit the initial breakpoint yet. Added a kgdb_init function which sets up the break and irq vectors.&n;*!&n;*! Revision 1.3  1999/07/21 19:51:18  bjornw&n;*! Check if the interrupting char is a ctrl-C, ignore otherwise.&n;*!&n;*! Revision 1.2  1999/07/21 18:09:39  bjornw&n;*! Ported to eLinux architecture, and added some kgdb documentation.&n;*!&n;*!&n;*!---------------------------------------------------------------------------&n;*!&n;*! $Id: kgdb.c,v 1.5 2004/10/07 13:59:08 starvik Exp $&n;*!&n;*! (C) Copyright 1999, Axis Communications AB, LUND, SWEDEN&n;*!&n;*!**************************************************************************/

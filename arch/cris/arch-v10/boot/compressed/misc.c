multiline_comment|/*&n; * misc.c&n; *&n; * $Id: misc.c,v 1.6 2003/10/27 08:04:31 starvik Exp $&n; * &n; * This is a collection of several routines from gzip-1.0.3 &n; * adapted for Linux.&n; *&n; * malloc by Hannu Savolainen 1993 and Matthias Urlichs 1994&n; * puts by Nick Holloway 1993, better puts by Martin Mares 1995&n; * adoptation for Linux/CRIS Axis Communications AB, 1999&n; * &n; */
multiline_comment|/* where the piggybacked kernel image expects itself to live.&n; * it is the same address we use when we network load an uncompressed&n; * image into DRAM, and it is the address the kernel is linked to live&n; * at by vmlinux.lds.S&n; */
...
c_func
(paren
l_string|&quot;You need an ETRAX 100LX to run linux 2.6&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop

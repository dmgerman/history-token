multiline_comment|/*&n; * arch/cris/mm/ioremap.c&n; *&n; * Re-map IO memory to kernel address space so that we can access it.&n; * Needed for memory-mapped I/O devices mapped outside our normal DRAM&n; * window (that is, all memory-mapped I/O devices).&n; *&n; * (C) Copyright 1995 1996 Linus Torvalds&n; * CRIS-port by Axis Communications AB&n; */
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* TODO: Here we can put checks for driver-writer abuse...  */

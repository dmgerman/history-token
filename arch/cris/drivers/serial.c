...
DECL|macro|SERIAL_RECV_SIZE
mdefine_line|#define SERIAL_RECV_SIZE      4096
DECL|macro|SERIAL_DESCR_BUF_SIZE
mdefine_line|#define SERIAL_DESCR_BUF_SIZE 512
...
suffix:semicolon
macro_line|#if defined(CONFIG_ETRAX_RS485) &amp;&amp; defined(CONFIG_ETRAX_RS485_ON_PA)
...
r_static
r_int
DECL|function|add_char_and_flag
...
(paren
id|__FUNCTION__
l_string|&quot;: Buffer overflow! %d byte(s) did not fit.&bslash;n&quot;
comma
id|recvl
op_minus
id|length
...
r_int
r_int
DECL|function|copy_all_descr_data
id|copy_all_descr_data
c_func
(paren
r_struct
id|e100_serial
...
id|_INLINE_
r_int
DECL|function|force_eop_if_needed
...
id|_INLINE_
r_void
DECL|function|flush_to_flip_buffer
...
suffix:semicolon
macro_line|#if LINUX_VERSION_CODE &gt; KERNEL_VERSION(2,1,66)
...
suffix:semicolon
multiline_comment|/* Report as BREAK (error) and let&n;&t;&t;&t;&t; * receive_chars() handle it&n;&t;&t;&t;&t; */
id|info-&gt;errorcode
op_assign
id|ERRCODE_SET_BREAK
suffix:semicolon
...
id|info-&gt;line
comma
l_string|&quot;ser_int OK %d&bslash;n&quot;
comma
id|info-&gt;line
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;starting up ttyS%d (xmit_buf 0x%p, recv_buf 0x%p)...&bslash;n&quot;
comma
id|info-&gt;line
comma
id|info-&gt;xmit.buf
...
id|tty-&gt;driver_data
suffix:semicolon
macro_line|#if defined(CONFIG_ETRAX_RS485) || (LINUX_VERSION_CODE &lt; 131394) /* Linux 2.1.66 */
r_int
id|error
suffix:semicolon
macro_line|#endif

...
DECL|macro|MDIO_BC_NEGOTIATE
mdefine_line|#define MDIO_BC_NEGOTIATE                0x0200
DECL|macro|MDIO_BC_FULL_DUPLEX_MASK
mdefine_line|#define MDIO_BC_FULL_DUPLEX_MASK         0x0100
DECL|macro|MDIO_BC_AUTO_NEG_MASK
mdefine_line|#define MDIO_BC_AUTO_NEG_MASK            0x1000
DECL|macro|MDIO_BC_SPEED_SELECT_MASK
mdefine_line|#define MDIO_BC_SPEED_SELECT_MASK        0x2000
DECL|macro|MDIO_ADVERTISMENT_REG
mdefine_line|#define MDIO_ADVERTISMENT_REG               0x4
DECL|macro|MDIO_ADVERT_100_FD
mdefine_line|#define MDIO_ADVERT_100_FD                0x100
DECL|macro|MDIO_ADVERT_100_HD
mdefine_line|#define MDIO_ADVERT_100_HD                0x080
DECL|macro|MDIO_ADVERT_10_FD
mdefine_line|#define MDIO_ADVERT_10_FD                 0x040
DECL|macro|MDIO_ADVERT_10_HD
mdefine_line|#define MDIO_ADVERT_10_HD                 0x020
...
DECL|macro|MDIO_FULL_DUPLEX_IND
mdefine_line|#define MDIO_FULL_DUPLEX_IND                0x1
...
mdefine_line|#define NBR_OF_RX_DESC     (RX_BUF_SIZE / &bslash;&n;                            RX_DESC_BUF_SIZE)
DECL|macro|GET_BIT
...
op_complement
(paren
id|MDIO_ADVERT_100_HD
op_or
id|MDIO_ADVERT_100_FD
op_or
id|MDIO_ADVERT_10_FD
op_or
id|MDIO_ADVERT_10_HD
)paren
suffix:semicolon
r_switch
c_cond
...
(brace
multiline_comment|/* Duplex changed to full? */
id|full_duplex
op_assign
l_int|1
suffix:semicolon
...
(brace
multiline_comment|/* Duplex changed to half? */
id|full_duplex
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/* Maybe default should return -EINVAL instead? */
r_switch
c_cond
(paren
id|cmd
...
suffix:colon
multiline_comment|/* Hhalf duplex. */
id|e100_set_duplex
c_func
(paren
id|half

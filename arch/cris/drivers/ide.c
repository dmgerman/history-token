...
id|ata_tot_size
suffix:semicolon
multiline_comment|/*&n; * This prepares a dma request.  Returns 0 if all went okay, returns 1&n; * otherwise.&n; */
DECL|function|e100_udma_new_table
r_static
r_int
id|e100_udma_new_table
c_func
(paren
r_struct
id|ata_channel

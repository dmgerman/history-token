...
c_func
(paren
l_string|&quot;ide: waiting 10 seconds for drives to regain consciousness&bslash;n&quot;
)paren
suffix:semicolon
id|h
op_assign
...
multiline_comment|/*&n; * The multiplexor for ide_xxxput_data and atapi calls&n; */
r_static
r_void
DECL|function|e100_ideproc
id|e100_ideproc
(paren
id|ide_ide_action_t
id|func
...
c_func
(paren
l_string|&quot;e100_ideproc: unsupported func %d!&bslash;n&quot;
comma
id|func
)paren
suffix:semicolon
...
multiline_comment|/* uh.. I&squot;m lazy.. if size &gt;= 65536, it should loop below and split it in&n;&t;&t;   more than one descriptor */
r_if
c_cond
(paren
id|size
...
c_func
(paren
l_string|&quot;too large ATA DMA request block, size = %d!&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon

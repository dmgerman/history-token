multiline_comment|/*&n; * Example showing how to pin down a range of virtual pages from user-space&n; * to be able to do for example DMA directly into them.&n; *&n; * It is necessary because the pages the virtual pointers reference, might&n; * not exist in memory (could be mapped to the zero-page, filemapped etc)&n; * and DMA cannot trigger the MMU to force them in (and would have time &n; * contraints making it impossible to wait for it anyway).&n; *&n; * Author:  Bjorn Wesen&n; *&n; * $Log: kiobuftest.c,v $&n; * Revision 1.1.1.1  2001/12/17 13:59:27  bjornw&n; * Import of Linux 2.5.1&n; *&n; * Revision 1.2  2001/02/27 13:52:50  bjornw&n; * malloc.h -&gt; slab.h&n; *&n; * Revision 1.1  2001/01/19 15:57:49  bjornw&n; * Example of how to do direct HW -&gt; user-mode DMA&n; *&n; *&n; */

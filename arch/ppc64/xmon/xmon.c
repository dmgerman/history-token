...
(brace
multiline_comment|/* unsigned long free = 0;  --Unused */
r_int
id|state
suffix:semicolon
r_static
...
c_func
(paren
l_string|&quot;%-11.11s pid: %5.5lx ppid: %5.5lx state: &quot;
comma
id|p-&gt;comm
comma
id|p-&gt;pid
...
c_func
(paren
l_string|&quot;            thread : 0x%16.16lx  ksp   : 0x%16.16lx&bslash;n&quot;
comma
op_amp
(paren
id|p-&gt;thread
...
c_func
(paren
l_string|&quot;            pgdir : 0x%16.16lx&bslash;n&quot;
comma
(paren
id|p-&gt;thread.pgdir
)paren
...
c_func
(paren
l_string|&quot;            regs   : 0x%16.16lx  sysc  : 0x%16.16lx&bslash;n&quot;
comma
(paren
id|p-&gt;thread.regs
)paren
...
c_func
(paren
l_string|&quot;            nip    : 0x%16.16lx  msr   : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            ctr    : 0x%16.16lx  link  : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            xer    : 0x%16.16lx  ccr   : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            trap   : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            dar    : 0x%16.16lx  dsis  : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            rslt   : 0x%16.16lx  org3  : 0x%16.16lx&bslash;n&quot;
comma
(paren
(paren
id|p-&gt;thread.regs
...
c_func
(paren
l_string|&quot;            mm     : 0x%16.16lx  pgd   : 0x%16.16lx&bslash;n&quot;
comma
id|mm
comma
id|mm-&gt;pgd
...
c_func
(paren
l_string|&quot;            context: 0x%16.16lx  mmap  : 0x%16.16lx&bslash;n&quot;
comma
id|mm-&gt;context
comma
id|mm-&gt;mmap
...
c_func
(paren
l_string|&quot;task name   st PC              stack   pid father child younger older&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#else
id|printf

...
id|PPC_OPCODE_PPC
op_or
id|PPC_OPCODE_CLASSIC
op_or
id|PPC_OPCODE_COMMON
op_or
id|PPC_OPCODE_64
op_or
id|PPC_OPCODE_POWER4
op_or
id|PPC_OPCODE_ALTIVEC
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* Make two passes over the operands.  First see if any of them&n;&t; have extraction functions, and, if they do, make sure the&n;&t; instruction is valid.  */
id|invalid
op_assign
l_int|0
suffix:semicolon
...
id|opindex
suffix:semicolon
multiline_comment|/* Operands that are marked FAKE are simply ignored.  We&n;&t;     already made sure that the extract function considered&n;&t;     the instruction to be valid.  */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* If the operand is optional, and the value is zero, don&squot;t&n;&t;     print anything.  */
r_if
c_cond
(paren
(paren

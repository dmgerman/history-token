...
multiline_comment|/* Return whether the region described by v_addr and size is a subset&n; * of the region described by parent&n; */
...
multiline_comment|/* Return whether the region described by v_addr and size is a superset&n; * of the region described by child&n; */
DECL|function|im_region_is_superset
r_static
r_int
id|im_region_is_superset
c_func
(paren
r_int
r_int
...
multiline_comment|/* Return whether the region described by v_addr and size overlaps&n; * the region described by vm.  Overlapping regions meet the&n; * following conditions:&n; * 1) The regions share some part of the address space&n; * 2) The regions aren&squot;t identical&n; * 3) Neither region is a subset of the other&n; */
...
(brace
multiline_comment|/* Return with tmp pointing to superset */
r_return
id|IM_REGION_SUBSET
suffix:semicolon
)brace
...
(brace
multiline_comment|/* Return with tmp pointing to first subset */
r_return
...
(brace
multiline_comment|/* Return with tmp pointing to exact region */
r_return
id|IM_REGION_EXISTS
suffix:semicolon
)brace
...
id|IM_REGION_EXISTS
suffix:colon
multiline_comment|/* Return requested region */
r_break
suffix:semicolon
r_case
id|IM_REGION_SUPERSET
suffix:colon
multiline_comment|/* Return first existing subset of requested region */
r_break
suffix:semicolon
r_default
suffix:colon

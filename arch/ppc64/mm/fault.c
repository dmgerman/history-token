...
id|PPCDBG_MM
comma
l_string|&quot;Entering do_page_fault: addr = 0x%16.16lx, error_code = %lx&bslash;n&bslash;tregs_trap = %lx, srr0 = %lx, srr1 = %lx&bslash;n&quot;
comma
id|address
comma
id|error_code
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: vma = 0x%16.16lx&bslash;n&quot;
comma
id|vma
)paren
suffix:semicolon
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: !vma&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|bad_area
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: vma-&gt;vm_start = 0x%16.16lx, vma-&gt;vm_flags = 0x%16.16lx&bslash;n&quot;
comma
id|vma-&gt;vm_start
comma
id|vma-&gt;vm_flags
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: vma-&gt;vm_flags = %lx, %lx&bslash;n&quot;
comma
id|vma-&gt;vm_flags
comma
id|VM_GROWSDOWN
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: expand_stack&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|bad_area
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: calling handle_mm_fault&bslash;n&quot;
)paren
suffix:semicolon
id|mm_fault_return
op_assign
...
id|PPCDBG_MM
comma
l_string|&quot;&bslash;tdo_page_fault: handle_mm_fault = 0x%lx&bslash;n&quot;
comma
id|mm_fault_return
)paren
suffix:semicolon
...
id|PPCDBG_SIGNAL
comma
l_string|&quot;Bad addr in user: 0x%lx&bslash;n&quot;
comma
id|address
)paren
suffix:semicolon

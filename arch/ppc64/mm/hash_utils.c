...
multiline_comment|/*&n;&t; * If we have a memory_limit and we&squot;ve allocated TCEs then we need to&n;&t; * explicitly map the TCE area at the top of RAM. We also cope with the&n;&t; * case that the TCEs start below memory_limit.&n;&t; * tce_alloc_start/end are 16MB aligned so the mapping should work&n;&t; * for either 4K or 16MB pages.&n;&t; */
r_if
c_cond
(paren
id|tce_alloc_start

...
c_func
(paren
l_string|&quot;WARNING: no NUMA information for cpu %ld&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If we used a CPU iterator here we would miss printing&n;&t;&t; * the holes in the cpumap.&n;&t;&t; */
r_for
c_loop
(paren
id|cpu

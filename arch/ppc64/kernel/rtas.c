...
l_int|3
suffix:colon
multiline_comment|/* Bad indicator/domain/etc */
id|rc
op_assign
op_minus
id|EINVAL
...
l_int|9000
suffix:colon
multiline_comment|/* Isolation error */
id|rc
op_assign
op_minus
id|EFAULT
...
l_int|9001
suffix:colon
multiline_comment|/* Outstanding TCE/PTE */
id|rc
op_assign
op_minus
id|EEXIST
...
l_int|9002
suffix:colon
multiline_comment|/* No usable slot */
id|rc
op_assign
op_minus
id|ENODEV
...
(paren
id|KERN_ERR
l_string|&quot;%s: unexpected RTAS error %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|rtas_rc

...
suffix:semicolon
multiline_comment|/* XXX get rid of the -2 Anton */
...
suffix:semicolon
multiline_comment|/* The PPC64 compiler makes use of a TOC to contain function &n;&t; * pointers.  The function (ret_from_except) is actually a pointer&n;&t; * to the TOC entry.  The first entry is a pointer to the actual&n;&t; * function.&n; &t; */
id|kregs-&gt;nip
op_assign
op_star
(paren

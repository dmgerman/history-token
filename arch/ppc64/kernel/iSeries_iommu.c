...
suffix:semicolon
multiline_comment|/* itc_size is in pages worth of table, it_size is in # of entries */
id|tbl-&gt;it_size
op_assign
(paren
id|parms-&gt;itc_size
...
DECL|function|iommu_dev_setup_iSeries
r_static
r_void
id|iommu_dev_setup_iSeries
c_func
(paren
r_struct
id|pci_dev
...
DECL|function|iommu_bus_setup_iSeries
r_static
r_void
id|iommu_bus_setup_iSeries
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|iommu_init_early_iSeries
r_void

...
DECL|function|do_event_scan_all_cpus
r_static
r_void
id|do_event_scan_all_cpus
c_func
(paren
r_int
id|delay
...
suffix:semicolon
multiline_comment|/* Drop hotplug lock, and sleep for the specified delay */
...
multiline_comment|/* Delay should be at least one second since some&n;&t; * machines have problems if we call event-scan too&n;&t; * quickly. */
r_for
c_loop
(paren
suffix:semicolon

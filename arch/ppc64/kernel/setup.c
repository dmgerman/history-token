...
multiline_comment|/*&n; * Called from setup_arch to initialize the bitmap of available&n; * syscalls in the systemcfg page&n; */
DECL|function|setup_syscall_map
r_void
id|__init
id|setup_syscall_map
c_func
(paren
r_void
)paren
...
(paren
id|KERN_INFO
l_string|&quot;Syscall map setup, %d 32 bits and %d 64 bits syscalls&bslash;n&quot;
comma
id|count32
comma
id|count64
...
suffix:semicolon
multiline_comment|/* initialize the syscall map in systemcfg */
id|setup_syscall_map
c_func
(paren
)paren

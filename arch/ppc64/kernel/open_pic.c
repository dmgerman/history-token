...
DECL|function|pSeries_init_openpic
r_void
id|__init
...
id|sense
suffix:semicolon
multiline_comment|/* skip cascade if any */
r_if
c_cond
(paren
id|offset
...
DECL|function|openpic_setup_i8259
r_static
r_int
id|__init
id|openpic_setup_i8259
c_func
(paren
r_void
)paren
...
DECL|variable|openpic_setup_i8259
id|arch_initcall
c_func
(paren
id|openpic_setup_i8259
...
(brace
multiline_comment|/* For PowerMac, setup ISUs on base openpic */
r_if
c_cond
(paren
id|systemcfg-&gt;platform
...
multiline_comment|/* basically each ISU is a bus, and this assumes that&n;&t; * open_pic_isu_count interrupts per bus are possible &n;&t; * ISU == Interrupt Source&n;&t; *&n;&t; * On G5, we keep the original NumSources provided by the controller,&n;&t; * it&squot;s below 128, so we have room to stuff the IPIs and timers like darwin&n;&t; * does. We put the spurrious vector up at 0xff though.&n;&t; */
r_if
c_cond
(paren
id|systemcfg-&gt;platform

...
multiline_comment|/*&n; * We use our own read_irq_line here because PCI_INTERRUPT_PIN is&n; * crap on some of Apple ASICs. We unconditionally use the Open Firmware&n; * interrupt number as this is always right.&n; */
DECL|function|pmac_pci_read_irq_line
r_static
r_int
id|pmac_pci_read_irq_line
c_func
(paren
r_struct
id|pci_dev

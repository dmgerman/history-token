...
id|PCIBIOS_DEVICE_NOT_FOUND
suffix:semicolon
multiline_comment|/*&n;&t; * When a device in K2 is powered down, we die on config&n;&t; * cycle accesses. Fix that here. We may ultimately want&n;&t; * to cache the config space for those instead of returning&n;&t; * 0xffffffff&squot;s to make life easier to HW detection tools&n;&t; */
r_if
c_cond
(paren
id|skip_k2_device
...
l_int|0
suffix:semicolon
multiline_comment|/* HT don&squot;t do more than 64 bytes transfers. FIXME: Deal with&n;&t; * the exception of U3/AGP (hook into pci_set_mwi)&n;&t; */
id|pci_cache_line_size
op_assign
l_int|16
suffix:semicolon

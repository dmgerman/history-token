...
DECL|macro|D
mdefine_line|#define D&t;0x100&t;/* double-word load/store */
DECL|macro|DCBZ
...
comma
multiline_comment|/* 00 1 1101: std */
id|INVALID
comma
...
(brace
multiline_comment|/* &n;&t;&t; * The POWER4 has a DSISR register but doesn&squot;t set it on&n;&t;&t; * an alignment fault.  -- paulus&n;&t;&t; */
id|instr
op_assign
op_star
(paren
...
multiline_comment|/* Unfortunately D (== 0x100) doesn&squot;t fit in the aligninfo[n].flags&n;&t;   field.  So synthesize it here. */
r_if
c_cond
(paren
(paren

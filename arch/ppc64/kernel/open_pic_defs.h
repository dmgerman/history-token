...
mdefine_line|#define OPENPIC_MAX_ISU&t;&t;32
...
mdefine_line|#define OPENPIC_NUM_VECTORS&t;OPENPIC_MAX_SOURCES
...
(brace
multiline_comment|/*&n;&t; *  Private Shadow Registers (for SLiC backwards compatibility)&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Interprocessor Interrupt Command Ports&n;&t; */
...
suffix:semicolon
multiline_comment|/* Write Only */
multiline_comment|/*&n;&t; *  Current Task Priority Register&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Interrupt Acknowledge Register&n;&t; */
DECL|member|_Interrupt_Acknowledge
id|OpenPIC_Reg
id|_Interrupt_Acknowledge
suffix:semicolon
multiline_comment|/* Read Only */
multiline_comment|/*&n;&t; *  End of Interrupt (EOI) Register&n;&t; */
DECL|member|_EOI
id|OpenPIC_Reg
id|_EOI
suffix:semicolon
...
id|_OpenPIC_Global
(brace
multiline_comment|/*&n;&t; *  Feature Reporting Registers&n;&t; */
...
multiline_comment|/*&n;&t; *  Global Configuration Registers&n;&t; */
...
suffix:semicolon
multiline_comment|/* Future Expansion */
multiline_comment|/*&n;&t; *  Vendor Specific Registers&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Vendor Identification Register&n;&t; */
DECL|member|_Vendor_Identification
id|OpenPIC_Reg
id|_Vendor_Identification
suffix:semicolon
multiline_comment|/* Read Only */
multiline_comment|/*&n;&t; *  Processor Initialization Register&n;&t; */
DECL|member|_Processor_Initialization
id|OpenPIC_Reg
id|_Processor_Initialization
suffix:semicolon
multiline_comment|/* Read/Write */
multiline_comment|/*&n;&t; *  IPI Vector/Priority Registers&n;&t; */
...
suffix:semicolon
multiline_comment|/* Read/Write */
multiline_comment|/*&n;&t; *  Spurious Vector Register&n;&t; */
DECL|member|_Spurious_Vector
id|OpenPIC_Reg
id|_Spurious_Vector
suffix:semicolon
multiline_comment|/* Read/Write */
multiline_comment|/*&n;&t; *  Global Timer Registers&n;&t; */
...
id|Global
suffix:semicolon
multiline_comment|/*&n;&t; *  Interrupt Source Configuration Registers&n;&t; */
DECL|member|Source
id|OpenPIC_Source
id|Source
(braket
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Per Processor Registers&n;&t; */
...
mdefine_line|#define OPENPIC_VECTOR_MASK&t;&t;&t;0x000007ff
multiline_comment|/*&n; *  Interrupt Source Registers&n; */

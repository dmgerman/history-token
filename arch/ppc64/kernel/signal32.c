...
multiline_comment|/*&n; *  Start of RT signal support&n; *&n; *     sigset_t is 64 bits for rt signals&n; *&n; *  System Calls&n; *       sigaction                sys32_rt_sigaction&n; *       sigpending               sys32_rt_sigpending&n; *       sigprocmask              sys32_rt_sigprocmask&n; *       sigreturn                sys32_rt_sigreturn&n; *       sigqueueinfo             sys32_rt_sigqueueinfo&n; *       sigsuspend               sys32_rt_sigsuspend&n; *&n; *  Other routines&n; *        setup_rt_frame32&n; *        copy_siginfo_to_user32&n; *        siginfo32to64&n; */

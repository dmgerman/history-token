...
multiline_comment|/* If the next sigcontext is actually the sigregs (frame)  */
multiline_comment|/*   - then no more sigcontexts on the user stack          */
r_if
c_cond
(paren
id|sc
...
l_int|0xFFFFFFFF
suffix:semicolon
multiline_comment|/* Insure that the interrupt mode is 64 bit, during 32 bit execution.&n;&t;&t; * (This is necessary because we only saved lower 32 bits of msr.)&n;&t;&t; */
id|regs-&gt;msr
op_assign
id|regs-&gt;msr
op_or
...
c_func
(paren
l_string|&quot;hey should not occur&bslash;n&quot;
)paren
suffix:semicolon
id|regs-&gt;gpr
(braket
...
id|sigctx.regs
suffix:semicolon
multiline_comment|/* first parm to signal handler is the signal number */
id|regs-&gt;gpr
(braket
l_int|3
)braket
...
id|sigctx.signal
suffix:semicolon
multiline_comment|/* second parm is a pointer to sig info */
id|get_user
c_func
(paren
id|regs-&gt;gpr
...
suffix:semicolon
multiline_comment|/* third parm is a pointer to the ucontext */
id|get_user
c_func
(paren
id|regs-&gt;gpr
...
suffix:semicolon
multiline_comment|/* fourth parm is the stack frame */
id|regs-&gt;gpr
(braket
l_int|6
)braket
...
id|rt_stack_frame
suffix:semicolon
multiline_comment|/* Set up link register to return to sigreturn when the */
multiline_comment|/*  signal handler completes */
id|regs-&gt;link
op_assign
(paren
id|u64
...
id|signalregs-&gt;tramp
suffix:semicolon
multiline_comment|/* Set next instruction to the start fo the signal handler */
id|regs-&gt;nip
op_assign
id|sigctx.handler
suffix:semicolon
multiline_comment|/* Set the reg1 to look like a call to the signal handler */
r_if
c_cond
(paren
id|get_user

...
suffix:semicolon
multiline_comment|/*&n;&t; * Register 2 is the kernel toc - should be reset on&n;&t; * any calls into the kernel &n;&t; */
r_for
c_loop
(paren
id|i
...
l_int|0xFFFFFFFF
suffix:semicolon
multiline_comment|/*&n;&t; *  restore the non gpr registers &n;&t; */
id|regs-&gt;msr
op_assign
(paren
id|u64
...
suffix:semicolon
multiline_comment|/*&n;&t; * Register 2 is the kernel toc - should be reset on any&n;&t; * calls into the kernel&n;&t; */
r_for
c_loop
(paren
id|i

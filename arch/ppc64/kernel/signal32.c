...
suffix:semicolon
multiline_comment|/*&n;&t; * Copy the register contents for the pt_regs structure on the&n;&t; *   kernel stack to the elf_gregset_t32 structure on the user&n;&t; *   stack. This is a copy of 64 bit register values to 32 bit&n;&t; *   register values. The high order 32 bits of the 64 bit&n;&t; *   registers are not needed since a 32 bit application is&n;&t; *   running and the saved registers are the contents of the&n;&t; *   user registers at the time of a system call.&n;&t; * &n;&t; * The values saved on the user stack will be restored into&n;&t; *  the registers during the signal return processing&n;&t; */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*&n;&t; * Copy the non gpr registers to the user stack&n;&t; */
r_if
c_cond
(paren
id|__put_user

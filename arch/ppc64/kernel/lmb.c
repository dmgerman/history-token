...
multiline_comment|/*&n; * Truncate the lmb list to memory_limit if it&squot;s set&n; * You must call lmb_analyze() after this.&n; */
DECL|function|lmb_enforce_memory_limit
r_void
id|__init

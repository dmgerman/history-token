...
DECL|function|__do_gettimeofday
r_static
r_inline
r_void
id|__do_gettimeofday
c_func
(paren
r_struct
id|timeval
...
id|temp_stamp_xsec
suffix:semicolon
multiline_comment|/*&n;&t; * These calculations are faster (gets rid of divides)&n;&t; * if done in units of 1/2^20 rather than microseconds.&n;&t; * The conversion to microseconds at the end is done&n;&t; * without a divide (and in fact, without a multiply)&n;&t; */
id|temp_varp
op_assign
id|do_gtod.varp
suffix:semicolon
...
multiline_comment|/*&n; * When the timebase - tb_orig_stamp gets too big, we do a manipulation&n; * between tb_orig_stamp and stamp_xsec. The goal here is to keep the&n; * difference tb - tb_orig_stamp small enough to always fit inside a&n; * 32 bits number. This is a requirement of our fast 32 bits userland&n; * implementation in the vdso. If we &quot;miss&quot; a call to this function&n; * (interrupt latency, CPU locked in a spinlock, ...) and we end up&n; * with a too big difference, then the vdso will fallback to calling&n; * the syscall&n; */
DECL|function|timer_recalc_offset
r_static
id|__inline__
r_void
id|timer_recalc_offset
c_func
(paren
r_int
r_int
...
macro_line|#endif
multiline_comment|/* collect purr register values often, for accurate calculations */
...
multiline_comment|/*&n; * Scheduler clock - returns current time in nanosec units.&n; *&n; * Note: mulhdu(a, b) (multiply high double unsigned) returns&n; * the high 64 bits of a * b, i.e. (a * b) &gt;&gt; 64, where a and b&n; * are 64-bit unsigned numbers.&n; */
...
suffix:semicolon
multiline_comment|/*&n;&t; * Compute scale factor for sched_clock.&n;&t; * The calibrate_decr() function has set tb_ticks_per_sec,&n;&t; * which is the timebase frequency.&n;&t; * We compute 1e9 * 2^64 / tb_ticks_per_sec and interpret&n;&t; * the 128-bit result as a 64.64 fixed-point number.&n;&t; * We then shift that number right until it is less than 1.0,&n;&t; * giving us the scale factor and shift count to use in&n;&t; * sched_clock().&n;&t; */
id|div128_by_32
c_func
(paren
l_int|1000000000

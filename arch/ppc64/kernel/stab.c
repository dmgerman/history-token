...
multiline_comment|/* XXX Note: Changes for bolted region have not been merged - Anton */
...
DECL|variable|ppc64_preload_all_segments
r_int
r_int
id|ppc64_preload_all_segments
suffix:semicolon
DECL|variable|ppc64_stab_preload
r_int
r_int
id|ppc64_stab_preload
op_assign
l_int|1
suffix:semicolon
DECL|macro|STAB_PRESSURE
mdefine_line|#define STAB_PRESSURE 0
DECL|macro|USE_SLBIE_ON_STAB
mdefine_line|#define USE_SLBIE_ON_STAB 0
multiline_comment|/*&n; * preload all 16 segments for a 32 bit process and the PC and SP segments&n; * for a 64 bit process.&n; */
...
macro_line|#if USE_SLBIE_ON_STAB
id|asm
r_volatile
(paren
l_string|&quot;sync&quot;

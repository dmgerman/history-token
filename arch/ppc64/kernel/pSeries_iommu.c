...
c_func
(paren
l_string|&quot;iommu_bus_setup_pSeriesLP, bus %p, bus-&gt;self %p&bslash;n&quot;
comma
id|bus
comma
id|bus-&gt;self
...
DECL|function|iommu_reconfig_notifier
r_static
r_int
id|iommu_reconfig_notifier
c_func
(paren
r_struct
id|notifier_block
...
DECL|variable|iommu_reconfig_nb
r_static
r_struct
id|notifier_block
id|iommu_reconfig_nb
op_assign
(brace
dot
id|notifier_call
...
suffix:semicolon
DECL|function|iommu_dev_setup_pSeriesLP
r_static
r_void
id|iommu_dev_setup_pSeriesLP
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;iommu_dev_setup_pSeriesLP, dev %p (%s)&bslash;n&quot;
comma
id|dev
comma
id|dev-&gt;pretty_name
...
suffix:semicolon
multiline_comment|/* dev setup for LPAR is a little tricky, since the device tree might&n;&t; * contain the dma-window properties per-device and not neccesarily&n;&t; * for the bus. So we need to search upwards in the tree until we&n;&t; * either hit a dma-window property, OR find a parent with a table&n;&t; * already allocated.&n;&t; */
id|dn
op_assign
id|pci_device_to_OF_node
c_func
...
multiline_comment|/* Check for parent == NULL so we don&squot;t try to setup the empty EADS&n;&t; * slots on POWER4 machines.&n;&t; */
r_if
c_cond
(paren
id|dma_window
...
(brace
multiline_comment|/* Fall back to regular (non-LPAR) dev setup */
id|DBG
c_func
(paren
l_string|&quot;No dma window for device, falling back to regular setup&bslash;n&quot;
)paren
suffix:semicolon
id|iommu_dev_setup_pSeries
c_func
...
c_func
(paren
l_string|&quot;Found DMA window, allocating table&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
(brace
multiline_comment|/* iommu_table_setparms_lpar needs bussubno. */
id|pdn-&gt;bussubno
op_assign
id|pdn-&gt;phb-&gt;bus-&gt;number
suffix:semicolon
id|tbl
op_assign
(paren

...
mdefine_line|#define RTAS_CLOCK_BUSY (-2)
DECL|function|pSeries_get_boot_time
r_void
...
suffix:semicolon
multiline_comment|/* This is boot time so we spin. */
id|udelay
c_func
(paren
id|wait_time
...
multiline_comment|/* NOTE: get_rtc_time will get an error if executed in interrupt context&n; * and if a delay is needed to read the clock.  In this case we just&n; * silently return without updating rtc_tm.&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;error: reading clock would delay interrupt&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
multiline_comment|/* delay not allowed */
)brace
id|wait_time
op_assign
id|rtas_extended_busy_delay_time
...
l_int|1
suffix:semicolon
multiline_comment|/* probably decrementer */
id|wait_time
op_assign
id|rtas_extended_busy_delay_time
c_func

...
mdefine_line|#define PROM_ERROR&t;(0x00000000fffffffful)
...
c_func
(paren
l_string|&quot;after basic inits, mem=0x&quot;
)paren
)paren
suffix:semicolon
id|prom_print_hex

...
multiline_comment|/* Return (relocated) pointer to this much memory: skips initrd if any. */
...
suffix:semicolon
multiline_comment|/* We can&squot;t pass huge values to OF, so use 1G. */
op_star
id|mem_end
op_assign
op_star
...
suffix:semicolon
macro_line|#ifdef CONFIG_BLK_DEV_INITRD
multiline_comment|/* If this didn&squot;t cover the initrd, do so now */
r_if
c_cond
(paren
id|mem

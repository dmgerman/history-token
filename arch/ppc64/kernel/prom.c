...
multiline_comment|/*&n; * Remove an OF device node from the system.&n; */
...
(brace
multiline_comment|/* For now, we will allow removal of a&n;&t;&t; * node with one and only one child, so&n;&t;&t; * that we can support removing a slot with&n;&t;&t; * an IOA in it.  More general support for&n;&t;&t; * subtree removal to be implemented later, if&n;&t;&t; * necessary.&n;&t;&t; */
id|of_remove_node
c_func
(paren
id|child

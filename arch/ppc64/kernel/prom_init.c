...
suffix:semicolon
DECL|variable|prom_memory_limit
r_static
r_int
r_int
id|__initdata
...
suffix:semicolon
DECL|variable|prom_tce_alloc_start
r_static
r_int
r_int
id|__initdata
id|prom_tce_alloc_start
suffix:semicolon
DECL|variable|prom_tce_alloc_end
r_static
r_int
r_int
id|__initdata
id|prom_tce_alloc_end
suffix:semicolon
...
multiline_comment|/* We can&squot;t use the standard versions because of RELOC headaches. */
DECL|macro|isxdigit
...
DECL|macro|isdigit
mdefine_line|#define isdigit(c)&t;(&squot;0&squot; &lt;= (c) &amp;&amp; (c) &lt;= &squot;9&squot;)
DECL|macro|islower
mdefine_line|#define islower(c)&t;(&squot;a&squot; &lt;= (c) &amp;&amp; (c) &lt;= &squot;z&squot;)
DECL|macro|toupper
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * We can&squot;t use a switch here because GCC *may* generate a&n;&t; * jump table which won&squot;t work, because we&squot;re not running at&n;&t; * the address we&squot;re linked at.&n;&t; */
r_if
c_cond
(paren
...
multiline_comment|/*&n; * Early parsing of the command line passed to the kernel, used for&n; * &quot;mem=x&quot; and the options that affect the iommu&n; */
...
suffix:semicolon
multiline_comment|/* Align to 16 MB == size of large page */
id|RELOC
c_func
(paren
id|prom_memory_limit
...
multiline_comment|/*&n;&t; * If prom_memory_limit is set we reduce the upper limits *except* for&n;&t; * alloc_top_high. This must be the real top of RAM so we can put&n;&t; * TCE&squot;s up there.&n;&t; */
id|RELOC
c_func
(paren
id|alloc_top_high
...
c_func
(paren
l_string|&quot;Ignoring mem=%x &lt;= alloc_bottom.&bslash;n&quot;
comma
id|RELOC
c_func
(paren
...
c_func
(paren
l_string|&quot;Ignoring mem=%x &gt;= ram_top.&bslash;n&quot;
comma
id|RELOC
c_func
(paren
...
multiline_comment|/*&n;&t; * Setup our top alloc point, that is top of RMO or top of&n;&t; * segment 0 when running non-LPAR.&n;&t; */
r_if
c_cond
(paren
id|RELOC
...
c_func
(paren
l_string|&quot;  memory_limit : %x (16 MB aligned)&bslash;n&quot;
comma
id|RELOC
c_func
(paren
...
(brace
multiline_comment|/*&n;&t;&t; * We align the start to a 16MB boundary so we can map the TCE area&n;&t;&t; * using large pages if possible. The end should be the top of RAM&n;&t;&t; * so no need to align it.&n;&t;&t; */
id|RELOC
c_func
(paren
id|prom_tce_alloc_start
...
DECL|function|prom_close_stdin
r_static
r_void
id|__init
id|prom_close_stdin
...
id|_prom-&gt;chosen
comma
l_string|&quot;linux,tce-alloc-start&quot;
comma
id|PTRRELOC
c_func
(paren
...
suffix:semicolon
multiline_comment|/* in case stdin is USB and still active on IBM machines... */
id|prom_close_stdin
c_func
(paren
)paren

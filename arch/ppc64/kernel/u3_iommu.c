...
id|iommu_table_u3
suffix:semicolon
DECL|variable|iommu_table_u3_inited
r_static
r_int
id|iommu_table_u3_inited
suffix:semicolon
...
DECL|function|iommu_table_u3_setup
r_static
r_void
id|iommu_table_u3_setup
c_func
(paren
r_void
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/* it_size is in number of entries */
...
DECL|function|iommu_dev_setup_u3
r_static
r_void
id|iommu_dev_setup_u3
c_func
(paren
r_struct
id|pci_dev
...
id|dn
suffix:semicolon
multiline_comment|/* We only have one iommu table on the mac for now, which makes&n;&t; * things simple. Setup all PCI devices to point to this table&n;&t; *&n;&t; * We must use pci_device_to_OF_node() to make sure that&n;&t; * we get the real &quot;final&quot; pointer to the device in the&n;&t; * pci_dev sysdata and not the temporary PHB one&n;&t; */
id|dn
op_assign
...
DECL|function|iommu_bus_setup_u3
r_static
r_void
id|iommu_bus_setup_u3
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|iommu_init_early_u3
r_void
...
(brace
multiline_comment|/* If init failed, use direct iommu and null setup functions */

...
id|pSeries_mpic
suffix:semicolon
DECL|function|config_access_valid
r_static
r_int
id|config_access_valid
c_func
(paren
r_struct
id|device_node
...
DECL|function|add_linux_pci_domain
r_static
r_void
id|__devinit
id|add_linux_pci_domain
c_func
(paren
r_struct
id|device_node
...
suffix:semicolon
multiline_comment|/*&n;&t; * pci_probe_only and pci_assign_all_buses can be set via properties&n;&t; * in chosen.&n;&t; */
r_if
c_cond
(paren
id|of_chosen
...
id|of_chosen
comma
l_string|&quot;linux,pci-assign-all-buses&quot;
comma
l_int|NULL
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Assume the winbond 82c105 is the IDE controller on a&n; * p610.  We should probably be more careful in case&n; * someone tries to plug in a similar adapter.&n; */
DECL|function|fixup_winbond_82c105
r_static
r_void
id|fixup_winbond_82c105
c_func
(paren
r_struct
id|pci_dev

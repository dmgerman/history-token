...
multiline_comment|/***********************************************************************&n; * find_floppy(void) &n; *&t;&n; * Finds the default floppy device, if the system has one, and returns &n; * the pci_dev for the isa bridge for the floppy device.  &n; *&n; * Note: This functions finds the first &quot;fdc&quot; device and then looks to &n; * the parent device which should be the isa bridge device.  If there &n; * is more than one floppy on the system, it will find the first one &n; * and maybe that is okay. &n; ***********************************************************************/
r_struct
id|pci_dev
op_star
...
id|PPCDBG_BUSWALK
comma
l_string|&quot;&bslash;tFloppy pci_dev&bslash;n&quot;
)paren
suffix:semicolon
id|PPCDBGCALL
c_func

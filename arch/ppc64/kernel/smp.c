...
DECL|function|look_for_more_cpus
r_static
r_inline
r_void
...
id|ireg
suffix:semicolon
multiline_comment|/* Find the property which will tell us about how many CPUs&n;&t; * we&squot;re allowed to have. */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;Could not find /rtas in device tree!&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(brace
multiline_comment|/* FIXME: make sure not marked as lrdr_capable() */
r_return
suffix:semicolon
)brace
id|maxcpus
...
suffix:semicolon
multiline_comment|/* Make those cpus (which might appear later) possible too. */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* cpu_possible is set up in prom.c */
id|cpu_set
c_func
(paren
id|boot_cpuid
...
id|nodemask
suffix:semicolon
singleline_comment|// phys_domain-&gt;cache_hot_time = XXX;
op_star
id|node_domain
op_assign
id|SD_NODE_INIT
...
id|cpu_possible_map
suffix:semicolon
singleline_comment|// node_domain-&gt;cache_hot_time = XXX;
)brace
...
macro_line|#else /* !CONFIG_SCHED_SMT */
DECL|variable|sched_group_cpus
r_static
r_struct
id|sched_group
...
id|cpu_possible_map
suffix:semicolon
singleline_comment|// cpu_sd-&gt;cache_hot_time = XXX;
)brace

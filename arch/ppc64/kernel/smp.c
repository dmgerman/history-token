...
multiline_comment|/* State of each CPU during hotplug phases */
id|DEFINE_PER_CPU
c_func
(paren
r_int
...
suffix:semicolon
DECL|function|generic_cpu_disable
r_int
...
DECL|function|generic_cpu_enable
r_int
...
(brace
multiline_comment|/* Do the normal bootup if we haven&squot;t&n;&t; * already bootstrapped. */
r_if
c_cond
(paren
id|system_state
...
id|ENOSYS
suffix:semicolon
multiline_comment|/* get the target out of it&squot;s holding state */
id|per_cpu
c_func
(paren
id|cpu_state
...
suffix:semicolon
multiline_comment|/* counter the irq disable in fixup_irqs */
id|local_irq_enable
c_func
(paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;CPU%d didn&squot;t die...&bslash;n&quot;
comma
id|cpu
)paren
suffix:semicolon
)brace
DECL|function|generic_mach_cpu_die
r_void
...
(paren
id|KERN_DEBUG
l_string|&quot;CPU%d offline&bslash;n&quot;
comma
id|cpu
)paren
suffix:semicolon

...
multiline_comment|/* Handle reads from the proc file system&n; */
...
multiline_comment|/* Handle writes to our proc file system&n; */
...
(brace
multiline_comment|/* Doesn&squot;t do anything today!!!&n;&t; */
r_return
id|count
suffix:semicolon
)brace
multiline_comment|/* setup our proc file system entries&n; */
...
suffix:semicolon
multiline_comment|/* If we have a valid hosting LP, create a proc file system entry&n;&t; * for config information&n;&t; */
r_if
c_cond
(paren
id|viopath_hostLp

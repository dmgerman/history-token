...
suffix:semicolon
multiline_comment|/* If no pte found, send the problem up to do_page_fault */
r_if
c_cond
(paren
op_logical_neg
...
id|ptep
suffix:semicolon
multiline_comment|/* If the pte is not &quot;present&quot; (valid), send the problem&n;&t; * up to do_page_fault.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t; * Check if pte might have an hpte, but we have&n;&t;&t; * no slot information&n;&t;&t; */
r_if
c_cond
(paren
id|pte_val
...
multiline_comment|/* For these cases we need to create a new&n;&t;&t;&t; * HPTE and update the linux pte (for&n;&t;&t;&t; * case 1).  For case 5 there is no linux pte.&n;&t;&t;&t; *&n;&t;&t;&t; * Find an available HPTE slot&n; &t;&t;&t; */
id|slot
op_assign
id|ppc_md
dot
...
id|_PAGE_HASHPTE
suffix:semicolon
multiline_comment|/* No need to use ldarx/stdcx here because all&n;&t;&t;&t;&t; * who might be updating the pte will hold the page_table_lock&n;&t;&t;&t;&t; * or the hash_table_lock (we hold both)&n;&t;&t;&t;&t; */
op_star
id|ptep
op_assign
id|new_pte
...
id|k
suffix:semicolon
multiline_comment|/* Temporarily lets check for the hpte in all possible slots */
r_for
c_loop
(paren
id|secondary

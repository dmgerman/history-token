...
DECL|function|iSeries_get_cmdline
r_static
r_void
id|__init
id|iSeries_get_cmdline
c_func
(paren
r_void
)paren
...
suffix:semicolon
multiline_comment|/* Parse early parameters, in particular mem=x */
...
c_func
(paren
l_string|&quot;Ignoring mem=%lu &gt;= ram_top.&bslash;n&quot;
comma
id|memory_limit
)paren
suffix:semicolon
...
multiline_comment|/* Bolt kernel mappings for all of memory (or just a bit if we&squot;ve got a limit) */
id|iSeries_bolt_kernel
c_func
(paren
l_int|0

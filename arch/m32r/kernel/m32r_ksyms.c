...
suffix:semicolon
multiline_comment|/* EXPORT_SYMBOL(memcpy_fromio); // not implement yet */
multiline_comment|/* EXPORT_SYMBOL(memcpy_toio); // not implement yet */
...
suffix:semicolon
multiline_comment|/* EXPORT_SYMBOL(memset_io); // not implement yet */

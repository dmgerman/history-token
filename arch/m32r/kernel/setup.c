...
macro_line|#if defined(CONFIG_CHIP_VDEC2) || defined(CONFIG_CHIP_XNUX2)&t;&bslash;&n;&t;|| defined(CONFIG_CHIP_M32700) || defined(CONFIG_CHIP_M32102) &bslash;&n;        || defined(CONFIG_CHIP_OPSP)

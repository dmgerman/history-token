...
suffix:semicolon
DECL|variable|i8042_dmi_noloop
r_int
r_int
id|i8042_dmi_noloop
op_assign
...
multiline_comment|/* &n; * Some APM bioses hang on APM idle calls&n; */
...
multiline_comment|/*&n; * Several HP Proliant (and maybe other OSB4/ProFusion) systems&n; * shouldn&squot;t use the AUX LoopBack command, or they crash or reboot.&n; */
DECL|function|set_8042_noloop
r_static
id|__init
r_int
id|set_8042_noloop

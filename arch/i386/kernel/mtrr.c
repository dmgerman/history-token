...
mdefine_line|#define MTRR_VERSION            &quot;1.40 (20010327)&quot;
DECL|macro|TRUE
...
l_int|NULL
suffix:semicolon
multiline_comment|/* ServerWorks LE chipsets have problems with write-combining &n;      Don&squot;t allow it and leave room for other chipsets to be tagged */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/*&n;&t;     *&t;FIXME: Winchip2 supports uncached&n;&t;     */
r_if
c_cond
(paren
id|type
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;     *&t;Clear any unconfigured MCR&squot;s.&n;     */
r_for
c_loop
(paren
id|i
...
r_else
multiline_comment|/*&n;&t;&t;&t; *&t;If the BIOS set up an MCR we cannot see it&n;&t;&t;&t; *&t;but we don&squot;t wish to obliterate it&n;&t;&t;&t; */
id|centaur_mcr_reserved
op_or_assign
(paren
l_int|1
...
multiline_comment|/*  &n;     *&t;Throw the main write-combining switch... &n;     *&t;However if OOSTORE is enabled then people have already done far&n;     *  cleverer things and we should behave. &n;     */
id|lo
op_or_assign
l_int|15
suffix:semicolon
...
multiline_comment|/*  End Function centaur_mcr1_init  */
...
suffix:semicolon
multiline_comment|/* Unfortunately, MCR&squot;s are read-only, so there is no way to&n;     * find out what the bios might have done.&n;     */
multiline_comment|/* Clear any unconfigured MCR&squot;s.&n;     * This way we are sure that the centaur_mcr array contains the actual&n;     * values. The disadvantage is that any BIOS tweaks are thus undone.&n;     *&n;     */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*  End Function centaur_mcr0_init  */

...
multiline_comment|/*&n;     *&t;Enable MCR key if we are using a winchip2&n;     */
r_if
c_cond
(paren
id|boot_cpu_data.x86_model
...
multiline_comment|/*  Throw the main write-combining switch... &n;        However if OOSTORE is enabled then people have already done far&n;        cleverer things and we should behave. &n;     */
r_if
c_cond
(paren
id|wc2

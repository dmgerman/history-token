...
multiline_comment|/*&n; * The node 0 pgdat is initialized before all of these because&n; * it&squot;s needed for bootmem.  node&gt;0 pgdats have their virtual&n; * space allocated before the pagetables are in place to access&n; * them, so they can&squot;t be cleared then.&n; *&n; * This should all compile down to nothing when NUMA is off.&n; */
DECL|function|remapped_pgdat_init
r_void
id|__init
id|remapped_pgdat_init
c_func
(paren
r_void
)paren

multiline_comment|/*&n; *  linux/arch/i386/nmi.c&n; *&n; *  NMI watchdog support on APIC systems&n; *&n; *  Started by Ingo Molnar &lt;mingo@redhat.com&gt;&n; *&n; *  Fixes:&n; *  Mikael Pettersson&t;: AMD K7 support for local APIC NMI watchdog.&n; *  Mikael Pettersson&t;: Power Management for local APIC NMI watchdog.&n; *  Mikael Pettersson&t;: Pentium 4 support for local APIC NMI watchdog.&n; */

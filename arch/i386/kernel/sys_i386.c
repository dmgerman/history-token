...
DECL|macro|HPAGE_ALIGN
mdefine_line|#define HPAGE_ALIGN(x)  (((unsigned long)x + (HPAGE_SIZE -1)) &amp; HPAGE_MASK)
r_extern
r_int
id|sys_munmap
c_func
...
suffix:semicolon
multiline_comment|/* get_addr function gets the currently unused virtaul range in&n; * current process&squot;s address space.  It returns the LARGE_PAGE_SIZE&n; * aligned address (in cases of success).  Other kernel generic&n; * routines only could gurantee that allocated address is PAGE_SIZSE aligned.&n; */
r_static
r_int
r_int

...
multiline_comment|/* It is correct to call set_IF(regs) from the set_vflags_*&n; * functions. However someone forgot to call clear_IF(regs)&n; * in the opposite case.&n; * After the command sequence CLI PUSHF STI POPF you should&n; * end up with interrups disabled, but you ended up with&n; * interrupts enabled.&n; *  ( I was testing my own changes, but the only bug I&n; *    could find was in a function I had not changed. )&n; * [KD]&n; */
...
DECL|macro|val_byte
mdefine_line|#define val_byte(val, n) (((__u8 *)&amp;val)[n])
DECL|macro|pushb
mdefine_line|#define pushb(base, ptr, val, err_label) &bslash;&n;&t;do { &bslash;&n;&t;&t;__u8 __val = val; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(__val, base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;} while(0)
DECL|macro|pushw
mdefine_line|#define pushw(base, ptr, val, err_label) &bslash;&n;&t;do { &bslash;&n;&t;&t;__u16 __val = val; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 1), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 0), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;} while(0)
DECL|macro|pushl
mdefine_line|#define pushl(base, ptr, val, err_label) &bslash;&n;&t;do { &bslash;&n;&t;&t;__u32 __val = val; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 3), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 2), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 1), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr--; &bslash;&n;&t;&t;if (put_user(val_byte(__val, 0), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;} while(0)
DECL|macro|popb
mdefine_line|#define popb(base, ptr, err_label) &bslash;&n;&t;({ &bslash;&n;&t;&t;__u8 __res; &bslash;&n;&t;&t;if (get_user(__res, base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;__res; &bslash;&n;&t;})
DECL|macro|popw
mdefine_line|#define popw(base, ptr, err_label) &bslash;&n;&t;({ &bslash;&n;&t;&t;__u16 __res; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 0), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 1), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;__res; &bslash;&n;&t;})
DECL|macro|popl
mdefine_line|#define popl(base, ptr, err_label) &bslash;&n;&t;({ &bslash;&n;&t;&t;__u32 __res; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 0), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 1), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 2), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;if (get_user(val_byte(__res, 3), base + ptr) &lt; 0) &bslash;&n;&t;&t;&t;goto err_label; &bslash;&n;&t;&t;ptr++; &bslash;&n;&t;&t;__res; &bslash;&n;&t;})
multiline_comment|/* There are so many possible reasons for this function to return&n; * VM86_INTx, so adding another doesn&squot;t bother me. We can expect&n; * userspace programs to be able to handle it. (Getting a problem&n; * in userspace is always better than an Oops anyway.) [KD]&n; */
...
mdefine_line|#define CHECK_IF_IN_TRAP &bslash;&n;&t;if (VMPI.vm86dbg_active &amp;&amp; VMPI.vm86dbg_TFpendig) &bslash;&n;&t;&t;newflags |= TF_MASK
DECL|macro|VM86_FAULT_RETURN
mdefine_line|#define VM86_FAULT_RETURN do { &bslash;&n;&t;if (VMPI.force_return_for_pic  &amp;&amp; (VEFLAGS &amp; (IF_MASK | VIF_MASK))) &bslash;&n;&t;&t;return_to_32bit(regs, VM86_PICRETURN); &bslash;&n;&t;return; } while (0)
id|csp
op_assign
(paren
r_int
...
l_int|0xf2
suffix:colon
multiline_comment|/* repnz */
r_break
suffix:semicolon
r_case
l_int|0xf3
suffix:colon
multiline_comment|/* rep */
r_break
suffix:semicolon
r_default
suffix:colon
...
id|simulate_sigsegv
suffix:colon
multiline_comment|/* FIXME: After a long discussion with Stas we finally&n;&t; *        agreed, that this is wrong. Here we should&n;&t; *        really send a SIGSEGV to the user program.&n;&t; *        But how do we create the correct context? We&n;&t; *        are inside a general protection fault handler&n;&t; *        and has just returned from a page fault handler.&n;&t; *        The correct context for the signal handler&n;&t; *        should be a mixture of the two, but how do we&n;&t; *        get the information? [KD]&n;&t; */
id|return_to_32bit
c_func
(paren
id|regs

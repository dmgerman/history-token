...
(brace
multiline_comment|/*&n;&t; *  VIA VT8363 host bridge has broken feature &squot;PCI Master Read&n;&t; *  Caching&squot;. It caches more than is good for it, sometimes&n;&t; *  serving the bus master with stale data. Some BIOSes enable&n;&t; *  it by default, so we disable it.&n;&t; */
id|u8
id|tmp
suffix:semicolon
id|pci_read_config_byte
...
c_func
(paren
l_string|&quot;PCI: Bus master read caching disabled&bslash;n&quot;
)paren
suffix:semicolon

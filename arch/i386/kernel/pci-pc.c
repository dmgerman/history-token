...
c_func
(paren
l_string|&quot;PCI: ServerWorks host bridge: last bus %02x&bslash;n&quot;
comma
id|pcibios_last_bus
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;PCI: Compaq host bridge: last bus %02x&bslash;n&quot;
comma
id|busno2
)paren
suffix:semicolon
...
DECL|function|pci_fixup_via_acpi
r_static
r_void
id|__init
id|pci_fixup_via_acpi
c_func
(paren
r_struct
id|pci_dev
...
(brace
multiline_comment|/*&n;&t; * VIA ACPI device: IRQ line in PCI config byte 0x42&n;&t; */
id|u8
id|irq
suffix:semicolon
id|pci_read_config_byte
...
DECL|function|pci_fixup_vt8363
r_static
r_void
id|__init
id|pci_fixup_vt8363
...
(brace
multiline_comment|/*&n;&t; * The VIA bridge will corrupt disks without these settings.&n;&t; */
id|u8
id|tmp
suffix:semicolon
id|pci_read_config_byte
...
c_func
(paren
l_string|&quot;PCI: Bus master Pipeline request disabled&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;PCI: Fast Write to Read turnaround disabled&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
c_func
(paren
l_string|&quot;PCI: Disabled enhanced CPU to PCI writes&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
c_func
(paren
l_string|&quot;PCI: Disabled Master Read Caching&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
c_func
(paren
l_string|&quot;PCI: Bursting cornercase bug worked around&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
c_func
(paren
l_string|&quot;PCI: Post Write Fail set to Retry&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
DECL|function|pci_fixup_via691
r_static
r_void
id|__init
id|pci_fixup_via691
...
(brace
multiline_comment|/*&n;&t; * The VIA bridge corrupts with Posting enabled&n;&t; */
id|u8
id|tmp
suffix:semicolon
id|pci_read_config_byte
...
c_func
(paren
l_string|&quot;PCI: Disabled enhanced CPU to PCI posting&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func
...
DECL|function|pci_fixup_via691_2
r_static
r_void
id|__init
id|pci_fixup_via691_2
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;PCI: Disabled enhanced CPU to PCI posting #2&bslash;n&quot;
)paren
suffix:semicolon
id|pci_write_config_byte
c_func

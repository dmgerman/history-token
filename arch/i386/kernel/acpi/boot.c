...
r_new
suffix:semicolon
multiline_comment|/* Real old ELCR mask */
id|old
op_assign
id|inb
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; * If we use ACPI to set PCI irq&squot;s, then we should clear ELCR&n;&t; * since we will set it correctly as we enable the PCI irq&n;&t; * routing.&n;&t; */
r_new
op_assign
id|acpi_noirq
ques
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Update SCI information in the ELCR, it isn&squot;t in the PCI&n;&t; * routing tables..&n;&t; */
r_switch
c_cond
(paren
id|trigger
...
(paren
id|PREFIX
l_string|&quot;setting ELCR to %04x (from %04x)&bslash;n&quot;
comma
r_new
comma
id|old

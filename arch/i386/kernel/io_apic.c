...
id|not_worth_the_effort
suffix:colon
multiline_comment|/* if we did not find an IRQ to move, then adjust the time interval upward */
id|balanced_irq_interval
op_assign
id|min
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Enable physical balance only if more than 1 physical processor is present */
r_if
c_cond
(paren
id|smp_num_siblings

...
(brace
multiline_comment|/*&n;&t;&t; * On some CPUs, we can see transient MSR values (which are&n;&t;&t; * not present in _PSS), while CPU is doing some automatic&n;&t;&t; * P-state transition (like TM2). Get the last freq set &n;&t;&t; * in PERF_CTL.&n;&t;&t; */
id|rdmsr
c_func
(paren

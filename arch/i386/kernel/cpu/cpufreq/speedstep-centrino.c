...
DECL|macro|OP
macro_line|#undef OP
multiline_comment|/* Dothan processor datasheet 30218903.pdf defines 4 voltages for each&n;   frequency (VID#A through VID#D) - this macro allows us to define all&n;   of these but we only use the VID#C voltages at compile time - this may&n;   need some work if we want to select the voltage profile at runtime. */
DECL|macro|OP
mdefine_line|#define OP(mhz, mva, mvb, mvc, mvd)&t;&t;&t;&t;&t;&bslash;&n;&t;{&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;.frequency = (mhz) * 1000,&t;&t;&t;&t;&bslash;&n;&t;&t;.index = (((mhz)/100) &lt;&lt; 8) | ((mvc - 700) / 16)       &t;&bslash;&n;&t;}
multiline_comment|/* Intel Pentium M processor 715 / 1.50GHz (Dothan) */
DECL|variable|dothan_1500
r_static
r_struct
id|cpufreq_frequency_table
id|dothan_1500
...
suffix:semicolon
multiline_comment|/* Intel Pentium M processor 725 / 1.60GHz (Dothan) */
DECL|variable|dothan_1600
r_static
r_struct
id|cpufreq_frequency_table
id|dothan_1600
...
suffix:semicolon
multiline_comment|/* Intel Pentium M processor 735 / 1.70GHz (Dothan) */
DECL|variable|dothan_1700
r_static
r_struct
id|cpufreq_frequency_table
id|dothan_1700
...
suffix:semicolon
multiline_comment|/* Intel Pentium M processor 745 / 1.80GHz (Dothan) */
DECL|variable|dothan_1800
r_static
r_struct
id|cpufreq_frequency_table
id|dothan_1800
...
suffix:semicolon
multiline_comment|/* Intel Pentium M processor 755 / 2.00GHz (Dothan) */
DECL|variable|dothan_2000
r_static
r_struct
id|cpufreq_frequency_table
id|dothan_2000
...
DECL|macro|DOTHAN
mdefine_line|#define DOTHAN(cpuid, max, name)&t;&bslash;&n;{&t;.cpu_id&t;&t;= cpuid,&t;&bslash;&n;&t;.model_name&t;= &quot;Intel(R) Pentium(R) M processor &quot; name &quot;GHz&quot;, &bslash;&n;&t;.max_freq&t;= (max)*1000,&t;&bslash;&n;&t;.op_points&t;= dothan_##max,&t;&bslash;&n;}

...
(brace
multiline_comment|/*&n;&t;&t; * On some CPUs, we can see transient MSR values (which are&n;&t;&t; * not present in _PSS), while CPU is doing some automatic&n;&t;&t; * P-state transition (like TM2). Allow CPU to stabilize at&n;&t;&t; * some freq and retry.&n;&t;&t; * If we continue to see transients for long time, just return&n;&t;&t; * the lowest possible frequency as best guess.&n;&t;&t; */
r_int
id|retries
op_assign
l_int|0
suffix:semicolon
DECL|macro|MAX_EXTRACT_CLOCK_RETRIES
mdefine_line|#define MAX_EXTRACT_CLOCK_RETRIES&t;5
r_while
c_loop
(paren
id|clock_freq

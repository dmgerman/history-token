...
suffix:semicolon
multiline_comment|/* &n;&t; * The current speed is unknown and not detectable by ACPI... argh! Assume &n;&t; * it&squot;s P0, it will be set to this value later during initialization.&n;&t; */
id|policy-&gt;cur
op_assign
id|perf-&gt;states
(braket

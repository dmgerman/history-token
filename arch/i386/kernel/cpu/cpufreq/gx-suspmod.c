...
multiline_comment|/*&n; *      cpufreq_gx_setpolicy:  &n; *&n; */
DECL|function|cpufreq_gx_setpolicy
r_static
r_int
...
(brace
multiline_comment|/* here we need to make sure that we don&squot;t set the&n;&t;&t; * frequency below policy-&gt;min (see comment in&n;&t;&t; * cpufreq_gx_verify() - guarantee of processing &n;&t;&t; * capacity.&n;&t;&t; */
id|u8
id|tmp1
comma
id|tmp2
...
(brace
multiline_comment|/* disable throttling */
id|gx_set_cpuspeed
c_func
(paren
id|stock_freq

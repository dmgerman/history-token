...
id|KERN_ERR
id|PFX
l_string|&quot;BIG FAT WARNING: currently in invalid setting&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
l_int|3
suffix:semicolon
multiline_comment|/* is there at least one state within the limit? */
r_for
c_loop
(paren
suffix:semicolon
...
id|KERN_INFO
id|PFX
l_string|&quot;unknown core frequency - please use module parameter &squot;stock_freq&squot;&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

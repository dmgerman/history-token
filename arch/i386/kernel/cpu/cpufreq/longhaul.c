multiline_comment|/*&n; *  $Id: longhaul.c,v 1.70 2002/09/12 10:22:17 db Exp $&n; *&n; *  (C) 2001  Dave Jones. &lt;davej@suse.de&gt;&n; *  (C) 2002  Padraig Brady. &lt;padraig@antefacto.com&gt;&n; *&n; *  Licensed under the terms of the GNU GPL License version 2.&n; *  Based upon datasheets &amp; sample CPUs kindly provided by VIA.&n; *&n; *  VIA have currently 3 different versions of Longhaul.&n; *&n; *  +---------------------+----------+---------------------------------+&n; *  | Marketing name      | Codename | longhaul version / features.    |&n; *  +---------------------+----------+---------------------------------+&n; *  |  Samuel/CyrixIII    |   C5A    | v1 : multipliers only           |&n; *  |  Samuel2/C3         | C3E/C5B  | v1 : multiplier only            |&n; *  |  Ezra               |   C5C    | v2 : multipliers &amp; voltage      |&n; *  |  Ezra-T             | C5M/C5N  | v3 : multipliers, voltage &amp; FSB |&n; *  +---------------------+----------+---------------------------------+&n; *&n; *  BIG FAT DISCLAIMER: Work in progress code. Possibly *dangerous*&n; */
...
suffix:semicolon
multiline_comment|/* fsb values as defined in CPU */
DECL|variable|eblcr_fsb_table
r_static
r_int
r_int
id|eblcr_fsb_table
...
suffix:semicolon
multiline_comment|/* fsb values to favour low fsb speed (lower power) */
DECL|variable|power_fsb_table
r_static
r_int
r_int
id|power_fsb_table
...
suffix:semicolon
multiline_comment|/* fsb values to favour high fsb speed (for e.g. if lowering CPU &n;   freq because of heat, but want to maintain highest performance possible) */
DECL|variable|perf_fsb_table
r_static
r_int
r_int
id|perf_fsb_table
...
suffix:semicolon
DECL|variable|fsb_search_table
r_static
r_int
r_int
op_star
...
multiline_comment|/**&n; * longhaul_set_cpu_frequency()&n; * @clock_ratio_index : index of clock_ratio[] for new frequency&n; * @newfsb: the new FSB&n; *&n; * Sets a new clock ratio, and -if applicable- a new Front Side Bus&n; */
...
(paren
id|KERN_INFO
l_string|&quot;longhaul: New FSB:%d Mult(x10):%d&bslash;n&quot;
comma
id|newfsb
comma
id|clock_ratio
...
(paren
id|KERN_INFO
l_string|&quot;longhaul: Voltage scaling + FSB scaling not done yet.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|bad_voltage
...
(paren
id|KERN_INFO
l_string|&quot;longhaul: Min FSB=%d Max FSB=%d&bslash;n&quot;
comma
id|minfsb
comma
id|maxfsb
...
DECL|function|longhaul_statecount_fsb
r_static
r_inline
r_int
r_int
id|longhaul_statecount_fsb
c_func
(paren
r_struct
id|cpufreq_policy
...
(paren
id|KERN_INFO
l_string|&quot;longhaul: CPU currently at %dMHz (%d x %d.%d)&bslash;n&quot;
comma
(paren
id|currentspeed
op_div

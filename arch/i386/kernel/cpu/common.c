...
(paren
id|KERN_DEBUG
l_string|&quot;CPU: After generic identify, caps:&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(paren
id|KERN_DEBUG
l_string|&quot;CPU: After vendor identify, caps:&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(paren
id|KERN_DEBUG
l_string|&quot;CPU: After all inits, caps:&quot;
)paren
suffix:semicolon
r_for
c_loop
...
suffix:semicolon
multiline_comment|/* Set up GDT entry for 16bit stack */
op_star
(paren
id|__u64
op_star

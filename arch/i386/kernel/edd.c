...
comma
op_amp
id|edd_attr_default_cylinders.attr
comma
op_amp
id|edd_attr_default_heads.attr
comma
op_amp
id|edd_attr_default_sectors_per_track.attr
comma
op_amp
id|edd_attr_interface.attr
comma
op_amp
id|edd_attr_host_bus.attr
comma
l_int|NULL
comma
)brace
suffix:semicolon
DECL|variable|edd_subsys
r_static
r_struct
id|subsystem
id|edd_subsys

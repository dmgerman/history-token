...
mdefine_line|#define EDD_VERSION &quot;0.06 2002-Oct-09&quot;
...
mdefine_line|#define EDD_DEVICE_ATTR(_name,_mode,_show) &bslash;&n;struct edd_attribute edd_attr_##_name = { &t;&bslash;&n;&t;.attr = {.name = __stringify(_name), .mode = _mode },&t;&bslash;&n;&t;.show&t;= _show,&t;&t;&t;&t;&bslash;&n;};
r_static
r_inline
r_struct
id|edd_info

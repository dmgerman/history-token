...
suffix:semicolon
multiline_comment|/*&n; * per-CPU IRQ handling stacks&n; */
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * this is where we switch to the IRQ stack. However, if we are already using&n;&t;&t; * the IRQ stack (because we interrupted a hardirq handler) we can&squot;t do that&n;&t;&t; * and just have to keep using the current stack (which is the irq stack already&n;&t;&t; * after all)&n;&t;&t; */
r_if
c_cond
(paren
id|curctx
...
l_string|&quot;       call    handle_IRQ_event &bslash;n&quot;
l_string|&quot;       xchgl   %%ebx,%%esp     &bslash;n&quot;
suffix:colon
l_string|&quot;=a&quot;
(paren

...
id|timer_none
suffix:semicolon
multiline_comment|/*&n; * This is a special lock that is owned by the CPU and holds the index&n; * register we are working with.  It is required for NMI access to the&n; * CMOS/RTC registers.  See include/asm-i386/mc146818rtc.h for details.&n; */
DECL|variable|cmos_lock
r_volatile
r_int
r_int
id|cmos_lock
...
suffix:semicolon
multiline_comment|/* Routines for accessing the CMOS RAM/RTC. */
DECL|function|rtc_cmos_read
r_int
r_char
id|rtc_cmos_read
c_func
...
multiline_comment|/*&n;&t;&t; * Not synced, exit, do not restart a timer (if one is&n;&t;&t; * running, let it run out).&n;&t;&t; */
r_return
suffix:semicolon
id|do_gettimeofday
c_func

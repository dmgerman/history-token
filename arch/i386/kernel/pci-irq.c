...
(paren
id|KERN_ERR
l_string|&quot;PCI: Unable to resolve IRQ for device %s&bslash;n&quot;
comma
id|dev-&gt;slot_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;PCI: %s: no interrupt pin&bslash;n&quot;
comma
id|dev-&gt;slot_name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;PCI: Invalid acpi_prts [%d]&bslash;n&quot;
comma
id|acpi_prts.count
)paren
suffix:semicolon

...
DECL|function|setup_x86_bogus_stack
id|fastcall
r_void
id|setup_x86_bogus_stack
c_func
(paren
r_int
r_char
...
suffix:semicolon
multiline_comment|/* reserve the space on 32bit stack for the magic switch16 pointer */
id|memmove
c_func
(paren
id|stk
...
id|stk
suffix:semicolon
multiline_comment|/* now the switch32 on 16bit stack */
id|stack_bot
op_assign
(paren
r_int
...
l_int|20
suffix:semicolon
multiline_comment|/* copy iret frame on 16bit stack */
id|memcpy
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* fill in the switch pointers */
id|switch16_ptr
(braket
l_int|0
)braket
...
DECL|function|fixup_x86_bogus_stack
id|fastcall
r_int
r_char
op_star
id|fixup_x86_bogus_stack
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* copy the data from 16bit stack to 32bit stack */
id|len
op_assign
id|CPU_16BIT_STACK_SIZE
op_minus

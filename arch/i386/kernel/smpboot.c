...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * num_online_cpus is not necessarily known at the time&n;&t; * this gets called, so we first wait for the BP to&n;&t; * finish SMP initialization:&n;&t; */
r_while
c_loop
(paren
op_logical_neg

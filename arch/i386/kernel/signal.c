...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * If TF is set due to a debugger (PT_DTRACE), clear the TF&n;&t; * flag so that register information in the sigcontext is&n;&t; * correct.&n;&t; */
r_if
c_cond
(paren
id|unlikely

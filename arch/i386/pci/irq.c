...
multiline_comment|/* return value:&n; * -1 on error&n; * 0 for PCI INTA-INTD&n; * 0 or enable bit mask to check or set for onchip functions&n; */
DECL|function|pirq_sis5595_onchip
r_static
r_inline
r_int
id|pirq_sis5595_onchip
c_func
(paren
r_int
id|pirq
...
id|ret
op_assign
id|PIRQ_SIS_USB_ENABLE
suffix:semicolon
multiline_comment|/* documented for 5595 */
r_break
suffix:semicolon
r_case
l_int|0x61
...
(paren
id|KERN_INFO
l_string|&quot;SiS pirq: IDE/ACPI/DAQ mapping not implemented: (%u)&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_INFO
l_string|&quot;SiS router unknown request: (%u)&bslash;n&quot;
comma
(paren
r_int
)paren
...
multiline_comment|/* return value:&n; * -1 on error&n; * 0 for PCI INTA-INTD&n; * 0 or enable bit mask to check or set for onchip functions&n; */
DECL|function|pirq_sis96x_onchip
r_static
r_inline
r_int
id|pirq_sis96x_onchip
c_func
(paren
r_int
id|pirq
...
DECL|function|pirq_sis5595_get
r_static
r_int
id|pirq_sis5595_get
c_func
...
DECL|function|pirq_sis5595_set
r_static
r_int
id|pirq_sis5595_set
c_func
...
comma
id|PCI_DEVICE_ID_INTEL_82440GX
comma
l_int|NULL
)paren
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * In case of SiS south bridge, we need to detect the two&n;&t; * kinds of routing tables we have seen so far (5595 and 96x). &n;&t; *&n;&t; * The 96x tends to still come with routing tables that claim&n;&t; * to be 503&squot;s.. Silly thing. Check the actual router chip.&n;&t; */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;PCI: Detecting SiS router at %02x:%02x : SiS096x detected&bslash;n&quot;
comma
id|rt-&gt;rtr_bus
comma
id|rt-&gt;rtr_devfn
...
c_func
(paren
l_string|&quot;PCI: Detecting SiS router at %02x:%02x : SiS5595 detected&bslash;n&quot;
comma
id|rt-&gt;rtr_bus
comma
id|rt-&gt;rtr_devfn

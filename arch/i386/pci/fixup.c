...
DECL|function|pci_fixup_ide_exbar
r_static
r_void
id|__devinit
id|pci_fixup_ide_exbar
c_func
(paren
r_struct
id|pci_dev
...
(brace
multiline_comment|/*&n;&t; * Some new Intel IDE controllers have an EXBAR register for&n;&t; * MMIO instead of PIO. It&squot;s unused, undocumented (though maybe&n;&t; * functional). BIOSes often assign conflicting memory address&n;&t; * to this. Just kill it.&n;&t; */
id|d-&gt;resource
(braket
l_int|5
)braket

...
id|__cacheline_aligned
suffix:semicolon
multiline_comment|/* Per CPU interrupt stacks */
r_extern
r_union
id|thread_union
id|init_irq_union
...
c_func
(paren
l_string|&quot;I can&squot;t seem to allocate my irq stack.  Oh well, giving up.&quot;
)paren
suffix:semicolon
id|irq_stacks
(braket
...
l_int|1
suffix:semicolon
multiline_comment|/* interrupts are not preemptable */
id|p-&gt;thread_info-&gt;irq_stack
op_assign
id|irq_stacks
(braket
id|cpu
...
suffix:semicolon
multiline_comment|/* If we want to make the irq stack more than one unit&n;&t; * deep, we can chain then off of the irq_stack pointer&n;&t; * here.&n;&t; */
)brace
...
suffix:semicolon
multiline_comment|/* The -4 is to correct for the fact that the stack pointer&n;&t; * is used to find the location of the thread_info structure&n;&t; * by masking off several of the LSBs.  Without the -4, esp&n;&t; * is pointing to the page after the one the stack is on.&n;&t; */
id|stack_start.esp
op_assign
(paren
r_void
...
r_static
r_void
DECL|function|flush_tlb_all_function

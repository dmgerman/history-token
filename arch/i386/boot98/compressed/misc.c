...
DECL|macro|STANDARD_MEMORY_BIOS_CALL
macro_line|#undef STANDARD_MEMORY_BIOS_CALL
macro_line|#endif
...
multiline_comment|/* We don&squot;t actually check for stack overflows this early. */
id|__asm__
c_func
(paren
l_string|&quot;.globl mcount ; mcount: ret&bslash;n&quot;
)paren
suffix:semicolon
eof

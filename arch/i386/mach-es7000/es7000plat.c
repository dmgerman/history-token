...
r_int
id|__init
DECL|function|es7000_gsi_override
id|es7000_gsi_override
c_func
(paren
r_int
id|ioapic
...
c_func
(paren
l_string|&quot;es7000_gsi_override: free_irqs = 0x%lx&bslash;n&quot;
comma
id|free_irqs
)paren
suffix:semicolon
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * These should NEVER be true at this point but we&squot;d rather be&n;&t; * safe than sorry.&n;&t; */
r_if
c_cond
(paren
id|acpi_disabled
...
c_func
(paren
l_string|&quot;es7000_rename_gsi: cycle_irqs = 0x%lx&bslash;n&quot;
comma
id|cycle_irqs
)paren
suffix:semicolon

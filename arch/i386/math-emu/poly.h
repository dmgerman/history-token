...
r_volatile
(paren
l_string|&quot;movl %1,%%edi; movl %2,%%esi;&bslash;n&quot;
l_string|&quot;movl (%%esi),%%eax; addl %%eax,(%%edi);&bslash;n&quot;
l_string|&quot;movl 4(%%esi),%%eax; adcl %%eax,4(%%edi);&bslash;n&quot;
l_string|&quot;movl 8(%%esi),%%eax; adcl %%eax,8(%%edi);&bslash;n&quot;
suffix:colon
l_string|&quot;=g&quot;
(paren
op_star
...
r_volatile
(paren
l_string|&quot;movl %2,%%ecx; movl %3,%%esi;&bslash;n&quot;
l_string|&quot;movl (%%esi),%%eax; addl %%eax,(%%ecx);&bslash;n&quot;
l_string|&quot;movl 4(%%esi),%%eax; adcl %%eax,4(%%ecx);&bslash;n&quot;
l_string|&quot;movl 8(%%esi),%%eax; adcl %%eax,8(%%ecx);&bslash;n&quot;
l_string|&quot;jnc 0f;&bslash;n&quot;
l_string|&quot;rcrl 8(%%ecx); rcrl 4(%%ecx); rcrl (%%ecx)&bslash;n&quot;
l_string|&quot;movl %4,%%ecx; incl (%%ecx)&bslash;n&quot;
l_string|&quot;movl $1,%%eax; jmp 1f;&bslash;n&quot;
l_string|&quot;0: xorl %%eax,%%eax;&bslash;n&quot;
l_string|&quot;1:&bslash;n&quot;
suffix:colon
l_string|&quot;=g&quot;
(paren
...
r_volatile
(paren
l_string|&quot;movl %1,%%esi;&bslash;n&quot;
l_string|&quot;xorl %%ecx,%%ecx;&bslash;n&quot;
l_string|&quot;movl %%ecx,%%eax; subl (%%esi),%%eax; movl %%eax,(%%esi);&bslash;n&quot;
l_string|&quot;movl %%ecx,%%eax; sbbl 4(%%esi),%%eax; movl %%eax,4(%%esi);&bslash;n&quot;
l_string|&quot;movl %%ecx,%%eax; sbbl 8(%%esi),%%eax; movl %%eax,8(%%esi);&bslash;n&quot;
suffix:colon
l_string|&quot;=g&quot;
(paren
op_star

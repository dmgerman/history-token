...
DECL|macro|PXA_SSP_PORTS
mdefine_line|#define PXA_SSP_PORTS &t;3
r_static
id|DECLARE_MUTEX
c_func
(paren
...
multiline_comment|/**&n; * ssp_config - configure SSP port settings&n; * @mode: port operating mode&n; * @flags: port config flags&n; * @psp_flags: port PSP config flags&n; * @speed: port speed&n; *&n; * Port MUST be disabled by ssp_disable before making any config changes.&n; */
DECL|function|ssp_config
r_int
id|ssp_config
c_func
(paren
...
c_func
(paren
l_string|&quot;PXA SSP driver&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
l_string|&quot;Liam Girdwood&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

multiline_comment|/*&n; * linux/arch/arm/mach-pxa/leds-idp.c&n; *&n; * Copyright (C) 2000 John Dorsey &lt;john+@cs.cmu.edu&gt;&n; *&n; * Copyright (c) 2001 Jeff Sutherland &lt;jeffs@accelent.com&gt;&n; *&n; * Original (leds-footbridge.c) by Russell King&n; *&n; * Macros for actual LED manipulation should be in machine specific&n; * files in this &squot;mach&squot; directory.&n; */

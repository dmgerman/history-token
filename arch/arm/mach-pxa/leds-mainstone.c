multiline_comment|/*&n; * linux/arch/arm/mach-pxa/leds-mainstone.c&n; *&n; * Author:     Nicolas Pitre&n; * Created:    Nov 05, 2002&n; * Copyright:  MontaVista Software Inc.&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */
...
multiline_comment|/* 8 discrete leds available for general use: */
DECL|macro|D28
...
id|hw_led_state
suffix:semicolon
DECL|function|mainstone_leds_event
r_void
id|mainstone_leds_event
c_func
(paren
id|led_event_t
id|evt

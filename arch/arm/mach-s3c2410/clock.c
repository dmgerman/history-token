...
(paren
id|KERN_INFO
l_string|&quot;S3C2410 Clocks, (c) 2004 Simtec Electronics&bslash;n&quot;
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;failed to register master xtal&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* register clocks from clock array */
r_for
c_loop
(paren
id|ptr
...
multiline_comment|/* S3C2440 extended clock support */
macro_line|#ifdef CONFIG_CPU_S3C2440
DECL|variable|s3c2440_clk_upll
r_static
r_struct
id|clk
id|s3c2440_clk_upll
...
c_func
(paren
l_string|&quot;S3C2440: Clock Support, UPLL %ld.%03ld MHz&bslash;n&quot;
comma
id|print_mhz
c_func
(paren
...
DECL|variable|s3c2440_clk_driver
r_static
r_struct
id|sysdev_driver
id|s3c2440_clk_driver
op_assign
(brace
dot
id|add
...
suffix:semicolon
DECL|function|s3c24xx_clk_driver
r_static
r_int
id|s3c24xx_clk_driver
c_func
(paren
r_void
)paren
...
DECL|variable|s3c24xx_clk_driver
id|arch_initcall
c_func
(paren
id|s3c24xx_clk_driver

...
multiline_comment|/* s3c24xx_init_clocks&n; *&n; * Initialise the clock subsystem and associated information from the&n; * given master crystal value.&n; *&n; * xtal  = 0 -&gt; use default PLL crystal value (normally 12MHz)&n; *      != 0 -&gt; PLL crystal value in Hz&n;*/
DECL|function|s3c24xx_init_clocks
r_void
id|__init
...
c_func
(paren
l_string|&quot;s3c24xx_init_clocks: no cpu setup?&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;s3c24xx_init_clocks: cpu has no clock init&bslash;n&quot;
)paren
suffix:semicolon
r_else
(paren
...
DECL|function|s3c24xx_init_uarts
r_void
id|__init
...
(paren
id|KERN_ERR
l_string|&quot;s3c24xx_init_uarts: cpu has no uart init&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_ERR
l_string|&quot;s3c24xx: failed to add board device %s (%d) @%p&bslash;n&quot;
comma
(paren
op_star
id|ptr

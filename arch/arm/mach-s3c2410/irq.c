...
macro_line|#include &lt;asm/arch/regs-lcd.h&gt;
macro_line|#if 0
...
multiline_comment|/* todo - put type handler in here */
r_static
r_int
...
c_func
(paren
l_string|&quot;s3c_irqext_type: called for irq %d, type %d&bslash;n&quot;
comma
id|irq
comma
id|type
...
suffix:semicolon
singleline_comment|//set_irq_chained_handler(IRQ_LCD, s3c_irq_demux_);
singleline_comment|//set_irq_chained_handler(IRQ_ADCPARENT, s3c_irq_demux_);

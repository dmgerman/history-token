...
mdefine_line|#define umul_ppmm(xh, xl, a, b) &bslash;&n;{register USItype __t0, __t1, __t2;                                     &bslash;&n;  __asm__ (&quot;%@ Inlined umul_ppmm
id|mov
op_mod
l_int|2
comma
...
comma
id|lsr
macro_line|#16&quot;                                    &bslash;&n;           : &quot;=&amp;r&quot; ((USItype) (xh)),                                    &bslash;&n;             &quot;=r&quot; ((USItype) (xl)),                                     &bslash;&n;             &quot;=&amp;r&quot; (__t0), &quot;=&amp;r&quot; (__t1), &quot;=r&quot; (__t2)                    &bslash;&n;           : &quot;r&quot; ((USItype) (a)),                                       &bslash;&n;             &quot;r&quot; ((USItype) (b)));}

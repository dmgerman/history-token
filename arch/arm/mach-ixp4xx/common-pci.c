...
multiline_comment|/*&n; *&t;Generalized PCI config access functions.&n; */
DECL|function|ixp4xx_read_config
r_static
r_int
id|ixp4xx_read_config
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|ixp4xx_write_config
r_static
r_int
id|ixp4xx_write_config
c_func
(paren
r_struct
id|pci_bus

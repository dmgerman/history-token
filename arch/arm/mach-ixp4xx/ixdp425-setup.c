multiline_comment|/*&n; * arch/arm/mach-ixp4xx/ixdp425-setup.c&n; *&n; * IXDP425/IXCDP1100 board-setup &n; *&n; * Copyright (C) 2003-2005 MontaVista Software, Inc.&n; *&n; * Author: Deepak Saxena &lt;dsaxena@plexity.net&gt;&n; */
...
suffix:semicolon
DECL|variable|ixdp425_uart_resources
r_static
r_struct
id|resource
id|ixdp425_uart_resources
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|ixdp425_uart_data
r_static
r_struct
id|plat_serial8250_port
id|ixdp425_uart_data
(braket
)braket
op_assign
(brace

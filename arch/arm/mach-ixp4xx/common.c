...
DECL|enum|ixp4xx_irq_type
r_enum
id|ixp4xx_irq_type
(brace
DECL|enumerator|IXP4XX_IRQ_LEVEL
DECL|enumerator|IXP4XX_IRQ_EDGE
id|IXP4XX_IRQ_LEVEL
comma
id|IXP4XX_IRQ_EDGE
)brace
...
multiline_comment|/*************************************************************************&n; * IXP4xx chipset IRQ handling&n; *&n; * TODO: GPIO IRQs should be marked invalid until the user of the IRQ&n; *       (be it PCI or something else) configures that GPIO line&n; *       as an IRQ.&n; **************************************************************************/
...
multiline_comment|/*&n; * Level triggered interrupts on GPIO lines can only be cleared when the&n; * interrupt condition disappears.&n; */
DECL|function|ixp4xx_irq_level_unmask
r_static
r_void
id|ixp4xx_irq_level_unmask
c_func
(paren
r_int
r_int
...
DECL|variable|ixp4xx_irq_level_chip
r_static
r_struct
id|irqchip
id|ixp4xx_irq_level_chip
op_assign
(brace
dot
id|ack
...
suffix:semicolon
DECL|variable|ixp4xx_irq_edge_chip
r_static
r_struct
id|irqchip
id|ixp4xx_irq_edge_chip
op_assign
(brace
dot
id|ack
...
suffix:semicolon
DECL|function|ixp4xx_config_irq
r_static
r_void
id|ixp4xx_config_irq
c_func
...
multiline_comment|/* Default to all level triggered */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
DECL|variable|ixp46x_i2c_resources
r_static
r_struct
id|resource
...
suffix:semicolon
multiline_comment|/*&n; * I2C controller. The IXP46x uses the same block as the IOP3xx, so&n; * we just use the same device name.&n; */
DECL|variable|ixp46x_i2c_controller
r_static
r_struct
id|platform_device
id|ixp46x_i2c_controller
op_assign
(brace
dot
id|name

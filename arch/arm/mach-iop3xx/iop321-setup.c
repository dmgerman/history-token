...
comma
id|IOP321_PCI_LOWER_IO_PA
comma
id|IOP321_PCI_IO_WINDOW_SIZE
comma
id|MT_DEVICE
)brace
)brace
...
suffix:semicolon
DECL|variable|iop32x_i2c_0_resources
r_static
r_struct
id|resource
id|iop32x_i2c_0_resources
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|iop32x_i2c_1_resources
r_static
r_struct
id|resource
id|iop32x_i2c_1_resources
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|iop32x_i2c_0_controller
r_static
r_struct
id|platform_device
id|iop32x_i2c_0_controller
op_assign
(brace
dot
id|name
...
suffix:semicolon
DECL|variable|iop32x_i2c_1_controller
r_static
r_struct
id|platform_device
id|iop32x_i2c_1_controller
op_assign
(brace
dot
id|name

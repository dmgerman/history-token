multiline_comment|/*&n; * arch/arm/mach-ixp2000/ixdp2x01.c&n; *&n; * Code common to Intel IXDP2401 and IXDP2801 platforms&n; *&n; * Original Author: Andrzej Mialkowski &lt;andrzej.mialkowski@intel.com&gt;&n; * Maintainer: Deepak Saxena &lt;dsaxena@plexity.net&gt;&n; *&n; * Copyright (C) 2002-2003 Intel Corp.&n; * Copyright (C) 2003-2004 MontaVista Software, Inc.&n; *&n; *  This program is free software; you can redistribute  it and/or modify it&n; *  under  the terms of  the GNU General  Public License as published by the&n; *  Free Software Foundation;  either version 2 of the  License, or (at your&n; *  option) any later version.&n; */

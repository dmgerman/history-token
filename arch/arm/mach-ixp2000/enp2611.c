multiline_comment|/*&n; * arch/arm/mach-ixp2000/enp2611.c&n; *&n; * Radisys ENP-2611 support.&n; *&n; * Created 2004 by Lennert Buytenhek from the ixdp2x01 code.  The&n; * original version carries the following notices:&n; *&n; * Original Author: Andrzej Mialkowski &lt;andrzej.mialkowski@intel.com&gt;&n; * Maintainer: Deepak Saxena &lt;dsaxena@plexity.net&gt;&n; *&n; * Copyright (C) 2002-2003 Intel Corp.&n; * Copyright (C) 2003-2004 MontaVista Software, Inc.&n; *&n; *  This program is free software; you can redistribute  it and/or modify it&n; *  under  the terms of  the GNU General  Public License as published by the&n; *  Free Software Foundation;  either version 2 of the  License, or (at your&n; *  option) any later version.&n; */

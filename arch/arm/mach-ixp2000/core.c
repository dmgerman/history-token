...
suffix:semicolon
macro_line|#if defined(CONFIG_ARCH_IXDP2400) || defined (CONFIG_ARCH_IXDP2401)
multiline_comment|/*&n;&t; * Fixup up page table entries to deal with IXP2400 errata&n;&t; * We first fix the small (page size) mappings and&n;&t; * then the large (section size) ones.&n;&t; */
r_if
c_cond
(paren
...
id|elapsed
suffix:semicolon
multiline_comment|/* Get ticks since last perfect jiffy */
id|elapsed
op_assign
id|ticks_per_jiffy
op_minus
...
suffix:semicolon
multiline_comment|/*&n; * Error interrupts. These are used extensively by the microengine drivers&n; */
DECL|function|ixp2000_err_irq_handler
r_static
r_void
id|ixp2000_err_irq_handler
c_func
(paren
r_int
r_int
...
DECL|function|ixp2000_err_irq_mask
r_static
r_void
id|ixp2000_err_irq_mask
c_func
(paren
r_int
r_int
...
DECL|function|ixp2000_err_irq_unmask
r_static
r_void
id|ixp2000_err_irq_unmask
c_func
(paren
r_int
r_int
...
DECL|variable|ixp2000_err_irq_chip
r_static
r_struct
id|irqchip
id|ixp2000_err_irq_chip
op_assign
(brace
dot
id|ack

...
id|elapsed2
suffix:semicolon
multiline_comment|/*&n; &t; * We have two cases to cover, one where we were pending&n;   &t; * already, and another where it overflowed while we were&n;   &t; * checking the timers.&n;   &t; */
r_if
c_cond
(paren
(paren

...
(brace
multiline_comment|/* This is some variant of a comparison (PerformComparison&n;&t;&t;   will sort out which one).  Since most of the other CPRT&n;&t;&t;   instructions are oddball cases of some sort or other it&n;&t;&t;   makes sense to pull this out into a fast path.  */
r_return
id|PerformComparison
c_func
(paren
...
(brace
multiline_comment|/* Fm is a constant.  Do the comparison in whatever precision&n;&t;&t;   Fn happens to be stored in.  */
r_if
c_cond
(paren
id|fpa11-&gt;fType
...
r_else
(brace
multiline_comment|/* Both operands are in registers.  */
r_if
c_cond
(paren
id|fpa11-&gt;fType
...
r_else
(brace
multiline_comment|/* Promote 32-bit operand to 64 bits.  */
id|float64
id|rFm
comma
id|rFn

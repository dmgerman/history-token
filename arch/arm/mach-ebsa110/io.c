...
multiline_comment|/*&n; * We&squot;re addressing an 8 or 16-bit peripheral which tranfers&n; * odd addresses on the low ISA byte lane.&n; */
DECL|function|__inb8
id|u8
id|__inb8
c_func
(paren
...
multiline_comment|/*&n; * We&squot;re addressing a 16-bit peripheral which transfers odd&n; * addresses on the high ISA byte lane.&n; */
DECL|function|__inb16
id|u8
id|__inb16
c_func
(paren
...
multiline_comment|/*&n; * Fake a 32-bit read with two 16-bit reads.  Needed for 3c589.&n; */
DECL|function|__inl
id|u32
id|__inl
c_func
...
suffix:semicolon
multiline_comment|/*&n; * We implement these as 16-bit insw/outsw, mainly for&n; * 3c589 cards.&n; */
DECL|function|outsl
r_void
id|outsl
c_func

...
id|dma_ptr
suffix:semicolon
multiline_comment|/* current DMA pointer position */
DECL|member|ref
r_int
id|ref
suffix:semicolon
...
multiline_comment|/*&n; * Get dma list&n; * for /proc/dma&n; */
DECL|function|sa1100_get_dma_list
r_int
id|sa1100_get_dma_list
c_func
(paren
r_char
op_star
...
(paren
id|KERN_ERR
l_string|&quot;%s: no free DMA channel available&bslash;n&quot;
comma
id|device_id
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: unable to request IRQ %d for DMA channel %d&bslash;n&quot;
comma
id|device_id
comma
id|dma-&gt;irq
...
DECL|function|sa1100_dma_set_device
r_int
...
suffix:semicolon
DECL|variable|sa1100_dma_set_device
id|EXPORT_SYMBOL
c_func
(paren
id|sa1100_dma_set_device

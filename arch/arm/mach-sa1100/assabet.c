...
multiline_comment|/*&n; * Assabet flash support code.&n; */
...
suffix:semicolon
multiline_comment|/*&n; * Assabet IrDA support code.&n; */
DECL|function|assabet_irda_set_power
r_static
r_int
id|assabet_irda_set_power
c_func
(paren
r_struct
id|device
...
DECL|function|assabet_irda_set_speed
r_static
r_void
id|assabet_irda_set_speed
c_func
(paren
r_struct
id|device
...
DECL|variable|assabet_irda_data
r_static
r_struct
id|irda_platform_data
id|assabet_irda_data
op_assign
(brace
dot
id|set_power

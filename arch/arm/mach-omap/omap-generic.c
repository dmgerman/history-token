multiline_comment|/*&n; * linux/arch/arm/mach-omap/generic.c&n; *&n; * Modified from innovator.c&n; *&n; * Code for generic OMAP board. Should work on many OMAP systems where&n; * the device drivers take care of all the necessary hardware initialization.&n; * Do not put any board specific code to this file; create a new machine&n; * type if you need custom low-level initializations.&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */

...
mdefine_line|#define OMAP_MPUIO_MASK         (~OMAP_MAX_GPIO_LINES &amp; 0xff)
...
id|reg
op_add_assign
id|OMAP_MPUIO_GPIO_INT_EDGE_REG
suffix:semicolon
id|l
op_assign
id|omap_readl
...
multiline_comment|/* Enable system clock for GPIO module.&n;&t; * The CAM_CLK_CTRL_REG *is* really the right place. */
r_if
c_cond
(paren
id|cpu_is_omap1610

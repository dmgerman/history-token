...
DECL|function|omap_set_dma_constant_fill
r_void
...
(paren
id|KERN_ERR
l_string|&quot;OMAP DMA constant fill not available in 1510 mode.&quot;
)paren
suffix:semicolon
id|BUG
c_func
...
DECL|function|omap_set_dma_transparent_copy
r_void
...
(paren
id|KERN_ERR
l_string|&quot;OMAP DMA transparent copy not available in 1510 mode.&quot;
)paren
suffix:semicolon
id|BUG
c_func
...
id|next_lch
suffix:semicolon
multiline_comment|/* Enable the queue, if needed so. */
r_if
c_cond
(paren
id|next_lch
...
suffix:semicolon
multiline_comment|/* The loop case */
r_if
c_cond
(paren
id|dma_chan
...
id|next_lch
suffix:semicolon
multiline_comment|/*&n;&t; * According to thw HW spec, enabling the STOP_LNK bit&n;&t; * resets the CCR_EN bit at the same time.&n;&t; */
id|w
op_assign
id|omap_readw
c_func
...
suffix:semicolon
DECL|variable|omap_set_dma_constant_fill
id|EXPORT_SYMBOL
c_func
(paren
id|omap_set_dma_constant_fill
...
suffix:semicolon
DECL|variable|omap_set_dma_transparent_copy
id|EXPORT_SYMBOL
c_func
(paren
id|omap_set_dma_transparent_copy

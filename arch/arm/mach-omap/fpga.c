multiline_comment|/*&n; * linux/arch/arm/mach-omap/fpga.c&n; *&n; * Interrupt handler for OMAP-1510 Innovator FPGA&n; *&n; * Copyright (C) 2001 RidgeRun, Inc.&n; * Author: Greg Lonnon &lt;glonnon@ridgerun.com&gt;&n; *&n; * Copyright (C) 2002 MontaVista Software, Inc.&n; *&n; * Separated FPGA interrupts from innovator1510.c and cleaned up for 2.6&n; * Copyright (C) 2004 Nokia Corporation by Tony Lindrgen &lt;tony@atomide.com&gt;&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */
...
DECL|function|omap1510_fpga_init_irq
r_void
...
c_func
(paren
id|OMAP1510_INT_FPGA
comma
id|innovator_fpga_IRQ_demux
)paren
suffix:semicolon
)brace
DECL|variable|omap1510_fpga_init_irq
id|EXPORT_SYMBOL
c_func
(paren
id|omap1510_fpga_init_irq

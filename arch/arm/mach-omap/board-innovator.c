...
suffix:semicolon
DECL|variable|innovator_partitions
r_static
r_struct
id|mtd_partition
id|innovator_partitions
(braket
)braket
op_assign
(brace
...
comma
multiline_comment|/* rest of flash1 is a file system */
(brace
dot
id|name
op_assign
...
suffix:semicolon
DECL|variable|innovator_flash_data
r_static
r_struct
id|flash_platform_data
id|innovator_flash_data
op_assign
(brace
dot
id|map_name
...
suffix:semicolon
DECL|variable|innovator_flash_resource
r_static
r_struct
id|resource
id|innovator_flash_resource
op_assign
(brace
dot
id|start
...
suffix:semicolon
DECL|variable|innovator_flash_device
r_static
r_struct
id|platform_device
id|innovator_flash_device
op_assign
(brace
dot
id|name
...
DECL|function|innovator_init_smc91x
r_static
r_void
id|__init
id|innovator_init_smc91x
c_func
(paren
r_void
)paren

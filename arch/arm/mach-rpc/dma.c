...
id|DMA_ST_OFL
suffix:colon
multiline_comment|/* OIA */
r_case
id|DMA_ST_AB
suffix:colon
multiline_comment|/* .IB */
id|iomd_writel
c_func
(paren
id|dma-&gt;cur_sg.dma_address
comma
id|base
op_plus
id|CURA
...
id|DMA_ST_AB
suffix:colon
multiline_comment|/* OIB */
r_case
l_int|0
suffix:colon
multiline_comment|/* .IA */
id|iomd_writel
c_func
(paren
id|dma-&gt;cur_sg.dma_address

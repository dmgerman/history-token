...
(paren
id|KERN_INFO
l_string|&quot;sa1111_dmabuf: sbp: %lu, lbp: %lu, other: %lu, total: %lu&bslash;n&quot;
comma
id|sbp_allocs
comma
id|lbp_allocs
...
(paren
id|KERN_ERR
l_string|&quot;sa1111_dmabuf: could not allocate small pci pool&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;sa1111_dmabuf: could not allocate large pci pool&bslash;n&quot;
)paren
suffix:semicolon
id|dma_pool_destroy
c_func
...
(paren
id|KERN_INFO
l_string|&quot;SA1111: DMA buffer sizes: small=%u, large=%u&bslash;n&quot;
comma
id|SIZE_SMALL
comma
id|SIZE_LARGE
...
(paren
id|KERN_INFO
l_string|&quot;sa1111_dmabuf: map_op_count=%lu, bounce_count=%lu&bslash;n&quot;
comma
id|map_op_count
comma
id|bounce_count
...
id|dev
comma
l_string|&quot;%s: unsafe buffer %p (phy=%08lx) mapped to %p (phy=%08x)&bslash;n&quot;
comma
id|__func__
comma
id|buf-&gt;ptr
...
id|dev
comma
l_string|&quot;%s: unsafe buffer %p (phy=%08lx) mapped to %p (phy=%08lx)&bslash;n&quot;
comma
id|__func__
comma
id|buf-&gt;ptr
...
id|dev
comma
l_string|&quot;%s(ptr=%08lx,size=%d,dir=%x)&bslash;n&quot;
comma
id|__func__
comma
id|dma_addr
...
DECL|function|sa1111_dma_sync_single_for_cpu
r_void
id|sa1111_dma_sync_single_for_cpu
c_func
(paren
r_struct
id|device
...
DECL|function|sa1111_dma_sync_single_for_device
r_void
id|sa1111_dma_sync_single_for_device
c_func
(paren
r_struct
id|device
...
DECL|function|sa1111_dma_sync_sg_for_cpu
r_void
id|sa1111_dma_sync_sg_for_cpu
c_func
(paren
r_struct
id|device
...
DECL|function|sa1111_dma_sync_sg_for_device
r_void
id|sa1111_dma_sync_sg_for_device
c_func
(paren
r_struct
id|device
...
suffix:semicolon
DECL|variable|sa1111_dma_sync_single_for_cpu
id|EXPORT_SYMBOL
c_func
(paren
id|sa1111_dma_sync_single_for_cpu
...
suffix:semicolon
DECL|variable|sa1111_dma_sync_single_for_device
id|EXPORT_SYMBOL
c_func
(paren
id|sa1111_dma_sync_single_for_device
...
suffix:semicolon
DECL|variable|sa1111_dma_sync_sg_for_cpu
id|EXPORT_SYMBOL
c_func
(paren
id|sa1111_dma_sync_sg_for_cpu
...
suffix:semicolon
DECL|variable|sa1111_dma_sync_sg_for_device
id|EXPORT_SYMBOL
c_func
(paren
id|sa1111_dma_sync_sg_for_device
...
suffix:semicolon
multiline_comment|/* **************************************** */
DECL|function|sa1111_dmabuf_init
r_static
r_int
id|__init
id|sa1111_dmabuf_init
c_func
(paren
r_void
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;sa1111_dmabuf: initializing SA-1111 DMA buffers&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|create_safe_buffer_pools
...
DECL|variable|sa1111_dmabuf_init
id|module_init
c_func
(paren
id|sa1111_dmabuf_init
...
suffix:semicolon
DECL|function|sa1111_dmabuf_exit
r_static
r_void
id|__exit
id|sa1111_dmabuf_exit
c_func
(paren
r_void
)paren
...
DECL|variable|sa1111_dmabuf_exit
id|module_exit
c_func
(paren
id|sa1111_dmabuf_exit
...
c_func
(paren
l_string|&quot;Special dma_{map/unmap/dma_sync}_* routines for SA-1111.&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

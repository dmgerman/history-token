multiline_comment|/*&n;  NOTE:&n;&n;  this code was lifted straight out of drivers/pci/pci.c;&n;  when compiling for the Intel StrongARM SA-1110/SA-1111 the&n;  usb-ohci.c driver needs these routines even when the architecture&n;  has no pci bus...&n;*/

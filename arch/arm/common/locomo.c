...
multiline_comment|/* M62332 output channel selection */
DECL|macro|M62332_EVR_CH
mdefine_line|#define M62332_EVR_CH&t;1&t;/* M62332 volume channel number  */
multiline_comment|/*   0 : CH.1 , 1 : CH. 2        */
multiline_comment|/* DAC send data */
DECL|macro|M62332_SLAVE_ADDR
mdefine_line|#define&t;M62332_SLAVE_ADDR&t;0x4e&t;/* Slave address  */
DECL|macro|M62332_W_BIT
mdefine_line|#define&t;M62332_W_BIT&t;&t;0x00&t;/* W bit (0 only) */
DECL|macro|M62332_SUB_ADDR
mdefine_line|#define&t;M62332_SUB_ADDR&t;&t;0x00&t;/* Sub address    */
DECL|macro|M62332_A_BIT
mdefine_line|#define&t;M62332_A_BIT&t;&t;0x00&t;/* A bit (0 only) */
multiline_comment|/* DAC setup and hold times (expressed in us) */
DECL|macro|DAC_BUS_FREE_TIME
mdefine_line|#define DAC_BUS_FREE_TIME&t;5&t;/*   4.7 us */
DECL|macro|DAC_START_SETUP_TIME
mdefine_line|#define DAC_START_SETUP_TIME&t;5&t;/*   4.7 us */
DECL|macro|DAC_STOP_SETUP_TIME
mdefine_line|#define DAC_STOP_SETUP_TIME&t;4&t;/*   4.0 us */
DECL|macro|DAC_START_HOLD_TIME
mdefine_line|#define DAC_START_HOLD_TIME&t;5&t;/*   4.7 us */
DECL|macro|DAC_SCL_LOW_HOLD_TIME
mdefine_line|#define DAC_SCL_LOW_HOLD_TIME&t;5&t;/*   4.7 us */
DECL|macro|DAC_SCL_HIGH_HOLD_TIME
mdefine_line|#define DAC_SCL_HIGH_HOLD_TIME&t;4&t;/*   4.0 us */
DECL|macro|DAC_DATA_SETUP_TIME
mdefine_line|#define DAC_DATA_SETUP_TIME&t;1&t;/*   250 ns */
DECL|macro|DAC_DATA_HOLD_TIME
mdefine_line|#define DAC_DATA_HOLD_TIME&t;1&t;/*   300 ns */
DECL|macro|DAC_LOW_SETUP_TIME
mdefine_line|#define DAC_LOW_SETUP_TIME&t;1&t;/*   300 ns */
DECL|macro|DAC_HIGH_SETUP_TIME
mdefine_line|#define DAC_HIGH_SETUP_TIME&t;1&t;/*  1000 ns */
...
suffix:semicolon
multiline_comment|/* All the locomo devices.  If offset is non-zero, the mapbase for the&n; * locomo_dev will be set to the chip base plus offset.  If offset is&n; * zero, then the mapbase for the locomo_dev will be set to zero.  An&n; * offset of zero means the device only uses GPIOs or other helper&n; * functions inside this file */
...
id|name
op_assign
l_string|&quot;locomo-frontlight&quot;
comma
dot
id|offset
op_assign
id|LOCOMO_FRONTLIGHT
comma
dot
id|length
op_assign
...
DECL|function|locomo_gpio_set_dir
r_void
...
DECL|function|locomo_gpio_read_level
r_int
r_int
...
DECL|function|locomo_gpio_read_output
r_int
r_int
...
DECL|function|locomo_gpio_write
r_void
...
DECL|function|locomo_m62332_sendbit
r_static
r_void
id|locomo_m62332_sendbit
c_func
(paren
r_void
op_star
...
c_func
(paren
id|DAC_LOW_SETUP_TIME
)paren
suffix:semicolon
multiline_comment|/* 300 nsec */
id|udelay
c_func
(paren
id|DAC_DATA_HOLD_TIME
)paren
suffix:semicolon
multiline_comment|/* 300 nsec */
id|r
...
c_func
(paren
id|DAC_SCL_LOW_HOLD_TIME
)paren
suffix:semicolon
multiline_comment|/* 4.7 usec */
r_if
c_cond
(paren
id|bit
...
c_func
(paren
id|DAC_HIGH_SETUP_TIME
)paren
suffix:semicolon
multiline_comment|/* 1000 nsec */
)brace
r_else
(brace
id|r
...
c_func
(paren
id|DAC_DATA_SETUP_TIME
)paren
suffix:semicolon
multiline_comment|/* 250 nsec */
id|r
op_assign
id|locomo_readl
c_func
...
c_func
(paren
id|DAC_SCL_HIGH_HOLD_TIME
)paren
suffix:semicolon
multiline_comment|/*  4.0 usec */
)brace
DECL|function|locomo_m62332_senddata
r_void
...
c_func
(paren
id|DAC_BUS_FREE_TIME
)paren
suffix:semicolon
multiline_comment|/* 5.0 usec */
id|r
op_assign
id|locomo_readl
c_func
...
suffix:semicolon
multiline_comment|/* 300 nsec */
multiline_comment|/* Send slave address and W bit (LSB is W bit) */
id|data
op_assign
(paren
id|M62332_SLAVE_ADDR
op_lshift
l_int|1
)paren
op_or
...
(brace
multiline_comment|/* High is error */
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;locomo: m62332_senddata Error 1&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
)brace
multiline_comment|/* Send Sub address (LSB is channel select) */
multiline_comment|/*    channel = 0 : ch1 select              */
multiline_comment|/*            = 1 : ch2 select              */
id|data
op_assign
id|M62332_SUB_ADDR
op_plus
...
(paren
id|KERN_WARNING
l_string|&quot;locomo: m62332_senddata Error 2&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
)brace
multiline_comment|/* Send DAC data */
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_WARNING
l_string|&quot;locomo: m62332_senddata Error 3&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
suffix:semicolon
DECL|variable|locomo_gpio_set_dir
id|EXPORT_SYMBOL
c_func
(paren
id|locomo_gpio_set_dir
...
suffix:semicolon
DECL|variable|locomo_gpio_read_level
id|EXPORT_SYMBOL
c_func
(paren
id|locomo_gpio_read_level
...
suffix:semicolon
DECL|variable|locomo_gpio_read_output
id|EXPORT_SYMBOL
c_func
(paren
id|locomo_gpio_read_output
...
suffix:semicolon
DECL|variable|locomo_gpio_write
id|EXPORT_SYMBOL
c_func
(paren
id|locomo_gpio_write
...
suffix:semicolon
DECL|variable|locomo_m62332_senddata
id|EXPORT_SYMBOL
c_func
(paren
id|locomo_m62332_senddata

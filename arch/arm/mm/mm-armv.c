...
multiline_comment|/*&n; * PTE table allocation cache.&n; *&n; * This is a move away from our custom 2K page allocator.  We now use the&n; * slab cache to keep track of these objects.&n; *&n; * With this, it is questionable as to whether the PGT cache gains us&n; * anything.  We may be better off dropping the PTE stuff from our PGT&n; * cache implementation.&n; */
DECL|variable|pte_cache
id|kmem_cache_t
op_star
id|pte_cache
suffix:semicolon
multiline_comment|/*&n; * The constructor gets called for each object within the cache when the&n; * cache page is created.  Note that if slab tries to misalign the blocks,&n; * we BUG() loudly.&n; */

...
comma
macro_line|#ifndef CONFIG_CPU_DCACHE_WRITETHROUGH
(brace
l_string|&quot;writeback&quot;
comma
l_int|0
...
multiline_comment|/*&n;&t; * ARMv6 can map the vectors as write-through.&n;&t; */
r_if
c_cond
(paren
id|cpu_arch
...
id|policy
op_assign
l_string|&quot;write back, write allocate&quot;
suffix:semicolon
r_break
suffix:semicolon
)brace

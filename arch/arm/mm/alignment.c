multiline_comment|/*&n; *  linux/arch/arm/mm/alignment.c&n; *&n; *  Copyright (C) 1995  Linus Torvalds&n; *  Modifications for ARM processor (c) 1995-2001 Russell King&n; *  Thumb aligment fault fixups (c) 2004 MontaVista Software, Inc.&n; *  - Adapted from gdb/sim/arm/thumbemu.c -- Thumb instruction emulation.&n; *    Copyright (C) 1996, Cygnus Software Technologies Ltd.&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */
...
DECL|macro|BE
mdefine_line|#define BE&t;&t;1
DECL|macro|FIRST_BYTE_16
mdefine_line|#define FIRST_BYTE_16&t;&quot;mov&t;%1, %1, ror #8&bslash;n&quot;
DECL|macro|FIRST_BYTE_32
mdefine_line|#define FIRST_BYTE_32&t;&quot;mov&t;%1, %1, ror #24&bslash;n&quot;
DECL|macro|NEXT_BYTE
mdefine_line|#define NEXT_BYTE&t;&quot;ror #24&quot;
macro_line|#else
DECL|macro|BE
mdefine_line|#define BE&t;&t;0
DECL|macro|FIRST_BYTE_16
mdefine_line|#define FIRST_BYTE_16
DECL|macro|FIRST_BYTE_32
mdefine_line|#define FIRST_BYTE_32
DECL|macro|NEXT_BYTE
mdefine_line|#define NEXT_BYTE&t;&quot;lsr #8&quot;
macro_line|#endif
...
mdefine_line|#define __get32_unaligned_check(ins,val,addr)&t;&t;&t;&bslash;&n;&t;do {&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;unsigned int err = 0, v, a = addr;&t;&t;&bslash;&n;&t;&t;__get8_unaligned_check(ins,v,a,err);&t;&t;&bslash;&n;&t;&t;val =  v &lt;&lt; ((BE) ? 24 :  0);&t;&t;&t;&bslash;&n;&t;&t;__get8_unaligned_check(ins,v,a,err);&t;&t;&bslash;&n;&t;&t;val |= v &lt;&lt; ((BE) ? 16 :  8);&t;&t;&t;&bslash;&n;&t;&t;__get8_unaligned_check(ins,v,a,err);&t;&t;&bslash;&n;&t;&t;val |= v &lt;&lt; ((BE) ?  8 : 16);&t;&t;&t;&bslash;&n;&t;&t;__get8_unaligned_check(ins,v,a,err);&t;&t;&bslash;&n;&t;&t;val |= v &lt;&lt; ((BE) ?  0 : 24);&t;&t;&t;&bslash;&n;&t;&t;if (err)&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;goto fault;&t;&t;&t;&t;&bslash;&n;&t;} while (0)
...
multiline_comment|/*&n; * Convert Thumb ld/st instruction forms to equivalent ARM instructions so&n; * we can reuse ARM userland alignment fault fixups for Thumb.&n; *&n; * This implementation was initially based on the algorithm found in&n; * gdb/sim/arm/thumbemu.c. It is basically just a code reduction of same&n; * to convert only Thumb ld/st instruction forms to equivalent ARM forms.&n; *&n; * NOTES:&n; * 1. Comments below refer to ARM ARM DDI0100E Thumb Instruction sections.&n; * 2. If for some reason we&squot;re passed an non-ld/st Thumb instruction to&n; *    decode, we return 0xdeadc0de. This should never happen under normal&n; *    circumstances but if it does, we&squot;ve got other problems to deal with&n; *    elsewhere and we obviously can&squot;t fix those problems here.&n; */
r_static
r_int
r_int
DECL|function|thumb2arm
id|thumb2arm
c_func
(paren
id|u16
...
(brace
multiline_comment|/* 6.5.1 Format 1: */
r_case
l_int|0x6000
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.52 STR(1) */
r_case
l_int|0x6800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.26 LDR(1) */
r_case
l_int|0x7000
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.55 STRB(1) */
r_case
l_int|0x7800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.30 LDRB(1) */
r_return
l_int|0xe5800000
op_or
(paren
...
l_int|11
suffix:colon
multiline_comment|/* 7.1.57 STRH(1) */
r_case
l_int|0x8800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.32 LDRH(1) */
r_return
l_int|0xe1c000b0
op_or
(paren
...
suffix:semicolon
multiline_comment|/* immed_5[4:3] */
multiline_comment|/* 6.5.1 Format 2: */
r_case
l_int|0x5000
op_rshift
l_int|11
...
l_int|0xe7800000
comma
multiline_comment|/* 7.1.53 STR(2) */
l_int|0xe18000b0
comma
multiline_comment|/* 7.1.58 STRH(2) */
l_int|0xe7c00000
comma
multiline_comment|/* 7.1.56 STRB(2) */
l_int|0xe19000d0
comma
multiline_comment|/* 7.1.34 LDRSB */
l_int|0xe7900000
comma
multiline_comment|/* 7.1.27 LDR(2) */
l_int|0xe19000b0
comma
multiline_comment|/* 7.1.33 LDRH(2) */
l_int|0xe7d00000
comma
multiline_comment|/* 7.1.31 LDRB(2) */
l_int|0xe19000f0
multiline_comment|/* 7.1.35 LDRSH */
)brace
suffix:semicolon
r_return
id|subset
...
suffix:semicolon
multiline_comment|/* Rm */
)brace
multiline_comment|/* 6.5.1 Format 3: */
r_case
l_int|0x4800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.28 LDR(3) */
multiline_comment|/* NOTE: This case is not technically possible. We&squot;re&n;&t;&t; * &t; loading 32-bit memory data via PC relative&n;&t;&t; *&t; addressing mode. So we can and should eliminate&n;&t;&t; *&t; this case. But I&squot;ll leave it here for now.&n;&t;&t; */
r_return
l_int|0xe59f0000
op_or
(paren
...
suffix:semicolon
multiline_comment|/* immed_8 */
multiline_comment|/* 6.5.1 Format 4: */
r_case
l_int|0x9000
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.54 STR(3) */
r_case
l_int|0x9800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.29 LDR(4) */
r_return
l_int|0xe58d0000
op_or
(paren
...
suffix:semicolon
multiline_comment|/* immed_8 */
multiline_comment|/* 6.6.1 Format 1: */
r_case
l_int|0xc000
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.51 STMIA */
r_case
l_int|0xc800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.25 LDMIA */
(brace
id|u32
id|Rn
op_assign
...
multiline_comment|/* 6.6.1 Format 2: */
r_case
l_int|0xb000
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.48 PUSH */
r_case
l_int|0xb800
op_rshift
l_int|11
suffix:colon
multiline_comment|/* 7.1.47 POP */
r_if
c_cond
(paren
(paren
...
l_int|0xe92d0000
comma
multiline_comment|/* STMDB sp!,{registers} */
l_int|0xe92d4000
comma
multiline_comment|/* STMDB sp!,{registers,lr} */
l_int|0xe8bd0000
comma
multiline_comment|/* LDMIA sp!,{registers} */
l_int|0xe8bd8000
multiline_comment|/* LDMIA sp!,{registers,pc} */
)brace
suffix:semicolon
r_return
id|subset
...
suffix:semicolon
multiline_comment|/* register_list */
)brace
multiline_comment|/* Else fall through for illegal instruction case */
r_default
suffix:colon
r_return
l_int|0xdeadc0de
...
l_string|&quot;%0*lx at [&lt;%08lx&gt;]&bslash;n&quot;
comma
id|thumb_mode
c_func
(paren
...
c_func
(paren
l_string|&quot;Alignment trap: %s (%d) PC=0x%08lx Instr=0x%0*lx &quot;

...
multiline_comment|/*&n; * 32-bit misaligned trap handler (c) 1998 San Mehat (CCC) -July 1998&n; * /proc/sys/debug/alignment, modified and integrated into&n; * Linux 2.1 by Russell King&n; *&n; * Speed optimisations and better fault handling by Russell King.&n; *&n; * NOTE!!! This is not portable onto the ARM6/ARM7 processors yet.  Also,&n; * it seems to give a severe performance impact (1 abort/ms - NW runs at&n; * ARM6 speeds) with GCC 2.7.2.2 - needs checking with a later GCC/EGCS.&n; */

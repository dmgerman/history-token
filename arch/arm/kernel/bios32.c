...
id|IORESOURCE_MEM
suffix:semicolon
multiline_comment|/* Turn off downsteam prefetchable memory address range */
id|bus-&gt;resource
(braket
l_int|2
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t; * Claim the currently allocated resources.  This ensures&n;&t; * that we will not allocate an already inuse region.&n;&t; */
id|pcibios_claim_resources
c_func
(paren
)paren

...
multiline_comment|/* ATPCS B01 mandates 8-byte alignment */
r_return
(paren
r_void
op_star
...
id|sig
suffix:semicolon
multiline_comment|/*&n;&t; * For realtime signals we must also set the second and third&n;&t; * arguments for the signal handler.&n;&t; *   -- Peter Maydell &lt;pmaydell@chiark.greenend.org.uk&gt; 2000-12-06&n;&t; */
id|regs-&gt;ARM_r1
op_assign
(paren
r_int

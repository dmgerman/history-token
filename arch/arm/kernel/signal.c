...
(brace
multiline_comment|/* Let&squot;s make sure the user mapping won&squot;t disappear under us */
r_struct
id|mm_struct
op_star
id|mm
...
(brace
multiline_comment|/* our user area has gone before grabbing the lock */
id|spin_unlock
c_func
(paren
op_amp

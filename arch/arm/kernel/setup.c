...
multiline_comment|/*&n; * This is the core tag table; these are the tags&n; * that we recognise for any machine type.&n; */
...
suffix:semicolon
multiline_comment|/*&n; * Scan one tag table for this tag, and call its parse function.&n; */
r_static
r_int
id|__init
...
(brace
multiline_comment|/*&n;&t; * The tag list is terminated with a zero-sized tag.  Size is&n;&t; * defined to be in units of 32-bit quantities.&n;&t; */
r_for
c_loop
(paren
suffix:semicolon
...
id|params
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Is the first tag the CORE tag?  This differentiates&n;&t;&t; * between the tag list and the parameter table.&n;&t;&t; */
r_if
c_cond
(paren
id|tag-&gt;hdr.tag

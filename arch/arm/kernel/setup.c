...
suffix:semicolon
multiline_comment|/*&n; * Pick out the memory size.  We look for mem=size@start,&n; * where start and size are &quot;size[KkMm]&quot;&n; */
DECL|function|early_mem
r_static
r_void
id|__init
id|early_mem
...
id|start
suffix:semicolon
multiline_comment|/*&n;&t; * If the user specifies memory size, we&n;&t; * blow away any automatically generated&n;&t; * size.&n;&t; */
r_if
c_cond
(paren
id|usermem
...
suffix:semicolon
multiline_comment|/*&n; * Initial parsing of the command line.&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;ATAG_INITRD is deprecated; &quot;
l_string|&quot;please update your bootloader.&bslash;n&quot;
)paren
suffix:semicolon
id|phys_initrd_start
op_assign
...
id|__initdata
suffix:semicolon
DECL|function|customize_machine
r_static
r_int
id|__init
id|customize_machine
c_func
(paren
r_void
)paren
(brace
multiline_comment|/* customizes platform devices, or adds new ones */
r_if
c_cond
(paren
id|init_machine
...
DECL|variable|customize_machine
id|arch_initcall
c_func
(paren
id|customize_machine

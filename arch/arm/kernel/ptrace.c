...
multiline_comment|/*&n; * Get the child iWMMXt state.&n; */
DECL|function|ptrace_getwmmxregs
r_static
r_int
id|ptrace_getwmmxregs
c_func
(paren
r_struct
id|task_struct
...
suffix:semicolon
multiline_comment|/* force it to ram */
multiline_comment|/* The iWMMXt state is stored doubleword-aligned.  */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; * Set the child iWMMXt state.&n; */
DECL|function|ptrace_setwmmxregs
r_static
r_int
id|ptrace_setwmmxregs
c_func
(paren
r_struct
id|task_struct

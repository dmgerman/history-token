...
c_func
(paren
l_string|&quot;IRQ%u: moving from cpu%u to cpu%u&bslash;n&quot;
comma
id|irq
comma
id|desc-&gt;cpu
...
(brace
macro_line|#if defined(CONFIG_SMP) &amp;&amp; defined(CONFIG_PROC_FS)
r_struct
id|proc_dir_entry
op_star
id|dir

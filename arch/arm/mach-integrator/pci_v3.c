...
DECL|macro|SC_PCI
mdefine_line|#define SC_PCI     (IO_ADDRESS(INTEGRATOR_SC_PCIENABLE))
...
suffix:semicolon
multiline_comment|/*&n;&t; * Clear any error conditions.&n;&t; */
id|__raw_writel
c_func
(paren
l_int|3
...
c_func
(paren
l_string|&quot;LB_CFG: %04x LB_ISTAT: %02x LB_IMASK: %02x&bslash;n&quot;
comma
id|v3_readw
c_func
(paren

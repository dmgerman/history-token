...
id|cm_osc
suffix:semicolon
multiline_comment|/*&n;&t; * Save this threads cpus_allowed mask, and bind to the&n;&t; * specified CPU.  When this call returns, we should be&n;&t; * running on the right CPU.&n;&t; */
id|cpus_allowed
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;CPU: unable to allocate cpufreqs structure&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

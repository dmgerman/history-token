...
DECL|function|tlb_batch_rtrap_debug
r_void
id|tlb_batch_rtrap_debug
c_func
(paren
r_struct
id|pt_regs
...
(brace
multiline_comment|/* If we are returning to userspace and have pending&n;&t; * tlb batch work on this processor, all hope is lost.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

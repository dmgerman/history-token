...
l_int|0
suffix:semicolon
multiline_comment|/* On UltraSPARC-III+ and later, configure the second half of&n;&t; * the Data-TLB for huge pages.&n;&t; */
r_if
c_cond
(paren
id|tlb_type
...
(brace
multiline_comment|/* When changing the page size fields, we&n;&t;&t;&t; * must perform a context flush so that no&n;&t;&t;&t; * stale entries match.  This flush must&n;&t;&t;&t; * occur with the original context register&n;&t;&t;&t; * settings.&n;&t;&t;&t; */
id|do_flush_tlb_mm
c_func
(paren
id|mm
...
suffix:semicolon
multiline_comment|/* Reload the context register of all processors&n;&t;&t;&t; * also executing in this address space.&n;&t;&t;&t; */
id|mm-&gt;context.sparc64_ctx_val
op_assign
id|ctx
suffix:semicolon

...
mdefine_line|#define set_utsfield(to, from, dotchop, countfrom) &bslash;&n;&t;__set_utsfield((to), sizeof(to), &bslash;&n;&t;&t;       (from), sizeof(from), &bslash;&n;&t;&t;       (dotchop), (countfrom))

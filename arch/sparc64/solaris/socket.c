multiline_comment|/* $Id: socket.c,v 1.6 2002/02/08 03:57:14 davem Exp $&n; * socket.c: Socket syscall emulation for Solaris 2.6+&n; *&n; * Copyright (C) 1998 Jakub Jelinek (jj@ultra.linux.cz)&n; *&n; * 1999-08-19 Fixed socketpair code &n; *            Jason Rappleye (rappleye@ccr.buffalo.edu)&n; */

...
suffix:semicolon
macro_line|#warning DaveM, reminder, Tomatillo support is hosed.
macro_line|#if 0
multiline_comment|/* Crap how to do this in 2.5.x?  I need the pdev :(&n;&t;&t; * Actually, just move over to more sane domain&n;&t;&t; * support to deal with this. -DaveM&n;&t;&t; */
r_if
c_cond
(paren
id|where
...
c_func
(paren
l_string|&quot;PCI: One PCI bus module of controller found.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;%s: Local PCI config space at %016lx&bslash;n&quot;
comma
id|pbm-&gt;name
comma
id|pbm-&gt;config_space
...
id|tmp
op_or_assign
id|SCHIZO_PCICTRL_ARB_T
suffix:semicolon
r_else
id|tmp
op_or_assign
id|SCHIZO_PCICTRL_ARB_S
suffix:semicolon
r_if
c_cond
(paren
...
(brace
macro_line|#if 0
multiline_comment|/* This is the recommended setting, but we&squot;ll just&n;&t;&t; * leave the value alone for now.&n;&t;&t; */
id|tmp
op_and_assign
op_complement
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* XXX Prefetch settings? */
)brace
r_else
(brace
id|tmp
...
suffix:semicolon
multiline_comment|/* Leave this at OBP initialized value on Tomatillo.  */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Disable TTO error reporting (won&squot;t happen anyway since we&n;&t;&t; * disabled the PCI interval timer above) and retry arbitration&n;&t;&t; * (can cause hangs in some Schizo revisions).&n;&t;&t; */
id|tmp
op_assign
id|schizo_read
c_func
...
c_func
(paren
l_string|&quot;%s: Fatal memory allocation error.&bslash;n&quot;
comma
id|chipset_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;PCI: Found %s, Port ID %x, control regs at %016lx&bslash;n&quot;
comma
id|chipset_name
comma
id|p-&gt;portid

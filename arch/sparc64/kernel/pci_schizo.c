...
l_int|4
suffix:semicolon
multiline_comment|/* On Schizo, no inofixup occurs.  This is because each&n;&t; * INO has it&squot;s own IMAP register.  On Psycho and Sabre&n;&t; * there is only one IMAP register for each PCI slot even&n;&t; * though four different INOs can be generated by each&n;&t; * PCI slot.&n;&t; */
id|bucket
op_assign
id|__bucket
c_func
...
c_func
(paren
l_string|&quot;TOMATILLO%d: Cannot register UE interrupt.&bslash;n&quot;
comma
id|p-&gt;index
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;TOMATILLO%d: Cannot register CE interrupt.&bslash;n&quot;
comma
id|p-&gt;index
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: Cannot register PciERR interrupt.&bslash;n&quot;
comma
id|pbm-&gt;name
)paren
suffix:semicolon

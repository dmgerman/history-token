...
multiline_comment|/* I can&squot;t believe they didn&squot;t put a real INO in the isa device&n; * interrupts property.  The whole point of the OBP properties&n; * is to shield the kernel from IRQ routing details.&n; *&n; * The P1275 standard for ISA devices seems to also have been&n; * totally ignored.&n; *&n; * On later systems, an interrupt-map and interrupt-map-mask scheme&n; * akin to EBUS is used.&n; */
r_static
r_struct
(brace
DECL|member|obp_irq
...
suffix:semicolon
DECL|function|isa_dev_get_irq_using_imap
r_static
r_int
id|__init
id|isa_dev_get_irq_using_imap
c_func
(paren
r_struct
id|sparc_isa_device
...
id|pregs-&gt;which_io
op_amp
id|isa_br-&gt;isa_intmask.phys_hi
suffix:semicolon
id|lo
op_assign
id|pregs-&gt;phys_addr
op_amp
id|isa_br-&gt;isa_intmask.phys_lo
suffix:semicolon
id|irq
op_assign
op_star
id|interrupt
op_amp
id|isa_br-&gt;isa_intmask.interrupt
suffix:semicolon
r_for
c_loop
(paren

...
DECL|function|central_probe_failure
r_static
r_void
id|central_probe_failure
c_func
(paren
r_int
id|line
...
c_func
(paren
l_string|&quot;CENTRAL: Critical device probe failure at central.c:%d&bslash;n&quot;
comma
id|line
)paren
suffix:semicolon
...
DECL|function|prom_reg_to_paddr
r_static
r_int
r_int
id|prom_reg_to_paddr
c_func
(paren
r_struct
id|linux_prom_registers

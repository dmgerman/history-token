multiline_comment|/* $Id: pci_common.c,v 1.18 2001/05/18 23:06:35 davem Exp $&n; * pci_common.c: PCI controller common support.&n; *&n; * Copyright (C) 1999 David S. Miller (davem@redhat.com)&n; */

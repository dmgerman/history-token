...
id|pwalk-&gt;sysdata
suffix:semicolon
multiline_comment|/* But if the PCI bridge has it&squot;s own interrupt map&n;&t;&t; * and mask properties, use that and the device regs.&n;&t;&t; */
id|plen
op_assign
id|prom_getproperty
c_func
...
c_func
(paren
l_string|&quot;pbm_intmap_match: Bridge has intmap but &quot;
l_string|&quot;no intmask.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func

multiline_comment|/* $Id: pci_common.c,v 1.21 2001/06/08 06:57:19 davem Exp $&n; * pci_common.c: PCI controller common support.&n; *&n; * Copyright (C) 1999 David S. Miller (davem@redhat.com)&n; */

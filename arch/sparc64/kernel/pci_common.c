...
id|pbus_next
suffix:semicolon
multiline_comment|/* This must be _safe because the cookie fillin&n;&t;   routine can delete devices from the tree.  */
...
c_func
(paren
l_string|&quot;PCI-IRQ: Routing bus[%2x] slot[%2x] map[%d] to INO[%02x]&bslash;n&quot;
comma
id|pdev-&gt;bus-&gt;number
comma
id|PCI_SLOT

...
id|i
suffix:semicolon
multiline_comment|/* Zap all of the normal resources, they are&n;&t;&t; * meaningless and generate bogus resource collision&n;&t;&t; * messages.  This is OpenBoot&squot;s ill-fated attempt to&n;&t;&t; * represent the implicit resources that these devices&n;&t;&t; * have.&n;&t;&t; */
...
c_func
(paren
l_string|&quot;PCI: Bogus PROM assignment. BUS[%02x] DEVFN[%x]&bslash;n&quot;
comma
id|pdev-&gt;bus-&gt;number
comma
id|pdev-&gt;devfn
...
DECL|function|pdev_resource_collisions_expected
r_static
r_int
id|__init
id|pdev_resource_collisions_expected
c_func
(paren
r_struct
id|pci_dev
...
(brace
multiline_comment|/* OK, there is some conflict.  But this is fine&n;&t;&t;&t; * since we&squot;ll reassign it in the fixup pass.&n;&t;&t;&t; *&n;&t;&t;&t; * We notify the user that OBP made an error if it&n;&t;&t;&t; * is a case we don&squot;t expect.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_string|&quot;[%016lx:%016lx] of device %s&bslash;n&quot;
comma
(paren
id|res
op_minus
...
multiline_comment|/* Return non-zero if PDEV has implicit I/O resources even&n; * though it may not have an I/O base address register&n; * active.&n; */
DECL|function|has_implicit_io
r_static
r_int
id|__init
id|has_implicit_io
...
id|pregs
op_assign
id|regs_pcp-&gt;prom_regs
suffix:semicolon
id|bus_pcp
op_assign
id|bus_dev-&gt;sysdata
suffix:semicolon
multiline_comment|/* But if the PCI bridge has it&squot;s own interrupt map&n;&t;&t; * and mask properties, use that and the regs of the&n;&t;&t; * PCI entity at the next level down on the path to the&n;&t;&t; * device.&n;&t;&t; */
id|plen
op_assign
id|prom_getproperty
c_func
...
c_func
(paren
l_string|&quot;pci_intmap_match: Warning! Bridge has intmap &quot;
l_string|&quot;but no intmask.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;pci_intmap_match: Trying to recover.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;pci_intmap_match: bus %02x, devfn %02x: &quot;
comma
id|pdev-&gt;bus-&gt;number
comma
id|pdev-&gt;devfn
...
multiline_comment|/* Firmware gets quad-hme interrupts property totally&n;&t; * wrong.  It is 4 EBUS+HME devices behind a Digital bridge.&n;&t; * For each of the 4 instances the EBUS has interrupt property&n;&t; * &squot;1&squot; and the HME has interrupt property &squot;2&squot;.  So we have to&n;&t; * fix this up.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|bus_dev
suffix:semicolon
multiline_comment|/* Underneath a bridge, use slot number of parent&n;&t;&t;&t; * bridge which is closest to the PBM.&n;&t;&t;&t; */
id|bus_dev
op_assign
id|pdev-&gt;bus-&gt;self
suffix:semicolon
...
DECL|function|pci_register_legacy_regions
r_void
...
id|p
suffix:semicolon
multiline_comment|/* VGA Video RAM. */
id|p
op_assign
id|kmalloc
c_func

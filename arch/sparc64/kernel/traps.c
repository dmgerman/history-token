...
suffix:semicolon
DECL|function|dump_tl1_traplog
r_static
r_void
id|dump_tl1_traplog
c_func
...
c_func
(paren
l_string|&quot;TRAPLOG: Error at trap level 0x%lx, dumping track stack.&bslash;n&quot;
comma
id|p-&gt;tl
)paren
suffix:semicolon
...
DECL|function|instruction_access_exception_tl1
r_void
id|instruction_access_exception_tl1
c_func
(paren
r_struct
id|pt_regs
...
id|DIE_TRAP_TL1
comma
l_string|&quot;instruction access exception tl1&quot;
comma
id|regs
comma
l_int|0
...
suffix:semicolon
DECL|variable|__cheetah_error_table
r_static
r_struct
id|afsr_error_table
id|__cheetah_error_table
(braket
)braket
op_assign
(brace
...
op_assign
l_string|&quot;System bus unmapped error for prefetch/storequeue-read&quot;
suffix:semicolon
DECL|variable|CHPAFSR_DBERR_msg
r_static
r_const
r_char
id|CHPAFSR_DBERR_msg
(braket
)braket
op_assign
l_string|&quot;System bus error for prefetch/storequeue-read&quot;
suffix:semicolon
DECL|variable|CHPAFSR_THCE_msg
r_static
r_const
r_char
id|CHPAFSR_THCE_msg
...
op_assign
l_string|&quot;Hardware corrected E-cache Tag ECC error&quot;
suffix:semicolon
DECL|variable|CHPAFSR_TSCE_msg
r_static
r_const
r_char
id|CHPAFSR_TSCE_msg
...
op_assign
l_string|&quot;SW handled correctable E-cache Tag ECC error&quot;
suffix:semicolon
DECL|variable|CHPAFSR_TUE_msg
r_static
r_const
r_char
id|CHPAFSR_TUE_msg
...
op_assign
l_string|&quot;Uncorrectable E-cache Tag ECC error&quot;
suffix:semicolon
DECL|variable|CHPAFSR_DUE_msg
r_static
r_const
r_char
id|CHPAFSR_DUE_msg
...
op_assign
l_string|&quot;System bus uncorrectable data ECC error due to prefetch/store-fill&quot;
suffix:semicolon
DECL|variable|__cheetah_plus_error_table
r_static
r_struct
id|afsr_error_table
id|__cheetah_plus_error_table
(braket
)braket
op_assign
(brace
...
op_assign
l_string|&quot;System interface protocol error, hw timeout caused&quot;
suffix:semicolon
DECL|variable|JPAFSR_SCE_msg
r_static
r_const
r_char
id|JPAFSR_SCE_msg
...
op_assign
l_string|&quot;Parity error on system snoop results&quot;
suffix:semicolon
DECL|variable|JPAFSR_JEIC_msg
r_static
r_const
r_char
id|JPAFSR_JEIC_msg
...
op_assign
l_string|&quot;System interface protocol error, illegal command detected&quot;
suffix:semicolon
DECL|variable|JPAFSR_JEIT_msg
r_static
r_const
r_char
id|JPAFSR_JEIT_msg
...
op_assign
l_string|&quot;System interface protocol error, illegal ADTYPE detected&quot;
suffix:semicolon
DECL|variable|JPAFSR_OM_msg
r_static
r_const
r_char
id|JPAFSR_OM_msg
...
op_assign
l_string|&quot;Out of range memory error has occurred&quot;
suffix:semicolon
DECL|variable|JPAFSR_ETP_msg
r_static
r_const
r_char
id|JPAFSR_ETP_msg
...
op_assign
l_string|&quot;Parity error on L2 cache tag SRAM&quot;
suffix:semicolon
DECL|variable|JPAFSR_UMS_msg
r_static
r_const
r_char
id|JPAFSR_UMS_msg
...
op_assign
l_string|&quot;Error due to unsupported store&quot;
suffix:semicolon
DECL|variable|JPAFSR_RUE_msg
r_static
r_const
r_char
id|JPAFSR_RUE_msg
...
op_assign
l_string|&quot;Uncorrectable ECC error from remote cache/memory&quot;
suffix:semicolon
DECL|variable|JPAFSR_RCE_msg
r_static
r_const
r_char
id|JPAFSR_RCE_msg
...
op_assign
l_string|&quot;Correctable ECC error from remote cache/memory&quot;
suffix:semicolon
DECL|variable|JPAFSR_BP_msg
r_static
r_const
r_char
id|JPAFSR_BP_msg
...
op_assign
l_string|&quot;JBUS parity error on returned read data&quot;
suffix:semicolon
DECL|variable|JPAFSR_WBP_msg
r_static
r_const
r_char
id|JPAFSR_WBP_msg
...
op_assign
l_string|&quot;JBUS parity error on data for writeback or block store&quot;
suffix:semicolon
DECL|variable|JPAFSR_FRC_msg
r_static
r_const
r_char
id|JPAFSR_FRC_msg
...
op_assign
l_string|&quot;Foreign read to DRAM incurring correctable ECC error&quot;
suffix:semicolon
DECL|variable|JPAFSR_FRU_msg
r_static
r_const
r_char
id|JPAFSR_FRU_msg
...
op_assign
l_string|&quot;Foreign read to DRAM incurring uncorrectable ECC error&quot;
suffix:semicolon
DECL|variable|__jalapeno_error_table
r_static
r_struct
id|afsr_error_table
id|__jalapeno_error_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|cheetah_afsr_errors
r_static
r_int
r_int
id|cheetah_afsr_errors
suffix:semicolon
...
r_int
r_int
id|cheetah_plus_icpe_trap_vector
(braket
)braket
comma
id|cheetah_plus_icpe_trap_vector_tl1
(braket
)braket
suffix:semicolon
r_extern
r_int
r_int
id|cheetah_plus_dcpe_trap_vector
(braket
)braket
comma
id|cheetah_plus_dcpe_trap_vector_tl1
(braket
)braket
suffix:semicolon
r_extern
...
DECL|function|__cheetah_flush_icache
r_static
r_void
id|__cheetah_flush_icache
c_func
(paren
r_void
)paren
...
multiline_comment|/* In order to make the even parity correct we must do two things.&n; * First, we clear DC_data_parity and set DC_utag to an appropriate value.&n; * Next, we clear out all 32-bytes of data for that line.  Data of&n; * all-zero + tag parity value of zero == correct parity.&n; */
DECL|function|cheetah_plus_zap_dcache_parity
r_static
r_void
id|cheetah_plus_zap_dcache_parity
c_func
(paren
r_void
)paren
...
multiline_comment|/* Handle a D/I cache parity error trap.  TYPE is encoded as:&n; *&n; * Bit0:&t;0=dcache,1=icache&n; * Bit1:&t;0=recoverable,1=unrecoverable&n; *&n; * The hardware has disabled both the I-cache and D-cache in&n; * the %dcr register.  &n; */
DECL|function|cheetah_plus_parity_error
r_void
id|cheetah_plus_parity_error
c_func
(paren
r_int
id|type
...
(paren
id|KERN_EMERG
l_string|&quot;CPU[%d]: Cheetah+ %c-cache parity error at TPC[%016lx]&bslash;n&quot;
comma
id|smp_processor_id
c_func
(paren
...
c_func
(paren
l_string|&quot;Irrecoverable Cheetah+ parity error.&quot;
)paren
suffix:semicolon
)brace
id|printk
...
id|DIE_TRAP
comma
l_string|&quot;tagged arithmetic overflow&quot;
comma
id|regs
comma
l_int|0
...
id|DIE_TRAP
comma
l_string|&quot;integer division by zero&quot;
comma
id|regs
comma
l_int|0
...
id|DIE_TRAP
comma
l_string|&quot;memory address unaligned&quot;
comma
id|regs
comma
l_int|0
...
r_extern
r_void
id|thread_info_offsets_are_bolixed_dave
c_func
(paren
r_void
)paren
...
(brace
multiline_comment|/* Compile time sanity check. */
r_if
c_cond
(paren
id|TI_TASK

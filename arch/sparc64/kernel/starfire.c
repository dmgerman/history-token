multiline_comment|/* $Id: starfire.c,v 1.10 2001/04/14 21:13:45 davem Exp $&n; * starfire.c: Starfire/E10000 support.&n; *&n; * Copyright (C) 1998 David S. Miller (davem@redhat.com)&n; * Copyright (C) 2000 Anton Blanchard (anton@samba.org)&n; */
...
(brace
multiline_comment|/* Currently, nothing to do.  */
)brace

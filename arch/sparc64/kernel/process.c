...
DECL|function|machine_alt_power_off
r_void
...
id|p-&gt;thread.smp_lock_count
op_assign
l_int|0
suffix:semicolon
id|p-&gt;thread.smp_lock_pc
op_assign
l_int|0
suffix:semicolon
macro_line|#endif
...
l_int|0xffUL
op_lshift
id|TI_FLAG_CWP_SHIFT
)paren
op_or
(paren
l_int|0xffUL
op_lshift
id|TI_FLAG_CURRENT_DS_SHIFT
)paren
)paren
)paren
op_or
...
(brace
multiline_comment|/* Only should be used for SunOS and ancient a.out&n;&t; * SparcLinux binaries...  Not worth implementing.&n;&t; */
id|memset
c_func
(paren
id|dump

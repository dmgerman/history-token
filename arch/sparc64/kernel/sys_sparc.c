...
suffix:semicolon
multiline_comment|/* get_addr function gets the currently unused virtual range in&n; * the current process&squot;s address space.  It returns the LARGE_PAGE_SIZE&n; * aligned address (in cases of success).  Other kernel generic&n; * routines only could gurantee that allocated address is PAGE_SIZE aligned.&n; */

multiline_comment|/* $Id: pci_sabre.c,v 1.42 2002/01/23 11:27:32 davem Exp $&n; * pci_sabre.c: Sabre specific PCI controller support.&n; *&n; * Copyright (C) 1997, 1998, 1999 David S. Miller (davem@caipfs.rutgers.edu)&n; * Copyright (C) 1998, 1999 Eddie C. Dost   (ecd@skynet.be)&n; * Copyright (C) 1999 Jakub Jelinek   (jakub@redhat.com)&n; */
...
mdefine_line|#define sabre_write(__reg, __val) &bslash;&n;&t;__asm__ __volatile__(&quot;stxa %0, [%1] %2&quot; &bslash;&n;&t;&t;&t;     : /* no outputs */ &bslash;&n;&t;&t;&t;     : &quot;r&quot; (__val), &quot;r&quot; (__reg), &bslash;&n;&t;&t;&t;       &quot;i&quot; (ASI_PHYS_BYPASS_EC_E) &bslash;&n;&t;&t;&t;     : &quot;memory&quot;)
...
DECL|function|__sabre_read_pci_cfg
r_static
r_int
id|__sabre_read_pci_cfg
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|sabre_read_pci_cfg
r_static
r_int
id|sabre_read_pci_cfg
c_func
(paren
r_struct
id|pci_bus
...
suffix:semicolon
multiline_comment|/* When accessing PCI config space of the PCI controller itself (bus&n;&t; * 0, device slot 0, function 0) there are restrictions.  Each&n;&t; * register must be accessed as it&squot;s natural size.  Thus, for example&n;&t; * the Vendor ID must be accessed as a 16-bit quantity.&n;&t; */
r_switch
c_cond
(paren
id|size
...
DECL|function|__sabre_write_pci_cfg
r_static
r_int
id|__sabre_write_pci_cfg
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|sabre_write_pci_cfg
r_static
r_int
id|sabre_write_pci_cfg
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|sabre_pcierr_intr_other
r_static
id|irqreturn_t
id|sabre_pcierr_intr_other
c_func
(paren
r_struct
id|pci_controller_info
...
c_func
(paren
l_string|&quot;SABRE%d: PCI SERR signal asserted.&bslash;n&quot;
comma
id|p-&gt;index
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SABRE%d: PCI bus error, PCI_STATUS[%04x]&bslash;n&quot;
comma
id|p-&gt;index
comma
id|stat
...
DECL|function|alloc_bridge_cookie
r_static
r_struct
id|pcidev_cookie
op_star
id|alloc_bridge_cookie
c_func
(paren
r_struct
id|pci_pbm_info
...
c_func
(paren
l_string|&quot;SABRE: Critical allocation failure.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* This driver has not been verified to handle&n;&t; * multiple SABREs yet, so trap this.&n;&t; *&n;&t; * Also note that the SABRE host bridge is hardwired&n;&t; * to live at bus 0.&n;&t; */
r_if
c_cond
(paren
id|once
...
(brace
multiline_comment|/* Hummingbird, no APBs. */
id|pbm
op_assign
op_amp
id|p-&gt;pbm_A
suffix:semicolon
id|sabre_bus-&gt;sysdata
op_assign
id|pbm
suffix:semicolon
id|pbm-&gt;pci_bus
...
id|err
suffix:semicolon
multiline_comment|/* No APBs underneath, probably this is a hummingbird&n;&t;&t; * system.&n;&t;&t; */
id|pbm
op_assign
op_amp
id|p-&gt;pbm_A
...
c_func
(paren
l_string|&quot;Hummingbird: Fatal error, no interrupt-map-mask.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;Cannot register Hummingbird&squot;s IO space.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;Cannot register Hummingbird&squot;s MEM space.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;SABRE: Error, kmalloc(pci_iommu) failed.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
multiline_comment|/* PCI first */
r_for
c_loop
(paren
id|clear_irq
op_assign
id|SABRE_ICLR_A_SLOT0
suffix:semicolon
id|clear_irq
OL
id|SABRE_ICLR_B_SLOT0
op_plus
l_int|0x80
suffix:semicolon
id|clear_irq

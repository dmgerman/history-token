multiline_comment|/* arch/sparc64/kernel/profile.c&n; *&n; * Almost entirely copied from ppc64 which is:&n; * (C) 2002 John Levon &lt;levon@movementarian.org&gt;&n; */
...
DECL|function|sparc64_profile_hook
r_void

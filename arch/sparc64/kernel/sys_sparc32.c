...
suffix:semicolon
multiline_comment|/* Hey, when you&squot;re trying to init module, take time and prepare us a nice&n; * 64bit module structure, even if from 32bit modutils... Why to pollute&n; * kernel... :))&n; */

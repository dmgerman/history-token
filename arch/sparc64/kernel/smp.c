...
r_int
r_int
id|xcall_flush_cache_all_spitfire
suffix:semicolon
r_extern
r_int
r_int
...
(brace
multiline_comment|/* Cheetah need do nothing. */
r_if
c_cond
(paren
id|tlb_type
...
(brace
multiline_comment|/* By virtue of being the current address space, and&n;&t;&t;&t; * having the only reference to it, the following&n;&t;&t;&t; * operation is safe.&n;&t;&t;&t; *&n;&t;&t;&t; * It would not be a win to perform the xcall tlb&n;&t;&t;&t; * flush in this case, because even if we switch back&n;&t;&t;&t; * to one of the other processors in cpu_vm_mask it&n;&t;&t;&t; * is almost certain that all TLB entries for this&n;&t;&t;&t; * context will be replaced by the time that happens.&n;&t;&t;&t; */
id|mm-&gt;cpu_vm_mask
op_assign
(paren
l_int|1UL
...
multiline_comment|/* OK, we have to actually perform the cross call.  Most&n;&t;&t; * likely this is a cloned mm or kswapd is kicking out pages&n;&t;&t; * for a task which has run recently on another cpu.&n;&t;&t; */
id|smp_cross_call_masked
c_func
(paren
op_amp

...
suffix:semicolon
DECL|variable|dcache_xcall_lock
r_static
id|spinlock_t
id|dcache_xcall_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
DECL|variable|dcache_page
r_static
r_struct
id|page
op_star
...
suffix:semicolon
macro_line|#endif
DECL|function|__smp_flush_dcache_page_client
r_static
id|__inline__
r_void
id|__smp_flush_dcache_page_client
c_func
(paren
r_struct
id|page
...
DECL|function|smp_flush_dcache_page_client
r_void
id|smp_flush_dcache_page_client
c_func
(paren
r_void
)paren
...
suffix:semicolon
multiline_comment|/* Target cpu drops dcache_xcall_lock. */
)brace
r_else
(brace
multiline_comment|/* Look mom, no locks... */
id|data0
op_assign
(paren
(paren

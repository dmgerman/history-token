...
op_increment
suffix:semicolon
multiline_comment|/* Make sure the resulting __per_cpu_base value&n;&t; * will fit in the 43-bit sign extended IMMU&n;&t; * TSB register.&n;&t; */
id|ptr
op_assign
id|__alloc_bootmem
c_func
...
c_func
(paren
l_string|&quot;PER_CPU: Invalid layout, &quot;
l_string|&quot;ptr[%p] shift[%lx] base[%lx]&bslash;n&quot;
comma
id|ptr
comma
id|__per_cpu_shift

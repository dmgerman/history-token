multiline_comment|/* ptrace.c: Sparc process tracing support.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caipfs.rutgers.edu)&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *&n; * Based upon code written by Ross Biro, Linus Torvalds, Bob Manson,&n; * and David Mosberger.&n; *&n; * Added Linux support -miguel (weird, eh?, the original code was meant&n; * to emulate SunOS).&n; */

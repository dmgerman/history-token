...
multiline_comment|/* Existing mappings are never marked invalid, instead they&n; * are pointed to a dummy page.&n; */
DECL|macro|IOPTE_IS_DUMMY
mdefine_line|#define IOPTE_IS_DUMMY(iommu, iopte)&t;&bslash;&n;&t;((iopte_val(*iopte) &amp; IOPTE_PAGE) == (iommu)-&gt;dummy_page_pa)
DECL|function|iopte_make_dummy
r_static
r_void
r_inline
id|iopte_make_dummy
...
DECL|function|pci_iommu_table_init
r_void
...
(paren
id|KERN_EMERG
l_string|&quot;pci_iommu: alloc_streaming_cluster of npages(%ld) failed!&bslash;n&quot;
comma
id|npages
)paren
suffix:semicolon
...
DECL|function|ali_sound_dma_hack
r_static
r_void
id|ali_sound_dma_hack
c_func
(paren
r_struct
id|pci_dev

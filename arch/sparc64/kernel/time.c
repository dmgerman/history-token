...
DECL|macro|SPARC64_USEC_PER_CYC_SHIFT
mdefine_line|#define SPARC64_USEC_PER_CYC_SHIFT&t;30UL
...
id|xtime.tv_sec
suffix:semicolon
multiline_comment|/* Believe it or not, this divide shows up on&n;&t;&t; * kernel profiles.  The problem is that it is&n;&t;&t; * both 64-bit and signed.  Happily, 32-bits&n;&t;&t; * of precision is all we really need and in&n;&t;&t; * doing so gcc ends up emitting a cheap multiply.&n;&t;&t; *&n;&t;&t; * XXX Why is tv_nsec &squot;long&squot; and &squot;signed&squot; in&n;&t;&t; * XXX the first place, can it even be negative?&n;&t;&t; */
id|usec
op_add_assign
(paren
(paren

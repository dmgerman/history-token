...
c_func
(paren
l_string|&quot;sbus_dma_sync_sg_for_cpu: not implemented yet&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;sbus_dma_sync_sg_for_device: not implemented yet&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* Map a single buffer of the indicated size for DMA in streaming mode.&n; * The 32-bit bus address to use is returned.&n; *&n; * Once the device is given the dma address, the device owns this memory&n; * until either pci_unmap_single or pci_dma_sync_single_* is performed.&n; */
...
multiline_comment|/*&n; * Same as pci_map_single, but with pages.&n; */
...
suffix:semicolon
multiline_comment|/* mmu_inval_dma_area XXX */
)brace

multiline_comment|/*  $Id: process.c,v 1.161 2002/01/23 11:27:32 davem Exp $&n; *  linux/arch/sparc/kernel/process.c&n; *&n; *  Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1996 Eddie C. Dost   (ecd@skynet.be)&n; */
...
suffix:semicolon
multiline_comment|/*&n; * default_idle is new in 2.5. XXX Review, currently stolen from sparc64.&n; */
...
c_func
(paren
l_string|&quot;%%G: %08lx %08lx  %08lx %08lx  %08lx %08lx  %08lx %08lx&bslash;n&quot;
comma
id|r-&gt;u_regs
(braket
l_int|0
...
c_func
(paren
l_string|&quot;%%O: %08lx %08lx  %08lx %08lx  %08lx %08lx  %08lx %08lx&bslash;n&quot;
comma
id|r-&gt;u_regs
(braket
l_int|8
...
c_func
(paren
l_string|&quot;%%L: %08lx %08lx  %08lx %08lx  %08lx %08lx  %08lx %08lx&bslash;n&quot;
comma
id|rw-&gt;locals
(braket
l_int|0
...
c_func
(paren
l_string|&quot;%%I: %08lx %08lx  %08lx %08lx  %08lx %08lx  %08lx %08lx&bslash;n&quot;
comma
id|rw-&gt;ins
(braket
l_int|0
...
multiline_comment|/*&n; * The show_stack is an external API which we do not use ourselves.&n; * The oops is printed in die_if_kernel.&n; */
...
multiline_comment|/*&n; * Note: sparc64 has a pretty intricated thread_saved_pc, check it out.&n; */

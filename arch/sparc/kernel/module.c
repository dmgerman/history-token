...
multiline_comment|/* Make generic code ignore STT_REGISTER dummy undefined symbols,&n; * and replace references to .func with func as in ppc64&squot;s dedotify.&n; */

multiline_comment|/*&n; * pcic.c: MicroSPARC-IIep PCI controller support&n; *&n; * Copyright (C) 1998 V. Roganov and G. Raiko&n; *&n; * Code is derived from Ultra/PCI PSYCHO controller support, see that&n; * for author info.&n; *&n; * Support for diverse IIep based platforms by Pete Zaitcev.&n; * CP-1200 by Eric Brower.&n; */
...
DECL|function|pcic_read_config
r_static
r_int
id|pcic_read_config
c_func
...
DECL|function|pcic_write_config
r_static
r_int
id|pcic_write_config
c_func
(paren
r_struct
id|pci_bus

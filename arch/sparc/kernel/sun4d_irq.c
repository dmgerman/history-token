...
(brace
multiline_comment|/* This interrupt is marked as specially allocated&n;&t;&t; * so it is a bad idea to free it.&n;&t;&t; */
id|printk
c_func
(paren
...
DECL|function|sun4d_sbint_to_irq
r_int
r_int
id|sun4d_sbint_to_irq
c_func
(paren
r_struct
id|sbus_dev

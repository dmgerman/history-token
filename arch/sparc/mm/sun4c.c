...
c_func
(paren
l_string|&quot;SUN4C: AIEEE, trying to invalidate vac while it is on.&quot;
)paren
suffix:semicolon
...
multiline_comment|/* File local boot time fixups. */
id|BTFIXUPDEF_CALL
c_func
(paren
r_void
...
DECL|macro|sun4c_flush_page
mdefine_line|#define sun4c_flush_page(addr) BTFIXUP_CALL(sun4c_flush_page)(addr)
DECL|macro|sun4c_flush_segment
mdefine_line|#define sun4c_flush_segment(addr) BTFIXUP_CALL(sun4c_flush_segment)(addr)
DECL|macro|sun4c_flush_context
mdefine_line|#define sun4c_flush_context() BTFIXUP_CALL(sun4c_flush_context)()
...
l_string|&quot; sta&t;%%g0, [%1 + %%o4] %3&bslash;n&quot;
suffix:colon
l_string|&quot;=&amp;r&quot;
(paren
id|nbytes
...
l_string|&quot;bg&t;1b&bslash;n&bslash;t&quot;
l_string|&quot; add&t;%0, %%o5, %0&bslash;n&quot;
suffix:colon
l_string|&quot;=&amp;r&quot;
(paren
id|addr
...
c_func
(paren
l_string|&quot;WEIRD Sun4C VAC cache size, &quot;
l_string|&quot;tell sparclinux@vger.kernel.org&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
DECL|function|sun4c_alloc_thread_info
r_static
r_struct
id|thread_info
op_star
id|sun4c_alloc_thread_info
c_func
(paren
r_void
)paren
...
DECL|function|sun4c_free_thread_info
r_static
r_void
id|sun4c_free_thread_info
c_func
(paren
r_struct
id|thread_info
...
r_extern
r_void
id|thread_info_size_is_bolixed_pete
c_func
(paren
r_void
)paren
...
c_func
(paren
l_string|&quot;ld&t;[%0 + 0x00], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x20], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x40], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x60], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x80], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xa0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xc0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xe0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x100], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x120], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x140], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x160], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x180], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x1a0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x1c0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x1e0], %%g0&bslash;n&quot;
suffix:colon
suffix:colon
l_string|&quot;r&quot;
(paren
...
(paren
l_string|&quot;ld&t;[%0 + 0x00], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x10], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x20], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x30], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x40], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x50], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x60], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x70], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x80], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0x90], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xa0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xb0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xc0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xd0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xe0], %%g0&bslash;n&bslash;t&quot;
l_string|&quot;ld&t;[%0 + 0xf0], %%g0&bslash;n&quot;
suffix:colon
suffix:colon
l_string|&quot;r&quot;
(paren
...
suffix:semicolon
multiline_comment|/* See commentary in sun4c_flush_cache_range(). */
r_for
c_loop
(paren
id|entry
...
DECL|function|sun4c_mapiorange
r_static
r_void
id|sun4c_mapiorange
c_func
...
DECL|function|sun4c_unmapiorange
r_static
r_void
id|sun4c_unmapiorange
c_func
(paren
r_int
r_int
...
DECL|function|sun4c_pgoff_to_pte
r_static
id|pte_t
id|sun4c_pgoff_to_pte
c_func
(paren
r_int
r_int
...
DECL|function|sun4c_pte_to_pgoff
r_static
r_int
r_int
id|sun4c_pte_to_pgoff
c_func
(paren
id|pte_t
id|pte
...
DECL|function|sun4c_pmd_page_v
r_static
id|__inline__
r_int
r_int
...
id|entry.val
op_amp
id|SUN4C_SWP_TYPE_MASK
)paren
suffix:semicolon
)brace
DECL|function|sun4c_swp_offset
r_static
r_int
r_int
id|sun4c_swp_offset
...
id|entry.val
op_rshift
id|SUN4C_SWP_OFF_SHIFT
)paren
op_amp
id|SUN4C_SWP_OFF_MASK
suffix:semicolon
)brace
DECL|function|sun4c_swp_entry
r_static
id|swp_entry_t
id|sun4c_swp_entry
c_func
...
id|pte_t
op_star
DECL|function|sun4c_pte_alloc_one_fast
id|sun4c_pte_alloc_one_fast
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_pte_alloc_one_kernel
r_static
id|pte_t
op_star
id|sun4c_pte_alloc_one_kernel
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_pte_alloc_one
r_static
r_struct
id|page
op_star
id|sun4c_pte_alloc_one
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_free_pmd_fast
r_static
r_void
id|sun4c_free_pmd_fast
c_func
(paren
id|pmd_t
op_star
...
suffix:semicolon
multiline_comment|/* The 2.4.18 code does not set this on sun4c, how does it work? XXX */
multiline_comment|/* BTFIXUPSET_SETHI(none_mask, 0x00000000); */
multiline_comment|/* Defaults to zero? */
id|BTFIXUPSET_CALL
c_func
(paren
id|pte_pfn
...
suffix:semicolon
macro_line|#if 0 /* PAGE_SHIFT &lt;= 12 */ /* Eek. Investigate. XXX */
id|BTFIXUPSET_CALL
c_func
(paren
id|pmd_page

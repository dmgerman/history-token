...
DECL|variable|srmmu_nocache_npages
r_int
...
id|pkmap_base_end
suffix:semicolon
DECL|variable|srmmu_nocache_bitmap_size
r_int
r_int
...
multiline_comment|/* Reserve nocache dynamically proportionally to the amount of&n; * system RAM. -- Tomas Szepe &lt;szepe@pinerecords.com&gt;, June 2002&n; */
...
id|PAGE_SIZE
suffix:semicolon
multiline_comment|/* printk(&quot;system memory available = %luk&bslash;nnocache ram size = %luk&bslash;n&quot;,&n;&t;&t;sysmemavail, srmmu_nocache_size / 1024); */
)brace

multiline_comment|/*&n; *  linux/arch/arm26/kernel/ptrace.c&n; *&n; *  By Ross Biro 1/23/92&n; * edited by Linus Torvalds&n; * ARM modifications Copyright (C) 2000 Russell King&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */
...
DECL|macro|REG_PSR
mdefine_line|#define REG_PSR 15
...
suffix:semicolon
singleline_comment|//FIXME - correct for arm26?
r_return
id|val
suffix:semicolon
)brace

multiline_comment|/*&n; * arch/shmedia/boot/compressed/misc.c&n; *&n; * This is a collection of several routines from gzip-1.0.3&n; * adapted for Linux.&n; *&n; * malloc by Hannu Savolainen 1993 and Matthias Urlichs 1994&n; *&n; * Adapted for SHmedia from sh by Stuart Menefy, May 2002&n; */
...
mdefine_line|#define ASCII_FLAG   0x01&t;/* bit 0 set: file probably ASCII text */
DECL|macro|CONTINUATION
mdefine_line|#define CONTINUATION 0x02&t;/* bit 1 set: continuation of multi-part gzip file */
DECL|macro|EXTRA_FIELD
mdefine_line|#define EXTRA_FIELD  0x04&t;/* bit 2 set: extra field present */
DECL|macro|ORIG_NAME
mdefine_line|#define ORIG_NAME    0x08&t;/* bit 3 set: original file name present */
DECL|macro|COMMENT
mdefine_line|#define COMMENT      0x10&t;/* bit 4 set: file comment present */
DECL|macro|ENCRYPTED
mdefine_line|#define ENCRYPTED    0x20&t;/* bit 5 set: file is encrypted */
DECL|macro|RESERVED
mdefine_line|#define RESERVED     0xC0&t;/* bit 6,7:   reserved */
DECL|macro|get_byte
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* When booting from ROM may want to do something like this if the&n;&t; * boot loader doesn&squot;t.&n;&t; */
multiline_comment|/* Set up the parameters and command line */
(brace
r_volatile
r_int
r_int
...
l_int|0x1
suffix:semicolon
multiline_comment|/* MOUNT_ROOT_RDONLY */
id|parambase
(braket
l_int|1
)braket
...
l_int|0x0
suffix:semicolon
multiline_comment|/* RAMDISK_FLAGS */
id|parambase
(braket
l_int|2
)braket
...
l_int|0x0200
suffix:semicolon
multiline_comment|/* ORIG_ROOT_DEV */
id|parambase
(braket
l_int|3
)braket
...
l_int|0x0
suffix:semicolon
multiline_comment|/* INITRD_START */
id|parambase
(braket
l_int|5
)braket

...
(brace
multiline_comment|/* This is really to help debug faults when starting&n;&t;&t;&t; * usermode, so only need a few */
id|count
op_increment
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;user mode bad_area address=%08lx pid=%d (%s) pc=%08lx&bslash;n&quot;
comma
id|address
comma
id|current-&gt;pid

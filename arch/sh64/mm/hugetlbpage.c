multiline_comment|/*&n; * arch/sh64/mm/hugetlbpage.c&n; *&n; * SuperH HugeTLB page support.&n; *&n; * Cloned from sparc64 by Paul Mundt.&n; *&n; * Copyright (C) 2002, 2003 David S. Miller (davem@redhat.com)&n; */

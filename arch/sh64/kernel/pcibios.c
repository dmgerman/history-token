multiline_comment|/*&n; * $Id: pcibios.c,v 1.1 2001/08/24 12:38:19 dwmw2 Exp $&n; *&n; * arch/sh/kernel/pcibios.c&n; *&n; * Copyright (C) 2002 STMicroelectronics Limited&n; *   Author : David J. McKay&n; *&n; * Copyright (C) 2004 Richard Curnow, SuperH UK Limited&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; * This is GPL&squot;d.&n; *&n; * Provided here are generic versions of:&n; *&t;pcibios_update_resource()&n; *&t;pcibios_align_resource()&n; *&t;pcibios_enable_device()&n; *&t;pcibios_set_master()&n; *&t;pcibios_update_irq()&n; *&n; * These functions are collected here to reduce duplication of common&n; * code amongst the many platform-specific PCI support code files.&n; *&n; * Platform-specific files are expected to provide:&n; *&t;pcibios_fixup_bus()&n; *&t;pcibios_init()&n; *&t;pcibios_setup()&n; *&t;pcibios_fixup_pbus_ranges()&n; */
...
DECL|function|pcibios_enable_bridge
r_static
r_void
id|pcibios_enable_bridge
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;PCI bridge %s, command register -&gt; %04x&bslash;n&quot;
comma
id|pci_name
c_func
(paren

...
id|sh_link
suffix:semicolon
multiline_comment|/* FIXME: AWFUL HACK&n;&t;&t;&t; * The cast is to drop the const from&n;&t;&t;&t; * the sechdrs pointer */
id|symhdr
op_assign
(paren
id|Elf_Shdr
...
l_int|1
suffix:semicolon
multiline_comment|/* we start counting at 1 */
id|nsyms
op_assign
id|symhdr-&gt;sh_size
op_div
...
c_func
(paren
l_string|&quot;OLD num_symtab %lu&bslash;n&quot;
comma
id|nsyms
)paren
suffix:semicolon
...
op_increment
suffix:semicolon
multiline_comment|/* note, count starts at 1 so preincrement */
r_if
c_cond
(paren
id|strncmp
...
c_func
(paren
l_string|&quot;NEW num_symtab %lu&bslash;n&quot;
comma
id|nsyms
)paren
suffix:semicolon

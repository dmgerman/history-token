...
mdefine_line|#define FLUSH_THRESHOLD 0x80000 /* 0.5MB */
DECL|variable|parisc_cache_flush_threshold
r_int
id|parisc_cache_flush_threshold
op_assign
id|FLUSH_THRESHOLD
suffix:semicolon
DECL|function|parisc_setup_cache_timing
r_void
...
(paren
id|KERN_DEBUG
l_string|&quot;Whole cache flush %lu cycles, flushing %lu bytes %lu cycles&bslash;n&quot;
comma
id|alltime
comma
id|size
...
suffix:semicolon
multiline_comment|/* Racy, but if we see an intermediate value, it&squot;s ok too... */
id|parisc_cache_flush_threshold
op_assign
id|size
op_star
...
c_func
(paren
l_string|&quot;Setting cache flush threshold to %x (%d CPUs online)&bslash;n&quot;
comma
id|parisc_cache_flush_threshold
comma
id|num_online_cpus

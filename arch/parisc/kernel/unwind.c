...
multiline_comment|/*&n; * J. David Anglin writes:&n; *&n; * &quot;You have to adjust the current sp to that at the begining of the function.&n; * There can be up to two stack additions to allocate the frame in the&n; * prologue.  Similar things happen in the epilogue.  In the presence of&n; * interrupts, you have to be concerned about where you are in the function&n; * and what stack adjustments have taken place.&quot;&n; *&n; * For now these cases are not handled, but they should be!&n; */

...
multiline_comment|/* #define min min&n;#define max max */
...
macro_line|#include &lt;asm/module.h&gt;&t;/* get #define module_map() */
...
mdefine_line|#define HANDLE_IOCTL(cmd, handler) asm volatile(&quot;.dword %1&bslash;n.word %0, 0&quot; : : &quot;i&quot; (cmd), &quot;i&quot; (handler));
...
c_func
(paren
l_string|&quot;register_ioctl32_conversion() is B0RKEN! Called by %p&bslash;n&quot;
comma
...
multiline_comment|/* intercept private networking ioctl() calls here since it is&n;&t; * an onerous task to figure out which ones of the HANDLE_IOCTL&n;&t; * list map to these values.&n;&t; */
r_if
c_cond
(paren
id|cmd

...
mdefine_line|#define READ_IO_IO_LOW(dev)  (unsigned long)(signed int)__raw_readl(dev-&gt;hpa + IO_IO_LOW)
DECL|macro|READ_IO_IO_HIGH
mdefine_line|#define READ_IO_IO_HIGH(dev) (unsigned long)(signed int)__raw_readl(dev-&gt;hpa + IO_IO_HIGH)
r_static
r_void
id|walk_native_bus
c_func
...
multiline_comment|/*&n; * parisc_generic_device_register_recursive() - internal function to recursively&n; * &t;register all parisc devices&n; */
DECL|function|parisc_generic_device_register_recursive
r_static
r_void
id|parisc_generic_device_register_recursive
c_func
(paren
r_struct
id|parisc_device
...
suffix:semicolon
multiline_comment|/* has this device been registered already ? */
r_if
c_cond
(paren
id|dev-&gt;dev.dma_mask
...
r_return
suffix:semicolon
multiline_comment|/* register all parents recursively */
r_if
c_cond
(paren
id|dev-&gt;parent
...
suffix:semicolon
multiline_comment|/* set up the generic device tree for this */
id|snprintf
c_func
(paren
id|tmp1
...
c_func
(paren
l_string|&quot;device_register(%s)&bslash;n&quot;
comma
id|dev-&gt;dev.bus_id
)paren
suffix:semicolon
...
multiline_comment|/*&n; * parisc_generic_device_register() - register all parisc devices&n; */
DECL|function|parisc_generic_device_register
r_void

...
suffix:semicolon
multiline_comment|/**&n; * device_to_hwpath - Populates the hwpath corresponding to the given device.&n; * @param dev the target device&n; * @param path pointer to a previously allocated hwpath struct to be filled in&n; */
DECL|function|device_to_hwpath
r_void
id|device_to_hwpath
c_func
(paren
...
DECL|variable|device_to_hwpath
id|EXPORT_SYMBOL
c_func
(paren
id|device_to_hwpath

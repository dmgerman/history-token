...
multiline_comment|/*&n; * BEGIN_DESC&n; *&n; *  File:&n; *&t;@(#)&t;pa/spmath/sfadd.c&t;&t;$Revision: 1.1 $&n; *&n; *  Purpose:&n; *&t;Single_add: add two single precision values.&n; *&n; *  External Interfaces:&n; *&t;sgl_fadd(leftptr, rightptr, dstptr, status)&n; *&n; *  Internal Interfaces:&n; *&n; *  Theory:&n; *&t;&lt;&lt;please update with a overview of the operation of this file&gt;&gt;&n; *&n; * END_DESC&n;*/
macro_line|#include &quot;float.h&quot;
macro_line|#include &quot;sgl_float.h&quot;
multiline_comment|/*&n; * Single_add: add two single precision values.&n; */
r_int
DECL|function|sgl_fadd
id|sgl_fadd
c_func
(paren

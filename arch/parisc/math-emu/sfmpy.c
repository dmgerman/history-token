...
multiline_comment|/* make sure result is left-justified */
r_if
c_cond
(paren
id|Sgl_iszero_sign
...
id|stickybit
suffix:semicolon
multiline_comment|/* re-align mantissa */
id|Sgl_rightshiftby8
c_func
(paren
id|opnd3
)paren

...
suffix:semicolon
DECL|variable|chunkmap
r_int
r_char
op_star
id|chunkmap
suffix:semicolon
DECL|variable|maxchunkmap
r_int
r_int
id|maxchunkmap
suffix:semicolon
...
macro_line|#ifdef CONFIG_DISCONTIGMEM
multiline_comment|/*&n;&t; * The below is still true as of 2.4.2. If this is ever fixed,&n;&t; * we can remove this warning!&n;&t; */
id|printk
c_func
(paren
id|KERN_WARNING
...
(paren
id|KERN_WARNING
l_string|&quot;CONFIG_DISCONTIGMEM is enabled, which is probably a mistake. This&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;option can lead to heavy swapping, even when there are gigabytes&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;of free memory.&bslash;n&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
macro_line|#ifdef __LP64__
...
multiline_comment|/*&n;&t; * Throw out ranges that are too far apart (controlled by&n;&t; * MAX_GAP). If CONFIG_DISCONTIGMEM wasn&squot;t implemented so&n;&t; * poorly, we would recommend enabling that option, but,&n;&t; * until it is fixed, this is the best way to go.&n;&t; */
r_for
c_loop
(paren
id|i
...
macro_line|#ifdef CONFIG_DISCONTIGMEM
multiline_comment|/*&n;&t; * Initialize support for virt_to_page() macro.&n;&t; *&n;&t; * Note that MAX_ADDRESS is the largest virtual address that&n;&t; * we can map. However, since we map all physical memory into&n;&t; * the kernel address space, it also has an effect on the maximum&n;&t; * physical address we can map (MAX_ADDRESS - PAGE_OFFSET).&n;&t; */
id|maxchunkmap
op_assign
id|MAX_ADDRESS
op_rshift
...
c_func
(paren
l_string|&quot;paging_init: Physical address exceeds maximum address space!&bslash;n&quot;
)paren
suffix:semicolon
id|badchunkmap2
suffix:colon
...
c_func
(paren
l_string|&quot;paging_init: Collision in chunk map array. CHUNKSZ needs to be smaller&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace

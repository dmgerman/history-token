...
macro_line|#endif
macro_line|#if defined(CONFIG_PILOT) || defined(CONFIG_UCSIMM)
r_if
c_cond
(paren
id|addr
...
id|_etext
suffix:semicolon
macro_line|#ifdef SHGLCORE_ROM_BANK_0_ADDR
r_if
c_cond
(paren
(paren
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef SHGLCORE_ROM_BANK_1_ADDR
r_else
r_if
c_cond
(paren
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef SHGLCORE_FLASH_BANK_0_ADDR
r_else
r_if
c_cond
(paren
...
id|SHGLCORE_FLASH_BANK_0_ADDR
op_plus
id|SHGLCORE_FLASH_BANK_0_LENGTH
)paren
)paren
)paren
r_return
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef SHGLCORE_FLASH_BANK_1_ADDR
r_else
r_if
c_cond
(paren
...
id|SHGLCORE_FLASH_BANK_1_ADDR
op_plus
id|SHGLCORE_FLASH_BANK_1_LENGTH
)paren
)paren
)paren
r_return

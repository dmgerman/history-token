...
multiline_comment|/*&n;&t; * Disable the BDM clocking.  This also turns off most of the rest of&n;&t; * the BDM device.  This is good for EMC reasons. This option is not&n;&t; * incompatible with the memory protection option.&n;&t; */
id|wdebug
c_func
(paren
id|MCFDEBUG_CSR

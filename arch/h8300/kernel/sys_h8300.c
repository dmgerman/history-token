multiline_comment|/*&n; * linux/arch/h8300/kernel/sys_h8300.c&n; *&n; * This file contains various random system calls that&n; * have a non-standard calling sequence on the H8/300&n; * platform.&n; */
...
multiline_comment|/* sys_cacheflush -- no support.  */
id|asmlinkage
r_int
...
macro_line|#if defined(CONFIG_SYSCALL_PRINT)
DECL|function|syscall_print
id|asmlinkage
r_void
id|syscall_print
c_func

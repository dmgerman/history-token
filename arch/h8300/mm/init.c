multiline_comment|/*&n; *  linux/arch/h8300/mm/init.c&n; *&n; *  Copyright (C) 1998  D. Jeff Dionne &lt;jeff@lineo.ca&gt;,&n; *                      Kenneth Albanowski &lt;kjahds@kjahds.com&gt;,&n; *  Copyright (C) 2000  Lineo, Inc.  (www.lineo.com) &n; *&n; *  Based on:&n; *&n; *  linux/arch/m68knommu/mm/init.c&n; *  linux/arch/m68k/mm/init.c&n; *&n; *  Copyright (C) 1995  Hamish Macdonald&n; *&n; *  JAN/1999 -- hacked to support ColdFire (gerg@snapgear.com)&n; *  DEC/2000 -- linux 2.4 support &lt;davidm@snapgear.com&gt;&n; */
...
(brace
multiline_comment|/*&n;&t; * Make sure start_mem is page aligned,  otherwise bootmem and&n;&t; * page_alloc get different views og the world.&n;&t; */
...
l_int|0
suffix:semicolon
multiline_comment|/* DAVIDM look at setup memory map generically with reserved area */
r_int
r_int
id|tmp
suffix:semicolon
...
id|__init_end
suffix:semicolon
multiline_comment|/*&n; *&t;the following code should be cool even if these sections&n; *&t;are not page aligned.&n; */
id|addr
op_assign
id|PAGE_ALIGN
c_func

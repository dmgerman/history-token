...
suffix:semicolon
multiline_comment|/* Yuk, we don&squot;t have PCI memory */
...
id|DMAF_MASTER
suffix:semicolon
multiline_comment|/* don&squot;t use Z2 RAM as system memory on Z3 capable machines */
r_if
c_cond
(paren
id|AMIGAHW_PRESENT
...
(paren
id|KERN_INFO
l_string|&quot;hwclk: timed out waiting for RTC (0x%x)&bslash;n&quot;
comma
id|tod_2000.cntrl1
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;set_clock_mmss: timed out waiting for RTC (0x%x)&bslash;n&quot;
comma
id|tod_2000.cntrl1
)paren
suffix:semicolon

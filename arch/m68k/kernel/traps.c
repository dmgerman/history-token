...
op_assign
l_string|&quot;MMU ILLEGAL OPERATION ERROR&quot;
comma
(braket
id|VEC_MMUACC
)braket
op_assign
l_string|&quot;MMU ACCESS LEVEL VIOLATION ERROR&quot;
comma
(braket
id|VEC_RESV59
)braket
op_assign
l_string|&quot;UNASSIGNED RESERVED 59&quot;
comma
(braket
id|VEC_UNIMPEA
)braket
op_assign
l_string|&quot;UNASSIGNED RESERVED 60&quot;
comma
(braket
id|VEC_UNIMPII
)braket
op_assign
l_string|&quot;UNASSIGNED RESERVED 61&quot;
comma
(braket
id|VEC_RESV62
)braket
op_assign
l_string|&quot;UNASSIGNED RESERVED 62&quot;
comma
(braket
id|VEC_RESV63
)braket
op_assign
l_string|&quot;UNASSIGNED RESERVED 63&quot;
comma
)brace
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* set_fs can not be moved, otherwise put_user() may oops */
id|set_fs
c_func
(paren
id|MAKE_MM_SEG

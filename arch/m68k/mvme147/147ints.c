multiline_comment|/*&n; * arch/m68k/mvme147/147ints.c&n; *&n; * Copyright (C) 1997 Richard Hirst [richard@sleepie.demon.co.uk]&n; *&n; * based on amiints.c -- Amiga Linux interrupt handling code&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file README.legal in the main directory of this archive&n; * for more details.&n; *&n; */
...
suffix:semicolon
multiline_comment|/*&n; * void mvme147_init_IRQ (void)&n; *&n; * Parameters:&t;None&n; *&n; * Returns:&t;Nothing&n; *&n; * This function is called during kernel startup to initialize&n; * the mvme147 IRQ handling routines.&n; */
DECL|function|mvme147_init_IRQ
r_void
id|mvme147_init_IRQ
(paren
r_void
...
DECL|function|mvme147_request_irq
r_int
...
DECL|function|mvme147_free_irq
r_void
id|mvme147_free_irq
c_func
(paren
...
DECL|function|show_mvme147_interrupts
r_int
...
DECL|function|mvme147_disable_irq
r_void

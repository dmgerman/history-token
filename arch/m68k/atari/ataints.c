...
id|__ALIGN_STR
l_string|&quot;&bslash;n&quot;
l_string|&quot;atari_fast_irq_handler:&bslash;n&bslash;t&quot;
l_string|&quot;orw &t;#0x700,%%sr&bslash;n&quot;
multiline_comment|/* disable all interrupts */
l_string|&quot;atari_prio_irq_handler:&bslash;n&bslash;t&quot;
l_string|&quot;addl&t;%3,%2&bslash;n&bslash;t&quot;
...
l_string|&quot;bfextu&t;%%sp@(%c1){#4,#10},%%d0&bslash;n&bslash;t&quot;
l_string|&quot;subw&t;#(0x40-8),%%d0&bslash;n&bslash;t&quot;
l_string|&quot;jpl &t;1f&bslash;n&bslash;t&quot;
l_string|&quot;addw&t;#(0x40-8-0x18),%%d0&bslash;n&quot;
l_string|&quot;1:&bslash;tlea&t;%a0,%%a0&bslash;n&bslash;t&quot;
l_string|&quot;addql&t;#1,%%a0@(%%d0:l:4)&bslash;n&bslash;t&quot;
l_string|&quot;lea&t;irq_handler,%%a0&bslash;n&bslash;t&quot;
l_string|&quot;lea&t;%%a0@(%%d0:l:8),%%a0&bslash;n&bslash;t&quot;
l_string|&quot;pea &t;%%sp@&bslash;n&bslash;t&quot;
multiline_comment|/* push frame address */
l_string|&quot;movel&t;%%a0@(4),%%sp@-&bslash;n&bslash;t&quot;
multiline_comment|/* push handler data */
l_string|&quot;movel&t;%%d0,%%sp@-&bslash;n&bslash;t&quot;
multiline_comment|/* push int number */
l_string|&quot;movel&t;%%a0@,%%a0&bslash;n&bslash;t&quot;
l_string|&quot;jsr&t;%%a0@&bslash;n&bslash;t&quot;
multiline_comment|/* and call the handler */
l_string|&quot;addql&t;#8,%%sp&bslash;n&bslash;t&quot;
l_string|&quot;addql&t;#4,%%sp&bslash;n&bslash;t&quot;
l_string|&quot;jbra&t;ret_from_interrupt&quot;
suffix:colon
suffix:colon
l_string|&quot;i&quot;
(paren
...
id|__ALIGN_STR
l_string|&quot;&bslash;n&bslash;t&quot;
l_string|&quot;falcon_hblhandler:&bslash;n&bslash;t&quot;
l_string|&quot;orw&t;#0x200,%sp@&bslash;n&bslash;t&quot;
multiline_comment|/* set saved ipl to 2 */
l_string|&quot;rte&quot;
)paren
suffix:semicolon

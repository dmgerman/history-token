multiline_comment|/*&n; * linux/arch/m68k/sun3/sun3ints.c -- Sun-3(x) Linux interrupt handling code&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file COPYING in the main directory of this archive&n; * for more details.&n; */
...
id|p
comma
l_string|&quot;vec %3d: %10u %s&bslash;n&quot;
comma
id|i
op_plus
l_int|64
...
c_func
(paren
l_string|&quot;sun3_request_irq: request for vec %d -- already taken!&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_request_irq: invalid irq %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_free_int: attempt to free unused irq %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_free_int: incorrect dev_id for irq %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_free_int: attempt to free unused vector %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_free_int: incorrect dev_id for vec %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_free_irq: invalid irq %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
id|panic
(paren
l_string|&quot;bad interrupt vector %d received&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sun3_process_int: unable to handle interrupt vector %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon

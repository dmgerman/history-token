...
l_string|&quot;mult&t;%1, %2&bslash;n&bslash;t&quot;
l_string|&quot;dsll32&t;%0, %3, %4&bslash;n&bslash;t&quot;
...
suffix:semicolon
multiline_comment|/*&n;&t; * We want the multiply and the shift to be isolated from the&n;&t; * rest of the code to disable gcc optimizations.  Hence the&n;&t; * asm statements that execute nothing, but make gcc not know&n;&t; * what the values of m1, m2 and s are and what v and p are&n;&t; * used for.&n;&t; *&n;&t; * We have to use single integers for m1 and m2 and a double&n;&t; * one for p to be sure the mulsidi3 gcc&squot;s RTL multiplication&n;&t; * instruction has the workaround applied.  Older versions of&n;&t; * gcc have correct mulsi3, but other multiplication variants&n;&t; * lack the workaround.&n;&t; */
id|asm
r_volatile
(paren
l_string|&quot;&quot;
...
suffix:semicolon
multiline_comment|/*&n;&t; * The following code fails to trigger an overflow exception&n;&t; * when executed on R4000 rev. 2.2 or 3.0.&n;&t; *&n;&t; * See &quot;MIPS R4000PC/SC Errata, Processor Revision 2.2 and&n;&t; * 3.0&quot; by MIPS Technologies, Inc., erratum #23 for details.&n;&t; * I got no permission to duplicate it here, sigh... --macro&n;&t; */
id|asm
r_volatile
(paren
l_string|&quot;.set&t;push&bslash;n&bslash;t&quot;

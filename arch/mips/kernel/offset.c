multiline_comment|/*&n; * offset.c: Calculate pt_regs and task_struct offsets.&n; *&n; * Copyright (C) 1996 David S. Miller&n; * Copyright (C) 1997, 1998, 1999, 2000, 2001, 2002 Ralf Baechle&n; * Copyright (C) 1999, 2000 Silicon Graphics, Inc.&n; *&n; * Kevin Kissell, kevink@mips.com and Carsten Langgaard, carstenl@mips.com&n; * Copyright (C) 2000 MIPS Technologies, Inc.&n; */
...
c_func
(paren
l_string|&quot;#define IC_SYSCALL_COUNT   &quot;
comma
id|irq_cpustat_t
comma
id|__syscall_count
...
c_func
(paren
l_string|&quot;#define IC_KSOFTIRQD_TASK  &quot;
comma
id|irq_cpustat_t
comma
id|__ksoftirqd_task

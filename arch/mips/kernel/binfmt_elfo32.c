...
DECL|macro|ELF_CORE_COPY_REGS
mdefine_line|#define ELF_CORE_COPY_REGS(_dest,_regs) elf32_core_copy_regs(_dest,_regs);
DECL|function|elf32_core_copy_regs
r_void
id|elf32_core_copy_regs
c_func
(paren
id|elf_gregset_t
id|_dest
...
suffix:semicolon
multiline_comment|/* XXXKW the 6 is from EF_REG0 in gdb/gdb/mips-linux-tdep.c, include/asm-mips/reg.h */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;Binary format loader for compatibility with o32 Linux/MIPS binaries&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func

...
macro_line|#ifndef CONFIG_MIPS_FPU_EMULATOR 
macro_line|#include &lt;asm/inst.h&gt;
macro_line|#endif
...
c_func
(paren
l_string|&quot;[%s:%d] Illegal instruction %08lx at %08lx, ra=%08lx, CP0_STATUS=%08lx&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|current-&gt;pid
...
c_func
(paren
l_string|&quot;[%s:%ld] Illegal instruction %08x at %08lx ra=%08lx&bslash;n&quot;
comma
id|current-&gt;comm
comma
(paren
...
multiline_comment|/*&n; * Some MIPS CPUs have a dedicated interrupt vector which reduces the&n; * interrupt processing overhead.  Use it where available.&n; */
...
multiline_comment|/*&n; * Some MIPS CPUs can enable/disable for cache parity detection, but does&n; * it different ways.&n; */
...
c_func
(paren
l_string|&quot;Can&squot;t handle the cache error - panic!&quot;
)paren
suffix:semicolon
)brace
...
id|CPU_SB1
suffix:colon
multiline_comment|/* XXX - This should be folded in to the &quot;cleaner&quot; handling, above */
id|memcpy
c_func
(paren
(paren
...
id|_restore_fp_context
suffix:semicolon
multiline_comment|/* Enable timer interrupt and scd mapped interrupt in status register */
id|clear_cp0_status
c_func
(paren
l_int|0xf000

...
c_func
(paren
l_string|&quot;Process %s (pid: %d, stackpage=%0*lx)&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|current-&gt;pid
...
id|init_mm
suffix:semicolon
multiline_comment|/* XXX Must be done for all CPUs  */

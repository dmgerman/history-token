...
suffix:semicolon
multiline_comment|/* &n;         * Address errors may be deliberately induced&n;         * by the FPU emulator to take retake control&n;         * of the CPU after executing the instruction&n;         * in the delay slot of an emulated branch.&n;         */
r_if
c_cond
(paren
(paren

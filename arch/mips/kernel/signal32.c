...
suffix:semicolon
multiline_comment|/* Convert (siginfo_t -&gt; siginfo_t32) and copy to user. */
id|err
op_or_assign
id|copy_siginfo_to_user32
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * As the result of a brainfarting competition a few years ago the&n;&t; * size of sigset_t for the 32-bit kernel was choosen to be 128 bits&n;&t; * but nothing so far is actually using that many, 64 are enough.  So&n;&t; * for now we just drop the high bits.&n;&t; */
r_if
c_cond
(paren
id|copy_from_user

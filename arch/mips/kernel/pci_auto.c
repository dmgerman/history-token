multiline_comment|/*&n; * PCI autoconfiguration library&n; *&n; * Author: Matt Porter &lt;mporter@mvista.com&gt;&n; *&n; * Copyright 2000, 2001 MontaVista Software Inc.&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; */
multiline_comment|/*&n; * Modified for MIPS by Jun Sun, jsun@mvista.com&n; *&n; * . Simplify the interface between pci_auto and the rest: a single function.&n; * . Assign resources from low address to upper address.&n; * . change most int to u32.&n; *&n; * Further modified to include it as mips generic code, ppopov@mvista.com.&n; */
...
macro_line|#endif
multiline_comment|/* These are used for config access before all the PCI probing has been done. */
r_int
...
mdefine_line|#define EARLY_PCI_OP(rw, size, type)&t;&t;&t;&t;&t;&bslash;&n;int early_##rw##_config_##size(struct pci_channel *hose, int bus,&t;&bslash;&n;                               int devfn, int offset, type value)&t;&bslash;&n;{&t;&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;return pci_##rw##_config_##size(fake_pci_dev(hose, bus, devfn),&t;&bslash;&n;&t;                                offset, value);&t;&t;&t;&bslash;&n;}
id|EARLY_PCI_OP
c_func
(paren
id|read

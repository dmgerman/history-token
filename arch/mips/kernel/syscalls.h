multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 1995, 96, 97, 98, 99, 2000, 2001, 2002 by Ralf Baechle&n; */
...
multiline_comment|/* was ioperm(2) */
id|SYS
c_func
(paren
id|sys_socketcall
...
multiline_comment|/* 4110 was iopl(2) */
id|SYS
c_func
(paren
id|sys_vhangup
...
multiline_comment|/* was sys_vm86 */
id|SYS
c_func
(paren
id|sys_wait4
...
multiline_comment|/* was create_module */
id|SYS
c_func
(paren
id|sys_init_module
...
multiline_comment|/* 4130, was get_kernel_syms */
id|SYS
c_func
(paren
id|sys_quotactl
...
multiline_comment|/* sys_query_module */
id|SYS
c_func
(paren
id|sys_poll

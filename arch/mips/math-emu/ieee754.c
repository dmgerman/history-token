multiline_comment|/* ieee754 floating point arithmetic&n; * single and double precision&n; *&n; * BUGS&n; * not much dp done&n; * doesn&squot;t generate IEEE754_INEXACT&n; *&n; */

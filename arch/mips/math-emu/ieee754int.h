...
DECL|macro|SETCX
mdefine_line|#define SETCX(x) &bslash;&n;  (ieee754_csr.cx |= (x),ieee754_csr.sx |= (x))
DECL|macro|SETANDTESTCX
mdefine_line|#define SETANDTESTCX(x) &bslash;&n;  (SETCX(x),ieee754_csr.mx &amp; (x))
DECL|macro|TSTX
...
DECL|macro|FLUSHDP
mdefine_line|#define FLUSHDP(v,vc,vs,ve,vm) &bslash;&n;&t;if(vc==IEEE754_CLASS_DNORM) {&bslash;&n;&t;    if(ieee754_csr.nod) {&bslash;&n;&t;&t;SETCX(IEEE754_INEXACT);&bslash;&n;&t;&t;vc = IEEE754_CLASS_ZERO;&bslash;&n;&t;&t;ve = DP_EMIN-1+DP_EBIAS;&bslash;&n;&t;&t;vm = 0;&bslash;&n;&t;&t;v = ieee754dp_zero(vs);&bslash;&n;&t;    }&bslash;&n;&t;}
DECL|macro|FLUSHSP
mdefine_line|#define FLUSHSP(v,vc,vs,ve,vm) &bslash;&n;&t;if(vc==IEEE754_CLASS_DNORM) {&bslash;&n;&t;    if(ieee754_csr.nod) {&bslash;&n;&t;&t;SETCX(IEEE754_INEXACT);&bslash;&n;&t;&t;vc = IEEE754_CLASS_ZERO;&bslash;&n;&t;&t;ve = SP_EMIN-1+SP_EBIAS;&bslash;&n;&t;&t;vm = 0;&bslash;&n;&t;&t;v = ieee754sp_zero(vs);&bslash;&n;&t;    }&bslash;&n;&t;}
DECL|macro|FLUSHXDP
mdefine_line|#define FLUSHXDP FLUSHDP(x,xc,xs,xe,xm)
DECL|macro|FLUSHYDP
mdefine_line|#define FLUSHYDP FLUSHDP(y,yc,ys,ye,ym)
DECL|macro|FLUSHXSP
mdefine_line|#define FLUSHXSP FLUSHSP(x,xc,xs,xe,xm)
DECL|macro|FLUSHYSP
mdefine_line|#define FLUSHYSP FLUSHSP(y,yc,ys,ye,ym)
eof

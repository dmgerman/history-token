...
(brace
multiline_comment|/* shunt out overflow bits */
r_while
c_loop
(paren
id|xm
...
r_else
(brace
multiline_comment|/* normalize in grs extended double precision */
r_while
c_loop
(paren
(paren
...
DECL|function|ieee754dp_fulong
id|ieee754dp
id|ieee754dp_fulong
c_func
(paren

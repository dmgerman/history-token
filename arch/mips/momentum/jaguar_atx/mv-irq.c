multiline_comment|/*&n; * Copyright 2002 Momentum Computer&n; * Author: mdharm@momenco.com&n; *&n; * arch/mips/momentum/jaguar_atx/mv-irq.c&n; *     Interrupt routines for mv64340.  Interrupt numbers are assigned from&n; *     MV64340_IRQ_BASE to MV64340_IRQ_BASE + 63.&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; */

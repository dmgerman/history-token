multiline_comment|/*&n; *  arch/mips/ddb5476/irq.c -- NEC DDB Vrc-5476 interrupt routines&n; *&n; *  Copyright (C) 2000 Geert Uytterhoeven &lt;geert@sonycom.com&gt;&n; *                     Sony Software Development Center Europe (SDCE), Brussels&n; */
...
r_struct
(brace
DECL|member|m1543_config
r_struct
id|resource
id|m1543_config
suffix:semicolon
DECL|member|pic_elcr
r_struct
id|resource
id|pic_elcr
suffix:semicolon
DECL|variable|m1543_ioport
)brace
id|m1543_ioport
op_assign
(brace
...
suffix:semicolon
multiline_comment|/* Enable the interrupt cascade from M1543 */
id|nile4_enable_irq
c_func
(paren
id|NILE4_INT_INTC
...
suffix:semicolon
multiline_comment|/* request io ports */
r_if
c_cond
(paren
id|request_resource
...
c_func
(paren
l_string|&quot;m1543_irq_setup : requesting io ports failed.&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;phantom interrupts detected : &bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;&bslash;tcause &bslash;t&bslash;t0x%08x&bslash;n&quot;
comma
id|cause
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;tcause reg&bslash;t0x%08x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;&bslash;tstatus reg&bslash;t0x%08x&bslash;n&quot;
comma
id|read_32bit_cp0_register
c_func
(paren
...
suffix:semicolon
multiline_comment|/* we pin #0 - #4 (no internal timer) */

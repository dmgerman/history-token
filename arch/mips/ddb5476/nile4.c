multiline_comment|/*&n; *  arch/mips/ddb5074/nile4.c -- NEC Vrc-5074 Nile 4 support routines&n; *&n; *  Copyright (C) 2000 Geert Uytterhoeven &lt;geert@sonycom.com&gt;&n; *                     Sony Software Development Center Europe (SDCE), Brussels&n; */
...
(brace
macro_line|#if 0&t;&t;&t;&t;/* We don&squot;t support 4 GB yet */
r_case
l_int|0x100000000
suffix:colon
...
suffix:semicolon
multiline_comment|/*&n;&t; * When programming a PDAR, the register should be read immediately&n;&t; * after writing it. This ensures that address decoders are properly&n;&t; * configured.&n;&t; */
id|nile4_in32
c_func
(paren
id|pdar

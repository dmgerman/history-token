multiline_comment|/*&n; *  linux/arch/mips/philips/nino/irq.c&n; *&n; *  Copyright (C) 1992 Linus Torvalds&n; *  Copyright (C) 1999 Harald Koerfgen&n; *  Copyright (C) 2000 Pavel Machek (pavel@suse.cz)&n; *  Copyright (C) 2001 Steven J. Hill (sjhill@realitydiluted.com)&n; * &n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; *  &n; *  Generic interrupt handler for Philips Nino.&n; */
...
l_int|0
suffix:colon
multiline_comment|/* Periodic Timer Interrupt */
id|IntClear5
op_assign
id|INT5_PERIODICINT
suffix:semicolon
...
l_int|3
suffix:colon
multiline_comment|/* Serial port receive interrupt */
r_break
suffix:semicolon
r_case
l_int|2
suffix:colon
multiline_comment|/* Serial port transmit interrupt */
r_break
suffix:semicolon
r_default
suffix:colon
...
c_func
(paren
l_string|&quot;Attempt to mask unknown IRQ %d?&bslash;n&quot;
comma
id|irq_nr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Attempt to unmask unknown IRQ %d?&bslash;n&quot;
comma
id|irq_nr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;20 %08lx %08lx&bslash;n   %08lx %08lx&bslash;n   %08lx&bslash;n&quot;
comma
id|IntStatus1
comma
id|IntStatus2

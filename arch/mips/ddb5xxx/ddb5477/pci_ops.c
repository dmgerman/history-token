...
mdefine_line|#define&t;MAKE_PCI_OPS(prefix, rw, pciswap) &bslash;&n;static int prefix##_##rw##_config(struct pci_bus *bus, unsigned int devfn, &bslash;&n;&t;&t;&t;&t;  int where, int size, u32 val) &bslash;&n;{ &bslash;&n;     return rw##_config(pciswap, bus, devfn, &bslash;&n;                                   where, size, val); &bslash;&n;}
id|MAKE_PCI_OPS
c_func
(paren
id|extpci

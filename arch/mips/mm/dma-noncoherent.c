...
id|DMA_TO_DEVICE
suffix:colon
singleline_comment|//dma_cache_wback(addr, size);
r_break
suffix:semicolon
r_case
id|DMA_FROM_DEVICE
suffix:colon
singleline_comment|//dma_cache_inv(addr, size);
r_break
suffix:semicolon
r_case
id|DMA_BIDIRECTIONAL
suffix:colon
singleline_comment|//dma_cache_wback_inv(addr, size);
r_break
suffix:semicolon
r_default
suffix:colon
...
suffix:semicolon
multiline_comment|/* The DAC routines are a PCIism.. */

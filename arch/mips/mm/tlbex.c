multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Synthesize TLB refill handlers at runtime.&n; *&n; * Copyright (C) 2004 by Thiemo Seufer&n; */
...
comma
DECL|enumerator|label_tlbwr_hazard
id|label_tlbwr_hazard
comma
...
multiline_comment|/* The only registers allowed in TLB handlers. */
DECL|macro|K0
...
multiline_comment|/*&n; * Write random TLB entry, and care about the hazards from the&n; * preceeding mtc0 and for the following eret.&n; */
DECL|function|build_tlb_write_random_entry
r_static
id|__init
r_void
id|build_tlb_write_random_entry
c_func
(paren
id|u32
op_star
...
id|CPU_R4400MC
suffix:colon
multiline_comment|/*&n;&t;&t; * This branch uses up a mtc0 hazard nop slot and saves&n;&t;&t; * two nops after the tlbwr.&n;&t;&t; */
id|il_bgezl
c_func
(paren
id|p
...
multiline_comment|/*&n;&t;&t; * This branch uses up a mtc0 hazard nop slot and saves&n;&t;&t; * a nop after the tlbwr.&n;&t;&t; */
id|il_bgezl
c_func
(paren
id|p
...
l_int|0xff0
suffix:semicolon
macro_line|#if !defined(CONFIG_MIPS64) &amp;&amp; !defined(CONFIG_64BIT_PHYS_ADDR)
id|shift
op_increment
suffix:semicolon
id|mask
...
suffix:semicolon
multiline_comment|/* get pmd ptr in K1 */
macro_line|#else
id|build_get_pgde32
c_func
(paren
...
suffix:semicolon
multiline_comment|/* get pgd ptr in K1 */
macro_line|#endif
id|build_get_ptep
c_func
(paren

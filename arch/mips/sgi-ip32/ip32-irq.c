...
multiline_comment|/* issue a PIO read to make sure no PIO writes are pending */
DECL|macro|flush_crime_bus
mdefine_line|#define flush_crime_bus() crime_read(CRIME_CONTROL);
DECL|function|flush_mace_bus
r_static
r_void
r_inline
id|flush_mace_bus
...
suffix:semicolon
multiline_comment|/*&n; * For interrupts wired from a single device to the CPU.  Only the clock&n; * uses this it seems, which is IRQ 0 and IP7.&n; */
...
suffix:semicolon
multiline_comment|/*&n; * This is for MACE PCI interrupts.  We can decrease bus traffic by masking&n; * as close to the source as possible.  This also means we can take the&n; * next chunk of the CRIME register in one piece.&n; */
DECL|variable|macepci_mask
r_static
r_int
r_int
id|macepci_mask
...
mdefine_line|#define MACEISA_AUDIO_INT&t;(MACEISA_AUDIO_SW_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO_SC_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO1_DMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO1_OF_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO2_DMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO2_MERR_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO3_DMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_AUDIO3_MERR_INT)
DECL|macro|MACEISA_MISC_INT
mdefine_line|#define MACEISA_MISC_INT&t;(MACEISA_RTC_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_KEYB_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_KEYB_POLL_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_MOUSE_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_MOUSE_POLL_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_TIMER0_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_TIMER1_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_TIMER2_INT)
DECL|macro|MACEISA_SUPERIO_INT
mdefine_line|#define MACEISA_SUPERIO_INT&t;(MACEISA_PARALLEL_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_PAR_CTXA_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_PAR_CTXB_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_PAR_MERR_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_TDMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_TDMAPR_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_TDMAME_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_RDMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL1_RDMAOR_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_INT |&t;&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_TDMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_TDMAPR_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_TDMAME_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_RDMAT_INT |&t;&bslash;&n;&t;&t;&t;&t; MACEISA_SERIAL2_RDMAOR_INT)
DECL|variable|maceisa_mask
r_static
r_int
r_int
id|maceisa_mask
...
id|DBG
(paren
l_string|&quot;crime_int %08x enabled&bslash;n&quot;
comma
id|crime_int
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;cp0_status: %08x&bslash;n&quot;
comma
id|read_c0_status
c_func
(paren
...
id|printk
(paren
l_string|&quot;cp0_cause: %08x&bslash;n&quot;
comma
id|read_c0_cause
c_func
(paren
...
id|printk
(paren
l_string|&quot;CRIME intr mask: %016lx&bslash;n&quot;
comma
id|crime
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;CRIME intr status: %016lx&bslash;n&quot;
comma
id|crime
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;CRIME hardware intr register: %016lx&bslash;n&quot;
comma
id|crime
)paren
suffix:semicolon
id|printk
(paren
l_string|&quot;MACE ISA intr mask: %08lx&bslash;n&quot;
comma
id|mace_perif_ctrl_read
c_func
(paren
...
id|printk
(paren
l_string|&quot;MACE ISA intr status: %08lx&bslash;n&quot;
comma
id|mace_perif_ctrl_read
c_func
(paren
...
c_func
(paren
l_string|&quot;Please mail this report to linux-mips@linux-mips.org&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
multiline_comment|/* change this to loop over all edge-triggered irqs, exception masked out ones */
...
suffix:semicolon
multiline_comment|/* Install our interrupt handler, then clear and disable all&n;&t; * CRIME and MACE interrupts. */
id|crime_write
c_func
(paren
l_int|0

...
mdefine_line|#define flush_crime_bus() crime_read_64(CRIME_CONTROL);
DECL|macro|flush_mace_bus
mdefine_line|#define flush_mace_bus() mace_read_64(MACEISA_FLASH_NIC_REG);

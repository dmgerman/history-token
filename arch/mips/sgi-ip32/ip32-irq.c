...
suffix:semicolon
multiline_comment|/*&n;&t; * In case the CRIME interrupt isn&squot;t enabled, we must enable it;&n;&t; * however, we never disable interrupts at that level.&n;&t; */
id|crime_mask
op_assign
id|crime_read_64
c_func
...
suffix:semicolon
multiline_comment|/* disable crime interrupts */
id|crime_mask
op_assign
id|crime_read_64
c_func
...
suffix:semicolon
multiline_comment|/* enable crime interrupts */
id|crime_write_64
c_func
(paren
id|CRIME_INT_MASK

...
DECL|macro|CONFIG_AU1000_SERIAL_CONSOLE
macro_line|#undef CONFIG_AU1000_SERIAL_CONSOLE
macro_line|#endif
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined(CONFIG_AU1000_SERIAL_CONSOLE) &amp;&amp; defined(CONFIG_MAGIC_SYSRQ)
...
macro_line|#if 0
multiline_comment|/* au1000, uart0 irq is 0 */
r_if
c_cond
(paren
id|state-&gt;irq
...
singleline_comment|//&t;if (state-&gt;irq &amp;&amp; (!IRQ_ports[state-&gt;irq] ||
r_if
c_cond
(paren
(paren
...
suffix:semicolon
singleline_comment|//if (baud == 38400 &amp;&amp;
r_if
c_cond
(paren
(paren

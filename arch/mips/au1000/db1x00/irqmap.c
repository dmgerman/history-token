...
op_assign
(brace
macro_line|#ifndef CONFIG_MIPS_MIRAGE
...
comma
multiline_comment|/* PCMCIA Card 0 IRQ# */
(brace
id|AU1000_GPIO_5
comma
id|INTC_INT_LOW_LEVEL
...
comma
multiline_comment|/* PCMCIA Card 1 IRQ# */
macro_line|#else
(brace
id|AU1000_GPIO_0
comma
...
comma
multiline_comment|/* PCMCIA Card 0 Fully_Interted# */
(brace
id|AU1000_GPIO_1
comma
id|INTC_INT_LOW_LEVEL
...
comma
multiline_comment|/* PCMCIA Card 0 STSCHG# */
(brace
id|AU1000_GPIO_2
comma
id|INTC_INT_LOW_LEVEL
...
comma
multiline_comment|/* PCMCIA Card 1 Fully_Interted# */
(brace
id|AU1000_GPIO_4
comma
id|INTC_INT_LOW_LEVEL
...
comma
multiline_comment|/* PCMCIA Card 1 STSCHG# */
(brace
id|AU1000_GPIO_5
comma
id|INTC_INT_LOW_LEVEL
...
comma
multiline_comment|/* touchscreen pen down */
macro_line|#endif
)brace
suffix:semicolon

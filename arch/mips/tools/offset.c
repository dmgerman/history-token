...
suffix:semicolon
macro_line|#error&t;offset(&quot;#define TASK_SIGPENDING    &quot;, struct task_struct, work.sigpending);
macro_line|#error&t;offset(&quot;#define TASK_NEED_RESCHED  &quot;, struct task_struct, work.need_resched);

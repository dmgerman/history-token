...
DECL|function|do_ioasic_gettimeoffset
r_static
r_int
r_int
id|do_ioasic_gettimeoffset
c_func
(paren
r_void
)paren
...
id|timerlo
suffix:semicolon
singleline_comment|//printk(&quot;count: %08x, %08x:%08x&bslash;n&quot;, count, timerhi, timerlo);
id|__asm__
c_func
(paren
l_string|&quot;multu&t;%2,%3&quot;
...
DECL|function|ioasic_timer_interrupt
r_static
r_void
id|ioasic_timer_interrupt
c_func
(paren
r_int
id|irq
...
id|count
suffix:semicolon
multiline_comment|/*&n;&t; * The free-running counter is 32 bit which is good for about&n;&t; * 2 minutes, 50 seconds at possible count rates of upto 25MHz.&n;&t; */
id|count
op_assign
id|ioasic_read
c_func

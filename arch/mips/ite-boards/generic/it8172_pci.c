...
c_func
(paren
l_string|&quot;it config: type %d bus %d dev_fn %x data %x&bslash;n&quot;
comma
id|access_type
comma
id|bus
...
r_static
r_int
DECL|function|it8172_pcibios_read
id|it8172_pcibios_read
(paren
r_struct
id|pci_bus
op_star
...
c_func
(paren
l_string|&quot;cfg read: bus %d devfn %x where %x size %x: val %x&bslash;n&quot;
comma
id|bus-&gt;number
comma
id|devfn
...
r_static
r_int
DECL|function|it8172_pcibios_write
id|it8172_pcibios_write
(paren
r_struct
id|pci_bus
op_star

...
id|MACH_IVR
suffix:semicolon
multiline_comment|/* Globespan&squot;s iTVC15 reference board */
id|prom_init_cmdline
c_func
(paren
)paren
suffix:semicolon
multiline_comment|/* pmon does not set memsize */
id|mem_size
op_assign
id|prom_get_memsize
c_func

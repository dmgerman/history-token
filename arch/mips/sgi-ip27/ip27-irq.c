...
mdefine_line|#define FAST_IRQ_TO_LEVEL(i)&t;(i)
DECL|macro|LEVEL_TO_IRQ
mdefine_line|#define LEVEL_TO_IRQ(c, l) (node_level_to_irq[CPUID_TO_COMPACT_NODEID(c)][(l)])

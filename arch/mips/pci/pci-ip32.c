...
DECL|macro|mkaddr
mdefine_line|#define mkaddr(_devfn, where) &bslash;&n;((((_devfn) &amp; 0xffUL) &lt;&lt; 8) | ((where) &amp; 0xfcUL))
r_void
id|macepci_error
c_func
(paren
...
suffix:semicolon
DECL|function|macepci_read_config
r_static
r_int
id|macepci_read_config
c_func
(paren
r_struct
id|pci_bus
...
DECL|function|macepci_write_config
r_static
r_int
id|macepci_write_config
c_func
(paren
r_struct
id|pci_bus
...
c_func
(paren
l_string|&quot;PCI bridge can&squot;t get interrupt; can&squot;t happen.&quot;
)paren
suffix:semicolon
id|pci_scan_bus
c_func
...
multiline_comment|/*&n;&t; * Fixup O2 PCI slot. Bad hack.&n;&t; */
multiline_comment|/*        devtag = pci_make_tag(0, 0, 3, 0);&n;&n;        slot = macepci_conf_read(0, devtag, PCI_COMMAND_STATUS_REG);&n;        slot |= PCI_COMMAND_IO_ENABLE | PCI_COMMAND_MEM_ENABLE;&n;        macepci_conf_write(0, devtag, PCI_COMMAND_STATUS_REG, slot);&n;&n;        slot = macepci_conf_read(0, devtag, PCI_MAPREG_START);&n;        if (slot == 0xffffffe1)&n;                macepci_conf_write(0, devtag, PCI_MAPREG_START, 0x00001000);&n;&n;        slot = macepci_conf_read(0, devtag, PCI_MAPREG_START + (2 &lt;&lt; 2));&n;        if ((slot &amp; 0xffff0000) == 0) {&n;                slot += 0x00010000;&n;                macepci_conf_write(0, devtag, PCI_MAPREG_START + (2 &lt;&lt; 2),&n;                    0x00000000);&n;        }&n; */
macro_line|#ifdef DEBUG_MACE_PCI
id|printk
c_func
(paren

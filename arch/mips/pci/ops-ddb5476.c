multiline_comment|/*&n; * Copyright 2001 MontaVista Software Inc.&n; * Author: Jun Sun, jsun@mvista.com or jsun@junsun.net&n; *&n; * arch/mips/ddb5xxx/ddb5476/pci_ops.c&n; *     Define the pci_ops for DB5477.&n; *&n; * Much of the code is derived from the original DDB5074 port by&n; * Geert Uytterhoeven &lt;geert@sonycom.com&gt;&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; *&n; */
...
suffix:semicolon
multiline_comment|/*&n; * On DDB5476, we have one set of swap registers&n; */
...
suffix:semicolon
DECL|variable|pci_config_workaround
r_static
r_int
id|pci_config_workaround
op_assign
l_int|1
suffix:semicolon
...
(brace
multiline_comment|/* [jsun] work around Vrc5476 controller itself, returnning&n;&t;&t; * slot 0 essentially makes vrc5476 invisible&n;&t;&t; */
r_if
c_cond
(paren
id|slot_num
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* BUG : skip P2P bridge for now */
r_if
c_cond
(paren
id|slot_num
...
r_else
(brace
multiline_comment|/* now we have to be hornest, returning the true&n;&t;&t; * PCI config headers for vrc5476&n;&t;&t; */
r_if
c_cond
(paren
id|slot_num
...
suffix:semicolon
multiline_comment|/* panic(&quot;ddb_access_config_base: we don&squot;t support type 1 config Yet&quot;); */
)brace
...
DECL|variable|ddb5476_ext_pci_ops
r_struct
id|pci_ops
id|ddb5476_ext_pci_ops
op_assign
(brace
id|extpci_read_config_byte
comma
id|extpci_read_config_word
comma
id|extpci_read_config_dword
comma
id|extpci_write_config_byte
comma
id|extpci_write_config_word
comma
id|extpci_write_config_dword
)brace
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;scan ddb5476 external PCI bus:&bslash;n&quot;
)paren
suffix:semicolon
id|bus.ops
op_assign

...
id|IORESOURCE_IO
suffix:semicolon
singleline_comment|//printk(KERN_WARNING &quot;PCI: bridge %s does not support I/O forwarding!&bslash;n&quot;, bridge-&gt;name);
r_return
l_int|0
suffix:semicolon
)brace

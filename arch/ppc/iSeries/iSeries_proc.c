...
DECL|macro|MYQUEUE
mdefine_line|#define MYQUEUE(T) &bslash;&n;MYQUEUETYPE(T) &bslash;&n;{ &bslash;&n;struct T *head; &bslash;&n;struct T *tail; &bslash;&n;}
DECL|macro|MYQUEUECTOR
mdefine_line|#define MYQUEUECTOR(q) do { (q)-&gt;head = NULL; (q)-&gt;tail = NULL; } while(0)
DECL|macro|MYQUEUEENQ
mdefine_line|#define MYQUEUEENQ(q, p) &bslash;&n;do { &bslash;&n;(p)-&gt;next = NULL; &bslash;&n;if ((q)-&gt;head != NULL) &bslash;&n;{ &bslash;&n;(q)-&gt;head-&gt;next = (p); &bslash;&n;(q)-&gt;head = (p); &bslash;&n;} &bslash;&n;else &bslash;&n;{ &bslash;&n;(q)-&gt;tail = (q)-&gt;head = (p); &bslash;&n;} &bslash;&n;} while(0)
DECL|macro|MYQUEUEDEQ
mdefine_line|#define MYQUEUEDEQ(q,p) &bslash;&n;do { &bslash;&n;(p) = (q)-&gt;tail; &bslash;&n;if ((p) != NULL) &bslash;&n;{ &bslash;&n;(q)-&gt;tail = (p)-&gt;next; &bslash;&n;(p)-&gt;next = NULL; &bslash;&n;} &bslash;&n;if ((q)-&gt;tail == NULL) &bslash;&n;(q)-&gt;head = NULL; &bslash;&n;} while(0)
...
(brace
singleline_comment|//&t;    printk(&quot;Registering %p in reg %p&bslash;n&quot;, initFunction, reg);
id|reg-&gt;functionMember
op_assign
id|initFunction
suffix:semicolon

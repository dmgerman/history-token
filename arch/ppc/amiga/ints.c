multiline_comment|/*&n; *  arch/ppc/amiga/ints.c&n; *&n; *  Linux/m68k general interrupt handling code from arch/m68k/kernel/ints.c&n; *  Needed to drive the m68k emulating IRQ hardware on the PowerUp boards.&n; */

multiline_comment|/*&n; *  arch/ppc/amiga/bootinfo.c&n; *&n; *  Extracted from arch/m68k/kernel/setup.c.&n; *  Should be properly generalized and put somewhere else.&n; *                              Jesper&n; */

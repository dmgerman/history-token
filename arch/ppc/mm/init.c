multiline_comment|/*&n; * BK Id: SCCS/s.init.c 1.22 05/17/01 18:14:23 cort&n; */
...
mdefine_line|#define MAX_LOW_MEM&t;(512 &lt;&lt; 20)
DECL|macro|PGTOKB
...
suffix:semicolon
macro_line|#else
multiline_comment|/* this could cause problems on SMP with nobats  -- paulus */
multiline_comment|/* XXX no hash_table_lock?  interesting  -- paulus */
id|__clear_user
c_func
(paren
id|Hash
...
(brace
multiline_comment|/* don&squot;t try to reassign a new context to the kernel */
multiline_comment|/*&n;&t;&t; * This could cause problems on SMP if we aren&squot;t using&n;&t;&t; * the BATs (e.g. on POWER4 or if the nobats option is used).&n;&t;&t; * The problem scenario is that one cpu is doing&n;&t;&t; * flush_hash_page or similar when another cpu clears&n;&t;&t; * out the HPTEs which map the flush_hash_page text&n;&t;&t; * and the hash table.  hash_page will then deadlock.&n;&t;&t; * We need some way to have &quot;protected&quot; HPTEs or else&n;&t;&t; * do all hash-table manipulation with the MMU off.&n;&t;&t; *  -- paulus.&n;&t;&t; */
macro_line|#ifdef CONFIG_PPC64BRIDGE
id|flush_hash_segments
c_func
(paren
...
suffix:semicolon
multiline_comment|/* acquire the write lock for context overflow */
id|write_lock
(paren
op_amp
id|context_overflow_lock
...
suffix:semicolon
multiline_comment|/* recheck if overflow still exists */
r_if
c_cond
(paren
id|atomic_read
...
multiline_comment|/* need to check to assure current task has an mm */
multiline_comment|/*   - idle thread does not have an MM */
r_if
c_cond
(paren
id|current-&gt;mm
...
id|_MACH_chrp
suffix:colon
multiline_comment|/*&n;&t;&t; * The code below tends to get removed, please don&squot;t take it out.&n;&t;&t; * The F50 needs this mapping and it you take it out I&squot;ll track you&n;&t;&t; * down and slap your hands.  If it causes problems please email me.&n;&t;&t; *  -- Cort &lt;cort@fsmlabs.com&gt;&n;&t;&t; */
macro_line|#ifndef CONFIG_POWER3
id|setbat
c_func
(paren
l_int|0

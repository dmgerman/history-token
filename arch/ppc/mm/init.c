...
multiline_comment|/* just flush the kernel part of the address space, that&squot;s&n;&t;   all that the current callers of this require.  -- paulus. */
...
l_int|1
suffix:semicolon
multiline_comment|/* init_mm uses context 0 */
id|next_mmu_context
op_assign
l_int|1
suffix:semicolon

...
DECL|function|sys_debug_setcontext
r_int
id|sys_debug_setcontext
c_func
(paren
r_struct
id|ucontext
...
multiline_comment|/* We wait until here to actually install the values in the&n;&t;   registers so if we fail in the above loop, it will not&n;&t;   affect the contents of these registers.  After this point,&n;&t;   failure is a problem, anyway, and it&squot;s very unlikely unless&n;&t;   the user is really doing something wrong. */
id|regs-&gt;msr
op_assign
id|new_msr
suffix:semicolon

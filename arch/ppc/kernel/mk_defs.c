...
suffix:semicolon
macro_line|#error&t;DEFINE(SIGPENDING, offsetof(struct task_struct, sigpending));
id|DEFINE
c_func
(paren
id|THREAD
...
suffix:semicolon
macro_line|#error&t;DEFINE(TASK_PTRACE, offsetof(struct task_struct, ptrace));
macro_line|#error&t;DEFINE(NEED_RESCHED, offsetof(struct task_struct, need_resched));
id|DEFINE
c_func
(paren
id|THREAD_FPR0

multiline_comment|/*&n; * BK Id: SCCS/s.apus_setup.c 1.20 09/08/01 15:47:42 paulus&n; */
...
macro_line|#if 0&t;/* no longer used  -- paulus */
r_void
...
id|apus_get_irq
suffix:semicolon
macro_line|#error Should use the -&gt;end() member of irq_desc[x]. -- Cort
multiline_comment|/*ppc_md.post_irq       = apus_post_irq;*/
macro_line|#ifdef CONFIG_HEARTBEAT
id|ppc_md.heartbeat
op_assign
id|apus_heartbeat

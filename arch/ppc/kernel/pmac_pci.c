...
id|EINVAL
suffix:semicolon
multiline_comment|/* Firewire was disabled after PCI probe, the driver is claiming it,&n;&t; * so we must re-enable it now, at least until the driver can do it&n;&t; * itself.&n;&t; */
r_if
c_cond
(paren
id|node

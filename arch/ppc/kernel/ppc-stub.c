...
id|kgdb_fault_handler
suffix:semicolon
multiline_comment|/* Accessing 16 bit and 32 bit objects in a single&n;&t;&t;** load instruction is required to avoid bad side&n;&t;&t;** effects for some IO registers.&n;&t;&t;*/
r_if
c_cond
(paren
(paren
...
id|kgdb_fault_handler
suffix:semicolon
multiline_comment|/* Accessing 16 bit and 32 bit objects in a single&n;&t;&t;** store instruction is required to avoid bad side&n;&t;&t;** effects for some IO registers.&n;&t;&t;*/
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;&t;&t;** Flush the data cache, invalidate the instruction cache.&n;&t;&t;*/
...
comma
multiline_comment|/* critical input interrupt */
(brace
l_int|0x200
comma
id|SIGSEGV
...
comma
multiline_comment|/* data storage */
(brace
l_int|0x400
comma
id|SIGBUS
...
comma
multiline_comment|/* instruction storage */
(brace
l_int|0x500
comma
id|SIGINT

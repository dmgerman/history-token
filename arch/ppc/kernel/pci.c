...
c_func
(paren
l_string|&quot;No hose for PCI dev %x.%x !&bslash;n&quot;
comma
id|dev-&gt;bus-&gt;number
comma
id|dev-&gt;devfn
...
c_func
(paren
l_string|&quot;Fixup mem res, dev: %x.%x, res_start: %lx-&gt;%lx&bslash;n&quot;
comma
id|dev-&gt;bus-&gt;number
comma
id|dev-&gt;devfn
...
c_func
(paren
l_string|&quot;Fixup IO res, dev: %x.%x, res_start: %lx-&gt;%lx&bslash;n&quot;
comma
id|dev-&gt;bus-&gt;number
comma
id|dev-&gt;devfn
...
c_func
(paren
l_string|&quot;PCI:%x:%x:%x: Resource %08lx-%08lx (f=%lx)&bslash;n&quot;
comma
id|dev-&gt;bus-&gt;number
comma
id|dev-&gt;devfn
...
suffix:semicolon
macro_line|#if 0&t;/* we don&squot;t need this PC-ism */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t;&t;&t; *  We shall assign a new address to this resource, either because&n;&t;&t;&t; *  the BIOS (sic) forgot to do so or because we have decided the old&n;&t;&t;&t; *  address was unusable for some reason.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Apply pci_mem_offset to bridge mem resource */
r_if
c_cond
(paren
id|hose-&gt;first_busno

...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * Fix the interrupt routing on the TI1211 chip on the 1999&n;&t; * G3 powerbook, which doesn&squot;t get initialized properly by OF.&n;&t; * Same problem with the 1410 of the new titanium pbook which&n;&t; * has the same register.&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;vendor

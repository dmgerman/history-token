...
mdefine_line|#define check_arg_irq(irq) &bslash;&n;    if (irq &lt; open_pic_irq_offset || irq &gt;= (NumSources+open_pic_irq_offset)){ &bslash;&n;      printk(&quot;open_pic.c:%d: illegal irq %d&bslash;n&quot;, __LINE__, irq); &bslash;&n;      print_backtrace(_get_SP()); }
...
macro_line|#else
DECL|macro|GET_ISU
mdefine_line|#define GET_ISU(source)&t;ISU[0][(source)]
macro_line|#endif
...
suffix:semicolon
multiline_comment|/*&n;         * Never want to disable a timer or ipi irq&n;         * (only want to disable irqs within an ISU).&n;         */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* silently ignore the enable of the timer or ipi irq. */
r_return
suffix:semicolon
)brace
id|openpic_clearfield
...
c_func
(paren
l_string|&quot;openpic_disable_irq - disabling non-ISU irq&quot;
)paren
suffix:semicolon
)brace
id|openpic_setfield
...
(brace
macro_line|#if 1 /* masking should be unnecessary, but I still get spurrious */
id|openpic_disable_irq
c_func
(paren
id|irq_nr

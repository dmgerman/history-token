...
DECL|macro|INST_STRING
mdefine_line|#define INST_STRING&t;&t;0x7c00042a
DECL|macro|INST_STRING_MASK
mdefine_line|#define INST_STRING_MASK&t;0x7c0007fe
DECL|macro|INST_STRING_GEN_MASK
mdefine_line|#define INST_STRING_GEN_MASK&t;0x7c00067e
DECL|macro|INST_LSWI
mdefine_line|#define INST_LSWI&t;&t;0x7c0004aa
DECL|macro|INST_LSWX
mdefine_line|#define INST_LSWX&t;&t;0x7c00042a
DECL|macro|INST_STSWI
mdefine_line|#define INST_STSWI&t;&t;0x7c0005aa
DECL|macro|INST_STSWX
mdefine_line|#define INST_STSWX&t;&t;0x7c00052a
DECL|function|emulate_string_inst
r_static
r_int
id|emulate_string_inst
c_func
(paren
r_struct
id|pt_regs
...
l_int|0
suffix:semicolon
multiline_comment|/* Early out if we are an invalid form of lswx */
r_if
c_cond
(paren
(paren
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Early out if we are an invalid form of lswi */
r_if
c_cond
(paren
(paren
...
id|EFAULT
suffix:semicolon
multiline_comment|/* first time updating this reg,&n;&t;&t;&t;&t; * zero it out */
r_if
c_cond
(paren
id|pos
...
multiline_comment|/* move EA to next address */
id|EA
op_add_assign
l_int|1
suffix:semicolon
...
op_decrement
suffix:semicolon
multiline_comment|/* manage our position within the register */
r_if
c_cond
(paren
op_increment
...
multiline_comment|/* Emulate load/store string insn. */
r_if
c_cond
(paren
(paren

...
DECL|macro|SX
mdefine_line|#define SX&t;0x40&t;/* byte count in XER */
DECL|macro|HARD
...
(brace
multiline_comment|/* lmw, stmw, lswi/x, stswi/x */
id|nb0
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/* read/write the least significant bits */
id|data.l
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* If we read the operand, copy it in, else get register values */
r_if
c_cond
(paren
id|flags
...
r_break
suffix:semicolon
multiline_comment|/* Single-precision FP load and store require conversions... */
r_case
id|LD
op_plus
id|F

...
id|keylargo_rev
suffix:semicolon
multiline_comment|/*&n; * WARNING ! This function is called early in setup_arch, neither the IO base&n; * nor the udelay calibration have been done yet&n; */
r_void
...
r_void
DECL|function|feature_core99_kick_cpu1
...
c_func
(paren
id|KL_GPIO_KICK_CPU1
)paren
comma
id|KL_GPIO_KICK_CPU1_UP
)paren
suffix:semicolon
id|udelay
c_func
...
suffix:semicolon
multiline_comment|/* Kludge (enable FW before PCI probe) */
id|fw
op_assign
id|find_devices
c_func

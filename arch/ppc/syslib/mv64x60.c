...
DECL|variable|mv64x60_mpsc_shared_pd_dd
r_static
r_struct
id|mpsc_shared_pd_dd
id|mv64x60_mpsc_shared_pd_dd
op_assign
(brace
dot
id|mrr_val
...
suffix:semicolon
DECL|variable|mv64x60_mpsc0_pd_dd
r_static
r_struct
id|mpsc_pd_dd
id|mv64x60_mpsc0_pd_dd
op_assign
(brace
dot
id|mirror_regs
...
suffix:semicolon
DECL|variable|mv64x60_mpsc1_pd_dd
r_static
r_struct
id|mpsc_pd_dd
id|mv64x60_mpsc1_pd_dd
op_assign
(brace
dot
id|mirror_regs
...
multiline_comment|/*&n; * mv64x60_mask_shift_left()&n; *&n; * Take the low-order &squot;num_bits&squot; of &squot;val&squot;, shift left to align at bit 31 (MSB).&n; */
id|u32
id|__init
...
suffix:semicolon
macro_line|#ifdef CONFIG_SERIAL_MPSC
id|mv64x60_mpsc0_pd_dd.mirror_regs
op_assign
l_int|1
suffix:semicolon
id|mv64x60_mpsc0_pd_dd.cache_mgmt
op_assign
l_int|1
suffix:semicolon
id|mv64x60_mpsc1_pd_dd.mirror_regs
op_assign
l_int|1
suffix:semicolon
id|mv64x60_mpsc1_pd_dd.cache_mgmt
op_assign
l_int|1
suffix:semicolon
r_if
...
(brace
macro_line|#ifdef CONFIG_SERIAL_MPSC
id|mv64x60_mpsc0_pd_dd.brg_can_tune
op_assign
l_int|1
suffix:semicolon
id|mv64x60_mpsc0_pd_dd.cache_mgmt
...
l_int|1
suffix:semicolon
id|mv64x60_mpsc1_pd_dd.brg_can_tune
op_assign
l_int|1
suffix:semicolon
id|mv64x60_mpsc1_pd_dd.cache_mgmt

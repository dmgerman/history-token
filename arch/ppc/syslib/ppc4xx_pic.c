...
id|ppc4xx_pic
suffix:semicolon
multiline_comment|/*&n; * We define 4xxIRQ_InitSenses table thusly:&n; * bit 0x1: sense, 1 for edge and 0 for level.&n; * bit 0x2: polarity, 0 for negative, 1 for positive.&n; */
...
macro_line|#endif
macro_line|#ifndef UIC2
DECL|macro|UIC2
mdefine_line|#define UIC2 UIC1
macro_line|#endif
r_static
r_void
DECL|function|ppc4xx_uic_enable
id|ppc4xx_uic_enable
c_func
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;ppc4xx_uic_enable - irq %d word %d bit 0x%x&bslash;n&quot;
comma
id|irq
comma
id|word
...
r_static
r_void
DECL|function|ppc4xx_uic_disable
id|ppc4xx_uic_disable
c_func
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;ppc4xx_uic_disable - irq %d word %d bit 0x%x&bslash;n&quot;
comma
id|irq
comma
id|word
...
r_static
r_void
DECL|function|ppc4xx_uic_disable_and_ack
id|ppc4xx_uic_disable_and_ack
c_func
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;ppc4xx_uic_disable_and_ack - irq %d word %d bit 0x%x&bslash;n&quot;
comma
id|irq
comma
id|word
...
c_func
(paren
l_string|&quot;ppc4xx_uic_end - irq %d word %d bit 0x%x&bslash;n&quot;
comma
id|irq
comma
id|word
...
c_func
(paren
l_string|&quot;ppc4xx_pic_get_irq - irq %d bit 0x%x&bslash;n&quot;
comma
id|irq
comma
id|bits
...
r_void
id|__init
DECL|function|ppc4xx_extpic_init
id|ppc4xx_extpic_init
c_func
(paren
r_void
)paren
...
l_int|3
suffix:semicolon
macro_line|#ifdef PPC4xx_PIC_DEBUG
id|printk
c_func
(paren
l_string|&quot;PPC4xx_picext %d word:%x bit:%x sense:%x&quot;
comma
id|irq
comma
id|word
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* polarity  setting */
id|mtdcr
c_func
(paren
id|DCRN_UIC_PR
...
suffix:semicolon
multiline_comment|/* Level setting */
id|mtdcr
c_func
(paren
id|DCRN_UIC_TR

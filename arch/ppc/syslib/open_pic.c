...
macro_line|#endif /* CONFIG_SMP */
macro_line|#if defined(CONFIG_EPIC_SERIAL_MODE) || defined(CONFIG_PMAC_PBOOK)
...
macro_line|#if defined(CONFIG_SMP) || defined(CONFIG_PMAC_PBOOK)
...
multiline_comment|/*&n; * Initalize the interrupt source which will generate an NMI (and disable it).&n; *&n; * irq: The logical IRQ which generates an NMI.&n; */
r_void
id|__init
...
id|sense
suffix:semicolon
multiline_comment|/* If this wasn&squot;t given, assume a level, negative polarity interrupt. */
id|sense
op_assign
(paren
id|irq
...
r_void
id|__pmac
DECL|function|openpic_sleep_save_intrs
...
r_void
id|__pmac
DECL|function|openpic_sleep_restore_intrs

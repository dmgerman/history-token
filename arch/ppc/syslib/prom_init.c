...
multiline_comment|/*&n; * Set up a hash table with a set of entries in it to map the&n; * first 64MB of RAM.  This is used on 64-bit machines since&n; * some of them don&squot;t have BATs.&n; */
...
suffix:semicolon
macro_line|#if 0 /* DEBUG stuff mapping the SCC */
id|make_pte
c_func
(paren
id|htab
...
suffix:semicolon
macro_line|#ifdef CONFIG_POWER4
macro_line|#if CONFIG_TASK_SIZE &gt; 0x80000000
macro_line|#error CONFIG_TASK_SIZE cannot be above 0x80000000 with BOOTX_TEXT on G5
macro_line|#endif
(brace
r_extern
id|boot_infos_t
...
(brace
multiline_comment|/* Pegasos 1 has a broken translate method in the OF,&n;&t;&t; * and furthermore the BATs are mapped 1:1 so the phys&n;&t;&t; * address calculated above is correct, so let&squot;s use&n;&t;&t; * it directly.&n;&t;&t; */
)brace
r_else
r_if
c_cond
...
(brace
multiline_comment|/* If we are already running at 0xc0000000, we assume we were&n;&t; &t; * loaded by an OF bootloader which did set a BAT for us.&n;&t; &t; * This breaks OF translate so we force phys to be 0.&n;&t; &t; */
id|prom_print
c_func
(paren
l_string|&quot;(already at 0xc0000000) phys=0&bslash;n&quot;
)paren
suffix:semicolon
id|phys
op_assign

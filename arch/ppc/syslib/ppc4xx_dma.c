...
multiline_comment|/*&n; * Clears the channel status bits&n; */
r_int
DECL|function|ppc4xx_clr_dma_status
...
(paren
id|KERN_ERR
l_string|&quot;ppc4xx_clr_dma_status: bad channel: %d&bslash;n&quot;
comma
id|dmanr
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Enables the burst on the channel (BTEN bit in the control/count register)&n; * Note:&n; * For scatter/gather dma, this function MUST be called before the&n; * ppc4xx_alloc_dma_handle() func as the chan count register is copied into the&n; * sgl list and used as each sgl element is added.&n; */
r_int
DECL|function|ppc4xx_enable_burst
...
(paren
id|KERN_ERR
l_string|&quot;ppc4xx_enable_burst: bad channel: %d&bslash;n&quot;
comma
id|dmanr
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Disables the burst on the channel (BTEN bit in the control/count register)&n; * Note:&n; * For scatter/gather dma, this function MUST be called before the&n; * ppc4xx_alloc_dma_handle() func as the chan count register is copied into the&n; * sgl list and used as each sgl element is added.&n; */
r_int
DECL|function|ppc4xx_disable_burst
...
(paren
id|KERN_ERR
l_string|&quot;ppc4xx_disable_burst: bad channel: %d&bslash;n&quot;
comma
id|dmanr
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Sets the burst size (number of peripheral widths) for the channel&n; * (BSIZ bits in the control/count register))&n; * must be one of:&n; *    DMA_CTC_BSIZ_2&n; *    DMA_CTC_BSIZ_4&n; *    DMA_CTC_BSIZ_8&n; *    DMA_CTC_BSIZ_16&n; * Note:&n; * For scatter/gather dma, this function MUST be called before the&n; * ppc4xx_alloc_dma_handle() func as the chan count register is copied into the&n; * sgl list and used as each sgl element is added.&n; */
r_int
DECL|function|ppc4xx_set_burst_size
...
(paren
id|KERN_ERR
l_string|&quot;ppc4xx_set_burst_size: bad channel: %d&bslash;n&quot;
comma
id|dmanr
)paren
suffix:semicolon
...
suffix:semicolon
DECL|variable|ppc4xx_clr_dma_status
id|EXPORT_SYMBOL
c_func
(paren
id|ppc4xx_clr_dma_status
...
suffix:semicolon
DECL|variable|ppc4xx_enable_burst
id|EXPORT_SYMBOL
c_func
(paren
id|ppc4xx_enable_burst
...
suffix:semicolon
DECL|variable|ppc4xx_disable_burst
id|EXPORT_SYMBOL
c_func
(paren
id|ppc4xx_disable_burst
...
suffix:semicolon
DECL|variable|ppc4xx_set_burst_size
id|EXPORT_SYMBOL
c_func
(paren
id|ppc4xx_set_burst_size

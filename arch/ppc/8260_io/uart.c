...
multiline_comment|/* SCC Console configuration.  Not quite finished.  The SCC_CONSOLE&n; * should be the number of the SCC to use, but only SCC1 will&n; * work at this time.&n; */
...
macro_line|#endif
macro_line|#ifndef CONFIG_SCC1_ENET
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SCC2 ttyS3 */
macro_line|#endif
)brace
suffix:semicolon
macro_line|#else /* SCC_CONSOLE */
DECL|macro|SCC_NUM_BASE
mdefine_line|#define SCC_NUM_BASE&t;0&t;/* SCC base tty &quot;number&quot; */
DECL|macro|SCC_IDX_BASE
mdefine_line|#define SCC_IDX_BASE&t;0&t;/* table index */
DECL|variable|rs_table
r_static
r_struct
id|serial_state
...
suffix:semicolon
macro_line|#endif /* SCC_CONSOLE */
DECL|macro|PORT_NUM
mdefine_line|#define PORT_NUM(P)&t;(((P) &lt; (SCC_NUM_BASE)) ? (P) : (P)-(SCC_NUM_BASE))
DECL|macro|NR_PORTS
...
macro_line|#ifdef CONFIG_SERIAL_CONSOLE
multiline_comment|/*&n; * Print a string to the serial port trying not to disturb any possible&n; * real use of the port...&n; * These funcitons work equally well for SCC, even though they are&n; * designed for SMC.  Our only interests are the transmit/receive&n; * buffers, which are identically mapped for either the SCC or SMC.&n; */
...
suffix:semicolon
multiline_comment|/* Tx */
multiline_comment|/* Connect SCC1, SCC2, SCC3 to NMSI.  Connect BRG1 to SCC1,&n;&t; * BRG2 to SCC2, BRG3 to SCC3.&n;&t; */
id|immap-&gt;im_cpmux.cmx_scr
op_and_assign
op_complement
l_int|0xffffff00
...
(paren
id|KERN_INFO
l_string|&quot;ttyS%d on %s%d at 0x%04x, BRG%d&bslash;n&quot;
comma
id|i
comma
(paren
...
l_int|0x3000
suffix:semicolon
multiline_comment|/* Wire BRG1 to SCC1.  The serial init will take care of&n;&t; * others.&n;&t; */
id|immap-&gt;im_cpmux.cmx_scr
op_assign
l_int|0
suffix:semicolon

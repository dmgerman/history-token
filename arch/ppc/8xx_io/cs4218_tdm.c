...
id|cp
suffix:semicolon
multiline_comment|/* Protect buffer */
...
id|flags
suffix:semicolon
multiline_comment|/* not sure if this is needed, since hardware command is #if 0&squot;d */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
multiline_comment|/* lock while modifying beep_timer */
id|spin_lock_irqsave
c_func
(paren
op_amp

multiline_comment|/*&n; * arch/ppc/boot/common/mpc10x_common.c&n; * &n; * A routine to find out how much memory the machine has.&n; *&n; * Based on:&n; * arch/ppc/kernel/mpc10x_common.c&n; *&n; * Author: Mark A. Greer&n; *         mgreer@mvista.com&n; *&n; * Copyright 2001-2002 MontaVista Software Inc.&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; */

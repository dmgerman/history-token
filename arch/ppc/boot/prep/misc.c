...
(brace
multiline_comment|/* We need to restore the slightly inaccurate&n;&t;&t;&t; * MSR so that OpenFirmware will behave. -- Tom&n;&t;&t;&t; */
id|_put_MSR
c_func
(paren
id|orig_MSR
...
id|hold_residual
suffix:semicolon
multiline_comment|/* Enforce a sane MSR for booting. */
id|_put_MSR
c_func
(paren
id|MSR_IP

...
id|rec_loc
suffix:semicolon
multiline_comment|/* We need to make sure that the initrd and bi_recs do not&n;&t;&t; * overlap. */
r_if
c_cond
(paren
id|initrd_size
...
suffix:semicolon
multiline_comment|/* If the bi_recs are in the middle of the current&n;&t;&t;&t; * initrd, move the initrd to the next MB&n;&t;&t;&t; * boundary. */
r_if
c_cond
(paren
(paren

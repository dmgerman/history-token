multiline_comment|/*&n; * BK Id: SCCS/s.embed_config.c 1.7 05/18/01 07:54:04 patch&n; */
...
macro_line|#if defined(CONFIG_RPXLITE) || defined(CONFIG_RPXCLASSIC) || defined(CONFIG_RPX6)
...
multiline_comment|/* We have to fill in everything.&n;*/
...
multiline_comment|/* The pointer we are given is for the string of key values.&n; */
DECL|variable|bdinfo
r_static
id|bd_t
id|bdinfo

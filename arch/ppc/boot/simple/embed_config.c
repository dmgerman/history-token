...
suffix:semicolon
multiline_comment|/* All we are looking for is the Ethernet MAC address.  The&n;&t; * first 8 bytes are &squot;MOTOROLA&squot;, so check for part of that.&n;&t; * Next, the VPD describes a MAC &squot;packet&squot; as being of type 08&n;&t; * and size 06.  So we look for that and the MAC must follow.&n;&t; * If there are more than one, we still only care about the first.&n;&t; * If it&squot;s there, assume we have a valid MAC address.  If not,&n;&t; * grab our default one.&n;&t; */
r_if
c_cond
(paren
(paren
...
l_int|2
suffix:semicolon
multiline_comment|/* skip this packet */
r_if
c_cond
(paren
id|i
...
multiline_comment|/* Couldn&squot;t find. */
id|mp
op_assign
(paren
id|u_char
...
macro_line|#ifdef CONFIG_8260
multiline_comment|/* Compute 8260 clock values if the rom doesn&squot;t provide them.&n; */
DECL|variable|bus2core_8260
r_static
r_int
r_char
id|bus2core_8260
...
l_int|0x1f
suffix:semicolon
multiline_comment|/* This is arithmetic from the 8280 manual.&n;&t;*/
id|main_clk
op_assign
id|clkin
op_star
...
multiline_comment|/* can busfreq be calculated? */
id|bd-&gt;bi_busfreq
op_assign
l_int|100000000
suffix:semicolon

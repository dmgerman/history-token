...
r_volatile
(paren
l_string|&quot;mftbu %0; mftb %1; mftbu %2&quot;
suffix:colon
l_string|&quot;=r&quot;
(paren
id|hi
...
c_func
(paren
l_string|&quot;%u.%06u seconds&bslash;n&quot;
comma
id|delta
op_div
l_int|1000000
...
c_func
(paren
l_string|&quot;W = %d (0x%x) H = %d (0x%x) D = %d (0x%x) P = %d (0x%x)&bslash;n&quot;
comma
id|disp_bi.dispDeviceRect
(braket
l_int|2
...
c_func
(paren
l_string|&quot;&bslash;nmsr = %x, sp = %x [%x]&bslash;n&quot;
comma
id|fp-&gt;msr
comma
id|fp-&gt;gpr
...
macro_line|#ifndef CONFIG_PPC_STD_MMU
r_static
r_void
...
c_func
(paren
l_string|&quot;This CPU doesn&squot;t have a hash table.&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#else
...
c_func
(paren
l_string|&quot;return value is %x&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;*** %x exception occurred&bslash;n&quot;
comma
id|fault_except
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;unknown symbol&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
r_char
op_star
DECL|function|xmon_find_symbol
id|xmon_find_symbol
c_func
(paren
r_int
...
r_int
r_int
DECL|function|xmon_symbol_to_addr
id|xmon_symbol_to_addr
c_func
(paren
r_char
...
l_int|1
suffix:semicolon
multiline_comment|/* best match if equal, better match if&n;&t;&t;&t;&t; * begins with&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|cur

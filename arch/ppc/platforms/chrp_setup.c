...
DECL|function|pegasos_set_l2cr
r_static
r_void
id|__init
id|pegasos_set_l2cr
...
id|np
suffix:semicolon
multiline_comment|/* On Pegasos, enable the l2 cache if needed, as the OF forgets it */
r_if
c_cond
(paren
id|_chrp_type
...
r_return
suffix:semicolon
multiline_comment|/* Enable L2 cache if needed */
id|np
op_assign
...
id|printk
(paren
l_string|&quot;Pegasos l2cr : no cpu l2cr property found&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
id|printk
(paren
l_string|&quot;Pegasos l2cr : L2 cache was not active, &quot;
...
multiline_comment|/* On pegasos, enable the L2 cache if not already done by OF */
id|pegasos_set_l2cr
c_func
(paren
)paren
...
r_else
(brace
multiline_comment|/* Let&squot;s assume it is an IBM chrp if all else fails */
id|_chrp_type
op_assign
id|_CHRP_IBM
suffix:semicolon

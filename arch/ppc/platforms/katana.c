multiline_comment|/*&n; * arch/ppc/platforms/katana.c&n; *&n; * Board setup routines for the Artesyn Katana cPCI boards.&n; *&n; * Author: Tim Montgomery &lt;timm@artesyncp.com&gt;&n; * Maintained by: Mark A. Greer &lt;mgreer@mvista.com&gt;&n; *&n; * Based on code done by Rabeeh Khoury - rabeeh@galileo.co.il&n; * Based on code done by - Mark A. Greer &lt;mgreer@mvista.com&gt;&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2 of the License, or (at your&n; * option) any later version.&n; */
...
suffix:semicolon
DECL|variable|katana_bus_frequency
r_static
id|u32
id|katana_bus_frequency
suffix:semicolon
DECL|variable|__res
r_int
r_char
...
id|save_exclude
suffix:semicolon
multiline_comment|/*&n;&t; * Some versions of the Katana firmware mistakenly change the vendor&n;&t; * &amp; device id fields in the bridge&squot;s pci device (visible via pci&n;&t; * config accesses).  This breaks mv64x60_init() because those values&n;&t; * are used to identify the type of bridge that&squot;s there.  Artesyn&n;&t; * claims that the subsystem vendor/device id&squot;s will have the correct&n;&t; * Marvell values so this code puts back the correct values from there.&n;&t; */
id|memset
c_func
(paren
op_amp
...
macro_line|#if defined(CONFIG_I2C_MV64XXX) &amp;&amp; defined(CONFIG_SENSORS_M41T00)
r_extern
id|ulong
...
r_int
id|__init
DECL|function|katana_rtc_hookup
id|katana_rtc_hookup
c_func
(paren
r_void
)paren
...
DECL|variable|katana_rtc_hookup
id|late_initcall
c_func
(paren
id|katana_rtc_hookup

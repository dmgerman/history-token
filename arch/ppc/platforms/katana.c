...
id|KATANA_ETH_RX_QUEUE_SIZE
suffix:semicolon
id|eth_pd-&gt;tx_sram_addr
op_assign
id|mv643xx_sram_alloc
c_func
(paren
id|tx_size
)paren
...
(paren
id|KERN_ERR
l_string|&quot;mv643xx_sram_alloc failed&bslash;n&quot;
)paren
suffix:semicolon
id|eth_pd-&gt;rx_sram_addr
op_assign
id|mv643xx_sram_alloc
c_func
(paren

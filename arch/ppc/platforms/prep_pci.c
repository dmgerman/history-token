...
r_return
suffix:semicolon
multiline_comment|/* Not I/O or memory?? */
)brace
)brace
r_else
r_return
suffix:semicolon
multiline_comment|/* Not a 32-bit address */
id|real_addr
op_assign
id|ld_le32
c_func
...
r_void
id|__init
DECL|function|prep_residual_setup_pci
...
multiline_comment|/*&n;&t;&t; * If we don&squot;t have residual data, then we need to use&n;&t;&t; * tables to determine the IRQ.  The table organisation&n;&t;&t; * is different depending on whether there is an OpenPIC&n;&t;&t; * or not.  The tables are only used for bus 0, so check&n;&t;&t; * this first.&n;&t;&t; */
r_else
r_if
c_cond
(paren
...
multiline_comment|/*&n;&t;&t; * Finally, if we don&squot;t have residual data and the bus is&n;&t;&t; * non-zero, use the callback (if provided)&n;&t;&t; */
r_else
(brace
r_if
c_cond

...
r_int
id|__prep
DECL|function|prep_read_config
id|prep_read_config
c_func
(paren
r_struct
...
r_int
id|__prep
DECL|function|prep_write_config
...
suffix:semicolon
multiline_comment|/* XXX why can&squot;t we use the indirect config space access method? */
id|hose-&gt;cfg_data
op_assign
id|ioremap
c_func

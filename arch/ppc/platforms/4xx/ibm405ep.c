multiline_comment|/*&n; * arch/ppc/platforms/ibm405ep.c&n; *&n; * Support for IBM PPC 405EP processors.&n; *&n; * Author: SAW (IBM), derived from ibmnp405l.c.&n; *         Maintained by MontaVista Software &lt;source@mvista.com&gt;&n; *&n; * 2003 (c) MontaVista Softare Inc.  This file is licensed under the&n; * terms of the GNU General Public License version 2. This program is&n; * licensed &quot;as is&quot; without any warranty of any kind, whether express&n; * or implied.&n; */
...
DECL|variable|ibm405ep_mal0_def
r_static
r_struct
id|ocp_func_mal_data
id|ibm405ep_mal0_def
op_assign
(brace
dot
id|num_tx_chans
...
DECL|variable|ibm405ep_emac0_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm405ep_emac0_def
op_assign
(brace
dot
id|rgmii_idx
...
l_int|0
comma
multiline_comment|/* MDIO via EMAC0 */
dot
id|tah_idx
op_assign
op_minus
...
suffix:semicolon
DECL|variable|ibm405ep_emac1_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm405ep_emac1_def
op_assign
(brace
dot
id|rgmii_idx
...
DECL|variable|ibm405ep_iic0_def
r_static
r_struct
id|ocp_func_iic_data
id|ibm405ep_iic0_def
op_assign
(brace
dot
id|fast_mode

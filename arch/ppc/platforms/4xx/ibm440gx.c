multiline_comment|/*&n; * arch/ppc/platforms/4xx/ibm440gx.c&n; *&n; * PPC440GX I/O descriptions&n; *&n; * Matt Porter &lt;mporter@mvista.com&gt;&n; * Copyright 2002-2004 MontaVista Software Inc.&n; *&n; * Eugene Surovegin &lt;eugene.surovegin@zultys.com&gt; or &lt;ebs@ebshome.net&gt;&n; * Copyright (c) 2003, 2004 Zultys Technologies&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; *&n; */
macro_line|#include &lt;linux/init.h&gt;
macro_line|#include &lt;linux/module.h&gt;
macro_line|#include &lt;platforms/4xx/ibm440gx.h&gt;
macro_line|#include &lt;asm/ocp.h&gt;
macro_line|#include &lt;asm/ppc4xx_pic.h&gt;
DECL|variable|ibm440gx_emac0_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm440gx_emac0_def
op_assign
(brace
dot
id|rgmii_idx
...
suffix:semicolon
DECL|variable|ibm440gx_emac1_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm440gx_emac1_def
op_assign
(brace
dot
id|rgmii_idx
...
suffix:semicolon
DECL|variable|ibm440gx_emac2_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm440gx_emac2_def
op_assign
(brace
dot
id|rgmii_idx
...
l_int|0
comma
multiline_comment|/* RGMII device index */
dot
id|rgmii_mux
op_assign
l_int|0
...
l_int|0
comma
multiline_comment|/* TAH device index */
dot
id|jumbo
op_assign
l_int|1
...
suffix:semicolon
DECL|variable|ibm440gx_emac3_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm440gx_emac3_def
op_assign
(brace
dot
id|rgmii_idx
...
DECL|variable|ibm440gx_mal0_def
r_static
r_struct
id|ocp_func_mal_data
id|ibm440gx_mal0_def
op_assign
(brace
dot
id|num_tx_chans
...
DECL|variable|ibm440gx_iic0_def
r_static
r_struct
id|ocp_func_iic_data
id|ibm440gx_iic0_def
op_assign
(brace
dot
id|fast_mode
...
suffix:semicolon
DECL|variable|ibm440gx_iic1_def
r_static
r_struct
id|ocp_func_iic_data
id|ibm440gx_iic1_def
op_assign
(brace
dot
id|fast_mode

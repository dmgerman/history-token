multiline_comment|/*&n; *&n; *&n; *    Copyright 2000 MontaVista Software Inc.&n; * &t;Author: MontaVista Software, Inc.&n; *         &t;akuster@mvista.com or source@mvista.com&n; *&n; *    Module name: cedar.h&n; *&n; *    Description:&n; *      Macros, definitions, and data structures specific to the IBM PowerPC&n; *      Cedar eval board.&n; *&n; *&n; */
macro_line|#ifdef __KERNEL__
macro_line|#ifndef __ASM_CEDAR_H__
DECL|macro|__ASM_CEDAR_H__
mdefine_line|#define __ASM_CEDAR_H__
macro_line|#include &lt;platforms/4xx/ibmnp405l.h&gt;
macro_line|#ifndef __ASSEMBLY__
multiline_comment|/*&n; * Data structure defining board information maintained by the boot&n; * ROM on IBM&squot;s &quot;Cedar&quot; evaluation board. An effort has been made to&n; * keep the field names consistent with the 8xx &squot;bd_t&squot; board info&n; * structures.&n; */
...
multiline_comment|/* Memory map for the IBM &quot;Cedar&quot; NP405 evaluation board.&n; */
r_extern
r_void
op_star
id|cedar_rtc_base
suffix:semicolon
DECL|macro|CEDAR_RTC_PADDR
mdefine_line|#define CEDAR_RTC_PADDR&t;&t;((uint)0xf0000000)
DECL|macro|CEDAR_RTC_VADDR
mdefine_line|#define CEDAR_RTC_VADDR&t;&t;CEDAR_RTC_PADDR
DECL|macro|CEDAR_RTC_SIZE
mdefine_line|#define CEDAR_RTC_SIZE&t;&t;((uint)8*1024)
...
mdefine_line|#define PPC4xx_MACHINE_NAME &quot;IBM NP405L Cedar&quot;
macro_line|#endif /* !__ASSEMBLY__ */
macro_line|#endif /* __ASM_CEDAR_H__ */

multiline_comment|/*&n; *&n; *    Copyright 2000-2001 MontaVista Software Inc.&n; *      Original author: Armin Kuster akuster@mvista.com&n; *&n; *    Module name: ibm405gp.c&n; *&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; *&n; */
...
DECL|variable|ibm405gp_emac0_def
r_static
r_struct
id|ocp_func_emac_data
id|ibm405gp_emac0_def
op_assign
(brace
dot
id|rgmii_idx
...
DECL|variable|ibm405gp_mal0_def
r_static
r_struct
id|ocp_func_mal_data
id|ibm405gp_mal0_def
op_assign
(brace
dot
id|num_tx_chans
...
DECL|variable|ibm405gp_iic0_def
r_static
r_struct
id|ocp_func_iic_data
id|ibm405gp_iic0_def
op_assign
(brace
dot
id|fast_mode

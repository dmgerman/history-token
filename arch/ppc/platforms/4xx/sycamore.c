multiline_comment|/*&n; *&n; *    Copyright 2000-2002 MontaVista Software Inc.&n; *      Author: Armin Kuster &lt;akuster@mvista.com&gt;&n; *      MontaVista Software, Inc.  &lt;source@mvista.com&gt;&n; *&n; *    Module name: sycamore.c&n; *&n; *    Description:&n; *      Architecture- / platform-specific boot-time initialization code for&n; *      IBM PowerPC 4xx based boards. &n; *&n; */

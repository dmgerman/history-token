multiline_comment|/*&n; * Support for IBM PPC 405EP evaluation board (Bubinga).&n; *&n; * Author: SAW (IBM), derived from walnut.c.&n; *         Maintained by MontaVista Software &lt;source@mvista.com&gt;&n; *&n; * 2003 (c) MontaVista Softare Inc.  This file is licensed under the&n; * terms of the GNU General Public License version 2. This program is&n; * licensed &quot;as is&quot; without any warranty of any kind, whether express&n; * or implied.&n; */
...
id|__res
suffix:semicolon
DECL|variable|bubinga_rtc_base
r_void
op_star
id|bubinga_rtc_base
suffix:semicolon
multiline_comment|/* Some IRQs unique to the board&n; * Used by the generic 405 PCI setup functions in ppc4xx_pci.c&n; */
r_int
id|__init
...
suffix:semicolon
multiline_comment|/* The serial clock for the chip is an internal clock determined by&n; * different clock speeds/dividers.&n; * Calculate the proper input baud rate and setup the serial driver.&n; */
r_static
r_void
id|__init
DECL|function|bubinga_early_serial_map
id|bubinga_early_serial_map
c_func
(paren
r_void
)paren
...
id|port
suffix:semicolon
multiline_comment|/* Calculate the serial clock input frequency&n;          *&n;          * The base baud is the PLL OUTA (provided in the board info&n;          * structure) divided by the external UART Divisor, divided&n;          * by 16.&n;          */
id|uart_div
op_assign
(paren
id|mfdcr
c_func
(paren
id|DCRN_CPC0_UCR_BASE
)paren
op_amp
id|DCRN_CPC0_UCR_U0DIV
)paren
suffix:semicolon
id|uart_clock
op_assign
id|__res.bi_pllouta_freq
op_div
id|uart_div
suffix:semicolon
...
r_void
id|__init
DECL|function|bubinga_setup_arch
id|bubinga_setup_arch
c_func
(paren
r_void
)paren
...
suffix:semicolon
multiline_comment|/* RTC step for the evb405ep */
id|bubinga_rtc_base
op_assign
(paren
r_void
...
c_func
(paren
l_string|&quot;IBM Bubinga port (MontaVista Software, Inc. &lt;source@mvista.com&gt;)&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_void
id|__init
DECL|function|bubinga_map_io
id|bubinga_map_io
c_func
(paren
r_void

...
r_int
id|__init
DECL|function|residual_scan_pcibridge
id|residual_scan_pcibridge
c_func
(paren
id|PnP_TAG_PACKET
op_star
...
r_int
id|__init
DECL|function|residual_pcidev_irq
...
DECL|function|residual_irq_mask
r_void
id|__init
id|residual_irq_mask
c_func
(paren
r_char
op_star
...
l_int|0x000
suffix:semicolon
multiline_comment|/* default to edge */
r_while
c_loop
(paren
(paren
...
DECL|function|residual_isapic_addr
r_int
r_int
id|__init
...
id|unknown
suffix:semicolon
multiline_comment|/* It doesn&squot;t seem to work where length != 1 (what can I say? :-/ ) */
r_if
c_cond
(paren
id|ld_le32
...
macro_line|#ifdef CONFIG_PROC_PREPRESIDUAL
DECL|function|proc_prep_residual_read
r_static
r_int
id|proc_prep_residual_read
c_func
(paren
r_char
op_star

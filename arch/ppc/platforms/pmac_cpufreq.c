...
id|pmac_cpufreq_driver
suffix:semicolon
multiline_comment|/* Look for voltage GPIO */
id|volt_gpio_np
op_assign
id|of_find_node_by_name
c_func
...
l_int|2
suffix:semicolon
multiline_comment|/* Read actual frequency from CPU */
id|driver-&gt;get
op_assign
id|dfs_get_cpu_speed
suffix:semicolon
...
l_int|1000
suffix:semicolon
multiline_comment|/*  Check for 7447A based MacRISC3 */
r_if
c_cond
(paren

...
id|cur_freq
suffix:semicolon
multiline_comment|/* Clean that up some day ... use a func ptr or at least an enum... */
DECL|variable|cpufreq_uses_pmu
r_static
r_int
id|cpufreq_uses_pmu
suffix:semicolon
DECL|variable|cpufreq_uses_gpios
r_static
r_int
id|cpufreq_uses_gpios
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Currently, we support the following machines:&n; *&n; *  - Titanium PowerBook 1Ghz (PMU based, 667Mhz &amp; 1Ghz)&n; *  - Titanium PowerBook 800 (PMU based, 667Mhz &amp; 800Mhz)&n; *  - Titanium PowerBook 500 (PMU based, 300Mhz &amp; 500Mhz)&n; *  - iBook2 500 (PMU based, 400Mhz &amp; 500Mhz)&n; *  - iBook2 700 (CPU based, 400Mhz &amp; 700Mhz, support low voltage)&n; *  - Recent MacRISC3 machines&n; */
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check to see if it&squot;s GPIO driven or PMU only&n;&t;&t; *&n;&t;&t; * The way we extract the GPIO address is slightly hackish, but it&n;&t;&t; * works well enough for now. We need to abstract the whole GPIO&n;&t;&t; * stuff sooner or later anyway&n;&t;&t; */
r_if
c_cond
(paren
id|volt_gpio_np
...
suffix:semicolon
multiline_comment|/* If we use the frequency GPIOs, calculate the min/max speeds based&n;&t;&t; * on the bus frequencies&n;&t;&t; */
r_if
c_cond
(paren
id|frequency_gpio
...
suffix:semicolon
multiline_comment|/* Grrrr.. It _seems_ that the device-tree is lying on the low bus&n;&t;&t;&t; * frequency, it claims it to be around 84Mhz on some models while&n;&t;&t;&t; * it appears to be approx. 101Mhz on all. Let&squot;s hack around here...&n;&t;&t;&t; * fortunately, we don&squot;t need to be too precise&n;&t;&t;&t; */
r_if
c_cond
(paren
id|low_freq
...
l_int|2000
suffix:semicolon
multiline_comment|/* Now we get the frequencies, we read the GPIO to see what is out current&n;&t;&t;&t; * speed&n;&t;&t;&t; */
id|rc
op_assign
id|pmac_call_feature
c_func
...
multiline_comment|/* If we use the PMU, look for the min &amp; max frequencies in the&n;&t;&t; * device-tree&n;&t;&t; */
id|value
op_assign
(paren
id|u32
...
(paren
id|KERN_INFO
l_string|&quot;Low: %d Mhz, High: %d Mhz, Boot: %d Mhz, switch method: %s&bslash;n&quot;
comma
id|low_freq
op_div
l_int|1000

...
r_int
id|__pmac
DECL|function|generic_scc_enable
id|generic_scc_enable
c_func
(paren
r_struct
id|device_node
...
r_int
id|__pmac
DECL|function|ohare_scc_enable
id|ohare_scc_enable
c_func
(paren
r_struct
...
r_int
id|__pmac
DECL|function|heathrow_scc_enable
id|heathrow_scc_enable
c_func
(paren
r_struct
id|device_node
...
suffix:semicolon
macro_line|#endif /* CONFIG_ADB_PMU */&t;&t;
multiline_comment|/* Fixme: It&squot;s possible that wallstreet (heathrow) is different&n;&t; * than other paddington machines. I still have to figure that&n;&t; * out exactly, for now, the paddington values are used&n;&t; */
id|rc
op_assign
id|generic_scc_enable
c_func
...
suffix:semicolon
multiline_comment|/* We use the paddington values as they seem to work properly&n;&t;    &t; * on the wallstreet (heathrow) as well. I can&squot;t tell why we&n;&t;    &t; * had to flip them on older feature.c, the fact is that new&n;&t;    &t; * code uses the paddington values which are also the ones used&n;&t;    &t; * in Darwin, and that works on wallstreet !&n;&t;    &t; */
r_if
c_cond
(paren
id|value
...
multiline_comment|/* On all machines, switch sound off */
r_if
c_cond
(paren
id|macio_chips

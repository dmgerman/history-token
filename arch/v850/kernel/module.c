multiline_comment|/*&n; * arch/v850/kernel/module.c -- Architecture-specific module functions&n; *&n; *  Copyright (C) 2002,03  NEC Electronics Corporation&n; *  Copyright (C) 2002,03  Miles Bader &lt;miles@gnu.org&gt;&n; *  Copyright (C) 2001,03  Rusty Russell&n; *&n; * This file is subject to the terms and conditions of the GNU General&n; * Public License.  See the file COPYING in the main directory of this&n; * archive for more details.&n; *&n; * Written by Miles Bader &lt;miles@gnu.org&gt;&n; *&n; * Derived in part from arch/ppc/kernel/module.c&n; */

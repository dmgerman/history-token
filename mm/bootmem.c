...
l_int|8
suffix:semicolon
multiline_comment|/*&n;&t; * sort pgdat_list so that the lowest one comes first,&n;&t; * which makes alloc_bootmem_low_pages work as desired.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_cond
(paren
id|tmp-&gt;pgdat_next-&gt;node_start_pfn
OG
id|pgdat-&gt;node_start_pfn
)paren
r_break

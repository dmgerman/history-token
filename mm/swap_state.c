...
multiline_comment|/*&n;&t;&t; * Add it to the swap cache and mark it dirty&n;&t;&t; * (adding to the page cache will clear the dirty&n;&t;&t; * and uptodate bits, so we need to do it again)&n;&t;&t; */
r_switch
c_cond
(paren
id|add_to_swap_cache

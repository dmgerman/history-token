...
multiline_comment|/*&n; * This function is pretty much like __find_page_nolock(), but it only&n; * requires 2 arguments and doesn&squot;t mark the page as touched, making it&n; * ideal for -&gt;writepage() clustering and other places where you don&squot;t&n; * want to mark the page referenced.&n; *&n; * The caller needs to hold the pagecache_lock.&n; */
r_static
r_struct
id|page
op_star
...
suffix:semicolon
DECL|function|__find_page_simple
r_static
r_struct
id|page
op_star
...
multiline_comment|/*&n; * Find a swapcache page (and get a reference) or return NULL.&n; * The SwapCache check is protected by the pagecache lock.&n; */
DECL|function|__find_get_swapcache_page
r_struct
id|page
op_star
...
id|page
suffix:semicolon
multiline_comment|/*&n;&t; * We need the LRU lock to protect against page_launder().&n;&t; */
id|spin_lock
c_func
(paren
op_amp

...
multiline_comment|/*&n; * Lock ordering:&n; *&n; *  -&gt;i_shared_lock&t;&t;(vmtruncate)&n; *    -&gt;private_lock&t;&t;(__free_pte-&gt;__set_page_dirty_buffers)&n; *      -&gt;swap_list_lock&n; *        -&gt;swap_device_lock&t;(exclusive_swap_page, others)&n; *          -&gt;mapping-&gt;page_lock&n; *  -&gt;inode_lock&n; *    -&gt;sb_lock&t;&t;&t;(fs/fs-writeback.c)&n; */
...
multiline_comment|/*&n; * If truncate cannot remove the fs-private metadata from the page, the page&n; * becomes anonymous.  It will be left on the LRU and may even be mapped into&n; * user pagetables if we&squot;re racing with filemap_nopage().&n; */

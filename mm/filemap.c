...
multiline_comment|/*&n; * Lock ordering:&n; *&n; *  -&gt;i_mmap_lock&t;&t;(vmtruncate)&n; *    -&gt;private_lock&t;&t;(__free_pte-&gt;__set_page_dirty_buffers)&n; *      -&gt;swap_list_lock&n; *        -&gt;swap_device_lock&t;(exclusive_swap_page, others)&n; *          -&gt;mapping-&gt;tree_lock&n; *    -&gt;page_map_lock()&t;&t;(try_to_unmap_file)&n; *&n; *  -&gt;i_sem&n; *    -&gt;i_mmap_lock&t;&t;(truncate-&gt;unmap_mapping_range)&n; *&n; *  -&gt;mmap_sem&n; *    -&gt;i_mmap_lock&n; *      -&gt;page_table_lock&t;(various places, mainly in mmap.c)&n; *        -&gt;mapping-&gt;tree_lock&t;(arch-dependent flush_dcache_mmap_lock)&n; *&n; *  -&gt;mmap_sem&n; *    -&gt;lock_page&t;&t;(access_process_vm)&n; *&n; *  -&gt;mmap_sem&n; *    -&gt;i_sem&t;&t;&t;(msync)&n; *&n; *  -&gt;i_sem&n; *    -&gt;i_alloc_sem             (various)&n; *&n; *  -&gt;inode_lock&n; *    -&gt;sb_lock&t;&t;&t;(fs/fs-writeback.c)&n; *    -&gt;mapping-&gt;tree_lock&t;(__sync_single_inode)&n; *&n; *  -&gt;page_table_lock&n; *    -&gt;swap_device_lock&t;(try_to_unmap_one)&n; *    -&gt;private_lock&t;&t;(try_to_unmap_one)&n; *    -&gt;tree_lock&t;&t;(try_to_unmap_one)&n; *    -&gt;zone.lru_lock&t;&t;(follow_page-&gt;mark_page_accessed)&n; *    -&gt;page_map_lock()&t;&t;(page_add_anon_rmap)&n; *      -&gt;tree_lock&t;&t;(page_remove_rmap-&gt;set_page_dirty)&n; *      -&gt;private_lock&t;&t;(page_remove_rmap-&gt;set_page_dirty)&n; *      -&gt;inode_lock&t;&t;(page_remove_rmap-&gt;set_page_dirty)&n; *    -&gt;anon_vma.lock&t;&t;(anon_vma_prepare)&n; *    -&gt;inode_lock&t;&t;(zap_pte_range-&gt;set_page_dirty)&n; *    -&gt;private_lock&t;&t;(zap_pte_range-&gt;__set_page_dirty_buffers)&n; *&n; *  -&gt;task-&gt;proc_lock&n; *    -&gt;dcache_lock&t;&t;(proc_pid_lookup)&n; */

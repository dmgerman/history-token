...
suffix:semicolon
multiline_comment|/**&n; * invalidate_inode_pages2_range - remove range of pages from an address_space&n; * @mapping - the address_space&n; * @start: the page offset &squot;from&squot; which to invalidate&n; * @end: the page offset &squot;to&squot; which to invalidate (inclusive)&n; *&n; * Any pages which are found to be mapped into pagetables are unmapped prior to&n; * invalidation.&n; *&n; * Returns -EIO if any pages could not be invalidated.&n; */
DECL|function|invalidate_inode_pages2_range
r_int
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t;&t; * Zap the rest of the file in one hit.&n;&t;&t;&t;&t;&t; */
...
DECL|variable|invalidate_inode_pages2_range

...
suffix:semicolon
multiline_comment|/* insert vma into inode&squot;s share list */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/*&n;&t;&t; * here area isn&squot;t visible to the semaphore-less readers&n;&t;&t; * so we don&squot;t need to update it under the spinlock.&n;&t;&t; */
id|area-&gt;vm_end
op_assign
id|addr
suffix:semicolon
...
id|PAGE_SHIFT
suffix:semicolon
multiline_comment|/* same locking considerations of the above case */
id|area-&gt;vm_start
op_assign
id|end
suffix:semicolon

...
id|vma-&gt;vm_truncate_count
op_ne
id|next-&gt;vm_truncate_count
)paren
(brace
multiline_comment|/*&n;&t;&t;&t; * unmap_mapping_range might be in progress:&n;&t;&t;&t; * ensure that the expanding vma is rescanned.&n;&t;&t;&t; */
id|importer-&gt;vm_truncate_count
op_assign
l_int|0
suffix:semicolon
)brace
...
multiline_comment|/*&n; * Verify that the stack growth is acceptable and&n; * update accounting. This is shared with both the&n; * grow-up and grow-down cases.&n; */
DECL|function|acct_stack_growth
r_static
r_int
id|acct_stack_growth
c_func
(paren
r_struct
id|vm_area_struct
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* Stack limit test */
r_if
c_cond
(paren
id|size
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* mlock limit tests */
r_if
c_cond
(paren
id|vma-&gt;vm_flags
...
multiline_comment|/*&n;&t; * Overcommit..  This must be the final test, as it will&n;&t; * update security statistics.&n;&t; */
r_if
c_cond
(paren
id|security_vm_enough_memory
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* Ok, everything looks good - let it rip */
id|mm-&gt;total_vm
op_add_assign
id|grow
suffix:semicolon
...
id|PGDIR_SIZE
suffix:semicolon
multiline_comment|/* No point trying to free anything if we&squot;re in the same pte page */
r_if
c_cond
(paren
(paren
...
DECL|function|verify_mm_writelocked
r_static
r_inline
r_void
id|verify_mm_writelocked
c_func
(paren
r_struct
id|mm_struct

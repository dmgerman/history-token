...
multiline_comment|/*&n; * Position vma after prev in shared file list:&n; * for mremap move error recovery racing against vmtruncate.&n; */
DECL|function|vma_relink_file
r_void
id|vma_relink_file
c_func
(paren

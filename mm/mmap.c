...
multiline_comment|/*&n; * vma is the first one with  address &lt; vma-&gt;vm_end,&n; * and even address &lt; vma-&gt;vm_start. Have to extend vma.&n; */
...
id|grow
suffix:semicolon
multiline_comment|/*&n;&t; * vma-&gt;vm_start/vm_end cannot change under us because the caller&n;&t; * is required to hold the mmap_sem in write mode. We need to get&n;&t; * the spinlock only before relocating the vma range ourself.&n;&t; */
id|address
op_and_assign
id|PAGE_MASK
suffix:semicolon

...
multiline_comment|/* If the request is for hugepages, then make sure that addr&n;&t;&t; * and length is properly aligned.&n;&t;&t; */
id|ret
op_assign
...
suffix:semicolon
r_else
multiline_comment|/* &n;&t;&t; * Make sure that a normal request is not falling&n;&t;&t; * in reserved hugepage range.  For some archs like IA-64, &n;&t;&t; * there is seperate region for hugepages.&n;&t;&t; */
id|ret
op_assign

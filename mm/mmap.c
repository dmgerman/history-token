...
multiline_comment|/*&n; * Dummy version of vma_prio_tree_next, just for this patch:&n; * no radix priority search tree whatsoever, just implement interface&n; * using the old lists: return the next vma overlapping [begin,end].&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* Return vma if it overlaps [begin,end] */
r_if
c_cond
(paren
id|vba
...
(brace
multiline_comment|/*&n;&t;&t;&t; * vma_merge has merged next into vma, and needs&n;&t;&t;&t; * us to remove next before dropping the locks.&n;&t;&t;&t; */
id|__vma_unlink
c_func
(paren
id|mm
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * split_vma has split next from vma, and needs&n;&t;&t;&t; * us to insert next before dropping the locks&n;&t;&t;&t; * (next may either follow vma or precede it).&n;&t;&t;&t; */
id|__insert_vm_struct
c_func
(paren
id|mm

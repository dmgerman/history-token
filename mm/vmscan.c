...
id|shortage
suffix:semicolon
multiline_comment|/* If not, do we have enough per-zone pages on the inactive list? */
id|shortage
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* &t;&n;&t; * Delete pages from the inode and dentry cache &n;&t; * if memory is low. &n;&t; */
r_if
c_cond
(paren
id|free_shortage

...
macro_line|#endif
macro_line|#ifndef CONFIG_QUOTA
DECL|macro|shrink_dqcache_memory
mdefine_line|#define shrink_dqcache_memory(ratio, gfp_mask) do { } while (0)
macro_line|#endif
...
multiline_comment|/*&n;&t;&t; * FIXME: need to consider page_count(page) here if/when we&n;&t;&t; * reap orphaned pages via the LRU (Daniel&squot;s locking stuff)&n;&t;&t; */
r_if
c_cond
(paren
id|total_swap_pages
...
multiline_comment|/*&n;&t; * Here we assume it costs one seek to replace a lru page and that&n;&t; * it also takes a seek to recreate a cache object.  With this in&n;&t; * mind we age equal percentages of the lru and ageable caches.&n;&t; * This should balance the seeks generated by these structures.&n;&t; *&n;&t; * NOTE: for now I do this for all zones.  If we find this is too&n;&t; * aggressive on large boxes we may want to exclude ZONE_HIGHMEM&n;&t; *&n;&t; * If we&squot;re encountering mapped pages on the LRU then increase the&n;&t; * pressure on slab to avoid swapping.&n;&t; */
id|ratio
op_assign
(paren
id|pages

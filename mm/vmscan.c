...
multiline_comment|/* &n;&t;&t; * If we are doing zone-specific laundering, &n;&t;&t; * avoid touching pages from zones which do &n;&t;&t; * not have a free shortage.&n;&t;&t; */
r_if
c_cond
(paren
id|zone
...
suffix:semicolon
multiline_comment|/*&n;&t; * Then check if there is any specific zone &n;&t; * needs laundering.&n;&t; */
r_for
c_loop
(paren
id|type

...
(brace
multiline_comment|/*&n;&t;&t; * Some data journaling orphaned pages can have&n;&t;&t; * page-&gt;mapping == NULL while being dirty with clean buffers.&n;&t;&t; */
r_if
c_cond
(paren
id|PageDirty
...
c_func
(paren
l_string|&quot;%s: orphaned page&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/*&n; * zone-&gt;lru_lock is heavily contended.  Some of the functions that&n; * shrink the lists perform better by taking out a batch of pages&n; * and working on them outside the LRU lock.&n; *&n; * For pagecache intensive workloads, this function is the hottest&n; * spot in the kernel (apart from copy_*_user functions).&n; *&n; * Appropriate locks must be held before calling this function.&n; *&n; * @nr_to_scan:&t;The number of pages to look through on the list.&n; * @src:&t;The LRU list to pull pages off.&n; * @dst:&t;The temp list to put pages on to.&n; * @scanned:&t;The number of pages that were scanned.&n; *&n; * returns how many pages were moved onto *@dst.&n; */
DECL|function|isolate_lru_pages
r_static
r_int
id|isolate_lru_pages
c_func
(paren
r_int
id|nr_to_scan
...
(brace
multiline_comment|/*&n;&t;&t;&t; * It is being freed elsewhere&n;&t;&t;&t; */
id|__put_page
c_func
(paren
id|page
...
multiline_comment|/*&n; * shrink_cache() adds the number of pages reclaimed to sc-&gt;nr_reclaimed&n; */

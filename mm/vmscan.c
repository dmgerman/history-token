...
DECL|macro|page_zone_plenty
mdefine_line|#define page_zone_plenty(page) ((page)-&gt;zone-&gt;free_pages &gt; (page)-&gt;zone-&gt;pages_high)
...
multiline_comment|/* Don&squot;t bother replenishing zones that have tons of memory */
r_if
c_cond
(paren
id|page_zone_plenty
...
suffix:semicolon
multiline_comment|/* Mapping-less page on LRU-list? */
r_if
c_cond
(paren
id|unlikely
...
multiline_comment|/*&n;&t;&t; * Still strictly racy - we don&squot;t own the pagecache lock,&n;&t;&t; * so somebody might look up the page while we do this.&n;&t;&t; * It&squot;s just a heuristic, though.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* we hold the page lock so the page cannot go away from under us */
id|spin_unlock
c_func
(paren
op_amp
...
multiline_comment|/*&n;&t;&t; * this is the non-racy check, it is critical to check&n;&t;&t; * PageDirty _after_ we made sure the page is freeable&n;&t;&t; * so not in use by anybody.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

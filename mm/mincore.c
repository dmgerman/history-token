...
id|error
suffix:semicolon
multiline_comment|/* check the arguments */
r_if
c_cond
(paren
id|start
...
id|len
suffix:semicolon
multiline_comment|/* check the output buffer whilst holding the lock */
id|error
op_assign
op_minus
id|EFAULT
...
multiline_comment|/* we found a hole in the area queried if we arrive here */
id|error
op_assign
op_minus
id|ENOMEM

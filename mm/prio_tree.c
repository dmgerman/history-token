multiline_comment|/*&n; * mm/prio_tree.c - priority search tree for mapping-&gt;i_mmap{,_shared}&n; *&n; * Copyright (C) 2004, Rajesh Venkatasubramanian &lt;vrajesh@umich.edu&gt;&n; *&n; * This file is released under the GPL v2.&n; *&n; * Based on the radix priority search tree proposed by Edward M. McCreight&n; * SIAM Journal of Computing, vol. 14, no.2, pages 257-276, May 1985&n; *&n; * 02Feb2004&t;Initial version&n; */
...
multiline_comment|/*&n; * The following macros are used for implementing prio_tree for i_mmap{_shared}&n; */

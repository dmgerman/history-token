...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Recheck mapcount: it is not safe to take anon_vma-&gt;lock after&n;&t; * last page_remove_rmap, since struct anon_vma might be reused.&n;&t; */
id|mapcount
op_assign
id|page_mapcount
c_func
...
id|SWAP_AGAIN
suffix:semicolon
multiline_comment|/*&n;&t; * Recheck mapped: it is not safe to take anon_vma-&gt;lock after&n;&t; * last page_remove_rmap, since struct anon_vma might be reused.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

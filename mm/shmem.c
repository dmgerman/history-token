...
multiline_comment|/* Flag end-of-file treatment to shmem_getpage and shmem_swp_alloc */
DECL|enum|sgp_type
r_enum
id|sgp_type
(brace
...
id|SGP_READ
comma
multiline_comment|/* don&squot;t exceed i_size */
DECL|enumerator|SGP_WRITE
id|SGP_WRITE
comma
multiline_comment|/* may exceed i_size */
)brace
suffix:semicolon
...
multiline_comment|/*&n; * shmem_swp_alloc - get the position of the swap entry for the page.&n; *                   If it does not exist allocate the entry.&n; *&n; * @info:&t;info structure for the inode&n; * @index:&t;index of the page to find&n; * @sgp:&t;check and recheck i_size?&n; */

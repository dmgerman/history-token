multiline_comment|/*&n; * Resizable virtual memory filesystem for Linux.&n; *&n; * Copyright (C) 2000 Linus Torvalds.&n; *&t;&t; 2000 Transmeta Corp.&n; *&t;&t; 2000 Christoph Rohland&n; * &n; * This file is released under the GPL.&n; */
...
suffix:semicolon
multiline_comment|/* Only move to the swap cache if there are no other users of&n;&t; * the page. */
r_if
c_cond
(paren
id|atomic_read
...
suffix:semicolon
multiline_comment|/* retest we may have slept */
r_if
c_cond
(paren
id|inode-&gt;i_size
...
(brace
multiline_comment|/*&n;&t;&t; * This is only a guestimate and not honoured.&n;&t;&t; * We need it to make some programs happy which like to&n;&t;&t; * test the free space of a file system.&n;&t;&t; */
id|buf-&gt;f_bavail
op_assign
id|buf-&gt;f_bfree
op_assign

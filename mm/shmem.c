...
id|page
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This check is racy: it&squot;s faintly possible that page&n;&t;&t; * was assigned to swap during truncate_inode_pages,&n;&t;&t; * and now assigned to file; but better than nothing.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * shmem_unuse() search for an eventually swapped out shmem page.&n; * Note shmem_unuse_inode drops shmem_ilock itself if successful.&n; */

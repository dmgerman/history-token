...
suffix:semicolon
multiline_comment|/**&n; * write_one_page - write out a single page and optionally wait on I/O&n; *&n; * @page - the page to write&n; * @wait - if true, wait on writeout&n; *&n; * The page must be locked by the caller and will come unlocked when I/O&n; * completes.&n; *&n; * write_one_page() returns a negative error code if I/O failed.&n; */

...
suffix:semicolon
DECL|function|throttle_vm_writeout
r_void
...
suffix:semicolon
multiline_comment|/*&n;                 * Boost the allowable dirty threshold a bit for page&n;                 * allocators so they don&squot;t get DoS&squot;ed by heavy writers&n;                 */
id|dirty_thresh
op_add_assign
id|dirty_thresh
op_div

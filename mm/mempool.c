multiline_comment|/*&n; *  linux/mm/mempool.c&n; *&n; *  memory buffer pool support. Such pools are mostly used to&n; *  guarantee deadlock-free IO operations even during extreme&n; *  VM load.&n; *&n; *  started by Ingo Molnar, Copyright (C) 2001&n; */
...
multiline_comment|/**&n; * mempool_free - return an element to the pool.&n; * @gfp_mask:  pool element pointer.&n; * @pool:      pointer to the memory pool which was allocated via&n; *             mempool_create().&n; *&n; * this function only sleeps if the free_fn() function sleeps.&n; */

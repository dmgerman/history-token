...
id|shared
suffix:semicolon
id|new_shared-&gt;batchcount
op_assign
l_int|0xbaadf00d
suffix:semicolon
id|new_shared-&gt;touched
op_assign
l_int|0
suffix:semicolon
id|spin_lock_irq
...
multiline_comment|/*&n; * This is a timer handler.  There is one per CPU.  It is called periodially&n; * to shrink this CPU&squot;s caches.  Otherwise there could be memory tied up&n; * for long periods (or for ever) due to load changes.&n; */
...
suffix:semicolon
multiline_comment|/* CPU hotplug can drag us off cpu: don&squot;t run on wrong CPU */
r_if
c_cond
(paren
op_logical_neg
...
id|cachep-&gt;name
suffix:semicolon
multiline_comment|/*&n;&t; * Check to see if `name&squot; resides inside a module which has been&n;&t; * unloaded (someone forgot to destroy their cache)&n;&t; */
id|old_fs
op_assign
id|get_fs
c_func

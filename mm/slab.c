...
(paren
id|KERN_ERR
l_string|&quot;Slab corruption: start=%p, expend=%p, &quot;
l_string|&quot;problemat=%p&bslash;n&quot;
comma
id|addr
comma
id|addr
...
id|cachep
comma
l_string|&quot;object was modified after freeing&quot;
)paren
suffix:semicolon
)brace
)brace
...
c_func
(paren
l_string|&quot;redzone: %lxh/%lxh/%lxh.&bslash;n&quot;
comma
(paren
(paren
r_int

...
suffix:semicolon
macro_line|#if DEBUG
multiline_comment|/* This happens if someone tries to call&n; &t;* kmem_cache_create(), or __kmalloc(), before&n; &t;* the generic caches are initialized.&n; &t;*/
id|BUG_ON
c_func
(paren
id|csizep-&gt;cs_cachep
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * Really subtile: The last entry with cs-&gt;cs_size==ULONG_MAX&n;&t; * has cs_{dma,}cachep==NULL. Thus no special case&n;&t; * for large kmalloc calls required.&n;&t; */
r_if
c_cond
(paren
id|unlikely

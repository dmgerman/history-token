...
id|p
op_assign
id|searchp-&gt;lists.slabs_free.next
suffix:semicolon
r_while
c_loop
(paren
...
id|perfect
suffix:colon
multiline_comment|/* free only 50% of the free slabs */
id|best_len
op_assign
(paren
id|best_len
...
id|p
op_assign
id|best_cachep-&gt;lists.slabs_free.prev
suffix:semicolon
r_if
c_cond
(paren
...
op_eq
op_amp
id|best_cachep-&gt;lists.slabs_free
)paren
r_break
suffix:semicolon
id|slabp

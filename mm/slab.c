...
id|offslab_limit
suffix:semicolon
multiline_comment|/*&n; * slab_t&n; *&n; * Manages the objs in a slab. Placed either at the beginning of mem allocated&n; * for a slab, or allocated from an general cache.&n; * Slabs are chained into three list: fully used, partial, fully free slabs.&n; */
DECL|struct|slab_s
r_typedef
r_struct
id|slab_s
...
multiline_comment|/*&n; * cpucache_t&n; *&n; * Per cpu structures&n; * Purpose:&n; * - LIFO ordering, to hand out cache-warm objects from _alloc&n; * - reduce spinlock operations&n; *&n; * The limit is stored in the per-cpu structure to reduce the data cache&n; * footprint.&n; * On NUMA systems, 2 per-cpu structures exist: one for the current&n; * node, one for wrong node free calls.&n; * Memory from the wrong node is never returned by alloc, it&squot;s returned&n; * to the home node as soon as the cpu cache is filled&n; *&n; */
...
multiline_comment|/*&n; * NUMA: check if &squot;ptr&squot; points into the current node,&n; * &t;use the alternate cpudata cache if wrong&n; */
DECL|macro|cc_data_ptr
mdefine_line|#define cc_data_ptr(cachep, ptr) &bslash;&n;&t;&t;cc_data(cachep)
...
suffix:semicolon
multiline_comment|/* NUMA: cpucache_t&t;*cpudata_othernode[NR_CPUS]; */
DECL|member|batchcount
r_int
r_int
id|batchcount
...
multiline_comment|/* This doesn&squot;t belong here, should be somewhere in kernel/ */
DECL|struct|cpucall_info
r_struct
id|cpucall_info
(brace
DECL|member|cpu
...
(paren
id|KERN_INFO
l_string|&quot;do_cpucall for cpu %d, callback %p failed at kmalloc.&bslash;n&quot;
comma
id|cpu
comma
id|fnc
...
(paren
id|KERN_INFO
l_string|&quot;do_cpucall for cpu %d, callback %p failed at kernel_thread.&bslash;n&quot;
comma
id|cpu
comma
id|fnc
...
l_int|0
suffix:semicolon
multiline_comment|/* Register a cpu startup notifier callback&n;&t; * that initializes cc_data for all new cpus&n;&t; */
...
suffix:semicolon
singleline_comment|// cache_grow can reenable interrupts, then cc could change.
id|cc
op_assign
id|cc_data
c_func
...
multiline_comment|/**&n; * cache_reap - Reclaim memory from caches.&n; *&n; * Called from a timer, every few seconds&n; * Purpuse:&n; * - clear the per-cpu caches&n; * - return freeable pages to gfp.&n; */

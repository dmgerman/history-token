...
suffix:semicolon
multiline_comment|/* Should not matter as we need quiescent system for suspend anyway, but... */
r_do
(brace
id|area
op_assign
...
(brace
singleline_comment|//&t;&t;&t;&t;&t;printk(&quot;FIXME: this should not happen but it does!!!&quot;);
r_break
suffix:semicolon
)brace
r_if
...
multiline_comment|/*&n; * Amount of free RAM allocatable as pagecache memory:&n; */

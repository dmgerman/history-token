...
suffix:semicolon
macro_line|#ifdef CONFIG_NUMA
multiline_comment|/* Early boot: Everything is done by one cpu, but the data structures will be&n; * used by all cpus - spread them on all nodes.&n; */
DECL|function|get_boot_pages
r_static
id|__init
r_int
r_int
...
id|z
suffix:semicolon
multiline_comment|/* The node contains memory. Check that there is&n;&t;&t;&t; * memory in the intended zonelist.&n;&t;&t;&t; */
id|z
op_assign
id|NODE_DATA
c_func

...
multiline_comment|/* Obtain a single element from the buddy allocator */
...
suffix:semicolon
multiline_comment|/*&n;&t; * This may look inefficient because we&squot;re walking the list again,&n;&t; * but the cachelines are hot, so it&squot;s very cheap, and this way we&n;&t; * can drop the zone lock much earlier&n;&t; */
id|list_for_each
c_func
(paren
id|curr
...
(paren
l_string|&quot;Zone:%s&quot;
l_string|&quot; freepages:%6lukB&quot;
l_string|&quot; min:%6lukB&quot;
l_string|&quot; low:%6lukB&quot;
l_string|&quot; high:%6lukB&quot;
l_string|&quot; active:%6lukB&quot;
l_string|&quot; inactive:%6lukB&quot;
l_string|&quot;&bslash;n&quot;
comma
id|zone-&gt;name
comma
...
l_int|0
suffix:semicolon
multiline_comment|/* offset within lmem_map */
r_for
c_loop
(paren
id|j
...
multiline_comment|/*&n;&t;&t;&t;&t; * The shift left won&squot;t overflow because the&n;&t;&t;&t;&t; * ZONE_NORMAL is below 4G.&n;&t;&t;&t;&t; */
id|set_page_address
c_func
(paren
id|page

...
multiline_comment|/*&n; * Locate the struct page for both the matching buddy in our&n; * pair (buddy1) and the combined O(n+1) page they form (page).&n; *&n; * 1) Any buddy B1 will have an order O twin B2 which satisfies&n; * the following equation:&n; *     B2 = B1 ^ (1 &lt;&lt; O)&n; * For example, if the starting buddy (buddy2) is #8 its order&n; * 1 buddy is #10:&n; *     B2 = 8 ^ (1 &lt;&lt; 1) = 8 ^ 2 = 10&n; *&n; * 2) Any buddy B will have an order O+1 parent P which&n; * satisfies the following equation:&n; *     P = B &amp; ~(1 &lt;&lt; O)&n; *&n; * Assumption: *_mem_map is contigious at least up to MAX_ORDER&n; */
r_static
r_inline
r_struct
id|page
op_star
DECL|function|__page_find_buddy
id|__page_find_buddy
c_func
(paren
r_struct
id|page
...
r_int
r_int
DECL|function|__find_combined_index
id|__find_combined_index
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * Go through the zonelist again. Let __GFP_HIGH and allocations&n;&t; * coming from realtime tasks to go deeper into reserves&n;&t; *&n;&t; * This is the last chance, in general, before the goto nopage.&n;&t; * Ignore cpuset if GFP_ATOMIC (!wait) - better that than panic.&n;&t; */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/*&n;&t;&t; * Go through the zonelist yet one more time, keep&n;&t;&t; * very high watermark here, this is only to catch&n;&t;&t; * a parallel oom killing, we must fail if we&squot;re still&n;&t;&t; * under heavy pressure.&n;&t;&t; */
r_for
c_loop
(paren
id|i

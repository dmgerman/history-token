...
id|mem_map
suffix:semicolon
multiline_comment|/*&n; * Called by TLB shootdown &n; */
DECL|function|__free_pte
r_void
id|__free_pte
c_func
(paren
...
(brace
multiline_comment|/* This will eventually call __free_pte on the pte. */
id|tlb_remove_page
c_func
(paren
id|tlb
...
suffix:semicolon
multiline_comment|/* FIXME: call the correct function,&n;&t;&t;&t;&t; * depending on the type of the found page&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|pages
...
id|PAGE_SIZE
suffix:semicolon
multiline_comment|/* mapping 0 bytes is not permitted */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* rw==READ means read from disk, write into memory area */
id|err
op_assign
id|get_user_pages
c_func
...
(brace
multiline_comment|/* FIXME: flush superflous for rw==READ,&n;&t;&t; * probably wrong function for rw==WRITE&n;&t;&t; */
...
multiline_comment|/*&n; * Mark all of the pages in a kiobuf as dirty &n; *&n; * We need to be able to deal with short reads from disk: if an IO error&n; * occurs, the number of bytes read into memory may be less than the&n; * size of the kiobuf, so we have to stop marking pages dirty once the&n; * requested byte count has been reached.&n; */
DECL|function|mark_dirty_kiobuf
r_void
...
suffix:semicolon
multiline_comment|/* FIXME: cache flush missing for rw==READ&n;&t;&t;&t; * FIXME: call the correct reference counting function&n;&t;&t;&t; */

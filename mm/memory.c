...
r_new
suffix:semicolon
multiline_comment|/* &quot;fast&quot; allocation can happen without dropping the lock.. */
r_new
op_assign
...
multiline_comment|/*&n; * Allocate the page table directory.&n; *&n; * We&squot;ve already handled the fast-path in-line, and we own the&n; * page table lock.&n; */
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Because we dropped the lock, we should re-check the&n;&t;&t;&t; * entry, as somebody else could have populated it..&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

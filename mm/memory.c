...
id|vma
op_eq
id|details-&gt;restart_vma
op_logical_and
id|start_addr
OL
id|details-&gt;restart_addr
)paren
(brace
multiline_comment|/*&n;&t;&t; * Be careful: this vm_area_struct may have been reused&n;&t;&t; * meanwhile.  If pgoff matches up, it&squot;s probably the&n;&t;&t; * same one (perhaps shrunk or extended), but no harm is&n;&t;&t; * done if actually it&squot;s new.  If pgoff does not match,&n;&t;&t; * it would likely be wrong to unmap from restart_addr,&n;&t;&t; * but it must be new, so we can just mark it completed.&n;&t;&t; */
id|start_addr
op_assign
id|details-&gt;restart_addr
suffix:semicolon

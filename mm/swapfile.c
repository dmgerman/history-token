...
suffix:semicolon
multiline_comment|/*&n; * Array of backing blockdevs, for swap_unplug_fn.  We need this because the&n; * bdev-&gt;unplug_fn can sleep and we cannot hold swap_list_lock while calling&n; * the unplug_fn.  And swap_list_lock cannot be turned into a semaphore.&n; */
r_static
id|DECLARE_MUTEX
c_func
(paren
...
multiline_comment|/*&n; * Caller holds swap_bdevs_sem&n; */
DECL|function|install_swap_bdev
r_static
r_void
id|install_swap_bdev
c_func
(paren
r_struct
id|block_device
...
DECL|function|remove_swap_bdev
r_static
r_void
id|remove_swap_bdev
c_func
...
multiline_comment|/*&n; * Unlike a standard unplug_io_fn, swap_unplug_io_fn is never called&n; * through swap&squot;s backing_dev_info (which is only used by shrink_list),&n; * but directly from sync_page when PageSwapCache: and takes the page&n; * as argument, so that it can find the right device from swp_entry_t.&n; */

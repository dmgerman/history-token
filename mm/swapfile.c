...
id|inode
op_assign
id|sis-&gt;swap_file-&gt;f_dentry-&gt;d_inode
suffix:semicolon
r_if
c_cond
(paren
...
id|page
suffix:semicolon
multiline_comment|/* save for swap_show */
id|swap_list_lock
c_func
(paren
)paren
...
id|p-&gt;bdev
op_assign
id|swap_file-&gt;f_dentry-&gt;d_inode-&gt;i_sb-&gt;s_bdev
suffix:semicolon
)brace
r_else
(brace

...
multiline_comment|/*&n; * this is called when we find a page in the swap list&n; * all the locks have been dropped at this point which&n; * isn&squot;t a problem because we rescan the swap map&n; * and we _don&squot;t_ clear the refrence count if for &n; * some reason it isn&squot;t 0&n; */
DECL|function|free_found_swap_entry
r_static
r_inline
r_int
id|free_found_swap_entry
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* &n;&t; * Get a page for the entry, using the existing swap&n;&t; * cache page if there is one.  Otherwise, get a clean&n;&t; * page and read the swap into it. &n;&t; */
id|page
op_assign
...
suffix:semicolon
multiline_comment|/* &n;&t; * Now get rid of the extra reference to the temporary&n;&t; * page we&squot;ve been using. &n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; * Check for and clear any overflowed swap map counts.&n;&t; */
id|swap_free
c_func
(paren
id|entry
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t;&t; * The algorithm is inefficient but seldomly used&n;&t;&t; *&n;&t;&t; * Find a swap page in use and read it in.&n;&t;&t; */
id|foundpage
op_assign
l_int|0
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Prevent swaphandle from being completely&n;&t;&t;&t; * unused by swap_free while we are trying&n;&t;&t;&t; * to read in the page - this prevents warning&n;&t;&t;&t; * messages from rw_swap_page_base.&n;&t;&t;&t; */
id|foundpage
op_assign
l_int|1
suffix:semicolon
...
id|ret
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * we pick up the swap_list_lock() to guard the nr_swap_pages,&n;&t;&t;&t; * si-&gt;swap_map[] should only be changed if it is SWAP_MAP_MAX&n;&t;&t;&t; * otherwise ugly stuff can happen with other people who are in&n;&t;&t;&t; * the middle of a swap operation to this device. This kind of&n;&t;&t;&t; * operation can sometimes be detected with the undead swap &n;&t;&t;&t; * check. Don&squot;t worry about these &squot;undead&squot; entries for now&n;&t;&t;&t; * they will be caught the next time though the top loop.&n;&t;&t;&t; * Do worry, about the weak locking that allows this to happen&n;&t;&t;&t; * because if it happens to a page that is SWAP_MAP_MAX&n;&t;&t;&t; * then bad stuff can happen.&n;&t;&t;&t; */
id|swap_list_lock
c_func
(paren
)paren
...
(brace
multiline_comment|/* normally this would just kill the swap page if&n;&t;&t;&t;&t; * it still existed, it appears though that the locks &n;&t;&t;&t;&t; * are a little fuzzy&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|si-&gt;swap_map
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * This lock stuff is ulgy!&n;&t;&t;&t; * Make sure that we aren&squot;t completely killing&n;&t;&t;&t; * interactive performance.&n;&t;&t;&t; */
r_if
c_cond
(paren

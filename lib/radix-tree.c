...
suffix:semicolon
DECL|macro|radix_tree_node_alloc
mdefine_line|#define radix_tree_node_alloc(root) &bslash;&n;&t;mempool_alloc(radix_tree_node_pool, (root)-&gt;gfp_mask)
DECL|macro|radix_tree_node_free
mdefine_line|#define radix_tree_node_free(node) &bslash;&n;&t;mempool_free((node), radix_tree_node_pool);

...
DECL|function|zlib_inflate_fast
r_int
...
id|s-&gt;window
suffix:semicolon
multiline_comment|/* force pointer in window */
)brace
r_while
c_loop
(paren
...
suffix:semicolon
multiline_comment|/* covers invalid distances */
id|e
op_assign
id|s-&gt;end
op_minus
...
id|e
suffix:semicolon
multiline_comment|/* wrapped copy */
r_do
(brace
op_star
id|q

...
id|clen32
suffix:semicolon
multiline_comment|/* UCMSG is the 64-bit format CMSG entry in user-space.&n;&t;&t; * KCMSG_COMPAT is within the kernel space temporary buffer&n;&t;&t; * we use to convert into a 32-bit style CMSG.&n;&t;&t; */
id|__get_user
c_func
(paren
id|kcmsg_compat-&gt;cmsg_len
comma
op_amp
id|ucmsg-&gt;cmsg_len
)paren
...
DECL|function|put_compat_msg_controllen
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * Since struct sock_filter is architecure independent,&n;&t; * we can just do the access_ok check and pass the&n;&t; * same pointer to the real syscall.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

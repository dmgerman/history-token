...
id|ptr
suffix:semicolon
multiline_comment|/*&n;&t; * Here we ignore erronous packets which should really&n;&t; * should cause a connection abort. It is not critical &n;&t; * for now though.&n;&t; */
r_if
c_cond
(paren
id|lsflags
...
(brace
multiline_comment|/* FCVAL INT */
r_case
l_int|0x00
suffix:colon
multiline_comment|/* Normal Request */
r_switch
c_cond
(paren
id|lsflags
...
(brace
multiline_comment|/* FCVAL MOD */
r_case
l_int|0x00
suffix:colon
multiline_comment|/* Request count */
r_if
c_cond
(paren
id|fcval
...
l_int|0x01
suffix:colon
multiline_comment|/* Stop outgoing data */
id|scp-&gt;flowrem_sw
op_assign
id|DN_DONTSEND
suffix:semicolon
...
l_int|0x02
suffix:colon
multiline_comment|/* Ok to start again */
id|scp-&gt;flowrem_sw
op_assign
id|DN_SEND
suffix:semicolon
...
l_int|0x04
suffix:colon
multiline_comment|/* Interrupt Request */
r_if
c_cond
(paren
id|fcval
...
id|NET_RX_DROP
suffix:semicolon
multiline_comment|/* Must not reply to returned packets */
r_if
c_cond
(paren
id|cb-&gt;rt_flags
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We linearize everything except data segments here.&n;&t;&t; */
r_if
c_cond
(paren
id|cb-&gt;nsp_flags
...
(paren
id|KERN_DEBUG
l_string|&quot;NSP: 0x%02x 0x%02x 0x%04x 0x%04x %d&bslash;n&quot;
comma
(paren
r_int
)paren

...
id|dev-&gt;dn_ptr
suffix:semicolon
multiline_comment|/* Check to see if its one of our own local addresses */
r_if
c_cond
(paren
id|dn_dev_islocal
...
c_func
(paren
l_string|&quot;dn_route_output_slow: Dest is local interface address, but loopback device is not up&bslash;n&quot;
)paren
suffix:semicolon
id|dev_put
c_func

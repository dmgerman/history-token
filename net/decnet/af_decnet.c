...
l_int|1450
suffix:semicolon
multiline_comment|/* Best guess for ethernet */
id|scp-&gt;nonagle
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME: This can fail if we&squot;ve run out of local ports....&n;&t; */
id|dn_hash_sock
c_func
(paren
id|newsk
...
suffix:semicolon
multiline_comment|/*&n;&t; * Here we use sk-&gt;allocation since although the conn conf is&n;&t; * for the newsk, the context is the old socket.&n;&t; */
r_if
c_cond
(paren
id|DN_SK
...
multiline_comment|/*&n;&t; * The only difference between SEQPACKET &amp; STREAM sockets under DECnet&n;&t; * is that SEQPACKET sockets set the MSG_EOR flag for the last&n;&t; * session control message segment. &n;&t; */
r_if
c_cond
(paren
id|flags
...
id|len
comma
l_string|&quot;%6s/%04X %04d:%04d %04d:%04d %01d %-16s %6s/%04X %04d:%04d %04d:%04d %01d %-16s %4s %s&bslash;n&quot;
comma
id|dn_addr2asc
c_func
(paren
...
op_assign
id|KERN_INFO
l_string|&quot;NET4: DECnet for Linux: V.2.5.40s (C) 1995-2002 Linux DECnet Project Team&bslash;n&quot;
suffix:semicolon

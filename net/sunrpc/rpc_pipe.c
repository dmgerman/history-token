...
r_void
DECL|function|rpc_purge_upcall
id|rpc_purge_upcall
c_func
(paren
r_struct
...
multiline_comment|/*&n; * XXX should only be called in -&gt;downcall&n; */
r_void
DECL|function|__rpc_purge_current_upcall

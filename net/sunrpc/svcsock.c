...
l_int|0
suffix:semicolon
multiline_comment|/* This was MSG_DONTWAIT, but I now want it to wait.&n;&t; * The only thing that it would wait for is memory and&n;&t; * if we are fairly low on memory, then we aren&squot;t likely&n;&t; * to make much progress anyway.&n;&t; * sk-&gt;sndtimeo is set to 30seconds just in case.&n;&t; */
id|msg.msg_flags
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;RPC update_bufs: permanent sock neither UDP or TCP_LISTEN&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(brace
multiline_comment|/* See svc_tcp_init above for rationale on buffer sizes */
id|svc_sock_setbufsize
c_func
(paren
id|sock
...
(paren
id|KERN_ERR
l_string|&quot;RPC update_bufs: temp sock not TCP&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|spin_unlock_bh

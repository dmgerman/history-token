...
id|gss_cl_ctx
op_star
DECL|function|gss_cred_get_uptodate_ctx
id|gss_cred_get_uptodate_ctx
c_func
(paren
r_struct
id|rpc_cred
...
r_static
r_void
DECL|function|gss_release_callback
id|gss_release_callback
c_func
(paren
r_struct
id|rpc_task
...
id|gss_auth
comma
id|task-&gt;tk_msg.rpc_cred-&gt;cr_uid
)paren
suffix:semicolon
id|BUG_ON
c_func

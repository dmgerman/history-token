...
id|gss_cl_ctx
op_star
DECL|function|gss_alloc_context
id|gss_alloc_context
c_func
(paren
r_void
)paren
...
DECL|macro|GSSD_MIN_TIMEOUT
mdefine_line|#define GSSD_MIN_TIMEOUT (60 * 60)
r_static
r_const
r_void
op_star
DECL|function|gss_fill_context
id|gss_fill_context
c_func
(paren
r_const
...
id|ret
suffix:semicolon
multiline_comment|/* First unsigned int gives the lifetime (in seconds) of the cred */
id|p
op_assign
id|simple_get_bytes
c_func
...
l_int|4
suffix:semicolon
multiline_comment|/* Sequence number window. Determines the maximum number of simultaneous requests */
id|p
op_assign
id|simple_get_bytes
c_func
...
(brace
multiline_comment|/* in which case, p points to  an error code which we ignore */
id|p
op_assign
id|ERR_PTR
c_func
...
multiline_comment|/* copy the opaque wire context */
id|p
op_assign
id|simple_get_netobj
c_func
...
id|err
suffix:semicolon
multiline_comment|/* import the opaque security context */
id|p
op_assign
id|simple_get_bytes
c_func
...
c_func
(paren
l_string|&quot;RPC:      gss_fill_context returning %ld&bslash;n&quot;
comma
op_minus
id|PTR_ERR
c_func
...
id|auth
suffix:semicolon
DECL|member|rpc_waitqueue
r_struct
id|rpc_wait_queue
id|rpc_waitqueue
suffix:semicolon
DECL|member|waitqueue
...
multiline_comment|/* Try to add a upcall to the pipefs queue.&n; * If an upcall owned by our uid already exists, then we return a reference&n; * to that upcall instead of adding the new upcall.&n; */
r_static
r_inline
r_struct
id|gss_upcall_msg
op_star
DECL|function|gss_add_msg
id|gss_add_msg
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|gss_upcall_callback
id|gss_upcall_callback
c_func
(paren
r_struct
id|rpc_task
...
id|gss_upcall_msg
op_star
DECL|function|gss_setup_upcall
id|gss_setup_upcall
c_func
(paren
r_struct
...
r_inline
r_int
DECL|function|gss_refresh_upcall
id|gss_refresh_upcall
c_func
(paren
r_struct
id|rpc_task
...
c_func
(paren
l_string|&quot;RPC: %4u gss_refresh_upcall for uid %u&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|cred-&gt;cr_uid
...
(paren
op_amp
id|gss_cred-&gt;gc_upcall-&gt;rpc_waitqueue
comma
id|task
comma
l_int|NULL
...
id|gss_msg
suffix:semicolon
multiline_comment|/* gss_upcall_callback will release the reference to gss_upcall_msg */
id|atomic_inc
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;RPC: %4u gss_refresh_upcall for uid %u result %d&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|cred-&gt;cr_uid
...
r_inline
r_int
DECL|function|gss_create_upcall
id|gss_create_upcall
c_func
(paren
r_struct
id|gss_auth
...
c_func
(paren
l_string|&quot;RPC: gss_upcall for uid %u&bslash;n&quot;
comma
id|cred-&gt;cr_uid
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;RPC: gss_create_upcall for uid %u result %d&bslash;n&quot;
comma
id|cred-&gt;cr_uid
comma
id|err
...
suffix:semicolon
multiline_comment|/* FIXME: Will go away once privacy support is merged in */
r_if
c_cond
(paren
id|gss_auth-&gt;service
...
multiline_comment|/*&n; * Lookup RPCSEC_GSS cred for the current process&n; */
r_static
r_struct
id|rpc_cred
op_star
DECL|function|gss_lookup_cred
id|gss_lookup_cred
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;RPC:      gss_create_cred failed with error %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Don&squot;t match with creds that have expired. */
r_if
c_cond
(paren
id|gss_cred-&gt;gc_ctx

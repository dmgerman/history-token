...
c_func
(paren
l_string|&quot;RPC: %4d TCP write queue full&bslash;n&quot;
comma
id|task-&gt;tk_pid
)paren
suffix:semicolon
...
id|out_write
suffix:semicolon
multiline_comment|/*&n;&t; * We&squot;re here because the xprt was marked disconnected.&n;&t; * Start by resetting any existing state.&n;&t; */
id|xprt_close
c_func
(paren
id|xprt
...
c_func
(paren
l_string|&quot;RPC: %4d  connect status %d connected %d sock state %d&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
op_minus
...
id|EALREADY
suffix:colon
multiline_comment|/* Protect against TCP socket state changes */
id|lock_sock
c_func
(paren
id|inet
...
c_func
(paren
l_string|&quot;RPC: %4d  waiting for connection&bslash;n&quot;
comma
id|task-&gt;tk_pid
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* if the socket is already closing, delay briefly */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* task status set when task wakes up again */
r_return
suffix:semicolon
)brace
id|release_sock
...
id|EISCONN
suffix:colon
multiline_comment|/* not likely, but just in case */
multiline_comment|/* Half closed state.  No race -- this socket is dead. */
r_if
c_cond
(paren
id|inet-&gt;state
...
multiline_comment|/* Otherwise, the connection is already established. */
id|task-&gt;tk_status
op_assign
l_int|0
suffix:semicolon
...
r_default
suffix:colon
multiline_comment|/* Report myriad other possible returns.  If this file&n;&t;&t; * system is soft mounted, just error out, like Solaris.  */
id|xprt_close
c_func
(paren
id|xprt
...
(paren
id|KERN_WARNING
l_string|&quot;RPC: error %d connecting to server %s, exiting&bslash;n&quot;
comma
op_minus
id|status
comma
...
suffix:semicolon
multiline_comment|/* prevent TCP from continuing to retry SYNs */
id|xprt_close
c_func
(paren
id|xprt
...
multiline_comment|/* if soft mounted, cause this RPC to fail */
r_if
c_cond
(paren
id|task-&gt;tk_client-&gt;cl_softrtry
...
multiline_comment|/*&n; * Exponential backoff for UDP retries&n; */
r_static
r_inline
r_int
DECL|function|xprt_expbackoff
id|xprt_expbackoff
c_func
(paren
r_struct
...
r_else
multiline_comment|/*&n;&t;&t; * Don&squot;t allow a TCP service user unless they have&n;&t;&t; * enough capability to bind a reserved port.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

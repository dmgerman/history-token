...
suffix:semicolon
multiline_comment|/* This will prevent anybody else from reconnecting */
id|rpc_delay
c_func
(paren
id|task
...
suffix:semicolon
multiline_comment|/* Override capabilities.&n;&t; * They were checked in xprt_create_proto i.e. at mount time&n;&t; */
id|cap_raise
c_func
(paren
id|current-&gt;cap_effective

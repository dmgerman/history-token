multiline_comment|/*&n; * linux/net/sunrpc/pmap.c&n; *&n; * Portmapper client.&n; *&n; * Copyright (C) 1996, Olaf Kirch &lt;okir@monad.swb.de&gt;&n; */
...
c_func
(paren
l_string|&quot;RPC: couldn&squot;t create pmap client. Error = %d&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon

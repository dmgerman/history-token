...
suffix:semicolon
multiline_comment|/*&n; * This is a dummy kset so bridge objects don&squot;t cause&n; * hotplug events &n; */
DECL|variable|bridge_subsys
r_struct
id|subsystem
id|bridge_subsys
op_assign

...
(brace
macro_line|#ifdef CONFIG_SYSCTL
multiline_comment|/* This code is executed while in the IP(v6) stack,&n;&t;&t;&t;   the version should be 4 or 6. We can&squot;t use&n;&t;&t;&t;   skb-&gt;protocol because that isn&squot;t set on&n;&t;&t;&t;   PF_INET(6)/LOCAL_OUT. */
r_struct
id|iphdr
op_star
id|ip

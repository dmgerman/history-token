...
mdefine_line|#define IS_VLAN_IP (skb-&gt;protocol == __constant_htons(ETH_P_8021Q) &amp;&amp; &bslash;&n;&t;hdr-&gt;h_vlan_encapsulated_proto == __constant_htons(ETH_P_IP))
DECL|macro|IS_VLAN_ARP
mdefine_line|#define IS_VLAN_ARP (skb-&gt;protocol == __constant_htons(ETH_P_8021Q) &amp;&amp; &bslash;&n;&t;hdr-&gt;h_vlan_encapsulated_proto == __constant_htons(ETH_P_ARP))

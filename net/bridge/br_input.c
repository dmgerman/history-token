...
multiline_comment|/* note: already called with rcu_read_lock (preempt_disabled) */
...
multiline_comment|/*&n; * Called via br_handle_frame_hook.&n; * Return 0 if *pskb should be processed furthur&n; *&t;  1 if *pskb is handled&n; * note: already called with rcu_read_lock (preempt_disabled) &n; */

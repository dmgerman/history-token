...
id|rose_node_list
suffix:semicolon
DECL|variable|rose_node_list_lock
r_static
id|spinlock_t
...
id|rose_neigh_list
suffix:semicolon
DECL|variable|rose_neigh_list_lock
r_static
id|spinlock_t
id|rose_neigh_list_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
...
id|rose_route_list
suffix:semicolon
DECL|variable|rose_route_list_lock
r_static
id|spinlock_t
id|rose_route_list_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
...
multiline_comment|/*&n; * Caller is holding rose_node_list_lock.&n; */
...
multiline_comment|/*&n; * Caller is holding rose_neigh_list_lock.&n; */
...
multiline_comment|/*&n; * Caller is holding rose_route_list_lock.&n; */
...
id|v
suffix:semicolon
multiline_comment|/* if (rose_node-&gt;loopback) {&n;&t;&t;&t;seq_printf(seq, &quot;%-10s %04d 1 loopback&bslash;n&quot;,&n;&t;&t;&t;&t;rose2asc(&amp;rose_node-&gt;address),&n;&t;&t;&t;&t;rose_node-&gt;mask);&n;&t;&t;} else { */
id|seq_printf
c_func
(paren
id|seq
...
DECL|variable|rose_node_seqops
r_static
r_struct
id|seq_operations
id|rose_node_seqops
...
suffix:semicolon
DECL|function|rose_neigh_start
r_static
r_void
op_star
id|rose_neigh_start
...
DECL|variable|rose_neigh_seqops
r_static
r_struct
id|seq_operations
id|rose_neigh_seqops
op_assign
(brace
dot
id|start
...
suffix:semicolon
DECL|function|rose_route_start
r_static
r_void
op_star
id|rose_route_start
...
DECL|variable|rose_route_seqops
r_static
r_struct
id|seq_operations
id|rose_route_seqops
op_assign
(brace
dot
id|start
...
DECL|variable|rose_routes_fops
r_struct
id|file_operations
id|rose_routes_fops
op_assign

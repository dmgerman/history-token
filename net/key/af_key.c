...
suffix:semicolon
DECL|struct|pfkey_sock
r_struct
id|pfkey_sock
(brace
multiline_comment|/* struct sock must be the first member of struct pfkey_sock */
DECL|member|sk
r_struct
id|sock
id|sk

...
id|AF_INET6
suffix:colon
multiline_comment|/* XXX handle IPv6 */
r_default
suffix:colon
id|x
op_assign
...
multiline_comment|/* Table of algos supported by pfkeyv2 interface. */
DECL|struct|algo_desc
r_struct
id|algo_desc
(brace
DECL|member|id
...
suffix:semicolon
multiline_comment|/* XXX identity &amp; sensitivity */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* XXX Do we need this check ? */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* XXX setkey set SADB_SASTATE_LARVAL here &n;&t;   if (hdr-&gt;sadb_msg_type == SADB_ADD &amp;&amp; &n;&t;   sa-&gt;sadb_sa_state != SADB_SASTATE_MATURE) &n;&t;   return ERR_PTR(-EINVAL);&n;&t;   */
r_if
c_cond
(paren
id|sa-&gt;sadb_sa_auth
...
id|EINVAL
suffix:semicolon
multiline_comment|/* XXX Implement XXX */
id|resp_skb
op_assign
l_int|NULL
suffix:semicolon
...
id|sin_addr.s_addr
op_assign
id|xp-&gt;selector.saddr.xfrm4_addr
suffix:semicolon
(paren
(paren
r_struct
...
id|sin_addr.s_addr
op_assign
id|xp-&gt;selector.daddr.xfrm4_addr
suffix:semicolon
(paren
(paren
r_struct

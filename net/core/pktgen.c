...
suffix:semicolon
multiline_comment|/* take 32bit ethernet CRC into account */
id|p
op_add_assign
id|sprintf
c_func
...
id|p
comma
l_string|&quot;OK: %llu(c%llu+d%llu) usec, %llu (%dbyte,%dfrags) %llupps %lluMb/sec (%llubps)  errors: %llu&quot;
comma
(paren
r_int
r_int
...
l_int|4
comma
multiline_comment|/* Add 4 to account for the ethernet checksum */
id|nr_frags
comma
(paren
r_int

...
l_int|NULL
suffix:semicolon
multiline_comment|/* Packet really early in init?  Making flow_cache_init a&n;&t; * pre-smp initcall would solve this.  --RR */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;NET: failed to allocate flow cache order %lu&bslash;n&quot;
comma
id|order
)paren
suffix:semicolon

...
suffix:semicolon
DECL|macro|flow_table
mdefine_line|#define flow_table(cpu) (per_cpu(flow_tables, cpu))
...
mdefine_line|#define flow_hash_rnd_recalc(cpu) &bslash;&n;&t;(per_cpu(flow_hash_info, cpu).hash_rnd_recalc)
DECL|macro|flow_hash_rnd
mdefine_line|#define flow_hash_rnd(cpu) &bslash;&n;&t;(per_cpu(flow_hash_info, cpu).hash_rnd)
DECL|macro|flow_count
mdefine_line|#define flow_count(cpu) &bslash;&n;&t;(per_cpu(flow_hash_info, cpu).count)
...
suffix:semicolon
DECL|macro|flow_flush_tasklet
mdefine_line|#define flow_flush_tasklet(cpu) (&amp;per_cpu(flow_flush_tasklets, cpu))
r_static
id|DECLARE_MUTEX
c_func
(paren
...
DECL|function|flow_cache_flush_tasklet
r_static
r_void
id|flow_cache_flush_tasklet
c_func
(paren
r_int
r_int
...
suffix:semicolon
DECL|function|flow_cache_flush_per_cpu
r_static
r_void
id|flow_cache_flush_per_cpu
c_func
...
DECL|function|flow_cache_flush
r_void
id|flow_cache_flush
c_func
(paren
...
DECL|function|flow_cache_cpu_prepare
r_static
r_int
id|__devinit
id|flow_cache_cpu_prepare
c_func
(paren
r_int
id|cpu
...
DECL|function|flow_cache_cpu_online
r_static
r_int
id|__devinit
id|flow_cache_cpu_online
c_func
(paren
r_int
id|cpu
...
DECL|function|flow_cache_cpu_notify
r_static
r_int
id|__devinit
id|flow_cache_cpu_notify
c_func
(paren
r_struct
id|notifier_block
...
DECL|variable|flow_cache_cpu_nb
r_static
r_struct
id|notifier_block
id|__devinitdata
id|flow_cache_cpu_nb
op_assign
(brace
dot
id|notifier_call
...
c_func
(paren
l_string|&quot;NET: failed to initialise flow cache hash table&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return

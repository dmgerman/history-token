...
mdefine_line|#define net_run_sbin_hotplug(dev, is_register) do { } while (0)
DECL|macro|net_run_hotplug_todo
mdefine_line|#define net_run_hotplug_todo() do { } while (0)
macro_line|#endif
...
multiline_comment|/**&n; *&t;__dev_get_by_flags - find any device with given flags&n; *&t;@if_flags: IFF_* values&n; *&t;@mask: bitmask of bits in if_flags to check&n; *&n; *&t;Search for any interface with the given flags. Returns NULL if a device&n; *&t;is not found or a pointer to the device. The caller must hold either&n; *&t;the RTNL semaphore or @dev_base_lock.&n; */
DECL|function|__dev_get_by_flags
r_struct
id|net_device
op_star
id|__dev_get_by_flags
...
id|p
suffix:semicolon
multiline_comment|/*&n;&t; * Verify the string as this thing may have come from&n;&t; * the user.  There must be either one &quot;%d&quot; and no other &quot;%&quot;&n;&t; * characters, or no &quot;%&quot; characters at all.&n;&t; */
id|p
op_assign
id|strchr
c_func
...
id|EINVAL
suffix:semicolon
multiline_comment|/*&n;&t; * If you need over 100 please also fix the algorithm...&n;&t; */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Calculate csum in the case, when packet is misrouted.&n; * If it failed by some reason, ignore and send skb with wrong&n; * checksum.&n; */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* It must be the very last action, after this &squot;dev&squot; may point&n;&t; * to freed up memory.&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;destructor
...
r_static
id|spinlock_t
id|unregister_todo_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
DECL|variable|unregister_todo
r_static
r_struct
id|net_device
op_star
...
suffix:semicolon
DECL|member|is_register
r_int
id|is_register
suffix:semicolon
)brace
suffix:semicolon
DECL|variable|net_hotplug_list_lock
r_static
id|spinlock_t
id|net_hotplug_list_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
r_static
...
suffix:semicolon
DECL|variable|net_hotplug_list
r_static
r_struct
id|list_head
id|net_hotplug_list
...
suffix:semicolon
DECL|function|net_run_hotplug_one
r_static
r_inline
r_void
id|net_run_hotplug_one
c_func
(paren
r_struct
id|net_hotplug_todo
...
multiline_comment|/* Run all queued hotplug requests. &n; * Requests are run in FIFO order.&n; */
DECL|function|net_run_hotplug_todo
r_static
r_void
id|net_run_hotplug_todo
c_func
...
suffix:semicolon
multiline_comment|/* This is racy but okay since any other requests will get&n;&t; * processed when the other guy does rtnl_unlock.&n;&t; */
r_if
c_cond
(paren
id|list_empty

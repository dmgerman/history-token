...
multiline_comment|/**&n; *&t;alloc_skb_from_cache&t;-&t;allocate a network buffer&n; *&t;@cp: kmem_cache from which to allocate the data area&n; *           (object size must be big enough for @size bytes + skb overheads)&n; *&t;@size: size to allocate&n; *&t;@gfp_mask: allocation mask&n; *&n; *&t;Allocate a new &amp;sk_buff. The returned buffer has no headroom and&n; *&t;tail room of size bytes. The object has a reference count of one.&n; *&t;The return is the buffer. On a failure the return is %NULL.&n; *&n; *&t;Buffers may only be allocated from interrupts using a @gfp_mask of&n; *&t;%GFP_ATOMIC.&n; */
DECL|function|alloc_skb_from_cache
r_struct
id|sk_buff
op_star
...
id|head_copy_len
suffix:semicolon
multiline_comment|/* Copy the linear header and data. */
r_if
c_cond
(paren
id|skb_copy_bits
...
(brace
multiline_comment|/* Unmap previous, if not head fragment. */
r_if
c_cond
(paren
id|i-&gt;nextfrag
...
id|fraglist
suffix:colon
multiline_comment|/* We&squot;re iterating through fraglist. */
r_if
c_cond
(paren
id|i-&gt;nextfrag
...
multiline_comment|/* Fragments with fragments?  Too hard! */
id|BUG_ON
c_func
(paren
id|skb_shinfo
...
id|end
suffix:colon
multiline_comment|/* Bug trap for callers */
id|i-&gt;data
op_assign
l_int|NULL
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* And move data appendix as is. */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Split line is inside header. */
id|skb_split_inside_header
c_func
(paren
id|skb
...
suffix:semicolon
r_else
multiline_comment|/* Second chunk has no header, nothing to copy. */
id|skb_split_no_header
c_func
(paren
id|skb
...
suffix:semicolon
DECL|variable|__pskb_pull_tail
id|EXPORT_SYMBOL
c_func
(paren
id|__pskb_pull_tail
...
suffix:semicolon
DECL|variable|pskb_expand_head
id|EXPORT_SYMBOL
c_func
(paren
id|pskb_expand_head
...
suffix:semicolon
DECL|variable|skb_clone_fraglist
id|EXPORT_SYMBOL
c_func
(paren
id|skb_clone_fraglist
...
suffix:semicolon
DECL|variable|skb_copy_and_csum_bits
id|EXPORT_SYMBOL
c_func
(paren
id|skb_copy_and_csum_bits
...
suffix:semicolon
DECL|variable|skb_dequeue_tail
id|EXPORT_SYMBOL
c_func
(paren
id|skb_dequeue_tail

...
multiline_comment|/**&n; *&t;sk_alloc - All socket objects are allocated here&n; *&t;@family - protocol family&n; *&t;@priority - for allocation (%GFP_KERNEL, %GFP_ATOMIC, etc)&n; *&t;@prot - struct proto associated with this new sock instance&n; *&t;@zero_it - if we should zero the newly allocated sock&n; */
...
suffix:semicolon
DECL|function|proto_unregister
r_void
id|proto_unregister
c_func
(paren
...
DECL|variable|proto_unregister
id|EXPORT_SYMBOL
c_func
(paren
id|proto_unregister
...
DECL|function|proto_method_implemented
r_static
r_char
id|proto_method_implemented
c_func
(paren
r_const
r_void
...
DECL|function|proto_seq_printf
r_static
r_void
id|proto_seq_printf
c_func
...
id|seq
comma
l_string|&quot;%-9s %4u %6d  %6d   %-3s %6u   %-3s  %-10s &quot;
l_string|&quot;%2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c %2c&bslash;n&quot;
comma
id|proto-&gt;name
comma
id|proto-&gt;obj_size
comma
id|proto-&gt;sockets_allocated
op_ne
l_int|NULL
ques
c_cond
...
c_func
(paren
id|proto-&gt;enter_memory_pressure
)paren
)paren
suffix:semicolon
)brace
DECL|function|proto_seq_show
r_static
r_int
id|proto_seq_show
c_func
...
id|seq
comma
l_string|&quot;%-9s %-4s %-8s %-6s %-5s %-7s %-4s %-10s %s&quot;
comma
l_string|&quot;protocol&quot;
comma
l_string|&quot;size&quot;
...
l_string|&quot;module&quot;
comma
l_string|&quot;cl co di ac io in de sh ss gs se re sp bi br ha uh gp em&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|proto_seq_printf
...
(brace
multiline_comment|/* register /proc/net/protocols */
r_return

...
multiline_comment|/* we have 12 bits of vlan ID. */
multiline_comment|/* If it&squot;s NULL, we will tag it to be junked below */
id|skb-&gt;dev
op_assign
...
id|KERN_ERR
id|__FUNCTION__
l_string|&quot;: dent is NOT NULL!&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* If we ever get here, there is a serious bug&n;&t;&t;&t;&t; * that must be fixed.&n;&t;&t;&t;&t; */
)brace
id|kfree
c_func
(paren
...
c_func
(paren
l_string|&quot;dev-&gt;priv free, addr: %p&bslash;n&quot;
comma
id|dev-&gt;priv
)paren
suffix:semicolon

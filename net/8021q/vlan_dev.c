...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Construct the second two bytes. This field looks something&n;&t;&t; * like:&n;&t;&t; * usr_priority: 3 bits&t; (high bits)&n;&t;&t; * CFI&t;&t; 1 bit&n;&t;&t; * VLAN ID&t; 12 bits (low bits)&n;&t;&t; */
id|veth_TCI
op_assign
id|VLAN_DEV_INFO
c_func
...
suffix:semicolon
(brace
multiline_comment|/* Please note, dev_queue_xmit consumes the pkt regardless of the&n;&t;&t; * error value.  So, will copy the skb first and free if successful.&n;&t;&t; */
r_struct
id|sk_buff
op_star
id|skb2
...
(brace
multiline_comment|/* Was success, need to free the skb reference since we bumped up the&n;&t;&t;&t; * user count above.&n;&t;&t;&t; */
id|stats-&gt;tx_packets
op_increment
suffix:semicolon
...
id|veth_TCI
suffix:semicolon
multiline_comment|/* Construct the second two bytes. This field looks something&n;&t; * like:&n;&t; * usr_priority: 3 bits&t; (high bits)&n;&t; * CFI&t;&t; 1 bit&n;&t; * VLAN ID&t; 12 bits (low bits)&n;&t; */
id|veth_TCI
op_assign
id|VLAN_DEV_INFO
c_func
...
DECL|function|vlan_dev_get_realdev_name
r_int
...
DECL|function|vlan_dev_get_vid
r_int
id|vlan_dev_get_vid
c_func
(paren

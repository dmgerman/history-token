...
id|netlink_chain
suffix:semicolon
multiline_comment|/* netlink workqueue handler */
DECL|function|netlink_wq_handler
r_static
r_void
id|netlink_wq_handler
c_func
(paren
r_void
op_star
...
(brace
multiline_comment|/* Kernel is sending information to user space&n;&t;&t;&t; * and socket buffer is full: Wake up user&n;&t;&t;&t; * process */
id|client
op_assign
id|find_task_by_pid
c_func
...
suffix:semicolon
multiline_comment|/* Create a work queue to handle callbacks to modules */
id|netlink_wq
op_assign
id|create_workqueue
c_func

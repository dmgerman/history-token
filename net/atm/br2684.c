...
c_func
(paren
id|brdev-&gt;net_dev.dev_addr
comma
id|esi
comma
id|brdev-&gt;net_dev.addr_len
)paren
suffix:semicolon
r_else
id|brdev-&gt;net_dev.dev_addr
...
suffix:semicolon
multiline_comment|/*&n;&t; * We track module use by vcc&squot;s NOT the devices they&squot;re on.  We&squot;re&n;&t; * protected here against module death by the kernel_lock, but if&n;&t; * we need to sleep we should make sure that the module doesn&squot;t&n;&t; * disappear under us.&n;&t; */
id|MOD_INC_USE_COUNT
suffix:semicolon
r_if
c_cond
...
id|my_eth_header_cache
op_assign
id|brdev-&gt;net_dev.hard_header_cache
suffix:semicolon
id|brdev-&gt;net_dev.hard_header_cache
op_assign
id|br2684_header_cache
suffix:semicolon
id|brdev-&gt;net_dev.hard_header_len
op_assign
r_sizeof
(paren
id|llc_oui_pid_pad
...
id|my_eth_mac_addr
op_assign
id|brdev-&gt;net_dev.set_mac_address
suffix:semicolon
id|brdev-&gt;net_dev.set_mac_address
op_assign
id|br2684_mac_addr
suffix:semicolon
id|brdev-&gt;net_dev.hard_start_xmit
op_assign
id|br2684_start_xmit
suffix:semicolon
id|brdev-&gt;net_dev.get_stats
op_assign
id|br2684_get_stats
suffix:semicolon
...
multiline_comment|/* Never put more than 256 bytes in at once */
DECL|function|br2684_proc_engine
r_static
r_int
id|br2684_proc_engine
c_func
(paren
id|loff_t
id|pos
...
DECL|function|br2684_proc_read
r_static
id|ssize_t
id|br2684_proc_read
c_func
...
multiline_comment|/*&n;&t;&t;&t; * This should only happen if the user passed in&n;&t;&t;&t; * a &quot;count&quot; too small for even one line&n;&t;&t;&t; */
id|x
op_assign
op_minus
id|EINVAL
...
DECL|variable|br2684_proc_operations
r_static
r_struct
id|file_operations

...
c_func
(paren
l_string|&quot;lec_start_xmit called&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;lec_start_xmit: reallocating skb&bslash;n&quot;
)paren
suffix:semicolon
id|skb2
op_assign
...
id|min_frame_size
op_assign
id|LEC_MINIMUM_8025_SIZE
suffix:semicolon
r_else
macro_line|#endif
id|min_frame_size
op_assign
id|LEC_MINIMUM_8023_SIZE
suffix:semicolon
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;%s:vcc:%p vcc_flags:%x, entry:%p&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|vcc
...
c_func
(paren
l_string|&quot;%s:lec_start_xmit: queuing packet, &quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s:lec_start_xmit: tx queue full or no arp entry, dropping, &quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * vcc-&gt;pop() might have occurred in between, making&n;&t;&t; * the vcc usuable again.  Since xmit is serialized,&n;&t;&t; * this is the only situation we have to re-test.&n;&t;&t; */
r_if
c_cond
(paren
id|atm_may_send
...
c_func
(paren
l_string|&quot;lec_pop(): vpriv = NULL!?!?!?&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
l_int|3
suffix:semicolon
multiline_comment|/* ESI_UNDEFINED */
r_return
id|lec_arp_status_string
(braket
id|status

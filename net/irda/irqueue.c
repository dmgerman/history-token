...
multiline_comment|/*&n; * Function hashbin_find (hashbin, hashv, name, pnext)&n; *&n; *    Find an item with the given hashv or name, and its successor&n; *&n; * This function allow to do concurent enumerations without the&n; * need to lock over the whole session, because the caller keep the&n; * context of the search. On the other hand, it might fail and return&n; * NULL if the entry is removed. - Jean II&n; */

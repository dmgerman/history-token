...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * Now, check all discovered devices (if any), and notify client&n;&t; * only about the services that the client is interested in&n;&t; * Note : most often, we will get called immediately following&n;&t; * a discovery, so the log is not going to expire.&n;&t; * On the other hand, comming here through irlmp_discovery_request()&n;&t; * is *very* problematic - Jean II&n;&t; * Can&squot;t use hashbin_find_next(), key is not unique. I&squot;m running&n;&t; * out of options :-( - Jean II&n;&t; */
id|discovery
op_assign
(paren
id|discovery_t

...
(brace
multiline_comment|/* Note that if there is only one LSAP on the LAP&n;&t;&t;&t; * (most common case), self-&gt;flow_next is always NULL,&n;&t;&t;&t; * so we always avoid this loop. - Jean II */
id|IRDA_DEBUG
c_func
(paren
l_int|4
comma
id|__FUNCTION__
l_string|&quot;() : searching my LSAP&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* We look again in hashbins, because the lsap&n;&t;&t;&t; * might have gone away... - Jean II */
id|curr
op_assign
(paren
r_struct
...
multiline_comment|/* Next time, we will get the next one (or the first one) */
id|self-&gt;flow_next
op_assign
(paren
r_struct

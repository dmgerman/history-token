...
l_int|1
comma
l_string|&quot;%s(), error: no more mem!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;%s(%p) : BUG : sk is NULL&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|self
...
multiline_comment|/* Prevent race conditions with irda_release() and irda_shutdown() */
r_if
c_cond
(paren
op_logical_neg
...
l_int|2
comma
l_string|&quot;%s(), max_data_size=%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|self-&gt;max_data_size
...
l_int|0
comma
l_string|&quot;%s() Unable to allocate sk_buff!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), IrTTP wants us to slow down&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), IrTTP wants us to start again&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), IAS query failed! (%d)&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|result
...
l_int|0
comma
l_string|&quot;%s(), Unable to allocate TSAP!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/* Treat unexpected wakeup as disconnect */
id|self-&gt;errno
op_assign
op_minus
id|EHOSTUNREACH
...
suffix:semicolon
multiline_comment|/* Wait for answer, if not yet finished (or failed) */
r_if
c_cond
(paren
...
multiline_comment|/* Treat signals as disconnect */
r_return
op_minus
id|EHOSTUNREACH
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Non blocking operation */
r_if
c_cond
(paren
id|flags
...
id|EWOULDBLOCK
suffix:semicolon
multiline_comment|/* The following code is a cut&squot;n&squot;paste of the&n;&t;&t; * wait_event_interruptible() macro.&n;&t;&t; * We don&squot;t us the macro because the condition has&n;&t;&t; * side effects : we want to make sure that only one&n;&t;&t; * skb get dequeued - Jean II */
id|add_wait_queue
c_func
(paren
id|sk-&gt;sk_sleep
...
id|irda_ultra_ops
suffix:semicolon
multiline_comment|/* Initialise now, because we may send on unbound&n;&t;&t;&t; * sockets. Jean II */
id|self-&gt;max_data_size
op_assign
id|ULTRA_MAX_DATA
op_minus
...
l_int|2
comma
l_string|&quot;%s(), Starting IrTTP&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
r_break
suffix:semicolon
multiline_comment|/* The following code is a cut&squot;n&squot;paste of the&n;&t;&t;&t; * wait_event_interruptible() macro.&n;&t;&t;&t; * We don&squot;t us the macro because the test condition&n;&t;&t;&t; * is messy. - Jean II */
id|set_bit
c_func
(paren
...
multiline_comment|/* Wait process until data arrives */
id|schedule
c_func
(paren
)paren
...
l_int|0
comma
l_string|&quot;%s() questionable!?&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|4
comma
l_string|&quot;%s(), appending user data&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Check if an address was specified with sendto. Jean II */
r_if
c_cond
(paren
id|msg-&gt;msg_name
...
id|msg-&gt;msg_name
suffix:semicolon
multiline_comment|/* Check address, extract pid. Jean II */
r_if
c_cond
(paren
id|msg-&gt;msg_namelen
...
r_else
(brace
multiline_comment|/* Check that the socket is properly bound to an Ultra&n;&t;&t; * port. Jean II */
r_if
c_cond
(paren
(paren
...
l_int|0
comma
l_string|&quot;%s(), socket not bound to Ultra PID.&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/* Use PID from socket */
id|bound
op_assign
l_int|1
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), doing device ioctl!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/* Find the object we target.&n;&t;&t; * If the user gives us an empty string, we use the object&n;&t;&t; * associated with this socket. This will workaround&n;&t;&t; * duplicated class name - Jean II */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* Only ROOT can mess with the global IAS database.&n;&t;&t; * Users can only add attributes to the object associated&n;&t;&t; * with the socket they own - Jean II */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* If the object doesn&squot;t exist, create it */
r_if
c_cond
(paren
id|ias_obj
...
multiline_comment|/* Do we have the attribute already ? */
r_if
c_cond
(paren
...
multiline_comment|/* Only ROOT can mess with the global IAS database.&n;&t;&t; * Users can only del attributes from the object associated&n;&t;&t; * with the socket they own - Jean II */
r_if
c_cond
(paren
(paren
...
l_int|1
comma
l_string|&quot;%s(), attempting to delete a kernel attribute&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), setting max_sdu_size = %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|opt
...
(brace
multiline_comment|/* pending request uses copy of ias_opt-content&n;&t;&t;&t; * we can free it regardless! */
id|kfree
c_func
(paren
id|ias_opt
...
l_int|1
comma
l_string|&quot;%s(), nothing discovered yet, going to sleep...&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), found immediately !&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

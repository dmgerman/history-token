...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Function irnet_get_discovery_log (self)&n; *&n; *    Query the content on the discovery log if not done&n; *&n; * This function query the current content of the discovery log&n; * at the startup of the event channel and save it in the internal struct.&n; */
r_static
r_void
DECL|function|irnet_get_discovery_log
id|irnet_get_discovery_log
c_func
(paren
id|irnet_socket
op_star
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Function irnet_read_discovery_log (self, event)&n; *&n; *    Read the content on the discovery log&n; *&n; * This function dump the current content of the discovery log&n; * at the startup of the event channel.&n; * Return 1 if wrote an event on the control channel...&n; *&n; * State of the ap-&gt;disco_XXX variables :&n; * Socket creation :  discoveries = NULL ; disco_index = 0 ; disco_number = 0&n; * While reading :    discoveries = ptr  ; disco_index = X ; disco_number = Y&n; * After reading :    discoveries = NULL ; disco_index = Y ; disco_number = -1&n; */
r_static
r_inline
r_int

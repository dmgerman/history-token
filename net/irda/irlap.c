...
(brace
multiline_comment|/* Check if the compiler did its job properly.&n;&t; * May happen on some ARM configuration, check with Russell King. */
id|ASSERT
c_func
(paren
r_sizeof
...
id|qos
suffix:semicolon
multiline_comment|/* Copy hardware name */
r_if
c_cond
(paren
id|hw_name
...
id|seq
comma
l_string|&quot;hardware name: %s&bslash;n&quot;
comma
id|self-&gt;hw_name
)paren
suffix:semicolon

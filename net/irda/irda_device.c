...
multiline_comment|/* We no longer initialise the driver ourselves here, we let&n;&t; * the system do it for us... - Jean II */
r_return
l_int|0
suffix:semicolon
)brace
DECL|function|leftover_dongle
r_static
r_void
id|__exit
id|leftover_dongle

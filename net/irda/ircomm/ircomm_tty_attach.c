...
suffix:semicolon
multiline_comment|/* Remove discovery handler */
r_if
c_cond
(paren
id|self-&gt;ckey
...
suffix:semicolon
multiline_comment|/* Compute hint bits based on service */
id|hints
op_assign
...
suffix:semicolon
multiline_comment|/* Advertise IrCOMM hint bit in discovery */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Set up a discovery handler */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* If already done, no need to do it again */
r_if
c_cond
(paren
id|self-&gt;obj
...
multiline_comment|/*&n; * Function ircomm_tty_ias_unregister (self)&n; *&n; *    Remove our IAS object and client hook while connected.&n; *&n; */
DECL|function|ircomm_tty_ias_unregister
r_static
r_void
id|ircomm_tty_ias_unregister
c_func
(paren
r_struct
id|ircomm_tty_cb
...
macro_line|#if 0
multiline_comment|/* Remove discovery handler.&n;&t; * While we are connected, we no longer need to receive&n;&t; * discovery events. This would be the case if there is&n;&t; * multiple IrLAP interfaces. Jean II */
r_if
c_cond
(paren
id|self-&gt;ckey
...
id|discovery-&gt;saddr
suffix:semicolon
multiline_comment|/* FIXME. We have a locking problem on the hashbin here.&n;&t; * We probably need to use hashbin_find_next(), but we first&n;&t; * need to ensure that &quot;line&quot; is unique. - Jean II */
id|self
op_assign
(paren
r_struct
...
(brace
multiline_comment|/*&n;&t;IRDA_ASSERT(self != NULL, return;);&n;&t;IRDA_ASSERT(self-&gt;magic == IRCOMM_TTY_MAGIC, return;);&n;&n;&t;IRDA_DEBUG(2, &quot;%s: next state=%s, service type=%d&bslash;n&quot;, __FUNCTION__ , &n;&t;&t;   ircomm_tty_state[self-&gt;state], self-&gt;service_type);&n;&t;*/
id|self-&gt;state
op_assign
id|state
suffix:semicolon

...
l_int|2
comma
l_string|&quot;%s(), already open so break out!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), O_NONBLOCK requested!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s(), doing CLOCAL!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* As far as I can see, we protect open_count - Jean II */
...
(brace
multiline_comment|/* Here, we use to lock those two guys, but&n;&t;&t;&t; * as ircomm_param_request() does it itself,&n;&t;&t;&t; * I don&squot;t see the point (and I see the deadlock).&n;&t;&t;&t; * Jean II */
...
(brace
multiline_comment|/* ++ is not atomic, so this should be protected - Jean II */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
l_int|2
comma
l_string|&quot;%s(), IrCOMM device&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), IrLPT device&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), returning after block_til_ready with %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ret
...
l_int|0
comma
l_string|&quot;%s(), returning 1&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;%s(), bad serial port count; &quot;
...
l_int|0
comma
l_string|&quot;%s(), open count &gt; 0&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), count=%d, hw_stopped=%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|count
...
l_int|0
suffix:semicolon
multiline_comment|/* Additional copy to avoid copy_from_user() under spinlock.&n;&t; * We tradeoff this extra copy to allow to pack more the&n;&t; * IrCOMM frames. This is advantageous because the IrDA link&n;&t; * is the bottleneck. */
r_if
c_cond
(paren
id|from_user
...
l_int|1
comma
l_string|&quot;%s(), FLOW_START&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* I guess we need to lock here - Jean II */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
l_int|2
comma
l_string|&quot;%s(), ircomm%d CD now %s...&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|self-&gt;line
...
l_int|2
comma
l_string|&quot;%s(), Doing serial hangup..&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), CTS tx start...&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), CTS tx stop...&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;%s(), polling for line settings!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s(), hw stopped!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

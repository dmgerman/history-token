...
suffix:semicolon
DECL|variable|ircomm_proc_fops
r_static
r_struct
id|file_operations
id|ircomm_proc_fops
...
suffix:semicolon
macro_line|#ifdef CONFIG_PROC_FS
DECL|struct|ircomm_iter_state
r_struct
id|ircomm_iter_state
(brace
DECL|member|flags
r_int
r_int
...
suffix:semicolon
DECL|function|ircomm_seq_start
r_static
r_void
op_star
id|ircomm_seq_start
...
id|seq
comma
l_string|&quot; state: %s, slsap_sel: %#02x, dlsap_sel: %#02x, mode:&quot;
comma
id|ircomm_state
(braket
id|self-&gt;state

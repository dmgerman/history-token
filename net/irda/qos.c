...
suffix:semicolon
multiline_comment|/* ---------------------- LOCAL SUBROUTINES ---------------------- */
multiline_comment|/* Note : we start with a bunch of local subroutines.&n; * As the compiler is &quot;one pass&quot;, this is the only way to get them to&n; * inline properly...&n; * Jean II&n; */

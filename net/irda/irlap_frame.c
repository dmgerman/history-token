...
multiline_comment|/* We are no longer an &quot;old&quot; protocol, so we need to handle&n;&t; * share and non linear skbs. This should never happen, so&n;&t; * we don&squot;t need to be clever about it. Jean II */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;%s: can&squot;t linearize skb!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

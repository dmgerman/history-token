...
id|RECV_DM_RSP
suffix:colon
multiline_comment|/* IrLAP-1.1 p.82: in SCLOSE, S and I type RSP frames&n;&t;&t; * shall take us down into default NDM state, like DM_RSP&n;&t;&t; */
r_case
id|RECV_RR_RSP
suffix:colon
r_case
...
multiline_comment|/* IrLAP-1.1 p.82: in SCLOSE, basically any received frame&n;&t;&t; * with pf=1 shall restart the wd-timer and resend the rd:rsp&n;&t;&t; */
r_if
c_cond
(paren
id|info
...
r_break
suffix:semicolon
multiline_comment|/* stay in SCLOSE */
)brace
id|IRDA_DEBUG
c_func
(paren

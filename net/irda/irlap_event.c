...
id|WD_TIMER_EXPIRED
suffix:colon
multiline_comment|/*&n;&t;&t; *  Wait until retry_count * n matches negotiated threshold/&n;&t;&t; *  disconnect time (note 2 in IrLAP p. 82)&n;&t;&t; *&n;&t;&t; * Note : self-&gt;wd_timeout = (self-&gt;final_timeout * 2),&n;&t;&t; *   which explain why we use (self-&gt;N2 / 2) here !!!&n;&t;&t; * Jean II&n;&t;&t; */
id|IRDA_DEBUG
c_func
(paren
l_int|1

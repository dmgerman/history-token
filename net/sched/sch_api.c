...
(brace
multiline_comment|/* We dropped the RTNL semaphore in order to&n;&t;&t;&t; * perform the module load.  So, even if we&n;&t;&t;&t; * succeeded in loading the module we have to&n;&t;&t;&t; * tell the caller to replay the request.  We&n;&t;&t;&t; * indicate this using -EAGAIN.&n;&t;&t;&t; * We replay the request because the device may&n;&t;&t;&t; * go away in the mean time.&n;&t;&t;&t; */
id|rtnl_unlock
c_func
(paren
)paren
...
(brace
multiline_comment|/* We will try again qdisc_lookup_ops,&n;&t;&t;&t;&t; * so don&squot;t keep a reference.&n;&t;&t;&t;&t; */
id|module_put
c_func
(paren
id|ops-&gt;owner
...
id|replay
suffix:colon
multiline_comment|/* Reinit, just in case something touches this. */
id|tcm
op_assign
id|NLMSG_DATA
c_func

...
DECL|function|qdisc_unlock_tree
r_void
...
id|size
suffix:semicolon
multiline_comment|/* ensure that the Qdisc and the private data are 32-byte aligned */
id|size
op_assign
(paren
(paren
...
multiline_comment|/* this is the rcu callback function to clean up a qdisc when there &n; * are no further references to it */
DECL|function|__qdisc_destroy
r_static
r_void
id|__qdisc_destroy
c_func
...
multiline_comment|/* unlink inner qdiscs from dev-&gt;qdisc_list immediately */
...
suffix:semicolon
DECL|variable|qdisc_unlock_tree
id|EXPORT_SYMBOL
c_func
(paren
id|qdisc_unlock_tree

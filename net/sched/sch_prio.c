...
id|ret
suffix:semicolon
multiline_comment|/* moving these up here changes things from before&n;&t; * packets counted now include everything that was ever&n;&t; * seen&n;        */
id|sch-&gt;stats.bytes
op_add_assign
id|skb-&gt;len
suffix:semicolon
...
id|NET_XMIT_BYPASS
suffix:semicolon
multiline_comment|/* we dont want to confuse TCP */
)brace
macro_line|#endif
)brace
r_static

...
suffix:semicolon
multiline_comment|/* We dropped the RTNL semaphore in order to&n;&t;&t; * perform the module load.  So, even if we&n;&t;&t; * succeeded in loading the module we have to&n;&t;&t; * tell the caller to replay the request.  We&n;&t;&t; * indicate this using -EAGAIN.&n;&t;&t; */
r_if
c_cond
(paren
id|a_o

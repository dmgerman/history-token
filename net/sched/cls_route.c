...
id|route4_bucket
(brace
multiline_comment|/* 16 FROM buckets + 16 IIF buckets + 1 wildcard bucket */
DECL|member|ht
r_struct
id|route4_filter
op_star
...
r_inline
r_void
DECL|function|route4_delete_filter
id|route4_delete_filter
c_func
(paren
r_struct
id|tcf_proto
...
DECL|function|route4_set_parms
r_static
r_int
id|route4_set_parms
c_func

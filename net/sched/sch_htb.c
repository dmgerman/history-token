...
mdefine_line|#define HTB_DUMTREE(root,memb) if(root) { &bslash;&n;&t;rb_node_t *n = (root)-&gt;rb_node; &bslash;&n;&t;while (n-&gt;rb_left) n = n-&gt;rb_left; &bslash;&n;&t;while (n) { &bslash;&n;&t;&t;struct htb_class *cl = rb_entry(n, struct htb_class, memb); &bslash;&n;&t;&t;printk(&quot; %x&quot;,cl-&gt;classid); htb_next_rb_node (&amp;n); &bslash;&n;&t;} }

...
id|sel-&gt;fshift
suffix:semicolon
multiline_comment|/*&n;&t;h ^= h&gt;&gt;16;&n;&t;h ^= h&gt;&gt;8;&n;&t;*/
r_return
id|h
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;fh %x cnt %lu hit %lu&bslash;n&quot;
comma
id|n-&gt;handle
comma
id|n-&gt;sel.rcnt
...
l_int|0
suffix:semicolon
multiline_comment|/* dump key cnt */
(brace
r_int
id|i
op_assign
...
c_func
(paren
l_string|&quot;&bslash;t key%d success %lu&bslash;n&quot;
comma
id|i
comma
id|key-&gt;kcnt

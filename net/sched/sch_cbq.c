...
id|maxidle
suffix:semicolon
multiline_comment|/* Class parameters: see below. */
DECL|member|offtime
r_int
id|offtime
suffix:semicolon
...
id|incr2
suffix:semicolon
multiline_comment|/* Time integrator. We calculate EOS time&n;&t;&t;   by adding expected packet transmission time.&n;&t;&t;   If real time is greater, we warp artificial clock,&n;&t;&t;   so that:&n;&n;&t;&t;   cbq_time = max(real_time, work);&n;&t;&t; */
id|incr2
op_assign
id|L2T
c_func
...
r_static
r_int
DECL|function|cbq_dump_class_stats
id|cbq_dump_class_stats
c_func
(paren
r_struct
id|Qdisc

...
c_func
(paren
l_string|&quot;cls_fw: bad indev name %s&bslash;n&quot;
comma
(paren
r_char
op_star
...
macro_line|#endif
macro_line|#else /* only POLICE defined */
macro_line|#ifdef CONFIG_NET_CLS_POLICE
r_if
c_cond
(paren
...
suffix:semicolon
macro_line|#ifdef CONFIG_NET_CLS_ACT
multiline_comment|/* again for backward compatible mode - we want&n;               *  to work with both old and new modes of entering&n;               *  tc data even if iproute2  was newer - jhs&n;               */
r_if
c_cond
(paren
id|f-&gt;action

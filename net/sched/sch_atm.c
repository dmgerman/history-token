...
suffix:semicolon
multiline_comment|/* Ethertype IP (0800) */
...
op_increment
suffix:semicolon
id|flow-&gt;bstats.bytes
op_add_assign
id|skb-&gt;len
suffix:semicolon
id|flow-&gt;bstats.packets
op_increment
suffix:semicolon
...
r_static
r_int
DECL|function|atm_tc_dump_class_stats
id|atm_tc_dump_class_stats
c_func
(paren
r_struct
id|Qdisc

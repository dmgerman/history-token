...
(paren
id|KERN_ERR
l_string|&quot;%s: invalid primitive %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|prim-&gt;prim
...
multiline_comment|/**&n; *&t;llc_confirm_impossible - Informs upper layer about failed connection&n; *&t;@prim: pointer to structure that contains confirmation data.&n; *&n; *&t;Informs upper layer about failing in connection establishment. This&n; *&t;function is called by llc_conn_req_handler.&n; */
DECL|function|llc_confirm_impossible
r_static
r_void
id|llc_confirm_impossible
c_func
(paren
r_struct
id|llc_prim_if_block
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Network layer supplies connection handle; map it to a connection;&n;&t; * package as event and send it to connection event handler&n;&t; */
r_struct
id|sock
op_star
id|sk

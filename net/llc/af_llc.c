...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * FIXME: check if the the address is multicast,&n;&t;&t; * &t;  only SOCK_DGRAM can do this.&n;&t;&t; */
id|memcpy
c_func
(paren
id|laddr.mac
...
c_func
(paren
l_string|&quot;IEEE 802.2 PF_LLC support&quot;
)paren
suffix:semicolon

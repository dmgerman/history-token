...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This only makes sense if the socket was inserted on the&n;&t;&t; * list, if sk-&gt;sk_pprev is NULL it wasn&squot;t&n;&t;&t; */
id|sock_put
c_func
(paren
id|sk

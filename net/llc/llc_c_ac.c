...
multiline_comment|/**&n; *&t;llc_conn_disc - removes connection from SAP list and frees it&n; *&t;@sk: closed connection&n; *&t;@skb: occurred event&n; *&n; *&t;Returns 2, to indicate the state machine that the connection was freed.&n; */

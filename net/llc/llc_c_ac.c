...
id|skb-&gt;dev
suffix:semicolon
multiline_comment|/* FIXME: find better way to notify upper layer */
id|ev-&gt;flag
op_assign
id|LLC_CONN_PRIM
op_plus
...
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME: find better way to tell upper layer that the packet was&n;&t; * confirmed by the other endpoint&n;&t; */
id|ev-&gt;flag
op_assign
id|LLC_DATA_PRIM
op_plus

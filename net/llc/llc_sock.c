...
c_func
(paren
l_string|&quot;%s: can&squot;t find a parent :-(&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: found parent of remote %02X, its local %02X&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|newllc-&gt;daddr.lsap
...
c_func
(paren
l_string|&quot;%s: bad parent :-(&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: bad status :-(&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: bad socket...&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

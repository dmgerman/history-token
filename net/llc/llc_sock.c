...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This only makes sense if the socket was inserted on the&n;&t;&t; * list, if sk-&gt;pprev is NULL it wasn&squot;t&n;&t;&t; */
id|sock_put
c_func
(paren
id|sk
...
c_func
(paren
l_string|&quot;%s: shouldn&squot;t happen, LLC_CONN_PRIM &quot;
...
c_func
(paren
l_string|&quot;%s: shouldn&squot;t happen, LLC_DISC_PRIM &quot;
l_string|&quot;is gone for -&gt;ind()...&bslash;n&quot;
comma
id|__FUNCTION__
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: prim not supported%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|prim-&gt;prim
...
id|buffer
comma
l_string|&quot;SKt Mc local_mac_sap        &quot;
l_string|&quot;remote_mac_sap       tx_queue rx_queue st uid &quot;

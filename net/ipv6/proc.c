...
mdefine_line|#define SNMP6_GEN(x) { #x , (void **)ipv6_statistics, offsetof(struct ipv6_mib, x) }
id|SNMP6_GEN
c_func
(paren
id|Ip6InReceives
...
DECL|macro|SNMP6_GEN
mdefine_line|#define SNMP6_GEN(x) { #x , (void **)icmpv6_statistics, offsetof(struct icmpv6_mib, x) }
id|SNMP6_GEN
c_func
(paren
id|Icmp6InMsgs
...
macro_line|#undef SNMP6_GEN
DECL|macro|SNMP6_GEN
mdefine_line|#define SNMP6_GEN(x) { &quot;Udp6&quot; #x , (void **)udp_stats_in6, offsetof(struct udp_mib, Udp##x) }
id|SNMP6_GEN
c_func
(paren
id|InDatagrams

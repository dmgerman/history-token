...
suffix:semicolon
multiline_comment|/* the IPv6 fallback tunnel */
DECL|variable|ip6ip6_fb_tnl
r_static
r_struct
id|ip6_tnl
id|ip6ip6_fb_tnl
...
multiline_comment|/**&n; * ip6_tnl_destroy() - destroy old tunnel&n; *   @t: tunnel to be destroyed&n; *&n; * Return:&n; *   whatever unregister_netdevice() returns&n; **/
r_static
r_inline
r_int
DECL|function|ip6_tnl_destroy
id|ip6_tnl_destroy
c_func
(paren
r_struct
...
multiline_comment|/**&n; * ip6ip6_tnl_dev_destructor - tunnel device destructor&n; *   @dev: the device to be destroyed&n; **/
r_static
r_void
DECL|function|ip6ip6_tnl_dev_destructor
id|ip6ip6_tnl_dev_destructor
c_func
(paren
r_struct
id|net_device
...
(brace
multiline_comment|/* as long as tunnels use the same socket &n;&t;&t;&t;&t;   for transmission, locally nested tunnels &n;&t;&t;&t;&t;   won&squot;t work */
id|dst_release
c_func
(paren
op_amp
...
multiline_comment|/**&n; * ip6ip6_tnl_dev_init_gen - general initializer for all tunnel devices&n; *   @dev: virtual device associated with tunnel&n; *&n; * Description:&n; *   Set function pointers and initialize the &amp;struct flowi template used&n; *   by the tunnel.&n; **/
r_static
r_void

...
multiline_comment|/* XXX no ipv6 esp specific */
DECL|macro|NIP6
...
id|nexthdr
suffix:semicolon
multiline_comment|/* XXX We know the option is inner dest opt&n;&t;&t;&t;   with next next header check. */
r_if
c_cond
(paren
id|nextnexthdr

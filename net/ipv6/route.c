...
DECL|function|rt6_check_expired
r_static
id|__inline__
r_int
id|rt6_check_expired
c_func
(paren
r_const
r_struct
...
(brace
multiline_comment|/*&n;&t;&t; * According to RFC2460, PMTU is set to the IPv6 Minimum Link &n;&t;&t; * MTU (1280) and a fragment header should always be included&n;&t;&t; * after a node receiving Too Big message reporting PMTU is&n;&t;&t; * less than the IPv6 Minimum Link MTU.&n;&t;&t; */
id|pmtu
op_assign
id|IPV6_MIN_MTU
suffix:semicolon

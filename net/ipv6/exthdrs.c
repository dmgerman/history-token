...
multiline_comment|/* Changes:&n; *&t;yoshfuji&t;&t;: ensure not to overrun while parsing &n; *&t;&t;&t;&t;  tlv options.&n; *&t;Mitsuru KANDA @USAGI&t;: Remove ipv6_parse_exthdrs().&n; *&t;&t;&t;&t;: Register inbound extention header&n; *&t;&t;&t;&t;: handlers as inet6_protocol{}.&n; */
...
multiline_comment|/* This is fake. We have already parsed hopopts in ipv6_rcv(). -mk */
DECL|function|ipv6_hopopts_rcv
r_static
r_int
id|ipv6_hopopts_rcv
c_func
...
DECL|variable|hopopts_protocol
r_static
r_struct
id|inet6_protocol
id|hopopts_protocol
...
suffix:semicolon
DECL|function|ipv6_hopopts_init
r_void
id|__init
...
(paren
id|KERN_ERR
l_string|&quot;ipv6_hopopts_init: Could not register protocol&bslash;n&quot;
)paren
suffix:semicolon
)brace

...
mdefine_line|#define icmpv6_socket&t;__get_cpu_var(__icmpv6_socket)
r_static
r_int
id|icmpv6_rcv
c_func
...
(brace
multiline_comment|/* This can happen if the output path (f.e. SIT or&n;&t;&t; * ip6ip6 tunnel) signals dst_link_failure() for an&n;&t;&t; * outgoing ICMP6 packet.&n;&t;&t; */
id|local_bh_enable
c_func
(paren
)paren
...
id|out
suffix:semicolon
id|tmp_hdr.icmp6_type
op_assign
id|type
suffix:semicolon
id|tmp_hdr.icmp6_code
op_assign
id|code
suffix:semicolon
id|tmp_hdr.icmp6_cksum
op_assign
l_int|0
suffix:semicolon
id|tmp_hdr.icmp6_pointer
op_assign
id|htonl
c_func
(paren
...
suffix:colon
r_case
id|ICMPV6_DHAAD_REQUEST
suffix:colon
r_case
id|ICMPV6_DHAAD_REPLY
suffix:colon
r_case
id|ICMPV6_MOBILE_PREFIX_SOL
suffix:colon
r_case
id|ICMPV6_MOBILE_PREFIX_ADV
suffix:colon
r_break
suffix:semicolon
r_default

...
DECL|function|fib6_force_start_gc
r_void
...
id|jiffies
suffix:semicolon
multiline_comment|/*&n;&t; *&t;check addrconf expiration here.&n;&t; *&t;Routes are expired even if they are in use.&n;&t; *&n;&t; *&t;Also age clones. Note, that clones are aged out&n;&t; *&t;only if they are not in use now.&n;&t; */
r_if
c_cond
(paren
id|rt-&gt;rt6i_flags
...
c_func
(paren
l_string|&quot;purging route %p via non-router but gateway&bslash;n&quot;
comma
id|rt
)paren
suffix:semicolon

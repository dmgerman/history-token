...
multiline_comment|/*&n; * Return the padding between the option length and the start of the&n; * link addr.  Currently only IP-over-InfiniBand needs this, although&n; * if RFC 3831 IPv6-over-Fibre Channel is ever implemented it may&n; * also need a pad of 2.&n; */
DECL|function|ndisc_addr_option_pad
r_static
r_int
id|ndisc_addr_option_pad
c_func
(paren
r_int
r_int
...
DECL|function|ndisc_opt_addr_space
r_static
r_inline
r_int
id|ndisc_opt_addr_space
c_func
(paren
r_struct
id|net_device
...
DECL|function|ndisc_fill_addr_option
r_static
id|u8
op_star
id|ndisc_fill_addr_option
c_func
(paren
id|u8
op_star
...
DECL|function|ndisc_opt_addr_data
r_static
r_inline
id|u8
op_star
id|ndisc_opt_addr_data
c_func
(paren
r_struct
id|nd_opt_hdr
...
suffix:semicolon
macro_line|#ifdef CONFIG_SYSCTL
DECL|function|ndisc_warn_deprecated_sysctl
r_static
r_void
id|ndisc_warn_deprecated_sysctl
c_func
(paren
r_struct
id|ctl_table
...
(paren
id|KERN_WARNING
l_string|&quot;process `%s&squot; is using deprecated sysctl (%s) &quot;
l_string|&quot;net.ipv6.neigh.%s.%s; &quot;
l_string|&quot;Use net.ipv6.neigh.%s.%s_ms &quot;
...
c_func
(paren
id|idev-&gt;nd_parms-&gt;base_reachable_time
)paren
suffix:semicolon
id|idev-&gt;tstamp
op_assign

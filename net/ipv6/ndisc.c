...
multiline_comment|/*&n; *&t;Changes:&n; *&n; *&t;Lars Fenneberg&t;&t;&t;:&t;fixed MTU setting on receipt&n; *&t;&t;&t;&t;&t;&t;of an RA.&n; *&n; *&t;Janos Farkas&t;&t;&t;:&t;kmalloc failure checks&n; *&t;Alexey Kuznetsov&t;&t;:&t;state machine reworked&n; *&t;&t;&t;&t;&t;&t;and moved to net/core.&n; *&t;Pekka Savola&t;&t;&t;:&t;RFC2461 validation&n; */
...
id|NDISC_NEIGHBOUR_SOLICITATION
suffix:colon
multiline_comment|/* XXX: import nd_neighbor_solicit from glibc netinet/icmp6.h */
r_if
c_cond
(paren
id|payload_len
...
(paren
id|KERN_WARNING
l_string|&quot;ICMP NS: packet too short&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* XXX: RFC2461 7.1.1:&n;&t;&t; * &t;If the IP source address is the unspecified address, there&n;&t;&t; *&t;MUST NOT be source link-layer address option in the message.&n;&t;&t; *&n;&t;&t; *&t;NOTE! Linux kernel &lt; 2.4.4 broke this rule.&n;&t;&t; */
multiline_comment|/* XXX: RFC2461 7.1.1:&n;&t;&t; *&t;If the IP source address is the unspecified address, the IP&n;      &t;&t; *&t;destination address MUST be a solicited-node multicast address.&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|NDISC_NEIGHBOUR_ADVERTISEMENT
suffix:colon
multiline_comment|/* XXX: import nd_neighbor_advert from glibc netinet/icmp6.h */
r_if
c_cond
(paren
id|payload_len
...
suffix:colon
multiline_comment|/* XXX: import nd_router_advert from glibc netinet/icmp6.h */
r_if
c_cond
(paren
id|payload_len
...
id|NDISC_REDIRECT
suffix:colon
multiline_comment|/* XXX: import nd_redirect from glibc netinet/icmp6.h */
r_if
c_cond
(paren
id|payload_len
...
(paren
id|KERN_WARNING
l_string|&quot;ICMP redirect: packet too short&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|NDISC_ROUTER_SOLICITATION
suffix:colon
multiline_comment|/* No RS support in the kernel, but we do some required checks */
multiline_comment|/* XXX: import nd_router_solicit from glibc netinet/icmp6.h */
r_if
c_cond
(paren
id|payload_len
...
(paren
id|KERN_WARNING
l_string|&quot;ICMP RS: packet too short&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

...
DECL|variable|ip6_frag_secret_timer
r_static
r_struct
id|timer_list
...
id|HZ
suffix:semicolon
DECL|function|ip6_frag_secret_rebuild
r_static
r_void
id|ip6_frag_secret_rebuild
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* idev might be pointed to NULL */
r_if
c_cond
(paren
id|fq-&gt;fragments
...
suffix:semicolon
id|IPV6_INC_STATS_BH
c_func
(paren
id|idev
comma
id|ipStatsReasmFails
)paren
suffix:semicolon
)brace
)brace
...
suffix:semicolon
multiline_comment|/* The first fragment.&n;&t; * nhoffset is obtained from the first fragment, of course.&n;&t; */
r_if
c_cond
(paren
id|offset
...
id|head
suffix:semicolon
multiline_comment|/* Yes, and fold redundant checksum back. 8) */
r_if
c_cond
(paren
id|head-&gt;ip_summed
...
(paren
id|KERN_ERR
l_string|&quot;ipv6_frag_init: Could not register protocol&bslash;n&quot;
)paren
suffix:semicolon
id|ip6_frag_hash_rnd
op_assign
...
suffix:semicolon
id|ip6_frag_secret_timer.function
op_assign
id|ip6_frag_secret_rebuild
suffix:semicolon
id|ip6_frag_secret_timer.expires
op_assign
id|jiffies
op_plus
id|sysctl_ip6frag_secret_interval

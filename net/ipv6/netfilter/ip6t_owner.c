...
macro_line|#include &lt;linux/netfilter_ipv6/ip6t_owner.h&gt;
...
c_func
(paren
l_string|&quot;IP6 tables owner matching module&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
c_func
(paren
l_string|&quot;ip6t_owner: only valid for LOCAL_OUT or POST_ROUTING.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

multiline_comment|/*&n; * IPv6 packet mangling table, a port of the IPv4 mangle table to IPv6&n; *&n; * Copyright (C) 2000 by Harald Welte &lt;laforge@gnumonks.org&gt;&n; */
macro_line|#include &lt;linux/module.h&gt;
macro_line|#include &lt;linux/netfilter_ipv6/ip6_tables.h&gt;
DECL|macro|MANGLE_VALID_HOOKS
mdefine_line|#define MANGLE_VALID_HOOKS ((1 &lt;&lt; NF_IP6_PRE_ROUTING) | (1 &lt;&lt; NF_IP6_LOCAL_OUT))
macro_line|#if 1
DECL|macro|DEBUGP
...
(brace
multiline_comment|/* something which could affect routing has changed */
id|DEBUGP
c_func
(paren
l_string|&quot;ip6table_mangle: we&squot;d need to re-route a packet&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return

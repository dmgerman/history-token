...
(paren
id|KERN_WARNING
l_string|&quot;ip6_queue: fill at %d entries, &quot;
l_string|&quot;dropping packet(s).  Dropped: %d&bslash;n&quot;
comma
id|queue_total
comma
id|queue_dropped
...
l_string|&quot;Netfilter dropped : %u&bslash;n&quot;
comma
id|peer_pid
comma
id|copy_mode

...
c_func
(paren
l_string|&quot;IPv6 packet filter&quot;
)paren
suffix:semicolon
DECL|macro|IPV6_HDR_LEN
mdefine_line|#define IPV6_HDR_LEN&t;(sizeof(struct ipv6hdr))
DECL|macro|IPV6_OPTHDR_LEN
mdefine_line|#define IPV6_OPTHDR_LEN&t;(sizeof(struct ipv6_opt_hdr))
...
id|ptr
suffix:semicolon
multiline_comment|/* Header offset in skb */
id|u_int16_t
id|hdrlen
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* NONE or ESP: there isn&squot;t protocol part */
multiline_comment|/* If we want to count these packets in &squot;-p all&squot;,&n;&t;&t;&t; * we will change the return 0 to 1*/
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Size calculation */
r_if
c_cond
(paren
id|currenthdr
...
id|hdrlen
suffix:semicolon
multiline_comment|/* ptr is too large */
r_if
c_cond
(paren
id|ptr
...
multiline_comment|/* currenthdr contains the protocol header */
id|dprintf
c_func
(paren
l_string|&quot;Packet protocol %hi ?= %s%hi.&bslash;n&quot;
comma
id|currenthdr
comma
id|ip6info-&gt;invflags
...
multiline_comment|/* We need match for the &squot;-p all&squot;, too! */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;tcp_match: cannot skip exthdr. Dropping.&bslash;n&quot;
)paren
suffix:semicolon
op_star
id|hotdrop
...
(brace
multiline_comment|/* cannot be occured */
id|duprintf
c_func
(paren
l_string|&quot;tcp_match: cannot get TCP header. Dropping.&bslash;n&quot;
)paren
suffix:semicolon
op_star
id|hotdrop
...
c_func
(paren
l_string|&quot;udp_match: cannot skip exthdr. Dropping.&bslash;n&quot;
)paren
suffix:semicolon
op_star
id|hotdrop
...
c_func
(paren
l_string|&quot;udp_match: cannot get UDP header. Dropping.&bslash;n&quot;
)paren
suffix:semicolon
op_star
id|hotdrop
...
DECL|function|ip6t_get_targets
r_static
r_int
id|ip6t_get_targets
c_func
...
DECL|function|ip6t_get_matches
r_static
r_int
id|ip6t_get_matches
c_func
...
comma
(brace
l_string|&quot;ip6_tables_targets&quot;
comma
id|ip6t_get_targets
)brace
comma
(brace
l_string|&quot;ip6_tables_matches&quot;
comma
id|ip6t_get_matches
)brace
comma
...
c_func
(paren
l_string|&quot;ip6_tables: (C) 2000-2002 Netfilter core team&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
DECL|variable|ip6t_register_table
id|EXPORT_SYMBOL
c_func
(paren
id|ip6t_register_table
...
suffix:semicolon
DECL|variable|ip6t_unregister_table
id|EXPORT_SYMBOL
c_func
(paren
id|ip6t_unregister_table
...
suffix:semicolon
DECL|variable|ip6t_unregister_match
id|EXPORT_SYMBOL
c_func
(paren
id|ip6t_unregister_match
...
suffix:semicolon
DECL|variable|ip6t_register_target
id|EXPORT_SYMBOL
c_func
(paren
id|ip6t_register_target
...
suffix:semicolon
DECL|variable|ip6t_unregister_target
id|EXPORT_SYMBOL
c_func
(paren
id|ip6t_unregister_target

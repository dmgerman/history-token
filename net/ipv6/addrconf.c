...
(paren
id|KERN_WARNING
l_string|&quot;%s(): cannot allocate memory for statistics; dev=%s.&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|dev-&gt;name
...
suffix:semicolon
multiline_comment|/*&n;&t; * Purge or update corresponding prefix&n;&t; *&n;&t; * 1) we don&squot;t purge prefix here if address was not permanent.&n;&t; *    prefix is managed by its own lifetime.&n;&t; * 2) if there&squot;re no addresses, delete prefix.&n;&t; * 3) if there&squot;re still other permanent address(es),&n;&t; *    corresponding prefix is still permanent.&n;&t; * 4) otherwise, update prefix lifetime to the&n;&t; *    longest valid lifetime among the corresponding&n;&t; *    addresses on the device.&n;&t; *    Note: subsequent RA will update lifetime.&n;&t; *&n;&t; * --yoshfuji&n;&t; */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * The zSeries OSA network cards can be shared among various&n;&t;&t; * OS instances, but the OSA cards have only one MAC address.&n;&t;&t; * This leads to duplicate address conflicts in conjunction&n;&t;&t; * with IPv6 if more than one instance uses the same card.&n;&t;&t; * &n;&t;&t; * The driver for these cards can deliver a unique 16-bit&n;&t;&t; * identifier for each instance sharing the same card.  It is&n;&t;&t; * placed instead of 0xFFFE in the interface identifier.  The&n;&t;&t; * &quot;u&quot; bit of the interface identifier is not inverted in this&n;&t;&t; * case.  Hence the resulting interface identifier has local&n;&t;&t; * scope according to RFC2373.&n;&t;&t; */
r_if
c_cond
(paren
id|dev-&gt;dev_id
...
suffix:semicolon
multiline_comment|/* Step 1.5: remove snmp6 entry */
...
suffix:semicolon
DECL|function|__ipv6_ifa_notify
r_static
r_void
id|__ipv6_ifa_notify
c_func

...
DECL|function|inet6_fill_ipstats
r_static
r_int
id|inet6_fill_ipstats
c_func
(paren
r_struct
id|sk_buff
...
(brace
multiline_comment|/* fill IP mibs system statistics */
id|RTA_PUT
c_func
(paren
id|skb
...
r_else
(brace
multiline_comment|/* fill IP mibs interface statistics */
id|r-&gt;ipstats_ifindex
op_assign
id|idev-&gt;dev-&gt;ifindex
suffix:semicolon
...
DECL|function|inet6_dump_ipstats
r_static
r_int
id|inet6_dump_ipstats
c_func
(paren
r_struct
id|sk_buff

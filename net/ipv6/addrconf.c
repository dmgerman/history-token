...
multiline_comment|/* check for reserved anycast addresses */
r_if
c_cond
(paren
(paren
...
DECL|function|if6_iface_seq_show
r_static
r_inline
r_void
id|if6_iface_seq_show
c_func
(paren
r_struct
id|seq_file

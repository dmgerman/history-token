...
multiline_comment|/* Do forward declarations of static functions.  */
r_static
r_void
...
id|sack
suffix:semicolon
multiline_comment|/* Caution:  gap &lt; 2 * SCTP_TSN_MAP_SIZE&n;&t; * &t;so gap can be negative.&n;&t; *&n;&t; *&t;&t;--xguo&n;&t; */
multiline_comment|/* Count this TSN.  */
r_if
c_cond
(paren
id|gap
...
multiline_comment|/* sctp_do_TSNdup() */
DECL|macro|AP
macro_line|#undef AP
...
(paren
id|__FUNCTION__
l_string|&quot;Sock is busy: timer %d&bslash;n&quot;
comma
id|timeout_type
)paren
suffix:semicolon
...
comma
op_amp
id|asoc-&gt;base.bind_addr.address_list
)paren
suffix:semicolon
)brace

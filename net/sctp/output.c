...
multiline_comment|/* Hey, before Linux changes, here&squot;s what we have to&n;&t; * do to force IP routing to recognize the change of&n;&t; * dest addr.&t;&t;&t;&t;--xguo&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;dst_cache

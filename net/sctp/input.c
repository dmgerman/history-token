...
multiline_comment|/* The free routine for skbuffs that sctp receives */
DECL|function|sctp_rfree
r_static
r_void
id|sctp_rfree
c_func
...
multiline_comment|/* The ownership wrapper routine to do receive buffer accounting */
DECL|function|sctp_rcv_set_owner_r
r_static
r_void
id|sctp_rcv_set_owner_r
c_func
(paren
r_struct
id|sk_buff

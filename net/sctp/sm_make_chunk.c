...
suffix:semicolon
multiline_comment|/* Skip the chunkhdr. */
id|chunk_len
op_sub_assign
r_sizeof
(paren
...
id|length
suffix:semicolon
multiline_comment|/* create an ASCONF_ACK chunk. &n;&t; * Based on the definitions of parameters, we know that the size of&n;&t; * ASCONF_ACK parameters are less than or equal to the twice of ASCONF&n;&t; * paramter.&n;&t; */
id|asconf_ack
op_assign
id|sctp_make_asconf_ack
c_func
...
suffix:semicolon
multiline_comment|/* Unrecognized or unsupported&t;paramter. */
r_if
c_cond
(paren
id|asconf_param_len

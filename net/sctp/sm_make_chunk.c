...
l_int|4
suffix:colon
id|source-&gt;v4.sin_family
op_assign
id|AF_INET
suffix:semicolon
id|source-&gt;v4.sin_port
op_assign
id|ntohs
c_func
(paren
...
c_func
(paren
id|source-&gt;v6.sin6_family
op_assign
id|AF_INET6
suffix:semicolon
id|source-&gt;v6.sin6_port
op_assign
id|ntohs
c_func
(paren
...
r_default
suffix:colon
multiline_comment|/* This is a bogus address type, just bail.  */
r_break
suffix:semicolon
)brace
suffix:semicolon
...
id|chunk
suffix:semicolon
multiline_comment|/* Make sure that the copy does NOT think it is on any lists.  */
id|retval-&gt;next
op_assign
l_int|NULL
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Now we copy the deep structure.  */
id|retval-&gt;skb
op_assign
id|skb_copy
c_func
...
multiline_comment|/* Move the copy headers to point into the new skb.  */
id|offset
op_assign
(paren
(paren
...
c_func
(paren
id|bear_cookie-&gt;peer_init-&gt;chunk_hdr.length
)paren
suffix:semicolon
id|var_size3
op_assign
id|bear_cookie-&gt;raw_addr_list_len
suffix:semicolon
...
l_string|&quot;SCTP_PARAM_UNRECOGNIZED_PARAMETERS&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME:  The entire parameter processing really needs&n;&t;&t; * redesigned.  For now, always return success as doing&n;&t;&t; * otherwise craters the system.&n;&t;&t; */
id|retval
op_assign
l_int|1
suffix:semicolon

...
multiline_comment|/* Make an ABORT chunk with a PROTOCOL VIOLATION cause code. */
DECL|function|sctp_make_abort_violation
r_struct
id|sctp_chunk
op_star
id|sctp_make_abort_violation
c_func
(paren
r_const
r_struct
...
id|no_hmac
suffix:colon
multiline_comment|/* IG Section 2.35.2:&n;&t; *  3) Compare the port numbers and the verification tag contained&n;&t; *     within the COOKIE ECHO chunk to the actual port numbers and the&n;&t; *     verification tag within the SCTP common header of the received&n;&t; *     packet. If these values do not match the packet MUST be silently&n;&t; *     discarded,&n;&t; */
r_if
c_cond
(paren
id|ntohl
...
op_ne
id|bear_cookie-&gt;peer_addr.v4.sin_port
op_logical_or
id|ntohs
c_func
(paren
...
DECL|function|sctp_process_inv_paramlength
r_static
r_int
id|sctp_process_inv_paramlength
c_func
(paren
r_const
r_struct
...
op_assign
l_string|&quot;The following parameter had invalid length:&quot;
suffix:semicolon
r_int
id|payload_len
op_assign
...
suffix:semicolon
multiline_comment|/* Create an error chunk and fill it in with our payload. */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* There is a possibility that a parameter length was bad and&n;&t; * in that case we would have stoped walking the parameters.&n;&t; * The current param.p would point at the bad one.&n;&t; * Current consensus on the mailing list is to generate a PROTOCOL&n;&t; * VIOLATION error.  We build the ERROR chunk here and let the normal&n;&t; * error handling code build and send the packet.&n;&t; */
r_if
c_cond
(paren
id|param.v

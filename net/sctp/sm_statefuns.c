...
multiline_comment|/*&n; * ADDIP Section 4.2 Upon reception of an ASCONF Chunk&n; * When an endpoint receive an ASCONF Chunk from the remote peer&n; * special procedures MAY be needed to identify the association the&n; * ASCONF Chunk is associated with. To properly find the association&n; * the following procedures should be L1 to L4 and C1 to C5&n; */
...
(brace
singleline_comment|// FIXME: Handle the ASCONF chunk
r_return
id|SCTP_DISPOSITION_CONSUME
suffix:semicolon
)brace

...
multiline_comment|/*&n; * ADDIP Section 4.1 ASCONF CHunk Procedures&n; * If the T-4 RTO timer expires the endpoint should do B1 to B5&n; */
...
(brace
singleline_comment|// FIXME: need to handle t4 expire
r_return
id|SCTP_DISPOSITION_CONSUME
suffix:semicolon
)brace

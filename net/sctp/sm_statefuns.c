...
(brace
multiline_comment|/* Make an ABORT. The T bit will be set if the asoc&n;&t;&t; * is NULL.&n;         &t; */
m_abort
op_assign
id|sctp_make_abort
c_func
...
(brace
multiline_comment|/* Make an ABORT.&n;         &t; * The T bit will be set if the asoc is NULL.&n;         &t; */
m_abort
op_assign
id|sctp_make_abort
c_func

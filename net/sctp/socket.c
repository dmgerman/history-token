...
l_int|NULL
suffix:semicolon
multiline_comment|/* If this is not a UDP-style socket, assoc id should be&n;&t; * ignored.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* A closed association can still be in the list if it&n;&t;&t; * belongs to a TCP-style listening socket that is not&n;&t;&t; * yet accepted.&n;&t;&t; */
r_if
c_cond
(paren
id|sctp_style
...
op_assign
id|asoc-&gt;defaults.context
suffix:semicolon
id|default_sinfo.sinfo_timetolive
op_assign
id|asoc-&gt;defaults.timetolive
suffix:semicolon
...
multiline_comment|/* This flag, in the UDP model, requests the SCTP stack to&n;&t; * override the primary destination address with the&n;&t; * address found with the sendto/sendmsg call.&n;&t; */
r_if
c_cond
(paren
id|sinfo_flags
...
multiline_comment|/*&n; * 7.1.15 Set default send parameters (SET_DEFAULT_SEND_PARAM)&n; *&n; *   Applications that wish to use the sendto() system call may wish to&n; *   specify a default set of parameters that would normally be supplied&n; *   through the inclusion of ancillary data.  This socket option allows&n; *   such an application to set the default sctp_sndrcvinfo structure.&n; *   The application that wishes to use this socket option simply passes&n; *   in to this call the sctp_sndrcvinfo structure defined in Section&n; *   5.2.2) The input parameters accepted by this call include&n; *   sinfo_stream, sinfo_flags, sinfo_ppid, sinfo_context,&n; *   sinfo_timetolive.  The user must provide the sinfo_assoc_id field in&n; *   to this call if the caller is using the UDP model.&n; */
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Find the requested address. */
id|addr
op_assign
(paren
r_union
...
multiline_comment|/*&n; *&n; * 7.1.15 Set default send parameters (SET_DEFAULT_SEND_PARAM)&n; *&n; *   Applications that wish to use the sendto() system call may wish to&n; *   specify a default set of parameters that would normally be supplied&n; *   through the inclusion of ancillary data.  This socket option allows&n; *   such an application to set the default sctp_sndrcvinfo structure.&n; *   The application that wishes to use this socket option simply passes&n; *   in to this call the sctp_sndrcvinfo structure defined in Section&n; *   5.2.2) The input parameters accepted by this call include&n; *   sinfo_stream, sinfo_flags, sinfo_ppid, sinfo_context,&n; *   sinfo_timetolive.  The user must provide the sinfo_assoc_id field in&n; *   to this call if the caller is using the UDP model.&n; *&n; *   For getsockopt, it get the default sctp_sndrcvinfo structure.&n; */

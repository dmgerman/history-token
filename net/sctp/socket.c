...
c_func
(paren
l_string|&quot;sctp_do_bind(sk: %p, newaddr: %p, addr_len: %d)&bslash;n&quot;
comma
id|sk
comma
id|newaddr
...
suffix:semicolon
multiline_comment|/* FIXME: This function needs to handle v4-mapped-on-v6&n;&t; * addresses!&n;&t; */
r_if
c_cond
(paren
id|PF_INET
...
c_func
(paren
multiline_comment|/* FIXME: Hui, please verify this.   Looking at&n;&t;&t;&t; * the ipv6 code I see a SIN6_LEN_RFC2133 check.&n;&t;&t;&t; * I&squot;m guessing that scope_id is a newer addition.&n;&t;&t;&t; */
r_if
(paren
id|addr_len
OL
...
(paren
op_amp
id|newaddr-&gt;v6.sin6_addr
)paren
suffix:semicolon
id|tmpaddr.v6.sin6_port
op_assign
id|htons
c_func
(paren
...
id|copied
suffix:semicolon
multiline_comment|/* FIXME: We need to support MSG_EOR correctly. */
id|msg-&gt;msg_flags
op_or_assign
id|MSG_EOR
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME: Currently we support only non-blocking connect().&n;&t; * To support blocking connect(), we need to wait for the association&n;&t; * to be ESTABLISHED before returning.&n;&t; */
id|err
op_assign
op_minus
id|EINPROGRESS
...
id|PF_INET
suffix:colon
id|autoaddr.v4.sin_family
op_assign
id|AF_INET
suffix:semicolon
id|autoaddr.v4.sin_addr.s_addr
op_assign
id|INADDR_ANY
suffix:semicolon
id|autoaddr.v4.sin_port
op_assign
id|htons
c_func
(paren
...
c_func
(paren
multiline_comment|/* FIXME: Write me for v6!  */
id|BUG
c_func
(paren
)paren
suffix:semicolon
id|autoaddr.v6.sin6_family
op_assign
id|AF_INET6
suffix:semicolon
id|autoaddr.v6.sin6_port
op_assign
id|htons
c_func
(paren
...
id|AF_INET
suffix:colon
id|saveaddr-&gt;v4.sin_addr.s_addr
op_assign
id|inet-&gt;rcv_saddr
suffix:semicolon
id|inet-&gt;rcv_saddr
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Do we support this address family in general? */
id|af
op_assign
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Verify the minimum for this AF sockaddr. */
r_if
c_cond
(paren
id|len

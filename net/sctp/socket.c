...
suffix:semicolon
multiline_comment|/* If the endpoint is bound to 0.0.0.0 or ::0, count the valid&n;&t; * addresses from the global local address list.&n;&t; */
r_if
c_cond
(paren
id|sctp_list_single_entry
...
multiline_comment|/* Helper function that copies local addresses to user and returns the number&n; * of addresses copied.&n; */
DECL|function|sctp_copy_laddrs_to_user
r_static
r_int
id|sctp_copy_laddrs_to_user
c_func
(paren
r_struct
id|sock
...
suffix:semicolon
multiline_comment|/* If the endpoint is bound to 0.0.0.0 or ::0, get the valid&n;&t; * addresses from the global local address list.&n;&t; */
r_if
c_cond
(paren
id|sctp_list_single_entry

multiline_comment|/* SCTP kernel reference Implementation&n; * Copyright (c) 1999-2000 Cisco, Inc.&n; * Copyright (c) 1999-2001 Motorola, Inc.&n; * Copyright (c) 2002 International Business Machines, Corp.&n; * &n; * This file is part of the SCTP kernel reference Implementation&n; * &n; * $Header: /cvsroot/lksctp/lksctp/sctp_cvs/net/sctp/sctp_inqueue.c,v 1.10 2002/05/20 22:05:54 jgrimm Exp $&n; * &n; * These functions are the methods for accessing the SCTP inqueue.&n; *&n; * An SCTP inqueue is a queue into which you push SCTP packets&n; * (which might be bundles or fragments of chunks) and out of which you&n; * pop SCTP whole chunks.&n; * &n; * The SCTP reference implementation is free software; &n; * you can redistribute it and/or modify it under the terms of &n; * the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; * &n; * The SCTP reference implementation is distributed in the hope that it &n; * will be useful, but WITHOUT ANY WARRANTY; without even the implied&n; *                 ************************&n; * warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.&n; * See the GNU General Public License for more details.&n; * &n; * You should have received a copy of the GNU General Public License&n; * along with GNU CC; see the file COPYING.  If not, write to&n; * the Free Software Foundation, 59 Temple Place - Suite 330,&n; * Boston, MA 02111-1307, USA.  &n; * &n; * Please send any bug reports or fixes you make to the&n; * email address(es):&n; *    lksctp developers &lt;lksctp-developers@lists.sourceforge.net&gt;&n; * &n; * Or submit a bug report through the following website:&n; *    http://www.sf.net/projects/lksctp&n; *&n; * Written or modified by: &n; *    La Monte H.P. Yarroll &lt;piggy@acm.org&gt;&n; *    Karl Knutson &lt;karl@athena.chicago.il.us&gt;&n; * &n; * Any bugs reported given to us we will try to fix... any fixes shared will&n; * be incorporated into the next SCTP release.&n; */
...
op_assign
l_string|&quot;$Id: sctp_inqueue.c,v 1.10 2002/05/20 22:05:54 jgrimm Exp $&quot;
suffix:semicolon
...
(paren
op_amp
id|queue-&gt;immediate.list
)paren
suffix:semicolon
id|queue-&gt;immediate.sync
op_assign
l_int|0
suffix:semicolon
id|queue-&gt;immediate.routine
op_assign
l_int|NULL
suffix:semicolon
id|queue-&gt;immediate.data
op_assign
l_int|NULL
suffix:semicolon
id|queue-&gt;malloced

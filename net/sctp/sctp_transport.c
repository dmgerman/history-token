...
(paren
id|__FUNCTION__
l_string|&quot;: transport: %p, rtt: %d, srtt: %d &quot;
...
(paren
id|__FUNCTION__
l_string|&quot;: SLOW START: transport: %p, &quot;
...
(paren
id|__FUNCTION__
l_string|&quot;: transport: %p reason: %d cwnd: &quot;

...
multiline_comment|/* Assert:  Either already in partial delivery mode or partial&n;&t; * delivery wasn&squot;t possible, so now the only recourse is&n;&t; * to renege.  FIXME: Add renege support starts here.&n;&t; */
)brace

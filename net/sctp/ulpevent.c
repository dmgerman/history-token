...
(brace
multiline_comment|/* NOTE:  skb_shinfos are recursive. */
id|sctp_rcvmsg_rfree
c_func
(paren
id|frag
...
multiline_comment|/* Free a ulpevent that has an owner.  See comments in&n; * sctp_stub_rfree().&n; */
DECL|function|sctp_ulpevent_kfree_skb
r_void

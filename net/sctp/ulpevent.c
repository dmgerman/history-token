...
(brace
multiline_comment|/* Note: Not clearing the entire event struct as&n;&t;&t; * this is just a fragment of the real event.  However,&n;&t;&t; * we still need to do rwnd accounting. &n;&t;&t; */
id|sctp_ulpevent_set_owner_r
c_func
(paren
id|list

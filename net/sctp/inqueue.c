...
suffix:semicolon
multiline_comment|/* In the unlikely case of an IP reassembly, the skb could be&n;&t; * non-linear. If so, update chunk_end so that it doesn&squot;t go past&n;&t; * the skb-&gt;tail.&n;&t; */
r_if
c_cond
(paren
id|unlikely
...
(brace
multiline_comment|/* RFC 2960, Section 6.10  Bundling&n;&t;&t; *&n;&t;&t; * Partial chunks MUST NOT be placed in an SCTP packet.&n;&t;&t; * If the receiver detects a partial chunk, it MUST drop&n;&t;&t; * the chunk.  &n;&t;&t; *&n;&t;&t; * Since the end of the chunk is past the end of our buffer&n;&t;&t; * (which contains the whole packet, we can freely discard&n;&t;&t; * the whole packet.&n;&t;&t; */
id|sctp_chunk_free
c_func
(paren
id|chunk

...
DECL|function|sctp_v4_cmp_saddr
r_int
id|sctp_v4_cmp_saddr
c_func
(paren
r_struct
id|dst_entry
...
multiline_comment|/* Checking the loopback, private and other address scopes as defined in&n; * RFC 1918.   The IPv4 scoping is based on the draft for SCTP IPv4&n; * scoping &lt;draft-stewart-tsvwg-sctp-ipv4-00.txt&gt;.&n; */
...
multiline_comment|/* Set the PF specific function table.  */
DECL|function|sctp_set_pf_specific
r_void

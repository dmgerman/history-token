...
id|asoc-&gt;peer.port
comma
l_string|&quot;:Invalid port&bslash;n&quot;
comma
r_return
l_int|NULL
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;WARNING, bogus socket address family %d&bslash;n&quot;
comma
id|ss1-&gt;sa.sa_family
)paren
suffix:semicolon

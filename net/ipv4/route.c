...
macro_line|#endif
DECL|macro|RT_FL_TOS
mdefine_line|#define RT_FL_TOS(oldflp) &bslash;&n;    ((u32)(oldflp-&gt;fl4_tos &amp; (IPTOS_RT_MASK | RTO_ONLINK)))
...
l_int|256
suffix:semicolon
DECL|variable|ip_rt_secret_interval
r_static
r_int
id|ip_rt_secret_interval
op_assign
l_int|10
op_star
l_int|60
...
id|rt_hash_log
suffix:semicolon
DECL|variable|rt_hash_rnd
r_static
r_int
r_int
id|rt_hash_rnd
suffix:semicolon
DECL|variable|rt_cache_stat
r_struct
id|rt_cache_stat
op_star
id|rt_cache_stat
...
DECL|struct|rt_cache_iter_state
r_struct
id|rt_cache_iter_state
(brace
DECL|member|bucket
r_int
id|bucket
...
suffix:semicolon
DECL|function|rt_cache_get_first
r_static
r_struct
id|rtable
op_star
id|rt_cache_get_first
c_func
(paren
r_struct
id|seq_file
...
DECL|function|rt_cache_get_next
r_static
r_struct
id|rtable
op_star
id|rt_cache_get_next
c_func
(paren
r_struct
id|seq_file
...
DECL|function|rt_cache_get_idx
r_static
r_struct
id|rtable
op_star
...
DECL|function|rt_cache_seq_start
r_static
r_void
op_star
id|rt_cache_seq_start
c_func
(paren
r_struct
id|seq_file
...
DECL|function|rt_cache_seq_next
r_static
r_void
op_star
id|rt_cache_seq_next
c_func
(paren
r_struct
id|seq_file
...
DECL|function|rt_cache_seq_stop
r_static
r_void
id|rt_cache_seq_stop
c_func
(paren
r_struct
id|seq_file
...
DECL|function|rt_cache_seq_show
r_static
r_int
id|rt_cache_seq_show
c_func
(paren
r_struct
id|seq_file
...
comma
l_string|&quot;Iface&bslash;tDestination&bslash;tGateway &bslash;tFlags&bslash;t&bslash;tRefCnt&bslash;tUse&bslash;t&quot;
l_string|&quot;Metric&bslash;tSource&bslash;t&bslash;tMTU&bslash;tWindow&bslash;tIRTT&bslash;tTOS&bslash;tHHRef&bslash;t&quot;
l_string|&quot;HHUptod&bslash;tSpecDst&quot;
)paren
suffix:semicolon
r_else
(brace
...
id|temp
comma
l_string|&quot;%s&bslash;t%08lX&bslash;t%08lX&bslash;t%8X&bslash;t%d&bslash;t%u&bslash;t%d&bslash;t&quot;
l_string|&quot;%08lX&bslash;t%d&bslash;t%u&bslash;t%u&bslash;t%02X&bslash;t%d&bslash;t%1d&bslash;t%08X&quot;
comma
id|r-&gt;u.dst.dev
ques
c_cond
...
DECL|variable|rt_cache_seq_ops
r_static
r_struct
id|seq_operations
id|rt_cache_seq_ops
...
suffix:semicolon
DECL|function|rt_cache_seq_open
r_static
r_int
...
DECL|variable|rt_cache_seq_fops
r_static
r_struct
id|file_operations
id|rt_cache_seq_fops
op_assign
(brace
dot
id|owner
...
suffix:semicolon
DECL|function|rt_cpu_seq_start
r_static
r_void
op_star
id|rt_cpu_seq_start
...
id|st-&gt;in_brd
comma
id|st-&gt;in_martian_dst
comma
id|st-&gt;in_martian_src
comma
id|st-&gt;out_hit
comma
id|st-&gt;out_slow_tot
...
id|st-&gt;gc_goal_miss
comma
id|st-&gt;gc_dst_overflow
comma
id|st-&gt;in_hlist_search
comma
id|st-&gt;out_hlist_search
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* Bits of score are:&n; * 31: very valuable&n; * 30: not quite useless&n; * 29..0: usage counter&n; */
DECL|function|rt_score
r_static
r_inline
id|u32
id|rt_score
...
DECL|function|rt_remove_balanced_route
r_static
r_struct
id|rtable
op_star
op_star
id|rt_remove_balanced_route
c_func
(paren
r_struct
id|rtable
...
multiline_comment|/* Cleanup aged off entries. */
macro_line|#ifdef CONFIG_IP_ROUTE_MULTIPATH_CACHED
...
id|ip_rt_min_delay
suffix:semicolon
multiline_comment|/* flush existing multipath state*/
id|multipath_flush
c_func
(paren
)paren
...
DECL|function|rt_secret_rebuild
r_static
r_void
...
(brace
multiline_comment|/* ip_rt_gc_elasticity used to be average length of chain&n;&t;&t; * length, when exceeded gc becomes really aggressive.&n;&t;&t; *&n;&t;&t; * The second limit is less certain. At the moment it allows&n;&t;&t; * only 2 entries per bucket. We will see.&n;&t;&t; */
r_if
c_cond
(paren
id|chain_length
...
multiline_comment|/* Copy all the information. */
op_star
id|rt
op_assign
op_star
...
(paren
id|KERN_INFO
l_string|&quot;Redirect from %u.%u.%u.%u on %s about &quot;
l_string|&quot;%u.%u.%u.%u ignored.&bslash;n&quot;
l_string|&quot;  Advised path = %u.%u.%u.%u -&gt; %u.%u.%u.%u, &quot;
l_string|&quot;tos %02x&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;ip_rt_advice: redirect to &quot;
l_string|&quot;%u.%u.%u.%u/%02x dropped&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;host %u.%u.%u.%u/if%d ignores &quot;
l_string|&quot;redirects for %u.%u.%u.%u to %u.%u.%u.%u.&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
DECL|function|ip_handle_martian_source
r_static
r_void
id|ip_handle_martian_source
c_func
(paren
r_struct
id|net_device
...
(paren
id|KERN_WARNING
l_string|&quot;martian source %u.%u.%u.%u from &quot;
l_string|&quot;%u.%u.%u.%u, on dev %s&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
id|itag
suffix:semicolon
multiline_comment|/* get a working reference to the output device */
id|out_dev
op_assign
id|in_dev_get
c_func
...
(paren
id|KERN_CRIT
l_string|&quot;Bug in ip_route_input&quot;
"&bslash;"
l_string|&quot;_slow(). Please, report&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|cleanup
suffix:colon
multiline_comment|/* release the working reference to the output device */
id|in_dev_put
c_func
(paren
id|out_dev
...
DECL|function|ip_mkroute_input_def
r_static
r_inline
r_int
...
suffix:semicolon
multiline_comment|/* put it into the cache */
id|hash
op_assign
id|rt_hash_code
c_func
...
DECL|function|ip_mkroute_input
r_static
r_inline
r_int
id|ip_mkroute_input
...
l_int|1
suffix:semicolon
multiline_comment|/* distinguish between multipath and singlepath */
r_if
c_cond
(paren
id|hopcount
...
l_int|0
suffix:semicolon
multiline_comment|/* IP on this device is disabled. */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_WARNING
l_string|&quot;martian destination %u.%u.%u.%u from &quot;
l_string|&quot;%u.%u.%u.%u, dev %s&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
DECL|function|__mkroute_output
r_static
r_inline
r_int
id|__mkroute_output
...
id|RTCF_LOCAL
suffix:semicolon
multiline_comment|/* get work reference to inet device */
id|in_dev
op_assign
id|in_dev_get
c_func
...
id|dev_out-&gt;ifindex
suffix:semicolon
multiline_comment|/* get references to the devices that are to be hold by the routing &n;&t;   cache entry */
id|rth-&gt;u.dst.dev
op_assign
id|dev_out
suffix:semicolon
...
id|cleanup
suffix:colon
multiline_comment|/* release work reference to inet device */
id|in_dev_put
c_func
(paren
id|in_dev
...
DECL|function|ip_mkroute_output_def
r_static
r_inline
r_int
id|ip_mkroute_output_def
c_func
(paren
r_struct
id|rtable
...
DECL|function|ip_mkroute_output
r_static
r_inline
r_int
id|ip_mkroute_output
c_func
(paren
r_struct
id|rtable
...
id|hop
suffix:semicolon
multiline_comment|/* hold a work reference to the output device */
id|dev2nexthop
op_assign
id|FIB_RES_DEV
c_func
...
id|cleanup
suffix:colon
multiline_comment|/* release work reference to output device */
id|dev_put
c_func
(paren
id|dev2nexthop
...
DECL|function|__ip_route_output_key
r_int
...
DECL|function|ip_route_output_flow
r_int
...
comma
(brace
multiline_comment|/*  Deprecated. Use gc_min_interval_ms */
dot
id|ctl_name
op_assign
...
id|buffer
suffix:semicolon
multiline_comment|/* Copy first cpu. */
op_star
id|start
op_assign
id|buffer
...
suffix:semicolon
multiline_comment|/* Add the other cpus in, one int at a time */
id|for_each_cpu
c_func
(paren
id|i
...
id|rhash_entries
suffix:semicolon
DECL|function|set_rhash_entries
r_static
r_int
id|__init
id|set_rhash_entries
c_func
(paren
r_char
op_star

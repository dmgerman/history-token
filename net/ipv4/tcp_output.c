...
multiline_comment|/* &n; * Do all connect socket setups that can be done AF independent.&n; * Could be inlined.&n; */
...
DECL|function|tcp_connect_send
r_void
id|tcp_connect_send
c_func
(paren

...
suffix:semicolon
multiline_comment|/* Always keep large mss multiple of real mss, but&n;&t;&t; * do not exceed 1/4 of the congestion window so we&n;&t;&t; * can keep the ACK clock ticking.&n;&t;&t; */
id|factor
op_assign
id|large_mss
op_div

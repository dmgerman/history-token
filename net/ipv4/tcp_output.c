...
suffix:semicolon
multiline_comment|/* Always keep large mss multiple of real mss, but&n;&t;&t; * do not exceed congestion window.&n;&t;&t; */
id|factor
op_assign
id|large_mss
op_div
...
id|EAGAIN
suffix:semicolon
multiline_comment|/* What is going on here?  When TSO packets are partially ACK&squot;d,&n;&t; * we adjust the TCP_SKB_CB(skb)-&gt;seq value forward but we do&n;&t; * not adjust the data area of the SKB.  We defer that to here&n;&t; * so that we can avoid the work unless we really retransmit&n;&t; * the packet.&n;&t; */
id|data_seq
op_assign
id|TCP_SKB_CB
c_func

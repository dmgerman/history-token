...
multiline_comment|/* numsrc &gt;= (1G-4) overflow in 32 bits */
r_if
c_cond
(paren
id|msf-&gt;imsf_numsrc
...
l_int|0
suffix:semicolon
multiline_comment|/* use index for mc_source */
r_if
c_cond
(paren
id|optname
...
r_else
multiline_comment|/* MCAST_LEAVE_SOURCE_GROUP */
(brace
id|omode
op_assign
id|MCAST_INCLUDE
...
multiline_comment|/* numsrc &gt;= (4G-140)/128 overflow in 32 bits */
r_if
c_cond
(paren
id|gsf-&gt;gf_numsrc

...
DECL|function|inet_rcu_free_ifa
r_static
r_void
id|inet_rcu_free_ifa
c_func
(paren
r_struct
id|rcu_head
...
l_int|1
suffix:semicolon
multiline_comment|/* Something else, probably a multicast. */
r_if
c_cond
(paren
id|ZERONET
...
suffix:colon
multiline_comment|/* Set the netmask for the interface */
multiline_comment|/*&n;&t;&t; *&t;The mask we set must be legal.&n;&t;&t; */
id|ret
op_assign
op_minus
id|EINVAL
...
suffix:semicolon
multiline_comment|/* See if current broadcast address matches&n;&t;&t;&t; * with current netmask, then recalculate&n;&t;&t;&t; * the broadcast address. Otherwise it&squot;s a&n;&t;&t;&t; * funny address, so don&squot;t touch it since&n;&t;&t;&t; * the user seems to know what (s)he&squot;s doing...&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
DECL|function|confirm_addr_indev
r_static
id|u32
id|confirm_addr_indev
c_func
(paren
r_struct
id|in_device
...
r_break
suffix:semicolon
multiline_comment|/* Is the selected addr into dst subnet? */
r_if
c_cond
(paren
id|inet_ifa_match
...
r_break
suffix:semicolon
multiline_comment|/* No, then can we use new local src? */
r_if
c_cond
(paren
id|ifa-&gt;ifa_scope
...
multiline_comment|/* search for large dst subnet for addr */
id|same
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n; * Confirm that local IP address exists using wildcards:&n; * - dev: only on this interface, 0=any interface&n; * - dst: only in the same subnet as dst, 0=any dst&n; * - local: address, 0=autoselect the local address&n; * - scope: maximum allowed scope value for the local address&n; */
DECL|function|inet_confirm_addr
id|u32
...
multiline_comment|/* Rename ifa_labels for a device name change. Make some effort to preserve existing&n; * alias numbering and to create unique labels if possible.&n;*/
DECL|function|inetdev_changename
r_static
r_void
id|inetdev_changename
c_func
(paren
r_struct
id|net_device
...
c_func
(paren
l_string|&quot;devinet: Failed to create loopback&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:colon
multiline_comment|/* Do not notify about label change, this event is&n;&t;&t; * not interesting to applications using netlink.&n;&t;&t; */
id|inetdev_changename
c_func
(paren
id|dev
...
id|procname
op_assign
l_string|&quot;arp_announce&quot;
comma
dot
id|data
op_assign
op_amp
id|ipv4_devconf.arp_announce
comma
dot
id|maxlen
op_assign
...
id|procname
op_assign
l_string|&quot;disable_xfrm&quot;
comma
dot
id|data
op_assign
op_amp
id|ipv4_devconf.no_xfrm
comma
dot
id|maxlen
op_assign
...
id|procname
op_assign
l_string|&quot;disable_policy&quot;
comma
dot
id|data
op_assign
op_amp
id|ipv4_devconf.no_policy
comma
dot
id|maxlen
op_assign
...
id|procname
op_assign
l_string|&quot;force_igmp_version&quot;
comma
dot
id|data
op_assign
op_amp
id|ipv4_devconf.force_igmp_version
comma
dot
id|maxlen
op_assign

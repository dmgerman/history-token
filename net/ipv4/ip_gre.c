...
suffix:semicolon
multiline_comment|/* WCCP version 1 and 2 protocol decoding.&n;&t;&t; * - Change protocol to IP&n;&t;&t; * - When dealing with WCCPv2, Skip extra 4 bytes in GRE header&n;&t;&t; */
r_if
c_cond
(paren
id|flags
...
macro_line|#endif
DECL|function|ipgre_tunnel_setup
r_static
r_void
id|ipgre_tunnel_setup
c_func

...
id|icmp_control
(brace
DECL|member|output_off
r_int
id|output_off
suffix:semicolon
multiline_comment|/* Field offset for increment on output */
DECL|member|input_off
r_int
id|input_off
suffix:semicolon
multiline_comment|/* Field offset for increment on input */
DECL|member|handler
r_void
(paren
op_star

...
id|bhead
suffix:semicolon
multiline_comment|/* Step 1: Put TW into bind hash. Original socket stays there too.&n;&t;   Note, that any socket with inet_sk(sk)-&gt;num != 0 MUST be bound in&n;&t;   binding cache, even if it is closed.&n;&t; */
id|bhead
op_assign
op_amp
id|tcp_bhash
...
suffix:semicolon
multiline_comment|/* Step 2: Remove SK from established hash. */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* Step 3: Hash TW into TIMEWAIT half of established hash table. */
id|tw_add_node
c_func
(paren
id|tw
...
DECL|macro|TCP_TWKILL_QUOTA
mdefine_line|#define TCP_TWKILL_QUOTA&t;100
...
suffix:semicolon
DECL|variable|twkill_thread_slots
r_static
id|u32
id|twkill_thread_slots
suffix:semicolon
multiline_comment|/* Returns non-zero if quota exceeded.  */
DECL|function|tcp_do_twkill_work
r_static
r_int
id|tcp_do_twkill_work
c_func
(paren
r_int
id|slot
...
r_else
(brace
multiline_comment|/* We purged the entire slot, anything left?  */
r_if
c_cond
(paren
id|tcp_tw_count
...
r_extern
r_void
id|twkill_slots_invalid
c_func
(paren
r_void
)paren
suffix:semicolon
DECL|function|twkill_work
r_static
r_void
id|twkill_work
c_func
...
(paren
op_amp
id|newsk-&gt;sk_omem_alloc
comma
l_int|0
)paren
suffix:semicolon
id|newsk-&gt;sk_wmem_queued
op_assign
l_int|0
suffix:semicolon
id|newsk-&gt;sk_forward_alloc
op_assign
l_int|0
suffix:semicolon
id|sock_reset_flag
...
suffix:semicolon
id|newsk-&gt;sk_backlog.head
op_assign
id|newsk-&gt;sk_backlog.tail
op_assign
l_int|NULL
suffix:semicolon
...
multiline_comment|/* RFC793 page 36: &quot;If the connection is in any non-synchronized state ...&n;&t; *                  and the incoming segment acknowledges something not yet&n;&t; *                  sent (the segment carries an unaccaptable ACK) ...&n;&t; *                  a reset is sent.&quot;&n;&t; *&n;&t; * Invalid ACK: reset will be sent by listening socket&n;&t; */
r_if
c_cond
(paren
(paren

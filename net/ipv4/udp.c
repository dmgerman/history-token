...
suffix:semicolon
multiline_comment|/*&n; *&t;Copy and checksum a UDP packet from user space into a buffer.&n; */
...
multiline_comment|/*&n; *&t;Copy a UDP packet from user space into a buffer without checksumming.&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/* 0x80000000 is temporary hook for testing new output path */
r_if
c_cond
(paren
id|corkreq
...
multiline_comment|/*&n;&t;&t; *&t;Now cork the socket to pend data.&n;&t;&t; */
id|up-&gt;daddr
op_assign
id|ufh.daddr
suffix:semicolon

...
suffix:semicolon
multiline_comment|/* bring loopback device up first */
r_if
c_cond
(paren
id|dev_change_flags
...
id|drop
suffix:semicolon
multiline_comment|/* Basic sanity checks can be done without the lock.  */
id|rarp
op_assign
(paren
r_struct
...
id|skb-&gt;h.raw
suffix:semicolon
multiline_comment|/* If this test doesn&squot;t pass, it&squot;s not IP, or we should&n;&t; * ignore it anyway.&n;&t; */
r_if
c_cond
(paren
id|rarp-&gt;ar_hln
...
id|drop
suffix:semicolon
multiline_comment|/* OK, it is all there and looks valid, process... */
id|rarp
op_assign
(paren
r_struct
...
id|ext_len
suffix:semicolon
multiline_comment|/* Perform verifications before taking the lock.  */
r_if
c_cond
(paren
id|skb-&gt;pkt_type
...
(paren
id|KERN_ERR
l_string|&quot;DHCP/BOOTP: Ignoring fragmented &quot;
...
id|drop
suffix:semicolon
multiline_comment|/* Ok the front looks good, make sure we can get at the rest.  */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;DHCP/BOOTP: Reply not for us, &quot;
l_string|&quot;op[%x] xid[%x]&bslash;n&quot;
comma
id|b-&gt;op
comma
id|b-&gt;xid

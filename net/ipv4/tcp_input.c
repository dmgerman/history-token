...
DECL|macro|IsReno
mdefine_line|#define IsReno(tp) ((tp)-&gt;rx_opt.sack_ok == 0)
DECL|macro|IsFack
mdefine_line|#define IsFack(tp) ((tp)-&gt;rx_opt.sack_ok &amp; 2)
DECL|macro|IsDSack
mdefine_line|#define IsDSack(tp) ((tp)-&gt;rx_opt.sack_ok &amp; 4)

...
id|scb-&gt;sacked
suffix:semicolon
multiline_comment|/* We adjust scb-&gt;seq but we do not pskb_pull() the&n;&t;&t; * SKB.  We let tcp_retransmit_skb() handle this case&n;&t;&t; * by checking skb-&gt;len against the data sequence span.&n;&t;&t; * This way, we avoid the pskb_pull() work unless we&n;&t;&t; * actually need to retransmit the SKB.&n;&t;&t; */
id|scb-&gt;seq
op_assign
id|seq
suffix:semicolon

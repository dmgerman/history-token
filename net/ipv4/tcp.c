...
DECL|macro|TCP_PAGE
mdefine_line|#define TCP_PAGE(sk)&t;(tcp_sk(sk)-&gt;sndmsg_page)
DECL|macro|TCP_OFF
mdefine_line|#define TCP_OFF(sk)&t;(tcp_sk(sk)-&gt;sndmsg_off)

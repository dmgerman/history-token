...
DECL|macro|TCP_PAGE
mdefine_line|#define TCP_PAGE(sk)&t;(sk-&gt;tp_pinfo.af_tcp.sndmsg_page)
DECL|macro|TCP_OFF
mdefine_line|#define TCP_OFF(sk)&t;(sk-&gt;tp_pinfo.af_tcp.sndmsg_off)
r_static
r_inline
r_int
...
suffix:semicolon
multiline_comment|/* If it has not 0 sk-&gt;num, it must be bound */
id|BUG_TRAP
c_func
(paren
op_logical_neg

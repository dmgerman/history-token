...
DECL|macro|fold_field
mdefine_line|#define fold_field(_mib, _nr)&t;__fold_field(_mib, (sizeof(unsigned long) * (_nr)))
...
op_assign
(brace
DECL|macro|__SNMP_GEN
mdefine_line|#define __SNMP_GEN(x,y)&t;SNMP_ITEM(struct ipstats_mib, x, y)
DECL|macro|SNMP_GEN
mdefine_line|#define SNMP_GEN(x)&t;__SNMP_GEN(x, #x)
id|SNMP_GEN
c_func
(paren
id|InReceives

...
id|fib_info_hash
suffix:semicolon
DECL|variable|fib_info_laddrhash
r_static
r_struct
id|hlist_head
op_star
id|fib_info_laddrhash
suffix:semicolon
DECL|variable|fib_hash_size
r_static
r_int
r_int
id|fib_hash_size
...
DECL|function|fib_devindex_hashfn
r_static
r_inline
r_int
r_int
id|fib_devindex_hashfn
c_func
(paren
r_int
r_int
...
multiline_comment|/* Return the first fib alias matching TOS with&n; * priority less than or equal to PRIO.&n; */
DECL|function|fib_find_alias
r_struct
id|fib_alias
op_star
id|fib_find_alias
...
DECL|function|fib_laddr_hashfn
r_static
r_inline
r_int
r_int

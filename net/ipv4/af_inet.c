...
DECL|variable|tcp_sk_cachep
id|kmem_cache_t
op_star
id|tcp_sk_cachep
suffix:semicolon
DECL|variable|udp_sk_cachep
r_static
id|kmem_cache_t
op_star
id|udp_sk_cachep
suffix:semicolon
DECL|variable|raw4_sk_cachep
r_static
id|kmem_cache_t
op_star
id|raw4_sk_cachep
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* Set all the per cpu copies of the mibs to zero */
r_for
c_loop
(paren
id|i

...
suffix:semicolon
multiline_comment|/* fastreuse state of tb is never changed in connect */
id|spin_unlock
c_func
(paren
op_amp
...
l_int|536
suffix:semicolon
multiline_comment|/* Initialise common fields */
id|tcp_connect_init
c_func
(paren
id|sk

...
suffix:semicolon
multiline_comment|/* TODO. Actually it is not so bad idea to remove&n; &t;&t; * tcp_portalloc_lock before next submission to Linus.&n; &t;&t; * As soon as we touch this place at all it is time to think.&n; &t;&t; *&n; &t;&t; * Now it protects single _advisory_ variable tcp_port_rover,&n; &t;&t; * hence it is mostly useless.&n; &t;&t; * Code will work nicely if we just delete it, but&n; &t;&t; * I am afraid in contented case it will work not better or&n; &t;&t; * even worse: another cpu just will hit the same bucket&n; &t;&t; * and spin there.&n; &t;&t; * So some cpu salt could remove both contention and&n; &t;&t; * memory pingpong. Any ideas how to do this in a nice way?&n; &t;&t; */
id|spin_lock
c_func
(paren
op_amp
...
id|ok
suffix:colon
multiline_comment|/* All locks still held and bhs disabled */
id|tcp_port_rover
op_assign
id|rover
suffix:semicolon
...
suffix:semicolon
DECL|function|listening_get_first
r_static
r_void
op_star
id|listening_get_first
c_func
(paren
r_struct
id|seq_file

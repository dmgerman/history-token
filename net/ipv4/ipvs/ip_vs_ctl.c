...
DECL|struct|ip_vs_sysctl_table
r_struct
id|ip_vs_sysctl_table
(brace
...
id|str
comma
l_string|&quot;  -&gt; %08X:%04X      %-7s %-6d %-10d %-10d&quot;
comma
id|ntohl
c_func
(paren
...
id|q
suffix:semicolon
multiline_comment|/*&n;&t; * Note: since the length of the buffer is usually the multiple&n;&t; * of 512, it is good to use fixed record of the divisor of 512,&n;&t; * so that records won&squot;t be truncated at buffer boundary.&n;&t; */
id|pos
op_assign
l_int|192
suffix:semicolon
...
l_string|&quot;%-63s&bslash;n&quot;
comma
l_string|&quot;Prot LocalAddress:Port Scheduler Flags&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
l_string|&quot;%-63s&bslash;n&quot;
comma
l_string|&quot;  -&gt; RemoteAddress:Port Forward Weight ActiveConn InActConn&quot;
)paren
suffix:semicolon
)brace
id|read_lock_bh
...
suffix:semicolon
multiline_comment|/* print the service table hashed by &lt;protocol,addr,port&gt; */
r_for
c_loop
(paren
id|idx
...
multiline_comment|/* print the service table hashed by fwmark */
r_for
c_loop
(paren
id|idx
...
r_static
r_int
DECL|function|ip_vs_stats_get_info
id|ip_vs_stats_get_info
c_func
(paren
r_char
op_star
...
id|len
comma
l_string|&quot;%-63s&bslash;n%-63s&bslash;n&quot;
comma
multiline_comment|/*                              01234567 01234567 01234567 0123456701234567 0123456701234567 */
l_string|&quot;   Total Incoming Outgoing         Incoming         Outgoing&quot;
comma
l_string|&quot;   Conns  Packets  Packets            Bytes            Bytes&quot;
)paren
suffix:semicolon
id|spin_lock_bh
c_func
...
id|temp
comma
l_string|&quot;%8X %8X %8X %8X%08X %8X%08X&quot;
comma
...
id|len
comma
l_string|&quot;%-62s&bslash;n&bslash;n&quot;
comma
id|temp
)paren
suffix:semicolon
...
comma
multiline_comment|/*                              01234567 01234567 01234567 0123456701234567 0123456701234567 */
l_string|&quot; Conns/s   Pkts/s   Pkts/s          Bytes/s          Bytes/s&quot;
)paren
suffix:semicolon
id|sprintf
c_func
...
suffix:semicolon
id|ipv4_vs_table.sysctl_header
op_assign
id|register_sysctl_table
c_func
(paren
id|ipv4_vs_table.root_dir
comma
l_int|0
)paren
suffix:semicolon

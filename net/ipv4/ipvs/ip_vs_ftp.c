...
(brace
multiline_comment|/* check if there is partial match */
r_if
c_cond
(paren
id|strnicmp
...
r_else
(brace
multiline_comment|/* unexpected character */
r_return
op_minus
l_int|1
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* Linear packets are much easier to deal with. */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Passive mode on */
id|IP_VS_DBG
c_func
(paren
l_int|1
...
suffix:semicolon
multiline_comment|/* Passive mode off */
id|cp-&gt;app_data
op_assign
l_int|NULL
suffix:semicolon

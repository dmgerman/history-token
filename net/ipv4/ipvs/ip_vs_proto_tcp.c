...
id|cp-&gt;dport
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Attempt ip_vs_app call.&n;&t; *&t;It will fix ip_vs_conn and iph ack_seq stuff&n;&t; */
r_if
c_cond
(paren
id|ip_vs_app_pkt_in
...
multiline_comment|/*&n;&t; *&t;Adjust TCP/UDP checksums&n;&t; */
r_if
c_cond
(paren
op_logical_neg

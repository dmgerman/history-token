...
multiline_comment|/*&n; *&t;Output pkt hook. Will call bound ip_vs_app specific function&n; *&t;called by ipvs packet handler, assumes previously checked cp!=NULL&n; *&t;returns (new - old) skb-&gt;len diff.&n; */
...
multiline_comment|/*&n; *&t;Input pkt hook. Will call bound ip_vs_app specific function&n; *&t;called by ipvs packet handler, assumes previously checked cp!=NULL.&n; *&t;returns (new - old) skb-&gt;len diff.&n; */
...
r_static
r_int
DECL|function|ip_vs_app_getinfo
id|ip_vs_app_getinfo
c_func
(paren
r_char
op_star
...
comma
l_string|&quot;prot port    usecnt name&quot;
)paren
suffix:semicolon
)brace
id|down

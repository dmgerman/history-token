...
r_static
r_int
DECL|function|ip_vs_conn_getinfo
id|ip_vs_conn_getinfo
c_func
(paren
r_char
op_star
...
comma
l_string|&quot;Pro FromIP   FPrt ToIP     TPrt DestIP   DPrt State       Expires&quot;
)paren
suffix:semicolon
)brace
r_for
...
(brace
multiline_comment|/*&n;&t;&t; *&t;Lock is actually only need in next loop&n;&t;&t; *&t;we are called from uspace: must stop bh.&n;&t;&t; */
id|ct_read_lock_bh
c_func
(paren
id|idx
...
id|temp
comma
l_string|&quot;%-3s %08X %04X %08X %04X %08X %04X %-11s %7lu&quot;
comma
id|ip_vs_proto_name
c_func
(paren

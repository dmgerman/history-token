...
suffix:semicolon
macro_line|#endif
DECL|variable|check_for_ip_vs_out
id|EXPORT_SYMBOL
c_func
(paren
...
l_int|1
suffix:semicolon
multiline_comment|/* reassemble IP fragments, but will it happen in ICMP packets?? */
r_if
c_cond
(paren
...
id|NF_ACCEPT
suffix:semicolon
multiline_comment|/* We need at least TCP/UDP ports here */
r_if
c_cond
(paren
id|clen
...
id|ciph
comma
l_string|&quot;Handling outgoing ICMP for&quot;
)paren
suffix:semicolon
multiline_comment|/* ciph content is actually &lt;protocol, caddr, cport, daddr, dport&gt; */
id|cp
op_assign
id|pp
op_member_access_from_pointer
...
id|ciph
comma
l_string|&quot;Forwarding correct outgoing ICMP&quot;
)paren
suffix:semicolon
id|skb-&gt;nfcache
op_or_assign
...
multiline_comment|/* make sure that protocol header is available in skb data area,&n;&t;   note that skb data area may be reallocated. */
id|ihl
op_assign
id|iph-&gt;ihl
op_lshift
...
suffix:semicolon
multiline_comment|/*&n;&t; * WARNING: we can work with !firstfrag packets, make sure&n;&t; * each protocol handler checks for firstfrag&n;&t; */
r_if
c_cond
(paren
id|firstfrag
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Notify the real server: there is no existing&n;&t;&t;&t; * entry if it is not RST packet or not TCP packet.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_int
r_int
DECL|function|check_for_ip_vs_out
id|check_for_ip_vs_out
c_func
(paren
r_struct
...
r_else
(brace
multiline_comment|/* send the packet immediately if it is already mangled&n;&t;&t;   by ip_vs_out */
r_if
c_cond
(paren
(paren
...
l_int|12
comma
l_string|&quot;icmp in (%d,%d) %u.%u.%u.%u -&gt; %u.%u.%u.%u&bslash;n&quot;
comma
id|icmph-&gt;type
comma
id|ntohs
...
c_func
(paren
l_string|&quot;incoming ICMP: failed checksum from &quot;
...
id|ciph
comma
l_string|&quot;Handling incoming ICMP for&quot;
)paren
suffix:semicolon
multiline_comment|/* This is pretty much what ip_vs_conn_in_get() does,&n;&t;   except parameters are in the reverse order */
id|cp
op_assign
id|pp
op_member_access_from_pointer
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* Enable this when not in LOCAL_IN */
id|firstfrag
op_assign
op_logical_neg
(paren

...
multiline_comment|/* Very simple timeout pushed back by each packet */
DECL|macro|REDIR_TIMEOUT
mdefine_line|#define REDIR_TIMEOUT (240*HZ)
r_static
id|DECLARE_LOCK
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Must have whole header */
r_if
c_cond
(paren
id|skb-&gt;len

...
suffix:semicolon
DECL|variable|ip_conntrack_amanda
r_struct
id|module
op_star
id|ip_conntrack_amanda
op_assign
id|THIS_MODULE
suffix:semicolon
...
id|NF_ACCEPT
suffix:semicolon
multiline_comment|/* Not whole UDP header? */
r_if
c_cond
(paren
id|udplen
...
c_func
(paren
l_string|&quot;ip_conntrack_amanda_help: udplen = %u&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;ip_ct_talk_help: bad csum: %p %u %u.%u.%u.%u &quot;
...
id|matchlen
suffix:semicolon
multiline_comment|/* this is not really tcp, but let&squot;s steal an&n;&t;&t;&t;&t; * idea from a tcp stream helper :-)&n;&t;&t;&t;&t; */
singleline_comment|// XXX expect.seq = data - datap;
...
id|datap
suffix:semicolon
singleline_comment|// XXX DEBUGP(&quot;expect.seq = %p - %p = %d&bslash;n&quot;, data, datap, expect.seq);
id|DEBUGP
c_func
(paren
...
multiline_comment|/* XXX - how do I get the&n;&t;&t;&t;&t;&t; *       ip_conntrack_expect that&n;&t;&t;&t;&t;&t; *       already exists so that I can&n;&t;&t;&t;&t;&t; *       update the .seq so that the&n;&t;&t;&t;&t;&t; *       nat module rewrites the port&n;&t;&t;&t;&t;&t; *       numbers?&n;&t;&t;&t;&t;&t; *       Perhaps I should use the&n;&t;&t;&t;&t;&t; *       exp_amanda_info instead of&n;&t;&t;&t;&t;&t; *       .seq.&n;&t;&t;&t;&t;&t; */
)brace
id|UNLOCK_BH
c_func
(paren
...
multiline_comment|/* if memcmp(conns) */
)brace
multiline_comment|/* for .. NUM_MSGS */
id|data
op_increment
suffix:semicolon
)brace
multiline_comment|/* while (*data != 0x0a &amp;&amp; data &lt; data_limit) */
r_return
id|NF_ACCEPT
suffix:semicolon
)brace
...
suffix:semicolon
id|amanda_helper.tuple.src.u.udp.port
op_assign
id|htons
c_func
(paren
...
suffix:semicolon
id|amanda_helper.tuple.dst.protonum
op_assign
id|IPPROTO_UDP
suffix:semicolon
id|amanda_helper.mask.src.u.udp.port
op_assign
l_int|0xFFFF
suffix:semicolon
id|amanda_helper.mask.dst.protonum
op_assign
l_int|0xFFFF
suffix:semicolon
id|amanda_helper.max_expected
op_assign
id|NUM_MSGS
suffix:semicolon
id|amanda_helper.timeout
op_assign
l_int|180
suffix:semicolon
id|amanda_helper.flags
op_assign
...
id|ip_conntrack_amanda
suffix:semicolon
id|amanda_helper.help
op_assign
id|help
suffix:semicolon
id|amanda_helper.name
op_assign
l_string|&quot;amanda&quot;
suffix:semicolon
id|DEBUGP

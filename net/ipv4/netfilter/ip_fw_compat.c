...
id|CHECKSUM_NONE
suffix:semicolon
multiline_comment|/* Firewall rules can alter TOS: raw socket (tcpdump) may have&n;           clone of incoming skb: don&squot;t disturb it --RR */
r_if
c_cond
(paren
id|skb_cloned
...
suffix:semicolon
multiline_comment|/* ip_conntrack_confirm return NF_DROP or NF_ACCEPT */
r_if
c_cond
(paren

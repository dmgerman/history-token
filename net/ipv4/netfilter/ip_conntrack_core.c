...
mdefine_line|#define IP_CONNTRACK_VERSION&t;&quot;2.0&quot;
macro_line|#if 0
...
multiline_comment|/* remove one specific expectation from all lists and free it */
...
DECL|function|destroy_expectations
r_static
r_void
id|destroy_expectations
c_func
(paren
r_struct
id|ip_conntrack
...
c_func
(paren
l_string|&quot;destroy_expectations(%p)&bslash;n&quot;
comma
id|ct
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;destroy_expectations: skipping established %p of %p&bslash;n&quot;
comma
id|exp-&gt;sibling
comma
id|ct
...
c_cond
(paren
id|exp-&gt;expectant-&gt;helper-&gt;timeout
op_logical_and
op_logical_neg
id|del_timer
c_func
...
c_func
(paren
l_string|&quot;destroy_expectations: skipping dying expectation %p of %p&bslash;n&quot;
comma
id|exp
comma
id|ct
...
suffix:semicolon
multiline_comment|/* Remove from both hash lists: must not NULL out next ptrs,&n;           otherwise we&squot;ll look unconfirmed.  Fortunately, LIST_DELETE&n;           doesn&squot;t do this. --RR */
id|LIST_DELETE
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Delete our master expectation from the local list&n;&t; * and destroy it, if we&squot;ve been expected */
r_if
c_cond
(paren
id|ct-&gt;master
...
(brace
multiline_comment|/* Refresh timer, if possible... */
r_if
c_cond
(paren
id|del_timer
...
multiline_comment|/* ... otherwise expectation is dying. Fall over and create a new one. */
r_new
op_assign
l_int|NULL
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;ip_conntrack: max number of expected connections %i of %s reached for %u.%u.%u.%u-&gt;%u.%u.%u.%u%s&bslash;n&quot;
comma
id|related_to-&gt;helper-&gt;max_expected
comma
...
id|cur_item
suffix:semicolon
multiline_comment|/* Let&squot;s choose the the oldest expectation to overwrite */
id|list_for_each
c_func
(paren
id|cur_item
...
(brace
multiline_comment|/* Expectation is dying. Fall over and create a new one */
r_new
op_assign
l_int|NULL
suffix:semicolon
...
c_func
(paren
l_string|&quot;expect_relaed: OOM allocating expect&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

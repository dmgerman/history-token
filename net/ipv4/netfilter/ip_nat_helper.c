...
id|tuple.dst.ip
suffix:semicolon
multiline_comment|/* hook doesn&squot;t matter, but it has to do source manip */
...
suffix:semicolon
multiline_comment|/* For DST manip, map port here to where it&squot;s expected. */
id|range.flags
op_assign
(paren
id|IP_NAT_RANGE_MAP_IPS
...
id|tuple.src.ip
suffix:semicolon
multiline_comment|/* hook doesn&squot;t matter, but it has to do destination manip */
id|ip_nat_setup_info
c_func
(paren
id|ct

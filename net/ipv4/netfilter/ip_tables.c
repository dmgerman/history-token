...
mdefine_line|#define ASSERT_WRITE_LOCK(x) IP_NF_ASSERT(down_trylock(&amp;ipt_mutex) != 0)
...
suffix:semicolon
DECL|macro|FWINV
mdefine_line|#define FWINV(bool,invflg) ((bool) ^ !!(ipinfo-&gt;invflags &amp; invflg))
r_if
c_cond
(paren
id|FWINV
...
id|ip-&gt;saddr
op_amp
id|ipinfo-&gt;smsk.s_addr
)paren
op_ne
id|ipinfo-&gt;src.s_addr
comma
id|IPT_INV_SRCIP
)paren
op_logical_or
...
id|ip-&gt;daddr
op_amp
id|ipinfo-&gt;dmsk.s_addr
)paren
op_ne
id|ipinfo-&gt;dst.s_addr
comma
id|IPT_INV_DSTIP
)paren
)paren
...
c_func
(paren
l_string|&quot;DST: %u.%u.%u.%u Mask: %u.%u.%u.%u Target: %u.%u.%u.%u.%s&bslash;n&quot;
comma
id|NIPQUAD
c_func
(paren
...
multiline_comment|/* Check specific protocol */
r_if
c_cond
(paren
id|ipinfo-&gt;proto
...
multiline_comment|/* If we have a fragment rule but the packet is not a fragment&n;&t; * then we return zero */
r_if
c_cond
(paren
id|FWINV
...
c_func
(paren
l_string|&quot;ip_tables: error: `%s&squot;&bslash;n&quot;
comma
(paren
r_char
op_star
...
multiline_comment|/*&n; * These are weird, but module loading must not be done with mutex&n; * held (since they will register), and we have to have a single&n; * function to use try_then_request_module().&n; */
multiline_comment|/* Find table by name, grabs mutex &amp; ref.  Returns ERR_PTR() on error. */
...
multiline_comment|/* Find match, grabs mutex &amp; ref.  Returns ERR_PTR() on error. */
...
suffix:semicolon
multiline_comment|/* Not found at all?  NULL so try_then_request_module loads module. */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Find target, grabs mutex &amp; ref.  Returns ERR_PTR() on error. */
...
multiline_comment|/* Returns true or false (if no such extension at all) */
DECL|function|find_revision
r_static
r_inline
r_int
id|find_revision
...
suffix:semicolon
multiline_comment|/* Nothing at all?  Return 0 to try loading module. */
r_if
c_cond
(paren
id|best
...
c_func
(paren
l_string|&quot;ipt_standard_check: bad verdict (%i)&bslash;n&quot;
comma
id|targ-&gt;verdict
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ipt_standard_check: bad negative verdict (%i)&bslash;n&quot;
comma
id|targ-&gt;verdict
)paren
suffix:semicolon
...
DECL|variable|ipt_standard_target
r_static
r_struct
id|ipt_target
id|ipt_standard_target
...
multiline_comment|/* FIXME: underflows must be unconditional, standard verdicts&n;           &lt; 0 (not IPT_RETURN). --RR */
...
c_func
(paren
l_string|&quot;do_ipt_set_ctl:  unknown request %i&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
r_case
id|IPT_SO_GET_REVISION_MATCH
suffix:colon
r_case
id|IPT_SO_GET_REVISION_TARGET
suffix:colon
(brace
r_struct
id|ipt_get_revision
...
c_func
(paren
l_string|&quot;do_ipt_get_ctl: unknown request %i&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
r_int
DECL|function|ipt_register_target
...
r_void
DECL|function|ipt_unregister_target
...
r_int
DECL|function|ipt_register_match
...
r_void
DECL|function|ipt_unregister_match
...
DECL|function|ipt_register_table
r_int
...
DECL|function|ipt_unregister_table
r_void
...
(brace
multiline_comment|/* To quote Alan:&n;&n;&t;&t;   Don&squot;t allow a fragment of TCP 8 bytes in. Nobody normal&n;&t;&t;   causes this. Its a cracker trying to break in by doing a&n;&t;&t;   flag overwrite to pass the direction checks.&n;&t;&t;*/
r_if
c_cond
(paren
id|offset
...
c_func
(paren
l_string|&quot;ipt_udp: Protocol %u != %u&bslash;n&quot;
comma
id|ip-&gt;proto
comma
id|IPPROTO_UDP
...
c_func
(paren
l_string|&quot;ipt_udp: matchsize %u != %u&bslash;n&quot;
comma
id|matchinfosize
comma
id|IPT_ALIGN
...
c_func
(paren
l_string|&quot;ipt_udp: unknown flags %X&bslash;n&quot;
comma
id|udpinfo-&gt;invflags
)paren
suffix:semicolon
...
suffix:semicolon
DECL|variable|ipt_error_target
r_static
r_struct
id|ipt_target
id|ipt_error_target
...
(brace
(brace
l_string|&quot;ip_tables_names&quot;
comma
id|ipt_get_tables
)brace
comma
(brace
l_string|&quot;ip_tables_targets&quot;
comma
id|ipt_get_targets
)brace
comma
(brace
l_string|&quot;ip_tables_matches&quot;
comma
id|ipt_get_matches
)brace
comma
...
DECL|variable|ipt_register_table
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_register_table
...
suffix:semicolon
DECL|variable|ipt_unregister_table
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_unregister_table
...
suffix:semicolon
DECL|variable|ipt_register_match
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_register_match
...
suffix:semicolon
DECL|variable|ipt_unregister_match
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_unregister_match
...
suffix:semicolon
DECL|variable|ipt_register_target
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_register_target
...
suffix:semicolon
DECL|variable|ipt_unregister_target
id|EXPORT_SYMBOL
c_func
(paren
id|ipt_unregister_target

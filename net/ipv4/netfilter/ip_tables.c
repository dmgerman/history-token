...
multiline_comment|/* Find match, grabs ref.  Returns ERR_PTR() on error. */
...
multiline_comment|/* Find target, grabs ref.  Returns ERR_PTR() on error. */

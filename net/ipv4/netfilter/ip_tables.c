...
multiline_comment|/* Find match by name, grabs mutex &amp; ref.  Returns ERR_PTR() on error. */
...
multiline_comment|/* Find target by name, grabs mutex &amp; ref.  Returns ERR_PTR() on error. */
...
c_func
(paren
l_string|&quot;ipt_register_target: `%s&squot; already in list!&bslash;n&quot;
comma
id|target-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ipt_register_match: `%s&squot; already in list!&bslash;n&quot;
comma
id|match-&gt;name
)paren
suffix:semicolon

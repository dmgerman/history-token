...
id|oldnfct
suffix:semicolon
multiline_comment|/* No RSTs for fragments. */
r_if
c_cond
(paren
(paren
...
id|NF_DROP
suffix:semicolon
multiline_comment|/* FIXME: Check checksum. */
(brace
r_struct
id|flowi
id|fl
...
multiline_comment|/* We&squot;re going to flip the header around, drop options and data. */
r_if
c_cond
(paren
op_logical_neg
...
l_int|4
suffix:semicolon
multiline_comment|/* Change over route. */
id|dst_release
c_func
(paren
(paren
...
id|NF_DROP
suffix:semicolon
multiline_comment|/* Related to old connection. */
id|oldnfct
op_assign
(paren
op_star
...
suffix:semicolon
id|nskb-&gt;h.icmph-&gt;type
op_assign
id|ICMP_DEST_UNREACH
suffix:semicolon
id|nskb-&gt;h.icmph-&gt;code
op_assign
id|code
suffix:semicolon
id|nskb-&gt;h.icmph-&gt;un.gateway
op_assign
l_int|0
suffix:semicolon
id|nskb-&gt;h.icmph-&gt;checksum
op_assign
l_int|0
suffix:semicolon

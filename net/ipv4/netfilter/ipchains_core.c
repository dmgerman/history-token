macro_line|#warning ipchains is obsolete, and will be removed soon.
...
mdefine_line|#define NUM_SLOTS (NR_CPUS*2)
...
suffix:semicolon
multiline_comment|/* Fix this one up by hand, who knows how many&n;&t;&t;&t; * tools will break if we start to barf on this.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|ntohs
...
c_func
(paren
l_string|&quot;ip_fw_ctl: tmp_skb alloc failure&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign

...
multiline_comment|/* Fix this one up by hand, who knows how many&n;&t;&t; * tools will break if we start to barf on this.&n;&t;&t; */
r_if
c_cond
(paren
id|ntohs

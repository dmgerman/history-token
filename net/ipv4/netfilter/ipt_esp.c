...
c_func
(paren
l_string|&quot;Dropping evil ESP tinygram.&bslash;n&quot;
)paren
suffix:semicolon
op_star
id|hotdrop
...
id|matchinfo
suffix:semicolon
multiline_comment|/* Must specify proto == ESP, and no unknown invflags */
r_if
c_cond
(paren
id|ip-&gt;proto
...
c_func
(paren
l_string|&quot;ipt_esp: Protocol %u != %u&bslash;n&quot;
comma
id|ip-&gt;proto
comma
id|IPPROTO_ESP
...
c_func
(paren
l_string|&quot;ipt_esp: matchsize %u != %u&bslash;n&quot;
comma
id|matchinfosize
comma
id|IPT_ALIGN
...
c_func
(paren
l_string|&quot;ipt_esp: unknown flags %X&bslash;n&quot;
comma
id|espinfo-&gt;invflags
)paren
suffix:semicolon

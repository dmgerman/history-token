...
l_int|0
suffix:semicolon
multiline_comment|/* Unknown: that&squot;s what we&squot;re trying to establish */
id|key.tos
op_assign
id|RT_TOS
c_func
...
(brace
multiline_comment|/* IP address was deleted.  Search entire table for&n;&t;&t;   conntracks which were associated with that device,&n;&t;&t;   and forget them. */
id|IP_NF_ASSERT
c_func
(paren
id|dev-&gt;ifindex

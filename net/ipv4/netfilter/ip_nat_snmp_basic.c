...
multiline_comment|/* We don&squot;t actually set up expectations, just adjust internal IP&n; * addresses if this is being NATted */
DECL|function|help
r_static
r_int
id|help
...
suffix:semicolon
multiline_comment|/* SNMP replies and originating SNMP traps get mangled */
r_if
c_cond
(paren
id|udph-&gt;source
...
(paren
id|KERN_WARNING
l_string|&quot;SNMP: dropping malformed packet &quot;
...
suffix:semicolon
DECL|variable|snmp_trap_helper
r_static
r_struct
id|ip_conntrack_helper
id|snmp_trap_helper

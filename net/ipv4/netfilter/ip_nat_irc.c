...
suffix:semicolon
multiline_comment|/* Master must be an irc connection */
id|ircinfo
op_assign
op_amp
id|master-&gt;help.ct_irc_info
suffix:semicolon
id|LOCK_BH
c_func
(paren
...
c_func
(paren
l_string|&quot;nat_expected: master not irc&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IRC_NAT: info (seq %u + %u) packet(seq %u + %u)&bslash;n&quot;
comma
id|ct_irc_info-&gt;seq
comma
id|ct_irc_info-&gt;len
...
c_func
(paren
l_string|&quot;got beyond ct_irc_info-&gt;len&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;IRC_NAT: score=2, calling fixup&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond

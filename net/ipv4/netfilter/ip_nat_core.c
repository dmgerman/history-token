...
multiline_comment|/* If we source map this tuple so reply looks like reply_tuple, will&n; * that meet the constraints of mr. */
r_static
r_int
...
(brace
multiline_comment|/* Try implicit source NAT; protocol&n;                                   may be able to play with ports to&n;                                   make it unique. */
r_struct
id|ip_nat_range
id|r
op_assign

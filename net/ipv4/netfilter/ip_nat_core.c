...
suffix:semicolon
multiline_comment|/* Reset the other ip in case it was mangled by&n;&t;&t; * do_extra_mangle last time. */
op_star
id|other_ipp
op_assign
id|saved_ip
...
(brace
multiline_comment|/* Optimization: doesn&squot;t get any better than&n;&t;&t;&t;   this. */
r_if
c_cond
(paren
id|score
...
(brace
multiline_comment|/* Leave IP address alone if we&squot;re not to map IP addresses. */
r_if
c_cond
(paren
op_logical_neg
...
r_else
(brace
multiline_comment|/* Only do extra mangle when required (breaks socket&n;&t;&t;   binding) */
r_if
c_cond
(paren
id|tuple-&gt;dst.ip
...
c_func
(paren
l_string|&quot;do_bindings: helper existing for (%p)&bslash;n&quot;
comma
id|ct
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Have to grab read lock before sibling_list traversal */
id|READ_LOCK
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* if this expectation is already established, skip */
r_if
c_cond
(paren
id|exp-&gt;sibling
...
c_func
(paren
l_string|&quot;calling nat helper (exp=%p) for packet&bslash;n&quot;
comma
id|exp
)paren
suffix:semicolon
...
id|helper-&gt;flags
op_amp
id|IP_NAT_HELPER_F_ALWAYS
)paren
(brace
id|DEBUGP
c_func
(paren
l_string|&quot;calling nat helper for packet without expectation&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
suffix:semicolon
multiline_comment|/* Adjust sequence number only once per packet &n;&t;&t; * (helper is called at all hooks) */
r_if
c_cond
(paren
id|proto
...
suffix:semicolon
multiline_comment|/* future: put this in a l4-proto specific function,&n;&t;&t;&t; * and call this function here. */
r_if
c_cond
(paren
op_logical_neg

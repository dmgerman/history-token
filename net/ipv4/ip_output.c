...
suffix:semicolon
multiline_comment|/* If this fails, retransmit mechanism of transport layer will&n;&t;&t;&t; * keep trying until route appears or the connection times itself&n;&t;&t;&t; * out.&n;&t;&t;&t; */
r_if
c_cond
(paren
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Give the upper layer a chance to decide whether to use HW&n;&t; *&t;checksumming or not.&n;&t; */
r_if
c_cond
(paren
id|offset
...
r_else
(brace
multiline_comment|/* On a non-blocking write, we check for send buffer&n;&t;&t;&t; * usage on the first fragment only.&n;&t;&t;&t; */
id|skb
op_assign
id|sock_wmalloc
c_func
...
id|alloc_new_skb
suffix:semicolon
multiline_comment|/* &n;&t;&t;&t; * Align the start address of the next IP fragment&n;&t;&t;&t; * on 8 byte boundary.&n;&t;&t;&t; */
id|copy
op_assign
l_int|8
op_minus

...
suffix:semicolon
DECL|struct|packet_sock
r_struct
id|packet_sock
(brace
multiline_comment|/* struct sock has to be the first member of packet_sock */
DECL|member|sk
r_struct
id|sock
id|sk
...
id|sk-&gt;sk_filter
suffix:semicolon
multiline_comment|/*&n;&t; * Our caller already checked that filter != NULL but we need to&n;&t; * verify that under bh_lock_sock() to be safe&n;&t; */
r_if
c_cond
(paren
id|likely
...
DECL|function|packet_seq_start
r_static
r_void
op_star
id|packet_seq_start
...
id|seq
comma
l_string|&quot;%p %-6d %-4d %04x   %-5d %1d %-6u %-6u %-6lu&bslash;n&quot;
comma
id|s
comma
id|atomic_read

...
id|make_active
suffix:semicolon
multiline_comment|/* handle finding the connection on the second time through the active list */
id|found_active_second_chance
suffix:colon
id|rxrpc_get_connection
c_func
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * finish using a connection record&n; * - it will be transferred to the peer&squot;s connection graveyard when refcount reaches 0&n; */
...
suffix:semicolon
multiline_comment|/* discard in 100 secs */
...
c_func
(paren
l_string|&quot;--- Destroying Connection %p ---&quot;
comma
id|conn
)paren
suffix:semicolon
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * allocate and prepare a message for sending out through the transport endpoint&n; */
...
suffix:colon
multiline_comment|/* ACK sequence numbers are complicated. The following may be wrong:&n;&t;&t;&t; * - jumbo packet ACKs should have a seq number&n;&t;&t;&t; * - normal ACKs should not&n;&t;&t;&t; */
r_default
suffix:colon
r_break
suffix:semicolon

...
suffix:semicolon
multiline_comment|/* Called on connection receive so cannot be GFP_KERNEL */
id|sk
op_assign
id|sk_alloc
c_func
...
op_assign
id|KERN_INFO
l_string|&quot;NET4: Sequenced Packet eXchange (SPX) 0.03&bslash;n&quot;
suffix:semicolon

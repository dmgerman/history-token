...
multiline_comment|/* The packet is a NCP request */
id|connection
op_assign
(paren
(paren
...
multiline_comment|/* The packet is a BURST packet */
id|connection
op_assign
(paren
(paren
...
(brace
multiline_comment|/* Now we have to look for a special NCP connection&n;&t;&t;&t; * handling socket. Only these sockets have&n;&t;&t;&t; * ipx_ncp_conn != 0, set by SIOCIPXNCPCONN. */
id|spin_lock_bh
c_func
(paren
op_amp
...
op_assign
id|KERN_INFO
l_string|&quot;NET4: Linux IPX 0.46 for NET4.0&bslash;n&quot;
id|KERN_INFO

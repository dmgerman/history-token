...
id|sk
suffix:semicolon
multiline_comment|/*&n;&t; * SPX support is not anymore in the kernel sources. If you want to&n;&t; * ressurrect it, completing it and making it understand shared skbs,&n;&t; * be fully multithreaded, etc, grab the sources in an early 2.5 kernel&n;&t; * tree.&n;&t; */
r_if
c_cond
(paren
id|sock-&gt;type

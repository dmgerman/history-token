...
suffix:semicolon
id|nr_make-&gt;source_addr
op_assign
op_star
id|dest
suffix:semicolon
id|nr_make-&gt;dest_addr
op_assign
op_star
id|src
suffix:semicolon
id|nr_make-&gt;user_addr
op_assign
op_star
id|user
suffix:semicolon
id|nr_make-&gt;your_index
op_assign
id|circuit_index
suffix:semicolon
id|nr_make-&gt;your_id
...
(paren
id|KERN_ERR
l_string|&quot;NET/ROM: nr_proto_init - unable to allocate device array&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;NET/ROM: nr_proto_init - unable to register socket family&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|fail

...
c_func
(paren
l_string|&quot;session %p hid %p data %p size %d&quot;
comma
id|session
comma
id|device
...
DECL|function|hidp_send_message
r_static
r_inline
r_void
id|hidp_send_message
c_func
(paren
r_struct
id|hidp_session
...
c_func
(paren
l_string|&quot;Can&squot;t allocate memory for message&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

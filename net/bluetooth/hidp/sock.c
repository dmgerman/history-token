...
macro_line|#endif
DECL|function|hidp_sock_release
r_static
r_int
id|hidp_sock_release
c_func
(paren
r_struct
id|socket
...
c_cond
(paren
id|csock-&gt;sk-&gt;sk_state
op_ne
id|BT_CONNECTED
op_logical_or
id|isock-&gt;sk-&gt;sk_state
op_ne
id|BT_CONNECTED
)paren
(brace
...
suffix:semicolon
DECL|function|hidp_sock_create
r_static
r_int
id|hidp_sock_create
c_func
...
DECL|variable|hidp_sock_family_ops
r_static
r_struct
id|net_proto_family
id|hidp_sock_family_ops
op_assign
(brace
dot
id|family
...
suffix:semicolon
DECL|function|hidp_init_sockets
r_int
id|__init
...
c_func
(paren
l_string|&quot;Can&squot;t register HIDP socket&quot;
)paren
suffix:semicolon
id|proto_unregister
c_func
...
DECL|function|hidp_cleanup_sockets
r_void
id|__exit
...
c_func
(paren
l_string|&quot;Can&squot;t unregister HIDP socket&quot;
)paren
suffix:semicolon
id|proto_unregister
c_func

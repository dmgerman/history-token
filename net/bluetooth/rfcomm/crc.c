...
multiline_comment|/*&n; * RFCOMM FCS calculation.&n; *&n; * $Id: crc.c,v 1.2 2002/09/21 09:54:32 holtmann Exp $&n; */
multiline_comment|/* reversed, 8-bit, poly=0x07 */
DECL|variable|rfcomm_crc_table
r_int
r_char
id|rfcomm_crc_table
(braket

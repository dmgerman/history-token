...
multiline_comment|/*&n; * RFCOMM core.&n; *&n; * $Id: core.c,v 1.42 2002/10/01 23:26:25 maxk Exp $&n; */
...
DECL|function|rfcomm_dlc_modem_status
r_int
...
id|ptr
comma
l_string|&quot;dlc %s %s %ld %d %d %d %d&bslash;n&quot;
comma
id|batostr
c_func
(paren

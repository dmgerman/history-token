...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;1.5&quot;
...
DECL|function|rfcomm_check_link_mode
r_static
r_inline
r_int
id|rfcomm_check_link_mode
c_func
(paren
r_struct
id|rfcomm_dlc
...
DECL|function|rfcomm_dlc_accept
r_static
r_void
id|rfcomm_dlc_accept
c_func
(paren
r_struct
id|rfcomm_dlc
...
c_func
(paren
id|RFCOMM_SCHED_AUTH
)paren
suffix:semicolon
)brace
DECL|function|rfcomm_encrypt_cfm
r_static
r_void
id|rfcomm_encrypt_cfm
c_func
(paren
r_struct
id|hci_conn
...
c_func
(paren
l_string|&quot;conn %p status 0x%02x encrypt 0x%02x&quot;
comma
id|conn
comma
id|status

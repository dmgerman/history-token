...
c_func
(paren
l_string|&quot;tty %p from_user %d count %d&quot;
comma
id|tty
comma
id|from_user
...
DECL|function|rfcomm_tty_set_modem_status
r_static
r_int
id|rfcomm_tty_set_modem_status
c_func
(paren
id|uint
id|cmd
...
id|TIOCMBIS
suffix:colon
multiline_comment|/* Turns on the lines as specified by the mask */
r_case
id|TIOCMBIC
suffix:colon
multiline_comment|/* Turns off the lines as specified by the mask */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
DECL|variable|rfcomm_tty_termios
r_static
r_struct
id|termios
op_star
id|rfcomm_tty_termios
(braket
id|RFCOMM_TTY_PORTS
)braket
suffix:semicolon
DECL|variable|rfcomm_tty_termios_locked
r_static
r_struct
id|termios
op_star
id|rfcomm_tty_termios_locked
(braket
id|RFCOMM_TTY_PORTS
)braket
suffix:semicolon

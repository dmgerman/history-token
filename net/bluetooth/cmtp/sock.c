...
macro_line|#endif
DECL|function|cmtp_sock_release
r_static
r_int
id|cmtp_sock_release
c_func
(paren
r_struct
id|socket
...
suffix:semicolon
DECL|function|cmtp_sock_create
r_static
r_int
id|cmtp_sock_create
c_func
...
DECL|variable|cmtp_sock_family_ops
r_static
r_struct
id|net_proto_family
id|cmtp_sock_family_ops
op_assign
(brace
dot
id|family
...
suffix:semicolon
DECL|function|cmtp_init_sockets
r_int
...
c_func
(paren
l_string|&quot;Can&squot;t register CMTP socket&quot;
)paren
suffix:semicolon
id|proto_unregister
c_func
...
DECL|function|cmtp_cleanup_sockets
r_void
...
c_func
(paren
l_string|&quot;Can&squot;t unregister CMTP socket&quot;
)paren
suffix:semicolon
id|proto_unregister
c_func

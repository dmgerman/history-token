...
multiline_comment|/* Special commands */
r_while
c_loop
(paren
(paren
...
multiline_comment|/* Alloc HCI device */
...
suffix:semicolon
DECL|function|hci_unregister_cb
r_int
...
DECL|variable|hci_unregister_cb
id|EXPORT_SYMBOL
c_func
(paren
id|hci_unregister_cb
...
(brace
multiline_comment|/* ACL tx timeout must be longer than maximum&n;&t;&t; * link supervision timeout (40.9 seconds) */
r_if
c_cond
(paren
op_logical_neg

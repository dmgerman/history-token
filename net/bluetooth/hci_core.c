...
multiline_comment|/*&n; * BlueZ HCI Core.&n; *&n; * $Id: hci_core.c,v 1.2 2001/06/01 16:57:03 davem Exp $&n; */
...
c_func
(paren
l_string|&quot;%s BUG handle %d is to large&quot;
comma
id|hdev-&gt;name
comma
id|handle
...
multiline_comment|/* Open HCI device */
...
multiline_comment|/* Close HCI device */
...
multiline_comment|/* ACL scheduler */
DECL|function|hci_low_acl_sent
r_static
id|__inline__
r_struct
id|hci_conn
...
(brace
multiline_comment|/* FIXME: Schedule next connection */
r_goto
id|done
suffix:semicolon
)brace
...
id|HCI_SCODATA_PKT
suffix:colon
multiline_comment|/* FIXME:&n;&t;&t; * Check header here and queue to aproptiate connection.&n;&t;&t; */
r_default
suffix:colon
id|skb_queue_tail
c_func
...
c_func
(paren
l_string|&quot;%s conn %p len %d flags 0x%x&quot;
comma
id|hdev-&gt;name
comma
id|conn
...
suffix:semicolon
multiline_comment|/* Add ACL header to all fragments */
id|flags
op_or_assign
id|ACL_START
suffix:semicolon
...
(brace
multiline_comment|/* Handle frame */
r_switch
c_cond
(paren
id|skb-&gt;pkt_type

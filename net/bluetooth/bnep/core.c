...
DECL|function|bnep_set_default_proto_filter
r_static
r_inline
r_void
id|bnep_set_default_proto_filter
c_func
(paren
r_struct
id|bnep_session
...
suffix:semicolon
multiline_comment|/* session struct allocated as private part of net_device */
id|dev
op_assign
id|alloc_netdev
c_func

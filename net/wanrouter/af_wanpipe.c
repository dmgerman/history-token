...
id|sk-&gt;protinfo.af_wanpipe-&gt;card
suffix:semicolon
r_if
c_cond
(paren
...
id|dev-&gt;ifindex
suffix:semicolon
id|newsk-&gt;protinfo.af_wanpipe-&gt;card
op_assign
id|sk-&gt;protinfo.af_wanpipe-&gt;card
suffix:semicolon
...
id|newsk-&gt;protinfo.af_wanpipe-&gt;lcn
op_assign
id|mbox_ptr-&gt;cmd.lcn
suffix:semicolon
id|newsk-&gt;protinfo.af_wanpipe-&gt;mbox
op_assign
(paren
r_void
op_star
...
id|sk-&gt;protinfo.af_wanpipe-&gt;tx_timer.data
op_assign
(paren
r_int
r_int
...
id|sk
suffix:semicolon
id|sk-&gt;protinfo.af_wanpipe-&gt;tx_timer.function
op_assign
id|wanpipe_delayed_transmit
suffix:semicolon
...
(paren
op_amp
id|sk-&gt;protinfo.af_wanpipe-&gt;packet_sent
)paren
suffix:semicolon
r_if
c_cond
...
comma
op_amp
id|sk-&gt;protinfo.af_wanpipe-&gt;timer
)paren
)paren
)paren
(brace
...
(paren
op_amp
id|sk-&gt;protinfo.af_wanpipe-&gt;tx_timer
)paren
suffix:semicolon
id|sk-&gt;protinfo.af_wanpipe-&gt;tx_timer.expires
op_assign
id|jiffies
op_plus
l_int|1
...
multiline_comment|/*============================================================&n; * execute_command &n; *&n; *&t;Execute x25api commands.  The atomic variable&n; *      chan-&gt;command is used to indicate to the driver that&n; *      command is pending for exection.  The acutal command&n; *      structure is placed into a sock mbox structure &n; *      (sk-&gt;protinfo.af_wanpipe-&gt;mbox).&n; *&n; *      The sock private structure, mbox is&n; *      used as shared memory between sock and the driver.&n; *      Driver uses the sock mbox to execute the command&n; *      and return the result.  &n; *&n; *      For all command except PLACE CALL, the function&n; *      waits for the result.  PLACE CALL can be ether&n; *      blocking or nonblocking. The user sets this option&n; *      via ioctl call.&n; *===========================================================*/
...
(paren
op_logical_neg
id|sk-&gt;protinfo.af_wanpipe-&gt;mbox
)paren
(brace
id|printk
c_func
...
(paren
op_increment
id|sk-&gt;protinfo.af_wanpipe-&gt;force
op_eq
l_int|5
)paren
)paren
...
c_func
(paren
id|sk-&gt;protinfo.af_wanpipe-&gt;poll_cnt
comma
op_amp
id|dbg_data-&gt;debug
(braket

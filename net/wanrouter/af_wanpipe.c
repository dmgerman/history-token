...
multiline_comment|/* &n; * FIXME: wanpipe_opt has to include a sock in its definition and stop using&n; * sk_protinfo, but this code is not even compilable now, so lets leave it for&n; * later.&n; */
DECL|variable|wanpipe_proto
r_static
r_struct
id|proto
id|wanpipe_proto
...
multiline_comment|/* Check if data buffers are pending for transmission,&n;                         * if so, check whether user wants to wait until data&n;                         * is transmitted, or clear a call and drop packets */
r_if
c_cond
(paren
id|atomic_read
...
multiline_comment|/* Check if data buffers are pending for transmission,&n;                         * if so, check whether user wants to wait until data&n;                         * is transmitted, or reset a call and drop packets */
r_if
c_cond
(paren
id|atomic_read

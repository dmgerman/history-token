...
DECL|variable|sock_inode_cachep
r_static
id|kmem_cache_t
op_star
id|sock_inode_cachep
suffix:semicolon
DECL|function|sock_alloc_inode
r_static
r_struct
id|inode
op_star
...
DECL|function|sock_destroy_inode
r_static
r_void
id|sock_destroy_inode
c_func
(paren
r_struct
id|inode
...
suffix:semicolon
id|x-&gt;async_msg.msg_name
op_assign
l_int|NULL
suffix:semicolon
id|x-&gt;async_msg.msg_namelen
op_assign
l_int|0
suffix:semicolon
id|x-&gt;async_msg.msg_iov
op_assign
op_amp
id|x-&gt;async_iov
suffix:semicolon
id|x-&gt;async_msg.msg_iovlen
op_assign
l_int|1
suffix:semicolon
id|x-&gt;async_msg.msg_control
op_assign
l_int|NULL
suffix:semicolon
id|x-&gt;async_msg.msg_controllen
op_assign
l_int|0
suffix:semicolon
id|x-&gt;async_iov.iov_base
op_assign
id|ubuf
suffix:semicolon
id|x-&gt;async_iov.iov_len
op_assign
id|size
suffix:semicolon
id|flags
...
multiline_comment|/*&n; * Atomic setting of ioctl hooks to avoid race&n; * with module unload.&n; */
r_static
id|DECLARE_MUTEX
c_func
(paren
...
DECL|function|sock_create_lite
r_int
id|sock_create_lite
c_func
(paren
...
id|out_module_put
suffix:semicolon
multiline_comment|/*&n;&t; * Now to bump the refcnt of the [loadable] module that owns this&n;&t; * socket at sock_release time we decrement its refcnt.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t; * Now that we&squot;re done with the -&gt;create function, the [loadable]&n;&t; * module can have its refcnt decremented&n;&t; */
id|module_put
c_func
(paren
id|net_families
...
DECL|function|sock_create_kern
r_int
id|sock_create_kern
c_func
(paren
...
id|out_release
suffix:semicolon
multiline_comment|/*&n;&t; * We don&squot;t need try_module_get here, as the listening socket (sock)&n;&t; * has the protocol module (sock-&gt;ops-&gt;owner) held.&n;&t; */
id|__module_get
c_func
(paren
...
multiline_comment|/* A couple of helpful macros for getting the address of the 32/64 bit &n; * fields which are the same type (int / unsigned) on our platforms.&n; */
DECL|macro|COMPAT_MSG
mdefine_line|#define COMPAT_MSG(msg, member)&t;((MSG_CMSG_COMPAT &amp; flags) ? &amp;msg##_compat-&gt;member : &amp;msg-&gt;member)
DECL|macro|COMPAT_NAMELEN
mdefine_line|#define COMPAT_NAMELEN(msg)&t;COMPAT_MSG(msg, msg_namelen)
DECL|macro|COMPAT_FLAGS
mdefine_line|#define COMPAT_FLAGS(msg)&t;COMPAT_MSG(msg, msg_flags)
...
multiline_comment|/* ABI emulation layers need these two */
...
suffix:semicolon
DECL|variable|sock_create_kern
id|EXPORT_SYMBOL
c_func
(paren
id|sock_create_kern
...
suffix:semicolon
DECL|variable|sock_create_lite
id|EXPORT_SYMBOL
c_func
(paren
id|sock_create_lite

...
DECL|macro|__HARDIRQ_MASK
mdefine_line|#define __HARDIRQ_MASK(x)&t;((1UL &lt;&lt; (x))-1)
DECL|macro|PREEMPT_MASK
mdefine_line|#define PREEMPT_MASK&t;(__HARDIRQ_MASK(PREEMPT_BITS) &lt;&lt; PREEMPT_SHIFT)
DECL|macro|SOFTIRQ_MASK
mdefine_line|#define SOFTIRQ_MASK&t;(__HARDIRQ_MASK(SOFTIRQ_BITS) &lt;&lt; SOFTIRQ_SHIFT)
DECL|macro|HARDIRQ_MASK
mdefine_line|#define HARDIRQ_MASK&t;(__HARDIRQ_MASK(HARDIRQ_BITS) &lt;&lt; HARDIRQ_SHIFT)

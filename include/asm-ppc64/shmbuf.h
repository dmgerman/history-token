macro_line|#ifndef _PPC64_SHMBUF_H
DECL|macro|_PPC64_SHMBUF_H
mdefine_line|#define _PPC64_SHMBUF_H
multiline_comment|/* &n; * The shmid64_ds structure for PPC64 architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 2 miscellaneous 64-bit values&n; *&n; * This program is free software; you can redistribute it and/or&n; * modify it under the terms of the GNU General Public License&n; * as published by the Free Software Foundation; either version&n; * 2 of the License, or (at your option) any later version.&n; */
...
suffix:semicolon
macro_line|#endif /* _PPC64_SHMBUF_H */
eof

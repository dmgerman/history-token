...
multiline_comment|/*&n; * DMA operations are abstracted for G5 vs. i/pSeries, PCI vs. VIO&n; */
DECL|struct|dma_mapping_ops
r_struct
id|dma_mapping_ops
(brace
DECL|member|alloc_coherent
r_void
op_star
(paren
op_star

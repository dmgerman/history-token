macro_line|#ifndef _PPC64_TERMIOS_H
DECL|macro|_PPC64_TERMIOS_H
mdefine_line|#define _PPC64_TERMIOS_H
multiline_comment|/*&n; * Liberally adapted from alpha/termios.h.  In particular, the c_cc[]&n; * fields have been reordered so that termio &amp; termios share the&n; * common subset in the same order (for brain dead programs that don&squot;t&n; * know or care about the differences).&n; *&n; * This program is free software; you can redistribute it and/or&n; * modify it under the terms of the GNU General Public License&n; * as published by the Free Software Foundation; either version&n; * 2 of the License, or (at your option) any later version.&n; */
...
macro_line|#endif&t;/* _PPC64_TERMIOS_H */
eof

...
suffix:semicolon
multiline_comment|/* ToDo: look for ff&squot;s in buf[n] */
)brace
DECL|function|eeh_outsb
r_static
r_inline
r_void
id|eeh_outsb
...
suffix:semicolon
multiline_comment|/* ToDo: look for ffff&squot;s in buf[n] */
)brace
DECL|function|eeh_outsw_ns
r_static
r_inline
r_void
id|eeh_outsw_ns
...
suffix:semicolon
multiline_comment|/* ToDo: look for ffffffff&squot;s in buf[n] */
)brace
DECL|function|eeh_outsl_ns
r_static
r_inline
r_void
id|eeh_outsl_ns

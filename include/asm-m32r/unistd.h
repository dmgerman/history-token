...
mdefine_line|#define __NR_cacheflush&t;&t; 31 /* old #define __NR_stty&t;&t; 31*/
...
mdefine_line|#define __NR_security           223     /* syscall for security modules */
...
mdefine_line|#define __NR_setxattr           226
DECL|macro|__NR_lsetxattr
mdefine_line|#define __NR_lsetxattr          227
DECL|macro|__NR_fsetxattr
mdefine_line|#define __NR_fsetxattr          228
DECL|macro|__NR_getxattr
mdefine_line|#define __NR_getxattr           229
DECL|macro|__NR_lgetxattr
mdefine_line|#define __NR_lgetxattr          230
DECL|macro|__NR_fgetxattr
mdefine_line|#define __NR_fgetxattr          231
DECL|macro|__NR_listxattr
mdefine_line|#define __NR_listxattr          232
DECL|macro|__NR_llistxattr
mdefine_line|#define __NR_llistxattr         233
DECL|macro|__NR_flistxattr
mdefine_line|#define __NR_flistxattr         234
DECL|macro|__NR_removexattr
mdefine_line|#define __NR_removexattr        235
DECL|macro|__NR_lremovexattr
mdefine_line|#define __NR_lremovexattr       236
DECL|macro|__NR_fremovexattr
mdefine_line|#define __NR_fremovexattr       237
...
mdefine_line|#define __NR_set_thread_area    243
DECL|macro|__NR_get_thread_area
mdefine_line|#define __NR_get_thread_area    244
DECL|macro|__NR_io_setup
mdefine_line|#define __NR_io_setup           245
DECL|macro|__NR_io_destroy
mdefine_line|#define __NR_io_destroy         246
DECL|macro|__NR_io_getevents
mdefine_line|#define __NR_io_getevents       247
DECL|macro|__NR_io_submit
mdefine_line|#define __NR_io_submit          248
DECL|macro|__NR_io_cancel
mdefine_line|#define __NR_io_cancel          249
DECL|macro|__NR_fadvise64
mdefine_line|#define __NR_fadvise64          250
DECL|macro|__NR_exit_group
mdefine_line|#define __NR_exit_group         252
DECL|macro|__NR_lookup_dcookie
mdefine_line|#define __NR_lookup_dcookie     253
DECL|macro|__NR_epoll_create
mdefine_line|#define __NR_epoll_create       254
DECL|macro|__NR_epoll_ctl
mdefine_line|#define __NR_epoll_ctl          255
DECL|macro|__NR_epoll_wait
mdefine_line|#define __NR_epoll_wait         256
DECL|macro|__NR_remap_file_pages
mdefine_line|#define __NR_remap_file_pages   257
DECL|macro|__NR_set_tid_address
mdefine_line|#define __NR_set_tid_address    258
DECL|macro|__NR_timer_create
mdefine_line|#define __NR_timer_create       259
DECL|macro|__NR_timer_settime
mdefine_line|#define __NR_timer_settime      (__NR_timer_create+1)
DECL|macro|__NR_timer_gettime
mdefine_line|#define __NR_timer_gettime      (__NR_timer_create+2)
DECL|macro|__NR_timer_getoverrun
mdefine_line|#define __NR_timer_getoverrun   (__NR_timer_create+3)
DECL|macro|__NR_timer_delete
mdefine_line|#define __NR_timer_delete       (__NR_timer_create+4)
DECL|macro|__NR_clock_settime
mdefine_line|#define __NR_clock_settime      (__NR_timer_create+5)
DECL|macro|__NR_clock_gettime
mdefine_line|#define __NR_clock_gettime      (__NR_timer_create+6)
DECL|macro|__NR_clock_getres
mdefine_line|#define __NR_clock_getres       (__NR_timer_create+7)
DECL|macro|__NR_clock_nanosleep
mdefine_line|#define __NR_clock_nanosleep    (__NR_timer_create+8)
DECL|macro|__NR_statfs64
mdefine_line|#define __NR_statfs64           268
DECL|macro|__NR_fstatfs64
mdefine_line|#define __NR_fstatfs64          269
DECL|macro|__NR_tgkill
mdefine_line|#define __NR_tgkill             270
DECL|macro|__NR_utimes
mdefine_line|#define __NR_utimes             271
DECL|macro|__NR_fadvise64_64
mdefine_line|#define __NR_fadvise64_64       272
DECL|macro|__NR_vserver
mdefine_line|#define __NR_vserver            273
...
mdefine_line|#define __syscall_return(type, res) &bslash;&n;do { &bslash;&n;&t;if ((unsigned long)(res) &gt;= (unsigned long)(-125)) { &bslash;&n;&t;/* Avoid using &quot;res&quot; which is declared to be in register r0; &bslash;&n;           errno might expand to a function call and clobber it.  */ &bslash;&n;                int __err = -(res); &bslash;&n;                errno = __err; &bslash;&n;                res = -1; &bslash;&n;&t;} &bslash;&n;&t;return (type) (res); &bslash;&n;} while (0)
...
mdefine_line|#define _syscall5(type,name,type1,arg1,type2,arg2,type3,arg3,type4,arg4, &bslash;&n;          type5,arg5) &bslash;&n;type name(type1 arg1,type2 arg2,type3 arg3,type4 arg4,type5 arg5) &bslash;&n;{ &bslash;&n;register long __scno __asm__ (&quot;r7&quot;) = __NR_##name; &bslash;&n;register long __arg5 __asm__ (&quot;r4&quot;) = (long)(arg5); &bslash;&n;register long __arg4 __asm__ (&quot;r3&quot;) = (long)(arg4); &bslash;&n;register long __arg3 __asm__ (&quot;r2&quot;) = (long)(arg3); &bslash;&n;register long __arg2 __asm__ (&quot;r1&quot;) = (long)(arg2); &bslash;&n;register long __res __asm__ (&quot;r0&quot;) = (long)(arg1); &bslash;&n;__asm__ __volatile__ (&bslash;&n;&t;&quot;trap #&quot; SYSCALL_VECTOR &bslash;&n;&t;: &quot;=r&quot; (__res) &bslash;&n;&t;: &quot;r&quot; (__scno), &quot;0&quot; (__res), &quot;r&quot; (__arg2), &bslash;&n;&t;&t;&quot;r&quot; (__arg3), &quot;r&quot; (__arg4), &quot;r&quot; (__arg5) &bslash;&n;&t;: &quot;memory&quot;); &bslash;&n;__syscall_return(type,__res); &bslash;&n;}

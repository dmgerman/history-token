...
multiline_comment|/**&n; * atomic_add_return - add integer to atomic variable and return&n; * @i: integer value to add&n; * @v: pointer of type atomic_t&n; *&n; * Atomically adds @i to @v and return (@i + @v).&n; */
...
multiline_comment|/**&n; * atomic_sub_return - subtract the atomic variable and return&n; * @i: integer value to subtract&n; * @v: pointer of type atomic_t&n; *&n; * Atomically subtracts @i from @v and return (@v - @i).&n; */
...
multiline_comment|/**&n; * atomic_inc_return - increment atomic variable and return&n; * @v: pointer of type atomic_t&n; *&n; * Atomically increments @v by 1 and returns the result.&n; */
...
multiline_comment|/**&n; * atomic_dec_return - decrement atomic variable and return&n; * @v: pointer of type atomic_t&n; *&n; * Atomically decrements @v by 1 and returns the result.&n; */

macro_line|#ifndef __M32R_IPC_H__
DECL|macro|__M32R_IPC_H__
mdefine_line|#define __M32R_IPC_H__
multiline_comment|/* orig : i386/ipc.h 2.6.0-test3 */
...
macro_line|#endif&t;/* __M32R_IPC_H__ */
eof

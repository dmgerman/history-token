macro_line|#ifndef _ASM_M32R_SIGNAL_H
DECL|macro|_ASM_M32R_SIGNAL_H
mdefine_line|#define _ASM_M32R_SIGNAL_H
...
mdefine_line|#define ptrace_signal_deliver(regs, cookie)&t;do { } while (0)
macro_line|#endif /* __KERNEL__ */
macro_line|#endif  /* _ASM_M32R_SIGNAL_H */
eof

macro_line|#ifndef _M32R_TERMIOS_H
DECL|macro|_M32R_TERMIOS_H
mdefine_line|#define _M32R_TERMIOS_H
multiline_comment|/* orig : i386 2.6.0-test5 */
...
macro_line|#endif&t;/* _M32R_TERMIOS_H */
eof

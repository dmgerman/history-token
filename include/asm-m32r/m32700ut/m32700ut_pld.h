multiline_comment|/*&n; * include/asm/m32700ut/m32700ut_pld.h&n; *&n; * Definitions for Programable Logic Device(PLD) on M32700UT board.&n; *&n; * Copyright (c) 2002&t;Takeo Takahashi&n; *&n; * This file is subject to the terms and conditions of the GNU General&n; * Public License.  See the file &quot;COPYING&quot; in the main directory of&n; * this archive for more details.&n; *&n; * $Id$&n; */
macro_line|#ifndef _M32700UT_M32700UT_PLD_H
DECL|macro|_M32700UT_M32700UT_PLD_H
mdefine_line|#define _M32700UT_M32700UT_PLD_H
macro_line|#include &lt;linux/config.h&gt;
macro_line|#if defined(CONFIG_PLAT_M32700UT_Alpha)
DECL|macro|PLD_PLAT_BASE
mdefine_line|#define PLD_PLAT_BASE&t;&t;0x08c00000
macro_line|#elif defined(CONFIG_PLAT_M32700UT) || defined(CONFIG_PLAT_USRV)
DECL|macro|PLD_PLAT_BASE
mdefine_line|#define PLD_PLAT_BASE&t;&t;0x04c00000
macro_line|#else
...
mdefine_line|#define PLD_IRQ_INT0&t;&t;(M32700UT_PLD_IRQ_BASE + 0)&t;/* None */
DECL|macro|PLD_IRQ_INT1
mdefine_line|#define PLD_IRQ_INT1&t;&t;(M32700UT_PLD_IRQ_BASE + 1)&t;/* reserved */
DECL|macro|PLD_IRQ_INT2
mdefine_line|#define PLD_IRQ_INT2&t;&t;(M32700UT_PLD_IRQ_BASE + 2)&t;/* reserved */
DECL|macro|PLD_IRQ_CFIREQ
mdefine_line|#define PLD_IRQ_CFIREQ&t;&t;(M32700UT_PLD_IRQ_BASE + 3)&t;/* CF IREQ */
DECL|macro|PLD_IRQ_CFC_INSERT
mdefine_line|#define PLD_IRQ_CFC_INSERT&t;(M32700UT_PLD_IRQ_BASE + 4)&t;/* CF Insert */
DECL|macro|PLD_IRQ_CFC_EJECT
mdefine_line|#define PLD_IRQ_CFC_EJECT&t;(M32700UT_PLD_IRQ_BASE + 5)&t;/* CF Eject */
DECL|macro|PLD_IRQ_EXINT
mdefine_line|#define PLD_IRQ_EXINT&t;&t;(M32700UT_PLD_IRQ_BASE + 6)&t;/* EXINT */
DECL|macro|PLD_IRQ_INT7
mdefine_line|#define PLD_IRQ_INT7&t;&t;(M32700UT_PLD_IRQ_BASE + 7)&t;/* reserved */
DECL|macro|PLD_IRQ_INT8
mdefine_line|#define PLD_IRQ_INT8&t;&t;(M32700UT_PLD_IRQ_BASE + 8)&t;/* reserved */
DECL|macro|PLD_IRQ_INT9
mdefine_line|#define PLD_IRQ_INT9&t;&t;(M32700UT_PLD_IRQ_BASE + 9)&t;/* reserved */
DECL|macro|PLD_IRQ_INT10
mdefine_line|#define PLD_IRQ_INT10&t;&t;(M32700UT_PLD_IRQ_BASE + 10)&t;/* reserved */
DECL|macro|PLD_IRQ_MMCCARD
mdefine_line|#define PLD_IRQ_MMCCARD&t;&t;(M32700UT_PLD_IRQ_BASE + 11)&t;/* MMC Insert/Eject */
DECL|macro|PLD_IRQ_INT12
mdefine_line|#define PLD_IRQ_INT12&t;&t;(M32700UT_PLD_IRQ_BASE + 12)&t;/* reserved */
DECL|macro|PLD_IRQ_SC_ERROR
mdefine_line|#define PLD_IRQ_SC_ERROR&t;(M32700UT_PLD_IRQ_BASE + 13)&t;/* SC error */
DECL|macro|PLD_IRQ_SC_RCV
mdefine_line|#define PLD_IRQ_SC_RCV&t;&t;(M32700UT_PLD_IRQ_BASE + 14)&t;/* SC receive */
DECL|macro|PLD_IRQ_SC_SND
mdefine_line|#define PLD_IRQ_SC_SND&t;&t;(M32700UT_PLD_IRQ_BASE + 15)&t;/* SC send */
DECL|macro|PLD_IRQ_SIO0_RCV
mdefine_line|#define PLD_IRQ_SIO0_RCV&t;(M32700UT_PLD_IRQ_BASE + 16)&t;/* SIO receive */
DECL|macro|PLD_IRQ_SIO0_SND
mdefine_line|#define PLD_IRQ_SIO0_SND&t;(M32700UT_PLD_IRQ_BASE + 17)&t;/* SIO send */
DECL|macro|PLD_IRQ_INT18
mdefine_line|#define PLD_IRQ_INT18&t;&t;(M32700UT_PLD_IRQ_BASE + 18)&t;/* reserved */
DECL|macro|PLD_IRQ_INT19
mdefine_line|#define PLD_IRQ_INT19&t;&t;(M32700UT_PLD_IRQ_BASE + 19)&t;/* reserved */
DECL|macro|PLD_IRQ_INT20
mdefine_line|#define PLD_IRQ_INT20&t;&t;(M32700UT_PLD_IRQ_BASE + 20)&t;/* reserved */
DECL|macro|PLD_IRQ_INT21
mdefine_line|#define PLD_IRQ_INT21&t;&t;(M32700UT_PLD_IRQ_BASE + 21)&t;/* reserved */
DECL|macro|PLD_IRQ_INT22
mdefine_line|#define PLD_IRQ_INT22&t;&t;(M32700UT_PLD_IRQ_BASE + 22)&t;/* reserved */
DECL|macro|PLD_IRQ_INT23
mdefine_line|#define PLD_IRQ_INT23&t;&t;(M32700UT_PLD_IRQ_BASE + 23)&t;/* reserved */
DECL|macro|PLD_IRQ_INT24
mdefine_line|#define PLD_IRQ_INT24&t;&t;(M32700UT_PLD_IRQ_BASE + 24)&t;/* reserved */
DECL|macro|PLD_IRQ_INT25
mdefine_line|#define PLD_IRQ_INT25&t;&t;(M32700UT_PLD_IRQ_BASE + 25)&t;/* reserved */
DECL|macro|PLD_IRQ_INT26
mdefine_line|#define PLD_IRQ_INT26&t;&t;(M32700UT_PLD_IRQ_BASE + 26)&t;/* reserved */
DECL|macro|PLD_IRQ_INT27
mdefine_line|#define PLD_IRQ_INT27&t;&t;(M32700UT_PLD_IRQ_BASE + 27)&t;/* reserved */
DECL|macro|PLD_IRQ_INT28
mdefine_line|#define PLD_IRQ_INT28&t;&t;(M32700UT_PLD_IRQ_BASE + 28)&t;/* reserved */
DECL|macro|PLD_IRQ_INT29
mdefine_line|#define PLD_IRQ_INT29&t;&t;(M32700UT_PLD_IRQ_BASE + 29)&t;/* reserved */
DECL|macro|PLD_IRQ_INT30
mdefine_line|#define PLD_IRQ_INT30&t;&t;(M32700UT_PLD_IRQ_BASE + 30)&t;/* reserved */
DECL|macro|PLD_IRQ_INT31
mdefine_line|#define PLD_IRQ_INT31&t;&t;(M32700UT_PLD_IRQ_BASE + 31)&t;/* reserved */
...
mdefine_line|#define PLD_IRQ_CF0&t;&t;(M32700UT_PLD_IRQ_BASE + 3)&t;/* CF0# */
DECL|macro|PLD_IRQ_CF1
mdefine_line|#define PLD_IRQ_CF1&t;&t;(M32700UT_PLD_IRQ_BASE + 4)&t;/* CF1# */
DECL|macro|PLD_IRQ_CF2
mdefine_line|#define PLD_IRQ_CF2&t;&t;(M32700UT_PLD_IRQ_BASE + 5)&t;/* CF2# */
DECL|macro|PLD_IRQ_CF3
mdefine_line|#define PLD_IRQ_CF3&t;&t;(M32700UT_PLD_IRQ_BASE + 6)&t;/* CF3# */
DECL|macro|PLD_IRQ_CF4
mdefine_line|#define PLD_IRQ_CF4&t;&t;(M32700UT_PLD_IRQ_BASE + 7)&t;/* CF4# */
DECL|macro|PLD_IRQ_INT8
mdefine_line|#define PLD_IRQ_INT8&t;&t;(M32700UT_PLD_IRQ_BASE + 8)&t;/* reserved */
DECL|macro|PLD_IRQ_INT9
mdefine_line|#define PLD_IRQ_INT9&t;&t;(M32700UT_PLD_IRQ_BASE + 9)&t;/* reserved */
...
mdefine_line|#define PLD_IRQ_INT11&t;&t;(M32700UT_PLD_IRQ_BASE + 11)&t;/* reserved */
DECL|macro|PLD_IRQ_UART0
mdefine_line|#define PLD_IRQ_UART0&t;&t;(M32700UT_PLD_IRQ_BASE + 12)&t;/* UARTIRQ0 */
DECL|macro|PLD_IRQ_UART1
mdefine_line|#define PLD_IRQ_UART1&t;&t;(M32700UT_PLD_IRQ_BASE + 13)&t;/* UARTIRQ1 */
DECL|macro|PLD_IRQ_INT14
mdefine_line|#define PLD_IRQ_INT14&t;&t;(M32700UT_PLD_IRQ_BASE + 14)&t;/* reserved */
DECL|macro|PLD_IRQ_INT15
mdefine_line|#define PLD_IRQ_INT15&t;&t;(M32700UT_PLD_IRQ_BASE + 15)&t;/* reserved */
DECL|macro|PLD_IRQ_SNDINT
mdefine_line|#define PLD_IRQ_SNDINT&t;&t;(M32700UT_PLD_IRQ_BASE + 16)&t;/* SNDINT# */
DECL|macro|PLD_IRQ_INT17
mdefine_line|#define PLD_IRQ_INT17&t;&t;(M32700UT_PLD_IRQ_BASE + 17)&t;/* reserved */
DECL|macro|PLD_IRQ_INT18
mdefine_line|#define PLD_IRQ_INT18&t;&t;(M32700UT_PLD_IRQ_BASE + 18)&t;/* reserved */
DECL|macro|PLD_IRQ_INT19
mdefine_line|#define PLD_IRQ_INT19&t;&t;(M32700UT_PLD_IRQ_BASE + 19)&t;/* reserved */
...
macro_line|#endif&t;/* _M32700UT_M32700UT_PLD.H */
eof

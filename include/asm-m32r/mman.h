macro_line|#ifndef __M32R_MMAN_H__
DECL|macro|__M32R_MMAN_H__
mdefine_line|#define __M32R_MMAN_H__
multiline_comment|/* orig : i386 2.6.0-test6 */
...
macro_line|#endif /* __M32R_MMAN_H__ */
eof

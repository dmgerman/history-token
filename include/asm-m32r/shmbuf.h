macro_line|#ifndef _ASM_M32R_SHMBUF_H
DECL|macro|_ASM_M32R_SHMBUF_H
mdefine_line|#define _ASM_M32R_SHMBUF_H
multiline_comment|/* $Id$ */
multiline_comment|/* orig : i386 2.4.18 */
multiline_comment|/*&n; * The shmid64_ds structure for M32R architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 64-bit time_t to solve y2038 problem&n; * - 2 miscellaneous 32-bit values&n; */
...
suffix:semicolon
macro_line|#endif /* _ASM_M32R_SHMBUF_H */
eof

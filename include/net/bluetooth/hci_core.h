...
comma
DECL|enumerator|HCI_CONN_RSWITCH_PEND
...
suffix:semicolon
multiline_comment|/* ----- HCI callbacks ----- */
DECL|struct|hci_cb
r_struct
id|hci_cb
(brace
...
DECL|function|hci_key_change_cfm
r_static
r_inline
r_void
id|hci_key_change_cfm
c_func
(paren
r_struct
id|hci_conn
...
DECL|function|hci_role_switch_cfm
r_static
r_inline
r_void
id|hci_role_switch_cfm
c_func
(paren
r_struct
id|hci_conn

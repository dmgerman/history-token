...
suffix:semicolon
DECL|macro|DN_SK
mdefine_line|#define DN_SK(__sk) ((struct dn_scp *)(__sk)-&gt;sk_protinfo)
...
DECL|function|dn_sk_ports_copy
r_static
r_inline
r_void
id|dn_sk_ports_copy
...
(brace
id|fl-&gt;uli_u.dnports.sport
op_assign
id|scp-&gt;addrloc
suffix:semicolon
id|fl-&gt;uli_u.dnports.dport
op_assign
id|scp-&gt;addrrem
suffix:semicolon
id|fl-&gt;uli_u.dnports.objnum
op_assign

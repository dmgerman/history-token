...
macro_line|#endif
macro_line|#if defined(CONFIG_IP_ROUTE_MULTIPATH_RR) || defined(CONFIG_IP_ROUTE_MULTIPATH_DRR)
r_extern
r_void
...
macro_line|#else /* CONFIG_IP_ROUTE_MULTIPATH_RR || CONFIG_IP_ROUTE_MULTIPATH_DRR */
DECL|function|multipath_remove
r_static
r_inline
r_void
...
macro_line|#endif /* CONFIG_IP_ROUTE_MULTIPATH_RR || CONFIG_IP_ROUTE_MULTIPATH_DRR */
...
suffix:semicolon
DECL|function|multipath_selectroute
r_static
r_inline
r_int

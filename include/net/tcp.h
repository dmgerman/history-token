...
suffix:semicolon
DECL|macro|tb_for_each
mdefine_line|#define tb_for_each(tb, node, head) hlist_for_each_entry(tb, node, head, node)
...
(brace
r_return
id|tw-&gt;tw_death_node.pprev
op_ne
l_int|NULL
suffix:semicolon
)brace
DECL|function|tw_dead_node_init
r_static
id|__inline__
r_void
...
DECL|function|__tw_del_dead_node
r_static
id|__inline__
r_void
id|__tw_del_dead_node
c_func
(paren
r_struct
id|tcp_tw_bucket
...
DECL|function|tw_del_dead_node
r_static
id|__inline__
r_int
id|tw_del_dead_node
...
DECL|macro|tcptw_sk_ipv6only
mdefine_line|#define tcptw_sk_ipv6only(__sk)&t;(tcptw_sk(__sk)-&gt;tw_v6_ipv6only)
DECL|function|tcp_v6_ipv6only
r_static
r_inline
r_int
id|tcp_v6_ipv6only
...
macro_line|#else
DECL|macro|__tcp_v6_rcv_saddr
macro_line|# define __tcp_v6_rcv_saddr(__sk)&t;NULL
DECL|macro|tcp_v6_rcv_saddr
macro_line|# define tcp_v6_rcv_saddr(__sk)&t;&t;NULL
DECL|macro|tcptw_sk_ipv6only
macro_line|# define tcptw_sk_ipv6only(__sk)&t;0
DECL|macro|tcp_v6_ipv6only
macro_line|# define tcp_v6_ipv6only(__sk)&t;&t;0
macro_line|#endif
r_extern
id|kmem_cache_t
op_star
...
mdefine_line|#define TCP_SYNQ_HSIZE&t;&t;512&t;/* Size of SYNACK hash table */
...
multiline_comment|/* Compute the current effective MSS, taking SACKs and IP options,&n; * and even PMTU discovery events into account.&n; *&n; * LARGESEND note: !urg_mode is overkill, only frames up to snd_up&n; * cannot be large. However, taking into account rare use of URG, this&n; * is not a big flaw.&n; */
...
DECL|function|tcp_fast_path_check
r_static
r_inline
r_void
...
multiline_comment|/* Due to TSO, an SKB can be composed of multiple actual&n; * packets.  To keep these tracked properly, we use this.&n; */
DECL|function|tcp_skb_pcount
r_static
r_inline
r_int
id|tcp_skb_pcount
...
DECL|function|tcp_inc_pcount_explicit
r_static
r_inline
r_void
id|tcp_inc_pcount_explicit
c_func
(paren
id|tcp_pcount_t
op_star
...
DECL|function|tcp_dec_pcount_explicit
r_static
r_inline
r_void
...
DECL|function|tcp_dec_pcount_approx
r_static
r_inline
r_void
...
DECL|function|tcp_packets_out_inc
r_static
r_inline
r_void
id|tcp_packets_out_inc
c_func
(paren
r_struct
id|sock
...
DECL|function|tcp_packets_out_dec
r_static
r_inline
r_void
...
DECL|function|tcp_sync_left_out
r_static
r_inline
r_void
...
multiline_comment|/* Packet is added to VJ-style prequeue for processing in process&n; * context, if a reader task is waiting. Apparently, this exciting&n; * idea (VJ&squot;s mail &quot;Re: query about TCP header on tcp-ip&quot; of 07 Sep 93)&n; * failed somewhere. Latency? Burstiness? Well, at least now we will&n; * see, why it failed. 8)8)&t;&t;&t;&t;  --ANK&n; *&n; * NOTE: is this not too big to inline?&n; */
...
multiline_comment|/* Determine a window scaling and initial window to offer. */
r_extern
r_void
...
DECL|function|tcp_v4_setup_caps
r_static
r_inline
r_void
...
suffix:semicolon
multiline_comment|/* F-RTO must be activated in sysctl and there must be some&n;&t; * unsent new data, and the advertised window should allow&n;&t; * sending it.&n;&t; */
r_return
(paren
id|sysctl_tcp_frto
op_logical_and
...
suffix:semicolon
multiline_comment|/* TCP Westwood functions and constants */
DECL|macro|TCP_WESTWOOD_INIT_RTT
mdefine_line|#define TCP_WESTWOOD_INIT_RTT  (20*HZ)           /* maybe too conservative?! */
DECL|macro|TCP_WESTWOOD_RTT_MIN
mdefine_line|#define TCP_WESTWOOD_RTT_MIN   (HZ/20)           /* 50ms */
DECL|function|tcp_westwood_update_rtt
r_static
r_inline
r_void
...
DECL|function|__tcp_westwood_bw_rttmin
r_static
r_inline
id|__u32
...
DECL|function|tcp_westwood_bw_rttmin
r_static
r_inline
id|__u32
...
DECL|function|tcp_westwood_ssthresh
r_static
r_inline
r_int
...
DECL|function|tcp_westwood_cwnd
r_static
r_inline
r_int

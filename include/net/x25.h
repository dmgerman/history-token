...
multiline_comment|/**&n; *&t;struct x25_route - x25 routing entry&n; *&t;@node - entry in x25_list_lock&n; *&t;@address - Start of address range&n; *&t;@sigdigits - Number of sig digits&n; *&t;@dev - More than one for MLP&n; *&t;@refcnt - reference counter&n; */
...
suffix:semicolon
multiline_comment|/* x25_neigh.c */
DECL|function|x25_neigh_hold
r_static
id|__inline__
r_void
id|x25_neigh_hold

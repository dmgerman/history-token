...
DECL|function|__ipv6_prefix_equal
r_static
r_inline
r_int
id|__ipv6_prefix_equal
c_func
(paren
r_const
id|u32
...
id|pbi
suffix:semicolon
multiline_comment|/* check complete u32 in prefix */
id|pdw
op_assign
id|prefixlen
op_rshift
...
l_int|0
suffix:semicolon
multiline_comment|/* check incomplete u32 in prefix */
id|pbi
op_assign
id|prefixlen
op_amp
...
DECL|function|ipv6_prefix_equal
r_static
r_inline
r_int

macro_line|#ifndef __ASM_ARM_IOCTLS_H
DECL|macro|__ASM_ARM_IOCTLS_H
mdefine_line|#define __ASM_ARM_IOCTLS_H
...
mdefine_line|#define TIOCSER_TEMT&t;0x01&t;/* Transmitter physically empty */
macro_line|#endif
eof

multiline_comment|/*&n; * include/asm-arm/arch-l7200/irqs.h&n; *&n; * Copyright (C) 2000 Rob Scott (rscott@mtrob.fdns.net)&n; *                    Steve Hill (sjhill@cotw.com)&n; *&n; * Changelog:&n; *   01-02-2000 RS&t;Create l7200 version&n; *   03-28-2000 SJH&t;Removed unused interrupt&n; *   07-28-2000 SJH&t;Added pseudo-keyboard interrupt&n; */
multiline_comment|/*&n; * NOTE: The second timer (Timer 2) is used as the keyboard&n; *       interrupt when the keyboard driver is enabled.&n; */
DECL|macro|NR_IRQS
...
mdefine_line|#define IRQ_GCTC2         5   /* Timer 2 / Keyboard */
DECL|macro|IRQ_DMA
...
DECL|macro|IRQ_UCB1200
mdefine_line|#define IRQ_UCB1200      29   /* Interrupt generated by UCB1200*/
...
mdefine_line|#define FIQ_START&t;64
eof

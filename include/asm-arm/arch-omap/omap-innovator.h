...
mdefine_line|#define MAXIRQNUM&t;&t;(IH_FPGA_BASE + NR_FPGA_IRQS - 1)
...
suffix:semicolon
macro_line|#endif
macro_line|#elif defined (CONFIG_ARCH_OMAP1610)
...
macro_line|#else
macro_line|#error &quot;Only OMAP1510 and OMAP1610 Innovator supported!&quot;
macro_line|#endif
macro_line|#endif
eof

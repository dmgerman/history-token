multiline_comment|/*&n; *  linux/include/asm-arm/arch-omap/omap-perseus2.h&n; *&n; *  Copyright 2003 by Texas Instruments Incorporated&n; *    OMAP730 / P2-sample additions&n; *    Author: Jean Pihet&n; *&n; * Copyright (C) 2001 RidgeRun, Inc. (http://www.ridgerun.com)&n; * Author: RidgeRun, Inc.&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2 of the License, or (at your&n; * option) any later version.&n; *&n; * THIS SOFTWARE IS PROVIDED ``AS IS&squot;&squot; AND ANY EXPRESS OR IMPLIED&n; * WARRANTIES, INCLUDING, BUT NOT LIMITED TO, THE IMPLIED WARRANTIES OF&n; * MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE ARE DISCLAIMED. IN&n; * NO EVENT SHALL THE AUTHOR BE LIABLE FOR ANY DIRECT, INDIRECT,&n; * INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES (INCLUDING, BUT&n; * NOT LIMITED TO, PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES; LOSS OF&n; * USE, DATA, OR PROFITS; OR BUSINESS INTERRUPTION) HOWEVER CAUSED AND ON&n; * ANY THEORY OF LIABILITY, WHETHER IN CONTRACT, STRICT LIABILITY, OR TORT&n; * (INCLUDING NEGLIGENCE OR OTHERWISE) ARISING IN ANY WAY OUT OF THE USE OF&n; * THIS SOFTWARE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE.&n; *&n; * You should have received a copy of the GNU General Public License along&n; * with this program; if not, write to the Free Software Foundation, Inc.,&n; * 675 Mass Ave, Cambridge, MA 02139, USA.&n; */
...
multiline_comment|/* ---------------------------------------------------------------------------&n; *  OMAP730 Debug Board FPGA&n; * ---------------------------------------------------------------------------&n; *&n; */
...
multiline_comment|/* 2.9.6 Traffic Controller Memory Interface Registers */
DECL|macro|OMAP_FLASH_CFG_0
mdefine_line|#define OMAP_FLASH_CFG_0&t;&t;0xfffecc10
DECL|macro|OMAP_FLASH_ACFG_0
mdefine_line|#define OMAP_FLASH_ACFG_0&t;&t;0xfffecc50
DECL|macro|OMAP_FLASH_CFG_1
mdefine_line|#define OMAP_FLASH_CFG_1&t;&t;0xfffecc14
DECL|macro|OMAP_FLASH_ACFG_1
mdefine_line|#define OMAP_FLASH_ACFG_1&t;&t;0xfffecc54
multiline_comment|/*&n; * Configuration Registers&n; */
DECL|macro|PERSEUS2_CONFIG_BASE
mdefine_line|#define PERSEUS2_CONFIG_BASE&t;   0xfffe1000
DECL|macro|PERSEUS2_IO_CONF_0
mdefine_line|#define PERSEUS2_IO_CONF_0&t;   0xfffe1070
DECL|macro|PERSEUS2_IO_CONF_1
mdefine_line|#define PERSEUS2_IO_CONF_1&t;   0xfffe1074
DECL|macro|PERSEUS2_IO_CONF_2
mdefine_line|#define PERSEUS2_IO_CONF_2&t;   0xfffe1078
DECL|macro|PERSEUS2_IO_CONF_3
mdefine_line|#define PERSEUS2_IO_CONF_3&t;   0xfffe107c
DECL|macro|PERSEUS2_IO_CONF_4
mdefine_line|#define PERSEUS2_IO_CONF_4&t;   0xfffe1080
DECL|macro|PERSEUS2_IO_CONF_5
mdefine_line|#define PERSEUS2_IO_CONF_5&t;   0xfffe1084
DECL|macro|PERSEUS2_IO_CONF_6
mdefine_line|#define PERSEUS2_IO_CONF_6&t;   0xfffe1088
DECL|macro|PERSEUS2_IO_CONF_7
mdefine_line|#define PERSEUS2_IO_CONF_7&t;   0xfffe108c
DECL|macro|PERSEUS2_IO_CONF_8
mdefine_line|#define PERSEUS2_IO_CONF_8&t;   0xfffe1090
DECL|macro|PERSEUS2_IO_CONF_9
mdefine_line|#define PERSEUS2_IO_CONF_9&t;   0xfffe1094
DECL|macro|PERSEUS2_IO_CONF_10
mdefine_line|#define PERSEUS2_IO_CONF_10&t;   0xfffe1098
DECL|macro|PERSEUS2_IO_CONF_11
mdefine_line|#define PERSEUS2_IO_CONF_11&t;   0xfffe109c
DECL|macro|PERSEUS2_IO_CONF_12
mdefine_line|#define PERSEUS2_IO_CONF_12&t;   0xfffe10a0
DECL|macro|PERSEUS2_IO_CONF_13
mdefine_line|#define PERSEUS2_IO_CONF_13&t;   0xfffe10a4
DECL|macro|PERSEUS2_MODE_1
mdefine_line|#define PERSEUS2_MODE_1&t;&t;   0xfffe1010
DECL|macro|PERSEUS2_MODE_2
mdefine_line|#define PERSEUS2_MODE_2&t;&t;   0xfffe1014
multiline_comment|/* CSMI specials: in terms of base + offset */
DECL|macro|PERSEUS2_MODE2_OFFSET
mdefine_line|#define PERSEUS2_MODE2_OFFSET&t;   0x14
multiline_comment|/* DSP control: ICR registers */
DECL|macro|ICR_BASE
mdefine_line|#define ICR_BASE&t;&t;0xfffbb800
multiline_comment|/* M_CTL */
DECL|macro|DSP_M_CTL
mdefine_line|#define DSP_M_CTL&t;&t;((volatile __u16 *)0xfffbb804)
multiline_comment|/* DSP control: MMU registers */
DECL|macro|DSP_MMU_BASE
mdefine_line|#define DSP_MMU_BASE&t;&t;((volatile __u16 *)0xfffed200)
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* PCC_UPLD control register: OMAP730 */
DECL|macro|PCC_UPLD_CTRL_REG_BASE
mdefine_line|#define PCC_UPLD_CTRL_REG_BASE&t;(0xfffe0900)
DECL|macro|PCC_UPLD_CTRL_REG
mdefine_line|#define PCC_UPLD_CTRL_REG&t;(volatile __u16 *)(PCC_UPLD_CTRL_REG_BASE + 0x00)
macro_line|#else

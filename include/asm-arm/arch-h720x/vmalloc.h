multiline_comment|/*&n; * linux/include/asm-arm/arch-h720x/vmalloc.h&n; */
macro_line|#ifndef __ARCH_ARM_VMALLOC_H
DECL|macro|__ARCH_ARM_VMALLOC_H
mdefine_line|#define __ARCH_ARM_VMALLOC_H

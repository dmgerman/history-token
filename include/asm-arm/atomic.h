...
mdefine_line|#define atomic_inc(v)&t;atomic_add(1, v)
DECL|macro|atomic_dec
mdefine_line|#define atomic_dec(v)&t;atomic_sub(1, v)
...
c_func
(paren
l_string|&quot;@ atomic_dec_and_test&bslash;n&quot;
l_string|&quot;1:&t;ldrex&t;%0, [%2]&bslash;n&quot;
...
c_func
(paren
l_string|&quot;@ atomic_add_negative&bslash;n&quot;
l_string|&quot;1:&t;ldrex&t;%0, [%2]&bslash;n&quot;
l_string|&quot;&t;add&t;%0, %0, %3&bslash;n&quot;
l_string|&quot;&t;strex&t;%1, %0, [%2]&bslash;n&quot;
l_string|&quot;&t;teq&t;%1, #0&bslash;n&quot;

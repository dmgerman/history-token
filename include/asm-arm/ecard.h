...
id|ecard_bus_type
suffix:semicolon
DECL|macro|ECARD_DEV
mdefine_line|#define ECARD_DEV(_d)&t;container_of((_d), struct expansion_card, dev)
DECL|struct|ecard_driver
r_struct
id|ecard_driver
(brace
DECL|member|probe
...
suffix:semicolon
DECL|macro|ECARD_DRV
mdefine_line|#define ECARD_DRV(_d)&t;container_of((_d), struct ecard_driver, drv)
DECL|macro|ecard_set_drvdata
mdefine_line|#define ecard_set_drvdata(ec,data)&t;dev_set_drvdata(&amp;(ec)-&gt;dev, (data))
DECL|macro|ecard_get_drvdata
mdefine_line|#define ecard_get_drvdata(ec)&t;&t;dev_get_drvdata(&amp;(ec)-&gt;dev)
r_int

...
mdefine_line|#define GPIO_H3600_NPOWER_BUTTON&t;GPIO_GPIO (0)
...
mdefine_line|#define EGPIO_H3600_LCD_ON       &t;(1 &lt;&lt; 6)  /* enable 3.3V to LCD.  active high. */
...
mdefine_line|#define EGPIO_H3600_AUD_PWR_ON&t;&t;(1 &lt;&lt; 11) /* apply poewr to reset of audio circuit.  active high. */
...
mdefine_line|#define H3600_EGPIO&t;(*(volatile int *)0xf0000000)
r_extern
r_void
id|clr_h3600_egpio
c_func

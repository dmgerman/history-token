multiline_comment|/* linux/include/asm/arch-s3c2410/regs-irq.h&n; *&n; * Copyright (c) 2003 Simtec Electronics &lt;linux@simtec.co.uk&gt;&n; *&t;&t;      http://www.simtec.co.uk/products/SWLINUX/&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; *&n; *&n; *&n; *  Changelog:&n; *    19-06-2003     BJD     Created file&n; *    12-03-2004     BJD     Updated include protection&n; *    10-03-2005     LCVR    Changed S3C2410_VA to S3C24XX_VA&n; */
...
mdefine_line|#define S3C2410_IRQREG(x)   ((x) + S3C24XX_VA_IRQ)
DECL|macro|S3C2410_EINTREG
mdefine_line|#define S3C2410_EINTREG(x)  ((x) + S3C24XX_VA_GPIO)

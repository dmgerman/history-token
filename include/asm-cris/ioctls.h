macro_line|#ifndef __ARCH_CRIS_IOCTLS_H__
DECL|macro|__ARCH_CRIS_IOCTLS_H__
mdefine_line|#define __ARCH_CRIS_IOCTLS_H__
multiline_comment|/* verbatim copy of asm-i386/ioctls.h */

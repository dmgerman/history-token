...
DECL|macro|IO_MASK
mdefine_line|#define IO_MASK(reg, field) IO_MASK_ (reg##_, field##_)
DECL|macro|IO_MASK_
mdefine_line|#define IO_MASK_(reg_, field_) &bslash;&n;    ( ( ( 1 &lt;&lt; reg_##_##field_##_WIDTH ) - 1 ) &lt;&lt; reg_##_##field_##_BITNR )
...
DECL|macro|IO_STATE
mdefine_line|#define IO_STATE(reg, field, state) IO_STATE_ (reg##_, field##_, _##state)
DECL|macro|IO_STATE_
mdefine_line|#define IO_STATE_(reg_, field_, _state) &bslash;&n;    ( reg_##_##field_##_state &lt;&lt; reg_##_##field_##_BITNR )
...
mdefine_line|#define IO_EXTRACT(reg, field, val) IO_EXTRACT_ (reg##_, field##_, val)
DECL|macro|IO_EXTRACT_
mdefine_line|#define IO_EXTRACT_(reg_, field_, val) ( (( ( ( 1 &lt;&lt; reg_##_##field_##_WIDTH ) &bslash;&n;     - 1 ) &lt;&lt; reg_##_##field_##_BITNR ) &amp; (val)) &gt;&gt; reg_##_##field_##_BITNR )
...
mdefine_line|#define IO_STATE_VALUE(reg, field, state) &bslash;&n;    IO_STATE_VALUE_ (reg##_, field##_, _##state)
DECL|macro|IO_STATE_VALUE_
mdefine_line|#define IO_STATE_VALUE_(reg_, field_, _state) ( reg_##_##field_##_state )
multiline_comment|/* IO_FIELD shifts the val parameter to be aligned with the bitfield&n;   specified. */
DECL|macro|IO_FIELD
mdefine_line|#define IO_FIELD(reg, field, val) IO_FIELD_ (reg##_, field##_, val)
DECL|macro|IO_FIELD_
mdefine_line|#define IO_FIELD_(reg_, field_, val) ((val) &lt;&lt; reg_##_##field_##_BITNR)
...
DECL|macro|IO_BITNR
mdefine_line|#define IO_BITNR(reg, field) IO_BITNR_ (reg##_, field##_)
DECL|macro|IO_BITNR_
mdefine_line|#define IO_BITNR_(reg_, field_) (reg_##_##field_##_BITNR)
multiline_comment|/* IO_WIDTH returns the width, in bits, of a bitfield. */
DECL|macro|IO_WIDTH
mdefine_line|#define IO_WIDTH(reg, field) IO_WIDTH_ (reg##_, field##_)
DECL|macro|IO_WIDTH_
mdefine_line|#define IO_WIDTH_(reg_, field_) (reg_##_##field_##_WIDTH)
...
DECL|macro|MEM_CSE0_SIZE
mdefine_line|#define MEM_CSE0_SIZE (0x04000000)
DECL|macro|MEM_CSE1_START
mdefine_line|#define MEM_CSE1_START (0x04000000)
DECL|macro|MEM_CSE1_SIZE
mdefine_line|#define MEM_CSE1_SIZE (0x04000000)

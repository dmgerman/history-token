macro_line|#ifndef __CRIS_IPC_H__
DECL|macro|__CRIS_IPC_H__
mdefine_line|#define __CRIS_IPC_H__
multiline_comment|/* &n; * These are used to wrap system calls on CRIS.&n; *&n; * See arch/cris/kernel/sys_cris.c for ugly details..&n; *&n; * Same as x86 version.&n; *&n; */

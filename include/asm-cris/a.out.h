macro_line|#ifndef __CRIS_A_OUT_H__
DECL|macro|__CRIS_A_OUT_H__
mdefine_line|#define __CRIS_A_OUT_H__
multiline_comment|/* we don&squot;t support a.out binaries on Linux/CRIS anyway, so this is&n; * not really used but still needed because binfmt_elf.c for some reason&n; * wants to know about a.out even if there is no interpreter available...&n; */

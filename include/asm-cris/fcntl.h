macro_line|#ifndef _CRIS_FCNTL_H
DECL|macro|_CRIS_FCNTL_H
mdefine_line|#define _CRIS_FCNTL_H
...
mdefine_line|#define F_GETLK64      12      /*  using &squot;struct flock64&squot; */

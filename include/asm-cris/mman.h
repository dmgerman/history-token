macro_line|#ifndef __CRIS_MMAN_H__
DECL|macro|__CRIS_MMAN_H__
mdefine_line|#define __CRIS_MMAN_H__
multiline_comment|/* verbatim copy of asm-i386/ version */
...
macro_line|#endif /* __CRIS_MMAN_H__ */
eof

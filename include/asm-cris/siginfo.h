macro_line|#ifndef _CRIS_SIGINFO_H
DECL|macro|_CRIS_SIGINFO_H
mdefine_line|#define _CRIS_SIGINFO_H
macro_line|#include &lt;linux/types.h&gt;
multiline_comment|/* This is copied from asm-m68k/siginfo.h.  */
DECL|union|sigval
r_typedef
r_union
id|sigval

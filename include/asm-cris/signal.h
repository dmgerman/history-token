macro_line|#ifndef _ASM_CRIS_SIGNAL_H
DECL|macro|_ASM_CRIS_SIGNAL_H
mdefine_line|#define _ASM_CRIS_SIGNAL_H
...
DECL|macro|SIGRTMAX
mdefine_line|#define SIGRTMAX        _NSIG
...
macro_line|#ifdef __KERNEL__
multiline_comment|/*&n; * These values of sa_flags are used only by the kernel as part of the&n; * irq handling routines.&n; *&n; * SA_INTERRUPT is also used by the irq handling routines.&n; * SA_SHIRQ is for shared interrupt support&n; */
DECL|macro|SA_PROBE

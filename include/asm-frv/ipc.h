macro_line|#ifndef __ASM_IPC_H__
DECL|macro|__ASM_IPC_H__
mdefine_line|#define __ASM_IPC_H__
multiline_comment|/*&n; * These are used to wrap system calls on FR-V&n; *&n; * See arch/frv/kernel/sys_frv.c for ugly details..&n; */

...
mdefine_line|#define minix_test_and_set_bit(nr, addr)&t;test_and_set_bit((nr) ^ 16, (unsigned long *)(addr))
DECL|macro|minix_set_bit
mdefine_line|#define minix_set_bit(nr,addr)&t;&t;&t;set_bit((nr) ^ 16, (unsigned long *)(addr))
DECL|macro|minix_test_and_clear_bit
mdefine_line|#define minix_test_and_clear_bit(nr, addr)&t;test_and_clear_bit((nr) ^ 16, (unsigned long *)(addr))
...
mdefine_line|#define ext2_set_bit(nr, addr)&t;&t;&t;test_and_set_bit((nr) ^ 24, (unsigned long *)(addr))
DECL|macro|ext2_set_bit_atomic
mdefine_line|#define ext2_set_bit_atomic(lock, nr, addr)&t;test_and_set_bit((nr) ^ 24, (unsigned long *)(addr))
DECL|macro|ext2_clear_bit
mdefine_line|#define ext2_clear_bit(nr, addr)&t;&t;test_and_clear_bit((nr) ^ 24, (unsigned long *)(addr))
DECL|macro|ext2_clear_bit_atomic
mdefine_line|#define ext2_clear_bit_atomic(lock, nr, addr)&t;test_and_clear_bit((nr) ^ 24, (unsigned long *)(addr))

multiline_comment|/*&n; * include/asm-m68k/serial.h&n; *&n; * currently this seems useful only for a Q40,&n; * it&squot;s an almost exact copy of ../asm-alpha/serial.h &n; *&n; */

...
mdefine_line|#define __NR_iopl&t;&t;/* 110 */ not supported
...
mdefine_line|#define _syscall0(type,name) &bslash;&n;type name(void) &bslash;&n;{ &bslash;&n;register long __res __asm__ (&quot;%d0&quot;) = __NR_##name; &bslash;&n;__asm__ __volatile__ (&quot;trap  #0&quot; &bslash;&n;                      : &quot;+d&quot; (__res) ); &bslash;&n;__syscall_return(type,__res); &bslash;&n;}
DECL|macro|_syscall1
mdefine_line|#define _syscall1(type,name,atype,a) &bslash;&n;type name(atype a) &bslash;&n;{ &bslash;&n;register long __res __asm__ (&quot;%d0&quot;) = __NR_##name; &bslash;&n;register long __a __asm__ (&quot;%d1&quot;) = (long)(a); &bslash;&n;__asm__ __volatile__ (&quot;trap  #0&quot; &bslash;&n;&t;&t;      : &quot;+d&quot; (__res) &bslash;&n;&t;&t;      : &quot;d&quot; (__a)  ); &bslash;&n;__syscall_return(type,__res); &bslash;&n;}
DECL|macro|_syscall2
mdefine_line|#define _syscall2(type,name,atype,a,btype,b) &bslash;&n;type name(atype a,btype b) &bslash;&n;{ &bslash;&n;register long __res __asm__ (&quot;%d0&quot;) = __NR_##name; &bslash;&n;register long __a __asm__ (&quot;%d1&quot;) = (long)(a); &bslash;&n;register long __b __asm__ (&quot;%d2&quot;) = (long)(b); &bslash;&n;__asm__ __volatile__ (&quot;trap  #0&quot; &bslash;&n;&t;&t;      : &quot;+d&quot; (__res) &bslash;&n;                      : &quot;d&quot; (__a), &quot;d&quot; (__b) &bslash;&n;&t;&t;     ); &bslash;&n;__syscall_return(type,__res); &bslash;&n;}
DECL|macro|_syscall3
mdefine_line|#define _syscall3(type,name,atype,a,btype,b,ctype,c) &bslash;&n;type name(atype a,btype b,ctype c) &bslash;&n;{ &bslash;&n;register long __res __asm__ (&quot;%d0&quot;) = __NR_##name; &bslash;&n;register long __a __asm__ (&quot;%d1&quot;) = (long)(a); &bslash;&n;register long __b __asm__ (&quot;%d2&quot;) = (long)(b); &bslash;&n;register long __c __asm__ (&quot;%d3&quot;) = (long)(c); &bslash;&n;__asm__ __volatile__ (&quot;trap  #0&quot; &bslash;&n;&t;&t;      : &quot;+d&quot; (__res) &bslash;&n;                      : &quot;d&quot; (__a), &quot;d&quot; (__b), &bslash;&n;&t;&t;&t;&quot;d&quot; (__c) &bslash;&n;&t;&t;     ); &bslash;&n;__syscall_return(type,__res); &bslash;&n;}

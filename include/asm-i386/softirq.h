...
mdefine_line|#define __cpu_bh_enable(cpu) &bslash;&n;&t;&t;do { barrier(); local_bh_count(cpu)--; preempt_enable(); } while (0)
DECL|macro|cpu_bh_disable
mdefine_line|#define cpu_bh_disable(cpu) &bslash;&n;&t;&t;do { preempt_disable(); local_bh_count(cpu)++; barrier(); } while (0)

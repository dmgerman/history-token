multiline_comment|/*&n; *  include/asm-i386/mach-default/apm.h&n; *&n; *  Machine specific APM BIOS functions for generic.&n; *  Split out from apm.c by Osamu Tomita &lt;tomita@cinet.co.jp&gt;&n; */

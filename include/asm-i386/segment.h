...
multiline_comment|/*&n; * The layout of the per-CPU GDT under Linux:&n; *&n; *   0 - null&n; *   1 - reserved&n; *   2 - reserved&n; *   3 - reserved&n; *&n; *   4 - default user CS&t;&t;&lt;==== new cacheline&n; *   5 - default user DS&n; *&n; *  ------- start of TLS (Thread-Local Storage) segments:&n; *&n; *   6 - TLS segment #1&t;&t;&t;[ glibc&squot;s TLS segment ]&n; *   7 - TLS segment #2&t;&t;&t;[ Wine&squot;s %fs Win32 segment ]&n; *   8 - TLS segment #3&n; *   9 - reserved&n; *  10 - reserved&n; *  11 - reserved&n; *&n; *  ------- start of kernel segments:&n; *&n; *  12 - kernel code segment&t;&t;&lt;==== new cacheline&n; *  13 - kernel data segment&n; *  14 - TSS&n; *  15 - LDT&n; *  16 - PNPBIOS support (16-&gt;32 gate)&n; *  17 - PNPBIOS support&n; *  18 - PNPBIOS support&n; *  19 - PNPBIOS support&n; *  20 - PNPBIOS support&n; *  21 - APM BIOS support&n; *  22 - APM BIOS support&n; *  23 - APM BIOS support &n; */
...
mdefine_line|#define GDT_ENTRY_TSS&t;&t;&t;(GDT_ENTRY_KERNEL_BASE + 2)
DECL|macro|GDT_ENTRY_LDT
mdefine_line|#define GDT_ENTRY_LDT&t;&t;&t;(GDT_ENTRY_KERNEL_BASE + 3)
DECL|macro|GDT_ENTRY_PNPBIOS_BASE
mdefine_line|#define GDT_ENTRY_PNPBIOS_BASE&t;&t;(GDT_ENTRY_KERNEL_BASE + 4)
DECL|macro|GDT_ENTRY_APMBIOS_BASE
mdefine_line|#define GDT_ENTRY_APMBIOS_BASE&t;&t;(GDT_ENTRY_KERNEL_BASE + 9)
multiline_comment|/*&n; * The GDT has 21 entries but we pad it to cacheline boundary:&n; */

...
DECL|macro|GDT_ENTRY_ESPFIX_SS
mdefine_line|#define GDT_ENTRY_ESPFIX_SS&t;&t;(GDT_ENTRY_KERNEL_BASE + 14)
DECL|macro|__ESPFIX_SS
mdefine_line|#define __ESPFIX_SS (GDT_ENTRY_ESPFIX_SS * 8)

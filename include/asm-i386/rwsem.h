multiline_comment|/* rwsem.h: R/W semaphores implemented using XADD/CMPXCHG for i486+&n; *&n; * Written by David Howells (dhowells@redhat.com).&n; *&n; * Derived from asm-i386/semaphore.h&n; */

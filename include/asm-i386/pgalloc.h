...
mdefine_line|#define pmd_populate(pmd, pte)&t;&t;set_pmd(pmd, __pmd(_PAGE_TABLE + __pa(pte)))
...
mdefine_line|#define pte_free_kernel(pte)&t;pte_free_slow(pte)
DECL|macro|pte_free
...
DECL|macro|pmd_free_one
mdefine_line|#define pmd_free_one(pmd)&t;free_pmd_slow(pmd)

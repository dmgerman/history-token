...
multiline_comment|/*&n; * On PC-9800, continuation on warm reset is done by loading&n; * %ss:%sp from 0x0000:0404 and executing &squot;lret&squot;, so:&n; */
DECL|macro|TRAMPOLINE_LOW
mdefine_line|#define TRAMPOLINE_LOW phys_to_virt(0x4fa)
DECL|macro|TRAMPOLINE_HIGH
mdefine_line|#define TRAMPOLINE_HIGH phys_to_virt(0x4fc)

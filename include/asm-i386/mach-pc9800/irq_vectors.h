...
DECL|macro|FPU_IRQ
mdefine_line|#define FPU_IRQ&t;&t;&t;8
DECL|macro|FIRST_VM86_IRQ
mdefine_line|#define&t;FIRST_VM86_IRQ&t;&t;2
DECL|macro|LAST_VM86_IRQ
mdefine_line|#define LAST_VM86_IRQ&t;&t;15
DECL|macro|invalid_vm86_irq
mdefine_line|#define invalid_vm86_irq(irq)&t;((irq) &lt; 2 || (irq) == 7 || (irq) &gt; 15)

...
mdefine_line|#define __cpu_bh_enable(cpu) &bslash;&n;                do { barrier(); local_bh_count(cpu)--; } while (0)
DECL|macro|cpu_bh_disable
mdefine_line|#define cpu_bh_disable(cpu) &bslash;&n;                do { local_bh_count(cpu)++; barrier(); } while (0)
...
mdefine_line|#define local_bh_enable()&t;&t;&t;          &t;        &bslash;&n;do {&t;&t;&t;&t;&t;&t;&t;                &bslash;&n;        unsigned int *ptr = &amp;local_bh_count(smp_processor_id());        &bslash;&n;        barrier();                                                      &bslash;&n;        if (!--*ptr)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;if (softirq_pending(smp_processor_id()))&t;&t;&bslash;&n;&t;&t;&t;/* Use the async. stack for softirq */&t;&t;&bslash;&n;&t;&t;&t;do_call_softirq();&t;&t;&t;&t;&bslash;&n;} while (0)

multiline_comment|/*&n; *  include/asm-s390/s390-regs-common.h&n; *&n; *  S390 version&n; *    Copyright (C) 1999 IBM Deutschland Entwicklung GmbH, IBM Corporation&n; *    Author(s): Denis Joseph Barrow (djbarrow@de.ibm.com,barrow_dj@yahoo.com)&n; *&n; *  this file is designed to keep as much compatibility between&n; *  gdb&squot;s representation of registers &amp; the kernels representation of registers&n; *  as possible so as to minimise translation between gdb registers &amp;&n; *  kernel registers please keep this matched with gdb &amp; strace &n; */
...
mdefine_line|#define REGISTER_SIZE 8
macro_line|#endif
DECL|macro|NUM_GPRS
...
mdefine_line|#define PSW_MASK_SIZE 8
DECL|macro|PSW_ADDR_SIZE
mdefine_line|#define PSW_ADDR_SIZE 8
DECL|macro|NUM_FPRS
...
mdefine_line|#define S390_REGS_COMMON       &bslash;&n;psw_t psw;                     &bslash;&n;__u64 gprs[NUM_GPRS];          &bslash;&n;__u32  acrs[NUM_ACRS];         &bslash;&n;
r_typedef
r_struct
(brace
id|S390_REGS_COMMON

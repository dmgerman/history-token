...
DECL|macro|set_fs
mdefine_line|#define set_fs(x)       ({asm volatile(&quot;sar   4,%0&quot;::&quot;a&quot; ((x).ar4));&bslash;&n;                          current-&gt;addr_limit = (x);})
...
mdefine_line|#define __put_user(x, ptr)                                      &bslash;&n;({                                                              &bslash;&n;        int __pu_err;                                           &bslash;&n;        switch (sizeof (*(ptr))) {                              &bslash;&n;                case 1:                                         &bslash;&n;                        __pu_err = __put_user_asm_1((__u8)(__u64)(x),(ptr));&bslash;&n;                        break;                                  &bslash;&n;                case 2:                                         &bslash;&n;                        __pu_err = __put_user_asm_2((__u16)(__u64)(x),(ptr));&bslash;&n;                        break;                                  &bslash;&n;                case 4:                                         &bslash;&n;                        __pu_err = __put_user_asm_4((__u32)(__u64)(x),(ptr));&bslash;&n;                        break;                                  &bslash;&n;                case 8:                                         &bslash;&n;                        __pu_err = __put_user_asm_8((__u64)(x),(ptr));&bslash;&n;                        break;                                  &bslash;&n;                default:                                        &bslash;&n;                __pu_err = __put_user_bad();                    &bslash;&n;                break;                                          &bslash;&n;         }                                                      &bslash;&n;        __pu_err;                                               &bslash;&n;})
DECL|macro|put_user
...
mdefine_line|#define __get_user_asm_8(x, ptr, err)                                      &bslash;&n;({                                                                         &bslash;&n;        __asm__ __volatile__ (  &quot;   sr    %1,%1&bslash;n&quot;                         &bslash;&n;                                &quot;   la    4,%2&bslash;n&quot;                          &bslash;&n;                                &quot;   sacf  512&bslash;n&quot;                           &bslash;&n;                                &quot;0: lg    %0,0(4)&bslash;n&quot;                       &bslash;&n;                                &quot;1: sacf  0&bslash;n&quot;                             &bslash;&n;                                &quot;.section .fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot;                 &bslash;&n;                                &quot;2: lhi   %1,%h3&bslash;n&quot;                        &bslash;&n;                                &quot;   jg    1b&bslash;n&quot;                            &bslash;&n;                                &quot;.previous&bslash;n&quot;                              &bslash;&n;                                &quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;              &bslash;&n;                                &quot;   .align 8&bslash;n&quot;                            &bslash;&n;                                &quot;   .quad 0b,2b&bslash;n&quot;                         &bslash;&n;                                &quot;.previous&quot;                                &bslash;&n;                                : &quot;=d&quot; (x) , &quot;=&amp;d&quot; (err)                   &bslash;&n;                                : &quot;m&quot; (*(const __u64*)(ptr)),&quot;K&quot; (-EFAULT) &bslash;&n;                                : &quot;4&quot; );                                   &bslash;&n;})
DECL|macro|__get_user_asm_4
mdefine_line|#define __get_user_asm_4(x, ptr, err)                                      &bslash;&n;({                                                                         &bslash;&n;        __asm__ __volatile__ (  &quot;   sr    %1,%1&bslash;n&quot;                         &bslash;&n;                                &quot;   la    4,%2&bslash;n&quot;                          &bslash;&n;                                &quot;   sacf  512&bslash;n&quot;                           &bslash;&n;                                &quot;0: l     %0,0(4)&bslash;n&quot;                       &bslash;&n;                                &quot;1: sacf  0&bslash;n&quot;                             &bslash;&n;                                &quot;.section .fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot;                 &bslash;&n;                                &quot;2: lhi   %1,%h3&bslash;n&quot;                        &bslash;&n;                                &quot;   jg    1b&bslash;n&quot;                            &bslash;&n;                                &quot;.previous&bslash;n&quot;                              &bslash;&n;                                &quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;              &bslash;&n;                                &quot;   .align 8&bslash;n&quot;                            &bslash;&n;                                &quot;   .quad 0b,2b&bslash;n&quot;                         &bslash;&n;                                &quot;.previous&quot;                                &bslash;&n;                                : &quot;=d&quot; (x) , &quot;=&amp;d&quot; (err)                   &bslash;&n;                                : &quot;m&quot; (*(const __u32*)(ptr)),&quot;K&quot; (-EFAULT) &bslash;&n;                                : &quot;4&quot; );                                   &bslash;&n;})
DECL|macro|__get_user_asm_2
mdefine_line|#define __get_user_asm_2(x, ptr, err)                                      &bslash;&n;({                                                                         &bslash;&n;        __asm__ __volatile__ (  &quot;   sr    %1,%1&bslash;n&quot;                         &bslash;&n;                                &quot;   la    4,%2&bslash;n&quot;                          &bslash;&n;                                &quot;   sacf  512&bslash;n&quot;                           &bslash;&n;                                &quot;0: lh    %0,0(4)&bslash;n&quot;                       &bslash;&n;                                &quot;1: sacf  0&bslash;n&quot;                             &bslash;&n;                                &quot;.section .fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot;                 &bslash;&n;                                &quot;2: lhi   %1,%h3&bslash;n&quot;                        &bslash;&n;                                &quot;   jg    1b&bslash;n&quot;                            &bslash;&n;                                &quot;.previous&bslash;n&quot;                              &bslash;&n;                                &quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;              &bslash;&n;                                &quot;   .align 8&bslash;n&quot;                            &bslash;&n;                                &quot;   .quad 0b,2b&bslash;n&quot;                         &bslash;&n;                                &quot;.previous&quot;                                &bslash;&n;                                : &quot;=d&quot; (x) , &quot;=&amp;d&quot; (err)                   &bslash;&n;                                : &quot;m&quot; (*(const __u16*)(ptr)),&quot;K&quot; (-EFAULT) &bslash;&n;                                : &quot;4&quot; );                                   &bslash;&n;})
DECL|macro|__get_user_asm_1
mdefine_line|#define __get_user_asm_1(x, ptr, err)                                     &bslash;&n;({                                                                        &bslash;&n;        __asm__ __volatile__ (  &quot;   sr    %1,%1&bslash;n&quot;                        &bslash;&n;                                &quot;   la    4,%2&bslash;n&quot;                         &bslash;&n;                                &quot;   sr    %0,%0&bslash;n&quot;                        &bslash;&n;                                &quot;   sacf  512&bslash;n&quot;                          &bslash;&n;                                &quot;0: ic    %0,0(4)&bslash;n&quot;                      &bslash;&n;                                &quot;1: sacf  0&bslash;n&quot;                            &bslash;&n;                                &quot;.section .fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot;                &bslash;&n;                                &quot;2: lhi   %1,%h3&bslash;n&quot;                       &bslash;&n;                                &quot;   jg    1b&bslash;n&quot;                           &bslash;&n;                                &quot;.previous&bslash;n&quot;                             &bslash;&n;                                &quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;             &bslash;&n;                                &quot;   .align 8&bslash;n&quot;                           &bslash;&n;                                &quot;   .quad 0b,2b&bslash;n&quot;                        &bslash;&n;                                &quot;.previous&quot;                               &bslash;&n;                                : &quot;=d&quot; (x) , &quot;=&amp;d&quot; (err)                  &bslash;&n;                                : &quot;m&quot; (*(const __u8*)(ptr)),&quot;K&quot; (-EFAULT) &bslash;&n;                                : &quot;4&quot; );                                  &bslash;&n;})
...
l_string|&quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;
l_string|&quot;   .align 8&bslash;n&quot;
l_string|&quot;   .quad  0b,__copy_to_user_fixup&bslash;n&quot;
l_string|&quot;.previous&quot;
suffix:colon
l_string|&quot;+&amp;d&quot;
(paren
...
l_string|&quot;   jo    0b&bslash;n&quot;
l_string|&quot;   sacf  0&bslash;n&quot;
l_string|&quot;   lgr   %0,5&bslash;n&quot;
l_string|&quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;
l_string|&quot;   .align 8&bslash;n&quot;
l_string|&quot;   .quad  0b,__copy_from_user_fixup&bslash;n&quot;
l_string|&quot;.previous&quot;
suffix:colon
l_string|&quot;+&amp;d&quot;
(paren
...
l_string|&quot;   je    2f&bslash;n&quot;
l_string|&quot;   ltr   3,3&bslash;n&quot;
l_string|&quot;   jne   0b&bslash;n&quot;
l_string|&quot;2: sacf  0&bslash;n&quot;
l_string|&quot;3:&bslash;n&quot;
l_string|&quot;.section .fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot;
l_string|&quot;4: lghi  %0,%h4&bslash;n&quot;
l_string|&quot;   jg    3b&bslash;n&quot;
l_string|&quot;.previous&bslash;n&quot;
l_string|&quot;.section __ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&quot;
l_string|&quot;   .align 8&bslash;n&quot;
l_string|&quot;   .quad  0b,4b&bslash;n&quot;
l_string|&quot;   .quad  1b,4b&bslash;n&quot;
l_string|&quot;.previous&quot;
suffix:colon
l_string|&quot;=&amp;a&quot;
(paren
...
l_string|&quot;   sacf  512&bslash;n&quot;
l_string|&quot;   lgr   4,%1&bslash;n&quot;
l_string|&quot;   lgr   5,%0&bslash;n&quot;
l_string|&quot;   sgr   2,2&bslash;n&quot;
l_string|&quot;   sgr   3,3&bslash;n&quot;
l_string|&quot;0: mvcle 4,2,0&bslash;n&quot;
l_string|&quot;   jo    0b&bslash;n&quot;
l_string|&quot;1: sacf  0&bslash;n&quot;
l_string|&quot;   lgr   %0,5&bslash;n&quot;

...
id|ec_bit_sig
suffix:semicolon
multiline_comment|/* Signals which come with a parameter area */
r_typedef
r_enum
(brace
DECL|enumerator|ec_callback_sync
id|ec_callback_sync
comma
DECL|enumerator|ec_callback_async
id|ec_callback_async
DECL|typedef|ec_cmd_sig
)brace
id|ec_cmd_sig
suffix:semicolon
multiline_comment|/* state information for signals */
r_typedef
r_enum
(brace
...
id|ec_state
suffix:semicolon
multiline_comment|/* header for the queuing of callbacks */

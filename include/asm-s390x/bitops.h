...
r_volatile
(paren
l_string|&quot;   lg   %0,0(%4)&bslash;n&quot;
l_string|&quot;0: lgr  %1,%0&bslash;n&quot;
l_string|&quot;   ogr  %1,%3&bslash;n&quot;
l_string|&quot;   csg  %0,%1,0(%4)&bslash;n&quot;
l_string|&quot;   jl   0b&quot;
suffix:colon
l_string|&quot;=&amp;d&quot;
(paren
...
mdefine_line|#define ext2_set_bit_atomic(lock, nr, addr)       &bslash;&n;&t;        test_and_set_bit((nr)^56, (unsigned long *)addr)
...
mdefine_line|#define ext2_clear_bit_atomic(lock, nr, addr)     &bslash;&n;&t;        test_and_clear_bit((nr)^56, (unsigned long *)addr)

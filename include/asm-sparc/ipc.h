macro_line|#ifndef __SPARC_IPC_H__
DECL|macro|__SPARC_IPC_H__
mdefine_line|#define __SPARC_IPC_H__
multiline_comment|/* &n; * These are used to wrap system calls on the sparc.&n; *&n; * See arch/sparc/kernel/sys_sparc.c for ugly details..&n; */

multiline_comment|/* $Id: processor.h,v 1.82 2001/09/20 00:35:34 davem Exp $&n; * include/asm-sparc/processor.h&n; *&n; * Copyright (C) 1994 David S. Miller (davem@caip.rutgers.edu)&n; */

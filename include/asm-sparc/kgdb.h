...
mdefine_line|#define LOAD_KGDB_SREGS(reg, reg_y, reg_psr, reg_wim, reg_tbr, reg_pc, reg_npc) &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_Y], %reg_y; &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_PSR], %reg_psr; &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_WIM], %reg_wim; &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_TBR], %reg_tbr; &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_PC], %reg_pc; &bslash;&n;&t;ld&t;[%reg + STACKFRAME_SZ + KGDB_NPC], %reg_npc;

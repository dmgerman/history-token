...
macro_line|#if defined(CONFIG_SIBYTE_SWARM) || defined(CONFIG_SIBYTE_PTSWARM) || &bslash;&n;    defined(CONFIG_SIBYTE_CRHONE) || defined(CONFIG_SIBYTE_CRHINE) || &bslash;&n;    defined(CONFIG_SIBYTE_LITTLESUR)

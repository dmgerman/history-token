...
DECL|macro|SIBYTE_HAVE_PCMCIA
mdefine_line|#define SIBYTE_HAVE_PCMCIA 1
DECL|macro|SIBYTE_HAVE_IDE
mdefine_line|#define SIBYTE_HAVE_IDE    1
macro_line|#endif
...
DECL|macro|SIBYTE_HAVE_IDE
mdefine_line|#define SIBYTE_HAVE_IDE    1
DECL|macro|SIBYTE_DEFAULT_CONSOLE
mdefine_line|#define SIBYTE_DEFAULT_CONSOLE &quot;ttyS0,115200&quot;
macro_line|#endif
macro_line|#ifdef CONFIG_SIBYTE_LITTLESUR
DECL|macro|SIBYTE_BOARD_NAME
mdefine_line|#define SIBYTE_BOARD_NAME &quot;BCM1250C2 (LittleSur)&quot;
DECL|macro|SIBYTE_HAVE_PCMCIA
mdefine_line|#define SIBYTE_HAVE_PCMCIA 0
DECL|macro|SIBYTE_HAVE_IDE
mdefine_line|#define SIBYTE_HAVE_IDE    1
DECL|macro|SIBYTE_DEFAULT_CONSOLE
mdefine_line|#define SIBYTE_DEFAULT_CONSOLE &quot;cfe0&quot;
macro_line|#endif
...
mdefine_line|#define SIBYTE_HAVE_PCMCIA 0
DECL|macro|SIBYTE_HAVE_IDE
mdefine_line|#define SIBYTE_HAVE_IDE    0
macro_line|#endif
...
macro_line|#ifdef SIBYTE_HAVE_IDE
DECL|macro|IDE_CS
...
macro_line|#endif
macro_line|#ifdef SIBYTE_HAVE_PCMCIA

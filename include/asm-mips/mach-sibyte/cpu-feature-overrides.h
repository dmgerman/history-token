...
macro_line|#ifndef __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H
DECL|macro|__ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H
mdefine_line|#define __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H
multiline_comment|/*&n; * Sibyte are MIPS64 processors weired to a specific configuration&n; */
...
macro_line|#endif /* __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H */
eof

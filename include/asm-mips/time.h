...
suffix:semicolon
multiline_comment|/*&n; * Timer interrupt functions.&n; * mips_timer_state is needed for high precision timer calibration.&n; * mips_timer_ack may be NULL if the interrupt is self-recoverable.&n; */
r_extern
r_int
(paren
op_star
...
suffix:semicolon
multiline_comment|/*&n; * High precision timer functions.&n; * If mips_hpt_read is NULL, an R4k-compatible timer setup is attempted.&n; */
r_extern
r_int
r_int
(paren
...
suffix:semicolon
multiline_comment|/*&n; * mips_hpt_frequency - must be set if you intend to use an R4k-compatible&n; * counter as a timer interrupt source; otherwise it can be set up&n; * automagically with an aid of mips_timer_state.&n; */
r_extern
r_int
r_int

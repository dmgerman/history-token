...
DECL|macro|BIT
mdefine_line|#define BIT(x) (1ULL &lt;&lt; (x))
...
suffix:semicolon
macro_line|#endif
DECL|macro|mace_read
mdefine_line|#define mace_read(r)&t;&bslash;&n;&t;(sizeof(r.reg) == 4 ? readl(&amp;r.reg) : readq(&amp;r.reg))
DECL|macro|mace_write
mdefine_line|#define mace_write(v,r)&t;&bslash;&n;&t;(sizeof(r.reg) == 4 ? writel(v,&amp;r.reg) : writeq(v,&amp;r.reg))
...
suffix:semicolon
DECL|macro|mace_eth_read
mdefine_line|#define mace_eth_read(r)&t;&bslash;&n;&t;mace_read(mace-&gt;eth.r)
DECL|macro|mace_eth_write
mdefine_line|#define mace_eth_write(v,r)&t;&bslash;&n;&t;mace_write(v,mace-&gt;eth.r)
...
suffix:semicolon
DECL|macro|mace_perif_audio_read
mdefine_line|#define mace_perif_audio_read(r)&t;&bslash;&n;&t;mace_read(mace-&gt;perif.audio.r)
DECL|macro|mace_perif_audio_write
mdefine_line|#define mace_perif_audio_write(v,r)&t;&bslash;&n;&t;mace_write(v,mace-&gt;perif.audio.r)
...
suffix:semicolon
DECL|macro|mace_perif_ctrl_read
mdefine_line|#define mace_perif_ctrl_read(r)&t;&t;&bslash;&n;&t;mace_read(mace-&gt;perif.ctrl.r)
DECL|macro|mace_perif_ctrl_write
mdefine_line|#define mace_perif_ctrl_write(v,r)&t;&bslash;&n;&t;mace_write(v,mace-&gt;perif.ctrl.r)

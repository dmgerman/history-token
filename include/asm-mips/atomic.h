...
c_func
(paren
l_string|&quot;1:   ll      %0, %1      # atomic_add&bslash;n&quot;
l_string|&quot;     addu    %0, %2                  &bslash;n&quot;
l_string|&quot;     sc      %0, %1                  &bslash;n&quot;
...
c_func
(paren
l_string|&quot;1:   ll      %0, %1      # atomic_sub&bslash;n&quot;
l_string|&quot;     subu    %0, %2                  &bslash;n&quot;
l_string|&quot;     sc      %0, %1                  &bslash;n&quot;
l_string|&quot;     beqz    %0, 1b                  &bslash;n&quot;
suffix:colon
l_string|&quot;=&amp;r&quot;
...
c_func
(paren
l_string|&quot;.set push               # atomic_add_return&bslash;n&quot;
l_string|&quot;.set noreorder                             &bslash;n&quot;
l_string|&quot;1:   ll      %1, %2                        &bslash;n&quot;
...
l_string|&quot;.set noreorder           # atomic_sub_return&bslash;n&quot;
l_string|&quot;1:   ll    %1, %2                           &bslash;n&quot;

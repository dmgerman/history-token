macro_line|#ifndef _ASM_LOCAL_H
DECL|macro|_ASM_LOCAL_H
mdefine_line|#define _ASM_LOCAL_H
...
multiline_comment|/*&n; * Use these for per-cpu local_t variables: on some archs they are&n; * much more efficient than these naive implementations.  Note they take&n; * a variable, not an address.&n; */

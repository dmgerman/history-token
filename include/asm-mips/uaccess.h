...
DECL|macro|put_user
mdefine_line|#define put_user(x,ptr)&t;&bslash;&n;&t;__put_user_check((x),(ptr),sizeof(*(ptr)))
...
DECL|macro|get_user
mdefine_line|#define get_user(x,ptr) &bslash;&n;&t;__get_user_check((x),(ptr),sizeof(*(ptr)))
...
mdefine_line|#define __put_user(x,ptr) &bslash;&n;&t;__put_user_nocheck((x),(ptr),sizeof(*(ptr)))
...
mdefine_line|#define __get_user(x,ptr) &bslash;&n;&t;__get_user_nocheck((x),(ptr),sizeof(*(ptr)))

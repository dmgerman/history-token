multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 2004 MontaVista Software Inc.&n; * Author: Manish Lachwani, mlachwani@mvista.com&n; * Copyright (C) 2004 Ralf Baechle&n; */
macro_line|#ifndef __ASM_MACH_JA_CPU_FEATURE_OVERRIDES_H
DECL|macro|__ASM_MACH_JA_CPU_FEATURE_OVERRIDES_H
mdefine_line|#define __ASM_MACH_JA_CPU_FEATURE_OVERRIDES_H
multiline_comment|/*&n; * Momentum Ocelot-3 is based on Rm7900 processor which&n; * is based on the E9000 core.&n; */
...
mdefine_line|#define cpu_has_nofpuex &t;0
...
macro_line|#endif /* __ASM_MACH_JA_CPU_FEATURE_OVERRIDES_H */
eof

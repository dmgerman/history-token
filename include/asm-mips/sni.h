...
DECL|macro|IT_INT2
mdefine_line|#define  IT_INT2&t;&t;0x01
DECL|macro|IT_INTD
mdefine_line|#define  IT_INTD&t;&t;0x02
DECL|macro|IT_INTC
mdefine_line|#define  IT_INTC&t;&t;0x04
DECL|macro|IT_INTB
mdefine_line|#define  IT_INTB&t;&t;0x08
DECL|macro|IT_INTA
mdefine_line|#define  IT_INTA&t;&t;0x10
DECL|macro|IT_EISA
mdefine_line|#define  IT_EISA&t;&t;0x20
DECL|macro|IT_SCSI
mdefine_line|#define  IT_SCSI&t;&t;0x40
DECL|macro|IT_ETH
mdefine_line|#define  IT_ETH&t;&t;&t;0x80
...
multiline_comment|/*&n; * Interrupt 0-16 are EISA interrupts.  Interrupts from 16 on are assigned&n; * to the other interrupts generated by ASIC PCI.&n; *&n; * INT2 is a wired-or of the push button interrupt, high temperature interrupt&n; * ASIC PCI interrupt.&n; */
DECL|macro|PCIMT_KEYBOARD_IRQ
mdefine_line|#define PCIMT_KEYBOARD_IRQ&t; 1
DECL|macro|PCIMT_IRQ_INT2
mdefine_line|#define PCIMT_IRQ_INT2&t;&t;16
DECL|macro|PCIMT_IRQ_INTD
mdefine_line|#define PCIMT_IRQ_INTD&t;&t;17
DECL|macro|PCIMT_IRQ_INTC
mdefine_line|#define PCIMT_IRQ_INTC&t;&t;18
DECL|macro|PCIMT_IRQ_INTB
mdefine_line|#define PCIMT_IRQ_INTB&t;&t;19
DECL|macro|PCIMT_IRQ_INTA
mdefine_line|#define PCIMT_IRQ_INTA&t;&t;20
DECL|macro|PCIMT_IRQ_EISA
mdefine_line|#define PCIMT_IRQ_EISA&t;&t;21
DECL|macro|PCIMT_IRQ_SCSI
mdefine_line|#define PCIMT_IRQ_SCSI&t;&t;22
DECL|macro|PCIMT_IRQ_ETHERNET
mdefine_line|#define PCIMT_IRQ_ETHERNET&t;23
DECL|macro|PCIMT_IRQ_TEMPERATURE
mdefine_line|#define PCIMT_IRQ_TEMPERATURE&t;24
DECL|macro|PCIMT_IRQ_EISA_NMI
mdefine_line|#define PCIMT_IRQ_EISA_NMI&t;25
DECL|macro|PCIMT_IRQ_POWER_OFF
mdefine_line|#define PCIMT_IRQ_POWER_OFF&t;26
DECL|macro|PCIMT_IRQ_BUTTON
mdefine_line|#define PCIMT_IRQ_BUTTON&t;27

multiline_comment|/*&n; * IRIX prctl interface&n; *&n; * The IRIX kernel maps a page at PRDA_ADDRESS with the&n; * contents of prda and fills it the bits on prda_sys.&n; */

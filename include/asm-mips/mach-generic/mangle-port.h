...
macro_line|#ifndef __ASM_MACH_GENERIC_MANGLE_PORT_H
DECL|macro|__ASM_MACH_GENERIC_MANGLE_PORT_H
mdefine_line|#define __ASM_MACH_GENERIC_MANGLE_PORT_H
DECL|macro|__swizzle_addr_b
mdefine_line|#define __swizzle_addr_b(port)&t;(port)
DECL|macro|__swizzle_addr_w
mdefine_line|#define __swizzle_addr_w(port)&t;(port)
...
macro_line|#endif /* __ASM_MACH_GENERIC_MANGLE_PORT_H */
eof

macro_line|#ifndef __H8300_IPC_H__
DECL|macro|__H8300_IPC_H__
mdefine_line|#define __H8300_IPC_H__
multiline_comment|/* &n; * These are used to wrap system calls on H8/300.&n; *&n; * See arch/h8300/kernel/sys_h8300.c for ugly details..&n; */

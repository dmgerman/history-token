macro_line|#ifndef _H8300_SEMAPHORE_HELPER_H
DECL|macro|_H8300_SEMAPHORE_HELPER_H
mdefine_line|#define _H8300_SEMAPHORE_HELPER_H
multiline_comment|/*&n; * SMP- and interrupt-safe semaphores helper functions.&n; *&n; * (C) Copyright 1996 Linus Torvalds&n; *&n; * based on&n; * m68k version by Andreas Schwab&n; */

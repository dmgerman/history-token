macro_line|#ifndef _X8664_MSGBUF_H
DECL|macro|_X8664_MSGBUF_H
mdefine_line|#define _X8664_MSGBUF_H
multiline_comment|/* &n; * The msqid64_ds structure for x86-64 architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 2 miscellaneous 64-bit values&n; */

multiline_comment|/*&n; * &lt;asm/smplock.h&gt;&n; */
...
mdefine_line|#define check_irq_holder(cpu) &t;&bslash;&n;&t;if (global_irq_holder == (cpu))&t;&bslash;&n;&t;&t;&t;BUG();&t;&t;       
macro_line|#else
...
DECL|macro|check_irq_holder
mdefine_line|#define check_irq_holder(cpu) do {} while(0)
macro_line|#else
DECL|macro|kernel_locked
...
mdefine_line|#define release_kernel_lock(task, cpu) &bslash;&n;do { &bslash;&n;&t;if (unlikely(task-&gt;lock_depth &gt;= 0)) {&t;&bslash;&n;&t;&t;spin_unlock(&amp;kernel_flag); &bslash;&n;&t;&t;check_irq_holder(cpu);&t;&bslash;&n;&t;}&t;&t;&t;&t;&t;&bslash;&n;} while (0)
multiline_comment|/*&n; * Re-acquire the kernel lock&n; */
DECL|macro|reacquire_kernel_lock
mdefine_line|#define reacquire_kernel_lock(task) &bslash;&n;do { &bslash;&n;&t;if (unlikely(task-&gt;lock_depth &gt;= 0))&t;&bslash;&n;&t;&t;spin_lock(&amp;kernel_flag); &bslash;&n;} while (0)

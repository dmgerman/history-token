multiline_comment|/*&n; * structures and definitions for the int 15, ax=e820 memory map&n; * scheme.&n; *&n; * In a nutshell, arch/x86_64/boot/setup.S populates a scratch table&n; * in the empty_zero_block that contains a list of usable address/size&n; * duples.   In arch/x86_64/kernel/setup.c, this information is&n; * transferred into the e820map, and in arch/i386/x86_64/init.c, that&n; * new information is used to mark pages reserved or not.&n; *&n; */

...
macro_line|#endif
multiline_comment|/*&n; * si_code values&n; * Digital reserves positive values for kernel-generated signals.&n; * ... And Linux ignores that convention -AK.&n; */
DECL|macro|SI_USER
...
mdefine_line|#define SI_DETHREAD    -7              /* sent by execve() killing subsidiary thread */

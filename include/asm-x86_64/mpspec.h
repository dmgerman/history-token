...
multiline_comment|/*&n; * A maximum of 255 APICs with the current APIC ID architecture.&n; */
DECL|macro|MAX_APICS
mdefine_line|#define MAX_APICS 128
...
mdefine_line|#define MAX_MP_BUSSES 256

macro_line|#ifndef _X8664_SHMBUF_H
DECL|macro|_X8664_SHMBUF_H
mdefine_line|#define _X8664_SHMBUF_H
multiline_comment|/* &n; * The shmid64_ds structure for x8664 architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 2 miscellaneous 64-bit values&n; */

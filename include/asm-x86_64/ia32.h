...
multiline_comment|/* The x86-64 port uses FXSAVE without prefix; thus a 32bit compatible&n;   FXSAVE layout. The additional XMM registers are added, but they&squot;re &n;   in currently unused space. Hopefully nobody else will use them*/
DECL|macro|_fpstate_ia32
mdefine_line|#define _fpstate_ia32 _fpstate

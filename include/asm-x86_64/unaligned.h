macro_line|#ifndef __X8664_UNALIGNED_H
DECL|macro|__X8664_UNALIGNED_H
mdefine_line|#define __X8664_UNALIGNED_H
multiline_comment|/*&n; * The x86-64 can do unaligned accesses itself. &n; *&n; * The strange macros are there to make sure these can&squot;t&n; * be misused in a way that makes them not work on other&n; * architectures where unaligned accesses aren&squot;t as simple.&n; */

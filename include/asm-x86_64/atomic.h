macro_line|#ifndef __ARCH_X86_64_ATOMIC__
DECL|macro|__ARCH_X86_64_ATOMIC__
mdefine_line|#define __ARCH_X86_64_ATOMIC__
macro_line|#include &lt;linux/config.h&gt;
multiline_comment|/* atomic_t should be 32 bit signed type */
...
multiline_comment|/* An 64bit atomic type */
DECL|member|counter
...
multiline_comment|/**&n; * atomic64_read - read atomic64 variable&n; * @v: pointer of type atomic64_t&n; *&n; * Atomically reads the value of @v.&n; * Doesn&squot;t imply a read memory barrier.&n; */
DECL|macro|atomic64_read
mdefine_line|#define atomic64_read(v)&t;&t;((v)-&gt;counter)
multiline_comment|/**&n; * atomic64_set - set atomic64 variable&n; * @v: pointer to type atomic64_t&n; * @i: required value&n; *&n; * Atomically sets the value of @v to @i.&n; */
DECL|macro|atomic64_set
mdefine_line|#define atomic64_set(v,i)&t;&t;(((v)-&gt;counter) = (i))
multiline_comment|/**&n; * atomic64_add - add integer to atomic64 variable&n; * @i: integer value to add&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically adds @i to @v.&n; */
...
multiline_comment|/**&n; * atomic64_sub - subtract the atomic64 variable&n; * @i: integer value to subtract&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically subtracts @i from @v.&n; */
...
multiline_comment|/**&n; * atomic64_sub_and_test - subtract value from variable and test result&n; * @i: integer value to subtract&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically subtracts @i from @v and returns&n; * true if the result is zero, or false for all&n; * other cases.&n; */
DECL|function|atomic64_sub_and_test
r_static
id|__inline__
r_int
id|atomic64_sub_and_test
c_func
(paren
r_int
id|i
...
multiline_comment|/**&n; * atomic64_inc - increment atomic64 variable&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically increments @v by 1.&n; */
...
multiline_comment|/**&n; * atomic64_dec - decrement atomic64 variable&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically decrements @v by 1.&n; */
...
multiline_comment|/**&n; * atomic64_dec_and_test - decrement and test&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically decrements @v by 1 and&n; * returns true if the result is 0, or false for all other&n; * cases.&n; */
...
multiline_comment|/**&n; * atomic64_inc_and_test - increment and test&n; * @v: pointer to type atomic64_t&n; *&n; * Atomically increments @v by 1&n; * and returns true if the result is zero, or false for all&n; * other cases.&n; */
...
multiline_comment|/**&n; * atomic64_add_negative - add and test if negative&n; * @v: pointer to atomic64_t&n; * @i: integer value to add&n; *&n; * Atomically adds @i to @v and returns true&n; * if the result is negative, or false when&n; * result is greater than or equal to zero.&n; */
...
mdefine_line|#define atomic_set_mask(mask, addr) &bslash;&n;__asm__ __volatile__(LOCK &quot;orl %0,%1&quot; &bslash;&n;: : &quot;r&quot; ((unsigned)mask),&quot;m&quot; (*(addr)) : &quot;memory&quot;)

...
l_int|0
suffix:semicolon
multiline_comment|/* check assembly! */
DECL|macro|C
mdefine_line|#define C(i) &bslash;&n;&t;p = ((u64 *)cpu_gdt_table[cpu]) + GDT_ENTRY_TLS_MIN + i; &bslash;&n;&t;old = *p; &bslash;&n;&t;new = t-&gt;tls_array[i]; &bslash;&n;&t;change |= old - new;  &bslash;&n;&t;*p = new;
id|C
c_func
(paren
l_int|0

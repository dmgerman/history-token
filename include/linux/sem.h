...
id|alter
suffix:semicolon
multiline_comment|/* does the operation alter the array? */
)brace
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* sem_undo_list controls shared access to the list of sem_undo structures&n; * that may be shared among all a CLONE_SYSVSEM task group.&n; */
DECL|struct|sem_undo_list
r_struct
id|sem_undo_list
(brace
DECL|member|refcnt

...
id|memmap
suffix:semicolon
multiline_comment|/**&n; * efi_range_is_wc - check the WC bit on an address range&n; * @start: starting kvirt address&n; * @len: length of range&n; *&n; * Consult the EFI memory map and make sure it&squot;s ok to set this range WC.&n; * Returns true or false.&n; */
DECL|function|efi_range_is_wc
r_static
r_inline
r_int
id|efi_range_is_wc
...
multiline_comment|/* The range checked out */
r_return
l_int|1
suffix:semicolon
)brace

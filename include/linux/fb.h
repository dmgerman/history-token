...
mdefine_line|#define VGA_SAVE_FONT0 1  /* save/restore plane 2 fonts   */
...
mdefine_line|#define VGA_SAVE_FONTS 7  /* save/restore all fonts       */
DECL|macro|VGA_SAVE_MODE
mdefine_line|#define VGA_SAVE_MODE  8  /* save/restore video mode      */
DECL|macro|VGA_SAVE_CMAP
mdefine_line|#define VGA_SAVE_CMAP  16 /* save/restore color map/DAC  */
DECL|struct|fb_vgastate
r_struct
id|fb_vgastate
(brace
DECL|member|vgabase
...
id|vgabase
suffix:semicolon
multiline_comment|/* mmio base, if supported                 */
DECL|member|flags
id|__u32
id|flags
suffix:semicolon
...
id|depth
suffix:semicolon
multiline_comment|/* current fb depth, not important         */
...
id|fbbase
suffix:semicolon
multiline_comment|/*    -- DO NOT ALTER STARTING HERE --     */

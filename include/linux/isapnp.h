...
mdefine_line|#define isapnp_for_each_card(card) &bslash;&n;&t;for(card = to_pnp_card(isapnp_cards.next); card != to_pnp_card(&amp;isapnp_cards); card = to_pnp_card(card-&gt;node.next))

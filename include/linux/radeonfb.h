...
mdefine_line|#define FBIO_RADEON_GET_MIRROR&t;_IOR(&squot;@&squot;, 3, sizeof(__u32*))
DECL|macro|FBIO_RADEON_SET_MIRROR
mdefine_line|#define FBIO_RADEON_SET_MIRROR&t;_IOW(&squot;@&squot;, 4, sizeof(__u32*))
macro_line|#endif
eof

...
mdefine_line|#define num_present_cpus()&t;&t;cpus_weight(cpu_present_map)
...
mdefine_line|#define cpu_present(cpu)&t;&t;cpu_isset(cpu, cpu_present_map)
...
DECL|macro|cpu_present_map
mdefine_line|#define&t;cpu_present_map&t;&t;&t;cpumask_of_cpu(0)
DECL|macro|num_online_cpus
mdefine_line|#define num_online_cpus()&t;&t;1
DECL|macro|num_possible_cpus
mdefine_line|#define num_possible_cpus()&t;&t;1
DECL|macro|num_present_cpus
mdefine_line|#define num_present_cpus()&t;&t;1
DECL|macro|cpu_online
...
DECL|macro|for_each_present_cpu
mdefine_line|#define for_each_present_cpu(cpu) for (cpu = 0; cpu &lt; 1; cpu++)
macro_line|#endif

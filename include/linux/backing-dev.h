...
DECL|enumerator|BDI_write_active
id|BDI_write_active
comma
multiline_comment|/* There are one or more queued writes */
DECL|enumerator|BDI_read_active
id|BDI_read_active
comma
multiline_comment|/* There are one or more queued reads */
...
DECL|function|bdi_write_active
r_static
r_inline
r_int
id|bdi_write_active

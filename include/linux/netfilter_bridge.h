...
multiline_comment|/* This is called by the IP fragmenting code and it ensures there is&n; * enough room for the encapsulating header (if there is one). */
r_static
r_inline
DECL|function|nf_bridge_pad
r_int
id|nf_bridge_pad
c_func
(paren

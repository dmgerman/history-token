...
suffix:semicolon
multiline_comment|/**&n; * valid_device - check if device is valid&n; * @dev:&t;device in question&n; *&n; * Check whether or not a device can be operated on.&n; * If so, increment the reference count and carry on.&n; */
DECL|function|valid_device
r_static
r_inline
r_int
id|valid_device

...
macro_line|#ifndef _IPTABLES_H
DECL|macro|_IPTABLES_H
mdefine_line|#define _IPTABLES_H
...
suffix:semicolon
DECL|struct|ipt_standard_target
r_struct
...
suffix:semicolon
multiline_comment|/* Values for &quot;flag&quot; field in struct ipt_ip (general ip structure). */
DECL|macro|IPT_F_FRAG
mdefine_line|#define IPT_F_FRAG&t;&t;0x01&t;/* Set if rule is a fragment rule */
DECL|macro|IPT_F_MASK
mdefine_line|#define IPT_F_MASK&t;&t;0x01&t;/* All possible flag bits mask. */
multiline_comment|/* Values for &quot;inv&quot; field in struct ipt_ip. */
DECL|macro|IPT_INV_VIA_IN
mdefine_line|#define IPT_INV_VIA_IN&t;&t;0x01&t;/* Invert the sense of IN IFACE. */
DECL|macro|IPT_INV_VIA_OUT
mdefine_line|#define IPT_INV_VIA_OUT&t;&t;0x02&t;/* Invert the sense of OUT IFACE */
DECL|macro|IPT_INV_TOS
mdefine_line|#define IPT_INV_TOS&t;&t;0x04&t;/* Invert the sense of TOS. */
DECL|macro|IPT_INV_SRCIP
mdefine_line|#define IPT_INV_SRCIP&t;&t;0x08&t;/* Invert the sense of SRC IP. */
DECL|macro|IPT_INV_DSTIP
mdefine_line|#define IPT_INV_DSTIP&t;&t;0x10&t;/* Invert the sense of DST OP. */
DECL|macro|IPT_INV_FRAG
mdefine_line|#define IPT_INV_FRAG&t;&t;0x20&t;/* Invert the sense of FRAG. */
DECL|macro|IPT_INV_PROTO
mdefine_line|#define IPT_INV_PROTO&t;&t;0x40&t;/* Invert the sense of PROTO. */
DECL|macro|IPT_INV_MASK
mdefine_line|#define IPT_INV_MASK&t;&t;0x7F&t;/* All possible flag bits mask. */
...
suffix:semicolon
multiline_comment|/*&n; * New IP firewall options for [gs]etsockopt at the RAW IP level.&n; * Unlike BSD Linux inherits IP options so you don&squot;t have to use a raw&n; * socket for this. Instead we check rights in the calls. */
DECL|macro|IPT_BASE_CTL
mdefine_line|#define IPT_BASE_CTL&t;&t;64&t;/* base for firewall socket options */
DECL|macro|IPT_SO_SET_REPLACE
mdefine_line|#define IPT_SO_SET_REPLACE&t;(IPT_BASE_CTL)
DECL|macro|IPT_SO_SET_ADD_COUNTERS
mdefine_line|#define IPT_SO_SET_ADD_COUNTERS&t;(IPT_BASE_CTL + 1)
...
DECL|macro|IPT_TCP_INV_SRCPT
mdefine_line|#define IPT_TCP_INV_SRCPT&t;0x01&t;/* Invert the sense of source ports. */
DECL|macro|IPT_TCP_INV_DSTPT
mdefine_line|#define IPT_TCP_INV_DSTPT&t;0x02&t;/* Invert the sense of dest ports. */
DECL|macro|IPT_TCP_INV_FLAGS
mdefine_line|#define IPT_TCP_INV_FLAGS&t;0x04&t;/* Invert the sense of TCP flags. */
DECL|macro|IPT_TCP_INV_OPTION
mdefine_line|#define IPT_TCP_INV_OPTION&t;0x08&t;/* Invert the sense of option test. */
DECL|macro|IPT_TCP_INV_MASK
mdefine_line|#define IPT_TCP_INV_MASK&t;0x0F&t;/* All possible flags. */
...
DECL|macro|IPT_UDP_INV_SRCPT
mdefine_line|#define IPT_UDP_INV_SRCPT&t;0x01&t;/* Invert the sense of source ports. */
DECL|macro|IPT_UDP_INV_DSTPT
mdefine_line|#define IPT_UDP_INV_DSTPT&t;0x02&t;/* Invert the sense of dest ports. */
DECL|macro|IPT_UDP_INV_MASK
mdefine_line|#define IPT_UDP_INV_MASK&t;0x03&t;/* All possible flags. */
multiline_comment|/* ICMP matching stuff */
DECL|struct|ipt_icmp
r_struct
id|ipt_icmp
(brace
DECL|member|type
...
DECL|macro|IPT_ICMP_INV
mdefine_line|#define IPT_ICMP_INV&t;0x01&t;/* Invert the sense of type/code test */
multiline_comment|/* The argument to IPT_SO_GET_INFO */
DECL|struct|ipt_getinfo
r_struct
id|ipt_getinfo
(brace
...
suffix:semicolon
multiline_comment|/* The argument to IPT_SO_SET_REPLACE. */
DECL|struct|ipt_replace
r_struct
id|ipt_replace
(brace
...
suffix:semicolon
multiline_comment|/* The argument to IPT_SO_ADD_COUNTERS. */
DECL|struct|ipt_counters_info
r_struct
...
suffix:semicolon
multiline_comment|/* The argument to IPT_SO_GET_ENTRIES. */
DECL|struct|ipt_get_entries
r_struct
id|ipt_get_entries
(brace

...
id|mem_end
suffix:semicolon
DECL|member|prefetch_start
DECL|member|prefetch_end
r_int
r_int
id|prefetch_start
comma
...
multiline_comment|/* If you define PCI_NEW_DMA_COMPAT_API it means you support the new DMA API&n; * and you want the pci_ DMA API to be implemented using it.&n; */
macro_line|#if defined(PCI_NEW_DMA_COMPAT_API) &amp;&amp; defined(CONFIG_PCI)

...
DECL|struct|transport_container
r_struct
...
suffix:semicolon
DECL|macro|attribute_container_to_transport_container
mdefine_line|#define attribute_container_to_transport_container(x) &bslash;&n;&t;container_of(x, struct transport_container, ac)
r_void
...
DECL|function|transport_container_register
r_static
r_inline
r_int
...
DECL|function|transport_container_unregister
r_static
r_inline
r_int

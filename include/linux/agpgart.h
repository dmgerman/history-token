...
mdefine_line|#define AGPIOC_INFO       _IOR (AGPIOC_BASE, 0, struct agp_info*)
...
mdefine_line|#define AGPIOC_SETUP      _IOW (AGPIOC_BASE, 3, struct agp_setup*)
DECL|macro|AGPIOC_RESERVE
mdefine_line|#define AGPIOC_RESERVE    _IOW (AGPIOC_BASE, 4, struct agp_region*)
DECL|macro|AGPIOC_PROTECT
mdefine_line|#define AGPIOC_PROTECT    _IOW (AGPIOC_BASE, 5, struct agp_region*)
DECL|macro|AGPIOC_ALLOCATE
mdefine_line|#define AGPIOC_ALLOCATE   _IOWR(AGPIOC_BASE, 6, struct agp_allocate*)
DECL|macro|AGPIOC_DEALLOCATE
mdefine_line|#define AGPIOC_DEALLOCATE _IOW (AGPIOC_BASE, 7, int)
DECL|macro|AGPIOC_BIND
mdefine_line|#define AGPIOC_BIND       _IOW (AGPIOC_BASE, 8, struct agp_bind*)
DECL|macro|AGPIOC_UNBIND
mdefine_line|#define AGPIOC_UNBIND     _IOW (AGPIOC_BASE, 9, struct agp_unbind*)

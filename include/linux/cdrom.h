multiline_comment|/*&n; * -- &lt;linux/cdrom.h&gt;&n; * General header file for linux CD-ROM drivers &n; * Copyright (C) 1992         David Giller, rafetmad@oxy.edu&n; *               1994, 1995   Eberhard Moenkeberg, emoenke@gwdg.de&n; *               1996         David van Leeuwen, david@tm.tno.nl&n; *               1997, 1998   Erik Andersen, andersee@debian.org&n; *               1998-2002    Jens Axboe, axboe@suse.de&n; */
...
multiline_comment|/* Note that scsi/scsi_ioctl.h also uses 0x5382 - 0x5386.&n; * Future CDROM ioctls should be kept below 0x537F&n; */
...
multiline_comment|/* conflict with SCSI_IOCTL_GET_IDLUN */
...
DECL|macro|CDC_MRW
mdefine_line|#define CDC_MRW&t;&t;&t;0x80000 /* drive can read MRW */
DECL|macro|CDC_MRW_W
mdefine_line|#define CDC_MRW_W&t;&t;0x100000 /* drive can write MRW */
DECL|macro|CDC_RAM
mdefine_line|#define CDC_RAM&t;&t;&t;0x200000 /* ok to open for WRITE */
...
DECL|macro|CDM_MRW_BGFORMAT_INACTIVE
mdefine_line|#define CDM_MRW_BGFORMAT_INACTIVE&t;1
DECL|macro|CDM_MRW_BGFORMAT_ACTIVE
mdefine_line|#define CDM_MRW_BGFORMAT_ACTIVE&t;&t;2
DECL|macro|CDM_MRW_BGFORMAT_COMPLETE
mdefine_line|#define CDM_MRW_BGFORMAT_COMPLETE&t;3
multiline_comment|/*&n; * mrw address spaces&n; */
DECL|macro|MRW_LBA_DMA
mdefine_line|#define MRW_LBA_DMA&t;&t;&t;0
DECL|macro|MRW_LBA_GAA
mdefine_line|#define MRW_LBA_GAA&t;&t;&t;1
multiline_comment|/*&n; * mrw mode pages (first is deprecated) -- probed at init time and&n; * cdi-&gt;mrw_mode_page is set&n; */
DECL|macro|MRW_MODE_PC_PRE1
mdefine_line|#define MRW_MODE_PC_PRE1&t;&t;0x2c
DECL|macro|MRW_MODE_PC
mdefine_line|#define MRW_MODE_PC&t;&t;&t;0x03
DECL|struct|mrw_feature_desc
r_struct
id|mrw_feature_desc
(brace
...
l_int|4
suffix:semicolon
DECL|member|notification_class
id|__u8
id|notification_class
suffix:colon
l_int|3
suffix:semicolon
macro_line|#elif defined(__LITTLE_ENDIAN_BITFIELD)
...
suffix:semicolon
macro_line|#endif
DECL|member|supp_event_class
id|__u8
id|supp_event_class
suffix:semicolon
)brace
suffix:semicolon
DECL|struct|media_event_desc
r_struct
id|media_event_desc
(brace
macro_line|#if defined(__BIG_ENDIAN_BITFIELD)
...
suffix:semicolon
macro_line|#endif
DECL|member|start_slot
id|__u8
id|start_slot
suffix:semicolon
DECL|member|end_slot
id|__u8
id|end_slot
suffix:semicolon
)brace

...
mdefine_line|#define&t;TP_REWCLOSE(d)&t;((d)&amp;1)&t;   &t;&t;/* rewind bit */
multiline_comment|/* rewind is only done if data has been transferred */
DECL|macro|TP_DENS
mdefine_line|#define&t;TP_DENS(d)&t;(((d) &gt;&gt; 1) &amp; 0x07) &t;      /* tape density */
DECL|macro|TP_UNIT
mdefine_line|#define TP_UNIT(d)&t;(((d) &gt;&gt; 4) &amp; 0x07)&t;       /* unit number */

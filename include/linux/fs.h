...
multiline_comment|/* NOTE NOTE NOTE: this interface _will_ change in a couple of patches */
DECL|function|dev_lock_part
r_static
r_inline
r_int
id|dev_lock_part

...
suffix:semicolon
multiline_comment|/* only used for the PTY driver */
multiline_comment|/*&n;&t; * Interface routines from the upper tty layer to the tty&n;&t; * driver.&t;Will be replaced with struct tty_operations.&n;&t; */
DECL|member|open
r_int
(paren
op_star

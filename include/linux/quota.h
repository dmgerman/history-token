...
multiline_comment|/*&n; * Statistics about disc quota.&n; */
r_enum
(brace
DECL|enumerator|DQSTATS_LOOKUPS
id|DQSTATS_LOOKUPS
comma
DECL|enumerator|DQSTATS_DROPS
id|DQSTATS_DROPS
comma
DECL|enumerator|DQSTATS_READS
id|DQSTATS_READS
comma
DECL|enumerator|DQSTATS_WRITES
id|DQSTATS_WRITES
comma
DECL|enumerator|DQSTATS_CACHE_HITS
id|DQSTATS_CACHE_HITS
comma
DECL|enumerator|DQSTATS_ALLOCATED
id|DQSTATS_ALLOCATED
comma
DECL|enumerator|DQSTATS_FREE
id|DQSTATS_FREE
comma
DECL|enumerator|DQSTATS_SYNCS
id|DQSTATS_SYNCS
comma
DECL|enumerator|DQSTATS_SIZE
id|DQSTATS_SIZE
)brace
suffix:semicolon
r_extern

multiline_comment|/*&n; * $Id: cfi_endian.h,v 1.11 2002/01/30 23:20:48 awozniak Exp $&n; *&n; */
...
DECL|macro|cpu_to_cfi64
mdefine_line|#define cpu_to_cfi64(x) cpu_to_le64(x)
...
DECL|macro|cfi64_to_cpu
mdefine_line|#define cfi64_to_cpu(x) le64_to_cpu(x)
...
DECL|macro|cpu_to_cfi64
mdefine_line|#define cpu_to_cfi64(x) cpu_to_be64(x)
DECL|macro|cfi16_to_cpu
mdefine_line|#define cfi16_to_cpu(x) be16_to_cpu(x)
DECL|macro|cfi32_to_cpu
mdefine_line|#define cfi32_to_cpu(x) be32_to_cpu(x)
DECL|macro|cfi64_to_cpu
mdefine_line|#define cfi64_to_cpu(x) be64_to_cpu(x)
...
DECL|macro|cpu_to_cfi64
mdefine_line|#define cpu_to_cfi64(x) (x)
DECL|macro|cfi16_to_cpu
mdefine_line|#define cfi16_to_cpu(x) (x)
DECL|macro|cfi32_to_cpu
mdefine_line|#define cfi32_to_cpu(x) (x)
DECL|macro|cfi64_to_cpu
mdefine_line|#define cfi64_to_cpu(x) (x)
macro_line|#else

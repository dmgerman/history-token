...
mdefine_line|#define list_for_each_rcu(pos, head) &bslash;&n;&t;for (pos = (head)-&gt;next, prefetch(pos-&gt;next); pos != (head); &bslash;&n;        &t;pos = rcu_dereference(pos-&gt;next), prefetch(pos-&gt;next))
...
mdefine_line|#define list_for_each_entry_rcu(pos, head, member)&t;&t;&t;&bslash;&n;&t;for (pos = list_entry((head)-&gt;next, typeof(*pos), member),&t;&bslash;&n;&t;&t;     prefetch(pos-&gt;member.next);&t;&t;&t;&bslash;&n;&t;     &amp;pos-&gt;member != (head); &t;&t;&t;&t;&t;&bslash;&n;&t;     pos = rcu_dereference(list_entry(pos-&gt;member.next, &t;&bslash;&n;&t;&t;&t;&t;&t;typeof(*pos), member)),&t;&t;&bslash;&n;&t;&t;     prefetch(pos-&gt;member.next))
...
mdefine_line|#define list_for_each_continue_rcu(pos, head) &bslash;&n;&t;for ((pos) = (pos)-&gt;next, prefetch((pos)-&gt;next); (pos) != (head); &bslash;&n;        &t;(pos) = rcu_dereference((pos)-&gt;next), prefetch((pos)-&gt;next))

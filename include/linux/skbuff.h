...
multiline_comment|/**&n; *&t;skb_header_cloned - is the header a clone&n; *&t;@skb: buffer to check&n; *&n; *&t;Returns true if modifying the header part of the buffer requires&n; *&t;the data to be copied.&n; */
DECL|function|skb_header_cloned
r_static
r_inline
r_int
...
multiline_comment|/**&n; *&t;skb_postpull_rcsum - update checksum for received skb after pull&n; *&t;@skb: buffer to update&n; *&t;@start: start of data before pull&n; *&t;@len: length of data pulled&n; *&n; *&t;After doing a pull on a received packet, you need to call this to&n; *&t;update the CHECKSUM_HW checksum, or set ip_summed to CHECKSUM_NONE&n; *&t;so that it can be recomputed from scratch.&n; */
DECL|function|skb_postpull_rcsum
r_static
r_inline
r_void
...
multiline_comment|/**&n; *&t;pskb_trim_rcsum - trim received skb and update checksum&n; *&t;@skb: buffer to trim&n; *&t;@len: new length&n; *&n; *&t;This is exactly the same as pskb_trim except that it ensures the&n; *&t;checksum of received packets are still valid after the operation.&n; */
DECL|function|pskb_trim_rcsum
r_static
r_inline
r_int
id|pskb_trim_rcsum

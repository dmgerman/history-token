...
mdefine_line|#define HAVE_FREE_NETDEV&t;&t;/* free_netdev() */
DECL|macro|HAVE_NETDEV_PRIV
mdefine_line|#define HAVE_NETDEV_PRIV&t;&t;/* netdev_priv() */
...
DECL|macro|LL_RESERVED_SPACE_EXTRA
mdefine_line|#define LL_RESERVED_SPACE_EXTRA(dev,extra) &bslash;&n;&t;((((dev)-&gt;hard_header_len+extra)&amp;~(HH_DATA_MOD - 1)) + HH_DATA_MOD)
...
id|poll_list
suffix:semicolon
multiline_comment|/* Link to poll list&t;*/
DECL|member|quota
r_int
id|quota
suffix:semicolon
...
suffix:semicolon
DECL|macro|HAVE_NETIF_RECEIVE_SKB
mdefine_line|#define HAVE_NETIF_RECEIVE_SKB 1
r_extern
r_int
...
id|netdev_nit
suffix:semicolon
multiline_comment|/* Post buffer to the network code from _non interrupt_ context.&n; * see net/core/dev.c for netif_rx description.&n; */
...
multiline_comment|/* Add interface to tail of rx poll list. This assumes that _prep has&n; * already been called and returned 1.&n; */
DECL|function|__netif_rx_schedule
r_static
r_inline
r_void
...
multiline_comment|/* Try to reschedule poll. Called by irq handler. */
DECL|function|netif_rx_schedule
r_static
r_inline
r_void
...
multiline_comment|/* Try to reschedule poll. Called by dev-&gt;poll() after netif_rx_complete().&n; * Do not inline this?&n; */
DECL|function|netif_rx_reschedule
r_static
r_inline
r_int
...
multiline_comment|/* Remove interface from poll list: it must be in the poll list&n; * on current cpu. This primitive is called by dev-&gt;poll(), when&n; * it completes the work. The device cannot be out of poll list at this&n; * moment, it is BUG().&n; */
DECL|function|netif_rx_complete
r_static
r_inline
r_void

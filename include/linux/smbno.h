...
multiline_comment|/* smb_flg field flags */
DECL|macro|SMB_FLAGS_SUPPORT_LOCKREAD
mdefine_line|#define SMB_FLAGS_SUPPORT_LOCKREAD&t;0x01
DECL|macro|SMB_FLAGS_CLIENT_BUF_AVAIL
mdefine_line|#define SMB_FLAGS_CLIENT_BUF_AVAIL&t;0x02
DECL|macro|SMB_FLAGS_RESERVED
mdefine_line|#define SMB_FLAGS_RESERVED&t;&t;0x04
DECL|macro|SMB_FLAGS_CASELESS_PATHNAMES
mdefine_line|#define SMB_FLAGS_CASELESS_PATHNAMES&t;0x08
DECL|macro|SMB_FLAGS_CANONICAL_PATHNAMES
mdefine_line|#define SMB_FLAGS_CANONICAL_PATHNAMES&t;0x10
DECL|macro|SMB_FLAGS_REQUEST_OPLOCK
mdefine_line|#define SMB_FLAGS_REQUEST_OPLOCK&t;0x20
DECL|macro|SMB_FLAGS_REQUEST_BATCH_OPLOCK
mdefine_line|#define SMB_FLAGS_REQUEST_BATCH_OPLOCK&t;0x40
DECL|macro|SMB_FLAGS_REPLY
mdefine_line|#define SMB_FLAGS_REPLY&t;&t;&t;0x80
multiline_comment|/* smb_flg2 field flags (samba-2.2.0/source/include/smb.h) */
DECL|macro|SMB_FLAGS2_LONG_PATH_COMPONENTS
mdefine_line|#define SMB_FLAGS2_LONG_PATH_COMPONENTS&t;&t;0x0001
DECL|macro|SMB_FLAGS2_EXTENDED_ATTRIBUTES
mdefine_line|#define SMB_FLAGS2_EXTENDED_ATTRIBUTES&t;&t;0x0002
DECL|macro|SMB_FLAGS2_DFS_PATHNAMES
mdefine_line|#define SMB_FLAGS2_DFS_PATHNAMES&t;&t;0x1000
DECL|macro|SMB_FLAGS2_READ_PERMIT_NO_EXECUTE
mdefine_line|#define SMB_FLAGS2_READ_PERMIT_NO_EXECUTE&t;0x2000
DECL|macro|SMB_FLAGS2_32_BIT_ERROR_CODES

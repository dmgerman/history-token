...
multiline_comment|/**&n; * d_add_unique - add dentry to hash queues without aliasing&n; * @entry: dentry to add&n; * @inode: The inode to attach to this dentry&n; *&n; * This adds the entry to the hash queues and initializes @inode.&n; * The entry was actually filled in earlier during d_alloc().&n; */
DECL|function|d_add_unique
r_static
r_inline
r_struct
id|dentry

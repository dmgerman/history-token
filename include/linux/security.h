...
suffix:semicolon
DECL|member|bprm_post_apply_creds
r_void
(paren
op_star
id|bprm_post_apply_creds
)paren
(paren
r_struct
id|linux_binprm
...
DECL|function|security_bprm_post_apply_creds
r_static
r_inline
r_void
...
(brace
id|security_ops-&gt;bprm_post_apply_creds
(paren
id|bprm
)paren
suffix:semicolon

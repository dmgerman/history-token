multiline_comment|/*&n; * ntfs_layout.h - All NTFS associated on-disk structures. Part of the&n; * &t;&t;   Linux-NTFS project.&n; *&n; * Copyright (c) 2001 Anton Altaparmakov.&n; *&n; * This program/include file is free software; you can redistribute it and/or&n; * modify it under the terms of the GNU General Public License as published&n; * by the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; *&n; * This program/include file is distributed in the hope that it will be &n; * useful, but WITHOUT ANY WARRANTY; without even the implied warranty &n; * of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program (in the main directory of the Linux-NTFS &n; * distribution in the file COPYING); if not, write to the Free Software&n; * Foundation,Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA&n; */
...
DECL|macro|is_magic
mdefine_line|#define is_magic(x, m)&t;&t;(   (__u32)(x) == magic_##m )
DECL|macro|is_magicp
mdefine_line|#define is_magicp(p, m) &t;( *(__u32*)(p) == magic_##m )
...
multiline_comment|/*&n; * The Update Sequence Array (usa) is an array of the __u16 values which belong&n; * to the end of each sector protected by the update sequence record in which&n; * this array is contained. Note that the first entry is the Update Sequence&n; * Number (usn), a cyclic counter of how many times the protected record has&n; * been written to disk. The values 0 and -1 (ie. 0xffff) are not used. All&n; * last __u16&squot;s of each sector have to be equal to the usn (during reading) or&n; * are set to it (during writing). If they are not, an incomplete multi sector&n; * transfer has occured when the data was written.&n; * The maximum size for the update sequence array is fixed to:&n; * &t;maximum size = usa_ofs + (usa_count * 2) = 510 bytes&n; * The 510 bytes comes from the fact that the last __u16 in the array has to&n; * (obviously) finish before the last __u16 of the first 512-byte sector.&n; * This formula can be used as a consistency check in that usa_ofs +&n; * (usa_count * 2) has to be less than or equal to 510.&n; */
r_typedef
r_struct
(brace
DECL|member|magic
...
id|usa_count
suffix:semicolon
multiline_comment|/* Number of __u16 sized entries in the usa&n;&t;&t;&t;&t;   including the Update Sequence Number (usn),&n;&t;&t;&t;&t;   thus the number of fixups is the usa_count&n;&t;&t;&t;&t;   minus 1. */
...
suffix:semicolon
DECL|macro|MREF
mdefine_line|#define MREF(x)&t;&t;((__u64)((x) &amp; MFT_REF_MASK_CPU))
DECL|macro|MSEQNO
mdefine_line|#define MSEQNO(x)&t;((__u16)(((x) &gt;&gt; 48) &amp; 0xffff))
DECL|macro|MREF_LE
mdefine_line|#define MREF_LE(x)&t;((__u64)(const_le64_to_cpu(x) &amp; MFT_REF_MASK_CPU))
DECL|macro|MSEQNO_LE
mdefine_line|#define MSEQNO_LE(x)&t;((__u16)((const_le64_to_cpu(x) &gt;&gt; 48) &amp; 0xffff))
DECL|macro|IS_ERR_MREF
mdefine_line|#define IS_ERR_MREF(x)&t;(((x) &amp; 0x0000800000000000ULL) ? 1 : 0)
DECL|macro|ERR_MREF
mdefine_line|#define ERR_MREF(x)&t;((__u64)((__s64)(x)))
DECL|macro|MREF_ERR
mdefine_line|#define MREF_ERR(x)&t;((int)((__s64)(x)))
multiline_comment|/*&n; * The mft record header present at the beginning of every record in the mft.&n; * This is followed by a sequence of variable length attribute records which&n; * is terminated by an attribute of type $END which is a truncated attribute&n; * in that it only consists of the attribute type code $END and none of the&n; * other members of the attribute structure are present.&n; */
r_typedef
r_struct
(brace
multiline_comment|/*Ofs*/
DECL|member|NTFS_RECORD
multiline_comment|/*  0*/
id|NTFS_RECORD
suffix:semicolon
...
singleline_comment|//__u16 reserved;&t;&t;/* Reserved/alignment. */
multiline_comment|/* 44*/
singleline_comment|//__u32 mft_record_number;&t;/* Number of this mft record. */
...
id|MFT_RECORD
suffix:semicolon
multiline_comment|/*&n; * System defined attributes (32-bit). Each attribute type has a corresponding&n; * attribute name (Unicode string of maximum 64 character length) as described&n; * by the attribute definitions present in the data attribute of the $AttrDef&n; * system file. On NTFS 3.0 volumes the names are just as the types are named&n; * in the below enum. Note: All system attribute names start with a dollar sign.&n; * If that isn&squot;t a revealing choice of symbol... (-;&n; */
r_typedef
r_enum
(brace
...
comma
DECL|enumerator|$STANDARD_INFORMATION
"$"
...
comma
DECL|enumerator|$ATTRIBUTE_LIST
"$"
id|ATTRIBUTE_LIST
op_assign
id|const_cpu_to_le32
...
comma
DECL|enumerator|$SECURITY_DESCRIPTOR
"$"
...
comma
DECL|enumerator|$VOLUME_INFORMATION
"$"
...
comma
DECL|enumerator|$INDEX_ALLOCATION
"$"
id|INDEX_ALLOCATION
op_assign
id|const_cpu_to_le32
...
comma
DECL|enumerator|$EA_INFORMATION
"$"
id|EA_INFORMATION
op_assign
id|const_cpu_to_le32
...
comma
DECL|enumerator|$LOGGED_UTILITY_STREAM
"$"
...
comma
DECL|enumerator|$FIRST_USER_DEFINED_ATTRIBUTE
"$"
id|FIRST_USER_DEFINED_ATTRIBUTE
op_assign
id|const_cpu_to_le32
c_func
(paren
...
id|length
suffix:semicolon
multiline_comment|/* Byte size of this entry. */
DECL|member|name_length
multiline_comment|/*  6*/
id|__u8
id|name_length
...
r_struct
(brace
DECL|member|SECURITY_DESCRIPTOR_HEADER
id|SECURITY_DESCRIPTOR_HEADER
suffix:semicolon
...
id|index_block_vcn
suffix:semicolon
multiline_comment|/* Virtual cluster number of the index block. */
DECL|member|index
multiline_comment|/* 24*/
id|INDEX_HEADER
id|index
...
r_struct
(brace
DECL|member|INDEX_ENTRY_HEADER
multiline_comment|/*  0*/
id|INDEX_ENTRY_HEADER
suffix:semicolon
...
id|ea_name_length
suffix:semicolon
multiline_comment|/* Length of the name of the extended&n;&t;&t;&t;&t;&t;   attribute in bytes. */
...
suffix:semicolon
multiline_comment|/* The value of the EA. Immediately&n;&t;&t;&t;&t;&t;   follows the name. */

...
suffix:semicolon
macro_line|#ifdef CONFIG_MAPPED_PCI_IO
r_extern
id|dma_addr_t
id|pci_map_single
c_func
...
macro_line|#else /* CONFIG_MAPPED_PCI_IO  */
...
macro_line|#endif /* CONFIG_MAPPED_PCI_IO  */
...
multiline_comment|/*&n; * Return the index of the PCI controller for device.&n; */

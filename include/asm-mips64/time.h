multiline_comment|/*&n; * Copyright (C) 2001, 2002, MontaVista Software Inc.&n; * Author: Jun Sun, jsun@mvista.com or jsun@junsun.net&n; *&n; * include/asm-mips/time.h&n; *     header file for the new style time.c file and time services.&n; *&n; * This program is free software; you can redistribute  it and/or modify it&n; * under  the terms of  the GNU General  Public License as published by the&n; * Free Software Foundation;  either version 2 of the  License, or (at your&n; * option) any later version.&n; *&n; * Please refer to Documentation/mips/time.README.&n; */

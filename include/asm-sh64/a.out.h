macro_line|#ifndef __ASM_SH64_A_OUT_H
DECL|macro|__ASM_SH64_A_OUT_H
mdefine_line|#define __ASM_SH64_A_OUT_H
multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * include/asm-sh64/a.out.h&n; *&n; * Copyright (C) 2000, 2001  Paolo Alberelli&n; *&n; */
DECL|struct|exec
r_struct
id|exec
(brace
...
macro_line|#endif
macro_line|#endif /* __ASM_SH64_A_OUT_H */
eof

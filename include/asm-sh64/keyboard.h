multiline_comment|/*&n; *  linux/include/asm-shmedia/keyboard.h&n; *&n; * Copied from i386 version:&n; *    Created 3 Nov 1996 by Geert Uytterhoeven&n; */
multiline_comment|/*&n; *  This file contains the i386 architecture specific keyboard definitions&n; */
macro_line|#ifndef __ASM_SH64_KEYBOARD_H
DECL|macro|__ASM_SH64_KEYBOARD_H
mdefine_line|#define __ASM_SH64_KEYBOARD_H
...
mdefine_line|#define KEYBOARD_IRQ&t;&t;&t;(START_EXT_IRQS + 2) /* SMSC SuperIO IRQ 1 */
macro_line|#endif
...
macro_line|#ifdef CONFIG_SH_CAYMAN
DECL|macro|AUX_IRQ
mdefine_line|#define AUX_IRQ (START_EXT_IRQS + 6) /* SMSC SuperIO IRQ12 */
macro_line|#endif
...
macro_line|#endif /* __ASM_SH64_KEYBOARD_H */
eof

macro_line|#ifndef __ASM_SH64_IOCTL_H
DECL|macro|__ASM_SH64_IOCTL_H
mdefine_line|#define __ASM_SH64_IOCTL_H
multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * include/asm-sh64/ioctl.h&n; *&n; * Copyright (C) 2000, 2001  Paolo Alberelli&n; *&n; * linux/ioctl.h for Linux by H.H. Bergman.&n; *&n; */
...
macro_line|#endif /* __ASM_SH64_IOCTL_H */
eof

macro_line|#ifndef __ASM_SH64_TLBFLUSH_H
DECL|macro|__ASM_SH64_TLBFLUSH_H
mdefine_line|#define __ASM_SH64_TLBFLUSH_H
...
suffix:semicolon
macro_line|#endif /* __ASM_SH64_TLBFLUSH_H */
eof

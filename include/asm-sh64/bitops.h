macro_line|#ifndef __ASM_SH64_BITOPS_H
DECL|macro|__ASM_SH64_BITOPS_H
mdefine_line|#define __ASM_SH64_BITOPS_H
multiline_comment|/*&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * include/asm-sh64/bitops.h&n; *&n; * Copyright (C) 2000, 2001  Paolo Alberelli&n; * Copyright (C) 2003  Paul Mundt&n; */
...
c_func
(paren
l_string|&quot;gettr  tr0, %2&bslash;n&bslash;t&quot;
l_string|&quot;pta    $+32, tr0&bslash;n&bslash;t&quot;
l_string|&quot;andi   %1, 1, %3&bslash;n&bslash;t&quot;
l_string|&quot;beq    %3, r63, tr0&bslash;n&bslash;t&quot;
l_string|&quot;pta    $+4, tr0&bslash;n&quot;
l_string|&quot;0:&bslash;n&bslash;t&quot;
l_string|&quot;shlri.l        %1, 1, %1&bslash;n&bslash;t&quot;
l_string|&quot;addi   %0, 1, %0&bslash;n&bslash;t&quot;
l_string|&quot;andi   %1, 1, %3&bslash;n&bslash;t&quot;
l_string|&quot;beqi   %3, 1, tr0&bslash;n&quot;
l_string|&quot;1:&bslash;n&bslash;t&quot;
l_string|&quot;ptabs  %2, tr0&bslash;n&bslash;t&quot;
suffix:colon
l_string|&quot;=r&quot;
(paren
id|result
...
DECL|macro|fls
mdefine_line|#define fls(x)&t;generic_fls(x)
macro_line|#endif /* __KERNEL__ */
macro_line|#endif /* __ASM_SH64_BITOPS_H */
eof

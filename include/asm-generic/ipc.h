macro_line|#ifndef _ASM_GENERIC_IPC_H
DECL|macro|_ASM_GENERIC_IPC_H
mdefine_line|#define _ASM_GENERIC_IPC_H
multiline_comment|/*&n; * These are used to wrap system calls.&n; *&n; * See architecture code for ugly details..&n; */
...
macro_line|#endif&t;/* _ASM_GENERIC_IPC_H */
eof

...
DECL|macro|cpu_set
mdefine_line|#define cpu_set(cpu, map)&t;&t;do { (void)(cpu); cpus_coerce(map) = 1UL; } while (0)
DECL|macro|cpu_clear
mdefine_line|#define cpu_clear(cpu, map)&t;&t;do { (void)(cpu); cpus_coerce(map) = 0UL; } while (0)
...
mdefine_line|#define cpumask_of_cpu(cpu)&t;&t;((void)(cpu), cpus_promote(1))

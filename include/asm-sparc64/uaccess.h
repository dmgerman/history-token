multiline_comment|/* $Id: uaccess.h,v 1.35 2002/02/09 19:49:31 davem Exp $ */
...
DECL|macro|get_fs
mdefine_line|#define get_fs() ((mm_segment_t) { get_thread_current_ds() })
DECL|macro|get_ds
...
DECL|macro|put_user
mdefine_line|#define put_user(x,ptr) ({ &bslash;&n;unsigned long __pu_addr = (unsigned long)(ptr); &bslash;&n;check_user_ptr(ptr); &bslash;&n;__put_user_nocheck((__typeof__(*(ptr)))(x),__pu_addr,sizeof(*(ptr))); })
DECL|macro|get_user
mdefine_line|#define get_user(x,ptr) ({ &bslash;&n;unsigned long __gu_addr = (unsigned long)(ptr); &bslash;&n;check_user_ptr(ptr); &bslash;&n;__get_user_nocheck((x),__gu_addr,sizeof(*(ptr)),__typeof__(*(ptr))); })

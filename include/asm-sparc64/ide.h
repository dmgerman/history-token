...
l_int|1
suffix:semicolon
multiline_comment|/* device INTRQ to host *&n;&t;&t;unsigned int bit0&t;: 1;&n;&t;} b;&n;} control_t;&n;&n;static __inline__ int ide_request_irq(unsigned int irq,&n;&t;&t;&t;&t;      void (*handler)(int, void *, struct pt_regs *),&n;&t;&t;&t;&t;      unsigned long flags, const char *name, void *devid)&n;{&n;&t;return request_irq(irq, handler, SA_SHIRQ, name, devid);&n;}&n;&n;static __inline__ void ide_free_irq(unsigned int irq, void *dev_id)&n;{&n;&t;free_irq(irq, dev_id);&n;}&n;&n;static __inline__ int ide_check_region(ide_ioreg_t base, unsigned int size)&n;{&n;&t;return check_region(base, size);&n;}&n;&n;static __inline__ void ide_request_region(ide_ioreg_t base, unsigned int size,&n;&t;&t;&t;&t;&t;  const char *name)&n;{&n;&t;request_region(base, size, name);&n;}&n;&n;static __inline__ void ide_release_region(ide_ioreg_t base, unsigned int size)&n;{&n;&t;release_region(base, size);&n;}&n;&n;#undef  SUPPORT_SLOW_DATA_PORTS&n;#define SUPPORT_SLOW_DATA_PORTS 0&n;&n;#undef  SUPPORT_VLB_SYNC&n;#define SUPPORT_VLB_SYNC 0&n;&n;#undef  HD_DATA&n;#define HD_DATA ((ide_ioreg_t)0)&n;&n;/* From m68k code... */

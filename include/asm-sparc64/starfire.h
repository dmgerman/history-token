multiline_comment|/* $Id: starfire.h,v 1.2 2001/07/04 00:18:18 davem Exp $&n; * starfire.h: Group all starfire specific code together.&n; *&n; * Copyright (C) 2000 Anton Blanchard (anton@samba.org)&n; */

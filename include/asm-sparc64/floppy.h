...
suffix:semicolon
DECL|variable|sun_pci_dma_current
r_static
r_struct
id|sun_pci_dma_op
id|sun_pci_dma_current
op_assign
(brace
op_minus
l_int|1U
...
suffix:semicolon
DECL|variable|sun_pci_dma_pending
r_static
r_struct
id|sun_pci_dma_op
id|sun_pci_dma_pending
op_assign
(brace
op_minus
l_int|1U
...
l_int|NULL
op_eq
id|sun_pci_dma_pending.buf
)paren
op_logical_or
(paren
l_int|0
op_eq
id|sun_pci_dma_pending.len
)paren
op_logical_or
(paren
l_int|0
...
id|sun_pci_dma_pending.buf
suffix:semicolon
id|sun_pci_dma_current.len
op_assign
id|sun_pci_dma_pending.len
suffix:semicolon
id|sun_pci_dma_current.direction
op_assign
id|sun_pci_dma_pending.direction
suffix:semicolon
id|sun_pci_dma_pending.buf
...
l_int|0
suffix:semicolon
id|sun_pci_dma_pending.addr
op_assign
op_minus
l_int|1U
suffix:semicolon
id|sun_pci_dma_current.addr
op_assign
id|pci_map_single
c_func
(paren
...
(brace
multiline_comment|/* Done by enable/disable irq */
r_return
l_int|0
suffix:semicolon
)brace
...
DECL|function|sun_pci_fd_dma_callback
r_void
id|sun_pci_fd_dma_callback
c_func
(paren
r_struct
id|ebus_dma_info
...
macro_line|#endif
macro_line|#ifdef CONFIG_PCI
DECL|macro|ISA_FLOPPY_WORKS
macro_line|#undef ISA_FLOPPY_WORKS
macro_line|#ifdef ISA_FLOPPY_WORKS
DECL|function|isa_floppy_init
r_static
r_int
r_int
id|__init
...
l_int|0
suffix:semicolon
multiline_comment|/* We could use DMA on devices behind the ISA bridge, but...&n;&t; *&n;&t; * There is a slight problem.  Normally on x86 kit the x86 processor&n;&t; * delays I/O port instructions when the ISA bus &quot;dma in progress&quot;&n;&t; * signal is active.  Well, sparc64 systems do not monitor this&n;&t; * signal thus we would need to block all I/O port accesses in software&n;&t; * when a dma transfer is active for some device.&n;&t; */
id|sun_fdc
op_assign
(paren
r_struct
...
id|sun_fd_free_irq
suffix:semicolon
multiline_comment|/* Floppy eject is manual.   Actually, could determine this&n;&t; * via presence of &squot;manual&squot; property in OBP node.&n;&t; */
...
macro_line|#endif /* ISA_FLOPPY_WORKS */
macro_line|#endif
...
(paren
op_amp
id|sun_pci_fd_ebus_dma.lock
)paren
suffix:semicolon
multiline_comment|/* XXX ioremap */
id|sun_pci_fd_ebus_dma.regs
op_assign
id|edev-&gt;resource
(braket
l_int|1
...
l_int|0
suffix:semicolon
id|sun_pci_fd_ebus_dma.flags
op_assign
id|EBUS_DMA_FLAG_USE_EBDMA_HANDLER
suffix:semicolon
id|sun_pci_fd_ebus_dma.callback
op_assign
id|sun_pci_fd_dma_callback
suffix:semicolon
id|sun_pci_fd_ebus_dma.client_cookie
op_assign
l_int|NULL
suffix:semicolon
id|sun_pci_fd_ebus_dma.irq
op_assign
id|FLOPPY_IRQ
suffix:semicolon
id|strcpy

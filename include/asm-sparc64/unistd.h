...
mdefine_line|#define __NR_io_destroy&t;&t;269
DECL|macro|__NR_io_submit
mdefine_line|#define __NR_io_submit&t;&t;270
DECL|macro|__NR_io_cancel
mdefine_line|#define __NR_io_cancel&t;&t;271
DECL|macro|__NR_io_getevents
mdefine_line|#define __NR_io_getevents&t;272
multiline_comment|/* WARNING: You MAY NOT add syscall numbers larger than 272, since&n; *          all of the syscall tables in the Sparc kernel are&n; *          sized to have 273 entries (starting at zero).  Therefore&n; *          find a free slot in the 0-272 range.&n; */

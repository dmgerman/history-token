...
suffix:semicolon
multiline_comment|/* Note - you should never unregister because that can race with NMIs.&n; * If you really want to do it first unregister - then synchronize_kernel&n; * - then free.&n; */
r_int

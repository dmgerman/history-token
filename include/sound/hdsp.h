...
suffix:semicolon
multiline_comment|/* These are only used for H96xx cards */
DECL|member|output_rms
r_int
r_int
r_int
id|output_rms
...
id|ad_gain
suffix:semicolon
DECL|member|phone_gain
r_int
r_char
id|phone_gain
suffix:semicolon
DECL|member|xlr_breakout_cable
r_int
r_char
id|xlr_breakout_cable
suffix:semicolon
DECL|member|analog_extension_board
r_int
r_char
id|analog_extension_board
suffix:semicolon
)brace
suffix:semicolon
...
DECL|typedef|hdsp_9632_aeb_t
r_typedef
r_struct
id|_snd_hdsp_9632_aeb
id|hdsp_9632_aeb_t
suffix:semicolon
DECL|struct|_snd_hdsp_9632_aeb
r_struct
id|_snd_hdsp_9632_aeb
(brace
DECL|member|aebi
...
suffix:semicolon
DECL|macro|SNDRV_HDSP_IOCTL_GET_9632_AEB
mdefine_line|#define SNDRV_HDSP_IOCTL_GET_9632_AEB _IOR(&squot;H&squot;, 0x45, hdsp_9632_aeb_t)

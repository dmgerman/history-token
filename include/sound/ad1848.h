...
suffix:semicolon
multiline_comment|/* exported mixer stuffs */
DECL|enumerator|AD1848_MIX_SINGLE
DECL|enumerator|AD1848_MIX_DOUBLE
DECL|enumerator|AD1848_MIX_CAPTURE
r_enum
(brace
...
suffix:semicolon
DECL|macro|AD1848_MIXVAL_SINGLE
mdefine_line|#define AD1848_MIXVAL_SINGLE(reg, shift, mask, invert) &bslash;&n;&t;((reg) | ((shift) &lt;&lt; 8) | ((mask) &lt;&lt; 16) | ((invert) &lt;&lt; 24))
DECL|macro|AD1848_MIXVAL_DOUBLE
mdefine_line|#define AD1848_MIXVAL_DOUBLE(left_reg, right_reg, shift_left, shift_right, mask, invert) &bslash;&n;&t;((left_reg) | ((right_reg) &lt;&lt; 8) | ((shift_left) &lt;&lt; 16) | ((shift_right) &lt;&lt; 19) | ((mask) &lt;&lt; 24) | ((invert) &lt;&lt; 22))
r_int
...
suffix:semicolon
multiline_comment|/* for ease of use */
DECL|struct|ad1848_mix_elem
r_struct
id|ad1848_mix_elem
(brace
DECL|member|name
...
mdefine_line|#define AD1848_SINGLE(xname, xindex, reg, shift, mask, invert) &bslash;&n;{ .name = xname, &bslash;&n;  .index = xindex, &bslash;&n;  .type = AD1848_MIX_SINGLE, &bslash;&n;  .private_value = AD1848_MIXVAL_SINGLE(reg, shift, mask, invert) }
DECL|macro|AD1848_DOUBLE
mdefine_line|#define AD1848_DOUBLE(xname, xindex, left_reg, right_reg, shift_left, shift_right, mask, invert) &bslash;&n;{ .name = xname, &bslash;&n;  .index = xindex, &bslash;&n;  .type = AD1848_MIX_DOUBLE, &bslash;&n;  .private_value = AD1848_MIXVAL_DOUBLE(left_reg, right_reg, shift_left, shift_right, mask, invert) }
DECL|function|snd_ad1848_add_ctl_elem
r_static
r_inline
r_int

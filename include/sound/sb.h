...
r_enum
(brace
DECL|enumerator|SB_MIX_SINGLE
id|SB_MIX_SINGLE
comma
DECL|enumerator|SB_MIX_DOUBLE
id|SB_MIX_DOUBLE
comma
DECL|enumerator|SB_MIX_INPUT_SW
id|SB_MIX_INPUT_SW
comma
DECL|enumerator|SB_MIX_CAPTURE_PRO
id|SB_MIX_CAPTURE_PRO
comma
DECL|enumerator|SB_MIX_CAPTURE_DT019X
id|SB_MIX_CAPTURE_DT019X
)brace
suffix:semicolon
DECL|macro|SB_MIXVAL_DOUBLE
mdefine_line|#define SB_MIXVAL_DOUBLE(left_reg, right_reg, left_shift, right_shift, mask) &bslash;&n;  ((left_reg) | ((right_reg) &lt;&lt; 8) | ((left_shift) &lt;&lt; 16) | ((right_shift) &lt;&lt; 19) | ((mask) &lt;&lt; 24))
DECL|macro|SB_MIXVAL_SINGLE
mdefine_line|#define SB_MIXVAL_SINGLE(reg, shift, mask) &bslash;&n;  ((reg) | ((shift) &lt;&lt; 16) | ((mask) &lt;&lt; 24))
DECL|macro|SB_MIXVAL_INPUT_SW
mdefine_line|#define SB_MIXVAL_INPUT_SW(reg1, reg2, left_shift, right_shift) &bslash;&n;  ((reg1) | ((reg2) &lt;&lt; 8) | ((left_shift) &lt;&lt; 16) | ((right_shift) &lt;&lt; 24))
r_int
...
mdefine_line|#define SB_SINGLE(xname, reg, shift, mask) &bslash;&n;{ .name = xname, &bslash;&n;  .type = SB_MIX_SINGLE, &bslash;&n;  .private_value = SB_MIXVAL_SINGLE(reg, shift, mask) }
DECL|macro|SB_DOUBLE
mdefine_line|#define SB_DOUBLE(xname, left_reg, right_reg, left_shift, right_shift, mask) &bslash;&n;{ .name = xname, &bslash;&n;  .type = SB_MIX_DOUBLE, &bslash;&n;  .private_value = SB_MIXVAL_DOUBLE(left_reg, right_reg, left_shift, right_shift, mask) }
DECL|macro|SB16_INPUT_SW
mdefine_line|#define SB16_INPUT_SW(xname, reg1, reg2, left_shift, right_shift) &bslash;&n;{ .name = xname, &bslash;&n;  .type = SB_MIX_INPUT_SW, &bslash;&n;  .private_value = SB_MIXVAL_INPUT_SW(reg1, reg2, left_shift, right_shift) }
DECL|function|snd_sbmixer_add_ctl_elem
r_static
r_inline
r_int

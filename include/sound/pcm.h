...
suffix:semicolon
DECL|struct|_snd_pcm_group
r_typedef
r_struct
id|_snd_pcm_group
(brace
multiline_comment|/* keep linked substreams */
DECL|member|lock
id|spinlock_t
id|lock
suffix:semicolon
...
DECL|member|link_list
r_struct
id|list_head
id|link_list
suffix:semicolon
multiline_comment|/* linked list member */
DECL|member|self_group
id|snd_pcm_group_t
id|self_group
suffix:semicolon
multiline_comment|/* fake group for non linked substream (with substream lock inside) */
DECL|member|group
id|snd_pcm_group_t
op_star
id|group
suffix:semicolon
multiline_comment|/* pointer to current group */
multiline_comment|/* -- assigned files -- */
DECL|member|file
id|snd_pcm_file_t
op_star
id|file
...
DECL|function|snd_pcm_stream_linked
r_static
r_inline
r_int
...
DECL|function|snd_pcm_stream_lock
r_static
r_inline
r_void
...
DECL|function|snd_pcm_stream_unlock
r_static
r_inline
r_void
...
DECL|function|snd_pcm_stream_lock_irq
r_static
r_inline
r_void
...
DECL|function|snd_pcm_stream_unlock_irq
r_static
r_inline
r_void
...
DECL|macro|snd_pcm_stream_lock_irqsave
mdefine_line|#define snd_pcm_stream_lock_irqsave(substream, flags) &bslash;&n;do { &bslash;&n;&t;read_lock_irqsave(&amp;snd_pcm_link_rwlock, (flags)); &bslash;&n;&t;spin_lock(&amp;substream-&gt;self_group.lock); &bslash;&n;} while (0)
DECL|macro|snd_pcm_stream_unlock_irqrestore
mdefine_line|#define snd_pcm_stream_unlock_irqrestore(substream, flags) &bslash;&n;do { &bslash;&n;&t;spin_unlock(&amp;substream-&gt;self_group.lock); &bslash;&n;&t;read_unlock_irqrestore(&amp;snd_pcm_link_rwlock, (flags)); &bslash;&n;} while (0)
DECL|macro|snd_pcm_group_for_each
mdefine_line|#define snd_pcm_group_for_each(pos, substream) &bslash;&n;&t;list_for_each(pos, &amp;substream-&gt;group-&gt;substreams)
DECL|macro|snd_pcm_group_substream_entry
mdefine_line|#define snd_pcm_group_substream_entry(pos) &bslash;&n;&t;list_entry(pos, snd_pcm_substream_t, link_list)

macro_line|#ifndef __SOUND_CS46XX_H
DECL|macro|__SOUND_CS46XX_H
...
multiline_comment|/*&n; *  The following define the offsets of the registers accessed via base address&n; *  register zero on the CS46xx part.&n; */
DECL|macro|BA0_HISR
...
macro_line|#endif
multiline_comment|/*&n; *  The following define the offsets of the registers and memories accessed via&n; *  base address register one on the CS46xx part.&n; */
...
macro_line|#ifndef NO_CS4612
DECL|macro|SERACC_CHIP_TYPE_MASK
mdefine_line|#define SERACC_CHIP_TYPE_MASK                  0x00000001
DECL|macro|SERACC_CHIP_TYPE_1_03
mdefine_line|#define SERACC_CHIP_TYPE_1_03                  0x00000000
...
DECL|macro|CS46XX_MODE_OUTPUT
mdefine_line|#define CS46XX_MODE_OUTPUT&t;(1&lt;&lt;0)&t; /* MIDI UART - output */ 
DECL|macro|CS46XX_MODE_INPUT
mdefine_line|#define CS46XX_MODE_INPUT&t;(1&lt;&lt;1)&t; /* MIDI UART - input */
multiline_comment|/*&n; *&n; */
DECL|macro|SAVE_REG_MAX
...
mdefine_line|#define CS46XX_PRIMARY_CODEC_INDEX          0
...
id|acpi_dev
suffix:semicolon
DECL|member|acpi_port
r_int
id|acpi_port
suffix:semicolon
DECL|member|eapd_switch
id|snd_kcontrol_t
op_star
id|eapd_switch
suffix:semicolon

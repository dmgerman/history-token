...
multiline_comment|/*&n; *  Timer abstract layer&n; *  Copyright (c) by Jaroslav Kysela &lt;perex@suse.cz&gt;,&n; *&t;&t;     Abramo Bagnara &lt;abramo@alsa-project.org&gt;&n; *&n; *&n; *   This program is free software; you can redistribute it and/or modify&n; *   it under the terms of the GNU General Public License as published by&n; *   the Free Software Foundation; either version 2 of the License, or&n; *   (at your option) any later version.&n; *&n; *   This program is distributed in the hope that it will be useful,&n; *   but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *   GNU General Public License for more details.&n; *&n; *   You should have received a copy of the GNU General Public License&n; *   along with this program; if not, write to the Free Software&n; *   Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307 USA&n; *&n; */
...
id|snd_timer_id_t
suffix:semicolon
DECL|typedef|snd_timer_ginfo_t
r_typedef
r_struct
id|sndrv_timer_ginfo
id|snd_timer_ginfo_t
suffix:semicolon
DECL|typedef|snd_timer_gparams_t
r_typedef
r_struct
id|sndrv_timer_gparams
id|snd_timer_gparams_t
suffix:semicolon
DECL|typedef|snd_timer_gstatus_t
r_typedef
r_struct
...
id|snd_timer_read_t
suffix:semicolon
DECL|typedef|snd_timer_tread_t
r_typedef
r_struct
...
suffix:semicolon
DECL|typedef|snd_timer_ccallback_t
r_typedef
r_void
(paren
op_star
id|snd_timer_ccallback_t
)paren
(paren
id|snd_timer_instance_t
op_star
...
id|resolution_min
suffix:semicolon
multiline_comment|/* minimal resolution */
DECL|member|resolution_max
r_int
r_int
id|resolution_max
suffix:semicolon
multiline_comment|/* maximal resolution */
DECL|member|ticks
r_int
r_int
id|ticks
...
suffix:semicolon
DECL|member|precise_resolution
r_int
(paren
op_star

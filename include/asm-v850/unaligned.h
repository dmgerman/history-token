multiline_comment|/*&n; * include/asm-v850/unaligned.h -- Unaligned memory access&n; *&n; *  Copyright (C) 2001  NEC Corporation&n; *  Copyright (C) 2001  Miles Bader &lt;miles@gnu.org&gt;&n; *&n; * This file is subject to the terms and conditions of the GNU General&n; * Public License.  See the file COPYING in the main directory of this&n; * archive for more details.&n; *&n; * This file is a copy of the arm version, include/asm-arm/unaligned.h&n; *&n; * Note that some v850 chips support unaligned access, but it seems too&n; * annoying to use.&n; */
macro_line|#ifndef __V850_UNALIGNED_H__
DECL|macro|__V850_UNALIGNED_H__
mdefine_line|#define __V850_UNALIGNED_H__
...
macro_line|#endif /* __V850_UNALIGNED_H__ */
eof

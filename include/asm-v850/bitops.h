...
multiline_comment|/* This is the same as generic_ffs, but we can&squot;t use that because it&squot;s&n;   inline and the #include order mucks things up.  */
DECL|function|generic_ffs_for_find_next_bit
r_static
r_inline
r_int
id|generic_ffs_for_find_next_bit
c_func
(paren
r_int
id|x

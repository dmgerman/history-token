...
DECL|macro|NB85E_TIMER_D_TMD_ADDR
mdefine_line|#define NB85E_TIMER_D_TMD_ADDR(n) (NB85E_TIMER_D_TMD_BASE_ADDR + 0x10 * (n))
DECL|macro|NB85E_TIMER_D_TMD
mdefine_line|#define NB85E_TIMER_D_TMD(n)&t;  (*(volatile u16 *)NB85E_TIMER_D_TMD_ADDR(n))
...
DECL|macro|NB85E_TIMER_D_TMCD
mdefine_line|#define NB85E_TIMER_D_TMCD(n)&t;   (*(volatile u8 *)NB85E_TIMER_D_TMCD_ADDR(n))
multiline_comment|/* Control bits for timer D.  */
DECL|macro|NB85E_TIMER_D_TMCD_CE
mdefine_line|#define NB85E_TIMER_D_TMCD_CE  &t;   0x2 /* count enable */
DECL|macro|NB85E_TIMER_D_TMCD_CAE
mdefine_line|#define NB85E_TIMER_D_TMCD_CAE&t;   0x1 /* clock action enable */
multiline_comment|/* Clock divider setting (log2).  */
DECL|macro|NB85E_TIMER_D_TMCD_CS
mdefine_line|#define NB85E_TIMER_D_TMCD_CS(divlog2) (((divlog2) - NB85E_TIMER_D_TMCD_CS_MIN) &lt;&lt; 4)
multiline_comment|/* Minimum clock divider setting (log2).  */
macro_line|#ifndef NB85E_TIMER_D_TMCD_CS_MIN /* Can be overridden by mach-specific hdrs */
DECL|macro|NB85E_TIMER_D_TMCD_CS_MIN
mdefine_line|#define NB85E_TIMER_D_TMCD_CS_MIN  2 /* Default is correct for the v850e/ma1 */
macro_line|#endif
multiline_comment|/* Maximum clock divider setting (log2).  */
DECL|macro|NB85E_TIMER_D_TMCD_CS_MAX
mdefine_line|#define NB85E_TIMER_D_TMCD_CS_MAX  (NB85E_TIMER_D_TMCD_CS_MIN + 7)
multiline_comment|/* Return the clock-divider (log2) of timer D unit N.  */
DECL|macro|NB85E_TIMER_D_DIVLOG2
mdefine_line|#define NB85E_TIMER_D_DIVLOG2(n) &bslash;&n;  (((NB85E_TIMER_D_TMCD(n) &gt;&gt; 4) &amp; 0x7) + NB85E_TIMER_D_TMCD_CS_MIN)
...
macro_line|#endif /* __V850_NB85E_TIMER_D_H__  */
eof

macro_line|#ifndef __V850_MSGBUF_H__
DECL|macro|__V850_MSGBUF_H__
mdefine_line|#define __V850_MSGBUF_H__
multiline_comment|/* &n; * The msqid64_ds structure for v850 architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 64-bit time_t to solve y2038 problem&n; * - 2 miscellaneous 32-bit values&n; */
...
suffix:semicolon
macro_line|#endif /* __V850_MSGBUF_H__ */
eof

multiline_comment|/*&n; * 68360 Communication Processor Module.&n; * Copyright (c) 2000 Michael Leslie &lt;mleslie@lineo.com&gt; (mc68360) after:&n; * Copyright (c) 1997 Dan Malek &lt;dmalek@jlc.net&gt; (mpc8xx)&n; *&n; * This file contains structures and information for the communication&n; * processor channels.  Some CPM control and status is available&n; * through the 68360 internal memory map.  See include/asm/360_immap.h for details.&n; * This file is not a complete map of all of the 360 QUICC&squot;s capabilities&n; *&n; * On the MBX board, EPPC-Bug loads CPM microcode into the first 512&n; * bytes of the DP RAM and relocates the I2C parameter area to the&n; * IDMA1 space.  The remaining DP RAM is available for buffer descriptors&n; * or other use.&n; */
macro_line|#ifndef __CPM_360__
DECL|macro|__CPM_360__
mdefine_line|#define __CPM_360__
macro_line|#include &lt;linux/config.h&gt;
multiline_comment|/* CPM Command register masks: */
...
multiline_comment|/* CPM Command set (opcodes): */
...
DECL|macro|CPM_CR_GRSTOP_TX
mdefine_line|#define CPM_CR_GRSTOP_TX&t;((ushort)0x0005)
DECL|macro|CPM_CR_RESTART_TX
mdefine_line|#define CPM_CR_RESTART_TX&t;((ushort)0x0006)
DECL|macro|CPM_CR_CLOSE_RXBD
mdefine_line|#define CPM_CR_CLOSE_RXBD&t;((ushort)0x0007)
DECL|macro|CPM_CR_SET_GADDR
mdefine_line|#define CPM_CR_SET_GADDR&t;((ushort)0x0008)
DECL|macro|CPM_CR_GCI_TIMEOUT
mdefine_line|#define CPM_CR_GCI_TIMEOUT&t;((ushort)0x0009)
DECL|macro|CPM_CR_GCI_ABORT
mdefine_line|#define CPM_CR_GCI_ABORT&t;((ushort)0x000a)
DECL|macro|CPM_CR_RESET_BCS
mdefine_line|#define CPM_CR_RESET_BCS&t;((ushort)0x000a)
multiline_comment|/* CPM Channel numbers. */
...
mdefine_line|#define CPM_CR_CH_SPI&t;((ushort)0x0005)&t;/* SPI / Timers */
DECL|macro|CPM_CR_CH_TMR
mdefine_line|#define CPM_CR_CH_TMR&t;((ushort)0x0005)
DECL|macro|CPM_CR_CH_SCC3
mdefine_line|#define CPM_CR_CH_SCC3&t;((ushort)0x0008)
DECL|macro|CPM_CR_CH_SMC1
mdefine_line|#define CPM_CR_CH_SMC1&t;((ushort)0x0009)&t;/* SMC1 / IDMA1 */
DECL|macro|CPM_CR_CH_IDMA1
mdefine_line|#define CPM_CR_CH_IDMA1&t;((ushort)0x0009)
DECL|macro|CPM_CR_CH_SCC4
mdefine_line|#define CPM_CR_CH_SCC4&t;((ushort)0x000c)
DECL|macro|CPM_CR_CH_SMC2
mdefine_line|#define CPM_CR_CH_SMC2&t;((ushort)0x000d)&t;/* SMC2 / IDMA2 */
DECL|macro|CPM_CR_CH_IDMA2
mdefine_line|#define CPM_CR_CH_IDMA2&t;((ushort)0x000d)
DECL|macro|mk_cr_cmd
mdefine_line|#define mk_cr_cmd(CH, CMD)&t;((CMD &lt;&lt; 8) | (CH &lt;&lt; 4))
macro_line|#if 1 /* mleslie: I dinna think we have any such restrictions on&n;       * DP RAM aboard the 360 board - see the MC68360UM p.3-3 */
...
multiline_comment|/* mleslie: The uCquicc board is using no extra microcode in DPRAM */
DECL|macro|CPM_DATAONLY_BASE
mdefine_line|#define CPM_DATAONLY_BASE&t;((uint)0x0000)
DECL|macro|CPM_DATAONLY_SIZE
mdefine_line|#define CPM_DATAONLY_SIZE&t;((uint)0x0800)
DECL|macro|CPM_DP_NOSPACE
mdefine_line|#define CPM_DP_NOSPACE&t;&t;((uint)0x7fffffff)
macro_line|#endif
multiline_comment|/* Export the base address of the communication processor registers&n; * and dual port ram. */
multiline_comment|/* extern&t;cpm360_t&t;*cpmp; */
...
suffix:semicolon
multiline_comment|/* void         *m360_cpm_hostalloc(uint size); */
r_void
id|m360_cpm_setbrg
c_func
(paren
...
suffix:semicolon
macro_line|#if 0 /* use QUICC_BD declared in include/asm/m68360_quicc.h  */
multiline_comment|/* Buffer descriptors used by many of the CPM protocols. */
r_typedef
r_struct
id|cpm_buf_desc
(brace
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* rx bd status/control bits */
DECL|macro|BD_SC_EMPTY
mdefine_line|#define BD_SC_EMPTY&t;((ushort)0x8000)&t;/* Recieve is empty */
DECL|macro|BD_SC_WRAP
mdefine_line|#define BD_SC_WRAP&t;((ushort)0x2000)&t;/* Last buffer descriptor in table */
DECL|macro|BD_SC_INTRPT
mdefine_line|#define BD_SC_INTRPT&t;((ushort)0x1000)&t;/* Interrupt on change */
DECL|macro|BD_SC_LAST
mdefine_line|#define BD_SC_LAST&t;((ushort)0x0800)&t;/* Last buffer in frame OR control char */
DECL|macro|BD_SC_FIRST
mdefine_line|#define BD_SC_FIRST&t;((ushort)0x0400)&t;/* 1st buffer in an HDLC frame */
DECL|macro|BD_SC_ADDR
mdefine_line|#define BD_SC_ADDR&t;((ushort)0x0400)&t;/* 1st byte is a multidrop address */
DECL|macro|BD_SC_CM
mdefine_line|#define BD_SC_CM&t;((ushort)0x0200)&t;/* Continous mode */
DECL|macro|BD_SC_ID
mdefine_line|#define BD_SC_ID&t;((ushort)0x0100)&t;/* Received too many idles */
DECL|macro|BD_SC_AM
mdefine_line|#define BD_SC_AM&t;((ushort)0x0080)&t;/* Multidrop address match */
DECL|macro|BD_SC_DE
mdefine_line|#define BD_SC_DE&t;((ushort)0x0080)&t;/* DPLL Error (HDLC) */
DECL|macro|BD_SC_BR
mdefine_line|#define BD_SC_BR&t;((ushort)0x0020)&t;/* Break received */
DECL|macro|BD_SC_LG
mdefine_line|#define BD_SC_LG&t;((ushort)0x0020)&t;/* Frame length violation (HDLC) */
DECL|macro|BD_SC_FR
mdefine_line|#define BD_SC_FR&t;((ushort)0x0010)&t;/* Framing error */
DECL|macro|BD_SC_NO
mdefine_line|#define BD_SC_NO&t;((ushort)0x0010)&t;/* Nonoctet aligned frame (HDLC) */
DECL|macro|BD_SC_PR
mdefine_line|#define BD_SC_PR&t;((ushort)0x0008)&t;/* Parity error */
DECL|macro|BD_SC_AB
mdefine_line|#define BD_SC_AB&t;((ushort)0x0008)&t;/* Received abort Sequence (HDLC) */
DECL|macro|BD_SC_OV
mdefine_line|#define BD_SC_OV&t;((ushort)0x0002)&t;/* Overrun */
DECL|macro|BD_SC_CD
mdefine_line|#define BD_SC_CD&t;((ushort)0x0001)&t;/* Carrier Detect lost */
multiline_comment|/* tx bd status/control bits (as differ from rx bd) */
...
multiline_comment|/* Parameter RAM offsets. */
multiline_comment|/* In 2.4 ppc, the PROFF_S?C? are used as byte offsets into DPRAM.&n; * In 2.0, we use a more structured C struct map of DPRAM, and so &n; * instead, we need only a parameter ram `slot&squot;  */
DECL|macro|PRSLOT_SCC1
mdefine_line|#define PRSLOT_SCC1&t;0
DECL|macro|PRSLOT_SCC2
mdefine_line|#define PRSLOT_SCC2&t;1
DECL|macro|PRSLOT_SCC3
mdefine_line|#define PRSLOT_SCC3&t;2
DECL|macro|PRSLOT_SMC1
mdefine_line|#define PRSLOT_SMC1&t;2
DECL|macro|PRSLOT_SCC4
mdefine_line|#define PRSLOT_SCC4&t;3
DECL|macro|PRSLOT_SMC2
mdefine_line|#define PRSLOT_SMC2&t;3
multiline_comment|/* #define PROFF_SCC1&t;((uint)0x0000) */
multiline_comment|/* #define PROFF_SCC2&t;((uint)0x0100) */
multiline_comment|/* #define PROFF_SCC3&t;((uint)0x0200) */
multiline_comment|/* #define PROFF_SMC1&t;((uint)0x0280) */
multiline_comment|/* #define PROFF_SCC4&t;((uint)0x0300) */
multiline_comment|/* #define PROFF_SMC2&t;((uint)0x0380) */
...
DECL|macro|SCC_FC_DMA
mdefine_line|#define SCC_FC_DMA ((u_char)0x08) /* Set SDMA */
...
multiline_comment|/* uCquicc has the following signals connected to Ethernet:&n; *  68360    - lxt905&n; * PA0/RXD1  - rxd&n; * PA1/TXD1  - txd&n; * PA8/CLK1  - tclk&n; * PA9/CLK2  - rclk&n; * PC0/!RTS1 - t_en&n; * PC1/!CTS1 - col&n; * PC5/!CD1  - cd&n; */
DECL|macro|PA_ENET_RXD
mdefine_line|#define PA_ENET_RXD&t;PA_RXD1
DECL|macro|PA_ENET_TXD
mdefine_line|#define PA_ENET_TXD&t;PA_TXD1
DECL|macro|PA_ENET_TCLK
mdefine_line|#define PA_ENET_TCLK&t;PA_CLK1
DECL|macro|PA_ENET_RCLK
mdefine_line|#define PA_ENET_RCLK&t;PA_CLK2
DECL|macro|PC_ENET_TENA
mdefine_line|#define PC_ENET_TENA&t;PC_RTS1
DECL|macro|PC_ENET_CLSN
mdefine_line|#define PC_ENET_CLSN&t;PC_CTS1
DECL|macro|PC_ENET_RENA
mdefine_line|#define PC_ENET_RENA&t;PC_CD1
multiline_comment|/* Control bits in the SICR to route TCLK (CLK1) and RCLK (CLK2) to&n; * SCC1.&n; */
DECL|macro|SICR_ENET_MASK
mdefine_line|#define SICR_ENET_MASK&t;((uint)0x000000ff)
DECL|macro|SICR_ENET_CLKRT
mdefine_line|#define SICR_ENET_CLKRT&t;((uint)0x0000002c)
macro_line|#endif /* config_ucquicc */
macro_line|#ifdef MBX
...
multiline_comment|/* #define CPMVEC_NR&t;&t;32 */
multiline_comment|/* #define&t;CPMVEC_PIO_PC15&t;&t;((ushort)0x1f) */
multiline_comment|/* #define&t;CPMVEC_SCC1&t;&t;((ushort)0x1e) */
multiline_comment|/* #define&t;CPMVEC_SCC2&t;&t;((ushort)0x1d) */
multiline_comment|/* #define&t;CPMVEC_SCC3&t;&t;((ushort)0x1c) */
multiline_comment|/* #define&t;CPMVEC_SCC4&t;&t;((ushort)0x1b) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC14&t;&t;((ushort)0x1a) */
multiline_comment|/* #define&t;CPMVEC_TIMER1&t;&t;((ushort)0x19) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC13&t;&t;((ushort)0x18) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC12&t;&t;((ushort)0x17) */
multiline_comment|/* #define&t;CPMVEC_SDMA_CB_ERR&t;((ushort)0x16) */
...
multiline_comment|/* #define CPMVEC_I2C&t;&t;((ushort)0x10) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC11&t;&t;((ushort)0x0f) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC10&t;&t;((ushort)0x0e) */
multiline_comment|/* #define CPMVEC_TIMER3&t;&t;((ushort)0x0c) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC9&t;&t;((ushort)0x0b) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC8&t;&t;((ushort)0x0a) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC7&t;&t;((ushort)0x09) */
multiline_comment|/* #define CPMVEC_TIMER4&t;&t;((ushort)0x07) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC6&t;&t;((ushort)0x06) */
multiline_comment|/* #define&t;CPMVEC_SPI&t;&t;((ushort)0x05) */
multiline_comment|/* #define&t;CPMVEC_SMC1&t;&t;((ushort)0x04) */
multiline_comment|/* #define&t;CPMVEC_SMC2&t;&t;((ushort)0x03) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC5&t;&t;((ushort)0x02) */
multiline_comment|/* #define&t;CPMVEC_PIO_PC4&t;&t;((ushort)0x01) */
multiline_comment|/* #define&t;CPMVEC_ERROR&t;&t;((ushort)0x00) */
r_extern
r_void

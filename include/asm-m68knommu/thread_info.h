multiline_comment|/* thread_info.h: m68knommu low-level thread information&n; * adapted from the i386 and PPC versions by Greg Ungerer (gerg@snapgear.com)&n; *&n; * Copyright (C) 2002  David Howells (dhowells@redhat.com)&n; * - Incorporating suggestions made by Linus Torvalds and Dave Miller&n; */

...
macro_line|#endif
multiline_comment|/*&n; * for asm files, THREAD_SIZE is now generated by asm-offsets.c&n; */
...
mdefine_line|#define alloc_thread_info(tsk) ((struct thread_info *) &bslash;&n;&t;&t;&t;&t;__get_free_pages(GFP_KERNEL, THREAD_SIZE_ORDER))
DECL|macro|free_thread_info
mdefine_line|#define free_thread_info(ti)&t;free_pages((unsigned long) (ti), THREAD_SIZE_ORDER)

macro_line|#ifndef __M68KNOMMU_FPU_H
DECL|macro|__M68KNOMMU_FPU_H
mdefine_line|#define __M68KNOMMU_FPU_H
...
macro_line|#else
multiline_comment|/* Assume no FP unit present then... */
DECL|macro|FPSTATESIZE
mdefine_line|#define FPSTATESIZE (2) /* dummy size */
macro_line|#endif

...
singleline_comment|//FIXME - is it always 32K ?
DECL|macro|ELF_EXEC_PAGESIZE
mdefine_line|#define ELF_EXEC_PAGESIZE       32768
...
id|elf_fpregset_t
suffix:semicolon
multiline_comment|/*&n; * This is used to ensure we don&squot;t load something for the wrong architecture.&n; * We can only execute 26-bit code.&n; */
DECL|macro|EM_ARM
mdefine_line|#define EM_ARM&t;40
DECL|macro|EF_ARM_APCS26
mdefine_line|#define EF_ARM_APCS26 0x08
singleline_comment|//#define elf_check_arch(x) ( ((x)-&gt;e_machine == EM_ARM) &amp;&amp; ((x)-&gt;e_flags &amp; EF_ARM_APCS26) )      FIXME!!!!! - this looks OK, but the flags seem to be wrong.
...
multiline_comment|/* For now we just provide a fairly general string that describes the&n;   processor family.  This could be made more specific later if someone&n;   implemented optimisations that require it.  26-bit CPUs give you&n;   &quot;v1l&quot; for ARM2 (no SWP) and &quot;v2l&quot; for anything else (ARM1 isn&squot;t&n;   supported).&n; */

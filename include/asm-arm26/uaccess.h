...
mdefine_line|#define __get_user(x,ptr)                                               &bslash;&n;({                                                                      &bslash;&n;        long __gu_err = 0;                                              &bslash;&n;        __get_user_err((x),(ptr),__gu_err);                             &bslash;&n;        __gu_err;                                                       &bslash;&n;})
DECL|macro|__get_user_error
mdefine_line|#define __get_user_error(x,ptr,err)                                     &bslash;&n;({                                                                      &bslash;&n;        __get_user_err((x),(ptr),err);                                  &bslash;&n;        (void) 0;                                                       &bslash;&n;})
DECL|macro|__get_user_err
mdefine_line|#define __get_user_err(x,ptr,err)                                       &bslash;&n;do {                                                                    &bslash;&n;        unsigned long __gu_addr = (unsigned long)(ptr);                 &bslash;&n;        unsigned long __gu_val;                                         &bslash;&n;        switch (sizeof(*(ptr))) {                                       &bslash;&n;        case 1: __get_user_asm_byte(__gu_val,__gu_addr,err);    break;  &bslash;&n;        case 2: __get_user_asm_half(__gu_val,__gu_addr,err);    break;  &bslash;&n;        case 4: __get_user_asm_word(__gu_val,__gu_addr,err);    break;  &bslash;&n;        default: (__gu_val) = __get_user_bad();                         &bslash;&n;        }                                                               &bslash;&n;        (x) = (__typeof__(*(ptr)))__gu_val;                             &bslash;&n;} while (0)
r_extern
r_int
id|__put_user_1
c_func
...
mdefine_line|#define __put_user_x(__r1,__p,__e,__s)                                  &bslash;&n;           __asm__ __volatile__ (                                       &bslash;&n;                __asmeq(&quot;%0&quot;, &quot;r0&quot;) __asmeq(&quot;%2&quot;, &quot;r1&quot;)                 &bslash;&n;                &quot;bl     __put_user_&quot; #__s                               &bslash;&n;                : &quot;=&amp;r&quot; (__e)                                           &bslash;&n;                : &quot;0&quot; (__p), &quot;r&quot; (__r1)                                 &bslash;&n;                : &quot;ip&quot;, &quot;lr&quot;, &quot;cc&quot;)
DECL|macro|put_user
mdefine_line|#define put_user(x,p)                                                   &bslash;&n;        ({                                                              &bslash;&n;                const register typeof(*(p)) __r1 asm(&quot;r1&quot;) = (x);       &bslash;&n;                const register typeof(*(p)) *__p asm(&quot;r0&quot;) = (p);       &bslash;&n;                register int __e asm(&quot;r0&quot;);                             &bslash;&n;                switch (sizeof(*(__p))) {                               &bslash;&n;                case 1:                                                 &bslash;&n;                        __put_user_x(__r1, __p, __e, 1);                &bslash;&n;                        break;                                          &bslash;&n;                case 2:                                                 &bslash;&n;                        __put_user_x(__r1, __p, __e, 2);                &bslash;&n;                        break;                                          &bslash;&n;                case 4:                                                 &bslash;&n;                        __put_user_x(__r1, __p, __e, 4);                &bslash;&n;                        break;                                          &bslash;&n;                case 8:                                                 &bslash;&n;                        __put_user_x(__r1, __p, __e, 8);                &bslash;&n;                        break;                                          &bslash;&n;                default: __e = __put_user_bad(); break;                 &bslash;&n;                }                                                       &bslash;&n;                __e;                                                    &bslash;&n;        })
macro_line|#if 0
...
mdefine_line|#define put_user(x,p)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;({&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;const register typeof(*(p)) __r1 asm(&quot;r1&quot;) = (x);&t;&bslash;&n;&t;&t;const register typeof(*(p)) *__p asm(&quot;r0&quot;) = (p);&t;&bslash;&n;&t;&t;register int __e asm(&quot;r0&quot;);&t;&t;&t;&t;&bslash;&n;&t;&t;switch (sizeof(*(p))) {&t;&t;&t;&t;&t;&bslash;&n;&t;&t;case 1:&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;__put_user_x(__r1, __p, __e, 1, &quot;r2&quot;, &quot;lr&quot;);&t;&bslash;&n;&t;&t;&t;break;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;case 2:&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;__put_user_x(__r1, __p, __e, 2, &quot;r2&quot;, &quot;lr&quot;);&t;&bslash;&n;&t;&t;&t;break;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;case 4:&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;__put_user_x(__r1, __p, __e, 4, &quot;r2&quot;, &quot;lr&quot;);&t;&bslash;&n;&t;&t;&t;break;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;case 8:&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;__put_user_x(__r1, __p, __e, 8, &quot;r2&quot;, &quot;ip&quot;, &quot;lr&quot;);&t;&bslash;&n;&t;&t;&t;break;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;default: __e = __put_user_bad(); break;&t;&t;&t;&bslash;&n;&t;&t;}&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;__e;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;})
multiline_comment|/*************************************************/
macro_line|#endif
DECL|macro|__put_user
mdefine_line|#define __put_user(x,ptr)                                               &bslash;&n;({                                                                      &bslash;&n;        long __pu_err = 0;                                              &bslash;&n;        __put_user_err((x),(ptr),__pu_err);                             &bslash;&n;        __pu_err;                                                       &bslash;&n;})
DECL|macro|__put_user_error
mdefine_line|#define __put_user_error(x,ptr,err)                                     &bslash;&n;({                                                                      &bslash;&n;        __put_user_err((x),(ptr),err);                                  &bslash;&n;        (void) 0;                                                       &bslash;&n;})
DECL|macro|__put_user_err
mdefine_line|#define __put_user_err(x,ptr,err)                                       &bslash;&n;do {                                                                    &bslash;&n;        unsigned long __pu_addr = (unsigned long)(ptr);                 &bslash;&n;        __typeof__(*(ptr)) __pu_val = (x);                              &bslash;&n;        switch (sizeof(*(ptr))) {                                       &bslash;&n;        case 1: __put_user_asm_byte(__pu_val,__pu_addr,err);    break;  &bslash;&n;        case 2: __put_user_asm_half(__pu_val,__pu_addr,err);    break;  &bslash;&n;        case 4: __put_user_asm_word(__pu_val,__pu_addr,err);    break;  &bslash;&n;        case 8: __put_user_asm_dword(__pu_val,__pu_addr,err);   break;  &bslash;&n;        default: __put_user_bad();                                      &bslash;&n;        }                                                               &bslash;&n;} while (0)

multiline_comment|/*&n; * linux/include/asm-arm26/ecard.h&n; *&n; * definitions for expansion cards&n; *&n; * This is a new system as from Linux 1.2.3&n; *&n; * Changelog:&n; *  11-12-1996&t;RMK&t;Further minor improvements&n; *  12-09-1997&t;RMK&t;Added interrupt enable/disable for card level&n; *  18-05-2003  IM      Adjusted for ARM26&n; *&n; * Reference: Acorns Risc OS 3 Programmers Reference Manuals.&n; */
...
DECL|macro|MANU_SIMTEC
mdefine_line|#define MANU_SIMTEC             0x005f
DECL|macro|PROD_SIMTEC_IDE8
mdefine_line|#define PROD_SIMTEC_IDE8                0x0130
DECL|macro|PROD_SIMTEC_IDE16
mdefine_line|#define PROD_SIMTEC_IDE16               0x0131
...
mdefine_line|#define MAX_ECARDS&t;4
r_typedef
r_enum
(brace
...
suffix:semicolon
multiline_comment|/*&n; * ecard_claim: claim an expansion card entry&n; * FIXME - are these atomic / called with interrupts off ?&n; */

multiline_comment|/*&n; *  linux/include/asm-arm/proc-armo/uaccess.h&n; *&n; *  Copyright (C) 1996 Russell King&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; */
...
multiline_comment|/*&n; * These are the values used to represent the user `fs&squot; and the kernel `ds&squot;&n; * FIXME - the KERNEL_DS should end at 0x03000000 but we want to access ROM at&n; * 0x03400000. ideally we want to forbid access to the IO space inbetween.&n; */
DECL|macro|KERNEL_DS
mdefine_line|#define KERNEL_DS&t;0x03FFFFFF
DECL|macro|USER_DS
...
mdefine_line|#define __range_ok(addr,size) ({&t;&t;&t;&t;&t;&bslash;&n;&t;unsigned long flag, sum;&t;&t;&t;&t;&t;&bslash;&n;&t;__asm__ __volatile__(&quot;subs %1, %0, %3; cmpcs %1, %2; movcs %0, #0&quot; &bslash;&n;&t;&t;: &quot;=&amp;r&quot; (flag), &quot;=&amp;r&quot; (sum)&t;&t;&t;&t;&bslash;&n;&t;&t;: &quot;r&quot; (addr), &quot;Ir&quot; (size), &quot;0&quot; (current_thread_info()-&gt;addr_limit)&t;&bslash;&n;&t;&t;: &quot;cc&quot;);&t;&t;&t;&t;&t;&t;&bslash;&n;&t;flag; })
DECL|macro|__addr_ok
mdefine_line|#define __addr_ok(addr) ({&t;&t;&t;&t;&t;&t;&bslash;&n;&t;unsigned long flag;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;__asm__ __volatile__(&quot;cmp %2, %0; movlo %0, #0&quot;&t;&t;&t;&bslash;&n;&t;&t;: &quot;=&amp;r&quot; (flag)&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;: &quot;0&quot; (current_thread_info()-&gt;addr_limit), &quot;r&quot; (addr)&t;&bslash;&n;&t;&t;: &quot;cc&quot;);&t;&t;&t;&t;&t;&t;&bslash;&n;&t;(flag == 0); })
...
mdefine_line|#define __put_user_asm_dword(x,addr,err)                                 &bslash;&n;        __asm__ __volatile__(                                           &bslash;&n;        &quot;       mov     r0, %1&bslash;n&quot;                                       &bslash;&n;        &quot;       mov     r1, %2&bslash;n&quot;                                       &bslash;&n;        &quot;       mov     r2, %0&bslash;n&quot;                                       &bslash;&n;        &quot;       mov     lr, pc&bslash;n&quot;                                       &bslash;&n;        &quot;       mov     pc, %3&bslash;n&quot;                                       &bslash;&n;        &quot;       mov     %0, r2&bslash;n&quot;                                       &bslash;&n;        : &quot;=r&quot; (err)                                                    &bslash;&n;        : &quot;r&quot; (x), &quot;r&quot; (addr), &quot;r&quot; (current-&gt;thread.uaccess-&gt;put_dword), &bslash;&n;          &quot;0&quot; (err)                                                     &bslash;&n;        : &quot;r0&quot;, &quot;r1&quot;, &quot;r2&quot;, &quot;lr&quot;)

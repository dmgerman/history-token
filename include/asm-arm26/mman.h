macro_line|#ifndef __ARM_MMAN_H__
DECL|macro|__ARM_MMAN_H__
mdefine_line|#define __ARM_MMAN_H__
...
mdefine_line|#define MAP_POPULATE    0x8000          /* populate (prefault) page tables */
DECL|macro|MAP_NONBLOCK
mdefine_line|#define MAP_NONBLOCK    0x10000         /* do not block on IO */
DECL|macro|MS_ASYNC
...
macro_line|#endif /* __ARM_MMAN_H__ */
eof

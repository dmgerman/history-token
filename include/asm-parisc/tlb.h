macro_line|#ifndef _PARISC_TLB_H
DECL|macro|_PARISC_TLB_H
mdefine_line|#define _PARISC_TLB_H
...
mdefine_line|#define __tlb_remove_tlb_entry(tlb, pte, address) &bslash;&n;&t;do { } while (0)

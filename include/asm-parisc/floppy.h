multiline_comment|/*    Architecture specific parts of the Floppy driver&n; *&n; *    Linux/PA-RISC Project (http://www.parisc-linux.org/)&n; *    Copyright (C) 2000 Matthew Wilcox (willy a debian . org)&n; *    Copyright (C) 2000 Dave Kennedy&n; *&n; *    This program is free software; you can redistribute it and/or modify&n; *    it under the terms of the GNU General Public License as published by&n; *    the Free Software Foundation; either version 2 of the License, or&n; *    (at your option) any later version.&n; *&n; *    This program is distributed in the hope that it will be useful,&n; *    but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *    GNU General Public License for more details.&n; *&n; *    You should have received a copy of the GNU General Public License&n; *    along with this program; if not, write to the Free Software&n; *    Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA&n; */
macro_line|#ifndef __ASM_PARISC_FLOPPY_H
DECL|macro|__ASM_PARISC_FLOPPY_H
mdefine_line|#define __ASM_PARISC_FLOPPY_H
...
DECL|macro|fd_inb
mdefine_line|#define fd_inb(port)&t;&t;&t;readb(port)
DECL|macro|fd_outb
mdefine_line|#define fd_outb(value, port)&t;&t;writeb(value, port)
...
l_int|0x3f0
suffix:semicolon
multiline_comment|/* Lies.  Floppy controller is memory mapped, not io mapped */
DECL|variable|FDC2
r_static
r_int
id|FDC2
...
mdefine_line|#define FLOPPY0_TYPE&t;0
...
macro_line|#endif /* __ASM_PARISC_FLOPPY_H */
eof

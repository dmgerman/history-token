...
multiline_comment|/* Offsets to configuration and base address registers */
DECL|macro|IC_PIC1
...
mdefine_line|#define SIO_ACPIBAR 0x88&t;&t;/* ACPI BAR */
...
multiline_comment|/* Interrupt triggers and routing */
...
DECL|macro|IR_SER
mdefine_line|#define IR_SER     0x69&t;&t;/* Serial 1 [0:3] and Serial 2 [4:7] */
DECL|macro|IR_PFD
mdefine_line|#define IR_PFD     0x6a&t;&t;/* Parallel [0:3] and Floppy [4:7] */
DECL|macro|IR_IDE
mdefine_line|#define IR_IDE     0x6b&t;&t;/* IDE1 [0:3] and IDE2 [4:7] */
DECL|macro|IR_USB
mdefine_line|#define IR_USB     0x6d         /* USB [4:7] */
DECL|macro|IR_LOW
mdefine_line|#define IR_LOW     0x69&t;&t;/* Lowest interrupt routing reg */
DECL|macro|IR_HIGH
mdefine_line|#define IR_HIGH    0x71&t;&t;/* Highest interrupt routing reg */
...
id|acpi_base
suffix:semicolon
DECL|member|iosapic_irq
r_int
id|iosapic_irq
suffix:semicolon
DECL|member|iosapic_irq_enabled
r_int
id|iosapic_irq_enabled
suffix:semicolon
...
id|lio_pdev
suffix:semicolon
multiline_comment|/* pci device for legacy IO fn */
)brace
suffix:semicolon

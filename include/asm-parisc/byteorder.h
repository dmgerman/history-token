...
c_func
(paren
l_string|&quot;shd %0, %0, 8, %0&bslash;n&bslash;t&quot;
multiline_comment|/* shift xabcxabc -&gt; cxab */
l_string|&quot;dep %0, 15, 8, %0&bslash;n&bslash;t&quot;
multiline_comment|/* deposit cxab -&gt; cbab */
l_string|&quot;shd %%r0, %0, 8, %0&quot;
multiline_comment|/* shift 0000cbab -&gt; 0cba */
suffix:colon
l_string|&quot;=r&quot;
(paren
id|x
...
macro_line|#elif !defined(__STRICT_ANSI__)
DECL|function|___arch__swab64
r_static
id|__inline__
id|__attribute_const__
...
DECL|macro|__arch__swab24
mdefine_line|#define __arch__swab24(x) ___arch__swab24(x)

...
suffix:semicolon
DECL|macro|HAVE_PCI_LEGACY
mdefine_line|#define HAVE_PCI_LEGACY
r_extern
r_int
...
suffix:semicolon
DECL|macro|pci_get_legacy_mem
mdefine_line|#define pci_get_legacy_mem platform_pci_get_legacy_mem
DECL|macro|pci_legacy_read
mdefine_line|#define pci_legacy_read platform_pci_legacy_read
DECL|macro|pci_legacy_write
mdefine_line|#define pci_legacy_write platform_pci_legacy_write

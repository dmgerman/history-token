...
DECL|macro|ARCH_HAS_TRANSLATE_MEM_PTR
mdefine_line|#define ARCH_HAS_TRANSLATE_MEM_PTR&t;1
r_static
id|__inline__
r_char
op_star
DECL|function|xlate_dev_mem_ptr
...
multiline_comment|/*&n; * Convert a virtual cached kernel memory pointer to an uncached pointer&n; */
r_static
id|__inline__
r_char
op_star
DECL|function|xlate_dev_kmem_ptr

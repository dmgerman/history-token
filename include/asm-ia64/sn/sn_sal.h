...
singleline_comment|// reentrant
DECL|macro|SN_SAL_GET_SN_INFO
mdefine_line|#define  SN_SAL_GET_SN_INFO                        0x0200001c
...
multiline_comment|/**&n; * ia64_sn_probe_mem - read from memory safely&n; * @addr: address to probe&n; * @size: number bytes to read (1,2,4,8)&n; * @data_ptr: address to store value read by probe (-1 returned if probe fails)&n; *&n; * Call into the SAL to do a memory read.  If the read generates a machine&n; * check, this routine will recover gracefully and return -1 to the caller.&n; * @addr is usually a kernel virtual address in uncached space (i.e. the&n; * address starts with 0xc), but if called in physical mode, @addr should&n; * be a physical address.&n; *&n; * Return values:&n; *  0 - probe successful&n; *  1 - probe failed (generated MCA)&n; *  2 - Bad arg&n; * &lt;0 - PAL error&n; */
r_static
r_inline
id|u64
DECL|function|ia64_sn_probe_mem
...
multiline_comment|/*&n; * Returns information about the HUB/SHUB.&n; *  In:&n; *&t;arg0 - SN_SAL_GET_SN_INFO&n; * &t;arg1 - 0 (other values reserved for future use)&n; *  Out:&n; *&t;v0 &n; *&t;&t;[7:0]   - shub type (0=shub1, 1=shub2)&n; *&t;&t;[15:8]  - Log2 max number of nodes in entire system (includes&n; *&t;&t;&t;  C-bricks, I-bricks, etc)&n; *&t;&t;[23:16] - Log2 of nodes per sharing domain&t;&t;&t; &n; * &t;&t;[31:24] - partition ID&n; * &t;&t;[39:32] - coherency_id&n; * &t;&t;[47:40] - regionsize&n; *&t;v1 &n; *&t;&t;[15:0]  - nasid mask (ex., 0x7ff for 11 bit nasid)&n; *&t; &t;[23:15] - bit position of low nasid bit&n; */
r_static
r_inline
id|u64
DECL|function|ia64_sn_get_sn_info
...
suffix:semicolon
suffix:semicolon
DECL|macro|SH_SHUB_ID_NODES_PER_BIT_MASK
mdefine_line|#define SH_SHUB_ID_NODES_PER_BIT_MASK 0x001f000000000000UL                                               
DECL|macro|SH_SHUB_ID_NODES_PER_BIT_SHFT
mdefine_line|#define SH_SHUB_ID_NODES_PER_BIT_SHFT 48                                                               
r_if
c_cond
(paren
id|shubtype
...
op_amp
id|SH_SHUB_ID_NODES_PER_BIT_MASK
)paren
op_rshift
id|SH_SHUB_ID_NODES_PER_BIT_SHFT
suffix:semicolon
r_return
l_int|0
suffix:semicolon

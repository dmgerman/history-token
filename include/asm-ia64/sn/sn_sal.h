...
DECL|macro|SAL_CONSOLE_INTR_IN
mdefine_line|#define SAL_CONSOLE_INTR_IN     0       /* manipulate input interrupts */
DECL|macro|SAL_CONSOLE_INTR_OUT
mdefine_line|#define SAL_CONSOLE_INTR_OUT    1       /* manipulate output low-water&n;                                         * interrupts&n;                                         */
...
mdefine_line|#define SN_SAL_MIN_MAJOR&t;0x0
DECL|macro|SN_SAL_MIN_MINOR
mdefine_line|#define SN_SAL_MIN_MINOR&t;0x03 /* SN1 PROMs are stuck at rev 0.03 */
macro_line|#elif defined(CONFIG_IA64_SGI_SN2)
DECL|macro|SN_SAL_MIN_MAJOR
mdefine_line|#define SN_SAL_MIN_MAJOR&t;0x0
DECL|macro|SN_SAL_MIN_MINOR
mdefine_line|#define SN_SAL_MIN_MINOR&t;0x11
macro_line|#else
macro_line|#error &quot;must specify which PROM revisions this kernel needs&quot;
...
op_assign
l_int|0
multiline_comment|/* nasid_to_cnodeid(nasid) */
suffix:semicolon
r_if
c_cond
(paren

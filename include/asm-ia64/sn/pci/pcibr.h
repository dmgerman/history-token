...
DECL|macro|PCIBR_SLOT_POWERUP
mdefine_line|#define PCIBR_SLOT_POWERUP&t;_PCIBR(1)
DECL|macro|PCIBR_SLOT_SHUTDOWN
mdefine_line|#define PCIBR_SLOT_SHUTDOWN&t;_PCIBR(2)
DECL|macro|PCIBR_SLOT_INQUIRY
mdefine_line|#define PCIBR_SLOT_INQUIRY&t;_PCIBR(3)

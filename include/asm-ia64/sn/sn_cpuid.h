...
mdefine_line|#define cpu_physical_id_to_coherence_id(cpi)&t;(((cpi) &amp; 0x600) &gt;&gt; 9)
...
mdefine_line|#define cpuid_to_coherence_id(cpuid)    cpu_physical_id_to_coherence_id(cpu_physical_id(cpuid))

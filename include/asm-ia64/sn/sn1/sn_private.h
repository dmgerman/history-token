...
id|debugger_stopped
suffix:semicolon
multiline_comment|/* &n; * IP27 piomap, created by hub_pio_alloc.&n; * xtalk_info MUST BE FIRST, since this structure is cast to a&n; * xtalk_piomap_s by generic xtalk routines.&n; */
...
id|hpio_hub
suffix:semicolon
multiline_comment|/* which hub&squot;s mapping registers are set up */
...
macro_line|#if TBD
multiline_comment|/* Ensure that hpio_xtalk_info is first */
macro_line|#assert (&amp;(((struct hub_piomap_s *)0)-&gt;hpio_xtalk_info) == 0)
macro_line|#endif
multiline_comment|/* &n; * IP27 dmamap, created by hub_pio_alloc.&n; * xtalk_info MUST BE FIRST, since this structure is cast to a&n; * xtalk_dmamap_s by generic xtalk routines.&n; */
...
id|hdma_hub
suffix:semicolon
multiline_comment|/* which hub we go through */
...
suffix:semicolon
multiline_comment|/* hub_dmamap flags */
...
macro_line|#if TBD
multiline_comment|/* Ensure that hdma_xtalk_info is first */
macro_line|#assert (&amp;(((struct hub_dmamap_s *)0)-&gt;hdma_xtalk_info) == 0)
macro_line|#endif
multiline_comment|/* &n; * IP27 interrupt handle, created by hub_intr_alloc.&n; * xtalk_info MUST BE FIRST, since this structure is cast to a&n; * xtalk_intr_s by generic xtalk routines.&n; */
...
macro_line|#if TBD
multiline_comment|/* Ensure that i_xtalk_info is first */
macro_line|#assert (&amp;(((struct hub_intr_s *)0)-&gt;i_xtalk_info) == 0)
macro_line|#endif
multiline_comment|/* IP27 hub-specific information stored under INFO_LBL_HUB_INFO */
multiline_comment|/* TBD: IP27-dependent stuff currently in nodepda.h should be here */
...
multiline_comment|/* IP27 cpu-specific information stored under INFO_LBL_CPU_INFO */
multiline_comment|/* TBD: IP27-dependent stuff currently in pda.h should be here */
...
id|ci_cpupda
suffix:semicolon
multiline_comment|/* pointer to CPU&squot;s private data area */
macro_line|#endif
...
suffix:semicolon
macro_line|#endif /* _ASM_IA64_SN_SN1_SN_PRIVATE_H */
eof

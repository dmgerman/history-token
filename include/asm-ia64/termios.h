...
mdefine_line|#define N_SMSBLOCK&t;12&t;/* SMS block mode - for talking to GSM data cards about SMS msgs */
DECL|macro|N_HDLC
...
mdefine_line|#define SET_LOW_TERMIOS_BITS(termios, termio, x) {&t;&bslash;&n;&t;unsigned short __tmp;&t;&t;&t;&t;&bslash;&n;&t;get_user(__tmp,&amp;(termio)-&gt;x);&t;&t;&t;&bslash;&n;&t;*(unsigned short *) &amp;(termios)-&gt;x = __tmp;&t;&bslash;&n;}
DECL|macro|user_termio_to_kernel_termios
mdefine_line|#define user_termio_to_kernel_termios(termios, termio)&t;&t;&bslash;&n;({&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;SET_LOW_TERMIOS_BITS(termios, termio, c_iflag);&t;&t;&bslash;&n;&t;SET_LOW_TERMIOS_BITS(termios, termio, c_oflag);&t;&t;&bslash;&n;&t;SET_LOW_TERMIOS_BITS(termios, termio, c_cflag);&t;&t;&bslash;&n;&t;SET_LOW_TERMIOS_BITS(termios, termio, c_lflag);&t;&t;&bslash;&n;&t;copy_from_user((termios)-&gt;c_cc, (termio)-&gt;c_cc, NCC);&t;&bslash;&n;})
multiline_comment|/*&n; * Translate a &quot;termios&quot; structure into a &quot;termio&quot;. Ugh.&n; */
DECL|macro|kernel_termios_to_user_termio
mdefine_line|#define kernel_termios_to_user_termio(termio, termios)&t;&t;&bslash;&n;({&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;put_user((termios)-&gt;c_iflag, &amp;(termio)-&gt;c_iflag);&t;&bslash;&n;&t;put_user((termios)-&gt;c_oflag, &amp;(termio)-&gt;c_oflag);&t;&bslash;&n;&t;put_user((termios)-&gt;c_cflag, &amp;(termio)-&gt;c_cflag);&t;&bslash;&n;&t;put_user((termios)-&gt;c_lflag, &amp;(termio)-&gt;c_lflag);&t;&bslash;&n;&t;put_user((termios)-&gt;c_line,  &amp;(termio)-&gt;c_line);&t;&bslash;&n;&t;copy_to_user((termio)-&gt;c_cc, (termios)-&gt;c_cc, NCC);&t;&bslash;&n;})
...
macro_line|#endif /* _ASM_IA64_TERMIOS_H */
eof

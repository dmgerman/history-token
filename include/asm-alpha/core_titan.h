...
DECL|macro|__readb
mdefine_line|#define __readb(a)&t;&t;titan_readb(a)
DECL|macro|__readw
mdefine_line|#define __readw(a)&t;&t;titan_readw(a)
DECL|macro|__readl
mdefine_line|#define __readl(a)&t;&t;titan_readl(a)
DECL|macro|__readq
mdefine_line|#define __readq(a)&t;&t;titan_readq(a)
DECL|macro|__writeb
mdefine_line|#define __writeb(x,a)&t;&t;titan_writeb(x,a)
DECL|macro|__writew
mdefine_line|#define __writew(x,a)&t;&t;titan_writew(x,a)
DECL|macro|__writel
mdefine_line|#define __writel(x,a)&t;&t;titan_writel(x,a)
DECL|macro|__writeq
mdefine_line|#define __writeq(x,a)&t;&t;titan_writeq(x,a)
DECL|macro|__ioremap
mdefine_line|#define __ioremap(a,s)&t;&t;titan_ioremap(a,s)
DECL|macro|__iounmap
mdefine_line|#define __iounmap(a)&t;&t;titan_iounmap(a)

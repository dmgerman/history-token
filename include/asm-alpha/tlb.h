...
mdefine_line|#define tlb_remove_tlb_entry(tlb, pte, addr)&t;do { } while (0)
...
mdefine_line|#define pte_free_tlb(tlb,pte)&t;&t;&t;pte_free(pte)
DECL|macro|pmd_free_tlb
mdefine_line|#define pmd_free_tlb(tlb,pmd)&t;&t;&t;pmd_free(pmd)
macro_line|#endif
eof

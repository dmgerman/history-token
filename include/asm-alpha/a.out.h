...
mdefine_line|#define SET_AOUT_PERSONALITY(BFPM, EX) &bslash;&n;&t;set_personality (((BFPM-&gt;sh_bang || EX.ah.entry &lt; 0x100000000L &bslash;&n;&t;&t;&t;   ? ADDR_LIMIT_32BIT : 0) | PER_OSF4))

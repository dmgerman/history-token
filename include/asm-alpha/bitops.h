...
multiline_comment|/*&n; * __ffs = Find First set bit in word.  Undefined if no set bit exists.&n; */
DECL|function|__ffs
r_static
r_inline
r_int
...
multiline_comment|/*&n; * ffs: find first bit set. This is defined the same way as&n; * the libc and compiler builtin ffs routines, therefore&n; * differs in spirit from the above __ffs.&n; */
DECL|function|ffs
r_static
r_inline
r_int

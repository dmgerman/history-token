multiline_comment|/* &n; * inclue/asm-ppc/rtc.h&n; *&n; * Copyright 2002 MontaVista Software Inc.&n; * Author: Tom Rini &lt;trini@mvista.com&gt;&n; *&n; * Based on:&n; * include/asm-m68k/rtc.h&n; *&n; * Copyright Richard Zidlicky&n; * implementation details for genrtc/q40rtc driver&n; *&n; * And the old drivers/macintosh/rtc.c which was heavily based on:&n; * Linux/SPARC Real Time Clock Driver&n; * Copyright (C) 1996 Thomas K. Dyas (tdyas@eden.rutgers.edu)&n; *&n; * With additional work by Paul Mackerras and Franz Sirl.&n; */

...
suffix:semicolon
multiline_comment|/*&n; * Dynamic DMA Mapping stuff&n; * Originally stolen from i386 by ajoshi and updated by paulus&n; * Non-consistent cache support by Dan Malek&n; */
...
multiline_comment|/* Make physical memory consistent for a set of streaming&n; * mode DMA translations after a transfer.&n; *&n; * The same as pci_dma_sync_single_for_* but for a scatter-gather list,&n; * same rules and usage.&n; */

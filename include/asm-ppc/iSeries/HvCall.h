...
multiline_comment|/*&n;enum HvCall_ReturnCode&n;{&n;    HvCall_Good&t;&t;&t;= 0,&n;    HvCall_Partial&t;&t;= 1,&n;    HvCall_NotOwned&t;&t;= 2,&n;    HvCall_NotFreed&t;&t;= 3,&n;    HvCall_UnspecifiedError&t;= 4&n;};&n;&n;enum HvCall_TypeOfSIT&n;{&n;    HvCall_ReduceOnly&t;&t;= 0,&n;    HvCall_Unconditional&t;= 1&n;};&n;&n;enum HvCall_TypeOfYield&n;{&n;    HvCall_YieldTimed&t;&t;= 0,&t;// Yield until specified time&n;    HvCall_YieldToActive&t;= 1,&t;// Yield until all active procs have run&n;    HvCall_YieldToProc&t;&t;= 2&t;// Yield until the specified processor has run&n;};&n;&n;enum HvCall_InterruptMasks&n;{&n;    HvCall_MaskIPI&t;&t;= 0x00000001,&n;    HvCall_MaskLpEvent&t;&t;= 0x00000002,&n;    HvCall_MaskLpProd&t;&t;= 0x00000004,&n;    HvCall_MaskTimeout&t;&t;= 0x00000008&n;};&n;&n;enum HvCall_VaryOffChunkRc&n;{&n;    HvCall_VaryOffSucceeded&t;= 0,&n;    HvCall_VaryOffWithdrawn&t;= 1,&n;    HvCall_ChunkInLoadArea&t;= 2,&n;    HvCall_ChunkInHPT&t;&t;= 3,&n;    HvCall_ChunkNotAccessible&t;= 4,&n;    HvCall_ChunkInUse&t;&t;= 5&n;};&n;*/

multiline_comment|/*&n; * Contains the definition of registers common to all PowerPC variants.&n; */
multiline_comment|/*&n; * The Book E definitions are hacked into here for 440 right&n; * now.  This whole thing needs regorganized (maybe two files)&n; * so that it becomes readable. -Matt&n; * It will be.  -- Tom.&n; */
...
macro_line|#else
DECL|macro|MSR_KERNEL
mdefine_line|#define MSR_KERNEL&t;(MSR_|MSR_IR|MSR_DR)
macro_line|#endif
DECL|macro|MSR_USER
...
mdefine_line|#define SPRN_CCR0&t;0x3B3&t;/* Core Configuration Register (4xx) */
...
macro_line|#else
DECL|macro|SPRN_DAC1
mdefine_line|#define SPRN_DAC1&t;0x13C&t;/* Book E Data Address Compare 1 */
DECL|macro|SPRN_DAC2
mdefine_line|#define SPRN_DAC2&t;0x13D&t;/* Book E Data Address Compare 2 */
...
DECL|macro|DBCR_EDM
mdefine_line|#define DBCR_EDM&t;0x80000000
DECL|macro|DBCR_IDM
mdefine_line|#define DBCR_IDM&t;0x40000000
DECL|macro|DBCR_RST
...
DECL|macro|DBCR_IC
mdefine_line|#define DBCR_IC&t;&t;0x08000000&t;/* Instruction Completion Debug Evnt */
DECL|macro|DBCR_BT
mdefine_line|#define DBCR_BT&t;&t;0x04000000&t;/* Branch Taken Debug Event */
DECL|macro|DBCR_EDE
mdefine_line|#define DBCR_EDE&t;0x02000000&t;/* Exception Debug Event */
DECL|macro|DBCR_TDE
mdefine_line|#define DBCR_TDE&t;0x01000000&t;/* TRAP Debug Event */
DECL|macro|DBCR_FER
...
mdefine_line|#define SPRN_DBCR0&t;0x3F2&t;&t;/* Debug Control Register 0 */
macro_line|#else
DECL|macro|SPRN_DBCR0
mdefine_line|#define SPRN_DBCR0&t;0x134&t;&t;/* Book E Debug Control Register 0 */
macro_line|#endif /* CONFIG_BOOKE */
...
mdefine_line|#define SPRN_DBCR1&t;0x3BD&t;&t;/* Debug Control Register 1 */&t;&t;
DECL|macro|SPRN_DBSR
mdefine_line|#define SPRN_DBSR&t;0x3F0&t;&t;/* Debug Status Register */&t;&t;
DECL|macro|DBSR_IC
...
macro_line|#else
DECL|macro|SPRN_DBCR1
mdefine_line|#define SPRN_DBCR1&t;0x135&t;&t;/* Book E Debug Control Register 1 */
DECL|macro|SPRN_DBSR
mdefine_line|#define SPRN_DBSR&t;0x130&t;&t;/* Book E Debug Status Register */
DECL|macro|DBSR_IC
mdefine_line|#define DBSR_IC&t;&t;0x08000000&t;/* Book E Instruction Completion */
DECL|macro|DBSR_TIE
mdefine_line|#define DBSR_TIE&t;0x01000000&t;/* Book E Trap Instruction Event */
macro_line|#endif /* CONFIG_BOOKE */
DECL|macro|SPRN_DCCR
mdefine_line|#define SPRN_DCCR&t;0x3FA&t;&t;/* Data Cache Cacheability Register */
...
mdefine_line|#define SPRN_DCMP&t;0x3D1&t;&t;/* Data TLB Compare Register */
DECL|macro|SPRN_DCWR
mdefine_line|#define SPRN_DCWR&t;0x3BA&t;&t;/* Data Cache Write-thru Register */
...
mdefine_line|#define SPRN_DEAR&t;0x3D5&t;&t;/* Data Error Address Register */
macro_line|#else
DECL|macro|SPRN_DEAR
mdefine_line|#define SPRN_DEAR&t;0x03D&t;&t;/* Book E Data Error Address Register */
macro_line|#endif /* CONFIG_BOOKE */
DECL|macro|SPRN_DEC
...
macro_line|#ifndef CONFIG_BOOKE
DECL|macro|SPRN_ESR
mdefine_line|#define SPRN_ESR&t;0x3D4&t;&t;/* Exception Syndrome Register */
macro_line|#else
DECL|macro|SPRN_ESR
mdefine_line|#define SPRN_ESR&t;0x03E&t;&t;/* Book E Exception Syndrome Register */
macro_line|#endif /* CONFIG_BOOKE */
DECL|macro|ESR_MCI
mdefine_line|#define ESR_MCI&t;&t;0x80000000&t;/* 405 Machine Check - Instruction */
DECL|macro|ESR_IMCP
...
mdefine_line|#define SPRN_EVPR&t;0x3D6&t;&t;/* Exception Vector Prefix Register */
...
macro_line|#else
DECL|macro|SPRN_IAC1
mdefine_line|#define SPRN_IAC1&t;0x138&t;/* Book E Instruction Address Compare 1 */
DECL|macro|SPRN_IAC2
mdefine_line|#define SPRN_IAC2&t;0x139&t;/* Book E Instruction Address Compare 2 */
macro_line|#endif /* CONFIG_BOOKE */
...
macro_line|#else
DECL|macro|SPRN_PID
mdefine_line|#define SPRN_PID&t;0x030&t;/* Book E Process ID */
DECL|macro|SPRN_PIR
mdefine_line|#define SPRN_PIR&t;0x11E&t;/* Book E Processor Identification Register */
macro_line|#endif /* CONFIG_BOOKE */
DECL|macro|SPRN_PIT
...
mdefine_line|#define SGR_NORMAL&t;0
DECL|macro|SGR_GUARDED
mdefine_line|#define SGR_GUARDED&t;1
DECL|macro|SPRN_SIA
...
mdefine_line|#define SPRN_SPRG4&t;0x114&t;/* Special Purpose Register General 4 (4xx) */
DECL|macro|SPRN_SPRG5
mdefine_line|#define SPRN_SPRG5&t;0x115&t;/* Special Purpose Register General 5 (4xx) */
DECL|macro|SPRN_SPRG6
mdefine_line|#define SPRN_SPRG6&t;0x116&t;/* Special Purpose Register General 6 (4xx) */
DECL|macro|SPRN_SPRG7
mdefine_line|#define SPRN_SPRG7&t;0x117&t;/* Special Purpose Register General 7 (4xx) */
...
mdefine_line|#define SPRN_SU0R&t;0x3BC&t;/* &quot;User 0&quot; real mode */
DECL|macro|SPRN_TBHI
mdefine_line|#define SPRN_TBHI&t;0x3DC&t;/* Time Base High (4xx) */
DECL|macro|SPRN_TBHU
mdefine_line|#define SPRN_TBHU&t;0x3CC&t;/* Time Base High User-mode (4xx) */
DECL|macro|SPRN_TBLO
mdefine_line|#define SPRN_TBLO&t;0x3DD&t;/* Time Base Low (4xx) */
DECL|macro|SPRN_TBLU
mdefine_line|#define SPRN_TBLU&t;0x3CD&t;/* Time Base Low User-mode (4xx) */
...
macro_line|#ifndef CONFIG_BOOKE
DECL|macro|SPRN_TCR
mdefine_line|#define SPRN_TCR&t;0x3DA&t;&t;/* Timer Control Register */
macro_line|#else
DECL|macro|SPRN_TCR
mdefine_line|#define SPRN_TCR&t;0x154&t;&t;/* Book E Timer Control Register */
macro_line|#endif
DECL|macro|TCR_WP
...
macro_line|#ifndef CONFIG_BOOKE
DECL|macro|SPRN_TSR
mdefine_line|#define SPRN_TSR&t;0x3D8&t;&t;/* Timer Status Register */
macro_line|#else
DECL|macro|SPRN_TSR
mdefine_line|#define SPRN_TSR&t;0x150&t;&t;/* Book E Timer Status Register */
macro_line|#endif /* CONFIG_BOOKE */
DECL|macro|TSR_ENW
...
DECL|macro|SPRN_ZPR
mdefine_line|#define SPRN_ZPR&t;0x3B0&t;/* Zone Protection Register */
...
DECL|macro|SPR4
mdefine_line|#define SPR4&t;SPRN_SPRG4&t;/* Supervisor Private Registers (4xx) */
DECL|macro|SPR5
...
DECL|macro|SPRG4R
mdefine_line|#define SPRG4R&t;SPRN_SPRG4R&t;/* Book E Supervisor Private Registers */
DECL|macro|SPRG5R

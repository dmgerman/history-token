...
multiline_comment|/* deliberately undefined */
DECL|macro|udelay
mdefine_line|#define udelay(n) (__builtin_constant_p(n)? &bslash;&n;&t;((n) &gt; __MAX_UDELAY? __bad_udelay(): __udelay((n) * (19 * HZ))) : &bslash;&n;&t;__udelay((n) * (19 * HZ)))
DECL|macro|ndelay
mdefine_line|#define ndelay(n) (__builtin_constant_p(n)? &bslash;&n;&t;((n) &gt; __MAX_NDELAY? __bad_ndelay(): __ndelay((n) * HZ)) : &bslash;&n;&t;__ndelay((n) * HZ))

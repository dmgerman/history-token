multiline_comment|/*&n; *  include/asm-ppc/raven.h -- Raven MPIC chip.&n; *&n; *  Copyright (C) 1998 Johnnie Peters&n; *&n; *  This file is subject to the terms and conditions of the GNU General Public&n; *  License.  See the file COPYING in the main directory of this archive&n; *  for more details.&n; */

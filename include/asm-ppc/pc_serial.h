multiline_comment|/*&n; * BK Id: %F% %I% %G% %U% %#%&n; *&n; * include/asm-ppc/pc_serial.h&n; *&n; * This is basically a copy of include/asm-i386/serial.h.&n; * It is used on platforms which have an ISA bus and thus are likely&n; * to have PC-style serial ports at the legacy I/O port addresses.&n; * It also includes the definitions for the fourport, accent, boca&n; * and hub6 multiport serial cards, although I have never heard of&n; * anyone using any of those on a PPC platform.  -- paulus&n; */

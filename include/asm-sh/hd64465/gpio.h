...
multiline_comment|/*&n; * $Id: gpio.h,v 1.3 2003/05/04 19:30:14 lethal Exp $&n; *&n; * Hitachi HD64465 companion chip: General Purpose IO pins support.&n; * This layer enables other device drivers to configure GPIO&n; * pins, get and set their values, and register an interrupt&n; * routine for when input pins change in hardware.&n; *&n; * by Greg Banks &lt;gbanks@pocketpenguins.com&gt;&n; * (c) 2000 PocketPenguins Inc.&n; */

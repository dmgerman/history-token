macro_line|#ifndef __ASM_SH_HITACHI_7751SE_H
DECL|macro|__ASM_SH_HITACHI_7751SE_H
mdefine_line|#define __ASM_SH_HITACHI_7751SE_H
multiline_comment|/*&n; * linux/include/asm-sh/hitachi_7751se.h&n; *&n; * Copyright (C) 2000  Kazumoto Kojima&n; *&n; * Hitachi SolutionEngine support&n;&n; * Modified for 7751 Solution Engine by&n; * Ian da Silva and Jeremy Siegel, 2001.&n; */
...
mdefine_line|#define PA_DIPSW0&t;0xb9000000&t;/* Dip switch 5,6 */
DECL|macro|PA_DIPSW1
mdefine_line|#define PA_DIPSW1&t;0xb9000002&t;/* Dip switch 7,8 */
DECL|macro|PA_LED
mdefine_line|#define PA_LED&t;&t;0xba000000&t;/* LED */
DECL|macro|PA_BCR
mdefine_line|#define&t;PA_BCR&t;&t;0xbb000000&t;/* FPGA on the MS7751SE01 */
...
DECL|macro|MRSHPC_MODE
mdefine_line|#define MRSHPC_MODE     (PA_MRSHPC + 4)
...
DECL|macro|IRQ_79C973
mdefine_line|#define IRQ_79C973&t;13
macro_line|#endif  /* __ASM_SH_HITACHI_7751SE_H */
eof

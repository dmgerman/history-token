macro_line|#ifndef __ASM_SH_M1543C_H
DECL|macro|__ASM_SH_M1543C_H
mdefine_line|#define __ASM_SH_M1543C_H
multiline_comment|/*&n; * linux/include/asm-sh/m1543c.h&n; * Copyright (C) 2001  Nobuhiro Sakawa&n; * M1543C:PCI-ISA Bus Bridge with Super IO Chip support&n; *&n; * from&n; *&n; * linux/include/asm-sh/smc37c93x.h&n; *&n; * Copyright (C) 2000  Kazumoto Kojima&n; *&n; * SMSC 37C93x Super IO Chip support&n; */
...
DECL|macro|COM3_PRIMARY_BASE
mdefine_line|#define COM3_PRIMARY_BASE&t;0x3e8
...
DECL|macro|I8259_M_CR
mdefine_line|#define I8259_M_CR&t;&t;0x20
DECL|macro|I8259_M_MR
mdefine_line|#define I8259_M_MR&t;&t;0x21
DECL|macro|I8259_S_CR
mdefine_line|#define I8259_S_CR&t;&t;0xa0
DECL|macro|I8259_S_MR
mdefine_line|#define I8259_S_MR&t;&t;0xa1
...
DECL|macro|LDN_COM3
mdefine_line|#define LDN_COM3&t;&t;11
DECL|macro|LDN_RTC
...
DECL|macro|CONFIG_ENTER1
mdefine_line|#define CONFIG_ENTER1&t;&t;0x51
DECL|macro|CONFIG_ENTER2
mdefine_line|#define CONFIG_ENTER2&t;&t;0x23
DECL|macro|CONFIG_EXIT
mdefine_line|#define CONFIG_EXIT&t;&t;0xbb
...
DECL|macro|PS2_IRQ_INDEX
mdefine_line|#define PS2_IRQ_INDEX&t;&t;0x72
...
macro_line|#endif  /* __ASM_SH_M1543C_H */
eof

...
mdefine_line|#define DEVREG_MATCH_CU_TYPE    0x00000001
DECL|macro|DEVREG_MATCH_CU_MODEL
mdefine_line|#define DEVREG_MATCH_CU_MODEL   0x00000002
DECL|macro|DEVREG_MATCH_DEV_TYPE
mdefine_line|#define DEVREG_MATCH_DEV_TYPE   0x00000004
DECL|macro|DEVREG_MATCH_DEV_MODEL
mdefine_line|#define DEVREG_MATCH_DEV_MODEL  0x00000008
DECL|macro|DEVREG_EXACT_MATCH
mdefine_line|#define DEVREG_EXACT_MATCH      (DEVREG_MATCH_CU_TYPE|DEVREG_MATCH_CU_MODEL|DEVREG_MATCH_DEV_TYPE|DEVREG_MATCH_DEV_MODEL)
DECL|macro|DEVREG_NO_CU_INFO
mdefine_line|#define DEVREG_NO_CU_INFO       (DEVREG_MATCH_DEV_TYPE|DEVREG_MATCH_DEV_MODEL)
DECL|macro|DEVREG_NO_DEV_INFO
mdefine_line|#define DEVREG_NO_DEV_INFO      (DEVREG_MATCH_CU_TYPE|DEVREG_MATCH_CU_MODEL)

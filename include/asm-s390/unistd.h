...
mdefine_line|#define _syscall0(type,name)                                 &bslash;&n;type name(void) {                                            &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name)                          &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}
DECL|macro|_syscall1
mdefine_line|#define _syscall1(type,name,type1,arg1)                      &bslash;&n;type name(type1 arg1) {                                      &bslash;&n;        register type1 __arg1 asm(&quot;2&quot;) = arg1;               &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name),                         &bslash;&n;                  &quot;0&quot; (__arg1)                               &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}
DECL|macro|_syscall2
mdefine_line|#define _syscall2(type,name,type1,arg1,type2,arg2)           &bslash;&n;type name(type1 arg1, type2 arg2) {                          &bslash;&n;        register type1 __arg1 asm(&quot;2&quot;) = arg1;               &bslash;&n;        register type2 __arg2 asm(&quot;3&quot;) = arg2;               &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name),                         &bslash;&n;                  &quot;0&quot; (__arg1),                              &bslash;&n;                  &quot;d&quot; (__arg2)                               &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}
DECL|macro|_syscall3
mdefine_line|#define _syscall3(type,name,type1,arg1,type2,arg2,type3,arg3)&bslash;&n;type name(type1 arg1, type2 arg2, type3 arg3) {              &bslash;&n;        register type1 __arg1 asm(&quot;2&quot;) = arg1;               &bslash;&n;        register type2 __arg2 asm(&quot;3&quot;) = arg2;               &bslash;&n;        register type3 __arg3 asm(&quot;4&quot;) = arg3;               &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name),                         &bslash;&n;                  &quot;0&quot; (__arg1),                              &bslash;&n;                  &quot;d&quot; (__arg2),                              &bslash;&n;                  &quot;d&quot; (__arg3)                               &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}
DECL|macro|_syscall4
mdefine_line|#define _syscall4(type,name,type1,arg1,type2,arg2,type3,arg3,&bslash;&n;                  type4,name4)                               &bslash;&n;type name(type1 arg1, type2 arg2, type3 arg3, type4 arg4) {  &bslash;&n;        register type1 __arg1 asm(&quot;2&quot;) = arg1;               &bslash;&n;        register type2 __arg2 asm(&quot;3&quot;) = arg2;               &bslash;&n;        register type3 __arg3 asm(&quot;4&quot;) = arg3;               &bslash;&n;        register type4 __arg4 asm(&quot;5&quot;) = arg4;               &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name),                         &bslash;&n;                  &quot;0&quot; (__arg1),                              &bslash;&n;                  &quot;d&quot; (__arg2),                              &bslash;&n;                  &quot;d&quot; (__arg3),                              &bslash;&n;                  &quot;d&quot; (__arg4)                               &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}
DECL|macro|_syscall5
mdefine_line|#define _syscall5(type,name,type1,arg1,type2,arg2,type3,arg3,&bslash;&n;                  type4,name4,type5,name5)                   &bslash;&n;type name(type1 arg1, type2 arg2, type3 arg3, type4 arg4,    &bslash;&n;          type5 arg5) {                                      &bslash;&n;        register type1 __arg1 asm(&quot;2&quot;) = arg1;               &bslash;&n;        register type2 __arg2 asm(&quot;3&quot;) = arg2;               &bslash;&n;        register type3 __arg3 asm(&quot;4&quot;) = arg3;               &bslash;&n;        register type4 __arg4 asm(&quot;5&quot;) = arg4;               &bslash;&n;        register type5 __arg5 asm(&quot;6&quot;) = arg5;               &bslash;&n;        register long __svcres asm(&quot;2&quot;);                     &bslash;&n;        long __res;                                          &bslash;&n;        __asm__ __volatile__ (                               &bslash;&n;                &quot;    svc %b1&bslash;n&quot;                              &bslash;&n;                : &quot;=d&quot; (__svcres)                            &bslash;&n;                : &quot;i&quot; (__NR_##name),                         &bslash;&n;                  &quot;0&quot; (__arg1),                              &bslash;&n;                  &quot;d&quot; (__arg2),                              &bslash;&n;                  &quot;d&quot; (__arg3),                              &bslash;&n;                  &quot;d&quot; (__arg4),                              &bslash;&n;                  &quot;d&quot; (__arg5)                               &bslash;&n;                : _svc_clobber );                            &bslash;&n;&t;__res = __svcres;                                    &bslash;&n;        __syscall_return(type,__res);                        &bslash;&n;}

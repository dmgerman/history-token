...
multiline_comment|/*&n; * page middle directory allocation/free routines.&n; * We don&squot;t use pmd cache, so these are dummy routines.&n; */
...
mdefine_line|#define pte_alloc_kernel(pmd, addr) pte_alloc(pmd, addr)

...
DECL|macro|__BITOPS_WORDS
mdefine_line|#define __BITOPS_WORDS(bits) (((bits)+__BITOPS_WORDSIZE-1)/__BITOPS_WORDSIZE)
DECL|macro|__BITOPS_BARRIER
mdefine_line|#define __BITOPS_BARRIER() __asm__ __volatile__ ( &quot;&quot; : : : &quot;memory&quot; )
...
mdefine_line|#define minix_test_and_set_bit(nr,addr) &bslash;&n;&t;test_and_set_bit(nr,(unsigned long *)addr)
DECL|macro|minix_set_bit
mdefine_line|#define minix_set_bit(nr,addr) &bslash;&n;&t;set_bit(nr,(unsigned long *)addr)
...
mdefine_line|#define minix_test_bit(nr,addr) &bslash;&n;&t;test_bit(nr,(unsigned long *)addr)
DECL|macro|minix_find_first_zero_bit
mdefine_line|#define minix_find_first_zero_bit(addr,size) &bslash;&n;&t;find_first_zero_bit(addr,size)

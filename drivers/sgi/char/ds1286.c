multiline_comment|/*&n; * DS1286 Real Time Clock interface for Linux&t;&n; *&n; * Copyright (C) 1998, 1999, 2000 Ralf Baechle&n; *&t;&n; * Based on code written by Paul Gortmaker.&n; *&n; * This driver allows use of the real time clock (built into nearly all&n; * computers) from user space. It exports the /dev/rtc interface supporting&n; * various ioctl() and also the /proc/rtc pseudo-file for status&n; * information.&n; *&n; * The ioctls can be used to set the interrupt behaviour and generation rate&n; * from the RTC via IRQ 8. Then the /dev/rtc interface can be used to make&n; * use of these timer interrupts, be they interval or alarm based.&n; *&n; * The /dev/rtc interface will block on reads until an interrupt has been&n; * received. If a RTC interrupt has already happened, it will output an&n; * unsigned long and then block. The output value contains the interrupt&n; * status in the low byte and the number of interrupts since the last read&n; * in the remaining high bytes. The /dev/rtc interface can also be used with&n; * the select(2) call.&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2 of the License, or (at your&n; * option) any later version.&n; */

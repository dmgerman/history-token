...
multiline_comment|/*&n; * Note: This driver seems to have been derived from some&n; * version of the sbus/char/zs.c driver.  A lot of clean-up&n; * and bug fixes seem to have happened to the Sun driver in&n; * the intervening time.  As of 21.09.1999, I have merged in&n; * ONLY the changes necessary to fix observed functional&n; * problems on the Indy.  Someone really ought to do a&n; * thorough pass to merge in the rest of the updates.&n; * Better still, someone really ought to make it a common&n; * code module for both platforms.   kevink@mips.com&n; *&n; * 20010616 - Klaus Naumann &lt;spock@mgnet.de&gt; : Make serial console work with&n; *                                             any speed - not only 9600&n; */
...
op_assign
id|KERN_WARNING
l_string|&quot;Warning: null sgi_serial for %s in %s&bslash;n&quot;
suffix:semicolon
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;rs_open %s successful...&bslash;n&quot;
comma
id|tty-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Wheee, bogus zs chip number requested.&quot;
)paren
suffix:semicolon
r_return
(paren
...
r_else
(brace
multiline_comment|/* If the user doesn&squot;t set console=... try to read the&n;&t;&t; * PROM variable - if this fails use 9600 baud and&n;&t;&t; * inform the user about the problem&n;&t;&t; */
id|dbaud
op_assign
...
r_else
(brace
multiline_comment|/* Use prom_printf() to make sure that the user&n;&t;&t;&t; * is getting anything ...&n;&t;&t;&t; */
id|prom_printf
c_func
(paren
l_string|&quot;No dbaud set in PROM ?!? Using 9600.&bslash;n&quot;
)paren
suffix:semicolon
id|baud
op_assign
...
c_func
(paren
l_string|&quot;Console: ttyS%d (Zilog8530), %d baud&bslash;n&quot;
comma
id|info-&gt;line
comma
id|baud

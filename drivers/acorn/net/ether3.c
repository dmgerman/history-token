...
r_static
r_int
DECL|function|ether3_set_mac_address
id|ether3_set_mac_address
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/*&n;&t; * We&squot;ll set the MAC address on the chip when we open it.&n;&t; */
r_return
l_int|0
suffix:semicolon
)brace

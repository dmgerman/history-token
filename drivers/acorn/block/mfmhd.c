...
multiline_comment|/*&n; * This routine is called to flush all partitions and partition tables&n; * for a changed MFM disk, and then re-read the new partition table.&n; */

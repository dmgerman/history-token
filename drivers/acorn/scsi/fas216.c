...
r_break
suffix:semicolon
multiline_comment|/* We were not negotiating a wide data transfer,&n;&t;&t; * but the device sent is a negotiation request.&n;&t;&t; * Honour the request by sending back a WDTR&n;&t;&t; * message containing our capability, limited by&n;&t;&t; * the targets capability.&n;&t;&t; */
r_default
suffix:colon
id|fas216_cmd
c_func
...
r_break
suffix:semicolon
multiline_comment|/* We initiated the wide data transfer negotiation,&n;&t;&t; * and have successfully received a response from the&n;&t;&t; * target.  The synchronous transfer agreement has been&n;&t;&t; * reached.  Note: if the values returned are out of our&n;&t;&t; * bounds, we must reject the message.&n;&t;&t; */
r_case
id|neg_inprogress
suffix:colon
id|res
...
multiline_comment|/*&n;&t; * If we were performing Data-In, then the FIFO counter&n;&t; * contains the number of bytes not transferred via DMA&n;&t; * from the on-board FIFO.  Read them manually.&n;&t; */
r_if
c_cond
(paren
id|info-&gt;scsi.phase
...
multiline_comment|/*&n;&t; * Default to PIO mode or DMA mode if we have&n;&t; * a synchronous transfer agreement.&n;&t; */
r_if
c_cond
(paren
id|info-&gt;device
...
id|LOG_CONNECT
comma
l_string|&quot;Connected: %1x %1x %02x, reconnected: %1x %1x %02x&quot;
comma
id|info-&gt;SCpnt-&gt;target
comma
id|info-&gt;SCpnt-&gt;lun
...
l_int|0
comma
l_string|&quot;reconnect queue tag 0x%02x&quot;
comma
id|message
(braket
l_int|1
...
id|EXTENDED_WDTR
suffix:colon
multiline_comment|/* Wide transfer negotiation request/reply */
id|fas216_handlewide
c_func
(paren
id|info
...
id|LOG_BUSSERVICE
comma
l_string|&quot;bus service: stat=%02x ssr=%02x phase=%02x&quot;
comma
id|stat
comma
id|ssr
...
id|LOG_FUNCTIONDONE
comma
l_string|&quot;function done: stat=%02x ssr=%02x phase=%02x&quot;
comma
id|stat
comma
id|ssr
...
l_string|&quot; phase %s isr %02X ssr %02X stat %02X&quot;
comma
id|fas216_drv_phase
c_func
(paren
...
macro_line|#if defined(DEBUG_CONNECT) || defined(DEBUG_MESSAGES)
id|printk
c_func
(paren
l_string|&quot;scsi%d.%c: starting &quot;
comma
id|info-&gt;host-&gt;host_no
comma
l_char|&squot;0&squot;
...
suffix:semicolon
singleline_comment|//printk(&quot;scsi%d.%c: sense buffer: &quot;, info-&gt;host-&gt;host_no, &squot;0&squot; + SCpnt-&gt;target);
...
c_func
(paren
l_string|&quot;scsi%d.H: received command for id %d (%p) &quot;
comma
...
c_func
(paren
l_string|&quot;scsi%d.H: queue %s&bslash;n&quot;
comma
id|info-&gt;host-&gt;host_no
comma
id|result

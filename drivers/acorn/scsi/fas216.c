...
suffix:semicolon
multiline_comment|/**&n; * fas216_clockrate - calculate clock conversion factor&n; * @clock: clock speed in MHz&n; *&n; * Calculate correct value to be written into clock conversion factor&n; * register. Returns CLKF_ value.&n; */
...
multiline_comment|/**&n; * fas216_command - queue a command for adapter to process.&n; * @SCpnt: Command to queue&n; *&n; * Queue a command for adapter to process.&n; * Returns: scsi result code.&n; * Notes: io_request_lock is held, interrupts are disabled.&n; */

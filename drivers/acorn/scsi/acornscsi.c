...
suffix:semicolon
id|ashost-&gt;dma.io_port
op_assign
id|host-&gt;io_port
op_plus
l_int|0xc00
suffix:semicolon
id|ashost-&gt;dma.io_intr_clear
op_assign
id|POD_SPACE
c_func
(paren
...
DECL|function|acornscsi_remove
r_static
r_void
id|__devexit
id|acornscsi_remove
...
suffix:semicolon
multiline_comment|/*&n;&t; * Put card into RESET state&n;&t; */
id|outb
c_func
(paren
l_int|0x80
...
suffix:semicolon
DECL|variable|acornscsi_driver
r_static
r_struct
id|ecard_driver
id|acornscsi_driver

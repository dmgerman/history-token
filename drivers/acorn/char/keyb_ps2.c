...
suffix:semicolon
DECL|macro|TX_DONE
mdefine_line|#define TX_DONE 0
DECL|macro|TX_SENT
mdefine_line|#define TX_SENT 1
DECL|macro|TX_SEND
mdefine_line|#define TX_SEND 2
DECL|variable|tx_state
r_static
r_volatile
r_int
id|tx_state
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t; * take care of MS extra keys (actually&n;&t;&t; * 0x7d - 0x7f, but last one is already K_NONE&n;&t;&t; */
r_case
id|ESCE0
c_func
(paren

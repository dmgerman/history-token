...
multiline_comment|/* Need to split up the buffers to stay within the limits of kmalloc */
DECL|macro|W100_BUF_NUM
mdefine_line|#define W100_BUF_NUM&t;6
...
(paren
id|KERN_WARNING
l_string|&quot;can&squot;t alloc pre-off image buffer %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;can&squot;t find pre-off image buffer %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon

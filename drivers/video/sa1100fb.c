...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * If inverse mode was selected, invert all the colours&n;&t; * rather than the register number.  The register number&n;&t; * is what you poke into the framebuffer to produce the&n;&t; * colour you requested.&n;&t; *&n;&t;if (inverse) {&n;&t;&t;red   = 0xffff - red;&n;&t;&t;green = 0xffff - green;&n;&t;&t;blue  = 0xffff - blue;&n;&t;}&n;&t;*/
...
c_func
(paren
l_string|&quot;sa1100fb_blank: blank=%d fix.id=%s&bslash;n&quot;
comma
id|blank
comma
id|info-&gt;fix.id
...
multiline_comment|/* Fake monspecs to fill in infonfo structure */
DECL|variable|__initdata
r_static
r_struct
id|fb_monspecs
...
macro_line|#endif
macro_line|#ifdef CONFIG_CPU_FREQ
id|info-&gt;clockchg.notifier_call
op_assign
id|sa1100fb_clkchg_notifier
suffix:semicolon

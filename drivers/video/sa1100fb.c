...
multiline_comment|/*&n; * enable this if your panel appears to have broken&n; */
DECL|macro|CHECK_COMPAT
macro_line|#undef CHECK_COMPAT
...
suffix:semicolon
macro_line|#ifdef CHECK_COMPAT
r_static
r_void
DECL|function|sa1100fb_check_shadow
id|sa1100fb_check_shadow
c_func
(paren
r_struct
id|sa1100fb_lcd_reg
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * These machines are good machines!&n;&t; */
r_if
c_cond
(paren
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * The following ones are bad, bad, bad.&n;&t; * Please make yours good!&n;&t; */
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;Configuring Pangolin LCD&bslash;n&quot;
)paren
suffix:semicolon
id|shadow.lccr0
op_assign
...
c_func
(paren
l_string|&quot;pcd = %x, PixCldDiv(pcd)=%x&bslash;n&quot;
comma
id|pcd
comma
id|LCCR3_PixClkDiv
...
c_func
(paren
l_string|&quot;Configuring  Freebird LCD&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#if 1
id|shadow.lccr0
...
suffix:semicolon
multiline_comment|/* Check ,Chester */
id|shadow.lccr1
op_assign
id|LCCR1_DisWdth
c_func
...
c_func
(paren
l_string|&quot;Configuring  HuW LCD&bslash;n&quot;
)paren
suffix:semicolon
id|shadow.lccr0
op_assign
...
suffix:semicolon
macro_line|#if defined LART_GREY_LCD
id|shadow.lccr0
op_assign
id|LCCR0_LEN
op_plus
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined LART_COLOR_LCD
id|shadow.lccr0
op_assign
id|LCCR0_LEN
op_plus
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined LART_VIDEO_OUT
id|shadow.lccr0
op_assign
id|LCCR0_LEN
op_plus
...
c_func
(paren
l_string|&quot;Configuring GraphicsClient LCD&bslash;n&quot;
)paren
suffix:semicolon
id|shadow.lccr0
op_assign
...
c_func
(paren
l_string|&quot;Configuring  OMNI LCD&bslash;n&quot;
)paren
suffix:semicolon
id|shadow.lccr0
op_assign
...
suffix:semicolon
singleline_comment|//jca (GetPCD(25) &lt;&lt; LCD3_V_PCD);
)brace
r_if
c_cond
(paren
...
multiline_comment|/*&n;&t; * Ok, since we&squot;re calculating these values, we want to know&n;&t; * if the calculation is correct.  If you see any of these&n;&t; * messages _PLEASE_ report the incident to me for diagnosis,&n;&t; * including details about what was happening when the&n;&t; * messages appeared. --rmk, 30 March 2001&n;&t; */
r_if
c_cond
(paren
id|shadow.lccr0
...
(paren
id|KERN_ERR
l_string|&quot;LCCR1 mismatch: 0x%08x != 0x%08x&bslash;n&quot;
comma
id|shadow.lccr1
comma
id|new_regs-&gt;lccr1
...
(paren
id|KERN_ERR
l_string|&quot;LCCR2 mismatch: 0x%08x != 0x%08x&bslash;n&quot;
comma
id|shadow.lccr2
comma
id|new_regs-&gt;lccr2
...
(paren
id|KERN_ERR
l_string|&quot;LCCR3 mismatch: 0x%08x != 0x%08x&bslash;n&quot;
comma
id|shadow.lccr3
comma
id|new_regs-&gt;lccr3
...
(paren
id|KERN_ERR
l_string|&quot;Please report this to Russell King &quot;
...
c_func
(paren
l_string|&quot;olccr0 = 0x%08x&bslash;n&quot;
comma
id|shadow.lccr0
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;olccr1 = 0x%08x&bslash;n&quot;
comma
id|shadow.lccr1
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;olccr2 = 0x%08x&bslash;n&quot;
comma
id|shadow.lccr2
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;olccr3 = 0x%08x&bslash;n&quot;
comma
id|shadow.lccr3
)paren
suffix:semicolon
...
macro_line|#else
DECL|macro|sa1100fb_check_shadow
mdefine_line|#define sa1100fb_check_shadow(regs,var,pcd)
macro_line|#endif
...
multiline_comment|/*&n;&t; * Sorry, this should have read:&n;&t; * FIXME: please get rid of the PCD and PixClkDiv definitions&n;&t; * in favour of pixclock. --rmk&n;&t; */
macro_line|#else
id|pixclock
suffix:colon
l_int|5722222
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; *            R        G       B       T&n;&t; * default  {11,5}, { 5,6}, { 0,5}, { 0,0}&n;&t; * bitsy    {12,4}, { 7,4}, { 1,4}, { 0,0}&n;&t; * freebird { 8,4}, { 4,4}, { 0,4}, {12,4}&n;&t; */
macro_line|#ifdef CONFIG_SA1100_ASSABET
r_if
c_cond
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;dma period = %d ps, clock = %d kHz&quot;
comma
id|sa1100fb_display_dma_period
c_func
(paren
...
macro_line|#endif
macro_line|#ifdef CONFIG_SA1100_BITSY
multiline_comment|/* what rmk said --dneuer */
macro_line|#endif
)brace
...
suffix:semicolon
macro_line|#if defined(CONFIG_SA1100_ASSABET) &amp;&amp; !defined(ASSABET_PAL_VIDEO)
r_if
c_cond
(paren
id|machine_is_assabet
...
macro_line|#ifdef CONFIG_SA1100_FREEBIRD
macro_line|#error Please contact &lt;rmk@arm.linux.org.uk&gt; about this
r_if
c_cond
(paren
id|machine_is_freebird
...
(brace
multiline_comment|/* Color single passive */
id|mask
op_or_assign
id|GPIO_LDD15
op_or
...
(paren
id|KERN_ERR
l_string|&quot;sa1100fb: failed in request_irq: %d&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon

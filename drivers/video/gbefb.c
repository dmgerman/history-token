...
DECL|function|gbefb_show_memsize
r_static
id|ssize_t
...
suffix:semicolon
DECL|function|gbefb_remove_sysfs
r_static
r_void
id|__devexit
id|gbefb_remove_sysfs
c_func
(paren
r_struct
id|device
...
comma
op_amp
id|dev_attr_revision
)paren
suffix:semicolon
)brace
DECL|function|gbefb_create_sysfs
r_static
r_void
id|gbefb_create_sysfs
c_func
(paren
r_struct
id|device

...
suffix:semicolon
DECL|struct|pmag_ba_my_fb_info
r_struct
id|pmag_ba_my_fb_info
(brace
DECL|member|info
r_struct
id|fb_info
...
id|bt459_regs
suffix:semicolon
DECL|member|pmagba_fb_start
r_int
r_int
id|pmagba_fb_start
suffix:semicolon
DECL|member|pmagba_fb_size
r_int
r_int
id|pmagba_fb_size
suffix:semicolon
DECL|member|pmagba_fb_line_length
r_int
r_int
id|pmagba_fb_line_length
suffix:semicolon
)brace
suffix:semicolon
DECL|variable|disp
...
id|current_par
suffix:semicolon
DECL|function|pmagbafb_encode_var
r_static
r_void
id|pmagbafb_encode_var
c_func
(paren
r_struct
id|fb_var_screeninfo
...
DECL|function|pmagbafb_get_par
r_static
r_void
id|pmagbafb_get_par
c_func
...
DECL|function|pmagba_fb_update_var
r_static
r_int
id|pmagba_fb_update_var
c_func
(paren
r_int
id|con
...
DECL|function|pmagba_do_fb_set_var
r_static
r_int
id|pmagba_do_fb_set_var
c_func
(paren
r_struct
id|fb_var_screeninfo
...
DECL|function|pmag_ba_bt459_write_colormap
r_void
id|pmag_ba_bt459_write_colormap
c_func
(paren
r_struct
id|pmag_ba_my_fb_info
...
DECL|function|pmagbafb_get_cmap
r_static
r_int
id|pmagbafb_get_cmap
c_func
(paren
r_struct
id|fb_cmap
...
DECL|function|pmagbafb_set_cmap
r_static
r_int
id|pmagbafb_set_cmap
c_func
(paren
r_struct
id|fb_cmap
...
DECL|function|pmagbafb_get_var
r_static
r_int
id|pmagbafb_get_var
c_func
...
DECL|function|pmagbafb_set_var
r_static
r_int
id|pmagbafb_set_var
c_func
...
DECL|function|pmagbafb_encode_fix
r_static
r_void
id|pmagbafb_encode_fix
c_func
(paren
r_struct
...
id|fix-&gt;smem_start
op_assign
id|info-&gt;pmagba_fb_start
suffix:semicolon
id|fix-&gt;smem_len
op_assign
id|info-&gt;pmagba_fb_size
suffix:semicolon
id|fix-&gt;type
op_assign
...
id|fix-&gt;line_length
op_assign
id|info-&gt;pmagba_fb_line_length
suffix:semicolon
)brace
DECL|function|pmagbafb_get_fix
r_static
r_int
id|pmagbafb_get_fix
c_func
...
DECL|function|pmagbafb_set_disp
r_static
r_void
id|pmagbafb_set_disp
c_func
(paren
r_int
id|con
...
DECL|function|pmagbafb_release
r_static
r_int
id|pmagbafb_release
c_func
...
suffix:semicolon
id|ip-&gt;pmagba_fb_size
op_assign
l_int|1024
op_star
l_int|864
suffix:semicolon
id|ip-&gt;pmagba_fb_line_length
op_assign
l_int|1024
suffix:semicolon
...
id|pmagbafb_defined.xres
op_assign
l_int|1024
suffix:semicolon
id|pmagbafb_defined.yres
op_assign
l_int|864
suffix:semicolon
id|pmagbafb_defined.xres_virtual
op_assign
l_int|1024
suffix:semicolon
id|pmagbafb_defined.yres_virtual
op_assign
l_int|864
suffix:semicolon
id|pmagbafb_defined.bits_per_pixel
op_assign
l_int|8
suffix:semicolon

multiline_comment|/* $Id: creatorfb.c,v 1.37 2001/10/16 05:44:44 davem Exp $&n; * creatorfb.c: Creator/Creator3D frame buffer driver&n; *&n; * Copyright (C) 1997,1998,1999 Jakub Jelinek (jj@ultra.linux.cz)&n; */
...
suffix:semicolon
DECL|function|creator_apply_upa_parent_ranges
r_static
r_int
id|__init
id|creator_apply_upa_parent_ranges
c_func
(paren
r_int
id|parent

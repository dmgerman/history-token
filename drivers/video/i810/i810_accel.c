...
DECL|function|get_buffer_offset
r_static
id|u32
id|get_buffer_offset
c_func
(paren
id|u32
id|size
...
multiline_comment|/*&n; * Blitting is done at 8x8 pixel-array at a time.  If map is not &n; * monochrome or not a multiple of 8x8 pixels, cfb_imageblit will&n; * be called instead.  &n; */
...
multiline_comment|/*&n;&t; * immediate blit if width is a multiple of 16 (hardware requirement)&n;&t; */
r_else
(brace
id|mono_src_copy_imm_blit
c_func

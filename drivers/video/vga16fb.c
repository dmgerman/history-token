...
l_int|0
suffix:semicolon
multiline_comment|/*&n;         * If we are setting all the virtual consoles, also set&n;         * the defaults used to create new consoles.&n;         */
r_if
c_cond
(paren
id|con
...
l_int|0
op_logical_or
id|info-&gt;fb_info.var.activate
op_amp
id|FB_ACTIVATE_ALL
)paren
id|info-&gt;fb_info.disp-&gt;var
op_assign
id|info-&gt;fb_info.var
suffix:semicolon
r_if
...
id|NODEV
suffix:semicolon
id|vga16fb.fb_info.var
op_assign
id|vga16fb_defined
suffix:semicolon
id|vga16fb.fb_info.fix
op_assign
id|vga16fb_fix
suffix:semicolon

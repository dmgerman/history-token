multiline_comment|/*&n; *  linux/drivers/video/sbusfb.c -- SBUS or UPA based frame buffer device&n; *&n; *&t;Copyright (C) 1998 Jakub Jelinek&n; *&n; *  This driver is partly based on the Open Firmware console driver&n; *&n; *&t;Copyright (C) 1997 Geert Uytterhoeven&n; *&n; *  and SPARC console subsystem&n; *&n; *      Copyright (C) 1995 Peter Zaitcev (zaitcev@yahoo.com)&n; *      Copyright (C) 1995-1997 David S. Miller (davem@caip.rutgers.edu)&n; *      Copyright (C) 1995-1996 Miguel de Icaza (miguel@nuclecu.unam.mx)&n; *      Copyright (C) 1996 Dave Redman (djhr@tadpole.co.uk)&n; *      Copyright (C) 1996-1998 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *      Copyright (C) 1996 Eddie C. Dost (ecd@skynet.be)&n; *&n; *  This file is subject to the terms and conditions of the GNU General Public&n; *  License. See the file COPYING in the main directory of this archive for&n; *  more details.&n; */
...
macro_line|#ifdef CONFIG_FB_CREATOR
DECL|function|creator_fb_scan_siblings
r_static
r_void
id|creator_fb_scan_siblings
c_func
(paren
r_int
id|root

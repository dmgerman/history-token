multiline_comment|/*&n; *  linux/drivers/video/console/sticore.c -&n; *&t;core code for console driver using HP&squot;s STI firmware&n; *&n; *&t;Copyright (C) 2000 Philipp Rumpf &lt;prumpf@tux.org&gt;&n; *&t;Portions Copyright (C) 2001-2002 Helge Deller &lt;deller@gmx.de&gt;&n; *&t;Portions Copyright (C) 2001-2002 Thomas Bogendoerfer &lt;tsbogend@alpha.franken.de&gt;&n; * &n; * TODO:&n; * - call STI in virtual mode rather than in real mode&n; * - screen blanking with state_mgmt() in text mode STI ? &n; * - try to make it work on m68k hp workstations ;)&n; * - clean up the cache flushing functions&n; * &n; */
...
mdefine_line|#define STI_DRIVERVERSION &quot;0.9&quot;
...
l_int|3
comma
multiline_comment|/* # of text planes (3 is maximum for STI) */
id|STI_PTR
c_func
(paren
op_amp
...
(paren
id|KERN_INFO
l_string|&quot;STI GSC/PCI graphics driver version %s&bslash;n&quot;
comma
...
id|out
suffix:colon
multiline_comment|/* return default STI if available */
r_if
c_cond
(paren
id|num_sti_roms

...
suffix:semicolon
macro_line|#else
DECL|macro|newport_show_logo
mdefine_line|#define newport_show_logo()&t;do { } while (0)
macro_line|#endif
...
suffix:semicolon
multiline_comment|/* gfx_init (display_desc); */
r_return
...
macro_line|#undef __initdata
DECL|macro|__initdata
mdefine_line|#define __initdata
macro_line|#include &quot;../logo/logo_sgi_clut224.c&quot;

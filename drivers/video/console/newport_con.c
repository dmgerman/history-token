...
multiline_comment|/* borrowed from fbcon.c */
DECL|macro|REFCOUNT
...
mdefine_line|#define FONT_EXTRA_WORDS 3
DECL|variable|font_data
r_static
r_int
r_char
op_star
...
l_int|24
suffix:semicolon
macro_line|#endif /* CONFIG_LOGO_SGI_CLUT224 */
)brace
...
multiline_comment|/* Can&squot;t be __init, take_over_console may call it later */
...
id|i
suffix:semicolon
multiline_comment|/* free memory used by user font */
r_for
c_loop
(paren
id|i
...
DECL|function|newport_set_font
r_static
r_int
id|newport_set_font
c_func
...
id|p
suffix:semicolon
multiline_comment|/* ladis: when I grow up, there will be a day... and more sizes will&n;&t; * be supported ;-) */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* check if font is already used by other console */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* current font is the same as the new one */
r_if
c_cond
(paren
id|i
...
multiline_comment|/* old font is user font */
r_if
c_cond
(paren
id|font_data
...
DECL|function|newport_set_def_font
r_static
r_int
id|newport_set_def_font
c_func
...
DECL|function|newport_font_default
r_static
r_int
id|newport_font_default
c_func
(paren
r_struct
id|vc_data
...
DECL|function|newport_font_set
r_static
r_int
id|newport_font_set
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * as bmove is only used to move stuff around in the same line&n;&t; * (h == 1), we don&squot;t care about wrap arounds caused by topscan != 0&n;&t; */
id|ys
op_assign
(paren
(paren
...
DECL|function|newport_console_init
r_static
r_int
id|__init
id|newport_console_init
c_func
(paren
r_void
)paren
...
DECL|variable|newport_console_init
id|module_init
c_func
(paren
id|newport_console_init
...
suffix:semicolon
DECL|variable|newport_console_exit
id|module_exit
c_func
(paren
id|newport_console_exit

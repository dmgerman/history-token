...
r_static
r_int
id|cursor_size_lastfrom
suffix:semicolon
DECL|variable|cursor_size_lastto
r_static
r_int
id|cursor_size_lastto
suffix:semicolon
DECL|variable|state
r_static
r_struct
...
(brace
multiline_comment|/* void size to cause regs to be rewritten */
id|cursor_size_lastfrom
op_assign
l_int|0
suffix:semicolon
...
macro_line|#else
DECL|macro|vgacon_font_set
mdefine_line|#define vgacon_font_set NULL
DECL|macro|vgacon_font_get
mdefine_line|#define vgacon_font_get NULL
macro_line|#endif

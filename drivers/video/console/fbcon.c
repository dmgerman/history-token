...
id|cursor_drawn
suffix:semicolon
DECL|macro|FBCON_PIXMAPSIZE
mdefine_line|#define FBCON_PIXMAPSIZE&t;&t;8192
...
DECL|function|sysmove_buf_aligned
r_static
r_inline
r_void
id|sysmove_buf_aligned
c_func
(paren
id|u8
op_star
...
DECL|function|iomove_buf_aligned
r_static
r_inline
r_void
id|iomove_buf_aligned
c_func
(paren
id|u8
op_star
...
DECL|function|sysmove_buf_unaligned
r_static
r_inline
r_void
id|sysmove_buf_unaligned
c_func
(paren
id|u8
op_star
...
DECL|function|iomove_buf_unaligned
r_static
r_inline
r_void
id|iomove_buf_unaligned
c_func
(paren
id|u8
op_star
...
id|h
suffix:semicolon
macro_line|#if 0          /* INCOMPLETE - let the console gurus handle this */
r_if
c_cond
(paren
id|info-&gt;var.yres

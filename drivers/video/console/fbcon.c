...
l_int|1
suffix:semicolon
multiline_comment|/*&t;pixmap = kmalloc((info-&gt;var.bits_per_pixel + 7) &gt;&gt; 3 *&n;&t;&t;&t;&t;vc-&gt;vc_font.height, GFP_KERNEL); &n;*/
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t;if (pixmap);&n;&t;&t;kfree(pixmap);&n;&t;*/
)brace
DECL|function|accel_clear_margins
r_void
id|accel_clear_margins
c_func
(paren
r_struct
id|vc_data
...
id|vc-&gt;vc_font.height
suffix:semicolon
multiline_comment|/* We trust the mode the driver supplies. */
r_if
c_cond
(paren
...
mdefine_line|#define fontwidthvalid(p,w) ((p)-&gt;fontwidthmask &amp; FONTWIDTH(w))
...
(brace
multiline_comment|/* If we are not the first console on this&n;&t;&t;&t;&t;   fb, copy the font from that console */
...
id|vc-&gt;vc_font.height
suffix:semicolon
multiline_comment|/*&n;&t; &t; *  ++guenther: console.c:vc_allocate() relies on initializing&n;&t; &t; *  vc_{cols,rows}, but we must not set those if we are only&n;&t; &t; *  resizing the console.&n;&t; &t; */
id|p-&gt;vrows
op_assign
id|info-&gt;var.yres_virtual
op_div
...
(paren
id|KERN_INFO
l_string|&quot;fbcon_startup: disable boot-logo (boot-logo bigger than screen).&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
DECL|function|fbcon_set_logocmap
r_static
r_void
id|__init
id|fbcon_set_logocmap
c_func
(paren
r_struct
id|fb_info
...
DECL|function|fbcon_set_logo_truepalette
r_static
r_void
id|__init
id|fbcon_set_logo_truepalette
c_func
(paren
r_struct
id|fb_info
...
DECL|function|fbcon_set_logo_directpalette
r_static
r_void
id|__init
id|fbcon_set_logo_directpalette
c_func
(paren
r_struct
id|fb_info
...
suffix:semicolon
multiline_comment|/* &n;&t; * Modes not yet supported: packed pixels with depth != 8 (does such a&n;&t; * thing exist in reality?) &n;&t; */
r_return
id|done
ques
c_cond

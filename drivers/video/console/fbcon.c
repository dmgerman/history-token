...
suffix:semicolon
id|info-&gt;cursor_timer.function
op_assign
id|cursor_timer_handler
suffix:semicolon
id|info-&gt;cursor_timer.expires
op_assign
id|jiffies
op_plus
id|HZ
...
id|step
suffix:semicolon
multiline_comment|/*&n;&t;&t; * remove underline attribute from erase character&n;&t;&t; * if black and white framebuffer.&n;&t;&t; */
r_if
c_cond
(paren
id|fb_get_color_depth
...
multiline_comment|/*&n; *  User asked to set font; we are guaranteed that&n; *&t;a) width and height are in range 1..32&n; *&t;b) charcount does not exceed 512&n; */
...
suffix:semicolon
DECL|variable|fbcon_event_notifier_registered
r_static
r_int
id|fbcon_event_notifier_registered
suffix:semicolon
multiline_comment|/* can&squot;t be __init as it can be called by set_con2fb_map() later */

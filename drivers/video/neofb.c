...
multiline_comment|/*&n;static void&n;neo2200_imageblit(struct fb_info *info, const struct fb_image *image)&n;{&n;&t;struct neofb_par *par = (struct neofb_par *) info-&gt;par;&n;&n;&t;neo2200_sync(info);&n;&n;&t;switch (info-&gt;var.bits_per_pixel) {&n;&t;case 8:&n;&t;&t;par-&gt;neo2200-&gt;fgColor = image-&gt;fg_color;&n;&t;&t;par-&gt;neo2200-&gt;bgColor = image-&gt;bg_color;&n;&t;&t;break;&n;&t;case 16:&n;&t;&t;par-&gt;neo2200-&gt;fgColor =&n;&t;&t;    ((u16 *) (info-&gt;pseudo_palette))[image-&gt;fg_color];&n;&t;&t;par-&gt;neo2200-&gt;bgColor =&n;&t;&t;    ((u16 *) (info-&gt;pseudo_palette))[image-&gt;bg_color];&n;&t;&t;break;&n;&t;}&n;&n;&t;par-&gt;neo2200-&gt;bltCntl = NEO_BC0_SYS_TO_VID |&n;&t;    NEO_BC0_SRC_MONO | NEO_BC3_SKIP_MAPPING |&n;&t;    //                      NEO_BC3_DST_XY_ADDR |&n;&t;    0x0c0000;&n;&n;&t;par-&gt;neo2200-&gt;srcStart = 0;&n;//      par-&gt;neo2200-&gt;dstStart = (image-&gt;dy &lt;&lt; 16) | (image-&gt;dx &amp; 0xffff);&n;&t;par-&gt;neo2200-&gt;dstStart =&n;&t;    ((image-&gt;dx &amp; 0xffff) * (info-&gt;var.bits_per_pixel &gt;&gt; 3) +&n;&t;     image-&gt;dy * info-&gt;fix.line_length);&n;&t;par-&gt;neo2200-&gt;xyExt =&n;&t;    (image-&gt;height &lt;&lt; 16) | (image-&gt;width &amp; 0xffff);&n;&n;&t;memcpy(par-&gt;mmio_vbase + 0x100000, image-&gt;data,&n;&t;       (image-&gt;width * image-&gt;height) &gt;&gt; 3);&n;}&n;*/
r_static
r_void
...
(brace
multiline_comment|/*&n;&t;if (image-&gt;depth == 1) {&n;&t;&t;switch (info-&gt;fix.accel) {&n;&t;&t;&t;case FB_ACCEL_NEOMAGIC_NM2200:&n;&t;&t;&t;case FB_ACCEL_NEOMAGIC_NM2230:&n;&t;&t;&t;case FB_ACCEL_NEOMAGIC_NM2360:&n;&t;&t;&t;case FB_ACCEL_NEOMAGIC_NM2380:&n;&t;&t;&t;&t;neo2200_imageblit(info, image);&n;&t;&t;&t;&t;break;&n;&t;&t;&t;default:&n;&t;&t;&t;&t;cfb_imageblit(info, image);&n;&t;&t;&t;&t;break;&n;&t;&t;}&n;&t;} else&n;*/
id|cfb_imageblit
c_func
(paren
id|info
...
suffix:semicolon
DECL|variable|neofb_var800x480x8
r_static
r_struct
id|fb_var_screeninfo
id|__devinitdata
id|neofb_var800x480x8
op_assign
(brace
dot
id|accel_flags

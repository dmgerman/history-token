...
mdefine_line|#define SIS315H
DECL|macro|OutPortByte
mdefine_line|#define OutPortByte(p,v) outb((IOADDRESS)(p),(CARD8)(v))
DECL|macro|OutPortWord
mdefine_line|#define OutPortWord(p,v) outw((IOADDRESS)(p),(CARD16)(v))
DECL|macro|OutPortLong
mdefine_line|#define OutPortLong(p,v) outl((IOADDRESS)(p),(CARD32)(v))
DECL|macro|InPortByte
mdefine_line|#define InPortByte(p)    inb((IOADDRESS)(p))
DECL|macro|InPortWord
mdefine_line|#define InPortWord(p)    inw((IOADDRESS)(p))
DECL|macro|InPortLong
mdefine_line|#define InPortLong(p)    inl((IOADDRESS)(p))
DECL|macro|SiS_SetMemory

...
(brace
multiline_comment|/* TW: Inserted from 650/302LV 1.10.6s */
id|temp
op_decrement
suffix:semicolon
)brace
...
multiline_comment|/* TW: For 650/LVDS (1.10.07), 650/302LV (1.10.6s) */
r_if
c_cond
(paren
id|HwDeviceExtension-&gt;jChipType
...
r_else
(brace
multiline_comment|/* TW: For 300/630/LVDS/301B: */
id|tempbx
op_assign
(paren
id|SiS_Pr-&gt;SiS_VGAVT
...
r_else
(brace
multiline_comment|/* LV (550/301LV checks ROM byte, other LCV BIOSes do not) */
id|tempbl
op_assign
l_int|0xF0
suffix:semicolon
...
(brace
multiline_comment|/* TW: Inserted from 650/30xLV 1.10.6s */
r_if
c_cond
(paren
id|ModeNo
...
multiline_comment|/* TW: not done in BIOS */
r_else
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* From Xabre 1.01.03 */
)brace
r_else
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* From 740/301LV 1.10.1i */
)brace
r_else
(brace
r_if
...
r_else
(brace
multiline_comment|/* TW: Inserted from 650/30xLV 1.10.6s, Xabre */
id|temp
op_or_assign
l_int|0xC0
suffix:semicolon
...
multiline_comment|/* TW: Inserted from 300/301LV BIOS */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* The following panels overrule LCDPass11: */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDResInfo
...
id|ModeID
suffix:semicolon
multiline_comment|/* TW: Inserted from 650/LVDS 1.10.07, 650/30xLV 1.10.6s */
r_if
c_cond
(paren
id|HwDeviceExtension-&gt;jChipType
...
(brace
multiline_comment|/*&t;      &t;&t;&t;if(!SiS_WeHaveBacklightCtrl(SiS_Pr,HwDeviceExtension, BaseAddr)) {  */
...
macro_line|#ifdef SIS315H
multiline_comment|/* TW: Inserted from 650/30xLV BIOS 1.10.6s */
r_if
c_cond
(paren
id|HwDeviceExtension-&gt;jChipType
...
(brace
multiline_comment|/* TW: Inserted from 650/30xLV 1.10.6s: (Is at end of SetGroup2!) */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_VBInfo
...
suffix:semicolon
multiline_comment|/* TW: Inserted from 650/LVDS BIOS - doesn&squot;t make sense */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_VBInfo
...
id|X_PROBED
comma
l_string|&quot;CRT2: Attached display exspects analog input (0x%02x)&bslash;n&quot;
comma
id|buffer
(braket
l_int|0x14
...
id|X_PROBED
comma
l_string|&quot;CRT2: Attached display exspects digital input&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

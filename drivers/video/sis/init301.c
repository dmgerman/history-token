...
l_int|0
suffix:semicolon
multiline_comment|/* Use the BIOS tables only for LVDS panels; DVI is unreliable&n;    * due to the variaty of panels the BIOS doesn&squot;t know about.&n;    */
r_if
c_cond
(paren
(paren
...
r_else
(brace
multiline_comment|/* By default, pass 1:1 on SiS TMDS (if scaling is disabled) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|LCDPass11
suffix:semicolon
...
(brace
multiline_comment|/* No scaling for this mode on any panel */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* We do not scale to 1280x720/800/960 (B/C bridges only) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* Do not scale to 1280x720/768/800/960 (B/C bridges only) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* Do not scale to 1280x720 by default (LVDS bridges) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* Do not scale to 1280x1024 (all bridges) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* Special for Fujitsu 7911 (VL-17WDX8), others custom */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDResInfo
...
id|Ext_CRT2CRTC_NS
suffix:semicolon
multiline_comment|/* Special for our 3 types, others custom (works with default) */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Special for 1280x720 TMDS &lt;&gt; LVDS */
r_if
c_cond
(paren
(paren
...
id|LCDPtr
op_assign
id|SiS_Pr-&gt;SiS_LCD1280x768_3Data
suffix:semicolon
r_break
suffix:semicolon
r_case
...
multiline_comment|/* is lvds if really LVDS, or SiS 301B-DH with external LVDS transmitter */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* For LV, the BIOS must know about the correct value */
id|delay
op_assign
id|ROMAddr
(braket
...
r_else
(brace
multiline_comment|/* TMDS: Set our own, since BIOS has no idea - TODO: Find out about values */
r_if
c_cond
(paren
op_logical_neg

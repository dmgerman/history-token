...
multiline_comment|/*********************************************/
multiline_comment|/*            HELPER: Enable CRT2            */
multiline_comment|/*********************************************/
r_void
...
multiline_comment|/*********************************************/
multiline_comment|/* For 661 series only */
macro_line|#ifdef SIS315H
macro_line|#if 0   /* Need to wait until hardware using this really exists */
r_static
id|UCHAR
op_star
id|GetLCDPtr661
...
id|Ext_CRT2CRTC
suffix:semicolon
multiline_comment|/* This is total bullshit: */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_EModeIDTable
...
(brace
macro_line|#if 0&t;/* Not yet implemented */
r_if
c_cond
(paren
id|ModeNo
...
multiline_comment|/*********************************************/
multiline_comment|/*              Get rate pointer             */
multiline_comment|/*********************************************/
id|USHORT
...
multiline_comment|/* CR33 holds refresh rate index for CRT1 [3:0] and CRT2 [7:4]. */
id|index
op_assign
(paren
id|SiS_GetReg
...
l_int|0x20
suffix:semicolon
multiline_comment|/* neg h/v sync, RGB24 */
)brace
)brace
r_if
c_cond
...
(brace
multiline_comment|/* For non-standard LCD resolution, we let the panel scale */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* We do not scale to 1280x960 (B/C bridges only) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* We do not scale to 1280x768 (B/C bridges only) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* No non-scaling data available for LV bridges */
id|SiS_Pr-&gt;SiS_LCDInfo
op_and_assign
op_complement
id|DontExpandLCD
...
(brace
multiline_comment|/* No idea about the timing and zoom factors */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* We do not scale to 1280x1024 (all bridges) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
(brace
multiline_comment|/* No idea about the timing and zoom factors (C bridge only) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|DontExpandLCD
suffix:semicolon
...
multiline_comment|/* Trumpion: Assume non-expanding */
r_if
c_cond
(paren
...
(brace
multiline_comment|/* Enable 302LV/302ELV dual link mode.&n;&t; * For 661, this is done above.&n;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* (Sets this in SenseLCD; new paneltypes) */
id|SiS_Pr-&gt;SiS_LCDInfo
op_or_assign
id|LCDDualLink
suffix:semicolon
...
id|SiS_Pr-&gt;SiS_LCDResInfo
op_eq
id|SiS_Pr-&gt;SiS_Panel640x480_2
op_logical_or
id|SiS_Pr-&gt;SiS_LCDResInfo
op_eq
id|SiS_Pr-&gt;SiS_Panel640x480_3
)paren
(brace
id|VCLKIndex
op_assign
...
multiline_comment|/* BIOS does not do this (neither 301 nor LVDS) */
...
multiline_comment|/* 661: Sets p4 27 and 34 here, done in SetGroup4 here */
macro_line|#endif /* SIS315H */
)brace
r_else
r_if
...
(brace
multiline_comment|/* 1280x768 and 1280x960 have same CRT2CRTC,&n;&t;          * so we change it here if 1280x960 is chosen&n;&t;          */
r_if
c_cond
(paren
id|resinfo
...
id|Ext_CRT2CRTC
suffix:semicolon
multiline_comment|/* No customs required yet (Clevo, Compaq, etc) */
op_star
id|CRT2Index
op_assign
id|tempbx
...
id|LVDSData
op_assign
id|SiS_Pr-&gt;SiS_LCDA1024x768Data_1
suffix:semicolon
r_break
suffix:semicolon
r_case
...
id|LVDSData
op_assign
id|SiS_Pr-&gt;SiS_LCDA1280x1024Data_1
suffix:semicolon
r_break
suffix:semicolon
r_case
...
id|LVDSData
op_assign
id|SiS_Pr-&gt;SiS_LCDA1024x768Data_2
suffix:semicolon
r_break
suffix:semicolon
r_case
...
id|LVDSData
op_assign
id|SiS_Pr-&gt;SiS_LCDA1280x1024Data_2
suffix:semicolon
r_break
suffix:semicolon
r_case
...
id|LCDPtr
op_assign
id|SiS_Pr-&gt;SiS_ExtLCD1280x768Data
suffix:semicolon
r_break
suffix:semicolon
multiline_comment|/* VESA Timing */
...
id|LCDPtr
op_assign
id|SiS_Pr-&gt;SiS_NoScaleData1280x768
suffix:semicolon
r_break
suffix:semicolon
multiline_comment|/* Non-expanding */
...
id|LCDPtr
op_assign
id|SiS_Pr-&gt;SiS_StLCD1280x768Data
suffix:semicolon
r_break
suffix:semicolon
multiline_comment|/* Non-VESA Timing */
...
r_break
suffix:semicolon
multiline_comment|/* Generic no-scale data */
macro_line|#ifdef SIS315H
r_case
l_int|50
suffix:colon
...
multiline_comment|/*********************************************/
multiline_comment|/*            GET LVDS DES DATA              */
multiline_comment|/*********************************************/
r_static
r_void
...
multiline_comment|/*********************************************/
multiline_comment|/*          SET CRT2 AUTO-THRESHOLD          */
multiline_comment|/*********************************************/
macro_line|#ifdef SIS315H
r_static
r_void
...
(brace
multiline_comment|/* For 300+301LV (A907) */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* 550, 650, 740, 660 */
id|modenum
op_assign
id|SiS_GetReg
c_func
...
multiline_comment|/************* Set CRT2 Sync *************/
r_static
r_void
...
r_else
(brace
multiline_comment|/* 315 - 301, 301B */
id|tempah
op_assign
id|infoflag
op_rshift
...
(brace
multiline_comment|/* TEST, imitate BIOS bug */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_VBInfo
...
id|tempvcfact
suffix:semicolon
multiline_comment|/* This is not supported with LCDA */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDResInfo
...
suffix:semicolon
multiline_comment|/* 740/301LV, 301BDH */
)brace
)brace
r_else
(brace
...
id|tempbx
suffix:semicolon
multiline_comment|/* HDE + HSKEW = lcdhdee  */
r_if
c_cond
(paren
id|tempax
...
multiline_comment|/* 650/30xLV 1.10.6s, 740/LVDS */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Don&squot;t check Part1Port,0x00 -&gt; is not being set if LCDA! */
multiline_comment|/* We check SR06 instead here: */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDInfo
...
multiline_comment|/******* Set Part 1 / SiS bridge *********/
r_static
r_void
...
multiline_comment|/*********** Set Part 1 / LVDS ***********/
r_static
r_void
...
l_int|0
suffix:semicolon
multiline_comment|/* This is not supported on LVDS */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDResInfo
...
multiline_comment|/* Set up Panel Link */
...
suffix:semicolon
multiline_comment|/* Part1_14h; Panel Link Horizontal Retrace Start  */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_LCDInfo
...
suffix:semicolon
multiline_comment|/* Part1_15h; Panel Link Horizontal Retrace End/Skew */
id|tempbx
op_assign
id|push2
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Part1_1Ah; Panel Link Vertical Retrace Start (2:0) */
id|tempcx
op_rshift_assign
l_int|3
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Part1_16h; Panel Link Horizontal Display Enable Start  */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Part1_17h; Panel Link Horizontal Display Enable End  */
...
l_int|0x0002
suffix:semicolon
multiline_comment|/* A901; sometimes 0x0003; */
)brace
r_else
(brace
id|tempcx
...
suffix:semicolon
multiline_comment|/* Part1_18h; Panel Link Vertical Retrace Start  */
id|tempcx
op_rshift_assign
l_int|3
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Part1_19h; Panel Link Vertical Retrace End (3:0); Misc.  */
id|temp
op_assign
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Part1_1Ah; Panel Link Control Signal (7:3); Vertical Retrace Start (2:0) */
r_if
c_cond
(paren
id|HwInfo-&gt;jChipType
...
suffix:semicolon
multiline_comment|/* Part1_1Eh; Panel Link Vertical Scaling Factor */
macro_line|#endif /* SIS300 */
)brace
r_else
(brace
...
suffix:semicolon
multiline_comment|/* Part1_37h; Panel Link Vertical Scaling Factor */
id|temp
op_assign
(paren
id|USHORT
...
suffix:semicolon
multiline_comment|/* Part1_36h; Panel Link Vertical Scaling Factor */
id|temp
op_assign
(paren
id|USHORT
...
suffix:semicolon
multiline_comment|/* Part1_35h; Panel Link Vertical Scaling Factor */
macro_line|#endif /* SIS315H */
)brace
id|tempbx
op_assign
...
multiline_comment|/* Doesnt make sense anyway... */
)brace
r_else
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* Part1_1Dh; Vertical Display Overflow; Control Signal */
id|temp
op_assign
id|tempbx
op_amp
l_int|0x00FF
suffix:semicolon
multiline_comment|/* if(SiS_Pr-&gt;SiS_IF_DEF_FSTN) temp++;  */
id|SiS_SetReg
c_func
(paren
id|SiS_Pr-&gt;SiS_Part1Port
...
suffix:semicolon
multiline_comment|/* Part1_1Ch; Panel Link Vertical Display Enable End  */
id|temp
op_assign
id|tempcx
op_amp
...
suffix:semicolon
multiline_comment|/* Part1_1Bh; Panel Link Vertical Display Enable Start  */
...
suffix:semicolon
multiline_comment|/* Part1_1Fh; Panel Link DDA Operational Number in each horiz. line */
id|tempbx
op_assign
id|SiS_Pr-&gt;SiS_VDE
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Part1_20h; Overflow register */
id|temp
op_assign
id|tempbx
op_amp
...
suffix:semicolon
multiline_comment|/* Part1_21h; Panel Link Vertical Accumulator Register */
id|tempecx
op_rshift_assign
l_int|16
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Part1_22h; Panel Link Horizontal Scaling Factor High */
id|temp
op_assign
(paren
id|USHORT
...
suffix:semicolon
multiline_comment|/* Part1_22h; Panel Link Horizontal Scaling Factor Low */
...
multiline_comment|/* The following is done for all bridge/chip types/series */
id|tempax
op_assign
id|tempbx
op_amp
...
suffix:semicolon
multiline_comment|/* Overflow (and HWCursor Test Mode) */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* CRT2 Vert. Retrace End; Overflow; &quot;Enable CRTC Check&quot; */
...
(brace
multiline_comment|/* Why not 301B/LV? */
id|temp
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* Must do special for Compaq1280; Acer1280 OK, Clevo1400 OK, COMPAL1400 OK */
multiline_comment|/* Compaq1280 panel loses sync if using CR37 sync info. */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
macro_line|#if 0  /* Use the 315/330 series code for now */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* This is done for the LVDS bridges only, since&n;       * the TMDS panels already work correctly with&n;       * the old code. Besides, we only do that if&n;       * we can get the data from the ROM, I am tired&n;       * of carrying a lot of tables around.&n;       */
macro_line|#ifdef SIS315H &t;&t;&t;&t;&t;&t;&t;/* ------------ 661/741/760 series --------- */
id|UCHAR
op_star
id|myptr
op_assign
...
(brace
macro_line|#ifdef SIS315H &t;&t;&t;&t;&t;&t;&t;/* ------------- 315/330 series ------------ */
id|SiS_GetCRT2Part2Ptr
c_func
(paren
id|SiS_Pr
...
(brace
multiline_comment|/* See Sync above, 0x1a */
id|temp
op_assign
l_int|1
suffix:semicolon
...
multiline_comment|/* Non-expanding: lcdvdees = tempcx = VT-1; lcdvdee = tempbx = VDE-1 */
macro_line|#ifdef TWDEBUG
id|xf86DrvMsg
c_func
(paren
...
id|SiS_Pr-&gt;SiS_VT
suffix:semicolon
multiline_comment|/* push2; */
id|tempax
op_assign
id|SiS_Pr-&gt;SiS_VDE
suffix:semicolon
multiline_comment|/* push1; */
id|tempcx
op_assign
(paren
id|tempbx
...
multiline_comment|/* non-expanding: lcdvrs = tempbx = ((VT + VDE) / 2) - 10 */
r_if
c_cond
(paren
id|SiS_Pr-&gt;UseCustomMode
...
suffix:semicolon
multiline_comment|/* Code from 630/301B (I+II) BIOS */
macro_line|#ifdef SIS300
r_if
c_cond
(paren
...
multiline_comment|/* Set 301 VGA2 registers */
r_static
r_void
...
multiline_comment|/*********************************************/
multiline_comment|/* Set 301 Palette address port registers */
r_static
r_void
...
suffix:semicolon
multiline_comment|/* 650/LVDS BIOS - doesn&squot;t make sense */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_VBInfo
...
suffix:semicolon
multiline_comment|/* Set up Panel Link for LVDS, 301BDH and 30xLV(for LCDA) */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Our private DDC functions&n;&n;   It complies somewhat with the corresponding VESA function&n;   in arguments and return values.&n;&n;   Since this is probably called before the mode is changed,&n;   we use our pre-detected pSiS-values instead of SiS_Pr as&n;   regards chipset and video bridge type.&n;&n;   Arguments:&n;       adaptnum: 0=CRT1, 1=LCD, 2=VGA2&n;                 CRT2 DDC is only supported on SiS301, 301B, 302B.&n;       DDCdatatype: 0=Probe, 1=EDID, 2=EDID+VDIF, 3=EDID V2 (P&amp;D), 4=EDID V2 (FPDI-2)&n;       buffer: ptr to 256 data bytes which will be filled with read data.&n;&n;   Returns 0xFFFF if error, otherwise&n;       if DDCdatatype &gt; 0:  Returns 0 if reading OK (included a correct checksum)&n;       if DDCdatatype = 0:  Returns supported DDC modes&n;&n; */
id|USHORT
...
id|X_PROBED
comma
l_string|&quot;CRT2: EDID corrupt&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
r_break
suffix:semicolon
macro_line|#if 0&t;    /* Treat this as custom, as we have no valid timing data yet */
r_case
l_int|1600
suffix:colon
r_if
...
suffix:semicolon
multiline_comment|/* By default we drive the LCD at 75Hz in 640x480 mode; if&n;&t;&t;   * the panel does not provide this mode, use 60hz&n;&t;&t;   */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* We must assume the panel can scale, since we have&n;&t;           * no scaling data&n;&t;&t;   */
id|checkexpand
op_assign
id|FALSE
suffix:semicolon
...
r_break
suffix:semicolon
macro_line|#if 0    /* Treat this one as custom since we have no timing data yet */
r_case
l_int|1600
suffix:colon
r_if
...
suffix:semicolon
multiline_comment|/* We must assume the panel can scale, since we have&n;&t;        * no scaling data&n;    &t;        */
id|cr37
op_or_assign
l_int|0x10
suffix:semicolon
...
id|X_PROBED
comma
l_string|&quot;Non-standard LCD timing data no. %d:&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
r_static
id|ULONG
DECL|function|GetOEMTVPtr661_2
id|GetOEMTVPtr661_2
c_func
(paren
id|SiS_Private
...
multiline_comment|/* Could we detect a PDC for LCD? If yes, use it */
r_if
c_cond
(paren
id|SiS_Pr-&gt;PDC
...
id|CUT_CLEVO14002
suffix:colon
multiline_comment|/* if(SiS_Pr-&gt;SiS_LCDResInfo == SiS_Pr-&gt;SiS_Panel1400x1050) { */
id|gotitfrompci
op_assign
id|TRUE
suffix:semicolon
...
multiline_comment|/* romptr = ROMAddr[0x120] | (ROMAddr[0x121] &lt;&lt; 8);  */
...
(brace
multiline_comment|/* Data for 1280x1024 wrong in BIOS */
id|romptr
op_assign
id|GetLCDromptr
c_func
...
multiline_comment|/* Always use the second pointer on 650; some BIOSes */
multiline_comment|/* still carry old 301 data at the first location    */
multiline_comment|/* romptr = ROMAddr[0x114] | (ROMAddr[0x115] &lt;&lt; 8);  */
multiline_comment|/* if(SiS_Pr-&gt;SiS_VBType &amp; VB_SIS302LV) */
id|romptr
op_assign
id|ROMAddr
...
l_int|0xffff
suffix:semicolon
multiline_comment|/* NTSC-J: Use PAL filters */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_TVMode
...
multiline_comment|/* BIOS: 8, wrong */
r_if
c_cond
(paren
id|SiS_Pr-&gt;SiS_VBInfo
...
multiline_comment|/* Should test dual edge */
)brace
r_else
r_if
c_cond
...
multiline_comment|/* BIOS: 18, wrong */
id|temp
op_or_assign
(paren
id|infoflag

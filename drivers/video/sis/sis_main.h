...
mdefine_line|#define VER_LEVEL                 25
...
mdefine_line|#define PCI_DEVICE_ID_SI_660      0x0661
macro_line|#endif
...
mdefine_line|#define FB_ACCEL_SIS_GLAMOUR_2  40&t;/* SiS 315, 65x, 740, 661, 741  */
macro_line|#endif
...
DECL|macro|SISMISCW
mdefine_line|#define SISMISCW                  SiS_Pr.SiS_P3c2
DECL|macro|SISINPSTAT
mdefine_line|#define SISINPSTAT&t;&t;  (SiS_Pr.RelIO + 0x2a)
DECL|macro|SISPEL
mdefine_line|#define SISPEL&t;&t;&t;  SiS_Pr.SiS_P3c6
...
multiline_comment|/* entries for disp_state - deprecated as of 1.6.02 */
...
multiline_comment|/* Deprecated as of 1.6.02 - use vbflags instead */
...
l_int|1
suffix:semicolon
multiline_comment|/* These are to adapted according to VGA_ENGINE type */
...
l_int|1
suffix:semicolon
multiline_comment|/* Use MMIO queue mode by default (315 series only) */
...
l_int|0xff
suffix:semicolon
multiline_comment|/* data for sis hardware (&quot;par&quot;) */
...
id|sisfbinfo
suffix:semicolon
multiline_comment|/* Hardware info; contains data on hardware */
DECL|variable|sishw_ext
id|SIS_HW_INFO
id|sishw_ext
suffix:semicolon
multiline_comment|/* SiS private structure */
...
comma
l_string|&quot;SIS 661FX/M661FX/741/760 VGA&quot;
)brace
comma
(brace
l_int|0
...
multiline_comment|/* NOT const - will be patched for 1280x768 mode number chaos reasons */
...
comma
DECL|macro|MODEINDEX_1280x768
mdefine_line|#define MODEINDEX_1280x768 79
(brace
l_string|&quot;1280x768x8&quot;
comma
l_int|0x23
...
id|datavalid
suffix:semicolon
DECL|variable|sisfb_thismonitor
)brace
...
suffix:semicolon
multiline_comment|/* Chrontel TV functions */
r_extern
id|USHORT
id|SiS_GetCH700x
c_func

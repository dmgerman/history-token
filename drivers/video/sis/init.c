...
multiline_comment|/* TW: I degraded this for LINUXBIOS only, because we&n; *     don&squot;t need this otherwise. Under normal&n; *     circumstances, the video BIOS has initialized&n; *     the adapter for us. BTW, this code is incomplete&n; *     and very possibly not functioning on newer chipsets.&n; */
id|BOOLEAN
...
multiline_comment|/* TW: New from 330, 650/LVDS/301LV BIOSes: */
r_if
c_cond
(paren
id|HwDeviceExtension-&gt;jChipType
...
(brace
multiline_comment|/* LCD on Panel link (LVDS, 301BDH) */
r_switch
c_cond
(paren
id|mode-&gt;HDisplay
...
(brace
multiline_comment|/* not supported on 1024x600 panels */
id|ModeIndex
op_assign
id|ModeIndex_512x384
(braket
...
(brace
multiline_comment|/* This mode only supported on 1024x600 panels */
id|ModeIndex
op_assign
id|ModeIndex_1024x600
(braket
...
r_else
(brace
multiline_comment|/* LCD on 301(B/LV) */
r_switch
c_cond
(paren
id|mode-&gt;HDisplay
...
r_else
(brace
multiline_comment|/* TV on 301(B/LV) */
r_switch
c_cond
(paren
id|mode-&gt;HDisplay
...
l_int|1024
suffix:colon
multiline_comment|/* Not supported with depth 32 */
r_if
c_cond
(paren
(paren
...
r_int
r_char
DECL|function|SiS_GetSetBIOSScratch
id|SiS_GetSetBIOSScratch
c_func
(paren
id|ScrnInfoPtr
...
id|X_ERROR
comma
l_string|&quot;(init.c: Could not map BIOS scratch area)&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
suffix:semicolon
multiline_comment|/* value != 0xff means: set register */
r_if
c_cond
(paren
id|value

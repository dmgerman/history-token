...
op_assign
id|SiS_ExtLCD1280x768Data
suffix:semicolon
id|SiS_Pr-&gt;SiS_StLCD1280x768Data
op_assign
id|SiS_StLCD1280x768Data
suffix:semicolon
id|SiS_Pr-&gt;SiS_NoScaleData1280x768
op_assign
id|SiS_NoScaleData1280x768
suffix:semicolon
...
op_assign
id|SiS_LCDA1024x768Data_1
suffix:semicolon
id|SiS_Pr-&gt;SiS_LCDA1024x768Data_2
op_assign
id|SiS_LCDA1024x768Data_2
suffix:semicolon
id|SiS_Pr-&gt;SiS_LCDA1280x1024Data_1
op_assign
id|SiS_LCDA1280x1024Data_1
suffix:semicolon
id|SiS_Pr-&gt;SiS_LCDA1280x1024Data_2
op_assign
id|SiS_LCDA1280x1024Data_2
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* LCDResInfo will on 300 series be translated to 315 series definitions */
...
l_int|255
suffix:semicolon
multiline_comment|/* Something illegal */
...
id|Panel_320x480
suffix:semicolon
multiline_comment|/* highest value */
id|SiS_Pr-&gt;SiS_PanelMinLVDS
op_assign
id|Panel_800x600
suffix:semicolon
multiline_comment|/* Lowest value LVDS */
...
(brace
macro_line|#if 0
multiline_comment|/* Rest of 300 series: We don&squot;t use the ROM image if&n;&t; * the BIOS version &lt; 2.0.0 as such old BIOSes don&squot;t&n;&t; * have the needed data at the expected locations.&n;&t; */
r_if
c_cond
(paren
id|ROMAddr
...
r_else
(brace
multiline_comment|/* 315/330 series stick to the standard */
id|SiS_Pr-&gt;SiS_UseROM
op_assign
id|TRUE
suffix:semicolon
...
multiline_comment|/*********************************************/
multiline_comment|/*            HELPER: GetDRAMSize            */
multiline_comment|/*********************************************/
macro_line|#ifndef LINUX_XF86
r_static
id|ULONG
...
suffix:semicolon
multiline_comment|/* Get adapter memory size (in MB) */
id|temp
op_div_assign
(paren
l_int|1024
...
id|LCDACRT1Ptr
op_assign
id|Compaq1280x1024_LCDACRT1_1_H
suffix:semicolon
r_break
suffix:semicolon
r_case
...
(brace
multiline_comment|/* This &quot;if&quot; is done in 330 and 650/LVDS/301LV BIOSes; Not in 315 BIOS */
r_if
c_cond
(paren
id|ModeNo
...
macro_line|#ifdef SIS315H
multiline_comment|/* 315 BIOS sets SR17 at this point */
r_if
c_cond
(paren
id|HwInfo-&gt;jChipType
...
multiline_comment|/* 330 BIOS sets SR17 at this point */
r_if
c_cond
(paren
id|HwInfo-&gt;jChipType
...
macro_line|#if 0   /* What is SR0E[D5:6]? */
r_if
c_cond
(paren
id|HwInfo-&gt;jChipType
...
(brace
multiline_comment|/* These are in the CRT1 table, and set by CRT1CRTC */
r_if
c_cond
(paren
id|resinfo
...
macro_line|#ifdef LINUX_XF86
multiline_comment|/* We never clear the buffer in X */
id|ModeNo
op_or_assign
l_int|0x8000
suffix:semicolon
...
macro_line|#endif
macro_line|#ifndef LINUX_XF86  /* We never lock registers in XF86 */
r_if
c_cond
(paren
id|KeepLockReg
...
id|FALSE
suffix:semicolon
multiline_comment|/* Remember: Custom modes for CRT2 are ONLY supported&n;    * &t;&t;-) on 315/330 series,&n;    *           -) on the 30x/B/C, and&n;    *           -) if CRT2 is LCD or VGA&n;    */
r_if
c_cond
(paren
(paren
...
macro_line|#endif
multiline_comment|/* We don&squot;t clear the buffer under X */
id|SiS_Pr-&gt;SiS_flag_clearbuffer
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* Build a list of supported modes */
id|DisplayModePtr

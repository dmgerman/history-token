...
DECL|function|sisfb_compat_ioctl
r_static
r_int
id|sisfb_compat_ioctl
c_func
(paren
r_struct
id|file
...
(paren
id|KERN_INFO
l_string|&quot;sisfb: Video ROM found and copied&bslash;n&quot;
)paren
suffix:semicolon
id|ivideo-&gt;sishw_ext.UseROM
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;sisfb: Framebuffer at 0x%lx, mapped to 0x%lx, size %ldk&bslash;n&quot;
comma
id|ivideo-&gt;video_base
comma
(paren
...
(paren
id|KERN_INFO
l_string|&quot;sisfb: MMIO at 0x%lx, mapped to 0x%lx, size %ldk&bslash;n&quot;
comma
id|ivideo-&gt;mmio_base
comma
(paren
...
(brace
multiline_comment|/* For broken BIOSes: Assume 1024x768, RGB18 */
id|ivideo-&gt;CRT2LCDType
op_assign
id|LCD_1024x768
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;sisfb: Invalid panel ID (%02x), assuming 1024x768, RGB18&bslash;n&quot;
comma
id|reg
)paren
suffix:semicolon

...
mdefine_line|#define READ_BYTE(fb,reg)&t;&t;gsc_readb((fb)-&gt;info.fix.mmio_start + (reg))
DECL|macro|READ_WORD
mdefine_line|#define READ_WORD(fb,reg)&t;&t;gsc_readl((fb)-&gt;info.fix.mmio_start + (reg))
...
macro_line|# define WRITE_BYTE(value,fb,reg)&t;gsc_writeb((value),(fb)-&gt;info.fix.mmio_start + (reg))
DECL|macro|WRITE_WORD
macro_line|# define WRITE_WORD(value,fb,reg)&t;gsc_writel((value),(fb)-&gt;info.fix.mmio_start + (reg))
macro_line|#else
...
DECL|macro|WRITE_BYTE
macro_line|# define WRITE_BYTE(value,fb,reg)&t;do { if (debug_on) &bslash;&n;&t;&t;&t;&t;&t;&t;printk(KERN_DEBUG &quot;%30s: WRITE_BYTE(0x%06x) = 0x%02x (old=0x%02x)&bslash;n&quot;, &bslash;&n;&t;&t;&t;&t;&t;&t;&t;__FUNCTION__, reg, value, READ_BYTE(fb,reg)); &t;&t;  &bslash;&n;&t;&t;&t;&t;&t;gsc_writeb((value),(fb)-&gt;info.fix.mmio_start + (reg)); } while (0)
DECL|macro|WRITE_WORD
macro_line|# define WRITE_WORD(value,fb,reg)&t;do { if (debug_on) &bslash;&n;&t;&t;&t;&t;&t;&t;printk(KERN_DEBUG &quot;%30s: WRITE_WORD(0x%06x) = 0x%08x (old=0x%08x)&bslash;n&quot;, &bslash;&n;&t;&t;&t;&t;&t;&t;&t;__FUNCTION__, reg, value, READ_WORD(fb,reg)); &t;&t;  &bslash;&n;&t;&t;&t;&t;&t;gsc_writel((value),(fb)-&gt;info.fix.mmio_start + (reg)); } while (0)

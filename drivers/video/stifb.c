...
multiline_comment|/* return virtual address */
...
suffix:semicolon
multiline_comment|/* XXX: replace by fb_setmem(), smem_start or screen_base ? */
id|memset_io
c_func
(paren
...
id|stifb_setcolreg
comma
multiline_comment|/* .fb_pan_display = stifb_pan_display, */
dot
id|fb_blank
op_assign
id|stifb_blank
comma
multiline_comment|/*&n;&t;.fb_fillrect&t;= cfb_fillrect,&n;&t;.fb_copyarea&t;= cfb_copyarea,&n;&t;.fb_imageblit&t;= cfb_imageblit, &n;&t;*/
)brace
suffix:semicolon
...
r_break
suffix:semicolon
macro_line|#ifdef FBCON_HAS_CFB8&t;&t;
r_case
l_int|8
suffix:colon
id|fix-&gt;type
...
id|ENXIO
suffix:semicolon
multiline_comment|/* no STI cards available */
r_for
c_loop
(paren
id|i
...
(brace
singleline_comment|// unregister_framebuffer(); 
)brace
r_int
id|__init

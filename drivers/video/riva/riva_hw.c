...
multiline_comment|/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/nv/riva_hw.c,v 1.33 2002/08/05 20:47:06 mvojkovi Exp $ */
...
mdefine_line|#define LOAD_FIXED_STATE(tbl,dev)                                       &bslash;&n;    for (i = 0; i &lt; sizeof(tbl##Table##dev)/8; i++)                 &bslash;&n;        NV_WR32(&amp;chip-&gt;dev[tbl##Table##dev[i][0]], 0, tbl##Table##dev[i][1])
DECL|macro|LOAD_FIXED_STATE_8BPP
mdefine_line|#define LOAD_FIXED_STATE_8BPP(tbl,dev)                                  &bslash;&n;    for (i = 0; i &lt; sizeof(tbl##Table##dev##_8BPP)/8; i++)            &bslash;&n;        NV_WR32(&amp;chip-&gt;dev[tbl##Table##dev##_8BPP[i][0]], 0, tbl##Table##dev##_8BPP[i][1])
DECL|macro|LOAD_FIXED_STATE_15BPP
mdefine_line|#define LOAD_FIXED_STATE_15BPP(tbl,dev)                                 &bslash;&n;    for (i = 0; i &lt; sizeof(tbl##Table##dev##_15BPP)/8; i++)           &bslash;&n;        NV_WR32(&amp;chip-&gt;dev[tbl##Table##dev##_15BPP[i][0]], 0, tbl##Table##dev##_15BPP[i][1])
DECL|macro|LOAD_FIXED_STATE_16BPP
mdefine_line|#define LOAD_FIXED_STATE_16BPP(tbl,dev)                                 &bslash;&n;    for (i = 0; i &lt; sizeof(tbl##Table##dev##_16BPP)/8; i++)           &bslash;&n;        NV_WR32(&amp;chip-&gt;dev[tbl##Table##dev##_16BPP[i][0]], 0, tbl##Table##dev##_16BPP[i][1])
DECL|macro|LOAD_FIXED_STATE_32BPP
mdefine_line|#define LOAD_FIXED_STATE_32BPP(tbl,dev)                                 &bslash;&n;    for (i = 0; i &lt; sizeof(tbl##Table##dev##_32BPP)/8; i++)           &bslash;&n;        NV_WR32(&amp;chip-&gt;dev[tbl##Table##dev##_32BPP[i][0]], 0, tbl##Table##dev##_32BPP[i][1])
...
DECL|function|SetStartAddress3
r_static
r_void
id|SetStartAddress3
(paren

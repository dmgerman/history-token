...
multiline_comment|/**&n; * rivafb_create_cursor - sets rectangular cursor&n; * @par: pointer to riva_par object containing info for current riva board&n; * @width: cursor width in pixels&n; * @height: cursor height in pixels&n; *&n; * DESCRIPTION:&n; * Sets rectangular cursor.&n; *&n; * CALLED FROM:&n; * rivafb_set_font()&n; * rivafb_set_var()&n; */
...
suffix:semicolon
multiline_comment|/*      *a++ = byte_rev[*a];&n;        *a++ = byte_rev[*a];*/
op_star
id|a
op_assign
id|byte_rev
...
multiline_comment|/*&n;&t;if (par-&gt;cursor) {&n;&t;&t;disp-&gt;dispsw.cursor = rivafb_cursor;&n;&t;&t;disp-&gt;dispsw.set_font = rivafb_set_font;&n;&t;}&n;*/
r_return
l_int|0
suffix:semicolon
)brace
...
singleline_comment|//rivafb_create_cursor(par, fontwidth(dsp), fontheight(dsp));
id|riva_load_video_mode
c_func
(paren
id|info

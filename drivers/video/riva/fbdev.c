...
mdefine_line|#define CURSOR_HIDE_DELAY&t;&t;(10)
...
multiline_comment|/**&n; * riva_cursor_timer_handler - blink timer&n; * @dev_addr: pointer to fb_info object containing info for current riva board&n; *&n; * DESCRIPTION:&n; * Cursor blink timer.&n; */
...
id|out
suffix:semicolon
id|par-&gt;cursor-&gt;prev_slice_moves
op_assign
id|par-&gt;cursor-&gt;last_slice_moves
suffix:semicolon
id|par-&gt;cursor-&gt;last_slice_moves
op_assign
l_int|0
...
multiline_comment|/**&n; * rivafb_exit_cursor - stops blink timer and releases cursor structure&n; * @par: pointer to riva_par object containing info for current riva board&n; *&n; * DESCRIPTION:&n; * Stops blink timer and releases cursor structure.&n; *&n; * CALLED FROM:&n; * rivafb_init_one()&n; * rivafb_remove_one()&n; */
...
multiline_comment|/**&n; * rivafb_download_cursor - writes cursor shape into card registers&n; * @par: pointer to riva_par object containing info for current riva board&n; *&n; * DESCRIPTION:&n; * Writes cursor shape into card registers.&n; *&n; * CALLED FROM:&n; * riva_load_video_mode()&n; */
...
multiline_comment|/**&n; * rivafb_create_cursor - sets rectangular cursor&n; * @par: pointer to riva_par object containing info for current riva board&n; * @width: cursor width in pixels&n; * @height: cursor height in pixels&n; *&n; * DESCRIPTION:&n; * Sets rectangular cursor.&n; *&n; * CALLED FROM:&n; * rivafb_set_font()&n; * rivafb_set_par()&n; */
...
c_cond
(paren
id|c-&gt;last_slice_moves
OG
l_int|2
op_logical_or
id|c-&gt;prev_slice_moves
OG
l_int|2
)paren
(brace
...
multiline_comment|/**&n; * riva_load_video_mode - calculate timings&n; * @info: pointer to fb_info object containing info for current riva board&n; * @video_mode: video mode to set&n; *&n; * DESCRIPTION:&n; * Calculate some timings and then send em off to riva_load_state().&n; *&n; * CALLED FROM:&n; * rivafb_set_par()&n; */
...
multiline_comment|/*&n;&t;if (par-&gt;cursor) {&n;&t;&t;disp-&gt;dispsw.cursor = rivafb_cursor;&n;&t;&t;disp-&gt;dispsw.set_font = rivafb_set_font;&n;&t;}&n;&t;rivafb_create_cursor(par, fontwidth(dsp), fontheight(dsp));&n;*/
id|riva_load_video_mode
c_func
(paren
id|info
...
comma
op_amp
id|default_par-&gt;initial_state
)paren
suffix:semicolon
id|default_par-&gt;ram_amount
op_assign
id|default_par-&gt;riva.RamAmountKBytes
op_star
l_int|1024
suffix:semicolon
id|default_par-&gt;dclk_max
op_assign
id|default_par-&gt;riva.MaxVClockFreqKHz
op_star
l_int|1000
suffix:semicolon
r_if
...
(brace
multiline_comment|/*&n;&t; &t; * Now the _normal_ chipsets can just map the amount of real&n;&t; &t; * physical ram instead of the whole aperture&t;&n;&t; &t; */
id|rivafb_fix.smem_len
op_assign
id|default_par-&gt;ram_amount
suffix:semicolon
...
id|par-&gt;mtrr.vram
comma
id|board-&gt;fix.smem_start
comma
id|board-&gt;fix.smem_len
)paren
suffix:semicolon
macro_line|#endif /* CONFIG_MTRR */
id|iounmap
...
c_func
(paren
id|board-&gt;screen_base
)paren
suffix:semicolon
id|release_mem_region
c_func
(paren
id|board-&gt;fix.mmio_start
comma
id|board-&gt;fix.mmio_len
)paren
suffix:semicolon
id|release_mem_region
c_func

...
id|cdat
suffix:semicolon
multiline_comment|/*&n;&t;for (i = 0; i &lt; size; i++) {&n;&t;&t;*dat = byte_rev[*dat];&n;&t;&t;dat++;&n;&t;}&n;*/
r_switch
c_cond
(paren
id|info-&gt;var.bits_per_pixel
...
multiline_comment|/*&n;&t;&t;bg = ((par-&gt;cmap[bg_idx].red &amp; 0xf8) &lt;&lt; 7) |&n;&t;&t;     ((par-&gt;cmap[bg_idx].green &amp; 0xf8) &lt;&lt; 2) |&n;&t;&t;     ((par-&gt;cmap[bg_idx].blue &amp; 0xf8) &gt;&gt; 3) | 1 &lt;&lt; 15;&n;&n;&t;&t;fg = ((par-&gt;cmap[fg_idx].red &amp; 0xf8) &lt;&lt; 7) |&n;&t;&t;     ((par-&gt;cmap[fg_idx].green &amp; 0xf8) &lt;&lt; 2) |&n;&t;&t;     ((par-&gt;cmap[fg_idx].blue &amp; 0xf8) &gt;&gt; 3) | 1 &lt;&lt; 15;&n;*/
id|par-&gt;riva
dot
id|LockUnlock
c_func
...
c_cond
(paren
id|par-&gt;use_default_var
)paren
multiline_comment|/* We will use the modified default var */
id|info-&gt;var
op_assign
id|rivafb_default_var
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* jump to detailed timing block section */
id|block
op_add_assign
l_int|54
suffix:semicolon
...
id|KERN_INFO
id|PFX
l_string|&quot;detected DFP panel size from EDID: %dx%d&bslash;n&quot;
comma
id|par-&gt;panel_xres
comma
id|par-&gt;panel_yres
...
DECL|function|riva_get_dfpinfo
r_static
r_void
id|riva_get_dfpinfo
c_func
...
id|KERN_ERR
id|PFX
l_string|&quot;cannot reserve PRAMIN region&bslash;n&quot;
)paren
suffix:semicolon
r_goto

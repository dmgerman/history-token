...
mdefine_line|#define RIVAFB_VERSION &quot;0.9.4&quot;
...
id|CH_GEFORCE2_MX
comma
DECL|enumerator|CH_GEFORCE2_MX2
id|CH_GEFORCE2_MX2
comma
...
id|CH_GEFORCE2_GTS
comma
DECL|enumerator|CH_GEFORCE2_GTS2
id|CH_GEFORCE2_GTS2
comma
...
id|CH_QUADRO2_PRO
comma
DECL|enumerator|CH_GEFORCE4_MX_460
id|CH_GEFORCE4_MX_460
comma
DECL|enumerator|CH_GEFORCE4_MX_440
id|CH_GEFORCE4_MX_440
comma
DECL|enumerator|CH_GEFORCE4_MX_420
id|CH_GEFORCE4_MX_420
comma
DECL|enumerator|CH_GEFORCE4_440_GO
id|CH_GEFORCE4_440_GO
comma
DECL|enumerator|CH_GEFORCE4_420_GO
id|CH_GEFORCE4_420_GO
comma
DECL|enumerator|CH_GEFORCE4_420_GO_M32
id|CH_GEFORCE4_420_GO_M32
comma
DECL|enumerator|CH_QUADRO4_500XGL
id|CH_QUADRO4_500XGL
comma
DECL|enumerator|CH_GEFORCE4_440_GO_M64
id|CH_GEFORCE4_440_GO_M64
comma
DECL|enumerator|CH_QUADRO4_200
id|CH_QUADRO4_200
comma
DECL|enumerator|CH_QUADRO4_550XGL
id|CH_QUADRO4_550XGL
comma
DECL|enumerator|CH_QUADRO4_500_GOGL
id|CH_QUADRO4_500_GOGL
comma
DECL|enumerator|CH_IGEFORCE2
id|CH_IGEFORCE2
comma
...
id|CH_QUADRO_DDC
comma
DECL|enumerator|CH_GEFORCE4_TI_4600
id|CH_GEFORCE4_TI_4600
comma
DECL|enumerator|CH_GEFORCE4_TI_4400
id|CH_GEFORCE4_TI_4400
comma
DECL|enumerator|CH_GEFORCE4_TI_4200
id|CH_GEFORCE4_TI_4200
comma
DECL|enumerator|CH_QUADRO4_900XGL
id|CH_QUADRO4_900XGL
comma
DECL|enumerator|CH_QUADRO4_750XGL
id|CH_QUADRO4_750XGL
comma
DECL|enumerator|CH_QUADRO4_700XGL
id|CH_QUADRO4_700XGL
)brace
suffix:semicolon
...
comma
(brace
l_string|&quot;GeForce4 Ti 4600&quot;
comma
id|NV_ARCH_20
)brace
comma
(brace
l_string|&quot;GeForce4 Ti 4400&quot;
comma
id|NV_ARCH_20
)brace
comma
(brace
l_string|&quot;GeForce4 Ti 4200&quot;
comma
id|NV_ARCH_20
)brace
comma
(brace
l_string|&quot;Quadro4-900-XGL&quot;
comma
id|NV_ARCH_20
)brace
comma
(brace
l_string|&quot;Quadro4-750-XGL&quot;
comma
id|NV_ARCH_20
)brace
comma
(brace
l_string|&quot;Quadro4-700-XGL&quot;
comma
id|NV_ARCH_20
)brace
)brace
...
multiline_comment|/**&n; * rivafb_load_cursor_image - load cursor image to hardware&n; * @data: address to monochrome bitmap (1 = foreground color, 0 = background)&n; * @mask: address to mask (1 = write image pixel, 0 = do not write pixel)&n; * @par:  pointer to private data&n; * @w:    width of cursor image in pixels&n; * @h:    height of cursor image in scanlines&n; * @bg:   background color (ARGB1555) - alpha bit determines opacity&n; * @fg:   foreground color (ARGB1555)&n; *&n; * DESCRIPTiON:&n; * Loads cursor image based on a monochrome source and mask bitmap.  The&n; * mask bit determines if the image pixel is to be written to the framebuffer&n; * or not.  The imaage bits determines the color of the pixel, 0 for &n; * background, 1 for foreground.  Only the affected region (as determined &n; * by @w and @h parameters) will be updated.&n; *&n; * CALLED FROM:&n; * rivafb_cursor()&n; */
...
multiline_comment|/**&n; * riva_save_state - saves current chip state&n; * @par: pointer to riva_par object containing info for current riva board&n; * @regs: pointer to riva_regs object&n; *&n; * DESCRIPTION:&n; * Saves current chip state to @regs.&n; *&n; * CALLED FROM:&n; * rivafb_init_one()&n; */
multiline_comment|/* from GGI */
...
multiline_comment|/**&n; * riva_load_state - loads current chip state&n; * @par: pointer to riva_par object containing info for current riva board&n; * @regs: pointer to riva_regs object&n; *&n; * DESCRIPTION:&n; * Loads chip state from @regs.&n; *&n; * CALLED FROM:&n; * riva_load_video_mode()&n; * rivafb_init_one()&n; * rivafb_remove_one()&n; */
multiline_comment|/* from GGI */
...
multiline_comment|/**&n; * riva_load_video_mode - calculate timings&n; * @info: pointer to fb_info object containing info for current riva board&n; * @video_mode: video mode to set&n; *&n; * DESCRIPTION:&n; * Calculate some timings and then send em off to riva_load_state().&n; *&n; * CALLED FROM:&n; * rivafb_set_var()&n; */
...
multiline_comment|/**&n; * rivafb_do_maximize - &n; * @info: pointer to fb_info object containing info for current riva board&n; * @var:&n; * @nom:&n; * @den:&n; *&n; * DESCRIPTION:&n; * .&n; *&n; * RETURNS:&n; * -EINVAL on failure, 0 on success&n; * &n; *&n; * CALLED FROM:&n; * rivafb_set_var()&n; */
...
id|bg
suffix:semicolon
multiline_comment|/*&n;&t; * Can&squot;t do invert if one of the operands (dest) is missing,&n;&t; * ie, only opaque cursor supported.  This should be&n;&t; * standard for GUI apps.&n;&t; */
r_if
c_cond
(paren
id|cursor-&gt;dest
...
id|FB_VMODE_YWRAP
suffix:semicolon
multiline_comment|/*&n;&t; * HACK: The hardware cursor occasionally disappears during fast scrolling.&n;&t; *       We just reset the cursor each time we change the start address.&n;&t; *       This also has a beneficial side effect of restoring the cursor &n;&t; *       image when switching from X.&n;&t; */
id|par-&gt;cursor_reset
op_assign
l_int|1
suffix:semicolon
...
(brace
multiline_comment|/* RGB555: all components have 32 entries, 8 indices apart */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* &n;&t;&t; * RGB 565: red and blue have 32 entries, 8 indices apart, while&n;&t;&t; *          green has 64 entries, 4 indices apart&n;&t;&t; */
r_if
c_cond
(paren
id|regno
...
DECL|function|rivafb_get_mem_len
r_static
r_void
id|__devinit
id|rivafb_get_mem_len
c_func
(paren
r_struct
id|riva_par
...
id|default_par-&gt;riva.EnableIRQ
op_assign
l_int|0
suffix:semicolon
id|default_par-&gt;riva.PRAMDAC
op_assign
(paren
r_int
op_star
...
(brace
multiline_comment|/*&n;&t;&t; * We have to map the full BASE_1 aperture for Riva128&squot;s&n;&t;&t; * because they use the PRAMIN set in &quot;framebuffer&quot; space&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t; * Now the _normal_ chipsets can just map the amount of&n;&t;&t; * real physical ram instead of the whole aperture&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

...
multiline_comment|/**&n; * riva_cursor_timer_handler - blink timer&n; * @dev_addr: pointer to riva_par object containing info for current riva board&n; *&n; * DESCRIPTION:&n; * Cursor blink timer.&n; */
...
multiline_comment|/**&n; * rivafb_download_cursor - writes cursor shape into card registers&n; * @info: pointer to fb_info object containing info for current riva board&n; *&n; * DESCRIPTION:&n; * Writes cursor shape into card registers.&n; *&n; * CALLED FROM:&n; * riva_load_video_mode()&n; */
...
multiline_comment|/**&n; * rivafb_create_cursor - sets rectangular cursor&n; * @info: pointer to fb_info object containing info for current riva board&n; * @width: cursor width in pixels&n; * @height: cursor height in pixels&n; *&n; * DESCRIPTION:&n; * Sets rectangular cursor.&n; *&n; * CALLED FROM:&n; * rivafb_set_font()&n; * rivafb_set_var()&n; */

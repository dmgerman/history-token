...
comma
multiline_comment|/* Newer stuff */
id|CHIP_DEF
c_func
(paren
id|PCI_CHIP_RV380_3E50
comma
id|RV380
comma
id|CHIP_HAS_CRTC2
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): ROM failed to map&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): Invalid ROM signature %x should be&quot;
l_string|&quot;0xaa55&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;radeonfb (%s): PCI DATA signature in ROM&quot;
l_string|&quot;incorrect: %08x&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(brace
multiline_comment|/* A temporal workaround for the occational blanking on certain laptop&n;&t;&t; * panels. This appears to related to the PLL divider registers&n;&t;&t; * (fail to lock?). It occurs even when all dividers are the same&n;&t;&t; * with their old settings. In this case we really don&squot;t need to&n;&t;&t; * fiddle with PLL registers. By doing this we can avoid the blanking&n;&t;&t; * problem with some panels.&n;&t;         */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* We still have to force a switch to selected PPLL div thanks to&n;&t;&t;&t; * an XFree86 driver bug which will switch it away in some cases&n;&t;&t;&t; * even when using UseFDev */
id|OUTREGP
c_func
(paren
id|CLOCK_CNTL_INDEX
comma
id|mode-&gt;clk_cntl_index
op_amp
...
suffix:semicolon
multiline_comment|/* Switch to selected PPLL divider */
id|OUTREGP
c_func
(paren
id|CLOCK_CNTL_INDEX
...
suffix:semicolon
multiline_comment|/* We use PPLL_DIV_3 */
id|newmode-&gt;clk_cntl_index
op_assign
l_int|0x300
suffix:semicolon
multiline_comment|/* Calculate PPLL value if necessary */
r_if
c_cond
(paren
op_logical_neg
...
id|newmode-&gt;fp_gen_cntl
op_or_assign
id|R200_FP_SOURCE_SEL_RMX
suffix:semicolon
r_else
id|newmode-&gt;fp_gen_cntl
op_or_assign
id|R200_FP_SOURCE_SEL_CRTC1
suffix:semicolon
)brace
r_else
id|newmode-&gt;fp_gen_cntl
...
macro_line|#endif /* CONFIG_PPC_OF */
DECL|function|radeon_identify_vram
r_static
r_void
id|radeon_identify_vram
c_func
(paren
r_struct
id|radeonfb_info
...
multiline_comment|/*&n;&t; * Now try to identify VRAM type&n;&t; */
r_if
c_cond
(paren
id|rinfo-&gt;is_IGP
...
multiline_comment|/* This may not be correct, as some cards can have half of channel disabled&n;&t; * ToDo: identify these cases&n;&t; */
id|RTRACE
c_func
(paren
l_string|&quot;radeonfb (%s): Found %ldk of %s %d bits wide videoram&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): Cannot enable PCI device&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): could not allocate memory&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): cannot reserve PCI regions.&quot;
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): cannot map MMIO&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
l_int|16
suffix:semicolon
multiline_comment|/*&n;&t; * Check for errata&n;&t; */
id|rinfo-&gt;errata
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
macro_line|#ifdef CONFIG_PPC_OF
multiline_comment|/* On PPC, we obtain the OF device-node pointer to the firmware&n;&t; * data for this chip&n;&t; */
id|rinfo-&gt;of_node
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;radeonfb (%s): Cannot match card to OF node !&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
suffix:semicolon
macro_line|#endif /* CONFIG_PPC_OF */
multiline_comment|/* Get VRAM size and type */
id|radeon_identify_vram
c_func
(paren
id|rinfo
...
(paren
id|KERN_ERR
l_string|&quot;radeonfb (%s): cannot map FB&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
c_func
(paren
l_string|&quot;radeonfb (%s): mapped %ldk videoram&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(brace
multiline_comment|/* -2 is special: means  ON on mobility chips and do not&n;&t;&t; * change on others&n;&t;&t; */
id|radeonfb_pm_init
c_func
(paren
id|rinfo
...
id|printk
(paren
l_string|&quot;radeonfb (%s): %s&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* restore original state&n;&t; * &n;&t; * Doesn&squot;t quite work yet, I suspect if we come from a legacy&n;&t; * VGA mode (or worse, text mode), we need to do some VGA black&n;&t; * magic here that I know nothing about. --BenH&n;&t; */
id|radeon_write_mode
(paren
id|rinfo
comma
...
id|default_dynclk
comma
l_string|&quot;int: -2=enable on mobility only,-1=do not change,0=off,1=on&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func

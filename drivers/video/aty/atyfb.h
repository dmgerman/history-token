...
DECL|member|monitors_enabled
id|u32
id|monitors_enabled
suffix:semicolon
multiline_comment|/* LCD monitor support */
DECL|member|h_stretching
id|u16
id|h_stretching
suffix:semicolon
multiline_comment|/* LCD monitor support */
DECL|member|v_stretching
id|u16
id|v_stretching
suffix:semicolon
multiline_comment|/* LCD monitor support */
...
id|lcd_hdisp
suffix:semicolon
DECL|member|lcd_hsync_start
id|u16
id|lcd_hsync_start
suffix:semicolon
DECL|member|lcd_hsync_delay
id|u16
id|lcd_hsync_delay
suffix:semicolon
DECL|member|lcd_hsync_width
id|u16
id|lcd_hsync_width
suffix:semicolon
...
id|lcd_vdisp
suffix:semicolon
DECL|member|lcd_vsync_start
id|u16
id|lcd_vsync_start
suffix:semicolon
DECL|member|lcd_vsync_width
id|u16
id|lcd_vsync_width
suffix:semicolon
DECL|member|lcd_right
id|u16
id|lcd_right
suffix:semicolon
DECL|member|lcd_lower
id|u16
id|lcd_lower
suffix:semicolon
DECL|member|lcd_hblank_width
id|u16
id|lcd_hblank_width
suffix:semicolon
DECL|member|lcd_vblank_width
id|u16
id|lcd_vblank_width
suffix:semicolon
macro_line|#endif

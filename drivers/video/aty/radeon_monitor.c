...
(brace
macro_line|#ifdef CONFIG_PPC_OF
multiline_comment|/*&n;&t; * LCD Flat panels should use fixed dividers, we enfore that on&n;&t; * PPC only for now...&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|pickup_default
suffix:colon
multiline_comment|/*&n;&t; * Apply passed-in mode option if any&n;&t; */
r_if
c_cond
(paren
id|mode_option
...
multiline_comment|/*&n;&t; * Still no mode, let&squot;s pick up a default from the db&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|mode
suffix:semicolon
multiline_comment|/* Make sure that whatever mode got selected is actually in the&n;&t;&t; * modelist or the kernel may die&n;&t;&t; */
...
multiline_comment|/*&n; * This is used when looking for modes. We assign a &quot;distance&quot; value&n; * to a mode in the modedb depending how &quot;close&quot; it is from what we&n; * are looking for.&n; * Currently, we don&squot;t compare that much, we could do better but&n; * the current fbcon doesn&squot;t quite mind ;)&n; */

...
(brace
multiline_comment|/*&n;&t; * A few iBook laptop panels seem to need a fixed PLL setting&n;&t; *&n;&t; * We should probably do this differently based on the panel&n;&t; * type/model or eventually some other device-tree informations,&n;&t; * but these tweaks below work enough for now. --BenH&n;&t; */
macro_line|#ifdef CONFIG_PPC_OF
multiline_comment|/* iBook2&squot;s */
r_if
c_cond
(paren

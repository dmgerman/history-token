...
suffix:semicolon
multiline_comment|/*&n; * Errata workarounds&n; */
DECL|enum|radeon_errata
r_enum
id|radeon_errata
(brace
DECL|enumerator|CHIP_ERRATA_R300_CG
id|CHIP_ERRATA_R300_CG
op_assign
l_int|0x00000001
comma
DECL|enumerator|CHIP_ERRATA_PLL_DUMMYREADS
id|CHIP_ERRATA_PLL_DUMMYREADS
op_assign
l_int|0x00000002
comma
DECL|enumerator|CHIP_ERRATA_PLL_DELAY
id|CHIP_ERRATA_PLL_DELAY
op_assign
l_int|0x00000004
comma
)brace
...
multiline_comment|/*&n; * Note about PLL register accesses:&n; *&n; * I have removed the spinlock on them on purpose. The driver now&n; * expects that it will only manipulate the PLL registers in normal&n; * task environment, where radeon_msleep() will be called, protected&n; * by a semaphore (currently the console semaphore) so that no conflict&n; * will happen on the PLL register index.&n; *&n; * With the latest changes to the VT layer, this is guaranteed for all&n; * calls except the actual drawing/blits which aren&squot;t supposed to use&n; * the PLL registers anyway&n; *&n; * This is very important for the workarounds to work properly. The only&n; * possible exception to this rule is the call to unblank(), which may&n; * be done at irq time if an oops is in progress.&n; */
DECL|function|radeon_pll_errata_after_index
r_static
r_inline
r_void
id|radeon_pll_errata_after_index
c_func
(paren
r_struct
id|radeonfb_info
...
DECL|function|radeon_pll_errata_after_data
r_static
r_inline
r_void
id|radeon_pll_errata_after_data
c_func
(paren
r_struct
id|radeonfb_info
...
(brace
multiline_comment|/* we can&squot;t deal with posted writes here ... */
id|_radeon_msleep
c_func
(paren
id|rinfo
...
DECL|macro|INPLL
mdefine_line|#define INPLL(addr)&t;&t;&t;__INPLL(rinfo, addr)
DECL|macro|OUTPLL
mdefine_line|#define OUTPLL(index, val)&t;&t;__OUTPLL(rinfo, index, val)
DECL|macro|OUTPLLP
mdefine_line|#define OUTPLLP(index, val, mask)&t;__OUTPLLP(rinfo, index, val, mask)
DECL|macro|BIOS_IN8

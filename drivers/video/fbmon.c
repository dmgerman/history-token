...
suffix:semicolon
multiline_comment|/* Only if display is GTF capable will&n;&t;&t;   the input type be reset to analog */
r_if
c_cond
(paren
id|b
...
c_func
(paren
l_string|&quot;fbmon: trying a header reconstruct&bslash;n&quot;
)paren
suffix:semicolon
id|memcpy
c_func

...
multiline_comment|/**&n; *&t;fb_copy_cmap - copy a colormap&n; *&t;@from: frame buffer colormap structure&n; *&t;@to: frame buffer colormap structure&n; *&n; *&t;Copy contents of colormap from @from to @to.&n; */
...
multiline_comment|/**&n; *&t;fb_set_cmap - set the colormap&n; *&t;@cmap: frame buffer colormap structure&n; *&t;@info: frame buffer info structure&n; *&n; *&t;Sets the colormap @cmap for a screen of device @info.&n; *&n; *&t;Returns negative errno on error, or zero on success.&n; *&n; */
...
DECL|function|fb_set_user_cmap
r_int
id|fb_set_user_cmap
c_func
(paren

...
multiline_comment|/**&n; *      tcx_check_var - Optional function.  Validates a var passed in.&n; *      @var: frame buffer variable screen structure&n; *      @info: frame buffer structure that represents a single frame buffer&n; */
DECL|function|tcx_check_var
r_static
r_int
id|tcx_check_var
c_func
...
multiline_comment|/**&n; *      tcx_set_par - Optional function.  Alters the hardware state.&n; *      @info: frame buffer structure that represents a single frame buffer&n; */
r_static
r_int
DECL|function|tcx_set_par
id|tcx_set_par
c_func
(paren
r_struct

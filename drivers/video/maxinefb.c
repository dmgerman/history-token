...
DECL|function|maxinefb_release
r_static
r_int
id|maxinefb_release
c_func
...
suffix:semicolon
DECL|function|maxinefb_init_one
r_int
id|__init
id|maxinefb_init_one
c_func
(paren
)paren
(brace
...
multiline_comment|/* Initialise the framebuffer */

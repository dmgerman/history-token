...
macro_line|#endif
macro_line|#if defined(__i386__) || defined(__x86_64__) || defined(__mips__)
multiline_comment|/*&n;&t; * x86 and MIPS are simple, we just do regular&n;&t; * outb&squot;s instead of cyber2000fb_writeb.&n;&t; */
id|outb
c_func
(paren
l_int|0x18
...
multiline_comment|/*&n;&t; * Hmm, we _need_ a portable way of finding the address for&n;&t; * the remap stuff, both for mmio and for smem.&n;&t; */

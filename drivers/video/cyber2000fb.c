...
l_int|16
suffix:colon
multiline_comment|/* DIRECTCOLOUR */
id|cfb-&gt;dispsw
op_assign
op_amp
id|fbcon_cfb16
...
multiline_comment|/*&n;&t; * 8bpp displays are always pseudo colour.&n;&t; * 16bpp and above are direct colour or true colour, depending&n;&t; * on whether the RAMDAC palettes are bypassed.  (Direct colour&n;&t; * has palettes, true colour does not.)&n;&t; */
r_if
c_cond
(paren
id|var-&gt;bits_per_pixel

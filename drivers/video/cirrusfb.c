...
id|btype
suffix:semicolon
multiline_comment|/* chipset enum, not strictly necessary, as&n;&t;&t;&t;&t; * cirrusfb_board_info[] is directly indexed&n;&t;&t;&t;&t; * by this value */
DECL|member|name
r_char
op_star
id|name
...
DECL|function|cirrusfb_pci_setup
r_static
r_struct
id|cirrusfb_info
op_star
id|cirrusfb_pci_setup
(paren
r_struct
id|pci_dev
op_star
...
macro_line|#ifdef CONFIG_ZORRO
DECL|function|cirrusfb_zorro_find
r_static
r_int
id|cirrusfb_zorro_find
(paren
r_struct
id|zorro_dev
op_star
...
(paren
id|KERN_NOTICE
l_string|&quot;cirrusfb: no supported board found.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|cirrusfb_zorro_setup
r_static
r_struct
id|cirrusfb_info
op_star
id|cirrusfb_zorro_setup
c_func
(paren
r_void
)paren
...
DECL|macro|cirrusfb_unmap
mdefine_line|#define cirrusfb_unmap cirrusfb_pci_unmap
DECL|macro|cirrusfb_bus_setup
mdefine_line|#define cirrusfb_bus_setup cirrusfb_pci_setup
macro_line|#elif defined(CONFIG_ZORRO)
DECL|macro|cirrusfb_unmap
mdefine_line|#define cirrusfb_unmap cirrusfb_zorro_unmap
DECL|macro|cirrusfb_bus_setup
mdefine_line|#define cirrusfb_bus_setup cirrusfb_zorro_setup
macro_line|#endif

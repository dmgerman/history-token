...
c_cond
(paren
id|info-&gt;fb_info.var.accel_flags
op_amp
id|FB_ACCELF_TEXT
)paren
id|aty128_init_engine
...
suffix:semicolon
macro_line|#endif&t;&t;&t;&t;/* CONFIG_BOOTX_TEXT */
id|info-&gt;fb_info.fix.line_length
op_assign
(paren
id|info-&gt;fb_info.var.xres_virtual
op_star
id|info-&gt;fb_info.var.bits_per_pixel
)paren
op_rshift
l_int|3
suffix:semicolon
id|info-&gt;fb_info.fix.visual
op_assign
id|info-&gt;fb_info.var.bits_per_pixel
op_le
l_int|8
...
id|oldxres
op_assign
id|info-&gt;fb_info.var.xres
suffix:semicolon
id|oldyres
op_assign
id|info-&gt;fb_info.var.yres
suffix:semicolon
id|oldvxres
op_assign
id|info-&gt;fb_info.var.xres_virtual
...
id|oldvyres
op_assign
id|info-&gt;fb_info.var.yres_virtual
suffix:semicolon
id|oldbpp
op_assign
id|info-&gt;fb_info.var.bits_per_pixel
...
id|display-&gt;type
op_assign
id|info-&gt;fb_info.fix.type
suffix:semicolon
id|display-&gt;type_aux
op_assign
id|info-&gt;fb_info.fix.type_aux
suffix:semicolon
id|display-&gt;ypanstep
op_assign
id|info-&gt;fb_info.fix.ypanstep
suffix:semicolon
id|display-&gt;ywrapstep
op_assign
id|info-&gt;fb_info.fix.ywrapstep
suffix:semicolon

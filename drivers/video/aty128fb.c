...
multiline_comment|/*&n;     * Functions to read from/write to the mmio registers&n;     *  - endian conversions may possibly be avoided by&n;     *    using the other register aperture. TODO.&n;     */
r_static
r_inline
id|u32
...
suffix:semicolon
multiline_comment|/* Disable ATOMIC updating.  Is this the right place?&n;&t; * -- BenH: Breaks on my G4&n;&t; */
macro_line|#if 0
id|aty_st_le32
c_func
(paren
...
r_static
r_void
DECL|function|aty128fb_rectcopy
id|aty128fb_rectcopy
c_func
(paren
r_int
id|srcx
...
(paren
id|KERN_ERR
l_string|&quot;aty128fb: can&squot;t alloc fb_info&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_unmap_out
...
(paren
id|KERN_ERR
l_string|&quot;aty128fb: can&squot;t alloc aty128fb_par&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_unmap_out
...
l_int|8
suffix:semicolon
multiline_comment|/* Note: For now, on M3, we set palette on both heads, which may&n;&t; * be useless. Can someone with a M3 check this ? */
...
suffix:semicolon
macro_line|#endif&t;&t;&t;/* CONFIG_MTRR */
id|iounmap
c_func
(paren
id|par-&gt;regbase

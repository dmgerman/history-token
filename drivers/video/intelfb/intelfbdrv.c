...
l_int|0
suffix:semicolon
multiline_comment|/* Disable HW cursor on 915G (not implemented yet) */
id|hwcursor
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;fb aperture: 0x%llx/0x%llx, MMIO region: 0x%llx/0x%llx&bslash;n&quot;
comma
(paren
r_int
r_int

...
macro_line|#include &quot;builtinmodes.c&quot;
DECL|macro|FB_ACCEL_I830
mdefine_line|#define FB_ACCEL_I830 42
...
multiline_comment|/* Framebuffer parameters - Use all the stolen memory */
id|dinfo-&gt;fb.size
op_assign
id|ROUND_UP_TO_PAGE
c_func
...
l_int|0
suffix:semicolon
singleline_comment|// starts at offset 0
...
c_func
(paren
l_string|&quot;options: accel = %d, hwcursor = %d, fixed = %d, &quot;
...
c_func
(paren
l_string|&quot;Failed to set hw for mode %dx%d&bslash;n&quot;
comma
id|var.xres
comma
id|var.yres
...
c_func
(paren
l_string|&quot;HW state for mode %dx%d&bslash;n&quot;
comma
id|var.xres
comma
id|var.yres
...
multiline_comment|/*&n; * A simplified version of fb_find_mode.  The latter doesn&squot;t seem to work&n; * too well -- haven&squot;t figured out why yet.&n; */
r_static
r_int
DECL|function|intelfb_find_mode
...
c_func
(paren
l_string|&quot;intelfb_find_mode&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Mode is %s, bpp %d&bslash;n&quot;
comma
id|mname
comma
id|bpp
...
multiline_comment|/* Convert a mode to a var, also making the bpp a supported value. */
r_static
r_void
DECL|function|mode_to_var
id|mode_to_var
c_func
(paren
r_const
...
c_func
(paren
l_string|&quot;var_to_mode: bad bpp: %d&bslash;n&quot;
comma
id|bpp
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;intelfb_init_disp_var&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
comma
id|dinfo-&gt;info-&gt;var.xres
comma
id|dinfo-&gt;info-&gt;var.yres
comma
id|intelfb_var_to_depth
c_func
(paren

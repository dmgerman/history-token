...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Hardware Cursor API Definitions&n;&t; * These used to be in linux/fb.h, but were preliminary and used by&n;&t; * amifb only anyway&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Saved color entry 0 so we can restore it when unblanking&n;&t; */
DECL|variable|red0
DECL|variable|green0
DECL|variable|blue0
r_static
id|u_char
id|red0
...
suffix:semicolon
DECL|function|amifb_setup_mcap
r_static
r_void
id|__init
id|amifb_setup_mcap
...
id|par
suffix:semicolon
multiline_comment|/* Validate wanted screen parameters */
r_if
c_cond
(paren
(paren
...
id|err
suffix:semicolon
multiline_comment|/* Encode (possibly rounded) screen parameters */
id|ami_encode_var
c_func
(paren
id|var
...
l_int|0
suffix:semicolon
multiline_comment|/* Decode wanted screen parameters */
id|ami_decode_var
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Set new videomode */
id|ami_build_copper
c_func
(paren
)paren
suffix:semicolon
multiline_comment|/* Set VBlank trigger */
id|do_vmode_full
op_assign
l_int|1
suffix:semicolon
multiline_comment|/* Update fix for new screen parameters */
r_if
c_cond
(paren
id|par-&gt;bpp
...
mdefine_line|#define BYTES_PER_LONG&t;4
DECL|macro|SHIFT_PER_LONG
mdefine_line|#define SHIFT_PER_LONG&t;5
macro_line|#elif BITS_PER_LONG == 64
DECL|macro|BYTES_PER_LONG
mdefine_line|#define BYTES_PER_LONG&t;8
DECL|macro|SHIFT_PER_LONG
mdefine_line|#define SHIFT_PER_LONG&t;6
macro_line|#else
DECL|macro|Please
mdefine_line|#define Please update me
macro_line|#endif
...
multiline_comment|/*&n;     *  Unaligned forward bit copy using 32-bit or 64-bit memory accesses&n;     */
...
multiline_comment|/*&n;     *  Unaligned reverse bit copy using 32-bit or 64-bit memory accesses&n;     */
...
multiline_comment|/*&n;     *  Unaligned forward inverting bit copy using 32-bit or 64-bit memory&n;     *  accesses&n;     */
DECL|function|bitcpy_not
r_static
r_void
id|bitcpy_not
c_func
...
multiline_comment|/*&n;     *  Unaligned 32-bit pattern xor using 32/64-bit memory accesses&n;     */
DECL|function|bitxor32
r_static
r_void
id|bitxor32
c_func
...
DECL|function|copy_one_line_rev
r_static
r_inline
r_void
id|copy_one_line_rev
c_func
(paren
r_int
id|bpp
...
id|dy
suffix:semicolon
multiline_comment|/* update sx,sy */
id|sx
op_assign
id|area-&gt;sx
op_plus
...
suffix:semicolon
multiline_comment|/* set or clear */
)brace
r_else
id|bitfill32
c_func
...
c_func
(paren
l_string|&quot;invalid diwstop_v&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

...
multiline_comment|/**&n; * &t;tdfxfb_probe - Device Initializiation&n; * &t;&n; * &t;@pdev:&t;PCI Device to initialize&n; * &t;@id:&t;PCI Device ID&n; *&n; * &t;Initializes and allocates resources for PCI device @pdev.&n; *&n; */
...
(brace
multiline_comment|/* &n;&t;&t; * ugh -- can&squot;t use the mode from the mode db. (or command&n;&t;&t; * line), so try the default&n;&t;&t; */
id|printk
c_func
(paren
id|KERN_NOTICE
l_string|&quot;tdfxfb: can&squot;t decode the supplied video mode, using default&bslash;n&quot;
)paren
suffix:semicolon
id|var
op_assign
...
multiline_comment|/**&n; *&t;tdfxfb_remove - Device removal&n; *&n; * &t;@pdev:&t;PCI Device to cleanup&n; *&n; *&t;Releases all resources allocated during the course of the driver&squot;s&n; *&t;lifetime for the PCI device @pdev.&n; *&n; */

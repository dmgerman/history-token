...
id|info-&gt;cursor.image.data
suffix:semicolon
id|cursor.image.cmap.red
op_assign
id|info-&gt;cursor.image.cmap.red
suffix:semicolon
id|cursor.image.cmap.green
op_assign
id|info-&gt;cursor.image.cmap.green
suffix:semicolon
id|cursor.image.cmap.blue
op_assign
id|info-&gt;cursor.image.cmap.blue
suffix:semicolon
id|cursor.image.cmap.transp
op_assign
id|info-&gt;cursor.image.cmap.transp
suffix:semicolon
id|cursor.data
op_assign
l_int|NULL
...
c_cond
(paren
id|cursor_user.image.cmap.transp
)paren
(brace
id|transp
op_assign
...
id|green
comma
id|cursor_user.image.cmap.green
comma
id|len
)paren
)paren
...
id|blue
comma
id|cursor_user.image.cmap.blue
comma
id|len
)paren
)paren

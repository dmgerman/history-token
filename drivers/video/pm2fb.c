multiline_comment|/*&n; * Permedia2 framebuffer driver.&n; * Copyright (c) 1998-2000 Ilario Nardinocchi (nardinoc@CS.UniBO.IT)&n; * Copyright (c) 1999 Jakub Jelinek (jakub@redhat.com)&n; * Based on linux/drivers/video/skeletonfb.c by Geert Uytterhoeven.&n; * --------------------------------------------------------------------------&n; * $Id: pm2fb.c,v 1.213 2000/09/19 01:03:19 illo Exp $&n; * --------------------------------------------------------------------------&n; * History:&n; *  1999/05/09 added Jim Hague&squot;s &squot;var&squot; kernel option (thanks Jim!)&n; *  2002/04/23 Jim Hague &lt;jim.hague@acm.org&gt;&n; *&t;* Integrated Illo&squot;s last changes, No changelist available.&n; *&t;  Major items: acceleration support, hardware cursor code&n; *&t;  (not yet enabled).&n; *&t;* Fixed -vsync, added lowhsync/lowvsync overrides for use with&n; *&t;  XFree GLINT driver.&n; * --------------------------------------------------------------------------&n; * TODO multiple boards support&n; * --------------------------------------------------------------------------&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file COPYING in the main directory of this archive&n; * for more details.&n; */
...
mdefine_line|#define VIDEO_MASK&t;0x00011e7f&t;/* r/w values for VIDEO_CONTROL */
DECL|macro|PM2FF_ACCEL
mdefine_line|#define PM2FF_ACCEL&t;&t;(1L&lt;&lt;0)
...
id|flags
suffix:semicolon
multiline_comment|/* internal flags (PM2FF_xxxx) */
)brace
suffix:semicolon
...
DECL|macro|OPTF_USER_VAR
mdefine_line|#define OPTF_USER_VAR&t;&t;(1L&lt;&lt;4)
DECL|macro|OPTF_LOW_HSYNC
mdefine_line|#define&t;OPTF_LOW_HSYNC&t;&t;(1L&lt;&lt;5)
DECL|macro|OPTF_LOW_VSYNC
mdefine_line|#define&t;OPTF_LOW_VSYNC&t;&t;(1L&lt;&lt;6)
r_static
r_struct
(brace
DECL|member|font
...
suffix:semicolon
DECL|macro|DEFAULT_USER_MODE
mdefine_line|#define DEFAULT_USER_MODE&t;0
r_static
r_const
r_struct
(brace
...
id|type
suffix:semicolon
multiline_comment|/* Permedia2 board type */
r_struct
(brace
DECL|member|fb_base
r_int
...
multiline_comment|/* Hsync is actually low */
id|p-&gt;video
op_or_assign
id|PM2F_HSYNC_ACT_LOW
suffix:semicolon
...
multiline_comment|/* Vsync is actually low */
id|p-&gt;video
op_or_assign
id|PM2F_VSYNC_ACT_LOW
suffix:semicolon
...
multiline_comment|/*&n;&t; * Somehow I have to manage this unretrievable fields.&n;&t; * To say the truth, &squot;flags&squot; field ought to be somewhere else.&n;&t; */
r_if
c_cond
(paren
...
id|p-&gt;pixclock
op_assign
id|i-&gt;current_par.pixclock
suffix:semicolon
id|p-&gt;flags
op_assign
id|i-&gt;current_par.flags
suffix:semicolon
)brace
)brace
...
suffix:semicolon
multiline_comment|/* FIXME: Find out what the actual pixclock is&n;&t;&t; * and other values as well */
r_if
c_cond
(paren
id|timing
...
multiline_comment|/* Pick up user_var settings if set. */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;pm2fb: user supplied var: mode is bad.&bslash;n&quot;
)paren
suffix:semicolon
id|memcpy
c_func

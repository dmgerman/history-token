...
multiline_comment|/**&n; * fb_find_nearest_mode - find mode closest video mode&n; *&n; * @var: pointer to struct fb_var_screeninfo&n; * @head: pointer to modelist&n; *&n; * Finds best matching videomode, smaller or greater in dimension.&n; * If more than 1 videomode is found, will return the videomode with&n; * the closest refresh rate&n; */
DECL|function|fb_find_nearest_mode
r_struct
id|fb_videomode
op_star
...
suffix:semicolon
DECL|variable|fb_find_nearest_mode
id|EXPORT_SYMBOL
c_func
(paren
id|fb_find_nearest_mode

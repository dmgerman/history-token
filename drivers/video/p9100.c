...
suffix:semicolon
multiline_comment|/**&n; *      p9100_check_var - Optional function.  Validates a var passed in.&n; *      @var: frame buffer variable screen structure&n; *      @info: frame buffer structure that represents a single frame buffer&n; */
DECL|function|p9100_check_var
r_static
r_int
id|p9100_check_var
c_func
...
multiline_comment|/**&n; *      p9100_set_par - Optional function.  Alters the hardware state.&n; *      @info: frame buffer structure that represents a single frame buffer&n; */
r_static
r_int
DECL|function|p9100_set_par
id|p9100_set_par
c_func
(paren
r_struct

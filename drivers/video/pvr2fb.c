multiline_comment|/* drivers/video/pvr2fb.c&n; *&n; * Frame buffer and fbcon support for the NEC PowerVR2 found within the Sega&n; * Dreamcast.&n; *&n; * Copyright (c) 2001 M. R. Brown &lt;mrbrown@0xd6.org&gt;&n; * Copyright (c) 2001, 2002, 2003, 2004, 2005 Paul Mundt &lt;lethal@linux-sh.org&gt;&n; *&n; * This file is part of the LinuxDC project (linuxdc.sourceforge.net).&n; *&n; */

multiline_comment|/*&n; *  arch/s390/kernel/s390io.c&n; *   S/390 common I/O routines&n; *&n; *  S390 version&n; *    Copyright (C) 1999, 2000 IBM Deutschland Entwicklung GmbH,&n; *                             IBM Corporation&n; *    Author(s): Ingo Adlung (adlung@de.ibm.com)&n; *    ChangeLog: 01/04/2001 Holger Smolinski (smolinsk@de.ibm.com)&n; *                          Fixed lost interrupts and do_adapter_IO&n; *               xx/xx/xxxx nnn          multiple changes not reflected&n; *               03/12/2001 Ingo Adlung  blacklist= - changed to cio_ignore=  &n; *               03/14/2001 Ingo Adlung  disable interrupts before start_IO&n; *                                        in Path Group processing &n; *                                       decrease retry2 on busy while &n; *                                        disabling sync_isc; reset isc_cnt&n; *                                        on io error during sync_isc enablement&n; *               05/09/2001 Cornelia Huck added exploitation of debug feature&n; *               05/16/2001 Cornelia Huck added /proc/deviceinfo/&lt;devno&gt;/&n; *               05/22/2001 Cornelia Huck added /proc/cio_ignore&n; *                                        un-ignore blacklisted devices by piping &n; *                                        to /proc/cio_ignore&n; */
...
multiline_comment|/* &n; * Function: blacklist_range_create&n; * Creates a range from the given parameters&n; */
DECL|function|blacklist_range_create
r_static
r_inline
id|dev_blacklist_range_t
op_star
id|blacklist_range_create
c_func
(paren
r_int
id|from
...
multiline_comment|/* &n; * Function: blacklist_range_destroy&n; * Free the given range&n; */
...
op_decrement
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME: the memory was allocated as bootmem, &n;&t; * how to get it free again ?! &n;&t; */
multiline_comment|/* kfree( range ); */
)brace
multiline_comment|/*&n; * Function: blacklist_range_append&n; * Append a range to the list of blacklisted ranges anchored at dev_blacklist_range_head&n; */
DECL|function|blacklist_range_append
r_static
r_inline
r_void
id|blacklist_range_append
c_func
(paren
id|dev_blacklist_range_t
op_star
...
multiline_comment|/*&n; * Function: blacklist_range_dechain&n; * Remove a range from the list of blacklisted ranges&n; */
DECL|function|blacklist_range_dechain
r_static
r_inline
r_void
id|blacklist_range_dechain
c_func
(paren
id|dev_blacklist_range_t
op_star
...
l_int|0
comma
l_string|&quot;enable_subchannel(%04X) : ccode 2 on msch() for device %04X received !&bslash;n&quot;
comma
id|irq
comma
id|ioinfo
...
id|ENODEV
suffix:semicolon
singleline_comment|// very unlikely
)brace
r_else
r_if
c_cond
...
id|EBUSY
suffix:semicolon
singleline_comment|// device busy ...
)brace
r_else
r_if
c_cond
...
suffix:semicolon
singleline_comment|//
singleline_comment|// The OSA_E FE card possibly causes -ETIMEDOUT
singleline_comment|//  conditions, as the SenseID may stay start
singleline_comment|//  pending. This will cause start_IO() to finally
singleline_comment|//  halt the operation we should retry. If the halt
singleline_comment|//  fails this may cause -EBUSY we simply retry
singleline_comment|//  and eventually clean up with free_irq().   &t;     &t;&t;
singleline_comment|//
r_if
c_cond
(paren
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t;&t; * we report back the&n;&t;&t;&t;&t;&t;&t;&t; *  first hit only&n;&t;&t;&t;&t;&t;&t;&t; */
id|psid
op_assign
op_amp
id|isid
...
multiline_comment|/* endif */
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t;&t; * if just the very first&n;&t;&t;&t;&t;&t;&t;&t; *  was requested to be&n;&t;&t;&t;&t;&t;&t;&t; *  sensed disable further&n;&t;&t;&t;&t;&t;&t;&t; *  scans.&n;&t;&t;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* endif */
multiline_comment|/*&n;&t;&t;&t; * Issue device info message if unit was operational .&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;do_crw_pending : ioinfo at %08X&bslash;n&quot;
comma
(paren
r_int
)paren
...
DECL|function|cio_search_devno_by_inode
r_int
id|cio_search_devno_by_inode
c_func
(paren
r_struct
id|inode
...
op_logical_or
(paren
id|tmp-&gt;entry-&gt;cio_sensedata_entry
op_eq
id|pde
)paren
op_logical_or
(paren
id|tmp-&gt;entry-&gt;cio_in_use_entry
op_eq
id|pde
)paren
op_logical_or
(paren
id|tmp-&gt;entry-&gt;cio_chpid_entry
op_eq
id|pde
)paren
)paren
...
suffix:semicolon
multiline_comment|/*&n; * Entry /proc/cio_ignore to display blacklisted ranges of devices.&n; * un-ignore devices by piping to /proc/cio_ignore:&n; * free all frees all blacklisted devices, free &lt;range&gt;,&lt;range&gt;,...&n; * frees specified ranges of devnos&n; */

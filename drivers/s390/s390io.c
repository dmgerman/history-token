...
l_string|&quot;dev_id does not match !&quot;
comma
id|irq
)paren
suffix:semicolon
...
multiline_comment|/* Display info on subchannels in /proc/subchannels. *&n; * Adapted from procfs stuff in dasd.c by Cornelia Huck, 02/28/01.      */
r_typedef
r_struct
(brace
DECL|member|data

...
multiline_comment|/* &n;&t; * for 64 bit we always support 64 bit IDAWs with 2k page&n;&t; *  size only&n;&t; * FIXTHEM: OSA microcode currently has problems with 4k&n;         *          we would like to use 4k.&n;&t; */
id|ioinfo
(braket
id|irq
)braket

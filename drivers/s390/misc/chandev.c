...
DECL|macro|CHANDEV_USE_KERNEL_THREADS
mdefine_line|#define CHANDEV_USE_KERNEL_THREADS (LINUX_VERSION_CODE&lt;KERNEL_VERSION(2,4,0))
macro_line|#if CHANDEV_USE_KERNEL_THREADS
r_static
r_void
id|chandev_start_msck_thread
c_func
(paren
r_void
op_star
...
suffix:semicolon
macro_line|#if LINUX_VERSION_CODE&lt;KERNEL_VERSION(2,3,0)
DECL|macro|chandev_daemonize
mdefine_line|#define chandev_daemonize(name,mask,use_init_fs) s390_daemonize(name,mask)
macro_line|#else
DECL|macro|chandev_daemonize
mdefine_line|#define chandev_daemonize(args...) s390_daemonize(args)
macro_line|#endif
DECL|typedef|chandev_task_retval
r_typedef
r_int
id|chandev_task_retval
suffix:semicolon
DECL|macro|chandev_task_return
mdefine_line|#define chandev_task_return(val) return(val)       
macro_line|#else
DECL|macro|chandev_daemonize
mdefine_line|#define chandev_daemonize(noargs...)
DECL|macro|chandev_task_retval
mdefine_line|#define chandev_task_retval void
DECL|macro|chandev_task_return
mdefine_line|#define chandev_task_return(val) return
macro_line|#endif
...
c_func
(paren
l_string|&quot;odd lock_cnt in lcs %d lcs_chan_lock&quot;
comma
id|chandev_lock_cnt
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;odd lock_cnt in lcs %d lcs_chan_unlock&quot;
comma
id|chandev_lock_cnt
)paren
suffix:semicolon
...
DECL|function|chandev_new_files_struct
r_struct
id|files_struct
op_star
id|chandev_new_files_struct
c_func
(paren
r_void
)paren
...
multiline_comment|/*&n; * Mostly robbed from kmod.c&n; */
r_static
r_inline
r_void
...
l_int|1
suffix:semicolon
multiline_comment|/* We copy this off init &amp; can&squot;t go until this is set up */
id|init_waitqueue_head
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* current-&gt;files sometimes was null this means we need */
multiline_comment|/* to build our own */
id|exit_files
c_func
(paren
id|current
...
c_func
(paren
l_string|&quot;chandev_new_files_struct allocation failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* Take all effective privileges.. */
id|current-&gt;uid
op_assign
id|current-&gt;euid
op_assign
...
suffix:semicolon
multiline_comment|/* Allow execve &amp; open args to be in kernel space. */
id|set_fs
c_func
(paren
id|KERNEL_DS
...
suffix:semicolon
multiline_comment|/* We need stdin out &amp; err for scripts */
r_if
c_cond
(paren
id|open
...
c_func
(paren
l_string|&quot;chandev exec_usermode_helper unable to open an initial console.&bslash;n&quot;
)paren
suffix:semicolon
(paren
r_void
...
DECL|function|exec_start_script
r_static
r_int
id|exec_start_script
c_func
(paren
r_void
op_star
...
c_func
(paren
l_string|&quot;exec_start_script failed retval=%d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We do CLONE_FILES so we can exit_files to get rid of it */
multiline_comment|/* cheaply &amp; allocate a new one we need current-&gt;files &amp;  */
multiline_comment|/* some tasks have current-&gt;files==NULL */
id|pid
op_assign
id|kernel_thread
c_func
...
c_func
(paren
l_string|&quot;error making kernel thread for exec_start_script&bslash;n&quot;
)paren
suffix:semicolon
id|retval
op_assign
...
id|new_not_oper
suffix:semicolon
id|chandev_daemonize
c_func
(paren
l_string|&quot;chandev_msck_kernel_thread&quot;
comma
l_int|0
comma
id|TRUE
...
macro_line|#if CHANDEV_USE_KERNEL_THREADS
DECL|function|chandev_start_msck_thread
r_static
r_void
id|chandev_start_msck_thread
c_func
...
(brace
multiline_comment|/* tq_scheduler sometimes leaves interrupts disabled from do bottom half */
id|__sti
c_func
(paren
)paren

...
mdefine_line|#define VERSION_QETH_C &quot;$Revision: 1.127 $&quot;
...
id|count
suffix:semicolon
multiline_comment|/* ok, since do_QDIO went wrong the buffers have not been given&n;&t;&t; * to the hardware. they still belong to us, so we can clear&n;&t;&t; * them and reuse then, i.e. set back next_buf_to_fill*/
r_for
c_loop
(paren
id|i

...
macro_line|#ifdef CONFIG_QETH_VLAN
multiline_comment|/* ATT: not a very readable order: bytes count from lower numbers, bits&n;   count from lsb */
r_static
r_void
DECL|function|qeth_layer2_set_bit
id|qeth_layer2_set_bit
c_func
(paren
id|__u8
op_star
...
r_static
r_int
DECL|function|qeth_layer2_get_bit
id|qeth_layer2_get_bit
c_func
(paren
id|__u8
op_star
...
r_static
r_void
DECL|function|qeth_layer2_takeover_vlans
id|qeth_layer2_takeover_vlans
c_func
(paren
r_struct
id|qeth_card
...
suffix:semicolon
multiline_comment|/* copy new to current */
id|memcpy
c_func
(paren
op_amp
id|card-&gt;vlans_current
(braket
l_int|0
)braket
comma
...
suffix:semicolon
multiline_comment|/* clear new vector */
id|memset
c_func
(paren
op_amp
...
r_static
r_void
DECL|function|qeth_layer2_register_vlans
id|qeth_layer2_register_vlans
c_func
(paren
r_struct
id|qeth_card

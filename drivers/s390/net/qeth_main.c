...
mdefine_line|#define VERSION_QETH_C &quot;$Revision: 1.89 $&quot;
...
suffix:semicolon
multiline_comment|/* do not give sizeof(struct qeth_arp_query_data) to next command;&n;&t; * this would cause the IPA PDU size to be set to a value of &gt; 256&n;&t; * and this is to much for HiperSockets */
id|iob
op_assign
id|qeth_get_ipa_arp_cmd_buffer
c_func

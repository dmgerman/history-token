...
mdefine_line|#define VERSION_QETH_C &quot;$Revision: 1.77 $&quot;
...
r_static
r_void
DECL|function|qeth_reinsert_todos
id|qeth_reinsert_todos
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_register_mc_addresses
id|qeth_register_mc_addresses
c_func
(paren
r_void
op_star
...
r_static
r_int
DECL|function|qeth_register_ip_address
id|qeth_register_ip_address
c_func
(paren
r_void
op_star
...
suffix:semicolon
id|card-&gt;options.enable_takeover
op_assign
l_int|1
suffix:semicolon
...
l_string|&quot;disabled the port. Setting state &quot;
l_string|&quot;of interface to DOWN.&bslash;n&quot;
comma
...
r_static
r_void
DECL|function|qeth_qdio_input_tasklet
id|qeth_qdio_input_tasklet
c_func
(paren
r_int
r_int
...
id|current_buf
op_assign
id|card-&gt;qdio.in_q-&gt;next_buf_to_process
suffix:semicolon
r_struct
id|qeth_qdio_buffer
op_star
...
suffix:semicolon
multiline_comment|/* give buffer back to hardware */
id|qeth_queue_input_buffer
c_func
(paren
id|card
...
multiline_comment|/* set index for next time the tasklet is scheduled */
id|card-&gt;qdio.in_q-&gt;next_buf_to_process
op_assign
id|current_buf
suffix:semicolon
...
id|count
suffix:semicolon
id|queue-&gt;card-&gt;perf_stats.outbound_cnt
op_increment
suffix:semicolon
macro_line|#endif
)brace
multiline_comment|/*&n; * switches between PACKING and non-PACKING state if needed.&n; * has to be called holding queue-&gt;lock&n; */
r_static
r_inline
r_void
DECL|function|qeth_switch_packing_state
id|qeth_switch_packing_state
c_func
(paren
r_struct
id|qeth_qdio_out_q
...
suffix:semicolon
singleline_comment|//if (!atomic_read(&amp;queue-&gt;set_pci_flags_count))
id|tasklet_schedule
c_func
(paren
op_amp
...
r_static
r_void
DECL|function|qeth_qdio_output_tasklet
id|qeth_qdio_output_tasklet
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* flush all PRIMED buffers */
id|index
op_assign
id|queue-&gt;next_buf_to_flush
suffix:semicolon
id|count
op_assign
l_int|0
...
id|index
suffix:semicolon
multiline_comment|/* flush a buffer with data, if no more PCIs are&n;&t; * outstanding */
r_if
c_cond
(paren
op_logical_neg
...
r_static
r_void
DECL|function|qeth_set_device_name
id|qeth_set_device_name
c_func
(paren
r_struct
id|qeth_card
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t; * dev_queue_xmit should ensure that we are called packet&n;&t; * after packet&n;&t; */
id|netif_stop_queue
c_func
(paren
id|dev
...
c_func
(paren
l_string|&quot;qeth_do_send_packet: error during &quot;
l_string|&quot;qeth_fill_buffer.&quot;
)paren
suffix:semicolon
id|card-&gt;stats.tx_dropped
op_increment
...
suffix:semicolon
multiline_comment|/* do we have empty buffers? */
id|rc
op_assign
(paren
id|atomic_read
...
id|qeth_cmd_buffer
op_star
DECL|function|qeth_get_ipa_arp_cmd_buffer
id|qeth_get_ipa_arp_cmd_buffer
c_func
(paren
r_struct
id|qeth_card
...
suffix:semicolon
multiline_comment|/* adjust sizes in IPA_PDU_HEADER */
id|s1
op_assign
(paren
id|u32
...
multiline_comment|/* get size of userspace mem area */
r_if
c_cond
(paren
id|copy_from_user
...
suffix:semicolon
multiline_comment|/* alloc mem area for the actual query */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;Error while querying ARP cache on %s: %s (0x%x)&bslash;n&quot;
comma
id|card-&gt;info.if_name
comma
id|qeth_arp_get_error_cause
...
c_func
(paren
l_string|&quot;Could not flush ARP cache on %s: %s (0x%x)&bslash;n&quot;
comma
id|card-&gt;info.if_name
comma
id|qeth_arp_get_error_cause
...
id|cmd-&gt;hdr.return_code
op_assign
id|cmd-&gt;data.setadapterparms.return_code
suffix:semicolon
r_return
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;Could not enable broadcasting &quot;
l_string|&quot;on %s: 0x%x&bslash;n&quot;
comma
id|card-&gt;info.if_name
comma

...
mdefine_line|#define VERSION_QETH_C &quot;$Revision: 1.107 $&quot;
...
suffix:semicolon
macro_line|#ifdef CONFIG_QETH_PERF_STATS
id|queue-&gt;card-&gt;perf_stats.outbound_do_qdio
op_increment
suffix:semicolon
macro_line|#endif
r_if

...
mdefine_line|#define VERSION_QETH_C &quot;$Revision: 1.206 $&quot;
...
(brace
multiline_comment|/* CHPP field bit 6 == 1 -&gt; single queue */
id|single_queue
op_assign
(paren
(paren
...
c_func
(paren
l_string|&quot;Priority Queueing not able &quot;
l_string|&quot;due to hardware limitations!&bslash;n&quot;
)paren
suffix:semicolon
...
r_static
r_void
DECL|function|qeth_create_qib_param_field_blkt
id|qeth_create_qib_param_field_blkt
c_func
(paren
r_struct
id|qeth_card
...
op_assign
id|card-&gt;info.blkt.inter_packet
suffix:semicolon
op_star
(paren
(paren
...
op_assign
id|card-&gt;info.blkt.inter_packet_jumbo
suffix:semicolon
)brace
r_static
r_void
...
id|i
suffix:semicolon
multiline_comment|/* give outbound qeth_qdio_buffers their qdio_buffers */
r_for
c_loop
(paren
id|j
...
multiline_comment|/*hard_header fake function; used in case fake_ll is set */
r_static
r_int
...
l_int|1
suffix:colon
multiline_comment|/* fallthrough for single-out-queue 1920-device */
r_default
suffix:colon
r_return
id|card-&gt;qdio.default_out_queue
...
r_inline
r_void
DECL|function|__qeth_fill_buffer_frag
id|__qeth_fill_buffer_frag
c_func
(paren
r_struct
id|sk_buff
...
id|nr_frags
suffix:semicolon
multiline_comment|/* start with last frag */
id|element
op_assign
op_star
id|next_element_to_fill
...
r_inline
r_void
DECL|function|__qeth_fill_buffer
id|__qeth_fill_buffer
c_func
(paren
r_struct
id|sk_buff
...
suffix:semicolon
multiline_comment|/* we did a step forward, so check buffer state&n;&t;&t;&t;&t; * again */
r_if
c_cond
(paren
id|atomic_read
...
r_else
(brace
multiline_comment|/* check if we have enough elements (including following&n;&t;&t;&t; * free buffers) to handle eddp context */
r_if
c_cond
(paren
id|qeth_eddp_check_buffers_for_context
...
c_func
(paren
l_string|&quot;eddp tx_dropped 1&bslash;n&quot;
)paren
suffix:semicolon
id|card-&gt;stats.tx_dropped
op_increment
...
c_func
(paren
l_string|&quot;eddp tx_dropped 2&bslash;n&quot;
)paren
suffix:semicolon
id|card-&gt;stats.tx_dropped
op_increment
...
multiline_comment|/*are we able to do TSO ? If so ,prepare and send it from here */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;could not create eddp context&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
op_increment
suffix:semicolon
multiline_comment|/* nr_frags + skb-&gt;data */
...
(brace
multiline_comment|/* drop creator&squot;s reference */
...
suffix:semicolon
multiline_comment|/* free skb; it&squot;s not referenced by a buffer */
r_if
c_cond
(paren
id|rc
...
r_static
r_int
DECL|function|qeth_layer2_send_setgroupmac_cb
id|qeth_layer2_send_setgroupmac_cb
c_func
(paren
r_struct
id|qeth_card
...
suffix:semicolon
multiline_comment|/* MAC already registered, needed in couple/uncouple case */
r_if
c_cond
(paren
id|cmd-&gt;hdr.return_code
...
c_func
(paren
l_string|&quot;Group MAC %02x:%02x:%02x:%02x:%02x:%02x &quot;
"&bslash;"
l_string|&quot;already existing on %s &bslash;n&quot;
comma
id|mac
(braket
l_int|0
...
r_static
r_int
DECL|function|qeth_layer2_send_setgroupmac
id|qeth_layer2_send_setgroupmac
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_delgroupmac_cb
id|qeth_layer2_send_delgroupmac_cb
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_delgroupmac
id|qeth_layer2_send_delgroupmac
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_setmac_cb
id|qeth_layer2_send_setmac_cb
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_setmac
id|qeth_layer2_send_setmac
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_delmac_cb
id|qeth_layer2_send_delmac_cb
c_func
(paren
r_struct
id|qeth_card
...
r_static
r_int
DECL|function|qeth_layer2_send_delmac
id|qeth_layer2_send_delmac
c_func
(paren
r_struct
id|qeth_card
...
c_func
(paren
l_string|&quot;Could not register IP address %s (rc=0x%x/%d)&bslash;n&quot;
comma
id|buf
comma
id|rc
...
r_static
id|u32
DECL|function|qeth_ethtool_get_tx_csum
id|qeth_ethtool_get_tx_csum
c_func
(paren
r_struct
id|net_device
...
(brace
multiline_comment|/* We may need to say that we support tx csum offload if&n;&t; * we do EDDP or TSO. There are discussions going on to&n;&t; * enforce rules in the stack and in ethtool that make&n;&t; * SG and TSO depend on HW_CSUM. At the moment there are&n;&t; * no such rules....&n;&t; * If we say yes here, we have to checksum outbound packets&n;&t; * any time. */
r_return
l_int|0
suffix:semicolon
)brace
r_static
r_int
DECL|function|qeth_ethtool_set_tx_csum
id|qeth_ethtool_set_tx_csum
c_func
(paren
r_struct
id|net_device
...
r_static
id|u32
DECL|function|qeth_ethtool_get_rx_csum
id|qeth_ethtool_get_rx_csum
c_func
(paren
r_struct
id|net_device
...
r_static
r_int
DECL|function|qeth_ethtool_set_rx_csum
id|qeth_ethtool_set_rx_csum
c_func
(paren
r_struct
id|net_device
...
r_static
id|u32
DECL|function|qeth_ethtool_get_sg
id|qeth_ethtool_get_sg
c_func
(paren
r_struct
id|net_device
...
r_static
r_int
DECL|function|qeth_ethtool_set_sg
id|qeth_ethtool_set_sg
c_func
(paren
r_struct
id|net_device
...
r_static
id|u32
DECL|function|qeth_ethtool_get_tso
id|qeth_ethtool_get_tso
c_func
(paren
r_struct
id|net_device
...
r_static
r_int
DECL|function|qeth_ethtool_set_tso
id|qeth_ethtool_set_tso
c_func
(paren
r_struct
id|net_device
...
DECL|variable|qeth_ethtool_ops
r_static
r_struct
id|ethtool_ops
id|qeth_ethtool_ops
...
multiline_comment|/*network device will be recovered*/
r_if
c_cond
(paren
id|card-&gt;dev
...
r_static
r_int
DECL|function|qeth_start_ipa_tso
id|qeth_start_ipa_tso
c_func
(paren
r_struct
id|qeth_card
...
c_func
(paren
l_string|&quot;Outbound TSO not supported on %s&bslash;n&quot;
comma
id|QETH_CARD_IFNAME
c_func
(paren
...
c_func
(paren
l_string|&quot;Could not start outbound TSO &quot;
l_string|&quot;assist on %s: rc=%i&bslash;n&quot;
comma
id|QETH_CARD_IFNAME
c_func
...
c_func
(paren
l_string|&quot;Outbound TSO enabled&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
r_int
DECL|function|qeth_set_large_send
id|qeth_set_large_send
c_func
(paren
r_struct
id|qeth_card
...
c_func
(paren
l_string|&quot;TSO not supported on %s. &quot;
l_string|&quot;large_send set to &squot;no&squot;.&bslash;n&quot;
comma
id|card-&gt;dev-&gt;name
)paren
suffix:semicolon
...
r_default
suffix:colon
multiline_comment|/* includes QETH_LARGE_SEND_NO */
id|card-&gt;dev-&gt;features
op_and_assign
op_complement
(paren

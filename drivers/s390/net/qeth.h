...
mdefine_line|#define VERSION_QETH_H &t;&t;&quot;$Revision: 1.135 $&quot;
...
suffix:semicolon
multiline_comment|/* eddp data */
DECL|member|large_send_bytes
r_int
r_int
id|large_send_bytes
suffix:semicolon
DECL|member|large_send_cnt
r_int
r_int
id|large_send_cnt
suffix:semicolon
DECL|member|sg_skbs_sent
r_int
r_int
id|sg_skbs_sent
suffix:semicolon
DECL|member|sg_frags_sent
r_int
r_int
id|sg_frags_sent
suffix:semicolon
...
id|inbound_checksum
suffix:semicolon
multiline_comment|/*TSO:__u16 seqno */
DECL|member|token
id|__u32
id|token
suffix:semicolon
multiline_comment|/*TSO: __u32 reserved */
DECL|member|length
id|__u16
id|length
suffix:semicolon
...
l_int|0x02
comma
DECL|enumerator|QETH_HEADER_TYPE_TSO
...
DECL|macro|QETH_HDR_EXT_UDP_TSO
mdefine_line|#define QETH_HDR_EXT_UDP_TSO          0x40 /*bit off for TCP*/
r_static
r_inline
r_int
...
suffix:semicolon
multiline_comment|/* possible types of qeth large_send support */
DECL|enum|qeth_large_send_types
r_enum
id|qeth_large_send_types
(brace
DECL|enumerator|QETH_LARGE_SEND_NO
id|QETH_LARGE_SEND_NO
comma
DECL|enumerator|QETH_LARGE_SEND_EDDP
id|QETH_LARGE_SEND_EDDP
comma
DECL|enumerator|QETH_LARGE_SEND_TSO
...
r_static
r_int
DECL|function|qeth_realloc_headroom
...
suffix:semicolon
multiline_comment|/*&n;         * sanity check, the Linux memory allocation scheme should&n;         * never present us cases like this one (the qdio header size plus&n;         * the first 40 bytes of the paket cross a 4k boundary)&n;         */
r_if
c_cond
(paren
(paren

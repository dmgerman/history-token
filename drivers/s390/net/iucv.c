multiline_comment|/* &n; * $Id: iucv.c,v 1.41 2004/08/11 14:54:14 geraldsc Exp $&n; *&n; * IUCV network driver&n; *&n; * Copyright (C) 2001 IBM Deutschland Entwicklung GmbH, IBM Corporation&n; * Author(s):&n; *    Original source:&n; *      Alan Altmark (Alan_Altmark@us.ibm.com)  Sept. 2000&n; *      Xenia Tkatschow (xenia@us.ibm.com)&n; *    2Gb awareness and general cleanup:&n; *      Fritz Elfert (elfert@de.ibm.com, felfert@millenux.com)&n; *&n; * Documentation used:&n; *    The original source&n; *    CP Programming Service, IBM document # SC24-5760&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * RELEASE-TAG: IUCV lowlevel driver $Revision: 1.41 $&n; *&n; */
"&f;"
...
id|max_connections
suffix:semicolon
multiline_comment|/**&n; * iucv_cpuid: contains the logical cpu number of the cpu which&n; * has declared the iucv buffer by issuing DECLARE_BUFFER.&n; * If no cpu has done the initialization iucv_cpuid contains -1.&n; */
DECL|variable|iucv_cpuid
r_static
r_int
id|iucv_cpuid
op_assign
...
multiline_comment|/**&n; * grab_param: - Get a parameter buffer from the pre-allocated pool.&n; *&n; * This function searches for an unused element in the pre-allocated pool&n; * of parameter buffers. If one is found, it marks it &quot;in use&quot; and returns&n; * a pointer to it. The calling function is responsible for releasing it&n; * when it has finished its usage.&n; *&n; * Returns: A pointer to iucv_param.&n; */
r_static
id|__inline__
id|iucv_param
op_star
...
multiline_comment|/**&n; * iucv_declare_buffer_cpuid&n; * Register at VM for subsequent IUCV operations. This is executed&n; * on the reserved CPU iucv_cpuid. Called from iucv_declare_buffer().&n; */
r_static
r_void
DECL|function|iucv_declare_buffer_cpuid
...
multiline_comment|/**&n; * iucv_retrieve_buffer_cpuid:&n; * Unregister IUCV usage at VM. This is always executed on the same&n; * cpu that registered the buffer to VM.&n; * Called from iucv_retrieve_buffer().&n; */
r_static
r_void
DECL|function|iucv_retrieve_buffer_cpuid
...
(brace
multiline_comment|/* Reserve any cpu for use by iucv. */
id|iucv_cpuid
op_assign
id|smp_get_cpu
c_func
...
r_void
DECL|function|iucv_setmask_cpuid

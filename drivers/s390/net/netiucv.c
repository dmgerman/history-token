...
comma
op_amp
id|dev_attr_connection_fsm_state
)paren
)paren
op_logical_or
(paren
...
comma
op_amp
id|dev_attr_max_tx_buffer_used
)paren
)paren
op_logical_or
(paren
...
comma
op_amp
id|dev_attr_tx_single_write_ops
)paren
)paren
op_logical_or
(paren
...
comma
op_amp
id|dev_attr_tx_multi_write_ops
)paren
)paren
op_logical_or
(paren

...
multiline_comment|/* Hm - move to iucv.c and export? - CH */
...
id|ret
suffix:semicolon
multiline_comment|/* Move the bus stuff to iucv.c? - CH */
id|ret
op_assign
id|bus_register
c_func
...
(paren
id|KERN_ERR
l_string|&quot;NETIUCV: failed to register bus.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ret
...
(paren
id|KERN_ERR
l_string|&quot;NETIUCV: failed to register iucv root.&bslash;n&quot;
)paren
suffix:semicolon
id|driver_unregister
c_func

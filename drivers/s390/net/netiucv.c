...
multiline_comment|/*&n; * XXX: Don&squot;t use sysfs unless you know WTF you are doing.&n; * This particular turd registers sysfs objects embedded into netiucv_priv&n; * which is kfreed without any regard to possible sysfs references.&n; * As the result, the wanker who&squot;d decided that sysfs exports were too hip and&n; * cute to resist had generated a set of user-exploitable holes in this driver.&n; */
r_static
r_int

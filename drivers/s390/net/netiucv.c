...
id|connections
suffix:semicolon
multiline_comment|/* Keep track of interfaces. */
DECL|variable|ifno
r_static
r_int
id|ifno
...
comma
DECL|enumerator|DEV_STATE_STARTRETRY
id|DEV_STATE_STARTRETRY
comma
...
id|arg
suffix:semicolon
singleline_comment|// struct iucv_connection *conn = ev-&gt;conn;
id|iucv_ConnectionPending
op_star
id|eib
op_assign

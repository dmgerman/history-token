...
DECL|function|ctc_tty_tiocmget
r_static
r_int
id|ctc_tty_tiocmget
c_func
...
r_static
r_int
DECL|function|ctc_tty_tiocmset
id|ctc_tty_tiocmset
c_func
(paren
r_struct
...
multiline_comment|/*&n;&t; *&t;If the name is a format string the caller wants us to&n;&t; *&t;do a name allocation : format string must end with %d&n;&t; */
r_if
c_cond
(paren
id|strchr
...
suffix:semicolon
singleline_comment|// dev-&gt;name is changed by this
r_if
c_cond
(paren
id|err
...
(paren
id|KERN_DEBUG
l_string|&quot;dev_alloc returned error %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon

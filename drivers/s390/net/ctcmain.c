...
DECL|macro|CTC_USE_IDALS
mdefine_line|#define CTC_USE_IDALS 1
macro_line|#if CTC_USE_IDALS
macro_line|#  include &lt;asm/idals.h&gt;
macro_line|#else
DECL|macro|set_normalized_cda
macro_line|#  define set_normalized_cda(ccw, addr) ((ccw)-&gt;cda = (addr))
...
id|tq
suffix:semicolon
multiline_comment|/**&n;&t; * RX/TX buffer for init sequence.&n;&t; */
DECL|member|dummy_buf
id|__u16
id|dummy_buf
suffix:semicolon
multiline_comment|/**&n;&t; * RX buffer size&n;&t; */
DECL|member|max_bufsize
r_int
id|max_bufsize
suffix:semicolon
multiline_comment|/**&n;&t; * Receive buffer.&n;&t; */
DECL|member|rx_skb
r_struct
id|sk_buff
op_star
...
id|collect_lock
suffix:semicolon
multiline_comment|/**&n;&t; * Pointer to dynamic allocated CCWs for TX&n;&t; */
DECL|member|dccw
id|ccw1_t
op_star
id|dccw
suffix:semicolon
multiline_comment|/**&n;&t; * Number of dynamic allocated CCWs needed for clearing IDALs.&n;&t; */
DECL|member|dccw_count
r_int
id|dccw_count
suffix:semicolon
...
id|skb-&gt;data
suffix:semicolon
multiline_comment|/**&n;&t;&t;&t; * Set truesize here to make the kernel&squot;s&n;&t;&t;&t; * socket layer happy. If this is not done,&n;&t;&t;&t; * the RX-routines of the socket code are dropping&n;&t;&t;&t; * most of the received packets, because they &quot;think&quot;&n;&t;&t;&t; * there isn&squot;t enough buffer space for the incoming&n;&t;&t;&t; * data.&n;&t;&t;&t; */
id|skb-&gt;truesize
op_assign
id|skb-&gt;len
suffix:semicolon
...
(brace
multiline_comment|/**&n;&t;&t;&t;&t; * Clone the skb only if there are still&n;&t;&t;&t;&t; * sub-packets.&n;&t;&t;&t;&t; */
r_struct
id|sk_buff
op_star
id|skb2
...
id|skb2-&gt;len
suffix:semicolon
multiline_comment|/**&n;&t;&t;&t;&t; * Advance pointers to next sub-packet.&n;&t;&t;&t;&t; */
id|skb_pull
c_func
(paren
id|skb
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unable to alloc dynamic ccws&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Couldn&squot;t alloc rx_skb in &quot;
l_string|&quot;ch_action_rx&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
multiline_comment|/* TODO: retry after bottom half */
r_return
suffix:semicolon
)brace
)brace
...
id|KERN_WARNING
l_string|&quot;%s: Couldn&squot;t alloc rx_skb in &quot;
l_string|&quot;ch_action_rxidle&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;ch_action_stopped: dccw !NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;ctc: add_channel: device %04x already in list&bslash;n&quot;
comma
(paren
op_star
id|c
...
id|p
comma
l_string|&quot;Max. chained CCWs: %ld&bslash;n&quot;
comma
id|privptr-&gt;channel
(braket
id|WRITE
...
suffix:semicolon
DECL|macro|alloc_param
mdefine_line|#define alloc_param() ((next_param&lt;parms_array+MAX_STATIC_DEVICES)?next_param++:NULL)
macro_line|#endif MODULE
...
(paren
id|KERN_INFO
l_string|&quot;%s: read: ch %04x (irq %04x), write: ch %04x (irq %04x) proto: %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|privptr-&gt;channel
...
(paren
id|KERN_EMERG
l_string|&quot;ctc: PANIC: channel list corrupted&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|c

multiline_comment|/*&n; *  drivers/s390/cio/css.c&n; *  driver for channel subsystem&n; *   $Revision: 1.65 $&n; *&n; *    Copyright (C) 2002 IBM Deutschland Entwicklung GmbH,&n; *&t;&t;&t; IBM Corporation&n; *    Author(s): Arnd Bergmann (arndb@de.ibm.com)&n; *&t;&t; Cornelia Huck (cohuck@de.ibm.com)&n; */
...
id|subchannel
op_star
DECL|function|__get_subchannel_by_stsch
id|__get_subchannel_by_stsch
c_func
(paren
r_int
id|irq
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Try to get subchannel from pmcw first. */
id|sch
op_assign
id|__get_subchannel_by_stsch
c_func
...
comma
op_amp
id|io_subchannel_driver.drv.devices
)paren
(brace
id|dev
op_assign

...
l_int|0xff
suffix:semicolon
multiline_comment|/* FIXME: this would be much nicer if it were table driven */
r_switch
c_cond
(paren
...
suffix:semicolon
multiline_comment|/*&n; * s390_register_subchannel&n; *&n; * initializes the struct device member of a subchannel and gives it to&n; * the device driver core&n; */
r_static
id|__devinit
r_void
DECL|function|s390_register_subchannel
id|s390_register_subchannel
(paren
r_struct
id|subchannel
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;failed to register subchannel %04x&bslash;n&quot;
comma
id|ioinfo-&gt;irq
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;probing %d subchannels...&bslash;n&quot;
comma
...
(paren
id|KERN_INFO
l_string|&quot;subchannel %04x: devno %04x, &quot;
comma
id|irq
comma
id|ioinfo
...
multiline_comment|/* console has already been probed */
id|s390_device_recognition_irq
(paren
id|irq
)paren
...
c_func
(paren
l_string|&quot;control unit type %04x&bslash;n&quot;
comma
id|ioinfo
(braket
id|irq
...
(brace
multiline_comment|/* SenseID may be called during console initialization,&n;&t; * before we have a working kmalloc, using a static&n;&t; * ccw area is the least evil workaround */
r_static
id|ccw1_t
id|sense_ccw
(braket
...
id|spinlock_t
id|sid_lock
multiline_comment|/* lock to protect sense_ccw */
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
id|senseid_t
...
l_string|&quot;CU  Type/Mod = %04X/%02X, Dev Type/Mod = %04X/%02X&bslash;n&quot;
comma
id|ioinfo
(braket
id|irq
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * If we are running under VM, try to obtain&n;&t;&t;&t;&t; * VM&squot;s PGID by SensePGID&n;&t;&t;&t;&t; */
op_star
(paren
r_int
op_star
...
comma
l_string|&quot;PathVerification(%04X) &quot;
l_string|&quot;- Device %04X is no longer there?!?&bslash;n&quot;
comma
id|irq
comma
id|ioinfo
...
comma
l_string|&quot;PathVerification(%04X) - &quot;
l_string|&quot;Unexpected error %d on device %04X&bslash;n&quot;
comma
id|irq
comma
id|ret
...
multiline_comment|/*&n; * Function: s390_send_nop&n; * &n; * sends a nop CCW to the specified subchannel down the given path(s)&n; */
r_int
...
l_int|0
suffix:semicolon
multiline_comment|/* static allocation is necessary because nop_ccw has to be below&n;&t; * the 2GB border. locking is not required since it nop_ccw is&n;&t; * never modified */
r_static
id|ccw1_t
id|nop_ccw
op_assign

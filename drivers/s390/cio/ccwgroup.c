...
id|found
suffix:semicolon
multiline_comment|/*&n;&t; * Find groupdevice cdev belongs to.&n;&t; * Unfortunately, we can&squot;t use bus_for_each_dev() because of the&n;&t; * semaphore (and return value of fn() is int).&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(paren
op_amp
id|ccwgroup_bus_type.subsys.rwsem
)paren
suffix:semicolon
id|list_for_each
c_func
...
comma
op_amp
id|ccwgroup_bus_type.devices.list
)paren
(brace
id|dev
op_assign

...
mdefine_line|#define VERSION_QDIO_C &quot;$Revision: 1.34 $&quot;
...
multiline_comment|/* &n; * unfortunately, we can&squot;t just xchg the values; in do_QDIO we want to reserve&n; * the q in any case, so that we&squot;ll not be interrupted when we are in&n; * qdio_mark_iq... shouldn&squot;t have a really bad impact, as reserving almost&n; * ever works (last famous words) &n; */
r_static
r_inline
r_int
...
suffix:semicolon
multiline_comment|/* &n;&t; * we don&squot;t issue this SYNC_MEMORY, as we trust Rick T and&n;&t; * moreover will not use the PROCESSING state, so q-&gt;polling was 0&n;&t; */
...
(brace
multiline_comment|/* &n;&t;&t; * for asynchronous queues, we better check, if the fill&n;&t;&t; * level is too high &n;&t;&t; */
r_if
c_cond
(paren
id|atomic_read
...
r_inline
r_int
DECL|function|iqdio_do_inbound_checks
id|iqdio_do_inbound_checks
c_func
(paren
r_struct
id|qdio_q
...
r_inline
r_void
DECL|function|qdio_cleanup_finish
id|qdio_cleanup_finish
c_func
(paren
r_struct
id|qdio_irq
...
r_static
r_void
DECL|function|qdio_cleanup_handle_timeout
id|qdio_cleanup_handle_timeout
c_func
(paren
r_struct
id|ccw_device
...
r_static
r_void
DECL|function|qdio_cleanup_handle_irq
id|qdio_cleanup_handle_irq
c_func
(paren
r_struct
id|ccw_device
...
c_func
(paren
l_string|&quot;Got unsolicited interrupt on cleanup &quot;
...
r_void
DECL|function|qdio_establish_handle_timeout
id|qdio_establish_handle_timeout
c_func
(paren
r_struct
id|ccw_device
...
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME:&n;&t; * this is broken,&n;&t; * we are in the context of a timer interrupt and&n;&t; * qdio_shutdown calls schedule&n;&t; */
id|qdio_shutdown
c_func
(paren
id|cdev
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * FIXME:&n;&t;&t; * this is broken,&n;&t;&t; * we are probably in the context of an i/o interrupt and&n;&t;&t; * qdio_shutdown calls schedule&n;&t;&t; */
id|qdio_shutdown
c_func
(paren
id|cdev
...
c_func
(paren
l_string|&quot;Got unsolicited interrupt on establish &quot;
l_string|&quot;queues (irq 0x%x).&bslash;n&quot;
comma
id|cdev
op_member_access_from_pointer
r_private
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * FIXME:&n;&t;&t;&t; * qdio_release_irq_memory does MOD_DEC_USE_COUNT&n;&t;&t;&t; * in an unbalanced fashion (see 30 lines farther down)&n;&t;&t;&t; */
id|qdio_release_irq_memory
c_func
(paren
id|irq_ptr
...
(brace
multiline_comment|/*&n;&t;&t; * FIXME:&n;&t;&t; * qdio_release_irq_memory does MOD_DEC_USE_COUNT&n;&t;&t; * in an unbalanced fashion (see 10 lines farther down)&n;&t;&t; */
id|qdio_release_irq_memory
c_func
(paren
id|irq_ptr
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * FIXME:&n;&t;&t;&t; * need some callback pointers to be set already,&n;&t;&t;&t; * i.e. irq_ptr-&gt;cleanup_irq and irq_ptr-&gt;cleanup_timeout?&n;&t;&t;&t; * (see 10 lines farther down)&n;&t;&t;&t; */
id|qdio_cleanup
c_func
(paren
id|init_data-&gt;cdev
...
multiline_comment|/* Set callback functions. */
id|irq_ptr-&gt;cleanup_irq
op_assign
id|qdio_cleanup_handle_irq
suffix:semicolon
id|irq_ptr-&gt;cleanup_timeout
op_assign
id|qdio_cleanup_handle_timeout
suffix:semicolon
id|irq_ptr-&gt;establish_irq
op_assign
id|qdio_establish_handle_irq
suffix:semicolon
id|irq_ptr-&gt;establish_timeout
op_assign
id|qdio_establish_handle_timeout
suffix:semicolon
id|irq_ptr-&gt;handler
...
(brace
multiline_comment|/* &n;&t;&t;&t; * that way we know, that, if we will get interrupted&n;&t;&t;&t; * by iqdio_inbound_processing, qdio_unmark_q will&n;&t;&t;&t; * not be called &n;&t;&t;&t; */
id|qdio_reserve_q
c_func
(paren
id|irq_ptr-&gt;input_qs
...
c_func
(paren
l_string|&quot;not enough memory for chsc area. Cannot &quot;
"&bslash;"

multiline_comment|/*&n; *  drivers/s390/cio/device.c&n; *  bus driver for ccw devices&n; *   $Revision: 1.124 $&n; *&n; *    Copyright (C) 2002 IBM Deutschland Entwicklung GmbH,&n; *&t;&t;&t; IBM Corporation&n; *    Author(s): Arnd Bergmann (arndb@de.ibm.com)&n; *&t;&t; Cornelia Huck (cohuck@de.ibm.com)&n; *&t;&t; Martin Schwidefsky (schwidefsky@de.ibm.com)&n; */
...
id|DEV_STATE_NOT_OPER
suffix:semicolon
multiline_comment|/*&n;&t; * Careful here. Our ccw device might be yet unregistered when&n;&t; * de-registering its subchannel (machine check during device&n;&t; * recognition). Better look if the subchannel has children.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

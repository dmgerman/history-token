multiline_comment|/*&n; *  drivers/s390/cio/device.c&n; *  bus driver for ccw devices&n; *   $Revision: 1.85 $&n; *&n; *    Copyright (C) 2002 IBM Deutschland Entwicklung GmbH,&n; *&t;&t;&t; IBM Corporation&n; *    Author(s): Arnd Bergmann (arndb@de.ibm.com)&n; *&t;&t; Cornelia Huck (cohuck@de.ibm.com)&n; *&t;&t; Martin Schwidefsky (schwidefsky@de.ibm.com)&n; */
...
id|sch
suffix:semicolon
multiline_comment|/* &n;&t;&t; * Forced offline in disconnected state means &n;&t;&t; * &squot;throw away device&squot;.&n;&t;&t; */
id|sch
op_assign
id|to_subchannel
c_func

multiline_comment|/*&n; *  drivers/s390/cio/device_ops.c&n; *&n; *   $Revision: 1.34 $&n; *&n; *    Copyright (C) 2002 IBM Deutschland Entwicklung GmbH,&n; *&t;&t;&t; IBM Corporation&n; *    Author(s): Martin Schwidefsky (schwidefsky@de.ibm.com)&n; */
...
suffix:semicolon
multiline_comment|/* FIXME: Check if we got sensible stuff. */
r_break
suffix:semicolon
)brace
)brace

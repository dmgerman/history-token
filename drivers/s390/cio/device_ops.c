multiline_comment|/*&n; *  drivers/s390/cio/device_ops.c&n; *&n; *   $Revision: 1.55 $&n; *&n; *    Copyright (C) 2002 IBM Deutschland Entwicklung GmbH,&n; *&t;&t;&t; IBM Corporation&n; *    Author(s): Martin Schwidefsky (schwidefsky@de.ibm.com)&n; *               Cornelia Huck (cohuck@de.ibm.com)&n; */
...
(brace
multiline_comment|/* Remember to fake irb when finished. */
r_if
c_cond
(paren
op_logical_neg
...
r_else
multiline_comment|/* There&squot;s already a fake I/O around. */
r_return
op_minus
id|EBUSY
suffix:semicolon

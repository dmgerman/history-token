...
multiline_comment|/*&n;&t;&t;&t; * check if chpid is in information updated by ssd&n;&t;&t;&t; */
r_if
c_cond
(paren
...
multiline_comment|/*&n;&t;&t; * Do a stsch to update our subchannel structure with the&n;&t;&t; * new path information and eventually check for logically&n;&t;&t; * offline chpids.&n;&t;&t; */
id|ccode
op_assign
id|stsch
c_func
...
(brace
singleline_comment|// FIXME:&t;&t;ccw_device_recognition(cdev);
id|spin_unlock_irq
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* We&squot;ve found it, get out of here. */
r_break
suffix:semicolon
)brace
)brace

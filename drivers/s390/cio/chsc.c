...
r_void
DECL|function|chpid_is_actually_online
...
suffix:semicolon
multiline_comment|/* Check for single path devices. */
r_if
c_cond
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * build the chsc request block for store event information&n;&t; * and do the call&n;&t; * This function is only called by the machine check handler thread,&n;&t; * so we don&squot;t need locking for the sei_page.&n;&t; */
id|sei_area
op_assign
id|sei_page
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* De-register is async anyway. */
)brace
multiline_comment|/*&n;&t; * Path has come. Allocate a new channel path structure,&n;&t; * if needed.&n;&t; */
r_if
c_cond
(paren
id|get_chp_status
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Give running I/O a grace period in which it&n;&t;&t;&t; * can successfully terminate, even using the&n;&t;&t;&t; * just varied off path. Then kill it.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;chpid %x is already offline&bslash;n&quot;
comma
id|chpid
)paren
suffix:semicolon
...
r_static
r_int
DECL|function|chsc_determine_channel_path_description
id|chsc_determine_channel_path_description
c_func
(paren
r_int
id|chpid
...
suffix:semicolon
id|scpd_area-&gt;first_chpid
op_assign
id|chpid
suffix:semicolon
id|scpd_area-&gt;last_chpid
op_assign
id|chpid
suffix:semicolon
id|ccode
...
l_int|0x0003
suffix:colon
multiline_comment|/* Invalid block. */
r_case
l_int|0x0007
suffix:colon
...
l_int|0x0008
suffix:colon
multiline_comment|/* Other invalid block. */
id|CIO_CRW_EVENT
c_func
(paren
l_int|2
...
l_int|0x0004
suffix:colon
multiline_comment|/* Command not provided in model. */
id|CIO_CRW_EVENT
c_func
(paren
l_int|2
comma
l_string|&quot;Model does not provide scpd&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
suffix:semicolon
multiline_comment|/* Obtain channel path description and fill it in. */
id|ret
op_assign
id|chsc_determine_channel_path_description
c_func
...
r_void
op_star
DECL|function|chsc_get_chp_desc
...
r_int
id|__init
DECL|function|chsc_alloc_sei_area
id|chsc_alloc_sei_area
c_func
(paren
r_void
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;Can&squot;t allocate page for processing of &quot;
"&bslash;"
l_string|&quot;chsc machine checks!&bslash;n&quot;
)paren
suffix:semicolon
r_return
(paren
...
DECL|variable|chsc_alloc_sei_area
id|subsys_initcall
c_func
(paren
id|chsc_alloc_sei_area
...
suffix:semicolon
DECL|variable|css_general_characteristics
r_struct
id|css_general_char
id|css_general_characteristics
suffix:semicolon
DECL|variable|css_chsc_characteristics
r_struct
id|css_chsc_char
...
r_int
id|__init
DECL|function|chsc_determine_css_characteristics
...
(paren
id|KERN_WARNING
l_string|&quot;cio: Was not able to determine available&quot;
"&bslash;"
...
(paren
id|KERN_WARNING
l_string|&quot;cio: Was not able to determine &quot;
"&bslash;"

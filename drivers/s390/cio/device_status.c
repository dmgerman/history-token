...
multiline_comment|/*&n; * Check if extended status word is valid.&n; */
r_static
r_inline
r_int
DECL|function|ccw_device_accumulate_esw_valid
id|ccw_device_accumulate_esw_valid
c_func
(paren
r_struct
id|irb
...
multiline_comment|/* Check if path verification is required. */
r_if
c_cond
(paren
id|ccw_device_accumulate_esw_valid

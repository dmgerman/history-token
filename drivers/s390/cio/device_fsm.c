...
r_int
DECL|function|device_is_online
id|device_is_online
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/* Deliver fake irb to device driver, if needed. */
r_if
c_cond
(paren
id|cdev
...
suffix:semicolon
multiline_comment|/*&n;&t; * Since we might not just be coming from an interrupt from the&n;&t; * subchannel we have to update the schib.&n;&t; */
id|stsch
c_func
(paren
id|sch-&gt;irq

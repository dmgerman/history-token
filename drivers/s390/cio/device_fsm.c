...
l_int|2
comma
l_string|&quot;SenseID : unknown device %s on subchannel %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
comma
id|sch-&gt;dev.bus_id
...
l_int|2
comma
l_string|&quot;SenseID : device %s reports: &quot;
...
l_int|2
comma
l_string|&quot;SenseID : boxed device %s on subchannel %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
comma
id|sch-&gt;dev.bus_id
...
l_int|2
comma
l_string|&quot;Boxed device %s on subchannel %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
comma
id|sch-&gt;dev.bus_id
...
r_static
r_void
DECL|function|ccw_device_disconnected_notoper
id|ccw_device_disconnected_notoper
c_func
(paren
r_struct
id|ccw_device

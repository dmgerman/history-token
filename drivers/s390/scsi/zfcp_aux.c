...
mdefine_line|#define ZFCP_AUX_REVISION &quot;$Revision: 1.65 $&quot;
...
id|NOTIFY_DONE
suffix:semicolon
multiline_comment|/* block access to config (for rest of lifetime of this Linux) */
id|down
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* initialise scsi faking structures */
id|rwlock_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* notification when there are no outstanding SCSI commands */
id|init_waitqueue_head
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;known=%d, reopen did 0x%x&bslash;n&quot;
comma
id|known
comma
id|fcp_rscn_element-&gt;nport_did
...
c_func
(paren
l_string|&quot;known %d, no_notifications %d&bslash;n&quot;
comma
id|known
comma
id|no_notifications
...
id|ZFCP_LOG_DEBUG
(paren
l_string|&quot;At least one unknown port changed state. &quot;
l_string|&quot;Unknown ports need to be reopened.&bslash;n&quot;
)paren
suffix:semicolon
id|reopen_unknown
op_assign
...
singleline_comment|// for (i=1; i &lt; no_entries; i++)
r_if
c_cond
(paren
id|reopen_unknown
...
c_func
(paren
l_string|&quot;At least one unknown did &quot;
l_string|&quot;underwent a state change.&bslash;n&quot;
)paren
suffix:semicolon
id|read_lock_irqsave
c_func

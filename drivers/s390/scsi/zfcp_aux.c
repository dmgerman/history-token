...
multiline_comment|/*&n; * function:    zfcp_cfdc_dev_ioctl&n; *&n; * purpose:     Handle control file upload/download transaction via IOCTL&n; *&t;&t;interface&n; *&n; * returns:     0           - Operation completed successfuly&n; *              -ENOTTY     - Unknown IOCTL command&n; *              -EINVAL     - Invalid sense data record&n; *              -ENXIO      - The FCP adapter is not available&n; *              -EOPNOTSUPP - The FCP adapter does not have CFDC support&n; *              -ENOMEM     - Insufficient memory&n; *              -EFAULT     - User space memory I/O operation fault&n; *              -EPERM      - Cannot create or queue FSF request or create SBALs&n; */
r_static
r_int
...
multiline_comment|/*&n; * function:    zfcp_sg_list_alloc&n; *&n; * purpose:     Create a scatter-gather list of the specified size&n; *&n; * returns:     0       - Scatter gather list is created&n; *              -ENOMEM - Insufficient memory (*list_ptr is then set to NULL)&n; */
r_static
r_inline
r_int
...
multiline_comment|/*&n; * function:    zfcp_sg_list_free&n; *&n; * purpose:     Destroy a scatter-gather list and release memory&n; *&n; * returns:     Always 0&n; */
r_static
r_inline
r_int
...
multiline_comment|/*&n; * function:    zfcp_sg_list_copy_from_user&n; *&n; * purpose:     Copy data from user space memory to the scatter-gather list&n; *&n; * returns:     0       - The data has been copied from user&n; *              -EFAULT - Memory I/O operation fault&n; */
r_static
r_inline
r_int
...
multiline_comment|/*&n; * function:    zfcp_sg_list_copy_to_user&n; *&n; * purpose:     Copy data from the scatter-gather list to user space memory&n; *&n; * returns:     0       - The data has been copied to user&n; *              -EFAULT - Memory I/O operation fault&n; */
r_static
r_inline
r_int

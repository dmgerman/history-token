...
mdefine_line|#define ZFCP_AUX_REVISION &quot;$Revision: 1.144 $&quot;
...
macro_line|#undef ZFCP_LOG_AREA
multiline_comment|/****************************************************************/
multiline_comment|/******* HBA API Support related Functions  *********************/
multiline_comment|/****************************************************************/
DECL|macro|ZFCP_LOG_AREA
mdefine_line|#define ZFCP_LOG_AREA                   ZFCP_LOG_AREA_FC
DECL|variable|zfcp_callbacks
r_struct
id|zfcp_callbacks
id|zfcp_callbacks
op_assign
...
suffix:semicolon
multiline_comment|/**&n; * zfcp_register_callbacks - register callbacks for event handling in HBA API&n; * @callbacks: set of callback functions to be registered&n; */
r_void
DECL|function|zfcp_register_callbacks
...
(brace
id|zfcp_callbacks.incoming_els
op_assign
id|callbacks-&gt;incoming_els
suffix:semicolon
id|zfcp_callbacks.link_down
op_assign
id|callbacks-&gt;link_down
suffix:semicolon
id|zfcp_callbacks.link_up
op_assign
id|callbacks-&gt;link_up
suffix:semicolon
id|zfcp_callbacks.adapter_add
op_assign
id|callbacks-&gt;adapter_add
suffix:semicolon
id|zfcp_callbacks.port_add
op_assign
id|callbacks-&gt;port_add
suffix:semicolon
id|zfcp_callbacks.unit_add
op_assign
id|callbacks-&gt;unit_add
suffix:semicolon
)brace
multiline_comment|/**&n; * zfcp_unregister_callbacks - deregister callbacks for event handling&n; */
r_void
DECL|function|zfcp_unregister_callbacks
...
l_int|NULL
suffix:semicolon
multiline_comment|/* wait until all callbacks returned */
id|wait_event
c_func
(paren
id|zfcp_callbacks.wq
...
multiline_comment|/**&n; * zfcp_cb_incoming_els - make callback for incoming els&n; * @adpater: adapter where ELS was received&n; * @payload: received ELS payload&n; */
r_void
DECL|function|zfcp_cb_incoming_els
id|zfcp_cb_incoming_els
c_func
(paren
r_struct
...
multiline_comment|/**&n; * zfcp_cb_link_down - make callback for link down event&n; * @adapter: adapter where link down occurred&n; */
r_void
DECL|function|zfcp_cb_link_down
...
multiline_comment|/**&n; * zfcp_cb_link_up - make callback for link up event&n; * @adapter: adapter where link up occurred&n; */
r_void
DECL|function|zfcp_cb_link_up
id|zfcp_cb_link_up
c_func
(paren
r_struct
...
multiline_comment|/**&n; * zfcp_cb_adapter_add - make callback for adapter add event&n; * @adapter: adapter which was added/activated&n; */
r_void
DECL|function|zfcp_cb_adapter_add
...
multiline_comment|/**&n; * zfcp_cb_port_add - make callback for port add event&n; * @port: port which was added&n; */
r_void
DECL|function|zfcp_cb_port_add
id|zfcp_cb_port_add
c_func
(paren
r_struct
...
multiline_comment|/**&n; * zfcp_cb_unit_add - make callback for unit add event&n; * @unit: unit which was added&n; */
r_void
DECL|function|zfcp_cb_unit_add
id|zfcp_cb_unit_add
c_func
(paren
r_struct
...
DECL|macro|ZFCP_LOG_AREA
macro_line|#undef ZFCP_LOG_AREA
DECL|variable|zfcp_sg_list_alloc
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_sg_list_alloc
...
suffix:semicolon
DECL|variable|zfcp_sg_list_free
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_sg_list_free
...
suffix:semicolon
DECL|variable|zfcp_sg_list_copy_from_user
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_sg_list_copy_from_user
...
suffix:semicolon
DECL|variable|zfcp_sg_list_copy_to_user
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_sg_list_copy_to_user
...
suffix:semicolon
DECL|variable|zfcp_get_unit_by_lun
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_get_unit_by_lun
...
suffix:semicolon
DECL|variable|zfcp_get_port_by_wwpn
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_get_port_by_wwpn
...
suffix:semicolon
DECL|variable|zfcp_get_port_by_did
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_get_port_by_did
...
suffix:semicolon
DECL|variable|zfcp_get_adapter_by_busid
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_get_adapter_by_busid
...
suffix:semicolon
DECL|variable|zfcp_register_callbacks
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_register_callbacks
...
suffix:semicolon
DECL|variable|zfcp_unregister_callbacks
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_unregister_callbacks
...
suffix:semicolon
DECL|variable|zfcp_port_enqueue
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_port_enqueue
...
suffix:semicolon
DECL|variable|zfcp_unit_enqueue
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_unit_enqueue
...
suffix:semicolon
DECL|variable|zfcp_unit_dequeue
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_unit_dequeue
...
suffix:semicolon
DECL|variable|zfcp_check_ct_response
id|EXPORT_SYMBOL
c_func
(paren
id|zfcp_check_ct_response

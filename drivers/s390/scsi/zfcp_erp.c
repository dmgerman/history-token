...
multiline_comment|/*&n;&t;&t;&t; * If fsf_req is neither dismissed nor completed&n;&t;&t;&t; * then keep it running asynchronously and don&squot;t mess with&n;&t;&t;&t; * the association of erp_action and fsf_req.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|fsf_req-&gt;status
...
(brace
multiline_comment|/* forget about association between fsf_req and erp_action */
...
l_int|NULL
suffix:semicolon
multiline_comment|/* some special things for time out conditions */
r_if
c_cond
(paren
id|erp_action
...
id|ZFCP_LOG_NORMAL
(paren
l_string|&quot;error: Error Recovery Procedure step timed out. &quot;
l_string|&quot;The action flag is 0x%x. The FSF request &quot;
...
suffix:semicolon
multiline_comment|/* fight for low memory buffer, if required */
r_if
c_cond
(paren
id|fsf_req
...
l_int|3
comma
l_string|&quot;a_ca_lowmem&quot;
)paren
suffix:semicolon
id|ZFCP_LOG_NORMAL
(paren
l_string|&quot;error: The error recovery action using the &quot;
l_string|&quot;low memory pool timed out. Restarting IO on &quot;
l_string|&quot;the adapter %s to free it.&bslash;n&quot;
comma
id|zfcp_get_busid_by_adapter
(paren
id|adapter
...
suffix:semicolon
multiline_comment|/* fall through, waiting for memory means action continues */
r_case
...
r_else
(brace
multiline_comment|/* ZFCP_ERP_FAILED or ZFCP_ERP_EXIT */
id|atomic_inc
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;port wwpn=0x%Lx is open &quot;
comma
id|port-&gt;wwpn
)paren
suffix:semicolon

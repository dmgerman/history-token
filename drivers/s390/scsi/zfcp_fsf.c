...
mdefine_line|#define ZFCP_FSF_C_REVISION &quot;$Revision: 1.45 $&quot;
...
c_func
(paren
l_string|&quot;FSF command 0x%x is not supported by FCP adapter &quot;
l_string|&quot;(adapter: %s)&bslash;n&quot;
comma
id|fsf_req-&gt;fsf_command
comma
...
c_func
(paren
l_string|&quot;FSF command 0x%x is not supported by the adapter %s&bslash;n&quot;
comma
id|fsf_req-&gt;fsf_command
comma
id|zfcp_get_busid_by_adapter

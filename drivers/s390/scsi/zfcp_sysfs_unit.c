...
mdefine_line|#define ZFCP_SYSFS_UNIT_C_REVISION &quot;$Revision: 1.25 $&quot;
...
suffix:semicolon
multiline_comment|/**&n; * zfcp_sysfs_unit_in_recovery_show - recovery state of unit&n; * @dev: pointer to belonging device&n; * @buf: pointer to input buffer&n; *&n; * Show function of &quot;in_recovery&quot; attribute of unit. Will be&n; * &quot;0&quot; if no error recovery is pending for unit, otherwise &quot;1&quot;.&n; */
r_static
id|ssize_t
DECL|function|zfcp_sysfs_unit_in_recovery_show
id|zfcp_sysfs_unit_in_recovery_show
c_func
(paren
r_struct
id|device

...
mdefine_line|#define ZFCP_SYSFS_ADAPTER_C_REVISION &quot;$Revision: 1.21 $&quot;
...
suffix:semicolon
multiline_comment|/**&n; * zfcp_sysfs_adapter_scsi_host_no_show - display scsi_host_no of adapter&n; * @dev: pointer to belonging device&n; * @buf: pointer to input buffer&n; *&n; * &quot;scsi_host_no&quot; attribute of adapter. Displays the SCSI host number.&n; */
r_static
id|ssize_t
DECL|function|zfcp_sysfs_adapter_scsi_host_no_show
id|zfcp_sysfs_adapter_scsi_host_no_show
c_func
(paren
r_struct
id|device
...
suffix:semicolon
multiline_comment|/* try to open port only if adapter is online */
r_if
c_cond
(paren

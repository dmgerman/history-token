...
mdefine_line|#define z90crypt_VARIANT 1
...
multiline_comment|/* DEPRECATED status call (bound for removal SOON) */
...
singleline_comment|// some unrecognized error occured
DECL|macro|EGETBUFF
mdefine_line|#define EGETBUFF  135&t;
singleline_comment|// Error getting buffer
...
id|cryptoDomain
suffix:semicolon
singleline_comment|// status: 0=not there. 1=PCICA. 2=PCICC. 3=PCIXCC
DECL|member|status
r_int
r_char
id|status
...
suffix:semicolon
macro_line|#endif /* _LINUX_Z90CRYPT_H_ */
eof

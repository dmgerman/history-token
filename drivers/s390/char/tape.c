...
id|tape-&gt;devinfo.devno
comma
id|tape-&gt;devinfo.sid_data.cu_type
comma
id|tape-&gt;devinfo.sid_data.cu_model
comma
id|tape-&gt;devinfo.sid_data.dev_type
comma
id|tape-&gt;devinfo.sid_data.dev_model
comma
(paren
(paren
id|tapestate_get
...
id|PRINT_WARN
(paren
l_string|&quot;oper handler was called&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
id|PRINT_WARN
(paren
l_string|&quot;No matching discipline for cu_type %x found&bslash;n&quot;
comma
id|dinfo.sid_data.cu_type
)paren
suffix:semicolon
...
id|PRINT_WARN
(paren
l_string|&quot;Register irq %d for using with discipline %x dev #%d&bslash;n&quot;
comma
id|irq
comma
...
id|PRINT_WARN
(paren
l_string|&quot;IBM S/390 Tape Device Driver (BETA).&bslash;n&quot;
)paren
suffix:semicolon
id|PRINT_WARN
(paren

...
suffix:semicolon
multiline_comment|/* Check for possible ESC sequence work to do */
r_if
c_cond
(paren
id|tubp-&gt;tty_escx
...
(brace
multiline_comment|/* If compiling new escape sequence */
r_if
c_cond
(paren
id|tubp-&gt;tty_esca
...
r_return
suffix:semicolon
multiline_comment|/* If esc seq needs refreshing after a write */
)brace
r_else
r_if
c_cond
...
(paren
id|KERN_WARNING
l_string|&quot;tty3270_update_log_area esca &quot;
l_string|&quot;character surprising:  %.2x&bslash;n&quot;
comma
id|tubp-&gt;tty_esca
(braket
l_int|0
...
(brace
multiline_comment|/* Check for room.  TAB could take up to 4 chars. */
r_if
c_cond
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Use blank if we don&squot;t know the character */
op_star
(paren
op_star
id|cpp
...
suffix:colon
multiline_comment|/* 0x0d -- Carriage Return */
id|tubp-&gt;tty_nextlogx
op_sub_assign
id|tubp-&gt;tty_nextlogx
op_mod
...
suffix:colon
multiline_comment|/* 0x0a -- New Line */
r_if
c_cond
(paren
id|tubp-&gt;tty_oucol
...
suffix:colon
multiline_comment|/* 0x09 -- Tabulate */
id|fill
op_assign
(paren
id|tubp-&gt;tty_nextlogx
...
suffix:colon
multiline_comment|/* 0x0c -- Form Feed */
id|tty3270_clear_log_area
c_func
(paren
id|tubp
...
id|cp
suffix:semicolon
multiline_comment|/* If starting a sequence, stuff ESC at [0] */
r_if
c_cond
(paren
id|tubp-&gt;tty_escx
...
l_int|0x1b
suffix:semicolon
multiline_comment|/* Now that sequence is started, see if room in buffer */
r_if
c_cond
(paren
op_amp
...
id|tubp-&gt;tty_escx
suffix:semicolon
multiline_comment|/* Gather the rest of the sequence&squot;s characters */
r_while
c_loop
(paren
id|tubp-&gt;tty_escx
...
id|error_return
suffix:semicolon
multiline_comment|/* Parse potentially empty string &quot;nn;nn;nn...&quot; */
id|i
op_assign
op_minus
l_int|1
...
suffix:semicolon
multiline_comment|/* Add 3270 data stream output to execute the sequence */
r_switch
c_cond
(paren
id|c
...
suffix:colon
multiline_comment|/* Define scroll area */
id|start
op_assign
id|quant
(braket
...
suffix:colon
multiline_comment|/* Erase for n chars from cursor */
id|start
op_assign
id|tubp-&gt;tty_nextlogx
suffix:semicolon
...
suffix:colon
multiline_comment|/* Erase to screen end from cursor */
op_star
(paren
op_star
id|cpp
...
r_static
r_void
DECL|function|tty3270_unnext_char
id|tty3270_unnext_char
c_func
(paren
id|tub_t
...
r_static
r_void
DECL|function|tty3270_set_bufadr
id|tty3270_set_bufadr
c_func
(paren
id|tub_t

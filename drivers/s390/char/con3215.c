multiline_comment|/*&n; *  drivers/s390/char/con3215.c&n; *    3215 line mode terminal driver.&n; *&n; *  S390 version&n; *    Copyright (C) 1999,2000 IBM Deutschland Entwicklung GmbH, IBM Corporation&n; *    Author(s): Martin Schwidefsky (schwidefsky@de.ibm.com),&n; *&n; *  Updated:&n; *   Aug-2000: Added tab support&n; *             Dan Morrison, IBM Corporation (dmorriso@cse.buffalo.edu)&n; */
...
mdefine_line|#define RAW3215_MAX_NEWLINE 50        /* max. lines to write with one ssch */
...
mdefine_line|#define TAB_STOP_SIZE&t;    8         /* tab stop size */
r_struct
id|_raw3215_info
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;         * now we have to count newlines. We can at max accept&n;         * RAW3215_MAX_NEWLINE newlines in a single ssch due to&n;         * a restriction in VM&n;         */
id|lines
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n;         * Add a NOP to the channel program. 3215 devices are purely&n;         * emulated and its much better to avoid the channel end&n;         * interrupt in this case.&n;         */
r_if
c_cond
(paren
id|ccw
...
multiline_comment|/*&n; */
DECL|function|raw3215_sched_tasklet
r_static
r_inline
r_void
id|raw3215_sched_tasklet
c_func
(paren
id|raw3215_info
op_star

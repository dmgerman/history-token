...
r_static
r_void
DECL|function|sclp_buffer_retry
id|sclp_buffer_retry
c_func
(paren
r_int
r_int
...
id|SCLP_REQ_FILLED
suffix:semicolon
id|buffer-&gt;sccb-&gt;header.response_code
op_assign
l_int|0x0000
suffix:semicolon
id|sclp_add_request
...
mdefine_line|#define SCLP_BUFFER_MAX_RETRY&t;&t;5
DECL|macro|SCLP_BUFFER_RETRY_INTERVAL
mdefine_line|#define&t;SCLP_BUFFER_RETRY_INTERVAL&t;2
...
multiline_comment|/* wait some time, then retry request */
id|buffer-&gt;retry_timer.function
op_assign
id|sclp_buffer_retry
suffix:semicolon
id|buffer-&gt;retry_timer.data
op_assign
(paren
r_int
r_int
...
id|buffer
suffix:semicolon
id|buffer-&gt;retry_timer.expires
op_assign
id|jiffies
op_plus
id|SCLP_BUFFER_RETRY_INTERVAL
op_star
id|HZ
suffix:semicolon
id|add_timer
...
l_string|&quot;sclp_writedata_callback: %s (response code=0x%x).&bslash;n&quot;
comma

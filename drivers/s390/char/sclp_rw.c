...
multiline_comment|/*&n; * Creates a new Message Text Object with enough room for str_len&n; * characters. This function will create a new sccb for buffering&n; * the mto if the current buffer sccb is full. A full buffer sccb&n; * is submitted for output.&n; * Returns a pointer to the start of the string in the mto.&n; */
r_static
r_int
DECL|function|sclp_create_mto
id|sclp_create_mto
c_func
(paren
r_struct
...
multiline_comment|/*&n; * Add the mto created with sclp_create_mto to the buffer sccb using&n; * the str_len parameter as the real length of the string.&n; */
r_static
r_void
DECL|function|sclp_add_mto
id|sclp_add_mto
c_func
(paren
r_struct
...
r_void
DECL|function|sclp_move_current_line
...
id|buffer-&gt;sccb
suffix:semicolon
multiline_comment|/* FIXME: proper error handling */
...
l_int|0x40F0
suffix:colon
multiline_comment|/* function code disabled in SCLP receive mask */
r_break
suffix:semicolon
r_default
suffix:colon
multiline_comment|/* sclp_free_sccb(sccb); */
id|printk
c_func
(paren
id|KERN_WARNING
id|SCLP_RW_PRINT_HEADER
l_string|&quot;write event data failed &quot;
l_string|&quot;(response code: 0x%x SCCB address %p).&bslash;n&quot;
comma
id|sccb-&gt;header.response_code
comma
id|sccb
...
multiline_comment|/*&n; * Setup the request structure in the struct sclp_buffer to do SCLP Write&n; * Event Data and pass the request to the core SCLP loop.&n; */
r_void

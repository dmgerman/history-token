...
mdefine_line|#define SCLP_VT220_DEVICE_NAME&t;&t;&quot;sclp_vt&quot;
...
op_logical_and
(paren
id|sclp_vt220_tty-&gt;ldisc.write_wakeup
op_ne
l_int|NULL
)paren
)paren
...
(paren
op_amp
id|sclp_vt220_tty-&gt;write_wait
)paren
suffix:semicolon
)brace
)brace
multiline_comment|/*&n; * Retry sclp write request after waiting some time for an sclp equipment&n; * check to pass.&n; */
r_static
r_void
DECL|function|sclp_vt220_retry
id|sclp_vt220_retry
c_func
(paren
r_int
...
id|vt220_request-&gt;retry_timer.function
op_assign
id|sclp_vt220_retry
suffix:semicolon
id|vt220_request-&gt;retry_timer.data
op_assign
(paren
r_int
r_int
...
id|vt220_request
suffix:semicolon
id|vt220_request-&gt;retry_timer.expires
op_assign
id|jiffies
op_plus
...
multiline_comment|/*&n; * Emit vt220 request buffer to SCLP.&n; */
r_static
r_void
...
multiline_comment|/*&n; * Queue and emit current request.&n; */
r_static
r_void
...
multiline_comment|/*&n; * Add msg to buffer associated with request. Return the number of characters&n; * added or -EFAULT on error.&n; */
r_static
r_int

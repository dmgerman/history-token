...
suffix:semicolon
multiline_comment|/*&n;&t; * No more requests may be processed. So just post them as i/o errors.&n;&t; */
id|spin_lock_irq
c_func
(paren
id|get_ccwdev_lock
...
c_func
(paren
l_string|&quot;(%s): Drive in use vanished - expect trouble!&bslash;n&quot;
comma
id|device-&gt;cdev-&gt;dev.bus_id
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;tape init: ($Revision: 1.48 $)&bslash;n&quot;
)paren
suffix:semicolon
id|tape_proc_init
c_func
...
l_string|&quot;tape device driver ($Revision: 1.48 $)&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

...
multiline_comment|/*&n; * Hutplug event support.&n; */
r_void
DECL|function|tape_hotplug_event
...
suffix:semicolon
multiline_comment|/* Call the busid DEVNO to be compatible with old tape.agent. */
id|sprintf
c_func
(paren
id|busid
...
l_int|3
comma
l_string|&quot;tape init: ($Revision: 1.41 $)&bslash;n&quot;
)paren
suffix:semicolon
id|tape_proc_init
c_func
...
l_string|&quot;tape device driver ($Revision: 1.41 $)&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

...
suffix:semicolon
DECL|variable|sclp_tty_termios
r_static
r_struct
id|termios
op_star
...
suffix:semicolon
DECL|variable|sclp_tty_termios_locked
r_static
r_struct
id|termios
op_star
id|sclp_tty_termios_locked
(braket
l_int|1
)braket
suffix:semicolon
...
op_logical_and
id|sclp_tty-&gt;ldisc.write_wakeup
)paren
(paren
id|sclp_tty-&gt;ldisc.write_wakeup
)paren
...
id|TTY_MAJOR
suffix:semicolon
id|sclp_tty_driver.minor_start
op_assign
l_int|64
suffix:semicolon
id|sclp_tty_driver.num
op_assign
l_int|1
suffix:semicolon
id|sclp_tty_driver.type
op_assign
id|TTY_DRIVER_TYPE_SYSTEM
suffix:semicolon
id|sclp_tty_driver.subtype
op_assign
id|SYSTEM_TYPE_TTY
suffix:semicolon
id|sclp_tty_driver.init_termios
op_assign
id|tty_std_termios
suffix:semicolon
id|sclp_tty_driver.init_termios.c_iflag
op_assign
id|IGNBRK
op_or
id|IGNPAR
suffix:semicolon
id|sclp_tty_driver.init_termios.c_oflag
op_assign
id|ONLCR
op_or
id|XTABS
suffix:semicolon
id|sclp_tty_driver.init_termios.c_lflag
op_assign
id|ISIG
op_or
id|ECHO
...
id|sclp_tty_table
suffix:semicolon
id|sclp_tty_driver.termios
op_assign
id|sclp_tty_termios
suffix:semicolon
id|sclp_tty_driver.termios_locked
op_assign
id|sclp_tty_termios_locked
suffix:semicolon
id|sclp_tty_driver.open
op_assign
id|sclp_tty_open
suffix:semicolon
id|sclp_tty_driver.close
op_assign
id|sclp_tty_close
suffix:semicolon
id|sclp_tty_driver.write
op_assign
id|sclp_tty_write
suffix:semicolon
id|sclp_tty_driver.put_char
op_assign
id|sclp_tty_put_char
suffix:semicolon
id|sclp_tty_driver.flush_chars
op_assign
id|sclp_tty_flush_chars
suffix:semicolon
id|sclp_tty_driver.write_room
op_assign
id|sclp_tty_write_room
suffix:semicolon
id|sclp_tty_driver.chars_in_buffer
op_assign
id|sclp_tty_chars_in_buffer
suffix:semicolon
id|sclp_tty_driver.flush_buffer
op_assign
id|sclp_tty_flush_buffer
suffix:semicolon
id|sclp_tty_driver.ioctl
op_assign
id|sclp_tty_ioctl
suffix:semicolon
multiline_comment|/*&n;&t; * No need for these function because they would be only called when&n;&t; * the line discipline is close to full. That means that there must be&n;&t; * collected nearly 4kB of input data. I suppose it is very difficult&n;&t; * for the operator to enter lines quickly enough to let overrun the&n;&t; * line discipline. Besides the n_tty line discipline does not try to&n;&t; * call such functions if the pointers are set to NULL. Finally I have&n;&t; * no idea what to do within these function. I can not prevent the&n;&t; * operator and the SCLP to deliver input. Because of the reasons&n;&t; * above it seems not worth to implement a buffer mechanism.&n;&t; */
id|sclp_tty_driver.throttle
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.unthrottle
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.send_xchar
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.set_termios
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.set_ldisc
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.stop
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.start
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.hangup
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.break_ctl
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.wait_until_sent
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.read_proc
op_assign
l_int|NULL
suffix:semicolon
id|sclp_tty_driver.write_proc
op_assign
l_int|NULL
suffix:semicolon
id|rc

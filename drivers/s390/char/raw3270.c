...
DECL|macro|RAW3270_FLAGS_SHUTDOWN
mdefine_line|#define RAW3270_FLAGS_SHUTDOWN&t;4&t;/* Device is in offline processing */
DECL|macro|RAW3270_FLAGS_CONSOLE
mdefine_line|#define RAW3270_FLAGS_CONSOLE&t;8&t;/* Device is the console. */
multiline_comment|/* Lock to protect global data of raw3270 (devices, views, etc). */
DECL|variable|raw3270_lock
r_static
id|spinlock_t
id|raw3270_lock
op_assign
...
multiline_comment|/* Hackish. A notifier chain would be cleaner. */
r_extern
r_void
id|tty3270_notifier
c_func

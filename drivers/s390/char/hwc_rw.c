multiline_comment|/*&n; *  drivers/s390/char/hwc_rw.c&n; *     driver: reading from and writing to system console on S/390 via HWC&n; *&n; *  S390 version&n; *    Copyright (C) 1999 IBM Deutschland Entwicklung GmbH, IBM Corporation&n; *    Author(s): Martin Peschke &lt;mpeschke@de.ibm.com&gt;&n; *&n; * &n; *&n; * &n; * &n; * &n; */
...
macro_line|#undef DUMP_HWC_INIT_ERROR
DECL|macro|DUMP_HWC_WRITE_ERROR
macro_line|#undef DUMP_HWC_WRITE_ERROR
DECL|macro|DUMP_HWC_WRITE_LIST_ERROR
macro_line|#undef DUMP_HWC_WRITE_LIST_ERROR
DECL|macro|DUMP_HWC_READ_ERROR
macro_line|#undef DUMP_HWC_READ_ERROR
...
DECL|macro|HWC_WTIMER_RUNS
mdefine_line|#define HWC_WTIMER_RUNS&t;1
DECL|macro|HWC_FLUSH
mdefine_line|#define HWC_FLUSH&t;&t;2
DECL|macro|HWC_INIT
mdefine_line|#define HWC_INIT&t;&t;4
DECL|macro|HWC_BROKEN
mdefine_line|#define HWC_BROKEN&t;&t;8
DECL|macro|HWC_INTERRUPT
mdefine_line|#define HWC_INTERRUPT&t;&t;16
DECL|macro|HWC_PTIMER_RUNS
mdefine_line|#define HWC_PTIMER_RUNS&t;32
r_static
r_struct
(brace
DECL|member|ioctls
...
r_int
r_int
DECL|function|hwc_ext_int_param
id|hwc_ext_int_param
(paren
r_void
)paren
(brace
...
l_string|&quot;found invalid HWCB at address 0x%lx. List corrupted. &quot;
...
(paren
op_amp
id|hwc_data.poll_timer
)paren
suffix:semicolon
id|hwc_data.poll_timer.function
op_assign
id|do_poll_hwc
suffix:semicolon
id|hwc_data.poll_timer.data
op_assign
(paren
r_int
r_int
...
l_int|NULL
suffix:semicolon
id|hwc_data.poll_timer.expires
op_assign
id|jiffies
op_plus
l_int|2
...
l_string|&quot;(expected: 0x%lx, got: 0x%lx).&bslash;n&quot;
comma
(paren
r_int
r_int
...
r_inline
r_int
DECL|function|eval_hwc_receive_mask
id|eval_hwc_receive_mask
(paren
id|_hwcb_mask_t
id|mask
)paren
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can write messages&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can not write messages&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
r_inline
r_int
DECL|function|eval_hwc_send_mask
id|eval_hwc_send_mask
(paren
id|_hwcb_mask_t
id|mask
)paren
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can read state change notifications&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|internal_print
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can not read state change notifications&bslash;n&quot;
)paren
suffix:semicolon
id|hwc_data.sig_quiesce
op_assign
(paren
(paren
id|mask
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can receive signal quiesce&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|internal_print
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can not receive signal quiesce&bslash;n&quot;
)paren
suffix:semicolon
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can read commands&bslash;n&quot;
)paren
suffix:semicolon
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can read priority commands&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;can not read commands from operator&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
r_static
r_int
DECL|function|eval_statechangebuf
id|eval_statechangebuf
(paren
id|statechangebuf_t
op_star
id|scbuf
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;HWC state change detected&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
(paren
id|scbuf-&gt;validity_hwc_active_facility_mask
)paren
(brace
)brace
r_if
c_cond
(paren
id|scbuf-&gt;validity_hwc_receive_mask
)paren
(brace
r_if
c_cond
...
id|__asm__
(paren
l_string|&quot;LHI 1,0xe50&bslash;n&bslash;t&quot;
l_string|&quot;LRA 2,0(%0)&bslash;n&bslash;t&quot;
l_string|&quot;J .+0 &bslash;n&bslash;t&quot;
suffix:colon
suffix:colon
...
c_cond
(paren
id|scbuf-&gt;validity_hwc_send_mask
)paren
(brace
r_if
c_cond
...
id|__asm__
(paren
l_string|&quot;LHI 1,0xe51&bslash;n&bslash;t&quot;
l_string|&quot;LRA 2,0(%0)&bslash;n&bslash;t&quot;
l_string|&quot;J .+0 &bslash;n&bslash;t&quot;
suffix:colon
suffix:colon
...
c_cond
(paren
id|scbuf-&gt;validity_read_data_function_mask
)paren
(brace
)brace
r_return
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;unconditional read: invalid function code&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;unconditional read: invalid selection mask&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;unconditional read: HWC equipment check&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|__asm__
(paren
l_string|&quot;LHI 1,0xe52&bslash;n&bslash;t&quot;
l_string|&quot;LRA 2,0(%0)&bslash;n&bslash;t&quot;
l_string|&quot;J .+0 &bslash;n&bslash;t&quot;
suffix:colon
suffix:colon
...
r_void
DECL|function|hwc_do_interrupt
id|hwc_do_interrupt
(paren
id|u32
id|ext_int_param
...
comma
id|HWC_RW_PRINT_HEADER
l_string|&quot;interrupt: mismatch: &quot;
l_string|&quot;ext. int param. (0x%x) vs. &quot;
l_string|&quot;current HWCB (0x%x)&bslash;n&quot;
comma
id|ext_int_param
comma
id|hwc_data.current_hwcb
...
r_void
DECL|function|hwc_interrupt_handler
id|hwc_interrupt_handler
(paren
r_struct
id|pt_regs
...
l_string|&quot; temporary breakdown&quot;
l_string|&quot; (ext. int. parameter=0x%x)&bslash;n&quot;
comma
id|ext_int_param
)paren
suffix:semicolon

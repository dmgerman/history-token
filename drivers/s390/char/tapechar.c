...
l_int|NULL
suffix:semicolon
id|tape-&gt;discipline-&gt;free_read_block
(paren
id|cqr
comma
id|tape
...
id|cqr
op_assign
id|tape-&gt;discipline-&gt;write_block
(paren
id|data
op_plus
id|i
...
l_int|NULL
suffix:semicolon
id|tape-&gt;discipline-&gt;free_write_block
(paren
id|cqr
comma
id|tape
...
id|cqr
op_assign
id|tape-&gt;discipline-&gt;mtsetdensity
(paren
id|tape
comma
id|mt_count
...
id|cqr
op_assign
id|tape-&gt;discipline-&gt;mtsetdrvbuffer
(paren
id|tape
comma
id|mt_count
...
id|cqr
op_assign
id|tape-&gt;discipline-&gt;mtcompression
(paren
id|tape
comma
id|mt_count
...
id|rc
op_assign
id|tape-&gt;discipline-&gt;discipline_ioctl_overload
(paren
id|inode
comma
id|filp

...
id|retry_timer
suffix:semicolon
multiline_comment|/* Timer for busy retries. */
DECL|variable|sclp_busy_timer
r_static
r_struct
id|timer_list
id|sclp_busy_timer
...
mdefine_line|#define SCLP_BUSY_POLL_INTERVAL&t;1
...
multiline_comment|/* Try to start requests from the request queue. */
r_while
c_loop
(paren
op_logical_neg
...
id|SCLP_REQ_RUNNING
suffix:semicolon
multiline_comment|/* Request active. Set running indication. */
id|set_bit
c_func
(paren
id|SCLP_RUNNING
...
(brace
multiline_comment|/**&n;&t;&t;&t; * SCLP is busy but no request is running.&n;&t;&t;&t; * Try again later.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|jiffies
op_plus
id|SCLP_BUSY_POLL_INTERVAL
op_star
id|HZ
)paren
)paren
(brace
id|sclp_busy_timer.function
op_assign
(paren
r_void
op_star

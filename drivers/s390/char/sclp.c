...
id|EBUSY
suffix:semicolon
multiline_comment|/* quick exit if queue is empty */
r_if
c_cond
(paren
id|list_empty
...
id|EINVAL
suffix:semicolon
multiline_comment|/* try to start the first request on the request queue. */
id|req
op_assign
id|list_entry
c_func
...
multiline_comment|/*&n; * Function to issue Read Event Data/Unconditional Read&n; */
r_static
r_void

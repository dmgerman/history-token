...
id|rc
suffix:semicolon
multiline_comment|/* Setup request queue and initialize gendisk for this device. */
id|tasklet_init
c_func
(paren
op_amp
...
l_int|6
comma
l_string|&quot;TBLOCK:open:  %x&bslash;n&quot;
comma
...
id|device
suffix:semicolon
multiline_comment|/* Remove all buffers at device close. */
multiline_comment|/* FIXME: can we do that a tape unload ? */

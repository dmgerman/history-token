...
suffix:semicolon
DECL|variable|dcssblk_devices_lock
r_static
id|rwlock_t
id|dcssblk_devices_lock
op_assign
id|RW_LOCK_UNLOCKED
suffix:semicolon
...
multiline_comment|/*&n; * get a minor number. needs to be called with&n; * write_lock(&amp;dcssblk_devices_lock) and the&n; * device needs to be enqueued before the lock is&n; * freed.&n; */
r_static
r_inline
r_int
...
multiline_comment|/*&n; * get the struct dcssblk_dev_info from dcssblk_devices&n; * for the given name.&n; * read_lock(&amp;dcssblk_devices_lock) must be held.&n; */
r_static
r_struct
id|dcssblk_dev_info
op_star
...
multiline_comment|/*&n; * register the device that represents a segment in sysfs,&n; * also add the attributes for the device&n; */
r_static
r_inline
r_int
DECL|function|dcssblk_register_segment_device
id|dcssblk_register_segment_device
c_func
(paren
r_struct
id|device
...
c_func
(paren
l_string|&quot;Segment %s already loaded in shared mode!&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Segment %s already loaded in exclusive mode!&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Segment %s not reloaded, rc=%d&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
comma
id|rc
...
c_func
(paren
l_string|&quot;Segment %s reloaded, shared mode.&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Segment %s reloaded, exclusive (read-write) mode.&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Could not get shared copy of segment %s&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Could not get exclusive copy of segment %s&bslash;n&quot;
comma
id|dev_info-&gt;segment_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Segment %s not loaded, rc=%d&bslash;n&quot;
comma
id|local_buf
comma
id|rc
...
c_func
(paren
l_string|&quot;Loaded segment %s from %p to %p, size = %lu Byte, &quot;
l_string|&quot;capacity = %lu sectors (512 Byte)&bslash;n&quot;
comma
id|local_buf
comma
(paren

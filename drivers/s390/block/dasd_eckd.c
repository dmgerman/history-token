...
DECL|macro|DASD_CDL
macro_line|#undef DASD_CDL 
singleline_comment|// Support compatible disk layout
...
id|cdl_msg
suffix:semicolon
macro_line|#ifdef DASD_CDL /* BAD HACK SO FIX ME UP */
r_int
id|i
suffix:semicolon
r_private
...
r_break
suffix:semicolon
macro_line|#ifdef DASD_CDL /* Format compatible disk Layout */
r_case
l_int|0x08
suffix:colon
r_case

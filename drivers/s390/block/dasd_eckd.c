...
l_int|0
suffix:semicolon
multiline_comment|/* get characteristis via diag to determine the kind of minidisk under VM */
multiline_comment|/* needed beacause XRC is not support by VM (jet)                         */
multiline_comment|/* Can be removed as soon as VM supports XRC                              */
singleline_comment|// TBD ??? HUM
)brace
r_static
id|dasd_ccw_req_t
op_star

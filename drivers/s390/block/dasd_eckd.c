multiline_comment|/* &n; * File...........: linux/drivers/s390/block/dasd_eckd.c&n; * Author(s)......: Holger Smolinski &lt;Holger.Smolinski@de.ibm.com&gt;&n; *&t;&t;    Horst Hummel &lt;Horst.Hummel@de.ibm.com&gt; &n; *&t;&t;    Carsten Otte &lt;Cotte@de.ibm.com&gt;&n; *&t;&t;    Martin Schwidefsky &lt;schwidefsky@de.ibm.com&gt;&n; * Bugreports.to..: &lt;Linux390@de.ibm.com&gt;&n; * (C) IBM Corporation, IBM Deutschland Entwicklung GmbH, 1999,2000&n; *&n; * $Revision: 1.69 $&n; */
...
r_static
r_int
DECL|function|dasd_eckd_read_conf
id|dasd_eckd_read_conf
c_func
(paren
r_struct
id|dasd_device
...
l_int|0
suffix:semicolon
multiline_comment|/* get configuration data per operational path */
r_for
c_loop
(paren
id|lpm
...
id|KERN_WARNING
comma
l_string|&quot;Read configuration data returned &quot;
l_string|&quot;error %d&quot;
comma
id|rc
)paren
...
l_string|&quot;%s&quot;
comma
l_string|&quot;No configuration &quot;
l_string|&quot;data retrieved&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
multiline_comment|/* save first valid configuration data */
r_if
c_cond
(paren
op_logical_neg

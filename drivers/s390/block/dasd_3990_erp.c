...
op_complement
(paren
id|erp-&gt;irb.esw.esw0.sublog.lpum
)paren
suffix:semicolon
r_else
id|erp-&gt;lpm
...
id|cpa
op_assign
id|default_erp-&gt;refers-&gt;irb.scsw.cpa
suffix:semicolon
r_if
c_cond
(paren
...
c_cond
(paren
id|cqr1-&gt;irb.scsw.cpa
op_ne
id|cqr2-&gt;irb.scsw.cpa
)paren
(brace
...
(paren
(paren
id|cqr-&gt;irb.scsw.cstat
op_eq
l_int|0x00
)paren
op_logical_and
(paren
id|cqr-&gt;irb.scsw.dstat
op_eq
(paren
id|DEV_STAT_CHN_END
op_or

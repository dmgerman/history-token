multiline_comment|/* &n; * File...........: linux/drivers/s390/block/dasd.c&n; * Author(s)......: Holger Smolinski &lt;Holger.Smolinski@de.ibm.com&gt;&n; *                  Horst Hummel &lt;Horst.Hummel@de.ibm.com&gt;  &n; *                  Carsten Otte &lt;Cotte@de.ibm.com&gt;&n; * Bugreports.to..: &lt;Linux390@de.ibm.com&gt;&n; * (C) IBM Corporation, IBM Deutschland Entwicklung GmbH, 1999,2000&n; *&n; * History of changes (starts July 2000)&n; * 11/09/00 complete redesign after code review&n; * 02/01/01 removed some warnings&n; * 02/01/01 added dynamic registration of ioctls&n; *          fixed bug in registration of new majors&n; *          fixed handling of request during dasd_end_request&n; *          fixed handling of plugged queues&n; *          fixed partition handling and HDIO_GETGEO&n; *          fixed traditional naming scheme for devices beyond 702&n; *          fixed some race conditions related to modules&n; *          added devfs suupport&n; * 03/06/01 refined dynamic attach/detach for leaving devices which are online.&n; * 06/09/01 refined dynamic modifiaction of devices&n; *          renewed debug feature exploitation&n; */
...
suffix:semicolon
DECL|variable|dasd_open_count_lock
r_static
id|spinlock_t
id|dasd_open_count_lock
suffix:semicolon
...
multiline_comment|/* Insert the new major info into dasd_major_info if needed */
r_if
c_cond
(paren
op_logical_neg
...
singleline_comment|//sense [27] = 0x00;
)brace
singleline_comment|// sense 24
singleline_comment|//                        {
singleline_comment|//                                char *sense = stat-&gt;ii.sense.data;
...
singleline_comment|//                        }
multiline_comment|/*&n;                memset(stat-&gt;ii.sense.data,0,32);&n;                stat-&gt;ii.sense.data[2] = 0x06;&n;                stat-&gt;ii.sense.data[4] = 0x04;&n;                stat-&gt;ii.sense.data[5] = 0x60;&n;                stat-&gt;ii.sense.data[6] = 0x41;&n;                stat-&gt;ii.sense.data[8] = 0xff;&n;                stat-&gt;ii.sense.data[9] = 0xff;&n;                stat-&gt;ii.sense.data[15] = 0x05;&n;                stat-&gt;ii.sense.data[16] = 0x21;&n;                stat-&gt;ii.sense.data[18] = 0x60;&n;                stat-&gt;ii.sense.data[19] = 0x3b;&n;                stat-&gt;ii.sense.data[20] = 0x24;&n;                stat-&gt;ii.sense.data[21] = 0x61;&n;                stat-&gt;ii.sense.data[22] = 0x65;&n;                stat-&gt;ii.sense.data[23] = 0x03;&n;                stat-&gt;ii.sense.data[24] = 0x04;&n;                stat-&gt;ii.sense.data[25] = 0x10;&n;                stat-&gt;ii.sense.data[26] = 0x4e;&n;*/
)brace
macro_line|#endif
...
id|KERN_WARNING
id|PRINTK_HEADER
l_string|&quot;default ERP postaction called for erp chain:&bslash;n&quot;
)paren
suffix:semicolon
(brace
id|ccw_req_t
...
id|KERN_INFO
id|PRINTK_HEADER
l_string|&quot;default_erp_postaction - left original request = %p &bslash;n&quot;
comma
id|cqr
)paren
suffix:semicolon
...
multiline_comment|/* check if at least one format cp was build in discipline */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* &n;         * re-analyse device&n;         */
id|dasd_set_device_level
(paren
id|device-&gt;devinfo.irq
comma
id|DASD_DEVICE_LEVEL_ONLINE
comma
id|device-&gt;discipline
comma
l_int|0
...
id|start_sect
suffix:semicolon
multiline_comment|/* This is a hack.  dasdfmt and ibm.c expect geo.start &n;&t;   to contain the block number of the label block when&n;&t;   it calls HDIO_GETGEO on the first partition. */
r_if
c_cond
(paren
id|geo-&gt;start
...
(brace
id|device-&gt;request_queue.plugged
op_assign
l_int|1
suffix:semicolon
multiline_comment|/* inhibit further calls of request_fn */
)brace
r_static
r_void
...
l_string|&quot;%s&quot;
comma
l_string|&quot;open device has gone. please repair!&quot;
)paren
suffix:semicolon
id|dasd_set_device_level
(paren
...
id|KERN_WARNING
id|PRINTK_HEADER
l_string|&quot;Oper handler called&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(brace
multiline_comment|/* e.g. when device has been detached before */
multiline_comment|/* search in device list */
id|list_for_each
c_func
(paren
id|l
...
id|KERN_WARNING
id|PRINTK_HEADER
l_string|&quot;/proc/dasd/devices: only &squot;set&squot; and &squot;add&squot; are supported verbs&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|KERN_INFO
id|PRINTK_HEADER
l_string|&quot;varying device range %04X-%04X&bslash;n&quot;
comma
id|rptr-&gt;from
comma
id|rptr-&gt;to
...
id|dasd_init
comma
l_string|&quot;1st step in initialization irq 0x%x&quot;
comma
id|irq
)paren
suffix:semicolon
...
id|dasd_init
comma
l_string|&quot;2nd step in initialization irq 0x%x&quot;
comma
id|irq
)paren
suffix:semicolon

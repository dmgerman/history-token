...
id|minor
suffix:semicolon
multiline_comment|/* Increase reference count of bdev. */
r_if
c_cond
(paren
id|bdget
...
id|DASD_STATE_NEW
suffix:semicolon
multiline_comment|/* Decrease reference count of bdev. */
id|bdev
op_assign
id|bdget
c_func
...
suffix:semicolon
singleline_comment|// FIXME: get rid of devmap.
id|devno
op_assign
...
(brace
multiline_comment|/* =&gt; device was in dasd parameter line */
...
l_int|0
suffix:semicolon
multiline_comment|/* device is still disabled -&gt; ignore it */
r_if
c_cond
(paren
id|IS_ERR
...
(paren
id|KERN_WARNING
l_string|&quot;dasd_generic could not get %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
)paren
suffix:semicolon
...
multiline_comment|/* ignore partial write */
r_return
l_int|0
suffix:semicolon
id|devmap

...
singleline_comment|// FIXME: if called from dasd_devices_write discpline is not set -&gt; oops.
r_void
...
id|DBF_NOTICE
comma
l_string|&quot;State change Interrupt for bus_id %s&quot;
comma
...
id|DBF_DEBUG
comma
l_string|&quot;Interrupt: stat %02x, bus_id %s&quot;
comma
id|irb-&gt;scsw.dstat
comma
id|cdev-&gt;dev.bus_id
...
id|device
op_assign
id|inp-&gt;i_bdev-&gt;bd_disk-&gt;private_data
suffix:semicolon
r_if
c_cond
(paren
...
id|DEVICE_NAME_SIZE
comma
l_string|&quot;Direct Access Storage Device&quot;
)paren
suffix:semicolon
id|devno
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;dasd_generic_probe: cannot autodetect %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;device %s is not diag (%d)&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
comma
id|rc
...
(paren
id|KERN_WARNING
l_string|&quot;dasd_generic found a bad device %s&bslash;n&quot;
comma
id|cdev-&gt;dev.bus_id
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Automatically online either all dasd devices (dasd_autodetect) or&n; * all devices specified with dasd= parameters. For dasd_autodetect&n; * dasd_generic_probe has added devmaps for all dasd devices. We&n; * scan all present dasd devmaps and call ccw_device_set_online.&n; */
r_void
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* this file shows the same information as /proc/dasd/devices using&n; * an inaccaptable interface */
multiline_comment|/* TODO: Split this up into smaller files! */
r_static
id|ssize_t
...
c_cond
(paren
multiline_comment|/* (ret = device_create_file(&amp;cdev-&gt;dev, &amp;dev_attr_dasd)) || */
(paren
id|ret
op_assign
...
suffix:semicolon
multiline_comment|/* device_remove_file(&amp;cdev-&gt;dev, &amp;dev_attr_dasd); */
)brace
r_return
id|ret
suffix:semicolon

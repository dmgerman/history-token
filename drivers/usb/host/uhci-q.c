...
multiline_comment|/* Process events in the schedule, but only in one thread at a time */
DECL|function|uhci_scan_schedule
r_static
r_void
id|uhci_scan_schedule
c_func
(paren
r_struct
id|uhci_hcd
...
id|tmp
suffix:semicolon
multiline_comment|/* Don&squot;t allow re-entrant calls */
r_if
c_cond
(paren
id|uhci-&gt;scan_in_progress
)paren
(brace
id|uhci-&gt;need_rescan
op_assign
...
suffix:semicolon
multiline_comment|/* If the controller is stopped, we can finish these off right now */
r_if
c_cond
(paren
id|uhci-&gt;is_stopped

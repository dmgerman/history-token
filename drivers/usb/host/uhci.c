...
multiline_comment|/*&n; * MUST be called with urb-&gt;lock acquired&n; */
...
multiline_comment|/*&n; * MUST be called with uhci-&gt;urb_list_lock acquired&n; */
...
multiline_comment|/* Remove it from uhci-&gt;urb_list */
id|list_del_init
c_func
(paren
op_amp

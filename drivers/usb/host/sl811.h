...
suffix:semicolon
DECL|struct|sl811h_req
r_struct
id|sl811h_req
(brace
multiline_comment|/* FIXME usbcore should maintain endpoints&squot; urb queues&n;&t; * directly in &squot;struct usb_host_endpoint&squot;&n;&t; */
DECL|member|urb
r_struct
id|urb
op_star

...
singleline_comment|// device drivers will soon be doing something like this
r_if
c_cond
(paren
id|resubmit
...
id|err
(paren
l_string|&quot;can&squot;t resubmit interrupt urb %p: status %d&quot;
comma
id|resubmit
comma
id|status
...
multiline_comment|/* unlink the rest?  once we start unlinking, after&n;&t;&t;&t; * a fault or explicit unlink, we unlink all later&n;&t;&t;&t; * urbs.  usb spec requires that for faults...&n;&t;&t;&t; */
r_if
c_cond
(paren
id|unlink
...
suffix:semicolon
multiline_comment|/* append to tds already queued to this qh? */
r_if
c_cond
(paren
id|unlikely
...
multiline_comment|/* Adjust any old copies in qh overlay too.&n;&t;&t;&t; * Interrupt code must cope with case of HC having it&n;&t;&t;&t; * cached, and clobbering these updates.&n;&t;&t;&t; * ... complicates getting rid of extra interrupts!&n;&t;&t;&t; * (Or:  use dummy td, so cache always stays valid.)&n;&t;&t;&t; */
r_if
c_cond
(paren
id|qh-&gt;hw_current
...
suffix:semicolon
macro_line|#if 0
singleline_comment|// one VT8235 system wants to die with STS_FATAL
singleline_comment|// unless this qh is leaked here. others seem ok...
id|qh
op_assign
id|qh_get
(paren
...
multiline_comment|/* unlink idle entries, reducing HC PCI usage as&n;&t;&t;&t; * well as HCD schedule-scanning costs.  removing&n;&t;&t;&t; * the last qh is deferred, since it&squot;s costly.&n;&t;&t;&t; *&n;&t;&t;&t; * FIXME don&squot;t unlink idle entries so quickly; it&n;&t;&t;&t; * can penalize (common) half duplex protocols.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|list_empty

...
(brace
multiline_comment|/* &quot;never happens&quot;: drivers do stall cleanup right */
r_if
c_cond
(paren
id|qh-&gt;qh_state
...
id|ehci
comma
l_string|&quot;clear toggle dev%d &quot;
l_string|&quot;ep%d%s: not idle&bslash;n&quot;
comma
id|usb_pipedevice
(paren
id|urb-&gt;pipe
...
suffix:semicolon
multiline_comment|/* else we know this overlay write is safe */
id|clear_toggle
(paren
id|urb-&gt;dev
comma
...
multiline_comment|/* just one way to queue requests: swap with the dummy qtd.&n;&t;&t; * only hc or qh_completions() usually modify the overlay.&n;&t;&t; */
r_if
c_cond
(paren
id|likely

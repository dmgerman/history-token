...
suffix:semicolon
multiline_comment|/* control qh may need patching after enumeration */
r_if
c_cond
(paren
id|unlikely
...
(brace
multiline_comment|/* set_address changes the address */
r_if
c_cond
(paren
id|le32_to_cpu
...
suffix:semicolon
multiline_comment|/* for full speed, ep0 maxpacket can grow */
r_else
r_if
c_cond
(paren
...
id|max
op_assign
id|urb-&gt;dev-&gt;descriptor.bMaxPacketSize0
suffix:semicolon
r_if
c_cond
(paren

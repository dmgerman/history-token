...
multiline_comment|/* UHCI controllers don&squot;t automatically stop resume signalling after 20 msec,&n; * so we have to poll and check timeouts in order to take care of it.&n; */
...
DECL|function|uhci_check_ports
r_static
r_void
id|uhci_check_ports
c_func
...
suffix:semicolon
multiline_comment|/* If the port was enabled before, turning&n;&t;&t;&t;&t; * reset on caused a port enable change.&n;&t;&t;&t;&t; * Turning reset off causes a port connect&n;&t;&t;&t;&t; * status change.  Clear these changes. */
id|CLR_RH_PORTSTAT
c_func
(paren
id|USBPORTSC_CSC
...
suffix:semicolon
multiline_comment|/* USB v2.0 7.1.7.5 */
id|uhci-&gt;ports_timeout
op_assign
id|jiffies
op_plus
...
suffix:semicolon
r_else
multiline_comment|/* USB v2.0 7.1.7.7 */
id|uhci-&gt;ports_timeout
op_assign
id|jiffies
op_plus

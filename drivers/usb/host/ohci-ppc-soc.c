...
(paren
id|__FILE__
l_string|&quot;: request_irq failed, returned %d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s (PPC-SOC) at 0x%p, irq %d&bslash;n&quot;
comma
id|hcd_name
comma
id|hcd-&gt;regs
...
(paren
id|__FILE__
l_string|&quot;: remove: %s, state %x&bslash;n&quot;
comma
id|hcd-&gt;self.bus_name
comma
id|hcd-&gt;state
...
c_func
(paren
l_string|&quot;%s: roothub graceful disconnect&bslash;n&quot;
comma
id|hcd-&gt;self.bus_name
)paren
suffix:semicolon

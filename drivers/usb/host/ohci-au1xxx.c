...
multiline_comment|/*-------------------------------------------------------------------------*/
DECL|function|usb_hcd_au1xxx_hcim_irq
r_static
id|irqreturn_t
id|usb_hcd_au1xxx_hcim_irq
(paren
r_int
id|irq
comma
...
id|pr_debug
(paren
l_string|&quot;usb_create_hcd failed&quot;
)paren
suffix:semicolon
id|retval
op_assign
...
id|pr_debug
(paren
l_string|&quot;%s (Au1xxx) at 0x%p, irq %d&quot;
comma
id|hcd-&gt;driver-&gt;description
comma
id|hcd-&gt;regs
...
c_func
(paren
l_string|&quot;bad driver-&gt;start&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|retval

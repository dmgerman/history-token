...
multiline_comment|/* put TDI/ARC silicon into EHCI mode */
DECL|function|tdi_reset
r_static
r_void
id|tdi_reset
(paren
...
id|pdev-&gt;device
op_eq
id|PCI_DEVICE_ID_TDI_EHCI
)paren
(brace
id|ehci-&gt;is_tdi_rh_tt
op_assign
l_int|1
suffix:semicolon
id|tdi_reset
...
(brace
multiline_comment|/* bogus &quot;fatal&quot; IRQs appear on some chips... why?  */
id|status
op_assign
id|readl
(paren
...
suffix:semicolon
multiline_comment|/* generic layer kills/unlinks all urbs, then&n;&t;&t;&t; * uses ehci_stop to clean up the rest&n;&t;&t;&t; */
id|bh
op_assign
l_int|1
suffix:semicolon

...
l_int|0
suffix:semicolon
multiline_comment|/* unlink urbs as requested, but rescan the list after&n;&t;&t; * we call a completion since it might have unlinked&n;&t;&t; * another (earlier) urb&n;&t;&t; *&n;&t;&t; * FIXME use td_list to scan, not td hashtables.&n;&t;&t; */
id|rescan_this
suffix:colon
id|completed
op_assign

...
id|flags
suffix:semicolon
singleline_comment|// FIXME going away along with the rest of interrrupt automagic...
...
suffix:semicolon
multiline_comment|/* we care about rm_list when setting CLE/BLE in case the HC was at&n;&t; * work on some TD when CLE/BLE was turned off, and isn&squot;t quiesced&n;&t; * yet.  finish_unlinks() restarts as needed, some upcoming INTR_SF.&n;&t; */
r_switch
c_cond
(paren
id|ed-&gt;type
...
multiline_comment|/* FIXME Except for a couple of exceptionally clean unlink cases&n;&t; * (like unlinking the only c/b ED, with no TDs) HCs may still be&n;&t; * caching this (till SOF).&n;&t; *&n;&t; * To avoid racing with the hardware, this needs to use ED_UNLINK&n;&t; * and delay til next INTR_SF.  Merge with start_urb_unlink().&n;&t; */
id|ed-&gt;state
op_assign
id|ED_IDLE
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* unlink urbs as requested, but rescan the list after&n;&t;&t; * we call a completion since it might have unlinked&n;&t;&t; * another (earlier) urb&n;&t;&t; *&n;&t;&t; * FIXME use td_list to scan, not ed hashtables.&n;&t;&t; * completely abolish ed hashtables!&n;&t;&t; */
id|rescan_this
suffix:colon
id|completed
op_assign

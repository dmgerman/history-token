multiline_comment|/*&n; * Copyright (c) 2001-2004 by David Brownell&n; * Copyright (c) 2003 Michal Sojka, for high-speed iso transfers&n; * &n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2 of the License, or (at your&n; * option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful, but&n; * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY&n; * or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License&n; * for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software Foundation,&n; * Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; */
...
r_return
suffix:semicolon
multiline_comment|/* update shadow and hardware lists ... the old &quot;next&quot; pointers&n;&t; * from ptr may still be in use, the caller updates them.&n;&t; */
op_star
id|prev_p
op_assign
op_star
...
id|ehci
comma
l_string|&quot;uframe %d sched overrun: %d usecs&bslash;n&quot;
comma
id|frame
op_star
l_int|8
...
multiline_comment|/*-------------------------------------------------------------------------*/
multiline_comment|/* periodic schedule slots have iso tds (normal or split) first, then a&n; * sparse tree for active interrupt transfers.&n; *&n; * this just links in a qh; caller guarantees uframe masks are set right.&n; * no FSTN support (yet; ehci 0.96+)&n; */
DECL|function|qh_link_periodic
r_static
r_int
id|qh_link_periodic
(paren
...
id|qh-&gt;dev-&gt;dev
comma
l_string|&quot;link qh%d-%04x/%p start %d [%d/%d us]&bslash;n&quot;
comma
id|period
comma
id|le32_to_cpup
...
suffix:semicolon
multiline_comment|/* high bandwidth, or otherwise every microframe */
r_if
c_cond
(paren
id|period
...
l_int|0
suffix:semicolon
multiline_comment|/* skip the iso nodes at list head */
r_while
c_loop
(paren
id|here.ptr
...
multiline_comment|/* sorting each branch by period (slow--&gt;fast)&n;&t;&t; * enables sharing interior tree nodes&n;&t;&t; */
r_while
c_loop
(paren
id|here.ptr
...
multiline_comment|/* link in this qh, unless some earlier pass did that */
r_if
c_cond
(paren
id|qh
...
DECL|function|qh_unlink_periodic
r_static
r_void
id|qh_unlink_periodic
(paren
r_struct
id|ehci_hcd
op_star
...
singleline_comment|// IF this isn&squot;t high speed
singleline_comment|//   and this qh is active in the current uframe
singleline_comment|//   (and overlay token SplitXstate is false?)
singleline_comment|// THEN
singleline_comment|//   qh-&gt;hw_info1 |= __constant_cpu_to_le32 (1 &lt;&lt; 7 /* &quot;ignore&quot; */);
multiline_comment|/* high bandwidth, or otherwise part of every microframe */
r_if
c_cond
(paren
(paren
...
id|qh-&gt;dev-&gt;dev
comma
l_string|&quot;unlink qh%d-%04x/%p start %d [%d/%d us]&bslash;n&quot;
comma
id|qh-&gt;period
comma
id|le32_to_cpup
...
suffix:semicolon
multiline_comment|/* qh-&gt;qh_next still &quot;live&quot; to HC */
id|qh-&gt;qh_state
op_assign
id|QH_STATE_UNLINK
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* simple/paranoid:  always delay, expecting the HC needs to read&n;&t; * qh-&gt;hw_next or finish a writeback after SPLIT/CSPLIT ... and&n;&t; * expect khubd to clean up after any CSPLITs we won&squot;t issue.&n;&t; * active high speed queues may need bigger delays...&n;&t; */
r_if
c_cond
(paren
id|list_empty
...
l_int|55
suffix:semicolon
multiline_comment|/* worst case: 3 * 1024 */
id|udelay
(paren
id|wait
)paren
...
id|usecs
suffix:semicolon
multiline_comment|/* we &quot;know&quot; 2 and 4 uframe intervals were rejected; so&n;&t; * for period 0, check _every_ microframe in the schedule.&n;&t; */
r_if
c_cond
(paren
id|unlikely
...
suffix:semicolon
multiline_comment|/* just check the specified uframe, at that period */
)brace
r_else
(brace
r_do
...
multiline_comment|/* FSTN territory? */
r_goto
id|done
suffix:semicolon
r_if
...
multiline_comment|/* Make sure this tt&squot;s buffer is also available for CSPLITs.&n;&t; * We pessimize a bit; probably the typical full speed case&n;&t; * doesn&squot;t need the second CSPLIT.&n;&t; * &n;&t; * NOTE:  both SPLIT and CSPLIT could be checked in just&n;&t; * one smart pass...&n;&t; */
id|mask
op_assign
l_int|0x03
op_lshift
...
multiline_comment|/* &quot;first fit&quot; scheduling policy used the first time through,&n; * or when the previous schedule slot can&squot;t be re-used.&n; */
...
(brace
multiline_comment|/* &quot;normal&quot; case, uframing flexible except with splits */
r_if
c_cond
(paren
id|qh-&gt;period
...
suffix:semicolon
multiline_comment|/* qh-&gt;period == 0 means every uframe */
)brace
r_else
(brace
id|frame
...
multiline_comment|/*-------------------------------------------------------------------------*/
multiline_comment|/* ehci_iso_sched ops can be ITD-only or SITD-only */
r_static
r_struct
id|ehci_iso_sched
op_star

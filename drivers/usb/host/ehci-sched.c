...
suffix:semicolon
multiline_comment|/* usbfs wants to report the average usecs per frame tied up&n;&t; * when transfers on this endpoint are scheduled ...&n;&t; */
id|stream-&gt;usecs
op_assign
id|HS_USECS_ISO
(paren
...
id|ready
suffix:semicolon
multiline_comment|/* two cases:&n;&t;&t; * (a) we missed some uframes ... can reschedule&n;&t;&t; * (b) trying to overcommit the schedule&n;&t;&t; * FIXME (b) should be a hard failure&n;&t;&t; */
)brace
...
id|ehci
comma
l_string|&quot;%s schedule from %d (%d..%d), was %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|now
...
id|urb-&gt;interval
suffix:semicolon
multiline_comment|/* hack:  account for itds already scheduled to this endpoint */
r_if
c_cond
(paren
id|unlikely
...
id|max
suffix:semicolon
multiline_comment|/* within [start..max] find a uframe slot with enough bandwidth */
id|end
op_mod_assign
id|mod
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* (re)schedule it here if there&squot;s enough bandwidth */
r_if
c_cond
(paren
id|enough_space
...
(brace
multiline_comment|/* host fell behind ... maybe irq latencies&n;&t;&t;&t;&t; * delayed this request queue for too long.&n;&t;&t;&t;&t; */
id|stream-&gt;rescheduled
op_increment
suffix:semicolon
id|dev_dbg
...
id|urb-&gt;dev-&gt;dev
comma
l_string|&quot;iso%d%s %d.%d skip %d.%d&bslash;n&quot;
comma
id|stream-&gt;bEndpointAddress
op_amp
l_int|0x0f
...
id|ehci
comma
l_string|&quot;iso %ssched full %p (now %d end %d max %d)&bslash;n&quot;
comma
id|list_empty
(paren
op_amp
...
macro_line|#ifdef have_split_iso
multiline_comment|/*-------------------------------------------------------------------------*/
multiline_comment|/*&n; * &quot;Split ISO TDs&quot; ... used for USB 1.1 devices going through&n; * the TTs in USB 2.0 hubs.&n; *&n; * FIXME not yet implemented&n; */
macro_line|#endif /* have_split_iso */
multiline_comment|/*-------------------------------------------------------------------------*/
r_static
r_void
...
suffix:semicolon
multiline_comment|/* always rescan here; simpler */
id|count
op_add_assign
id|itd_complete
(paren
...
r_else
(brace
multiline_comment|/* FIXME sometimes we can scan the next frame&n;&t;&t;&t; * right away, not always inching up on it ...&n;&t;&t;&t; */
id|now_uframe
op_increment
suffix:semicolon
id|now_uframe

...
l_int|3
suffix:semicolon
singleline_comment|// FIXME microframe periods not handled yet
...
id|dbg
(paren
l_string|&quot;qh %p usecs %d/%d period %d.0 &quot;
l_string|&quot;starting %d.%d (gap %d)&quot;
comma
id|qh
comma
id|qh-&gt;usecs
...
singleline_comment|// AS WELL AS updating the check_period() logic
id|BUG
(paren
)paren
suffix:semicolon

...
r_do
(brace
multiline_comment|/* tt is busy in the gap before CSPLIT */
id|tmp
op_assign
l_int|1
op_lshift
...
suffix:semicolon
multiline_comment|/* tt must be idle for start(s), any gap, and csplit */
r_if
c_cond
(paren
op_logical_neg
...
id|ready
suffix:semicolon
multiline_comment|/* else fell behind; try to reschedule */
)brace

...
multiline_comment|/* Are there any URBs for a particular device/endpoint on a given list? */
DECL|function|urbs_for_ep_list
r_static
r_int
id|urbs_for_ep_list
c_func
...
multiline_comment|/* Are there any URBs for a particular device/endpoint? */
DECL|function|urbs_for_ep
r_static
r_int
id|urbs_for_ep
c_func

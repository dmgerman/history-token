...
suffix:semicolon
multiline_comment|/* FIXME: Wait for the controller to actually stop */
id|uhci_get_current_frame_number
c_func
(paren
id|uhci
...
multiline_comment|/*&n; * Store the current frame number in uhci-&gt;frame_number if the controller&n; * is runnning&n; */
...
id|flags
suffix:semicolon
multiline_comment|/* Minimize latency by avoiding the spinlock */
id|local_irq_save
c_func
(paren
id|flags

...
DECL|macro|CONFIG_USB_SA1110
mdefine_line|#define&t;CONFIG_USB_SA1110
DECL|macro|CONFIG_USB_ZAURUS
mdefine_line|#define&t;CONFIG_USB_ZAURUS
DECL|macro|DRIVER_VERSION
mdefine_line|#define DRIVER_VERSION&t;&t;&quot;18-Oct-2002&quot;
multiline_comment|/*-------------------------------------------------------------------------*/
...
suffix:semicolon
macro_line|#endif&t;/* CONFIG_USB_SA1100 */
"&f;"
macro_line|#ifdef CONFIG_USB_ZAURUS
multiline_comment|/*-------------------------------------------------------------------------&n; *&n; * Zaurus is also a SA-1110 based PDA, but one using a different driver&n; * for its USB slave/target controller than the case above.&n; *&n; * The key differences are that (a) it&squot;s got a msft-friendly configuration,&n; * and (b) the linux-friendly framing adds a crc32 to cope with some&n; * memory corruption observed with usb-to-memory DMA in some cases.&n; *&n; *-------------------------------------------------------------------------*/
...
suffix:semicolon
DECL|macro|CRC32_INITFCS
mdefine_line|#define CRC32_INITFCS     0xffffffff  
singleline_comment|// Initial FCS value 
DECL|macro|CRC32_FCS
mdefine_line|#define CRC32_FCS(fcs, c) (((fcs) &gt;&gt; 8) ^ crc32_table[((fcs) ^ (c)) &amp; 0xff])
multiline_comment|/* fcs_compute32 - memcpy and calculate fcs&n; * Perform a memcpy and calculate fcs using ppp 32bit CRC algorithm.&n; */
DECL|function|fcs_compute32
r_static
r_inline
id|u32
id|fcs_compute32
...
id|fcs
suffix:semicolon
singleline_comment|// ? add optional byte make addr even ?
op_star
id|skb_put
(paren
id|skb
...
macro_line|#endif
macro_line|#ifdef&t;CONFIG_USB_SA1100
multiline_comment|/*&n; * SA-1100 using www.handhelds.org kernels, or compatible.&n; * Often used when talking to Linux PDAs (iPaq, Yopy, etc).&n; * The sa-1100 &quot;usb-eth&quot; driver handles the basic framing.&n; */
(brace
...
comma
singleline_comment|// iPaq: Compaq &quot;Itsy&quot;
dot
id|driver_info
op_assign
(paren

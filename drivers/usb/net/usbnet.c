...
(brace
multiline_comment|/* Oops, couldn&squot;t allocate a buffer for setting the multicast&n;&t;&t;&t;   filter. Try all multi mode. */
id|rx_ctl
op_or_assign
l_int|0x02
suffix:semicolon

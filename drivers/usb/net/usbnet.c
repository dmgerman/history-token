...
singleline_comment|// #define&t;CONFIG_USB_PXA
DECL|macro|CONFIG_USB_SA1100
mdefine_line|#define&t;CONFIG_USB_SA1100
...
multiline_comment|/* mostly for PDA style devices, which are always present */
...
"&f;"
macro_line|#ifdef&t;CONFIG_USB_PXA
multiline_comment|/*-------------------------------------------------------------------------&n; *&n; * PXA250 and PXA210 use XScale cores (ARM v5TE) with better USB support,&n; * and different USB endpoint numbering than the SA1100 devices.&n; *&n; *-------------------------------------------------------------------------*/
DECL|variable|pxa_info
r_static
r_const
r_struct
id|driver_info
...
macro_line|#endif
macro_line|#ifdef&t;CONFIG_USB_PXA
multiline_comment|/*&n; * PXA250 or PXA210 ...  these use a &quot;usb-eth&quot; driver much like&n; * the sa1100 one.&n; */
(brace
singleline_comment|// Compaq &quot;Itsy&quot; vendor/product id, version &quot;2.0&quot;
id|USB_DEVICE_VER
(paren
l_int|0x049F
comma
...
macro_line|#endif
macro_line|#ifdef&t;CONFIG_USB_SA1100
multiline_comment|/*&n; * SA-1100 using standard ARM Linux kernels, or compatible.&n; * Often used when talking to Linux PDAs (iPaq, Yopy, etc).&n; * The sa-1100 &quot;usb-eth&quot; driver handles the basic framing.&n; */
(brace
singleline_comment|// 1183 = 0x049F, both used as hex values?
singleline_comment|// Compaq &quot;Itsy&quot; vendor/product id, version &quot;0.0&quot;
id|USB_DEVICE_VER
(paren
l_int|0x049F
comma

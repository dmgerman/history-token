...
DECL|macro|INTBUFFERSIZE
mdefine_line|#define INTBUFFERSIZE&t;&t;&t;&t;4
DECL|macro|STATE_OFFSET
mdefine_line|#define STATE_OFFSET&t;&t;&t;&t;0
DECL|macro|STATE_MASK
mdefine_line|#define STATE_MASK&t;&t;&t;&t;0x40
DECL|macro|STATE_SHIFT
mdefine_line|#define&t;STATE_SHIFT&t;&t;&t;&t;5
id|MODULE_AUTHOR
c_func
(paren
l_string|&quot;Michael Zappe &lt;zapman@interlan.net&gt;, Stephane Alnet &lt;stephane@u-picardie.fr&gt;, Brad Hards &lt;bhards@bigpond.net.au&gt; and Oliver Neukum &lt;oliver@neukum.org&gt;&quot;
)paren
suffix:semicolon
...
id|removed
suffix:semicolon
DECL|member|suspend_lowmem_rx
r_int
id|suspend_lowmem_rx
suffix:semicolon
DECL|member|suspend_lowmem_ctrl
r_int
id|suspend_lowmem_ctrl
suffix:semicolon
DECL|member|linkstate
r_int
id|linkstate
suffix:semicolon
DECL|member|lowmem_work
r_struct
id|work_struct
id|lowmem_work
suffix:semicolon
...
id|irq_urb
suffix:semicolon
DECL|member|intbufferhandle
id|dma_addr_t
id|intbufferhandle
suffix:semicolon
DECL|member|intbuffer
id|__u8
op_star
id|intbuffer
suffix:semicolon
DECL|member|rxbufferhandle
id|dma_addr_t
id|rxbufferhandle
suffix:semicolon
DECL|member|rx_buf
...
suffix:semicolon
multiline_comment|/****************************************************************&n;&t;int_callback&n;*****************************************************************/
DECL|function|kaweth_resubmit_int_urb
r_static
r_void
id|kaweth_resubmit_int_urb
c_func
(paren
r_struct
id|kaweth_device
...
DECL|function|kaweth_resubmit_tl
r_static
r_void
id|kaweth_resubmit_tl
c_func
(paren
r_void
op_star
...
suffix:semicolon
id|kaweth-&gt;rx_urb-&gt;transfer_flags
op_or_assign
id|URB_NO_TRANSFER_DMA_MAP
suffix:semicolon
id|kaweth-&gt;rx_urb-&gt;transfer_dma
op_assign
id|kaweth-&gt;rxbufferhandle
suffix:semicolon
r_if
c_cond
(paren
...
suffix:semicolon
id|kaweth-&gt;irq_urb-&gt;transfer_flags
op_or_assign
id|URB_NO_TRANSFER_DMA_MAP
suffix:semicolon
id|res
...
DECL|function|kaweth_get_drvinfo
r_static
r_void
id|kaweth_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/* We now decide whether we can put our special header into the sk_buff */
r_if
c_cond
(paren
id|skb_cloned
...
(brace
multiline_comment|/* no such luck - we make our own */
r_struct
id|sk_buff
op_star
id|copied_skb
...
suffix:semicolon
multiline_comment|/* kaweth is zeroed as part of alloc_netdev */
id|INIT_WORK
c_func
(paren
op_amp

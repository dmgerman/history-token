...
mdefine_line|#define DRIVER_VERSION &quot;v0.5.0 (2002/03/28)&quot;
...
mdefine_line|#define&t;RTL8150_MTU&t;&t;1500
DECL|macro|RTL8150_MAX_MTU
mdefine_line|#define&t;RTL8150_MAX_MTU&t;&t;1536
DECL|macro|RTL8150_TX_TIMEOUT
mdefine_line|#define&t;RTL8150_TX_TIMEOUT&t;(HZ)
multiline_comment|/* rtl8150 flags */
DECL|macro|RTL8150_FLAG_HWCRC
mdefine_line|#define&t;RTL8150_FLAG_HWCRC&t;0
...
c_func
(paren
l_string|&quot;netdev is not present&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
l_int|0xd8
suffix:semicolon
multiline_comment|/* bit0=1 no CRC at the end of the frame */
id|cr
op_assign
l_int|0x0c
suffix:semicolon
...
suffix:semicolon
id|dev-&gt;tx_urb-&gt;transfer_buffer_length
op_assign
id|count
suffix:semicolon
r_if

...
DECL|macro|IDR
mdefine_line|#define&t;IDR&t;&t;&t;0x0120
DECL|macro|MAR
...
DECL|macro|INTBUFSIZE
mdefine_line|#define&t;INTBUFSIZE&t;&t;8
...
DECL|macro|RX_URB_FAIL
mdefine_line|#define&t;RX_URB_FAIL&t;&t;3
...
DECL|function|rtl8150_set_mac_address
r_static
r_int
id|rtl8150_set_mac_address
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/* Set the IDR registers. */
id|set_registers
c_func
(paren
id|dev
...
suffix:semicolon
macro_line|#ifdef EEPROM_WRITE
(brace
id|u8
id|cr
suffix:semicolon
multiline_comment|/* Get the CR contents. */
id|get_registers
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* Set the WEPROM bit (eeprom write enable). */
id|cr
op_or_assign
l_int|0x20
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Write the MAC address into eeprom. Eeprom writes must be word-sized,&n;&t;   so we need to split them up. */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Clear the WEPROM bit (preventing accidental eeprom writes). */
id|cr
op_and_assign
l_int|0xdf
suffix:semicolon
...
r_return
suffix:semicolon
multiline_comment|/* the urb is in unlink state */
r_case
op_minus
id|ETIMEDOUT
suffix:colon
...
DECL|function|rtl8150_get_drvinfo
r_static
r_void
id|rtl8150_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
DECL|function|rtl8150_get_settings
r_static
r_int
id|rtl8150_get_settings
c_func
(paren
r_struct
id|net_device
...
c_func
(paren
l_string|&quot;couldn&squot;t register the device&quot;
)paren
suffix:semicolon
r_goto
id|out2

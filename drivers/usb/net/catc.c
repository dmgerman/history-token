multiline_comment|/*&n; *  Copyright (c) 2001 Vojtech Pavlik&n; *&n; *  CATC EL1210A NetMate USB Ethernet driver&n; *&n; *  Sponsored by SuSE&n; *&n; *  Based on the work of&n; *&t;&t;Donald Becker&n; * &n; *  Old chipset support added by Simon Evans &lt;spse@secret.org.uk&gt; 2002&n; *    - adds support for Belkin F5U011&n; */
...
DECL|macro|RX_PKT_SZ
mdefine_line|#define RX_PKT_SZ&t;&t;1600&t;/* Max size of receive packet for F5U011 */
...
l_int|0xf5
comma
DECL|enumerator|SetRxMode
id|SetRxMode
op_assign
l_int|0xf5
comma
multiline_comment|/* F5U011 only */
...
l_int|0x10
comma
DECL|enumerator|AltRxPromisc
id|AltRxPromisc
op_assign
l_int|0x20
comma
multiline_comment|/* F5U011 uses different bit */
)brace
suffix:semicolon
...
suffix:semicolon
DECL|enum|link_status
r_enum
id|link_status
(brace
DECL|enumerator|LinkNoChange
id|LinkNoChange
op_assign
l_int|0
comma
DECL|enumerator|LinkGood
id|LinkGood
op_assign
l_int|1
comma
DECL|enumerator|LinkBad
id|LinkBad
op_assign
l_int|2
)brace
...
id|ctrl_urb
suffix:semicolon
DECL|member|is_f5u011
id|u8
id|is_f5u011
suffix:semicolon
multiline_comment|/* Set if device is an F5U011 */
DECL|member|rxmode
id|u8
id|rxmode
(braket
...
suffix:semicolon
multiline_comment|/* Used for F5U011 */
DECL|member|recq_sz
id|atomic_t
id|recq_sz
suffix:semicolon
multiline_comment|/* Used for F5U011 - counter of waiting rx packets */
)brace
suffix:semicolon
...
DECL|macro|f5u011_rxmode
mdefine_line|#define f5u011_rxmode(catc, rxmode)&t;&t;&t;catc_ctrl_msg(catc, USB_DIR_OUT, SetRxMode, 0, 1, rxmode, 2)
DECL|macro|f5u011_rxmode_async
mdefine_line|#define f5u011_rxmode_async(catc, rxmode)&t;&t;catc_ctrl_async(catc, USB_DIR_OUT, SetRxMode, 0, 1, &amp;rxmode, 2, NULL)
DECL|macro|f5u011_mchash_async
mdefine_line|#define f5u011_mchash_async(catc, hash)&t;&t;&t;catc_ctrl_async(catc, USB_DIR_OUT, SetRxMode, 0, 2, &amp;hash, 8, NULL)
...
id|pkt_len
suffix:semicolon
multiline_comment|/* F5U011 only does one packet per RX */
r_if
c_cond
(paren
id|catc-&gt;is_f5u011
...
c_func
(paren
l_string|&quot;Setting RX mode to %2.2X %2.2X&quot;
comma
id|catc-&gt;rxmode
(braket
l_int|0
...
DECL|function|catc_get_settings
r_static
r_int
id|catc_get_settings
c_func
(paren
r_struct
id|net_device
...
l_int|0xa
op_logical_and
id|catc-&gt;usbdev-&gt;descriptor.bcdDevice
op_eq
l_int|0x0130
)paren
(brace
...
c_func
(paren
l_string|&quot;Performing reset&bslash;n&quot;
)paren
suffix:semicolon
id|catc_reset
c_func
...
comma
multiline_comment|/* CATC Netmate, Belkin F5U011 */
(brace
id|USB_DEVICE
c_func
(paren

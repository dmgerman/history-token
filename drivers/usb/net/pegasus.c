...
mdefine_line|#define DRIVER_VERSION &quot;v0.5.6 (2002/06/23)&quot;
...
c_func
(paren
l_string|&quot;%s: rx_skb == NULL&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
multiline_comment|/*&n;&t;** we are sure at this point pegasus-&gt;rx_skb != NULL&n;&t;** so we go ahead and pass up the packet.&n;&t;*/
id|skb_put
c_func
(paren
id|pegasus-&gt;rx_skb

...
DECL|macro|DEBUG
mdefine_line|#define&t;DEBUG 1&t;&t;&t;/* data to help fault diagnosis */
...
id|data-&gt;dev
comma
l_string|&quot;%s read %d OUT&bslash;n&quot;
comma
id|data-&gt;name
comma
id|len
...
id|data-&gt;dev
comma
l_string|&quot;%s write %d IN&bslash;n&quot;
comma
id|data-&gt;name
comma
id|len
...
id|ep_release
comma
singleline_comment|// .aio_read =&t;ep_aio_read,
singleline_comment|// .aio_write =&t;ep_aio_write,
)brace
suffix:semicolon

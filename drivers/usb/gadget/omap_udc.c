multiline_comment|/*&n; * omap_udc.c -- for OMAP 1610 udc, with OTG support&n; *&n; * Copyright (C) 2004 Texas Instruments, Inc.&n; * Copyright (C) 2004 David Brownell&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA&n; */
DECL|macro|DEBUG
...
multiline_comment|/* OUT-dma seems to be behaving */
DECL|macro|USE_DMA
...
multiline_comment|/* FIXME ISO can dma, but prefers first channel.&n;&t;&t;&t; * IN can dma, but lacks debugging.&n;&t;&t;&t; */
id|dma_channel_claim
c_func
(paren
id|ep
...
suffix:semicolon
singleline_comment|// FIXME double buffered PIO OUT wasn&squot;t behaving...
...
id|last
suffix:semicolon
singleline_comment|// FIXME this surely isn&squot;t #bytes transferred
id|last
op_assign
(paren
id|omap_readw
...
id|count
suffix:semicolon
multiline_comment|/* FIXME must be a better way to see how much dma&n;&t; * happened, even when it never got going...&n;&t; */
id|count
op_assign
id|omap_readw
c_func
...
c_func
(paren
l_string|&quot;%s, SPIN abort TX dma&bslash;n&quot;
comma
id|ep-&gt;ep.name
)paren
suffix:semicolon
)brace
multiline_comment|/* host may empty the fifo (or not...) */
r_while
c_loop
(paren
id|UDC_TXDMA_CFG_REG
...
id|ep-&gt;dma_channel
suffix:semicolon
multiline_comment|/* releasing the dma completion cancels the request,&n;&t;&t; * reclaiming the channel restarts the queue&n;&t;&t; */
id|dma_channel_release
c_func
(paren
id|ep
...
multiline_comment|/*&n; * Called by whatever detects VBUS sessions:  external transceiver&n; * driver, or maybe GPIO0 VBUS IRQ.&n; */
...
suffix:semicolon
singleline_comment|// FIXME double buffered PIO OUT should work
)brace
id|UDC_EP_NUM_REG
op_assign
id|epnum
...
id|UDC_EP_DIR
suffix:semicolon
multiline_comment|/* 6 wait states before it&squot;ll tx */
)brace
)brace
id|spin_unlock_irqrestore
c_func
...
id|s
comma
l_string|&quot;&bslash;n%s %sirqs %ld stat %04x &quot;
id|EIGHTBITS
id|FOURBITS
l_string|&quot;%s&bslash;n&quot;
comma
...
id|s
comma
l_string|&quot;UDC rev %d.%d, OTG rev %d.%d, fifo mode %d, gadget %s&bslash;n&quot;
l_string|&quot;hmc %d, transceiver %08x %s&bslash;n&quot;
comma
id|tmp
op_rshift
l_int|4
...
r_else
(brace
multiline_comment|/* pio-out could potentially double-buffer,&n;&t;&t; * as can (should!) DMA-IN&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;OMAP UDC rev %d.%d, OTG rev %d.%d, %s receptacle&bslash;n&quot;
comma
id|UDC_REV_REG
op_rshift
l_int|4
...
(brace
multiline_comment|/* should work on many OMAP systems with at most minor changes,&n;&t; * but the 1510 doesn&squot;t have an OTG controller.&n;&t; */
r_if
c_cond
(paren
id|cpu_is_omap1510
...
c_func
(paren
l_string|&quot;no OMAP1510 support yet&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

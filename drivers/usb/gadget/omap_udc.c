...
c_func
(paren
l_string|&quot;OMAP UDC rev %d.%d, %s receptacle&bslash;n&quot;
comma
id|UDC_REV_REG
op_rshift
l_int|4
...
l_string|&quot;(unknown)&quot;
suffix:semicolon
multiline_comment|/* FIXME may need a GPIO-0 handler to call&n;&t;&t; * usb_gadget_vbus_{dis,}connect() on us...&n;&t;&t; */
)brace
r_else
(brace
id|hmc

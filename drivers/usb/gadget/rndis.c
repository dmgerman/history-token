...
DECL|function|devFlags2currentFilter
r_static
id|u32
id|devFlags2currentFilter
(paren
r_struct
id|net_device
op_star
...
id|filter
op_or_assign
id|NDIS_PACKET_TYPE_ALL_MULTICAST
suffix:semicolon
r_if
c_cond
(paren
...
id|filter
op_or_assign
id|NDIS_PACKET_TYPE_PROMISCUOUS
suffix:semicolon
r_return
id|filter
suffix:semicolon
)brace
DECL|function|currentFilter2devFlags
r_static
r_void
id|currentFilter2devFlags
(paren
id|u32
id|currentFilter
comma
...
suffix:semicolon
multiline_comment|/* &n;&t;&t;&t; * we need a MAC address and hope that &n;&t;&t;&t; * (our MAC + 1) is not in use&n;&t;&t;&t; */
op_star
(paren
(paren
id|u8
...
id|r
suffix:semicolon
multiline_comment|/* respond only in RNDIS_INITIALIZED state */
r_if
c_cond
(paren
id|rndis_per_dev_params
...
(brace
r_case
id|REMOTE_NDIS_INIZIALIZE_MSG
suffix:colon
id|DEBUG
c_func
(paren
id|KERN_INFO
l_string|&quot;%s: REMOTE_NDIS_INIZIALIZE_MSG&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

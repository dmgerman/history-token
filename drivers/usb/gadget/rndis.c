...
(brace
multiline_comment|/* FIXME the filter is supposed to control what gets&n;&t; * forwarded from gadget to host; but dev-&gt;flags controls&n;&t; * reporting from host to gadget ...&n;&t; */
macro_line|#if 0
r_if
c_cond
(paren

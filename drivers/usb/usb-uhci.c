...
comma
id|s-&gt;ls_control_chain-&gt;dma_addr
op_or
id|UHCI_PTR_QH
)paren
suffix:semicolon
...
singleline_comment|// Sanity checks
r_if
c_cond
(paren
id|usb_maxpacket
...
c_func
(paren
l_string|&quot;uhci_submit_urb: pipesize for pipe %x is zero&quot;
comma
id|urb-&gt;pipe
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;uhci_submit_urb: Negative transfer length for urb %p&quot;
comma
id|urb
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Host controller halted, trying to restart.&quot;
)paren
suffix:semicolon
id|outw
(paren

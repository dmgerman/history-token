...
DECL|function|uhci_alloc_root_hub
r_static
r_int
id|uhci_alloc_root_hub
c_func
(paren
r_struct
id|uhci
...
(paren
id|KERN_ERR
l_string|&quot;Unable to allocate consistent memory for frame list&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|free_uhci
...
(paren
id|KERN_ERR
l_string|&quot;Unable to create td pci_pool&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|free_fl
...
(paren
id|KERN_ERR
l_string|&quot;Unable to create qh pci_pool&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|free_td_pool
...
multiline_comment|/*&n; * If we&squot;ve successfully found a UHCI, now is the time to return success..&n; */

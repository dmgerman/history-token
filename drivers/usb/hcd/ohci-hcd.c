...
suffix:semicolon
singleline_comment|//&t;&t;writel (OHCI_BLF, &amp;ohci-&gt;regs-&gt;cmdstatus);
singleline_comment|//&t;&t;writel (OHCI_CLF, &amp;ohci-&gt;regs-&gt;cmdstatus);
id|ohci_dump_status
(paren
id|ohci
)paren

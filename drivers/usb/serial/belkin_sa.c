...
suffix:semicolon
DECL|variable|belkin_dockstation_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|belkin_dockstation_table
(braket
)braket
op_assign
(brace
...
id|name
suffix:colon
l_string|&quot;Belkin F5U120-PC USB Serial Adapter&quot;
comma
id|id_table
suffix:colon
id|belkin_dockstation_table
...
id|name
suffix:colon
l_string|&quot;GO-COM232 USB Serial Converter&quot;
comma
id|id_table
suffix:colon
id|gocom232_table
comma
multiline_comment|/* the GO-COM232 device */
id|needs_interrupt_in
suffix:colon
id|MUST_HAVE
comma

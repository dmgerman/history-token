...
suffix:semicolon
DECL|variable|kl5kusb105d_driver
r_static
r_struct
id|usb_driver
id|kl5kusb105d_driver
op_assign
(brace
dot
id|owner
...
c_func
(paren
l_string|&quot;%s - %d byte block, baudrate %x, databits %d, u1 %d, u2 %d&quot;
comma
id|__FUNCTION__
comma
id|settings-&gt;pktlen
...
c_func
(paren
l_string|&quot;%s - sending SIO Poll request&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%skmalloc for klsi_105_private failed.&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s - read line state 0x%lx&quot;
comma
id|__FUNCTION__
comma
id|line_state
...
m_exit
suffix:colon
multiline_comment|/* lockless, but it&squot;s for debug info only... */
id|priv-&gt;bytes_out
op_add_assign
id|bytes_sent
suffix:semicolon
...
multiline_comment|/* dbg(&quot;%s - emtpy URB&quot;, __FUNCTION__); */
suffix:semicolon
)brace
r_else
r_if
...
c_func
(paren
l_string|&quot;%s - size %d URB not understood&quot;
comma
id|__FUNCTION__
comma
id|urb-&gt;actual_length
...
c_func
(paren
l_string|&quot;%s - trying to read more data than available&quot;
l_string|&quot; (%d vs. %d)&quot;
comma
id|__FUNCTION__
comma
...
suffix:semicolon
multiline_comment|/* again lockless, but debug info only */
id|priv-&gt;bytes_in
op_add_assign
id|bytes_sent
suffix:semicolon
...
id|flags
suffix:semicolon
multiline_comment|/* lock while we are modifying the settings */
id|spin_lock_irqsave
(paren
op_amp
id|priv-&gt;lock
...
c_func
(paren
l_string|&quot;%s - 5 bits/byte not supported&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
macro_line|#endif
DECL|function|klsi_105_tiocmget
r_static
r_int
id|klsi_105_tiocmget
(paren
...
c_func
(paren
l_string|&quot;%s - request, just guessing&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
DECL|function|klsi_105_tiocmset
r_static
r_int
id|klsi_105_tiocmset
(paren
...
suffix:semicolon
multiline_comment|/* if this ever gets implemented, it should be done something like this:&n;&t;struct usb_serial *serial = port-&gt;serial;&n;&t;struct klsi_105_private *priv = usb_get_serial_port_data(port);&n;&t;unsigned long flags;&n;&t;int control;&n;&n;&t;spin_lock_irqsave (&amp;priv-&gt;lock, flags);&n;&t;if (set &amp; TIOCM_RTS)&n;&t;&t;priv-&gt;control_state |= TIOCM_RTS;&n;&t;if (set &amp; TIOCM_DTR)&n;&t;&t;priv-&gt;control_state |= TIOCM_DTR;&n;&t;if (clear &amp; TIOCM_RTS)&n;&t;&t;priv-&gt;control_state &amp;= ~TIOCM_RTS;&n;&t;if (clear &amp; TIOCM_DTR)&n;&t;&t;priv-&gt;control_state &amp;= ~TIOCM_DTR;&n;&t;control = priv-&gt;control_state;&n;&t;spin_unlock_irqrestore (&amp;priv-&gt;lock, flags);&n;&t;retval = mct_u232_set_modem_ctrl(serial, control);&n;*/
r_return
id|retval
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;%s - TIOCMIWAIT not handled&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s - TIOCGICOUNT not handled&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s - TCGETS data faked/incomplete&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

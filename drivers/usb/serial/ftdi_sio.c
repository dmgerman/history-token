...
multiline_comment|/* Have to check for validity of queueing up the tasks */
id|dbg
c_func
(paren
l_string|&quot;%s - port-&gt;open_count = %d&quot;
comma
id|__FUNCTION__
comma
id|port-&gt;open_count

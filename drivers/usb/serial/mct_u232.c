...
suffix:semicolon
DECL|variable|mct_u232_sitecom_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|mct_u232_sitecom_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|mct_u232_du_h3sp_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|mct_u232_du_h3sp_table
(braket
)braket
op_assign
(brace
...
id|name
suffix:colon
l_string|&quot;MCT/Sitecom USB-RS232&quot;
comma
id|id_table
suffix:colon
id|mct_u232_sitecom_table
...
id|name
suffix:colon
l_string|&quot;MCT/D-Link DU-H3SP USB BAY&quot;
comma
id|id_table
suffix:colon
id|mct_u232_du_h3sp_table
...
l_int|1
suffix:semicolon
multiline_comment|/* normally not reached */
)brace
)brace
r_else
r_return
...
c_func
(paren
l_string|&quot;set_baud_rate: value: %d, divisor: 0x%x&quot;
comma
id|value
comma
id|divisor

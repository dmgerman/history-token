...
suffix:semicolon
multiline_comment|/* Include Keyspan message headers.  All current Keyspan Adapters&n;   make use of one of four message formats which are referred&n;   to as USA-26, USA-28 and USA-49, USA-90 by Keyspan and within this driver. */
macro_line|#include &quot;keyspan_usa26msg.h&quot;
macro_line|#include &quot;keyspan_usa28msg.h&quot;
macro_line|#include &quot;keyspan_usa49msg.h&quot;
macro_line|#include &quot;keyspan_usa90msg.h&quot;
...
r_goto
id|failed_4port_device_register
suffix:semicolon
id|retval
op_assign
id|usb_register
...
DECL|function|keyspan_tiocmget
r_static
r_int
id|keyspan_tiocmget
c_func
...
DECL|function|keyspan_tiocmset
r_static
r_int
id|keyspan_tiocmset
c_func
...
multiline_comment|/* Write function is similar for the four protocols used&n;&t;   with only a minor change for usa90 (usa19hs) required */
...
multiline_comment|/* First byte in buffer is &quot;last flag&quot; (except for usa19hx) - unused so&n;&t;&t;   for now so set to zero */
(paren
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;%s - nonzero status: %x on endpoint %d.&quot;
comma
id|__FUNCTION__
comma
id|urb-&gt;status
...
(brace
multiline_comment|/* 0x80 bit is error flag */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* no errors on individual bytes, only possible overrun err*/
r_if
c_cond
(paren
id|data
...
c_func
(paren
l_string|&quot;%s - resubmit read urb failed. (%d)&quot;
comma
id|__FUNCTION__
comma
id|err
...
multiline_comment|/* Outdat handling is common for all devices */
...
c_func
(paren
l_string|&quot;%s - port status: port %d cts %d dcd %d dsr %d ri %d toff %d txoff %d rxen %d cr %d&quot;
comma
id|__FUNCTION__
comma
id|msg-&gt;port
...
id|dbg
(paren
l_string|&quot;%s - Unexpected port number %d&quot;
comma
id|__FUNCTION__
comma
id|msg-&gt;port
...
multiline_comment|/*dbg(&quot;%s %x %x %x %x %x %x %x %x %x %x %x %x&quot;, __FUNCTION__&n;&t;    data[0], data[1], data[2], data[3], data[4], data[5],&n;&t;    data[6], data[7], data[8], data[9], data[10], data[11]);*/
multiline_comment|/* Now do something useful with the data */
id|msg
op_assign
(paren
...
multiline_comment|/*dbg(&quot; %x %x %x %x %x %x %x %x %x %x %x&quot;, __FUNCTION__, &n;&t;    data[0], data[1], data[2], data[3], data[4], data[5],&n;&t;    data[6], data[7], data[8], data[9], data[10]);*/
multiline_comment|/* Now do something useful with the data */
id|msg
op_assign
(paren
...
DECL|function|usa90_indat_callback
r_static
r_void
id|usa90_indat_callback
c_func
(paren
r_struct
id|urb
...
(brace
multiline_comment|/* if current mode is DMA, looks like usa28 format&n;&t;   &t;&t;otherwise looks like usa26 data format */
r_if
c_cond
(paren
id|p_priv-&gt;baud
...
DECL|function|usa90_instat_callback
r_static
r_void
id|usa90_instat_callback
c_func
(paren
r_struct
id|urb
...
DECL|function|usa90_outcont_callback
r_static
r_void
id|usa90_outcont_callback
c_func
(paren
r_struct
id|urb
...
l_int|9600
suffix:semicolon
multiline_comment|/* force baud and lcr to be set on open */
id|p_priv-&gt;old_baud
op_assign
l_int|0
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* Reset low level data toggle and start reading from endpoints */
r_for
c_loop
(paren
id|i
...
id|serial-&gt;dev
suffix:semicolon
multiline_comment|/* make sure endpoint data toggle is synchronized with the device */
id|usb_clear_halt
c_func
(paren
id|urb-&gt;dev
...
c_func
(paren
l_string|&quot;%s - submit urb %d failed (%d)&quot;
comma
id|__FUNCTION__
comma
id|i
...
multiline_comment|/* Reset low level data toggle on out endpoints */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* get the terminal config for the setup message now so we don&squot;t &n;&t; * need to send 2 of them */
id|cflag
op_assign
id|port-&gt;tty-&gt;termios-&gt;c_cflag
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* If no match or invalid, leave as default */
r_if
c_cond
(paren
id|baud_rate
...
suffix:semicolon
singleline_comment|//mdelay(100);
singleline_comment|//keyspan_set_termios(port, NULL);
r_return
(paren
l_int|0
)paren
...
id|dbg
(paren
l_string|&quot;%s - alloc for endpoint %d.&quot;
comma
id|__FUNCTION__
comma
id|endpoint
...
id|dbg
(paren
l_string|&quot;%s - alloc for endpoint %d failed.&quot;
comma
id|__FUNCTION__
comma
id|endpoint
...
comma
(brace
multiline_comment|/* msg_usa90 callbacks */
dot
id|instat_callback
op_assign
id|usa90_instat_callback
...
multiline_comment|/* usa19hs function doesn&squot;t require prescaler */
DECL|function|keyspan_usa19hs_calc_baud
r_static
r_int
id|keyspan_usa19hs_calc_baud
c_func
(paren
id|u32
id|baud_rate
...
multiline_comment|/* calculate the divisor */
r_if
c_cond
(paren
(paren
...
id|best_prescaler
suffix:semicolon
multiline_comment|/*  dbg(&quot;%s - %d %d&quot;, __FUNCTION__, *prescaler, div); */
)brace
r_return
(paren
id|KEYSPAN_BAUD_RATE_OK
...
multiline_comment|/* USA-28 supports different maximum baud rates on each port */
DECL|function|keyspan_usa28_calc_baud
r_static
r_int
...
multiline_comment|/* check for out of range, based on portnum, &n;&t;&t;   and return result */
r_if
c_cond
(paren
id|portnum
...
multiline_comment|/* return the counter values if not NULL&n;&t;&t;   (port 1 will ignore retHi) */
r_if
c_cond
(paren
id|rate_low
...
(brace
multiline_comment|/*  dbg (&quot;%s - already writing&quot;, __FUNCTION__); */
id|mdelay
c_func
(paren
l_int|5
...
c_func
(paren
l_string|&quot;%s - Invalid baud rate %d requested, using 9600.&quot;
comma
id|__FUNCTION__
comma
id|p_priv-&gt;baud
...
c_func
(paren
l_string|&quot;%s - usb_submit_urb(setup) failed (%d)&quot;
comma
id|__FUNCTION__
comma
id|err
...
c_func
(paren
l_string|&quot;%s - usb_submit_urb(%d) OK %d bytes (end %d)&quot;
comma
id|__FUNCTION__
id|outcont_urb
comma
...
c_func
(paren
l_string|&quot;%s - Invalid baud rate requested %d.&quot;
comma
id|__FUNCTION__
comma
id|p_priv-&gt;baud
...
c_func
(paren
l_string|&quot;%s - usb_submit_urb(setup) failed&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s - usb_submit_urb(setup) OK %d bytes&quot;
comma
id|__FUNCTION__
comma
id|this_urb-&gt;transfer_buffer_length
...
c_func
(paren
l_string|&quot;%s - endpoint %d port %d (%d)&quot;
comma
id|__FUNCTION__
comma
id|usb_pipeendpoint
...
c_func
(paren
l_string|&quot;%s - oops no urb for port %d.&quot;
comma
id|__FUNCTION__
comma
id|port-&gt;number
...
DECL|function|keyspan_usa90_send_setup
r_static
r_int
id|keyspan_usa90_send_setup
c_func
...
multiline_comment|/* Save reset port val for resend.&n;&t;   Don&squot;t overwrite resend for open/close condition. */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* modes must always be correctly specified */
r_if
c_cond
(paren
id|p_priv-&gt;baud
...
id|msg.txFlowControl
op_assign
id|TXFLOW_CTS
suffix:semicolon
id|msg.setTxFlowControl
op_assign
l_int|0x01
suffix:semicolon
id|msg.setRxFlowControl
op_assign
l_int|0x01
suffix:semicolon
id|msg.rxForwardingLength
op_assign
l_int|16
suffix:semicolon
id|msg.rxForwardingTimeout
op_assign
l_int|16
suffix:semicolon
id|msg.txAckSetting
...
c_func
(paren
l_string|&quot;%s - kmalloc for keyspan_serial_private failed.&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s - kmalloc for keyspan_port_private (%d) failed!.&quot;
comma
id|__FUNCTION__
comma
id|i
...
c_func
(paren
l_string|&quot;%s - submit instat urb failed %d&quot;
comma
id|__FUNCTION__
comma
id|err

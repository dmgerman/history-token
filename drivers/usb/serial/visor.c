...
id|connection_info-&gt;num_ports
suffix:semicolon
multiline_comment|/* handle devices that report invalid stuff here */
r_if
c_cond
(paren
id|num_ports
...
suffix:semicolon
multiline_comment|/* Ok, this is pretty ugly, but these devices want to use the&n;&t; * interrupt endpoint as paired up with a bulk endpoint for a&n;&t; * &quot;virtual serial port&quot;.  So let&squot;s force the endpoints to be&n;&t; * where we want them to be. */
r_for
c_loop
(paren
id|i

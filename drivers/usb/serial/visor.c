...
suffix:semicolon
DECL|variable|palm_m500_id_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|palm_m500_id_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|palm_m505_id_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|palm_m505_id_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|variable|clie_id_4_0_table
r_static
id|__devinitdata
r_struct
id|usb_device_id
id|clie_id_4_0_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
multiline_comment|/* device info for the Palm M500 */
DECL|variable|palm_m500_device
r_struct
id|usb_serial_device_type
id|palm_m500_device
op_assign
...
suffix:semicolon
multiline_comment|/* device info for the Palm M505 */
DECL|variable|palm_m505_device
r_struct
id|usb_serial_device_type
id|palm_m505_device
op_assign
...
suffix:semicolon
multiline_comment|/* device info for the Sony Clie OS version 4.0 */
DECL|variable|clie_4_0_device
r_static
r_struct
id|usb_serial_device_type
id|clie_4_0_device
...
(brace
multiline_comment|/* Palm OS 4.0 Hack */
id|response
op_assign
id|usb_control_msg
(paren
...
comma
id|PALM_GET_SOME_UNKNOWN_INFORMATION
comma
l_int|0xc2
comma
l_int|0x0000
...
(paren
id|__FUNCTION__
l_string|&quot; - error getting first unknown palm command&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|__FUNCTION__
l_string|&quot; - error getting second unknown palm command&quot;
)paren
suffix:semicolon
)brace
r_else

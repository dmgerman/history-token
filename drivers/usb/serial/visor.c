...
mdefine_line|#define DRIVER_VERSION &quot;v1.9&quot;
...
(paren
id|__FUNCTION__
l_string|&quot;: get config number failed: %d&quot;
comma
id|result
)paren
suffix:semicolon
...
(paren
id|__FUNCTION__
l_string|&quot;: get config number bad return length: %d&quot;
comma
id|result
)paren
suffix:semicolon
...
(paren
id|__FUNCTION__
l_string|&quot;: get interface number failed: %d&quot;
comma
id|result
)paren
suffix:semicolon
...
(paren
id|__FUNCTION__
l_string|&quot;: get interface number bad return length: %d&quot;
comma
id|result
)paren
suffix:semicolon

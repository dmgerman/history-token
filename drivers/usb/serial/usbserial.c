...
DECL|macro|CONFIG_USB_SERIAL_CONSOLE
macro_line|#undef CONFIG_USB_SERIAL_CONSOLE
macro_line|#endif
...
id|usbcons
suffix:semicolon
macro_line|#endif /* CONFIG_USB_SERIAL_CONSOLE */
...
(paren
id|__FUNCTION__
l_string|&quot; - no physical device present, failing.&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(brace
multiline_comment|/* disconnect beat us to the punch here, so handle it gracefully */
r_goto
m_exit
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* maybe use generic_read_bulk_callback ??? */
r_return
id|c
suffix:semicolon
)brace

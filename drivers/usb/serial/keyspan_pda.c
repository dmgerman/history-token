...
mdefine_line|#define DRIVER_DESC &quot;USB Keyspan PDA Converter driver&quot;
...
suffix:semicolon
DECL|variable|keyspan_pda_driver
r_static
r_struct
id|usb_driver
id|keyspan_pda_driver
op_assign
(brace
dot
id|owner
...
DECL|function|keyspan_pda_tiocmget
r_static
r_int
id|keyspan_pda_tiocmget
c_func
(paren
r_struct
id|usb_serial_port
...
DECL|function|keyspan_pda_tiocmset
r_static
r_int
id|keyspan_pda_tiocmset
c_func
(paren
r_struct
id|usb_serial_port

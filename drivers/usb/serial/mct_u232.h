...
multiline_comment|/* Belkin badge the MCT U232-P9 as the F5U109 */
DECL|macro|MCT_U232_BELKIN_F5U109_VID
mdefine_line|#define MCT_U232_BELKIN_F5U109_VID&t;0x050d&t;/* Vendor Id */
DECL|macro|MCT_U232_BELKIN_F5U109_PID
mdefine_line|#define MCT_U232_BELKIN_F5U109_PID&t;0x0109&t;/* Product Id */
...
multiline_comment|/* This USB device request code is not well understood.  It is transmitted by&n;   the MCT-supplied Windows driver whenever the baud rate changes. &n;*/
DECL|macro|MCT_U232_SET_UNKNOWN1_REQUEST
mdefine_line|#define MCT_U232_SET_UNKNOWN1_REQUEST   11  /* Unknown functionality */
DECL|macro|MCT_U232_SET_UNKNOWN1_SIZE
mdefine_line|#define MCT_U232_SET_UNKNOWN1_SIZE       1
multiline_comment|/* This USB device request code is not well understood.  It is transmitted by&n;   the MCT-supplied Windows driver whenever the baud rate changes. &n;   &n;   Without this USB device request, the USB/RS-232 adapter will not write to&n;   RS-232 devices which do not assert the &squot;CTS&squot; signal.&n;*/
DECL|macro|MCT_U232_SET_UNKNOWN2_REQUEST

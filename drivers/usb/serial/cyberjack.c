multiline_comment|/*&n; *  REINER SCT cyberJack pinpad/e-com USB Chipcard Reader Driver&n; *&n; *  Copyright (C) 2001  REINER SCT&n; *  Author: Matthias Bruestle&n; *&n; *  Contact: support@reiner-sct.com (see MAINTAINERS)&n; *&n; *  This program is largely derived from work by the linux-usb group&n; *  and associated source files.  Please see the usb/serial files for&n; *  individual credits and copyrights.&n; *&n; *  This program is free software; you can redistribute it and/or modify&n; *  it under the terms of the GNU General Public License as published by&n; *  the Free Software Foundation; either version 2 of the License, or&n; *  (at your option) any later version.&n; *&n; *  Thanks to Greg Kroah-Hartman (greg@kroah.com) for his help and&n; *  patience.&n; *&n; *  In case of problems, please write to the contact e-mail address&n; *  mentioned above.&n; *&n; *  Please note that later models of the cyberjack reader family are&n; *  supported by a libusb-based userspace device driver.&n; *&n; *  Homepage: http://www.reiner-sct.de/support/treiber_cyberjack.php#linux&n; */
...
mdefine_line|#define DRIVER_VERSION &quot;v1.01&quot;
...
c_func
(paren
l_string|&quot;%s - ignoring since device not open&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
(paren
id|port-&gt;serial-&gt;type-&gt;write_bulk_callback
)paren
ques
c_cond
id|port-&gt;serial-&gt;type-&gt;write_bulk_callback

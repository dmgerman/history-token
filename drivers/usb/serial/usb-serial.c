...
DECL|variable|usb_serial_kobj_type
r_static
r_struct
id|kobj_type
id|usb_serial_kobj_type
op_assign
(brace
dot
id|release
...
suffix:semicolon
multiline_comment|/* initialize the kobject portion of the usb_device */
id|kobject_init
c_func
(paren
op_amp

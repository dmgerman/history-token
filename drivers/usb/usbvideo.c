...
multiline_comment|/*******************************/
multiline_comment|/*&n; * Here we want the physical address of the memory.&n; * This is used when initializing the contents of the area.&n; */
...
suffix:semicolon
DECL|variable|usbvideo_template
r_static
r_struct
id|video_device
id|usbvideo_template
op_assign
(brace
id|owner
suffix:colon

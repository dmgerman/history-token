...
multiline_comment|/* read the standard strings and cache them if present */
id|get_string
c_func
(paren
id|udev
...
DECL|function|usb_resume_root_hub
r_void
...
suffix:semicolon
multiline_comment|/* Is this is a root hub wanting to be resumed? */
r_if
c_cond
(paren
id|i
...
id|loop
suffix:semicolon
multiline_comment|/* If the hub has died, clean up after it */
r_if
c_cond
(paren
id|hdev-&gt;state
...
multiline_comment|/* If this is an inactive or suspended hub, do nothing */
r_if
c_cond
(paren
id|hub-&gt;quiescing

...
id|hcd-&gt;self.controller
comma
l_string|&quot;re-suspend fail, %d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* POLICY: ignore D1/D2/D3hot differences;&n;&t;&t;&t;&t; * we know D3hot will always work.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|retval
...
id|hcd-&gt;self.controller
comma
l_string|&quot;suspended to PCI %s%s&bslash;n&quot;
comma
id|pci_state
c_func
(paren

...
multiline_comment|/**&n; *&t;usb_unbind_driver - disconnects a driver from a device&n; *&t;@device: usb device to be disconnected&n; *&t;@intf: interface of the device to be disconnected&n; *&t;Context: BKL held&n; *&n; *&t;Handles module usage count correctly&n; */
...
multiline_comment|/**&n; *&t;usb_bind_driver - connect a driver to a device&squot;s interface&n; *&t;@driver: device driver to be bound to a devices interface&n; *&t;@dev: device to be bound&n; *&t;@ifnum: index number of the interface to be used&n; *&n; *&t;Does a save binding of a driver to a device&squot;s interface&n; *&t;Returns a pointer to the drivers private description of the binding&n; */
...
suffix:semicolon
DECL|variable|usb_unbind_driver
id|EXPORT_SYMBOL
c_func
(paren
id|usb_unbind_driver

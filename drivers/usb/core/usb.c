...
id|alt
suffix:semicolon
multiline_comment|/* only endpoints in current altsetting are active */
id|intf
op_assign
id|config-&gt;interface
(braket
...
multiline_comment|/**&n; * usb_release_address - deallocate device address (usbcore-internal)&n; * @dev: newly removed device&n; *&n; * Removes and deallocates the address assigned to a device.&n; * Only hub drivers (but not virtual root hub drivers for host&n; * controllers) should ever call this.&n; */
DECL|function|usb_release_address
r_void
id|usb_release_address
c_func
(paren
...
DECL|function|usb_choose_configuration
r_static
r_int
id|usb_choose_configuration
c_func
(paren
r_struct
id|usb_device

...
c_func
(paren
l_string|&quot;nuking urbs assigned to %s&quot;
comma
id|dev-&gt;dev.bus_id
)paren
suffix:semicolon
...
DECL|function|usb_device_remove
r_int
...
suffix:semicolon
multiline_comment|/* release all urbs for this device */
id|nuke_urbs
c_func
(paren
...
suffix:semicolon
DECL|variable|usb_device_remove
id|EXPORT_SYMBOL
c_func
(paren
id|usb_device_remove

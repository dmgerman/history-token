...
multiline_comment|/* FIXME high speed reserves 20% frametime for non-periodic,&n;&t;     * while full/low speed reserves only 10% ... so this is wrong&n;&t;     * for high speed busses.  also, change how bandwidth is recorded.&n;&t;     */
r_if
c_cond
(paren
id|level

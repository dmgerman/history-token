...
mdefine_line|#define DRIVER_AUTHOR &quot;Alan Cox &lt;alan@lxorguk.ukuu.org.uk&gt;, Thomas Sailer (sailer@ife.ee.ethz.ch)&quot;
DECL|macro|DRIVER_DESC
mdefine_line|#define DRIVER_DESC &quot;USB Audio Class driver&quot;
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: dmabuf_init bytepersec %d bufs %d ossfragshift %d ossmaxfrags %d &quot;
l_string|&quot;fragshift %d fragsize %d numfrag %d dmasize %d bufsize %d fmt 0x%x srate %d&bslash;n&quot;
comma
id|bytepersec
comma
id|bufs
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: no sample format conversion&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dmabuf_copyin
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: sample format conversion %x != %x&bslash;n&quot;
comma
id|u-&gt;format
comma
id|u-&gt;dma.format
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: usb_audio_ioctl cmd=%x arg=%lx *arg=%d&bslash;n&quot;
comma
id|cmd
comma
id|arg
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: usb_audio_ioctl - no command found&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
multiline_comment|/* altsetting 0 has no endpoints (Section B.3.4.1) */
id|printk
c_func
(paren
id|KERN_ERR
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: valid input sample rate %u&bslash;n&quot;
comma
id|fp-&gt;sratelo
)paren
suffix:semicolon
...
multiline_comment|/* See USB audio formats manual, section 2 */
id|fmt
op_assign
id|find_csinterface_descriptor
c_func
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: valid output sample rate %u&bslash;n&quot;
comma
id|fp-&gt;sratelo
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: registered dsp 14,%d&bslash;n&quot;
comma
id|as-&gt;dev_audio
)paren
suffix:semicolon
...
multiline_comment|/* See Audio Class Spec, section 4.3.2.5 */
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: wrong controls size in feature unit %u&bslash;n&quot;
comma
id|ftr
(braket
l_int|3
...
(paren
id|KERN_WARNING
l_string|&quot;usbaudio: warning: found %d of %d logical channels.&bslash;n&quot;
comma
id|state-&gt;nrchannels
comma
id|nr_logical_channels
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: assuming the channel found is the master channel (got a Philips camera?). Should be fine.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: assuming that a stereo channel connected directly to a mixer is missing in search (got Labtec headset?). Should be fine.&bslash;n&quot;
)paren
suffix:semicolon
id|state-&gt;nrchannels
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;usbaudio: no idea what&squot;s going on..., contact linux-usb-devel@lists.sourceforge.net&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
multiline_comment|/* There is always a master channel */
id|mchftr
op_assign
id|ftr
(braket
...
suffix:semicolon
multiline_comment|/* Binary AND over logical channels if they exist */
r_if
c_cond
(paren
id|nr_logical_channels
...
id|FEATURE_UNIT
suffix:colon
multiline_comment|/* See USB Audio Class Spec 4.3.2.5 */
r_if
c_cond
(paren
id|p1
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: registered mixer 14,%d&bslash;n&quot;
comma
id|ms-&gt;dev_mixer
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: cannot get first 8 bytes of config descriptor %d of device %d (error %d)&bslash;n&quot;
comma
id|i
comma
id|dev-&gt;devnum
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: cannot get config descriptor %d of device %d (error %d)&bslash;n&quot;
comma
id|i
comma
id|dev-&gt;devnum
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: note, usb_audio_disconnect called with -1&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_DEBUG
l_string|&quot;usbaudio: error,  usb_audio_disconnect already called for %p!&bslash;n&quot;
comma
id|s
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: unregister dsp 14,%d&bslash;n&quot;
comma
id|as-&gt;dev_audio
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;usbaudio: unregister mixer 14,%d&bslash;n&quot;
comma
id|ms-&gt;dev_mixer
)paren
suffix:semicolon

...
multiline_comment|/* &n; * FIXME, either remove this call, or talk the maintainer into &n; * adding usb_set_report back into the core.&n; */
macro_line|#if 0
r_static
r_void
id|aiptek_command
...
singleline_comment|//&t;aiptek_command(dev, ifnum, 0x18, 0x04);
singleline_comment|// SwitchToTablet
singleline_comment|//&t;aiptek_command(dev, ifnum, 0x10, 0x01);
id|aiptek-&gt;features
op_assign
id|aiptek_features
op_plus
...
(paren
id|KERN_INFO
l_string|&quot;input: %s on usb%d:%d&bslash;n&quot;
comma
id|aiptek-&gt;features-&gt;name
comma
id|dev-&gt;bus-&gt;busnum

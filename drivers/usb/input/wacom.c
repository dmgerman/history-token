...
mdefine_line|#define WACOM_INTUOS_ABS&t;(BIT(ABS_TILT_X) | BIT(ABS_TILT_Y) | BIT(ABS_RZ) | BIT(ABS_THROTTLE) | BIT(ABS_SERIAL))
...
suffix:semicolon
macro_line|#if 0&t;/* Missing usb_set_report() */
id|usb_set_report
c_func
(paren
id|intf

...
DECL|macro|USB_VENDOR_ID_BTC
mdefine_line|#define USB_VENDOR_ID_BTC&t;&t;0x046e
DECL|macro|USB_DEVICE_ID_BTC_KEYBOARD
mdefine_line|#define USB_DEVICE_ID_BTC_KEYBOARD&t;0x5303
...
comma
(brace
id|USB_VENDOR_ID_BTC
comma
id|USB_DEVICE_ID_BTC_KEYBOARD
comma
id|HID_QUIRK_NOGET
)brace
comma

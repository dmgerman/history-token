...
multiline_comment|/* (See ov511.txt for detailed descriptions of these.) */
multiline_comment|/* Sensor automatically changes brightness */
...
l_int|1
suffix:semicolon
multiline_comment|/* Sensor automatically changes gain */
...
l_int|1
suffix:semicolon
multiline_comment|/* Sensor automatically changes exposure */
...
l_int|1
suffix:semicolon
multiline_comment|/* Enable compression. Needs a fast (&gt;300 MHz) CPU. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Setting this to 1 will make the sensor output GBR422 instead of YUV420. Only&n; * affects RGB24 mode. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Dump raw pixel data. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* LED policy. Only works on some OV511+ cameras. 0=off, 1=on (default), 2=auto&n; * (on when open) */
DECL|variable|led
r_static
r_int
id|led
...
l_int|1
suffix:semicolon
multiline_comment|/* Set this to 1 to dump the bridge register contents after initialization */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Set this to 1 to dump the sensor register contents after initialization */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Temporary option for debugging &quot;works, but no image&quot; problem. Prints the&n; * first 12 bytes of data (potentially a packet header) in each isochronous&n; * data frame. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Compression parameters - I&squot;m not exactly sure what these do yet */
DECL|variable|phy
r_static
r_int
id|phy
...
l_int|0x04
suffix:semicolon
multiline_comment|/* Light frequency. Set to 50 or 60 (Hz), or zero for default settings */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Set this to 1 to enable banding filter by default. Compensates for&n; * alternating horizontal light/dark bands caused by (usually fluorescent)&n; * lights */
...
l_int|1
suffix:semicolon
multiline_comment|/* Allows picture settings (brightness, hue, etc...) to take effect immediately,&n; * even in the middle of a frame. This reduces the time to change settings, but&n; * can ruin frames during the change. Only affects OmniVision sensors. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Forces the palette to a specific value. If an application requests a&n; * different palette, it will be rejected. */
...
suffix:semicolon
multiline_comment|/* = 0 */
multiline_comment|/* Set tuner type, if not autodetected */
DECL|variable|tuner
r_static
r_int
id|tuner
...
l_int|1
suffix:semicolon
multiline_comment|/* Allows proper exposure of objects that are illuminated from behind. Only&n; * affects OmniVision sensors. */
...
multiline_comment|/* Allows specified minor numbers to be forced. They will be assigned in the&n; * order that devices are detected. Note that you cannot specify 0 as a minor&n; * number. If you do not specify any, the next available one will be used. This&n; * requires kernel 2.4.5 or later. */
...
suffix:semicolon
multiline_comment|/* Remove zero-padding from uncompressed incoming data. This will compensate for&n; * the blocks of corruption that appear when the camera cannot keep up with the&n; * speed of the USB bus (eg. at low frame resolutions) */
...
multiline_comment|/*&n; * Writes bits at positions specified by mask to a reg. Bits that are in&n; * the same position as 1&squot;s in &quot;mask&quot; are cleared and set to &quot;value&quot;. Bits&n; * that are in the same position as 0&squot;s in &quot;mask&quot; are preserved, regardless &n; * of their respective state in &quot;value&quot;.&n; */
r_static
r_int
DECL|function|ov511_reg_write_mask
id|ov511_reg_write_mask
c_func
(paren
r_struct
id|usb_device
...
multiline_comment|/* Writes multiple (n) values to a single register. Only valid with certain&n; * registers (0x30 and 0xc4 - 0xce). Used for writing 16 and 24-bit values. */
r_static
r_int
DECL|function|ov518_reg_write_multi
id|ov518_reg_write_multi
c_func
(paren
r_struct
id|usb_device
...
c_func
(paren
l_string|&quot;reg write multiple: NULL buffer&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;reg write multiple: error %d&quot;
comma
id|rc
)paren
suffix:semicolon
...
multiline_comment|/* NOTE: Do not call this function directly!&n; * The OV518 I2C I/O procedure is different, hence, this function.&n; * This is normally only called from ov51x_i2c_write(). Note that this function&n; * always succeeds regardless of whether the sensor is present and working.&n; */
r_static
r_int
...
c_func
(paren
l_string|&quot;ov518 i2c write: error %d&quot;
comma
id|rc
)paren
suffix:semicolon
...
multiline_comment|/* NOTE: Do not call this function directly!&n; * The OV518 I2C I/O procedure is different, hence, this function.&n; * This is normally only called from ov51x_i2c_read(). Note that this function&n; * always succeeds regardless of whether the sensor is present and working.&n; */
r_static
r_int
...
c_func
(paren
l_string|&quot;ov518 i2c read: error %d&quot;
comma
id|rc
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* This is needed to make ov51x_i2c_write() work */
id|rc
op_assign
id|ov511_reg_write
c_func
...
r_static
r_int
DECL|function|ov51x_i2c_write_mask
id|ov51x_i2c_write_mask
c_func
(paren
r_struct
id|usb_ov511
...
r_static
r_int
DECL|function|ov51x_i2c_write_slave
id|ov51x_i2c_write_slave
c_func
(paren
r_struct
id|usb_ov511
...
r_static
r_int
DECL|function|ov51x_i2c_read_slave
id|ov51x_i2c_read_slave
c_func
(paren
r_struct
id|usb_ov511
...
r_static
r_void
DECL|function|ov51x_dump_i2c_regs
id|ov51x_dump_i2c_regs
c_func
(paren
r_struct
id|usb_ov511
...
r_static
r_void
DECL|function|ov511_dump_reg_range
...
r_static
r_int
DECL|function|ov51x_init_ov_sensor
id|ov51x_init_ov_sensor
c_func
(paren
r_struct
id|usb_ov511
...
singleline_comment|//&t;&t;rc = ov511_i2c_write(ov511-&gt;dev, 0x62, (val &gt;&gt; 9) &amp; 0x7e);
...
singleline_comment|//&t;&t;rc = ov51x_i2c_read(ov511, 0x62);
singleline_comment|//&t;&t;if (rc &lt; 0)
...
id|SEN_OV7620
suffix:colon
singleline_comment|//&t;&t;ov51x_i2c_write(ov511, 0x2b, 0x00);
id|ov51x_i2c_write
c_func
(paren
id|ov511
...
singleline_comment|//&t;&t;ov51x_i2c_write_mask(ov511, 0x12, 0x00, 0x04);
singleline_comment|// This will go away as soon as ov511_mode_init_sensor_regs()
...
suffix:semicolon
singleline_comment|// Turn on Y &amp; UV compression
id|ov511_reg_write
c_func
(paren
id|dev
...
suffix:semicolon
singleline_comment|// Enable LUTs
id|ov511_reset
c_func
(paren
id|ov511
...
suffix:semicolon
multiline_comment|/* Multiple-value reg buffer */
id|PDEBUG
c_func
(paren
l_int|3
...
singleline_comment|//&t;&t;pxcnt = sub_flag ? (ov511-&gt;subw &gt;&gt; 3) - 1 : mlist[i].pxcnt;
singleline_comment|//&t;&t;lncnt = sub_flag ? (ov511-&gt;subh &gt;&gt; 3) - 1 : mlist[i].lncnt;
singleline_comment|//
singleline_comment|//&t;&t;ov511_reg_write(dev, 0x12, pxcnt);
singleline_comment|//&t;&t;ov511_reg_write(dev, 0x13, lncnt);
...
id|SEN_SAA7111A
suffix:colon
singleline_comment|//&t;&t;rc = mode_init_saa_sensor_regs(ov511, width, height, mode, 
...
multiline_comment|/* Copies a 64-byte segment at pIn to an 8x8 block at pOut. The width of the&n; * array at pOut is specified by w.&n; */
r_static
r_inline
r_void
DECL|function|ov511_make_8x8
id|ov511_make_8x8
c_func
(paren
r_int
...
multiline_comment|/* Chooses a decompression module, locks it, and sets ov511-&gt;decomp_ops&n; * accordingly. Returns -ENXIO if decompressor is not available, otherwise&n; * returns 0 if no other error.&n; */
r_static
r_int
DECL|function|ov51x_request_decompressor
id|ov51x_request_decompressor
c_func
(paren
r_struct
id|usb_ov511
...
(paren
op_logical_neg
id|ov511-&gt;decomp_ops-&gt;decomp_lock
)paren
(brace
id|ov511-&gt;decomp_ops
op_assign
...
multiline_comment|/* Unlocks decompression module and nulls ov511-&gt;decomp_ops. Safe to call even&n; * if ov511-&gt;decomp_ops is NULL.&n; */
r_static
r_void
DECL|function|ov51x_release_decompressor
id|ov51x_release_decompressor
c_func
(paren
r_struct
id|usb_ov511
...
id|ov511-&gt;decomp_ops
op_logical_and
id|ov511-&gt;decomp_ops-&gt;decomp_unlock
)paren
(brace
id|ov511-&gt;decomp_ops
op_member_access_from_pointer
...
r_static
r_void
DECL|function|ov51x_decompress
id|ov51x_decompress
c_func
(paren
r_struct
...
id|VIDEO_PALETTE_GREY
op_logical_and
id|ov511-&gt;decomp_ops-&gt;decomp_400
)paren
(brace
r_int
id|ret
...
c_cond
(paren
id|ov511-&gt;decomp_ops-&gt;decomp_420
)paren
(brace
r_int
id|ret
...
r_static
r_void
DECL|function|ov511_postprocess
id|ov511_postprocess
c_func
(paren
r_struct
id|usb_ov511
...
c_func
(paren
l_string|&quot;Cannot convert data to this format&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;packet header (%3d): %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x&quot;
comma
id|cdata
(braket
id|ov511-&gt;packet_size
...
l_int|4
comma
l_string|&quot;Frame end, curframe = %d, packnum=%d, hw=%d, vw=%d, recvd=%d&quot;
comma
id|ov511-&gt;curframe
comma
(paren
...
macro_line|#if 0
multiline_comment|/* Skip packet if first 9 bytes are zero. These are common, so&n;&t;&t; * we use a less expensive test here instead of later */
r_if
c_cond
(paren
id|frame-&gt;compressed
...
l_int|5
comma
l_string|&quot;Skipping packet (all zero)&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* OV518(+) has no packet numbering */
id|data_size
op_assign
id|ov511-&gt;packet_size
suffix:semicolon
...
l_int|4
comma
l_string|&quot;No frame currently active&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
id|d
suffix:semicolon
multiline_comment|/* Print all data */
r_for
c_loop
(paren
id|d
...
c_func
(paren
l_string|&quot;%4x: %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x&quot;
comma
id|d
comma
id|cdata
...
c_func
(paren
l_string|&quot;packet header: %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x %2x&quot;
comma
id|cdata
(braket
l_int|0
...
multiline_comment|/* A false positive here is likely, until OVT gives me&n;&t;&t; * the definitive SOF/EOF format */
r_if
c_cond
(paren
(paren
...
r_else
(brace
multiline_comment|/* All incoming data are divided into 8-byte segments. If the&n;&t;&t;&t; * segment contains all zero bytes, it must be skipped. These&n;&t;&t;&t; * zero-segments allow the OV518 to mainain a constant data rate&n;&t;&t;&t; * regardless of the effectiveness of the compression. Segments&n;&t;&t;&t; * are aligned relative to the beginning of each isochronous&n;&t;&t;&t; * packet. The first segment is a header.&n;&t;&t;&t; */
r_int
id|b
comma
id|in
...
l_int|0
suffix:semicolon
singleline_comment|// Decompressor expects the header
macro_line|#if 0
r_if
c_cond
(paren
...
r_static
r_int
DECL|function|ov511_ioctl_internal
id|ov511_ioctl_internal
c_func
(paren
r_struct
id|video_device
...
l_int|0
suffix:semicolon
singleline_comment|//&t;&t;v.flags |= (ov511-&gt;has_decoder) ? VIDEO_VC_NORM : 0;
id|v.tuners
op_assign
(paren
id|ov511-&gt;has_tuner
...
r_static
r_int
DECL|function|ov511_control_ioctl
id|ov511_control_ioctl
c_func
(paren
r_struct
...
r_else
(brace
multiline_comment|/* 352x288 not working with OV518 yet */
id|ov511-&gt;maxwidth
op_assign
l_int|320
suffix:semicolon
...
comma
multiline_comment|/* Reset snapshot */
(brace
id|OV511_REG_BUS
comma
l_int|0x52
...
c_func
(paren
l_string|&quot;USB OV518 camera found&quot;
)paren
suffix:semicolon
id|ov511-&gt;bridge
op_assign

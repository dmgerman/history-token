...
id|swapRGB
comma
l_string|&quot;Swap red and blue, e.g., for xawtv&quot;
)paren
suffix:semicolon
id|MODULE_PARM
(paren
...
suffix:semicolon
multiline_comment|/* clear output matrix. Maybe not necessary. */
r_for
c_loop
(paren
id|y
...
l_int|3
suffix:semicolon
multiline_comment|/* output already zeroed out with memset */
op_star
(paren
id|output
op_plus
...
l_int|2
comma
l_string|&quot;STV(i): palette set to RGB in VIDIOSPICT&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|2
comma
l_string|&quot;STV(i): VIDIOCMCAPTURE swapRGB is ON&quot;
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;STV(e): VIDIOCMCAPTURE grabstate != FRAME_UNUSED&quot;
)paren
suffix:semicolon
r_return
op_minus

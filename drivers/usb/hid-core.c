multiline_comment|/*&n; * $Id: hid-core.c,v 1.8 2001/05/23 12:02:18 vojtech Exp $&n; *&n; *  Copyright (c) 1999 Andreas Gal&n; *  Copyright (c) 2000-2001 Vojtech Pavlik&n; *&n; *  USB HID support for Linux&n; *&n; *  Sponsored by SuSE&n; */
...
mdefine_line|#define DRIVER_VERSION &quot;v1.8&quot;
...
multiline_comment|/*&n;&t;&t; * Some low-speed devices have large reports and maxpacketsize 8.&n;&t;&t; * We buffer the data in that case and parse it when we got it all.&n;&t;&t; * Works only for unnumbered reports. Doesn&squot;t make sense for numbered&n;&t;&t; * reports anyway - then they don&squot;t need to be large.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;couldn&squot;t allocate report buffer&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;report data buffer overflow&quot;
)paren
suffix:semicolon
id|report-&gt;idx
op_assign
...
multiline_comment|/*&n; * Interrupt input handler.&n; */
...
multiline_comment|/*&n; * hid_read_report() reads in report values without waiting for an irq urb.&n; */
...
c_func
(paren
l_string|&quot;reading report type %d id %d failed len %d read %d&quot;
comma
id|report-&gt;type
op_plus
l_int|1
...
DECL|function|hid_write_report
r_void
id|hid_write_report
c_func
(paren
...
multiline_comment|/*&n; * Initialize all readable reports&n; */
...
suffix:semicolon
DECL|function|get_class_descriptor
r_static
r_int
id|get_class_descriptor
c_func
(paren
r_struct
id|usb_device
...
suffix:semicolon
multiline_comment|/*&n; * Some devices don&squot;t like this and crash. I don&squot;t know of any devices&n; * needing this, so it is disabled for now.&n; */
macro_line|#if 0
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;: USB HID v%x.%02x %s [%s] on usb%d:%d.%d&bslash;n&quot;
comma
id|hid-&gt;version
op_rshift
l_int|8

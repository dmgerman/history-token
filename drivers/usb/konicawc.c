multiline_comment|/*&n; * $Id$&n; *&n; * konicawc.c - konica webcam driver&n; *&n; * Author: Simon Evans &lt;spse@secret.org.uk&gt;&n; *&n; * Copyright (C) 2002 Simon Evans&n; *&n; * Licence: GPL&n; * &n; * Driver for USB webcams based on Konica chipset. This&n; * chipset is used in Intel YC76 camera.&n; *&n; */
...
mdefine_line|#define MAX_WHITEBAL&t;372
DECL|macro|MAX_SPEED
mdefine_line|#define MAX_SPEED&t;6
DECL|macro|MAX_CAMERAS
mdefine_line|#define MAX_CAMERAS&t;1
DECL|macro|DRIVER_VERSION
mdefine_line|#define DRIVER_VERSION&t;&quot;v1.1&quot;
DECL|macro|DRIVER_DESC
mdefine_line|#define DRIVER_DESC&t;&quot;Konica Webcam driver&quot;
DECL|enum|ctrl_req
r_enum
id|ctrl_req
(brace
...
l_int|6
suffix:semicolon
multiline_comment|/* Speed (fps) 0 (slowest) to 6 (fastest) */
...
suffix:semicolon
DECL|variable|speed_to_interface
r_static
r_int
id|speed_to_interface
(braket
)braket
op_assign
(brace
...
suffix:semicolon
multiline_comment|/* These FPS speeds are from the windows config box. They are&n; * indexed on size (0-2) and speed (0-6). Divide by 3 to get the&n; * real fps.&n; */
DECL|variable|speed_to_fps
r_static
r_int
id|speed_to_fps
(braket
...
id|speed
suffix:semicolon
multiline_comment|/* Stored as 0 - 6, used as index in speed_to_* (above) */
DECL|member|size
id|u8
id|size
suffix:semicolon
...
DECL|function|konicawc_adjust_picture
r_static
r_void
...
(brace
multiline_comment|/* This one is the requested one */
id|actInterface
op_assign
id|i
suffix:semicolon
...
c_func
(paren
l_string|&quot;Selecting requested active setting=%d. maxPS=%d.&quot;
comma
id|i
comma
id|maxPS
...
c_func
(paren
l_string|&quot;Cant find required endpoint&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
id|speed
comma
l_string|&quot;FPS speed: 0 (slowest) - 6 (fastest)&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func

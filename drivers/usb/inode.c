...
multiline_comment|/* --------------------------------------------------------------------- */
multiline_comment|/*&n; * This list of superblocks is still used,&n; * but since usbdevfs became FS_SINGLE&n; * there is only one super_block.&n; */
r_static
id|LIST_HEAD
c_func
(paren
...
id|busmode
suffix:semicolon
id|s-&gt;u.usbdevfs_sb.listuid
op_assign
id|listuid
suffix:semicolon
id|s-&gt;u.usbdevfs_sb.listgid
op_assign
id|listgid
suffix:semicolon
id|s-&gt;u.usbdevfs_sb.listmode
op_assign
id|listmode
suffix:semicolon
r_return
...
DECL|function|usbdevfs_remount
r_static
r_int
id|usbdevfs_remount
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;usbdevfs: remount parameter error&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ret
...
multiline_comment|/*&n; * The usbdevfs name is now depreciated (as of 2.5.1).&n; * It will be removed when the 2.7.x development cycle is started.&n; * You have been warned :)&n; */
r_static
id|DECLARE_FSTYPE
c_func
(paren

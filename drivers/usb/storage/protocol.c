...
c_func
(paren
l_string|&quot;Invoking Mode Translation&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* save the old command for later */
id|old_cmnd
op_assign
id|srb-&gt;cmnd
(braket
...
(brace
multiline_comment|/* change READ_6/WRITE_6 to READ_10/WRITE_10 */
r_case
id|WRITE_6
suffix:colon
r_case
...
multiline_comment|/* switch (srb-&gt;cmnd[0]) */
)brace

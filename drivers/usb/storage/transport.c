...
multiline_comment|/* Some broken devices report odd signatures, so we do not check them&n;&t; * for validity against the spec. We store the first one we see,&n;&t; * and check subsequent transfers for validity against this signature.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;Learnt BCS signature 0x%08X&bslash;n&quot;
comma
id|le32_to_cpu
c_func
(paren

...
c_func
(paren
l_string|&quot;-- command aborted&bslash;n&quot;
)paren
suffix:semicolon
...
r_return
suffix:semicolon
multiline_comment|/* indicate a transport error -- this is the best we can do */
id|us-&gt;irqdata
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;CBI interrupt aborted&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|USB_STOR_TRANSPORT_ABORTED
...
id|pipe
suffix:semicolon
multiline_comment|/* issue the command -- use usb_control_msg() because&n;&t; *  the state machine is not yet alive */
id|pipe
op_assign
id|usb_rcvctrlpipe
c_func
...
suffix:semicolon
multiline_comment|/* Use usb_clear_halt() because the state machine&n;&t;&t; *  is not yet alive */
id|usb_clear_halt
c_func
(paren
id|us-&gt;pusb_dev
...
suffix:semicolon
multiline_comment|/* The timeout event handler&n; */
DECL|function|usb_stor_timeout_handler
r_static
r_void
id|usb_stor_timeout_handler
c_func
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Timeout occurred&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* abort the current request */
id|usb_stor_abort_transport
c_func
(paren
id|us
...
suffix:semicolon
multiline_comment|/* let the reset routine know we have finished */
id|spin_unlock
c_func
(paren
op_amp
...
id|timeout_list
suffix:semicolon
multiline_comment|/* prepare the timeout handler */
id|spin_lock
c_func
(paren
op_amp
id|timeout_data.timer_lock
)paren
suffix:semicolon
id|init_timer
c_func
...
id|Done
suffix:colon
multiline_comment|/* prevent the timer from coming back to haunt us */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* the handler has already started; wait for it to finish */
id|spin_lock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* change the abort into a timeout */
r_if
c_cond
(paren
id|result

multiline_comment|/* Driver for Microtech DPCM-USB CompactFlash/SmartMedia reader&n; *&n; * $Id: dpcm.c,v 1.4 2001/06/11 02:54:25 mdharm Exp $&n; *&n; * DPCM driver v0.1:&n; *&n; * First release&n; *&n; * Current development and maintenance by:&n; *   (c) 2000 Brian Webb (webbb@earthlink.net)&n; *&n; * This device contains both a CompactFlash card reader, which&n; * uses the Control/Bulk w/o Interrupt protocol and&n; * a SmartMedia card reader that uses the same protocol&n; * as the SDDR09.&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2, or (at your option) any&n; * later version.&n; *&n; * This program is distributed in the hope that it will be useful, but&n; * WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU&n; * General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License along&n; * with this program; if not, write to the Free Software Foundation, Inc.,&n; * 675 Mass Ave, Cambridge, MA 02139, USA.&n; */

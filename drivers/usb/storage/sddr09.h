...
id|lbact
suffix:semicolon
multiline_comment|/* number of available pages */
DECL|member|flags
r_int
id|flags
suffix:semicolon
DECL|macro|SDDR09_WP
mdefine_line|#define&t;SDDR09_WP&t;1&t;&t;/* write protected */
)brace
suffix:semicolon
macro_line|#endif
eof

...
c_func
(paren
l_string|&quot;SCM data %s transfer %d&bslash;n&quot;
comma
(paren
id|direction
op_eq
...
l_int|1024
suffix:semicolon
multiline_comment|/* scan through the map lookiong for an unused block&n;&t;&t;&t; * leave 16 unused blocks at start (or as many as possible)&n;&t;&t;&t; * since the sddr55 seems to reuse a used block when it shouldn&squot;t&n;&t;&t;&t; * if we don&squot;t leave space */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* oh dear, couldn&squot;t find an unallocated block */
id|US_DEBUGP
c_func
(paren
...
multiline_comment|/* if we detected a problem with the map when writing, don&squot;t allow any more access */
r_if
c_cond
(paren
id|info-&gt;fatal_error
...
id|capacity
suffix:semicolon
multiline_comment|/* figure out the maximum logical block number, allowing for the fact&n;                 * that only 250 out of every 256 are used */
id|info-&gt;max_log_blks
op_assign
(paren
(paren

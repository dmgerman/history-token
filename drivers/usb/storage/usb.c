...
multiline_comment|/* handle requests for EVPD, which most USB devices do&n;&t;&t; * not support */
r_else
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;Faking INQUIRY command for EVPD&bslash;n&quot;
)paren
suffix:semicolon
id|memcpy
c_func
...
(brace
multiline_comment|/* INQUIRY should always work, per spec... */
r_int
r_char
id|data_ptr
(braket
...
suffix:semicolon
multiline_comment|/* largest SCSI-III cmd */
id|__u8
id|old_cmd_len
suffix:semicolon
id|US_DEBUGP
c_func
(paren
l_string|&quot;Converting START_STOP to TUR&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* save old command */
id|memcpy
c_func
(paren
id|saved_cdb
...
id|us-&gt;srb-&gt;cmd_len
suffix:semicolon
multiline_comment|/* set up new command -- preserve LUN */
id|us-&gt;srb-&gt;cmd_len
op_assign
l_int|6
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* restore original command */
id|us-&gt;srb-&gt;cmd_len
op_assign
id|old_cmd_len
suffix:semicolon
...
multiline_comment|/* unlock the data structure */
id|up
c_func
(paren
op_amp
...
multiline_comment|/* ss-&gt;protocol == US_PR_CBI */
r_return
l_int|0
suffix:semicolon

...
id|usblp-&gt;ifnum
suffix:semicolon
multiline_comment|/* High byte has the interface index.&n;&t;   Low byte has the alternate setting.&n;&t; */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;usblp_control_msg: rq: 0x%02x dir: %d recip: %d value: %d idx: %d len: %#x result: %d&quot;
comma
id|request
comma
op_logical_neg
...
c_func
(paren
l_string|&quot;usblp_ioctl: cmd=0x%x (%c nr=%d len=%d dir=%d)&quot;
comma
id|cmd
comma
id|_IOC_TYPE
...
multiline_comment|/* We must increment writecount here, and not at the&n;&t;&t; * end of the loop. Otherwise, the final loop iteration may&n;&t;&t; * be skipped, leading to incomplete printer output.&n;&t;&t; */
id|writecount
op_add_assign
id|transfer_length
suffix:semicolon

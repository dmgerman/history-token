...
id|dev-&gt;actconfig
suffix:semicolon
multiline_comment|/* We know we&squot;re probe()d with the control interface. */
id|ifcom
op_assign
...
multiline_comment|/* there&squot;s been a problem */
r_if
c_cond
(paren
op_logical_neg

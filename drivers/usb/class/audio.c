...
(paren
id|KERN_WARNING
l_string|&quot;usbaudio: device %d interface %d altsetting %d claims adaptive in &quot;
l_string|&quot;but has invalid synch pipe; treating as asynchronous in&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|u-&gt;interface
...
(paren
id|KERN_WARNING
l_string|&quot;usbaudio: device %d interface %d altsetting %d claims asynch out &quot;
l_string|&quot;but has invalid synch pipe; treating as adaptive out&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|u-&gt;interface
...
(paren
id|KERN_ERR
l_string|&quot;prepmixch: out of memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: device %d audiocontrol interface %u interface %u has no altsetting 0&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|ctrlif
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: device %d audiocontrol interface %u interface %u has no altsetting 1&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|ctrlif

...
mdefine_line|#define DRIVER_DESC &quot;USB Bluetooth tty driver&quot;
...
DECL|function|get_bluetooth_by_index
r_static
r_inline
r_struct
id|usb_bluetooth
op_star
id|get_bluetooth_by_index
(paren
r_int
id|index
)paren
...
multiline_comment|/* keep increasing the urb transfer buffer to fit the size of the message */
r_if
c_cond
(paren
...
multiline_comment|/* we are done with this urb, so let the host driver&n;&t;&t;&t; * really free it when it is finished with it */
id|usb_free_urb
(paren
id|urb
)paren
...
id|ENOMEM
suffix:semicolon
id|bluetooth_tty_driver-&gt;owner
op_assign
id|THIS_MODULE
suffix:semicolon
id|bluetooth_tty_driver-&gt;driver_name
op_assign
...
suffix:semicolon
id|bluetooth_tty_driver-&gt;minor_start
op_assign
l_int|0
suffix:semicolon
id|bluetooth_tty_driver-&gt;type
op_assign
id|TTY_DRIVER_TYPE_SERIAL
suffix:semicolon
id|bluetooth_tty_driver-&gt;subtype
op_assign
id|SERIAL_TYPE_NORMAL
suffix:semicolon
id|bluetooth_tty_driver-&gt;flags
op_assign

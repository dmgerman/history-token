...
mdefine_line|#define DRIVER_VERSION &quot;v0.0.1&quot;
...
mdefine_line|#define&t;RTL8150_MAX_MTU&t;&t;1500
...
c_func
(paren
l_string|&quot;async registers change in progress&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;ethID-&gt;%02x:%02x:%02x:%02x:%02x:%02x&quot;
comma
id|node_id
(braket
l_int|0
...
c_func
(paren
l_string|&quot;&bslash;b ..done&bslash;n&quot;
)paren
suffix:semicolon
id|memset
c_func
...
id|dev-&gt;netdev
suffix:semicolon
multiline_comment|/* info(&quot;%s: Tx errs %02x:%02x:%02x:%02x&quot;, dev-&gt;netdev-&gt;name,&n;&t;     d[0], d[1], d[2], d[3]); */
)brace
...
c_func
(paren
l_string|&quot;%s: the rtl8150 is detected&quot;
comma
id|netdev-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;compiled %s %s&bslash;n&quot;
comma
id|__DATE__
comma
id|__TIME__

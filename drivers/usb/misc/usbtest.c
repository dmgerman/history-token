...
mdefine_line|#define NUM_SUBCASES&t;13&t;&t;/* how many test subcases here? */
DECL|struct|subcase
r_struct
id|subcase
(brace
...
suffix:semicolon
multiline_comment|/* ezusb family device with dedicated usb test firmware,&n; * or a peripheral running Linux and &squot;zero.c&squot; test firmware.&n; *&n; * FIXME usbtest should read the descriptors, since compatible&n; * test firmware might run on hardware (pxa250 for one) that&n; * can&squot;t configure an ep2in-bulk.&n; */

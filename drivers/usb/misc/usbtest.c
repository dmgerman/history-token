...
multiline_comment|/*-------------------------------------------------------------------------*/
multiline_comment|/* use ch9 requests to test whether:&n; *   (a) queues work for control, keeping N subtests queued and&n; *       active (auto-resubmit) for M loops through the queue.&n; *   (b) protocol stalls (control-only) will autorecover.&n; *       it&squot;s quite not like bulk/intr; no halt clearing.&n; *   (c) short control reads are reported and handled.&n; */
...
op_decrement
suffix:semicolon
multiline_comment|/* FIXME verify that the completions are in the right sequence.&n;&t; * we could store the test number with the setup packet, that&n;&t; * buffer has extra space.&n;&t; */
r_switch
c_cond
(paren
id|status
...
id|EPIPE
suffix:colon
multiline_comment|/* (protocol) stall */
r_if
c_cond
(paren
id|reqp-&gt;bRequestType
...
l_int|0
suffix:semicolon
multiline_comment|/* some stalls we plan on; others would be errors */
r_if
c_cond
(paren
id|status
...
r_break
suffix:semicolon
multiline_comment|/* else FALLTHROUGH */
id|error
suffix:colon
r_default
suffix:colon
...
multiline_comment|/* this fault&squot;s an error */
r_if
c_cond
(paren
id|ctx-&gt;status
...
suffix:semicolon
multiline_comment|/* FIXME use this &quot;unlink everything&quot; exit route&n;&t;&t;&t; * in all cases, not just for fault cleanup.&n;&t;&t;&t; * it&squot;ll be another test mode, but one that makes&n;&t;&t;&t; * testing be more consistent.&n;&t;&t;&t; */
...
op_mod
l_int|12
multiline_comment|/* number of subtest cases here */
)paren
(brace
r_case
l_int|0
...
id|dbg
(paren
l_string|&quot;%s TEST 10:  queue %d control calls, %d times&quot;
comma
id|dev-&gt;id
comma
id|param-&gt;sglen
...
id|dbg
(paren
l_string|&quot;%s TEST 11:  unlink %d reads of %d&quot;
comma
id|dev-&gt;id
comma
id|param-&gt;iterations
...
id|dbg
(paren
l_string|&quot;%s TEST 12:  unlink %d writes of %d&quot;
comma
id|dev-&gt;id
comma
id|param-&gt;iterations

...
suffix:semicolon
DECL|member|recvqueue_tasklet
r_struct
id|tasklet_struct
id|recvqueue_tasklet
suffix:semicolon
)brace
suffix:semicolon
...
id|PDEBUG
(paren
l_string|&quot;udsl_atm_processqueue: got packet %p with length %d and status %d&bslash;n&quot;
comma
id|urb
comma
...
id|PDEBUG
(paren
l_string|&quot;udsl_atm_processqueue: processing urb with ctx %p, urb %p, skb %p&bslash;n&quot;
comma
id|ctx
comma
id|urb
...
id|PDEBUG
(paren
l_string|&quot;udsl_atm_processqueue: submission failed&bslash;n&quot;
)paren
suffix:semicolon
...
id|PDEBUG
(paren
l_string|&quot;udsl_atm_processqueue: adding to spare_receivers&bslash;n&quot;
)paren
suffix:semicolon
id|spin_lock_irqsave
(paren
...
id|PDEBUG
(paren
l_string|&quot;udsl_atm_processqueue successful&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
id|PDEBUG
(paren
l_string|&quot;udsl_usb_data_receive entered&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|PDEBUG
(paren
l_string|&quot;udsl_usb_data_receive: bad urb!&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* receive urb init */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* no need to take the spinlock - recvqueue_tasklet is not running */
id|list_for_each
(paren
id|pos
comma
...
r_break
suffix:semicolon
multiline_comment|/* not all urbs accounted for */
id|yield
(paren
)paren
suffix:semicolon
...
id|PDEBUG
(paren
l_string|&quot;udsl_usb_disconnect: flushing %u completed receivers&bslash;n&quot;
comma
id|count
)paren
suffix:semicolon
multiline_comment|/* no need to take the spinlock - no completion handlers running */
id|INIT_LIST_HEAD
(paren
op_amp
id|instance-&gt;completed_receivers

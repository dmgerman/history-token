...
multiline_comment|/* encapsulate in an AAL5 frame, which is then split into ATM cells */
DECL|function|atmsar_encode
r_int
r_int
id|atmsar_encode
(paren
...
id|PDEBUG
(paren
l_string|&quot;atmsar_encode entered&bslash;n&quot;
)paren
suffix:semicolon
id|PDEBUG
(paren
l_string|&quot;pdu_length %d, num_cells %d, num_pdu_cells %d, aal5_length %d, zero_padding %d, final_length %d&bslash;n&quot;
comma
id|pdu_length
comma
id|num_cells

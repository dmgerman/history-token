...
multiline_comment|/*&n; * Start checking for one or two bulk endpoints and an optional&n; * interrupt endpoint. If we have an interrupt endpoint go ahead and&n; * setup the handler. FIXME: This is a future enhancement...&n; */
id|dbg
c_func
(paren
...
c_func
(paren
l_string|&quot;probe_scanner: Only 1, 2, or 3 endpoints supported.&quot;
)paren
suffix:semicolon
r_return
op_minus

...
multiline_comment|/**&n; * usb_make_path - returns device path in the hub tree&n; * @dev: the device whose path is being constructed&n; * @buf: where to put the string&n; * @size: how big is &quot;buf&quot;?&n; *&n; * Returns length of the string (&gt;= 0) or out of memory status (&lt; 0).&n; */

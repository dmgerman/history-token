...
multiline_comment|/****************************************************************************&n; * Modules paramaters                                                       *&n; ****************************************************************************/
...
c_func
(paren
l_string|&quot;Luca Risolia &lt;luca_ing@libero.it&gt;&quot;
)paren
suffix:semicolon
id|MODULE_DESCRIPTION
c_func
(paren
l_string|&quot;Video4Linux driver for &quot;
l_string|&quot;W996[87]CF JPEG USB Dual Mode Camera Chip&quot;
)paren
suffix:semicolon
...
l_string|&quot;&bslash;nYou can specify &quot;
id|__MODULE_STRING
c_func
(paren
id|W9968CF_MAX_DEVICES
...
id|max_buffers
comma
l_string|&quot;&bslash;n&lt;n[,...]&gt; Only for advanced users.&quot;
...
id|sensor_mono
comma
l_string|&quot;&bslash;n&lt;0|1[,...]&gt; The OV CMOS sensor is monochrome:&quot;
l_string|&quot;&bslash;n 0 = no, 1 = yes&quot;
l_string|&quot;&bslash;nDefault value is &quot;
id|__MODULE_STRING
c_func
...
l_string|&quot;&bslash;n0 = none (be cautious)&quot;
...
r_static
r_int
id|w9968cf_sensor_change_settings
c_func
(paren
r_struct
id|w9968cf_device
...
multiline_comment|/* Shameless copy from bttv-driver.c */
...
multiline_comment|/* End of shameless copy */
...
multiline_comment|/*--------------------------------------------------------------------------&n;  Write data to the fast serial bus registers.&n;  Return 0 on success, -1 otherwise.&n;  --------------------------------------------------------------------------*/
...
(brace
multiline_comment|/* Work around: this seems to wake up  &n;&t;&t;&t;&t;&t;   the EEPROM from the stall state */
r_for
c_loop
(paren
id|j
...
multiline_comment|/* This works around a bug in the I2C core */
r_if
c_cond
(paren
id|rc
...
l_int|1
comma
l_string|&quot;CMOS sensor initialization failed (rc=%d)&quot;
comma
id|rc
)paren
suffix:semicolon
...
l_int|4
comma
l_string|&quot;Rejected client [%s] with [%s]&quot;
comma
id|clientname
comma
...
l_int|2
comma
l_string|&quot;I2C attach client [%s] with [%s]&quot;
comma
id|clientname
comma
id|client-&gt;driver-&gt;name
...
l_int|6
comma
l_string|&quot;Registering I2C bus with kernel...&quot;
)paren
id|rc
op_assign
id|i2c_add_adapter
...
l_int|5
comma
l_string|&quot;Failed to register the I2C bus.&quot;
)paren
r_else
id|DBG
c_func
...
multiline_comment|/* Setup the sensor window */
id|s_win.format
op_assign
id|SENSOR_FORMAT
suffix:semicolon
...
l_int|6
comma
l_string|&quot;Executing CMOS sensor command...&quot;
)paren
r_if
c_cond
(paren
...
multiline_comment|/*--------------------------------------------------------------------------&n;  Change some settings of the CMOS sensor.&n;  Returns: 0 for success, a negative number otherwise.&n;  --------------------------------------------------------------------------*/
DECL|function|w9968cf_sensor_change_settings
r_static
r_int
id|w9968cf_sensor_change_settings
c_func
...
multiline_comment|/*--------------------------------------------------------------------------&n;  Get some current picture settings from the CMOS sensor.&n;  Returns: 0 for success, a negative number otherwise.&n;  --------------------------------------------------------------------------*/
r_static
r_int
...
id|v
suffix:semicolon
multiline_comment|/* Don&squot;t return error if a setting is unsupported, or rest of settings&n;&t;   will not be performed */
id|rc
op_assign
id|w9968cf_sensor_get_control
c_func
...
multiline_comment|/*--------------------------------------------------------------------------&n;  Change picture settings of the CMOS sensor.&n;  Returns: 0 for success, a negative number otherwise.&n;  --------------------------------------------------------------------------*/
r_static
r_int
DECL|function|w9968cf_sensor_set_picture
id|w9968cf_sensor_set_picture
c_func
(paren
r_struct
...
multiline_comment|/*--------------------------------------------------------------------------&n;  This function is called when the CMOS sensor is detected.&n;  --------------------------------------------------------------------------*/
DECL|function|w9968cf_sensor_configure
r_static
r_void
id|w9968cf_sensor_configure
c_func
...
l_int|5
comma
l_string|&quot;CMOS sensor %s configured.&quot;
comma
id|symbolic
c_func
(paren
...
l_int|5
comma
l_string|&quot;Opening the %s, /dev/video%d ...&quot;
comma
id|symbolic
c_func
(paren
...
r_static
r_int
DECL|function|w9968cf_do_ioctl
id|w9968cf_do_ioctl
c_func
(paren
r_struct
...
l_int|4
comma
l_string|&quot;Depth %d bpp is not supported for %s palette. &quot;
l_string|&quot;VIDIOCSPICT failed.&quot;
comma
id|pict.depth
comma
id|symbolic
...
l_int|1
comma
l_string|&quot;Device configuration failed.&quot;
)paren
r_return
op_minus
id|EIO
...
multiline_comment|/* Ok, add a new entry into the list of V4L registered devices */
id|down
c_func
(paren
op_amp

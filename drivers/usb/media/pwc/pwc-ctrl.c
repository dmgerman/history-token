...
c_func
(paren
l_string|&quot;Using alternate setting %d.&bslash;n&quot;
comma
id|pChoose-&gt;alternate
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t;case VIDIOCPWCGVIDTABLE:&n;&t;{&n;&t;&t;ARG_DEF(struct pwc_table_init_buffer, table);&n;&t;&t;ARGR(table).len = pdev-&gt;cmd_len;&n;&t;&t;memcpy(&amp;ARGR(table).buffer, pdev-&gt;decompress_data, pdev-&gt;decompressor-&gt;table_size);&n;&t;&t;ARG_OUT(table)&n;&t;&t;break;&n;&t;}&n;&t;*/
r_default
suffix:colon
id|ret
op_assign

...
c_func
(paren
l_string|&quot;Failed to allocate image buffer(s). needed (%d)&bslash;n&quot;
comma
id|default_mbufs
op_star
id|pdev-&gt;len_per_image
...
id|EFAULT
suffix:semicolon
macro_line|#if LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,6,5)
id|idesc
op_assign
op_amp
...
c_func
(paren
l_string|&quot;Luc Saillard &lt;luc@saillard.org&gt;&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

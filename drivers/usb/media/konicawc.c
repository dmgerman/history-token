multiline_comment|/*&n; * konicawc.c - konica webcam driver&n; *&n; * Author: Simon Evans &lt;spse@secret.org.uk&gt;&n; *&n; * Copyright (C) 2002 Simon Evans&n; *&n; * Licence: GPL&n; *&n; * Driver for USB webcams based on Konica chipset. This&n; * chipset is used in Intel YC76 camera.&n; *&n; */
...
mdefine_line|#define DRIVER_VERSION&t;&quot;v1.4&quot;
...
id|speed
suffix:semicolon
multiline_comment|/* Stored as 0 - 6, used as index in spd_to_* (above) */
DECL|member|size
id|u8
id|size
suffix:semicolon
...
id|lastframe
suffix:semicolon
DECL|member|cur_frame_size
r_int
id|cur_frame_size
suffix:semicolon
multiline_comment|/* number of bytes in current frame size */
DECL|member|maxline
r_int
id|maxline
suffix:semicolon
multiline_comment|/* number of lines per frame */
DECL|member|yplanesz
r_int
id|yplanesz
suffix:semicolon
multiline_comment|/* Number of bytes in the Y plane */
DECL|member|buttonsts
r_int
r_int
id|buttonsts
suffix:colon
...
DECL|function|konicawc_camera_on
r_static
r_inline
r_void
...
DECL|function|konicawc_camera_off
r_static
r_inline
r_void
...
DECL|function|konicawc_set_camera_size
r_static
r_void
...
suffix:semicolon
multiline_comment|/* sts: 0x80-0xff: frame start with frame number (ie 0-7f)&n;&t;&t; * otherwise:&n;&t;&t; * bit 0 0: keep packet&n;&t;&t; *&t; 1: drop packet (padding data)&n;&t;&t; *&n;&t;&t; * bit 4 0 button not clicked&n;&t;&t; *       1 button clicked&n;&t;&t; * button is used to `take a picture&squot; (in software)&n;&t;&t; */
r_if
c_cond
(paren
id|sts
...
l_int|2
comma
l_string|&quot;dropping frame looking for image start&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
l_int|3
comma
l_string|&quot;submitting urb of length %d&quot;
comma
...
c_func
(paren
l_string|&quot;usb_submit_urb error (%d)&quot;
comma
id|ret
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;got frame %d len = %d buflen =%d&quot;
comma
id|urb-&gt;start_frame
comma
...
id|urb-&gt;start_frame
op_ne
id|cam-&gt;last_data_urb-&gt;start_frame
)paren
(brace
id|err
c_func
(paren
l_string|&quot;Lost sync on frames&quot;
)paren
suffix:semicolon
)brace
r_else
...
l_int|2
comma
l_string|&quot;dropped %d bytes looking for new frame&quot;
comma
id|drop
)paren
suffix:semicolon
...
DECL|function|konicawc_find_fps
r_static
r_int
id|konicawc_find_fps
c_func
(paren
r_int
id|size
...
l_int|1
comma
l_string|&quot;konica_find_fps: size = %d fps = %d&quot;
comma
id|size
comma
id|fps
...
l_int|2
comma
l_string|&quot;fps %d between %d and %d&quot;
comma
id|fps
comma
id|i
...
DECL|function|konicawc_set_video_mode
r_static
r_int
...
l_int|2
comma
l_string|&quot;trying to find size %d,%d&quot;
comma
id|x
comma
id|y
...
l_int|1
comma
l_string|&quot;trying to set fps to %d&quot;
comma
id|fps
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;find_fps returned %d (%d)&quot;
comma
id|newspeed
comma
id|spd_to_fps
...
l_int|1
comma
l_string|&quot;setting size to %d speed to %d&quot;
comma
id|newsize
comma
id|newspeed
...
l_int|0
comma
l_string|&quot;setting to  %dx%d @ %d fps&quot;
comma
id|camera_sizes
(braket
id|newsize
...
multiline_comment|/* Flush the input queue and clear any current frame in progress */
id|RingQueue_Flush
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;Incorrect number of alternate settings (%d) for this camera!&quot;
comma
id|nas
)paren
suffix:semicolon
...
macro_line|#ifdef CONFIG_INPUT
multiline_comment|/* Register input device for button */
id|memset
c_func
(paren
op_amp
...
id|cam-&gt;input.name
op_assign
l_string|&quot;Konicawc snapshot button&quot;
suffix:semicolon
id|cam-&gt;input
dot
r_private
...
suffix:semicolon
id|cam-&gt;input.id.bustype
op_assign
id|BUS_USB
suffix:semicolon
id|cam-&gt;input.id.vendor
op_assign
id|le16_to_cpu
c_func
(paren
...
c_func
(paren
l_string|&quot;konicawc: %s on %s&bslash;n&quot;
comma
id|cam-&gt;input.name
comma
id|cam-&gt;input.phys

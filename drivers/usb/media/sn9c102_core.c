...
suffix:semicolon
multiline_comment|/* Number of random bytes that complete the SOF above headers */
DECL|macro|SN9C102_SOFLEN
mdefine_line|#define SN9C102_SOFLEN 5
...
multiline_comment|/* NOTE: It is probably correct to assume that SOF and EOF&n;&t;&t;         headers do not occur between two consecutive packets,&n;&t;&t;         but who knows..Whatever is the truth, this assumption&n;&t;&t;         doesn&squot;t introduce bugs. */
id|redo
suffix:colon
id|sof
op_assign
...
multiline_comment|/* NOTE 1: being inside one of the following methods implies that the v4l&n;           device exists for sure (see kobjects and reference counters)&n;   NOTE 2: buffers are PAGE_SIZE long */
...
r_static
id|ssize_t
DECL|function|sn9c102_store_redblue
id|sn9c102_store_redblue
c_func
(paren
r_struct
id|class_device
...
l_int|0
suffix:semicolon
multiline_comment|/* These are a sort of stroboscopic signal for some sensors */
id|err
op_add_assign
id|sn9c102_write_reg
c_func
...
suffix:semicolon
(brace
multiline_comment|/* calculate the scaling factor */
id|u32
id|a
comma
id|b
...
l_int|1
comma
l_string|&quot;Sorry, this is not a SN9C10[12] based camera &quot;

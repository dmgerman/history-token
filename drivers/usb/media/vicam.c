...
id|needsDummyRead
suffix:semicolon
DECL|member|framebuf_size
id|u32
id|framebuf_size
suffix:semicolon
singleline_comment|// # of valid bytes in framebuf
DECL|member|framebuf_read_start
id|u32
id|framebuf_read_start
suffix:semicolon
singleline_comment|// position in frame buf that a read is happening at.
...
id|status
suffix:semicolon
singleline_comment|// for reasons not yet known to me, you can&squot;t send USB control messages
singleline_comment|// with data in the module (if you are compiled as a module).  Whatever
singleline_comment|// the reason, copying it to memory allocated as kernel memory then
singleline_comment|// doing the usb control message fixes the problem.
r_int
r_char
op_star
id|transfer_buffer
...
DECL|macro|DATA_HEADER_SIZE
mdefine_line|#define DATA_HEADER_SIZE 64
singleline_comment|// --------------------------------------------------------------------------------
singleline_comment|//&t;vicam_decode_color - Convert from Vicam Y-Cr-Cb to RGB
singleline_comment|//
...
suffix:semicolon
id|cam-&gt;framebuf_size
op_assign
l_int|320
op_star
l_int|240
op_star
id|VICAM_BYTES_PER_PIXEL
suffix:semicolon
id|cam-&gt;framebuf_read_start
op_assign
l_int|0
suffix:semicolon
r_return
...
id|EINVAL
suffix:semicolon
singleline_comment|// This is some code that will hopefully allow us to do shell copies from
singleline_comment|// the /dev/videoX to a file and have it actually work.
r_if
c_cond
(paren
id|cam-&gt;framebuf_size
...
(brace
singleline_comment|// count does not exceed available bytes
id|copy_to_user
c_func
(paren
id|buf
...
singleline_comment|// read_frame twice because the camera doesn&squot;t seem to take the shutter speed for the first one.
id|read_frame
c_func
(paren
id|cam
...
id|out
comma
l_string|&quot;Vicam-based WebCam Linux Driver.&bslash;n&quot;
)paren
suffix:semicolon
id|out
op_add_assign
...
id|out
comma
l_string|&quot;(c) 2002 Joe Burks (jburks@wavicle.org)&bslash;n&quot;
)paren
suffix:semicolon
id|out
op_add_assign
...
id|out
comma
l_string|&quot;    Shutter Speed: 1/%d&bslash;n&quot;
comma
id|cam-&gt;shutter_speed
)paren
suffix:semicolon
...
r_static
r_int
DECL|function|vicam_write_proc
id|vicam_write_proc
c_func
(paren
r_struct
...
l_int|0
suffix:semicolon
singleline_comment|// I&squot;m not sure buffer is gauranteed to be null terminated
singleline_comment|// so I do this to make sure I have a null in there.
id|strncpy
c_func
(paren
id|in
...
macro_line|#endif
r_int
DECL|function|vicam_video_init
id|vicam_video_init
c_func
(paren
r_struct
...
(brace
singleline_comment|// This would normally create the proc entry for this camera
macro_line|#ifdef CONFIG_PROC_FS
id|vicam_create_proc_entry
c_func
(paren

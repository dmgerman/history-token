...
macro_line|#endif
multiline_comment|/*&n; * Probing and Initialization&n; */
DECL|function|pnpbios_prepare_bios_calls
r_static
r_void
id|pnpbios_prepare_bios_calls
c_func
(paren
r_union
id|pnp_bios_expansion_header
...
DECL|function|pnpbios_probe_installation
r_int

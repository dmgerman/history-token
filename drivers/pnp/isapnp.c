...
multiline_comment|/**&n; * isapnp_dev_driver - get the isapnp_driver of a device&n; * @dev: the device to query&n; *&n; * Returns the appropriate isapnp_driver structure or %NULL if there is no &n; * registered driver for the device.&n; */
DECL|function|isapnp_dev_driver
r_static
r_struct
id|isapnp_driver
op_star
id|isapnp_dev_driver
c_func
(paren
r_const
r_struct
...
suffix:semicolon
multiline_comment|/**&n; * isapnp_register_driver - register a new ISAPnP driver&n; * @drv: the driver structure to register&n; * &n; * Adds the driver structure to the list of registered ISAPnP drivers&n; * Returns the number of isapnp devices which were claimed by the driver&n; * during registration.  The driver remains registered even if the&n; * return value is zero.&n; */
...
multiline_comment|/**&n; * isapnp_unregister_driver - unregister an isapnp driver&n; * @drv: the driver structure to unregister&n; * &n; * Deletes the driver structure from the list of registered ISAPnP drivers,&n; * gives it a chance to clean up by calling its remove() function for&n; * each device it was responsible for, and marks those devices as&n; * driverless.&n; */
...
suffix:semicolon
DECL|variable|isapnp_register_driver
id|EXPORT_SYMBOL
c_func
(paren
id|isapnp_register_driver
...
suffix:semicolon
DECL|variable|isapnp_unregister_driver
id|EXPORT_SYMBOL
c_func
(paren
id|isapnp_unregister_driver
...
suffix:semicolon
DECL|variable|isapnp_device_driver
r_static
r_struct
id|device_driver
...
suffix:semicolon
macro_line|#ifdef MODULE
DECL|function|isapnp_cleanup_device_tree
r_static
r_inline
r_void
id|isapnp_cleanup_device_tree
c_func
(paren
r_void
)paren
...
suffix:semicolon
multiline_comment|/* format is: isapnp_reserve_irq=irq1[,irq2] .... */
DECL|function|isapnp_setup_reserve_irq
r_static
r_int
id|__init
id|isapnp_setup_reserve_irq
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;isapnp_reserve_irq=&quot;
comma
id|isapnp_setup_reserve_irq
)paren
suffix:semicolon
multiline_comment|/* format is: isapnp_reserve_dma=dma1[,dma2] .... */
DECL|function|isapnp_setup_reserve_dma
r_static
r_int
id|__init
id|isapnp_setup_reserve_dma
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;isapnp_reserve_dma=&quot;
comma
id|isapnp_setup_reserve_dma
)paren
suffix:semicolon
multiline_comment|/* format is: isapnp_reserve_io=io1,size1[,io2,size2] .... */
DECL|function|isapnp_setup_reserve_io
r_static
r_int
id|__init
id|isapnp_setup_reserve_io
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;isapnp_reserve_io=&quot;
comma
id|isapnp_setup_reserve_io
)paren
suffix:semicolon
multiline_comment|/* format is: isapnp_reserve_mem=mem1,size1[,mem2,size2] .... */
DECL|function|isapnp_setup_reserve_mem
r_static
r_int
id|__init
id|isapnp_setup_reserve_mem
c_func
(paren
r_char
op_star

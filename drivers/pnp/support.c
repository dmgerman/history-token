multiline_comment|/*&n; * support.c - provides standard pnp functions for the use of pnp protocol drivers,&n; *&n; * Copyright 2002 Adam Belay &lt;ambx1@neo.rr.com&gt;&n; *&n; * Resource parsing functions are based on those in the linux pnpbios driver.&n; * Copyright Christian Schmidt, Tom Lees, David Hinds, Alan Cox, Thomas Hood,&n; * Brian Gerst and Adam Belay.&n; */

...
(paren
id|KERN_INFO
l_string|&quot;Linux Plug and Play Support v0.9 (c) Adam Belay&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|bus_register
...
suffix:semicolon
DECL|variable|pnp_protocol_register
id|EXPORT_SYMBOL
c_func
(paren
id|pnp_protocol_register
...
suffix:semicolon
DECL|variable|pnp_protocol_unregister
id|EXPORT_SYMBOL
c_func
(paren
id|pnp_protocol_unregister

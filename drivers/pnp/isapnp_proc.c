...
c_func
(paren
l_string|&quot;isapnp: configuration start sequence for card %d failed&bslash;n&quot;
comma
id|isapnp_info_card-&gt;number
)paren
suffix:semicolon
...
suffix:semicolon
DECL|function|isapnp_set_allow_dma0
r_static
r_int
id|isapnp_set_allow_dma0
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;isapnp: wrong value %i for allow_dma0&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon

...
DECL|function|isapnp_parse_current_resources
r_static
r_int
id|isapnp_parse_current_resources
c_func
(paren
r_struct
id|pnp_dev
...
l_int|1
suffix:semicolon
multiline_comment|/* all we can do is assume 1 :-( */
id|res-&gt;port_resource
(braket
id|tmp
)braket
...
(brace
multiline_comment|/* some isapnp systems forget to set this to 4 so we have to check */
id|res-&gt;dma_resource
(braket
id|tmp
)braket
...
id|isapnp_protocol
suffix:semicolon
multiline_comment|/* read the current resource data */

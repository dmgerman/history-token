...
(brace
multiline_comment|/* We don&squot;t need to do anything but this, the rest is taken care of */
r_if
c_cond
(paren
(paren
...
DECL|variable|isapnp_card_protocol
r_struct
id|pnp_protocol
id|isapnp_card_protocol
op_assign
...
id|name
op_assign
l_string|&quot;ISA Plug and Play - card&quot;
comma
dot
id|get
op_assign
...
id|name
op_assign
l_string|&quot;ISA Plug and Play - device&quot;
comma
dot
id|get
op_assign

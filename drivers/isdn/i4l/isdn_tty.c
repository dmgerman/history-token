...
macro_line|#endif
DECL|macro|RING_TIMEOUT
mdefine_line|#define RING_TIMEOUT     (5*HZ)  /* repeat RING every 5 secs */
...
r_static
r_int
DECL|function|isdn_tty_event_callback
id|isdn_tty_event_callback
c_func
(paren
r_struct
id|isdn_slot
...
r_static
r_int
DECL|function|isdn_tty_readbchan
id|isdn_tty_readbchan
c_func
(paren
r_struct
id|modem_info
...
id|out
suffix:semicolon
macro_line|#warning need fixing /kkeil
id|save_flags
c_func
(paren
id|flags
...
(paren
op_amp
id|info-&gt;escape_timer
)paren
suffix:semicolon
id|info-&gt;escape_timer.data
op_assign
(paren
r_int
r_int
...
id|info
suffix:semicolon
id|info-&gt;connect_timer.function
op_assign
id|isdn_tty_connect_timer
suffix:semicolon
id|init_timer
...
mdefine_line|#define TTY_IS_ACTIVE(info) &bslash;&n;&t;(info-&gt;flags &amp; ISDN_ASYNC_NORMAL_ACTIVE)
r_static
r_int
...
r_static
r_void
DECL|function|isdn_tty_escape_timer
id|isdn_tty_escape_timer
c_func
(paren
r_int
...
multiline_comment|/*&n; * Check Buffer for Modem-escape-sequence, activate timer-callback to&n; * isdn_tty_modem_escape() if sequence found.&n; */
...
r_static
r_void
DECL|function|isdn_tty_ring_timer
id|isdn_tty_ring_timer
c_func
(paren
r_int
...
r_static
r_void
DECL|function|isdn_tty_connect_timer
id|isdn_tty_connect_timer
c_func
(paren
r_int

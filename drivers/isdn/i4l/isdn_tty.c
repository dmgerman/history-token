...
r_static
r_int
DECL|function|isdn_tty_tiocmget
id|isdn_tty_tiocmget
c_func
(paren
r_struct
id|tty_struct
...
r_static
r_int
DECL|function|isdn_tty_tiocmset
id|isdn_tty_tiocmset
c_func
(paren
r_struct
id|tty_struct
...
(paren
id|KERN_DEBUG
l_string|&quot;ttyI%d ioctl TIOCMxxx: %x %x&bslash;n&quot;
comma
id|info-&gt;line
comma
id|set
...
multiline_comment|/*&n; * Perform line-editing of AT-commands&n; *&n; * Parameters:&n; *   p        inputbuffer&n; *   count    length of buffer&n; *   channel  index to line (minor-device)&n; */
r_static
r_int

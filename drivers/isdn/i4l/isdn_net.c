...
id|EV_NET_DIAL
suffix:colon
multiline_comment|/* Wait for D-Channel-connect.&n;&t;&t;&t; * If timeout, dial again (using the next phone number)&n;&t;&t;&t; */
r_if
c_cond
(paren
id|lp-&gt;dtimer

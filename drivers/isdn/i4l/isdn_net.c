multiline_comment|/* $Id: isdn_net.c,v 1.1.2.2 2004/01/12 22:37:19 keil Exp $&n; *&n; * Linux ISDN subsystem, network interfaces and related functions (linklevel).&n; *&n; * Copyright 1994-1998  by Fritz Elfert (fritz@isdn4linux.de)&n; * Copyright 1995,96    by Thinking Objects Software GmbH Wuerzburg&n; * Copyright 1995,96    by Michael Hipp (Michael.Hipp@student.uni-tuebingen.de)&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; * Data Over Voice (DOV) support added - Guy Ellis 23-Mar-02 &n; *                                       guy@traverse.com.au&n; * Outgoing calls - looks for a &squot;V&squot; in first char of dialed number&n; * Incoming calls - checks first character of eaz as follows:&n; *   Numeric - accept DATA only - original functionality&n; *   &squot;V&squot;     - accept VOICE (DOV) only&n; *   &squot;B&squot;     - accept BOTH DATA and DOV types&n; *&n; * Jan 2001: fix CISCO HDLC      Bjoern A. Zeeb &lt;i4l@zabbadoz.net&gt;&n; *           for info on the protocol, see &n; *           http://i4l.zabbadoz.net/i4l/cisco-hdlc.txt&n; */
...
r_static
r_void
id|isdn_net_ciscohdlck_connected
c_func
(paren
id|isdn_net_local
op_star
...
r_static
r_void
id|isdn_net_ciscohdlck_disconnected
c_func
(paren
id|isdn_net_local
op_star
...
id|skb
comma
l_string|&quot;dial rejected: packet filtered&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
r_static
r_void
DECL|function|isdn_net_ciscohdlck_connected
id|isdn_net_ciscohdlck_connected
c_func
(paren
id|isdn_net_local
...
r_static
r_void
DECL|function|isdn_net_ciscohdlck_disconnected
id|isdn_net_ciscohdlck_disconnected
c_func
(paren
id|isdn_net_local
...
r_static
r_void
DECL|function|isdn_net_ciscohdlck_receive
id|isdn_net_ciscohdlck_receive
c_func
(paren
id|isdn_net_local
op_star
...
id|ISDN_NET_ENCAP_SYNCPPP
suffix:colon
multiline_comment|/* huptimer is done in isdn_ppp_push_higher */
id|isdn_ppp_receive
c_func
(paren
id|lp-&gt;netdev
...
suffix:semicolon
multiline_comment|/* Accept DATA and VOICE calls at this stage&n;&t; * local eaz is checked later for allowed call types&n;&t; */
r_if
c_cond
(paren
(paren

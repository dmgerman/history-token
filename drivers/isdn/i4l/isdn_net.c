...
multiline_comment|/* Initiate dialout. Set phone-number-pointer to first number&n; * of interface, number of retries to 0.&n; */
r_static
r_void
...
id|ISDN_STAT_CINF
suffix:colon
multiline_comment|/* Charge-info from TelCo. Calculate interval between&n;&t;&t; * charge-infos and set timestamp for last info for&n;&t;&t; * usage by isdn_net_autohup()&n;&t;&t; */
id|idev-&gt;charge
op_increment
suffix:semicolon
r_switch

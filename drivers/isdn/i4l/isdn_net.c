...
multiline_comment|/*&n; * Perform auto-hangup and cps-calculation for net-interfaces.&n; *&n; * auto-hangup:&n; * Increment idle-counter (this counter is reset on any incoming or&n; * outgoing packet), if counter exceeds configured limit either do a&n; * hangup immediately or - if configured - wait until just before the next&n; * charge-info.&n; */
r_void
...
multiline_comment|/*&n;&t;&t; * Switch to next number or back to start if at end of list.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|ST_CHARGE_NULL
suffix:semicolon
multiline_comment|/* Got incoming Call, setup L2 and L3 protocols,&n;&t;&t;&t;&t;&t; * then wait for D-Channel-connect&n;&t;&t;&t;&t;&t; */
id|cmd.arg
op_assign
id|lp-&gt;l2_proto
op_lshift

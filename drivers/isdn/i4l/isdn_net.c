...
multiline_comment|/* &n; * all frames sent from the (net) LL to a HL driver should go via this function&n; * it&squot;s serialized by the caller holding the idev-&gt;xmit_lock spinlock&n; * must hold mlp-&gt;xmit_lock&n; */
r_void

...
r_return
suffix:semicolon
singleline_comment|// FIXME ugly and recursive
r_if
c_cond
(paren
id|idev-&gt;slave
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_tx_timeout dev %s %d&bslash;n&quot;
comma
id|ndev-&gt;name
comma
id|idev-&gt;dialstate
...
r_static
r_int
DECL|function|isdn_net_force_dial_idev
id|isdn_net_force_dial_idev
c_func
(paren
id|isdn_net_dev
...
c_func
(paren
id|netdev-&gt;local.dev.name
comma
id|name
)paren
suffix:semicolon
id|netdev-&gt;local.dev.priv
op_assign
op_amp
id|netdev-&gt;local
suffix:semicolon
id|netdev-&gt;local.dev.init
op_assign
id|isdn_net_init
suffix:semicolon
r_if
...
id|netdev-&gt;local.dev.tx_timeout
op_assign
id|isdn_net_tx_timeout
suffix:semicolon
id|netdev-&gt;local.dev.watchdog_timeo
op_assign
id|ISDN_NET_TX_TIMEOUT
suffix:semicolon
id|retval
...
id|netdev
suffix:semicolon
id|netdev-&gt;tqueue.sync
op_assign
l_int|0
suffix:semicolon
id|netdev-&gt;tqueue.routine
op_assign
id|isdn_net_softint
suffix:semicolon
id|netdev-&gt;tqueue.data
op_assign
id|netdev
suffix:semicolon
id|spin_lock_init
...
l_int|1
suffix:semicolon
id|netdev-&gt;pre_device
op_assign
op_minus
l_int|1
suffix:semicolon
id|netdev-&gt;pre_channel
op_assign
op_minus
l_int|1
suffix:semicolon
...
id|netdev-&gt;dialstarted
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Jiffies of last dial-start */
id|netdev-&gt;dialwait_timer
op_assign
l_int|0
suffix:semicolon
...
(paren
op_amp
id|netdev-&gt;dial_timer
)paren
suffix:semicolon
id|netdev-&gt;dial_timer.data
op_assign
(paren
r_int
r_int

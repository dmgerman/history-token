...
id|err
suffix:semicolon
singleline_comment|// FIXME do the above in state machine
...
id|arg
suffix:semicolon
singleline_comment|// FIXME this really should be done in generic code
singleline_comment|//&t;strcpy(isdn_slot_num(slot), nr);
id|isdn_slot_set_usage
c_func
(paren
id|slot
...
id|slot
suffix:semicolon
multiline_comment|/* Is the state MANUAL?&n;&t; * If so, no callback can be made */
r_if
c_cond
(paren
...
(paren
id|KERN_INFO
l_string|&quot;incoming call for callback, &quot;
l_string|&quot;interface %s `off&squot; -&gt; rejected&bslash;n&quot;
comma
id|idev-&gt;name
)paren
suffix:semicolon

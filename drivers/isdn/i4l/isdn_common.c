multiline_comment|/* $Id: isdn_common.c,v 1.1.2.3 2004/02/10 01:07:13 keil Exp $&n; *&n; * Linux ISDN subsystem, common used functions (linklevel).&n; *&n; * Copyright 1994-1999  by Fritz Elfert (fritz@isdn4linux.de)&n; * Copyright 1995,96    Thinking Objects Software GmbH Wuerzburg&n; * Copyright 1995,96    by Michael Hipp (Michael.Hipp@student.uni-tuebingen.de)&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
macro_line|#include &lt;linux/isdn
singleline_comment|//capicmd.h&gt;
r_int
...
multiline_comment|/*&n; * This function must be called with holding the dev-&gt;lock.&n; */
r_int

...
id|IIOCNETGPN
suffix:colon
multiline_comment|/* Get peer phone number of a connected &n;&t;&t; * isdn network interface */
r_if
c_cond
(paren
id|arg
...
id|isdn_net_dev
op_star
DECL|function|isdn_slot_rx_netdev
...
r_void
DECL|function|isdn_slot_set_st_netdev
...
id|isdn_net_dev
op_star
DECL|function|isdn_slot_st_netdev

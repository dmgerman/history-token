multiline_comment|/* Linux ISDN subsystem, V.110&n; *&n; * Copyright by Thomas Pfeiffer (pfeiffer@pds.de)&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; */
...
suffix:semicolon
multiline_comment|/* &n; * FlipBits reorders sequences of keylen bits in one byte.&n; * E.g. source order 7654321 will be converted to 45670123 when keylen = 4,&n; * and to 67452301 when keylen = 2. This is necessary because ordering on&n; * the isdn line is the other way.&n; */
r_static
id|__inline
r_int
r_char
...
id|isdn_v110_stream
op_star
DECL|function|do_isdn_v110_open
id|do_isdn_v110_open
c_func
(paren
r_int
r_char
...
r_static
r_void
DECL|function|do_isdn_v110_close
id|do_isdn_v110_close
c_func
(paren
id|isdn_v110_stream
op_star
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_v110: Couldn&squot;t open stream&bslash;n&quot;
)paren
suffix:semicolon
id|atomic_dec
c_func
...
id|ret
suffix:semicolon
multiline_comment|/* Keep the send-queue of the driver filled&n;&t; * with frames:&n;&t; * If number of outstanding frames &lt; 3,&n;&t; * send down an Idle-Frame (or an Sync-Frame, if&n;&t; * v-&gt;SyncInit != 0). &n;&t; */
id|atomic_inc
c_func
(paren
op_amp

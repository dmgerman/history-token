multiline_comment|/* $Id: isdn_audio.c,v 1.1.2.2 2004/01/12 22:37:18 keil Exp $&n; *&n; * Linux ISDN subsystem, audio conversion and compression (linklevel).&n; *&n; * Copyright 1994-1999 by Fritz Elfert (fritz@isdn4linux.de)&n; * DTMF code (c) 1996 by Christian Mock (cm@kukuruz.ping.at)&n; * Silence detection (c) 1998 by Armin Schindler (mac@gismo.telekom.de)&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
suffix:semicolon
DECL|macro|NCOEFF
mdefine_line|#define NCOEFF            8     /* number of frequencies to be analyzed       */
DECL|macro|DTMF_TRESH
mdefine_line|#define DTMF_TRESH     4000     /* above this is dtmf                         */
...
l_int|1
suffix:semicolon
multiline_comment|/* compute |X(k)|**2 */
multiline_comment|/* report overflows. This should not happen. */
multiline_comment|/* Comment this out if desired */
r_if
c_cond
(paren
id|sk
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_audio: dtmf goertzel overflow, sk=%d&bslash;n&quot;
comma
id|sk
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_audio: dtmf goertzel overflow, sk2=%d&bslash;n&quot;
comma
id|sk2
)paren
suffix:semicolon
...
l_int|4
suffix:semicolon
multiline_comment|/* touchtones must match within 12 dB */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* good level found. This is allowed only one time per group */
r_if
c_cond
(paren
id|i
...
(brace
singleline_comment|// Bad. Another tone found. */
id|grp
(braket
id|LOGRP
)braket

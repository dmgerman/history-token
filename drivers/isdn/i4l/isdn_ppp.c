...
multiline_comment|/*&n; * bind isdn_net_local &lt;=&gt; ippp-device&n; *&n; * This function is allways called with holding dev-&gt;lock so&n; * no additional lock is needed&n; */
r_int
...
macro_line|#endif
macro_line|#ifdef CONFIG_IPPP_FILTER
id|is-&gt;pass_filter.filter
op_assign
l_int|NULL
suffix:semicolon
id|is-&gt;active_filter.filter
op_assign
l_int|NULL
suffix:semicolon
macro_line|#endif
...
(paren
id|KERN_ERR
l_string|&quot;%s: no file-&gt;private_data&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
macro_line|#endif
multiline_comment|/* TODO: if this was the previous master: link the stuff to the new master */
r_if
c_cond
(paren
id|is-&gt;comp_stat
...
id|val
suffix:semicolon
multiline_comment|/* isdn_ppp_xmit test for SC_ENABLE_IP !!! */
id|netif_wake_queue
c_func
(paren
op_amp
...
macro_line|#endif /* CONFIG_IPPP_FILTER */
r_default
suffix:colon
r_break
suffix:semicolon
...
macro_line|#ifdef CONFIG_IPPP_FILTER
multiline_comment|/* check if the packet passes the pass and active filters&n;&t; * the filter instructions are constructed assuming&n;&t; * a four-byte PPP header on each packet (which is still present) */
id|skb_push
c_func
(paren
id|skb
...
l_int|0
suffix:semicolon
multiline_comment|/* indicate inbound */
r_if
c_cond
(paren
id|is-&gt;pass_filter.filter
...
(paren
id|KERN_DEBUG
l_string|&quot;IPPP: inbound frame filtered.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree_skb
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;IPPP: link-active filter: reseting huptimer.&bslash;n&quot;
)paren
suffix:semicolon
id|lp-&gt;huptimer
op_assign
...
suffix:semicolon
macro_line|#else /* CONFIG_IPPP_FILTER */
id|lp-&gt;huptimer
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
macro_line|#ifdef CONFIG_IPPP_FILTER
multiline_comment|/* check if we should pass this packet&n;&t; * the filter instructions are constructed assuming&n;&t; * a four-byte PPP header on each packet */
id|skb_push
c_func
(paren
id|skb
...
l_int|1
suffix:semicolon
multiline_comment|/* indicate outbound */
op_star
(paren
id|u_int16_t
op_star
...
(paren
id|KERN_DEBUG
l_string|&quot;IPPP: outbound frame filtered.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree_skb
c_func
...
macro_line|#ifdef CONFIG_IPPP_FILTER
multiline_comment|/*&n; * check if this packet may trigger auto-dial.&n; */
DECL|function|isdn_ppp_autodial_filter
r_int
id|isdn_ppp_autodial_filter
c_func
(paren
r_struct
id|sk_buff
...
(paren
id|KERN_ERR
l_string|&quot;isdn_ppp_autodial_filter: unsupported protocol 0x%x.&bslash;n&quot;
comma
id|skb-&gt;protocol
)paren
suffix:semicolon
...
multiline_comment|/* the filter instructions are constructed assuming&n;&t; * a four-byte PPP header on each packet. we have to&n;&t; * temporarily remove part of the fake header stuck on&n;&t; * earlier.&n;&t; */
id|skb_pull
c_func
(paren
id|skb
...
id|CCPResetSentReq
suffix:semicolon
multiline_comment|/* We always expect an Ack if the decompressor doesn&squot;t&n;&t;&t;&t;   know&t;better */
id|rs-&gt;expra
op_assign
l_int|1
suffix:semicolon

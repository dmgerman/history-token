...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_ppp_free %d %p&bslash;n&quot;
comma
id|idev-&gt;ppp_slot
comma
id|is-&gt;idev
...
id|idev
suffix:semicolon
id|idev-&gt;reset-&gt;xmit_reset
op_assign
id|isdn_ppp_ccp_xmit_reset
suffix:semicolon
id|idev-&gt;reset-&gt;kick_up
op_assign
id|isdn_ppp_ccp_kick_up
suffix:semicolon
macro_line|#ifdef CONFIG_ISDN_MPP
...
DECL|function|isdn_ppp_ccp_kick_up
r_static
r_void
id|isdn_ppp_ccp_kick_up
c_func
...
DECL|function|isdn_ppp_ccp_lp_kick_up
r_static
r_void
id|isdn_ppp_ccp_lp_kick_up
c_func
(paren
r_void
op_star
...
DECL|function|isdn_ppp_ccp_lp_xmit_reset
r_static
r_void
id|isdn_ppp_ccp_lp_xmit_reset
c_func
(paren
r_void
op_star

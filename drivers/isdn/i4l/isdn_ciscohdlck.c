...
id|KERN_DEBUG
l_string|&quot;%s: HDLC &quot;
l_string|&quot;myseq %u, mineseen %u%c, yourseen %u, %s&bslash;n&quot;
comma
id|idev-&gt;name
comma
id|cisco-&gt;myseq
...
id|lp
suffix:semicolon
id|cisco-&gt;timer.function
op_assign
id|isdn_net_ciscohdlck_slarp_send_keepalive
suffix:semicolon
id|cisco-&gt;timer.expires
op_assign
id|jiffies
op_plus
id|cisco-&gt;keepalive_period
...
r_static
r_int
DECL|function|isdn_ciscohdlck_open
id|isdn_ciscohdlck_open
c_func
(paren
id|isdn_net_local
op_star
...
r_static
r_void
DECL|function|isdn_ciscohdlck_close
id|isdn_ciscohdlck_close
c_func
(paren
id|isdn_net_local
op_star

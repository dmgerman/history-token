multiline_comment|/* $Id: eicon_mod.c,v 1.1.4.1.2.4 2002/10/01 11:29:13 armin Exp $&n; *&n; * ISDN lowlevel-module for Eicon active cards.&n; * &n; * Copyright 1997      by Fritz Elfert (fritz@isdn4linux.de)&n; * Copyright 1998-2000 by Armin Schindler (mac@melware.de) &n; * Copyright 1999,2000 Cytronics &amp; Melware (info@melware.de)&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; * Thanks to    Eicon Networks for&n; *              documents, informations and hardware.&n; *&n; *&t;&t;Deutsche Mailbox Saar-Lor-Lux GmbH&n; *&t;&t;for sponsoring and testing fax&n; *&t;&t;capabilities with Diva Server cards.&n; *&t;&t;(dor@deutschemailbox.de)&n; *&n; */
...
l_int|1
comma
l_string|&quot;eicon_rcv_dispatch: Illegal bustype %d&bslash;n&quot;
comma
id|card-&gt;bus
)paren
suffix:semicolon

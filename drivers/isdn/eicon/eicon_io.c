multiline_comment|/* $Id: eicon_io.c,v 1.13.6.2 2001/09/23 22:24:37 kai Exp $&n; *&n; * ISDN low-level module for Eicon active ISDN-Cards.&n; * Code for communicating with hardware.&n; *&n; * Copyright 1999,2000  by Armin Schindler (mac@melware.de)&n; * Copyright 1999,2000  Cytronics &amp; Melware (info@melware.de)&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; * Thanks to&t;Eicon Networks for &n; *&t;&t;documents, informations and hardware. &n; *&n; */

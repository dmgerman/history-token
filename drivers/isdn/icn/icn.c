...
multiline_comment|/*&n; * Map a cards channel0 (Bank0/Bank8) or channel1 (Bank4/Bank12)&n; *&n; * must called with holding the devlock&n; */
r_static
r_inline
r_void
...
multiline_comment|/*&n; * Lock a cards channel.&n; * Return 0 if requested card/channel is unmapped (failure).&n; * Return 1 on success.&n; *&n; * must called with holding the devlock&n; */
r_static
r_inline
r_int
...
multiline_comment|/*&n; * Release current card/channel lock&n; *&n; * must called with holding the devlock&n; */
r_static
r_inline
r_void
DECL|function|__icn_release_channel
id|__icn_release_channel
c_func
(paren
r_void
)paren
...
l_int|0
suffix:semicolon
macro_line|#warning TODO test headroom or use skb-&gt;nb to flag ACK
id|nskb
op_assign
id|skb_clone
c_func

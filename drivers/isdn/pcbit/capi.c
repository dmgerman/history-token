multiline_comment|/*&n; * CAPI encoder/decoder for&n; * Portugal Telecom CAPI 2.0&n; *&n; * Copyright (C) 1996 Universidade de Lisboa&n; * &n; * Written by Pedro Roque Marques (roque@di.fc.ul.pt)&n; *&n; * This software may be used and distributed according to the terms of &n; * the GNU General Public License, incorporated herein by reference.&n; *&n; * Not compatible with the AVM Gmbh. CAPI 2.0&n; *&n; */

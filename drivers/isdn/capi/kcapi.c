...
suffix:semicolon
DECL|variable|capi_drivers_list_lock
id|rwlock_t
id|capi_drivers_list_lock
op_assign
id|RW_LOCK_UNLOCKED
suffix:semicolon
DECL|variable|application_lock
r_static
id|rwlock_t
id|application_lock
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;%s: cannot get card resources&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: invalid contr %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|contr
...
multiline_comment|/*&n; * The notifier will result in adding/deleteing of devices. Devices can&n; * only removed in user process, not in bh.&n; */
...
DECL|function|capi_ctr_handle_message
r_void
...
(paren
id|KERN_ERR
l_string|&quot;kcapi: handle_message: applid %d state released (%s)&bslash;n&quot;
comma
id|CAPIMSG_APPID
c_func
(paren
...
DECL|variable|capi_ctr_handle_message
id|EXPORT_SYMBOL
c_func
(paren
id|capi_ctr_handle_message
...
suffix:semicolon
DECL|function|capi_ctr_reseted
r_void
id|capi_ctr_reseted
c_func
(paren
...
DECL|variable|capi_ctr_reseted
id|EXPORT_SYMBOL
c_func
(paren
id|capi_ctr_reseted
...
suffix:semicolon
DECL|function|capi_ctr_suspend_output
r_void
...
DECL|variable|capi_ctr_suspend_output
id|EXPORT_SYMBOL
c_func
(paren
id|capi_ctr_suspend_output
...
suffix:semicolon
DECL|function|capi_ctr_resume_output
r_void
...
DECL|variable|capi_ctr_resume_output
id|EXPORT_SYMBOL
c_func
(paren
id|capi_ctr_resume_output
...
suffix:semicolon
DECL|function|register_capi_driver
r_void
...
DECL|variable|register_capi_driver
id|EXPORT_SYMBOL
c_func
(paren
id|register_capi_driver
...
suffix:semicolon
DECL|function|unregister_capi_driver
r_void
...
DECL|variable|unregister_capi_driver
id|EXPORT_SYMBOL
c_func
(paren
id|unregister_capi_driver
...
(paren
id|KERN_DEBUG
l_string|&quot;kcapi: load: no load function&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
multiline_comment|/* make sure all notifiers are finished */
id|flush_scheduled_work
c_func
(paren
)paren

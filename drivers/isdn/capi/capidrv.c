...
(paren
id|KERN_WARNING
l_string|&quot;capidrv: (%s) Could not reserve module&bslash;n&quot;
comma
id|id
)paren
suffix:semicolon
...
macro_line|#warning FIXME: maybe a race condition the card should be removed here from global list /kkeil
id|spin_unlock_irqrestore
c_func
(paren
op_amp

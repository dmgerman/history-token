multiline_comment|/* $Id: hscx.c,v 1.24.2.4 2004/01/24 20:47:23 keil Exp $&n; *&n; * HSCX specific routines&n; *&n; * Author       Karsten Keil&n; * Copyright    by Karsten Keil      &lt;keil@isdn4linux.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */

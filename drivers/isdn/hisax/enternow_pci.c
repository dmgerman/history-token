...
r_static
r_void
DECL|function|enpci_led_handler
id|enpci_led_handler
c_func
(paren
r_struct
id|IsdnCardState
...
(paren
id|KERN_WARNING
l_string|&quot;enter:now: You tried to load &quot;
l_string|&quot;this driver with an incompatible &quot;
l_string|&quot;TigerJet-card&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;Use type=20 for Traverse &quot;
l_string|&quot;NetJet PCI Card.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

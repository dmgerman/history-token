...
multiline_comment|/**********************************************************/
multiline_comment|/* create a new l3 process and fill in ni1 specific data */
multiline_comment|/**********************************************************/
r_static
r_struct
id|l3_process
DECL|function|ni1_new_l3_process
op_star
id|ni1_new_l3_process
c_func
(paren
r_struct
id|PStack
...
l_int|NULL
suffix:semicolon
id|proc-&gt;prot.ni1.invoke_id
op_assign
l_int|0
suffix:semicolon
id|proc-&gt;prot.ni1.remote_operation
op_assign
l_int|0
suffix:semicolon
id|proc-&gt;prot.ni1.uus1_data
(braket
l_int|0
)braket
op_assign
...
multiline_comment|/* ni1_new_l3_process */
multiline_comment|/************************************************/
multiline_comment|/* free a l3 process and all ni1 specific data */
multiline_comment|/************************************************/
r_static
r_void
DECL|function|ni1_release_l3_process
id|ni1_release_l3_process
c_func
(paren
r_struct
id|l3_process
...
multiline_comment|/* ni1_release_l3_process */
multiline_comment|/********************************************************/
...
id|l3_process
op_star
DECL|function|l3ni1_search_dummy_proc
id|l3ni1_search_dummy_proc
c_func
(paren
r_struct
id|PStack
...
multiline_comment|/* l3ni1_search_dummy_proc */
multiline_comment|/*******************************************************************/
...
r_static
r_void
DECL|function|l3ni1_dummy_return_result
id|l3ni1_dummy_return_result
c_func
(paren
r_struct
id|PStack
...
id|ic.arg
op_assign
id|NI1_STAT_INVOKE_RES
suffix:semicolon
id|ic.parm.ni1_io.hl_id
op_assign
id|pc-&gt;prot.ni1.invoke_id
suffix:semicolon
id|ic.parm.ni1_io.ll_id
op_assign
id|pc-&gt;prot.ni1.ll_id
suffix:semicolon
id|ic.parm.ni1_io.proc
op_assign
id|pc-&gt;prot.ni1.proc
suffix:semicolon
id|ic.parm.ni1_io.timeout
op_assign
l_int|0
suffix:semicolon
id|ic.parm.ni1_io.datalen
op_assign
id|nlen
suffix:semicolon
id|ic.parm.ni1_io.data
op_assign
id|p
suffix:semicolon
id|free_invoke_id
...
multiline_comment|/* l3ni1_dummy_return_result */
multiline_comment|/*******************************************************************/
multiline_comment|/* called when a facility message with a dummy callref is received */
...
r_static
r_void
DECL|function|l3ni1_dummy_error_return
id|l3ni1_dummy_error_return
c_func
(paren
r_struct
id|PStack
...
multiline_comment|/* l3ni1_error_return */
multiline_comment|/*******************************************************************/
multiline_comment|/* called when a facility message with a dummy callref is received */
...
r_static
r_void
DECL|function|l3ni1_dummy_invoke
id|l3ni1_dummy_invoke
c_func
(paren
r_struct
id|PStack
...
multiline_comment|/* l3ni1_dummy_invoke */
r_static
r_void
DECL|function|l3ni1_parse_facility
id|l3ni1_parse_facility
c_func
(paren
r_struct
id|PStack
...
r_static
r_void
DECL|function|l3ni1_message_plus_chid
id|l3ni1_message_plus_chid
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_message_cause
id|l3ni1_message_cause
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_status_send
id|l3ni1_status_send
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_msg_without_setup
id|l3ni1_msg_without_setup
c_func
(paren
r_struct
id|l3_process
...
(paren
id|KERN_ERR
l_string|&quot;HiSax l3ni1_msg_without_setup wrong cause %d&bslash;n&quot;
comma
id|pc-&gt;para.cause
)paren
suffix:semicolon
...
r_static
r_int
DECL|function|l3ni1_check_messagetype_validity
id|l3ni1_check_messagetype_validity
c_func
(paren
r_struct
id|l3_process
...
id|pc-&gt;st
comma
l_string|&quot;l3ni1_check_messagetype_validity mt(%x) OK&quot;
comma
id|mt
)paren
suffix:semicolon
...
id|pc-&gt;st
comma
l_string|&quot;l3ni1_check_messagetype_validity mt(%x) fail&quot;
comma
id|mt
)paren
suffix:semicolon
...
r_static
r_void
DECL|function|l3ni1_std_ie_err
id|l3ni1_std_ie_err
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|l3ni1_get_channel_id
id|l3ni1_get_channel_id
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_msg_with_uus
id|l3ni1_msg_with_uus
c_func
(paren
r_struct
id|l3_process
...
multiline_comment|/* l3ni1_msg_with_uus */
r_static
r_void
DECL|function|l3ni1_release_req
id|l3ni1_release_req
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_release_cmpl
id|l3ni1_release_cmpl
c_func
(paren
r_struct
id|l3_process
...
multiline_comment|/*&n;&t; * Set Bearer Capability, Map info from 1TR6-convention to NI1&n;&t; */
r_switch
c_cond
(paren
...
l_int|0x90
suffix:semicolon
multiline_comment|/* 3.1khz Audio      &t;&t;&t;      */
op_star
id|p
op_increment
op_assign
...
r_static
r_void
DECL|function|l3ni1_disconnect
id|l3ni1_disconnect
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_disconnect_req
id|l3ni1_disconnect_req
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_connect_ack
id|l3ni1_connect_ack
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_reject_req
id|l3ni1_reject_req
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_proceed_req
id|l3ni1_proceed_req
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_setup_ack_req
id|l3ni1_setup_ack_req
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_deliver_display
id|l3ni1_deliver_display
c_func
(paren
r_struct
id|l3_process
...
multiline_comment|/* l3ni1_deliver_display */
r_static
r_void
DECL|function|l3ni1_progress
id|l3ni1_progress
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_status_enq
id|l3ni1_status_enq
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_information
id|l3ni1_information
c_func
(paren
r_struct
id|l3_process
...
multiline_comment|/* l3ni1_redir_req */
multiline_comment|/********************************************/
multiline_comment|/* handle deflection request in early state */
multiline_comment|/********************************************/
DECL|function|l3ni1_redir_req_early
r_static
r_void
id|l3ni1_redir_req_early
c_func
(paren
r_struct
id|l3_process
...
id|st
comma
l_string|&quot;l3ni1_cmd_global abort unknown id&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|st
comma
l_string|&quot;l3ni1_cmd_global unknown cmd 0x%lx&quot;
comma
id|ic-&gt;arg
)paren
suffix:semicolon
...
multiline_comment|/* l3ni1_cmd_global */
r_static
r_void
DECL|function|l3ni1_io_timer
id|l3ni1_io_timer
c_func
(paren
r_struct
...
multiline_comment|/* l3ni1_io_timer */
r_static
r_void
DECL|function|l3ni1_release_ind
id|l3ni1_release_ind
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_suspend_req
id|l3ni1_suspend_req
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_suspend_ack
id|l3ni1_suspend_ack
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_suspend_rej
id|l3ni1_suspend_rej
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_resume_req
id|l3ni1_resume_req
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_resume_ack
id|l3ni1_resume_ack
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_resume_rej
id|l3ni1_resume_rej
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_global_restart
id|l3ni1_global_restart
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_dl_release
id|l3ni1_dl_release
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|l3ni1_dl_reestablish
id|l3ni1_dl_reestablish
c_func
(paren
r_struct
id|l3_process
...
r_static
r_void
DECL|function|l3ni1_dl_reest_status
id|l3ni1_dl_reest_status
c_func
(paren
r_struct
id|l3_process
...
(paren
id|KERN_ERR
l_string|&quot;SPID not supplied in EAZMSN %s&bslash;n&quot;
comma
id|pChan-&gt;setup.eazmsn
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;HiSax can&squot;t get memory to send SPID&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;SPID not accepted&bslash;n&quot;
)paren
suffix:semicolon
id|newl3state
c_func
...
comma
multiline_comment|/*&t;{SBIT(1),&n;&t; MT_RESTART_ACKNOWLEDGE, l3ni1_restart_ack},&n;*/
(brace
id|SBIT
c_func
(paren
...
id|st
comma
l_string|&quot;ni1 global state %d mt %x unhandled&quot;
comma
id|proc-&gt;state
comma
id|mt
...
(paren
id|KERN_ERR
l_string|&quot;HiSax ni1up unknown pr=%04x&bslash;n&quot;
comma
id|pr
)paren
suffix:semicolon
...
id|st
comma
l_string|&quot;ni1up frame too short(%d)&quot;
comma
id|skb-&gt;len
)paren
suffix:semicolon
...
id|st
comma
l_string|&quot;ni1up%sunexpected discriminator %x message len %d&quot;
comma
(paren
id|pr
op_eq
...
id|st
comma
l_string|&quot;ni1up dummy Callref (no facility msg or ie)&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
id|st
comma
l_string|&quot;ni1up wrong CRef flag&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
id|st
comma
l_string|&quot;ni1up%sstate %d mt %#x unhandled&quot;
comma
(paren
id|pr
op_eq
...
(paren
id|KERN_ERR
l_string|&quot;HiSax ni1down without proc pr=%04x&bslash;n&quot;
comma
id|pr
)paren
suffix:semicolon
...
id|st
comma
l_string|&quot;ni1down state %d prim %#x unhandled&quot;
comma
id|proc-&gt;state
comma
id|pr
...
id|st
comma
l_string|&quot;ni1down state %d prim %#x&quot;
comma
id|proc-&gt;state
comma
id|pr
...
(paren
id|KERN_ERR
l_string|&quot;HiSax ni1man without proc pr=%04x&bslash;n&quot;
comma
id|pr
)paren
suffix:semicolon
...
id|st
comma
l_string|&quot;cr %d ni1man state %d prim %#x unhandled&quot;
comma
id|proc-&gt;callref
op_amp
l_int|0x7f
...
id|st
comma
l_string|&quot;cr %d ni1man state %d prim %#x&quot;
comma
id|proc-&gt;callref
op_amp
l_int|0x7f
...
l_int|1
suffix:semicolon
id|st-&gt;prot.ni1.last_invoke_id
op_assign
l_int|0
suffix:semicolon
id|st-&gt;prot.ni1.invoke_used
(braket
l_int|0
)braket
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;HiSax can&squot;t get memory for ni1 global CR&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
l_int|1
suffix:semicolon
id|st-&gt;l3.global-&gt;prot.ni1.invoke_id
op_assign
l_int|0
suffix:semicolon
id|L3InitTimer
...
(paren
id|KERN_INFO
l_string|&quot;HiSax: National ISDN-1 Rev. %s&bslash;n&quot;
comma
id|HiSax_getrev
c_func
(paren

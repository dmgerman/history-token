...
id|next_entry
suffix:colon
multiline_comment|/* new in dummy.cs 2001/01/28 MN &n;        if (link-&gt;io.NumPorts1)&n;           pcmcia_release_io(link-&gt;handle, &amp;link-&gt;io);&n;*/
id|CS_CHECK
c_func
(paren
id|GetNextTuple
...
(paren
id|KERN_ERR
l_string|&quot;sedlbauer_cs: failed to initialize SEDLBAUER PCMCIA %d at i/o %#x&bslash;n&quot;
comma
id|last_ret
comma
id|link-&gt;io.BasePort1
...
DECL|variable|sedlbauer_driver
r_static
r_struct
id|pcmcia_driver
id|sedlbauer_driver

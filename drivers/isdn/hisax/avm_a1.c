multiline_comment|/* $Id: avm_a1.c,v 2.15.2.4 2004/01/13 21:46:03 keil Exp $&n; *&n; * low level stuff for AVM A1 (Fritz) isdn cards&n; *&n; * Author       Karsten Keil&n; * Copyright    by Karsten Keil      &lt;keil@isdn4linux.de&gt;&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */

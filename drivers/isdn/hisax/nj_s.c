...
(paren
id|KERN_WARNING
l_string|&quot;Netjet: You tried to load this &quot;
l_string|&quot;driver with an incompatible TigerJet-card&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;Use type=41 for Formula-n &quot;
l_string|&quot;enter:now ISDN PCI and compatible&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

...
mdefine_line|#define MAX_D_FRAMES 0x0f
DECL|macro|MAX_B_FRAMES
mdefine_line|#define MAX_B_FRAMES 0x1f
DECL|macro|B_FIFO_SIZE
mdefine_line|#define B_FIFO_SIZE  (0x2000 - 0x200)
DECL|macro|D_FIFO_SIZE
mdefine_line|#define D_FIFO_SIZE  0x200
singleline_comment|// ----------------------------------------------------------------------
singleline_comment|//
...
mdefine_line|#define OFF_B1_rx_z2 0x6000
DECL|macro|OFF_B2_rx_z2
mdefine_line|#define OFF_B2_rx_z2 0x6100
DECL|macro|OFF_B1_tx_z1
mdefine_line|#define OFF_B1_tx_z1 0x2002
DECL|macro|OFF_B2_tx_z1
mdefine_line|#define OFF_B2_tx_z1 0x2102
...
suffix:semicolon
singleline_comment|//&t;&t;&t;adapter-&gt;conn &amp;= ~0x03;
r_if
c_cond
(paren
id|mode
...
suffix:semicolon
singleline_comment|//&t;&t;&t;adapter-&gt;conn &amp;= ~0x18; // XXX
r_if
c_cond
(paren
id|mode
...
suffix:semicolon
macro_line|#endif
singleline_comment|// XXX FsmEvent
)brace
r_static
r_inline
r_void
...
l_int|0x10
comma
l_string|&quot;stat %02x s1 %02x&bslash;n&quot;
comma
id|stat
comma
id|val

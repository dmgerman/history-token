...
suffix:semicolon
DECL|variable|hisax_config_lock
r_static
id|spinlock_t
id|hisax_config_lock
op_assign
...
DECL|macro|DEFAULT_CARD
mdefine_line|#define DEFAULT_CARD 0
DECL|macro|DEFAULT_CFG
mdefine_line|#define DEFAULT_CFG {0,0,0,0}
macro_line|#endif
r_int
...
c_func
(paren
l_string|&quot;ISDN4Linux: Driver for passive ISDN cards&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
suffix:semicolon
singleline_comment|//      CallcFreeChan(cs);
)brace
...
r_static
r_void
DECL|function|do_register_isdn
id|do_register_isdn
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/* init_card only handles interrupts which are not */
multiline_comment|/* used here for the loadable driver */
r_switch
c_cond
(paren
id|card-&gt;typ
...
suffix:semicolon
DECL|variable|hisax_unregister
id|EXPORT_SYMBOL
c_func
(paren
id|hisax_unregister
...
id|hisax_d_l2l1
suffix:semicolon
id|cs-&gt;bc_l1_ops-&gt;open
op_assign
id|hisax_bc_setstack
suffix:semicolon
id|cs-&gt;bc_l1_ops-&gt;close
op_assign
id|hisax_bc_close
suffix:semicolon
r_for
...
DECL|function|hisax_unregister
r_void
id|hisax_unregister
c_func
(paren
...
id|skb
suffix:semicolon
singleline_comment|// FIXME use isdnl1?
r_switch
c_cond
(paren
id|pr
...
c_func
(paren
l_string|&quot;hisax_b_l1l2 pr %#x&bslash;n&quot;
comma
id|pr
)paren
suffix:semicolon
...
id|skb
comma
l_string|&quot;PH_DATA_REQ&quot;
comma
l_int|0
)paren
suffix:semicolon
singleline_comment|// FIXME lock?
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|hisax_bc_setstack
r_static
r_int
id|hisax_bc_setstack
c_func
...
DECL|function|EChannel_proc_rcv
r_static
r_void
id|EChannel_proc_rcv
c_func
...
r_void
DECL|function|resources_release
...
(paren
id|KERN_WARNING
l_string|&quot;%s: IO %#lx-%#lx already in use&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|start
...
(paren
id|KERN_WARNING
l_string|&quot;%s: MMIO %#lx-%#lx already in use&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|start

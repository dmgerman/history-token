multiline_comment|/* $Id: config.c,v 2.57.6.18 2001/08/27 22:19:05 kai Exp $&n; *&n; * Author       Karsten Keil (keil@isdn4linux.de)&n; *              based on the teles driver from Jan den Ouden&n; *&n; * This file is (c) under GNU General Public License&n; *&n; */
...
DECL|function|hisax_sched_event
r_static
r_void
id|hisax_sched_event
c_func
(paren
r_struct
id|IsdnCardState
...
DECL|function|hisax_b_sched_event
r_static
r_void
id|hisax_b_sched_event
c_func
(paren
r_struct
id|BCState
...
singleline_comment|// hope we do win the race...

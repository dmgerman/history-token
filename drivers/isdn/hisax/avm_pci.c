...
(brace
multiline_comment|/* Here we lost an TX interrupt, so&n;&t;&t; * restart transmitting the whole frame. */
r_if
c_cond
(paren
id|bcs-&gt;cs-&gt;debug
...
(paren
id|KERN_INFO
l_string|&quot;FritzPnP: no ISA PnP present&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif

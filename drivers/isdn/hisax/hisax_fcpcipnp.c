...
mdefine_line|#define  HDLC_STAT_RML_MASK&t;0xff00
...
mdefine_line|#define  HDLC_CMD_XML_MASK&t;0xff00
...
multiline_comment|/* only hdlc restarts the frame, transparent mode must continue */
r_if
c_cond
(paren
id|bcs-&gt;mode
...
(paren
id|KERN_WARNING
l_string|&quot;%s: pnp_activate_dev(%s) ret(%d)&bslash;n&quot;
comma
id|__FUNCTION__
comma
(paren

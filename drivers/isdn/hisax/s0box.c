multiline_comment|/* $Id: s0box.c,v 2.6.2.4 2004/01/13 23:48:39 keil Exp $&n; *&n; * low level stuff for Creatix S0BOX&n; *&n; * Author       Enrik Berkhan&n; * Copyright    by Enrik Berkhan &lt;enrik@starfleet.inka.de&gt;&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */

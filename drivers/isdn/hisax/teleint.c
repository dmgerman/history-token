multiline_comment|/* $Id: teleint.c,v 1.16.2.5 2004/01/19 15:31:50 keil Exp $&n; *&n; * low level stuff for TeleInt isdn cards&n; *&n; * Author       Karsten Keil&n; * Copyright    by Karsten Keil      &lt;keil@isdn4linux.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */

...
id|resource
op_star
DECL|function|gazel_request_region
id|gazel_request_region
c_func
(paren
r_int
r_int
...
(paren
id|KERN_WARNING
l_string|&quot;Gazel: io %#lx-%#lx already in use&bslash;n&quot;
comma
id|start
comma
id|start

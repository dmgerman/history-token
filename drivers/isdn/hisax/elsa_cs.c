...
c_func
(paren
l_string|&quot;ISDN4Linux: PCMCIA client driver for Elsa PCM cards&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
l_string|&quot;Klaus Lichtenwalder&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
id|version
op_assign
l_string|&quot;elsa_cs.c $Revision: 1.2.2.4 $ $Date: 2004/01/25 15:07:06 $ (K.Lichtenwalder)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
(paren
id|KERN_ERR
l_string|&quot;elsa_cs: failed to initialize Elsa PCMCIA %d at i/o %#x&bslash;n&quot;
comma
id|i
comma
id|link-&gt;io.BasePort1

...
(paren
id|KERN_INFO
l_string|&quot;ISDNLink: defined at %#lx IRQ %lu&bslash;n&quot;
comma
id|card-&gt;para
(braket
l_int|1
...
(paren
id|KERN_ERR
l_string|&quot;AsusPnP: attach failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_ERR
l_string|&quot;AsusPnP: activate failed&bslash;n&quot;
)paren
suffix:semicolon

...
DECL|macro|READHSCX
mdefine_line|#define READHSCX(cs, nr, reg) readreg(cs, &bslash;&n;&t;reg + (nr ? 0x40 : 0))
DECL|macro|WRITEHSCX
mdefine_line|#define WRITEHSCX(cs, nr, reg, data) writereg(cs, &bslash;&n;&t;reg + (nr ? 0x40 : 0), data)
DECL|macro|READHSCXFIFO
mdefine_line|#define READHSCXFIFO(cs, nr, ptr, cnt) readfifo(cs, &bslash;&n;&t;(nr ? 0x40 : 0), ptr, cnt)
DECL|macro|WRITEHSCXFIFO
mdefine_line|#define WRITEHSCXFIFO(cs, nr, ptr, cnt) writefifo(cs, &bslash;&n;&t;(nr ? 0x40 : 0), ptr, cnt)

...
c_cond
(paren
id|chanp-&gt;cs-&gt;card_ops-&gt;led_handler
)paren
id|chanp-&gt;cs-&gt;card_ops
...
r_inline
r_void
DECL|function|mdl_info_connect
id|mdl_info_connect
c_func
(paren
r_struct
...
r_inline
r_void
DECL|function|mdl_info_release
id|mdl_info_release
c_func
(paren
r_struct

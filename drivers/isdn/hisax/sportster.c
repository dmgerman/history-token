multiline_comment|/* $Id: sportster.c,v 1.14.6.1 2001/02/16 16:43:29 kai Exp $&n; *&n; * sportster.c     low level stuff for USR Sportster internal TA&n; *&n; * Author       Karsten Keil (keil@isdn4linux.de)&n; *&n; * Thanks to Christian &quot;naddy&quot; Weisgerber (3Com, US Robotics) for documentation&n; *&n; * This file is (c) under GNU General Public License&n; *&n; */

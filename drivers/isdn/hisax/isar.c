...
mdefine_line|#define FAXMODCNT&t;13
...
(paren
id|KERN_WARNING
l_string|&quot;ISAR: frame to short %d&bslash;n&quot;
comma
id|bcs-&gt;hw.isar.rcvidx
)paren
suffix:semicolon
...
id|L1_MODE_FAX
suffix:colon
multiline_comment|/* SART must not configured with FAX */
r_break
suffix:semicolon
)brace
id|udelay
...
id|cs
comma
l_string|&quot;isar FTS=%d and FTI busy&quot;
comma
id|ic-&gt;parm.aux.para
(braket
l_int|0
...
id|cs
comma
l_string|&quot;isar FTS=%d and isar.state not ready(%x)&quot;
comma
id|ic-&gt;parm.aux.para
(braket
l_int|0
...
(paren
id|KERN_DEBUG
l_string|&quot;HiSax: max modulation old(%04x) new(%04x)&bslash;n&quot;
comma
id|modmask
comma
id|features
...
(paren
id|KERN_DEBUG
l_string|&quot;HiSax: FRM extra delay old(%d) new(%d) ms&bslash;n&quot;
comma
id|frm_extra_delay
comma
id|features
...
(paren
id|KERN_DEBUG
l_string|&quot;HiSax: TOA old(%d) new(%d) db&bslash;n&quot;
comma
id|para_TOA
comma
id|features

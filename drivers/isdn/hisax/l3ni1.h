...
DECL|macro|MT_DL_ESTABLISHED
mdefine_line|#define MT_DL_ESTABLISHED&t;0xfe
...
DECL|macro|IE_SPID
mdefine_line|#define IE_SPID&t;&t;0x3a
DECL|macro|IE_ENDPOINT_ID
mdefine_line|#define IE_ENDPOINT_ID&t;0x3b
...
macro_line|#else /* only l3ni1_process */
multiline_comment|/* l3ni1 specific data in l3 process */
r_typedef
r_struct
...
DECL|typedef|ni1_proc_priv
)brace
id|ni1_proc_priv
suffix:semicolon
multiline_comment|/* l3dni1 specific data in protocol stack */
r_typedef
r_struct
...
DECL|typedef|ni1_stk_priv
)brace
id|ni1_stk_priv
suffix:semicolon
macro_line|#endif /* only l3dni1_process */
eof

multiline_comment|/* $Id: jade_irq.c,v 1.7.2.3 2004/01/14 16:04:48 keil Exp $&n; *&n; * Low level JADE IRQ stuff (derived from original hscx_irq.c)&n; *&n; * Author       Roland Klabunde&n; * Copyright    by Roland Klabunde   &lt;R.Klabunde@Berkom.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
r_static
r_inline
r_void

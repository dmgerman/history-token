multiline_comment|/* $Id: act2000_isa.h,v 1.4.6.1 2001/09/23 22:24:32 kai Exp $&n; *&n; * ISDN lowlevel-module for the IBM ISDN-S0 Active 2000 (ISA-Version).&n; *&n; * Author       Fritz Elfert&n; * Copyright    by Fritz Elfert      &lt;fritz@isdn4linux.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; * Thanks to Friedemann Baitinger and IBM Germany&n; *&n; */

multiline_comment|/*&n; * $Id: t1pci.c,v 1.13.6.5 2001/05/17 20:41:51 kai Exp $&n; * &n; * Module for AVM T1 PCI-card.&n; * &n; * (c) Copyright 1999 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; */

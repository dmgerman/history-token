multiline_comment|/*&n; * $Id: b1pcmcia.c,v 1.12.6.4 2001/05/17 20:41:51 kai Exp $&n; * &n; * Module for AVM B1/M1/M2 PCMCIA-card.&n; * &n; * (c) Copyright 1999 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; */

multiline_comment|/* $Id: b1pci.c,v 1.1.2.2 2004/01/16 21:09:27 keil Exp $&n; * &n; * Module for AVM B1 PCI-card.&n; * &n; * Copyright 1999 by Carsten Paeth &lt;calle@calle.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
suffix:semicolon
DECL|variable|capi_driver_b1pci
r_static
r_struct
id|capi_driver
id|capi_driver_b1pci
op_assign
(brace
dot
id|name
...
suffix:semicolon
macro_line|#ifdef CONFIG_ISDN_DRV_AVMB1_B1PCIV4
DECL|variable|capi_driver_b1pciv4
r_static
r_struct
id|capi_driver
id|capi_driver_b1pciv4
op_assign
(brace
dot
id|name
...
c_func
(paren
id|capi_driver_b1pciv4.revision
comma
id|rev
comma
l_int|32

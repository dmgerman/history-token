multiline_comment|/* $Id: c4.c,v 1.1.2.2 2004/01/16 21:09:27 keil Exp $&n; * &n; * Module for AVM C4 &amp; C2 card.&n; * &n; * Copyright 1999 by Carsten Paeth &lt;calle@calle.de&gt;&n; *&n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
(paren
id|KERN_ERR
l_string|&quot;%s: card with %d controllers ??&bslash;n&quot;
comma
id|card-&gt;name
comma
id|cidx
...
(paren
id|KERN_NOTICE
l_string|&quot;c4: NO card at 0x%x error(%d)&bslash;n&quot;
comma
id|card-&gt;port
comma
id|retval
...
(paren
id|KERN_INFO
l_string|&quot;c4: revision %s&bslash;n&quot;
comma
id|rev
)paren
suffix:semicolon

multiline_comment|/* $Id: t1isa.c,v 1.1.2.3 2004/02/10 01:07:12 keil Exp $&n; * &n; * Module for AVM T1 HEMA-card.&n; * &n; * Copyright 1999 by Carsten Paeth &lt;calle@calle.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * no one else should use the ISA bus in this moment,&n;&t; * but no function there to prevent this :-(&n;&t; * save_flags(flags); cli();&n;&t; */
...
DECL|variable|capi_driver_t1isa
r_static
r_struct
id|capi_driver
id|capi_driver_t1isa
op_assign
(brace
dot
id|name
...
(paren
id|KERN_INFO
l_string|&quot;t1isa: revision %s&bslash;n&quot;
comma
id|rev
)paren
suffix:semicolon

multiline_comment|/* $Id: t1pci.c,v 1.1.2.2 2004/01/16 21:09:27 keil Exp $&n; * &n; * Module for AVM T1 PCI-card.&n; * &n; * Copyright 1999 by Carsten Paeth &lt;calle@calle.de&gt;&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
suffix:semicolon
DECL|variable|capi_driver_t1pci
r_static
r_struct
id|capi_driver
id|capi_driver_t1pci
op_assign
(brace
dot
id|name
...
(paren
id|KERN_INFO
l_string|&quot;t1pci: revision %s&bslash;n&quot;
comma
id|rev
)paren
suffix:semicolon

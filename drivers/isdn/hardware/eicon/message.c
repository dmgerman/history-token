...
DECL|function|set_group_ind_mask_bit
r_void
id|set_group_ind_mask_bit
(paren
id|PLCI
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/* to be completed */
DECL|function|disable_adapter
r_void
id|disable_adapter
c_func
(paren
...
c_func
(paren
l_string|&quot;disable adapter: number %d invalid&quot;
comma
id|adapter_number
)paren
)paren
...
c_func
(paren
l_string|&quot;disable adapter number %d&quot;
comma
id|adapter_number
)paren
)paren
suffix:semicolon
multiline_comment|/* Capi20 starts with Nr. 1, internal field starts with 0 */
id|a
op_assign
op_amp
id|adapter
...
multiline_comment|/* disconnect logical links */
(brace
id|plci
op_assign
op_amp
...
multiline_comment|/* disconnect physical links */
(brace
id|Id
op_assign
(paren
...
c_func
(paren
l_string|&quot;enable adapter: number %d invalid&quot;
comma
id|adapter_number
)paren
)paren
...
c_func
(paren
l_string|&quot;enable adapter number %d&quot;
comma
id|adapter_number
)paren
)paren

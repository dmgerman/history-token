multiline_comment|/* $Id: capifunc.c,v 1.1.2.2 2002/10/02 14:38:37 armin Exp $&n; *&n; * ISDN interface module for Eicon active cards DIVA.&n; * CAPI Interface common functions&n; * &n; * Copyright 2000-2002 by Armin Schindler (mac@melware.de) &n; * Copyright 2000-2002 Cytronics &amp; Melware (info@melware.de)&n; * &n; * This software may be used and distributed according to the terms&n; * of the GNU General Public License, incorporated herein by reference.&n; *&n; */
...
suffix:semicolon
macro_line|#if IMPLEMENT_LINE_INTERCONNECT
r_if
c_cond
(paren
id|a-&gt;li_pri
...
multiline_comment|/*&n; * remove a card&n; */
...
(paren
(paren
l_string|&quot;diva_add_card: failed alloc li_config.pri struct.&quot;
)paren
)paren
id|memset
c_func
...
(paren
(paren
l_string|&quot;diva_add_card: failed alloc li_config.bri struct.&quot;
)paren
)paren
id|memset
c_func
...
id|appl
suffix:semicolon
multiline_comment|/* We do not need a list */
multiline_comment|/* InitializeListHead(&amp;this-&gt;s_function); */
r_for
c_loop
(paren
id|i
...
(paren
(paren
l_string|&quot;application %d cleanup&quot;
comma
id|this-&gt;Id
)paren
)paren

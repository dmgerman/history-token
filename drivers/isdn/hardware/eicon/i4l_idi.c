...
multiline_comment|/* Additional DLC element */
r_switch
c_cond
(paren
id|chan-&gt;l2prot
...
suffix:semicolon
multiline_comment|/* max. info (lo byte) */
id|reqbuf-&gt;XBuffer.P
(braket
id|l
op_increment
...
suffix:semicolon
multiline_comment|/* max. info (hi byte) */
r_break
suffix:semicolon
)brace
id|reqbuf-&gt;XBuffer.P
...
id|ISDN_PROTO_L2_MODEM
suffix:colon
multiline_comment|/* reqbuf-&gt;XBuffer.P[1] = 12; */
id|reqbuf-&gt;XBuffer.P
(braket
l_int|2
)braket
...
l_int|1
comma
l_string|&quot;idi_conn_res: Ch%d: old net_id %x still exist, removing.&bslash;n&quot;
comma
id|chan-&gt;No
comma
id|chan-&gt;e.B2Id
...
id|ISDN_PROTO_L2_MODEM
suffix:colon
multiline_comment|/* reqbuf-&gt;XBuffer.P[l-7] = 12; */
id|reqbuf-&gt;XBuffer.P
(braket
id|l
op_minus
...
l_int|1
comma
l_string|&quot;idi_ind: Ch%d: old net_id %x still exist, removing.&bslash;n&quot;
comma
id|chan-&gt;No
comma
id|chan-&gt;e.B2Id
...
l_int|0x08
suffix:colon
multiline_comment|/* ADAPTER_DEAD */
r_case
id|WRONG_CH
suffix:colon
r_case
...
l_int|2
comma
l_string|&quot;idi_err: Ch%d: Alert Not OK : Rc=%d Id=%x Ch=%d&bslash;n&quot;
comma
id|dCh
comma
id|ack-&gt;Rc
...
l_int|1
comma
l_string|&quot;idi_err: Ch%d: Ack Not OK !!: Rc=%d Id=%x Ch=%d Req=%d&bslash;n&quot;
comma
id|dCh
comma
id|ack-&gt;Rc

...
multiline_comment|/*---------------------------------------------------------------------------*/
DECL|macro|dsp_download_reserve_space
mdefine_line|#define dsp_download_reserve_space(fp,length)
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * OS file access abstraction layer&n; *&n; * I/O functions returns -1 on error, 0 on EOF&n; */
DECL|macro|OS_SEEK_SET
mdefine_line|#define OS_SEEK_SET 0
DECL|macro|OS_SEEK_CUR
mdefine_line|#define OS_SEEK_CUR 1
DECL|macro|OS_SEEK_END
mdefine_line|#define OS_SEEK_END 2
r_struct
id|_OsFileHandle_
suffix:semicolon
DECL|typedef|OsFileIo
r_typedef
r_int
(paren
op_star
...
suffix:semicolon
DECL|struct|_OsFileHandle_
r_typedef
r_struct
id|_OsFileHandle_
DECL|member|sysFileDesc
(brace
r_void
op_star
id|sysFileDesc
suffix:semicolon
DECL|member|sysFileSize
r_int
r_int
id|sysFileSize
suffix:semicolon
DECL|member|sysFileRead
id|OsFileIo
id|sysFileRead
suffix:semicolon
DECL|member|sysFileSeek
id|OsFileSeek
id|sysFileSeek
suffix:semicolon
DECL|member|sysLoadDesc
r_void
op_star
id|sysLoadDesc
suffix:semicolon
DECL|member|sysCardLoad
id|OsCardLoad
id|sysCardLoad
suffix:semicolon
DECL|typedef|OsFileHandle
)brace
id|OsFileHandle
suffix:semicolon
r_extern
...
suffix:semicolon
multiline_comment|/*****************************************************************************/
DECL|macro|DSP_TELINDUS_FILE
mdefine_line|#define DSP_TELINDUS_FILE &quot;dspdload.bin&quot;
multiline_comment|/* special DSP file for BRI cards for Qsig and CornetN because of missing memory */
DECL|macro|DSP_QSIG_TELINDUS_FILE
mdefine_line|#define DSP_QSIG_TELINDUS_FILE &quot;dspdqsig.bin&quot;
DECL|macro|DSP_MDM_TELINDUS_FILE
mdefine_line|#define DSP_MDM_TELINDUS_FILE &quot;dspdvmdm.bin&quot;
DECL|macro|DSP_FAX_TELINDUS_FILE
mdefine_line|#define DSP_FAX_TELINDUS_FILE &quot;dspdvfax.bin&quot;
DECL|macro|DSP_DIRECTORY_ENTRIES
mdefine_line|#define DSP_DIRECTORY_ENTRIES 64
...
id|p_data_blocks_pm
suffix:semicolon
DECL|typedef|t_dsp_desc
)brace
id|t_dsp_desc
suffix:semicolon
DECL|struct|tag_dsp_portable_download_desc
r_typedef
r_struct
id|tag_dsp_portable_download_desc
...
id|p_data_blocks_pm
suffix:semicolon
DECL|typedef|t_dsp_portable_desc
)brace
...
mdefine_line|#define DSP_MAX_DOWNLOAD_COUNT                  64
...
multiline_comment|/*&n;data indications if transparent framer&n;  &lt;byte&gt; data 0&n;  &lt;byte&gt; data 1&n;  ...&n;data indications if HDLC framer&n;  &lt;byte&gt; data 0&n;  &lt;byte&gt; data 1&n;  ...&n;  &lt;byte&gt; CRC 0&n;  &lt;byte&gt; CRC 1&n;  &lt;byte&gt; preamble flags&n;*/
...
id|word
op_star
id|p_dsp_download_count
comma
id|t_dsp_desc
op_star
id|p_dsp_download_table
comma
id|t_dsp_portable_desc
op_star
id|p_dsp_portable_download_table
)paren
suffix:semicolon
multiline_comment|/*---------------------------------------------------------------------------*/
macro_line|#endif /* DSP_DEFS_H_ */  
eof

...
DECL|macro|WATCHMASK
mdefine_line|#define WATCHMASK       0352 /* 11101010 */
DECL|macro|DEBUG
...
mdefine_line|#define RDS_DATAMASK        0x04   /* Bit 2 */
...
c_func
(paren
l_string|&quot;aci-rds: Hidden information discoverd!&bslash;n&quot;
)paren
suffix:semicolon
id|i
op_decrement
...
l_int|0
suffix:semicolon
multiline_comment|/* to be able to use rds_readcycle_nowait()&n;&t;   I have to readwait() here */
r_if
c_cond
(paren
id|rds_waitread
...
c_func
(paren
l_string|&quot;aci-rds: Out of memory...&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

multiline_comment|/* GemTek radio card driver for Linux (C) 1998 Jonas Munsin &lt;jmunsin@iki.fi&gt;&n; *&n; * GemTek hasn&squot;t released any specs on the card, so the protocol had to&n; * be reverse engineered with dosemu.&n; *&n; * Besides the protocol changes, this is mostly a copy of:&n; *&n; *    RadioTrack II driver for Linux radio support (C) 1998 Ben Pfaff&n; * &n; *    Based on RadioTrack I/RadioReveal (C) 1997 M. Kirkwood&n; *    Converted to new API by Alan Cox &lt;Alan.Cox@linux.org&gt;&n; *    Various bugfixes and enhancements by Russell Kroll &lt;rkroll@exploits.org&gt;&n; *&n; * TODO: Allow for more than one of these foolish entities :-)&n; *&n; */

...
suffix:semicolon
singleline_comment|//&t;DEB_INT((&quot;0x%08x&bslash;n&quot;,isr));
r_if
c_cond
(paren
l_int|0
...
multiline_comment|/* disable alle irqs */
id|saa7146_write
c_func
(paren
id|dev
...
(paren
(paren
l_string|&quot;found saa7146 @ mem 0x%08x (revision %d, irq %d) (0x%04x,0x%04x).&bslash;n&quot;
comma
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* free kernel memory */
id|kfree
c_func
(paren
id|dev-&gt;rps0

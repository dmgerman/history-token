...
(paren
(paren
l_string|&quot;before getting lock...&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|down
...
(paren
(paren
l_string|&quot;overlay already active in another open&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
(paren
l_string|&quot;cannot get overlay resources&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
(paren
l_string|&quot;this open is not capturing.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
multiline_comment|/* stop any active overlay */
r_if
c_cond
(paren
id|vv-&gt;ov_data
...
(paren
(paren
l_string|&quot;cannot get overlay resources again!&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|BUG

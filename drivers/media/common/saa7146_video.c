...
suffix:semicolon
multiline_comment|/* clear out beginning of streaming bit */
id|saa7146_write
c_func
(paren
id|dev
...
id|cap-&gt;capabilities
op_or_assign
id|dev-&gt;ext-&gt;ext_vv_data-&gt;capabilities
suffix:semicolon
r_return
l_int|0
suffix:semicolon
...
id|e-&gt;index
OL
id|dev-&gt;ext-&gt;ext_vv_data-&gt;num_stds
)paren
(brace
id|DEB_EE
c_func
...
l_int|NULL
op_ne
id|dev-&gt;ext-&gt;ext_vv_data-&gt;std_callback
)paren
(brace
id|dev-&gt;ext-&gt;ext_vv_data
op_member_access_from_pointer
...
(paren
(paren
l_string|&quot;VIDIOC_REQBUFS &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
(paren
l_string|&quot;VIDIOC_QUERYBUF &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
(paren
l_string|&quot;VIDIOC_DQBUF &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
(paren
l_string|&quot;VIDIOC_STREAMON &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
(paren
(paren
l_string|&quot;VIDIOC_STREAMOFF &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if

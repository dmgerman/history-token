...
suffix:semicolon
singleline_comment|// fixme: is this used at all? SAA7146_CLIPPING_RECT_INVERTED;
id|u32
id|type
op_assign
...
multiline_comment|/* reprogram hps, enable(1) / disable(0) video */
DECL|function|saa7146_set_overlay
r_void
...
l_int|0x18
suffix:semicolon
multiline_comment|/*&n;&t;if( 0 != (dev-&gt;ext_vv_data-&gt;flags &amp; SAA7146_EXT_SWAP_ODD_EVEN)) {&n;&t;&t;saa7146_write(dev, where, &t;vdma-&gt;base_even);&n;&t;&t;saa7146_write(dev, where+0x04, &t;vdma-&gt;base_odd);&n;&t;} else {&n;*/
id|saa7146_write
c_func
(paren
id|dev
...
id|CMD_O_FID_B
suffix:semicolon
multiline_comment|/*&n;&t;if( 0 != (dev-&gt;ext_vv_data-&gt;flags &amp; SAA7146_EXT_SWAP_ODD_EVEN)) {&n;&t;&t;unsigned long tmp = e_wait;&n;&t;&t;e_wait = o_wait;&n;&t;&t;o_wait = tmp;&n;&t;}&n;*/

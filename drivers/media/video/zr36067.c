...
multiline_comment|/*&n;   Miro/Pinnacle Systems Inc. DC10/DC10plus and&n;   Linux Media Labs LML33 video capture boards driver&n;   now with IOMega BUZ support!&n;   &n;   Copyright (C) 2000 Serguei Miridonov &lt;mirsev@cicese.mx&gt;&n;&n;   Changes for BUZ by Wolfgang Scherr &lt;scherr@net4you.net&gt;&n;   &n;   Based on&n;   &n;    Miro DC10 driver&n;    Copyright (C) 1999 Wolfgang Scherr &lt;scherr@net4you.net&gt;&n;   &n;    Iomega Buz driver version 1.0&n;    Copyright (C) 1999 Rainer Johanni &lt;Rainer@Johanni.de&gt;&n;&n;    buz.0.0.3&n;    Copyright (C) 1998 Dave Perks &lt;dperks@ibm.net&gt;&n;&n;    bttv - Bt848 frame grabber driver&n;    Copyright (C) 1996,97,98 Ralph  Metzler (rjkm@thp.uni-koeln.de)&n;                           &amp; Marcus Metzler (mocm@thp.uni-koeln.de)&n;&n;    &n;    This program is free software; you can redistribute it and/or modify&n;    it under the terms of the GNU General Public License as published by&n;    the Free Software Foundation; either version 2 of the License, or&n;    (at your option) any later version.&n;&n;    This program is distributed in the hope that it will be useful,&n;    but WITHOUT ANY WARRANTY; without even the implied warranty of&n;    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n;    GNU General Public License for more details.&n;&n;    You should have received a copy of the GNU General Public License&n;    along with this program; if not, write to the Free Software&n;    Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n;*/
...
macro_line|#endif
DECL|macro|IRQ_MASK
mdefine_line|#define IRQ_MASK ( ZR36057_ISR_GIRQ0 | ZR36057_ISR_GIRQ1 | /* ZR36057_ISR_CodRepIRQ | */  ZR36057_ISR_JPEGRepIRQ )&t;
singleline_comment|// SW
singleline_comment|//#define GPIO_MASK 0xcd
singleline_comment|//#define GPIO_MASK 0x8d
multiline_comment|/*&n;DC10:&n;GPIO0 = /RESET ZR 36060&n;GPIO1 = VIDEO BUS DIRECTION (0: CAPTURE, 1: DISPLAY)&n;GPIO2 = VIDEO BUS ENABLE    (0: ON, 1: OFF)&n;GPIO3 = /SLEEP ZR 36060&n;GPIO4 = ADC7175 (video out) FREQUENCY (0: LCC/SAA7110, 1: 27 MHz (quarz))&n;GPIO5 = ZORAN FREQUENCY  (0: LCC and LCC2 from SAA7110,&n;                          1: 27 and 13.5 MHz (quarz))&n;GPIO6 = /FRAME ZR 36060&n;GPIO7 = /RESET ADV7175 (video out)&n;(I think they lost the SAA7110 reset.....)&n;&n;GIRQ0 signals that ZR36060&squot;s DATERR# line is asserted.&n;GIRQ1 signals a vertical sync of the video signal (VS SAA7110)&n;&n;  SAA7110A:&n;   mode 0 - Composite&n;   mode 1 - &n;   mode 2 - &n;   mode 3 - &n;   mode 4 - &n;   mode 5 - internal Composite (from PCTV)&n;   mode 6 - &n;   mode 7 - S-Video&n;&n;BUZ:&n;GPIO0 = 1, take board out of reset&n;GPIO1 = 1, take JPEG codec out of sleep mode&n;GPIO3 = 1, deassert FRAME# to 36060&n;&n;GIRQ0 signals a vertical sync of the video signal&n;GIRQ1 signals that ZR36060&squot;s DATERR# line is asserted.&n;&n;SAA7111A&n;&n;   In their infinite wisdom, the Iomega engineers decided to&n;   use the same input line for composite and S-Video Color,&n;   although there are two entries not connected at all!&n;   Through this ingenious strike, it is not possible to&n;   keep two running video sources connected at the same time&n;   to Composite and S-VHS input!&n;&n;   mode 0 - N/C&n;   mode 1 - S-Video Y&n;   mode 2 - noise or something I don&squot;t know&n;   mode 3 - Composite and S-Video C&n;   mode 4 - N/C&n;   mode 5 - S-Video (gain C independently selectable of gain Y)&n;   mode 6 - N/C&n;   mode 7 - S-Video (gain C adapted to gain Y)&n;*/
DECL|macro|MAJOR_VERSION
mdefine_line|#define MAJOR_VERSION 0&t;&t;/* driver major version */
DECL|macro|MINOR_VERSION
mdefine_line|#define MINOR_VERSION 7&t;&t;/* driver minor version */
DECL|macro|ZORAN_NAME
mdefine_line|#define ZORAN_NAME    &quot;zr36067&quot;&t;/* name of the device */
DECL|macro|BUZ_ERR
mdefine_line|#define BUZ_ERR       KERN_ERR     ZORAN_NAME
DECL|macro|BUZ_DEBUG
mdefine_line|#define BUZ_DEBUG     KERN_INFO    ZORAN_NAME
DECL|macro|BUZ_INFO
mdefine_line|#define BUZ_INFO      KERN_INFO    ZORAN_NAME
DECL|macro|BUZ_WARNING
mdefine_line|#define BUZ_WARNING   KERN_WARNING ZORAN_NAME
macro_line|#if(DEBUGLEVEL&gt;0)
DECL|macro|DEBUG1
mdefine_line|#define DEBUG1(x...)    x
macro_line|#else
DECL|macro|DEBUG1
mdefine_line|#define DEBUG1(x...)
macro_line|#endif
macro_line|#if(DEBUGLEVEL&gt;1)
DECL|macro|DEBUG2
mdefine_line|#define DEBUG2(x...)    x
macro_line|#else
DECL|macro|DEBUG2
mdefine_line|#define DEBUG2(x...)
macro_line|#endif
macro_line|#if(DEBUGLEVEL&gt;2)
DECL|macro|DEBUG3
mdefine_line|#define DEBUG3(x...)    x
macro_line|#else
DECL|macro|DEBUG3
mdefine_line|#define DEBUG3(x...)
macro_line|#endif
macro_line|#if(DEBUGLEVEL&gt;3)
DECL|macro|DEBUG4
mdefine_line|#define DEBUG4(x...)    x
macro_line|#else
DECL|macro|DEBUG4
mdefine_line|#define DEBUG4(x...)
macro_line|#endif
...
l_int|0
suffix:semicolon
multiline_comment|/* 1 will use digital path in capture mode instead of analog.&n;&t;&t;&t;&t;   It can be used for picture adjustments using tool like xawtv&n;&t;&t;&t;&t;   while watching image on TV monitor connected to the output.&n;&t;&t;&t;&t;   However, due to absence of 75 Ohm load on Bt819 input, there&n;&t;&t;&t;&t;   will be some image imperfections */
...
(paren
id|KERN_INFO
l_string|&quot;%s: V4L frame %d mem 0x%lx (bus: 0x%lx)&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|i
...
(paren
id|KERN_ERR
l_string|&quot;%s: bigphysarea_alloc_pages for V4L bufs failed&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: No bigphysarea_patch present, usage of high memory disabled,&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: sorry, could not allocate V4L buffers of size %d KB.&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v4l_bufsize
...
id|off
suffix:semicolon
singleline_comment|//alloc_contig;
r_int
r_int
id|mem
suffix:semicolon
...
singleline_comment|//alloc_contig = (zr-&gt;jpg_bufsize &lt;= MAX_KMALLOC_MEM);
r_for
c_loop
(paren
id|i
...
id|printk
(paren
l_string|&quot;%s: jpg_fbuffer_alloc: %ld KB allocated&bslash;n&quot;
comma
id|zr-&gt;name
comma
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: i2c attach %02x&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|id
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: i2c detach %02x&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|id
...
l_int|NULL
comma
multiline_comment|/* SECAM (not supported in LML33) */
)brace
suffix:semicolon
DECL|variable|buznorms
r_static
r_struct
id|tvnorm
op_star
...
id|dc10norms
comma
multiline_comment|/* DC10     */
id|dc10norms
comma
multiline_comment|/* DC10plus */
id|lml33norms
comma
multiline_comment|/* LML33    */
id|buznorms
comma
multiline_comment|/* Buz      */
)brace
suffix:semicolon
DECL|variable|cardvsync
r_static
id|u32
id|cardvsync
(braket
...
(paren
id|BUZ_INFO
l_string|&quot;: width = %d, height = %d&bslash;n&quot;
comma
id|video_width
comma
id|video_height
...
singleline_comment|//btand(~ZR36057_ICR_GIRQ1, ZR36057_ICR); // SW
...
id|bpp
suffix:semicolon
multiline_comment|/*&n;&t; * There is a long list of limitations to what is allowed to be grabbed&n;&t; * We don&squot;t output error messages here, since some programs (e.g. xawtv)&n;&t; * just try several settings to find out what is valid or not.&n;&t; */
...
(paren
id|KERN_ERR
l_string|&quot;%s: Can not grab frame %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|mp-&gt;frame
...
(paren
id|KERN_ERR
l_string|&quot;%s: Wrong frame size.&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: Wrong bytes-per-pixel format&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: Video buffer size is too small&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: Wrong frame alingment&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
suffix:semicolon
singleline_comment|//DEBUG2(printk(KERN_INFO &quot;%s: Frame grab 3...&bslash;n&quot;, zr-&gt;name));
r_return
id|res
suffix:semicolon
)brace
...
multiline_comment|/*&n;Wait til post office is no longer busy */
...
DECL|function|set_videobus_enable
r_static
r_void
id|set_videobus_enable
c_func
(paren
r_struct
id|zoran
...
l_int|8192
suffix:semicolon
multiline_comment|/* Upper limit: 6/8 of the code buffers */
r_if
c_cond
(paren
id|size
...
l_int|0xf0
suffix:semicolon
multiline_comment|/* 480 bits/block, does 0xff represents unlimited? */
id|zr36060_write_8
c_func
(paren
id|zr
...
suffix:semicolon
singleline_comment|// Not needed for compr. with variable scale factor, just in case ...
...
suffix:semicolon
singleline_comment|//reg   = 30 - 1;               /* HsyncSize */
id|reg
op_assign
(paren
id|zr-&gt;params.norm
...
(paren
id|KERN_ERR
l_string|&quot;%sZR36060: stuck busy, statux=%02x&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|reg
...
singleline_comment|//if(zr-&gt;params.VFIFO_FB) reg |= ZR36057_JMC_VFIFO_FB; // No, it doesn&squot;t. SM
r_break
suffix:semicolon
r_case
id|BUZ_MODE_STILL_COMPRESS
...
(brace
singleline_comment|// Don&squot;t read zr36060 here
id|guest
(braket
id|i
)braket
...
suffix:semicolon
singleline_comment|// &bslash;CFlush
id|btor
c_func
(paren
...
suffix:semicolon
singleline_comment|// Enable IRQs
id|set_frame
c_func
(paren
id|zr
...
suffix:semicolon
singleline_comment|// GPIO(zr, 1, 0);
...
suffix:semicolon
singleline_comment|// Load ZR36060
id|init_jpeg_queue
c_func
(paren
id|zr
...
suffix:semicolon
singleline_comment|// GPIO(zr, 1, 1);
id|i2c_control_device
c_func
(paren
op_amp
...
suffix:semicolon
singleline_comment|//GPIO(zr, 6, 1);     // /FRAME
id|btor
c_func
(paren
id|ZR36057_MCTCR_CFlush
...
(brace
multiline_comment|/* Ok load up the zr36060 */
id|zr36057_enable_jpg
c_func
(paren
id|zr
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Warning: queing frame in BUZ_STATE_DONE state&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: BUZIOCSYNC: - codec not in streaming mode&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: timeout: codec isr=0x%02x, csr=0x%02x&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|zr36060_read_8
...
(brace
singleline_comment|//printk(KERN_ERR &quot;%s: Internal error: error handling request in mode %d&bslash;n&quot;, zr-&gt;name, zr-&gt;codec_mode);
r_return
suffix:semicolon
)brace
r_if
...
singleline_comment|//      printk(KERN_ERR &quot;%s: JPEG interrupt while not in motion (de)compress mode!&bslash;n&quot;, zr-&gt;name);
singleline_comment|//}
)brace
...
multiline_comment|/* DATERR interrupt received                 */
op_logical_or
id|zr-&gt;JPEG_missed
OG
l_int|25
multiline_comment|/* Too many fields missed without processing */
op_logical_or
id|zr-&gt;JPEG_error
op_eq
l_int|1
multiline_comment|/* We are already in error processing        */
op_logical_or
(paren
(paren
id|zr-&gt;codec_mode
...
multiline_comment|/* fields missed during decompression */
)paren
(brace
id|error_handler
c_func
...
id|MINOR_VERSION
suffix:semicolon
multiline_comment|/* Check input and norm: must be set by calling VIDIOCSCHAN only! */
id|params-&gt;norm
op_assign
id|zr-&gt;params.norm
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: SET PARAMS: error in params for decimation = 0&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: SET PARAMS: decimation = %d, must be 0, 1, 2 or 4&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|params-&gt;decimation
...
(paren
id|KERN_INFO
l_string|&quot;%s: zoran_open, %s pid=[%d]&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|current-&gt;comm
...
(paren
id|KERN_ERR
l_string|&quot;%s: zoran_open: v4l_fbuffer_alloc failed&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* Allow second open */
)brace
r_break
suffix:semicolon
r_default
...
(paren
id|KERN_WARNING
l_string|&quot;%s: zoran_open: flags = 0x%x not yet supported&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|flags
...
(paren
id|KERN_INFO
l_string|&quot;%s: zoran_close, %s pid=[%d]&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|current-&gt;comm
...
c_func
(paren
l_string|&quot;%s: ioctl VIDIOCGCAP&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
l_int|3
suffix:semicolon
multiline_comment|/* composite, svhs, internal */
)brace
r_else
(brace
id|b.channels
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCGCHAN for channel %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v.channel
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSCHAN called while the card in capture/playback mode&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|BUZ_WARNING
l_string|&quot;%s: Warning: VIDIOCSCHAN called while the card in capture/playback mode&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCSCHAN: channel=%d, norm=%d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v.channel
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSCHAN on not existing channel %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v.channel
...
(paren
id|KERN_WARNING
l_string|&quot;%s: VIDIOCSCHAN: TV standard is locked, can not switch norm.&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;%s: VIDIOCSCHAN: TV standard is locked, norm was not changed.&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSCHAN with not supported norm %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v.norm
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCGTUNER not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCSTUNER not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCGPICT&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCSPICT bri=%d hue=%d col=%d con=%d dep=%d pal=%d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|p.brightness
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCCAPTURE: %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCCAPTURE: buffer or window not set&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
c_func
(paren
l_string|&quot;%s: ioctl VIDIOCGWIN&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCSWIN: x=%d y=%d w=%d h=%d clipcount=%d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|vw.x
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSWIN: frame buffer has to be set first&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSWIN: width = %d or height = %d invalid&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|vw.width
...
(paren
id|KERN_ERR
l_string|&quot;%s: zoran_ioctl: Alloc of clip mask failed&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCGFBUF&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|v
suffix:semicolon
multiline_comment|/* RJ: Isn&squot;t this too restrictive? As long as the user doesn&squot;t set&n;&t;&t;&t;   the base address it shouldn&squot;t be too dangerous */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;%s: Only the superuser may issue VIDIOCSFBUF ioctl&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCSFBUF: base=0x%x w=%d h=%d depth=%d bpl=%d&bslash;n&quot;
comma
id|zr-&gt;name
comma
(paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSFBUF not allowed when overlay active&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSFBUF: depth=%d not supported&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v.depth
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSFBUF: invalid height/width/bpl value&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: VIDIOCSFBUF: bytesperline must be 4-byte aligned&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
c_func
(paren
l_string|&quot;%s: ioctl VIDIOCKEY&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCGFREQ not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCSFREQ not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCGAUDIO not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCSAUDIO not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCSYNC %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCMCAPTURE frame=%d geom=%dx%d fmt=%d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|vm.frame
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCGMBUF&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl VIDIOCGUNIT&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCGCAPTURE not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: ioctl VIDIOCSCAPTURE not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_G_PARAMS&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|bp
suffix:semicolon
multiline_comment|/* int input, on; */
r_if
c_cond
(paren
id|zr-&gt;codec_mode
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_S_PARAMS&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_REQBUFS count = %lu size=%lu&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|br.count
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_QBUF_CAPT %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|nb
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_QBUF_PLAY %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|nb
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_SYNC&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
id|printk
(paren
l_string|&quot;%s: ioctl BUZIOC_G_STATUS&bslash;n&quot;
comma
id|zr-&gt;name
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: BUZIOC_G_STATUS on not existing input %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|bs.input
...
(paren
id|KERN_INFO
l_string|&quot;%s: mmap at 0x%08lx, size %lu&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|start
...
(paren
id|KERN_ERR
l_string|&quot;%s: zoran_mmap(MJPEG): Max size is %lu - you wanted %lu&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|zr-&gt;jpg_nbufs
...
(paren
id|KERN_WARNING
l_string|&quot;%s: zoran_mmap(MJPEG): Expected %lu - you wanted %lu&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|zr-&gt;jpg_nbufs
...
(paren
id|KERN_ERR
l_string|&quot;%s: zoran_mmap(V4L): Max size is %d - you wanted %ld&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v4l_nbufs
...
(paren
id|KERN_WARNING
l_string|&quot;%s: zoran_mmap(V4L): Expected %d - you wanted %ld&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|v4l_nbufs
...
id|printk
(paren
l_string|&quot;V4L remap page range %d 0x%lx %ld to 0x%lx&bslash;n&quot;
comma
id|i
comma
id|page
...
(paren
id|KERN_INFO
l_string|&quot;%s: Initializing card[%d], zr=%x&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|i
...
(paren
id|KERN_WARNING
l_string|&quot;%s: default TV statdard not supported by hardware. PAL will be used.&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: zr36057_init: kmalloc (STAT_COM + ovl.mask) failed&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|// Enable Vsync interrupts too. SM
id|zr36057_init_vfe
c_func
(paren
id|zr
...
macro_line|#include &quot;zoran_procfs.c&quot;
DECL|function|release_dc10
r_static
r_void
id|release_dc10
c_func
...
(paren
id|KERN_ERR
l_string|&quot;%s: Bad irq number or handler&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: IRQ %d busy, change your PnP config in BIOS&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|zr-&gt;pci_dev-&gt;irq
...
(paren
id|KERN_ERR
l_string|&quot;%s: Can&squot;t assign irq, error code %d&bslash;n&quot;
comma
id|zr-&gt;name
comma
id|result
...
(paren
id|KERN_ERR
l_string|&quot;%s: Can&squot;t initialize i2c bus&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Card not supported&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s card detected&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Zoran ZR36060 not found&bslash;n&quot;
comma
id|zr-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;Chipset may not support reliable PCI-PCI DMA.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
(paren
id|KERN_WARNING
l_string|&quot;Enabling Triton support.&bslash;n&quot;
)paren
suffix:semicolon
id|triton
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;Enabling Natoma workaround.&bslash;n&quot;
)paren
suffix:semicolon
id|natoma
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;Zoran ZR36060 + ZR36057/67 MJPEG board driver version %d.%d&bslash;n&quot;
comma
id|MAJOR_VERSION
comma
id|MINOR_VERSION
...
l_int|0
suffix:semicolon
singleline_comment|//-ENXIO;
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;MJPEG: %d card(s) found&bslash;n&quot;
comma
id|zoran_num
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;MJPEG: using %d V4L buffers of size %d KB&bslash;n&quot;
comma
id|v4l_nbufs
comma
id|v4l_bufsize
...
(paren
id|KERN_INFO
l_string|&quot;MJPEG: Using supplied video memory base address @ 0x%lx&bslash;n&quot;
comma
id|vidmem
)paren
suffix:semicolon

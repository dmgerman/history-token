...
l_int|0
suffix:semicolon
DECL|macro|DFP_COUNT
mdefine_line|#define DFP_COUNT 0x41
DECL|variable|bl_dfp
r_static
r_const
r_int
id|bl_dfp
...
macro_line|# define I2C_M_IGNORE_NAK 0x1000
macro_line|#endif
...
r_static
r_void
DECL|function|msp3400c_restore_dfp
id|msp3400c_restore_dfp
c_func
(paren
r_struct
id|i2c_client
...
multiline_comment|/* unmute + restore dfp registers */
id|msp3400c_setvolume
c_func
(paren
id|client
...
id|I2C_HW_B_BT848
suffix:colon
singleline_comment|//case I2C_ALGO_SAA7134:
r_return
id|i2c_probe
c_func
(paren
...
suffix:semicolon
macro_line|#if 1
multiline_comment|/* work-in-progress:  hook to control the DFP registers */
r_case
id|MSP_SET_DFPREG
suffix:colon
(brace

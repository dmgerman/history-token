...
r_break
suffix:semicolon
multiline_comment|/* 4front API specs mention these ones,&n;   the (2.4.15) kernel header hasn&squot;t them ... */
macro_line|#ifdef AFMT_S32_LE
r_case
id|AFMT_S32_LE
suffix:colon
r_case
...
c_func
(paren
l_string|&quot;rec_start: afmt=%d ch=%d  =&gt;  fmt=0x%x swap=%c%c&bslash;n&quot;
comma
id|dev-&gt;oss.afmt
comma
id|dev-&gt;oss.channels

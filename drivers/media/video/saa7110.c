...
DECL|macro|SAA7110_NR_REG
mdefine_line|#define SAA7110_NR_REG&t;&t;0x35
DECL|struct|saa7110
r_struct
id|saa7110
(brace
...
id|data
suffix:semicolon
multiline_comment|/* first register to write to */
...
suffix:semicolon
multiline_comment|/* Cache the written data */
id|memcpy
c_func
(paren
id|decoder-&gt;reg

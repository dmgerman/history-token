...
suffix:semicolon
singleline_comment|//cx88_set_stereo(dev,norm-&gt;tvaudio, V4L2_TUNER_MODE_MONO);
singleline_comment|//cx_write(MO_AUD_DMACNTRL, 0x03); /* need audio fifo */
r_return
l_int|0
suffix:semicolon
)brace
...
l_int|1
comma
l_string|&quot;video_mux: %d [vmux=%d,gpio=0x%x]&bslash;n&quot;
comma
id|input
comma
id|INPUT
...
id|tvnorms
suffix:semicolon
multiline_comment|/* init dma queues */
id|INIT_LIST_HEAD
c_func
(paren
op_amp

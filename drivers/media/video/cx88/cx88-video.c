...
suffix:semicolon
DECL|macro|dprintk
mdefine_line|#define dprintk(level,fmt, arg...)&t;if (video_debug &gt;= level) &bslash;&n;&t;printk(KERN_DEBUG &quot;%s: &quot; fmt, dev-&gt;name , ## arg)
multiline_comment|/* ------------------------------------------------------------------ */
DECL|variable|cx8800_devlist
r_static
r_struct
id|list_head
id|cx8800_devlist
suffix:semicolon
DECL|variable|cx8800_devcount
r_static
r_int
r_int
id|cx8800_devcount
...
c_func
(paren
l_string|&quot;%s: pll out of range&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;set_tvnorm: &bslash;&quot;%s&bslash;&quot; fsc8=%d adc=%d vdec=%d&bslash;n&quot;
comma
id|norm-&gt;name
comma
id|fsc8
...
suffix:semicolon
singleline_comment|//cx88_risc_disasm(dev,&amp;dev-&gt;vidq.stopper);
id|cx_clear
c_func
(paren
id|MO_VID_DMACNTRL
...
(paren
id|KERN_WARNING
l_string|&quot;%s: video risc op code error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: irq loop -- clearing mask&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* stop interupts */
id|cx_write
c_func
(paren
id|MO_PCI_INTMSK
...
l_int|1
comma
l_string|&quot;cx8800_reset&bslash;n&quot;
)paren
suffix:semicolon
id|cx8800_shutdown
c_func
...
(paren
id|KERN_INFO
l_string|&quot;%s: can&squot;t register vbi device&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: can&squot;t register radio device&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* restart video capture */
id|spin_lock
c_func
(paren
op_amp

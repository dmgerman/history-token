...
op_assign
(brace
multiline_comment|/* Magic stuff from leadtek driver + datasheet.*/
(brace
id|AUD_DBX_IN_GAIN
comma
l_int|0x4734
...
comma
macro_line|#if 0
singleline_comment|// found this in WDM-driver for A2, must country spec.
singleline_comment|// Table 2
(brace
id|AUD_DMD_RA_DDS
comma
l_int|0x002a73bd
...
c_func
(paren
l_string|&quot;%s (status: WorksForMe[tm])&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

...
(brace
singleline_comment|// &squot;pass-thru mode&squot;: this enables the i2s output to the mpeg encoder
id|cx_set
c_func
(paren
id|AUD_CTL
...
c_func
(paren
id|AUD_I2SOUTPUTCNTL
comma
l_int|1
)paren
suffix:semicolon
singleline_comment|//cx_write(AUD_APB_IN_RATE_ADJ, 0);
)brace
...
(brace
multiline_comment|/* This is probably weird..&n;         * Let&squot;s operate and find out. */
r_static
r_const
r_struct
id|rlist
...
c_func
(paren
l_string|&quot;%s (status: devel), stereo : %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|stereo
...
(brace
multiline_comment|/* AM mono sound */
id|set_audio_start
c_func
(paren
id|core
...
DECL|function|set_audio_standard_PAL_I
r_static
r_void
id|set_audio_standard_PAL_I
c_func
(paren
r_struct
id|cx88_core
...
comma
singleline_comment|//     { AUD_DMD_RA_DDS,          0x00c0d5ce },
(brace
id|AUD_DEEMPHGAIN_R
comma
l_int|0x000023c2
...
r_else
(brace
singleline_comment|// Nicam Stereo
id|set_audio_start
c_func
(paren
id|core
...
id|WW_SYSTEM_L_AM
suffix:colon
multiline_comment|/* try nicam ... */
id|core-&gt;audiomode_current
op_assign
...
multiline_comment|/* manually set, don&squot;t do anything. */
r_continue
suffix:semicolon
multiline_comment|/* monitor signal */
r_if
c_cond
(paren
id|t.rxsubchans
...
r_continue
suffix:semicolon
multiline_comment|/* automatically switch to best available mode */
id|cx88_set_stereo
c_func
(paren
id|core

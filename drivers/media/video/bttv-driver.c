...
multiline_comment|/*&n; * Take a vmalloc address, and turn it into&n; * the aliased kernel virtual address..&n; *&n; * CAREFUL! Anybody who does this gets to sit&n; * in their own cr*p when it comes to virtual&n; * cache aliases. It&squot;s _your_ problem.&n; *&n; * Also, note how it only works within one page.&n; * If you&squot;re doing page-crossing stuff, you&squot;re on&n; * your own.&n; *&n; * THIS IS BROKEN CODE! You shouldn&squot;t do things&n; * like this.&n; */
DECL|function|vmalloc_to_virt
r_static
r_inline
r_void
op_star
...
macro_line|#if 0 /* tuner.signal might be of intrest for non-tuner sources too ... */
r_if
c_cond
(paren
id|v.tuner
...
id|v.bytesperline
suffix:semicolon
macro_line|#if 0 /* was broken for ages and nobody noticed.  Looks like we don&squot;t need&n;&t; it any more as everybody explicitly sets the palette using VIDIOCSPICT&n;&t; these days */
...
suffix:semicolon
multiline_comment|/* japan:          76.0 MHz -  89.9 MHz&n;&t;&t;   western europe: 87.5 MHz - 108.0 MHz&n;&t;&t;   russia:         65.0 MHz - 108.0 MHz */
id|v.rangelow
op_assign
(paren
r_int
...
DECL|macro|do_video_register
macro_line|# define do_video_register(dev,type,nr) video_register_device(dev,type,nr)

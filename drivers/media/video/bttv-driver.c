...
c_func
(paren
l_string|&quot;read count=%d type=%s&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;bttv%d: irq top=0x%08x bottom=0x%08x&quot;
l_string|&quot; vbi=0x%08x/0x%08x&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|btv-&gt;top
...
c_func
(paren
l_string|&quot;bttv%d: Huh? IRQ latency? main=0x%x rc=0x%x&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|btv-&gt;main.dma

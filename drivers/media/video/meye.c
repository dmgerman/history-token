...
c_func
(paren
l_string|&quot;v4l/v4l2 driver for the MotionEye camera&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
suffix:semicolon
DECL|variable|MEYE_DRIVER_VERSION
id|MODULE_VERSION
c_func
(paren
id|MEYE_DRIVER_VERSION
)paren
suffix:semicolon
multiline_comment|/* force usage of V4L1 API */
DECL|variable|forcev4l1
r_static
r_int
id|forcev4l1
suffix:semicolon
...
id|forcev4l1
comma
l_string|&quot;force use of V4L1 instead of V4L2&quot;
)paren
suffix:semicolon
...
l_string|&quot; (will be rounded up to a page multiple)&quot;
)paren
suffix:semicolon
...
multiline_comment|/* copy data from ptable into buf */
DECL|function|ptable_copy
r_static
r_void
id|ptable_copy
c_func
...
(paren
id|KERN_ERR
l_string|&quot;meye: need to reset HIC!&bslash;n&quot;
)paren
suffix:semicolon
id|mchip_set
c_func
...
(brace
multiline_comment|/* standard YUV 422 capture */
id|memset
c_func
(paren
id|f
...
r_else
(brace
multiline_comment|/* compressed MJPEG capture */
id|memset
c_func
(paren
id|f
...
(brace
multiline_comment|/* already allocated, no modifications */
r_break
suffix:semicolon
)brace
id|down
...
(paren
id|KERN_ERR
l_string|&quot;meye: v4l framebuffer allocation&quot;
...
multiline_comment|/*&n;&t; * XXX what about private snapshot ioctls ?&n;&t; * Do they need to be converted to V4L2 ?&n;&t;*/
r_default
suffix:colon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;meye: video_device_alloc() failed!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|outnotdev
...
(paren
id|KERN_ERR
l_string|&quot;meye: grab buffer allocation failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|outvmalloc
...
(paren
id|KERN_ERR
l_string|&quot;meye: fifo allocation failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|outkfifoalloc1
...
(paren
id|KERN_ERR
l_string|&quot;meye: request_irq failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|outreqirq
...
(paren
id|KERN_INFO
l_string|&quot;meye: Motion Eye Camera Driver v%s.&bslash;n&quot;
comma
id|MEYE_DRIVER_VERSION
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;meye: using %d buffers with %dk (%dk total)&quot;
l_string|&quot;for capture&bslash;n&quot;
comma
id|gbuffers
comma
id|gbufsize

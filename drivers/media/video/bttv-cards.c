...
id|vsfx
comma
l_string|&quot;set VSFX pci config bit [yet another chipset flaw workaround]&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
...
id|BTTV_MODTEC_205
comma
l_string|&quot;Modular Technology PCTV&quot;
)brace
comma
(brace
l_int|0x18501851
...
id|name
suffix:colon
l_string|&quot;GrandTec &squot;Grand Video Capture&squot;&quot;
comma
id|video_inputs
suffix:colon
l_int|2
...
id|name
suffix:colon
l_string|&quot;Phoebe TV Master Only (No FM)&quot;
comma
id|video_inputs
suffix:colon
l_int|3
...
singleline_comment|// 0x010000: somehow influences tuner picture quality (?)
id|audiomux
suffix:colon
(brace
l_int|0x947fff
...
singleline_comment|// AVermedia specific stuff...
singleline_comment|// from  bktr_card.c
...
suffix:semicolon
multiline_comment|/*&n;int tuner_0_fm_table[] = {&n;        PHILIPS_FR1236_NTSC,  PHILIPS_FR1216_PAL,&n;        PHILIPS_FR1216_PAL,   PHILIPS_FR1216_PAL,&n;        PHILIPS_FR1216_PAL,   PHILIPS_FR1216_PAL,&n;        PHILIPS_FR1236_SECAM, PHILIPS_FR1236_SECAM,&n;        PHILIPS_FR1236_SECAM, PHILIPS_FR1216_PAL};&n;*/
...
DECL|function|bttv_boot_msp34xx
r_void
id|__devinit

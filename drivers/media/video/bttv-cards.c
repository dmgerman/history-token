...
l_int|3
comma
multiline_comment|/* old &n;&t;gpiomask:&t;15,&n;&t;audiomux:&t;{12, 4,11,11, 0},&n;&t;*/
id|muxsel
suffix:colon
(brace
l_int|2
...
id|name
suffix:colon
l_string|&quot;Typhoon TView RDS / FM Stereo&quot;
comma
id|video_inputs
suffix:colon
l_int|3
...
comma
(brace
multiline_comment|/* Miguel Angel Alvarez &lt;maacruz@navegalia.com&gt; */
id|name
suffix:colon
...
multiline_comment|/* Gordon Heydon &lt;gjheydon@bigfoot.com */
id|name
suffix:colon
...
id|TUNER_ABSENT
comma
l_string|&quot;LG TAPC_l001D&quot;
)brace
comma
(brace
id|TUNER_ABSENT
comma
l_string|&quot;LG TAPC_l701D&quot;
)brace
)brace
suffix:semicolon
...
c_func
(paren
l_string|&quot;bttv%d: Hauppauge eeprom: model=%d, tuner=%s (%d), radio=%s&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|model
...
l_int|1
suffix:semicolon
multiline_comment|/* print warnings about quirks found */
r_if
c_cond
(paren
id|triton1

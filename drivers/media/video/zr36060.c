...
id|low_bitrate
comma
l_string|&quot;Buz compatibility option, halves bitrate&quot;
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|//dprintk(4, &quot;%s: reading from 0x%04x: %02x&bslash;n&quot;,ptr-&gt;name,reg,value);
r_return
id|value
suffix:semicolon
)brace
...
(brace
singleline_comment|//dprintk(4, &quot;%s: writing 0x%02x to 0x%04x&bslash;n&quot;,ptr-&gt;name,value,reg);
id|dprintk
c_func
(paren
l_int|4
comma
l_string|&quot;0x%02x @0x%04x&bslash;n&quot;
comma
id|value
comma
id|reg
...
r_static
id|u8
DECL|function|zr36060_read_status
id|zr36060_read_status
(paren
r_struct
id|zr36060
op_star
...
r_static
id|u16
DECL|function|zr36060_read_scalefactor
id|zr36060_read_scalefactor
(paren
r_struct
id|zr36060
op_star
...
r_static
r_void
DECL|function|zr36060_wait_end
id|zr36060_wait_end
(paren
r_struct
id|zr36060
...
r_static
r_int
DECL|function|zr36060_basic_test
id|zr36060_basic_test
(paren
r_struct
id|zr36060
op_star
...
multiline_comment|/* =========================================================================&n;   Basic datasets:&n;&n;   jpeg baseline setup data (you find it on lots places in internet, or just&n;   extract it from any regular .jpg image...)&n;&n;   Could be variable, but until it&squot;s not needed it they are just fixed to save&n;   memory. Otherwise expand zr36060 structure with arrays, push the values to&n;   it and initalize from there, as e.g. the linux zr36057/60 driver does it.&n;   ========================================================================= */
DECL|variable|zr36060_dqt
r_static
r_const
r_char
id|zr36060_dqt
...
l_int|0xe0
comma
singleline_comment|//Marker: APP0
l_int|0x00
comma
l_int|0x07
comma
singleline_comment|//Length: 7
l_char|&squot; &squot;
comma
...
l_int|0
comma
singleline_comment|// &squot;AVI&squot; field
l_int|0
comma
l_int|0
comma
...
l_int|0xfe
comma
singleline_comment|//Marker: COM
l_int|0x00
comma
l_int|0x06
comma
singleline_comment|//Length: 6
l_char|&squot; &squot;
comma
...
l_int|0
comma
singleline_comment|// &squot;COM&squot; field
l_int|0
comma
l_int|0
comma
...
DECL|variable|zr36060_decimation_h
r_static
r_const
r_char
id|zr36060_decimation_h
(braket
l_int|8
)braket
op_assign
...
suffix:semicolon
DECL|variable|zr36060_decimation_v
r_static
r_const
r_char
id|zr36060_decimation_v
(braket
l_int|8
)braket
op_assign
...
suffix:semicolon
singleline_comment|// only &squot;8&squot; possible with zr36060
id|sof_data
(braket
l_int|5
)braket
...
multiline_comment|/* =========================================================================&n;   Setup function:&n;&n;   Setup compression/decompression of Zoran&squot;s JPEG processor&n;   ( see also zoran 36060 manual )&n;&n;   ... sorry for the spaghetti code ...&n;   ========================================================================= */
r_static
r_void
DECL|function|zr36060_init
id|zr36060_init
(paren
r_struct
id|zr36060
...
id|ZR060_LOAD
comma
id|ZR060_LOAD_SyncRst
)paren
suffix:semicolon
multiline_comment|/* 060 communicates with 067 in master mode */
id|zr36060_write
c_func
(paren
id|ptr
...
id|ZR060_CIR
comma
id|ZR060_CIR_CodeMstr
)paren
suffix:semicolon
multiline_comment|/* Compression with or without variable scale factor */
multiline_comment|/*FIXME: What about ptr-&gt;bitrate_ctrl? */
id|zr36060_write
c_func
(paren
id|ptr
...
suffix:semicolon
multiline_comment|/* Disable all IRQs - no DataErr means autoreset */
id|zr36060_write
c_func
(paren
id|ptr
...
suffix:semicolon
multiline_comment|/* JPEG markers to be included in the compressed stream */
id|zr36060_write
c_func
(paren
id|ptr
...
suffix:semicolon
multiline_comment|/* Setup the Video Frontend */
multiline_comment|/* Limit pixel range to 16..235 as per CCIR-601 */
id|zr36060_write
c_func
(paren
id|ptr
...
suffix:semicolon
multiline_comment|/* Setup the Video Frontend */
singleline_comment|//zr36060_write(ptr, ZR060_VCR, ZR060_VCR_FIExt);
singleline_comment|//this doesn&squot;t seem right and doesn&squot;t work...
id|zr36060_write
c_func
(paren
id|ptr
...
multiline_comment|/* Load the tables */
id|zr36060_write
c_func
(paren
id|ptr
...
r_static
r_int
DECL|function|zr36060_set_mode
id|zr36060_set_mode
(paren
r_struct
id|videocodec
...
l_int|2
comma
l_string|&quot;%s: set_video %d/%d-%dx%d (%%%d) call&bslash;n&quot;
comma
id|ptr-&gt;name
comma
id|cap-&gt;x
...
suffix:semicolon
multiline_comment|/* Note that VSPol/HSPol bits in zr36060 have the opposite&n;&t; * meaning of their zr360x7 counterparts with the same names&n;&t; * N.b. for VSPol this is only true if FIVEdge = 0 (default,&n;&t; * left unchanged here - in accordance with datasheet).&n;&t;*/
id|reg
op_assign
(paren
op_logical_neg
...
singleline_comment|///*CP*/        reg = (zr-&gt;params.norm == 1 ? 57 : 68);
id|reg
op_assign
l_int|68
suffix:semicolon
...
multiline_comment|/* (Ronald) by default, quality = 100 is a compression&n;&t; * ratio 1:2. Setting low_bitrate (insmod option) sets&n;&t; * it to 1:4 (instead of 1:2, zr36060 max) as limit because the&n;&t; * buz can&squot;t handle more at decimation=1... Use low_bitrate if&n;&t; * you have a Buz, unless you know what you&squot;re doing */
id|size
op_assign
id|size
op_star
...
multiline_comment|/* the MBCVR is the *maximum* block volume, according to the&n;&t; * JPEG ISO specs, this shouldn&squot;t be used, since that allows&n;&t; * for the best encoding quality. So set it to it&squot;s max value */
id|reg
op_assign
...
l_int|2
comma
l_string|&quot;zr36060: initializing MJPEG subsystem #%d.&bslash;n&quot;
comma
id|zr36060_codecs
)paren
suffix:semicolon
...
comma
id|KERN_ERR
l_string|&quot;zr36060: Can&squot;t attach more codecs!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
comma
id|KERN_ERR
l_string|&quot;zr36060: Can&squot;t get enough memory!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
comma
id|KERN_ERR
l_string|&quot;zr36060: failed to increase module use count&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
l_int|240
suffix:semicolon
multiline_comment|/* CHECKME, was 120 is 240 */
id|ptr-&gt;scalefact
op_assign
l_int|0x100
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* CHECKME, was 8 is 1 */
id|zr36060_init
c_func
(paren
id|ptr
...
r_int
id|__init
DECL|function|zr36060_init_module
id|zr36060_init_module
(paren
r_void
)paren
(brace
singleline_comment|//dprintk(1, &quot;zr36060 driver %s&bslash;n&quot;,ZR060_VERSION);
id|zr36060_codecs
op_assign
l_int|0
suffix:semicolon
...
r_void
id|__exit
DECL|function|zr36060_cleanup_module
id|zr36060_cleanup_module
(paren
r_void
)paren
(brace
...
l_int|1
comma
l_string|&quot;zr36060: something&squot;s wrong - %d codecs left somehow.&bslash;n&quot;
comma
id|zr36060_codecs
)paren
suffix:semicolon
)brace
multiline_comment|/* however, we can&squot;t just stay alive */
...
DECL|variable|zr36060_init_module
id|module_init
c_func
(paren
id|zr36060_init_module
...
suffix:semicolon
DECL|variable|zr36060_cleanup_module
id|module_exit
c_func
(paren
id|zr36060_cleanup_module
...
c_func
(paren
l_string|&quot;Laurent Pinchart &lt;laurent.pinchart@skynet.be&gt;&quot;
)paren
suffix:semicolon
id|MODULE_DESCRIPTION
c_func
(paren
l_string|&quot;Driver module for ZR36060 jpeg processors &quot;
id|ZR060_VERSION
)paren
suffix:semicolon
id|MODULE_LICENSE

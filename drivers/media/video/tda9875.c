...
macro_line|#endif
DECL|function|i2c_read_register
r_static
r_int
id|i2c_read_register
c_func
(paren
r_struct
id|i2c_adapter
...
(paren
id|KERN_WARNING
l_string|&quot;tda9875: I/O error (read2)&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;tda9875: chip_read2: reg%d=0x%x&bslash;n&quot;
comma
id|reg
comma
id|read
...
(brace
singleline_comment|// tda9875 and tda9875A
id|printk
c_func
(paren
l_string|&quot;tda9875: TDA9875%s Rev.%d detected at 0x%x&bslash;n&quot;
comma
id|dic
op_eq
l_int|0
...
c_func
(paren
l_string|&quot;tda9875: no such chip at 0x%x (dic=0x%x rev=0x%x)&bslash;n&quot;
comma
id|addr
op_lshift
l_int|1

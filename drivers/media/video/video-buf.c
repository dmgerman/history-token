...
l_int|2
comma
l_string|&quot;lock ok [%d pages]&bslash;n&quot;
comma
id|nr_pages
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;lock failed, unlock ...&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
l_int|2
comma
l_string|&quot;unlock start ...&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
l_int|2
comma
l_string|&quot;unlock ok [%d pages]&bslash;n&quot;
comma
id|nr_pages
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;videobuf_lock: %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(brace
multiline_comment|/* dirty, undocumented hack -- pass the frame counter&n;&t;&t;&t; * within the last four bytes of each vbi data block.&n;&t;&t;&t; * We need that one to maintain backward compatibility&n;&t;&t;&t; * to all vbi decoding software out there ... */
id|fc
op_assign
(paren
r_int

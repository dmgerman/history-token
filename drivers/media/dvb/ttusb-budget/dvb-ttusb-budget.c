...
multiline_comment|/*&n;  TTUSB_HWSECTIONS:&n;    the DSP supports filtering in hardware, however, since the &quot;muxstream&quot;&n;    is a bit braindead (no matching channel masks or no matching filter mask),&n;    we won&squot;t support this - yet. it doesn&squot;t event support negative filters,&n;    so the best way is maybe to keep TTUSB_HWSECTIONS undef&squot;d and just&n;    parse TS data. USB bandwith will be a problem when having large&n;    datastreams, especially for dvb-net, but hey, that&squot;s not my problem.&n;&n;  TTUSB_DISEQC, TTUSB_TONE:&n;    let the STC do the diseqc/tone stuff. this isn&squot;t supported at least with&n;    my TTUSB, so let it undef&squot;d unless you want to implement another&n;    frontend. never tested.&n;&n;  DEBUG:&n;    define it to &gt; 3 for really hardcore debugging. you probably don&squot;t want&n;    this unless the device doesn&squot;t load at all. &gt; 2 for bandwidth statistics.&n;*/
DECL|variable|debug
r_static
r_int
id|debug
...
macro_line|#endif
DECL|macro|TTUSB_REV_2_2
mdefine_line|#define TTUSB_REV_2_2&t;0x22
...
macro_line|#endif
DECL|function|lnbp21_set_voltage
r_static
r_int
id|lnbp21_set_voltage
c_func
(paren
r_struct
id|dvb_frontend
...
suffix:semicolon
DECL|variable|alps_bsbe1_inittab
r_static
id|u8
id|alps_bsbe1_inittab
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|function|alps_stv0299_set_symbol_rate
r_static
r_int
id|alps_stv0299_set_symbol_rate
c_func
(paren
r_struct
id|dvb_frontend
...
DECL|function|philips_tsa5059_pll_set
r_static
r_int
id|philips_tsa5059_pll_set
c_func
(paren
r_struct
id|dvb_frontend
...
l_int|0xC0
suffix:semicolon
multiline_comment|/* BSBE1 wants XCE bit set */
r_if
c_cond
(paren
id|ttusb-&gt;revision
...
DECL|variable|alps_stv0299_config
r_static
r_struct
id|stv0299_config
id|alps_stv0299_config
op_assign
(brace
dot
id|demod_address
...
suffix:semicolon
DECL|function|ttusb_novas_grundig_29504_491_pll_set
r_static
r_int
id|ttusb_novas_grundig_29504_491_pll_set
c_func
(paren
r_struct
id|dvb_frontend
...
DECL|variable|ttusb_novas_grundig_29504_491_config
r_static
r_struct
id|tda8083_config
id|ttusb_novas_grundig_29504_491_config
op_assign
(brace
dot
id|demod_address
...
l_int|0x1003
suffix:colon
singleline_comment|// Hauppauge/TT Nova-USB-S budget (stv0299/ALPS BSRU6|BSBE1(tsa5059))
singleline_comment|// try the stv0299 based first
id|ttusb-&gt;fe
op_assign
id|stv0299_attach
c_func
...
(brace
singleline_comment|// ALPS BSBE1
id|alps_stv0299_config.inittab
op_assign
id|alps_bsbe1_inittab
suffix:semicolon
id|ttusb-&gt;fe-&gt;ops-&gt;set_voltage
op_assign
id|lnbp21_set_voltage
suffix:semicolon
)brace
...
singleline_comment|// Grundig 29504-491
id|ttusb-&gt;fe
op_assign
id|tda8083_attach
c_func

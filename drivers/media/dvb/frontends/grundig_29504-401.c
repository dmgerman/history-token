...
multiline_comment|/**&n; *   set up the downconverter frequency divisor for a&n; *   reference clock comparision frequency of 166666 Hz.&n; *   frequency offset is 36000000 Hz.&n; */
r_static
...
suffix:semicolon
singleline_comment|//&t;&t;tsa5060_set_tv_freq (i2c, p-&gt;frequency, 0);
)brace
r_case
id|FE_GET_FRONTEND
suffix:colon
...
id|FE_RESET
suffix:colon
singleline_comment|//reset_afc (i2c);
id|apply_tps
(paren
id|i2c
)paren

...
DECL|macro|rd
mdefine_line|#define rd(reg) dib3000mb_read_reg(state,reg)
DECL|macro|wr
mdefine_line|#define wr(reg,val) if (dib3000mb_write_reg(state,reg,val)) &bslash;&n;&t;{ err(&quot;while sending 0x%04x to 0x%04x.&quot;,val,reg); return -EREMOTEIO; }
...
c_func
(paren
l_string|&quot;setting pid 0x%x on index %d&bslash;n&quot;
comma
id|pid
comma
id|index
...
DECL|function|dib3000mb_pid_filter
r_static
r_int
id|dib3000mb_pid_filter
c_func
(paren
r_struct
id|dvb_frontend
...
(brace
singleline_comment|//struct dib3000mb_state *state = fe-&gt;demodulator_priv;
...
id|error
suffix:semicolon
multiline_comment|/* initialize the id_list */
id|deb_info
c_func
(paren

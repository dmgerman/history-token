...
id|FE_INIT
suffix:colon
singleline_comment|//For the VP310 we should run at 60MHz when ever possible.
singleline_comment|//It should be better to run the mt312 ar lower speed when ever possible, but tunning will be slower. ACCJr 09/29/03
r_if
c_cond
(paren
(paren

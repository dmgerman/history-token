...
mdefine_line|#define FRONTEND_NAME &quot;dvbfe_mt312&quot;
DECL|macro|dprintk
...
id|FE_INIT
suffix:colon
multiline_comment|/* For the VP310 we should run at 60MHz when ever possible.&n;&t;&t; * It should be better to run the mt312 ar lower speed when&n;&t;&t; * ever possible, but tunning will be slower. ACCJr 09/29/03&n;&t;&t; */
r_if
c_cond
(paren
id|state-&gt;id
...
id|client_template
suffix:semicolon
DECL|function|mt312_attach_adapter
r_static
r_int
id|mt312_attach_adapter
c_func
(paren
r_struct
id|i2c_adapter
...
DECL|function|mt312_detach_client
r_static
r_int
id|mt312_detach_client
c_func
(paren
r_struct
id|i2c_client
...
(paren
id|KERN_ERR
l_string|&quot;mt312: driver deregistration failed.&bslash;n&quot;
)paren
suffix:semicolon
)brace

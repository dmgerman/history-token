...
id|feps
suffix:semicolon
id|feps.u.ofdm.bandwidth
op_assign
id|ofdm-&gt;bandwidth
suffix:semicolon
multiline_comment|/* bw is not auto searched */
suffix:semicolon
r_if
c_cond
(paren
...
suffix:semicolon
singleline_comment|//&t;&t;dib3000mc_set_timing(1,ofdm-&gt;transmission_mode,ofdm-&gt;bandwidth);
singleline_comment|//&t;&t;wr(DIB3000MC_REG_LOCK_MASK,DIB3000MC_ACTIVATE_LOCK_MASK); /* activates some locks if needed */
multiline_comment|/*&t;&t;set_or(DIB3000MC_REG_DEMOD_PARM,DIB3000MC_DEMOD_RST_AUTO_SRCH_ON);&n;&t;&t;set_or(DIB3000MC_REG_DEMOD_PARM,DIB3000MC_DEMOD_RST_AUTO_SRCH_OFF);&n;&t;&t;wr(DIB3000MC_REG_RESTART_VIT,DIB3000MC_RESTART_VIT_ON);&n;&t;&t;wr(DIB3000MC_REG_RESTART_VIT,DIB3000MC_RESTART_VIT_OFF);*/
)brace
r_return
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&t;if (state-&gt;config-&gt;pll_init) {&n;&t;&t;wr(DIB3000MC_REG_TUNER,&n;&t;&t;&t;DIB3000_TUNER_WRITE_ENABLE(state-&gt;config-&gt;pll_addr));&n;&t;&t;state-&gt;config-&gt;pll_init(fe);&n;&t;&t;wr(DIB3000MC_REG_TUNER,&n;&t;&t;&t;DIB3000_TUNER_WRITE_DISABLE(state-&gt;config-&gt;pll_addr));&n;&t;}*/
r_return
l_int|0
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;Found a DiBcom 3000-MC.&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon

...
c_func
(paren
l_string|&quot;%s: readreg error (reg=%d, ret==%i)&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|reg
...
DECL|function|mt352_calc_nominal_rate
r_static
r_void
id|mt352_calc_nominal_rate
c_func
(paren
r_struct
id|mt352_state
...
c_func
(paren
l_string|&quot;%s: bw %d, adc_clock %d =&gt; 0x%x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|bw
...
DECL|function|mt352_calc_input_freq
r_static
r_void
id|mt352_calc_input_freq
c_func
(paren
r_struct
id|mt352_state
...
l_int|20480
suffix:semicolon
multiline_comment|/* 20.480000 MHz */
r_int
id|if2
op_assign
l_int|36167
suffix:semicolon
multiline_comment|/* 36.166667 MHz */
r_int
id|ife
comma
id|value
...
c_func
(paren
l_string|&quot;%s: if2 %d, ife %d, adc_clock %d =&gt; %d / 0x%x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|if2
...
singleline_comment|//&t;buf[3] = 0xf4;  // pinnacle
id|mt352_calc_nominal_rate
c_func
(paren
id|state
...
c_cond
(paren
id|state-&gt;config-&gt;no_tuner
)paren
(brace
multiline_comment|/* start decoding */
id|mt352_write
c_func
(paren
id|fe
...
r_else
(brace
multiline_comment|/* start tuning */
id|mt352_write
c_func
(paren
id|fe
...
id|s3
suffix:semicolon
multiline_comment|/* FIXME:&n;&t; *&n;&t; * The MT352 design manual from Zarlink states (page 46-47):&n;&t; *&n;&t; * Notes about the TUNER_GO register:&n;&t; *&n;&t; * If the Read_Tuner_Byte (bit-1) is activated, then the tuner status&n;&t; * byte is copied from the tuner to the STATUS_3 register and&n;&t; * completion of the read operation is indicated by bit-5 of the&n;&t; * INTERRUPT_3 register.&n;&t; */
r_if
c_cond
(paren
(paren

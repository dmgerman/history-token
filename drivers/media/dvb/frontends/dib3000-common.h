...
mdefine_line|#define wr_foreach(a,v) { int i; &bslash;&n;&t;if (sizeof(a) != sizeof(v)) &bslash;&n;&t;&t;err(&quot;sizeof: %zu %zu is different&quot;,sizeof(a),sizeof(v));&bslash;&n;&t;for (i=0; i &lt; sizeof(a)/sizeof(u16); i++) &bslash;&n;&t;&t;wr(a[i],v[i]); &bslash;&n;&t;}
DECL|macro|set_or

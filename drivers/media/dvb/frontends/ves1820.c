...
DECL|macro|SET_PWM
mdefine_line|#define SET_PWM(data,pwm) do { &t;&t;&bslash;&n;&t;(int) data &amp;= ~0xff; &t;&t;&bslash;&n;&t;(int) data |= pwm; &t;&t;&bslash;&n;} while (0)
DECL|macro|SET_REG0
mdefine_line|#define SET_REG0(data,reg0) do {&t;&bslash;&n;&t;(int) data &amp;= ~(0xff &lt;&lt; 8); &t;&bslash;&n;&t;(int) data |= reg0 &lt;&lt; 8; &t;&bslash;&n;} while (0)
DECL|macro|SET_TUNER
mdefine_line|#define SET_TUNER(data,type) do {&t;&bslash;&n;&t;(int) data &amp;= ~(0xff &lt;&lt; 16); &t;&bslash;&n;&t;(int) data |= type &lt;&lt; 16;&t;&bslash;&n;} while (0)
DECL|macro|SET_DEMOD_ADDR
mdefine_line|#define SET_DEMOD_ADDR(data,type) do {&t;&bslash;&n;&t;(int) data &amp;= ~(0xff &lt;&lt; 24); &t;&bslash;&n;&t;(int) data |= type &lt;&lt; 24;&t;&bslash;&n;} while (0)
DECL|macro|GET_PWM
mdefine_line|#define GET_PWM(data) ((u8) ((int) data &amp; 0xff))
DECL|macro|GET_REG0
mdefine_line|#define GET_REG0(data) ((u8) (((int) data &gt;&gt; 8) &amp; 0xff))
DECL|macro|GET_TUNER
mdefine_line|#define GET_TUNER(data) ((u8) (((int) data &gt;&gt; 16) &amp; 0xff))
DECL|macro|GET_DEMOD_ADDR
mdefine_line|#define GET_DEMOD_ADDR(data) ((u8) (((int) data &gt;&gt; 24) &amp; 0xff))
r_static
r_inline

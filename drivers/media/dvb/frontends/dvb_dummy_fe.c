...
mdefine_line|#define FRONTEND_NAME &quot;dvbfe_dummy&quot;
DECL|variable|frontend_type
r_static
r_int
id|frontend_type
suffix:semicolon
...
id|frontend_type
comma
l_string|&quot;0 == DVB-S, 1 == DVB-C, 2 == DVB-T&quot;
)paren
suffix:semicolon
...
id|client_template
suffix:semicolon
DECL|function|dvbdummyfe_attach_adapter
r_static
r_int
id|dvbdummyfe_attach_adapter
c_func
(paren
r_struct
id|i2c_adapter
...
DECL|function|dvbdummyfe_detach_client
r_static
r_int
id|dvbdummyfe_detach_client
c_func
(paren
r_struct
id|i2c_client
...
DECL|function|dvbdummyfe_command
r_static
r_int
id|dvbdummyfe_command
c_func
(paren
r_struct
id|i2c_client
...
(paren
id|KERN_ERR
l_string|&quot;dummyfe: driver deregistration failed.&bslash;n&quot;
)paren
suffix:semicolon
)brace

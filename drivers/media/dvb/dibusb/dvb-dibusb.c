multiline_comment|/*&n; * Driver for mobile USB Budget DVB-T devices based on reference&n; * design made by DiBcom (http://www.dibcom.fr/)&n; *&n; * dvb-dibusb.c&n; *&n; * Copyright (C) 2004 Patrick Boettcher (patrick.boettcher@desy.de)&n; *&n; * based on GPL code from DiBcom, which has&n; * Copyright (C) 2004 Amaury Demol for DiBcom (ademol@dibcom.fr)&n; *&n; * Remote control code added by David Matthews (dm@prolingua.co.uk)&n; *&n; *&t;This program is free software; you can redistribute it and/or&n; *&t;modify it under the terms of the GNU General Public License as&n; *&t;published by the Free Software Foundation, version 2.&n; *&n; * Acknowledgements&n; *&n; *  Amaury Demol (ademol@dibcom.fr) from DiBcom for providing specs and driver&n; *  sources, on which this driver (and the dib3000mb/mc/p frontends) are based.&n; *&n; * see Documentation/dvb/README.dibusb for more information&n; */
...
suffix:semicolon
DECL|variable|panasonic_cofdm_env57h1xd5
r_static
r_struct
id|dib3000_config
id|panasonic_cofdm_env57h1xd5
op_assign
(brace
dot
id|demod_address
...
id|addr
op_assign
id|panasonic_cofdm_env57h1xd5.pll_addr
comma
dot
id|flags
op_assign
...
c_func
(paren
l_string|&quot;running at FULL speed, will use pid parsing.&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
c_func
(paren
l_string|&quot;running at HIGH speed, will use pid_parsing anyway.&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon

...
id|EINVAL
suffix:semicolon
multiline_comment|/*&t;if (dib-&gt;disconnecting)&n;&t;&t;return -EINVAL;*/
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;could not submit buffer urb.&quot;
)paren
suffix:semicolon
r_return
id|ret
...
c_func
(paren
l_string|&quot;stopfeed pid: 0x%04x, feedtype: %d&quot;
comma
id|dvbdmxfeed-&gt;pid
comma
id|dvbdmxfeed-&gt;type
...
multiline_comment|/*&n; * do not use this, just a workaround for a bug,&n; * which will never occur :).&n; */
...
multiline_comment|/*&n; * TODO: a tasklet should run with a delay of 1/10 second&n; * and fill an appropriate event device ?&n; */

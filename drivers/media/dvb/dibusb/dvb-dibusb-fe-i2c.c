...
c_func
(paren
l_string|&quot;demod id: %d %d&bslash;n&quot;
comma
...
id|TUNER_MUL
suffix:semicolon
singleline_comment|//&t;div = ((fep-&gt;frequency/1000 + 36166) * 6) / 1000;
r_if
c_cond
(paren
id|fep-&gt;frequency
...
l_int|0xce
suffix:semicolon
singleline_comment|//&t;pllbuf[2] = 0xcc;
id|pllbuf
(braket
l_int|3
)braket

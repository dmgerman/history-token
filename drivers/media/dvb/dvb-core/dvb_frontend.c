...
suffix:semicolon
DECL|struct|dvb_frontend_private
r_struct
id|dvb_frontend_private
(brace
DECL|member|dvbdev
r_struct
id|dvb_device
...
op_assign
id|fepriv-&gt;parameters.inversion
suffix:semicolon
id|u32
id|original_frequency
op_assign
id|fepriv-&gt;parameters.frequency
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: drift:%i inversion:%i auto_step:%i &quot;
...
c_cond
(paren
id|fe-&gt;ops-&gt;read_signal_strength
)paren
id|err
op_assign
id|fe-&gt;ops
...
c_cond
(paren
id|fe-&gt;ops-&gt;diseqc_reset_overload
)paren
(brace
id|err
op_assign
...
c_cond
(paren
id|fe-&gt;ops-&gt;diseqc_send_master_cmd
)paren
(brace
id|err
op_assign
...
c_cond
(paren
id|fe-&gt;ops-&gt;dishnetwork_send_legacy_command
)paren
(brace
id|err
op_assign
...
c_cond
(paren
id|fe-&gt;ops-&gt;diseqc_recv_slave_reply
)paren
id|err
op_assign
id|fe-&gt;ops
...
c_cond
(paren
id|fe-&gt;ops-&gt;enable_high_lnb_voltage
)paren
id|err
op_assign
id|fe-&gt;ops
...
c_cond
(paren
id|fepriv-&gt;parameters.u.ofdm.hierarchy_information
op_eq
id|HIERARCHY_NONE
op_logical_and
id|fepriv-&gt;parameters.u.ofdm.code_rate_LP
op_eq
id|FEC_NONE
)paren
id|fepriv-&gt;parameters.u.ofdm.code_rate_LP
...
id|fepriv-&gt;step_size
op_assign
id|fepriv-&gt;parameters.u.qpsk.symbol_rate
op_div
l_int|16000
suffix:semicolon
id|fepriv-&gt;max_drift
...
id|fepriv-&gt;step_size
op_assign
id|fe-&gt;ops-&gt;info.frequency_stepsize
op_star
l_int|2
suffix:semicolon
id|fepriv-&gt;max_drift
...
c_cond
(paren
id|fepriv-&gt;events.eventw
op_ne
id|fepriv-&gt;events.eventr
)paren
r_return
(paren
id|POLLIN

...
suffix:semicolon
DECL|struct|dvb_fe_notifier_callbacks
r_struct
id|dvb_fe_notifier_callbacks
(brace
...
id|dvbdev
suffix:semicolon
DECL|member|notifier_callbacks
r_struct
id|list_head
id|notifier_callbacks
suffix:semicolon
...
(brace
(brace
multiline_comment|/* NTV on Astra */
id|frequency
suffix:colon
l_int|12669500
op_minus
...
id|printk
(paren
l_string|&quot;%s: initialising frontend %i:%i (%s)...&bslash;n&quot;
comma
id|__FUNCTION__
comma

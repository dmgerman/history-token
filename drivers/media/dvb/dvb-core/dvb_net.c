...
suffix:semicolon
r_else
multiline_comment|/* compatibility fix to keep dvb0_0 format */
id|snprintf
c_func
(paren
id|net-&gt;name
...
c_func
(paren
l_string|&quot;dvb_net: created network interface %s&bslash;n&quot;
comma
id|net-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;dvb_net: removed network interface %s&bslash;n&quot;
comma
id|net-&gt;name
)paren
suffix:semicolon

...
id|writers
suffix:semicolon
multiline_comment|/* don&squot;t really need those !? */
...
suffix:semicolon
singleline_comment|// FIXME: use generic_usercopy()
DECL|member|priv
r_void
op_star
id|priv
suffix:semicolon
DECL|typedef|dvb_device_t
)brace
id|dvb_device_t
suffix:semicolon
r_int
...
suffix:semicolon
macro_line|#endif /* #ifndef __DVBDEV_H */
eof

...
mdefine_line|#define KBUILD_MODNAME av7110
macro_line|#endif
...
(paren
(paren
l_string|&quot;dvb_filter_pes2ts_t:%p&bslash;n&quot;
comma
id|p2t
)paren
)paren
...
c_func
(paren
l_string|&quot;buffer empty - avail %d blen %u dlen %d&bslash;n&quot;
comma
id|len
comma
id|blen
...
(paren
(paren
l_string|&quot;pread=%08x, pwrite=%08x&bslash;n&quot;
comma
id|buf-&gt;pread
comma
id|buf-&gt;pwrite
...
multiline_comment|/**&n;&t; * some special handling for the Siemens DVB-C card...&n;&t; */
r_if
c_cond
(paren

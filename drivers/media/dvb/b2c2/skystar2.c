...
suffix:semicolon
DECL|macro|dprintk
mdefine_line|#define dprintk&t;if(debug != 0) printk
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|//              register functions
singleline_comment|/////////////////////////////////////////////////////////////////////
DECL|function|WriteRegDW
r_void
id|WriteRegDW
c_func
(paren
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|//      device = 0x10000000 for tuner
singleline_comment|//               0x20000000 for eeprom
singleline_comment|/////////////////////////////////////////////////////////////////////
...
singleline_comment|// allow only the vp310 frontend to access the bus
r_if
c_cond
(paren
(paren
...
suffix:semicolon
singleline_comment|// master xfer functions always return the number of successfully
singleline_comment|// transmitted messages, not the number of transmitted bytes.
singleline_comment|// return -EREMOTEIO in case of failure.
r_return
id|ret
suffix:semicolon
)brace
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|// SRAM (Skystar2 rev2.3 has one &quot;ISSI IS61LV256&quot; chip on board,
singleline_comment|// but it seems that FlexCopII can work with more than one chip)
singleline_comment|/////////////////////////////////////////////////////////////////////
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|// SRAM memory is accessed through a buffer register in the FlexCop
singleline_comment|// chip (0x700). This register has the following structure:
singleline_comment|//  bits 0-14  : address
singleline_comment|//  bit  15    : read/write flag
singleline_comment|//  bits 16-23 : 8-bit word to write
singleline_comment|//  bits 24-27 : = 4
singleline_comment|//  bits 28-29 : memory bank selector
singleline_comment|//  bit  31    : busy flag
singleline_comment|////////////////////////////////////////////////////////////////////
...
singleline_comment|//////////////////////////////////////////////////////////////////////
singleline_comment|// FlexcopII can work with 32K, 64K or 128K of external SRAM memory.
singleline_comment|//  - for 128K there are 4x32K chips at bank 0,1,2,3.
singleline_comment|//  - for  64K there are 2x32K chips at bank 1,2.
singleline_comment|//  - for  32K there is one 32K chip at bank 0.
singleline_comment|//
singleline_comment|// FlexCop works only with one bank at a time. The bank is selected
singleline_comment|// by bits 28-29 of the 0x700 register.
singleline_comment|//
singleline_comment|// bank 0 covers addresses 0x00000-0x07FFF
singleline_comment|// bank 1 covers addresses 0x08000-0x0FFFF
singleline_comment|// bank 2 covers addresses 0x10000-0x17FFF
singleline_comment|// bank 3 covers addresses 0x18000-0x1FFFF
singleline_comment|/////////////////////////////////////////////////////////////////////
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|//      EEPROM (Skystar2 has one &quot;24LC08B&quot; chip on board)
singleline_comment|////////////////////////////////////////////////////////////////////
...
DECL|function|EEPROM_LRC_write
r_int
id|EEPROM_LRC_write
c_func
(paren
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|// These functions could be called from the initialization routine 
singleline_comment|// to unlock SkyStar2 cards, locked by &quot;Europe On Line&quot;.
singleline_comment|//      
singleline_comment|// in cards from &quot;Europe On Line&quot; the key is:
singleline_comment|//
singleline_comment|//      u8 key[20] = {
singleline_comment|//           0xB2, 0x01, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//      };
singleline_comment|//
singleline_comment|//      LRC = 0xB3;
singleline_comment|//
singleline_comment|// in unlocked cards the key is:
singleline_comment|//
singleline_comment|//      u8 key[20] = {
singleline_comment|//           0xB2, 0x00, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//           0x00, 0x00, 0x00, 0x00,
singleline_comment|//      };
singleline_comment|//
singleline_comment|//     LRC = 0xB2;
singleline_comment|/////////////////////////////////////////////////////////////////////
DECL|function|EEPROM_writeKey
r_int
id|EEPROM_writeKey
c_func
(paren
...
DECL|function|EEPROM_setMacAddr
r_char
id|EEPROM_setMacAddr
c_func
(paren
r_struct
id|adapter
...
DECL|function|FilterEnableNullFilter
r_void
id|FilterEnableNullFilter
c_func
(paren
r_struct
id|adapter
...
DECL|function|SetIgnoreMACFilter
r_void
id|SetIgnoreMACFilter
c_func
(paren
r_struct
id|adapter
...
DECL|function|CheckNullFilterEnable
r_void
id|CheckNullFilterEnable
c_func
(paren
r_struct
id|adapter
...
DECL|function|ResetHardwarePIDFilter
r_void
id|ResetHardwarePIDFilter
c_func
(paren
r_struct
id|adapter
...
singleline_comment|///////////////////////////////////////////////////////////////////////
singleline_comment|//
singleline_comment|// FlexCopII has 2 dma channels. DMA1 is used to transfer TS data to
singleline_comment|// system memory.
singleline_comment|//
singleline_comment|// The DMA1 buffer is divided in 2 subbuffers of equal size.
singleline_comment|// FlexCopII will transfer TS data to one subbuffer, signal an interrupt
singleline_comment|// when the subbuffer is full and continue fillig the second subbuffer.
singleline_comment|//
singleline_comment|// For DMA1:
singleline_comment|//      subbuffer size in 32-bit words is stored in the first 24 bits of
singleline_comment|//      register 0x004. The last 8 bits of register 0x004 contain the number
singleline_comment|//      of subbuffers.
singleline_comment|//      
singleline_comment|//      the first 30 bits of register 0x000 contain the address of the first
singleline_comment|//      subbuffer. The last 2 bits contain 0, when dma1 is disabled and 1,
singleline_comment|//      when dma1 is enabled.
singleline_comment|//
singleline_comment|//      the first 30 bits of register 0x00C contain the address of the second
singleline_comment|//      subbuffer. the last 2 bits contain 1.
singleline_comment|//
singleline_comment|//      register 0x008 will contain the address of the subbuffer that was filled
singleline_comment|//      with TS data, when FlexCopII will generate an interrupt.
singleline_comment|//
singleline_comment|// For DMA2:
singleline_comment|//      subbuffer size in 32-bit words is stored in the first 24 bits of
singleline_comment|//      register 0x014. The last 8 bits of register 0x014 contain the number
singleline_comment|//      of subbuffers.
singleline_comment|//      
singleline_comment|//      the first 30 bits of register 0x010 contain the address of the first
singleline_comment|//      subbuffer.  The last 2 bits contain 0, when dma1 is disabled and 1,
singleline_comment|//      when dma1 is enabled.
singleline_comment|//
singleline_comment|//      the first 30 bits of register 0x01C contain the address of the second
singleline_comment|//      subbuffer. the last 2 bits contain 1.
singleline_comment|//
singleline_comment|//      register 0x018 contains the address of the subbuffer that was filled
singleline_comment|//      with TS data, when FlexCopII generates an interrupt.
singleline_comment|//
singleline_comment|///////////////////////////////////////////////////////////////////////
...
singleline_comment|///////////////////////////////////////////////////////////////////////////////
singleline_comment|// bit 0 of dma_mask is set to 1 if dma1 channel has to be enabled/disabled
singleline_comment|// bit 1 of dma_mask is set to 1 if dma2 channel has to be enabled/disabled
...
singleline_comment|//  dprintk(&quot;%s: DmaQ1.tail       = %d&bslash;n&quot; , __FUNCTION__, adapter-&gt;DmaQ1.tail):
...
DECL|function|SLL_reset_FlexCOP
r_int
id|SLL_reset_FlexCOP
c_func
(paren
r_struct
id|adapter
...
singleline_comment|/////////////////////////////////////////////////////////////////////
singleline_comment|//                      LNB control
singleline_comment|/////////////////////////////////////////////////////////////////////
...
c_func
(paren
l_string|&quot;&bslash;nTechnisat SkyStar2 driver loading&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|pci_module_init
...
c_func
(paren
l_string|&quot;&bslash;nTechnisat SkyStar2 driver unloading&bslash;n&quot;
)paren
suffix:semicolon

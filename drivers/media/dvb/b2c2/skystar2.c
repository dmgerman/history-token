...
DECL|function|init_dma_queue_one
r_static
r_int
id|init_dma_queue_one
c_func
(paren
r_struct
id|adapter
...
DECL|function|free_dma_queue_one
r_static
r_void
id|free_dma_queue_one
c_func
(paren
r_struct
id|adapter
...
suffix:semicolon
DECL|function|nxt2002_request_firmware
r_static
r_int
id|nxt2002_request_firmware
c_func
(paren
r_struct
id|dvb_frontend
...
DECL|variable|samsung_tbmv_config
r_static
r_struct
id|nxt2002_config
id|samsung_tbmv_config
op_assign
(brace
dot
id|demod_address
...
l_int|0x2103
suffix:colon
singleline_comment|// Technisat Skystar2 OR Technisat Airstar2 (DVB-T or ATSC)
singleline_comment|// Attempt to load the Nextwave nxt2002 for ATSC support 
id|skystar2-&gt;fe
op_assign
id|nxt2002_attach
c_func

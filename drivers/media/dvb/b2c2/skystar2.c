...
suffix:semicolon
multiline_comment|/* allow only the mt312, mt352 and stv0299 frontends to access the bus */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;client_register&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;client_unregister&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|I2C_ALGO_BIT
suffix:semicolon
id|adapter-&gt;i2c_adap.client_register
op_assign
id|client_register
suffix:semicolon
id|adapter-&gt;i2c_adap.client_unregister
op_assign
id|client_unregister
suffix:semicolon
r_if

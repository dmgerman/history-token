...
DECL|macro|QUERY_INTERVAL
mdefine_line|#define QUERY_INTERVAL (CONFIG_DVB_CINERGYT2_QUERY_INTERVAL)
macro_line|#ifdef CONFIG_DVB_CINERGYT2_ENABLE_RC_INPUT_DEVICE
DECL|macro|RC_QUERY_INTERVAL
mdefine_line|#define RC_QUERY_INTERVAL (CONFIG_DVB_CINERGYT2_RC_QUERY_INTERVAL)
...
DECL|macro|STREAM_BUF_SIZE
mdefine_line|#define STREAM_BUF_SIZE (512)&t;/* bytes */
DECL|macro|ENABLE_RC
mdefine_line|#define ENABLE_RC (1)
DECL|macro|RC_QUERY_INTERVAL
mdefine_line|#define RC_QUERY_INTERVAL (100)&t;/* milliseconds */
DECL|macro|QUERY_INTERVAL
mdefine_line|#define QUERY_INTERVAL (333)&t;/* milliseconds */
macro_line|#endif
...
suffix:semicolon
DECL|struct|dvbt_get_status_msg
r_struct
id|dvbt_get_status_msg
(brace
DECL|member|freq
r_uint32
id|freq
...
id|poll_wq
suffix:semicolon
DECL|member|pending_fe_events
r_int
id|pending_fe_events
suffix:semicolon
...
DECL|function|cinergyt2_release
r_static
r_int
id|cinergyt2_release
(paren
r_struct
id|inode
op_star
...
suffix:colon
multiline_comment|/* UNC are already converted to host byte order... */
r_return
id|put_user
c_func
(paren
id|stat-&gt;uncorrected_block_count
comma
(paren
id|__u32
id|__user
...
l_int|0
suffix:semicolon
id|cinergyt2-&gt;pending_fe_events
op_increment
suffix:semicolon
...
DECL|function|cinergyt2_suspend
r_static
r_int
id|cinergyt2_suspend
(paren
r_struct
id|usb_interface
op_star
...
(brace
multiline_comment|/* state 0 seems to mean DEVICE_PM_ON */
r_struct
id|cinergyt2
op_star
id|cinergyt2
...
DECL|function|cinergyt2_resume
r_static
r_int
id|cinergyt2_resume
(paren

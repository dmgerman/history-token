...
DECL|macro|IRQ_PIPE
mdefine_line|#define IRQ_PIPE&t;&t;0x8A
...
(brace
multiline_comment|/* we have to check whether the irq URB is already submitted.&n;&t;&t; * As the irq is submitted after the interface is changed,&n;&t;&t; * this is the best method i figured out.&n;&t;&t; * Any other possibilities?*/
r_if
c_cond
(paren
id|dec-&gt;interface

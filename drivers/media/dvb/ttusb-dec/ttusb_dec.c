...
(brace
DECL|enumerator|PACKET_AV_PES
id|PACKET_AV_PES
comma
DECL|enumerator|PACKET_SECTION
id|PACKET_SECTION
)brace
suffix:semicolon
...
id|dvb_net
suffix:semicolon
DECL|member|frontend_info
r_struct
id|dvb_frontend_info
op_star
id|frontend_info
suffix:semicolon
DECL|member|frontend_ioctl
r_int
(paren
op_star
id|frontend_ioctl
...
suffix:semicolon
DECL|member|av_pes_stream_count
r_int
id|av_pes_stream_count
suffix:semicolon
...
suffix:semicolon
DECL|variable|dec2000t_frontend_info
r_static
r_struct
id|dvb_frontend_info
id|dec2000t_frontend_info
op_assign
(brace
dot
id|name
...
suffix:semicolon
DECL|variable|dec3000s_frontend_info
r_static
r_struct
id|dvb_frontend_info
id|dec3000s_frontend_info
op_assign
(brace
dot
id|name
...
DECL|function|ttusb_dec_2000t_frontend_ioctl
r_static
r_int
id|ttusb_dec_2000t_frontend_ioctl
c_func
(paren
r_struct
id|dvb_frontend
...
DECL|function|ttusb_dec_3000s_frontend_ioctl
r_static
r_int
id|ttusb_dec_3000s_frontend_ioctl
c_func
(paren
r_struct
id|dvb_frontend
...
c_func
(paren
l_string|&quot;%s: FE_DISEQC_SEND_MASTER_CMD&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: FE_DISEQC_SEND_BURST&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
DECL|function|ttusb_dec_init_frontend
r_static
r_void
id|ttusb_dec_init_frontend
c_func
(paren
r_struct
id|ttusb_dec
...
DECL|function|ttusb_dec_exit_frontend
r_static
r_void
id|ttusb_dec_exit_frontend
c_func
(paren
r_struct
id|ttusb_dec
...
id|dec-&gt;firmware_name
op_assign
l_string|&quot;dvb-ttusb-dec-3000s-2.15a.fw&quot;
suffix:semicolon
r_break
suffix:semicolon
r_case
...
id|dec-&gt;firmware_name
op_assign
l_string|&quot;dvb-ttusb-dec-2000t-2.15a.fw&quot;
suffix:semicolon
r_break
suffix:semicolon
)brace

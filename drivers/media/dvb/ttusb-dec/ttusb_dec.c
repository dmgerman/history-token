multiline_comment|/*&n; * TTUSB DEC Driver&n; *&n; * Copyright (C) 2003-2004 Alex Woods &lt;linux-dvb@giblets.org&gt;&n; * IR support by Peter Beutner &lt;p.beutner@gmx.net&gt;&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; */
...
id|enable_rc
comma
l_string|&quot;Turn on/off IR remote control(default: off)&quot;
)paren
suffix:semicolon
DECL|macro|dprintk
...
mdefine_line|#define RESULT_PIPE&t;&t;0x04
DECL|macro|IN_PIPE
mdefine_line|#define IN_PIPE&t;&t;&t;0x08
DECL|macro|OUT_PIPE
mdefine_line|#define OUT_PIPE&t;&t;0x07
DECL|macro|IRQ_PIPE
mdefine_line|#define IRQ_PIPE&t;&t;0x0A
...
DECL|macro|IRQ_PACKET_SIZE
mdefine_line|#define IRQ_PACKET_SIZE&t;&t;0x8
...
suffix:semicolon
DECL|function|ttusb_dec_handle_irq
r_static
r_void
id|ttusb_dec_handle_irq
c_func
(paren
r_struct
id|urb
...
id|ETIMEDOUT
suffix:colon
multiline_comment|/* this urb is dead, cleanup */
id|dprintk
c_func
(paren
l_string|&quot;%s:urb shutting down with status: %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|urb-&gt;status
...
c_func
(paren
l_string|&quot;%s:nonzero status received: %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|urb-&gt;status
...
(brace
multiline_comment|/* IR - Event */
multiline_comment|/* this is an fact a bit too simple implementation;&n;&t;&t; * the box also reports a keyrepeat signal&n;&t;&t; * (with buffer[3] == 0x40) in an intervall of ~100ms.&n;&t;&t; * But to handle this correctly we had to imlemenent some&n;&t;&t; * kind of timer which signals a &squot;key up&squot; event if no&n;&t;&t; * keyrepeat signal is recieved for lets say 200ms.&n;&t;&t; * this should/could be added later ...&n;&t;&t; * for now lets report each signal as a key down and up*/
id|dprintk
c_func
(paren
l_string|&quot;%s:rc signal:%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|buffer
...
c_func
(paren
l_string|&quot;%s - usb_commit_urb failed with result: %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|retval
...
suffix:semicolon
id|dec-&gt;rc_input_dev.name
op_assign
l_string|&quot;ttusb_dec remote control&quot;
suffix:semicolon
id|dec-&gt;rc_input_dev.evbit
(braket
l_int|0
)braket
op_assign
...
suffix:semicolon
id|dec-&gt;rc_input_dev.keycodesize
op_assign
r_sizeof
(paren
id|u16
...
suffix:semicolon
id|dec-&gt;rc_input_dev.keycodemax
op_assign
l_int|0x1a
suffix:semicolon
id|dec-&gt;rc_input_dev.keycode
op_assign
id|rc_keys
suffix:semicolon
r_for
...
multiline_comment|/* enable irq pipe */
id|ttusb_dec_send_command
c_func
(paren
id|dec
...
suffix:semicolon
id|dec-&gt;irq_urb-&gt;transfer_dma
op_assign
id|dec-&gt;irq_dma_handle
suffix:semicolon
id|dec-&gt;irq_urb-&gt;transfer_flags
op_or_assign
...
DECL|function|ttusb_dec_exit_rc
r_static
r_void
id|ttusb_dec_exit_rc
c_func
(paren
r_struct
id|ttusb_dec
...
suffix:semicolon
multiline_comment|/* we have to check whether the irq URB is already submitted.&n;&t;  * As the irq is submitted after the interface is changed,&n;&t;  * this is the best method i figured out.&n;&t;  * Any others?*/
r_if
c_cond
(paren
id|dec-&gt;interface

...
suffix:semicolon
DECL|function|or51211_request_firmware
r_static
r_int
id|or51211_request_firmware
c_func
(paren
r_struct
id|dvb_frontend
...
id|fe-&gt;dvb-&gt;priv
suffix:semicolon
multiline_comment|/* RESET DEVICE&n;&t; * reset is controled by GPIO-0&n;&t; * when set to 0 causes reset and when to 1 for normal op&n;&t; * must remain reset for 128 clock cycles on a 50Mhz clock&n;&t; * also PRM1 PRM2 &amp; PRM4 are controled by GPIO-1,GPIO-2 &amp; GPIO-4&n;&t; * We assume that the reset has be held low long enough or we&n;&t; * have been reset by a power on.  When the driver is unloaded&n;&t; * reset set to 0 so if reloaded we have been reset.&n;&t; */
multiline_comment|/* reset &amp; PRM1,2&amp;4 are outputs */
r_int
id|ret
op_assign
id|bttv_gpio_enable
...
(paren
id|KERN_WARNING
l_string|&quot;or51211: Init Error - Can&squot;t Reset DVR &quot;
l_string|&quot;(%i)&bslash;n&quot;
comma
id|ret
)paren
...
suffix:semicolon
multiline_comment|/* Now set for normal operation */
id|bttv_write_gpio
c_func
(paren
id|bt-&gt;bttv_nr
...
suffix:semicolon
multiline_comment|/* wait for operation to begin */
id|msleep
c_func
(paren
l_int|500

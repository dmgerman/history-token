...
suffix:semicolon
DECL|function|w1_master_attribute_show
r_static
id|ssize_t
id|w1_master_attribute_show
c_func
(paren
r_struct
id|device
...
id|buf
comma
l_string|&quot;please fix me&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#if 0
r_struct
...
id|c
comma
l_string|&quot;bus_master=0x%p, timeout=%d, max_slave_count=%d, attempts=%lu&bslash;n&quot;
comma
id|md-&gt;bus_master
comma
id|w1_timeout
...
DECL|variable|w1_master_attribute
r_struct
id|device_attribute
...
id|w1_slave_bin_attribute.read
op_assign
id|sl-&gt;family-&gt;fops-&gt;rbin
suffix:semicolon
id|w1_slave_attribute.show
op_assign
id|sl-&gt;family-&gt;fops-&gt;rname
suffix:semicolon
id|w1_slave_attribute_val.show
op_assign
id|sl-&gt;family-&gt;fops-&gt;rval
suffix:semicolon
id|w1_slave_attribute_val.attr.name
op_assign
...
id|dev-&gt;dev
comma
l_string|&quot;Family %x is not registered.&bslash;n&quot;
comma
id|rn-&gt;family
)paren
suffix:semicolon

...
multiline_comment|/* Because we are a 1394a-2000 compliant IRM, we need to inform all the other&n; * nodes of the broadcast channel.  (Really we&squot;re only setting the validity&n; * bit). */
...
DECL|function|nodemgr_check_root_capability
r_static
r_int
id|nodemgr_check_root_capability
c_func
(paren
r_struct
id|hpsb_host
...
(brace
multiline_comment|/* The root node does not have a valid BROADCAST_CHANNEL&n;&t;&t; * register and we do, so reset the bus with force_root set */
id|HPSB_DEBUG
c_func
(paren
l_string|&quot;Remote root is not IRM capable, resetting...&quot;
)paren
suffix:semicolon
id|hpsb_reset_bus
c_func

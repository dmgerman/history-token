...
id|UNIT_DIRECTORY_HAS_LUN
suffix:semicolon
multiline_comment|/* Logical Unit Directory */
)brace
r_else
r_if
c_cond
...
(brace
multiline_comment|/* This should really be done in SBP2 as this is&n;&t;&t;&t;&t; * doing SBP2 specific parsing.&n;&t;&t;&t;&t; */
...
r_else
(brace
multiline_comment|/* old cache is valid, so update its generation */
r_struct
id|nodemgr_csr_info
op_star
id|ci
...
id|generation
suffix:semicolon
multiline_comment|/* free the partially filled now unneeded new cache */
id|kfree
c_func
(paren
id|csr

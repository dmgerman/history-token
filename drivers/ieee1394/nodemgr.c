...
suffix:semicolon
DECL|variable|nodemgr_platform_data_ne
r_static
r_int
id|nodemgr_platform_data_ne
suffix:semicolon
DECL|variable|nodemgr_platform_data_ud
r_static
r_int
id|nodemgr_platform_data_ud
suffix:semicolon
DECL|variable|nodemgr_platform_data_host
r_static
r_int
id|nodemgr_platform_data_host
suffix:semicolon
DECL|function|nodemgr_generic_probe
r_static
r_int
id|nodemgr_generic_probe
c_func
(paren
r_struct
id|device
...
id|id
suffix:semicolon
multiline_comment|/* We only match unit directories, and ignore our internal drivers */
r_if
c_cond
(paren
...
suffix:semicolon
DECL|function|nodemgr_check_node_cb
r_static
r_int
id|nodemgr_check_node_cb
c_func
(paren
r_struct
id|device
...
DECL|struct|ne_cb_data_struct
r_struct
id|ne_cb_data_struct
(brace
DECL|member|hi
r_struct
id|host_info
...
suffix:semicolon
DECL|function|nodemgr_probe_ne_cb
r_static
r_int
id|nodemgr_probe_ne_cb
c_func
(paren
r_struct
id|device
...
l_int|0
suffix:semicolon
multiline_comment|/* We can&squot;t call nodemgr_process_root_directory() here because&n;&t; * that can call device_register. Since this callback is under a&n;&t; * rwsem, the device_register would deadlock. So, we signal back&n;&t; * to the callback, and process things there. */
r_if
c_cond
(paren
id|ne-&gt;needs_probe
...
DECL|function|nodemgr_suspend_ud
r_static
r_void
id|nodemgr_suspend_ud
c_func
(paren
r_struct
id|unit_directory
...
DECL|function|nodemgr_resume_ud
r_static
r_void
id|nodemgr_resume_ud
c_func
(paren
r_struct
id|unit_directory
...
(brace
multiline_comment|/* If we get in here, we&squot;ve got a node that needs it&squot;s&n;&t;&t; * unit directories processed. */
r_struct
id|device
op_star
id|dev
...
id|host
suffix:semicolon
multiline_comment|/* This will iterate until all devices that do not match&n;&t;&t; * the generation are suspended. */
r_while
c_loop
(paren
id|bus_for_each_dev
...
DECL|struct|for_each_host_struct
r_struct
id|for_each_host_struct
(brace
DECL|member|cb
r_int
(paren
...
suffix:semicolon
DECL|function|nodemgr_for_each_host_cb
r_static
r_int
id|nodemgr_for_each_host_cb
c_func
(paren
r_struct
id|device

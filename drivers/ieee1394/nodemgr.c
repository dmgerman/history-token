...
suffix:semicolon
DECL|macro|PUTF
mdefine_line|#define PUTF(fmt, args...) disp_size += sprintf(display_str, fmt, ## args); strcat(buffer,display_str)
id|buffer
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;&bslash;tNodes connected : %d&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;&bslash;tSelfIDs received: %d&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;&bslash;tOwn ID          : 0x%08x&bslash;n&quot;
comma
id|ne-&gt;host-&gt;node_id
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;tIrm ID          : 0x%08x&bslash;n&quot;
comma
id|ne-&gt;host-&gt;irm_id
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;tBusMgr ID       : 0x%08x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;&bslash;tBR IR IC II IB&bslash;n&quot;
)paren
suffix:semicolon
id|PUTF
c_func
(paren
l_string|&quot;&bslash;t%02d %02d %02d %02d %02d&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;&bslash;tVendor ID: %s [0x%06x]&bslash;n&quot;
comma
id|ne-&gt;vendor_name
ques
c_cond
...
c_func
(paren
l_string|&quot;&bslash;tCapabilities: 0x%06x&bslash;n&quot;
comma
id|ne-&gt;capabilities
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;tirmc=%d cmc=%d isc=%d bmc=%d pmc=%d cyc_clk_acc=%d max_rec=%d gen=%d lspd=%d&bslash;n&quot;
comma
id|ne-&gt;busopt.irmc
comma
id|ne-&gt;busopt.cmc
...
c_func
(paren
l_string|&quot;ConfigROM quadlet transaction error (%d) for node &quot;
id|NODE_BUS_FMT
comma
id|ret
comma
...
c_func
(paren
l_string|&quot;ConfigROM quadlet transaction error (%d) for &quot;
id|NODE_BUS_FMT
comma
id|ret
comma
...
multiline_comment|/* Cleanup if needed */
id|nodemgr_node_probe_cleanup
c_func
(paren
id|host

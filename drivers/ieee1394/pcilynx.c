...
(brace
DECL|macro|FAIL
mdefine_line|#define FAIL(fmt, args...) do { &bslash;&n;        PRINT_G(KERN_ERR, fmt , ## args); &bslash;&n;        num_of_cards--; &bslash;&n;        remove_card(dev); &bslash;&n;        return -1; &bslash;&n;        } while (0)
r_struct
id|ti_lynx
op_star
id|lynx
...
id|have_host_struct
suffix:colon
multiline_comment|/* FIXME - verify host freeing */
r_case
id|clear
suffix:colon
suffix:semicolon

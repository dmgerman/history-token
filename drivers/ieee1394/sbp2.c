...
suffix:semicolon
multiline_comment|/* Make sure the scsi_host is ready for this */
...
suffix:semicolon
singleline_comment|//scsi_device_put(scsi_id-&gt;sdev);
)brace
id|sbp2util_remove_command_orb_pool
c_func
(paren
...
DECL|function|sbp2_alloc_scsi_id
r_static
r_struct
id|scsi_id_instance_data
op_star
id|sbp2_alloc_scsi_id
c_func
(paren
r_struct
id|scsi_id_group

...
id|__devinitdata
op_assign
l_string|&quot;$Rev: 886 $ Ben Collins &lt;bcollins@debian.org&gt;&quot;
suffix:semicolon
...
id|dev
suffix:semicolon
multiline_comment|/* Ignore validity in hopes that it will be set in the future.  It&squot;ll&n;&t; * check it on transmit. */
...
multiline_comment|/* A packet has been received by the ieee1394 bus. Build an skbuff&n;&t;&t; * around it so we can pass it to the high level network layer. */
id|skb
op_assign
id|dev_alloc_skb
(paren
...
suffix:semicolon
multiline_comment|/* don&squot;t check it */
multiline_comment|/* Parse the encapsulation header. This actually does the job of&n;&t;&t; * converting to an ethernet frame header, aswell as arp&n;&t;&t; * conversion if needed. ARP conversion is easier in this&n;&t;&t; * direction, since we are using ethernet as our backend.  */
id|skb-&gt;protocol
op_assign
id|ether1394_parse_encap
(paren
...
id|dev-&gt;name
comma
l_string|&quot;Cannot send packet, no broadcast channel available.&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
id|dev-&gt;name
comma
l_string|&quot;Could not start async reception&bslash;n&quot;
)paren
suffix:semicolon
id|hpsb_iso_shutdown
c_func

...
suffix:semicolon
multiline_comment|/* clear ISO context usage bit */
r_if
c_cond
(paren
(paren
...
id|ohci-&gt;id
comma
l_string|&quot;IR DMA context %d is not available&quot;
comma
id|ctx
)paren
suffix:semicolon
...
id|ohci-&gt;id
comma
l_string|&quot;IT DMA context %d is not available&quot;
comma
id|ctx
)paren
suffix:semicolon
...
DECL|function|ohci1394_run_irq_hooks
r_static
r_inline
r_void
id|ohci1394_run_irq_hooks
...
DECL|function|ohci1394_hook_irq
r_int
...
id|data
suffix:semicolon
multiline_comment|/* ohci1394 will never be unloaded while an IRQ hook is&n;&t;   in use, because the user must reference this symbol */
r_return
l_int|0
suffix:semicolon
)brace
DECL|function|ohci1394_unhook_irq
r_void
...
suffix:semicolon
DECL|variable|ohci1394_hook_irq
id|EXPORT_SYMBOL
c_func
(paren
id|ohci1394_hook_irq
...
suffix:semicolon
DECL|variable|ohci1394_unhook_irq
id|EXPORT_SYMBOL
c_func
(paren
id|ohci1394_unhook_irq
...
id|KERN_ERR
comma
l_string|&quot;hpsb_register_lowlevel failed&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|KERN_ERR
comma
l_string|&quot;pci_module_init failed&quot;
)paren
suffix:semicolon
id|hpsb_unregister_lowlevel
c_func

...
id|__devinitdata
op_assign
l_string|&quot;$Rev: 675 $ Ben Collins &lt;bcollins@debian.org&gt;&quot;
suffix:semicolon
...
id|ohci-&gt;id
comma
l_string|&quot;OHCI-1394 %d.%d (PCI): IRQ=[%d]  &quot;
...
id|task_active
suffix:semicolon
multiline_comment|/* index of next packet to arrive */
DECL|member|pkt_dma
r_int
id|pkt_dma
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* size of DMA program = one INPUT_LAST per packet in the buffer */
id|prog_size
op_assign
r_sizeof
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/* start at pkt_dma and go around the whole buffer */
r_int
id|pkt
op_assign
id|recv-&gt;pkt_dma
...
suffix:semicolon
multiline_comment|/* offset of this bus_cycle within the DMA buffer */
r_int
r_int
id|buf_offset
op_assign
...
id|iso-&gt;buf.kvirt
suffix:semicolon
multiline_comment|/* back up 8 bytes for the iso header */
id|buf_offset
op_sub_assign
l_int|8
suffix:semicolon
...
l_int|8
suffix:semicolon
multiline_comment|/* ask for an interrupt every now and then, and&n;&t;&t;   always interrupt on the final descriptor */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* write the DMA descriptor */
id|il-&gt;control
op_assign
l_int|3
op_lshift
...
suffix:semicolon
multiline_comment|/* use packet-per-buffer mode, and keep ISO headers */
id|reg_write
c_func
(paren
id|recv-&gt;ohci
...
DECL|function|ohci_iso_recv_release_one
r_static
r_void
id|ohci_iso_recv_release_one
c_func
(paren
r_struct
id|hpsb_iso
...
id|iso-&gt;hostdata
suffix:semicolon
multiline_comment|/* re-use the DMA descriptor for first_packet */
...
suffix:semicolon
multiline_comment|/* &squot;next&squot; becomes the new end of the DMA chain */
id|next-&gt;control
op_or_assign
l_int|3
op_lshift
...
suffix:semicolon
multiline_comment|/* advance packet cursors */
id|iso-&gt;first_packet
op_assign
(paren
id|iso-&gt;first_packet
...
multiline_comment|/* at least one packet came in, so wake up the reader */
id|wake
op_assign
l_int|1
suffix:semicolon
...
id|iso-&gt;max_packet_size
suffix:semicolon
multiline_comment|/* advance DMA packet cursor */
id|recv-&gt;pkt_dma
op_assign
(paren
id|recv-&gt;pkt_dma
...
id|iso-&gt;buf_packets
suffix:semicolon
multiline_comment|/* one more packet for the user, one less for us */
r_if
c_cond
(paren
...
(brace
multiline_comment|/* if n_dma_packets reaches zero, we have an overflow */
id|atomic_inc
c_func
(paren
op_amp
...
l_int|1
suffix:semicolon
multiline_comment|/* predict the timestamp pkt_dma will have next time around the buffer */
(brace
r_struct
id|hpsb_iso_packet_info
op_star
...
l_int|0
suffix:semicolon
multiline_comment|/* advance packet cursor */
id|xmit-&gt;pkt_dma
op_assign
(paren
id|xmit-&gt;pkt_dma
...
id|iso-&gt;buf_packets
suffix:semicolon
multiline_comment|/* one less packet for us */
r_if
c_cond
(paren
id|atomic_dec_and_test
...
DECL|function|ohci_iso_xmit_queue_one
r_static
r_void
id|ohci_iso_xmit_queue_one
c_func
(paren
r_struct
id|hpsb_iso
...
suffix:semicolon
multiline_comment|/* retrieve the packet info stashed in the buffer */
id|info
op_assign
id|hpsb_iso_packet_info
c_func
...
id|ohci-&gt;id
comma
l_string|&quot;Async Iso Xmit %d Context died: &quot;
l_string|&quot;ctrl[%08x] cmdptr[%08x]&quot;
comma
id|ctx
comma
...
id|ohci-&gt;id
comma
l_string|&quot;Async Iso Recv %d Context died: &quot;
...
suffix:semicolon
multiline_comment|/* IT DMA context allocation */
r_if
c_cond
(paren
id|alloc_dma_trm_ctx

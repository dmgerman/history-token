...
suffix:semicolon
multiline_comment|/* Retrieve a hostinfo pointer bound to this driver/host */
r_void
op_star
...
suffix:semicolon
multiline_comment|/* Allocate a hostinfo pointer of data_size bound to this driver/host */
r_void
op_star
...
suffix:semicolon
multiline_comment|/* Free and remove the hostinfo pointer bound to this driver/host */
r_void
...
suffix:semicolon
multiline_comment|/* Set an alternate lookup key for the hostinfo bound to this driver/host */
r_void
...
suffix:semicolon
multiline_comment|/* Retrieve the alternate lookup key for the hostinfo bound to this driver/host */
r_int
r_int
...
suffix:semicolon
multiline_comment|/* Set the hostinfo pointer to something useful. Usually follows a call to&n; * hpsb_create_hostinfo, where the size is 0. */
r_int

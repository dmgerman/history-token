...
multiline_comment|/*******************************/
multiline_comment|/* note: we no longer use mem_map_reserve, because it causes a memory&n;   leak, and setting vma-&gt;vm_flags to VM_RESERVED should be sufficient&n;   to pin the pages in memory anyway. */
...
multiline_comment|/* XXX this should be the last step of initialization, since the interrupt&n;&t;   handler uses ohci_i*_ctx to indicate whether or not it is safe to touch&n;&t;   frames. I&squot;m not making this change quite yet, since it would be better&n;&t;   to clean up the init/shutdown process first.*/
r_if
c_cond
(paren
...
l_int|2
suffix:semicolon
multiline_comment|/* the following are now set via proc_fs or devfs */
id|init.channel
op_assign
id|video-&gt;channel
suffix:semicolon
...
suffix:semicolon
DECL|struct|dv1394_procfs_entry
r_struct
...
suffix:semicolon
DECL|variable|dv1394_procfs_lock
r_static
id|spinlock_t
id|dv1394_procfs_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
...
id|count
comma
l_string|&quot;&bslash;&n;format=%s&bslash;n&bslash;&n;channel=%d&bslash;n&bslash;&n;cip_n=%lu&bslash;n&bslash;&n;cip_d=%lu&bslash;n&bslash;&n;syt_offset=%u&bslash;n&quot;
comma
(paren
id|video-&gt;pal_or_ntsc
op_eq
...
id|dv1394_procfs_entry
op_star
DECL|function|dv1394_procfs_find
id|dv1394_procfs_find
c_func
(paren
r_char
op_star
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: cannot allocate dv1394_procfs_entry&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to locate parent procfs of %s&bslash;n&quot;
comma
id|buf
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to create /proc/bus/ieee1394/%s/%s&bslash;n&quot;
comma
id|parent-&gt;name
comma
(paren
...
id|video
suffix:semicolon
id|p-&gt;procfs-&gt;read_proc
op_assign
id|dv1394_procfs_read
suffix:semicolon
id|p-&gt;procfs-&gt;write_proc
op_assign
id|dv1394_procfs_write
suffix:semicolon
id|spin_lock
...
r_static
r_int
DECL|function|dv1394_procfs_add_dir
id|dv1394_procfs_add_dir
c_func
(paren
r_char
op_star
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to create /proc/bus/ieee1394/%s&bslash;n&quot;
comma
id|p-&gt;name
)paren
suffix:semicolon
...
DECL|function|dv1394_procfs_del
r_void
...
id|dv1394_devfs_entry
op_star
DECL|function|dv1394_devfs_find
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: cannot allocate dv1394_devfs_entry&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to locate parent devfs of %s&bslash;n&quot;
comma
id|buf
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to create /dev/ieee1394/%s/%s&bslash;n&quot;
comma
id|parent-&gt;name
comma
(paren
...
r_static
r_int
DECL|function|dv1394_devfs_add_dir
id|dv1394_devfs_add_dir
c_func
(paren
r_char
op_star
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to create /dev/ieee1394/%s&bslash;n&quot;
comma
id|p-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;dv1394: unable to create /proc/bus/ieee1394/dv&bslash;n&quot;
)paren
suffix:semicolon
id|ieee1394_unregister_chardev
c_func

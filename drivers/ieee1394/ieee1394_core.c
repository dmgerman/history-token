...
multiline_comment|/**&n; * hpsb_add_packet_complete_task - add a new task for when a packet completes&n; * @packet: the packet whose completion we want the task added to&n; * @tq: the hpsb_queue_struct describing the task to add&n; */

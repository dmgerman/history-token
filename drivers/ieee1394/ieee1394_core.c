...
suffix:semicolon
multiline_comment|/* check for common cycle master error */
...
DECL|function|hpsb_check_cycle_master
r_void
id|hpsb_check_cycle_master
c_func
(paren
...
(brace
multiline_comment|/* check if host is IRM and not ROOT */
r_if
c_cond
(paren
id|host-&gt;is_irm
...
c_func
(paren
l_string|&quot;Host is IRM but not root, resetting&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(brace
multiline_comment|/* selfid stage did not yield valid cycle master */
id|hpsb_reset_bus
c_func
(paren
id|host
...
c_func
(paren
l_string|&quot;Warning - Cycle Master not set correctly&quot;
)paren
suffix:semicolon
)brace
r_return
...
suffix:semicolon
DECL|variable|hpsb_check_cycle_master
id|EXPORT_SYMBOL
c_func
(paren
id|hpsb_check_cycle_master
...
suffix:semicolon
DECL|variable|hpsb_get_config_rom
id|EXPORT_SYMBOL
c_func
(paren

...
op_assign
id|current_drive-&gt;mode_yb_7
op_or
id|current_drive-&gt;volume_control
suffix:semicolon
id|drvcmd
(braket
l_int|8
...
id|channel0
op_assign
id|current_drive-&gt;vol_chan0
suffix:semicolon
id|volume0
op_assign
id|current_drive-&gt;vol_ctrl0
suffix:semicolon
id|channel1
op_assign
id|control1
op_assign
id|current_drive-&gt;vol_chan1
suffix:semicolon
id|volume1
op_assign
id|value1
op_assign
id|current_drive-&gt;vol_ctrl1
suffix:semicolon
id|control0
op_assign
id|value0
...
c_func
(paren
id|current_drive-&gt;pos_audio_start
comma
id|current_drive-&gt;pos_audio_end
)paren
)paren
suffix:semicolon
r_else
...
(brace
id|current_drive-&gt;SubQ_ctl_adr
op_assign
id|current_drive-&gt;SubQ_trk
op_assign
id|current_drive-&gt;SubQ_pnt_idx
op_assign
id|current_drive-&gt;SubQ_whatisthis
op_assign
l_int|0
suffix:semicolon
id|current_drive-&gt;SubQ_run_tot
op_assign
id|current_drive-&gt;SubQ_run_trk
op_assign
l_int|0
suffix:semicolon
r_return
...
suffix:semicolon
macro_line|#if 000
id|current_drive-&gt;vol_chan2
op_assign
l_int|2
suffix:semicolon
id|current_drive-&gt;vol_ctrl2
op_assign
l_int|0xFF
suffix:semicolon
id|current_drive-&gt;vol_chan3
op_assign
l_int|3
suffix:semicolon
id|current_drive-&gt;vol_ctrl3
op_assign
l_int|0xFF
suffix:semicolon
macro_line|#endif /*  000 */
...
id|current_drive-&gt;f_multisession
op_assign
l_int|0
suffix:semicolon
id|drvcmd
...
(brace
id|current_drive-&gt;first_session
op_assign
id|infobuf
(braket
l_int|1
...
suffix:semicolon
id|current_drive-&gt;n_first_track
op_assign
id|infobuf
(braket
l_int|3
...
(brace
id|current_drive-&gt;TocEnt_nixbyte
op_assign
id|infobuf
(braket
l_int|0
...
l_int|5
suffix:semicolon
id|current_drive-&gt;TocEnt_ctl_adr
op_assign
id|swap_nibbles
c_func
(paren
...
(brace
id|current_drive-&gt;TocEnt_number
op_assign
id|infobuf
(braket
id|i
...
suffix:semicolon
id|current_drive-&gt;TocEnt_format
op_assign
id|infobuf
(braket
id|i
...
l_int|9
suffix:semicolon
id|current_drive-&gt;TocEnt_address
op_assign
id|make32
c_func
(paren
...
suffix:semicolon
id|current_drive-&gt;track_of_last_session
op_assign
id|infobuf
(braket
l_int|6
...
id|type
comma
id|current_drive-&gt;drive_model
comma
id|current_drive-&gt;drv_id
)paren
suffix:semicolon
r_for
c_loop
...
id|current_drive-&gt;firmware_version
(braket
id|j
)braket
op_assign
...
id|DBG_IO2
comma
l_string|&quot;ioctl(%s, 0x%08lX, 0x%08lX)&bslash;n&quot;
comma
id|cdi-&gt;name
comma
id|cmd
...
id|DBG_INF
comma
l_string|&quot;ioctl: bad device: %s&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
id|DBG_IO2
comma
l_string|&quot;ioctl: device %s, request %04X&bslash;n&quot;
comma
id|cdi-&gt;name
comma
id|cmd
...
id|DBG_IO2
comma
l_string|&quot;ioctl(%s, 0x%08lX, 0x%08p)&bslash;n&quot;
comma
id|cdi-&gt;name
comma
id|cmd
...
l_int|4
op_ge
id|current_drive-&gt;sbp_first_frame
)paren
op_logical_and
(paren
id|req-&gt;sector
...
l_int|4
op_le
id|current_drive-&gt;sbp_last_frame
)paren
)paren
(brace
id|offs
...
id|current_drive-&gt;sbp_read_frames
op_assign
id|current_drive-&gt;sbp_bufsiz
suffix:semicolon
r_else
...
multiline_comment|/*==========================================================================*/
multiline_comment|/*&n; *  Check the completion of the read-data command.  On success, read&n; *  the current_drive-&gt;sbp_bufsiz * 2048 bytes of data from the disk into buffer.&n; */
...
multiline_comment|/*==========================================================================*/
DECL|function|sbpcd_block_open
r_static
r_int
id|sbpcd_block_open
c_func
...
DECL|function|sbpcd_block_release
r_static
r_int
id|sbpcd_block_release
c_func
(paren
r_struct
id|inode
...
DECL|function|sbpcd_block_ioctl
r_static
r_int
id|sbpcd_block_ioctl
c_func
(paren
r_struct
id|inode
...
DECL|function|sbpcd_block_media_changed
r_static
r_int
id|sbpcd_block_media_changed
c_func
(paren
r_struct
id|gendisk
...
id|DBG_INF
comma
l_string|&quot;release: bad device: %s&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;sbpcd: Unable to request region 0x%x&bslash;n&quot;
comma
id|CDo_command
)paren
suffix:semicolon
...
id|sbpcd_dops
suffix:semicolon
id|sbpcd_infop-&gt;speed
op_assign
l_int|2
suffix:semicolon
id|sbpcd_infop-&gt;capacity
op_assign
l_int|1
suffix:semicolon
id|sprintf
...
id|DBG_CHK
comma
l_string|&quot;media_check (%s) called&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
id|DBG_CHK
comma
l_string|&quot;medium changed (drive %s)&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME: Old modules.conf claims MATSUSHITA_CDROM2_MAJOR and CDROM3, but&n;   AFAICT this doesn&squot;t support those majors, so why? --RR 30 Jul 2003 */
DECL|variable|MATSUSHITA_CDROM_MAJOR

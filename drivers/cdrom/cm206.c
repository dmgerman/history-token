...
mdefine_line|#define BLOCKS_ISO (ISO_SECTOR_SIZE/LINUX_BLOCK_SIZE)&t;/* 4 */
...
DECL|macro|PAUSED
mdefine_line|#define PAUSED cd-&gt;audio_status[0]&t;/* misuse this memory byte! */
DECL|macro|PLAY_TO
...
suffix:semicolon
multiline_comment|/* resets data_ready, data_error,&n;&t;&t;&t;&t;&t;&t;   crc_error, sync_error, toc_ready &n;&t;&t;&t;&t;&t;&t;   interrupts */
id|cd-&gt;intr_ls
op_assign
id|inw
c_func
...
suffix:semicolon
DECL|function|cm206_block_open
r_static
r_int
id|cm206_block_open
c_func
...
DECL|function|cm206_block_release
r_static
r_int
id|cm206_block_release
c_func
(paren
r_struct
id|inode
...
DECL|function|cm206_block_ioctl
r_static
r_int
id|cm206_block_ioctl
c_func
(paren
r_struct
id|inode
...
DECL|function|cm206_block_media_changed
r_static
r_int
id|cm206_block_media_changed
c_func
(paren
r_struct
id|gendisk
...
suffix:semicolon
multiline_comment|/* Now, the problem here is that reset_cm260 can generate an&n;&t;   interrupt. It seems that this can cause a kernel oops some time&n;&t;   later. So we wait a while and `service&squot; this interrupt. */
id|mdelay
c_func
(paren
l_int|1

...
mdefine_line|#define SONY_JIFFIES_TIMEOUT    (10*HZ)&t;/* Maximum number of times the&n;                                           drive will wait/try for an&n;                                           operation */
DECL|macro|SONY_RESET_TIMEOUT
mdefine_line|#define SONY_RESET_TIMEOUT      HZ&t;/* Maximum number of times the&n;                                           drive will wait/try a reset&n;                                           operation */

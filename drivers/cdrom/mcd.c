...
DECL|function|mcd_block_release
r_static
r_int
id|mcd_block_release
c_func
(paren
r_struct
id|inode
...
DECL|function|mcd_block_media_changed
r_static
r_int
id|mcd_block_media_changed
c_func
(paren
r_struct
id|gendisk
...
(paren
id|KERN_INFO
l_string|&quot;mcd: can&squot;t allocated disk.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
DECL|variable|MITSUMI_CDROM_MAJOR

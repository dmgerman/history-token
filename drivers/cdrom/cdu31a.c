...
id|disk_changed
suffix:semicolon
multiline_comment|/* This was readahead_buffer once... Now it&squot;s used only for audio reads */
DECL|variable|audio_buffer
r_static
r_char
id|audio_buffer
(braket
...
r_static
r_void
DECL|function|input_data_sector
id|input_data_sector
c_func
(paren
r_char
op_star
...
suffix:semicolon
multiline_comment|/* If an XA disk, we have to clear out the rest of the unused&n;&t;   error correction data. We can use audio_buffer for that. */
r_if
c_cond
(paren
id|sony_xa_mode
...
(brace
multiline_comment|/* Open for IOCTLs only - no media check */
id|sony_usage
op_increment
suffix:semicolon
r_return
...
id|is_double_speed
suffix:semicolon
multiline_comment|/* Set 2X drives to 2X by default */
id|set_drive_params
c_func
(paren
id|sony_speed

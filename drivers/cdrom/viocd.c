...
mdefine_line|#define VIOCD_MAX_CD 8
...
DECL|macro|VIOCDI
mdefine_line|#define VIOCDI&t;&t;viocd_diskinfo[deviceno].viocd_info
DECL|variable|viocd_queue
r_static
id|request_queue_t
op_star
id|viocd_queue
...
l_string|&quot;error allocating tce&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* initialize units */
r_for
c_loop
(paren
id|deviceno

...
id|printk
(paren
l_string|&quot;aztcd: DriverVersion=%s For IDE/ATAPI-drives use ide-cd.c&bslash;n&quot;
comma
id|AZT_VERSION
)paren
suffix:semicolon
...
multiline_comment|/* use udelay(), damnit -- AV */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
DECL|variable|AZTECH_CDROM_MAJOR
id|MODULE_ALIAS_BLOCKDEV_MAJOR
c_func
(paren
id|AZTECH_CDROM_MAJOR
)paren
suffix:semicolon
eof

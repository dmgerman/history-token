...
id|check_media_type
suffix:semicolon
multiline_comment|/* automatically restart mrw format */
DECL|variable|mrw_format_restart
r_static
r_int
id|mrw_format_restart
op_assign
l_int|1
suffix:semicolon
id|module_param
...
suffix:semicolon
DECL|variable|mrw_format_status
r_static
r_const
r_char
op_star
id|mrw_format_status
(braket
)braket
op_assign
(brace
l_string|&quot;not mrw&quot;
comma
l_string|&quot;bgformat inactive&quot;
comma
l_string|&quot;bgformat active&quot;
comma
l_string|&quot;mrw complete&quot;
comma
)brace
suffix:semicolon
DECL|variable|mrw_address_space
r_static
r_const
r_char
op_star
id|mrw_address_space
(braket
)braket
op_assign
(brace
...
id|topCdromPtr
suffix:semicolon
DECL|function|cdrom_dummy_generic_packet
r_static
r_int
id|cdrom_dummy_generic_packet
c_func
(paren
r_struct
id|cdrom_device_info
...
DECL|function|cdrom_get_media_event
r_int
...
DECL|function|cdrom_mrw_bgformat
r_static
r_int
id|cdrom_mrw_bgformat
c_func
(paren
r_struct
id|cdrom_device_info
...
(paren
id|KERN_INFO
l_string|&quot;cdrom: %sstarting format&bslash;n&quot;
comma
id|cont
ques
c_cond
...
suffix:semicolon
multiline_comment|/*&n;&t; * FmtData bit set (bit 4), format type is 1&n;&t; */
id|init_cdrom_command
c_func
(paren
op_amp
...
id|HZ
suffix:semicolon
multiline_comment|/*&n;&t; * 4 byte format list header, 8 byte format list descriptor&n;&t; */
id|buffer
(braket
l_int|1
)braket
...
l_int|8
suffix:semicolon
multiline_comment|/*&n;&t; * nr_blocks field&n;&t; */
id|buffer
(braket
l_int|4
)braket
...
(paren
id|KERN_INFO
l_string|&quot;cdrom: bgformat failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ret
...
DECL|function|cdrom_mrw_bgformat_susp
r_static
r_int
id|cdrom_mrw_bgformat_susp
c_func
(paren
r_struct
id|cdrom_device_info
...
suffix:semicolon
multiline_comment|/*&n;&t; * Session = 1, Track = 0&n;&t; */
id|cgc.cmd
(braket
l_int|1
)braket
...
DECL|function|cdrom_flush_cache
r_static
r_int
id|cdrom_flush_cache
c_func
(paren
r_struct
id|cdrom_device_info
...
(paren
id|KERN_INFO
l_string|&quot;cdrom: issuing MRW back ground &quot;
l_string|&quot;format suspend&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
DECL|function|cdrom_mrw_set_lba_space
r_static
r_int
id|cdrom_mrw_set_lba_space
c_func
(paren
r_struct
id|cdrom_device_info
...
(paren
id|KERN_INFO
l_string|&quot;cdrom: %s: mrw address space %s selected&bslash;n&quot;
comma
id|cdi-&gt;name
comma
id|mrw_address_space
...
id|CDF_RWRT
suffix:semicolon
multiline_comment|/* often 0x0020 */
id|cgc.cmd
(braket
l_int|8
)braket
...
DECL|function|cdrom_media_erasable
r_static
r_int
id|cdrom_media_erasable
c_func
(paren
r_struct
id|cdrom_device_info
...
multiline_comment|/*&n; * FIXME: check RO bit&n; */
DECL|function|cdrom_dvdram_open_write
r_static
r_int
id|cdrom_dvdram_open_write
c_func
(paren
r_struct
id|cdrom_device_info
...
suffix:semicolon
multiline_comment|/*&n;&t; * allow writable open if media info read worked and media is&n;&t; * erasable, _or_ if it fails since not all drives support it&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|cdrom_mrw_open_write
r_static
r_int
id|cdrom_mrw_open_write
c_func
(paren
r_struct
id|cdrom_device_info
...
id|ret
suffix:semicolon
multiline_comment|/*&n;&t; * always reset to DMA lba space on open&n;&t; */
r_if
c_cond
(paren
id|cdrom_mrw_set_lba_space
...
(paren
id|KERN_ERR
l_string|&quot;cdrom: failed setting lba address space&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * mrw_status&n;&t; * 0&t;-&t;not MRW formatted&n;&t; * 1&t;-&t;MRW bgformat started, but not running or complete&n;&t; * 2&t;-&t;MRW bgformat in progress&n;&t; * 3&t;-&t;MRW formatting complete&n;&t; */
id|ret
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;cdrom open: mrw_status &squot;%s&squot;&bslash;n&quot;
comma
id|mrw_format_status
(braket
id|di.mrw_status
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * obtain write protect information as per&n;&t; * drivers/scsi/sd.c:sd_read_write_protect_flag&n;&t; */
id|ret
op_assign
id|cdrom_mode_sense
c_func
...
multiline_comment|/* drive gave us no info, let the user go ahead */
r_if
c_cond
(paren
id|ret
...
DECL|function|cdrom_ram_open_write
r_static
r_int
id|cdrom_ram_open_write
c_func
(paren
r_struct
id|cdrom_device_info
...
id|CD_OPEN
comma
l_string|&quot;can open for random write&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ret
...
DECL|function|cdrom_mmc3_profile
r_static
r_void
id|cdrom_mmc3_profile
c_func
(paren
r_struct
id|cdrom_device_info
...
l_int|0x12
suffix:colon
multiline_comment|/* DVD-RAM&t;*/
r_case
l_int|0x1A
suffix:colon
multiline_comment|/* DVD+RW&t;*/
r_return
l_int|0
suffix:semicolon
r_default
...
multiline_comment|/*&n; * returns 0 for ok to open write, non-0 to disallow&n; */
DECL|function|cdrom_open_write
r_static
r_int
id|cdrom_open_write
c_func
...
DECL|function|cdrom_dvd_rw_close_write
r_static
r_void
id|cdrom_dvd_rw_close_write
c_func
(paren
r_struct
id|cdrom_device_info
...
id|CD_CLOSE
comma
l_string|&quot;%s: DVD+RW media clean&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;cdrom: %s: dirty DVD+RW media, &bslash;&quot;finalizing&bslash;&quot;&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
l_int|2
suffix:semicolon
multiline_comment|/* Close session */
id|cgc.quiet
op_assign
l_int|1
suffix:semicolon
...
DECL|function|cdrom_close_write
r_static
r_int
id|cdrom_close_write
c_func
(paren
r_struct
id|cdrom_device_info
...
suffix:semicolon
multiline_comment|/*&n;&t; * flush cache on last write release&n;&t; */
r_if
c_cond
(paren
id|CDROM_CAN
...
l_int|0xff
suffix:semicolon
multiline_comment|/*&n;&t; * refrain from reporting errors on non-existing layers (mainly)&n;&t; */
id|cgc.quiet
op_assign
l_int|1
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * place the data... really ugly, but at least we won&squot;t have to&n;&t; * worry about endianess in userspace.&n;&t; */
id|memset
c_func
(paren
id|layer
...
DECL|function|cdrom_read_cdda_old
r_static
r_int
id|cdrom_read_cdda_old
c_func
(paren
r_struct
id|cdrom_device_info
...
suffix:semicolon
multiline_comment|/*&n;&t; * start with will ra.nframes size, back down if alloc fails&n;&t; */
id|nr
op_assign
id|nframes
suffix:semicolon
...
DECL|function|cdrom_read_cdda_bpc
r_static
r_int
id|cdrom_read_cdda_bpc
c_func
(paren
r_struct
id|cdrom_device_info
...
id|retry
suffix:colon
multiline_comment|/*&n;&t; * for anything else than success and io error, we need to retry&n;&t; */
id|ret
op_assign
id|cdrom_read_cdda_bpc
c_func
...
id|ret
suffix:semicolon
multiline_comment|/*&n;&t; * I&squot;ve seen drives get sense 4/8/3 udma crc errors on multi&n;&t; * frame dma, so drop to single frame dma if we need to&n;&t; */
r_if
c_cond
(paren
id|cdi-&gt;cdda_method
...
c_func
(paren
l_string|&quot;cdrom: dropping to single frame dma&bslash;n&quot;
)paren
suffix:semicolon
id|cdi-&gt;cdda_method
op_assign
...
multiline_comment|/*&n;&t; * so we have an io error of some sort with multi frame dma. if the&n;&t; * condition wasn&squot;t a hardware error&n;&t; * problems, not for any error&n;&t; */
r_if
c_cond
(paren
id|cdi-&gt;last_sense
...
c_func
(paren
l_string|&quot;cdrom: dropping to old style cdda (sense=%x)&bslash;n&quot;
comma
id|cdi-&gt;last_sense
)paren
suffix:semicolon
...
id|ret
suffix:semicolon
multiline_comment|/* originally the code depended on buffer[1] to determine&n;&t;&t;   how much data is available for transfer. buffer[1] is&n;&t;&t;   unfortunately ambigious and the only reliable way seem&n;&t;&t;   to be to simply skip over the block descriptor... */
id|offset
op_assign
l_int|8
op_plus
...
id|ret
suffix:semicolon
multiline_comment|/* return actual fill size */
r_return
id|buflen
suffix:semicolon
)brace
...
id|use_toc
suffix:semicolon
multiline_comment|/* if unit didn&squot;t return msb, it&squot;s zeroed by cdrom_get_disc_info */
id|last_track
op_assign
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/* this is where we end up if the drive either can&squot;t do a&n;&t;   GPCMD_READ_DISC_INFO or GPCMD_READ_TRACK_RZONE_INFO or if&n;&t;   it doesn&squot;t give enough information or fails. then we return&n;&t;   the toc contents. */
id|use_toc
suffix:colon
id|toc.cdte_format
op_assign
...
suffix:semicolon
DECL|variable|cdrom_media_changed
id|EXPORT_SYMBOL
c_func
(paren
id|cdrom_media_changed
...
suffix:semicolon
DECL|variable|cdrom_get_media_event
id|EXPORT_SYMBOL
c_func
(paren
id|cdrom_get_media_event
...
id|pos
comma
l_string|&quot;&bslash;nCan write RAM:&bslash;t&quot;
)paren
suffix:semicolon
r_for
c_loop

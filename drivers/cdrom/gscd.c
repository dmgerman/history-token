...
c_func
(paren
l_string|&quot;GSCD: bad cmd %p&bslash;n&quot;
comma
id|req-&gt;cmd
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;GSCD: block %d, nsect %d&bslash;n&quot;
comma
id|block
comma
id|nsect

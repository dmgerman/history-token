...
(paren
id|KERN_INFO
l_string|&quot;optcd: cannot allocate read buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|buf
suffix:semicolon
multiline_comment|/* save read buffer */
id|toc_uptodate
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;optcd: can&squot;t allocate disk&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

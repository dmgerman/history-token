...
id|Enodev
suffix:semicolon
multiline_comment|/* was able to get the configuration,&n;&t; * set drive mode as rest of init&n;&t; */
macro_line|#if DEBUG &gt; 0
...
(paren
id|KERN_WARNING
l_string|&quot;sonycd535: Unable to request region 0x%x&bslash;n&quot;
comma
id|sony535_cd_base_io
)paren
suffix:semicolon
...
suffix:semicolon
DECL|variable|CDU535_CDROM_MAJOR
id|MODULE_ALIAS_BLOCKDEV_MAJOR
c_func
(paren
id|CDU535_CDROM_MAJOR
)paren
suffix:semicolon
eof

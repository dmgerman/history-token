...
(paren
id|KERN_WARNING
l_string|&quot;i2o_config : No suitable DMA available on controller %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t;Wait for a considerable time till the Controller &n;&t;does its job before timing out. The controller might&n;&t;take more time to process this request if there are&n;&t;many devices connected to it.&n;&t;*/
id|token
op_assign

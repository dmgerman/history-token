...
suffix:semicolon
singleline_comment|//              printk(KERN_INFO &quot;File %p w/id %d has %d events&bslash;n&quot;,
singleline_comment|//                      inf-&gt;fp, inf-&gt;q_id, inf-&gt;q_len);
id|kill_fasync
c_func
(paren
op_amp
...
suffix:semicolon
singleline_comment|//      printk(&quot;i2o_config: swdl frag %d/%d (size %d)&bslash;n&quot;, curfrag, maxfrag, fragsize);
id|status
op_assign
...
suffix:semicolon
singleline_comment|//      printk(&quot;i2o_config: swul frag %d/%d (size %d)&bslash;n&quot;, curfrag, maxfrag, fragsize);
id|status
op_assign
id|i2o_msg_post_wait_mem
c_func

...
suffix:semicolon
multiline_comment|/**&n; *      i2o_cntxt_list_get - Get a pointer from the context list and remove it&n; *&t;@context: context id to which the pointer belong&n; *&t;@c: controller to which the context list belong&n; *&t;returns pointer to the matching context id&n; */

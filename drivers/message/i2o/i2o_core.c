...
multiline_comment|/**&n; *      i2o_context_list_add -&t;append an ptr to the context list and return a&n; *&t;&t;&t;&t;matching context id.&n; *&t;@ptr: pointer to add to the context list&n; *&t;@c: controller to which the context list belong&n; *&t;returns context id, which could be used in the transaction context&n; *&t;field.&n; *&n; *&t;Because the context field in I2O is only 32-bit large, on 64-bit the&n; *&t;pointer is to large to fit in the context field. The i2o_context_list&n; *&t;functiones map pointers to context fields.&n; */
...
(paren
id|KERN_EMERG
l_string|&quot;i2o_core: context list overflow&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_EMERG
l_string|&quot;i2o_core: could not allocate memory for context list element&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_DEBUG
l_string|&quot;i2o_core: add context to list %p -&gt; %d&bslash;n&quot;
comma
id|ptr
comma
id|context
...
multiline_comment|/**&n; *      i2o_context_list_remove - remove a ptr from the context list and return&n; *&t;&t;&t;&t;  the matching context id.&n; *&t;@ptr: pointer to be removed from the context list&n; *&t;@c: controller to which the context list belong&n; *&t;returns context id, which could be used in the transaction context&n; *&t;field.&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;i2o_core: could not remove nonexistent ptr %p&bslash;n&quot;
comma
id|ptr
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;i2o_core: markt as deleted in context list %p -&gt; %d&bslash;n&quot;
comma
id|ptr
comma
id|context
...
multiline_comment|/**&n; *      i2o_context_list_get -&t;get a ptr from the context list and remove it&n; *&t;&t;&t;&t;from the list.&n; *&t;@context: context id to which the pointer belong&n; *&t;@c: controller to which the context list belong&n; *&t;returns pointer to the matching context id&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;i2o_core: context id %d not found&bslash;n&quot;
comma
id|context
)paren
suffix:semicolon
...
id|count
op_ge
id|I2O_CONTEXT_LIST_MIN_LENGTH
)paren
(brace
op_star
id|entry
...
(paren
id|KERN_DEBUG
l_string|&quot;i2o_core: get ptr from context list %d -&gt; %p&bslash;n&quot;
comma
id|context
comma
id|ptr
...
(paren
id|KERN_INFO
l_string|&quot;i2o: PCI I2O controller&bslash;n    BAR0 at 0x%08lX size=%ld&bslash;n    BAR1 at 0x%08lX size=%ld&bslash;n&quot;
comma
id|bar0_phys
comma
id|bar0_size
...
suffix:semicolon
DECL|variable|i2o_context_list_add
id|EXPORT_SYMBOL
c_func
(paren
id|i2o_context_list_add
...
suffix:semicolon
DECL|variable|i2o_context_list_get
id|EXPORT_SYMBOL
c_func
(paren
id|i2o_context_list_get
...
suffix:semicolon
DECL|variable|i2o_context_list_remove
id|EXPORT_SYMBOL
c_func
(paren
id|i2o_context_list_remove

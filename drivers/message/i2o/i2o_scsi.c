...
id|list
suffix:semicolon
multiline_comment|/* node in in i2o_scsi_hosts */
...
suffix:semicolon
multiline_comment|/*&n; * This is only needed, because we can only set the hostdata after the device is&n; * added to the scsi core. So we need this little workaround.&n; */
r_static
id|DECLARE_MUTEX
c_func
(paren
id|i2o_scsi_probe_lock
)paren
suffix:semicolon
DECL|variable|i2o_scsi_probe_dev
r_static
r_struct
id|i2o_device
op_star
id|i2o_scsi_probe_dev
op_assign
l_int|NULL
suffix:semicolon
DECL|function|i2o_scsi_slave_alloc
r_static
r_int
id|i2o_scsi_slave_alloc
c_func
(paren
r_struct
id|scsi_device
...
id|rc
suffix:semicolon
multiline_comment|/* skip if already registered as I2O SCSI host */
id|list_for_each_entry
c_func
(paren
id|i2o_shost
...
(paren
id|KERN_ERR
l_string|&quot;scsi-osm: Could not initialize SCSI host&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|i2o_shost
...
(paren
id|KERN_ERR
l_string|&quot;scsi-osm: Could not add SCSI host&bslash;n&quot;
)paren
suffix:semicolon
id|scsi_host_put
c_func
...
id|i2o_scsi_queuecommand
comma
multiline_comment|/*&n;&t;.eh_abort_handler&t;= i2o_scsi_abort,&n;*/
dot
id|bios_param
op_assign
id|i2o_scsi_bios_param
...
id|tmp
suffix:semicolon
multiline_comment|/* Remove I2O SCSI hosts */

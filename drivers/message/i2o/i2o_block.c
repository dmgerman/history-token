...
suffix:semicolon
multiline_comment|/*&n; * Per IOP request queue information&n; *&n; * We have a separate request_queue_t per IOP so that a heavilly&n; * loaded I2O block device on an IOP does not starve block devices&n; * across all I2O controllers.&n; * &n; */
...
c_cond
(paren
id|dev-&gt;i2odev-&gt;controller-&gt;promise
)paren
(brace
id|panic
c_func
...
id|q
suffix:semicolon
multiline_comment|/*&n;&t; * Allocate a gendisk structure and initialize it&n;&t; */
id|disk
op_assign
id|alloc_disk
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;release request queue&n;&t; */
r_for
c_loop
(paren
id|i

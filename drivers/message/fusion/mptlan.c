...
id|KERN_INFO
id|MYNAM
l_string|&quot;: %s: PortNum=%x, &quot;
l_string|&quot;ProtocolFlags=%02Xh (%c%c%c%c)&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|ioc-&gt;pfacts
...
id|KERN_INFO
id|MYNAM
l_string|&quot;: %s: Hmmm... LAN protocol &quot;
l_string|&quot;seems to be disabled on this adapter port!&bslash;n&quot;
comma
id|ioc-&gt;name
)paren
suffix:semicolon
...
id|KERN_ERR
id|MYNAM
l_string|&quot;: %s: Unable to register &quot;
l_string|&quot;port%d as a LAN device&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|ioc-&gt;pfacts
...
id|KERN_INFO
id|MYNAM
l_string|&quot;: %s: Fusion MPT LAN device &quot;
l_string|&quot;registered as &squot;%s&squot;&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|dev-&gt;name

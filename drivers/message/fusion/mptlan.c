...
c_cond
(paren
id|mpt_dev-&gt;pfacts0.MaxLanBuckets
OL
id|max_buckets_out
)paren
id|priv-&gt;max_buckets_out
...
id|i
OL
id|curadapter-&gt;facts0.NumberOfPorts
suffix:semicolon
id|i
op_increment
)paren
...
id|curadapter-&gt;name
comma
id|curadapter-&gt;pfacts0.PortNumber
comma
id|curadapter-&gt;pfacts0.ProtocolFlags
comma

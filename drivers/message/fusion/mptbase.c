...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;ii=%d IocFacts failed r=%x&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|ii
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;Retry IocFacts failed r=%x&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|r
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;Initial Alt IocFacts failed r=%x&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|r
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;Retry Alt IocFacts failed r=%x&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|r
...
suffix:semicolon
multiline_comment|/* clear the PREVENT_IOC_BOOT bit */
id|diag0val
op_assign
id|CHIPREG_READ32
c_func
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;downloadboot diag0val=%x, turning off PREVENT_IOC_BOOT&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|diag0val
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;downloadboot diag0val=%x, turning off DISABLE_ARM, RW_ENABLE, RESET_HISTORY&bslash;n&quot;
comma
id|ioc-&gt;name
comma
id|diag0val
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;CAN_SLEEP 100 msec before reset the sequencer&bslash;n&quot;
comma
id|ioc-&gt;name
)paren
)paren
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;mdelay 100 msec before reset the sequencer&bslash;n&quot;
comma
id|ioc-&gt;name
)paren
)paren
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;downloadboot failed, diag0val=%x FLASH_BAD_SIG | DISABLE_ARM on&bslash;n &quot;
comma
id|ioc-&gt;name
comma
id|diag0val
...
suffix:semicolon
multiline_comment|/*&t;&t;&t;if ((r = GetIocFacts(ioc, sleepFlag, MPT_HOSTEVENT_IOC_BRINGUP)) != 0) {&n;&t;&t;&t;&t;if ((r = GetIocFacts(ioc, sleepFlag, MPT_HOSTEVENT_IOC_BRINGUP)) != 0) {&n;&t;&t;&t;&t;&t;ddlprintk((MYIOC_s_INFO_FMT &quot;GetIocFacts failed&bslash;n&quot;,&n;&t;&t;&t;&t;&t;&t;ioc-&gt;name));&n;&t;&t;&t;&t;&t;&t;return -EFAULT;&n;&t;&t;&t;&t;}&n;&t;&t;&t;} */
multiline_comment|/* wait 2 sec */
multiline_comment|/*&t;&t;&t;if (sleepFlag == CAN_SLEEP) {&n;&t;&t;&t;&t;set_current_state(TASK_INTERRUPTIBLE);&n;&t;&t;&t;&t;schedule_timeout(5000 * HZ / 1000);&n;&t;&t;&t;} else {&n;&t;&t;&t;&t;mdelay (5000);&n;&t;&t;&t;} */
r_return
l_int|0
suffix:semicolon
)brace

...
mdefine_line|#define CHIPREG_READ32(addr) &t;&t;readl(addr)
...
(paren
id|KERN_ERR
l_string|&quot;mpt_put_msg_frame: Invalid iocid=%d&bslash;n&quot;
comma
id|iocid
)paren
suffix:semicolon
...
multiline_comment|/* Get IOC facts! Allow 1 retry */
r_if
c_cond
(paren
(paren
...
id|this-&gt;pcidev
comma
id|this-&gt;fifo_pool_sz
comma
id|this-&gt;fifo_pool
comma
id|this-&gt;fifo_pool_dma
)paren
suffix:semicolon
...
id|num_chain
suffix:semicolon
multiline_comment|/* request buffer size,  rounding UP to nearest 4-kB boundary */
id|request_buffer_sz
op_assign
(paren
id|ioc-&gt;req_sz
...
l_int|0x1000
suffix:semicolon
multiline_comment|/* reply buffer size */
id|reply_buffer_sz
op_assign
(paren
id|ioc-&gt;reply_sz
...
suffix:semicolon
multiline_comment|/* reply fifo pointers */
id|ioc-&gt;reply_alloc
op_assign
id|ioc-&gt;fifo_pool
suffix:semicolon
...
id|ioc-&gt;fifo_pool_dma
suffix:semicolon
multiline_comment|/* request fifo pointers */
id|ioc-&gt;req_alloc
op_assign
id|ioc-&gt;reply_alloc
op_plus
...
id|reply_buffer_sz
suffix:semicolon
multiline_comment|/* chain buffer pointers */
id|ioc-&gt;chain_alloc
op_assign
id|ioc-&gt;req_alloc
op_plus
id|request_buffer_sz
suffix:semicolon
id|ioc-&gt;chain_alloc_dma
op_assign
id|ioc-&gt;req_alloc_dma
op_plus
id|request_buffer_sz
suffix:semicolon
id|ioc-&gt;chain_alloc_sz
op_assign
id|chain_buffer_sz
suffix:semicolon
...
multiline_comment|/* ioc-&gt;fifo_pool == NULL */
...
l_int|0x7
suffix:semicolon
singleline_comment|//&t;u32 SubCl = log_info &amp; 0x27000000;
id|printk
c_func
(paren
id|MYIOC_s_INFO_FMT

...
id|KERN_ERR
id|MYNAM
l_string|&quot;: Failed to register callback1 with MPT base driver&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|mpt_scsi_hosts
...
id|KERN_ERR
id|MYNAM
l_string|&quot;: Failed to register callback2 with MPT base driver&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|mpt_scsi_hosts
...
l_int|0
suffix:semicolon
multiline_comment|/* Yikes!  This is important!&n;&t;&t;&t; * Otherwise, by default, linux only scans target IDs 0-7!&n;&t;&t;&t; *&n;&t;&t;&t; * BUG FIX!  20010618 -sralston &amp; pdelaney&n;&t;&t;&t; * FC919 testing was encountering &quot;duplicate&quot; FC devices,&n;&t;&t;&t; * as it turns out because the 919 was returning 512&n;&t;&t;&t; * for PortFacts.MaxDevices, causing a wraparound effect&n;&t;&t;&t; * in SCSI IO requests.  So instead of using:&n;&t;&t;&t; *     sh-&gt;max_id = this-&gt;pfacts[0].MaxDevices - 1&n;&t;&t;&t; * we&squot;ll use a definitive max here.&n;&t;&t;&t; */
id|sh-&gt;max_id
op_assign
...
id|KERN_ERR
id|MYNAM
l_string|&quot;: ERROR - ScsiLookup fail(#2) for SCpnt=%p&bslash;n&quot;
comma
id|SCpnt
)paren
suffix:semicolon
...
id|ctx2abort
suffix:semicolon
multiline_comment|/* MPI v0.10 requires SCSITaskMgmt requests be sent via Doorbell/handshake&n;&t;&t;&t;mpt_put_msg_frame(hd-&gt;ioc-&gt;id, mf);&n;&t;&t;*/
r_if
c_cond
(paren
(paren
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: WARNING[2] - IOC error (%d) processing TaskMgmt request (mf=%p:sc=%p)&bslash;n&quot;
comma
id|i
comma
id|mf
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: WARNING[3] - IOC error (%d) processing TaskMgmt request (mf=%p:sc=%p)&bslash;n&quot;
comma
id|i
comma
id|mf
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: WARNING[4] - IOC error (%d) processing TaskMgmt request (mf=%p:sc=%p)&bslash;n&quot;
comma
id|i
comma
id|mf
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: Attempting _ABORT SCSI IO! (mf=%p:sc=%p)&bslash;n&quot;
comma
id|mf
comma
id|SCpnt
...
id|KERN_ERR
id|MYNAM
l_string|&quot;: ERROR - ScsiLookup fail(#1) for SCpnt=%p&bslash;n&quot;
comma
id|SCpnt
)paren
suffix:semicolon
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: Attempting _BUS_RESET! (against SCSI IO mf=%p:sc=%p)&bslash;n&quot;
comma
id|mf
comma
id|SCpnt
...
suffix:semicolon
multiline_comment|/* Control: No data direction, set task mgmt bit? */
multiline_comment|/*&n;&t;&t; *  As of MPI v0.10 this request can NOT be sent (normally)&n;&t;&t; *  via FIFOs.&t;So we can&squot;t:&n;&t;&t; *&t;&t;mpt_put_msg_frame(ScsiTaskCtx, hd-&gt;ioc-&gt;id, mf);&n;&t;&t; *  SCSITaskMgmt requests MUST be sent ONLY via&n;&t;&t; *  Doorbell/handshake now.   :-(&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|KERN_WARNING
id|MYNAM
l_string|&quot;: WARNING[1] - IOC error (%d) processing TaskMgmt request (mf=%p:sc=%p)&bslash;n&quot;
comma
id|i
comma
id|mf
...
(brace
multiline_comment|/* FIXME! Do pre-reset cleanup */
)brace
r_else
(brace
multiline_comment|/* FIXME! Do post-reset cleanup */
)brace
r_return
l_int|1
suffix:semicolon

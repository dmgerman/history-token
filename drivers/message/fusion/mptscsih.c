...
id|num_sge
suffix:semicolon
multiline_comment|/* chain buffer allocation done from PrimeIocFifos */
r_if
c_cond
(paren
id|hd-&gt;ioc-&gt;fifo_pool
...
id|hd-&gt;ChainBuffer
op_assign
id|hd-&gt;ioc-&gt;chain_alloc
suffix:semicolon
id|hd-&gt;ChainBufferDMA
op_assign
id|hd-&gt;ioc-&gt;chain_alloc_dma
suffix:semicolon
id|dprintk
c_func
(paren
...
(paren
id|MYIOC_s_INFO_FMT
l_string|&quot;Free&squot;d ScsiLookup (%d) Target (%d+%d) memory&bslash;n&quot;
comma
id|hd-&gt;ioc-&gt;name
comma
id|sz1

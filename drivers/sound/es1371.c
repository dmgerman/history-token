...
mdefine_line|#define CT5880REV_CT5880_D  0x03
...
id|amplifier
comma
l_string|&quot;Set to 1 if the machine needs the amp control enabling (many laptops)&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
id|sdid
suffix:semicolon
DECL|variable|amplifier_needed
)brace
id|amplifier_needed
(braket
)braket
...
comma
multiline_comment|/* Mebius PC-MJ100V */
(brace
l_int|0x1102
comma
l_int|0x5938
...
comma
multiline_comment|/* Targa Xtender 300 */
(brace
l_int|0x1102
comma
l_int|0x8938
...
comma
multiline_comment|/* IPC notebook */
(brace
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
l_int|0
suffix:semicolon
multiline_comment|/* Check amplifier requirements */
r_if
c_cond
(paren
id|amplifier
...
id|CTRL_GPIO_OUT0
suffix:semicolon
multiline_comment|/* turn internal amplifier on */
id|printk
c_func
(paren
id|KERN_INFO
id|PFX
l_string|&quot;Enabling internal amplifier.&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
id|KERN_ERR
id|PFX
l_string|&quot;no free joystick address found&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|s-&gt;sctrl

...
id|wavnc_info
suffix:semicolon
multiline_comment|/*&n; * This is the implementation specific mixer information.&n; */
DECL|struct|waveartist_mixer_info
r_struct
id|waveartist_mixer_info
(brace
DECL|member|supported_devs
r_int
r_int
id|supported_devs
suffix:semicolon
multiline_comment|/* Supported devices */
DECL|member|recording_devs
r_int
r_int
id|recording_devs
suffix:semicolon
multiline_comment|/* Recordable devies */
DECL|member|stereo_devs
r_int
r_int
id|stereo_devs
suffix:semicolon
multiline_comment|/* Stereo devices&t;*/
DECL|member|select_input
r_int
r_int
(paren
op_star
...
comma
multiline_comment|/* SOUND_MIXER_DIGITAL1 */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_DIGITAL2 */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_DIGITAL3 */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_PHONEIN  */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_PHONEOUT */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_VIDEO    */
(brace
l_int|0
comma
l_int|0
...
comma
multiline_comment|/* SOUND_MIXER_RADIO    */
(brace
l_int|0
comma
l_int|0
...
multiline_comment|/* SOUND_MIXER_MONITOR  */
)brace
suffix:semicolon
r_static
r_void
...
multiline_comment|/*&n; * Set the ADC MUX to the specified values.  We do NOT do any&n; * checking of the values passed, since we assume that the&n; * relevant *_select_input function has done that for us.&n; */
r_static
r_void
DECL|function|waveartist_set_adc_mux
id|waveartist_set_adc_mux
c_func
(paren
id|wavnc_info
op_star
...
multiline_comment|/*&n; * Decode a recording mask into a mixer selection as follows:&n; *&n; *     OSS Source&t;WA Source&t;Actual source&n; *  SOUND_MASK_IMIX&t;Mixer&t;&t;Mixer output (same as AD1848)&n; *  SOUND_MASK_LINE&t;Line&t;&t;Line in&n; *  SOUND_MASK_LINE1&t;Aux 1&t;&t;Aux 1 in&n; *  SOUND_MASK_LINE2&t;Aux 2&t;&t;Aux 2 in&n; *  SOUND_MASK_MIC&t;Mic&t;&t;Microphone&n; */
r_static
r_int
r_int
...
r_static
r_int
DECL|function|waveartist_decode_mixer
id|waveartist_decode_mixer
c_func
(paren
id|wavnc_info
op_star
...
DECL|function|waveartist_get_mixer
r_static
r_int
id|waveartist_get_mixer
c_func
(paren
id|wavnc_info
op_star
...
DECL|variable|waveartist_mixer
r_static
r_const
r_struct
id|waveartist_mixer_info
...
r_static
r_void
DECL|function|waveartist_set_recmask
id|waveartist_set_recmask
c_func
(paren
id|wavnc_info
op_star
...
id|recmask
op_and_assign
id|devc-&gt;mix-&gt;recording_devs
suffix:semicolon
multiline_comment|/*&n;&t; * If more than one recording device selected,&n;&t; * disable the device that is currently in use.&n;&t; */
r_if
c_cond
(paren
id|hweight32
...
id|devc-&gt;recmask
suffix:semicolon
multiline_comment|/*&n;&t; * Translate the recording device mask into&n;&t; * the ADC multiplexer settings.&n;&t; */
id|devc-&gt;recmask
op_assign
id|devc-&gt;mix
op_member_access_from_pointer
...
r_static
r_int
DECL|function|waveartist_set_mixer
id|waveartist_set_mixer
c_func
(paren
id|wavnc_info
op_star
...
l_int|100
suffix:semicolon
multiline_comment|/*&n;&t; * Mono devices have their right volume forced to their&n;&t; * left volume.  (from ALSA driver OSS emulation).&n;&t; */
r_if
c_cond
(paren
op_logical_neg
(paren
id|devc-&gt;mix-&gt;stereo_devs
op_amp
(paren
l_int|1
op_lshift
...
id|nr
suffix:semicolon
multiline_comment|/*&n;&t; * All SOUND_MIXER_* ioctls use type &squot;M&squot;&n;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; * Decode a recording mask into a mixer selection on the NetWinder&n; * as follows:&n; *&n; *     OSS Source&t;WA Source&t;Actual source&n; *  SOUND_MASK_IMIX&t;Mixer&t;&t;Mixer output (same as AD1848)&n; *  SOUND_MASK_LINE&t;Line&t;&t;Line in&n; *  SOUND_MASK_LINE1&t;Left Mic&t;Handset&n; *  SOUND_MASK_PHONEIN&t;Left Aux&t;Telephone microphone&n; *  SOUND_MASK_MIC&t;Right Mic&t;Builtin microphone&n; */
r_static
r_int
r_int
DECL|function|netwinder_select_input
id|netwinder_select_input
c_func
(paren
id|wavnc_info
op_star
...
r_static
r_int
DECL|function|netwinder_decode_mixer
id|netwinder_decode_mixer
c_func
(paren
id|wavnc_info
op_star
...
id|SOUND_MIXER_MIC
suffix:colon
multiline_comment|/* right mic only */
id|devc-&gt;levels
(braket
id|SOUND_MIXER_MIC
)braket
...
id|SOUND_MIXER_LINE1
suffix:colon
multiline_comment|/* left mic only  */
id|devc-&gt;levels
(braket
id|SOUND_MIXER_MIC
)braket
...
suffix:colon
multiline_comment|/* left aux only  */
id|devc-&gt;levels
(braket
id|SOUND_MIXER_LINE1
)braket
...
DECL|function|netwinder_get_mixer
r_static
r_int
id|netwinder_get_mixer
c_func
(paren
id|wavnc_info
op_star
...
id|SOUND_MIXER_MIC
suffix:colon
multiline_comment|/* builtin mic: right mic only */
id|levels
op_assign
id|devc-&gt;levels
(braket
...
id|SOUND_MIXER_LINE1
suffix:colon
multiline_comment|/* handset mic: left mic only */
id|levels
op_assign
id|devc-&gt;levels
(braket
...
id|SOUND_MIXER_PHONEIN
suffix:colon
multiline_comment|/* phone mic: left aux1 only */
id|levels
op_assign
id|devc-&gt;levels
(braket
...
multiline_comment|/*&n; * Waveartist specific mixer information.&n; */
DECL|variable|netwinder_mixer
r_static
r_const
r_struct
id|waveartist_mixer_info
...
id|old_td
suffix:semicolon
multiline_comment|/*&n;&t; * read the &quot;buttons&quot; state.&n;&t; *  Bit 4 = 0 means handset present&n;&t; *  Bit 5 = 1 means phone offhook&n;&t; */
id|temp
op_assign
id|inb
c_func
...
(brace
multiline_comment|/*&n;&t;&t; * special case for master volume: if we&n;&t;&t; * received this call - switch from hw&n;&t;&t; * volume control to a software volume&n;&t;&t; * control, till the hw volume is modified&n;&t;&t; * to signal that user wants to be back in&n;&t;&t; * hardware...&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;Rockwell WaveArtist RWA-010 sound driver&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func

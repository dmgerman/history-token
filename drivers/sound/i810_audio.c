...
c_func
(paren
l_string|&quot;i810_audio: called i810_set_dac_rate : rate = %d/%d&bslash;n&quot;
comma
id|dmabuf-&gt;rate
comma
id|rate
...
c_func
(paren
l_string|&quot;i810_audio: invalid dmabuf-&gt;enable state in get_dma_addr&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* sample_shift is for 16 byte samples, add an extra shift for bytes */
id|bytepersec
op_assign
id|dmabuf-&gt;rate
op_lshift
...
id|c
op_assign
id|state-&gt;dmabuf.write_channel
suffix:semicolon
)brace
r_else
id|c
op_assign
id|state-&gt;dmabuf.read_channel
suffix:semicolon
id|port
op_add_assign
id|c-&gt;port
...
r_else
(brace
singleline_comment|// don&squot;t do both read and write paths or we won&squot;t get woke up properly
singleline_comment|// when we have a file with both permissions
r_if
c_cond
(paren
op_logical_neg
...
id|size
suffix:semicolon
multiline_comment|/* &n;&t; *&t;Until we figure out a few problems&n;&t; */
id|lock_kernel
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;i810_audio: mmap&squot;ed %d bytes of data space&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;i810_audio: setting clocking to %d to compensate&bslash;n&quot;
comma
id|clocking
)paren
suffix:semicolon

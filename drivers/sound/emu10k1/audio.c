...
(paren
op_amp
id|wave_dev-&gt;card-&gt;mgr
comma
id|wave_dev-&gt;card-&gt;pt.patch_name
comma
id|wave_dev-&gt;card-&gt;pt.enable_gpr_name
)paren
op_ge
l_int|0
)paren
...
l_int|2
comma
l_string|&quot;set recording format -&gt; %d&bslash;n&quot;
comma
id|val
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;set playback format -&gt; %d&bslash;n&quot;
comma
id|val
)paren
suffix:semicolon
...
(brace
multiline_comment|/* digital pass-through fragment count and size are fixed values */
r_if
c_cond
(paren
id|woinst-&gt;state
...
DECL|function|emu10k1_mm_nopage
r_static
r_struct
id|page
op_star
...
suffix:semicolon
multiline_comment|/* No m&squot;mapping possible for multichannel */
r_if
c_cond
(paren
id|woinst-&gt;num_voices
...
multiline_comment|/* FIXME sort out poll() + mmap() */
...
l_int|2
comma
l_string|&quot; buffer size register -&gt; %#04x&bslash;n&quot;
comma
id|buffer-&gt;sizeregval
)paren
suffix:semicolon

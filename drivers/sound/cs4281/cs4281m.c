...
DECL|macro|CS4281_CFLR_DEFAULT
mdefine_line|#define&t;CS4281_CFLR_DEFAULT&t;0x00000001  /* CFLR must be in AC97 link mode */
...
DECL|macro|CS_PM
mdefine_line|#define CS_PM&t;&t;0x00004000&t;
singleline_comment|// power management 
DECL|macro|CS_TMP
mdefine_line|#define CS_TMP&t;&t;0x10000000&t;
singleline_comment|// tmp debug mask bit
DECL|macro|CS_IOCTL_CMD_SUSPEND
mdefine_line|#define CS_IOCTL_CMD_SUSPEND&t;0x1&t;
singleline_comment|// suspend
DECL|macro|CS_IOCTL_CMD_RESUME
mdefine_line|#define CS_IOCTL_CMD_RESUME&t;0x2&t;
...
mdefine_line|#define CS4281_MINOR_VERSION &t;13
...
id|cs4281_state
suffix:semicolon
macro_line|#include &quot;cs4281_wrapper-24.c&quot;
...
id|pl
(braket
id|CS4281_NUMBER_OF_PIPELINES
)braket
suffix:semicolon
)brace
suffix:semicolon
macro_line|#include &quot;cs4281pm-24.c&quot;
macro_line|#if CSDEBUG
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_hw_init() CFLR 0x%x&bslash;n&quot;
comma
id|temp2
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_hw_init() CFLR invalid - resetting from 0x%x to 0x%x&bslash;n&quot;
comma
id|temp2
comma
id|CS4281_CFLR_DEFAULT
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_hw_init() Invalid hardware - unable to configure CFLR&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;flags:0x%x u32CLKCR1_SAVE: 0%x u32SSPMValue: 0x%x&bslash;n&quot;
comma
(paren
r_int
)paren
id|s-&gt;pm.flags
comma
id|s-&gt;pm.u32CLKCR1_SAVE
comma
id|s-&gt;pm.u32SSPMValue
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32PPLVCvalue: 0x%x u32PPRVCvalue: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32PPLVCvalue
comma
id|s-&gt;pm.u32PPRVCvalue
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32FMLVCvalue: 0x%x u32FMRVCvalue: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32FMLVCvalue
comma
id|s-&gt;pm.u32FMRVCvalue
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32GPIORvalue: 0x%x u32JSCTLvalue: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32GPIORvalue
comma
id|s-&gt;pm.u32JSCTLvalue
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32SSCR: 0x%x u32SRCSA: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32SSCR
comma
id|s-&gt;pm.u32SRCSA
...
c_func
(paren
l_string|&quot;u32DacASR: 0x%x u32AdcASR: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32DacASR
comma
id|s-&gt;pm.u32AdcASR
...
c_func
(paren
l_string|&quot;u32DacSR: 0x%x u32AdcSR: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32DacSR
comma
id|s-&gt;pm.u32AdcSR
...
c_func
(paren
l_string|&quot;u32MIDCR_Save: 0x%x&bslash;n&quot;
comma
id|s-&gt;pm.u32MIDCR_Save
)paren
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;flags:0x%x number: 0%x&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;u32DBAnValue: 0%x u32DBCnValue: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DBAnValue
comma
id|pl-&gt;u32DBCnValue
...
c_func
(paren
l_string|&quot;u32DMRnValue: 0x%x u32DCRnValue: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DMRnValue
comma
id|pl-&gt;u32DCRnValue
...
c_func
(paren
l_string|&quot;u32DBAnAddress: 0x%x u32DBCnAddress: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DBAnAddress
comma
id|pl-&gt;u32DBCnAddress
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32DCAnAddress: 0x%x u32DCCnAddress: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DCCnAddress
comma
id|pl-&gt;u32DCCnAddress
)paren
)paren
...
c_func
(paren
l_string|&quot;u32DMRnAddress: 0x%x u32DCRnAddress: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DMRnAddress
comma
id|pl-&gt;u32DCRnAddress
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32HDSRnAddress: 0x%x u32DBAn_Save: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32HDSRnAddress
comma
id|pl-&gt;u32DBAn_Save
)paren
)paren
...
c_func
(paren
l_string|&quot;u32DBCn_Save: 0x%x u32DMRn_Save: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DBCn_Save
comma
id|pl-&gt;u32DMRn_Save
...
c_func
(paren
l_string|&quot;u32DCRn_Save: 0x%x u32DCCn_Save: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DCRn_Save
comma
id|pl-&gt;u32DCCn_Save
...
c_func
(paren
l_string|&quot;u32DCAn_Save: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32DCAn_Save
)paren
)paren
...
c_func
(paren
l_string|&quot;u32FCRn_Save: 0x%x u32FSICn_Save: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32FCRn_Save
comma
id|pl-&gt;u32FSICn_Save
...
c_func
(paren
l_string|&quot;u32FCRnValue: 0x%x u32FSICnValue: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32FCRnValue
comma
id|pl-&gt;u32FSICnValue
...
c_func
(paren
l_string|&quot;u32FCRnAddress: 0x%x u32FSICnAddress: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32FCRnAddress
comma
id|pl-&gt;u32FSICnAddress
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;u32FPDRnValue: 0x%x u32FPDRnAddress: 0x%x&bslash;n&quot;
comma
id|pl-&gt;u32FPDRnValue
comma
id|pl-&gt;u32FPDRnAddress
)paren
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;cs4281: cs4281_ac97_suspend()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;* change the state, save the current hwptr, then stop the dac/adc&n;*/
id|s-&gt;pm.flags
op_and_assign
op_complement
id|CS4281_PM_IDLE
...
id|s-&gt;pm.flags
op_or_assign
id|CS4281_PM_SUSPENDING
suffix:semicolon
id|s-&gt;pm.u32hwptr_playback
op_assign
id|readl
c_func
(paren
...
id|Count
op_le
id|CS4281_AC97_HIGHESTREGTORESTORE
)paren
op_logical_and
(paren
id|i
...
multiline_comment|/*&n;* Save the ac97 volume registers as well as the current powerdown state.&n;* Now, mute the all the outputs (master, headphone, and mono), as well&n;* as the PCM volume, in preparation for powering down the entire part.&n;*/
id|cs4281_read_ac97
c_func
(paren
id|s
...
comma
op_amp
id|s-&gt;pm.u32AC97_headphone_volume
)paren
suffix:semicolon
id|cs4281_read_ac97
c_func
...
comma
op_amp
id|s-&gt;pm.u32AC97_master_volume_mono
)paren
suffix:semicolon
id|cs4281_read_ac97
c_func
...
comma
op_amp
id|s-&gt;pm.u32AC97_pcm_out_volume
)paren
suffix:semicolon
id|cs4281_write_ac97
c_func
...
comma
op_amp
id|s-&gt;pm.u32AC97_general_purpose
)paren
suffix:semicolon
multiline_comment|/*&n;* And power down everything on the AC97 codec.&n;*/
id|cs4281_write_ac97
c_func
(paren
id|s
...
c_func
(paren
l_string|&quot;cs4281: cs4281_ac97_resume()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/* do not save the power state registers at this time&n;    //&n;    // If we saved away the power control registers, write them into the&n;    // shadows so those saved values get restored instead of the current&n;    // shadowed value.&n;    //&n;    if( bPowerStateSaved )&n;    {&n;        PokeShadow( 0x26, ulSaveReg0x26 );&n;        bPowerStateSaved = FALSE;&n;    }&n;*/
singleline_comment|//
singleline_comment|// First, we restore the state of the general purpose register.  This
singleline_comment|// contains the mic select (mic1 or mic2) and if we restore this after
singleline_comment|// we restore the mic volume/boost state and mic2 was selected at
singleline_comment|// suspend time, we will end up with a brief period of time where mic1
singleline_comment|// is selected with the volume/boost settings for mic2, causing
singleline_comment|// acoustic feedback.  So we restore the general purpose register
singleline_comment|// first, thereby getting the correct mic selected before we restore
singleline_comment|// the mic volume/boost.
singleline_comment|//
id|cs4281_write_ac97
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Now, while the outputs are still muted, restore the state of power
singleline_comment|// on the AC97 part.
singleline_comment|//
id|cs4281_write_ac97
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;* Restore just the first set of registers, from register number&n;* 0x02 to the register number that ulHighestRegToRestore specifies.&n;*/
r_for
c_loop
(paren
id|Count
...
(brace
multiline_comment|/*&n; * We need to save the contents of the BASIC FIFO Registers.&n; */
id|pl-&gt;u32FCRn_Save
op_assign
id|readl
c_func
...
(brace
multiline_comment|/*&n; * We need to restore the contents of the BASIC FIFO Registers.&n; */
id|writel
c_func
(paren
id|pl-&gt;u32FCRn_Save
...
(brace
singleline_comment|//
singleline_comment|// We need to save the contents of the BASIC DMA Registers.
singleline_comment|//
id|pl-&gt;u32DBAn_Save
op_assign
id|readl
...
c_func
(paren
l_string|&quot;cs4281: cs4281_suspend()+ flags=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
multiline_comment|/*&n;* check the current state, only suspend if IDLE&n;*/
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;cs4281: cs4281_suspend() unable to suspend, not IDLE&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Gershwin CLKRUN - Set CKRA
singleline_comment|//
id|u32CLKCR1
op_assign
id|readl
...
singleline_comment|//
singleline_comment|// First, turn on the clocks (yikes) to the devices, so that they will
singleline_comment|// respond when we try to save their state.
singleline_comment|//
r_if
c_cond
(paren
...
singleline_comment|//
singleline_comment|// Save the power state
singleline_comment|//
id|pm-&gt;u32SSPMValue
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save the PCM Playback Left and Right Volume Control.
singleline_comment|//
id|pm-&gt;u32PPLVCvalue
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save the FM Synthesis Left and Right Volume Control.
singleline_comment|//
id|pm-&gt;u32FMLVCvalue
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save the GPIOR value.
singleline_comment|//
id|pm-&gt;u32GPIORvalue
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save the JSCTL value.
singleline_comment|//
id|pm-&gt;u32JSCTLvalue
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save Sound System Control Register
singleline_comment|//
id|pm-&gt;u32SSCR
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save SRC Slot Assinment register
singleline_comment|//
id|pm-&gt;u32SRCSA
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Save sample rate
singleline_comment|//
id|pm-&gt;u32DacASR
op_assign
id|readl
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Loop through all of the PipeLines 
singleline_comment|//
r_for
c_loop
(paren
...
(brace
singleline_comment|//
singleline_comment|// Ask the DMAengines and FIFOs to Suspend.
singleline_comment|//
id|cs4281_SuspendDMAengine
c_func
(paren
...
singleline_comment|//
singleline_comment|// We need to save the contents of the Midi Control Register.
singleline_comment|//
id|pm-&gt;u32MIDCR_Save
op_assign
id|readl
...
suffix:semicolon
multiline_comment|/*&n;* save off the AC97 part information&n;*/
id|cs4281_ac97_suspend
c_func
(paren
id|s
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Turn off the serial ports.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Power off FM, Joystick, AC link, 
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// AC link off.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Put the chip into D3(hot) state.
singleline_comment|//
singleline_comment|// PokeBA0(BA0_PMCS, 0x00000003);
singleline_comment|//
singleline_comment|// Gershwin CLKRUN - Clear CKRA
singleline_comment|//
id|u32CLKCR1
op_assign
id|readl
...
c_func
(paren
l_string|&quot;cs4281: cs4281_resume()+ flags=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;cs4281: cs4281_resume() unable to resume, not SUSPENDED&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
suffix:semicolon
singleline_comment|//
singleline_comment|// set the power state.
singleline_comment|//
singleline_comment|//old PokeBA0(BA0_PMCS, 0);
singleline_comment|//
singleline_comment|// Program the clock circuit and serial ports.
singleline_comment|//
id|temp1
op_assign
id|cs4281_hw_init
...
(paren
id|KERN_ERR
l_string|&quot;cs4281: resume cs4281_hw_init() error.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
singleline_comment|//
singleline_comment|// restore the Power state
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Set post SRC mix setting (FM or ALT48K)
singleline_comment|//
id|writel
c_func
(paren
...
(brace
singleline_comment|//
singleline_comment|// Ask the DMAengines and FIFOs to Resume.
singleline_comment|//
id|cs4281_ResumeDMAengine
c_func
(paren
...
singleline_comment|//
singleline_comment|// We need to restore the contents of the Midi Control Register.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore the PCM Playback Left and Right Volume Control.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore the FM Synthesis Left and Right Volume Control.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore the JSCTL value.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore the GPIOR register value.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore Sound System Control Register
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore SRC Slot Assignment register
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Restore sample rate
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
singleline_comment|// 
singleline_comment|// Restore CFL1/2 registers we saved to compensate for OEM bugs.
singleline_comment|//
singleline_comment|//&t;PokeBA0(BA0_CFLR, ulConfig);
singleline_comment|//
singleline_comment|// Gershwin CLKRUN - Clear CKRA
singleline_comment|//
id|writel
...
suffix:semicolon
singleline_comment|//
singleline_comment|// Enable interrupts on the part.
singleline_comment|//
id|writel
c_func
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;* change the state, restore the current hwptrs, then stop the dac/adc&n;*/
id|s-&gt;pm.flags
op_or_assign
id|CS4281_PM_IDLE
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;* check for order within limits, but do not overwrite value, check&n;* later for a fractional defaultorder (i.e. 100+).&n;*/
r_if
c_cond
(paren
(paren
...
id|db-&gt;buforder
suffix:semicolon
multiline_comment|/*&n;* added fractional &quot;defaultorder&quot; inputs. if &gt;100 then use &n;* defaultorder-100 as power of 2 for the buffer size. example:&n;* 106 = 2^(106-100) = 2^6 = 64 bytes for the buffer size.&n;*/
r_if
c_cond
(paren
id|defaultorder
...
l_int|2
suffix:semicolon
multiline_comment|/* &n;* Nominal frag size(bytes/interrupt)&n;*/
id|temp1
op_assign
id|bytespersec
op_div
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_update_ptr(): underrun&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
(paren
id|KERN_INFO
l_string|&quot;write ac97 mixreg[%d]=0x%x mix.vol[]=0x%x&bslash;n&quot;
comma
id|vidx
op_minus
l_int|1
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_open_mixdev()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|list_for_each
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_open_mixdev()- -ENODEV&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_open_mixdev()- 0&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
singleline_comment|// or if the data should be output at 8-bit unsigned mono.
singleline_comment|//
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/*&n;* If not DMA or MIDI interrupt, then just return.&n;*/
r_if
c_cond
(paren
op_logical_neg
...
id|BA0_FCR0
suffix:semicolon
id|p-&gt;u32FSICnAddress
op_assign
id|BA0_FSIC0
suffix:semicolon
id|p-&gt;u32FPDRnAddress
op_assign
id|BA0_FPDR0
suffix:semicolon
r_break
...
singleline_comment|//
singleline_comment|// first read the hardware to initialize the member variables
singleline_comment|//
id|p-&gt;u32FCRnValue
op_assign
id|readl
...
(brace
multiline_comment|/*&n;* initialize all the addresses of this pipeline dma info.&n;*/
r_switch
c_cond
(paren
id|p-&gt;number
...
singleline_comment|//
singleline_comment|// Initialize the dma values for this pipeline
singleline_comment|//
id|p-&gt;u32DBAnValue
op_assign
id|readl
...
suffix:semicolon
multiline_comment|/*&n;&t;* currently only  2 pipelines are used&n;&t;* so, only set the valid bit on the playback and capture.&n;&t;*/
r_if
c_cond
(paren
(paren
id|i
op_eq
id|CS4281_PLAYBACK_PIPELINE_NUMBER
)paren
op_logical_or
(paren
id|i
op_eq
id|CS4281_CAPTURE_PIPELINE_NUMBER
)paren
)paren
(brace
id|p-&gt;flags
...
id|s-&gt;pm.u32SSPM_BITS
op_assign
l_int|0x7e
suffix:semicolon
multiline_comment|/* rev c, use 0x7c for rev a or b */
)brace
macro_line|#endif
...
suffix:semicolon
multiline_comment|/* Convert phys to linear. */
id|s-&gt;pBA0
op_assign
id|ioremap_nocache
c_func
...
(paren
id|KERN_ERR
l_string|&quot;cs4281: BA0 I/O mapping failed. Skipping part.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_goto
...
(paren
id|KERN_ERR
l_string|&quot;cs4281: BA1 I/O mapping failed. Skipping part.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_goto
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_init_module()+ &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_init_module()- (%d)&bslash;n&quot;
comma
id|rtn
)paren
)paren
...
c_func
(paren
l_string|&quot;gw boynton, audio@crystal.cirrus.com&quot;
)paren
suffix:semicolon
...
suffix:semicolon
DECL|variable|cs4281_cleanup_module
id|module_exit
c_func
(paren
id|cs4281_cleanup_module

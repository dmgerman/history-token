...
DECL|variable|maestro_pci_driver
r_static
r_struct
id|pci_driver
...
id|volume
suffix:semicolon
multiline_comment|/* Figure out which volume control button was pushed,&n;&t;&t;   based on differences from the default register&n;&t;&t;   values. */
id|x
op_assign
id|inb
c_func
...
suffix:semicolon
multiline_comment|/* Deal with the button press in a hammer-handed&n;&t;&t;   manner by adjusting the master mixer volume. */
id|volume
op_assign
id|c-&gt;mix.mixer_state
(braket
l_int|0
)braket
op_amp
...
r_else
(brace
multiline_comment|/* vol_evt == MUTE_EVT */
r_if
c_cond
(paren
id|volume
...
suffix:semicolon
multiline_comment|/* Hardware volume control on */
id|w
op_or_assign
(paren
l_int|1
...
suffix:semicolon
multiline_comment|/* Debounce off: easier to push the HWV buttons. */
id|w
op_and_assign
op_complement
(paren
...
suffix:semicolon
multiline_comment|/* Hardware volume control interrupt off... for now. */
id|outw
c_func
(paren
id|w
...
multiline_comment|/* Turn on hardware volume control interrupt.&n;&t;   This has to come after we grab the IRQ above,&n;&t;   or a crash will result on installation if a button has been pressed,&n;&t;   because in that case we&squot;ll get an immediate interrupt. */
id|n
op_assign
id|inw
c_func
...
id|i
suffix:semicolon
multiline_comment|/* XXX maybe should force stop bob, but should be all &n;&t;&t;stopped by _release by now */
id|free_irq
c_func
(paren
id|card-&gt;irq
...
suffix:semicolon
multiline_comment|/* this will remove all card instances too */
...
suffix:semicolon
multiline_comment|/* XXX dunno about power management */
r_return
id|NOTIFY_OK
suffix:semicolon
)brace

...
suffix:semicolon
multiline_comment|/* Includes extended register space */
...
DECL|macro|MD_4236
mdefine_line|#define MD_4236&t;&t;10 /* 4236 and higher */
DECL|macro|MD_42xB
mdefine_line|#define MD_42xB&t;&t;11 /* CS 42xB */
DECL|macro|MD_4239
mdefine_line|#define MD_4239&t;&t;12 /* CS4239 */
...
op_assign
(brace
multiline_comment|/* &n;&t;&t;   Values for the newer chips&n;&t;&t;   Some of the register initialization values were changed. In&n;&t;&t;   order to get rid of the click that preceded PCM playback,&n;&t;&t;   calibration was disabled on the 10th byte. On that same byte,&n;&t;&t;   dual DMA was enabled; on the 11th byte, ADC dithering was&n;&t;&t;   enabled, since that is theoretically desirable; on the 13th&n;&t;&t;   byte, Mode 3 was selected, to enable access to extended&n;&t;&t;   registers.&n;&t;&t; */
l_int|0xa8
comma
l_int|0xa8
comma
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Select initialisation data&n;&t; */
id|init_values
op_assign
id|init_values_a
suffix:semicolon
...
l_int|3
suffix:colon
multiline_comment|/* CS4236/CS4235/CS42xB/CS4239 */
(brace
r_int
id|xid
suffix:semicolon
...
l_int|0x08
suffix:colon
multiline_comment|/* Seems to be a 4238 ?? */
id|devc-&gt;chip_name
op_assign
l_string|&quot;CS4238&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;Chip ident is %X.&bslash;n&quot;
comma
id|xid
op_amp
l_int|0x1F
...
suffix:semicolon
multiline_comment|/* Thinkpad is a bit more of PITA than normal. The BIOS tends to&n;&t;   restore it in a different config to the one we use.  Need to&n;&t;   fix this somehow */
...
id|dma2
suffix:semicolon
multiline_comment|/* index into isapnp table */
DECL|member|type
r_int
id|type
suffix:semicolon
...
comma
(brace
l_string|&quot;Advanced Gravis InterWave Audio&quot;
comma
id|ISAPNP_VENDOR
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;ad1848: %s %s config failed (out of resources?)[%d]&bslash;n&quot;
comma
id|devname
comma
id|resname
...
DECL|function|ad1848_isapnp_init
r_static
r_int
id|__init
id|ad1848_isapnp_init
c_func
(paren
r_struct
id|address_info
...
(paren
id|KERN_NOTICE
l_string|&quot;ad1848: ISAPnP reports &squot;%s&squot; at i/o %#x, irq %d, dma %d, %d&bslash;n&quot;
comma
id|busname
comma
id|hw_config-&gt;io_base
...
DECL|function|ad1848_isapnp_probe
r_static
r_int
id|__init
id|ad1848_isapnp_probe
c_func
(paren
r_struct
id|address_info
...
(paren
id|KERN_ERR
l_string|&quot;ad1848: Valid range for isapnpjump is 0-%d. Adjusted to %d.&bslash;n&quot;
comma
id|i
comma
id|isapnpjump
...
(paren
id|KERN_NOTICE
l_string|&quot;ad1848: No ISAPnP cards found, trying standard ones...&bslash;n&quot;
)paren
suffix:semicolon
id|isapnp
op_assign

...
id|cnt
suffix:semicolon
singleline_comment|// spin_unlock_irqrestore(&amp;state-&gt;unit-&gt;reg_lock, flags);
id|count
op_sub_assign
id|cnt
suffix:semicolon
...
id|cnt
suffix:semicolon
singleline_comment|// spin_lock_irqsave(&amp;state-&gt;unit-&gt;reg_lock, flags);
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
singleline_comment|// if (file-&gt;f_mode &amp; FMODE_READ)
singleline_comment|// &t;poll_wait(file, &amp;dmabuf-&gt;wait, wait);
id|spin_lock_irqsave
c_func
(paren
op_amp
...
l_int|0
suffix:semicolon
macro_line|#if 0 /* XXX Was dummy implementation anyways. Make sense of this. */
r_case
...
suffix:semicolon
macro_line|#if 0 /* not implememnted, yet? */
r_case
...
id|dmabuf-&gt;hwptr
suffix:semicolon
multiline_comment|/* XXX fishy - breaks invariant  count=hwptr-swptr */
r_if
c_cond
(paren
id|dmabuf-&gt;mapped
...
id|dmabuf-&gt;hwptr
suffix:semicolon
multiline_comment|/* XXX fishy - breaks invariant  count=swptr-hwptr */
r_if
c_cond
(paren
id|dmabuf-&gt;mapped
...
id|EINVAL
suffix:semicolon
macro_line|#if 0 /* XXX implement when an app found that uses it. */
r_case
...
id|out_disable_dsp
suffix:semicolon
multiline_comment|/* ymfpci_proc_init(unit, codec); */
r_if
c_cond
(paren
id|request_irq
...
l_int|1
suffix:semicolon
multiline_comment|/* XXX Make it ours. */
r_if
c_cond
(paren
id|codec-&gt;iomidi

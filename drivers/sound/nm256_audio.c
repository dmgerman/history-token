...
l_int|1
suffix:semicolon
multiline_comment|/* should not come here ... */
)brace
r_static
r_void
id|__devinit
DECL|function|nm256_remove
id|nm256_remove
c_func
(paren
r_struct
...
(paren
id|KERN_INFO
l_string|&quot;NeoMagic 256AV/256ZX audio driver, version 1.1p&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|pci_module_init

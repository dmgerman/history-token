...
suffix:semicolon
multiline_comment|/* Add by Matt Wu 01-05-2001 for spdif in */
...
suffix:semicolon
singleline_comment|//&t;&t;printk(&quot;trident: diff=%d count= %d/%d total=%d tmo=%d hwptr=%d swptr=%d curptr=%d&bslash;n&quot;,diff,dmabuf-&gt;count,dmabuf-&gt;dmasize,dmabuf-&gt;total_bytes,tmo,dmabuf-&gt;hwptr,dmabuf-&gt;swptr,trident_get_dma_addr(state));
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;Err: Record is working on the card!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
singleline_comment|//&t;&t;printk(&quot;codec 2 ready flag= %lx&bslash;n&quot;, ready_2nd);
r_break
suffix:semicolon
r_case
id|PCI_DEVICE_ID_SI_7018
...
l_string|&quot; %dbit PCI busmaster DMA&bslash;n&quot;
comma
id|bits
)paren
suffix:semicolon

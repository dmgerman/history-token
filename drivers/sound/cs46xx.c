...
DECL|macro|CS_PM
mdefine_line|#define CS_PM&t;&t;0x00004000&t;&t;/* PM */
DECL|macro|CS_TMP
...
mdefine_line|#define CS46XX_MINOR_VERSION &quot;28&quot;
...
macro_line|#else
DECL|macro|CS46XX_ARCH
mdefine_line|#define CS46XX_ARCH&t;     &t;&quot;32&quot;&t;
singleline_comment|//architecture key
macro_line|#endif
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;* check for order within limits, but do not overwrite value.&n;*/
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: alloc_dmabuf(): unable to allocate rawbuf&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
singleline_comment|// remap_page_range() in cs46xx_mmap doesn&squot;t work.
...
c_func
(paren
l_string|&quot;cs46xx: alloc_dmabuf(): allocated %ld (order = %d) bytes at %p&bslash;n&quot;
comma
id|PAGE_SIZE
op_lshift
id|order
...
suffix:semicolon
multiline_comment|/*&n;*  only allocate the conversion buffer for the ADC&n;*/
r_if
c_cond
(paren
id|dmabuf-&gt;type
...
c_func
(paren
l_string|&quot;cs46xx: allocated %ld (order = %d) bytes at %p&bslash;n&quot;
comma
id|PAGE_SIZE
op_lshift
id|order
...
c_func
(paren
l_string|&quot;cs46xx: prog_dmabuf(): CAPTURE rate=%d fmt=0x%x numfrag=%d &quot;
...
c_func
(paren
l_string|&quot;cs46xx: prog_dmabuf(): PLAYBACK rate=%d fmt=0x%x numfrag=%d &quot;
l_string|&quot;fragsize=%d dmasize=%d&bslash;n&quot;
comma
id|dmabuf-&gt;rate
comma
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: drain_dac, dma timeout? %d&bslash;n&quot;
comma
id|count
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_midi_open(): Error - unable to find card struct&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: cs_copy_to_user()- fault dest=0x%x src=0x%x cnt=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_copy_to_user()- copied bytes is %d &bslash;n&quot;
comma
id|cnt
)paren
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;* Start the loop to read from the user&squot;s buffer and write to the dma buffer.&n;* check for PM events and underrun/overrun in the loop.&n;*/
r_while
c_loop
(paren
id|count
...
c_func
(paren
l_string|&quot;cs46xx: cs_poll()- (0x%x) &bslash;n&quot;
comma
id|mask
)paren
)paren
...
r_else
(brace
multiline_comment|/*&n;&t;* sometimes on a resume the bit is set, so always reset the bit.&n;&t;*/
id|CS_DBGOUT
c_func
(paren
id|CS_PARMS
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_open(): Error - unable to find audio card struct&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup of ADC failed (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup of DAC failed (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_release_mixdev() powerdown DAC failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_release_mixdev() powerdown ADC failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
c_func
(paren
l_string|&quot;u32AC97_powerdown: 0x%x _general_purpose 0x%x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;u32AC97_master_volume: 0x%x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;u32AC97_headphone_volume: 0x%x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;u32AC97_master_volume_mono: 0x%x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;u32AC97_pcm_out_volume: 0x%x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;dmabuf_swptr_play: 0x%x dmabuf_count_play: %d&bslash;n&quot;
comma
id|s-&gt;pm.dmabuf_swptr_play
comma
id|s-&gt;pm.dmabuf_count_play
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
c_func
(paren
l_string|&quot;dmabuf_swptr_capture: 0x%x dmabuf_count_capture: %d&bslash;n&quot;
comma
id|s-&gt;pm.dmabuf_swptr_capture
comma
id|s-&gt;pm.dmabuf_count_capture
)paren
)paren
suffix:semicolon
)brace
...
id|Count
op_le
id|CS46XX_AC97_HIGHESTREGTORESTORE
)paren
op_logical_and
(paren
id|i
...
multiline_comment|/*&n;* Save the ac97 volume registers as well as the current powerdown state.&n;* Now, mute the all the outputs (master, headphone, and mono), as well&n;* as the PCM volume, in preparation for powering down the entire part.&n;&t;card-&gt;pm.u32AC97_master_volume = (u32)cs_ac97_get( dev, &n;&t;&t;&t;(u8)BA0_AC97_MASTER_VOLUME); &n;&t;card-&gt;pm.u32AC97_headphone_volume = (u32)cs_ac97_get(dev, &n;&t;&t;&t;(u8)BA0_AC97_HEADPHONE_VOLUME); &n;&t;card-&gt;pm.u32AC97_master_volume_mono = (u32)cs_ac97_get(dev, &n;&t;&t;&t;(u8)BA0_AC97_MASTER_VOLUME_MONO); &n;&t;card-&gt;pm.u32AC97_pcm_out_volume = (u32)cs_ac97_get(dev, &n;&t;&t;&t;(u8)BA0_AC97_PCM_OUT_VOLUME);&n;*/
multiline_comment|/*&n;* mute the outputs&n;*/
id|cs_ac97_set
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/*&n;* save the registers that cause pops&n;*/
id|card-&gt;pm.u32AC97_powerdown
op_assign
(paren
id|u32
)paren
...
suffix:semicolon
id|card-&gt;pm.u32AC97_general_purpose
op_assign
(paren
id|u32
)paren
...
suffix:semicolon
multiline_comment|/*&n;* And power down everything on the AC97 codec.&n;* well, for now, only power down the DAC/ADC and MIXER VREFON components. &n;* trouble with removing VREF.&n;*/
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_ac97_suspend() failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
suffix:semicolon
multiline_comment|/*&n;* First, we restore the state of the general purpose register.  This&n;* contains the mic select (mic1 or mic2) and if we restore this after&n;* we restore the mic volume/boost state and mic2 was selected at&n;* suspend time, we will end up with a brief period of time where mic1&n;* is selected with the volume/boost settings for mic2, causing&n;* acoustic feedback.  So we restore the general purpose register&n;* first, thereby getting the correct mic selected before we restore&n;* the mic volume/boost.&n;*/
id|cs_ac97_set
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/*&n;* Now, while the outputs are still muted, restore the state of power&n;* on the AC97 part.&n;*/
id|cs_ac97_set
c_func
(paren
id|dev
...
multiline_comment|/* Check if we have to init the amplifier */
r_if
c_cond
(paren
id|card-&gt;amp_init
...
DECL|function|cs46xx_restart_part
r_static
r_int
id|cs46xx_restart_part
c_func
(paren
r_struct
id|cs_card
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_restart_part()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_restart_part()- (-1) prog_dmabuf() dac error&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_restart_part()- (-1) prog_dmabuf() adc error&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
op_complement
(paren
id|CS46XX_PM_SUSPENDING
op_or
id|CS46XX_PM_SUSPENDED
op_or
id|CS46XX_PM_RESUMING
op_or
id|CS46XX_PM_RESUMED
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_suspend() unable to suspend, not IDLE&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
id|card-&gt;pm.dmabuf_swptr_capture
op_assign
id|card-&gt;states
(braket
l_int|0
...
id|dmabuf.swptr
suffix:semicolon
id|card-&gt;pm.dmabuf_count_capture
op_assign
id|card-&gt;states
(braket
l_int|0
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Power down the DAC and ADC.  For now leave the other areas on.&n;&t; */
id|cs_ac97_set
c_func
(paren
id|card-&gt;ac97_codec
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_resume() unable to resume, not SUSPENDED&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_resume()- ERROR in cs_hardware_init()&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|mdelay
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_resume()- cs_hardware_init() failed, retried %d times.&bslash;n&quot;
comma
id|i
)paren
)paren
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_resume(): cs46xx_restart_part() returned error&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: AC&squot;97 read problem (ACCTL_DCV), reg = 0x%x returning 0xffff&bslash;n&quot;
comma
id|reg
)paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: AC&squot;97 read problem (ACSTS_VSTS), reg = 0x%x val=0x%x 0xffff &bslash;n&quot;
comma
id|reg
comma
id|tmp
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_get() reg = 0x%x, val = 0x%x, BA0_ACCAD = 0x%x&bslash;n&quot;
comma
id|reg
comma
id|cs461x_peekBA0
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: AC&squot;97 write problem, reg = 0x%x, val = 0x%x&bslash;n&quot;
comma
id|reg
comma
id|val
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_open_mixdev()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|list_for_each
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_open_mixdev()- -ENODEV&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_open_mixdev() powerup failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_open_mixdev()- 0&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_release_mixdev() powerdown MIXVON failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: mixer_ioctl(): ERROR unknown debug cmd&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_init()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_for
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_init()- codec number %d not found&bslash;n&quot;
comma
id|num_ac97
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_init() found codec %d&bslash;n&quot;
comma
id|num_ac97
)paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: codec %d not present&bslash;n&quot;
comma
id|num_ac97
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: couldn&squot;t register mixer!&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_init()- %d&bslash;n&quot;
comma
(paren
r_int
r_int
...
DECL|function|cs461x_powerdown
r_static
r_int
id|cs461x_powerdown
c_func
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()+ type=0x%x&bslash;n&quot;
comma
id|type
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown() DISABLED exiting&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown() powerdown reg=0x%x&bslash;n&quot;
comma
id|tmp
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;* if powering down only the VREF, and not powering down the DAC/ADC,&n;* then do not power down the VREF, UNLESS both the DAC and ADC are not&n;* currently powered down.  If powering down DAC and ADC, then&n;* it is possible to power down the VREF (ON).&n;*/
r_if
c_cond
(paren
(paren
...
id|tmp
op_amp
id|CS_AC97_POWER_CONTROL_ADC_ON
)paren
op_logical_or
(paren
id|tmp
op_amp
id|CS_AC97_POWER_CONTROL_DAC_ON
)paren
)paren
)paren
(brace
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()- 0  unable to powerdown. tmp=0x%x&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()+ MIXVOFF&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *  Power down the MIXER (VREF ON) on the AC97 card.  &n;&t;&t; */
id|tmp
op_assign
id|cs_ac97_get
c_func
...
id|tmp
op_amp
id|CS_AC97_POWER_CONTROL_MIXVOFF_ON
)paren
(brace
r_if
c_cond
...
id|tmp
op_or_assign
id|CS_AC97_POWER_CONTROL_MIXVOFF
suffix:semicolon
id|cs_ac97_set
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *  Now, we wait until we sample a ready state.&n;&t;&t;&t; */
r_for
c_loop
(paren
id|count
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; *  First, lets wait a short while to let things settle out a&n;&t;&t;&t;&t; *  bit, and to prevent retrying the read too quickly.&n;&t;&t;&t;&t; */
id|udelay
c_func
(paren
l_int|500
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; *  Read the current state of the power control register.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t;&t;&t; *  Check the status..&n;&t;&t;&t; */
r_if
c_cond
(paren
id|cs_ac97_get
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerdown MIXVOFF failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()+ MIXVON&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *  Power down the MIXER (VREF ON) on the AC97 card.  &n;&t;&t; */
...
id|tmp
op_amp
id|CS_AC97_POWER_CONTROL_MIXVON_ON
)paren
(brace
r_if
c_cond
...
id|tmp
op_or_assign
id|CS_AC97_POWER_CONTROL_MIXVON
suffix:semicolon
id|cs_ac97_set
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerdown MIXVON failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
multiline_comment|/*&n;&t;&t; *  Power down the ADC on the AC97 card.  &n;&t;&t; */
id|CS_DBGOUT
c_func
(paren
id|CS_FUNCTION
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()+ ADC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|tmp
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerdown ADC failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
multiline_comment|/*&n;&t;&t; *  Power down the DAC on the AC97 card.  &n;&t;&t; */
id|CS_DBGOUT
c_func
(paren
id|CS_FUNCTION
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()+ DAC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|tmp
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerdown DAC failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown()- 0 tmp=0x%x&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()+ type=0x%x&bslash;n&quot;
comma
id|type
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;* check for VREF and powerup if need to.&n;&t;*/
r_if
c_cond
(paren
id|type
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()+ MIXVOFF&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *  Power up the MIXER (VREF ON) on the AC97 card.  &n;&t;&t; */
id|tmp
op_assign
id|cs_ac97_get
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerup MIXVOFF failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()+ MIXVON&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *  Power up the MIXER (VREF ON) on the AC97 card.  &n;&t;&t; */
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerup MIXVON failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
multiline_comment|/*&n;&t;&t; *  Power up the ADC on the AC97 card.  &n;&t;&t; */
id|CS_DBGOUT
c_func
(paren
id|CS_FUNCTION
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()+ ADC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|tmp
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerup ADC failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(brace
multiline_comment|/*&n;&t;&t; *  Power up the DAC on the AC97 card.  &n;&t;&t; */
id|CS_DBGOUT
c_func
(paren
id|CS_FUNCTION
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()+ DAC&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|tmp
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: powerup DAC failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_powerup()- 0 tmp=0x%x&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: SPCR_RUNFR never reset&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_hardware_init()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;* The part seems to not be ready for a while after a resume.&n;&t;* so, if we are resuming, then wait for 700 mils.  Note that 600 mils&n;&t;* is not enough for some platforms! tested on an IBM Thinkpads and &n;&t;* reference cards.&n;&t;*/
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;* If we are resuming under 2.2.x then we can not schedule a timeout.&n;* so, just spin the CPU.&n;*/
r_if
c_cond
(paren
id|card-&gt;pm.flags
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: create - never read card ready from AC&squot;97&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: probably not a bug, try using the CS4232 driver,&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|CS_DBGOUT
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: or turn off any automatic Power Management support in the BIOS.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
r_do
(brace
multiline_comment|/*&n;&t;&t;&t; *  Read the input slot valid register and see if input slots 3 and&n;&t;&t;&t; *  4 are valid yet.&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;cs46xx: create - never read ISV3 &amp; ISV4 from AC&squot;97&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_ac97_init() failure&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
multiline_comment|/*&n;&t; *  If IDLE then Power down the part.  We will power components up &n;&t; *  when we need them.  &n;&t; */
r_if
c_cond
(paren
id|card-&gt;pm.flags
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs461x_powerdown() failure (0x%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs_hardware_init()- 0&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;Alan Cox &lt;alan@redhat.com&gt;, Jaroslav Kysela, &lt;pcaudio@crystal.cirrus.com&gt;&quot;
)paren
suffix:semicolon
...
op_assign
id|KERN_INFO
l_string|&quot;Crystal 4280/46xx + AC97 Audio, version &quot;
id|CS46XX_MAJOR_VERSION
l_string|&quot;.&quot;
id|CS46XX_MINOR_VERSION
l_string|&quot;.&quot;
id|CS46XX_ARCH
l_string|&quot;, &quot;
id|__TIME__
...
op_assign
id|KERN_INFO
l_string|&quot;cs46xx: Found %d audio device(s).&bslash;n&quot;
suffix:semicolon
DECL|function|cs46xx_probe
r_static
r_int
id|__devinit
id|cs46xx_probe
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: probe()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dma_mask
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: probe()- Memory region not assigned&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: probe() IRQ not assigned&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: probe() architecture does not support 32bit PCI busmaster DMA&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: out of memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: Card found at 0x%08lx and 0x%08lx, IRQ %d&bslash;n&quot;
comma
id|card-&gt;ba0_addr
comma
id|card-&gt;ba1_addr
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: Unknown card (%04X:%04X) at 0x%08lx/0x%08lx, IRQ %d&bslash;n&quot;
comma
id|ss_vendor
comma
id|ss_card
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: %s (%04X:%04X) at 0x%08lx/0x%08lx, IRQ %d&bslash;n&quot;
comma
id|cp-&gt;name
comma
id|ss_vendor
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: Crystal EAPD support forced on.&bslash;n&quot;
)paren
suffix:semicolon
id|card-&gt;amplifier_ctrl
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: Activating CLKRUN hack for Thinkpad.&bslash;n&quot;
)paren
suffix:semicolon
id|card-&gt;active_ctrl
op_assign
...
multiline_comment|/*&n;* The thinkpads don&squot;t work well without runtime updating on their kernel &n;* delay values (or any laptop with variable CPU speeds really).&n;* so, just to be safe set the init delay to 2100.  Eliminates&n;* failures on T21 Thinkpads.  remove this code when the udelay&n;* and mdelay kernel code is replaced by a pm timer, or the delays&n;* work well for battery and/or AC power both.&n;*/
r_if
c_cond
(paren
id|card-&gt;active_ctrl
...
(brace
multiline_comment|/*&n;* for some currently unknown reason, powering down the DAC and ADC component&n;* blocks on thinkpads causes some funky behavior... distoorrrtion and ac97 &n;* codec access problems.  probably the serial clock becomes unsynced. &n;* added code to sync the chips back up, but only helped about 70% the time.&n;*/
id|cs_powerdown
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: unable to allocate irq %d&bslash;n&quot;
comma
id|card-&gt;irq
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: unable to register dsp&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|fail
...
(paren
id|KERN_ERR
l_string|&quot;cs46xx: unable to register midi&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|card-&gt;pm.flags
...
c_func
(paren
l_string|&quot;cs46xx: ERROR in cs_hardware_init()... retrying&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_for
...
c_func
(paren
l_string|&quot;cs46xx: cs46xx_probe()- cs_hardware_init() failed, retried %d times.&bslash;n&quot;
comma
id|i
)paren
)paren
...
suffix:semicolon
multiline_comment|/* &n;&t;* Check if we have to init the amplifier, but probably already done&n;&t;* since the CD logic in the ac97 init code will turn on the ext amp.&n;&t;*/
r_if
c_cond
(paren
id|cp-&gt;amp_init
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: probe()- device allocated successfully&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: probe()- no device allocated&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
singleline_comment|// probe_cs46xx
singleline_comment|// --------------------------------------------------------------------- 
DECL|function|cs46xx_remove
r_static
r_void
id|__devinit
id|cs46xx_remove
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_remove()+&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|card
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_remove()-: remove successful&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_init_module()+ &bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_init_module()- no pci bus found&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;cs46xx: Unable to detect valid cs46xx device&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_init_module()- (%d)&bslash;n&quot;
comma
id|rtn
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cleanup_cs46xx() finished&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
DECL|variable|cs46xx_init_module
id|module_init
c_func
(paren
id|cs46xx_init_module
...
suffix:semicolon
DECL|variable|cs46xx_cleanup_module
id|module_exit
c_func
(paren
id|cs46xx_cleanup_module
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: PM suspend request refused&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: PM resume request refused&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_suspend_tbl request&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|cs46xx_suspend
...
DECL|function|cs46xx_resume_tbl
r_static
r_int
id|cs46xx_resume_tbl
c_func
...
(paren
id|KERN_INFO
l_string|&quot;cs46xx: cs46xx_resume_tbl request&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|cs46xx_resume

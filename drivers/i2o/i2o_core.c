...
suffix:semicolon
singleline_comment|// Better to leak this for safety: kfree(status);
r_return
op_minus
id|ETIMEDOUT
suffix:semicolon
...
multiline_comment|/* &n; &t; * Provide three SGL-elements:&n; &t; * System table (SysTab), Private memory space declaration and &n; &t; * Private i/o space declaration  &n; &t; *&n; &t; * FIXME: provide these for controllers needing them&n; &t; */
id|msg
(braket
l_int|6
)braket

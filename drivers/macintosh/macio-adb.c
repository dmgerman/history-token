...
l_int|1000000
suffix:semicolon
multiline_comment|/* Hrm... we may want to not lock interrupts for so&n;&t; * long ... oh well, who uses that chip anyway ? :)&n;&t; * That function will be seldomly used during boot&n;&t; * on rare machines, so...&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp

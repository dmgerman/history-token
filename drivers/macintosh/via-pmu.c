...
multiline_comment|/* XXX It would be nice to have some way to ensure that&n;&t; * nobody is dirtying any new buffers while we wait. That&n;&t; * could be achieved using the refrigerator for processes&n;&t; * that swsusp uses&n;&t; */
id|sys_sync
c_func
(paren
)paren
...
multiline_comment|/* FIXME: This is a temporary set of callbacks to enable us&n; * to do suspend-to-disk.&n; */
macro_line|#ifdef CONFIG_PM
DECL|variable|pmu_sys_suspended
r_static
r_int
id|pmu_sys_suspended
op_assign
l_int|0
suffix:semicolon
DECL|function|pmu_sys_suspend
r_static
r_int
id|pmu_sys_suspend
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Suspend PMU event interrupts */
id|pmu_suspend
c_func
(paren
)paren
...
suffix:semicolon
multiline_comment|/* Resume PMU event interrupts */
id|pmu_resume
c_func
(paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;Failed registering PMU sys class&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Failed registering PMU sys device&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Failed registering PMU sys driver&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

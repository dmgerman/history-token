multiline_comment|/*&n; * Device driver for the via-pmu on Apple Powermacs.&n; *&n; * The VIA (versatile interface adapter) interfaces to the PMU,&n; * a 6805 microprocessor core whose primary function is to control&n; * battery charging and system power on the PowerBook 3400 and 2400.&n; * The PMU also controls the ADB (Apple Desktop Bus) which connects&n; * to the keyboard and mouse, as well as the non-volatile RAM&n; * and the RTC (real time clock) chip.&n; *&n; * Copyright (C) 1998 Paul Mackerras and Fabio Riccardi.&n; * Copyright (C) 2001 Benjamin Herrenschmidt&n; * &n; * todo: - Cleanup synchro between VIA interrupt and GPIO-based PMU&n; *         interrupt.&n; *&n; *&n; */
...
DECL|macro|NEW_OHARE_CODE
mdefine_line|#define NEW_OHARE_CODE
...
macro_line|#ifdef CONFIG_PMAC_PBOOK
multiline_comment|/* &n; * WARNING ! This code probably needs some debugging... -- BenH.&n; */
macro_line|#ifdef NEW_OHARE_CODE
r_static
r_void
id|__pmac
...
macro_line|#else /* NEW_OHARE_CODE */
r_static
r_void
id|__pmac
DECL|function|done_battery_state_ohare
...
macro_line|#endif /* NEW_OHARE_CODE */
r_static
r_void
id|__pmac
DECL|function|done_battery_state_comet
id|done_battery_state_comet
c_func
(paren
r_struct
id|adb_request
...
(brace
multiline_comment|/* battery exist */
r_int
id|vb
comma
id|i
...
l_int|100
suffix:semicolon
multiline_comment|/*  in charging vb = 1300&lt;-&gt;2130 */
r_if
c_cond
(paren
id|req-&gt;reply
...
(brace
multiline_comment|/* full charged */
id|charge
op_assign
id|max
suffix:semicolon

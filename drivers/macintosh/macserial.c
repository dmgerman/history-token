...
DECL|macro|MACSERIAL_VERSION
mdefine_line|#define MACSERIAL_VERSION&t;&quot;2.0&quot;
...
id|flags
suffix:semicolon
multiline_comment|/* delay is in ms */
id|save_flags
c_func
(paren
id|flags
...
DECL|function|fix_zero_bug_scc
r_static
r_void
id|fix_zero_bug_scc
c_func
...
c_func
(paren
l_string|&quot;ttyS%d: powering up hardware&bslash;n&quot;
comma
id|info-&gt;line
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ttyS%d: shutting down hardware&bslash;n&quot;
comma
id|info-&gt;line
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ttyS%d: shutting down modem&bslash;n&quot;
comma
id|info-&gt;line
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * Here we want to turn off the RTS line.  On Macintoshes,&n;&t;&t; * the external serial ports using a DIN-8 or DIN-9&n;&t;&t; * connector only have the DTR line (which is usually&n;&t;&t; * wired to both RTS and DTR on an external modem in&n;&t;&t; * the cable).  RTS doesn&squot;t go out to the serial port&n;&t;&t; * socket, it acts as an output enable for the transmit&n;&t;&t; * data line.  So in this case we don&squot;t drop RTS.&n;&t;&t; *&n;&t;&t; * Macs with internal modems generally do have both RTS&n;&t;&t; * and DTR wired to the modem, so in that case we do&n;&t;&t; * drop RTS.&n;&t;&t; */
r_if
c_cond
(paren
id|info-&gt;is_internal_modem
...
(brace
multiline_comment|/* Assert DTR line */
id|save_flags
c_func
(paren
id|flags
...
c_func
(paren
l_string|&quot;rs_open %s%d, count = %d, tty=%p&bslash;n&quot;
comma
id|tty-&gt;driver.name
comma
id|info-&gt;line
...
(paren
id|KERN_INFO
l_string|&quot;PowerMac Z8530 serial driver version &quot;
id|MACSERIAL_VERSION
l_string|&quot;&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
l_int|0
suffix:semicolon
multiline_comment|/* For now, we assume you either have a slot-names property&n;&t; * with &quot;Modem&quot; in it, or your channel is compatible with&n;&t; * &quot;cobalt&quot;. Might need additional fixups&n;&t; */
id|zss-&gt;is_internal_modem
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;macserial: i2c-modem detected, id: %d&bslash;n&quot;
comma
id|mid
ques
c_cond
...
(paren
id|KERN_INFO
l_string|&quot;macserial: serial modem detected&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(paren
op_amp
id|zss-&gt;powerup_timer
)paren
suffix:semicolon
id|zss-&gt;powerup_timer.function
op_assign
id|powerup_done
suffix:semicolon
id|zss-&gt;powerup_timer.data
op_assign
(paren
r_int
r_int
...
multiline_comment|/*&n; * /proc fs routines. TODO: Add status lines &amp; error stats&n; */
r_static
r_inline
r_int
...
DECL|function|macserial_read_proc
r_int
id|macserial_read_proc
c_func
(paren
r_char
op_star
...
suffix:semicolon
multiline_comment|/* XXX assume it&squot;s a powerbook if we have a via-pmu&n;&t; * &n;&t; * This is OK for core99 machines as well.&n;&t; */
id|is_powerbook
op_assign
id|find_devices
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Register the interrupt handler for each one&n;&t; * We also request the OF resources here as probe_sccs()&n;&t; * might be called too early for that&n;&t; */
id|save_flags
c_func
(paren
id|flags
...
(paren
id|KERN_ERR
l_string|&quot;macserial: can&squot;t request IO resource !&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;macserial: can&squot;t request TX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
id|zs_soft
(braket
...
(paren
id|KERN_ERR
l_string|&quot;macserial: can&squot;t request RX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
id|zs_soft
(braket
...
DECL|function|macserial_cleanup
r_void
...
suffix:semicolon
DECL|variable|macserial_cleanup
id|module_exit
c_func
(paren
id|macserial_cleanup

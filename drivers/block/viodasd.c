...
suffix:semicolon
DECL|variable|viodasd_max_disk
r_static
r_int
id|viodasd_max_disk
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * Note that probe_disk has side effects:&n;&t;&t; *  a) it updates the size of the disk&n;&t;&t; *  b) it updates viodasd_max_disk&n;&t;&t; *  c) it registers the disk if it has not done so already&n;&t;&t; */
id|probe_disk
c_func
(paren
op_amp
...
(paren
id|VIOD_KERN_INFO
l_string|&quot;Only examining the first %d of %d disks connected&bslash;n&quot;
comma
id|MAX_DISKNO
comma
id|viodasd_max_disk

...
DECL|function|__reschedule_timeout
r_static
r_void
id|__reschedule_timeout
c_func
(paren
r_int
id|drive
...
DECL|macro|INFBOUND
mdefine_line|#define INFBOUND(a,b) (a)=max_t(int, a, b)
DECL|macro|SUPBOUND
mdefine_line|#define SUPBOUND(a,b) (a)=min_t(int, a, b)

...
DECL|macro|ON_HASH
mdefine_line|#define ON_HASH(drq)&t;&t;(drq)-&gt;hash_valid_count
...
multiline_comment|/*&n;&t; * this should not typically happen, but if it does simply chain&n;&t; * the two requests. then they will be moved to the dispatch list&n;&t; * at the same time&n;&t; */
id|list_add
c_func
(paren
op_amp

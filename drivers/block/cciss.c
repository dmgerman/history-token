...
singleline_comment|//hba[ctlr]-&gt;gendisk.nr_real++;
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;cciss: Device busy for &quot;
...
suffix:semicolon
singleline_comment|// printk(&quot;invalidating( %d %d)&bslash;n&quot;, ctlr, minor);
...
suffix:semicolon
multiline_comment|/* so open will now fail */
id|h-&gt;sizes
(braket
id|minor
)braket
...
l_int|0
suffix:semicolon
multiline_comment|/* so it will no longer appear in /proc/partitions */
id|gdev-&gt;part
(braket
id|minor
)braket
...
(paren
id|KERN_WARNING
l_string|&quot;cciss: reading geometry failed, &quot;
l_string|&quot;volume does not support reading geometry&bslash;n&quot;
)paren
suffix:semicolon
id|hba
(braket
...
id|KERN_WARNING
l_string|&quot;cciss: reading geometry failed, &quot;
l_string|&quot;continuing with default geometry&bslash;n&quot;
)paren
suffix:semicolon
id|hba
(braket
...
id|CISS_INQUIRY
suffix:colon
multiline_comment|/* If the logical unit number is 0 then, this is going&n;&t;&t;&t;&t;to controller so It&squot;s a physical command&n;&t;&t;&t;&t;mode = 0 target = 0.&n;&t;&t;&t;&t;So we have nothing to write. &n;&t;&t;&t;&t;otherwise, if use_unit_num == 1, &n;&t;&t;&t;&t;mode = 1(volume set addressing) target = LUNID&n;&t;&t;&t;&t;otherwise, if use_unit_num == 2,&n;&t;&t;&t;&t;mode = 0(periph dev addr) target = scsi3addr &n;&t;&t;&t;*/
r_if
c_cond
(paren
id|use_unit_num
...
l_int|0
suffix:semicolon
singleline_comment|// phys dev addr 
)brace
...
id|BMIC_WRITE
suffix:semicolon
singleline_comment|// BMIC Passthru
id|c-&gt;Request.CDB
(braket
l_int|6
)braket
...
suffix:semicolon
multiline_comment|/* I am not prepared to deal with a 64 bit address value */
id|cfg_base_addr
op_and_assign
l_int|0xffff
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* find our tape drives, if any */
...
suffix:semicolon
multiline_comment|/* hook ourself into SCSI subsystem */
r_return
l_int|1
suffix:semicolon
)brace

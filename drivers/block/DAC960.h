...
suffix:semicolon
multiline_comment|/*&n;  dma_loaf is used by helper routines to divide a region of&n;  dma mapped memory into smaller pieces, where those pieces&n;  are not of uniform size.&n; */
DECL|struct|dma_loaf
r_struct
id|dma_loaf
(brace
...
suffix:semicolon
DECL|member|ScatterGatherListDMA
id|dma_addr_t
id|ScatterGatherListDMA
suffix:semicolon
...
suffix:semicolon
DECL|member|ShutdownMonitoringTimer
r_int
r_int
id|ShutdownMonitoringTimer
suffix:semicolon
...
suffix:semicolon
DECL|member|FirstCommandMailboxDMA
id|dma_addr_t
id|FirstCommandMailboxDMA
suffix:semicolon
...
suffix:semicolon
DECL|member|FirstStatusMailboxDMA
id|dma_addr_t
id|FirstStatusMailboxDMA
suffix:semicolon
...
id|MonitoringDCDB
suffix:semicolon
DECL|member|MonitoringDCDB_DMA
id|dma_addr_t
id|MonitoringDCDB_DMA
suffix:semicolon
DECL|member|Enquiry
id|DAC960_V1_Enquiry_T
id|Enquiry
...
id|RebuildProgress
suffix:semicolon
DECL|member|RebuildProgressDMA
id|dma_addr_t
id|RebuildProgressDMA
suffix:semicolon
...
suffix:semicolon
DECL|member|NewLogicalDriveInformationDMA
id|dma_addr_t
id|NewLogicalDriveInformationDMA
suffix:semicolon
id|DAC960_V1_BackgroundInitializationStatus_T
...
suffix:semicolon
DECL|member|BackgroundInitializationStatusDMA
id|dma_addr_t
id|BackgroundInitializationStatusDMA
suffix:semicolon
id|DAC960_V1_BackgroundInitializationStatus_T
...
id|NewDeviceState
suffix:semicolon
DECL|member|NewDeviceStateDMA
id|dma_addr_t
id|NewDeviceStateDMA
suffix:semicolon
id|DAC960_SCSI_Inquiry_T
...
suffix:semicolon
DECL|member|NewInquiryStandardData
id|DAC960_SCSI_Inquiry_T
op_star
id|NewInquiryStandardData
suffix:semicolon
DECL|member|NewInquiryStandardDataDMA
id|dma_addr_t
...
suffix:semicolon
DECL|member|NewInquiryUnitSerialNumber
id|DAC960_SCSI_Inquiry_UnitSerialNumber_T
op_star
id|NewInquiryUnitSerialNumber
suffix:semicolon
DECL|member|NewInquiryUnitSerialNumberDMA
id|dma_addr_t
...
id|NextStatusMailbox
suffix:semicolon
DECL|member|HealthStatusBufferDMA
id|dma_addr_t
id|HealthStatusBufferDMA
suffix:semicolon
DECL|member|HealthStatusBuffer
id|DAC960_V2_HealthStatusBuffer_T
op_star
...
suffix:semicolon
DECL|member|NewControllerInformationDMA
id|dma_addr_t
id|NewControllerInformationDMA
suffix:semicolon
id|DAC960_V2_LogicalDeviceInfo_T
...
suffix:semicolon
DECL|member|NewLogicalDeviceInformationDMA
id|dma_addr_t
id|NewLogicalDeviceInformationDMA
suffix:semicolon
id|DAC960_V2_PhysicalDeviceInfo_T
...
suffix:semicolon
DECL|member|NewPhysicalDeviceInformationDMA
id|dma_addr_t
id|NewPhysicalDeviceInformationDMA
suffix:semicolon
DECL|member|NewInquiryUnitSerialNumber
id|DAC960_SCSI_Inquiry_UnitSerialNumber_T
op_star
...
id|Event
suffix:semicolon
DECL|member|EventDMA
id|dma_addr_t
id|EventDMA
suffix:semicolon
DECL|member|PhysicalToLogicalDevice
id|DAC960_V2_PhysicalToLogicalDevice_T
op_star
id|PhysicalToLogicalDevice
suffix:semicolon
DECL|member|PhysicalToLogicalDeviceDMA
id|dma_addr_t
id|PhysicalToLogicalDeviceDMA
suffix:semicolon
id|DAC960_V2_PhysicalDevice_T
...
multiline_comment|/*&n; * dma_addr_writeql is provided to write dma_addr_t types&n; * to a 64-bit pci address space register.  The controller&n; * will accept having the register written as two 32-bit&n; * values.&n; *&n; * In HIGHMEM kernels, dma_addr_t is a 64-bit value.&n; * without HIGHMEM,  dma_addr_t is a 32-bit value.&n; *&n; * The compiler should always fix up the assignment&n; * to u.wq appropriately, depending upon the size of&n; * dma_addr_t.&n; */
r_static
r_inline
DECL|function|dma_addr_writeql
r_void
id|dma_addr_writeql
c_func
(paren
...
multiline_comment|/*&n;  DAC960_AcquireControllerLock acquires exclusive access to Controller.&n;&t;Reference the queue_lock through the controller structure,&n;&t;rather than through the request queue.  These macros are&n;        used to mutex on the controller structure during initialization,&n;&t;BEFORE the request queue is allocated and initialized in&n;&t;DAC960_RegisterBlockDevice().&n;*/
r_static
r_inline

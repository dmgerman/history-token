...
multiline_comment|/*&n; * This is the per-process anticipatory I/O scheduler state.  It is refcounted&n; * and kmalloc&squot;ed.&n; *&n; * There is no locking protecting the contents of this structure!  Pointers&n; * to a single as_io_context may appear in multiple queues at once.&n; */
...
DECL|member|aic_finished
r_int
id|aic_finished
suffix:semicolon
multiline_comment|/* IO associated with as_io_context finished */
DECL|member|nr_dispatched
r_int
id|nr_dispatched
suffix:semicolon
...
suffix:semicolon
DECL|function|put_as_io_context
r_static
r_void
id|put_as_io_context
c_func
(paren
r_struct
id|as_io_context
...
DECL|function|get_as_io_context
r_static
r_struct
id|as_io_context
op_star
id|get_as_io_context
c_func
(paren
r_void
)paren
...
r_static
r_void
DECL|function|copy_as_io_context
id|copy_as_io_context
c_func
(paren
r_struct
id|as_io_context
...
r_static
r_void
DECL|function|swap_as_io_context
id|swap_as_io_context
c_func
(paren
r_struct
id|as_io_context
...
suffix:semicolon
multiline_comment|/*&n; * Add the request to the rb tree if it is unique.  If there is an alias (an&n; * existing request against the same sector), which can happen when using&n; * direct IO, then move the alias to the dispatch list and then add the&n; * request.&n; */
...
suffix:semicolon
multiline_comment|/* This can be caused by direct IO */
r_while
c_loop
(paren
(paren
...
multiline_comment|/* fixed point factor is cancelled here */
id|aic-&gt;ttime_mean
op_assign
(paren
id|aic-&gt;ttime_total
...
id|rq-&gt;nr_sectors
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Don&squot;t allow the seek distance to get too large from the&n;&t;&t; * odd fragment, pagein, etc&n;&t;&t; */
r_if
c_cond
(paren
id|aic-&gt;seek_samples
...
(paren
op_amp
id|arq-&gt;as_io_context-&gt;nr_queued
)paren
)paren
suffix:semicolon
id|atomic_dec
...
(paren
op_amp
id|arq-&gt;as_io_context-&gt;nr_dispatched
)paren
suffix:semicolon
id|WARN_ON
c_func

...
suffix:semicolon
multiline_comment|/*&n; * spare queue&n; */
DECL|macro|CFQ_KEY_SPARE
mdefine_line|#define CFQ_KEY_SPARE&t;&t;(~0UL)
...
c_func
(paren
l_string|&quot;%s: got spare queue&bslash;n&quot;
comma
id|current-&gt;comm
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * if hashing type has changed, the cfq_queue might change here. we&n;&t; * don&squot;t bother rechecking -&gt;allocated since it should be a rare&n;&t; * event&n;&t; */
id|cic
op_assign
id|cfq_get_io_context
c_func
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * kill spare queue, getting it means we have two refences to it.&n;&t; * drop both&n;&t; */
id|spin_lock_irq
c_func
(paren
id|q-&gt;queue_lock
...
suffix:semicolon
multiline_comment|/*&n;&t; * setup spare failure queue&n;&t; */
id|cfqq
op_assign
id|cfq_get_queue
c_func
...
id|page
comma
l_string|&quot;Busy queues: %u&bslash;n&quot;
comma
id|cfqd-&gt;busy_queues
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;last sector: %Lu&bslash;n&quot;
comma
(paren
r_int
r_int
...
id|len
comma
l_string|&quot;max time in iosched: %lu&bslash;n&quot;
comma
id|max_elapsed_dispatch
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;max completion time: %lu&bslash;n&quot;
comma
id|max_elapsed_crq
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;Busy queue list:&bslash;n&quot;
)paren
suffix:semicolon
id|spin_lock_irq
c_func
...
id|len
comma
l_string|&quot;  cfqq: key=%lu alloc=%d/%d, &quot;
l_string|&quot;queued=%d/%d, last_fifo=%lu, service_used=%lu&bslash;n&quot;
comma
id|cfqq-&gt;key
comma
id|cfqq-&gt;allocated
...
id|len
comma
l_string|&quot;  busy queues total: %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;Empty queue list:&bslash;n&quot;
)paren
suffix:semicolon
id|i
op_assign
...
id|len
comma
l_string|&quot;  empty queues total: %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;Total queues: %d&bslash;n&quot;
comma
id|queues
)paren
suffix:semicolon

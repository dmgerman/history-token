...
mdefine_line|#define CARTRCH_STAT(aip,buf)&t;&t;&t;&t;&t;&t;&bslash;&n;&t;(aip-&gt;old_atari_disk ?&t;&t;&t;&t;&t;&t;&bslash;&n;&t; (((buf)[0] &amp; 0x7f) == 0x28) :&t;&t;&t;&t;&t;&bslash;&n;&t; ((((buf)[0] &amp; 0x70) == 0x70) ?&t;&t;&t;&t;&t;&bslash;&n;&t;  (((buf)[2] &amp; 0x0f) == 0x06) :&t;&t;&t;&t;&t;&bslash;&n;&t;  (((buf)[0] &amp; 0x0f) == 0x06)))&t;&t;&t;&t;&t;&bslash;&n;
...
c_func
(paren
l_string|&quot;%s: attempted access for blocks %d...%ld past end of device at block %ld.&bslash;n&quot;
comma
id|disk-&gt;disk_name
comma
id|block
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: request denied because cartridge has &quot;
...
(paren
id|KERN_ERR
l_string|&quot;%s: REQUEST SENSE failed in test for &quot;
...
(paren
id|KERN_ERR
l_string|&quot;%s: Test for medium changed timed out; &quot;

...
multiline_comment|/*&n; * A second ought to be enough for a 32K transfer (UB_MAX_SECTORS)&n; * even if a webcam hogs the bus (famous last words).&n; * Some CDs need a second to spin up though.&n; */

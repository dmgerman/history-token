...
id|lo
op_assign
id|rbh-&gt;bi_bdev-&gt;bd_disk-&gt;private_data
suffix:semicolon
r_if
c_cond
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * iterate iovec list and alloc pages&n;&t; */
...
multiline_comment|/*&n;&t; * When called on the page reclaim -&gt; writepage path, this code can&n;&t; * trivially consume all memory.  So we drop PF_MEMALLOC to avoid&n;&t; * stealing all the page reserves and throttle to the writeout rate.&n;&t; * pdflush will have been woken by page reclaim.  Let it do its work.&n;&t; */
r_do
(brace
r_int
id|flags
...
DECL|function|loop_transfer_bio
r_static
r_int
id|loop_transfer_bio
c_func
(paren
r_struct
id|loop_device
...
id|lo
suffix:semicolon
multiline_comment|/*&n;&t; * we remap to a block device, make sure we correctly stack limits&n;&t; */
r_if
c_cond
(paren
id|S_ISBLK

...
id|epatc8
comma
l_string|&quot;support for the Shuttle EP1284 chip, &quot;
l_string|&quot;used in any recent Imation SuperDisk (LS-120) drive.&quot;
)paren
suffix:semicolon

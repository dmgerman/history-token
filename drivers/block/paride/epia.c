multiline_comment|/* &n;        epia.c    (c) 1997-8  Grant R. Guenther &lt;grant@torque.net&gt;&n;                              Under the terms of the GNU General Public License.&n;&n;        epia.c is a low-level protocol driver for Shuttle Technologies &n;&t;EPIA parallel to IDE adapter chip.  This device is now obsolete&n;&t;and has been replaced with the EPAT chip, which is supported&n;&t;by epat.c, however, some devices based on EPIA are still&n;&t;available.&n;&n;*/

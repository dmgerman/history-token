...
suffix:semicolon
multiline_comment|/* bits in tape-&gt;flags */
DECL|macro|PT_MEDIA
...
id|available
suffix:semicolon
multiline_comment|/* 1 if access is available 0 otherwise */
DECL|member|bs
r_int
id|bs
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* sysfs class support */
DECL|variable|pt_class
r_static
r_struct
id|class_simple
op_star

...
l_int|0
suffix:semicolon
multiline_comment|/**&n; * blk_get_queue: - return the queue that matches the given device&n; * @dev:    device&n; *&n; * Description:&n; *     Given a specific device, return the queue that will hold I/O&n; *     for it. This is either a &amp;struct blk_dev_struct lookup and a&n; *     call to the -&gt;queue() function defined, or the default queue&n; *     stored in the same location.&n; *&n; **/
...
multiline_comment|/**&n; * blk_queue_max_segments - set max segments for a request for this queue&n; * @q:  the request queue for the device&n; * @max_segments:  max number of segments&n; *&n; * Description:&n; *    Enables a low level driver to set an upper limit on the number of&n; *    data segments in a request&n; **/
DECL|function|blk_queue_max_segments
r_void
...
DECL|function|blk_contig_segment
r_inline
r_int
...
multiline_comment|/*&n; * map a request to scatterlist, return number of sg entries setup. Caller&n; * must make sure sg can hold rq-&gt;nr_segments entries&n; */
...
c_func
(paren
l_string|&quot;map: %d &gt;= %d, i %d, segs %d, size %ld&bslash;n&quot;
comma
id|nsegs
comma
id|q-&gt;max_segments
...
suffix:semicolon
multiline_comment|/*&n;&t; * debug stuff...&n;&t; */
r_if
c_cond
(paren
id|insert_here
...
suffix:semicolon
multiline_comment|/*&n;&t; * not a rw command&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * don&squot;t touch NOMERGE rq, or one that has been started by driver&n;&t; */
r_if
c_cond
(paren
id|next-&gt;flags
...
multiline_comment|/*&n;&t; * fill up the request-info, and add it to the queue&n;&t; */
...
suffix:semicolon
multiline_comment|/* whole disk device */
...
(brace
multiline_comment|/* This may well happen - the kernel calls&n;&t;&t;&t;&t; * bread() without checking the size of the&n;&t;&t;&t;&t; * device, e.g., when mounting a device. */
id|printk
c_func
(paren
id|KERN_INFO
...
multiline_comment|/*&n;&t;&t; * this needs to be handled by q-&gt;make_request_fn, to just&n;&t;&t; * setup a part of the bio in the request to enable easy&n;&t;&t; * multiple passing&n;&t;&t; */
id|BUG_ON
c_func
(paren
id|bio_sectors
...
suffix:semicolon
macro_line|#endif
DECL|function|blk_recalc_request
r_inline
r_void
id|blk_recalc_request
c_func
(paren
r_struct
id|request
...
id|rq-&gt;current_nr_sectors
suffix:semicolon
multiline_comment|/*&n;&t; * if total number of sectors is less than the first segment&n;&t; * size, something has gone terribly wrong&n;&t; */
r_if
c_cond
(paren
id|rq-&gt;nr_sectors
...
suffix:semicolon
DECL|variable|blk_queue_max_segments
id|EXPORT_SYMBOL
c_func
(paren
id|blk_queue_max_segments

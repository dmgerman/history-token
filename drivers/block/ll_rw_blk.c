...
suffix:semicolon
multiline_comment|/*&n;&t; * local_plug_list is now a private copy we can traverse lockless&n;&t; */
...
multiline_comment|/*&n;&t; * add any remaining queue back to plug list&n;&t; */
r_if
c_cond
(paren
op_logical_neg

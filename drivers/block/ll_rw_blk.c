...
c_func
(paren
l_string|&quot;blk_queue_ordered: bad value %d&bslash;n&quot;
comma
id|flag
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n; * Cache flushing for ordered writes handling&n; */
DECL|function|blk_pre_flush_end_io
r_static
r_void
id|blk_pre_flush_end_io
c_func
(paren
r_struct
id|request
...
DECL|function|blk_post_flush_end_io
r_static
r_void
id|blk_post_flush_end_io
c_func
(paren
r_struct
id|request
...
suffix:semicolon
multiline_comment|/*&n;&t; * called from end_that_request_last(), so we know that the queue&n;&t; * lock is held&n;&t; */
id|spin_unlock
c_func
(paren
id|q-&gt;queue_lock
...
DECL|function|blk_start_pre_flush
r_struct
id|request
op_star
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * prepare_flush returns 0 if no flush is needed, just mark both&n;&t; * pre and post flush as done in that case&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t; * some drivers dequeue requests right away, some only after io&n;&t; * completion. make sure the request is dequeued.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|blk_start_post_flush
r_static
r_void
id|blk_start_post_flush
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|blk_check_end_barrier
r_static
r_inline
r_int
id|blk_check_end_barrier
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|__blk_complete_barrier_rq
r_static
r_int
id|__blk_complete_barrier_rq
c_func
(paren
id|request_queue_t
op_star
...
multiline_comment|/**&n; * blk_complete_barrier_rq - complete possible barrier request&n; * @q:  the request queue for the device&n; * @rq:  the request&n; * @sectors:  number of sectors to complete&n; *&n; * Description:&n; *   Used in driver end_io handling to determine whether to postpone&n; *   completion of a barrier request until a post flush has been done. This&n; *   is the unlocked variant, used if the caller doesn&squot;t already hold the&n; *   queue lock.&n; **/
DECL|function|blk_complete_barrier_rq
r_int
...
DECL|variable|blk_complete_barrier_rq
id|EXPORT_SYMBOL
c_func
(paren
id|blk_complete_barrier_rq
...
suffix:semicolon
multiline_comment|/**&n; * blk_complete_barrier_rq_locked - complete possible barrier request&n; * @q:  the request queue for the device&n; * @rq:  the request&n; * @sectors:  number of sectors to complete&n; *&n; * Description:&n; *   See blk_complete_barrier_rq(). This variant must be used if the caller&n; *   holds the queue lock.&n; **/
DECL|function|blk_complete_barrier_rq_locked
r_int
...
DECL|variable|blk_complete_barrier_rq_locked
id|EXPORT_SYMBOL
c_func
(paren
id|blk_complete_barrier_rq_locked
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * in the very unlikely event that allocation failed and no&n;&t;&t; * requests for this direction was pending, mark us starved&n;&t;&t; * so that freeing of a request in the other direction will&n;&t;&t; * notice us. another possible fix would be to split the&n;&t;&t; * rq mempool into READ and WRITE&n;&t;&t; */
id|rq_starved
suffix:colon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/**&n; * blk_end_sync_rq - executes a completion event on a request&n; * @rq: request to complete&n; */
DECL|function|blk_end_sync_rq
r_void
id|blk_end_sync_rq
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * complete last, if this is a stack request the process (and thus&n;&t; * the rq pointer) could be invalid right after this complete()&n;&t; */
id|complete
c_func
(paren
id|waiting
...
DECL|function|handle_bad_sector
r_static
r_void
id|handle_bad_sector
c_func
(paren
r_struct
id|bio
...
(brace
multiline_comment|/*&n;&t;&t;&t; * This may well happen - the kernel calls bread()&n;&t;&t;&t; * without checking the size of the device, e.g., when&n;&t;&t;&t; * mounting a device.&n;&t;&t;&t; */
id|handle_bad_sector
c_func
(paren
id|bio

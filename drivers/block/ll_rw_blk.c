...
multiline_comment|/**&n; * blk_set_readahead - set a queue&squot;s readahead tunable&n; * @dev:&t;device&n; * @sectors:&t;readahead, in 512 byte sectors&n; *&n; * Returns zero on success, else negative errno&n; */
DECL|function|blk_set_readahead
r_int
...
multiline_comment|/**&n; * blk_get_readahead - query a queue&squot;s readahead tunable&n; * @dev:&t;device&n; *&n; * Locates the passed device&squot;s request queue and returns its&n; * readahead setting.&n; *&n; * The returned value is in units of 512 byte sectors.&n; *&n; * Will return zero if the queue has never had its readahead&n; * setting altered.&n; */
DECL|function|blk_get_readahead
r_int

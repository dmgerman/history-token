...
DECL|function|DAC960_revalidate
r_static
r_int
id|DAC960_revalidate
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * We could save DmaDirection in the command structure&n;&t; * and just reuse that information here.&n;&t; */
r_if
c_cond
(paren
id|CommandType
...
suffix:semicolon
multiline_comment|/*&n;&t; * BlockCount is redundant with nr_sectors in the request&n;&t; * structure.  Consider eliminating BlockCount from the&n;&t; * command structure now that Command includes a pointer to&n;&t; * the request.&n;&t; */
r_while
c_loop
(paren
...
(brace
multiline_comment|/*&n;&t;   * Finish this later.&n;&t;   *&n;&t;   * We should call &quot;complete_that_request_first()&quot;&n;&t;   * to remove the first part of the request.  Then, if there&n;&t;   * is still more I/O to be done, resubmit the request.&n;&t;   *&n;&t;   * We want to recalculate scatter/gather list,&n;&t;   * and requeue the command.&n;&t;   *&n;&t;   * For now, print a message on the console, and clone&n;&t;   * the code for &quot;normal&quot; completion.&n;&t;   */
id|printk
c_func
(paren
l_string|&quot;V1_ProcessCompletedCommand: I/O error on read/write&bslash;n&quot;
)paren
suffix:semicolon
id|DAC960_ProcessCompletedRequest
c_func
...
(brace
multiline_comment|/*&n;&t; * We&squot;re not doing retry commands yet.&n;&t; */
id|printk
c_func
(paren
l_string|&quot;DAC960_ProcessCompletedCommand: RetryCommand not done yet&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(brace
multiline_comment|/*&n;&t;   * Don&squot;t know yet how to handle this case.  &n;&t;   * See comments in DAC960_V1_ProcessCompletedCommand()&n;&t;   *&n;&t;   * For now, print a message on the console, and clone&n;&t;   * the code for &quot;normal&quot; completion.&n;&t;   */
id|printk
c_func
(paren
l_string|&quot;V1_ProcessCompletedCommand: I/O error on read/write&bslash;n&quot;
...
c_func
(paren
l_string|&quot;DAC960_V2_ProcessCompletedCommand: retries not coded yet&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
suffix:semicolon
id|Inode-&gt;i_bdev-&gt;bd_invalidated
op_assign
l_int|1
suffix:semicolon
)brace

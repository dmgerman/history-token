...
mdefine_line|#define DAC960_DriverVersion&t;&t;&t;&quot;2.4.11&quot;
DECL|macro|DAC960_DriverDate
mdefine_line|#define DAC960_DriverDate&t;&t;&t;&quot;11 October 2001&quot;
...
id|V1.LastBackgroundInitializationStatus
)paren
suffix:semicolon
)brace
...
multiline_comment|/*&n;  DAC960_Notifier is the notifier for the DAC960 Driver.&n;*/
DECL|function|DAC960_Notifier
r_static
r_int
id|DAC960_Notifier
c_func
...
DECL|function|DAC960_PartitionByCommand
r_static
r_inline
r_int
id|DAC960_PartitionByCommand
c_func
(paren
id|DAC960_Command_T
op_star
...
c_func
(paren
l_string|&quot;  /dev/rd/c%dd%dp%d: relative blocks %u..%u&bslash;n&quot;
comma
id|Controller
comma
id|Controller-&gt;ControllerNumber
...
comma
id|Command-&gt;BufferHeader-&gt;bi_sector
comma
id|Command-&gt;BufferHeader-&gt;bi_sector
op_plus
id|Command-&gt;BlockCount
...
multiline_comment|/*&n;  DAC960_P_InterruptHandler handles hardware interrupts from DAC960 P Series&n;  Controllers.&n;*/
...
suffix:semicolon
multiline_comment|/* BROKEN, same as modular ide-floppy/ide-disk; same fix - -&gt;probe() */
id|register_disk
c_func
(paren
op_amp

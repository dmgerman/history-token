...
multiline_comment|/*&n; * 1999/01/19 -- N.Fujita &amp; Linux/98 Project -- Added code for NEC PC-9800&n; * series.&n; */
...
multiline_comment|/*&n; * 2002/10/12 -- Osamu Tomita &lt;tomita@cinet.co.jp&gt;&n; * split code from floppy.c&n; * support NEC PC-9800 only&n; */
...
multiline_comment|/*&n;#define PC9800_DEBUG_FLOPPY&n;#define PC9800_DEBUG_FLOPPY2&n;*/
...
DECL|macro|FD98_DATA
mdefine_line|#define FD98_DATA&t;(2 + FD_IOPORT )
DECL|macro|FD_MODE
mdefine_line|#define FD_MODE&t;&t;(4 + FD_IOPORT )
DECL|macro|FD_MODE_CHANGE
mdefine_line|#define FD_MODE_CHANGE&t;0xbe
DECL|macro|FD_EMODE_CHANGE
mdefine_line|#define FD_EMODE_CHANGE&t;0x4be
...
macro_line|#ifndef DEFAULT_FLOPPY_IRQ
DECL|macro|DEFAULT_FLOPPY_IRQ
macro_line|# define DEFAULT_FLOPPY_IRQ&t;11
macro_line|#endif
macro_line|#ifndef DEFAULT_FLOPPY_DMA
DECL|macro|DEFAULT_FLOPPY_DMA
macro_line|# define DEFAULT_FLOPPY_DMA&t;2
macro_line|#endif
...
l_int|2
suffix:semicolon
DECL|variable|auto_detect_mode
r_static
r_int
id|auto_detect_mode
op_assign
l_int|0
suffix:semicolon
DECL|variable|retry_auto_detect
r_static
r_int
id|retry_auto_detect
op_assign
l_int|0
suffix:semicolon
DECL|macro|FD_AFTER_RESET_DELAY
mdefine_line|#define FD_AFTER_RESET_DELAY 1000
...
suffix:semicolon
macro_line|#endif
DECL|macro|current_reqD
mdefine_line|#define current_reqD -1
...
macro_line|#ifndef CONFIG_PC9800_MOTOR_OFF /* tomita */
...
(paren
id|KERN_DEBUG
l_string|&quot;fdc%lu: turn off motor&bslash;n&quot;
comma
id|nr
)paren
suffix:semicolon
...
macro_line|#else /* CONFIG_PC9800_MOTOR_OFF */
multiline_comment|/* switches the motor off after a given timeout */
DECL|function|motor_off_callback
r_static
r_void
...
(paren
id|KERN_DEBUG
l_string|&quot;fdc%u: turn off motor&bslash;n&quot;
comma
(paren
r_int
r_int
...
comma
macro_line|#endif
macro_line|#if N_FDC &gt; 2
macro_line|# error &quot;N_FDC &gt; 2; please fix initializer for motor_off_timer[]&quot;
macro_line|#endif
)brace
suffix:semicolon
multiline_comment|/* schedules motor off */
...
macro_line|#endif /* CONFIG_PC9800_MOTOR_OFF */
...
macro_line|#ifdef PC9800_DEBUG_FLOPPY
DECL|macro|READY_DELAY
mdefine_line|#define READY_DELAY 10000000
macro_line|#else
DECL|macro|READY_DELAY
mdefine_line|#define READY_DELAY 100000
macro_line|#endif
...
DECL|function|auto_detect_mode_pc9800
r_static
r_int
id|auto_detect_mode_pc9800
c_func
(paren
r_void
)paren
...
c_func
(paren
l_string|&quot;auto_detect_mode_pc9800: retry_auto_detect=%d&bslash;n&quot;
comma
id|retry_auto_detect
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy error: MA: _floppy - floppy_type=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;floppy debug: floppy ejected (drive %d)&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;floppy debug: floppy inserted (drive %d)&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;floppy debug : unknown interrupt&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;floppy debug: reset interrupt&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
macro_line|#ifdef DEBUGT
...
c_func
(paren
l_string|&quot;floppy debug: reset_fdc&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|do_floppy
...
c_func
(paren
l_string|&quot;current_req=%p&bslash;n&quot;
comma
id|current_req
)paren
suffix:semicolon
...
DECL|function|access_mode_change_pc9800
r_static
r_void
id|access_mode_change_pc9800
c_func
...
l_int|1
suffix:semicolon
macro_line|#ifdef PC9800_DEBUG_FLOPPY2
id|printk
c_func
(paren
l_string|&quot;enter access_mode_change&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|access_mode
...
c_func
(paren
l_string|&quot;floppy debug: DP-&gt;cmos=%d&bslash;n&quot;
comma
id|DP-&gt;cmos
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy debug: mode_change_now=%d&bslash;n&quot;
comma
id|mode_change_now
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy debug: access_mode=%d&bslash;n&quot;
comma
id|access_mode
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy debug: old_mode=%d&bslash;n&quot;
comma
id|old_mode
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy debug: _floppy - &amp;floppy_type[0]=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
macro_line|#endif /* PC9800_DEBUG_FLOPPY2 */
r_if
c_cond
(paren
id|mode_change_now
...
c_func
(paren
l_string|&quot;floppy check: wait_til_done out:%d&bslash;n&quot;
comma
id|command_status
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;set_floppy: set floppy type=%d&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;current_req-&gt;nr_sectors=%ld&bslash;n&quot;
comma
id|current_req-&gt;nr_sectors
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;current_req-&gt;current_nr_sectors=%u&bslash;n&quot;
comma
...
id|current_req-&gt;rq_disk-&gt;private_data
)paren
suffix:semicolon
id|raw_cmd
op_assign
...
c_func
(paren
l_string|&quot;warning: usage count=0, current_req=%p exiting&bslash;n&quot;
comma
id|current_req
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy open: start&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
...
c_func
(paren
l_string|&quot;floppy open: drive=%d, current_drive=%d, UDP-&gt;cmos=%d&bslash;n&quot;
l_string|&quot;floppy open: FDCS={spec1=%d, spec2=%d, dtr=%d, version=%d, dor=%d, address=%lu}&bslash;n&quot;
comma
id|drive
comma
id|current_drive
...
c_func
(paren
l_string|&quot;floppy open: _floppy={size=%d, sect=%d, head=%d, track=%d, spec1=%d}&bslash;n&quot;
comma
id|_floppy-&gt;size
comma
id|_floppy-&gt;sect
...
c_func
(paren
l_string|&quot;floppy open: _floppy=NULL&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif /* PC9800_DEBUG_FLOPPY */
id|down
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;floppy open: floppy.c:%d passed&bslash;n&quot;
comma
id|__LINE__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;floppy open: end normally&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace
...
c_func
(paren
l_string|&quot;check_floppy_change: MINOR=%d&bslash;n&quot;
comma
id|minor
c_func
(paren
...
DECL|function|floppy_read_block_0
r_static
r_int
...
suffix:semicolon
DECL|macro|NO_GEOM
mdefine_line|#define NO_GEOM (!current_type[drive] &amp;&amp; !ITYPE(UDRS-&gt;fd_device))
r_int
id|cf
suffix:semicolon
r_int
...
(brace
multiline_comment|/* internal FDC */
r_if
c_cond
(paren
id|request_region
...
l_int|1
comma
l_string|&quot;floppy ex. mode change&quot;
)paren
)paren
r_continue
suffix:semicolon
...
c_func
(paren
l_string|&quot;Floppy io-port 0x4be in use&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
c_func
(paren
l_string|&quot;Floppy io-port 0xbe in use&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
id|floppy
suffix:semicolon
DECL|function|unregister_devfs_entries
r_static
r_void

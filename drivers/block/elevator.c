...
multiline_comment|/*&n; * For careful internal use by the block layer. Essentially the same as&n; * a requeue in that it tells the io scheduler that this request is not&n; * active in the driver or hardware anymore, but we don&squot;t want the request&n; * added back to the scheduler. Function is not exported.&n; */
DECL|function|elv_deactivate_request
r_void
...
c_cond
(paren
id|e-&gt;ops-&gt;elevator_deactivate_req_fn
)paren
id|e-&gt;ops
op_member_access_from_pointer
...
suffix:semicolon
multiline_comment|/*&n;&t; * if this is the flush, requeue the original instead and drop the flush&n;&t; */
r_if
c_cond
(paren
id|rq-&gt;flags
...
suffix:semicolon
multiline_comment|/*&n;&t; * if this is a barrier write and the device has to issue a&n;&t; * flush sequence to support it, check how far we are&n;&t; */
r_if
c_cond
(paren
id|rq

...
c_func
(paren
id|e-&gt;elevator_type-&gt;elevator_owner
)paren
suffix:semicolon
id|e-&gt;elevator_type
op_assign
...
suffix:semicolon
multiline_comment|/*&n; * switch to new_e io scheduler. be careful not to introduce deadlocks -&n; * we don&squot;t free the old io scheduler, before we have allocated what we&n; * need for the new one. this way we have a chance of going back to the old&n; * one, if the new one fails init for some reason&n; */
...
c_func
(paren
l_string|&quot;elevator: out of memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

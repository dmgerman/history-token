...
DECL|function|cpq_back_merge_fn
r_static
r_int
id|cpq_back_merge_fn
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|cpq_front_merge_fn
r_static
r_int
id|cpq_front_merge_fn
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|cpq_merge_requests_fn
r_static
r_int
id|cpq_merge_requests_fn
c_func
(paren
id|request_queue_t
op_star
...
id|sect
suffix:semicolon
multiline_comment|/*&n;&t; * Since we control our own merging, we know that this request&n;&t; * is now fully setup and there&squot;s nothing left.&n;         */
r_if
c_cond
(paren
id|creq-&gt;nr_sectors
...
c_func
(paren
l_string|&quot;ida: %ld sectors remain&bslash;n&quot;
comma
id|creq-&gt;nr_sectors
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * ehh, we can&squot;t really end the request here since it&squot;s not&n;&t; * even started yet. for now it shouldn&squot;t hurt though&n;&t; */
id|DBGPX
c_func
(paren
id|printk

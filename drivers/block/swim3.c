...
mdefine_line|#define SINGLE_SIDED&t;6&t;/* drive or diskette is 4MB type? */
...
DECL|macro|check_media_bay
mdefine_line|#define check_media_bay(which, what)&t;1
macro_line|#endif
...
id|settling
suffix:colon
multiline_comment|/* check for SEEK_COMPLETE after 30ms */
id|fs-&gt;settle_time
op_assign
(paren
id|HZ
...
(paren
id|KERN_ERR
l_string|&quot;swim3: seek settle timeout&bslash;n&quot;
)paren
suffix:semicolon
id|end_request
c_func
...
suffix:semicolon
multiline_comment|/* We must wait a bit for dbdma to stop */
r_for
c_loop
(paren
id|n
...
id|cp
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check that the main data transfer has finished.&n;&t;&t; * On writing, the swim3 sometimes doesn&squot;t use&n;&t;&t; * up all the bytes of the postamble, so we can still&n;&t;&t; * see DMA active here.  That doesn&squot;t matter as long&n;&t;&t; * as all the sector data has been transferred.&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* wait a little while for DMA to complete */
r_for
c_loop
(paren
id|n
...
suffix:semicolon
multiline_comment|/* shouldn&squot;t we do something with results of swim_add_device()? */
r_return
id|err
suffix:semicolon
)brace

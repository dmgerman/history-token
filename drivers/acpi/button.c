...
suffix:semicolon
DECL|variable|acpi_button_fops
r_static
r_struct
id|file_operations
id|acpi_button_fops
...
l_int|NULL
suffix:semicolon
DECL|function|acpi_button_seq_show
r_static
r_int
id|acpi_button_seq_show
c_func
(paren
r_struct
id|seq_file
...
DECL|function|acpi_button_open_fs
r_static
r_int
id|acpi_button_open_fs
c_func

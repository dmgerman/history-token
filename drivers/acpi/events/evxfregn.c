multiline_comment|/******************************************************************************&n; *&n; * Module Name: evxfregn - External Interfaces, ACPI Operation Regions and&n; *                         Address Spaces.&n; *              $Revision: 50 $&n; *&n; *****************************************************************************/
...
id|ACPI_DB_OPREGION
comma
l_string|&quot;Installing address handler for region %s(%X) on Device %p(%p)&bslash;n&quot;
comma

multiline_comment|/******************************************************************************&n; *&n; * Module Name: evevent - Fixed and General Purpose Even handling and dispatch&n; *              $Revision: 78 $&n; *&n; *****************************************************************************/
...
id|ACPI_DB_INTERRUPTS
comma
l_string|&quot;GPE block at %8.8X%8.8X - Enable %08X Status %08X&bslash;n&quot;
comma
id|ACPI_HIDWORD
(paren
id|gpe_register_info-&gt;enable_address.address

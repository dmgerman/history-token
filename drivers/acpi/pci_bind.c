...
id|ACPI_DB_INFO
comma
l_string|&quot;Unbinding PCI device [%s]...&bslash;n&quot;
comma
id|pathname
)paren
)paren
...
id|ACPI_DB_ERROR
comma
l_string|&quot;Unable to get data from device %s&bslash;n&quot;
comma
id|acpi_device_bid
c_func
(paren
...
id|ACPI_DB_ERROR
comma
l_string|&quot;Unable to detach data from device %s&bslash;n&quot;
comma
id|acpi_device_bid
c_func
(paren

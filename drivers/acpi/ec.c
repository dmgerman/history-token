...
id|ec_ecdt
suffix:semicolon
multiline_comment|/* compare this against UIDs in properly enumerated ECs to determine if we&n;   have a dupe */
DECL|variable|ecdt_uid
r_static
r_int
r_int
id|ecdt_uid
...
suffix:semicolon
multiline_comment|/* If our UID matches ecdt_uid, we already found this EC via the&n;&t;   ECDT. Abort. */
id|acpi_evaluate_integer
c_func
(paren
id|ec-&gt;handle
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * TODO: When the new driver model allows it, simply tell the&n;&t;&t; * EC driver it has a new device via that, instead if this.&n;&t;&t; */
id|ec_ecdt
op_assign
id|kmalloc
c_func
...
id|ecdt_ptr-&gt;uid
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Install GPE handler&n;&t;&t; */
id|status
op_assign
id|acpi_install_gpe_handler
c_func

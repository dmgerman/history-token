multiline_comment|/******************************************************************************&n; *&n; * Module Name: utglobal - Global variables for the ACPI subsystem&n; *              $Revision: 123 $&n; *&n; *****************************************************************************/
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ut_format_exception&n; *&n; * PARAMETERS:  Status              - Acpi status to be formatted&n; *&n; * RETURN:      Formatted status string&n; *&n; * DESCRIPTION: Convert an ACPI exception to a string&n; *&n; ****************************************************************************/
id|NATIVE_CHAR
op_star
DECL|function|acpi_ut_format_exception

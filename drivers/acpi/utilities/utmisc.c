multiline_comment|/*******************************************************************************&n; *&n; * Module Name: utmisc - common utility procedures&n; *              $Revision: 75 $&n; *&n; ******************************************************************************/
...
multiline_comment|/*******************************************************************************&n; *&n; * FUNCTION:    Acpi_ut_resolve_reference&n; *&n; * PARAMETERS:  ACPI_PKG_CALLBACK&n; *&n; * RETURN:      Status          - the status of the call&n; *&n; * DESCRIPTION: Resolve a reference object to an actual value&n; *&n; ******************************************************************************/
id|acpi_status
DECL|function|acpi_ut_resolve_reference
...
suffix:colon
multiline_comment|/*&n;&t;&t; * Simple object - check for a reference&n;&t;&t; */
r_if
c_cond
(paren
...
c_cond
(paren
id|source_object-&gt;reference.opcode
)paren
(brace
r_case
id|AML_ZERO_OP
...
suffix:semicolon
id|source_object-&gt;integer.value
op_assign
l_int|0
suffix:semicolon
r_break
...
r_default
suffix:colon
multiline_comment|/* Other types not supported */
r_return
(paren
id|AE_SUPPORT
)paren
...
(paren
(paren
l_string|&quot;Expecting a Package object&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|return_ACPI_STATUS

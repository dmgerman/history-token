...
id|FUNCTION_TRACE
(paren
l_string|&quot;Hw_obtain_sleep_type_register_data&quot;
)paren
suffix:semicolon
...
id|FUNCTION_TRACE
(paren
l_string|&quot;Hw_register_bit_access&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|ACPI_DB_IO
comma
l_string|&quot;GPE Enable bits: Read %X from %X&bslash;n&quot;
comma
id|register_value
comma
id|register_id
...
id|value
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * This write will put the Action state into the General Purpose&n;&t;&t;&t; * Enable Register indexed by the value in Mask&n;&t;&t;&t; */
id|ACPI_DEBUG_PRINT
(paren
(paren
id|ACPI_DB_IO
...
id|ACPI_DB_IO
comma
l_string|&quot;Register I/O: returning %X&bslash;n&quot;
comma
id|register_value
)paren
)paren
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t; * For the GPE? Blocks, the lower word of Register_id contains the&n;&t; * byte offset for which to read, as each part of each block may be&n;&t; * several bytes long.&n;&t; */
r_case
id|GPE0_STS_BLOCK
suffix:colon
multiline_comment|/* 8-bit access */

...
r_void
DECL|function|acpi_pci_irq_disable
...
id|return_VOID
suffix:semicolon
multiline_comment|/*&n;&t; * First we check the PCI IRQ routing table (PRT) for an IRQ.&n;&t; */
id|gsi
op_assign
id|acpi_pci_irq_lookup
c_func
...
id|return_VOID
suffix:semicolon
multiline_comment|/*&n;&t; * TBD: It might be worth clearing dev-&gt;irq by magic constant&n;&t; * (e.g. PCI_UNDEFINED_IRQ).&n;&t; */
id|printk
c_func
(paren
id|KERN_INFO
id|PREFIX
l_string|&quot;PCI interrupt for device %s disabled&bslash;n&quot;
comma
id|pci_name
c_func
(paren

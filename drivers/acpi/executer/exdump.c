...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_dump_operand&n; *&n; * PARAMETERS:  *Entry_desc         - Pointer to entry to be dumped&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Dump a stack entry&n; *&n; ****************************************************************************/
id|acpi_status
...
multiline_comment|/*  Entry_desc is a valid object */
id|ACPI_DEBUG_PRINT
(paren
(paren
id|ACPI_DB_INFO
...
c_cond
(paren
id|entry_desc-&gt;reference.opcode
)paren
(brace
r_case
id|AML_ZERO_OP
...
id|DUMP_PATHNAME
(paren
id|entry_desc-&gt;reference.object
comma
...
comma
id|entry_desc-&gt;reference.offset
)paren
)paren
suffix:semicolon
r_if
...
comma
id|entry_desc-&gt;buffer.length
comma
id|entry_desc-&gt;buffer.pointer
)paren
)paren
suffix:semicolon
id|length
...
comma
id|entry_desc-&gt;package.count
comma
id|entry_desc-&gt;package.elements
)paren
)paren
suffix:semicolon
...
comma
id|entry_desc-&gt;string.length
comma
id|entry_desc-&gt;string.pointer
)paren
)paren
suffix:semicolon
r_for
...
comma
id|entry_desc-&gt;field.access_bit_width
comma
id|entry_desc-&gt;field.lock_rule
comma
id|entry_desc-&gt;field.update_rule
comma
id|entry_desc-&gt;field.base_byte_offset
comma
id|entry_desc-&gt;field.start_field_bit_offset
)paren
)paren
suffix:semicolon
id|DUMP_STACK_ENTRY
(paren
id|entry_desc-&gt;field.region_obj
)paren
suffix:semicolon
r_break
suffix:semicolon
...
comma
id|entry_desc-&gt;buffer_field.base_byte_offset
comma
id|entry_desc-&gt;buffer_field.start_field_bit_offset
)paren
)paren
suffix:semicolon
r_if
...
(paren
op_logical_neg
id|entry_desc-&gt;buffer_field.buffer_obj
)paren
(brace
id|ACPI_DEBUG_PRINT
(paren
...
id|ACPI_TYPE_BUFFER
op_ne
id|entry_desc-&gt;buffer_field.buffer_obj-&gt;common.type
)paren
(brace
id|ACPI_DEBUG_PRINT_RAW
(paren
...
r_default
suffix:colon
multiline_comment|/*  unknown Entry_desc-&gt;Common.Type value   */
id|ACPI_DEBUG_PRINT_RAW
(paren
(paren
id|ACPI_DB_INFO
...
suffix:semicolon
multiline_comment|/* Back up to previous entry */
id|entry_desc
op_decrement
suffix:semicolon
multiline_comment|/* TBD: [Restructure]  Change to use dump object routine !! */
multiline_comment|/*       What is all of this?? */
id|DUMP_BUFFER
(paren
id|entry_desc
comma
...
id|acpi_os_printf
(paren
l_string|&quot;%p is not a valid ACPI object&bslash;n&quot;
comma
id|obj_desc
)paren
suffix:semicolon
...
l_string|&quot;Access_bit_width&quot;
comma
id|obj_desc-&gt;bank_field.access_bit_width
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;%20s : %X&bslash;n&quot;
comma
l_string|&quot;Update_rule&quot;
comma
id|obj_desc-&gt;bank_field.update_rule
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Bit_length&quot;
comma
id|obj_desc-&gt;bank_field.bit_length
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Access_bit_width&quot;
comma
id|obj_desc-&gt;index_field.access_bit_width
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Update_rule&quot;
comma
id|obj_desc-&gt;index_field.update_rule
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Bit_length&quot;
comma
id|obj_desc-&gt;index_field.bit_length
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Handler&quot;
comma
id|obj_desc-&gt;addr_handler.handler
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
l_string|&quot;Handler&quot;
comma
id|obj_desc-&gt;notify_handler.handler
)paren
suffix:semicolon
id|acpi_os_printf
(paren
...
id|acpi_os_printf
(paren
l_string|&quot;*** Structure display not implemented for type %X! ***&bslash;n&quot;
comma
id|obj_desc-&gt;common.type
)paren
suffix:semicolon
...
id|acpi_os_printf
(paren
l_string|&quot;*** Cannot display unknown type %X! ***&bslash;n&quot;
comma
id|obj_desc-&gt;common.type
)paren
suffix:semicolon

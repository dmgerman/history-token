...
id|ACPI_DB_ERROR
comma
l_string|&quot;Field access width (%d bytes) too large for region size (%X)&bslash;n&quot;
comma
id|obj_desc-&gt;common_field.access_byte_width
comma
id|rgn_desc-&gt;region.length
...
id|ACPI_DB_ERROR
comma
l_string|&quot;Field base+offset+width %X+%X+%X exceeds region size (%X bytes) field=%p region=%p&bslash;n&quot;
comma
id|obj_desc-&gt;common_field.base_byte_offset
comma
id|field_datum_byte_offset
...
id|ACPI_DB_ERROR
comma
l_string|&quot;%p, wrong source type - %s&bslash;n&quot;
comma
id|obj_desc
comma
id|acpi_ut_get_type_name
...
id|ACPI_DB_INFO
comma
l_string|&quot;Byte_len=%x, Datum_len=%x, Bit_gran=%x, Byte_gran=%x&bslash;n&quot;
comma
id|byte_field_length
comma
id|datum_count
...
id|ACPI_DB_ERROR
comma
l_string|&quot;**** Region type %s(%X) not implemented&bslash;n&quot;
comma
id|acpi_ut_get_region_name
(paren
id|rgn_desc-&gt;region.space_id
...
id|ACPI_DB_ERROR
comma
l_string|&quot;**** Region type %s(%X) does not have a handler&bslash;n&quot;
comma
id|acpi_ut_get_region_name
(paren
id|rgn_desc-&gt;region.space_id
...
id|FUNCTION_TRACE
(paren
l_string|&quot;Ex_write_field_datum_with_update_rule&quot;
)paren
suffix:semicolon
...
id|ACPI_DB_BFIELD
comma
l_string|&quot;Mask %X Datum_offset %X Value %X, Merged_value %X&bslash;n&quot;
comma
id|mask
comma
id|field_datum_byte_offset

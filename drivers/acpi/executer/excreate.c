multiline_comment|/******************************************************************************&n; *&n; * Module Name: excreate - Named object creation&n; *              $Revision: 66 $&n; *&n; *****************************************************************************/
...
id|FUNCTION_TRACE
(paren
l_string|&quot;Ex_create_buffer_field&quot;
)paren
suffix:semicolon
multiline_comment|/* Create the descriptor */
id|obj_desc
op_assign
...
id|obj_desc-&gt;buffer_field.extra-&gt;extra.pcode
op_assign
id|aml_ptr
suffix:semicolon
id|obj_desc-&gt;buffer_field.extra-&gt;extra.pcode_length
op_assign
id|aml_length
suffix:semicolon
...
id|node
comma
l_string|&quot;Ex_create_buffer_field: Removing Current Reference&quot;
comma
id|ACPI_LV_BFIELD
comma
id|_COMPONENT
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_event&n; *&n; * PARAMETERS:  None&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new event object&n; *&n; ****************************************************************************/
id|acpi_status
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_mutex&n; *&n; * PARAMETERS:  Interpreter_mode    - Current running mode (load1/Load2/Exec)&n; *              Operands            - List of operands for the opcode&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new mutex object&n; *&n; ****************************************************************************/
id|acpi_status
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_region&n; *&n; * PARAMETERS:  Aml_ptr             - Pointer to the region declaration AML&n; *              Aml_length          - Max length of the declaration AML&n; *              Operands            - List of operands for the opcode&n; *              Interpreter_mode    - Load1/Load2/Execute&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new operation region object&n; *&n; ****************************************************************************/
id|acpi_status
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_processor&n; *&n; * PARAMETERS:  Op              - Op containing the Processor definition and&n; *                                args&n; *              Processor_node  - Parent Node for the processor object&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new processor object and populate the fields&n; *&n; ****************************************************************************/
id|acpi_status
...
multiline_comment|/* Get first arg and verify existence */
id|arg
op_assign
id|op-&gt;value.arg
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Get second arg and verify existence */
id|arg
op_assign
id|arg-&gt;next
suffix:semicolon
...
id|arg-&gt;value.integer
suffix:semicolon
multiline_comment|/* Get third arg and verify existence */
id|arg
op_assign
id|arg-&gt;next
suffix:semicolon
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_power_resource&n; *&n; * PARAMETERS:  Op              - Op containing the Power_resource definition&n; *                                and args&n; *              Power_node      - Parent Node for the power object&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new Power_resource object and populate the fields&n; *&n; ****************************************************************************/
id|acpi_status
...
id|arg-&gt;value.integer
suffix:semicolon
multiline_comment|/* Get second arg and check existence */
id|arg
op_assign
id|arg-&gt;next
suffix:semicolon
...
multiline_comment|/*****************************************************************************&n; *&n; * FUNCTION:    Acpi_ex_create_method&n; *&n; * PARAMETERS:  Aml_ptr         - First byte of the method&squot;s AML&n; *              Aml_length      - AML byte count for this method&n; *              Method_flags    - AML method flag byte&n; *              Method          - Method Node&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create a new method object&n; *&n; ****************************************************************************/
id|acpi_status

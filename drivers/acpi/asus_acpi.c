...
id|xxN
comma
singleline_comment|//M2400N, M3700N, M6800N, S1300N, S5200N (Centrino)
...
suffix:semicolon
multiline_comment|/*&n;&t; * Another value for userspace: the ASYM method returns 0x02 for&n;&t; * battery low and 0x04 for battery critical, it&squot;s readings tend to be&n;&t; * more accurate than those provided by _BST. &n;&t; * Note: since not all the laptops provide this method, errors are&n;&t; * silently ignored.&n;&t; */
r_if
c_cond
(paren
id|read_acpi_int
...
suffix:semicolon
multiline_comment|/* M6N differs slightly and has a usable WLED */
)brace
r_else
r_if
c_cond

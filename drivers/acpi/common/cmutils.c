multiline_comment|/*******************************************************************************&n; *&n; * Module Name: cmutils - common utility procedures&n; *              $Revision: 27 $&n; *&n; ******************************************************************************/
...
multiline_comment|/*******************************************************************************&n; *&n; * FUNCTION:    Acpi_cm_create_pkg_state_and_push&n; *&n; * PARAMETERS:  *Object         - Object to be added to the new state&n; *              Action          - Increment/Decrement&n; *              State_list      - List the state will be added to&n; *&n; * RETURN:      None&n; *&n; * DESCRIPTION: Create a new state and push it&n; *&n; ******************************************************************************/
id|ACPI_STATUS
DECL|function|acpi_cm_create_pkg_state_and_push
...
multiline_comment|/*******************************************************************************&n; *&n; * FUNCTION:    Acpi_cm_create_pkg_state&n; *&n; * PARAMETERS:  Object              - Initial Object to be installed in the&n; *                                    state&n; *              Action              - Update action to be performed&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Create an &quot;Update State&quot; - a flavor of the generic state used&n; *              to update reference counts and delete complex objects such&n; *              as packages.&n; *&n; ******************************************************************************/
id|ACPI_GENERIC_STATE
op_star
DECL|function|acpi_cm_create_pkg_state
id|acpi_cm_create_pkg_state
(paren
r_void
op_star
...
multiline_comment|/*******************************************************************************&n; *&n; * FUNCTION:    Acpi_cm_walk_package_tree&n; *&n; * PARAMETERS:  Obj_desc        - The Package object on which to resolve refs&n; *&n; * RETURN:      Status&n; *&n; * DESCRIPTION: Walk through a package&n; *&n; ******************************************************************************/
id|ACPI_STATUS
DECL|function|acpi_cm_walk_package_tree
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check for&n;&t;&t; * 1) An uninitialized package element.  It is completely&n;&t;&t; *      legal to declare a package and leave it uninitialized&n;&t;&t; * 2) Not an internal object - can be a namespace node instead&n;&t;&t; * 3) Any type other than a package.  Packages are handled in else case below.&n;&t;&t; */
r_if
c_cond
(paren
(paren

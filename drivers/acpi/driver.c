...
multiline_comment|/*static int &n;acpi_do_sleep(ctl_table * ctl,&n;&t;      int write,&n;&t;      struct file *file,&n;&t;      void *buffer,&n;&t;      size_t * len)&n;{&n;&t;if (!write) {&n;&t;&t;if (file-&gt;f_pos) {&n;&t;&t;&t;*len = 0;&n;&t;&t;&t;return 0;&n;&t;&t;}&n;&t;}&n;&t;else {&n;&t;&t;int status = acpi_enter_sx(ACPI_STATE_S1);&n;&t;&t;if (status)&n;&t;&t;&t;return status;&n;&t;}&n;&t;file-&gt;f_pos += *len;&n;&t;return 0;&n;}*/
...
comma
multiline_comment|/* until it actually works */
multiline_comment|/*&t;{ACPI_SLEEP, &quot;sleep&quot;, NULL, 0, 0600, NULL, &amp;acpi_do_sleep},*/
(brace
id|ACPI_EVENT
comma
l_string|&quot;event&quot;
...
(paren
id|KERN_INFO
l_string|&quot;ACPI: Disabled&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return

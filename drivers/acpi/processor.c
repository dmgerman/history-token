...
suffix:semicolon
macro_line|#ifdef CONFIG_ACPI_PROCESSOR_PERF
DECL|variable|cpufreq_usage_count
r_static
r_int
r_int
id|cpufreq_usage_count
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;acpi_processor_get_performance_info_dummy&quot;
)paren
suffix:semicolon
r_if
c_cond
...
multiline_comment|/* set one or all CPUs to the new state */
id|result
op_assign
id|acpi_processor_set_performance
(paren
...
suffix:semicolon
multiline_comment|/* now check if at least one value is within this limit */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* test if it works */
id|current_state
op_assign
id|pr-&gt;performance.state
suffix:semicolon
...
macro_line|#endif
multiline_comment|/* detect highest transition latency */
r_for
c_loop
(paren
id|i
...
id|ACPI_DB_INFO
comma
l_string|&quot;Removing cpufreq driver&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|result
...
c_func
(paren
l_string|&quot;acpi_cpufreq_init_dummy&quot;
)paren
suffix:semicolon
id|return_VALUE
c_func
...
c_func
(paren
l_string|&quot;acpi_cpufreq_exit_dummy&quot;
)paren
suffix:semicolon
id|return_VALUE
c_func
...
id|ACPI_DB_ERROR
comma
l_string|&quot;Please use kernel with Processor Performance States support included!&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|result

multiline_comment|/*******************************************************************************&n; *&n; * Module Name: dbinput - user front-end to the AML debugger&n; *              $Revision: 61 $&n; *&n; ******************************************************************************/
...
suffix:semicolon
DECL|variable|opt_tables
id|u8
id|opt_tables
op_assign
id|FALSE
suffix:semicolon
DECL|variable|opt_disasm
id|u8
id|opt_disasm
op_assign
id|FALSE
suffix:semicolon
DECL|variable|opt_stats
id|u8
id|opt_stats
op_assign
id|FALSE
suffix:semicolon
DECL|variable|opt_parse_jit
id|u8
id|opt_parse_jit
op_assign
id|FALSE
...
id|acpi_os_printf
(paren
l_string|&quot;Unload                            Unload an ACPI table&bslash;n&quot;
)paren
suffix:semicolon
id|acpi_os_printf
(paren

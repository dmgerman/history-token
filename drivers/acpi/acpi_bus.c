multiline_comment|/*&n; *  acpi_bus.c - ACPI Bus Driver ($Revision: 56 $)&n; *&n; *  Copyright (C) 2001, 2002 Paul Diefenbaugh &lt;paul.s.diefenbaugh@intel.com&gt;&n; *&n; * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~&n; *&n; *  This program is free software; you can redistribute it and/or modify&n; *  it under the terms of the GNU General Public License as published by&n; *  the Free Software Foundation; either version 2 of the License, or (at&n; *  your option) any later version.&n; *&n; *  This program is distributed in the hope that it will be useful, but&n; *  WITHOUT ANY WARRANTY; without even the implied warranty of&n; *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU&n; *  General Public License for more details.&n; *&n; *  You should have received a copy of the GNU General Public License along&n; *  with this program; if not, write to the Free Software Foundation, Inc.,&n; *  59 Temple Place, Suite 330, Boston, MA 02111-1307 USA.&n; *&n; * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~&n; */
...
r_static
r_void
DECL|function|acpi_bus_data_handler_powerf
id|acpi_bus_data_handler_powerf
(paren
id|acpi_handle
id|handle
comma
...
c_func
(paren
l_string|&quot;acpi_bus_data_handler_powerf&quot;
)paren
suffix:semicolon
multiline_comment|/* TBD */
id|return_VOID
...
r_static
r_void
DECL|function|acpi_bus_data_handler_sleepf
id|acpi_bus_data_handler_sleepf
(paren
id|acpi_handle
id|handle
comma
...
c_func
(paren
l_string|&quot;acpi_bus_data_handler_sleepf&quot;
)paren
suffix:semicolon
multiline_comment|/* TBD */
id|return_VOID
...
multiline_comment|/**&n; * acpi_bus_bind &n; * -------------&n; * Callback for acpi_bus_walk() used to find devices that match a specific &n; * driver&squot;s criteria and bind the driver to the device.&n; */
r_static
r_int
DECL|function|acpi_bus_bind
id|acpi_bus_bind
(paren
r_struct
id|acpi_device
...
multiline_comment|/**&n; * acpi_bus_unbind &n; * ---------------&n; * Callback for acpi_bus_walk() used to find devices that match a specific &n; * driver&squot;s criteria and unbind the driver from the device.&n; */
r_static
r_int
DECL|function|acpi_bus_unbind
id|acpi_bus_unbind
(paren
r_struct
id|acpi_device
...
multiline_comment|/*&n;&t; * Context&n;&t; * -------&n;&t; * Attach this &squot;struct acpi_device&squot; to the ACPI object.  This makes&n;&t; * resolutions from handle-&gt;device very efficient.  Note that since we&n;&t; * attach multiple context to the root object (system device plus all&n;&t; * fixed-feature devices) we must use alternate handlers.&n;&t; */
r_switch
c_cond
(paren
id|type
...
suffix:semicolon
multiline_comment|/*&n;&t; * Find Driver&n;&t; * -----------&n;&t; * Check to see if there&squot;s a driver installed for this kind of device.&n;&t; */
id|acpi_bus_find_driver
c_func
(paren
id|device
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [2] Get a separate copy of the FADT for use by other drivers.&n;&t; */
id|status
op_assign
id|acpi_get_table
c_func
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [3] Enable the ACPI Core Subsystem.&n;&t; */
id|status
op_assign
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [4] Register for all standard device notifications.&n;&t; */
id|status
op_assign
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [5] Create the root device.&n;&t; */
id|result
op_assign
id|acpi_bus_add
c_func
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [6] Create the root file system.&n;&t; */
id|acpi_device_dir
c_func
(paren
id|acpi_root
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [7] Install drivers required for proper enumeration of the&n;&t; *     ACPI namespace.&n;&t; */
id|acpi_system_init
c_func
(paren
)paren
...
op_increment
suffix:semicolon
multiline_comment|/*&n;&t; * [8] Enumerate devices in the ACPI namespace.&n;&t; */
id|result
op_assign
id|acpi_bus_scan_fixed
c_func

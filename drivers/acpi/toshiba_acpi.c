...
DECL|macro|KERNEL24
mdefine_line|#define KERNEL24 (LINUX_VERSION_CODE &lt; KERNEL_VERSION(2, 5, 0))
macro_line|#if KERNEL24
...
multiline_comment|/* This is the common code at the end of every proc read handler.  I don&squot;t&n; * understand it yet.&n; */
r_static
r_int
DECL|function|end_proc_read
id|end_proc_read
c_func
(paren
r_const
...
id|force_fan
suffix:semicolon
multiline_comment|/* proc file handlers&n; *&n; * WARNING: The write handlers are using sscanf on non-zero-terminated&n; * buffers.  This may result in memory reads past the buffer bounds.&n; */
r_static
r_int

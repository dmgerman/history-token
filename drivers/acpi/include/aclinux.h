multiline_comment|/******************************************************************************&n; *&n; * Name: aclinux.h - OS specific defines, etc.&n; *       $Revision: 9 $&n; *&n; *****************************************************************************/
...
multiline_comment|/* And the ia32 kernel doesn&squot;t include 64-bit divide support */
DECL|macro|ACPI_DIV64
mdefine_line|#define ACPI_DIV64(dividend, divisor) do_div(dividend, divisor)
macro_line|#else
DECL|macro|ACPI_DIV64
mdefine_line|#define ACPI_DIV64(dividend, divisor) ACPI_DIVIDE(dividend, divisor)
macro_line|#endif

multiline_comment|/******************************************************************************&n; *&n; * Name: accommon.h -- prototypes for the common (subsystem-wide) procedures&n; *       $Revision: 90 $&n; *&n; *****************************************************************************/
...
suffix:semicolon
id|ACPI_STATUS
id|acpi_cm_copy_esimple_to_isimple
c_func
(paren
id|ACPI_OBJECT
op_star
...
suffix:semicolon
id|ACPI_STATUS
id|acpi_cm_copy_isimple_to_isimple
(paren
id|ACPI_OPERAND_OBJECT
op_star
id|source_obj
...
suffix:semicolon
id|ACPI_STATUS
id|acpi_cm_create_pkg_state_and_push
(paren
r_void
op_star
id|internal_object
...
macro_line|#ifdef ACPI_DEBUG
r_void
id|acpi_cm_display_init_pathname
(paren
id|ACPI_HANDLE
id|obj_handle
comma

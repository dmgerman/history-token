multiline_comment|/******************************************************************************&n; *&n; * Module Name: dsopcode - Dispatcher Op Region support and handling of&n; *                         &quot;control&quot; opcodes&n; *              $Revision: 52 $&n; *&n; *****************************************************************************/
...
id|ACPI_DB_EXEC
comma
l_string|&quot;[%4.4s] Op_region Init at AML %p[%x]&bslash;n&quot;
comma
op_amp
id|node-&gt;name
comma
...
suffix:semicolon
multiline_comment|/* Evaluate the address and length arguments for the Op_region */
id|op
op_assign
id|acpi_ps_alloc_op
(paren
...
id|ACPI_DB_ERROR
comma
l_string|&quot;(%s) destination must be a Node&bslash;n&quot;
comma
id|acpi_ps_get_opcode_name
(paren
id|op-&gt;opcode
...
multiline_comment|/* TBD: This line MUST be a single line until Acpi_src can handle it (block deletion) */
(brace
id|ACPI_DEBUG_PRINT
(paren
(paren
...
id|ACPI_DB_EXEC
comma
l_string|&quot;Rgn_obj %p Addr %8.8lX%8.8lX Len %X&bslash;n&quot;
comma
id|obj_desc
comma
id|HIDWORD
...
id|ACPI_DB_INFO
comma
l_string|&quot;Break to end of current package, Op=%p&bslash;n&quot;
comma
id|op
)paren
)paren
suffix:semicolon
multiline_comment|/* TBD: update behavior for ACPI 2.0 */

multiline_comment|/******************************************************************************&n; *&n; * Module Name: dswload - Dispatcher namespace load callbacks&n; *              $Revision: 44 $&n; *&n; *****************************************************************************/
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;Create_xxx_field: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
multiline_comment|/* We could put the returned object (Node) on the object stack for later, but&n;&t;&t; * for now, we will put it in the &quot;op&quot; object that the parser uses, so we&n;&t;&t; * can get it again at the end of this scope&n;&t;&t; */
id|op-&gt;node
op_assign
id|new_node
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If there is no object attached to the node, this node was just created and&n;&t;&t; * we need to create the field object.  Otherwise, this was a lookup of an&n;&t;&t; * existing node and we don&squot;t want to create the field object again.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t;&t; * The Field definition is not fully parsed at this time.&n;&t;&t;&t; * (We must save the address of the AML for the buffer and index operands)&n;&t;&t;&t; */
id|status
op_assign
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Processor: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;Completed Processor Init, Op=%p State=%p entry=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Power_resource: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;Completed Power_resource Init, Op=%p State=%p entry=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Thermal_zone: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Field: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Index_field: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Bank_field: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Mutex: Op=%p State=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Event: Op=%p State=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Opregion: Op=%p State=%p Named_obj=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;Completed Op_region Init, Op=%p State=%p entry=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Alias: Op=%p State=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Name: Op=%p State=%p&bslash;n&quot;
comma
id|op
comma
id|walk_state
...
id|ACPI_DB_DISPATCH
comma
l_string|&quot;LOADING-Name_path object: State=%p Op=%p Named_obj=%p&bslash;n&quot;
comma
id|walk_state
comma
id|op

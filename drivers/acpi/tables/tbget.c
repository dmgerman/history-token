multiline_comment|/******************************************************************************&n; *&n; * Module Name: tbget - ACPI Table get* routines&n; *              $Revision: 78 $&n; *&n; *****************************************************************************/
...
(paren
(paren
l_string|&quot;Could not map memory at %p for length %X&bslash;n&quot;
comma
id|address-&gt;pointer.physical
comma
r_sizeof
...
(paren
(paren
l_string|&quot;Could not map memory for table [%4.4s] at %p for length %X&bslash;n&quot;
comma
id|header-&gt;signature
comma
id|address-&gt;pointer.physical

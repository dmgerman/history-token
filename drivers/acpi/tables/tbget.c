...
suffix:colon
multiline_comment|/*&n;&t;&t; * Not reading from a buffer, just map the table&squot;s physical memory&n;&t;&t; * into our address space.&n;&t;&t; */
id|size
op_assign
id|SIZE_IN_HEADER
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Loop through all table pointers found in RSDT.&n;&t; * This will NOT include the FACS and DSDT - we must get&n;&t; * them after the loop.&n;&t; *&n;&t; * The ONLY table we are interested in getting here is the FADT.&n;&t; */
r_for
c_loop
(paren
id|index
...
(paren
(paren
l_string|&quot;Could not get the DSDT&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|return_ACPI_STATUS
...
suffix:semicolon
multiline_comment|/*&n;&t; * What mode is the processor in? (Virtual or Physical addressing)&n;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Incoming pointer can be either logical or physical */
r_switch
c_cond
(paren
id|address-&gt;pointer_type
...
r_else
(brace
multiline_comment|/* In Physical addressing mode, all pointers must be physical */
r_switch
c_cond
(paren
id|address-&gt;pointer_type

...
DECL|macro|IBM_HANDLE_INIT_REQ
mdefine_line|#define IBM_HANDLE_INIT_REQ(object) do {                                      &bslash;&n;        if (ibm_handle_init(#object, &amp;object##_handle, *object##_parent,      &bslash;&n;&t;&t;object##_paths, sizeof(object##_paths)/sizeof(char *), 1) &lt; 0)&bslash;&n;&t;&t;return -ENODEV;                                               &bslash;&n;} while (0)
DECL|macro|IBM_HANDLE_INIT
mdefine_line|#define IBM_HANDLE_INIT(object)                                           &bslash;&n;&t;ibm_handle_init(#object, &amp;object##_handle, *object##_parent,      &bslash;&n;&t;&t;object##_paths, sizeof(object##_paths)/sizeof(char *), 0)
DECL|function|ibm_param
r_static
r_void
id|ibm_param
c_func
...
mdefine_line|#define IBM_PARAM(feature) do {&t;&t;&t;&t;&t;&bslash;&n;&t;static char cmd[32];&t;&t;&t;&t;&t;&bslash;&n;&t;module_param_string(feature, cmd, sizeof(cmd) - 1, 0);&t;&bslash;&n;&t;ibm_param(#feature, cmd);&t;&t;&t;&t;&bslash;&n;} while (0)
...
(paren
id|IBM_ERR
l_string|&quot;neither led nor sysl object found&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

...
multiline_comment|/**&n; *&t;ata_scsi_rw_queue -&n; *&t;@ap:&n; *&t;@dev:&n; *&t;@cmd:&n; *&t;@done:&n; *&n; *&t;LOCKING:&n; *&t;spin_lock_irqsave(host_set lock)&n; */
...
multiline_comment|/* otherwise fall through to slow path */
)brace
r_else
(brace
m_assert

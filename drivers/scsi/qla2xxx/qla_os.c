...
suffix:semicolon
r_int
DECL|function|qla2x00_set_info
id|qla2x00_set_info
c_func
(paren
r_char
...
l_string|&quot;timeout=%x, dpc_flags=%lx, vis_ha-&gt;dpc_flags=%lx&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|cmd
...
l_string|&quot;from RISC. pid=%ld sp-&gt;state=%x&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|sp
...
c_func
(paren
l_string|&quot;Resetting the Bus= 0x%x&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;qla2xxx_eh_host_reset&quot;
)paren
suffix:semicolon
...
id|ha
comma
l_string|&quot;Host Reset...  Command=&bslash;n&quot;
)paren
suffix:semicolon
id|qla2x00_print_scsi_cmd
c_func
...
multiline_comment|/**************************************************************************&n;* qla2x00_slave_configure&n;*&n;* Description:&n;**************************************************************************/
r_int
...
(brace
multiline_comment|/* Update our PCI device dma_mask for full 64 bits */
r_if
c_cond
(paren
id|pci_set_dma_mask
...
id|ha
comma
l_string|&quot;region #0 not a PIO resource (%s), aborting&bslash;n&quot;
comma
id|ha-&gt;pdev-&gt;slot_name
)paren
suffix:semicolon
...
id|ha
comma
l_string|&quot;Invalid PCI I/O region size (%s), aborting&bslash;n&quot;
comma
id|ha-&gt;pdev-&gt;slot_name
)paren
suffix:semicolon
...
comma
l_string|&quot;&bslash;n&quot;
l_string|&quot; QLogic ISP2xxx PCI/PCI-X Fibre Channel HBA Driver: %s&bslash;n&quot;
...
id|info
comma
l_string|&quot;Entry address = %p&bslash;n&quot;
comma
id|qla2x00_set_info
)paren
suffix:semicolon
...
id|info
comma
l_string|&quot;Info -- pci=%x xchgs=0x%x iocbs=0x%x&bslash;n&quot;
comma
id|ha-&gt;pci_attr
comma
id|ha-&gt;xchg_buf_cnt
...
multiline_comment|/*&n;&t;&t; * Allocate an initial list of mailbox semaphore queue to be&n;&t;&t; * used for serialization of the mailbox commands.&n;&t;&t; */
id|tmp_q_head
op_assign
id|kmalloc
c_func
...
id|ha
comma
l_string|&quot;Memory Allocation failed - mbx_cmd_q&quot;
)paren
suffix:semicolon
id|qla2x00_mem_free
c_func
...
id|tmp_q_head
suffix:semicolon
multiline_comment|/* Now try to allocate more */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * Error. Just exit. If more is needed later&n;&t;&t;&t;&t; * they will be allocated at that time.&n;&t;&t;&t;&t; */
r_break
suffix:semicolon
)brace
id|memset
...
suffix:semicolon
multiline_comment|/* Get consistent memory allocated for CT SNS commands */
id|ha-&gt;ct_sns
op_assign
id|pci_alloc_consistent
c_func
...
multiline_comment|/* Now free the mbx sem pool */
id|tmp_q_head
op_assign
id|ha-&gt;mbx_sem_pool_head
suffix:semicolon
...
multiline_comment|/*&n; * This routine will alloacte SP from the free queue&n; * input:&n; *        scsi_qla_host_t *&n; * output:&n; *        srb_t * or NULL&n; */
id|srb_t
op_star
...
multiline_comment|/* TODO: Remove this code!!! */
macro_line|#if defined(QL_DEBUG_LEVEL_3)
id|spin_lock_irqsave
c_func
(paren
...
c_func
(paren
l_string|&quot;scsi(%ld): loop/port is down - &quot;
l_string|&quot;pid=%ld, sp=%p loopid=0x%x queued to dest HBA &quot;
...
multiline_comment|/*&n; * qla2x00_reset_lun_fo_counts&n; *&t;Reset failover retry counts&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&n; * Context:&n; *&t;Interrupt context.&n; */
r_void
DECL|function|qla2x00_reset_lun_fo_counts
...
suffix:semicolon
multiline_comment|/*&n;&t; * the pending queue.&n;&t; */
id|list_for_each
c_func
(paren
id|list
...
multiline_comment|/*&n;&t; * the retry queue.&n;&t; */
id|list_for_each
c_func
(paren
id|list
...
multiline_comment|/*&n;&t; * the done queue.&n;&t; */
id|list_for_each
c_func
(paren
id|list
...
multiline_comment|/**************************************************************************&n;*   qla2x00_check_tgt_status&n;*&n;* Description:&n;*     Checks to see if the target or loop is down.&n;*&n;* Input:&n;*     cmd - pointer to Scsi cmd structure&n;*&n;* Returns:&n;*   1 - if target is present&n;*   0 - if target is not present&n;*&n;**************************************************************************/
r_int
DECL|function|qla2x00_check_tgt_status
...
(paren
id|KERN_INFO
l_string|&quot;scsi(%ld:%2d:%2d:%2d): %s connection is down&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|b
...
multiline_comment|/**************************************************************************&n;*   qla2x00_check_port_status&n;*&n;* Description:&n;*     Checks to see if the port or loop is down.&n;*&n;* Input:&n;*     fcport - pointer to fc_port_t structure.&n;*&n;* Returns:&n;*   1 - if port is present&n;*   0 - if port is not present&n;*&n;**************************************************************************/
r_int
DECL|function|qla2x00_check_port_status
...
(paren
id|KERN_INFO
l_string|&quot;scsi(%ld): Connection is down. fcport=%p.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|fcport
...
(paren
id|KERN_INFO
l_string|&quot;QLogic ISP2xxx PCI/PCI-X Fibre Channel HBA Driver (%p)&bslash;n&quot;
comma
id|qla2x00_set_info
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;QLogic ISP2xxx FC-SCSI Host Bus Adapter driver&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

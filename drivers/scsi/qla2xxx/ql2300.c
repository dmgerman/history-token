multiline_comment|/*&n; * QLogic ISP2300 device driver for Linux 2.6.x&n; * Copyright (C) 2003 Christoph Hellwig.&n; * Copyright (C) 2003 QLogic Corporation (www.qlogic.com)&n; *&n; * Released under GPL v2.&n; */

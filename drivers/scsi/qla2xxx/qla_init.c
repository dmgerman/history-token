...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Go setup flash database devices with proper&n;&t;&t;&t;&t; * Loop ID&squot;s.&n;&t;&t;&t;&t; */
r_do
(brace
id|clear_bit
c_func
...
l_int|200
suffix:semicolon
multiline_comment|/* FIXME&n; *&n; * port_down_retry_count updated twice&n; *&n; */
...
id|MIN_LUNS
suffix:semicolon
macro_line|#if USE_BIOS_MAX_LUNS
id|ha-&gt;max_luns
op_assign
id|le16_to_cpu
c_func
...
suffix:semicolon
multiline_comment|/* dg 02/26/02 ha-&gt;dpc_flags &amp;= ~(LOCAL_LOOP_UPDATE | RSCN_UPDATE); */
...
multiline_comment|/* Isolate error status. */
r_if
c_cond
(paren
id|rval
...
c_func
(paren
l_string|&quot;scsi(%ld): Loop down counter running= %d or &quot;
l_string|&quot;Resync needed- dpc flags= %ld&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|atomic_read
...
suffix:semicolon
multiline_comment|/* ???? dg 02/26/02  rval = 1; */
)brace
r_if
c_cond
(paren
...
multiline_comment|/*&n; * qla2x00_configure_local_loop&n; *&t;Updates Fibre Channel Device Database with local loop devices.&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&n; * Returns:&n; *&t;0 = success.&n; *&t;BIT_0 = error.&n; */
r_static
r_int
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * No point in continuing if the loop is in a volatile state -- &n;&t; * reschedule LOCAL_LOOP_UPDATE for later processing&n;&t; */
r_if
c_cond
(paren
id|test_bit
...
multiline_comment|/*&n; * qla2x00_find_all_fabric_devs&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&t;dev = database device entry pointer.&n; *&n; * Returns:&n; *&t;0 = success.&n; *&t;BIT_0 = error.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_static
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * start pending queue&n;&t; */
id|pending_q_cnt
op_assign
id|ha-&gt;qthreads
suffix:semicolon

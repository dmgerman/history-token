...
multiline_comment|/*&n; * qla2x00_print_q_info&n; * &t; Prints queue info&n; * Input&n; *      q: lun queue&t; &n; */
r_void
DECL|function|qla2x00_print_q_info
...
c_func
(paren
l_string|&quot;Queue info: flags=0x%lx&bslash;n&quot;
comma
id|q-&gt;q_flag
)paren
suffix:semicolon
...
multiline_comment|/**************************************************************************&n;*   qla2x00_panic&n;*&n;**************************************************************************/
r_static
r_void
DECL|function|qla2x00_panic
id|qla2x00_panic
c_func
(paren
r_char
...
c_func
(paren
l_string|&quot;qla2100 - PANIC:  %s&bslash;n&quot;
comma
id|cp
)paren
suffix:semicolon
...
macro_line|#endif
multiline_comment|/**************************************************************************&n;*   qla2x00_dump_requests&n;*&n;**************************************************************************/
r_void
DECL|function|qla2x00_dump_requests
id|qla2x00_dump_requests
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;(%d): Pid=%ld, sp flags=0x%x, cmd=0x%p&bslash;n&quot;
comma
id|i
comma

...
multiline_comment|/**&n; * qla2x00_gnn_id() - SNS Get Node Name (GNN_ID) query.&n; * @ha: HA context&n; * @list: switch info entries to populate&n; *&n; * Returns 0 on success.&n; */
r_int
...
c_func
(paren
l_string|&quot;scsi(%ld): RSNN_ID call unsupported on &quot;
l_string|&quot;ISP2200.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren
...
multiline_comment|/**&n; * qla2x00_prep_sns_cmd() - Prepare common SNS command request fields for query.&n; * @ha: HA context&n; * @cmd: GS command&n; * @scmd_len: Subcommand length&n; * @data_size: response size in bytes&n; *&n; * Returns a pointer to the @ha&squot;s sns_cmd.&n; */
r_static
r_inline
r_struct
id|sns_cmd_pkt
op_star
DECL|function|qla2x00_prep_sns_cmd
id|qla2x00_prep_sns_cmd
c_func
(paren
id|scsi_qla_host_t
...
l_int|2
suffix:semicolon
multiline_comment|/* Size in 16bit words. */
id|sns_cmd-&gt;p.cmd.buffer_length
op_assign
id|cpu_to_le16
c_func
(paren
...
suffix:semicolon
id|sns_cmd-&gt;p.cmd.buffer_address
(braket
l_int|0
)braket
op_assign
...
suffix:semicolon
id|sns_cmd-&gt;p.cmd.subcommand_length
op_assign
id|cpu_to_le16
c_func
(paren
...
l_int|4
suffix:semicolon
multiline_comment|/* Size in 32bit words. */
id|sns_cmd-&gt;p.cmd.size
op_assign
id|cpu_to_le16
c_func
(paren
...
multiline_comment|/**&n; * qla2x00_sns_ga_nxt() - SNS scan for fabric devices via GA_NXT command.&n; * @ha: HA context&n; * @fcport: fcport entry to updated&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_ga_nxt
id|qla2x00_sns_ga_nxt
c_func
(paren
id|scsi_qla_host_t
...
suffix:semicolon
multiline_comment|/* Issue GA_NXT. */
multiline_comment|/* Prepare SNS command request. */
id|sns_cmd
op_assign
id|qla2x00_prep_sns_cmd
c_func
...
id|GA_NXT_CMD
comma
id|GA_NXT_SNS_SCMD_LEN
comma
id|GA_NXT_SNS_DATA_SIZE
)paren
suffix:semicolon
multiline_comment|/* Prepare SNS command arguments -- port_id. */
id|sns_cmd-&gt;p.cmd.param
(braket
l_int|0
)braket
op_assign
...
id|fcport-&gt;d_id.b.domain
suffix:semicolon
multiline_comment|/* Execute SNS command. */
id|rval
op_assign
id|qla2x00_send_sns
c_func
...
c_func
(paren
l_string|&quot;scsi(%ld): GA_NXT Send SNS failed (%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
multiline_comment|/**&n; * qla2x00_sns_gid_pt() - SNS scan for fabric devices via GID_PT command.&n; * @ha: HA context&n; * @list: switch info entries to populate&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * NOTE: Non-Nx_Ports are not requested.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_gid_pt
id|qla2x00_sns_gid_pt
c_func
(paren
id|scsi_qla_host_t
...
id|GID_PT_CMD
comma
id|GID_PT_SNS_SCMD_LEN
comma
id|GID_PT_SNS_DATA_SIZE
)paren
suffix:semicolon
multiline_comment|/* Prepare SNS command arguments -- port_type. */
id|sns_cmd-&gt;p.cmd.param
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;scsi(%ld): GID_PT Send SNS failed (%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
multiline_comment|/**&n; * qla2x00_sns_gpn_id() - SNS Get Port Name (GPN_ID) query.&n; * @ha: HA context&n; * @list: switch info entries to populate&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_gpn_id
id|qla2x00_sns_gpn_id
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;scsi(%ld): GPN_ID Send SNS failed &quot;
l_string|&quot;(%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
...
(paren
l_string|&quot;scsi(%ld): GPN_ID failed, rejected &quot;
l_string|&quot;request, gpn_rsp:&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren
...
multiline_comment|/**&n; * qla2x00_sns_gnn_id() - SNS Get Node Name (GNN_ID) query.&n; * @ha: HA context&n; * @list: switch info entries to populate&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_gnn_id
id|qla2x00_sns_gnn_id
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;scsi(%ld): GNN_ID Send SNS failed &quot;
l_string|&quot;(%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
...
(paren
l_string|&quot;scsi(%ld): GNN_ID failed, rejected &quot;
l_string|&quot;request, gnn_rsp:&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren
...
multiline_comment|/**&n; * qla2x00_snd_rft_id() - SNS Register FC-4 TYPEs (RFT_ID) supported by the HBA.&n; * @ha: HA context&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_rft_id
id|qla2x00_sns_rft_id
c_func
(paren
id|scsi_qla_host_t
...
id|RFT_ID_CMD
comma
id|RFT_ID_SNS_SCMD_LEN
comma
id|RFT_ID_SNS_DATA_SIZE
)paren
suffix:semicolon
multiline_comment|/* Prepare SNS command arguments -- port_id, FC-4 types */
id|sns_cmd-&gt;p.cmd.param
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;scsi(%ld): RFT_ID Send SNS failed (%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;scsi(%ld): RFT_ID failed, rejected request, &quot;
l_string|&quot;rft_rsp:&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren
...
multiline_comment|/**&n; * qla2x00_sns_rff_id() - SNS Register FC-4 Features (RFF_ID) supported by the&n; * HBA.&n; * @ha: HA context&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_rff_id
id|qla2x00_sns_rff_id
c_func
(paren
id|scsi_qla_host_t
...
id|RFF_ID_CMD
comma
id|RFF_ID_SNS_SCMD_LEN
comma
id|RFF_ID_SNS_DATA_SIZE
)paren
suffix:semicolon
multiline_comment|/* Prepare SNS command arguments -- port_id, FC-4 feature, FC-4 type */
id|sns_cmd-&gt;p.cmd.param
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;scsi(%ld): RFF_ID Send SNS failed (%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;scsi(%ld): RFF_ID failed, rejected request, &quot;
l_string|&quot;rff_rsp:&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren
...
multiline_comment|/**&n; * qla2x00_sns_rnn_id() - SNS Register Node Name (RNN_ID) of the HBA.&n; * HBA.&n; * @ha: HA context&n; *&n; * This command uses the old Exectute SNS Command mailbox routine.&n; *&n; * Returns 0 on success.&n; */
r_static
r_int
DECL|function|qla2x00_sns_rnn_id
id|qla2x00_sns_rnn_id
c_func
(paren
id|scsi_qla_host_t
...
id|RNN_ID_CMD
comma
id|RNN_ID_SNS_SCMD_LEN
comma
id|RNN_ID_SNS_DATA_SIZE
)paren
suffix:semicolon
multiline_comment|/* Prepare SNS command arguments -- port_id, nodename. */
id|sns_cmd-&gt;p.cmd.param
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;scsi(%ld): RNN_ID Send SNS failed (%d).&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;scsi(%ld): RNN_ID failed, rejected request, &quot;
l_string|&quot;rnn_rsp:&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
)paren

...
suffix:semicolon
multiline_comment|/***************************/
multiline_comment|/* Function implementation */
multiline_comment|/***************************/
r_static
r_void
...
multiline_comment|/*&n; *  tov = timeout value in seconds&n; */
r_static
r_int
DECL|function|qla2x00_get_mbx_access
id|qla2x00_get_mbx_access
c_func
(paren
id|scsi_qla_host_t
...
l_int|1
suffix:semicolon
multiline_comment|/* assume no access yet */
id|mbx_cmdq_t
op_star
id|ptmp_mbq
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): going &quot;
l_string|&quot; to test access flags.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
)paren
multiline_comment|/* No one else is waiting. Go ahead and try to&n;&t;&t;&t; * get access.&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* wait for previous command to finish */
id|DEBUG
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): access &quot;
l_string|&quot;flags=%lx. busy. Waiting for access. curr time=0x%lx.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|ha-&gt;mbx_cmd_flags
...
multiline_comment|/*&n;&t;&t; * Init timer and get semaphore from mbx q. After we got valid&n;&t;&t; * semaphore pointer the MBX_CMD_WANT flag would also had&n;&t;&t; * been set.&n;&t;&t; */
id|qla2x00_mbx_q_add
c_func
(paren
id|ha
...
(brace
multiline_comment|/* queue full? problem? can&squot;t proceed. */
id|DEBUG2_3_11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): ERROR &quot;
l_string|&quot;no more mbx_q allowed. exiting.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/* init timer and semaphore */
id|init_timer
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;get_mbx_access(%ld): adding timer. &quot;
l_string|&quot;curr time=0x%lx timeoutval=0x%lx.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|jiffies
...
multiline_comment|/*&t; &t; add_timer(&amp;tmp_cmd_timer);*/
id|DEBUG11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;get_mbx_access(%ld): going to sleep. &quot;
...
c_func
(paren
l_string|&quot;get_mbx_access(%ld): woke up. current &quot;
...
multiline_comment|/*&t;&t;del_timer(&amp;tmp_cmd_timer);*/
multiline_comment|/* try to get lock again. we&squot;ll test later to see&n;&t;&t; * if we actually got the lock.&n;&t;&t; */
id|prev_val
op_assign
id|test_and_set_bit
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * After we tried to get access then we check to see&n;&t;&t; * if we need to clear the MBX_CMD_WANT flag. Don&squot;t clear&n;&t;&t; * this flag before trying to get access or else another&n;&t;&t; * new thread might grab it before we did.&n;&t;&t; */
...
(brace
multiline_comment|/* We&squot;re the last thread in queue. */
id|clear_bit
c_func
(paren
id|MBX_CMD_WANT
...
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): success.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Timeout or resource error. */
id|DEBUG2_3_11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_get_mbx_access(%ld): timed out.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
r_static
r_int
DECL|function|qla2x00_release_mbx_access
id|qla2x00_release_mbx_access
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;qla2x00_release_mbx_access:(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Wake up one pending mailbox cmd thread in queue. */
id|qla2x00_mbx_q_get
c_func
(paren
id|ha
...
c_func
(paren
l_string|&quot;qla2x00_release_mbx_access: found pending &quot;
l_string|&quot;mbx cmd. Waking up sem in %p.&bslash;n&quot;
comma
op_amp
id|next_thread
)paren
...
c_func
(paren
l_string|&quot;qla2x00_release_mbx_access:(%ld): exiting.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/* Allocates a mbx_cmdq_t struct and add to the mbx_q list. */
r_static
r_int
DECL|function|qla2x00_mbx_q_add
id|qla2x00_mbx_q_add
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_add: got mbx_q spinlock. &quot;
l_string|&quot;Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
suffix:semicolon
...
(brace
multiline_comment|/* can&squot;t add any more threads */
id|DEBUG2_3_11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_mbx_q_add: ERROR no more &quot;
l_string|&quot;ioctl threads allowed. Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
suffix:semicolon
...
(brace
multiline_comment|/* First thread to queue. */
id|set_bit
c_func
(paren
id|MBX_CMD_WANT
...
id|ptmp
suffix:semicolon
multiline_comment|/* Now init the semaphore */
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_add: going to release spinlock. &quot;
l_string|&quot;ret_mbq=%p, ret=%d. Inst=%d.&bslash;n&quot;
comma
op_star
id|ret_mbq
comma
...
multiline_comment|/* Just remove and return first member from mbx_cmdq.  Don&squot;t free anything. */
r_static
r_void
DECL|function|qla2x00_mbx_q_get
id|qla2x00_mbx_q_get
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_get: got mbx_q spinlock. &quot;
l_string|&quot;Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
...
multiline_comment|/* Remove from head */
op_star
id|ret_mbq
op_assign
id|ha-&gt;mbx_q_head
...
(brace
multiline_comment|/* That&squot;s the last one in queue. */
id|ha-&gt;mbx_q_tail
op_assign
l_int|NULL
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_remove: return ret_mbq=%p. Going to &quot;
l_string|&quot;release spinlock. Inst=%d.&bslash;n&quot;
comma
op_star
id|ret_mbq
comma
...
multiline_comment|/* Find a free mbx_q member from the array. Must already got the&n; * mbx_q_lock spinlock.&n; */
r_static
r_void
DECL|function|qla2x00_mbx_q_memb_alloc
id|qla2x00_mbx_q_memb_alloc
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_memb_alloc: entered. &quot;
l_string|&quot;Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
...
r_else
(brace
multiline_comment|/* We ran out of pre-allocated semaphores.  Try to allocate&n;&t;&t; * a new one.&n;&t;&t; */
id|ptmp
op_assign
id|kmalloc
c_func
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_memb_alloc: return waitq_memb=%p. &quot;
l_string|&quot;Inst=%d.&bslash;n&quot;
comma
op_star
id|ret_mbx_q_memb
...
multiline_comment|/* Add the specified mbx_q member back to the free semaphore pool. Must&n; * already got the mbx_q_lock spinlock.&n; */
r_static
r_void
DECL|function|qla2x00_mbx_q_memb_free
id|qla2x00_mbx_q_memb_free
c_func
(paren
id|scsi_qla_host_t
...
c_func
(paren
l_string|&quot;qla2x00_mbx_q_memb_free: entered. Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Add to tail */
id|ha-&gt;mbx_sem_pool_tail-&gt;pnext
op_assign
id|pfree_mbx_q_memb
suffix:semicolon
)brace
...
multiline_comment|/* put it back to the free pool. */
id|DEBUG11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_mbx_q_memb_free: exiting. &quot;
l_string|&quot;Inst=%d.&bslash;n&quot;
comma
id|apiHBAInstance
)paren
...
multiline_comment|/*&n; * qla2x00_read_ram_word&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_read_ram_word
...
c_func
(paren
l_string|&quot;qla2x00_read_ram_word(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_read_ram_word(%ld): failed=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;qla2x00_read_ram_word(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/*&n; * qla2x00_write_ram_word&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_write_ram_word
...
c_func
(paren
l_string|&quot;qla2x00_write_ram_word(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_write_ram_word(%ld): failed=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;qla2x00_write_ram_word(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/*&n; * qla2x00_write_ram_word_ext&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_write_ram_word_ext
...
op_assign
id|MBC_WRITE_RAM_WORD_EXTENDED
suffix:semicolon
id|mcp-&gt;mb
(braket
l_int|1
...
c_func
(paren
l_string|&quot;qla2x00_issue_iocb: started&quot;
)paren
suffix:semicolon
id|mcp-&gt;mb
(braket
...
c_func
(paren
l_string|&quot;qla2x00_issue_iocb: exiting normally&quot;
)paren
suffix:semicolon
)brace
r_return
...
multiline_comment|/*&n; * qla2x00_abort_device&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *      loop_id  = FC loop ID&n; *      lun  = SCSI LUN.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_abort_device
...
c_func
(paren
l_string|&quot;qla2x00_abort_device(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_abort_device(%ld): failed=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
c_func
(paren
l_string|&quot;qla2x00_abort_device(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/*&n; * qla2x00_get_link_status&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&t;loop_id = device loop ID.&n; *&t;ret_buf = pointer to link status return buffer.&n; *&n; * Returns:&n; *&t;0 = success.&n; *&t;BIT_0 = mem alloc error.&n; *&t;BIT_1 = mailbox error.&n; */
r_uint8
DECL|function|qla2x00_get_link_status
...
c_func
(paren
l_string|&quot;qla2x00_get_link_status(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_get_link_status(%ld): Failed to &quot;
...
c_func
(paren
l_string|&quot;qla2x00_get_link_status(%ld): cmd &quot;
l_string|&quot;failed. mbx0=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|mcp-&gt;mb
...
c_func
(paren
l_string|&quot;qla2x00_get_link_status(%ld): stat &quot;
l_string|&quot;dump: fail_cnt=%d loss_sync=%d loss_sig=%d &quot;
l_string|&quot;seq_err=%d inval_xmt_word=%d inval_crc=%d.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|stat_buf-&gt;link_fail_cnt
...
c_func
(paren
l_string|&quot;qla2x00_get_link_status(%ld): failed=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|rval
...
id|MBX_DMA_IN
suffix:semicolon
multiline_comment|/*mcp-&gt;tov = ha-&gt;retry_count * ha-&gt;login_timeout * 2;*/
id|mcp-&gt;tov
op_assign
id|ha-&gt;login_timeout
op_star
...
macro_line|#if 0 /* not yet needed */
r_int
id|qla2x00_dump_ram
c_func
(paren
...
macro_line|#endif
multiline_comment|/*&n; * qla2x00_lun_reset&n; *&t;Issue lun reset mailbox command.&n; *&n; * Input:&n; *&t;ha = adapter block pointer.&n; *&t;loop_id = device loop ID.&n; *      lun = lun to be reset.&n; *&t;TARGET_QUEUE_LOCK must be released.&n; *&t;ADAPTER_STATE_LOCK must be released.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_lun_reset
...
(paren
id|KERN_WARNING
l_string|&quot;qla2x00_lun_reset(%d): failed = %d&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;qla2x00_lun_reset: exiting normally&quot;
)paren
suffix:semicolon
)brace
r_return
...
multiline_comment|/*&n; * qla2x00_send_rnid_mbx&n; *&t;Issue RNID ELS using mailbox command&n; *&n; * Input:&n; *&t;ha = adapter state pointer.&n; *&t;loop_id = loop ID of the target device.&n; *&t;data_fmt = currently supports only 0xDF.&n; *&t;buffer = buffer pointer.&n; *&t;buf_size = size of buffer.&n; *&t;mb_reg = pointer to return mailbox registers.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_send_rnid_mbx
...
c_func
(paren
l_string|&quot;qla2x00_send_rnid_mbx(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* 2 status regs */
id|DEBUG2_3_11
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;qla2x00_send_rnid_mbx(%ld): failed=%x &quot;
l_string|&quot;mb[1]=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
...
c_func
(paren
l_string|&quot;qla2x00_send_rnid_mbx(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/*&n; * qla2x00_set_rnid_params_mbx&n; *&t;Set RNID parameters using mailbox command&n; *&n; * Input:&n; *&t;ha = adapter state pointer.&n; *&t;buffer = buffer pointer.&n; *&t;buf_size = size of buffer.&n; *&t;mb_reg = pointer to return mailbox registers.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_set_rnid_params_mbx
...
c_func
(paren
l_string|&quot;qla2x00_set_rnid_params_mbx(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_set_rnid_params_mbx(%ld): &quot;
l_string|&quot;failed=%x mb[1]=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
id|mcp-&gt;mb
...
c_func
(paren
l_string|&quot;qla2x00_set_rnid_params_mbx(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
multiline_comment|/*&n; * qla2x00_get_rnid_params_mbx&n; *&t;Get RNID parameters using mailbox command&n; *&n; * Input:&n; *&t;ha = adapter state pointer.&n; *&t;buffer = buffer pointer.&n; *&t;buf_size = size of buffer.&n; *&t;mb_reg = pointer to return mailbox registers.&n; *&n; * Returns:&n; *&t;qla2x00 local function return status code.&n; *&n; * Context:&n; *&t;Kernel context.&n; */
r_int
DECL|function|qla2x00_get_rnid_params_mbx
...
c_func
(paren
l_string|&quot;qla2x00_get_rnid_params_mbx(%ld): entered.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qla2x00_get_rnid_params_mbx(%ld): &quot;
l_string|&quot;failed=%x mb[1]=%x.&bslash;n&quot;
comma
id|ha-&gt;host_no
comma
...
c_func
(paren
l_string|&quot;qla2x00_get_rnid_params_mbx(%ld): done.&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon

...
multiline_comment|/*&n; * Function : mac_esp_setup(char *str)&n; *&n; * Purpose : booter command line initialization of the overrides array,&n; *&n; * Inputs : str - parameters, separated by commas.&n; *&n; * Currently unused in the new driver; need to add settable parameters to the &n; * detect function.&n; *&n; */
...
c_func
(paren
l_string|&quot;mac_esp_setup: invalid number of hosts %ld !&bslash;n&quot;
comma
id|opt
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;mac_esp_setup: invalid host ID %ld !&bslash;n&quot;
comma
id|opt
)paren
suffix:semicolon

...
multiline_comment|/* default: activate /proc and character device IOCTL interface */
DECL|macro|GDTH_IOCTL_PROC
mdefine_line|#define GDTH_IOCTL_PROC
DECL|macro|GDTH_IOCTL_CHRDEV
mdefine_line|#define GDTH_IOCTL_CHRDEV
...
macro_line|#elif LINUX_VERSION_CODE &gt;= 0x020126
DECL|macro|GDTH_INITFUNC
mdefine_line|#define GDTH_INITFUNC(type, func)       __initfunc(type func)
macro_line|#include &lt;linux/init.h&gt;
macro_line|#else
DECL|macro|GDTH_INITFUNC
mdefine_line|#define GDTH_INITFUNC(type, func)       type func
...
suffix:semicolon
macro_line|#endif
macro_line|#if LINUX_VERSION_CODE &gt;= 0x02040B
id|MODULE_LICENSE
c_func
(paren
l_string|&quot;GPL&quot;
...
macro_line|#elif LINUX_VERSION_CODE &gt;= 0x2015C
id|pdev
op_assign
l_int|NULL
suffix:semicolon
...
c_func
(paren
l_string|&quot;GDT CTR%d Vendor: %s&bslash;n&quot;
comma
id|hanum
comma
...
c_func
(paren
l_string|&quot;GDT: Storage RAID Controller Driver. Version: %s &bslash;n&quot;
comma
id|GDTH_VERSION_STR
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;GDT: Found %d PCI Storage RAID Controllers&bslash;n&quot;
comma
id|cnt
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;GDT CTR%d: Configuring GDT-PCI HA at %d/%d IRQ %u&bslash;n&quot;
comma
id|ctr
comma
id|pcistr
...
id|res.ionode
suffix:semicolon
multiline_comment|/* Because we need a Scsi_Cmnd struct., we make a scsi_allocate device also for kernels &gt;=2.5.x */
macro_line|#if LINUX_VERSION_CODE &gt;= 0x02053C
id|sdev
op_assign
id|scsi_get_host_dev
...
macro_line|#endif
macro_line|#if LINUX_VERSION_CODE &lt; 0x020400 &amp;&amp; !defined(MODULE)
DECL|function|GDTH_INITFUNC
id|GDTH_INITFUNC
c_func
(paren

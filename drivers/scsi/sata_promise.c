...
l_int|0x00200000
comma
DECL|enumerator|PDC_20621_HOST_PRD
id|PDC_20621_HOST_PRD
op_assign
l_int|64
comma
DECL|enumerator|PDC_20621_ATA_PRD
id|PDC_20621_ATA_PRD
op_assign
l_int|72
comma
...
DECL|function|pdc20621_pkt_header
r_static
r_inline
r_int
r_int
id|pdc20621_pkt_header
c_func
(paren
r_struct
id|ata_taskfile
...
suffix:semicolon
multiline_comment|/* copy two packets and three S/G tables to DIMM MMIO window */
id|memcpy_toio
c_func
(paren
id|dimm_mmio
...
multiline_comment|/* if reading, we (1) do ATA command, then (2) DMA from DIMM */
r_else
(brace
id|pkt_addr
op_assign

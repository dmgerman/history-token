...
c_cond
(paren
id|StatusRegister.HostAdapterReady
op_logical_and
op_logical_neg
id|StatusRegister.CommandParameterRegisterBusy
)paren
r_break
suffix:semicolon
id|udelay
...
c_cond
(paren
id|InterruptRegister.CommandComplete
)paren
r_break
suffix:semicolon
r_if
...
c_cond
(paren
id|StatusRegister.DataInRegisterReady
)paren
r_break
suffix:semicolon
r_if
...
c_cond
(paren
id|StatusRegister.CommandInvalid
)paren
(brace
id|BusLogic_CommandFailureReason
op_assign
...
op_logical_or
op_logical_neg
id|StatusRegister.InitializationRequired
op_logical_or
id|StatusRegister.DiagnosticActive
op_logical_or
id|StatusRegister.DiagnosticFailure
)paren
(brace
...
id|HostAdapter-&gt;ExtendedTranslationEnabled
op_assign
id|GeometryRegister.ExtendedTranslationEnabled
suffix:semicolon
...
c_cond
(paren
id|InterruptRegister.InterruptValid
)paren
(brace
...
c_cond
(paren
id|InterruptRegister.ExternalBusReset
)paren
...
c_cond
(paren
id|InterruptRegister.IncomingMailboxLoaded
)paren
id|BusLogic_ScanIncomingMailboxes
c_func
(paren
...
multiline_comment|/*&n; * Initialization function&n; */

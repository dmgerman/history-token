...
c_func
(paren
l_string|&quot;Rickard E. Faith&quot;
)paren
suffix:semicolon
id|MODULE_DESCRIPTION
c_func
(paren
l_string|&quot;Future domain SCSI driver&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
suffix:semicolon
DECL|macro|VERSION
mdefine_line|#define VERSION          &quot;$Revision: 5.51 $&quot;
...
suffix:semicolon
multiline_comment|/* .bss will zero all the static variables below */
...
macro_line|#endif
DECL|function|__fdomain_16x0_detect
r_struct
id|Scsi_Host
op_star
...
c_func
(paren
l_string|&quot;scsi: &lt;fdomain&gt; port 0x%x is busy&bslash;n&quot;
comma
id|port_base
)paren
suffix:semicolon
...
multiline_comment|/* Check for other IRQ sources */
r_if
c_cond
(paren
(paren

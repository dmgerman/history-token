...
id|name
op_assign
l_string|&quot;EATA/DMA 2.0x rev. 8.10.00 &quot;
comma
dot
id|detect
op_assign
...
DECL|macro|TAG_DISABLED
mdefine_line|#define TAG_DISABLED 0
DECL|macro|TAG_SIMPLE
mdefine_line|#define TAG_SIMPLE   1
DECL|macro|TAG_ORDERED
mdefine_line|#define TAG_ORDERED  2
DECL|macro|REG_CMD
...
mdefine_line|#define REGION_SIZE     9UL
...
DECL|macro|EATA_SIG_BE
mdefine_line|#define EATA_SIG_BE 0x45415441
...
id|cp_dma_addr
suffix:semicolon
multiline_comment|/* dma handle for this cp structure */
DECL|member|sglist
r_struct
id|sg_list
op_star
id|sglist
suffix:semicolon
multiline_comment|/* pointer to the allocated SG list */
)brace
suffix:semicolon
DECL|macro|CP_TAIL_SIZE
mdefine_line|#define CP_TAIL_SIZE (sizeof(struct sglist *) + sizeof(dma_addr_t))
...
suffix:semicolon
multiline_comment|/* If 1 redo i/o on target */
DECL|member|retries
r_int
r_int
id|retries
...
id|is_pci
suffix:semicolon
multiline_comment|/* 1 is bus type is PCI */
DECL|member|pdev
r_struct
id|pci_dev
op_star
id|pdev
suffix:semicolon
multiline_comment|/* pdev for PCI bus, NULL otherwise */
DECL|member|sp_cpu_addr
r_struct
id|mssp
op_star
id|sp_cpu_addr
suffix:semicolon
multiline_comment|/* cpu addr for DMA buffer sp */
DECL|member|sp_dma_addr
id|dma_addr_t
id|sp_dma_addr
suffix:semicolon
multiline_comment|/* dma handle for DMA buffer sp */
DECL|member|sp
r_struct
id|mssp
id|sp
suffix:semicolon
multiline_comment|/* Local copy of sp buffer */
)brace
suffix:semicolon
DECL|variable|sh
r_static
...
suffix:semicolon
multiline_comment|/* Device is Big Endian */
DECL|macro|H2DEV
mdefine_line|#define H2DEV(x)   cpu_to_be32(x)
DECL|macro|DEV2H
mdefine_line|#define DEV2H(x)   be32_to_cpu(x)
DECL|macro|H2DEV16
mdefine_line|#define H2DEV16(x) cpu_to_be16(x)
DECL|macro|DEV2H16
mdefine_line|#define DEV2H16(x) be16_to_cpu(x)
multiline_comment|/* But transfer orientation from the 16 bit data register is Little Endian */
DECL|macro|REG2H
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined(CONFIG_EISA)
DECL|variable|eisa_probe
r_static
r_int
id|eisa_probe
op_assign
...
DECL|macro|MAX_BOOT_OPTIONS_SIZE
mdefine_line|#define MAX_BOOT_OPTIONS_SIZE 256
DECL|variable|boot_options
r_static
r_char
id|boot_options
(braket
id|MAX_BOOT_OPTIONS_SIZE
)braket
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: get_pci_dev, bus %d, devfn 0x%x, addr 0x%x.&bslash;n&quot;
comma
id|driver_name
comma
id|dev-&gt;bus-&gt;number
...
c_func
(paren
l_string|&quot;%s: enable_pci_ports, bus %d, devfn 0x%x.&bslash;n&quot;
comma
id|driver_name
comma
id|dev-&gt;bus-&gt;number
...
c_func
(paren
l_string|&quot;%s: detect, do_dma failed at 0x%03lx.&bslash;n&quot;
comma
id|name
comma
id|port_base
...
c_func
(paren
l_string|&quot;%s: detect, read_pio failed at 0x%03lx.&bslash;n&quot;
comma
id|name
comma
id|port_base
...
c_func
(paren
l_string|&quot;%s: signature 0x%04x discarded.&bslash;n&quot;
comma
id|name
comma
id|info.sign
...
c_func
(paren
l_string|&quot;%s: warning, port address has been forced.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: pci_alloc_consistent failed, detaching.&bslash;n&quot;
comma
id|ha-&gt;board_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: warning, pci_set_dma_mask failed.&bslash;n&quot;
comma
id|ha-&gt;board_name
)paren
suffix:semicolon
...
(brace
multiline_comment|/* If we get here with PCI_DMA_NONE, pci_map_single triggers a BUG() */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;%s: qcomm, invalid SCpnt-&gt;sc_data_direction.&bslash;n&quot;
comma
id|ha-&gt;board_name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Set pointer to status packet structure, Big Endian format */
id|cpp-&gt;sp_dma_addr
op_assign
id|H2DEV
c_func
...
suffix:semicolon
multiline_comment|/* Use data transfer direction SCpnt-&gt;sc_data_direction */
id|scsi_to_dev_dir
c_func
(paren
id|i
...
suffix:semicolon
multiline_comment|/* Map DMA buffers and SG list */
id|map_dma
c_func
(paren
id|i
...
DECL|function|eata2x_eh_host_reset
r_static
r_int
id|eata2x_eh_host_reset
c_func
...
DECL|function|eata2x_bios_param
r_int
id|eata2x_bios_param
c_func
(paren
...
c_func
(paren
l_string|&quot;%s: ihdlr, irq %d, shost-&gt;irq %d.&bslash;n&quot;
comma
id|ha-&gt;board_name
comma
id|irq

...
(brace
singleline_comment|//(u32)(pSRB-&gt;pcmd-&gt;cmnd[0]) = pSRB-&gt;Segment0[0];
id|pSRB-&gt;TotalXferredLen
op_assign
...
id|AUTO_REQSENSE
suffix:semicolon
singleline_comment|//pSRB-&gt;Segment0[0] = (u32) pSRB-&gt;CmdBlock[0];
singleline_comment|//pSRB-&gt;Segment0[1] = (u32) pSRB-&gt;CmdBlock[4];
singleline_comment|//pSRB-&gt;Segment1[0] = ((u32)(pcmd-&gt;cmd_len) &lt;&lt; 8) + pSRB-&gt;SGcount;
...
multiline_comment|/* We are called from SRBdone, original PCI mapping has been removed&n;     * already, new one is set up from StartSCSI */
id|pSRB-&gt;SGIndex
op_assign
l_int|0
suffix:semicolon
...
singleline_comment|//(u16) pSRB-&gt;CmdBlock[2] = 0;
singleline_comment|//(u16) pSRB-&gt;CmdBlock[4] = sizeof(pcmd-&gt;sense_buffer);

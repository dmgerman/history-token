multiline_comment|/***************************************************************************&n;                          dpti_ioctl.h  -  description&n;                             -------------------&n;    begin                : Thu Sep 7 2000&n;    copyright            : (C) 2001 by Adaptec&n;    email                : deanna_bonds@adaptec.com&n;&n;    See Documentation/scsi/dpti.txt for history, notes, license info&n;    and credits&n; ***************************************************************************/

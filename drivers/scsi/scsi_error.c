...
c_func
(paren
l_string|&quot;scsi_test_unit_ready: SCpnt %p eh_state %x&bslash;n&quot;
comma
id|SCpnt
comma
id|SCpnt-&gt;eh_state
...
c_func
(paren
l_string|&quot;scsi_send_eh_cmnd: scsi_eh_completed_normally %x&bslash;n&quot;
comma
id|ret
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;scsi: device set offline - not ready or command retry failed after bus reset: host %d channel %d id %d lun %d&bslash;n&quot;
comma
id|SDloop-&gt;host-&gt;host_no
comma
id|SDloop-&gt;channel
comma
id|SDloop-&gt;id
...
(paren
id|KERN_INFO
l_string|&quot;scsi: device set offline - not ready or command retry failed after host reset: host %d channel %d id %d lun %d&bslash;n&quot;
comma
id|SDloop-&gt;host-&gt;host_no
comma
id|SDloop-&gt;channel
...
(paren
id|KERN_INFO
l_string|&quot;scsi: device set offline - command error recover failed: host %d channel %d id %d lun %d&bslash;n&quot;
comma
id|SDloop-&gt;host-&gt;host_no
comma
id|SDloop-&gt;channel
...
multiline_comment|/*&n; * Function:&t;scsi_new_reset&n; *&n; * Purpose:&t;Send requested reset to a bus or device at any phase.&n; *&n; * Arguments:&t;SCpnt&t;- command ptr to send reset with (usually a dummy)&n; *&t;&t;flag - reset type (see scsi.h)&n; *&n; * Returns:&t;SUCCESS/FAILURE.&n; *&n; * Notes:&t;This is used by the SCSI Generic driver to provide&n; *&t;&t;Bus/Device reset capability.&n; */
r_int

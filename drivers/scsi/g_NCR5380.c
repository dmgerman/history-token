...
(paren
id|KERN_ERR
l_string|&quot;dtc436e probe: attach failed&bslash;n&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;dtc436e probe: no valid port&bslash;n&quot;
)paren
suffix:semicolon
id|pnp_device_detach
c_func
...
(brace
multiline_comment|/* At this point we have our region reserved */
id|outb
c_func
(paren
l_int|0x59
...
r_else
(brace
multiline_comment|/* Not a 53C400A style setup - just grab */
r_if
c_cond
(paren
op_logical_neg
...
id|name
op_assign
l_string|&quot;Generic NCR5380/NCR53C400 Scsi Driver&quot;
comma
dot
id|detect
op_assign

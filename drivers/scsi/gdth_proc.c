...
c_func
(paren
l_string|&quot;GDT: Wrong signature %x (%x required)!&bslash;n&quot;
comma
id|piowr-&gt;magic
comma
id|GDTIOCTL_MAGIC
...
c_func
(paren
l_string|&quot;GDT: Please update your driver.&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|printk
c_func
(paren
l_string|&quot;GDT: Please update your tool.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace
...
id|piord-&gt;iu.ctrtype.device_id
op_assign
id|ha-&gt;stype
suffix:semicolon
id|piord-&gt;iu.ctrtype.sub_device_id
op_assign
id|ha-&gt;subdevice_id
suffix:semicolon
)brace
...
l_int|0
suffix:colon
id|piowr-&gt;iu.scsi.bus
suffix:semicolon
id|scp-&gt;cmd_len
op_assign
id|piowr-&gt;iu.scsi.cmd_len
suffix:semicolon
id|gdth_do_cmd
c_func
(paren
...
suffix:semicolon
macro_line|#if LINUX_VERSION_CODE &gt;= 0x02053C
(brace
id|Scsi_Device
op_star
id|sdev
...
id|ENOMEM
suffix:semicolon
id|scmnd-&gt;device-&gt;host
op_assign
id|scp-&gt;sr_host
suffix:semicolon
id|scmnd-&gt;device-&gt;channel
op_assign
id|virt_ctr
ques
c_cond
...
macro_line|#elif LINUX_VERSION_CODE &gt;= 0x020503
(brace
id|Scsi_Cmnd
id|scmnd
suffix:semicolon
...
c_cond
(paren
id|piowr-&gt;iu.rescan.flag
op_eq
l_int|0
)paren
(brace
multiline_comment|/* old method: scan all host drives &n;               re-initialize cache service to get host drive count&n;            */
id|gdtcmd.Service
op_assign
id|CACHESERVICE
suffix:semicolon
...
(brace
multiline_comment|/* info about host drive */
id|gdtcmd.Service
op_assign
id|CACHESERVICE
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* next host drive */
multiline_comment|/* devtype, cluster info, R/W attributes */
id|gdtcmd.Service
op_assign
id|CACHESERVICE
suffix:semicolon
...
macro_line|#endif
macro_line|#ifdef GDTH_IOCTL_PROC
multiline_comment|/* ioctl from tool? */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
macro_line|#elif LINUX_VERSION_CODE &gt;= 0x020407
id|scp-&gt;request.rq_status
op_assign
id|RQ_SCSI_DONE
suffix:semicolon

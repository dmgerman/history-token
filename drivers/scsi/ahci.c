...
suffix:semicolon
id|pp-&gt;cmd_slot-&gt;status
op_assign
l_int|0
suffix:semicolon
id|pp-&gt;cmd_slot-&gt;tbl_addr
op_assign
id|cpu_to_le32
c_func
(paren
...
(brace
multiline_comment|/* do everything in exec command */
)brace
DECL|function|ahci_exec_command
r_static
r_void
id|ahci_exec_command
c_func
...
multiline_comment|/* make sure we&squot;re in AHCI mode, with irq disabled */
r_if
c_cond
(paren
(paren
...
id|KERN_ERR
id|DRV_NAME
l_string|&quot;(%s): AHCI enable failed (0x%x)&bslash;n&quot;
comma
id|pci_name
c_func
(paren

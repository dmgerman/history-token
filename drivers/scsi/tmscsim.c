...
c_func
(paren
l_string|&quot;Scanning target %02x lun %02x&bslash;n&quot;
comma
id|cmd-&gt;device-&gt;id
comma
id|cmd-&gt;device-&gt;lun
...
(paren
id|KERN_ERR
l_string|&quot;DC390: no DCB found, target %02x lun %02x&bslash;n&quot;
comma
id|cmd-&gt;device-&gt;id
comma
id|cmd-&gt;device-&gt;lun
...
(paren
id|KERN_ERR
l_string|&quot;%s() called for non-existing device!&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

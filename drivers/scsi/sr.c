...
multiline_comment|/* Get space for scatterlist and bounce buffer array. */
id|i
op_assign
id|sg_ent
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * no more failing memory allocs possible, we can safely assign&n;&t; * SCpnt values now&n;&t; */
id|SCpnt-&gt;sglist_len
op_assign
id|i
suffix:semicolon

...
DECL|function|sr_device_kdev_read
r_static
id|ssize_t
id|sr_device_kdev_read
c_func
(paren
r_struct
id|device
...
DECL|variable|sr_device_kdev_file
r_static
r_struct
id|driver_file_entry
id|sr_device_kdev_file
op_assign
(brace
id|name
suffix:colon
...
suffix:semicolon
DECL|function|sr_device_type_read
r_static
id|ssize_t
id|sr_device_type_read
c_func
(paren
r_struct
id|device
...
DECL|variable|sr_device_type_file
r_static
r_struct
id|driver_file_entry
id|sr_device_type_file
op_assign
(brace
id|name
suffix:colon
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;FIXME: someone needs to handle a get_capabilities&n;&t;&t; *&t;failure properly ??&n;&t;&t; */
id|get_capabilities
c_func
(paren
id|i
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Since the cdrom is read-only, no need to sync&n;&t;&t;&t; * the device.&n;&t;&t;&t; * We should be kind to our buffer cache, however.&n;&t;&t;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Reset things back to a sane state so that one can&n;&t;&t;&t; * re-load a new driver (perhaps the same one).&n;&t;&t;&t; */
id|unregister_cdrom
c_func
(paren
op_amp
...
(brace
id|sr_template.scsi_driverfs_driver.name
op_assign
(paren
r_char
op_star
...
id|sr_template.tag
suffix:semicolon
id|sr_template.scsi_driverfs_driver.bus
op_assign
op_amp
id|scsi_driverfs_bus_type
suffix:semicolon
...
(paren
op_amp
id|sr_template.scsi_driverfs_driver
)paren
suffix:semicolon
)brace
r_return

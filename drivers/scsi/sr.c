...
c_func
(paren
l_string|&quot;Doing sr request, dev = %d&bslash;n&quot;
comma
id|devm
)paren
)paren
...
id|cleanup_sizes
suffix:semicolon
multiline_comment|/*&n;&t; * These are good guesses for the time being.&n;&t; * Don&squot;t set sr_hardsizes here! That will prevent reading anything smaller.&n;&t; */
r_for
c_loop
(paren
id|i

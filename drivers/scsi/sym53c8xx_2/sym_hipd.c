...
id|tinfo.goal
suffix:semicolon
multiline_comment|/* here we enforce all the fiddly SPI rules */
r_if
c_cond
(paren
op_logical_neg
...
r_else
(brace
multiline_comment|/*&n;&t;&t; *  negotiate wide transfers ?&n;&t;&t; */
r_if
c_cond
(paren
...
id|NS_WIDE
suffix:semicolon
multiline_comment|/*&n;&t;&t; *  negotiate synchronous transfers?&n;&t;&t; */
r_else
r_if
c_cond
(paren

...
suffix:semicolon
multiline_comment|/*&n; *  Print a buffer in hexadecimal format with a &quot;.&bslash;n&quot; at end.&n; */
...
suffix:semicolon
multiline_comment|/* Enable clock multiplier */
...
suffix:semicolon
multiline_comment|/* Halt the scsi clock&t;*/
id|OUTB
c_func
(paren
id|np
...
suffix:semicolon
multiline_comment|/* Restart scsi clock &t;*/
)brace
...
c_func
(paren
l_string|&quot;%s: %s, ID %d, Fast-%d, %s, %s&bslash;n&quot;
comma
id|sym_name
c_func
(paren
...
suffix:semicolon
DECL|macro|sym_num_devs
mdefine_line|#define sym_num_devs &bslash;&n;&t;(sizeof(sym_dev_table) / sizeof(sym_dev_table[0]))
multiline_comment|/*&n; *  Look up the chip table.&n; *&n; *  Return a pointer to the chip entry if found, &n; *  zero otherwise.&n; */
r_struct
id|sym_chip
op_star
DECL|function|sym_lookup_chip_table
...
macro_line|#endif
multiline_comment|/* Enforce all the fiddly SPI rules and the chip limitations */
DECL|function|sym_check_goals
r_static
r_void
id|sym_check_goals
c_func
...
multiline_comment|/* Some targets fail to properly negotiate DT in SE mode */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* all DT transfers must be wide */
id|goal-&gt;width
op_assign
l_int|1
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Many devices implement PPR in a buggy way, so only use it if we&n;&t; * really want to.&n;&t; */
r_if
c_cond
(paren
id|goal-&gt;iu
...
multiline_comment|/*&n; *  Switch trans mode for current job and its target.&n; */
...
l_int|NULL
suffix:semicolon
multiline_comment|/* gcc isn&squot;t quite smart enough yet */
r_struct
id|scsi_target
op_star
id|starget
...
l_int|0
suffix:semicolon
multiline_comment|/* We don&squot;t expect to fail here */
id|np-&gt;abrt_msg
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Retrieve the lun descriptor.&n;&t; */
id|lp
op_assign
id|sym_lp
c_func
...
id|sdev-&gt;sdev_gendev
comma
l_string|&quot;CCB=%p STAT=%x/%x/%x&bslash;n&quot;
comma
id|cp
comma
id|cp-&gt;host_status
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Wrong transfer residuals may be worse than just always &n;&t; *  returning zero. User can disable this feature in &n;&t; *  sym53c8xx.h. Residual support is enabled by default.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Initialization for optional handling &n;&t; *  of device queueing.&n;&t; */
macro_line|#ifdef SYM_OPT_HANDLE_DEVICE_QUEUEING
id|sym_que_init
c_func
(paren

...
macro_line|#if SYM_CONF_NVRAM_WRITE_SUPPORT
multiline_comment|/*&n; *  Write &squot;len&squot; bytes starting at &squot;offset&squot;.&n; */
DECL|function|sym_write_S24C16_nvram
r_static
r_int
id|sym_write_S24C16_nvram
c_func
(paren
r_struct
id|sym_device
...
suffix:semicolon
multiline_comment|/* NVRAM has to be written in segments of 16 bytes */
r_for
c_loop
(paren
id|x
...
macro_line|#endif /* SYM_CONF_NVRAM_WRITE_SUPPORT */
...
macro_line|#ifdef CONFIG_PARISC
multiline_comment|/*&n; * Host firmware (PDC) keeps a table for altering SCSI capabilities.&n; * Many newer machines export one channel of 53c896 chip as SE, 50-pin HD.&n; * Also used for Multi-initiator SCSI clusters to set the SCSI Initiator ID.&n; */
DECL|function|sym_read_parisc_pdc
r_static
r_int
id|sym_read_parisc_pdc
c_func
(paren
r_struct
id|sym_device
...
suffix:colon
r_return
l_string|&quot;Symbios NVRAM&quot;
suffix:semicolon
r_case
id|SYM_TEKRAM_NVRAM
suffix:colon
r_return
l_string|&quot;Tekram NVRAM&quot;
suffix:semicolon
r_case
id|SYM_PARISC_PDC
suffix:colon
r_return
l_string|&quot;PA-RISC Firmware&quot;
suffix:semicolon
r_default
suffix:colon
r_return

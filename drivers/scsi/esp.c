...
multiline_comment|/* this is clearly wrong for esp.. */
DECL|function|esp_release
r_static
r_int
id|esp_release
...
comma
id|esp_dev-&gt;sync_max_offset
comma
id|esp_dev-&gt;sync_min_period
)paren
suffix:semicolon
id|copy_info
c_func
...
DECL|function|esp_slave_destroy
r_static
r_void

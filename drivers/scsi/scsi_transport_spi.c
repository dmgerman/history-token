multiline_comment|/* &n; *  Parallel SCSI (SPI) transport specific attributes exported to sysfs.&n; *&n; *  Copyright (c) 2003 Silicon Graphics, Inc.  All rights reserved.&n; *  Copyright (c) 2004, 2005 James Bottomley &lt;James.Bottomley@SteelEye.com&gt;&n; *&n; *  This program is free software; you can redistribute it and/or modify&n; *  it under the terms of the GNU General Public License as published by&n; *  the Free Software Foundation; either version 2 of the License, or&n; *  (at your option) any later version.&n; *&n; *  This program is distributed in the hope that it will be useful,&n; *  but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *  GNU General Public License for more details.&n; *&n; *  You should have received a copy of the GNU General Public License&n; *  along with this program; if not, write to the Free Software&n; *  Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA&n; */
...
DECL|function|spi_device_configure
r_static
r_int
id|spi_device_configure
c_func
(paren
r_struct
id|device
...
suffix:semicolon
multiline_comment|/**&n; * spi_display_xfer_agreement - Print the current target transfer agreement&n; * @starget: The target for which to display the agreement&n; *&n; * Each SPI port is required to maintain a transfer agreement for each&n; * other port on the bus.  This function prints a one-line summary of&n; * the current agreement; more detailed information is available in sysfs.&n; */
DECL|function|spi_display_xfer_agreement
r_void
...
id|starget-&gt;dev
comma
l_string|&quot;%s %sSCSI %d.%d MB/s %s%s%s (%s ns, offset %d)&bslash;n&quot;
comma
id|scsi
comma
id|tp-&gt;width
...
DECL|variable|spi_display_xfer_agreement
id|EXPORT_SYMBOL
c_func
(paren
id|spi_display_xfer_agreement
...
DECL|function|spi_device_match
r_static
r_int
id|spi_device_match
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Note: this class has no device attributes, so it has&n;&t; * no per-HBA allocation and thus we don&squot;t need to distinguish&n;&t; * the attribute containers for the device */
r_return
l_int|1
suffix:semicolon
)brace
DECL|function|spi_target_match
r_static
r_int
id|spi_target_match
c_func
...
suffix:semicolon
r_static
id|DECLARE_ANON_TRANSPORT_CLASS
c_func
(paren
id|spi_device_class
comma

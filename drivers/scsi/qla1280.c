...
macro_line|#endif
multiline_comment|/* MACROS for managing the endian addresses */
DECL|function|qla1280_addr0_15
r_static
r_inline
r_uint16
id|qla1280_addr0_15
...
DECL|function|qla1280_addr16_31
r_static
r_inline
r_uint16
id|qla1280_addr16_31
c_func
(paren
id|dma_addr_t
id|dma
...
DECL|function|qla1280_addr32_47
r_static
r_inline
r_uint16
id|qla1280_addr32_47
c_func
(paren
id|dma_addr_t
id|dma
...
DECL|function|qla1280_addr48_63
r_static
r_inline
r_uint16
id|qla1280_addr48_63
c_func
(paren
id|dma_addr_t
id|dma
...
multiline_comment|/*&n;&t;&t; * Normally, would would need to search our queue for&n;&t;&t; * the specified command but; since our sp contains&n;&t;&t; * the cmd ptr, we can just remove it from our LUN&n;&t;&t; * queue.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* wait 4 seconds */
id|schedule_timeout
c_func
(paren
l_int|4
...
multiline_comment|/**************************************************************************&n; *   qla1200_abort&n; *     Abort the specified SCSI command(s).&n; **************************************************************************/
r_int
...
multiline_comment|/**************************************************************************&n; *   qla1200_device_reset&n; *     Reset the specified SCSI device&n; **************************************************************************/
r_int
...
multiline_comment|/**************************************************************************&n; *   qla1200_bus_reset&n; *     Reset the specified bus.&n; **************************************************************************/
r_int
...
multiline_comment|/**************************************************************************&n; *   qla1200_adapter_reset&n; *     Reset the specified adapter (both channels)&n; **************************************************************************/
r_int
...
mdefine_line|#define DUMP_IT_BACK 1&t;&t;/* for debug of RISC loading */
r_static
r_int
...
singleline_comment|//dword_ptr = (uint32_t *)(pkt + 1);
singleline_comment|//*dword_ptr++ = 0;
singleline_comment|//*dword_ptr = 0;
id|dprintk
c_func
(paren
...
l_string|&quot;0x%x, handle = 0x%lx&bslash;n&quot;
comma
id|comp_status
comma
id|scsi_status

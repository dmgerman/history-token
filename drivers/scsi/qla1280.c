...
macro_line|#error &quot;Kernels older then 2.4.x are no longer supported&quot;
macro_line|#endif
...
mdefine_line|#define pci_dma_hi32(a, ch, ha)&t;&t;0
macro_line|#endif
...
macro_line|#if LINUX_VERSION_CODE &lt; 0x020545
DECL|macro|CMD_HOST
mdefine_line|#define&t;CMD_HOST(Cmnd)&t;&t;Cmnd-&gt;host
DECL|macro|CMD_REQUEST
mdefine_line|#define CMD_REQUEST(Cmnd)&t;Cmnd-&gt;request.cmd
DECL|macro|SCSI_BUS_32
mdefine_line|#define SCSI_BUS_32(Cmnd)&t;Cmnd-&gt;channel
DECL|macro|SCSI_TCN_32
mdefine_line|#define SCSI_TCN_32(Cmnd)&t;Cmnd-&gt;target
DECL|macro|SCSI_LUN_32
mdefine_line|#define SCSI_LUN_32(Cmnd)&t;Cmnd-&gt;lun
macro_line|#else
DECL|macro|CMD_HOST
mdefine_line|#define&t;CMD_HOST(Cmnd)&t;&t;Cmnd-&gt;device-&gt;host
DECL|macro|CMD_REQUEST
mdefine_line|#define CMD_REQUEST(Cmnd)&t;Cmnd-&gt;request-&gt;cmd
DECL|macro|SCSI_BUS_32
...
(paren
id|KERN_WARNING
l_string|&quot;qla1280_detect: [WARNING] struct srb too big&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
l_int|2
comma
l_string|&quot;qla1280_queuecommand(): jiffies %li&bslash;n&quot;
comma
id|jiffies
)paren
suffix:semicolon
...
op_decrement
suffix:semicolon
macro_line|#if LINUX_KERNEL_VERSION &lt; 0x020500
r_if
c_cond
(paren
id|cmd-&gt;cmnd
...
multiline_comment|/*&n;&t;&t; * qla1280_bus_reset() will take care of issueing markers,&n;&t;&t; * no need to do that here as well!&n;&t;&t; */
macro_line|#if 0
multiline_comment|/* Issue marker command. */
id|ha-&gt;flags.reset_marker
op_assign
...
l_int|3
comma
l_string|&quot;qla1280_chip_diag: reset register cleared by &quot;
l_string|&quot;chip reset&bslash;n&quot;
)paren
suffix:semicolon
id|WRT_REG_WORD
c_func
...
l_int|3
comma
l_string|&quot;qla1280_chip_diag: Checking product &quot;
l_string|&quot;ID of chip&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|1
comma
l_string|&quot;qla1280_chip_diag: Checking &quot;
l_string|&quot;mailboxes of chip&bslash;n&quot;
)paren
suffix:semicolon
...
id|KERN_INFO
l_string|&quot;qla1280: &quot;
l_string|&quot;Failed mbox check&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;scsi(%li): qla1280_setup_chip: &quot;
l_string|&quot;Failed checksum&bslash;n&quot;
comma
id|ha-&gt;host_no
)paren
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Set default FIFO magic - What appropriate values&n;&t;&t; * would be here is unknown. This is what I have found&n;&t;&t; * testing with 12160s.&n;&t;&t; * Now, I would love the magic decoder ring for this one,&n;&t;&t; * the header file provided by QLogic seems to be bogus&n;&t;&t; * or incomplete at best.&n;&t;&t; */
id|nv-&gt;isp_config.c
op_assign
l_int|0x44
suffix:semicolon
...
l_int|5
suffix:semicolon
multiline_comment|/* 8 = 5.0 clocks */
id|nv-&gt;bus
(braket
id|bus
)braket
...
suffix:semicolon
macro_line|#if 1&t;/* Is this safe? */
...
l_int|8
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Do not enable wide, sync, and ppr for the initial&n;&t;&t;&t; * INQUIRY run. We enable this later if we determine&n;&t;&t;&t; * the target actually supports it.&n;&t;&t;&t; */
id|nv-&gt;bus
(braket
id|bus
)braket
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * No sync, wide, etc. while probing&n;&t;&t;&t; */
id|mb
(braket
l_int|2
)braket
...
id|BIT_3
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * We don&squot;t want to enable ppr etc. before we have &n;&t;&t;&t; * determined that the target actually supports it&n;&t;&t;&t; */
macro_line|#if 0
r_if
c_cond
(paren
...
multiline_comment|/*&n;&t;&t;&t;&t; * qla1280_bus_reset() will do the marker&n;&t;&t;&t;&t; * dance - no reason to repeat here!&n;&t;&t;&t;&t; */
macro_line|#if  0
multiline_comment|/* Issue marker command. */
id|ha-&gt;flags.reset_marker
op_assign

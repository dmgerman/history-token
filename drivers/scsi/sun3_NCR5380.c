multiline_comment|/* sun3_NCR5380.c -- adapted from atari_NCR5380.c for the sun3 by &n;   Sam Creasey. */
...
c_func
(paren
l_string|&quot;scsi%d: overrun in UDC counter -- not prepared to deal with this!&bslash;n&quot;
comma
id|HOSTNO
)paren
suffix:semicolon
...
multiline_comment|/* make sure we&squot;re not stuck in a data phase */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;scsi%d: bus stuck in data phase -- probably a single byte &quot;
...
c_func
(paren
l_string|&quot;not prepared for this error!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;scsi%d: transfer_dma without setup!&bslash;n&quot;
comma
id|HOSTNO
)paren
suffix:semicolon
...
macro_line|#ifdef REAL_DMA
multiline_comment|/* this command setup for dma yet? */
r_if
c_cond
(paren
(paren
...
macro_line|#if defined(REAL_DMA)
singleline_comment|//&t;&t;if (!cmd-&gt;device-&gt;borken &amp;&amp;
r_if
c_cond
(paren
(paren
...
suffix:semicolon
macro_line|#ifdef REAL_DMA
multiline_comment|/* if we had intended to dma that command clear it */
r_if
c_cond
(paren
id|sun3_dma_setup_done
...
multiline_comment|/* it might eventually prove necessary to do a dma setup on&n;   reselection, but it doesn&squot;t seem to be needed now -- sam */
...
suffix:semicolon
macro_line|#if 1
singleline_comment|// acknowledge toggle to MSGIN
id|NCR5380_write
c_func
(paren
id|TARGET_COMMAND_REG
...
suffix:semicolon
singleline_comment|// peek at the byte without really hitting the bus
id|msg
(braket
l_int|0
)braket
...
macro_line|#if 1
multiline_comment|/* engage dma setup for the command we just saw */
(brace
r_void
op_star
id|d
...
(paren
op_logical_neg
id|tmp-&gt;SCp.this_residual
op_logical_and
id|tmp-&gt;SCp.buffers_residual
)paren
(brace
id|count
op_assign
id|tmp-&gt;SCp.buffer-&gt;length
suffix:semicolon
id|d
op_assign
id|SGADDR

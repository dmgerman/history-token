...
(paren
id|OSST_DEB_MSG
l_string|&quot;%s:D: Locking drive door.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
(paren
id|OSST_DEB_MSG
l_string|&quot;%s:D: Unlocking drive door.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;%s:I: Could not relock door after bus reset.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon

...
DECL|macro|NCR_700_DEV_PRINT_SYNC_NEGOTIATION
mdefine_line|#define NCR_700_DEV_PRINT_SYNC_NEGOTIATION (1&lt;&lt;19)
r_static
r_inline
r_void
...
macro_line|#ifdef CONFIG_53C700_BOTH_MAPPED
DECL|member|mem_mapped
id|__u32
id|mem_mapped
suffix:semicolon
multiline_comment|/* set if memory mapped */
macro_line|#endif
...
r_inline
id|__u8
DECL|function|NCR_700_mem_readb
id|NCR_700_mem_readb
c_func
(paren
r_struct
id|Scsi_Host
...
r_inline
id|__u32
DECL|function|NCR_700_mem_readl
id|NCR_700_mem_readl
c_func
(paren
r_struct
id|Scsi_Host
...
r_inline
r_void
DECL|function|NCR_700_mem_writeb
id|NCR_700_mem_writeb
c_func
(paren
id|__u8
id|value
...
r_inline
r_void
DECL|function|NCR_700_mem_writel
id|NCR_700_mem_writel
c_func
(paren
id|__u32
id|value
...
r_inline
id|__u8
DECL|function|NCR_700_io_readb
id|NCR_700_io_readb
c_func
(paren
r_struct
...
r_inline
id|__u32
DECL|function|NCR_700_io_readl
id|NCR_700_io_readl
c_func
(paren
r_struct
...
r_inline
r_void
DECL|function|NCR_700_io_writeb
id|NCR_700_io_writeb
c_func
(paren
id|__u8
id|value
...
r_inline
r_void
DECL|function|NCR_700_io_writel
id|NCR_700_io_writel
c_func
(paren
id|__u32
id|value
...
r_inline
r_void
DECL|function|NCR_700_set_mem_mapped
...
r_inline
r_void
DECL|function|NCR_700_set_io_mapped
...
DECL|macro|NCR_700_readb
mdefine_line|#define NCR_700_readb NCR_700_io_readb
DECL|macro|NCR_700_readl
mdefine_line|#define NCR_700_readl NCR_700_io_readl
DECL|macro|NCR_700_writeb
mdefine_line|#define NCR_700_writeb NCR_700_io_writeb
DECL|macro|NCR_700_writel
mdefine_line|#define NCR_700_writel NCR_700_io_writel
DECL|macro|NCR_700_set_io_mapped
mdefine_line|#define NCR_700_set_io_mapped(x)
DECL|macro|NCR_700_set_mem_mapped
mdefine_line|#define NCR_700_set_mem_mapped(x)&t;error I/O mapped only
macro_line|#elif defined(CONFIG_53C700_MEM_MAPPED)
DECL|macro|NCR_700_readb
mdefine_line|#define NCR_700_readb NCR_700_mem_readb
DECL|macro|NCR_700_readl
mdefine_line|#define NCR_700_readl NCR_700_mem_readl
DECL|macro|NCR_700_writeb
mdefine_line|#define NCR_700_writeb NCR_700_mem_writeb
DECL|macro|NCR_700_writel
mdefine_line|#define NCR_700_writel NCR_700_mem_writel
DECL|macro|NCR_700_set_io_mapped
mdefine_line|#define NCR_700_set_io_mapped(x)&t;error MEM mapped only
DECL|macro|NCR_700_set_mem_mapped
mdefine_line|#define NCR_700_set_mem_mapped(x)
macro_line|#else
macro_line|#error neither CONFIG_53C700_MEM_MAPPED nor CONFIG_53C700_IO_MAPPED is set
macro_line|#endif
macro_line|#endif
eof

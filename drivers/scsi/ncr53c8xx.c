...
suffix:semicolon
multiline_comment|/*&n;&t;**&t;Since the queue depth is not tunable under Linux,&n;&t;**&t;we need to know this value in order not to &n;&t;**&t;announce stupid things to user.&n;&t;*/
r_if
c_cond
(paren
id|lp
...
id|info
comma
l_string|&quot;  Chip NCR53C720, revision id 0x%x, IRQ %d&bslash;n&quot;
comma
id|np-&gt;revision_id
comma
(paren
...
multiline_comment|/* Fill Linux host instance structure */

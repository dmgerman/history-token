...
multiline_comment|/* In case of a bus reset, ncr_negotiate will reset &n;&t;&t; * the flags tp-&gt;widedone and tp-&gt;period to 0, forcing&n;&t;&t; * a new negotiation. &n;&t;&t; */
id|no_increase
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * Midlayer signal to the driver that all of the scsi commands&n;&t;&t; * for the integrity check have completed. Save the negotiated&n;&t;&t; * parameters (extracted from sval and wval). &n;&t;&t; */
(brace
id|u_char
id|idiv
suffix:semicolon
...
l_int|40
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Negotiation for this target it complete.&n;&t;&t; */
id|tp-&gt;ic_max_width
op_assign
(paren
id|tp-&gt;wval

...
macro_line|#include &lt;../drivers/scsi/fdomain.h&gt;
...
id|version
op_assign
l_string|&quot;fdomain_cs.c 1.43 2000/06/12 21:27:25 (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
l_int|1
comma
l_string|&quot;fdomain_cs: release postponed, &quot;
...
multiline_comment|/* fdomain_release */
multiline_comment|/*====================================================================*/
...
(paren
id|KERN_NOTICE
l_string|&quot;fdomain_cs: Card Services release &quot;
...
l_int|0
comma
l_string|&quot;fdomain_cs: unloading&bslash;n&quot;
)paren
suffix:semicolon

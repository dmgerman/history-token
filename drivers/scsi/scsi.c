...
suffix:semicolon
multiline_comment|/**&n; * __scsi_device_lookup_by_target - find a device given the target (UNLOCKED)&n; * @starget:&t;SCSI target pointer&n; * @lun:&t;SCSI Logical Unit Number&n; *&n; * Looks up the scsi_device with the specified @lun for a give&n; * @starget. The returned scsi_device does not have an additional&n; * reference.  You must hold the host&squot;s host_lock over this call and&n; * any access to the returned scsi_device.&n; *&n; * Note:  The only reason why drivers would want to use this is because&n; * they&squot;re need to access the device list in irq context.  Otherwise you&n; * really want to use scsi_device_lookup_by_target instead.&n; **/
DECL|function|__scsi_device_lookup_by_target
r_struct
id|scsi_device
op_star
...
DECL|variable|__scsi_device_lookup_by_target
id|EXPORT_SYMBOL
c_func
(paren
id|__scsi_device_lookup_by_target
...
DECL|variable|scsi_device_lookup_by_target
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_device_lookup_by_target

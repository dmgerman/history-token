...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * We only get here if the error&n;&t;&t;&t;&t; * recovery thread has died.&n;&t;&t;&t;&t; */
id|scsi_finish_command
c_func
(paren
id|cmd
...
multiline_comment|/**&n; * scsi_set_device_offline - set scsi_device offline&n; * @sdev:&t;pointer to struct scsi_device to offline. &n; *&n; * Locks:&t;host_lock held on entry.&n; **/
DECL|function|scsi_set_device_offline
r_void
...
r_else
(brace
multiline_comment|/* FIXME: Send online state change hotplug event */
)brace
)brace

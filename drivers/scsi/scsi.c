...
suffix:semicolon
multiline_comment|/*&n; * Private interface into the new error handling code.&n; */
r_extern
r_int
id|scsi_new_reset
c_func
...
suffix:semicolon
multiline_comment|/* The detect routine must carefully spinunlock/spinlock if &n;&t;   it enables interrupts, since all interrupt handlers do &n;&t;   spinlock as well.  */
multiline_comment|/*&n;&t; * detect should do its own locking&n;&t; */
id|tpnt-&gt;present
op_assign
id|tpnt
op_member_access_from_pointer
...
c_func
(paren
id|shpnt-&gt;host_driverfs_dev.name
comma
id|name
comma
id|DEVICE_NAME_SIZE
...
c_func
(paren
id|shpnt-&gt;host_driverfs_dev.bus_id
comma
l_string|&quot;scsi%d&quot;
comma
id|shpnt-&gt;host_no
...
multiline_comment|/*&n; * Function:&t;scsi_reset_provider_done_command&n; *&n; * Purpose:&t;Dummy done routine.&n; *&n; * Notes:&t;Some low level drivers will call scsi_done and end up here,&n; *&t;&t;others won&squot;t bother.&n; *&t;&t;We don&squot;t want the bogus command used for the bus/device&n; *&t;&t;reset to find its way into the mid-layer so we intercept&n; *&t;&t;it here.&n; */
r_static
r_void

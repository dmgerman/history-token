...
macro_line|#endif
DECL|function|scsi_detect_device
r_void
...
(paren
id|KERN_WARNING
l_string|&quot;SCSI module %s not ready, skipping detection.&bslash;n&quot;
comma
id|sdt-&gt;name
)paren
suffix:semicolon
...
c_cond
(paren
id|sdev-&gt;host-&gt;hostt-&gt;slave_detach
op_ne
l_int|NULL
)paren
id|sdev-&gt;host-&gt;hostt
...
multiline_comment|/*&n;&t;&t;&t;&t; * XXX check result when the upper level&n;&t;&t;&t;&t; * attach return values are fixed, and&n;&t;&t;&t;&t; * stop attaching on failure.&n;&t;&t;&t;&t; */
(paren
op_star
id|tpnt-&gt;attach
)paren

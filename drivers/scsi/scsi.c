...
multiline_comment|/* TODO FIXME This is a hack and MUST go eventually.&n;&t;   This fixes a problem in scsi_scan.c::scsi_alloc_sdev()&n;&t;   else we cannot ever have ANY SCSI devices.&n;&t;*/
id|SDpnt-&gt;current_queue_depth
op_assign
l_int|1
suffix:semicolon
...
(paren
id|KERN_CRIT
l_string|&quot;Couldn&squot;t load SCSI Core -- out of memory!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

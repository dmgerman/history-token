...
id|DID_BUS_BUSY
comma
multiline_comment|/*&n;&t; * The transaction has made it through our queue routine.&n;&t; */
DECL|enumerator|CAM_SIM_QUEUED
id|CAM_SIM_QUEUED
op_assign
l_int|0x200
comma

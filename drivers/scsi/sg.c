...
id|Sg_fd
suffix:semicolon
multiline_comment|/* 2760 bytes long on i386 */
...
id|Sg_device
suffix:semicolon
multiline_comment|/* 36 bytes long on i386 */
r_static
r_int
id|sg_fasync
c_func
...
c_func
(paren
l_string|&quot;sg_rb_correct4mmap: startFinish=%d, &quot;
l_string|&quot;scatg=%d&bslash;n&quot;
comma
id|startFinish
comma
...
suffix:semicolon
multiline_comment|/* N.B. correction _not_ applied to base page of aech allocation */
r_if
c_cond
(paren
id|rsv_schp-&gt;k_use_sg
...
suffix:semicolon
multiline_comment|/* decrement page count */
)brace
)brace
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;sg_cmd_done_bh: NULL request&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_INFO
l_string|&quot;sg_cmd_done_bh: device detached&bslash;n&quot;
)paren
suffix:semicolon
id|scsi_release_request
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;sg_def_reserved_size : usage &quot;
l_string|&quot;sg_def_reserved_size=n (n could be 65536, 131072 or 262144)&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
DECL|function|sg_device_kdev_read
r_static
id|ssize_t
...
suffix:semicolon
DECL|function|sg_device_type_read
r_static
id|ssize_t
id|sg_device_type_read
c_func
(paren
r_struct
id|device
...
l_string|&quot;%sgeneric&quot;
comma
id|scsidp-&gt;sdev_driverfs_dev.name
)paren
suffix:semicolon
id|sdp-&gt;sg_driverfs_dev.parent
op_assign
op_amp
id|scsidp-&gt;sdev_driverfs_dev
suffix:semicolon
id|sdp-&gt;sg_driverfs_dev.bus
op_assign
op_amp
...
(brace
id|sg_template.scsi_driverfs_driver.name
op_assign
(paren
r_char
op_star
...
id|sg_template.tag
suffix:semicolon
id|sg_template.scsi_driverfs_driver.bus
op_assign
op_amp
id|scsi_driverfs_bus_type
suffix:semicolon
...
(paren
op_amp
id|sg_template.scsi_driverfs_driver
)paren
suffix:semicolon
)brace
r_return
...
suffix:semicolon
multiline_comment|/* scatter gather array, followed by mem_src_arr (array of chars) */
r_int
id|sg_bufflen
op_assign
id|tablesize
...
c_func
(paren
l_string|&quot;sg_build_dir: sg_alloc_kiovec res=%d&bslash;n&quot;
comma
id|res
)paren
)paren
...
c_func
(paren
l_string|&quot;sg_build_dir: k_use_sg=%d, k=%d, rem_sz=%d&bslash;n&quot;
comma
id|j
comma
id|k
...
l_int|1
suffix:semicolon
macro_line|#endif /* SG_ALLOW_DIO_CODE */
)brace
...
id|SG_HEAP_KMAL
suffix:semicolon
multiline_comment|/* was SG_HEAP_PAGE */
id|resp
op_assign
id|sg_low_malloc
c_func
...
(paren
id|KERN_ERR
l_string|&quot;sg_low_free: bad mem_src=%d, buff=0x%p, rqSz=%d&bslash;n&quot;
comma
id|mem_src
comma
id|buff
...
DECL|function|sg_proc_adio_read
r_static
r_int
id|sg_proc_adio_read
c_func
...
DECL|function|sg_proc_adio_info
r_static
r_int
id|sg_proc_adio_info
c_func
...
DECL|function|sg_proc_adio_write
r_static
r_int
id|sg_proc_adio_write
c_func
...
DECL|macro|SG_MAX_HOST_STR_LEN
mdefine_line|#define SG_MAX_HOST_STR_LEN 256
...
l_char|&squot; &squot;
suffix:semicolon
multiline_comment|/* suppress imbedded newlines */
)brace
id|PRINT_PROC
c_func
(paren

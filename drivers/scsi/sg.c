...
mdefine_line|#define SG_DEV_ARR_LUMP 6&t;/* amount to over allocate sg_dev_arr by */
r_static
r_int
id|sg_init
c_func
...
suffix:semicolon
singleline_comment|// static void sg_unmap_and(Sg_scatter_hold * schp, int free_also);
r_static
id|Sg_device
op_star
id|sg_get_dev
...
suffix:semicolon
singleline_comment|// sg_unmap_and(&amp;srp-&gt;data, 1);
r_if
c_cond
(paren
id|srp-&gt;res_used

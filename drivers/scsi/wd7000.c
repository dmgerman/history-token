...
id|wd7000_card_num
suffix:semicolon
multiline_comment|/* .bss will zero this */
r_int
id|i
suffix:semicolon
r_int
...
c_func
(paren
l_string|&quot;BUS_ON value is out of range (500&quot;
l_string|&quot; to 31875 nanoseconds)!&quot;
comma
id|ints
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;BUS_OFF value is out of range (500&quot;
l_string|&quot; to 31875 nanoseconds)!&quot;
comma
id|ints
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;wd7000_setup: IRQ=%d, DMA=%d, I/O=0x%x, &quot;
l_string|&quot;BUS_ON=%dns, BUS_OFF=%dns&bslash;n&quot;
comma
id|configs
(braket
id|wd7000_card_num
...
c_func
(paren
l_string|&quot;wd7000_intr: irq = %d, host = 0x%06lx&bslash;n&quot;
comma
id|irq
comma
(paren
...
c_func
(paren
l_string|&quot;wd7000_intr: intr stat = 0x%02x&bslash;n&quot;
comma
id|flag
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;wd7000_intr: phantom interrupt...&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|ack
...
c_func
(paren
l_string|&quot;wd7000_intr: free outgoing mailbox&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If sleep_on() and the &quot;interrupt on free OGMB&quot; command are&n;&t;&t; * used in mail_out(), wake_up() should correspondingly be called&n;&t;&t; * here.  For now, we don&squot;t need to do anything special.&n;&t;&t; */
r_goto
id|ack
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;wd7000_intr: unsolicited interrupt 0x%02x&bslash;n&quot;
comma
id|icmb_status
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;wd7000_intr: return from interrupt handler&bslash;n&quot;
)paren
suffix:semicolon
id|wd7000_intr_ack
c_func

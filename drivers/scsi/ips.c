...
id|scb-&gt;scsi_cmd-&gt;device-&gt;channel
comma
id|scb-&gt;scsi_cmd-&gt;channel-&gt;id
comma
id|scb-&gt;scsi_cmd-&gt;channel-&gt;lun
comma
id|scb-&gt;basic_status
comma
id|scb-&gt;extended_status
...
(paren
id|KERN_WARNING
l_string|&quot;Warning: Adapter %d Firmware Compatible Version is %s, but should be %s&bslash;n&quot;
comma
id|ha-&gt;host_num
comma
id|FirmwareVersion
...
(paren
id|KERN_WARNING
l_string|&quot;Warning: Adapter %d BIOS Compatible Version is %s, but should be %s&bslash;n&quot;
comma
id|ha-&gt;host_num
comma
id|BiosVersion

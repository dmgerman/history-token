...
mdefine_line|#define IPS_VERSION_HIGH        &quot;5.10&quot;
DECL|macro|IPS_VERSION_LOW
mdefine_line|#define IPS_VERSION_LOW         &quot;.13-BETA &quot;
macro_line|#if LINUX_VERSION_CODE &lt; LinuxVersionCode(2,4,0)
...
macro_line|#elif LINUX_VERSION_CODE &lt;= LinuxVersionCode(2,3,18)
DECL|macro|dma_addr_t
mdefine_line|#define dma_addr_t uint32_t
...
mdefine_line|#define pci_free_consistent(a,size,address,dmahandle) kfree(address)
DECL|macro|pci_map_sg
mdefine_line|#define pci_map_sg(a,b,n,z)       (n)
...
macro_line|#endif
DECL|macro|pci_unregister_driver
mdefine_line|#define pci_unregister_driver(x)
macro_line|#endif
...
macro_line|#if LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,4,0)
multiline_comment|/* This table describes any / all ServeRAID Adapters */
...
suffix:semicolon
multiline_comment|/* This table describes only Sarasota ( ServeRAID 5i ) Adapters */
DECL|variable|__devinitdata
r_static
r_struct
id|pci_device_id
...
suffix:semicolon
multiline_comment|/* This table describes all i960 Adapters */
DECL|variable|__devinitdata
r_static
r_struct
id|pci_device_id
id|ips_pci_table_i960
(braket
)braket
id|__devinitdata
op_assign
...
suffix:semicolon
DECL|variable|ips_pci_driver_5i
r_struct
id|pci_driver
id|ips_pci_driver_5i
op_assign
(brace
dot
id|name
...
suffix:semicolon
DECL|variable|ips_pci_driver_i960
r_struct
id|pci_driver
id|ips_pci_driver_i960
op_assign
(brace
dot
id|name
...
suffix:semicolon
singleline_comment|//static void ips_select_queue_depth(struct Scsi_Host *, Scsi_Device *);
r_static
r_void
id|ips_chkstatus
c_func
...
multiline_comment|/**********************************************************************************/
multiline_comment|/* For Kernel Versions 2.4 or greater, use new PCI ( Hot Pluggable ) architecture */
multiline_comment|/**********************************************************************************/
macro_line|#if LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,4,0)
macro_line|#if LINUX_VERSION_CODE &lt; LinuxVersionCode(2,5,0)
id|spin_unlock_irq
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* By definition, a Sarasota ( 5i ) Adapter MUST be enumerated first or the */
multiline_comment|/* server may not boot properly. The adapters must be enumerated in exactly */
multiline_comment|/* the same order as ServeRAID BIOS for the machine to come up properly.    */
id|pci_module_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Ask for 5i Adapters First  */
r_if
c_cond
(paren
id|ips_num_controllers
)paren
multiline_comment|/* If there is a 5i Adapter   */
id|pci_module_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*    Get all i960&squot;s next     */
id|pci_module_init
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Get all remaining Adapters */
multiline_comment|/*  ( in normal BUS order )   */
macro_line|#if LINUX_VERSION_CODE &lt; LinuxVersionCode(2,5,0)
id|spin_lock_irq
c_func
(paren
...
id|irq
suffix:semicolon
singleline_comment|//sh-&gt;select_queue_depths = ips_select_queue_depth;
id|sh-&gt;sg_tablesize
op_assign
...
id|order
suffix:semicolon
multiline_comment|/* try to allocate a bigger buffer */
r_for
c_loop
(paren
id|count

...
multiline_comment|/* Copyright (C) 2002,2003 Adaptec, Inc.                                     */
multiline_comment|/*                                                                           */
...
multiline_comment|/* 4.80.26  - Clean up potential code problems ( Arjan&squot;s recommendations )   */
multiline_comment|/* 4.90.01  - Version Matching for FirmWare, BIOS, and Driver                */
multiline_comment|/* 4.90.05  - Use New PCI Architecture to facilitate Hot Plug Development    */
multiline_comment|/* 4.90.08  - Increase Delays in Flashing ( Trombone Only - 4H )             */
multiline_comment|/* 4.90.08  - Data Corruption if First Scatter Gather Element is &gt; 64K       */
multiline_comment|/* 4.90.11  - Don&squot;t actually RESET unless it&squot;s physically required           */
multiline_comment|/*          - Remove unused compile options                                  */
multiline_comment|/* 5.00.01  - Sarasota ( 5i ) adapters must always be scanned first          */
multiline_comment|/*          - Get rid on IOCTL_NEW_COMMAND code                              */
multiline_comment|/*          - Add Extended DCDB Commands for Tape Support in 5I              */
multiline_comment|/* 5.10.12  - use pci_dma interfaces, update for 2.5 kernel changes          */
...
l_int|32
suffix:semicolon
multiline_comment|/* Max Active Cmds for a Lite Adapter */
DECL|variable|ips_driver_template
r_static
...
suffix:semicolon
DECL|variable|ips_hot_plug_name
r_static
r_char
id|ips_hot_plug_name
(braket
)braket
op_assign
l_string|&quot;ips&quot;
...
mdefine_line|#define MAX_ADAPTER_NAME 15
...
(brace
multiline_comment|/* morpheus / marco / sebring */
id|ha-&gt;func.isintr
op_assign
id|ips_isintr_morpheus
suffix:semicolon
...
multiline_comment|/* much faster and avoids any problems that might be caused by a        */
multiline_comment|/* physical reset ( such as having to fail all the outstanding I/O&squot;s ). */
r_if
c_cond
(paren
id|ha-&gt;ioctl_reset
...
(brace
multiline_comment|/* IF Not an IOCTL Requested Reset */
id|scb
op_assign
op_amp
id|ha-&gt;scbs
...
l_int|0
suffix:semicolon
multiline_comment|/* Attempt the flush command */
id|ret
op_assign
id|ips_send_wait
c_func
...
(paren
(paren
id|pt-&gt;CoppCP.cmd.reset.op_code
op_eq
id|IPS_CMD_RESET_CHANNEL
)paren
op_logical_and
(paren
id|pt-&gt;CoppCP.cmd.reset.adapter_flag
op_eq
l_int|1
)paren
)paren
...
l_int|1
suffix:semicolon
multiline_comment|/* This reset request is from an IOCTL */
id|ips_eh_reset
c_func
(paren
id|SC
...
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*                                                                          */
multiline_comment|/*   Set queue depths on devices once scan is complete                      */
multiline_comment|/*                                                                          */
multiline_comment|/****************************************************************************/
r_int
...
suffix:semicolon
multiline_comment|/* interrupt during initialization */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_alloc_passthru_buffer                                  */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   allocate a buffer large enough for the ioctl data if the ioctl buffer  */
multiline_comment|/*   is too small or doesn&squot;t exist                                          */
multiline_comment|/****************************************************************************/
r_static
r_int
...
multiline_comment|/****************************************************************************/
multiline_comment|/* Routine Name: ips_flash_copperhead                                       */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   Flash the BIOS/FW on a Copperhead style controller                     */
multiline_comment|/****************************************************************************/
r_static
r_int
...
c_cond
(paren
id|pt-&gt;CoppCP.cmd.flashfw.packet_num
op_eq
l_int|0
)paren
(brace
...
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   flashes the bios of a copperhead adapter                               */
multiline_comment|/****************************************************************************/
r_static
r_int
...
l_int|1
comma
l_string|&quot;(%s%d) flash bios failed - unable to flash&quot;
comma
id|ips_name
comma
id|ha-&gt;host_num
...
multiline_comment|/****************************************************************************/
multiline_comment|/* Routine Name: ips_flash_firmware                                         */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   flashes the firmware of a copperhead adapter                           */
multiline_comment|/****************************************************************************/
r_static
r_int
...
id|scb-&gt;bus
op_assign
id|scb-&gt;scsi_cmd-&gt;device-&gt;channel
suffix:semicolon
id|scb-&gt;target_id
op_assign
id|scb-&gt;scsi_cmd-&gt;device-&gt;id
suffix:semicolon
id|scb-&gt;lun
op_assign
id|scb-&gt;scsi_cmd-&gt;device-&gt;lun
suffix:semicolon
id|scb-&gt;sg_len
op_assign
l_int|0
...
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   release the memory resources used to hold the flash image              */
multiline_comment|/****************************************************************************/
r_static
r_void
...
suffix:semicolon
multiline_comment|/* For the Next 3 lines Check for Binary 0 at the end and don&squot;t include it if it&squot;s there. */
multiline_comment|/* That keeps everything happy for &quot;text&quot; operations on the proc file.                    */
r_if
c_cond
(paren
id|le32_to_cpu
...
id|info
comma
l_string|&quot;&bslash;tBIOS Version                      : %c%c%c%c%c%c%c&bslash;n&quot;
comma
...
id|info
comma
l_string|&quot;&bslash;tFirmware Version                  : %c%c%c%c%c%c%c&bslash;n&quot;
comma
id|ha-&gt;enq-&gt;CodeBlkVersion
(braket
l_int|0
...
id|info
comma
l_string|&quot;&bslash;tBoot Block Version                : %c%c%c%c%c%c%c&bslash;n&quot;
comma
id|ha-&gt;enq-&gt;BootBlkVersion
(braket
l_int|0
...
id|info
comma
l_string|&quot;&bslash;tDriver Build                      : %d&bslash;n&quot;
comma
id|IPS_BUILD_IDENT
)paren
suffix:semicolon
...
suffix:semicolon
r_case
id|IPS_SUBDEVICEID_5I2
suffix:colon
id|ha-&gt;ad_type
op_assign
id|IPS_ADTYPE_SERVERAID5I2
suffix:semicolon
r_break
suffix:semicolon
r_case
id|IPS_SUBDEVICEID_5I1
suffix:colon
id|ha-&gt;ad_type
op_assign
...
multiline_comment|/* If there are Logical Drives and a Reset Occurred, then an EraseStripeLock is Needed */
r_if
c_cond
(paren
(paren
id|ha-&gt;conf-&gt;ucLogDriveCount
OG
l_int|0
)paren
op_logical_and
...
multiline_comment|/* Limit the Active Commands on a Lite Adapter */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Allow a WRITE BUFFER Command to Have no Data */
multiline_comment|/* This is Used by Tape Flash Utilites          */
r_if
c_cond
(paren
(paren
...
id|scb-&gt;scsi_cmd-&gt;request_buffer
suffix:semicolon
multiline_comment|/* Spin forward to last dma chunk */
id|sg_dma_index
op_assign
id|scb-&gt;breakup
suffix:semicolon
...
multiline_comment|/*                                                                          */
multiline_comment|/*   The FFDC Time Stamp use this function for the callback, but doesn&squot;t    */
multiline_comment|/*   actually need to wait.                                                 */
multiline_comment|/****************************************************************************/
r_static
r_int
...
(brace
multiline_comment|/* Won&squot;t be Waiting if this is a Time Stamp */
id|ha-&gt;waitflag
op_assign
id|TRUE
suffix:semicolon
...
multiline_comment|/* Don&squot;t Wait around if this is a Time Stamp */
id|ret
op_assign
id|ips_wait
c_func
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_scmd_buf_write                                         */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_scmd_buf_read                                          */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
...
id|scb-&gt;data_busaddr
op_assign
id|ha-&gt;logical_drive_info_dma_addr
suffix:semicolon
id|scb-&gt;flags
op_assign
l_int|0
...
id|IPS_CMD_WRITE
suffix:semicolon
id|scb-&gt;cmd.basic_io.enhanced_sg
op_assign
l_int|0
suffix:semicolon
id|scb-&gt;cmd.basic_io.sg_addr
...
id|scb-&gt;cmd.basic_io.segment_4G
op_assign
l_int|0
suffix:semicolon
id|scb-&gt;cmd.basic_io.command_id
...
l_int|0
suffix:semicolon
id|scb-&gt;cmd.dcdb.segment_4G
op_assign
l_int|0
suffix:semicolon
id|scb-&gt;cmd.dcdb.enhanced_sg
op_assign
l_int|0
suffix:semicolon
id|TimeOut
...
(brace
multiline_comment|/* If NEW Tape DCDB is Supported */
r_if
c_cond
(paren
op_logical_neg
...
id|scb-&gt;dcdb
suffix:semicolon
multiline_comment|/* Use Same Data Area as Old DCDB Struct */
id|tapeDCDB-&gt;device_address
op_assign
(paren
(paren
id|scb-&gt;bus
...
c_cond
(paren
id|ha-&gt;logical_drive_info-&gt;drive_info
(braket
id|scb-&gt;target_id
)braket
dot
...
l_int|0x8
suffix:colon
id|mdata.pdata.pg8.PageCode
op_assign
l_int|8
suffix:semicolon
id|mdata.pdata.pg8.PageLength
op_assign
r_sizeof
(paren
...
id|mdata.pdata.pg8.PageLength
suffix:semicolon
multiline_comment|/* everything else is left set to 0 */
r_break
suffix:semicolon
r_default
suffix:colon
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_deallocatescbs                                         */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*                                                                          */
multiline_comment|/*   Free the command blocks                                                */
multiline_comment|/*                                                                          */
multiline_comment|/****************************************************************************/
r_static
r_int
DECL|function|ips_deallocatescbs
id|ips_deallocatescbs
c_func
(paren
id|ips_ha_t
...
id|cmds
comma
id|ha-&gt;scbs-&gt;sg_list.list
comma
id|ha-&gt;scbs-&gt;sg_busaddr
)paren
suffix:semicolon
id|pci_free_consistent
c_func
...
suffix:semicolon
multiline_comment|/* Allocate memory for the SCBs */
id|ha-&gt;scbs
op_assign
id|pci_alloc_consistent
c_func
...
id|i
suffix:semicolon
multiline_comment|/* set up S/G list */
r_if
c_cond
(paren
id|IPS_USE_ENH_SGLIST
...
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*                                                                          */
multiline_comment|/*   Is controller initialized ?                                            */
multiline_comment|/*                                                                          */
multiline_comment|/****************************************************************************/
r_static
r_int
...
r_break
suffix:semicolon
multiline_comment|/* Delay for 1 Second */
id|MDELAY
c_func
(paren
id|IPS_ONE_SEC
...
(brace
multiline_comment|/*    Wait Up to 2 Min. for Completion */
id|Post
op_assign
id|readl
c_func
...
suffix:semicolon
multiline_comment|/* if we get here then everything went OK */
multiline_comment|/* Since we did a RESET, an EraseStripeLock may be needed */
r_if
c_cond
(paren
id|Post
...
suffix:semicolon
multiline_comment|/* Delay for 5 Seconds */
id|MDELAY
c_func
(paren
l_int|5
...
id|IPS_ONE_SEC
suffix:semicolon
multiline_comment|/* convert seconds */
r_while
c_loop
(paren
(paren
...
multiline_comment|/* This looks like a very evil loop, but it only does this during start-up */
id|udelay
c_func
(paren
l_int|1000
...
suffix:semicolon
multiline_comment|/* Check BIOS/FW/Driver Versions */
...
l_int|7
suffix:semicolon
multiline_comment|/* Allow Completed with Errors, so JCRM can access the Adapter to fix the problems */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*---------------------------------------------------------------------------*/
multiline_comment|/*   Routine Name: ips_version_check                                         */
multiline_comment|/*                                                                           */
multiline_comment|/*   Dependencies:                                                           */
...
suffix:semicolon
multiline_comment|/* Get the Compatible BIOS Version from NVRAM Page 5 */
id|memcpy
c_func
(paren
id|BiosVersion
comma
id|ha-&gt;nvram-&gt;BiosCompatibilityID
comma
id|IPS_COMPAT_ID_LENGTH
)paren
suffix:semicolon
...
id|FirmwareVersion
comma
id|VersionInfo-&gt;compatibilityId
comma
id|IPS_COMPAT_ID_LENGTH
)paren
suffix:semicolon
...
multiline_comment|/* printk(KERN_WARNING &quot;Adapter&squot;s BIOS Version  = %s&bslash;n&quot;, BiosVersion);          */
multiline_comment|/* printk(KERN_WARNING &quot;BIOS Compatible Version = %s&bslash;n&quot;, IPS_COMPAT_BIOS);      */
multiline_comment|/* printk(KERN_WARNING &quot;Adapter&squot;s Firmware Version  = %s&bslash;n&quot;, FirmwareVersion);  */
multiline_comment|/* printk(KERN_WARNING &quot;Firmware Compatible Version = %s &bslash;n&quot;, Compatable[ ha-&gt;nvram-&gt;adapter_type ]); */
id|MatchError
op_assign
l_int|0
suffix:semicolon
...
l_int|1
suffix:semicolon
id|ha-&gt;nvram-&gt;versioning
op_assign
l_int|1
suffix:semicolon
multiline_comment|/* Indicate the Driver Supports Versioning */
r_if
c_cond
(paren
id|MatchError
...
op_assign
id|IPS_CMD_GET_VERSION_INFO
suffix:semicolon
id|scb-&gt;cmd.version_info.op_code
op_assign
id|IPS_CMD_GET_VERSION_INFO
suffix:semicolon
id|scb-&gt;cmd.version_info.command_id
op_assign
id|IPS_COMMAND_ID
c_func
(paren
...
suffix:semicolon
id|scb-&gt;cmd.version_info.reserved
op_assign
l_int|0
suffix:semicolon
id|scb-&gt;cmd.version_info.count
op_assign
r_sizeof
(paren
id|IPS_VERSION_DATA
...
suffix:semicolon
id|scb-&gt;cmd.version_info.reserved2
op_assign
l_int|0
suffix:semicolon
id|scb-&gt;data_len
...
id|Buffer
suffix:semicolon
id|scb-&gt;cmd.version_info.buffer_addr
op_assign
id|Buffer
suffix:semicolon
id|scb-&gt;flags
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_abort_init                                             */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
...
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   helper function for ordering adapters                                  */
multiline_comment|/****************************************************************************/
r_static
r_void
...
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   place controllers is the &quot;proper&quot; boot order                           */
multiline_comment|/****************************************************************************/
r_static
r_void
...
multiline_comment|/* if adapter_order[0], then ordering is complete */
r_return
suffix:semicolon
)brace
multiline_comment|/* old bios, use older ordering */
id|tmp
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* if there were no 5I cards, then don&squot;t do any extra ordering */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   perform any registration and setup with the scsi layer                 */
multiline_comment|/****************************************************************************/
r_static
r_int
...
suffix:semicolon
multiline_comment|/* Install the interrupt handler with the new ha */
r_if
c_cond
(paren
id|request_irq
...
multiline_comment|/****************************************************************************/
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Name: ips_module_init                                            */
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   function called on module load                                         */
multiline_comment|/****************************************************************************/
r_static
r_int
id|__init
...
multiline_comment|/*                                                                          */
multiline_comment|/* Routine Description:                                                     */
multiline_comment|/*   function called on module unload                                       */
multiline_comment|/****************************************************************************/
r_static
r_void
id|__exit
...
suffix:semicolon
multiline_comment|/*---------------------------------------------------------------------------*/
multiline_comment|/*   Routine Name: ips_insert_device                                         */
multiline_comment|/*                                                                           */
multiline_comment|/*   Routine Description:                                                    */
multiline_comment|/*     Add One Adapter ( Hot Plug )                                          */
multiline_comment|/*                                                                           */
multiline_comment|/*   Return Value:                                                           */
multiline_comment|/*     0 if Successful, else non-zero                                        */
multiline_comment|/*---------------------------------------------------------------------------*/
...
multiline_comment|/*---------------------------------------------------------------------------*/
multiline_comment|/*   Routine Name: ips_init_phase1                                           */
multiline_comment|/*                                                                           */
multiline_comment|/*   Routine Description:                                                    */
multiline_comment|/*     Adapter Initialization                                                */
multiline_comment|/*                                                                           */
multiline_comment|/*   Return Value:                                                           */
multiline_comment|/*     0 if Successful, else non-zero                                        */
multiline_comment|/*---------------------------------------------------------------------------*/
...
id|pci_dev
comma
l_string|&quot;Unable to allocate logical drive info structure&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ips_abort_init
...
(brace
multiline_comment|/* If Morpheus appears dead, reset it */
id|IsDead
op_assign
id|readl
c_func
...
multiline_comment|/*---------------------------------------------------------------------------*/
multiline_comment|/*   Routine Name: ips_init_phase2                                           */
multiline_comment|/*                                                                           */
multiline_comment|/*   Routine Description:                                                    */
multiline_comment|/*     Adapter Initialization Phase 2                                        */
multiline_comment|/*                                                                           */
multiline_comment|/*   Return Value:                                                           */
multiline_comment|/*     0 if Successful, else non-zero                                        */
multiline_comment|/*---------------------------------------------------------------------------*/

...
mdefine_line|#define IPS_VERSION_HIGH        &quot;4.72&quot;
...
suffix:semicolon
multiline_comment|/***** Implement the following if it gets into a future kernel&n;#if LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,4,4)&n;         sh-&gt;max_sectors = 128;&n;#endif&n;******/
...
suffix:semicolon
multiline_comment|/* Copy the result back */
id|memcpy
c_func
(paren
id|SC-&gt;request_buffer
...
suffix:semicolon
multiline_comment|/* Get Sub Minor version */
id|writel
c_func
(paren
l_int|0x1FD

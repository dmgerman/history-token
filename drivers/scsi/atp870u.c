...
l_int|0x02
suffix:semicolon
multiline_comment|/*&n;&t;&t; *      Remap wide devices onto id numbers&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *      Remap wide identifiers&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|target_id
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *      Is this a wide device&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
l_int|0x18
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *      Check transfer direction&n;&t;&t;&t; */
r_if
c_cond
(paren
id|dev-&gt;id
...
id|go_42
suffix:colon
multiline_comment|/*&n;&t;&t;&t; *      Complete the command&n;&t;&t;&t; */
r_if
c_cond
(paren
id|workrequ-&gt;use_sg
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *      Clear it off the queue&n;&t;&t;&t; */
id|dev-&gt;id
(braket
id|target_id
)braket
...
r_else
(brace
singleline_comment|//              tmport = workportu + 0x17;
singleline_comment|//              inb(tmport);
singleline_comment|//              dev-&gt;working = 0;
id|dev-&gt;in_int
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n;&t; *      Check queue state&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;quhdu
...
multiline_comment|/*&n;&t; *      Write the command&n;&t; */
id|tmport
op_assign
id|workportu
suffix:semicolon
...
l_int|0x02
suffix:semicolon
multiline_comment|/*&n;&t; *      Write the target&n;&t; */
id|outb
c_func
(paren
id|dev-&gt;id
...
suffix:semicolon
multiline_comment|/*&n;&t; *      Figure out the transfer size&n;&t; */
r_if
c_cond
(paren
id|workrequ-&gt;use_sg
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; *      Write transfer size&n;&t; */
id|outb
c_func
(paren
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; *      Flip the wide bits&n;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;&t; *      Check transfer direction&n;&t; */
r_if
c_cond
(paren
id|workrequ-&gt;sc_data_direction
...
id|prd
suffix:semicolon
multiline_comment|/*&n;&t; *      Now write the request list. Either as scatter/gather or as&n;&t; *      a linear chain.&n;&t; */
r_if
c_cond
(paren
id|workrequ-&gt;use_sg
...
r_else
(brace
multiline_comment|/*&n;&t;&t; *      For a linear request write a chain of blocks&n;&t;&t; */
id|bttl
op_assign
id|workrequ-&gt;SCp.dma_handle
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;atp870u: 32bit DMA mask required but not available.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;   ACARD AEC-671X PCI Ultra/W SCSI-3 Host Adapter: %d &quot;
...
multiline_comment|/* Sort of - the thing handles itself */
r_return
id|SUCCESS
suffix:semicolon
)brace

...
id|map
suffix:semicolon
multiline_comment|/* base of array [QLOGICFC_MAX_ID + 1] */
r_struct
id|id_name_map
op_star
id|mapx
suffix:semicolon
multiline_comment|/* array entry pointer */
r_struct
id|isp2x00_hostdata
op_star
id|hostdata
...
c_func
(paren
l_string|&quot;qlogicfc%d : error getting memory -- cannot make port database.&bslash;n&quot;
comma
id|hostdata-&gt;host_id
)paren
suffix:semicolon
...
id|tmap
suffix:semicolon
multiline_comment|/* second array entry pointer */
r_if
c_cond
(paren
id|mapx-&gt;wwn
...
id|host-&gt;hostdata
suffix:semicolon
multiline_comment|/*&n;&t; *&t;This cannot be right - PCI writes are posted&n;&t; *&t;(apparently this is hardware design flaw not software ?)&n;&t; */
id|outw
c_func
(paren
l_int|0x01

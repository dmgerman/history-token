...
multiline_comment|/**&n; *&t;aac_rx_init&t;-&t;initialize an i960 based AAC card&n; *&t;@dev: device to configure&n; *&n; *&t;Allocate and set up resources for the i960 based AAC variants. The &n; *&t;device_interface in the commregion will be allocated and linked &n; *&t;to the comm region.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;%s%d: adapter kernel panic.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|instance

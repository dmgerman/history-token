...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Yes yes, I know this could be an index, but we have a&n;&t;&t; * better guarantee of uniqueness for the locked loop below.&n;&t;&t; * Without the aid of a persistent history, this also helps&n;&t;&t; * reduce the chance that the opaque context would be reused.&n;&t;&t; */
id|fibctx-&gt;unique
op_assign
(paren
id|u32
...
suffix:semicolon
multiline_comment|/* Ensure that we have a unique identifier */
id|entry
op_assign
...
(brace
multiline_comment|/* Not unique (32 bits) */
id|fibctx-&gt;unique
op_increment
suffix:semicolon
id|entry
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Extract the AdapterFibContext from the Input parameters.&n;&t;&t; */
r_if
c_cond
(paren
id|fibctx-&gt;unique
...
(paren
id|KERN_INFO
l_string|&quot;Fib Context not found&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
(paren
id|KERN_INFO
l_string|&quot;Fib Context corrupt?&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Extract the fibctx from the input parameters&n;&t;&t; */
r_if
c_cond
(paren
id|fibctx-&gt;unique
...
multiline_comment|/**&n; *&t;check_revision&t;-&t;close down user fib context&n; *&t;@dev: adapter&n; *&t;@arg: ioctl arguments&n; *&n; *&t;This routine returns the driver version.&n; *      Under Linux, there have been no version incompatibilities, so this is &n; *      simple!&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This should also catch if user used the 32 bit sgmap&n;&t;&t; */
id|actual_fibsize
op_assign
r_sizeof
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;aacraid: SG with no direction specified in Raw SRB command&bslash;n&quot;
)paren
suffix:semicolon
id|rcode
op_assign

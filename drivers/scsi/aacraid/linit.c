...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *&t;This function is called after the device list has&n;&t;&t;&t; *&t;been built to find the tagged queueing depth &n;&t;&t;&t; *&t;supported for each device.&n;&t;&t;&t; */
id|host_ptr-&gt;select_queue_depths
op_assign
id|aac_queuedepth
suffix:semicolon
id|aac
...
(paren
id|KERN_DEBUG
l_string|&quot;aac_queuedepth.&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dprintk
...
(paren
id|KERN_DEBUG
l_string|&quot;Device #   Q Depth   Online&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dprintk
...
comma
l_string|&quot;Raid Controller, scsi hba number&quot;
comma
id|host_no
)paren
suffix:semicolon

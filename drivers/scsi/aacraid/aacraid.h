...
suffix:semicolon
DECL|macro|CT_FLUSH_CACHE
mdefine_line|#define CT_FLUSH_CACHE 129
DECL|struct|aac_synchronize
r_struct
id|aac_synchronize
(brace
DECL|member|command
...
id|type
suffix:semicolon
multiline_comment|/* CT_FLUSH_CACHE */
DECL|member|cid
id|u32
id|cid
suffix:semicolon
...
id|count
suffix:semicolon
multiline_comment|/* sizeof(((struct aac_synchronize_reply *)NULL)-&gt;data) */
)brace
suffix:semicolon
DECL|struct|aac_synchronize_reply
r_struct
id|aac_synchronize_reply
(brace
DECL|member|dummy0
id|u32
id|dummy0

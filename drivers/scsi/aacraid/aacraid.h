...
mdefine_line|#define AAC_NUM_IO_FIB&t;512
DECL|macro|AAC_MAX_TARGET
mdefine_line|#define AAC_MAX_TARGET (MAXIMUM_NUM_CONTAINERS+1)
singleline_comment|//#define AAC_MAX_TARGET &t;(16)
...
id|aac_log_level
(brace
DECL|enumerator|LOG_INIT
id|LOG_INIT
op_assign
l_int|10
comma
DECL|enumerator|LOG_INFORMATIONAL
id|LOG_INFORMATIONAL
op_assign
l_int|20
comma
DECL|enumerator|LOG_WARNING
id|LOG_WARNING
op_assign
l_int|30
comma
DECL|enumerator|LOG_LOW_ERROR
id|LOG_LOW_ERROR
op_assign
l_int|40
comma
DECL|enumerator|LOG_MEDIUM_ERROR
id|LOG_MEDIUM_ERROR
op_assign
l_int|50
comma
DECL|enumerator|LOG_HIGH_ERROR
id|LOG_HIGH_ERROR
op_assign
l_int|60
comma
DECL|enumerator|LOG_PANIC
id|LOG_PANIC
op_assign
l_int|70
comma
DECL|enumerator|LOG_DEBUG
id|LOG_DEBUG
op_assign
l_int|80
comma
DECL|enumerator|LOG_WINDBG_PRINT
id|LOG_WINDBG_PRINT
op_assign
l_int|90
)brace
...
id|logical
suffix:semicolon
multiline_comment|/* This is the address we give the adapter */
DECL|member|base
r_struct
id|aac_entry
op_star
id|base
suffix:semicolon
multiline_comment|/* This is the system virtual address */
DECL|member|headers
r_struct
id|aac_qhdr
id|headers
suffix:semicolon
multiline_comment|/* A pointer to the producer and consumer queue headers for this queue */
DECL|member|entries
id|u32
id|entries
suffix:semicolon
multiline_comment|/* Number of queue entries on this queue */
DECL|member|qfull
id|wait_queue_head_t
id|qfull
suffix:semicolon
multiline_comment|/* Event to wait on if the queue is full */
DECL|member|cmdready
id|wait_queue_head_t
id|cmdready
suffix:semicolon
multiline_comment|/* Indicates there is a Command ready from the adapter on this queue. */
...
mdefine_line|#define FSCS_READONLY&t;0x0002&t;/*&t;possible result of broken mirror */
...
suffix:semicolon
DECL|macro|fib_data
mdefine_line|#define fib_data(fibctx) ((void *)(fibctx)-&gt;fib-&gt;data)
r_int
id|aac_detach
c_func
(paren

...
id|fibptr-&gt;fib-&gt;header.XferState
op_assign
id|cpu_to_le32
c_func
(paren
...
suffix:semicolon
id|fib-&gt;header.SenderFibAddress
op_assign
id|cpu_to_le32
c_func
(paren
...
suffix:semicolon
id|fib-&gt;header.ReceiverFibAddress
op_assign
id|cpu_to_le32
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;Queue %d full, %ld outstanding.&bslash;n&quot;
comma
id|qid
comma
id|q-&gt;numpending
...
suffix:semicolon
multiline_comment|/* for callback */
...
suffix:semicolon
id|fibptr-&gt;fib-&gt;header.Flags
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Zero the flags field - its internal only...&t; */
...
multiline_comment|/**&n; *&t;aac_handle_aif&t;&t;-&t;Handle a message from the firmware&n; *&t;@dev: Which adapter this fib is from&n; *&t;@fibptr: Pointer to fibptr from adapter&n; *&n; *&t;This routine handles a driver notify fib from the adapter and&n; *&t;dispatches it to the appropriate routine for handling.&n; */
DECL|function|aac_handle_aif
r_static
r_void
id|aac_handle_aif
c_func
...
id|fibptr-&gt;fib
suffix:semicolon
multiline_comment|/*&n;&t; * Set the status of this FIB to be Invalid parameter.&n;&t; *&n;&t; *&t;*(u32 *)fib-&gt;data = ST_INVAL;&n;&t; */
op_star
(paren
id|u32
op_star
...
id|fibptr
suffix:semicolon
multiline_comment|/* for error logging */
r_struct
id|aac_queue_block
op_star
id|queues

...
singleline_comment|//&t;hw_fib-&gt;header.SenderFibAddress = ((u32)(fibptr-dev-&gt;fibs)) &lt;&lt; 1;
id|hw_fib-&gt;header.SenderFibAddress
op_assign
id|cpu_to_le32
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;  hw_fib pa being sent=%xl&bslash;n&quot;
comma
(paren
id|ulong
)paren
...
(paren
(paren
l_string|&quot;aacraid: Command thread: removing fib from cmdq (%p)&bslash;n&quot;
comma
id|entry
)paren
)paren

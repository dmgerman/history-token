...
l_int|0
suffix:semicolon
DECL|variable|ipr_transop_timeout
r_static
r_int
r_int
id|ipr_transop_timeout
op_assign
...
comma
(brace
multiline_comment|/* Snipe and Scamp */
dot
id|mailbox
op_assign
l_int|0x0052C
...
comma
id|PCI_DEVICE_ID_ADAPTEC2_SCAMP
comma
op_amp
id|ipr_chip_cfg
(braket
...
id|fastfail
comma
l_string|&quot;Reduce timeouts and retries&quot;
)paren
suffix:semicolon
id|module_param_named
c_func
...
id|transop_timeout
comma
l_string|&quot;Time in seconds to wait for adapter to come operational (default: 300)&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
multiline_comment|/**&n; * ipr_oper_timeout -  Adapter timed out transitioning to operational&n; * @ipr_cmd:&t;ipr command struct&n; *&n; * This function blocks host requests and initiates an&n; * adapter reset.&n; *&n; * Return value:&n; * &t;none&n; **/
DECL|function|ipr_oper_timeout
r_static
r_void
id|ipr_oper_timeout
c_func
...
id|ioa_cfg-&gt;pdev-&gt;dev
comma
l_string|&quot;Adapter timed out transitioning to operational.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
macro_line|#endif
multiline_comment|/**&n; * ipr_change_queue_depth - Change the device&squot;s queue depth&n; * @sdev:&t;scsi device struct&n; * @qdepth:&t;depth to set&n; *&n; * Return value:&n; * &t;actual depth set&n; **/
DECL|function|ipr_change_queue_depth
r_static
r_int
id|ipr_change_queue_depth
c_func
(paren
r_struct
id|scsi_device
...
multiline_comment|/**&n; * ipr_change_queue_type - Change the device&squot;s queue type&n; * @dsev:&t;&t;scsi device struct&n; * @tag_type:&t;type of tags to use&n; *&n; * Return value:&n; * &t;actual queue type set&n; **/
DECL|function|ipr_change_queue_type
r_static
r_int
id|ipr_change_queue_type
c_func
(paren
r_struct
id|scsi_device
...
(brace
multiline_comment|/*&n;&t;&t;&t; * We don&squot;t bother quiescing the device here since the&n;&t;&t;&t; * adapter firmware does it for us.&n;&t;&t;&t; */
...
multiline_comment|/**&n; * ipr_get_chip_cfg - Find adapter chip configuration&n; * @dev_id:&t;&t;PCI device id struct&n; *&n; * Return value:&n; * &t;ptr to chip config on success / NULL on failure&n; **/
r_static
r_const
r_struct
id|ipr_chip_cfg_t
op_star
id|__devinit
DECL|function|ipr_get_chip_cfg
id|ipr_get_chip_cfg
c_func
(paren
r_const
...
id|pdev-&gt;dev
comma
l_string|&quot;Unknown adapter chipset 0x%04X 0x%04X&bslash;n&quot;
comma
id|dev_id-&gt;vendor
comma
id|dev_id-&gt;device

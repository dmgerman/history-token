...
DECL|struct|dc390_srb
r_struct
id|dc390_srb
(brace
singleline_comment|//u8&t;&t;CmdBlock[12];
...
mdefine_line|#define DC390_read8_(address, base)&t;&t;&bslash;&n;&t;(inb ((u16)(base) + (address)))
...
mdefine_line|#define DC390_write8_(address,value,base)&t;&bslash;&n;&t;outb ((value), (u16)(base) + (address))

...
macro_line|#ifdef SUPPORT_RESET
...
id|FCP_TARGET_RESET
suffix:semicolon
singleline_comment|// FIXME: this would panic, SCpnt-&gt;request would be NULL.
...
id|NOT_READY
suffix:colon
singleline_comment|// This happens if there is no disc in drive 
r_if
c_cond
(paren
id|dev-&gt;removable
...
l_int|0
suffix:semicolon
singleline_comment|// This is no longer considered an error
singleline_comment|// gag this error, VFS will log it anyway /axboe 
singleline_comment|// printk(KERN_INFO &quot;Disc change detected.&bslash;n&quot;); 
r_break
suffix:semicolon
)brace
suffix:semicolon
r_default
suffix:colon
singleline_comment|// Fall through for non-removable media
id|printk
c_func
(paren
...
macro_line|#endif /* SUPPORT_RESET */

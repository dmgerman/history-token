...
mdefine_line|#define IBMVSCSI_VERSION &quot;1.5.5&quot;
...
(paren
id|KERN_WARNING
l_string|&quot;ibmvscsi: bad SRP RSP type %d&bslash;n&quot;
comma
id|rsp-&gt;type
)paren
suffix:semicolon
...
(brace
multiline_comment|/* copy the response back */
r_if
c_cond
(paren
id|evt_struct-&gt;sync_srp
...
suffix:semicolon
multiline_comment|/* make sure we got a good response */
r_if
c_cond
(paren
id|unlikely
...
(paren
id|KERN_WARNING
l_string|&quot;ibmvscsi: abort bad SRP RSP type %d&bslash;n&quot;
comma
id|srp_rsp.srp.generic.type
)paren
suffix:semicolon
...
id|srp_rsp.srp.rsp.sense_and_response_data
)paren
suffix:semicolon
r_else
id|rsp_rc
op_assign
id|srp_rsp.srp.rsp.status
suffix:semicolon
r_if
c_cond
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;ibmvscsi: abort code %d for task tag 0x%lx&bslash;n&quot;
comma
id|rsp_rc
comma
id|tsk_mgmt-&gt;managed_task_tag
...
(paren
id|KERN_INFO
l_string|&quot;ibmvscsi: aborted task tag 0x%lx completed&bslash;n&quot;
comma
id|tsk_mgmt-&gt;managed_task_tag
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;ibmvscsi: reset bad SRP RSP type %d&bslash;n&quot;
comma
id|srp_rsp.srp.generic.type
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;ibmvscsi: reset code %d for task tag 0x%lx&bslash;n&quot;
comma
id|rsp_rc
comma
id|tsk_mgmt-&gt;managed_task_tag
...
(paren
id|KERN_ERR
l_string|&quot;ibmvscsi: received duplicate  correlation_token 0x%p!&bslash;n&quot;
comma
(paren
r_void
op_star

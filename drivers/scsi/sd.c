...
c_func
(paren
l_string|&quot;Unknown sd command %lx&bslash;n&quot;
comma
id|SCpnt-&gt;request.flags
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;(sd_init_onedisk:) Request allocation failure.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|i
...
(paren
id|KERN_WARNING
l_string|&quot;(sd_init_onedisk:) Memory allocation failure.&bslash;n&quot;
)paren
suffix:semicolon
...
mdefine_line|#define init_mem_lth(x,n)&t;x = kmalloc((n) * sizeof(*x), GFP_ATOMIC)
...
id|cleanup_gendisks
suffix:colon
multiline_comment|/* kfree can handle NULL, so no test is required here */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;Attached scsi %sdisk %s at scsi%d, channel %d, id %d, lun %d&bslash;n&quot;
comma
id|SDp-&gt;removable
ques
c_cond
...
DECL|macro|ALLOW_REVALIDATE
mdefine_line|#define ALLOW_REVALIDATE rscsi_disks[target].device-&gt;allow_revalidate
DECL|macro|USAGE

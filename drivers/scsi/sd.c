...
c_func
(paren
l_string|&quot;sd_rescan: disk=%s&bslash;n&quot;
comma
id|gd-&gt;disk_name
)paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;(sd_rescan:) Request allocation &quot;
...
c_cond
(paren
id|sdkp-&gt;device-&gt;host-&gt;unchecked_isa_dma
)paren
id|buffer
op_assign
id|kmalloc
...
l_int|4
suffix:semicolon
multiline_comment|/* start of mode page */
id|sdkp-&gt;WCE
op_assign
(paren
(paren
...
id|sdp-&gt;use_10_for_rw
op_assign
l_int|1
suffix:semicolon
id|sdp-&gt;use_10_for_ms
op_assign
l_int|0
suffix:semicolon
id|set_capacity

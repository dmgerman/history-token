...
multiline_comment|/*&n; * read write protect setting, if possible - called only in sd_init_onedisk()&n; * called with buffer of length 512&n; */
r_static
r_void
...
multiline_comment|/*&n; * sd_read_cache_type - called only from sd_init_onedisk()&n; * called with buffer of length 512&n; */
r_static
r_void
...
suffix:semicolon
multiline_comment|/* without media there is no reason to ask;&n;&t;   moreover, some devices react badly if we do */
r_if
c_cond
(paren
id|sdkp-&gt;media_present

...
suffix:semicolon
DECL|variable|scsi_disk_kobj_type
r_static
r_struct
id|kobj_type
id|scsi_disk_kobj_type
op_assign
(brace
dot
id|release
...
mdefine_line|#define to_scsi_disk(obj) container_of(obj,struct scsi_disk,kobj);
...
multiline_comment|/**&n; *&t;scsi_disk_release - Called to free the scsi_disk structure&n; *&t;@kobj: pointer to embedded kobject&n; **/

...
r_else
(brace
multiline_comment|/*&n;&t;&t; * force journal abort of barriers&n;&t;&t; */
...
DECL|function|sd_prepare_flush
r_static
r_int
id|sd_prepare_flush
c_func
...
multiline_comment|/* &n; * This gets directly called from VFS. When the ioctl &n; * is not recognized we go back to the other translation paths. &n; */
DECL|function|sd_compat_ioctl
r_static
r_int
id|sd_compat_ioctl
c_func
...
multiline_comment|/* &n;&t; * Let the static ioctl translation table take care of it.&n;&t; */
r_return
op_minus
id|ENOIOCTLCMD
suffix:semicolon
...
c_func
(paren
l_string|&quot;sd_rw_intr: sb[respc,sk,asc,&quot;
l_string|&quot;ascq]=%x,%x,%x,%x&bslash;n&quot;
comma
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * May want to warn and skip if following cast results&n;&t;&t;&t; * in actual truncation (if sector_t &lt; 64 bits)&n;&t;&t;&t; */
id|error_sector
op_assign
(paren
id|sector_t
...
l_int|0
suffix:semicolon
multiline_comment|/* not invoked for commands that could return deferred errors */
r_if
c_cond
(paren

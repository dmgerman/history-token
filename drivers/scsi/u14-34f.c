...
id|name
op_assign
l_string|&quot;UltraStor 14F/34F rev. 8.10.00 &quot;
comma
dot
id|detect
op_assign
...
mdefine_line|#define REGION_SIZE       13UL
...
multiline_comment|/* Device is Little Endian */
DECL|macro|H2DEV
mdefine_line|#define H2DEV(x) cpu_to_le32(x)
DECL|macro|DEV2H
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined(CONFIG_SCSI_U14_34F_TAGGED_QUEUE)
...
id|u14_34f
comma
l_string|&quot; equivalent to the &bslash;&quot;u14-34f=...&bslash;&quot; kernel boot &quot;
"&bslash;"
l_string|&quot;option.&quot;
"&bslash;"
l_string|&quot;      Example: modprobe u14-34f &bslash;&quot;u14_34f=0x340,0x330,lc:y,tm:0,mq:4&bslash;&quot;&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
c_func
(paren
l_string|&quot;UltraStor 14F/34F SCSI Driver&quot;
)paren
suffix:semicolon
macro_line|#endif
...
c_func
(paren
l_string|&quot;UltraStor 14F/34F: Copyright (C) 1994-2003 Dario Ballabio.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;%s config options -&gt; of:%c, tm:%d, lc:%c, mq:%d, et:%c.&bslash;n&quot;
comma
id|driver_name
comma
id|YESNO
...
DECL|function|u14_34f_eh_abort
r_static
r_int
id|u14_34f_eh_abort
c_func
...
DECL|function|u14_34f_eh_host_reset
r_static
r_int
id|u14_34f_eh_host_reset
c_func
...
DECL|function|u14_34f_bios_param
r_static
r_int
id|u14_34f_bios_param
c_func

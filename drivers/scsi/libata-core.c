...
(paren
id|KERN_ERR
l_string|&quot;ata%d: FIXME: PIO_ST_TMOUT&bslash;n&quot;
comma
...
(paren
id|KERN_ERR
l_string|&quot;ata%d: FIXME: PIO_ST_ERR&bslash;n&quot;
comma
multiline_comment|/* FIXME */
id|ap-&gt;id
)paren
...
multiline_comment|/**&n; *&t;ata_check_bmdma - read PCI IDE BMDMA status&n; *&t;@ap: struct ata_port&n; */
DECL|function|ata_check_bmdma
r_static
id|u8
id|ata_check_bmdma
c_func

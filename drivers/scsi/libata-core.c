...
DECL|function|atapi_pio_sector
r_static
r_void
id|atapi_pio_sector
c_func
...
id|err_out
suffix:semicolon
multiline_comment|/* make sure byte count is multiple of sector size; not&n;&t;* required by standard (warning! warning!), but IDE driver&n;&t;* does this to simplify things a bit.  We are lazy, and&n;&t;* follow suit.&n;&t;*/
r_if
c_cond
(paren
id|bytes

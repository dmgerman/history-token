...
multiline_comment|/* FIXME: hack. create a hook instead */
id|ata_irq_on
c_func
(paren
id|ap
...
DECL|function|ata_pr_blacklisted
r_static
r_void
id|ata_pr_blacklisted
c_func
(paren
r_struct
id|ata_port
...
(paren
id|KERN_WARNING
l_string|&quot;ata%u: dev %u is on DMA blacklist, disabling DMA&bslash;n&quot;
comma
id|ap-&gt;id
comma
id|dev-&gt;devno
...
DECL|variable|ata_dma_blacklist
r_static
r_const
r_char
op_star
id|ata_dma_blacklist
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|function|ata_dma_blacklisted
r_static
r_int
id|ata_dma_blacklisted
c_func
(paren
r_struct
id|ata_port
...
l_int|14
suffix:semicolon
id|probe_ent-&gt;hard_port_no
op_assign
l_int|0
suffix:semicolon
id|probe_ent-&gt;legacy_mode
op_assign
l_int|1
suffix:semicolon
...
l_int|15
suffix:semicolon
id|probe_ent2-&gt;hard_port_no
op_assign
l_int|1
suffix:semicolon
id|probe_ent2-&gt;legacy_mode
op_assign
l_int|1
suffix:semicolon
id|probe_ent-&gt;port
...
suffix:semicolon
DECL|variable|ata_bmdma_status
id|EXPORT_SYMBOL_GPL
c_func
(paren
id|ata_bmdma_status

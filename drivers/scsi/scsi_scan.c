...
(brace
multiline_comment|/*&n;&t;&t; * Scanning MAX_SCSI_LUNS units would be a bad idea.&n;&t;&t; * Any better idea?&n;&t;&t; * I think we need REPORT LUNS in future to avoid scanning&n;&t;&t; * of unused LUNs. But, that is another item.&n;&t;&t; *&n;&t;&t; * FIXME(eric) - perhaps this should be a kernel configurable?&n;&t;&t; */
r_if
c_cond
(paren
op_star
...
(brace
multiline_comment|/* &n;&t;&t; * Scanning MAX_SCSI_LUNS units would be a bad idea.&n;&t;&t; * Any better idea?&n;&t;&t; * I think we need REPORT LUNS in future to avoid scanning&n;&t;&t; * of unused LUNs. But, that is another item.&n;&t;&t; */
r_if
c_cond
(paren
op_star
...
multiline_comment|/*&n; * The worker for scan_scsis.&n; * Returns the scsi_level of lun0 on this host, channel and dev (if already&n; * known), otherwise returns SCSI_2.&n; */

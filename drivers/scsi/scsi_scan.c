...
macro_line|#endif
multiline_comment|/* Driverfs file content handlers */
...
suffix:semicolon
multiline_comment|/* end content handlers */
...
suffix:semicolon
multiline_comment|/* interrogate scsi target to provide device identifier */
id|scsi_load_identifier
c_func
(paren
id|SDpnt
...
suffix:semicolon
multiline_comment|/* create driverfs files */
id|sprintf
c_func
(paren
id|SDpnt-&gt;sdev_driverfs_dev.bus_id
comma
l_string|&quot;%d:%d:%d:%d&quot;
comma
...
suffix:semicolon
id|SDpnt-&gt;sdev_driverfs_dev.parent
op_assign
op_amp
id|SDpnt-&gt;host-&gt;host_driverfs_dev
suffix:semicolon
id|SDpnt-&gt;sdev_driverfs_dev.bus
op_assign
op_amp
...
(paren
op_amp
id|SDpnt-&gt;sdev_driverfs_dev
)paren
suffix:semicolon
multiline_comment|/* Create driverfs file entries */
...
DECL|macro|SCSI_UID_DEV_ID
mdefine_line|#define SCSI_UID_DEV_ID  &squot;U&squot;
...
multiline_comment|/* Use vital product pages to determine serial number */
multiline_comment|/* Try Supported vital product data pages 0x00 first */
id|scsi_cmd
(braket
l_int|0
)braket
...
multiline_comment|/* check to see if response was truncated */
r_if
c_cond
(paren
id|evpd_page
...
suffix:semicolon
multiline_comment|/* some ill behaved devices return the std inquiry here rather than&n;&t;&t;the evpd data. snoop the data to verify */
r_if
c_cond
(paren
id|evpd_page
...
(brace
multiline_comment|/* if vend id appears in the evpd page assume evpd is invalid */
r_if
c_cond
(paren
op_logical_neg
...
id|id
op_assign
id|SDpnt-&gt;sdev_driverfs_dev.name
suffix:semicolon
r_int
id|lun
op_assign
...
(brace
multiline_comment|/* try to obtain serial number anyway */
r_if
c_cond
(paren
op_logical_neg

...
(brace
multiline_comment|/* release fn is set up in scsi_sysfs_device_initialise, so&n;&t;&t; * have to free and put manually here */
id|put_device
c_func
(paren
op_amp
...
(brace
multiline_comment|/*&n;&t;&t;&t; * if LLDD reports slave not present, don&squot;t clutter&n;&t;&t;&t; * console with alloc failure messages&n;&n;&n;&t;&t;&t; */
r_if
c_cond
(paren
id|ret
...
DECL|function|scsi_is_target_device
r_int
...
DECL|variable|scsi_is_target_device
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_is_target_device
...
suffix:semicolon
DECL|function|__scsi_find_target
r_static
r_struct
id|scsi_target
op_star
id|__scsi_find_target
c_func
(paren
r_struct
id|device
...
DECL|function|scsi_alloc_target
r_static
r_struct
id|scsi_target
op_star
...
suffix:semicolon
multiline_comment|/* allocate and add */
...
multiline_comment|/**&n; * scsi_target_reap - check to see if target is in use and destroy if not&n; *&n; * @starget: target to be checked&n; *&n; * This is used after removing a LUN or doing a last put of the target&n; * it checks atomically that nothing is using the target and removes&n; * it if so.&n; */
DECL|function|scsi_target_reap
r_void
id|scsi_target_reap
c_func
(paren
...
multiline_comment|/**&n; * scsi_probe_and_add_lun - probe a LUN, if a LUN is found add it&n; * @starget:&t;pointer to target device structure&n; * @lun:&t;LUN of target device&n; * @sdevscan:&t;probe the LUN corresponding to this Scsi_Device&n; * @sdevnew:&t;store the value of any new Scsi_Device allocated&n; * @bflagsp:&t;store bflags here if not NULL&n; *&n; * Description:&n; *     Call scsi_probe_lun, if a LUN with an attached device is found,&n; *     allocate and set it up by calling scsi_add_lun.&n; *&n; * Return:&n; *     SCSI_SCAN_NO_RESPONSE: could not allocate or setup a Scsi_Device&n; *     SCSI_SCAN_TARGET_PRESENT: target responded, but no device is&n; *         attached at the LUN&n; *     SCSI_SCAN_LUN_PRESENT: a new Scsi_Device was allocated and initialized&n; **/
...
(paren
id|KERN_INFO
l_string|&quot;scsi scan: device exists on %s&bslash;n&quot;
comma
...
multiline_comment|/**&n; * scsi_sequential_lun_scan - sequentially scan a SCSI target&n; * @starget:&t;pointer to target structure to scan&n; * @bflags:&t;black/white list flag for LUN 0&n; * @lun0_res:&t;result of scanning LUN 0&n; *&n; * Description:&n; *     Generally, scan from LUN 1 (LUN 0 is assumed to already have been&n; *     scanned) to some maximum lun until a LUN is found with no device&n; *     attached. Use the bflags to figure out any oddities.&n; *&n; *     Modifies sdevscan-&gt;lun.&n; **/
...
id|out_reap
suffix:colon
multiline_comment|/* now determine if the target has any children at all&n;&t; * and if not, nuke it */
id|scsi_target_reap
c_func
(paren
id|starget
...
DECL|variable|scsi_scan_target
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_scan_target
...
suffix:semicolon
multiline_comment|/**&n; * scsi_scan_single_target - scan the given SCSI target&n; * @shost:         adapter to scan&n; * @chan:          channel to scan&n; * @id:            target id to scan&n; **/
DECL|function|scsi_scan_single_target
r_void

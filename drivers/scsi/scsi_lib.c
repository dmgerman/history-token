...
multiline_comment|/* -------------------------------------------------- */
DECL|function|scsi_create_cmdcache
r_int
...
id|ENOMEM
suffix:semicolon
id|scsi_core-&gt;scsi_cmd_dma_cache
op_assign
id|kmem_cache_create
c_func
(paren
...
multiline_comment|/* end scsi_create_cmdcache() */
multiline_comment|/* -------------------------------------------------- */
DECL|function|scsi_destroy_cmdcache
r_int
id|scsi_destroy_cmdcache
c_func
(paren
...
(paren
id|KERN_CRIT
l_string|&quot;Failed to free scsi command cache&quot;
l_string|&quot; -- memory leak&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/* end scsi_destroy_cmdcache() */
multiline_comment|/* -------------------------------------------------- */
...
multiline_comment|/* end scsi_get_command() */
multiline_comment|/* -------------------------------------------------- */
multiline_comment|/* scsi_put_command: free a scsi_cmnd struct.&n;   Note: the command must not belong to any lists!&n;*/
...
(paren
id|KERN_NOTICE
l_string|&quot;Trying to free a command which&quot;
l_string|&quot; doesn&squot;t belong to scsi core?!&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* Memory leak, but let the system survive for now --&n;&t;&t;    they&squot;ll get it eventually! */
r_return
suffix:semicolon
)brace
id|host
...
multiline_comment|/* end scsi_put_command() */
multiline_comment|/* -------------------------------------------------- */
multiline_comment|/* scsi_setup_command: This will do post-alloc init of the command.&n;   We want to do as little as possible here.&n;*/
DECL|function|scsi_setup_command
r_void
...
multiline_comment|/* end scsi_setup_command() */
multiline_comment|/* -------------------------------------------------- */
eof

...
multiline_comment|/*&n; * The target associated with myself can only handle one active command at&n; * a time. Scan through all of the luns on the same target as myself,&n; * return 1 if any are active.&n; */

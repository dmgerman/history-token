...
multiline_comment|/*&n; * Called for single_lun devices on IO completion. Clear starget_busy, and&n; * Call __blk_run_queue for all the scsi_devices on the target - including&n; * current_sdev first.&n; *&n; * Called with *no* scsi locks held.&n; */
...
(paren
op_logical_neg
id|current_sdev-&gt;sdev_target-&gt;starget_busy
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/*&n;&t; * Call __blk_run_queue for all LUNs on the target, starting with&n;&t; * current_sdev.&n;&t; */
id|__blk_run_queue
c_func
(paren
...
id|sdev-&gt;device_busy
op_logical_and
id|sdev-&gt;sdev_target-&gt;starget_busy
)paren
r_goto
id|after_host_lock
suffix:semicolon

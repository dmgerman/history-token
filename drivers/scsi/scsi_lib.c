...
suffix:semicolon
multiline_comment|/*&n;&t; * set REQ_SPECIAL - we have a command&n;&t; * clear REQ_DONTPREP - we assume the sg table has been &n;&t; *&t;nuked so we need to set it up again.&n;&t; */

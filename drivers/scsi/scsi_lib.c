...
multiline_comment|/* note the overloading of req-&gt;special.  When the tag&n;&t;&t; * is active it always means SCpnt.  If the tag goes&n;&t;&t; * back for re-queueing, it may be reset */
id|req-&gt;special
op_assign
id|SCpnt
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* &n;&t;&t;&t; * This sets up the scatter-gather table (allocating if&n;&t;&t;&t; * required).&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

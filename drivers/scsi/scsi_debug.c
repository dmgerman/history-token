...
suffix:semicolon
DECL|variable|sdebug_host_list_lock
r_static
id|spinlock_t
...
id|sdebug_host_info
op_star
DECL|function|sdebug_shost_to_host_info
id|sdebug_shost_to_host_info
c_func
(paren
r_struct
id|Scsi_Host
...
(paren
id|KERN_ERR
l_string|&quot;Unable to locate host info&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
(brace
multiline_comment|/* free up adapters here ?? */
id|stop_all_queued
c_func
(paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: sdebug_host_info not found&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: scsi_remove_host failed&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

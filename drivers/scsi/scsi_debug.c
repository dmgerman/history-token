...
suffix:semicolon
DECL|variable|scsi_debug_hosts
r_struct
id|sdebug_host_info
op_star
id|scsi_debug_hosts
...
suffix:semicolon
r_int
id|scsi_debug_unregister_driver
c_func
(paren
r_struct
id|device_driver
...
id|spare_buff
suffix:semicolon
multiline_comment|/* assume cmd moves no data */
id|bufflen
op_assign
id|SDEBUG_SENSE_LEN
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;scsi_debug_max_luns: usage scsi_debug_max_luns=&lt;n&gt; &quot;
l_string|&quot;(&lt;n&gt; is a postive integer (def=2))&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;scsi_debug_max_luns=&quot;
comma
id|max_luns_setup
)paren
suffix:semicolon
DECL|function|scsi_level_setup
r_static
r_int
id|__init
id|scsi_level_setup
...
(paren
id|KERN_INFO
l_string|&quot;scsi_debug_scsi_level: usage &quot;
l_string|&quot;scsi_debug_scsi_level=&lt;n&gt; (&lt;n&gt; is 1..4 (def=3))&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;scsi_debug_scsi_level=&quot;
comma
id|scsi_level_setup
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;scsi_debug_add_host: usage &quot;
l_string|&quot;scsi_debug_add_host=&lt;n&gt;&bslash;n&quot;
l_string|&quot;    &lt;n&gt; 0..127 (default 1)&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
DECL|function|sdebug_dev_size_mb_read
r_static
id|ssize_t
id|sdebug_dev_size_mb_read
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_every_nth_read
r_static
id|ssize_t
id|sdebug_every_nth_read
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_max_luns_read
r_static
id|ssize_t
id|sdebug_max_luns_read
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_scsi_level_read
r_static
id|ssize_t
id|sdebug_scsi_level_read
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_add_host_read
r_static
id|ssize_t
id|sdebug_add_host_read
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_add_host_write
r_static
id|ssize_t
id|sdebug_add_host_write
c_func
(paren
r_struct
id|device_driver
...
DECL|function|sdebug_add_shost
r_static
r_void
id|sdebug_add_shost
c_func
...
(paren
id|KERN_ERR
l_string|&quot;sdebug_add_shost: sdebug_add_adapter failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;sdebug_add_shost: scsi_register failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;sdebug_add_shost: scsi_add_host failed&bslash;n&quot;
)paren
suffix:semicolon
id|scsi_unregister
c_func
...
DECL|function|sdebug_remove_shost
r_static
r_void
id|sdebug_remove_shost
c_func
...
(paren
id|KERN_ERR
l_string|&quot;scsi_debug_init: out of memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_string|&quot;sdebug_add_shost failed k=%d&bslash;n&quot;
comma
id|k
)paren
suffix:semicolon
...
suffix:semicolon
DECL|function|scsi_debug_register_driver
r_int
id|scsi_debug_register_driver
c_func
(paren
...
DECL|function|scsi_debug_unregister_driver
r_int
id|scsi_debug_unregister_driver
c_func
(paren

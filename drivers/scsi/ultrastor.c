...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;     * Brrr, &amp;config.mscp[0].SCint-&gt;host) it is something magical....&n;     * XXX and FIXME&n;     */
r_if
c_cond
(paren
id|request_irq
...
(paren
id|KERN_WARNING
l_string|&quot;(ultrastor:) Could not register scsi device. Aborting registration.&bslash;n&quot;
)paren
suffix:semicolon
id|free_irq
c_func
...
DECL|function|ultrastor_release
r_static
r_int
id|ultrastor_release
c_func
(paren
r_struct
id|Scsi_Host
...
id|name
op_assign
l_string|&quot;UltraStor 14F/24F/34F&quot;
comma
dot
id|detect
op_assign

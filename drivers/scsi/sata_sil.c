...
(paren
id|KERN_INFO
l_string|&quot;ata%u(%u): applying pessimistic Maxtor errata fix&bslash;n&quot;
comma
id|ap-&gt;id
comma
id|dev-&gt;devno
...
(paren
id|KERN_INFO
l_string|&quot;ata%u(%u): applying pessimistic Seagate errata fix&bslash;n&quot;
comma
id|ap-&gt;id
comma
id|dev-&gt;devno

...
mdefine_line|#define DRV_VERSION&t;&quot;0.9&quot;
r_enum
(brace
...
l_int|1
comma
DECL|enumerator|SIL_FIFO_R0
id|SIL_FIFO_R0
op_assign
l_int|0x40
comma
DECL|enumerator|SIL_FIFO_W0
id|SIL_FIFO_W0
op_assign
l_int|0x41
comma
DECL|enumerator|SIL_FIFO_R1
id|SIL_FIFO_R1
op_assign
l_int|0x44
comma
DECL|enumerator|SIL_FIFO_W1
id|SIL_FIFO_W1
op_assign
l_int|0x45
comma
DECL|enumerator|SIL_FIFO_R2
id|SIL_FIFO_R2
op_assign
l_int|0x240
comma
DECL|enumerator|SIL_FIFO_W2
id|SIL_FIFO_W2
op_assign
l_int|0x241
comma
DECL|enumerator|SIL_FIFO_R3
id|SIL_FIFO_R3
op_assign
l_int|0x244
comma
DECL|enumerator|SIL_FIFO_W3
id|SIL_FIFO_W3
op_assign
l_int|0x245
comma
...
suffix:semicolon
DECL|function|sil_get_device_cache_line
r_static
r_int
r_char
id|sil_get_device_cache_line
c_func
(paren
r_struct
id|pci_dev
...
multiline_comment|/* Initialize FIFO PCI bus arbitration */
id|cls
op_assign
id|sil_get_device_cache_line
c_func
...
op_increment
suffix:semicolon
multiline_comment|/* cls = (line_size/8)+1 */
id|writeb
c_func
(paren
id|cls

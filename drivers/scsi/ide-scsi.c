...
id|failed
suffix:semicolon
multiline_comment|/* we accept everything except ide-disk */
r_if
c_cond
(paren
id|drive-&gt;media
...
(brace
multiline_comment|/* is cmd active?&n;&t;&t;&t; *  need to lock so this stuff doesn&squot;t change under us */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
(brace
multiline_comment|/* yep - let&squot;s give it some more time - &n;&t;&t;&t;&t; * we can do that, we&squot;re in _our_ error kernel thread */
id|spin_unlock_irqrestore
c_func
(paren
op_amp
...
suffix:semicolon
id|idescsi_host-&gt;max_id
op_assign
id|id
suffix:semicolon
id|idescsi_host-&gt;max_lun
op_assign
id|last_lun
op_plus
l_int|1

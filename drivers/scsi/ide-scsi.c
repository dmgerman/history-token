...
id|scsi
suffix:semicolon
multiline_comment|/* FIXME: The following is just plain wrong, since those are definitely *not* the&n;&t; * media types supported by the ATA layer */
id|byte
id|media
(braket
)braket
...
id|REQ_SPECIAL
suffix:semicolon
multiline_comment|/* FIX ME, the next executable line causes on oops in lk 2.5.10-dj1&n;&t; * [code copied from ide-cd&squot;s ide_cdrom_reset(), does it work?]&n;&t; */
id|ide_do_drive_cmd
c_func
(paren
id|drive
...
suffix:semicolon
multiline_comment|/* FIXME: The media types scanned here have literally nothing to do&n;&t; * with the media types used by the overall ATA code!&n;&t; *&n;&t; * This is basically showing us, that there is something wrong with the&n;&t; * ide_scan_devices function.&n;&t; */
r_for
c_loop
(paren
id|i

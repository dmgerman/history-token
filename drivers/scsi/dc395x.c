...
mdefine_line|#define DC395x_read8(acb,address)&t;&t;(u8)(inb(acb-&gt;IOPortBase + (address)))
...
mdefine_line|#define DC395x_read16(acb,address)&t;&t;(u16)(inw(acb-&gt;IOPortBase + (address)))
DECL|macro|DC395x_read32
mdefine_line|#define DC395x_read32(acb,address)&t;&t;(u32)(inl(acb-&gt;IOPortBase + (address)))
DECL|macro|DC395x_write8
mdefine_line|#define DC395x_write8(acb,address,value)&t;outb((value), acb-&gt;IOPortBase + (address))
...
mdefine_line|#define DC395x_write16(acb,address,value)&t;outw((value), acb-&gt;IOPortBase + (address))
DECL|macro|DC395x_write32
mdefine_line|#define DC395x_write32(acb,address,value)&t;outl((value), acb-&gt;IOPortBase + (address))
DECL|macro|BUS_ADDR
...
id|acb
suffix:semicolon
DECL|member|going_srb
r_struct
id|ScsiReqBlk
op_star
id|going_srb
suffix:semicolon
DECL|member|going_last
r_struct
id|ScsiReqBlk
op_star
id|going_last
suffix:semicolon
DECL|member|waiting_srb
r_struct
id|ScsiReqBlk
op_star
id|waiting_srb
...
id|max_command
suffix:semicolon
DECL|member|going_srb_count
id|u16
id|going_srb_count
suffix:semicolon
DECL|member|waiting_srb_count
id|u16
id|waiting_srb_count
suffix:semicolon
...
id|IOPortBase
suffix:semicolon
DECL|member|link_dcb
r_struct
id|DeviceCtlBlk
op_star
id|link_dcb
suffix:semicolon
DECL|member|last_dcb
r_struct
id|DeviceCtlBlk
op_star
id|last_dcb
...
id|srb
suffix:semicolon
multiline_comment|/*DC395x_Free_integrity (acb); */
id|srb
op_assign
id|acb-&gt;free_srb
suffix:semicolon
...
r_static
r_inline
DECL|function|insert_srb_waiting
r_void
id|insert_srb_waiting
c_func
(paren
r_struct
id|DeviceCtlBlk
...
id|DBG_0
comma
l_string|&quot;Insert srb %p cmd %li to Waiting&bslash;n&quot;
comma
id|srb
comma
id|srb-&gt;cmd-&gt;pid
...
r_static
r_inline
DECL|function|append_srb_waiting
r_void
id|append_srb_waiting
c_func
(paren
r_struct
id|DeviceCtlBlk
...
id|DBG_0
comma
l_string|&quot;Append srb %p cmd %li to Waiting&bslash;n&quot;
comma
id|srb
comma
id|srb-&gt;cmd-&gt;pid
...
r_static
r_inline
DECL|function|append_srb_going
r_void
id|append_srb_going
c_func
(paren
...
id|srb-&gt;next
suffix:semicolon
multiline_comment|/*srb-&gt;next = NULL; */
r_return
id|pre
suffix:semicolon
)brace
...
r_static
DECL|function|remove_srb_going
r_void
id|remove_srb_going
c_func
(paren
...
r_static
DECL|function|remove_srb_waiting
r_void
id|remove_srb_waiting
c_func
(paren
r_struct
id|DeviceCtlBlk
...
r_static
DECL|function|move_srb_going_to_waiting
r_void
id|move_srb_going_to_waiting
c_func
(paren
r_struct
id|DeviceCtlBlk
...
r_static
r_inline
DECL|function|move_srb_waiting_to_going
r_void
id|move_srb_waiting_to_going
c_func
(paren
r_struct
id|DeviceCtlBlk
...
suffix:semicolon
multiline_comment|/*      srb = waiting_srb_get(dcb); */
...
id|cfg0
suffix:semicolon
multiline_comment|/*dcb-&gt;AdpMode = eeprom-&gt;channel_cfg; */
id|period_index
op_assign
id|eeprom-&gt;target
(braket
...
l_string|&quot; %s&bslash;n&quot;
comma
id|acb-&gt;active_dcb-&gt;active_srb-&gt;debugtrace
)paren
suffix:semicolon
r_return
l_int|1
...
suffix:semicolon
multiline_comment|/*TRACEOUT (&quot; %s&bslash;n&quot;, srb-&gt;debugtrace); */
id|srb-&gt;msg_count
op_assign
l_int|1
suffix:semicolon
...
c_cond
(paren
id|dcb_temp-&gt;target_id
op_eq
id|bval
)paren
(brace
id|dcb_temp-&gt;sync_period
op_assign
id|dcb-&gt;sync_period
suffix:semicolon
id|dcb_temp-&gt;sync_offset
op_assign
id|dcb-&gt;sync_offset
suffix:semicolon
id|dcb_temp-&gt;sync_mode
op_assign
id|dcb-&gt;sync_mode
suffix:semicolon
id|dcb_temp-&gt;min_nego_period
op_assign
id|dcb-&gt;min_nego_period
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/*dump_register_info (acb, dcb, srb); */
multiline_comment|/*TRACEOUT (&quot; %s&bslash;n&quot;, srb-&gt;debugtrace); */
multiline_comment|/*dcb-&gt;flag |= ABORT_DEV_; */
multiline_comment|/*enable_msgout_abort (acb, srb); */
...
multiline_comment|/*if (arblostflag) TRACEOUT (&quot; %s&bslash;n&quot;, srb-&gt;debugtrace); */
)brace
id|srb-&gt;scsi_phase
op_assign
id|PH_BUS_FREE
...
id|dcb-&gt;waiting_srb
suffix:semicolon
multiline_comment|/*struct ScsiReqBlk* wait_list = dcb-&gt;wait_list; */
id|u16
id|waiting_srb_count
op_assign
id|dcb-&gt;waiting_srb_count
...
suffix:semicolon
multiline_comment|/*dcb-&gt;going_srb_count = 0;; */
multiline_comment|/*dcb-&gt;going_srb = NULL; dcb-&gt;going_last = NULL; */
...
multiline_comment|/*dcb-&gt;waiting_srb_count = 0;; */
multiline_comment|/*dcb-&gt;waiting_srb = NULL; dcb-&gt;wait_list = NULL; */
id|dcb-&gt;flag
op_and_assign
op_complement
id|ABORT_DEV_
...
multiline_comment|/*&n; *********************************************************************&n; *&t;&t;dc395x_queue_command&n; *&n; * Function : void init_dcb&n; *  Purpose : initialize the internal structures for a given DCB&n; *   Inputs : cmd - pointer to this scsi cmd request block structure&n; *********************************************************************&n; */
r_static
DECL|function|init_dcb
r_void
id|init_dcb
c_func
(paren
...
suffix:semicolon
multiline_comment|/*dcb = find_dcb (acb, target, lun); */
op_star
id|pdcb
op_assign
id|dcb
...
id|dcb-&gt;sync_mode
op_assign
id|prevDCB-&gt;sync_mode
suffix:semicolon
id|dcb-&gt;sync_period
op_assign
id|prevDCB-&gt;sync_period
suffix:semicolon
id|dcb-&gt;min_nego_period
op_assign
id|prevDCB-&gt;min_nego_period
suffix:semicolon
id|dcb-&gt;sync_offset
op_assign
id|prevDCB-&gt;sync_offset
suffix:semicolon
id|dcb-&gt;inquiry7
op_assign
id|prevDCB-&gt;inquiry7
...
multiline_comment|/*      acb-&gt;srb_array[i].debugtrace, i); */
id|dc395x_kfree
c_func
(paren
id|acb-&gt;srb_array
...
multiline_comment|/*      PAGE_SIZE, ptr, srb_idx); */
id|i
op_assign
l_int|0
suffix:semicolon
...
id|KERN_DEBUG
comma
l_string|&quot;No space for tmsrb tracebuf reserved?!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/*      acb-&gt;srb_array[i].segment_x, i); */
id|dc395x_kfree
c_func
(paren
id|acb-&gt;srb_array
...
multiline_comment|/*&n; ********************************************************************&n; * scsiio&n; *&t;&t;init_acb&n; ********************************************************************&n; */
DECL|function|link_srb
r_static
r_void
id|__init
id|link_srb
...
multiline_comment|/*&n; ***********************************************************************&n; *&t;&t;host_init&n; *&n; * Function : static void init_acb&n; *  Purpose :  initialize the internal structures for a given SCSI host&n; *   Inputs : host - pointer to this host adapter&squot;s structure&n; ***********************************************************************&n; */
r_static
DECL|function|init_acb
r_int
id|__init
id|init_acb
c_func
...
suffix:semicolon
multiline_comment|/*acb-&gt;scsi_host-&gt;this_lun = 0; */
id|acb-&gt;dcb_count
op_assign
l_int|0
suffix:semicolon
...
id|DBG_0
comma
l_string|&quot;acb = %p, pdcb_map = %p, psrb_array = %p&bslash;n&quot;
comma
id|acb
comma
id|acb-&gt;dcb_map
...
multiline_comment|/**&n; * print_config - print adapter connection and termination&n; * config&n; *&n; * @acb:&t;adapter control block&n; **/
r_static
...
multiline_comment|/*&n; *********************************************************************&n; *&t;&t;&t;DC395x_detect&n; *&n; *      Function : static int host_init (struct Scsi_Host *host)&n; *       Purpose : initialize the internal structures for a given SCSI host&n; *        Inputs : host - pointer to this host adapter&squot;s structure/&n; * Preconditions : when this function is called, the chip_type&n; *&t;&t;   field of the acb structure MUST have been set.&n; *********************************************************************&n; */
r_static
DECL|function|host_init
r_struct
id|Scsi_Host
op_star
id|__init
...
multiline_comment|/**&n; * chip_shutdown - cleanly shut down the scsi controller chip,&n; * stopping all operations and disablig interrupt generation on the&n; * card.&n; *&n; * @acb: The scsi adapter control block of the adapter to shut down.&n; **/
r_static
DECL|function|chip_shutdown
r_void
id|chip_shutdown
c_func
(paren
...
multiline_comment|/**&n; * free_dcbs - Free all of the DCBs.&n; *&n; * @acb: Adapter to remove the DCBs for.&n; **/
r_static
DECL|function|free_dcbs
r_void
id|free_dcbs
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Free the DCB. This removes the entry from the&n;&t;&t; * link_dcb list and decrements the count in dcb_count&n;&t;&t; */
id|remove_dev
c_func
(paren
id|acb
...
multiline_comment|/**&n; * host_release - shutdown device and release resources that were&n; * allocate for it. Called once for each card as it is shutdown.&n; *&n; * @host: The adapter instance to shutdown.&n; **/
r_static
DECL|function|host_release
r_void
id|host_release
c_func
(paren
...
id|DBG_0
comma
l_string|&quot;host_init failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

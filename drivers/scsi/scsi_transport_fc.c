...
(brace
op_amp
id|class_device_attr_seconds_since_last_reset.attr
comma
op_amp
id|class_device_attr_tx_frames.attr
comma
op_amp
id|class_device_attr_tx_words.attr
comma
op_amp
id|class_device_attr_rx_frames.attr
comma
op_amp
id|class_device_attr_rx_words.attr
comma
op_amp
id|class_device_attr_lip_count.attr
comma
op_amp
id|class_device_attr_nos_count.attr
comma
op_amp
id|class_device_attr_error_frames.attr
comma
op_amp
id|class_device_attr_dumped_frames.attr
comma
op_amp
id|class_device_attr_link_failure_count.attr
comma
op_amp
id|class_device_attr_loss_of_sync_count.attr
comma
op_amp
id|class_device_attr_loss_of_signal_count.attr
comma
op_amp
id|class_device_attr_prim_seq_protocol_err_count.attr
comma
op_amp
id|class_device_attr_invalid_tx_word_count.attr
comma
op_amp
id|class_device_attr_invalid_crc_count.attr
comma
op_amp
id|class_device_attr_fcp_input_requests.attr
comma
op_amp
id|class_device_attr_fcp_output_requests.attr
comma
op_amp
id|class_device_attr_fcp_control_requests.attr
comma
op_amp
id|class_device_attr_fcp_input_megabytes.attr
comma
op_amp
id|class_device_attr_fcp_output_megabytes.attr
comma
op_amp
id|class_device_attr_reset_statistics.attr
comma
l_int|NULL
)brace
suffix:semicolon

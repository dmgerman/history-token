...
suffix:semicolon
multiline_comment|/* printk(&quot;st: allocated %x, order %d&bslash;n&quot;, STbuffer-&gt;sg[segs].page, order); */
id|STbuffer-&gt;sg
(braket
id|segs
)braket
...
suffix:semicolon
multiline_comment|/* empty */
multiline_comment|/* printk(&quot;st: freeing %x, order %d&bslash;n&quot;, STbuffer-&gt;sg[i].page, order); */
id|__free_pages
c_func
(paren
id|STbuffer-&gt;sg
...
DECL|function|st_device_kdev_read
r_static
id|ssize_t
id|st_device_kdev_read
c_func
(paren
r_struct
id|device
...
DECL|variable|st_device_kdev_file
r_static
r_struct
...
suffix:semicolon
DECL|function|st_device_type_read
r_static
id|ssize_t
id|st_device_type_read
c_func
(paren
r_struct
id|device
...
DECL|variable|st_device_type_file
r_static
r_struct
id|driver_file_entry
...
id|buffer-&gt;use_sg
op_assign
id|tpnt-&gt;device-&gt;host-&gt;sg_tablesize
suffix:semicolon
id|tpnt-&gt;buffer
op_assign
id|buffer
...
(paren
id|KERN_INFO
l_string|&quot;st: Version %s, fixed bufsize %d, wrt %d, &quot;
l_string|&quot;s/g segs %d&bslash;n&quot;
comma
id|verstr
comma
id|st_fixed_buffer_size
...
(brace
id|st_template.scsi_driverfs_driver.name
op_assign
(paren
r_char
op_star
...
id|st_template.tag
suffix:semicolon
id|st_template.scsi_driverfs_driver.bus
op_assign
op_amp
id|scsi_driverfs_bus_type
suffix:semicolon
...
(paren
op_amp
id|st_template.scsi_driverfs_driver
)paren
suffix:semicolon
r_return
l_int|0

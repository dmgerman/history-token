...
(paren
id|KERN_WARNING
l_string|&quot;st: scsi_tapes[] not &quot;
l_string|&quot;empty after scsi_unregister_device&bslash;n&quot;
)paren
suffix:semicolon
id|st_detach
c_func
...
suffix:semicolon
multiline_comment|/* The sysfs interface. Read-only at the moment */

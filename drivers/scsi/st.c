...
id|max_sg_segs
comma
l_string|&quot;Maximum number of scatter/gather segments to use (64)&quot;
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Previously buffered data not written */
id|count
op_sub_assign
id|do_count
suffix:semicolon

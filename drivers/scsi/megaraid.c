...
macro_line|#if LINUX_VERSION_CODE &gt;= KERNEL_VERSION(2,4,0)
macro_line|#if 0
multiline_comment|/*&n; *&t;This leads to corruption on some HP boards so disable it&n; */

...
mdefine_line|#define pci_unmap_single(a,b,c,d,e)
...
(paren
(paren
l_string|&quot;M_RD_PTHRU_WITH_SGLIST Enabled &bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
macro_line|#endif&t;&t;&t;&t;/* KERNEL_VERSION(2,3,0) */
macro_line|#if DEBUG
...
suffix:semicolon
multiline_comment|/* We need to handle special commands like READ64, WRITE64&n;&t;&t;   as they need a minimum of 1 SG irrespective of actaully SG&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
macro_line|#endif
macro_line|#ifdef MEGA_HP_FIX&t;&t;/* use HP firmware and bios version encoding */
id|sprintf
(paren
id|megaCfg-&gt;fwVer
comma
...
suffix:semicolon
multiline_comment|/*&n;&t; * issue command to find out if the BIOS is enbled for this controller&n;&t; */
id|mbox
(braket
l_int|0
)braket
...
id|megaCfg
comma
l_string|&quot;Interrupts Collected = %u&bslash;n&quot;
comma
(paren
id|u32
)paren
...
id|megaCfg
comma
l_string|&quot;&bslash;tReads Issued = %10u, Writes Issued = %10u&bslash;n&quot;
comma
(paren
id|u32
)paren
...
id|megaCfg
comma
l_string|&quot;&bslash;tSectors Read = %10u, Sectors Written = %10u&bslash;n&bslash;n&quot;
comma
(paren
id|u32
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * We do not transfer more than IOCTL_MAX_DATALEN (see megaraid.h) with&n;&t; * this interface.If the user needs to transfer more than this,he should&n;&t; * use 0x81 command op-code.&n;&t; */
...
multiline_comment|/*&n;&t; * The first call the applications should make is to find out the number&n;&t; * of controllers in the system. The next logical call should be for&n;&t; * getting the list of controllers in the system as detected by the&n;&t; * driver.&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;* For M_RD_IOCTL_CMD_NEW commands, the fields outlen and inlen of uioctl_t&n;* structure are treated as flags. If outlen is 1, the data is&n;* transferred from the device and if inlen is 1, the data is&n;* transferred to the device.&n;*/
id|outlen
op_assign
id|ioc.outlen
suffix:semicolon
...
multiline_comment|/* How many pages required of size PAGE_SIZE */
id|npages
op_assign
id|ioc.ui.fcs.length
op_div
id|PAGE_SIZE
suffix:semicolon
multiline_comment|/* Do we need one more? */
r_if
c_cond
(paren
id|ioc.ui.fcs.length
...
op_increment
suffix:semicolon
multiline_comment|/* ioctl does not support data xfer &gt; 32KB */
r_if
c_cond
(paren
id|npages
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Allocate kernel space for npages.&n;&t;&t;&t; *&n;&t;&t;&t; * Since we need the memory for DMA, it needs to be physically&n;&t;&t;&t; * contiguous. __get_free_pags() return consecutive free pages&n;&t;&t;&t; * in kernel space.&n;&t;&t;&t; * Note: We don&squot;t do __get_dma_pages(), since for PCI devices,&n;&t;&t;&t; * the DMA memory is not restriceted to 16M, which is ensured&n;&t;&t;&t; * by __get_dma_pages()&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Find this host in the hostlist&n;&t;&t; */
r_for
c_loop
(paren
id|shpnt

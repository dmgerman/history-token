...
id|j
suffix:semicolon
multiline_comment|/* This separation of pScript and script is not strictly&n;&t; * necessay, but may be useful in architectures which can&n;&t; * allocate consistent memory on which virt_to_bus will not&n;&t; * work */
id|script
op_assign
id|kmalloc
c_func
...
multiline_comment|/* This separation of slots and pSlots may facilitate later&n;&t; * migration to consistent memory on architectures which&n;&t; * support it */
id|hostdata-&gt;slots
op_assign
id|kmalloc
c_func
...
(paren
id|KERN_ERR
l_string|&quot;53c700: Failed to allocate command slots or message buffers, detatching&bslash;n&quot;
)paren
suffix:semicolon
id|scsi_unregister
c_func
...
multiline_comment|/* now patch up fixed addresses. &n;&t; * NOTE: virt_to_bus may be wrong if consistent memory is used&n;&t; * for these in the future */
id|script_patch_32
c_func
(paren
id|script
...
suffix:semicolon
multiline_comment|/* NOTE: these may be NULL if we weren&squot;t fully initialised before&n;&t; * the scsi_unregister was called */
id|kfree
c_func
(paren
id|hostdata-&gt;script

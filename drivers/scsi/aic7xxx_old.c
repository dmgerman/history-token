...
multiline_comment|/* We don&squot;t know what to do here, so bail. */
r_break
suffix:semicolon
r_if
c_cond
...
l_int|63
suffix:semicolon
multiline_comment|/* pull this crap because 64bit math in the kernel is a no-no as far&n;     * as division is concerned, but 64bit multiplication can be done */
multiline_comment|/* This shift approximates capacity / (heads * sectors) */
id|cylinders
op_assign
id|capacity
op_rshift
l_int|14
suffix:semicolon
multiline_comment|/* Now we brute force upping cylinders until we go over by 1 */
r_while
c_loop
(paren
id|capacity
...
multiline_comment|/* Then back it back down by one */
id|cylinders
op_decrement
suffix:semicolon
)brace

...
mdefine_line|#define AIC7XXX_C_VERSION  &quot;5.2.5&quot;
DECL|macro|NUMBER
...
id|aic_devs
suffix:semicolon
multiline_comment|/* all aic devs on host */
DECL|member|host_no
r_int
id|host_no
suffix:semicolon
...
multiline_comment|/*+F*************************************************************************&n; * Function:&n; *   aic7xxx_init_aic_dev&n; *&n; * Description:&n; *   Set up the initial aic_dev values from the BIOS settings and data&n; *   we got back from INQUIRY commands.&n; *-F*************************************************************************/
r_static
r_void
DECL|function|aic7xxx_init_aic_dev
id|aic7xxx_init_aic_dev
c_func
(paren
r_struct
id|aic7xxx_host

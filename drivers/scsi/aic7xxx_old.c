...
(paren
id|INFO_LEAD
l_string|&quot;Reset device, hardware_scb %d,&bslash;n&quot;
comma
id|p-&gt;host_no
comma
id|channel
...
multiline_comment|/*+F*************************************************************************&n; * Function:&n; *   aic7xxx_slave_alloc&n; *&n; * Description:&n; *   Set up the initial aic_dev struct pointers&n; *-F*************************************************************************/
r_static
r_int
DECL|function|aic7xxx_slave_alloc
...
multiline_comment|/*+F*************************************************************************&n; * Function:&n; *   aic7xxx_slave_destroy&n; *&n; * Description:&n; *   prepare for this device to go away&n; *-F*************************************************************************/
r_static
r_void
DECL|function|aic7xxx_slave_destroy
...
multiline_comment|/*+F*************************************************************************&n; * Function:&n; *   aic7xxx_slave_configure&n; *&n; * Description:&n; *   Configure the device we are attaching to the controller.  This is&n; *   where we get to do things like scan the INQUIRY data, set queue&n; *   depths, allocate command structs, etc.&n; *-F*************************************************************************/
r_static
r_int
DECL|function|aic7xxx_slave_configure
...
(paren
id|KERN_INFO
l_string|&quot;(scsi%d) IO Memory at 0x%lx, MMAP Memory at %p&bslash;n&quot;
comma
id|p-&gt;host_no
comma
id|p-&gt;mbase

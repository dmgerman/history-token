multiline_comment|/***************************************************************************&n;                          dpti.c  -  description&n;                             -------------------&n;    begin                : Thu Sep 7 2000&n;    copyright            : (C) 2000 by Adaptec&n;&n;&t;&t;&t;   July 30, 2001 First version being submitted&n;&t;&t;&t;   for inclusion in the kernel.  V2.4&n;&n;    See Documentation/scsi/dpti.txt for history, notes, license info&n;    and credits&n; ***************************************************************************/
...
multiline_comment|/***************************************************************************&n; * Sat Dec 20 2003 Go Taniguchi &lt;go@turbolinux.co.jp&gt;&n; - Support 2.6 kernel and DMA-mapping&n; - ioctl fix for raid tools&n; - use schedule_timeout in long long loop&n; **************************************************************************/
multiline_comment|/*#define DEBUG 1 */
multiline_comment|/*#define UARTDELAY 1 */
multiline_comment|/* On the real kernel ADDR32 should always be zero for 2.4. GFP_HIGH allocates&n;   high pages. Keep the macro around because of the broken unmerged ia64 tree */
DECL|macro|ADDR32
...
(brace
singleline_comment|// I/O issued, but cannot get result in
singleline_comment|// specified time. Freeing resorces is
singleline_comment|// dangerous.
id|status
op_assign
op_minus
id|ETIME
...
c_func
(paren
l_string|&quot;adpt_i2o_passthru: post wait failed %d %p&bslash;n&quot;
comma
id|rcode
comma
id|reply
...
(paren
id|KERN_CRIT
l_string|&quot;%s: query scalar failed; Out of memory.&bslash;n&quot;
comma
id|pHba-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: issue params failed; Timed out.&bslash;n&quot;
comma
id|pHba-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: issue params failed; Interrupted.&bslash;n&quot;
comma
id|pHba-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;adpt_i2o_issue_params: post_wait failed (%p)&bslash;n&quot;
comma
id|resblk
)paren
suffix:semicolon

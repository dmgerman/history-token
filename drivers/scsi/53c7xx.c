...
c_func
(paren
l_string|&quot;scsi-ncr53c7xx : %s at memory 0x%lx, io 0x%x, irq %d&quot;
comma
id|chip_str
comma
id|base
...
(paren
id|KERN_ERR
l_string|&quot;53c7xx: hostdata &gt; 8K&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;53c7xx: allocate_cmd size &gt; 4K&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL

...
op_decrement
suffix:semicolon
multiline_comment|/* Cleanup proc */
...
suffix:semicolon
multiline_comment|/* Get one backup command for this host. */
id|cmd
op_assign
id|scsi_get_command
c_func
...
(paren
id|KERN_NOTICE
l_string|&quot;The system is running low in memory.&bslash;n&quot;
)paren
suffix:semicolon

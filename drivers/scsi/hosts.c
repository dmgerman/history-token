...
r_int
id|__init
DECL|function|scsi_ignore_no_error_handling_setup
id|scsi_ignore_no_error_handling_setup
c_func
(paren
r_char
op_star
...
c_func
(paren
l_string|&quot;scsi_ignore_no_error_handling=&quot;
comma
id|scsi_ignore_no_error_handling_setup
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ERROR: not attaching this host.&bslash;n&bslash;nERROR: to force attachment, boot with the scsi_ignore_no_error_handling flag&quot;
)paren
suffix:semicolon
r_return
l_int|NULL

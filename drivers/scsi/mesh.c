...
suffix:semicolon
DECL|variable|mesh_sleep_notifier
r_static
r_struct
id|pmu_sleep_notifier
id|mesh_sleep_notifier
op_assign
(brace
id|mesh_notify_sleep
comma
...
(paren
id|KERN_ERR
l_string|&quot;mesh: Can&squot;t locate PCI entry&bslash;n&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
r_int
DECL|function|mesh_notify_sleep
id|mesh_notify_sleep
c_func
(paren
r_struct
...
suffix:colon
multiline_comment|/* XXX We should wait for current transactions and queue&n;&t;&t; * new ones that would be posted beyond this point &n;&t;&t; */
r_break
suffix:semicolon
r_case
...
multiline_comment|/*&n; * Work out whether we expect data to go out from the host adaptor or into it.&n; */
r_static
r_int

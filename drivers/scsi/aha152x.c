...
DECL|enumerator|check_condition
id|check_condition
op_assign
l_int|0x0800
comma
multiline_comment|/* requesting sense after CHECK CONDITION */
)brace
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
DECL|function|aha152x_probe_one
r_struct
id|Scsi_Host
op_star
...
(paren
id|KERN_ERR
l_string|&quot;aha152x: scsi_host_alloc failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
(paren
id|KERN_ERR
l_string|&quot;aha152x%d: irq %d busy.&bslash;n&quot;
comma
id|shpnt-&gt;host_no
comma
id|shpnt-&gt;irq
...
(paren
id|KERN_ERR
l_string|&quot;aha152x%d: irq %d possibly wrong.  &quot;
l_string|&quot;Please verify.&bslash;n&quot;
comma
id|shpnt-&gt;host_no
comma
id|shpnt-&gt;irq
...
(paren
id|KERN_ERR
l_string|&quot;aha152x%d: failed to reassign irq %d.&bslash;n&quot;
comma
id|shpnt-&gt;host_no
comma
id|shpnt-&gt;irq
...
(paren
id|KERN_ERR
l_string|&quot;aha152x%d: failed to add host.&bslash;n&quot;
comma
id|shpnt-&gt;host_no
)paren
suffix:semicolon
...
(paren
id|INFO_LEAD
l_string|&quot;queue: %p; cmd_len=%d pieces=%d size=%u cmnd=&quot;
comma
id|CMDINFO
c_func
(paren
...
(paren
id|ERR_LEAD
l_string|&quot;cannot reuse command&bslash;n&quot;
comma
id|CMDINFO
c_func
(paren
...
multiline_comment|/*&n; *  queue a command&n; *&n; */
...
comma
id|INFO_LEAD
l_string|&quot;reset_done called&bslash;n&quot;
comma
id|CMDINFO
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;aha152x: reset_done w/o semaphore&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
multiline_comment|/*&n; * Reset a device&n; *&n; */
...
(paren
id|DEBUG_LEAD
l_string|&quot;queue corrupted at %p&bslash;n&quot;
comma
id|CMDINFO
c_func
(paren
...
comma
id|DEBUG_LEAD
l_string|&quot;bus resetted&bslash;n&quot;
comma
id|CMDINFO
c_func
(paren
...
multiline_comment|/*&n;&t; * Read a couple of registers that are known to not be all 1&squot;s. If&n;&t; * we read all 1&squot;s (-1), that means that either:&n;&t; *&n;&t; * a. The host adapter chip has gone bad, and we cannot control it,&n;&t; *&t;OR&n;&t; * b. The host adapter is a PCMCIA card that has been ejected&n;&t; *&n;&t; * In either case, we cannot do anything with the host adapter at&n;&t; * this point in time. So just ignore the interrupt and return.&n;&t; * In the latter case, the interrupt might actually be meant for&n;&t; * someone else sharing this IRQ, and that driver will handle it.&n;&t; */
id|rev
op_assign
id|GETPORT
c_func
...
macro_line|#endif
multiline_comment|/* restore old command */
id|memcpy
c_func
(paren
(paren
...
suffix:semicolon
id|DONE_SC-&gt;request_buffer
op_assign
id|DONE_SC-&gt;buffer
suffix:semicolon
id|DONE_SC-&gt;request_bufflen
op_assign
id|DONE_SC-&gt;bufflen
suffix:semicolon
id|DONE_SC-&gt;use_sg
op_assign
id|DONE_SC-&gt;old_use_sg
suffix:semicolon
id|DONE_SC-&gt;cmd_len
op_assign
id|DONE_SC-&gt;old_cmd_len
suffix:semicolon
...
id|hostno
op_assign
id|DONE_SC-&gt;device-&gt;host-&gt;host_no
suffix:semicolon
r_int
id|id
op_assign
id|DONE_SC-&gt;device-&gt;id
op_amp
l_int|0xf
suffix:semicolon
r_int
...
c_func
(paren
l_string|&quot;; next=(host scribble NULL)&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;aha152x: io port 0x%x busy.&bslash;n&quot;
comma
id|setup-&gt;io_port
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;aha152x: found ISAPnP adapter at io=0x%03x, irq=%d&bslash;n&quot;
comma
id|setup
(braket
id|setup_count
...
c_func
(paren
l_string|&quot;%d controller(s) configured&bslash;n&quot;
comma
id|setup_count
)paren
suffix:semicolon

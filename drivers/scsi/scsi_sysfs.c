...
r_static
id|ssize_t
DECL|function|show_iostat_counterbits
id|show_iostat_counterbits
c_func
(paren
r_struct
id|device
...
comma
op_amp
id|dev_attr_iocounterbits
comma
op_amp
id|dev_attr_iorequest_cnt
comma
op_amp
id|dev_attr_iodone_cnt
comma
op_amp
id|dev_attr_ioerr_cnt
comma
l_int|NULL
)brace
suffix:semicolon
...
DECL|function|scsi_is_sdev_device
r_int
...
DECL|variable|scsi_is_sdev_device
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_is_sdev_device

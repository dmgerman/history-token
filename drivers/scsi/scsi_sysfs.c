...
r_static
id|ssize_t
DECL|function|show_queue_type_field
id|show_queue_type_field
c_func
(paren
r_struct
id|device
...
suffix:semicolon
DECL|function|sdev_store_queue_type_rw
r_static
id|ssize_t
id|sdev_store_queue_type_rw
c_func
(paren
r_struct
id|device
...
DECL|variable|sdev_attr_queue_type_rw
r_static
r_struct
id|device_attribute
id|sdev_attr_queue_type_rw
op_assign
id|__ATTR
c_func
(paren
...
op_logical_and
id|shost-&gt;hostt-&gt;change_queue_type
)paren
r_return
op_amp
id|sdev_attr_queue_type_rw

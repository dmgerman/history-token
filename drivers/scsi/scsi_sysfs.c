...
suffix:semicolon
DECL|function|__scsi_remove_target
r_void
id|__scsi_remove_target
c_func
(paren
r_struct
id|scsi_target
...
multiline_comment|/**&n; * scsi_remove_target - try to remove a target and all its devices&n; * @dev: generic starget or parent of generic stargets to be removed&n; *&n; * Note: This is slightly racy.  It is possible that if the user&n; * requests the addition of another device then the target won&squot;t be&n; * removed.&n; */
DECL|function|scsi_remove_target
r_void
...
DECL|variable|scsi_remove_target
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_remove_target

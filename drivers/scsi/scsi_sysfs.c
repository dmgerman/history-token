...
suffix:semicolon
multiline_comment|/**&n; * scsi_remove_target - try to remove a target and all its devices&n; * @starget: the target to remove&n; *&n; * Note: This is slightly racy.  It is possible that if the user&n; * requests the addition of another device then the target won&squot;t be&n; * removed.&n; */

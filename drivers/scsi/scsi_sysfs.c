...
id|scsi_bus_type
suffix:semicolon
id|sdev-&gt;sdev_driverfs_dev.release
op_assign
id|scsi_device_release
suffix:semicolon
...
multiline_comment|/** scsi_sysfs_modify_shost_attribute - modify or add a host class attribute&n; *&n; * @class_attrs:host class attribute list to be added to or modified&n; * @attr:&t;individual attribute to change or added&n; *&n; * returns zero if successful or error if not&n; **/
DECL|function|scsi_sysfs_modify_shost_attribute
r_int
...
DECL|variable|scsi_sysfs_modify_shost_attribute
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_sysfs_modify_shost_attribute
...
suffix:semicolon
multiline_comment|/** scsi_sysfs_modify_sdev_attribute - modify or add a host device attribute&n; *&n; * @dev_attrs:&t;pointer to the attribute list to be added to or modified&n; * @attr:&t;individual attribute to change or added&n; *&n; * returns zero if successful or error if not&n; **/
DECL|function|scsi_sysfs_modify_sdev_attribute
r_int
...
DECL|variable|scsi_sysfs_modify_sdev_attribute
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_sysfs_modify_sdev_attribute
...
suffix:semicolon
DECL|function|scsi_sysfs_release_attributes
r_void
...
DECL|variable|scsi_sysfs_release_attributes
id|EXPORT_SYMBOL
c_func
(paren
id|scsi_sysfs_release_attributes

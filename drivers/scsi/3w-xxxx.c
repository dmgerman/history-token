...
l_int|0
comma
id|tw_ioctl-&gt;data_buffer_length
)paren
suffix:semicolon
...
c_cond
(paren
id|tw_ioctl-&gt;firmware_command.byte0.sgl_offset
)paren
(brace
r_case
l_int|2
...
multiline_comment|/* This function handles close for the character device */
DECL|function|tw_chrdev_release
r_static
r_int
id|tw_chrdev_release
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_ioctl_release()&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* End tw_chrdev_release() */
...
multiline_comment|/* Set card status as online */
id|tw_dev-&gt;online
op_assign
l_int|1
suffix:semicolon
macro_line|#ifdef CONFIG_3W_XXXX_CMD_PER_LUN
id|tw_host-&gt;cmd_per_lun
op_assign
id|CONFIG_3W_XXXX_CMD_PER_LUN
suffix:semicolon
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* Need to init the sem/wqueue after the copy */
id|init_MUTEX
c_func
(paren
op_amp
id|tw_dev2-&gt;ioctl_sem
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Unable to set features for card %d, old firmware or card.&bslash;n&quot;
comma
id|j
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: No cards found.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Unable to register &bslash;&quot;twe&bslash;&quot; character device, error = %d.&bslash;n&quot;
comma
id|twe_major
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Don&squot;t load sg_list for non-data ATA cmds */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_ioctl(): Passthru size (%d) too big.&bslash;n&quot;
comma
id|passthru-&gt;sg_list
(braket
l_int|0
...
id|ioctl-&gt;data
suffix:semicolon
multiline_comment|/* Don&squot;t return data for non-data ATA cmds */
r_if
c_cond
(paren
(paren
...
r_else
(brace
multiline_comment|/* For non-data cmds, return cmd pkt */
r_if
c_cond
(paren
id|tw_dev-&gt;srb
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_poll_status_gone(): Unexpected bits.&bslash;n&quot;
)paren
suffix:semicolon
id|tw_decode_bits
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_poll_status_gone(): Flag 0x%x never disappeared.&bslash;n&quot;
comma
id|flag
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Unit #%d: Command (%p) timed out.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
comma
id|tw_dev-&gt;srb
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Unit #%d: Command (%p) timed out, resetting card.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
comma
id|tw_dev-&gt;srb
...
(paren
id|KERN_INFO
l_string|&quot;Physical command packet addr: 0x%lx&bslash;n&quot;
comma
id|tw_dev-&gt;command_packet_physical_address
(braket
id|j
...
multiline_comment|/* This function will configure individual target parameters */
DECL|function|tw_slave_configure
r_int
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_slave_configure()&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#ifdef CONFIG_3W_XXXX_CMD_PER_LUN
id|max_cmds
...
multiline_comment|/* End tw_slave_configure() */

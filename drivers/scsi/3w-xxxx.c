...
mdefine_line|#define TW_DRIVER_VERSION &quot;1.26.02.001&quot;
...
DECL|function|tw_change_queue_depth
r_static
r_int
id|tw_change_queue_depth
c_func
(paren
r_struct
id|scsi_device
...
multiline_comment|/* End tw_change_queue_depth() */
...
multiline_comment|/* We timed out, and didn&squot;t get an interrupt */
r_if
c_cond
(paren
id|tw_dev-&gt;chrdev_request_id
...
suffix:semicolon
multiline_comment|/* Shutdown the card */
id|__tw_shutdown
c_func
(paren
id|tw_dev

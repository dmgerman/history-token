...
suffix:semicolon
r_case
id|TW_AEN_APORT_TIMEOUT
suffix:colon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Received drive timeout AEN on port %d, check drive and drive cables.&bslash;n&quot;
comma
id|aen
op_rshift
l_int|8
...
suffix:semicolon
r_case
id|TW_AEN_DRIVE_ERROR
suffix:colon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Received drive error AEN on port %d, check/replace cabling, or possible bad drive.&bslash;n&quot;
comma
id|aen
op_rshift
l_int|8
...
suffix:semicolon
r_case
id|TW_AEN_SMART_FAIL
suffix:colon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Received S.M.A.R.T. threshold AEN on port %d, check drive/cooling, or possible bad drive.&bslash;n&quot;
comma
id|aen
op_rshift
l_int|8
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Received SBUF integrity check failure AEN, reseat card or bad card.&bslash;n&quot;
)paren
suffix:semicolon
id|queue
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: PCI Parity Error: Reseat card, move card, or buggy device on the bus.&bslash;n&quot;
)paren
suffix:semicolon
id|outl
c_func
...
multiline_comment|/* This function will print readable messages from flags and status values */
DECL|function|tw_decode_error
r_void
id|tw_decode_error
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_decode_error()&bslash;n&quot;
)paren
suffix:semicolon
r_switch
c_cond
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Drive timeout on unit %d, check drive and drive cables.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
comma
id|unit
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Unrecoverable drive error on unit %d, check/replace cabling, or possible bad drive.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
comma
id|unit
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Controller error: status = 0x%x, flags = 0x%x, unit #%d.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
comma
id|status
...
multiline_comment|/* End tw_decode_error() */
...
multiline_comment|/* Find raid 5 arrays */
r_for
c_loop
(paren
id|j
...
l_int|0x6
suffix:semicolon
multiline_comment|/* unit descriptor */
id|param-&gt;parameter_size_bytes
op_assign
l_int|0xc
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Found unit %d to be a raid5 unit.&bslash;n&quot;
comma
id|j
)paren
suffix:semicolon
...
id|num_raid_five
suffix:semicolon
multiline_comment|/* Now allocate raid5 bounce buffers */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: Bounce buffer allocation failed.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: scsi%d: Card not responding, retrying.&bslash;n&quot;
comma
id|tw_dev-&gt;host-&gt;host_no
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Do this if there are no sg list entries for raid 5 */
r_if
c_cond
(paren
id|tw_dev-&gt;srb
...
(paren
id|KERN_WARNING
l_string|&quot;doing raid 5 write use_sg = 0, bounce_buffer[%d] = 0x%p&bslash;n&quot;
comma
id|request_id
comma
id|tw_dev-&gt;bounce_buffer
...
multiline_comment|/* Do this if we have multiple sg list entries for raid 5 */
r_if
c_cond
(paren
id|tw_dev-&gt;srb
...
(paren
id|KERN_WARNING
l_string|&quot;doing raid 5 write use_sg = %d, sglist[0].length = %d&bslash;n&quot;
comma
id|tw_dev-&gt;srb
(braket
id|request_id

multiline_comment|/*&n; *&n; *&t;&t;&t;Linux MegaRAID device driver&n; *&n; * Copyright (c) 2003-2004  LSI Logic Corporation.&n; *&n; *&t;   This program is free software; you can redistribute it and/or&n; *&t;   modify it under the terms of the GNU General Public License&n; *&t;   as published by the Free Software Foundation; either version&n; *&t;   2 of the License, or (at your option) any later version.&n; *&n; * FILE&t;&t;: megaraid_mm.c&n; * Version&t;: v2.20.0.0 (June 23 2004)&n; *&n; * Common management module&n; */
...
l_int|0
suffix:semicolon
DECL|variable|adparr
r_static
id|mraid_mmadp_t
id|adparr
(braket
id|MAX_LSI_CMN_ADAPS
)braket
suffix:semicolon
...
multiline_comment|/**&n; * mraid_mm_get_adpindex - Returns adp number from mimd_t user packet&n; * @umimd&t;: User space mimd_t ioctl packet&n; * @adp_index&t;: Contains adp number if success&n; */
r_static
r_int
DECL|function|mraid_mm_get_adpindex
id|mraid_mm_get_adpindex
c_func
(paren
id|mimd_t
...
multiline_comment|/**&n; * lld_ioctl - Routine to issue ioctl to low level drvr&n; *&n; * @adp&t;&t;: The adapter entry in adparr&n; * @kioc&t;: The ioctl packet with kernel addresses&n; */
r_static
r_int

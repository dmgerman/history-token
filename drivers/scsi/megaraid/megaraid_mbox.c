...
multiline_comment|/*&n;&t; * Setup the driver global data structures&n;&t; */
id|INIT_LIST_HEAD
c_func
(paren
op_amp
id|mraid_driver_g.device_list
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|// All adapters must be detached by now
id|ASSERT
c_func
(paren
id|list_empty
...
l_int|1
suffix:semicolon
singleline_comment|// Adapter setup complete, put it in the global list of controllers
id|list_add_tail
c_func
(paren
op_amp
...
suffix:semicolon
singleline_comment|// remove the adapter from the global list of our controllers
id|list_del_init
c_func
(paren
op_amp
...
multiline_comment|/**&n; * megaraid_queue_command - generic queue entry point for all LLDs&n; * @scp&t;&t;: pointer to the scsi command to be executed&n; * @done&t;: callback routine to be called after the cmd has be completed&n; *&n; * Queue entry point for mailbox based controllers. This entry point is common&n; * for memory and IO based controllers&n; */
r_static
r_int
...
(paren
id|KERN_WARNING
l_string|&quot;megaraid abort: %ld:%d[%d:%d], do now own&bslash;n&quot;
comma
id|scp-&gt;serial_number
comma
id|scb-&gt;sno
...
singleline_comment|// complete command processing. Wait for additional 3 minutes for the
...
singleline_comment|//msleep(1000);
id|sleep_on_timeout
c_func
(paren
op_amp
...
suffix:semicolon
singleline_comment|// wait for maximum 1 second for status to post
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_WARNING
l_string|&quot;megaraid mailbox: status not available&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
multiline_comment|/**&n; * megaraid_busywait_mbox() - Wait until the controller&squot;s mailbox is available&n; * @raid_dev&t;- RAID device (HBA) soft state&n; *&n; * wait until the controller&squot;s mailbox is available to accept more commands.&n; */
r_static
r_inline
r_int
...
multiline_comment|/**&n; * __megaraid_busywait_mbox() - Wait until controller&squot;s mailbox is available&n; * @raid_dev&t;- mailbox data structures&n; *&n; * wait until the controller&squot;s mailbox is available to accept more commands.&n; */
r_static
r_inline
r_int
DECL|function|__megaraid_busywait_mbox
id|__megaraid_busywait_mbox
c_func
(paren
id|mraid_device_t
...
l_int|1
suffix:semicolon
singleline_comment|// give up after 1 second
)brace

...
c_cond
(paren
id|command_packet-&gt;byte0_offset.opcode
op_eq
id|TW_OP_SET_PARAM
)paren
(brace
...
id|event-&gt;severity
op_assign
id|header-&gt;status_block.substatus_block.severity
suffix:semicolon
id|do_gettimeofday
c_func
(paren
...
id|TW_OP_SET_PARAM
suffix:semicolon
id|command_packet-&gt;byte0_offset.sgl_offset
op_assign
l_int|2
suffix:semicolon
...
c_cond
(paren
id|full_command_packet-&gt;command.newcommand.command.opcode
op_eq
...
c_cond
(paren
id|oldcommand-&gt;byte0_offset.sgl_offset
)paren
(brace
...
l_int|0
suffix:semicolon
id|full_command_packet-&gt;header.status_block.substatus_block.severity
op_assign
l_int|0
suffix:semicolon
id|command_packet
...
l_int|0
suffix:semicolon
id|command_packet-&gt;command.opcode
op_assign
id|TW_OP_EXECUTE_SCSI
suffix:semicolon
...
multiline_comment|/* End twa_setup_irq() */
...
DECL|function|twa_slave_configure
r_static
r_int
id|twa_slave_configure
c_func
...
multiline_comment|/* End twa_slave_configure */
...
multiline_comment|/* Get informationa bout the card/driver */
DECL|function|twa_info
r_static
r_const
r_char
op_star
...
multiline_comment|/* End twa_info() */
...
suffix:semicolon
multiline_comment|/* Make sure that mem region isn&squot;t already taken */
r_if
c_cond
(paren
id|check_mem_region
...
multiline_comment|/* Reserve the mem address space */

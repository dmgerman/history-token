...
mdefine_line|#define TW_DRIVER_VERSION &quot;2.26.02.002&quot;
...
id|PAGE_SIZE
comma
l_string|&quot;3w-9xxx Driver version: %s&bslash;n&quot;
...
DECL|function|twa_change_queue_depth
r_static
r_int
id|twa_change_queue_depth
c_func
(paren
r_struct
id|scsi_device
...
multiline_comment|/* End twa_change_queue_depth() */
...
op_increment
suffix:semicolon
multiline_comment|/* Check for embedded error string */
id|error_str
op_assign
op_amp
(paren
...
comma
id|TW_CURRENT_DRIVER_SRL
comma
id|TW_9000_ARCH_ID
comma
id|TW_CURRENT_DRIVER_BRANCH
comma
id|TW_CURRENT_DRIVER_BUILD
comma
op_amp
id|fw_on_ctlr_srl
comma
...
id|tw_dev-&gt;working_build
suffix:semicolon
id|tw_compat_info-&gt;driver_srl_high
op_assign
id|TW_CURRENT_DRIVER_SRL
suffix:semicolon
id|tw_compat_info-&gt;driver_branch_high
op_assign
id|TW_CURRENT_DRIVER_BRANCH
suffix:semicolon
id|tw_compat_info-&gt;driver_build_high
op_assign
id|TW_CURRENT_DRIVER_BUILD
suffix:semicolon
id|tw_compat_info-&gt;driver_srl_low
op_assign
id|TW_BASE_FW_SRL
suffix:semicolon
id|tw_compat_info-&gt;driver_branch_low
op_assign
id|TW_BASE_FW_BRANCH
suffix:semicolon
id|tw_compat_info-&gt;driver_build_low
op_assign
id|TW_BASE_FW_BUILD
suffix:semicolon
r_break
...
id|set_features
suffix:semicolon
multiline_comment|/* Turn on 64-bit sgl support if we need to */
id|tw_initconnect-&gt;features
op_or_assign
r_sizeof
(paren
...
multiline_comment|/* Report residual bytes for single sgl */
r_if
c_cond
(paren
(paren
...
c_cond
(paren
id|full_command_packet-&gt;command.newcommand.sg_list
(braket
l_int|0
)braket
dot
...
suffix:semicolon
id|newcommand-&gt;request_id__lunl
op_assign
id|TW_REQ_LUN_IN
c_func
(paren
...
id|length
suffix:semicolon
id|newcommand-&gt;sgl_entries__lunh
op_assign
id|TW_REQ_LUN_IN
c_func
(paren
...
id|SCpnt-&gt;device-&gt;host-&gt;hostdata
suffix:semicolon
multiline_comment|/* Check if this FW supports luns */
r_if
c_cond
(paren
(paren
...
id|srb-&gt;device-&gt;id
suffix:semicolon
id|command_packet-&gt;request_id__lunl
op_assign
id|TW_REQ_LUN_IN
c_func
(paren
...
id|command_packet-&gt;sgl_entries__lunh
op_assign
id|TW_REQ_LUN_IN
c_func
(paren
...
id|TW_MAX_CDB_LEN
suffix:semicolon
multiline_comment|/* Channels aren&squot;t supported by adapter */
id|host-&gt;max_lun
op_assign
id|TW_MAX_LUNS
c_func

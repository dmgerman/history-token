...
multiline_comment|/**&n; *&t;attach - add device to driver.&n; *&t;@dev:&t;device.&n; *&t;&n; *&t;By this point, we know for sure what the driver is, so we &n; *&t;do the rest (which ain&squot;t that much).&n; */
...
multiline_comment|/**&n; *&t;detach - do dirty work of detaching device from its driver.&n; *&t;@dev:&t;device.&n; *&t;@drv:&t;its driver.&n; *&n; *&t;Note that calls to this function are serialized by taking the &n; *&t;bus&squot;s rwsem in both bus_remove_device() and bus_remove_driver().&n; */
...
multiline_comment|/**&n; *&t;device_detach - detach device from its driver.&n; *&t;@dev:&t;device.&n; */

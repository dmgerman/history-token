...
id|EINVAL
suffix:semicolon
multiline_comment|/* perform first-time initialization (system root device) */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/**&n; * device_init - initialize the root device&n; *&n; * Ensures creation of the system root device (device_root)&n; * in the absence of a system root enumerator (e.g. ACPI,&n; * PnP BIOS, &lt;insert non-IA paradigm here&gt;, etc.).&n; */

...
multiline_comment|/**&n; *&t;sys_device_resume - Bring system devices back to life.&n; *&n; *&t;Similar to sys_device_suspend(), but we iterate the list forwards&n; *&t;to guarantee that parent devices are resumed before their children.&n; *&n; *&t;Note: Interrupts are disabled when called.&n; */
DECL|function|sys_device_resume
r_int

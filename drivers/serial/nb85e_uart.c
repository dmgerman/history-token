...
r_static
r_void
DECL|function|nb85e_uart_change_speed
id|nb85e_uart_change_speed
(paren
r_struct
id|uart_port
op_star
...
(brace
multiline_comment|/* The serial framework doesn&squot;t give us the baud rate directly, but&n;&t;   insists on calculating a `quotient&squot; from it, and giving us that&n;&t;   instead.  Get the real baud rate from the tty code instead.  */
r_int
id|baud
op_assign

...
ques
c_cond
id|pi-&gt;shared_regs-&gt;SDMA_INTR_MASK_m
suffix:colon
id|readl
c_func
(paren
id|pi-&gt;shared_regs-&gt;sdma_intr_base
op_plus
id|SDMA_INTR_MASK
)paren
suffix:semicolon
...
id|pi-&gt;shared_regs-&gt;SDMA_INTR_CAUSE_m
op_assign
l_int|0
suffix:semicolon
id|writel
...
suffix:semicolon
macro_line|#if defined(CONFIG_PPC32) &amp;&amp; !defined(CONFIG_NOT_COHERENT_CACHE)
r_if
c_cond
(paren
id|pi-&gt;cache_mgmt
)paren
multiline_comment|/* GT642[46]0 Res #COMM-2 */
...
id|v
comma
id|pi-&gt;shared_regs-&gt;mpsc_routing_base
op_plus
id|MPSC_MRR
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Erratum prevents reading CHR_2 so just delay for a while */
id|udelay
c_func
(paren
l_int|100
...
op_assign
id|pdata-&gt;intr_cause_val
suffix:semicolon
id|mpsc_shared_regs.SDMA_INTR_MASK_m
op_assign
id|pdata-&gt;intr_mask_val
suffix:semicolon
id|rc
op_assign
l_int|0
...
id|pi-&gt;default_bits
op_assign
id|pdata-&gt;default_bits
suffix:semicolon
id|pi-&gt;default_parity
op_assign
id|pdata-&gt;default_parity
suffix:semicolon
id|pi-&gt;default_flow
op_assign
id|pdata-&gt;default_flow
suffix:semicolon

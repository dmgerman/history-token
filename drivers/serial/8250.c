multiline_comment|/*&n; *  linux/drivers/char/8250.c&n; *&n; *  Driver for 8250/16550-type serial ports&n; *&n; *  Based on drivers/char/serial.c, by Linus Torvalds, Theodore Ts&squot;o.&n; *&n; *  Copyright (C) 2001 Russell King.&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; *&n; *  $Id: 8250.c,v 1.83 2002/07/21 23:08:22 rmk Exp $&n; *&n; * A note about mapbase / membase&n; *&n; *  mapbase is the physical address of the IO port.  Currently, we don&squot;t&n; *  support this very well, and it may well be dropped from this driver&n; *  in future.  As such, mapbase should be NULL.&n; *&n; *  membase is an &squot;ioremapped&squot; cookie.  This is compatible with the old&n; *  serial.c driver, and is currently the preferred form.&n; */
...
c_func
(paren
l_string|&quot;Testing ttyS%d (0x%04x, 0x%08lx)...&bslash;n&quot;
comma
id|up-&gt;port.line
comma
id|up-&gt;port.iobase
...
c_func
(paren
l_string|&quot;serial: ttyS%d: simple autoconfig &quot;
l_string|&quot;failed (%02x, %02x)&bslash;n&quot;
comma
id|up-&gt;port.line
comma
id|scratch2
...
c_func
(paren
l_string|&quot;serial: ttyS%d: no UART loopback &quot;
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Turn off LCR == 0xBF so we actually set the IER&n;&t;&t;&t; * register on the XR16C850&n;&t;&t;&t; */
id|serial_outp
c_func
(paren
id|up
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Now reset LCR so we can turn off the ECB bit&n;&t;&t;&t; */
id|serial_outp
c_func
(paren
id|up
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * For a XR16C850, we need to set the trigger levels&n;&t;&t;&t; */
r_if
c_cond
(paren
id|up-&gt;port.type
...
(paren
id|KERN_INFO
l_string|&quot;Serial: 8250/16550 driver $Revision: 1.83 $ &quot;
...
c_func
(paren
l_string|&quot;Generic 8250/16x50 serial driver $Revision: 1.83 $&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func

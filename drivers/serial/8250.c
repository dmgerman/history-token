...
multiline_comment|/*&n; * Remove a platform device.  We only remove serial ports from this&n; * platform device if it actually added any in the first place (iow,&n; * dev-&gt;platform_data is non-NULL.)&n; */

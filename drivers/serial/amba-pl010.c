...
suffix:semicolon
DECL|function|amba_console_init
r_static
r_int
id|__init
id|amba_console_init
c_func
(paren
r_void
)paren
(brace
multiline_comment|/*&n;&t; * All port initializations are done statically&n;&t; */
id|register_console
c_func
(paren
op_amp
...
DECL|variable|amba_console_init
id|console_initcall
c_func
(paren
id|amba_console_init
...
suffix:semicolon
DECL|function|amba_late_console_init
r_static
r_int
id|__init
id|amba_late_console_init
c_func
(paren
r_void
)paren
...
DECL|variable|amba_late_console_init
id|late_initcall
c_func
(paren
id|amba_late_console_init

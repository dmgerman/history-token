...
c_func
(paren
l_string|&quot;serial: PNP device &squot;%s&squot; prepare failed&bslash;n&quot;
comma
id|slot_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;serial: PNP device &squot;%s&squot; activate failed&bslash;n&quot;
comma
id|slot_name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Public health warning: remove this once the 2.5&n;&t;&t; * pnpbios_module_init() stuff is incorporated.&n;&t;&t; */
id|dev-&gt;driver
op_assign
(paren
r_void
...
suffix:semicolon
multiline_comment|/*&n; * This function should vanish when 2.5 comes around and&n; * we have pnpbios_module_init()&n; */
...
c_func
(paren
l_string|&quot;Generic 8250/16x50 PNPBIOS serial probe module&quot;
)paren
suffix:semicolon

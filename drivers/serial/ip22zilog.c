...
DECL|variable|ip22serial_current_minor
r_int
id|ip22serial_current_minor
op_assign
l_int|64
suffix:semicolon
r_void
...
mdefine_line|#define NUM_IP22ZILOG&t;1
DECL|macro|NUM_CHANNELS
mdefine_line|#define NUM_CHANNELS&t;(NUM_IP22ZILOG * 2)
DECL|macro|ZS_CLOCK
...
suffix:semicolon
DECL|macro|IP22ZILOG_CONSOLE
mdefine_line|#define IP22ZILOG_CONSOLE&t;(&amp;ip22zilog_console)
DECL|function|ip22zilog_console_init
r_static
r_int
id|__init
id|ip22zilog_console_init
c_func
(paren
r_void
)paren
...
macro_line|#else /* CONFIG_SERIAL_IP22_ZILOG_CONSOLE */
DECL|macro|IP22ZILOG_CONSOLE
mdefine_line|#define IP22ZILOG_CONSOLE&t;&t;(NULL)
DECL|macro|ip22zilog_console_init
mdefine_line|#define ip22zilog_console_init()&t;do { } while (0)
macro_line|#endif

...
suffix:semicolon
multiline_comment|/* ======================================================================== */
multiline_comment|/* Platform Driver                                                          */
multiline_comment|/* ======================================================================== */
r_static
r_int
id|__devinit
...
id|ret
suffix:semicolon
multiline_comment|/* Check validity &amp; presence */
id|idx
op_assign
id|pdev-&gt;id
suffix:semicolon
...
id|mpc52xx_uart_ops
suffix:semicolon
multiline_comment|/* Search for IRQ and mapbase */
r_for
c_loop
(paren
id|i
...
macro_line|#endif
DECL|variable|mpc52xx_uart_platform_driver
r_static
r_struct
id|device_driver
id|mpc52xx_uart_platform_driver
op_assign
(brace
dot
id|name

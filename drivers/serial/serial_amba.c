...
(paren
id|KERN_INFO
l_string|&quot;Serial: AMBA driver $Revision: 1.35 $&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
c_func
(paren
l_string|&quot;ARM AMBA serial port driver $Revision: 1.35 $&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

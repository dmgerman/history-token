...
id|close_wait
suffix:semicolon
multiline_comment|/*&t;struct wait_queue     *open_wait; */
multiline_comment|/*&t;struct wait_queue&t;   *close_wait;i */
...
multiline_comment|/*static void rs_360_timer(void)&n;{&n;&t;printk(&quot;rs_360_timer&bslash;n&quot;);&n;}*/
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* return put_user(result,value); */
id|put_user
c_func
(paren
id|result
...
multiline_comment|/* __clear_user(&amp;serial_driver,sizeof(struct tty_driver)); */
id|memset
c_func
(paren
op_amp
...
id|TTY_DRIVER_MAGIC
suffix:semicolon
multiline_comment|/* serial_driver.driver_name = &quot;serial&quot;; */
...
id|rs_360_unthrottle
suffix:semicolon
multiline_comment|/* serial_driver.send_xchar = rs_360_send_xchar; */
...
id|rs_360_hangup
suffix:semicolon
multiline_comment|/* serial_driver.wait_until_sent = rs_360_wait_until_sent; */
multiline_comment|/* serial_driver.read_proc = rs_360_read_proc; */
...
id|SERIAL_TYPE_CALLOUT
suffix:semicolon
multiline_comment|/* callout_driver.read_proc = 0; */
multiline_comment|/* callout_driver.proc_entry = 0; */
r_if
c_cond
(paren
...
(brace
multiline_comment|/* __clear_user(info,sizeof(ser_info_t)); */
id|memset
(paren
id|info
comma

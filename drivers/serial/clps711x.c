...
r_static
r_void
DECL|function|clps711xuart_change_speed
id|clps711xuart_change_speed
c_func
(paren
r_struct
id|uart_port
...
(paren
id|KERN_INFO
l_string|&quot;Serial: CLPS711x driver $Revision: 1.39 $&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
c_func
(paren
l_string|&quot;CLPS-711x generic serial driver $Revision: 1.39 $&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

...
id|TxENAB
suffix:semicolon
multiline_comment|/* Enable RX and status interrupts.  TX interrupts are enabled&n;&t; * as needed.&n;&t; */
id|up-&gt;curregs
(braket
id|R1
)braket
...
(brace
multiline_comment|/* Don&squot;t modify MIE. */
id|up-&gt;curregs
(braket
id|R9
)braket
...
c_func
(paren
l_string|&quot;sunzilog_init: Cannot alloc SunZilog tables.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;SunZilog: Cannot find bus of Zilog %d in get_zs_sun4u.&bslash;n&quot;
comma
id|chip
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SunZilog: Cannot find Zilog %d in get_zs_sun4u.&bslash;n&quot;
comma
id|chip
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SunZilog: Child of obio node does &quot;
l_string|&quot;not exist.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
(brace
multiline_comment|/* Sun4d Zilog nodes lack the address property, so just&n;&t;&t;&t; * map it like a normal device.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|prom_getproperty
...
c_func
(paren
l_string|&quot;SunZilog: Cannot map Zilog %d &quot;
l_string|&quot;regs on sun4c.&bslash;n&quot;
comma
id|chip
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SunZilog: Cannot get address property for &quot;
l_string|&quot;Zilog %d.&bslash;n&quot;
comma
id|chip
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SunZilog: Cannot get IRQ property for &quot;
l_string|&quot;Zilog %d.&bslash;n&quot;
comma
id|chip
)paren
...
c_func
(paren
l_string|&quot;SunZilog: OBP node for Zilog %d not found.&bslash;n&quot;
comma
id|chip
)paren
suffix:semicolon
...
DECL|function|sunzilog_console_device
r_static
id|kdev_t
id|sunzilog_console_device
c_func
(paren
r_struct
id|console
...
(paren
id|KERN_INFO
l_string|&quot;zs%d at 0x%p (irq = %s) is a Zilog8530&bslash;n&quot;
comma
id|channel
comma
id|up-&gt;port.membase
...
(brace
multiline_comment|/* sunzilog_console_setup takes care of this */
)brace
r_else
(brace

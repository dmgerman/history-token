...
DECL|macro|UART_NR
mdefine_line|#define UART_NR 8
DECL|struct|mux_card
r_struct
id|mux_card
(brace
DECL|member|ports
...
(paren
id|KERN_INFO
l_string|&quot;Serial mux driver (%d ports) Revision: 0.2&bslash;n&quot;
comma
id|ports
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Serial mux: Unable to allocate memory.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1

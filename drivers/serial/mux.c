...
DECL|macro|MUX_NR
mdefine_line|#define MUX_NR 256
DECL|variable|port_cnt
r_static
r_int
r_int
id|port_cnt
...
DECL|macro|GET_MUX_PORTS
mdefine_line|#define GET_MUX_PORTS(iodc_data) ((((iodc_data)[4] &amp; 0xf0) &gt;&gt; 4) * 8) + 8
...
multiline_comment|/**&n; * mux_release_port - Release memory and IO regions.&n; * @port: Ptr to the uart_port.&n; * &n; * Release any memory and IO region resources currently in use by&n; * the port.&n; */
...
DECL|function|mux_console_write
r_static
r_void
id|mux_console_write
c_func
(paren
r_struct
id|console
...
DECL|function|mux_console_setup
r_static
r_int
id|mux_console_setup
c_func
(paren
r_struct
id|console
...
DECL|function|mux_console_device
r_struct
id|tty_driver
op_star
id|mux_console_device
c_func
(paren
r_struct
id|console
...
(paren
id|KERN_ERR
l_string|&quot;Serial mux: Unable to read IODC.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
(paren
id|KERN_INFO
l_string|&quot;Serial mux driver (%d ports) Revision: 0.3&bslash;n&quot;
comma
id|ports
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Serial mux: Unable to register driver.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
suffix:semicolon
DECL|variable|serial_mux_driver
r_static
r_struct
id|parisc_driver
id|serial_mux_driver
op_assign
(brace
dot
id|name

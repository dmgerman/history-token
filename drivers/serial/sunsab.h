multiline_comment|/* sunsab.h: Register Definitions for the Siemens SAB82532 DUSCC&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; */
macro_line|#ifndef _SUNSAB_H
DECL|macro|_SUNSAB_H
mdefine_line|#define _SUNSAB_H

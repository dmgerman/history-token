...
id|termios
suffix:semicolon
multiline_comment|/*&n;&t;&t; * First try to use the console cflag setting.&n;&t;&t; */
id|memset
c_func
(paren
op_amp
...
id|port-&gt;cons-&gt;cflag
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If that&squot;s unset, use the tty termios setting.&n;&t;&t; */
r_if
c_cond
(paren
id|state-&gt;info

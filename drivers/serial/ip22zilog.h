macro_line|#ifndef _IP22_ZILOG_H
DECL|macro|_IP22_ZILOG_H
mdefine_line|#define _IP22_ZILOG_H
...
mdefine_line|#define ZS_CLEARERR(channel)    do { writeb(ERR_RES, &amp;channel-&gt;control); &bslash;&n;&t;&t;&t;&t;     udelay(5); } while(0)
DECL|macro|ZS_CLEARSTAT
mdefine_line|#define ZS_CLEARSTAT(channel)   do { writeb(RES_EXT_INT, &amp;channel-&gt;control); &bslash;&n;&t;&t;&t;&t;     udelay(5); } while(0)
DECL|macro|ZS_CLEARFIFO
mdefine_line|#define ZS_CLEARFIFO(channel)   do { readb(&amp;channel-&gt;data); &bslash;&n;&t;&t;&t;&t;     udelay(2); &bslash;&n;&t;&t;&t;&t;     readb(&amp;channel-&gt;data); &bslash;&n;&t;&t;&t;&t;     udelay(2); &bslash;&n;&t;&t;&t;&t;     readb(&amp;channel-&gt;data); &bslash;&n;&t;&t;&t;&t;     udelay(2); } while(0)
macro_line|#endif /* _IP22_ZILOG_H */
eof

...
c_func
(paren
l_string|&quot;Marcel Holtmann &lt;marcel@holtmann.org&gt;, Jose Orlando Pereira &lt;jop@di.uminho.pt&gt;&quot;
)paren
suffix:semicolon
...
multiline_comment|/* ======================== Special I/O functions ======================== */
DECL|macro|DATA_L
mdefine_line|#define DATA_L   0
DECL|macro|DATA_H
mdefine_line|#define DATA_H   1
DECL|macro|ADDR_L
mdefine_line|#define ADDR_L   2
DECL|macro|ADDR_H
mdefine_line|#define ADDR_H   3
DECL|macro|CONTROL
...
DECL|function|bt3c_write_wakeup
r_static
r_void
id|bt3c_write_wakeup
c_func
(paren
id|bt3c_info_t
op_star
...
suffix:semicolon
singleline_comment|//printk(&quot;bt3c_cs: receiving %d bytes&bslash;n&quot;, avail);
id|bt3c_address
c_func
(paren
id|iobase
...
suffix:semicolon
singleline_comment|//printk(&quot;bt3c: PACKET_TYPE=%02x&bslash;n&quot;, info-&gt;rx_skb-&gt;pkt_type);
r_switch
c_cond
(paren
id|info-&gt;rx_skb-&gt;pkt_type
...
DECL|function|bt3c_hci_send_frame
r_static
r_int
id|bt3c_hci_send_frame
c_func
(paren
r_struct
id|sk_buff
...
DECL|function|bt3c_hci_destruct
r_static
r_void
id|bt3c_hci_destruct
c_func
(paren
r_struct
id|hci_dev
...
c_func
(paren
l_string|&quot;Bad address in firmware&quot;
)paren
suffix:semicolon
id|err
op_assign
...
c_func
(paren
l_string|&quot;Checksum error in firmware&quot;
)paren
suffix:semicolon
id|err
op_assign

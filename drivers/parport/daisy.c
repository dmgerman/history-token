...
(brace
singleline_comment|// For these modes we should switch to EPP mode:
r_case
...
suffix:semicolon
singleline_comment|// For these modes we should switch to ECP mode:
r_case
...
suffix:semicolon
singleline_comment|// Nothing was told for BECP in Daisy chain specification.
singleline_comment|// May be it&squot;s wise to use ECP?
r_case
id|IEEE1284_MODE_BECP
suffix:colon
singleline_comment|// Others use compat mode
r_case

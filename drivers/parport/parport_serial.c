...
id|titan_210l
comma
DECL|enumerator|netmos_9xx5_combo
id|netmos_9xx5_combo
comma
...
id|avlab_2s1p_850
comma
DECL|enumerator|siig_1s1p_10x
id|siig_1s1p_10x
comma
DECL|enumerator|siig_2s1p_10x
id|siig_2s1p_10x
comma
DECL|enumerator|siig_2p1s_20x
id|siig_2p1s_20x
comma
DECL|enumerator|siig_1s1p_20x
id|siig_1s1p_20x
comma
DECL|enumerator|siig_2s1p_20x
id|siig_2s1p_20x
comma
)brace
suffix:semicolon
...
suffix:semicolon
DECL|function|netmos_parallel_init
r_static
r_int
id|__devinit
id|netmos_parallel_init
c_func
(paren
r_struct
id|pci_dev
...
(brace
multiline_comment|/*&n;&t; * Netmos uses the subdevice ID to indicate the number of parallel&n;&t; * and serial ports.  The form is 0x00PS, where &lt;P&gt; is the number of&n;&t; * parallel ports and &lt;S&gt; is the number of serial ports.&n;&t; */
id|card-&gt;numports
op_assign
(paren
...
comma
multiline_comment|/* netmos_9xx5_combo */
(brace
l_int|1
comma
(brace
...
comma
multiline_comment|/* siig_1s1p_10x */
(brace
l_int|1
comma
(brace
...
comma
multiline_comment|/* siig_2s1p_10x */
(brace
l_int|1
comma
(brace
...
comma
multiline_comment|/* siig_2p1s_20x */
(brace
l_int|2
comma
(brace
...
comma
multiline_comment|/* siig_1s1p_20x */
(brace
l_int|1
comma
(brace
...
comma
multiline_comment|/* siig_2s1p_20x */
(brace
l_int|1
comma
(brace
...
DECL|function|netmos_serial_init
r_static
r_int
id|__devinit
id|netmos_serial_init
c_func
(paren
r_struct
id|pci_dev
...
(paren
id|KERN_WARNING
l_string|&quot;parport_serial: %s: only %u serial lines &quot;
l_string|&quot;supported (%d reported)&bslash;n&quot;
comma
id|pci_name
(paren
id|dev
...
(paren
id|KERN_WARNING
l_string|&quot;parport_serial: %s: only %u parallel ports &quot;
l_string|&quot;supported (%d reported)&bslash;n&quot;
comma
id|pci_name
(paren

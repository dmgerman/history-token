...
macro_line|#include &quot;parport_gsc.h&quot;
id|MODULE_AUTHOR
c_func
(paren
...
c_func
(paren
l_string|&quot;IRQ not found for parallel device at 0x%lx&bslash;n&quot;
comma
id|dev-&gt;hpa
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* some older machines with ASP-chip don&squot;t support&n;&t; * the enhanced parport modes.&n;&t; */
r_if
c_cond
(paren
...
DECL|function|parport_gsc_exit
r_static
r_void
id|__devexit
id|parport_gsc_exit
...
DECL|variable|parport_gsc_init
id|module_init
c_func
(paren
id|parport_gsc_init
...
suffix:semicolon
DECL|variable|parport_gsc_exit
id|module_exit
c_func
(paren
id|parport_gsc_exit

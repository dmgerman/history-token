...
macro_line|#include &lt;linux/via.h&gt;
...
mdefine_line|#define ECR_MODE_MASK 0xe0
DECL|macro|ECR_WRITE
mdefine_line|#define ECR_WRITE(p,v) frob_econtrol((p),0xff,(v))
DECL|macro|DEBUG
...
suffix:semicolon
macro_line|#endif
DECL|variable|pci_registered_parport
r_static
r_int
id|pci_registered_parport
suffix:semicolon
DECL|variable|pnp_registered_parport
r_static
r_int
id|pnp_registered_parport
suffix:semicolon
...
multiline_comment|/* Set ackIntEn */
id|s-&gt;u.pc.ctr
op_or_assign
l_int|0x10
suffix:semicolon
...
(paren
l_string|&quot;leave fifo_write_block_pio&quot;
comma
id|port
)paren
suffix:semicolon
...
multiline_comment|/* For some hardware we don&squot;t want to touch the mode until&n;&t; * the FIFO is empty, so allow 4 seconds for each position&n;&t; * in the fifo.&n;&t; */
id|expire
op_assign
id|jiffies
op_plus
...
r_do
(brace
multiline_comment|/* Wait for the FIFO to empty */
id|r
op_assign
id|change_mode
(paren
...
id|out2
suffix:semicolon
multiline_comment|/* a misnomer, actually - it&squot;s allocate and reserve parport number */
id|p
op_assign
...
multiline_comment|/* Likewise for EEP ports */
r_if
c_cond
(paren
id|EPP_res
...
suffix:semicolon
DECL|function|parport_pc_unregister_port
r_void
...
DECL|variable|parport_pc_unregister_port
id|EXPORT_SYMBOL
(paren
id|parport_pc_unregister_port
)paren
...
multiline_comment|/* ITE support maintained by Rich Liu &lt;richliu@poorman.org&gt; */
DECL|function|sio_ite_8872_probe
r_static
r_int
id|__devinit
id|sio_ite_8872_probe
(paren
r_struct
id|pci_dev
op_star
...
(paren
id|KERN_DEBUG
l_string|&quot;sio_ite_8872_probe()&bslash;n&quot;
)paren
suffix:semicolon
singleline_comment|// make sure which one chip
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: cannot find ITE8872 INTA&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: ITE8871 found (1P)&bslash;n&quot;
)paren
suffix:semicolon
id|ite8872set
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: ITE8875 found (1P)&bslash;n&quot;
)paren
suffix:semicolon
id|ite8872set
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: ITE8872 found (2S1P)&bslash;n&quot;
)paren
suffix:semicolon
id|ite8872set
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: ITE8874 found (2S)&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: unknown ITE887x&bslash;n&quot;
)paren
suffix:semicolon
id|printk
(paren
id|KERN_INFO
l_string|&quot;parport_pc: please mail &squot;lspci -nvv&squot; &quot;
l_string|&quot;output to Rich.Liu@ite.com.tw&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
suffix:semicolon
singleline_comment|// SET SPP&amp;EPP , Parallel Port NO DMA , Enable All Function
singleline_comment|// SET Parallel IRQ
id|pci_write_config_dword
(paren
id|pdev
comma
...
(paren
id|KERN_DEBUG
l_string|&quot;ITE887x: The IRQ is %d.&bslash;n&quot;
comma
id|ite8872_irq
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;ITE887x: The PARALLEL I/O port is 0x%x.&bslash;n&quot;
comma
id|ite8872_lpt
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;ITE887x: The PARALLEL I/O porthi is 0x%x.&bslash;n&quot;
comma
id|ite8872_lpthi
)paren
suffix:semicolon
multiline_comment|/* Let the user (or defaults) steer us away from interrupts */
id|irq
op_assign
id|ite8872_irq
suffix:semicolon
...
id|PARPORT_IRQ_NONE
suffix:semicolon
multiline_comment|/*&n;&t; * Release the resource so that parport_pc_probe_port can get it.&n;&t; */
id|release_resource
c_func
(paren
id|base_res
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: ITE 8872 parallel port: io=0x%X&quot;
comma
id|ite8872_lpt
)paren
suffix:semicolon
...
multiline_comment|/* VIA 8231 support by Pavel Fedin &lt;sonic_amiga@rambler.ru&gt;&n;   based on VIA 686a support code by Jeff Garzik &lt;jgarzik@pobox.com&gt; */
...
l_int|0
suffix:semicolon
multiline_comment|/* Data for two known VIA chips */
DECL|variable|__devinitdata
r_static
r_struct
id|parport_pc_via_data
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: VIA 686A/8231 detected&bslash;n&quot;
)paren
suffix:semicolon
r_switch
c_cond
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: setting SPP mode&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
id|VIA_FUNCTION_PARPORT_SPP
suffix:semicolon
r_break
suffix:semicolon
r_case
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: setting PS/2 mode&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: setting EPP mode&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
id|VIA_FUNCTION_PARPORT_EPP
suffix:semicolon
id|ppcontrol
op_assign
id|VIA_PARPORT_BIDIR
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: setting ECP mode&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
id|VIA_FUNCTION_PARPORT_ECP
suffix:semicolon
id|ppcontrol
op_assign
id|VIA_PARPORT_BIDIR
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: setting EPP+ECP mode&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: probing current configuration&bslash;n&quot;
)paren
suffix:semicolon
id|siofunc
op_assign
id|VIA_FUNCTION_PROBE
suffix:semicolon
r_break
suffix:semicolon
)brace
multiline_comment|/*&n;&t; * unlock super i/o configuration&n;&t; */
id|pci_read_config_byte
c_func
(paren
id|pdev
comma
id|via-&gt;via_pci_superio_config_reg
comma
op_amp
id|tmp
)paren
...
id|tmp
op_or_assign
id|via-&gt;via_pci_superio_config_data
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Bits 1-0: Parallel Port Mode / Enable */
id|outb
c_func
(paren
id|via-&gt;viacfg_function
comma
id|VIA_CONFIG_INDEX
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Bit 5: EPP+ECP enable; bit 7: PS/2 bidirectional port enable */
id|outb
c_func
(paren
id|via-&gt;viacfg_parport_control
comma
id|VIA_CONFIG_INDEX
)paren
suffix:semicolon
...
id|tmp
op_amp
id|VIA_FUNCTION_PARPORT_DISABLE
suffix:semicolon
id|ppcontrol
op_assign
id|tmp2
...
multiline_comment|/* Parallel Port I/O Base Address, bits 9-2 */
id|outb
c_func
(paren
id|via-&gt;viacfg_parport_base
comma
id|VIA_CONFIG_INDEX
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: Current parallel port base: 0x%X&bslash;n&quot;
comma
id|port1
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc: Parallel port base changed to 0x378&bslash;n&quot;
)paren
suffix:semicolon
id|port1
op_assign
...
multiline_comment|/*&n;&t; * lock super i/o configuration&n;&t; */
id|pci_read_config_byte
c_func
(paren
id|pdev
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: VIA parallel port disabled in BIOS&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* Bits 7-4: PnP Routing for Parallel Port IRQ */
id|pci_read_config_byte
c_func
(paren
id|pdev
comma
id|via-&gt;via_pci_parport_irq_reg
comma
op_amp
id|tmp
)paren
...
(brace
multiline_comment|/* Bits 3-2: PnP Routing for Parallel Port DMA */
id|pci_read_config_byte
c_func
(paren
id|pdev
comma
id|via-&gt;via_pci_parport_dma_reg
comma
op_amp
id|tmp
)paren
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: Weird VIA parport base 0x%X, ignoring&bslash;n&quot;
comma
id|port1
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;parport_pc: VIA parallel port: io=0x%X&quot;
comma
id|port1
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;parport_pc: Strange, can&squot;t probe VIA parallel port: io=0x%X, irq=%d, dma=%d&bslash;n&quot;
comma
id|port1
comma
id|irq
...
DECL|enumerator|sio_via_8231
id|sio_via_8231
comma
multiline_comment|/* Via VT8231 south bridge integrated Super IO */
DECL|enumerator|sio_ite_8872
id|sio_ite_8872
comma
...
id|syba_1p_ecp
comma
DECL|enumerator|titan_010l
id|titan_010l
comma
DECL|enumerator|titan_1284p2
id|titan_1284p2
comma
DECL|enumerator|avlab_1p
id|avlab_1p
comma
DECL|enumerator|avlab_2p
id|avlab_2p
comma
DECL|enumerator|oxsemi_954
id|oxsemi_954
comma
DECL|enumerator|oxsemi_840
id|oxsemi_840
comma
...
id|mobility_pp
comma
DECL|enumerator|netmos_9705
id|netmos_9705
comma
DECL|enumerator|netmos_9805
id|netmos_9805
comma
DECL|enumerator|netmos_9815
id|netmos_9815
comma
...
suffix:semicolon
multiline_comment|/* If set, this is called immediately after pci_enable_device.&n;&t; * If it returns non-zero, no probing will take place and the&n;&t; * ports will not be used. */
DECL|member|preinit_hook
r_int
(paren
op_star
id|preinit_hook
...
suffix:semicolon
multiline_comment|/* If set, this is called after probing for ports.  If &squot;failed&squot;&n;&t; * is non-zero we couldn&squot;t use any of the ports. */
DECL|member|postinit_hook
r_void
(paren
op_star
id|postinit_hook
...
comma
multiline_comment|/* titan_1284p2 */
(brace
l_int|2
comma
(brace
...
comma
multiline_comment|/* avlab_1p&t;&t;*/
(brace
l_int|1
comma
(brace
...
comma
multiline_comment|/* avlab_2p&t;&t;*/
(brace
l_int|2
comma
(brace
...
comma
multiline_comment|/* The Oxford Semi cards are unusual: 954 doesn&squot;t support ECP,&n;&t; * and 840 locks up if you write 1 to bit 2! */
multiline_comment|/* oxsemi_954 */
(brace
l_int|1
comma
(brace
...
suffix:semicolon
DECL|variable|parport_pc_pci_tbl
r_static
r_struct
id|pci_device_id
...
comma
id|PCI_DEVICE_ID_OXSEMI_16PCI954PP
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
id|PCI_VENDOR_ID_OXSEMI
comma
id|PCI_DEVICE_ID_OXSEMI_12PCI840
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
comma
(brace
id|PCI_VENDOR_ID_AKS
comma
id|PCI_DEVICE_ID_AKS_ALADDINCARD
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
comma
multiline_comment|/* NetMos communication controllers */
(brace
id|PCI_VENDOR_ID_NETMOS
comma
id|PCI_DEVICE_ID_NETMOS_9705
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
DECL|function|parport_pc_pci_remove
r_static
r_void
id|__devexit
id|parport_pc_pci_remove
c_func
(paren
r_struct
id|pci_dev
...
DECL|variable|parport_pc_pnp_tbl
r_static
r_const
r_struct
id|pnp_device_id
id|parport_pc_pnp_tbl
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|function|parport_pc_pnp_probe
r_static
r_int
id|parport_pc_pnp_probe
c_func
(paren
r_struct
id|pnp_dev
...
(paren
id|KERN_INFO
l_string|&quot;parport: PnPBIOS parport detected.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
DECL|function|parport_pc_pnp_remove
r_static
r_void
id|parport_pc_pnp_remove
c_func
(paren
r_struct
id|pnp_dev
...
multiline_comment|/*&n; *&t;Piles of crap below pretend to be a parser for module and kernel&n; *&t;parameters.  Say &quot;thank you&quot; to whoever had come up with that&n; *&t;syntax and keep in mind that code below is a cleaned up version.&n; */
DECL|variable|io
r_static
r_int
id|__initdata
...
suffix:semicolon
DECL|function|parport_parse_param
r_static
r_int
id|__init
id|parport_parse_param
c_func
(paren
r_const
r_char
...
DECL|function|parport_parse_irq
r_static
r_int
id|__init
id|parport_parse_irq
c_func
(paren
r_const
r_char
...
DECL|function|parport_parse_dma
r_static
r_int
id|__init
id|parport_parse_dma
c_func
(paren
r_const
r_char
...
(paren
id|KERN_DEBUG
l_string|&quot;parport_pc.c: Specified parameter parport_init_mode=%s&bslash;n&quot;
comma
id|str
)paren
suffix:semicolon

...
suffix:semicolon
multiline_comment|/*&n;&t; * Chicken and Egg problem.  request_region() wants the name of&n;&t; * the owner, but this instance will not know that name until&n;&t; * after the parport_register_port() call.  Give request_region()&n;&t; * a fake name until after parport_register_port(), then use&n;&t; * rename_region() to set correct name.&n;&t; */
id|base_res
op_assign
id|request_region
c_func
...
id|errout
suffix:semicolon
multiline_comment|/*&n;&t; * Now the real name is known... Replace the fake name&n;&t; * in the resources with the correct one.&n;&t; */
id|rename_region
c_func
(paren
id|base_res

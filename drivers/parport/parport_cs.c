...
multiline_comment|/*======================================================================&n;&n;    parport_attach() creates an &quot;instance&quot; of the driver, allocating&n;    local data structures for one device.  The device is registered&n;    with Card Services.&n;&n;======================================================================*/
DECL|function|parport_attach
r_static
id|dev_link_t
op_star
id|parport_attach
...
l_int|0
comma
l_string|&quot;parport_attach()&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* Create new parport device */
id|info
op_assign
id|kmalloc
c_func
...
multiline_comment|/* parport_attach */
...
l_int|0
comma
l_string|&quot;parport_detach(0x%p)&bslash;n&quot;
comma
id|link
)paren
suffix:semicolon
...
multiline_comment|/* parport_detach */
multiline_comment|/*======================================================================&n;&n;    parport_config() is scheduled to run after a CARD_INSERTION event&n;    is received, to configure the PCMCIA socket, and to make the&n;    parport device available to the system.&n;&n;======================================================================*/
DECL|macro|CS_CHECK
...
l_int|0
comma
l_string|&quot;parport_config(0x%p)&bslash;n&quot;
comma
id|link
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;parport_cs: parport_pc_probe_port() at &quot;
l_string|&quot;0x%3x, irq %u failed&bslash;n&quot;
comma
id|link-&gt;io.BasePort1
comma
id|link-&gt;irq.AssignedIRQ
...
multiline_comment|/*======================================================================&n;&n;    After a card is removed, parport_cs_release() will unregister the&n;    device, and release the PCMCIA configuration.  If the device is&n;    still open, this will be postponed until it is closed.&n;    &n;======================================================================*/
DECL|function|parport_cs_release
r_void
id|parport_cs_release
c_func
(paren
...
l_int|0
comma
l_string|&quot;parport_release(0x%p)&bslash;n&quot;
comma
id|link
)paren
suffix:semicolon
...
multiline_comment|/* parport_cs_release */
multiline_comment|/*======================================================================&n;&n;    The card status event handler.  Mostly, this schedules other&n;    stuff to run after an event is received.&n;    &n;======================================================================*/
DECL|function|parport_event
r_int
id|parport_event
c_func
(paren
...
l_int|1
comma
l_string|&quot;parport_event(0x%06x)&bslash;n&quot;
comma
id|event
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;parport_cs: Card Services release &quot;
...
l_int|0
comma
l_string|&quot;parport_cs: unloading&bslash;n&quot;
)paren
suffix:semicolon

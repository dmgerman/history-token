multiline_comment|/*&n; * linux/drivers/firmware/smbios.c&n; *  Copyright (C) 2004 Dell Inc.&n; *  by Michael Brown &lt;Michael_E_Brown@dell.com&gt;&n; *  vim:noet:ts=8:sw=8:filetype=c:textwidth=80:&n; *&n; * BIOS SMBIOS Table access&n; * conformant to DMTF SMBIOS definition&n; *   at http://www.dmtf.org/standards/smbios&n; *&n; * This code takes information provided by SMBIOS tables&n; * and presents it in sysfs as:&n; *    /sys/firmware/smbios/smbios&n; *&t;&t;&t;&t;|--&gt; /table_entry_point&n; *&t;&t;&t;&t;|--&gt; /table&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License v2.0 as published by&n; * the Free Software Foundation&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; */

...
(paren
id|KERN_ERR
l_string|&quot;efivars: Memory allocation failed.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;efivars: Firmware registration failed with error %d.&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;efivars: Subsystem registration failed with error %d.&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon
r_goto
id|out_firmware_unregister
suffix:semicolon
)brace
...
(paren
id|KERN_ERR
l_string|&quot;efivars: Sysfs attribute export failed with error %d.&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon

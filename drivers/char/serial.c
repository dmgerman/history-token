...
id|sstate-&gt;info
suffix:semicolon
multiline_comment|/*&n;&t; * If the async_struct is already allocated, do the fastpath.&n;&t; */
r_if
c_cond
(paren
id|info
...
id|out
suffix:colon
multiline_comment|/*&n;&t; * If this is the first open, copy over some timeouts.&n;&t; */
r_if
c_cond
(paren
id|sstate-&gt;count
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * Register the serial board in the array if we need to&n;&t; * shutdown the board on a module unload or card removal&n;&t; */
r_if
c_cond
(paren
id|DEACTIVATE_FUNC
...
comma
macro_line|#endif
macro_line|#if 0&t;/* PCI_DEVICE_ID_DCI_PCCOM8 ? */&t;&t;   /* pbn_dci_pccom8 */
(brace
id|SPCI_FL_BASE3
comma
l_int|8
...
DECL|function|serial_remove_one
r_static
r_void
id|__devexit
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * Iterate through all of the ports finding those that belong&n;&t; * to this PCI device.&n;&t; */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*&n;&t; * Now execute any board-specific shutdown procedure&n;&t; */
r_for
c_loop
(paren
id|i
...
comma
macro_line|#endif
macro_line|#if 0&t;/* PCI_DEVICE_ID_DCI_PCCOM8 ? */
(brace
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Register call PCI serial devices.  Null out&n;&t; * the driver name upon failure, as a signal&n;&t; * not to attempt to unregister the driver later&n;&t; */
r_if
c_cond
(paren
id|pci_module_init
...
multiline_comment|/*&n; * This is for use by architectures that know their serial console &n; * attributes only at run time. Not to be invoked after rs_init().&n; */
...
multiline_comment|/*&n; *&t;Setup initial baud/bits/parity/flow control. We do two things here:&n; *&t;- construct a cflag setting for the first rs_open()&n; *&t;- initialize the serial port&n; *&t;Return non-zero if we didn&squot;t find a serial port.&n; */

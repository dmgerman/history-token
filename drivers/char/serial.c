...
multiline_comment|/*&n; * This is for use by architectures that know their serial port&n; * attributes only at run time. Not to be invoked after rs_init().&n; */
...
multiline_comment|/*&n; *&t;Setup initial baud/bits/parity/flow. We do two things here:&n; *&t;- construct a cflag setting for the first rs_open()&n; *&t;- initialize the serial port&n; *&t;Return non-zero if we didn&squot;t find a serial port.&n; */

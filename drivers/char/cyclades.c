...
mdefine_line|#define Z_FPGA_CHECK(card) &bslash;&n;    ((cy_readl(&amp;((struct RUNTIME_9060 __iomem *) &bslash;&n;&t;&t; ((card).ctl_addr))-&gt;init_ctrl) &amp; (1&lt;&lt;17)) != 0)
DECL|macro|ISZLOADED
mdefine_line|#define ISZLOADED(card)&t;(((ZO_V1==cy_readl(&amp;((struct RUNTIME_9060 __iomem *) &bslash;&n;&t;&t;&t;((card).ctl_addr))-&gt;mail_box_0)) || &bslash;&n;&t;&t;&t;Z_FPGA_CHECK(card)) &amp;&amp; &bslash;&n;&t;&t;&t;(ZFIRM_ID==cy_readl(&amp;((struct FIRM_ID __iomem *) &bslash;&n;&t;&t;&t;((card).base_addr+ID_ADDRESS))-&gt;signature)))
...
macro_line|#endif /* CONFIG_CYZ_INTR */
multiline_comment|/* Make sure this Z port really exists in hardware */
r_if
c_cond
(paren
id|info-&gt;line
...
multiline_comment|/* This function is used to send a high-priority XON/XOFF character to&n;   the device.&n;*/
r_static
r_void
DECL|function|cy_send_xchar
id|cy_send_xchar
(paren
r_struct
id|tty_struct
...
(paren
id|KERN_ERR
l_string|&quot;cyclades: failed to reserve PCI resources&bslash;n&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon

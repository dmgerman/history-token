...
(paren
id|KERN_ERR
l_string|&quot;cyclades: failed to allocate IO &quot;
l_string|&quot;resource at 0x%lx&bslash;n&quot;
comma
id|cy_pci_phys1
)paren
suffix:semicolon
...
l_int|NULL
suffix:semicolon
multiline_comment|/* For next card */
...
(paren
id|KERN_ERR
l_string|&quot;cyclades: failed ot allocate IO resource &quot;

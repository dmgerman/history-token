...
op_amp
id|SH_EVENT_OCCURRED_RTC2_INT_MASK
)paren
(brace
id|HUB_S
c_func
...
op_amp
id|SH_EVENT_OCCURRED_RTC3_INT_MASK
)paren
(brace
id|HUB_S
c_func
...
multiline_comment|/* No timer left here, bail out */
r_goto
id|out
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;mmtimer: unable to deliver signal&quot;
)paren
suffix:semicolon
id|t-&gt;it_overrun
op_increment

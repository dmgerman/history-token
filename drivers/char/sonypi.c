...
multiline_comment|/* Old PM scheme */
...
multiline_comment|/* New PM scheme (device model) */
DECL|variable|sonypi_sysclass
r_static
r_struct
id|sysdev_class
id|sonypi_sysclass
...
(paren
id|KERN_ERR
l_string|&quot;sonypi: sysdev_class_register failed&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;sonypi: sysdev_register failed&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign

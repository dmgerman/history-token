...
suffix:semicolon
multiline_comment|/* set in DMI table parse routines */
...
DECL|function|sonypi_normal_srs
r_static
r_void
id|__devinit
id|sonypi_normal_srs
c_func
(paren
r_void
)paren
...
DECL|function|sonypi_normal_dis
r_static
r_void
id|__devexit
id|sonypi_normal_dis
c_func
(paren
r_void
)paren
...
op_eq
id|SONYPI_DEVICE_MODEL_R505
)paren
(brace
id|sonypi_jogger_ev
op_assign
id|SONYPI_R505_JOGGER_EV
suffix:semicolon
id|sonypi_fnkey_ev
op_assign
id|SONYPI_R505_FNKEY_EV
suffix:semicolon
)brace
r_else
(brace
id|sonypi_jogger_ev
op_assign
id|SONYPI_NORMAL_JOGGER_EV
suffix:semicolon
id|sonypi_fnkey_ev
op_assign
id|SONYPI_NORMAL_FNKEY_EV
suffix:semicolon
)brace
id|v1
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;sonypi: unknown event port1=0x%x,port2=0x%x&bslash;n&quot;
comma
id|v1
comma
id|v2
...
(paren
id|KERN_ERR
l_string|&quot;sonypi: only one device allowed!&bslash;n&quot;
)paren
comma
id|ret
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;sonypi: detected %s model, camera = %s&bslash;n&quot;
comma
(paren
id|sonypi_device.model
op_eq
id|SONYPI_DEVICE_MODEL_NORMAL
)paren
ques
c_cond
l_string|&quot;normal&quot;

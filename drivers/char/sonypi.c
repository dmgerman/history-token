...
multiline_comment|/* FAN0 information (reverse engineered from ACPI tables) */
DECL|macro|SONYPI_FAN0_STATUS
mdefine_line|#define SONYPI_FAN0_STATUS&t;0x93
DECL|macro|SONYPI_TEMP_STATUS
mdefine_line|#define SONYPI_TEMP_STATUS&t;0xC1
...
r_break
suffix:semicolon
multiline_comment|/* FAN Controls */
r_case
id|SONYPI_IOCGFAN
suffix:colon
r_if
...
r_break
suffix:semicolon
multiline_comment|/* GET Temperature (useful under APM) */
r_case
id|SONYPI_IOCGTEMP
suffix:colon
r_if

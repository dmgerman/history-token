...
mdefine_line|#define WATCHDOG_HEARTBEAT 30&t;&t;&t;/* 30 sec default heartbeat */
...
multiline_comment|/**&n; * &t;sh_wdt_keepalive - Keep the Userspace Watchdog Alive&n; *&n; * &t;The Userspace watchdog got a KeepAlive: schedule the next heartbeat.&n; */
DECL|function|sh_wdt_keepalive
r_static
r_void
id|sh_wdt_keepalive
c_func
...
multiline_comment|/**&n; * &t;sh_wdt_set_heartbeat - Set the Userspace Watchdog heartbeat&n; *&n; * &t;Set the Userspace Watchdog heartbeat&n; */
DECL|function|sh_wdt_set_heartbeat
r_static
r_int
id|sh_wdt_set_heartbeat
c_func
(paren
r_int
id|t
...
id|KERN_INFO
id|PFX
l_string|&quot;clock_division_ratio value must be 0x5&lt;=x&lt;=0x7, using %d&bslash;n&quot;
comma
id|clock_division_ratio
)paren
suffix:semicolon
...
id|KERN_INFO
id|PFX
l_string|&quot;heartbeat value must be 1&lt;=x&lt;=3600, using %d&bslash;n&quot;
comma
id|heartbeat
)paren
suffix:semicolon
...
id|KERN_ERR
id|PFX
l_string|&quot;Can&squot;t register miscdev on minor=%d (err=%d)&bslash;n&quot;
comma
id|sh_wdt_miscdev.minor
comma
id|rc
)paren
suffix:semicolon
...
id|heartbeat
comma
l_string|&quot;Watchdog heartbeat in seconds. (1&lt;=heartbeat&lt;=3600, default=&quot;
id|__MODULE_STRING
c_func
(paren
id|WATCHDOG_HEARTBEAT

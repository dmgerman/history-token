...
suffix:semicolon
DECL|macro|WD_VER
mdefine_line|#define WD_VER                  &quot;1.14 (03/26/2004)&quot;
...
(paren
id|KERN_INFO
l_string|&quot;pcwd: Could not start watchdog.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;pcwd: Could not stop watchdog.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_CRIT
l_string|&quot;pcwd: Unexpected close, not stopping watchdog!&bslash;n&quot;
)paren
suffix:semicolon
id|pcwd_send_heartbeat
c_func
...
(paren
id|KERN_INFO
l_string|&quot;pcwd: No previous trip detected - Cold boot or reset&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/*  Disable the board  */
r_if

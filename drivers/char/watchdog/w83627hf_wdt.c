...
r_static
r_void
DECL|function|w83627hf_select_wd_register
id|w83627hf_select_wd_register
c_func
(paren
r_void
)paren
...
r_static
r_void
DECL|function|w83627hf_unselect_wd_register
id|w83627hf_unselect_wd_register
c_func
(paren
r_void
)paren
...
multiline_comment|/* tyan motherboards seem to set F5 to 0x4C ?&n; * So explicitly init to appropriate value. */
r_static
r_void
DECL|function|w83627hf_init
id|w83627hf_init
c_func
(paren
r_void
...
suffix:semicolon
multiline_comment|/* read CRF5 */
id|t
op_and_assign
op_complement
l_int|0x0C
suffix:semicolon
multiline_comment|/* set second mode &amp; disable keyboard turning off watchdog */
id|outb_p
c_func
(paren
id|t
...
suffix:semicolon
multiline_comment|/* Write back to CRF5 */
id|w83627hf_unselect_wd_register
c_func
(paren
)paren
...
id|KERN_INFO
id|PFX
l_string|&quot;timeout value must be 1&lt;=timeout&lt;=63, using %d&bslash;n&quot;
comma
id|WATCHDOG_TIMEOUT
)paren
suffix:semicolon

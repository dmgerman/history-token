...
multiline_comment|/* TODO:&n; * test FSP reset&n; * add udbg support for xmon/kdb&n; */
DECL|macro|DEBUG
...
multiline_comment|/*&n; * we can&squot;t call tty_hangup() directly here because we need to call that&n; * outside of our lock&n; */
...
(paren
id|KERN_DEBUG
l_string|&quot;hvsi%i: service processor closed connection!&bslash;n&quot;
comma
id|hp-&gt;index
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * either all data was sent or there was an error, and we throw away&n;&t;&t; * data on error.&n;&t;&t; */
id|hp-&gt;n_outbuf
op_assign
l_int|0
suffix:semicolon

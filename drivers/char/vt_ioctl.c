...
id|op
suffix:semicolon
multiline_comment|/* used in multiple places here */
r_struct
id|kbd_struct
op_star
id|kbd
...
id|KDSETMODE
suffix:colon
multiline_comment|/*&n;&t;&t; * currently, setting the mode from KD_TEXT to KD_GRAPHICS&n;&t;&t; * doesn&squot;t do a whole lot. i&squot;m not sure if it should do any&n;&t;&t; * restoration of modes or what...&n;&t;&t; *&n;&t;&t; * XXX It should at least call into the driver, fbdev&squot;s definitely&n;&t;&t; * need to restore their engine state. --BenH&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * A process can indicate its willingness to accept signals&n;&t; * generated by pressing an appropriate key combination.&n;&t; * Thus, one can have a daemon that e.g. spawns a new console&n;&t; * upon a keypress and then changes to it.&n;&t; * See also the kbrequest field of inittab(5).&n;&t; */
r_case
id|KDSIGACCEPT
suffix:colon
(brace
...
l_int|0
suffix:semicolon
id|vc-&gt;vt_mode.relsig
op_assign
l_int|0
suffix:semicolon
id|vc-&gt;vt_mode.acqsig
op_assign
l_int|0
suffix:semicolon
id|vc-&gt;vt_mode.frsig

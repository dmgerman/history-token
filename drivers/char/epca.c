...
multiline_comment|/* ---------------------------------------------------------------&n;&t;&t;&t;Allow someone else to be scheduled.  We will occasionally go&n;&t;&t;&t;through this loop until one of the above conditions change.&n;&t;&t;&t;The below schedule call will allow other processes to enter and&n;&t;&t;&t;prevent this loop from hogging the cpu.&n;&t;&t;------------------------------------------------------------------ */
id|schedule
c_func
(paren
)paren
...
id|SERIAL_TYPE_INFO
suffix:semicolon
id|pc_info-&gt;init_termios
op_assign
id|tty_std_termios
suffix:semicolon
id|pc_info-&gt;init_termios.c_iflag
op_assign
l_int|0
suffix:semicolon
id|pc_info-&gt;init_termios.c_oflag
op_assign
l_int|0
suffix:semicolon
id|pc_info-&gt;init_termios.c_lflag
op_assign
l_int|0
suffix:semicolon
...
id|lowwater
suffix:semicolon
multiline_comment|/*  -------------------------------------------------------------&n;&t;&t;This call is made by the user via. the ioctl call DIGI_INIT.&n;&t;&t;It is responsible for setting up all the card specific stuff.&n;&t;---------------------------------------------------------------- */
id|bd
op_assign
op_amp
id|boards
...
multiline_comment|/* ------------------------------------------------------------&n;&t;&t;&t;&t;This call is made by the apps to complete the initilization&n;&t;&t;&t;&t;of the board(s).  This routine is responsible for setting&n;&t;&t;&t;&t;the card to its initial state and setting the drivers control&n;&t;&t;&t;&t;fields to the sutianle settings for the card in question.&n;&t;&t;&t;---------------------------------------------------------------- */
r_int
id|crd
suffix:semicolon
r_for
...
(paren
id|KERN_ERR
l_string|&quot;&lt;Error&gt; - ch is NULL in pc_tiocmget!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;&lt;Error&gt; - ch is NULL in pc_tiocmset!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
multiline_comment|/*&n;&t; * I think this modemfake stuff is broken.  It doesn&squot;t&n;&t; * correctly reflect the behaviour desired by the TIOCM*&n;&t; * ioctls.  Therefore this is probably broken.&n;&t; */
r_if
c_cond
(paren
id|set
...
r_else
(brace
multiline_comment|/* ldisc lock already held in ioctl */
r_if
c_cond
(paren

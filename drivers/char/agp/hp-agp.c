...
multiline_comment|/* HP ZX1 LBA registers */
DECL|macro|HP_ZX1_AGP_STATUS
mdefine_line|#define HP_ZX1_AGP_STATUS&t;0x64
DECL|macro|HP_ZX1_AGP_COMMAND
mdefine_line|#define HP_ZX1_AGP_COMMAND&t;0x68
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* ouch!! can&squot;t do that with a non-PCI AGP bridge... */
...
id|KERN_INFO
id|PFX
l_string|&quot;Detected HP ZX1 AGP chipset (ioc=%lx, lba=%lx)&bslash;n&quot;
comma
id|ioc_hpa
comma
id|lba_hpa
...
id|KERN_INFO
id|PFX
l_string|&quot;Failed to initialize zx1 AGP.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

...
multiline_comment|/* ULi K8 registers */
DECL|macro|ULI_X86_64_BASE_ADDR
mdefine_line|#define ULI_X86_64_BASE_ADDR&t;&t;0x10
DECL|macro|ULI_X86_64_HTT_FEA_REG
mdefine_line|#define ULI_X86_64_HTT_FEA_REG&t;&t;0x50
DECL|macro|ULI_X86_64_ENU_SCR_REG
mdefine_line|#define ULI_X86_64_ENU_SCR_REG&t;&t;0x54
...
(paren
id|KERN_INFO
l_string|&quot;Setting up ULi AGP. &bslash;n&quot;
)paren
suffix:semicolon
id|dev1
op_assign
...
id|KERN_INFO
id|PFX
l_string|&quot;Detected a ULi chipset, &quot;
l_string|&quot;but could not fine the secondary device.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|KERN_INFO
id|PFX
l_string|&quot;No ULi size found for %d&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
...
multiline_comment|/* shadow x86-64 registers into ULi registers */
id|pci_read_config_dword
(paren
id|hammers
(braket

...
(brace
multiline_comment|/* &n;&t;&t;&t; * We probably have a I845MP chipset with an external graphics&n;&t;&t;&t; * card. It will be initialized later &n;&t;&t;&t; */
id|agp_bridge-&gt;type
op_assign
id|INTEL_I845_G
suffix:semicolon
...
id|KERN_INFO
id|PFX
l_string|&quot;Detected an Intel 845G Chipset.&bslash;n&quot;
)paren
suffix:semicolon
id|agp_bridge-&gt;type
op_assign
...
id|KERN_INFO
id|PFX
l_string|&quot;Detected an Intel 830M Chipset.&bslash;n&quot;
)paren
suffix:semicolon
id|agp_bridge-&gt;type
op_assign

...
suffix:semicolon
DECL|variable|amd_irongate_bridge
r_struct
id|agp_bridge_data
id|amd_irongate_bridge
op_assign
(brace
dot
id|type
...
id|found
suffix:colon
id|amd_irongate_bridge.dev
op_assign
id|pdev
suffix:semicolon
id|amd_irongate_bridge.capndx
op_assign
id|cap_ptr
suffix:semicolon

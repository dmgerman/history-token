...
suffix:semicolon
DECL|function|check_bridge_mode
r_static
r_int
id|check_bridge_mode
c_func
(paren
r_struct
id|pci_dev
...
op_assign
id|bridge-&gt;version-&gt;major
suffix:semicolon
id|info-&gt;version.minor
op_assign
id|bridge-&gt;version-&gt;minor
suffix:semicolon
id|info-&gt;chipset
op_assign
id|SUPPORTED
...
op_assign
id|bridge-&gt;driver-&gt;cant_use_aperture
suffix:semicolon
id|info-&gt;vm_ops
op_assign
id|bridge-&gt;vm_ops
...
multiline_comment|/* Check the speed bits make sense. Only one should be set. */
id|tmp
op_assign
op_star
id|requested_mode
...
multiline_comment|/* Check the speed bits make sense. */
id|tmp
op_assign
op_star
id|requested_mode
...
l_string|&quot;[bridge_agpstat:%x vga_agpstat:%x fell back to:- bridge_agpstat:%x vga_agpstat:%x]&bslash;n&quot;
comma
id|origbridge
comma
id|origvga
...
(paren
(paren
id|device-&gt;bus-&gt;self-&gt;vendor
op_ne
id|bridge-&gt;dev-&gt;vendor
)paren
op_logical_and
(paren
id|device-&gt;bus-&gt;self-&gt;device
op_ne
...
suffix:semicolon
multiline_comment|/* When we remove the global variable agp_bridge from all drivers&n; * then agp_alloc_bridge and agp_generic_find_bridge need to be updated&n; */
DECL|function|agp_generic_find_bridge
r_struct
id|agp_bridge_data
op_star

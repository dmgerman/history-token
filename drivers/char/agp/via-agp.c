...
suffix:semicolon
DECL|variable|via_generic_agp3_bridge
r_struct
id|agp_bridge_data
id|via_generic_agp3_bridge
op_assign
(brace
dot
id|type
...
suffix:semicolon
DECL|variable|via_generic_bridge
r_struct
id|agp_bridge_data
id|via_generic_bridge
op_assign
(brace
dot
id|type
...
id|PCI_DEVICE_ID_VIA_8367_0
suffix:colon
multiline_comment|/*&n;&t;&t; * Garg, there are KT400s with KT266 IDs.&n;&t;&t; */
...
id|PCI_DEVICE_ID_VIA_8377_0
suffix:colon
multiline_comment|/*&n;&t;&t; * The KT400 does magick to put the AGP bridge compliant&n;&t;&t; * with the same standards version as the graphics card.&n;&t;&t; */
id|pci_read_config_byte
c_func
(paren
id|pdev

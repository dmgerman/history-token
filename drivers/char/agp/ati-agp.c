...
suffix:semicolon
DECL|variable|ati_generic_masks
r_static
r_struct
id|gatt_mask
id|ati_generic_masks
(braket
)braket
op_assign
(brace
...
id|remapped
suffix:semicolon
DECL|typedef|ati_page_map
)brace
id|ati_page_map
suffix:semicolon
DECL|struct|_ati_generic_private
r_static
r_struct
id|_ati_generic_private
(brace
...
id|num_tables
suffix:semicolon
DECL|variable|ati_generic_private
)brace
id|ati_generic_private
suffix:semicolon
DECL|function|ati_create_page_map
r_static
r_int
id|ati_create_page_map
c_func
(paren
id|ati_page_map
op_star
...
DECL|function|ati_free_page_map
r_static
r_void
id|ati_free_page_map
c_func
(paren
id|ati_page_map
op_star
...
DECL|function|ati_free_gatt_pages
r_static
r_void
id|ati_free_gatt_pages
c_func
(paren
r_void
)paren
...
id|tables
op_assign
id|ati_generic_private.gatt_pages
suffix:semicolon
r_for
c_loop
(paren
...
id|i
OL
id|ati_generic_private.num_tables
suffix:semicolon
id|i
op_increment
)paren
...
DECL|function|ati_create_gatt_pages
r_static
r_int
id|ati_create_gatt_pages
c_func
(paren
r_int
id|nr_tables
...
id|agp_bridge-&gt;dev-&gt;device
op_eq
id|PCI_DEVICE_ID_ATI_RS200
)paren
op_logical_or
(paren
id|agp_bridge-&gt;dev-&gt;device
op_eq
id|PCI_DEVICE_ID_ATI_RS200_B
)paren
op_logical_or
(paren
id|agp_bridge-&gt;dev-&gt;device
op_eq
id|PCI_DEVICE_ID_ATI_RS250
)paren
)paren
r_return
l_int|1
...
DECL|function|ati_remove_memory
r_static
r_int
id|ati_remove_memory
c_func
(paren
r_struct
id|agp_memory
...
DECL|function|ati_create_gatt_table
r_static
r_int
id|ati_create_gatt_table
c_func
(paren
r_void
)paren
...
multiline_comment|/*&n;&t; * Get the address for the gart region.&n;&t; * This is a bus address even on the alpha, b/c its&n;&t; * used to program the agp master not the cpu&n;&t; */
id|pci_read_config_dword
c_func
(paren
id|agp_bridge-&gt;dev
...
DECL|function|ati_free_gatt_table
r_static
r_int
id|ati_free_gatt_table
c_func
(paren
r_void
)paren
...
DECL|variable|ati_generic_bridge
r_struct
id|agp_bridge_driver
id|ati_generic_bridge
op_assign
(brace
dot
id|owner
...
id|device_id
op_assign
id|PCI_DEVICE_ID_ATI_RS300_100
comma
dot
id|chipset_name
op_assign
...
id|device_id
op_assign
id|PCI_DEVICE_ID_ATI_RS300_133
comma
dot
id|chipset_name
op_assign
...
id|device_id
op_assign
id|PCI_DEVICE_ID_ATI_RS300_166
comma
dot
id|chipset_name
op_assign
...
id|device_id
op_assign
id|PCI_DEVICE_ID_ATI_RS300_200
comma
dot
id|chipset_name
op_assign
...
id|KERN_INFO
id|PFX
l_string|&quot;Detected Ati %s chipset&bslash;n&quot;
comma
id|devs
(braket
id|j
...
suffix:semicolon
DECL|variable|agp_ati_pci_driver
r_static
r_struct
id|pci_driver
id|agp_ati_pci_driver
op_assign
(brace
dot
id|name
op_assign
l_string|&quot;agpgart-ati&quot;
comma
dot
id|id_table
op_assign

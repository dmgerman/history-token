...
suffix:semicolon
multiline_comment|/* for sysfs class support */
DECL|variable|ip2_class
r_static
r_struct
id|class_simple
op_star
...
(paren
id|KERN_ERR
l_string|&quot;IP2: can&squot;t enable PCI device at %s&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;IP2: PCI error 0x%x &bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* create the sysfs class */
id|ip2_class
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;IP2: bad addr=0x%x&bslash;n&quot;
comma
id|ip2config.addr
(braket
id|boardnum
...
suffix:semicolon
singleline_comment|// rc = put_user(ip2_init, pIndex++ );
id|rc
op_assign
id|put_user
c_func
...
suffix:semicolon
singleline_comment|//rc = put_user(ip2_wait_until_sent, pIndex++ );
id|rc
op_assign
id|put_user
c_func

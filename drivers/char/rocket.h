multiline_comment|/*&n; * rocket.h --- the exported interface of the rocket driver to its configuration program.&n; *&n; * Written by Theodore Ts&squot;o, Copyright 1997.&n; * Copyright 1997 Comtrol Corporation. &n; *&n; */

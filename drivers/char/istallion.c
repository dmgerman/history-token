...
c_func
(paren
l_string|&quot;stli_write(tty=%x,buf=%x,count=%d)&bslash;n&quot;
comma
(paren
r_int
)paren
...
multiline_comment|/*&n; *&t;Set up the tty driver structure and register us as a driver.&n; */

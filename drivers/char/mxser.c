...
c_func
(paren
l_string|&quot;Tty devices major number = %d&bslash;n&quot;
comma
id|ttymajor
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Too many Smartio family boards found (maximum %d),board not configured&bslash;n&quot;
comma
id|MXSER_BOARDS
)paren
suffix:semicolon

...
multiline_comment|/* Interval between polling of keys, in jiffies. */
DECL|macro|I8K_POLL_INTERVAL
mdefine_line|#define I8K_POLL_INTERVAL&t;(HZ/20)
DECL|macro|I8K_REPEAT_DELAY
mdefine_line|#define I8K_REPEAT_DELAY&t;250&t;/* 250 ms */
DECL|macro|I8K_REPEAT_RATE
mdefine_line|#define I8K_REPEAT_RATE&t;&t;10
multiline_comment|/*&n; * (To be escaped) Scancodes for the keys.  These were chosen to match other&n; * &quot;Internet&quot; keyboards.&n; */
DECL|macro|I8K_KEYS_UP_SCANCODE
mdefine_line|#define I8K_KEYS_UP_SCANCODE&t;0x30
DECL|macro|I8K_KEYS_DOWN_SCANCODE
mdefine_line|#define I8K_KEYS_DOWN_SCANCODE&t;0x2e
DECL|macro|I8K_KEYS_MUTE_SCANCODE
mdefine_line|#define I8K_KEYS_MUTE_SCANCODE&t;0x20
...
id|handle_buttons
comma
l_string|&quot;Generate keyboard events for i8k buttons&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|repeat_delay
comma
l_string|&quot;I8k buttons repeat delay (ms)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|repeat_rate
comma
l_string|&quot;I8k buttons repeat rate&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
multiline_comment|/*&n; * i8k_keys stuff. Thanks to David Bustos &lt;bustos@caltech.edu&gt;&n; */
DECL|function|i8k_keys_make_scancode
r_static
r_int
r_char
id|i8k_keys_make_scancode
c_func
(paren
r_int
id|x
...
suffix:colon
r_return
id|I8K_KEYS_UP_SCANCODE
suffix:semicolon
r_case
id|I8K_FN_DOWN
suffix:colon
r_return
id|I8K_KEYS_DOWN_SCANCODE
suffix:semicolon
r_case
id|I8K_FN_MUTE
suffix:colon
r_return
id|I8K_KEYS_MUTE_SCANCODE
suffix:semicolon
)brace
r_return
l_int|0
...
r_else
(brace
multiline_comment|/* Generate keyboard repeat events with current scancode -- dz */
r_if
c_cond
(paren
(paren
...
DECL|function|i8k_keys_set_timer
r_static
r_void
id|i8k_keys_set_timer
c_func
...
(brace
id|i8k_keys_timer.expires
op_assign
id|jiffies
op_plus
id|I8K_POLL_INTERVAL
suffix:semicolon
id|add_timer
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Register the i8k_keys timer. */
r_if
c_cond
(paren
id|handle_buttons
...
(paren
id|KERN_INFO
l_string|&quot;i8k: enabling buttons events, delay=%d, rate=%d&bslash;n&quot;
comma
id|repeat_delay
comma
id|repeat_rate
...
suffix:semicolon
multiline_comment|/* Unregister the i8k_keys timer. */
r_while
c_loop
(paren
id|handle_buttons

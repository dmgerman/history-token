...
suffix:semicolon
multiline_comment|/* AAargh! The order in which to do these things is essential and&n;     not trivial. &n;     &n;     - Rate limit goes before &quot;recursive&quot;. Otherwise a series of&n;       recursive calls will hang the machine in the interrupt routine. &n;&n;     - hardware twiddling goes before &quot;recursive&quot;. Otherwise when we&n;       poll the card, and a recursive interrupt happens, we won&squot;t&n;       ack the card, so it might keep on interrupting us. (especially&n;       level sensitive interrupt systems like PCI).&n;&n;     - Rate limit goes before hardware twiddling. Otherwise we won&squot;t&n;       catch a card that has gone bonkers.&n;&n;     - The &quot;initialized&quot; test goes after the hardware twiddling. Otherwise&n;       the card will stick us in the interrupt routine again.&n;&n;     - The initialized test goes before recursive. &n;  */
...
suffix:semicolon
id|rio_driver2-&gt;owner
op_assign
id|THIS_MODULE
suffix:semicolon
id|rio_driver2-&gt;driver_name
op_assign
l_string|&quot;specialix_rio&quot;
suffix:semicolon
id|rio_driver2-&gt;name
...
id|TTY_DRIVER_TYPE_SERIAL
suffix:semicolon
id|rio_driver2-&gt;subtype
op_assign
id|SERIAL_TYPE_NORMAL
suffix:semicolon
id|rio_driver2-&gt;init_termios
op_assign
id|tty_std_termios
suffix:semicolon
id|rio_driver2-&gt;init_termios.c_cflag
op_assign
id|B9600
op_or
id|CS8
...
suffix:semicolon
multiline_comment|/*free5:&n; free4:&n; free3:*/
id|kfree
(paren
id|p-&gt;RIOPortp
)paren
...
id|RIO_DEBUG_INIT
comma
l_string|&quot;Not enough memory! %p %p %p&bslash;n&quot;
comma
id|p
comma
id|p-&gt;RIOHosts
...
r_else
(brace
multiline_comment|/* deregister the misc device we created earlier */
id|misc_deregister
c_func
(paren
op_amp

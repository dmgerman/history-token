...
suffix:semicolon
multiline_comment|/*&n; * Variables/functions exported for vt_ioctl.c&n; */
...
id|spawnsig
suffix:semicolon
multiline_comment|/*&n; * Translation of scancodes to keycodes.&n; */
...
multiline_comment|/*&n; * Variables/function exported for vt.c&n; */

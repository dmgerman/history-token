...
c_func
(paren
l_string|&quot;stl_write(tty=%x,buf=%x,count=%d)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;stl_intr(brdp=%x,irq=%d,regs=%x)&bslash;n&quot;
comma
(paren
r_int
)paren

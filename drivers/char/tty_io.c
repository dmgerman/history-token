...
macro_line|#else
DECL|macro|tty_unregister_devfs
macro_line|# define tty_unregister_devfs(driver, index)&t;do { } while (0)
...
suffix:semicolon
DECL|macro|to_tty_dev
mdefine_line|#define to_tty_dev(d) container_of(d, struct tty_dev, class_dev)
r_static
id|LIST_HEAD
c_func
(paren
...
suffix:semicolon
DECL|variable|tty_dev_list_lock
r_static
id|spinlock_t
id|tty_dev_list_lock
op_assign
...
suffix:semicolon
DECL|function|tty_add_class_device
r_static
r_void
id|tty_add_class_device
c_func
(paren
r_char
op_star
...
suffix:semicolon
multiline_comment|/* stupid &squot;/&squot; in tty name strings... */
id|temp
op_assign
id|strrchr
c_func
...
id|name
suffix:semicolon
id|tty_dev-&gt;class_dev.dev
op_assign
id|device
suffix:semicolon
id|tty_dev-&gt;class_dev
dot
r_class
op_assign
op_amp
...
DECL|function|tty_remove_class_device
r_void
id|tty_remove_class_device
c_func
(paren
id|dev_t
id|dev
...
suffix:semicolon
multiline_comment|/* stupid console driver devfs names... change vc/X into ttyX */
r_if
c_cond
(paren
id|driver-&gt;type
...
suffix:semicolon
multiline_comment|/* we don&squot;t care about the ptys */
r_if
c_cond
(paren
id|driver-&gt;type
...
suffix:semicolon
multiline_comment|/* that should be handled by register_chrdev_region() */
DECL|function|get_range
r_static
r_int
id|get_range
c_func
...
multiline_comment|/* that should be handled by unregister_chrdev_region() */
DECL|function|put_range
r_static
r_void
id|put_range
c_func

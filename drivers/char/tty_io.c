...
suffix:semicolon
multiline_comment|/* Lock for tty_termios changes - private to tty_io/tty_ioctl */
DECL|variable|tty_termios_lock
id|spinlock_t
id|tty_termios_lock
op_assign
...
multiline_comment|/*&n; *&t;Call the ldisc flush directly from a driver. This function may&n; *&t;return an error and need retrying by the user.&n; */
DECL|function|tty_push_data
r_int
id|tty_push_data
c_func
(paren

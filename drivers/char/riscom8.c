...
multiline_comment|/*&n; * This routine is called from the work queue when the interrupt&n; * routine has signalled that a hangup has occurred.  The path of&n; * hangup processing is:&n; *&n; * &t;serial interrupt routine -&gt; (workqueue) -&gt;&n; * &t;do_rc_hangup() -&gt; tty-&gt;hangup() -&gt; rc_hangup()&n; * &n; */

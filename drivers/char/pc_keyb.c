...
(brace
multiline_comment|/* Aux port detected */
...
(brace
multiline_comment|/* Mouse not in use */
id|spin_lock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* kbd_write_cmd(AUX_INTS_OFF); */
multiline_comment|/* Config &amp; lock */
id|kb_wait
c_func
(paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;keyboard: Timeout - AT keyboard not present?(%02x)&bslash;n&quot;
comma
id|data
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Some Alphas cannot mask some/all interrupts, so we have to&n; * make sure not to allow interrupts AT ALL when polling for&n; * specific return values from the keyboard.&n; *&n; * I think this should work on any architecture, but for now, only Alpha.&n; */
DECL|function|kbd_write_command_w_and_wait
r_static
r_int
id|kbd_write_command_w_and_wait
c_func
(paren
r_int
id|data
...
DECL|function|kbd_write_output_w_and_wait
r_static
r_int
id|kbd_write_output_w_and_wait
c_func
(paren
r_int
id|data
...
(paren
id|KERN_ERR
l_string|&quot;psaux_init(): out of memory&bslash;n&quot;
)paren
suffix:semicolon
id|misc_deregister
c_func

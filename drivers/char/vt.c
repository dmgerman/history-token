...
DECL|macro|IS_FG
mdefine_line|#define IS_FG&t;&t;&t;(currcons == fg_console)
DECL|macro|IS_FG_VC
mdefine_line|#define IS_FG_VC(vc)&t;&t;(vc == vc_cons[fg_console].d)
...
mdefine_line|#define DO_UPDATE&t;&t;0
DECL|macro|DO_UPDATE_VC
mdefine_line|#define DO_UPDATE_VC(vc)&t;0
macro_line|#else
DECL|macro|DO_UPDATE
mdefine_line|#define DO_UPDATE &t;&t;IS_VISIBLE
DECL|macro|DO_UPDATE_VC
mdefine_line|#define DO_UPDATE_VC(vc)&t;CON_IS_VISIBLE(vc)
macro_line|#endif
r_static
r_int
id|pm_con_request

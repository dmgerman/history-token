...
macro_line|#else
mdefine_line|#define FLUSH if (draw_x &gt;= 0) { &bslash;&n;&t;sw-&gt;con_putcs(vc, (u16 *)draw_from, (u16 *)draw_to-(u16 *)draw_from, y, draw_x); &bslash;&n;&t;draw_x = -1; &bslash;&n;&t;}
macro_line|#endif
r_int
id|c
comma

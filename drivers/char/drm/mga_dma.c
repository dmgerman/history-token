...
suffix:semicolon
multiline_comment|/* We need to wait so that we can do an safe flush */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;age=0x%06lx wrap=%d&bslash;n&quot;
comma
...
DECL|function|mga_driver_pretakedown
r_static
r_void
...
DECL|function|mga_driver_dma_quiescent
r_static
r_int
...
DECL|function|mga_driver_register_fns
r_void
id|mga_driver_register_fns
c_func
(paren
id|drm_device_t
op_star

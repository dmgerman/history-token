...
multiline_comment|/* i810 DRM version 1.1 used a smaller init structure with different&n; * ordering of values than is currently used (drm &gt;= 1.2). There is&n; * no defined way to detect the XFree version to correct this problem,&n; * however by checking using this procedure we can detect the correct&n; * thing to do.&n; *&n; * #1 Read the Smaller init structure from user-space&n; * #2 Verify the overlay_physical is a valid physical address, or NULL&n; *    If it isn&squot;t then we have a v1.1 client. Fix up params.&n; *    If it is, then we have a 1.2 client... get the rest of the data.&n; */
DECL|function|i810_dma_init_compat
r_int
id|i810_dma_init_compat
c_func
(paren
id|drm_i810_init_t
op_star
...
(brace
multiline_comment|/* Get v1.1 init data */
r_if
c_cond
(paren
id|copy_from_user
...
(brace
multiline_comment|/* This is a v1.2 client, just get the v1.2 init data */
id|DRM_INFO
c_func
(paren
l_string|&quot;Using POST v1.2 init.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
r_else
(brace
multiline_comment|/* This is a v1.1 client, fix the params */
id|DRM_INFO
c_func
(paren
l_string|&quot;Using PRE v1.2 init.&bslash;n&quot;
)paren
suffix:semicolon
id|init-&gt;pitch_bits
op_assign
...
l_int|0
suffix:semicolon
multiline_comment|/* Get only the init func */
r_if
c_cond
(paren
id|copy_from_user
...
id|I810_INIT_DMA
suffix:colon
multiline_comment|/* This case is for backward compatibility. It&n;&t;&t;&t; * handles XFree 4.1.0 and 4.2.0, and has to&n;&t;&t;&t; * do some parameter checking as described below.&n;&t;&t;&t; * It will someday go away.&n;&t;&t;&t; */
id|retcode
op_assign
id|i810_dma_init_compat
c_func
...
c_func
(paren
l_string|&quot;Using v1.4 init.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
DECL|function|i810_dma_dispatch_flip
r_static
r_void
id|i810_dma_dispatch_flip
c_func
(paren
id|drm_device_t
op_star
...
suffix:semicolon
multiline_comment|/* On i815 at least ASYNC is buggy */
multiline_comment|/* pitch&lt;&lt;5 is from 11.2.8 p158,&n;&t;   its the pitch / 8 then left shifted 8,&n;&t;   so (pitch &gt;&gt; 3) &lt;&lt; 8 */
id|OUT_RING
c_func
(paren
id|CMD_OP_FRONTBUFFER_INFO
op_or
(paren
id|pitch
op_lshift
...
c_func
(paren
id|CMD_OP_WAIT_FOR_EVENT
op_or
id|WAIT_FOR_PLANE_A_FLIP
)paren
suffix:semicolon
id|OUT_RING
c_func
...
DECL|function|i810_do_init_pageflip
r_static
r_void
id|i810_do_init_pageflip
c_func
(paren
id|drm_device_t
op_star
...
DECL|function|i810_do_cleanup_pageflip
r_int
id|i810_do_cleanup_pageflip
c_func
(paren
id|drm_device_t
op_star
...
c_func
(paren
l_string|&quot;i810_flip_buf called without lock held&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|i810_driver_pretakedown
r_static
r_void
...
DECL|function|i810_driver_release
r_static
r_void
...
DECL|function|i810_driver_dma_quiescent
r_static
r_int
...
DECL|function|i810_driver_register_fns
r_void
id|i810_driver_register_fns
c_func
(paren
id|drm_device_t
op_star

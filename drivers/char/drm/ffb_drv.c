multiline_comment|/* $Id: ffb_drv.c,v 1.9 2001/03/23 07:58:39 davem Exp $&n; * ffb_drv.c: Creator/Creator3D direct rendering driver.&n; *&n; * Copyright (C) 2000 David S. Miller (davem@redhat.com)&n; */

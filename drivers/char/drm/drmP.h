...
macro_line|#endif
macro_line|#ifndef __HAVE_DMA_HISTOGRAM
DECL|macro|__HAVE_DMA_HISTOGRAM
mdefine_line|#define __HAVE_DMA_HISTOGRAM&t;0
macro_line|#endif
...
multiline_comment|/* GH: This is a dirty hack for now...&n; */
r_extern
r_void
id|DRM
c_func
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Buffer list support (drm_lists.h) */

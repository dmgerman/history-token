...
suffix:semicolon
multiline_comment|/* FIXME: If the X server changes screen resolution, it&n;&t; * clobbers the value of RADEON_CRTC_OFFSET_CNTL, above,&n;&t; * leading to a flashing efect.&n;&t; */
id|dev_priv-&gt;page_flipping
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME The second and subsequent times round this loop, send a&n;&t;&t;&t; * WAIT_UNTIL_3D_IDLE before calling emit_clip_rect(). This&n;&t;&t;&t; * fixes a lockup on fast machines when sending several&n;&t;&t;&t; * cliprects with a cmdbuf, as when waving a 2D window over&n;&t;&t;&t; * a 3D window. Something in the commands from user space&n;&t;&t;&t; * seems to hang the card when they&squot;re sent several times&n;&t;&t;&t; * in a row. That would be the correct place to fix it but&n;&t;&t;&t; * this works around it until I can figure that out - Tim Smith */
r_if
c_cond
(paren
id|i

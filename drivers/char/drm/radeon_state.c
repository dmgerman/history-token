...
suffix:semicolon
multiline_comment|/*&t;OUT_RING( ((box-&gt;y2 - 1) &lt;&lt; 16) | (box-&gt;x2 - 1) );*/
id|OUT_RING
c_func
(paren
(paren
...
id|EFAULT
suffix:semicolon
multiline_comment|/*  &t;&t;printk( &quot;pk3 %d: %x&bslash;n&quot;, j, tmp); */
id|OUT_RING
c_func
(paren
id|tmp
...
id|EFAULT
suffix:semicolon
multiline_comment|/*  &t;&t;&t;printk( &quot;pk3_clip %d: %x&bslash;n&quot;, j, tmp); */
id|OUT_RING
c_func
(paren
id|tmp

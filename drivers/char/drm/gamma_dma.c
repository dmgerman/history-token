...
DECL|function|gamma_driver_irq_handler
id|irqreturn_t
id|gamma_driver_irq_handler
c_func
(paren
id|DRM_IRQ_ARGS
)paren
...
DECL|function|gamma_driver_irq_preinstall
r_void
id|gamma_driver_irq_preinstall
c_func
(paren
id|drm_device_t
op_star
...
DECL|function|gamma_driver_irq_postinstall
r_void
id|gamma_driver_irq_postinstall
c_func
(paren
id|drm_device_t
op_star
...
DECL|function|gamma_driver_irq_uninstall
r_void
id|gamma_driver_irq_uninstall
c_func
(paren
id|drm_device_t
op_star
...
id|gamma_driver_dma_quiescent
suffix:semicolon
id|dev-&gt;driver.dma_flush_block_and_flush
op_assign
id|gamma_flush_block_and_flush
suffix:semicolon
id|dev-&gt;driver.dma_flush_unblock
op_assign

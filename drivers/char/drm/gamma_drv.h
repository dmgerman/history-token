...
suffix:semicolon
multiline_comment|/* Gamma-specific code pulled from drm_fops.h:&n; */
r_extern
r_int
id|DRM
c_func
...
suffix:semicolon
multiline_comment|/* Gamma-specific code pulled from drm_lists.h (now renamed gamma_lists.h):&n; */
r_extern
r_int
id|DRM
c_func
...
suffix:semicolon
multiline_comment|/* externs for gamma changes to the ops */
r_extern
r_struct
id|file_operations
id|DRM

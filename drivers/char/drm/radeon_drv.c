multiline_comment|/* radeon_drv.c -- ATI Radeon driver -*- linux-c -*-&n; *&n; * Copyright 1999, 2000 Precision Insight, Inc., Cedar Park, Texas.&n; * Copyright 2000 VA Linux Systems, Inc., Fremont, California.&n; * All Rights Reserved.&n; *&n; * Permission is hereby granted, free of charge, to any person obtaining a&n; * copy of this software and associated documentation files (the &quot;Software&quot;),&n; * to deal in the Software without restriction, including without limitation&n; * the rights to use, copy, modify, merge, publish, distribute, sublicense,&n; * and/or sell copies of the Software, and to permit persons to whom the&n; * Software is furnished to do so, subject to the following conditions:&n; *&n; * The above copyright notice and this permission notice (including the next&n; * paragraph) shall be included in all copies or substantial portions of the&n; * Software.&n; *&n; * THE SOFTWARE IS PROVIDED &quot;AS IS&quot;, WITHOUT WARRANTY OF ANY KIND, EXPRESS OR&n; * IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY,&n; * FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT.  IN NO EVENT SHALL&n; * PRECISION INSIGHT AND/OR ITS SUPPLIERS BE LIABLE FOR ANY CLAIM, DAMAGES OR&n; * OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE,&n; * ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER&n; * DEALINGS IN THE SOFTWARE.&n; *&n; * Authors: Kevin E. Martin &lt;martin@valinux.com&gt;&n; *          Rickard E. (Rik) Faith &lt;faith@valinux.com&gt;&n; *&n; */
macro_line|#include &lt;linux/config.h&gt;
macro_line|#include &quot;drmP.h&quot;
macro_line|#include &quot;radeon_drv.h&quot;
DECL|macro|RADEON_NAME
mdefine_line|#define RADEON_NAME&t;&t;&quot;radeon&quot;
DECL|macro|RADEON_DESC
mdefine_line|#define RADEON_DESC&t;&t;&quot;ATI Radeon&quot;
DECL|macro|RADEON_DATE
mdefine_line|#define RADEON_DATE&t;&t;&quot;20010105&quot;
DECL|macro|RADEON_MAJOR
mdefine_line|#define RADEON_MAJOR&t;&t;1
DECL|macro|RADEON_MINOR
mdefine_line|#define RADEON_MINOR&t;&t;0
DECL|macro|RADEON_PATCHLEVEL
mdefine_line|#define RADEON_PATCHLEVEL&t;0
DECL|variable|radeon_device
r_static
id|drm_device_t
id|radeon_device
suffix:semicolon
DECL|variable|radeon_res_ctx
id|drm_ctx_t
id|radeon_res_ctx
suffix:semicolon
DECL|variable|radeon_fops
r_static
r_struct
id|file_operations
id|radeon_fops
...
c_func
(paren
id|DRM_IOCTL_RADEON_FULLSCREEN
)paren
)braket
op_assign
(brace
...
suffix:semicolon
DECL|macro|RADEON_IOCTL_COUNT
mdefine_line|#define RADEON_IOCTL_COUNT DRM_ARRAY_SIZE(radeon_ioctls)
macro_line|#ifdef MODULE
DECL|variable|radeon
r_static
r_char
op_star
id|radeon
...
multiline_comment|/* radeon_options is called by the kernel to parse command-line options&n; * passed via the boot-loader (e.g., LILO).  It calls the insmod option&n; * routine, drm_parse_drm.&n; */
...
id|nexte
suffix:semicolon
multiline_comment|/* Remove AGP resources, but leave dev-&gt;agp&n;                                   intact until radeon_cleanup is called. */
r_for
c_loop
(paren
id|entry
...
multiline_comment|/* radeon_init is called via init_module at module load time, or via&n; * linux/init/main.c (this is not currently supported). */
...
c_func
(paren
l_string|&quot;Cannot initialize agpgart module.&bslash;n&quot;
)paren
suffix:semicolon
id|drm_proc_cleanup
c_func
...
multiline_comment|/* radeon_cleanup is called via cleanup_module at module unload time. */
DECL|function|radeon_cleanup
r_static
r_void
id|__exit
id|radeon_cleanup
...
suffix:semicolon
multiline_comment|/* Force the cleanup of page flipping when required */
r_if
c_cond
(paren
id|dev-&gt;dev_private
...
multiline_comment|/* radeon_ioctl is called whenever a process performs an ioctl on /dev/drm. */
DECL|function|radeon_ioctl
r_int
id|radeon_ioctl
c_func
(paren
...
OL
l_int|0
multiline_comment|/* || lock.context &gt;= dev-&gt;queue_count */
)paren
r_return
op_minus
id|EINVAL
...
c_func
(paren
l_string|&quot;not quiescent!&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#if 0
id|radeon_quiescent

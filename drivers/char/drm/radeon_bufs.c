...
DECL|function|radeon_addbufs_agp
r_int
id|radeon_addbufs_agp
c_func
(paren
r_struct
id|inode
...
multiline_comment|/* Might be too low a limit. XFree folks need to fix this properly */
r_if
c_cond
(paren
id|count

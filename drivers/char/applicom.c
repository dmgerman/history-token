...
suffix:semicolon
DECL|variable|applicom_pci_tbl
r_static
r_struct
id|pci_device_id
id|applicom_pci_tbl
...
comma
id|PCI_DEVICE_ID_APPLICOM_PCIGENERIC
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
id|PCI_VENDOR_ID_APPLICOM
comma
id|PCI_DEVICE_ID_APPLICOM_PCI2000IBS_CAN
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
id|PCI_VENDOR_ID_APPLICOM
comma
id|PCI_DEVICE_ID_APPLICOM_PCI2000PFB
comma
id|PCI_ANY_ID
comma
id|PCI_ANY_ID
...
(paren
id|KERN_INFO
l_string|&quot;Hmmm. write() of Applicom card, length %zd != expected %zd&bslash;n&quot;
comma
id|count
comma
r_sizeof
...
(paren
id|KERN_WARNING
l_string|&quot;Hmmm. read() of Applicom card, length %zd != expected %zd&bslash;n&quot;
comma
id|count
comma
r_sizeof

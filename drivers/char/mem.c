...
l_int|0
suffix:semicolon
macro_line|#ifdef __ARCH_HAS_NO_PAGE_ZERO_MAPPED
...
(brace
multiline_comment|/*&n;&t;&t; * Handle first page in case it&squot;s not aligned&n;&t;&t; */
r_if
c_cond
(paren
op_minus
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * On ia64 if a page has been mapped somewhere as&n;&t;&t; * uncached, then it must also be accessed uncached&n;&t;&t; * by the kernel or data corruption may occur&n;&t;&t; */
id|ptr
op_assign
id|xlate_dev_mem_ptr
c_func
(paren
id|p
)paren
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Handle first page in case it&squot;s not aligned&n;&t;&t;&t; */
r_if
c_cond
(paren
op_minus

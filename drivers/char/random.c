...
c_func
(paren
l_string|&quot;%s added %d bits, now %d&bslash;n&quot;
comma
id|r
op_eq
id|sec_random_state
...
c_func
(paren
l_string|&quot;xfer %d from primary to %s (have %d, need %d)&bslash;n&quot;
comma
id|nwords
op_star
l_int|32
...
c_func
(paren
l_string|&quot;reseeding %s with %d from primary&bslash;n&quot;
comma
id|r
op_eq
id|sec_random_state
...
c_func
(paren
l_string|&quot;%s has %d bits, want %d bits&bslash;n&quot;
comma
id|r
op_eq
id|sec_random_state
...
id|random_state-&gt;poolinfo.poolwords
suffix:semicolon
multiline_comment|/* prepare to atomically snapshot pool */
id|tmp
op_assign
id|kmalloc
c_func
...
id|sysctl_poolsize
op_assign
id|random_state-&gt;poolinfo.POOLBYTES
suffix:semicolon
id|ret
op_assign
id|proc_dointvec
...
mdefine_line|#define COUNT_BITS&t;8
DECL|macro|COUNT_MASK
mdefine_line|#define COUNT_MASK&t;( (1&lt;&lt;COUNT_BITS)-1)
DECL|macro|HASH_BITS
mdefine_line|#define HASH_BITS&t;24
DECL|macro|HASH_MASK
mdefine_line|#define HASH_MASK&t;( (1&lt;&lt;HASH_BITS)-1 )
DECL|struct|keydata
r_static
r_struct
id|keydata
(brace
DECL|member|rekey_time
id|time_t
id|rekey_time
suffix:semicolon
DECL|member|count
...
id|count
suffix:semicolon
singleline_comment|// already shifted to the final position
DECL|member|secret
id|__u32
id|secret
(braket
...
id|ip_cnt
suffix:semicolon
DECL|function|__check_and_rekey
r_static
r_struct
id|keydata
op_star
id|__check_and_rekey
c_func
(paren
id|time_t
id|time

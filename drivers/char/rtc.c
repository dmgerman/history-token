...
DECL|variable|rtc_max_user_freq
r_static
r_int
r_int
id|rtc_max_user_freq
op_assign
l_int|64
suffix:semicolon
...
macro_line|#endif
multiline_comment|/*&n; * sysctl-tuning infrastructure.&n; */
DECL|variable|rtc_table
r_static
id|ctl_table
id|rtc_table
(braket
...
macro_line|#endif
multiline_comment|/* These limits and adjustments are independant of&n;&t;&t; * whether the chip is in binary mode or not.&n;&t;&t; */
r_if
c_cond
(paren
id|yrs

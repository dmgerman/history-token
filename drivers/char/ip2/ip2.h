...
multiline_comment|/* Do NOT set compile time defaults HERE!  Use the arrays in&n;&t;&t;ip2.c!  These WILL be overwritten!  =mhw= */
l_int|0x0000
comma

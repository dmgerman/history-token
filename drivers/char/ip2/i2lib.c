...
r_else
(brace
multiline_comment|/*&t;&t;The only time we hit this area is when &quot;iiTrySendMail&quot; has&n;&t;&t;failed.  That only occurs when the outbound mailbox is&n;&t;&t;still busy with the last message.  We take a short breather&n;&t;&t;to let the board catch up with itself and then try again.&n;&t;&t;16 Retries is the limit - then we got a borked board.&n;&t;&t;&t;/&bslash;/&bslash;|=mhw=|&bslash;/&bslash;/&t;&t;&t;&t;*/
r_if
c_cond
(paren
op_increment
...
op_amp
(paren
id|pB-&gt;SendPendingTimer
)paren
)paren
suffix:semicolon
id|pB-&gt;SendPendingTimer.expires
op_assign
id|jiffies
op_plus
l_int|1
suffix:semicolon
id|pB-&gt;SendPendingTimer.function
op_assign
(paren
r_void
op_star
...
(paren
id|KERN_ERR
l_string|&quot;IP2: iiSendPendingMail unable to queue outbound mail&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
suffix:semicolon
singleline_comment|// Now we take our interruptible sleep on
singleline_comment|// Clean up the queue
id|set_current_state
c_func
(paren
id|TASK_RUNNING
...
id|flags
suffix:semicolon
multiline_comment|/* This should be atomic because of the way we are called... */
r_if
c_cond
(paren
id|NO_MAIL_HERE

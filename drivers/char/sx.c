...
DECL|macro|NR_SI1_ADDRS
mdefine_line|#define NR_SI1_ADDRS (sizeof(si1_probe_addrs)/sizeof (int))
...
mdefine_line|#define func_enter() sx_dprintk (SX_DEBUG_FLOW, &quot;sx: enter %s&bslash;n&quot;,__FUNCTION__)
...
suffix:semicolon
singleline_comment|// value does not matter
)brace
r_else
(brace
...
suffix:semicolon
singleline_comment|//printk (&quot;%s SETTING port count to zero: %p count: %d&bslash;n&quot;, __FUNCTION__, port, port-&gt;gs.count);
singleline_comment|//port-&gt;gs.count = 0;
)brace
id|func_exit
(paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;sx: couldn&squot;t send break (%x).&bslash;n&quot;
comma
id|read_sx_byte
(paren
id|port-&gt;board
...
id|SX_DEBUG_PROBE
comma
l_string|&quot;Going to verify SI signature hw %lx at %p.&bslash;n&quot;
comma
id|board-&gt;hw_base
comma
id|board-&gt;base
...
multiline_comment|/* Now we&squot;re pretty much convinced that there is an SI board here, &n;&t;   but to prevent trouble, we&squot;d better double check that we don&squot;t&n;&t;   have an SI1 board when we&squot;re probing for an SI2 board.... */
id|write_sx_byte
(paren
id|board
comma
...
(brace
multiline_comment|/* This should be an SI1 board, which has this&n;&t;&t;   location writable... */
r_if
c_cond
(paren
id|read_sx_byte
...
r_else
(brace
multiline_comment|/* This should be an SI2 board, which has the bottom&n;&t;&t;   3 bits non-writable... */
r_if
c_cond
(paren
id|read_sx_byte
...
id|SX_DEBUG_PROBE
comma
l_string|&quot;Got a specialix card: %x/%p(%d) %x.&bslash;n&quot;
comma
id|tint
comma
id|boards
...
id|SX_DEBUG_CLEANUP
comma
l_string|&quot;Cleaning up board at %p&bslash;n&quot;
comma
id|board-&gt;base
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;sx: couldn&squot;t deregister firmware loader devic&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|sx_dprintk

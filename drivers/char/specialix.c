...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;1.11&quot;
...
DECL|macro|dprintk
mdefine_line|#define dprintk(f, str...) if (sx_debug &amp; f) printk (str)
macro_line|#else
DECL|macro|dprintk
mdefine_line|#define dprintk(f, str...) /* nothing */
macro_line|#endif
DECL|macro|SX_DEBUG_FLOW
mdefine_line|#define SX_DEBUG_FLOW    0x0001
DECL|macro|SX_DEBUG_DATA
mdefine_line|#define SX_DEBUG_DATA    0x0002
DECL|macro|SX_DEBUG_PROBE
mdefine_line|#define SX_DEBUG_PROBE   0x0004
DECL|macro|SX_DEBUG_CHAN
mdefine_line|#define SX_DEBUG_CHAN    0x0008
DECL|macro|SX_DEBUG_INIT
mdefine_line|#define SX_DEBUG_INIT    0x0010
DECL|macro|SX_DEBUG_RX
mdefine_line|#define SX_DEBUG_RX      0x0020
DECL|macro|SX_DEBUG_TX
mdefine_line|#define SX_DEBUG_TX      0x0040
DECL|macro|SX_DEBUG_IRQ
mdefine_line|#define SX_DEBUG_IRQ     0x0080
DECL|macro|SX_DEBUG_OPEN
mdefine_line|#define SX_DEBUG_OPEN    0x0100
DECL|macro|SX_DEBUG_TERMIOS
mdefine_line|#define SX_DEBUG_TERMIOS 0x0200
DECL|macro|SX_DEBUG_SIGNALS
mdefine_line|#define SX_DEBUG_SIGNALS 0x0400
DECL|macro|SX_DEBUG_FIFO
mdefine_line|#define SX_DEBUG_FIFO    0x0800
DECL|macro|func_enter
mdefine_line|#define func_enter() dprintk (SX_DEBUG_FLOW, &quot;io8: enter %s&bslash;n&quot;,__FUNCTION__)
DECL|macro|func_exit
mdefine_line|#define func_exit()  dprintk (SX_DEBUG_FLOW, &quot;io8: exit  %s&bslash;n&quot;, __FUNCTION__)
...
id|SX_DEBUG_CHAN
comma
l_string|&quot;port: %d %p flags: 0x%x&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
id|SX_DEBUG_RX
comma
l_string|&quot;Hmm, couldn&squot;t find port.&bslash;n&quot;
)paren
suffix:semicolon
id|func_exit
c_func
...
id|SX_DEBUG_RX
comma
l_string|&quot;port: %p count: %d BUFF_SIZE: %d&bslash;n&quot;
comma
id|port
comma
id|tty-&gt;flip.count
...
id|port-&gt;mark_mask
suffix:semicolon
multiline_comment|/* This flip buffer check needs to be below the reading of the&n;&t;   status register to reset the chip&squot;s IRQ.... */
r_if
c_cond
(paren
id|tty-&gt;flip.count
...
id|SX_DEBUG_RX
comma
l_string|&quot;port: %p: count: %d&bslash;n&quot;
comma
id|port
comma
id|count
...
id|SX_DEBUG_FLOW
comma
l_string|&quot;enter %s port %d room: %ld&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|port_No
...
(paren
id|KERN_ERR
l_string|&quot;sx%d: status: 0x%x Bad receive ack 0x%02x.&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;sx%d: status: 0x%x Bad transmit ack 0x%02x. port: %d&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;sx%d: status: 0x%x Bad modem ack 0x%02x.&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
id|SX_DEBUG_FIFO
comma
l_string|&quot;sx%d: port %d: %ld overruns, FIFO hits [ &quot;
comma
id|board_No
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;sx%d: sx_shutdown_port: bad board count: %d port: %d&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
id|SX_DEBUG_TX
comma
l_string|&quot;check tty: %p %p&bslash;n&quot;
comma
id|tty
comma
id|port-&gt;xmit_buf
...
id|SX_DEBUG_TX
comma
l_string|&quot;xmit_cnt: %d xmit_buf: %p&bslash;n&quot;
comma
id|port-&gt;xmit_cnt
comma
id|port-&gt;xmit_buf
...
id|SX_DEBUG_TX
comma
l_string|&quot;Handle xmit: %p %p&bslash;n&quot;
comma
id|port
comma
id|port-&gt;xmit_buf
...
suffix:semicolon
multiline_comment|/*&t;if (set &amp; TIOCM_RTS)&n;&t;&t;port-&gt;MSVR |= MSVR_RTS; */
multiline_comment|/*   if (set &amp; TIOCM_DTR)&n;&t;&t;port-&gt;MSVR |= MSVR_DTR; */
r_if
c_cond
(paren
id|SX_CRTSCTS
...
multiline_comment|/*&t;if (clear &amp; TIOCM_RTS)&n;&t;&t;port-&gt;MSVR &amp;= ~MSVR_RTS; */
multiline_comment|/*    if (clear &amp; TIOCM_DTR)&n;&t;&t;port-&gt;MSVR &amp;= ~MSVR_DTR; */
r_if
c_cond
(paren
id|SX_CRTSCTS
...
suffix:semicolon
multiline_comment|/*&n;&t;error = verify_area(VERIFY_READ, (void *) newinfo, sizeof(tmp));&n;&t;if (error) {&n;&t;&t;func_exit();&n;&t;&t;return error;&n;&t;}&n;&t;*/
r_if
c_cond
(paren
id|copy_from_user
...
suffix:semicolon
singleline_comment|//&t;int error;
id|func_enter
c_func
(paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;error = verify_area(VERIFY_WRITE, (void *) retinfo, sizeof(tmp));&n;&t;if (error)&n;&t;&t;return error;&n;&t;*/
id|memset
c_func
(paren
op_amp
...
multiline_comment|/*&n; * This routine is called from the work-queue when the interrupt&n; * routine has signalled that a hangup has occurred.  The path of&n; * hangup processing is:&n; *&n; * &t;serial interrupt routine -&gt; (workqueue) -&gt;&n; * &t;do_sx_hangup() -&gt; tty-&gt;hangup() -&gt; sx_hangup()&n; * &n; */
...
(paren
id|KERN_ERR
l_string|&quot;sx%d: sx_hangup: bad board count: %d port: %d&bslash;n&quot;
comma
id|board_No
c_func
(paren
...
suffix:semicolon
singleline_comment|//wake_up_interruptible(&amp;tty-&gt;write_wait);
)brace
id|func_exit
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;sx: Couldn&squot;t allocate tty_driver.&bslash;n&quot;
)paren
suffix:semicolon
id|func_exit
c_func
...
suffix:semicolon
multiline_comment|/* Init de the semaphore - pvdl */
r_if
c_cond
(paren
id|iobase

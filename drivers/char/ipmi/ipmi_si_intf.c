...
suffix:semicolon
multiline_comment|/* Slave address, could be reported from DMI. */
...
id|slave_addrs
comma
l_string|&quot;Set the default IPMB slave address for&quot;
l_string|&quot; the controller.  Normally this is 0x20, but can be&quot;
l_string|&quot; overridden by this parm.  This is an array indexed&quot;
l_string|&quot; by interface number.&quot;
)paren
suffix:semicolon
...
macro_line|#if defined(CONFIG_ACPI_INTERPRETER) || defined(CONFIG_X86) || defined(CONFIG_PCI)
...
suffix:semicolon
DECL|variable|dmi_data_entries
r_static
r_int
id|dmi_data_entries
suffix:semicolon
...
multiline_comment|/* If bit 4 of byte 0x10 is set, then the lsb for the address&n;&t;&t;   is odd. */
...
r_default
suffix:colon
multiline_comment|/* Some other interface, just ignore it. */
r_return
op_minus
id|EIO
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Old DMI spec. */
id|ipmi_data-&gt;base_addr
op_assign
id|base_addr
suffix:semicolon
...
l_string|&quot; address 0x%lx, slave address 0x%x&bslash;n&quot;
comma
id|io_type
comma
(paren

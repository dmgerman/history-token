...
mdefine_line|#define IPMI_KCS_VERSION &quot;v33&quot;
...
suffix:semicolon
multiline_comment|/* Reserve 2 I/O bytes. */
r_return
l_int|2
suffix:semicolon
)brace
...
DECL|variable|kcs_smi_handlers
r_struct
id|si_sm_handlers
id|kcs_smi_handlers
op_assign

...
mdefine_line|#define IPMI_DEVINTF_VERSION &quot;v33&quot;
...
id|recv_sem
suffix:semicolon
DECL|member|default_retries
r_int
id|default_retries
suffix:semicolon
DECL|member|default_retry_time_ms
r_int
r_int
id|default_retry_time_ms
suffix:semicolon
)brace
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Use the low-level defaults. */
id|priv-&gt;default_retries
op_assign
op_minus
l_int|1
suffix:semicolon
id|priv-&gt;default_retry_time_ms
op_assign
l_int|0
suffix:semicolon
r_return
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* From here out we cannot return, we must jump to &quot;out&quot; for&n;&t;   error exits to free msgdata. */
id|rv
op_assign
...
r_case
id|IPMICTL_SEND_COMMAND_SETTIME
suffix:colon
(brace
r_struct
id|ipmi_req_settime
...
r_case
id|IPMICTL_SET_TIMING_PARMS_CMD
suffix:colon
(brace
r_struct
...
r_case
id|IPMICTL_GET_TIMING_PARMS_CMD
suffix:colon
(brace
r_struct
id|ipmi_timing_parms
...
id|ipmi_major
comma
l_string|&quot;Sets the major number of the IPMI device.  By&quot;
l_string|&quot; default, or if you set it to zero, it will choose the next&quot;
l_string|&quot; available device.  Setting it to -1 will disable the&quot;
l_string|&quot; interface.  Other values will set the major device number&quot;
l_string|&quot; to that value.&quot;
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ipmi device interface version &quot;
id|IPMI_DEVINTF_VERSION
l_string|&quot;&bslash;n&quot;
)paren
suffix:semicolon
id|rv
...
(paren
id|KERN_WARNING
l_string|&quot;ipmi: can&squot;t register smi watcher&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|rv

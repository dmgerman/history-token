...
mdefine_line|#define REGION_SIZE 8   /* size of io region to request */
...
multiline_comment|/* Caller must hold info-&gt;lock */
...
multiline_comment|/*&n; * ---------------------------------------------------------------&n; * Low level utility subroutines for the serial driver:  routines to&n; * figure out the appropriate timeout for an interrupt chain, routines&n; * to initialize and startup a serial port, and routines to shutdown a&n; * serial port.  Useful stuff like that.&n; *&n; * Caller should hold lock&n; * ---------------------------------------------------------------&n; */
...
multiline_comment|/* DMA lock is higher priority always */
r_if
c_cond
(paren
id|info-&gt;stat_flags
...
suffix:semicolon
multiline_comment|/* FIXME - new style wait needed here */
...
(brace
multiline_comment|/* FIXME: convert to new style wakeup */
id|interruptible_sleep_on
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;esp_open %s, count = %d&bslash;n&quot;
comma
id|tty-&gt;name
comma
id|info-&gt;count
...
c_func
(paren
l_string|&quot;esp_open %s successful...&quot;
comma
id|tty-&gt;name
)paren
suffix:semicolon

...
(brace
multiline_comment|/*&n;&t;&t; * For now we set static_rate to 0.  This is not&n;&t;&t; * really correct: we should look at the rate&n;&t;&t; * component of the path member record, compare it&n;&t;&t; * with the rate of our local port (calculated from&n;&t;&t; * the active link speed and link width) and set an&n;&t;&t; * inter-packet delay appropriately.&n;&t;&t; */
r_struct
id|ib_ah_attr
id|av
op_assign

...
(brace
multiline_comment|/*&n;&t;&t; * It&squot;s safe to call ipoib_put_ah() inside priv-&gt;lock&n;&t;&t; * here, because we know that path-&gt;ah will always&n;&t;&t; * hold one more reference, so ipoib_put_ah() will&n;&t;&t; * never do more than decrement the ref count.&n;&t;&t; */
r_if
c_cond
(paren
id|neigh-&gt;ah

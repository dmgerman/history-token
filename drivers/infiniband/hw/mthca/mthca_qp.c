...
l_int|2
comma
DECL|enumerator|MTHCA_QP_OPTPAR_REW
id|MTHCA_QP_OPTPAR_REW
op_assign
l_int|1
op_lshift
l_int|3
...
multiline_comment|/* leave sched_queue as 0 */
r_if
c_cond
(paren
id|qp-&gt;transport
...
multiline_comment|/* XXX initiator resources */
r_if
c_cond
(paren
id|attr_mask
...
suffix:semicolon
multiline_comment|/* XXX RDMA/atomic enable, responder resources */
r_if
c_cond
(paren
id|qp-&gt;rq.policy
...
suffix:semicolon
multiline_comment|/* XXX ra_buff_indx */
...
id|dev
comma
l_string|&quot;SQ full (%d posted, %d max, %d nreq)&bslash;n&quot;
comma
id|qp-&gt;sq.cur
comma
id|qp-&gt;sq.max
...
DECL|function|mthca_post_receive
r_int

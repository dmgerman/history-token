...
DECL|macro|MTHCA_TAVOR_CQ_DB_INC_CI
mdefine_line|#define MTHCA_TAVOR_CQ_DB_INC_CI       (1 &lt;&lt; 24)
DECL|macro|MTHCA_TAVOR_CQ_DB_REQ_NOT
mdefine_line|#define MTHCA_TAVOR_CQ_DB_REQ_NOT      (2 &lt;&lt; 24)
DECL|macro|MTHCA_TAVOR_CQ_DB_REQ_NOT_SOL
mdefine_line|#define MTHCA_TAVOR_CQ_DB_REQ_NOT_SOL  (3 &lt;&lt; 24)
DECL|macro|MTHCA_TAVOR_CQ_DB_SET_CI
mdefine_line|#define MTHCA_TAVOR_CQ_DB_SET_CI       (4 &lt;&lt; 24)
DECL|macro|MTHCA_TAVOR_CQ_DB_REQ_NOT_MULT
mdefine_line|#define MTHCA_TAVOR_CQ_DB_REQ_NOT_MULT (5 &lt;&lt; 24)
DECL|macro|MTHCA_ARBEL_CQ_DB_REQ_NOT_SOL
mdefine_line|#define MTHCA_ARBEL_CQ_DB_REQ_NOT_SOL  (1 &lt;&lt; 24)
DECL|macro|MTHCA_ARBEL_CQ_DB_REQ_NOT
mdefine_line|#define MTHCA_ARBEL_CQ_DB_REQ_NOT      (2 &lt;&lt; 24)
DECL|macro|MTHCA_ARBEL_CQ_DB_REQ_NOT_MULT
mdefine_line|#define MTHCA_ARBEL_CQ_DB_REQ_NOT_MULT (3 &lt;&lt; 24)
...
multiline_comment|/*&n; * incr is ignored in native Arbel (mem-free) mode, so cq-&gt;cons_index&n; * should be correct before calling update_cons_index().&n; */
DECL|function|update_cons_index
r_static
r_inline
r_void
id|update_cons_index
c_func
(paren
r_struct
id|mthca_dev
...
multiline_comment|/*&n;&t;&t; * We do not have to take the QP table lock here,&n;&t;&t; * because CQs will be locked while QPs are removed&n;&t;&t; * from the table.&n;&t;&t; */
op_star
id|cur_qp
op_assign
id|mthca_array_get
...
DECL|function|mthca_tavor_arm_cq
r_int
...
ques
c_cond
id|MTHCA_TAVOR_CQ_DB_REQ_NOT_SOL
suffix:colon
id|MTHCA_TAVOR_CQ_DB_REQ_NOT
)paren
op_or
id|to_mcq
c_func
...
DECL|function|mthca_arbel_arm_cq
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * Make sure that the doorbell record in host memory is&n;&t; * written before ringing the doorbell via PCI MMIO.&n;&t; */
id|wmb
c_func
(paren
)paren
...
ques
c_cond
id|MTHCA_ARBEL_CQ_DB_REQ_NOT_SOL
suffix:colon
id|MTHCA_ARBEL_CQ_DB_REQ_NOT
)paren
op_or
id|cq-&gt;cqn
)paren
...
DECL|function|mthca_free_cq_buf
r_static
r_void
id|mthca_free_cq_buf
c_func
(paren
r_struct
id|mthca_dev
...
DECL|function|mthca_alloc_cq_buf
r_static
r_int
id|mthca_alloc_cq_buf
c_func
(paren
r_struct
id|mthca_dev

...
mdefine_line|#define MAD_IFC_BOX_SIZE      0x400
DECL|macro|MAD_IFC_MY_QPN_OFFSET
mdefine_line|#define MAD_IFC_MY_QPN_OFFSET 0x100
DECL|macro|MAD_IFC_RQPN_OFFSET
mdefine_line|#define MAD_IFC_RQPN_OFFSET   0x104
DECL|macro|MAD_IFC_SL_OFFSET
mdefine_line|#define MAD_IFC_SL_OFFSET     0x108
DECL|macro|MAD_IFC_G_PATH_OFFSET
mdefine_line|#define MAD_IFC_G_PATH_OFFSET 0x109
DECL|macro|MAD_IFC_RLID_OFFSET
mdefine_line|#define MAD_IFC_RLID_OFFSET   0x10a
DECL|macro|MAD_IFC_PKEY_OFFSET
mdefine_line|#define MAD_IFC_PKEY_OFFSET   0x10e
DECL|macro|MAD_IFC_GRH_OFFSET
mdefine_line|#define MAD_IFC_GRH_OFFSET    0x140
id|box
op_assign
id|pci_alloc_consistent
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; * Key check traps can&squot;t be generated unless we have in_wc to&n;&t; * tell us where to send the trap.&n;&t; */
r_if
c_cond
(paren
id|ignore_mkey
...
id|val
comma
id|MAD_IFC_SL_OFFSET
)paren
suffix:semicolon
id|val
op_assign
id|in_wc-&gt;dlid_path_bits
op_or
(paren
id|in_wc-&gt;wc_flags
op_amp

...
suffix:semicolon
multiline_comment|/* IB_DEVICE_RESIZE_MAX_WR not supported by driver.&n;&t;   May be doable since hardware supports it for SRQ.&n;&n;&t;   IB_DEVICE_N_NOTIFY_CQ is supported by hardware but not by driver.&n;&n;&t;   IB_DEVICE_SRQ_RESIZE is supported by hardware but SRQ is not&n;&t;   supported by driver. */
id|mdev-&gt;device_cap_flags
op_assign
...
multiline_comment|/*&n;&t; * It&squot;s not strictly required, but for simplicity just map the&n;&t; * whole multicast group table now.  The table isn&squot;t very big&n;&t; * and it&squot;s a lot easier than trying to track ref counts.&n;&t; */
id|mdev-&gt;mcg_table.table
op_assign
id|mthca_alloc_icm_table
c_func
(paren
...
comma
id|mdev-&gt;limits.num_mgms
op_plus
id|mdev-&gt;limits.num_amgms
comma
id|mdev-&gt;limits.num_mgms
op_plus
id|mdev-&gt;limits.num_amgms
...
id|mdev
comma
l_string|&quot;Failed to map MCG context memory, aborting.&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
l_string|&quot;user access region table, aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|err
...
id|dev
comma
l_string|&quot;Failed to allocate driver access region, &quot;
l_string|&quot;aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_uar_table_free
suffix:semicolon
)brace
id|dev-&gt;kar
op_assign
...
id|err
suffix:semicolon
multiline_comment|/*&n;&t; * We can&squot;t just use pci_request_regions() because the MSI-X&n;&t; * table is right in the middle of the first BAR.  If we did&n;&t; * pci_request_region and grab all of the first BAR, then&n;&t; * setting up MSI-X would fail, since the PCI core wants to do&n;&t; * request_mem_region on the MSI-X vector table.&n;&t; *&n;&t; * So just request what we need right now, and request any&n;&t; * other regions we need when setting up EQs.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|mdev
comma
l_string|&quot;Warning: native MT25208 mode support is incomplete.  &quot;
l_string|&quot;Your HCA may not work properly.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond

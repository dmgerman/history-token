...
id|cur_order
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We allocate with GFP_HIGHUSER because only the&n;&t;&t; * firmware is going to touch these pages, so there&squot;s&n;&t;&t; * no need for a kernel virtual address.  We use&n;&t;&t; * __GFP_NOWARN because we&squot;ll deal with any allocation&n;&t;&t; * failures ourselves.&n;&t;&t; */
id|mdev-&gt;fw.arbel.mem
(braket
id|num_ent
)braket

...
comma
DECL|enumerator|IB_DEVICE_RQ_SIG_TYPE
id|IB_DEVICE_RQ_SIG_TYPE
op_assign
(paren
l_int|1
op_lshift
...
comma
DECL|enumerator|IB_PORT_PORT_NOTICE_SUP
id|IB_PORT_PORT_NOTICE_SUP
op_assign
(paren
l_int|1
op_lshift
...
suffix:semicolon
DECL|enum|ib_recv_flags
r_enum
id|ib_recv_flags
(brace
DECL|enumerator|IB_RECV_SIGNALED
id|IB_RECV_SIGNALED
op_assign
l_int|1
)brace

multiline_comment|/* $Id: uctrl.c,v 1.10 2001/02/13 01:17:00 davem Exp $&n; * uctrl.c: TS102 Microcontroller interface on Tadpole Sparcbook 3&n; *&n; * Copyright 1999 Derrick J Brashear (shadow@dementia.org)&n; */

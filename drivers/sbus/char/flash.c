multiline_comment|/* $Id: flash.c,v 1.24 2001/10/08 22:19:51 davem Exp $&n; * flash.c: Allow mmap access to the OBP Flash, for OBP updates.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; */

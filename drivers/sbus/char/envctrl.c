...
DECL|macro|PCF8584_DATA
mdefine_line|#define PCF8584_DATA&t;0x00
DECL|macro|PCF8584_CSR
mdefine_line|#define PCF8584_CSR&t;0x01
...
c_func
(paren
l_string|&quot;envctrl: Failed to allocate table.&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
DECL|function|envctrl_do_shutdown
r_static
r_void
id|envctrl_do_shutdown
c_func
(paren
r_void
)paren
...
(paren
id|KERN_CRIT
l_string|&quot;kenvctrld: WARNING: Shutting down the system now.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_CRIT
l_string|&quot;kenvctrld: WARNING: system shutdown failed!&bslash;n&quot;
)paren
suffix:semicolon
id|inprog
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* unlikely to succeed, but we could try again */
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;envctrl: kenvctrld unable to monitor CPU temp-- exiting&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|HZ
suffix:semicolon
multiline_comment|/* TODO env_mon_interval */
id|daemonize
c_func
(paren
l_string|&quot;kenvctrld&quot;
...
(paren
id|KERN_INFO
l_string|&quot;envctrl: %s starting...&bslash;n&quot;
comma
id|current-&gt;comm
)paren
suffix:semicolon
...
(paren
id|KERN_CRIT
l_string|&quot;%s: WARNING: CPU%i temperature %i C meets or exceeds &quot;
"&bslash;"
l_string|&quot;shutdown threshold %i C&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|whichcpu
...
(paren
id|KERN_INFO
l_string|&quot;envctrl: %s exiting...&bslash;n&quot;
comma
id|current-&gt;comm
)paren
suffix:semicolon

multiline_comment|/* $Id: sunserial.c,v 1.81 2002/01/05 01:13:43 davem Exp $&n; * serial.c: Serial port driver infrastructure for the Sparc.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; */

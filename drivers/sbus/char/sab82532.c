...
DECL|macro|SERIAL_DEBUG_FIFO
macro_line|#undef SERIAL_DEBUG_FIFO
...
multiline_comment|/*&n; * This is used to figure out the divisor speeds.&n; *&n; * The formula is:    Baud = BASE_BAUD / ((N + 1) * (1 &lt;&lt; M)),&n; *&n; * with               0 &lt;= N &lt; 64 and 0 &lt;= M &lt; 16&n; * &n; * 12-Oct-2001 - Replaced table driven approach with code written by&n; * Theodore Ts&squot;o &lt;tytso@alum.mit.edu&gt; which exactly replicates the&n; * table.  (Modulo bugs for the 307200 and 61440 baud rates, which&n; * were clearly incorrectly calculated in the original table.  This is&n; * why tables filled with magic constants are evil.)&n; */
...
(brace
macro_line|#ifdef SERIAL_DEBUG_FIFO
id|printk
c_func
(paren
...
l_string|&quot;xmit_cnt = %ld, alls = %d (jiff=%lu)...&bslash;n&quot;
comma
id|timeout
comma
id|char_time
...
c_func
(paren
l_string|&quot;xmit_cnt = %ld, alls = %d (jiff=%lu)...done&bslash;n&quot;
comma
id|CIRC_CNT
c_func
(paren
...
id|con-&gt;cflag
suffix:semicolon
multiline_comment|/*&n;&t; * Fake up the tty and tty-&gt;termios structures so we can use&n;&t; * change_speed (and eliminate a lot of duplicate code).&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Now take out the pointers to static structures if necessary */
r_if
c_cond
(paren
id|info-&gt;tty-&gt;termios

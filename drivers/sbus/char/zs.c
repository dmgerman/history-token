multiline_comment|/* $Id: zs.c,v 1.71 2002/01/12 07:04:54 davem Exp $&n; * zs.c: Zilog serial port driver for the Sparc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996 Eddie C. Dost   (ecd@skynet.be)&n; * Fixes by Pete A. Zaitcev &lt;zaitcev@yahoo.com&gt;.&n; *&n; * Fixed to use tty_get_baud_rate().&n; *   Theodore Ts&squot;o &lt;tytso@mit.edu&gt;, 2001-Oct-12&n; *&n; * /proc/tty/driver/serial now exists and is readable.&n; *   Alex Buell &lt;alex.buell@tahallah.demon.co.uk&gt;, 2001-12-23&n; *&n; */
...
multiline_comment|/*&n; *&n; * line_info - returns information about each channel&n; *&n; */
...
id|buf
comma
l_string|&quot;%d: uart:Zilog8530 port:%x irq:%d&quot;
comma
id|info-&gt;line
comma
id|info-&gt;port
...
multiline_comment|/*&n; *&n; * zs_read_proc() - called when /proc/tty/driver/serial is read.&n; *&n; */
DECL|function|zs_read_proc
r_int
id|zs_read_proc
c_func
(paren
...
multiline_comment|/* I just did. :-) -AIB 2001-12-23 */

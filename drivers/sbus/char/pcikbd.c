multiline_comment|/* $Id: pcikbd.c,v 1.61 2001/08/18 09:40:46 davem Exp $&n; * pcikbd.c: Ultra/AX PC keyboard support.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; * JavaStation support by Pete A. Zaitcev.&n; *&n; * This code is mainly put together from various places in&n; * drivers/char, please refer to these sources for credits&n; * to the original authors.&n; */
...
macro_line|#if defined(CONFIG_USB) &amp;&amp; defined(CONFIG_SPARC64)
...
mdefine_line|#define DEFAULT_KEYB_REP_DELAY&t;250
...
DECL|function|pcikbd_enter_prom
r_static
r_void
id|pcikbd_enter_prom
c_func
(paren
r_void
)paren
...
c_func
(paren
l_string|&quot;Prom Enter: Disable keyboard: no ACK&bslash;n&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/* Disable PC scancode translation */
id|pcikbd_write
c_func
(paren
id|KBD_CNTL_REG
...
multiline_comment|/* Save current mode register settings */
id|pcikbd_write
c_func
(paren
id|KBD_CNTL_REG
...
c_func
(paren
l_string|&quot;Prom Enter: Read Mode: no ACK&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* Disable PC scancode translation */
id|pcikbd_write
...
suffix:semicolon
multiline_comment|/* Drop into OBP.&n;&t; * Note that we must flush the user windows&n;&t; * first before giving up control.&n;&t; */
...
suffix:semicolon
multiline_comment|/* Read prom&squot;s key up event (use short timeout) */
r_do
(brace
id|timeout
op_assign
...
suffix:semicolon
multiline_comment|/* Reenable PC scancode translation */
id|pcikbd_write
c_func
(paren
id|KBD_DATA_REG
...
c_func
(paren
l_string|&quot;Prom Leave: Disable keyboard: no ACK&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|pcikbd_write
...
l_int|0
suffix:semicolon
multiline_comment|/* Handle ctrl-break event */
id|ctrl_break
c_func
(paren
)paren
suffix:semicolon
multiline_comment|/* Send ctrl up event to the keyboard driver */
op_star
id|keycode
op_assign
l_int|0x1d
...
multiline_comment|/* We are being called for the sake of USB keyboard&n;&t;&t; * state initialization.  So we should check for beeper&n;&t;&t; * device in this case.&n;&t;&t; */
id|edev
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;8042(speaker): iobase[%016lx]&bslash;n&quot;
comma
id|pcibeep_iobase
)paren
suffix:semicolon
...
multiline_comment|/* Maybe we have one inside the ALI southbridge? */
(brace
r_struct
id|isa_bridge
op_star
...
(brace
multiline_comment|/* This is a hack, the &squot;dma&squot; device node has&n;&t;&t;&t;&t;&t; * the base of the I/O port space for that PBM&n;&t;&t;&t;&t;&t; * as it&squot;s resource, so we use that. -DaveM&n;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;isa(speaker): iobase[%016lx:%016lx]&bslash;n&quot;
comma
id|pcibeep_iobase
op_plus
l_int|0x42
...
macro_line|#endif
multiline_comment|/* No beeper found, ok complain. */
macro_line|#endif
id|printk
c_func
(paren

...
mdefine_line|#define DRV_VERSION&t;&quot;1.07+LK1.0.8&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&quot;Aug 07, 2001&quot;
...
suffix:semicolon
multiline_comment|/* Bits in WOLCmd register. */
DECL|enum|wol_bits
r_enum
id|wol_bits
(brace
...
id|aneg_bits
(brace
DECL|enumerator|Aneg10BaseT
DECL|enumerator|Aneg10BaseTFull
id|Aneg10BaseT
op_assign
l_int|0x20
comma
...
l_int|0x40
comma
DECL|enumerator|Aneg100BaseT
DECL|enumerator|Aneg100BaseTFull
id|Aneg100BaseT
op_assign
l_int|0x80
comma
...
id|bmcr_bits
(brace
DECL|enumerator|BMCRDuplex
DECL|enumerator|BMCRAnegRestart
DECL|enumerator|BMCRAnegEnable
id|BMCRDuplex
op_assign
l_int|0x100
comma
...
l_int|0x1000
comma
DECL|enumerator|BMCRSpeed
DECL|enumerator|BMCRPhyReset
id|BMCRSpeed
op_assign
l_int|0x2000
comma
...
suffix:semicolon
multiline_comment|/* should we burn these into the EEPROM? */
r_return
l_int|0
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* should we burn this into the EEPROM? */
r_return
l_int|0
suffix:semicolon
)brace
...
multiline_comment|/* Only shut down chip if wake on lan is not set */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* spec says write 0 here */
id|writel
c_func
(paren
l_int|0
...
suffix:semicolon
multiline_comment|/* allow wake-event interrupts now */
id|writel
c_func
(paren
id|readl
...
(brace
multiline_comment|/* make sure to enable PME */
id|clkrun
op_or_assign
l_int|0x100
suffix:semicolon

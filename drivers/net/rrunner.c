...
c_func
(paren
l_string|&quot;Jes Sorensen &lt;jes@wildopensource.com&gt;&quot;
)paren
suffix:semicolon
...
l_string|&quot;RoadRunner will be disabled.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t; * Don&squot;t access any register before this point!&n;&t; */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t; * Need to add a case for little-endian 64-bit hosts here.&n;&t; */
id|rr_init
c_func
(paren
id|dev
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Data checksum error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unexpected short burst &quot;
l_string|&quot;error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Recv. state transition&quot;
l_string|&quot; error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unexpected data error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Link lost error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Framming Error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Flag sync. lost during&quot;
...
id|drop
suffix:colon
multiline_comment|/* Label packet to be dropped.&n;&t;&t;&t; * Actual dropping occurs in rx&n;&t;&t;&t; * handling.&n;&t;&t;&t; *&n;&t;&t;&t; * The index of packet we get to drop is&n;&t;&t;&t; * the index of the packet following&n;&t;&t;&t; * the bad packet. -kbf&n;&t;&t;&t; */
(brace
id|u16
id|index
op_assign
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t; * Order here is important.  We must handle events&n;&t; * before doing anything else in order to catch&n;&t; * such things as LLRC errors, etc -kbf&n;&t; */
id|eidx
op_assign
id|rrpriv-&gt;info-&gt;evt_ctrl.pi
suffix:semicolon
...
r_do
(brace
multiline_comment|/* Due to occational firmware TX producer/consumer out&n;&t;&t;&t; * of sync. error need to check entry in ring -kbf&n;&t;&t;&t; */
r_if
c_cond
(paren
id|rrpriv-&gt;tx_skbuff
...
id|rrpriv-&gt;regs
suffix:semicolon
multiline_comment|/*&n;&t; * Lock to make sure we are not cleaning up while another CPU&n;&t; * is handling interrupts.&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
DECL|function|rr_cleanup_module
r_static
r_void
id|__exit
id|rr_cleanup_module
c_func
(paren
r_void
)paren
...
suffix:semicolon
DECL|variable|rr_cleanup_module
id|module_exit
c_func
(paren
id|rr_cleanup_module

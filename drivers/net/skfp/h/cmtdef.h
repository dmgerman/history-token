...
macro_line|#include &quot;h/smtstate.h&quot;&t;/* struct smt_state */
r_void
id|hwt_restart
c_func
(paren
...
suffix:semicolon
macro_line|#if defined(DEBUG) || !defined(NO_SMT_PANIC)
r_void
id|smt_panic
c_func
(paren
...
macro_line|#endif /* DEBUG || !NO_SMT_PANIC */
r_void
id|smt_stat_counter
c_func
(paren
...
mdefine_line|#define smt_init_evc(smc)
DECL|macro|smt_srf_event
mdefine_line|#define smt_srf_event(smc,code,index,cond)
macro_line|#endif

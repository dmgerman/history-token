...
multiline_comment|/* u_long td;&t;&t; transmit descriptor */
multiline_comment|/* struct fddi_mac *mac; mac frame pointer */
multiline_comment|/* unsigned off;&t; start address within buffer memory */
multiline_comment|/* int len ;&t;&t; lenght of the frame including the FC */
(brace
r_int
id|i
suffix:semicolon
...
multiline_comment|/* u_short queue; 0 = synchronous queue, 1 = asynchronous queue 0 */
(brace
id|u_short
id|imask
suffix:semicolon

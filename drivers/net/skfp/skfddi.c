...
(paren
id|KERN_INFO
l_string|&quot;entering skfp_init_one&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;skfp: region is not an MMIO resource&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;skfp: region is not PIO resource&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;skfp: Unable to allocate fddi device, &quot;
...
multiline_comment|/*&n; * Called for each adapter board from pci_unregister_driver&n; */
DECL|function|skfp_remove_one
r_static
r_void
id|__devexit
id|skfp_remove_one
...
DECL|variable|skfddi_pci_driver
r_static
r_struct
id|pci_driver
id|skfddi_pci_driver
op_assign
(brace
dot
id|name

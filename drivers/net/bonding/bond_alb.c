...
op_minus
multiline_comment|/* Convert to Megabit per sec */
(paren
id|s64
)paren
(paren
...
suffix:semicolon
multiline_comment|/* Bytes to bits */
...
id|KERN_ERR
id|DRV_NAME
l_string|&quot;: Error: failed to create an ARP packet&bslash;n&quot;
)paren
suffix:semicolon
r_continue
suffix:semicolon
...
multiline_comment|/* save net_device&squot;s current hw address */
id|memcpy
c_func
(paren
id|tmp_addr
...
suffix:semicolon
multiline_comment|/* restore net_device&squot;s hw address */
id|memcpy
c_func
(paren
id|slave-&gt;dev-&gt;dev_addr
...
(brace
multiline_comment|/* inform clients mac address has changed */
id|rlb_req_update_slave_clients
c_func
(paren
id|bond

...
mdefine_line|#define DRV_VERSION&t;&quot;2.4.0&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&quot;August 7, 2003&quot;
DECL|macro|DRV_NAME
...
r_default
suffix:colon
multiline_comment|/* A master that is also a slave ? */
r_break
suffix:semicolon
)brace
r_return
...
multiline_comment|/* Future:&n;&t; * If anything fails beyond this point&n;&t; * make sure to destroy the proc entry&n;&t; */
id|list_add_tail
c_func
(paren
op_amp
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;err_out:&n;&t;bond_destroy_proc_info(bond);&n;&t;return err;&n;*/
)brace

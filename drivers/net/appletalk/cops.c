...
id|version
op_assign
l_string|&quot;cops.c:v0.04 6/7/98 Jay Schulist &lt;jschlst@samba.org&gt;&bslash;n&quot;
suffix:semicolon
...
r_else
(brace
multiline_comment|/* FIXME  Does this really work for cards which generate irq?&n;&t;&t; * It&squot;s definitely N.G. for polled Tangent. sh&n;&t;&t; * Dayna cards don&squot;t autoprobe well at all, but if your card is&n;&t;&t; * at IRQ 5 &amp; IO 0x240 we find it every time. ;) JS&n;&t;&t; */
r_for
c_loop
(paren
id|port
...
r_break
suffix:semicolon
multiline_comment|/* No IRQ found on this port, fallthrough */
r_case
l_int|1
suffix:colon
id|retval

...
suffix:semicolon
multiline_comment|/* Save off the current value of register 0x2F5B to be restored at&n;         * the end of this routine. */
id|ret_val
op_assign
...
suffix:semicolon
multiline_comment|/* Disabled the PHY transmitter */
...
suffix:semicolon
multiline_comment|/* Now enable the transmitter */
id|e1000_write_phy_reg
c_func
(paren
id|hw
...
suffix:semicolon
multiline_comment|/* Force MDI for earlier revs of the IGP PHY */
id|phy_data
op_and_assign
op_complement
(paren
...
(brace
multiline_comment|/* Save off the current value of register 0x2F5B to be restored at&n;             * the end of the routines. */
id|ret_val
op_assign
id|e1000_read_phy_reg
c_func
...
multiline_comment|/* Disable the PHY transmitter */
id|ret_val
op_assign
id|e1000_write_phy_reg
c_func

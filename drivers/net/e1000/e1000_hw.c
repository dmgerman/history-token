...
multiline_comment|/******************************************************************************&n; * Verifies the hardware needs to allow ARPs to be processed by the host&n; *&n; * hw - Struct containing variables accessed by shared code&n; *&n; * returns: - TRUE/FALSE&n; *&n; *****************************************************************************/
r_uint32
DECL|function|e1000_enable_mng_pass_thru
...
id|manc
op_amp
id|E1000_MANC_EN_MAC_ADDR_FILTER
)paren
)paren
r_return
id|FALSE

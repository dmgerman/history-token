...
r_static
r_void
DECL|function|e1000_clock_eeprom
id|e1000_clock_eeprom
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|e1000_cleanup_eeprom
id|e1000_cleanup_eeprom
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/* Send the 9-bit (or 11-bit on large EEPROM) EWEN (write enable) command&n;     * to the EEPROM (5-bit opcode plus 4/6-bit dummy). This puts the EEPROM&n;     * into write/erase mode. &n;     */
id|e1000_shift_out_ee_bits
c_func
(paren
id|hw
...
suffix:semicolon
multiline_comment|/* Send the 9-bit (or 11-bit on large EEPROM) EWDS (write disable) command&n;     * to the EEPROM (5-bit opcode plus 4/6-bit dummy). This takes the EEPROM&n;     * out of write/erase mode.&n;     */
id|e1000_shift_out_ee_bits
c_func
(paren
id|hw

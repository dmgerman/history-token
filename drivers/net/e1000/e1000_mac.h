...
multiline_comment|/* e1000_mac.h&n; * Structures, enums, and macros for the MAC&n; */
macro_line|#ifndef _E1000_MAC_H_
DECL|macro|_E1000_MAC_H_
mdefine_line|#define _E1000_MAC_H_
...
suffix:semicolon
multiline_comment|/* Link layer setup functions */
id|boolean_t
...
mdefine_line|#define NUM_DEV_IDS 7
...
mdefine_line|#define MAXIMUM_ETHERNET_PACKET_SIZE 1514 /* Without FCS */
DECL|macro|MINIMUM_ETHERNET_PACKET_SIZE
mdefine_line|#define MINIMUM_ETHERNET_PACKET_SIZE 60   /* Without FCS */
DECL|macro|CRC_LENGTH
mdefine_line|#define CRC_LENGTH                   4
...
DECL|struct|e1000_shared_stats
r_struct
id|e1000_shared_stats
(brace
DECL|member|crcerrs
...
suffix:semicolon
multiline_comment|/* Structure containing variables used by the shared code (e1000_mac.c and &n; * e1000_phy.c)&n; */
DECL|struct|e1000_shared_adapter
r_struct
id|e1000_shared_adapter
(brace
DECL|member|hw_addr
...
mdefine_line|#define E1000_FDX_COLLISION_DISTANCE    64
DECL|macro|E1000_HDX_COLLISION_DISTANCE
mdefine_line|#define E1000_HDX_COLLISION_DISTANCE    64
...
multiline_comment|/* TBI_ACCEPT macro definition:&n; *&n; * If Tbi Compatibility mode is turned-on, then we should accept frames with&n; * receive errors if and only if:&n; *      1) errors is equal to the CRC error bit.&n; *      2) The last byte is a Carrier extension (0x0F).&n; *      3) The frame length (as reported by Hardware) is greater than 64 (60&n; *         if a VLAN tag was stripped from the frame.&n; *      4) &quot;    &quot;     &quot;      &quot;   &quot;       &quot;   &quot;        &lt;= max_frame_size+1.&n; *&n; * This macro requires:&n; *      adapter = a pointer to struct e1000_shared_adapter &n; *      special = the 16 bit special field of the RX descriptor with EOP set&n; *      error = the 8 bit error field of the RX descriptor with EOP set&n; *      length = the sum of all the length fields of the RX descriptors that&n; *               make up the current frame&n; *      last_byte = the last byte of the frame DMAed by the hardware&n; *      max_frame_length = the maximum frame length we want to accept.&n; *      min_frame_length = the minimum frame length we want to accept.&n; *&n; * This macro is a conditional that should be used in the interrupt &n; * handler&squot;s Rx processing routine when RxErrors have been detected.&n; *&n; * Typical use:&n; *  ...&n; *  if (TBI_ACCEPT) {&n; *      accept_frame = TRUE;&n; *      e1000_tbi_adjust_stats(adapter, MacAddress);&n; *      frame_length--;&n; *  } else {&n; *      accept_frame = FALSE;&n; *  }&n; *  ...&n; */
DECL|macro|TBI_ACCEPT
mdefine_line|#define TBI_ACCEPT(adapter, special, errors, length, last_byte) &bslash;&n;    ((adapter)-&gt;tbi_compatibility_on &amp;&amp; &bslash;&n;     (((errors) &amp; E1000_RXD_ERR_FRAME_ERR_MASK) == E1000_RXD_ERR_CE) &amp;&amp; &bslash;&n;     ((last_byte) == CARRIER_EXTENSION) &amp;&amp; &bslash;&n;     ((length) &lt;= ((adapter)-&gt;max_frame_size + 1)) &amp;&amp; &bslash;&n;     ((length) &gt; ((special == 0x0000) ? &bslash;&n;&t;&t;  ((adapter)-&gt;min_frame_size) : &bslash;&n;&t;&t;  ((adapter)-&gt;min_frame_size - VLAN_TAG_SIZE))))
macro_line|#endif /* _E1000_MAC_H_ */
eof

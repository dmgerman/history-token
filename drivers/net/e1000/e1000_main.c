...
multiline_comment|/**&n; * e1000_check_64k_bound - check that memory doesn&squot;t cross 64kB boundary&n; * @adapter: address of board private structure&n; * @begin: address of beginning of memory&n; * @end: address of end of memory&n; **/
r_static
r_inline
id|boolean_t
DECL|function|e1000_check_64k_bound
id|e1000_check_64k_bound
c_func
(paren
r_struct
id|e1000_adapter
...
id|len
suffix:semicolon
multiline_comment|/* first rev 82545 and 82546 need to not allow any memory&n;&t; * write location to cross a 64k boundary due to errata 23 */
r_if
c_cond
(paren
id|adapter-&gt;hw.mac_type
...
(brace
multiline_comment|/* check buffer doesn&squot;t cross 64kB */
r_return
(paren
(paren
id|begin
...
multiline_comment|/* fix for errata 23, cant cross 64kB boundary */
r_if
c_cond
(paren
op_logical_neg
...
id|ERR
comma
l_string|&quot;txdr align check failed: %u bytes at %p&bslash;n&quot;
comma
id|txdr-&gt;size
comma
id|txdr-&gt;desc
...
suffix:semicolon
multiline_comment|/* try again, without freeing the previous */
id|txdr-&gt;desc
op_assign
id|pci_alloc_consistent
c_func
...
suffix:semicolon
multiline_comment|/* failed allocation, critial failure */
r_if
c_cond
(paren
op_logical_neg
...
id|ERR
comma
l_string|&quot;Unable to Allocate aligned Memory for the Transmit&quot;
l_string|&quot; descriptor ring&bslash;n&quot;
)paren
suffix:semicolon
id|vfree
c_func
...
r_else
(brace
multiline_comment|/* free old, move on with the new one since its okay */
id|pci_free_consistent
c_func
(paren
id|pdev
...
id|ERR
comma
l_string|&quot;rxdr align check failed: %u bytes at %p&bslash;n&quot;
comma
id|rxdr-&gt;size
comma
id|rxdr-&gt;desc
...
id|ERR
comma
l_string|&quot;Unable to Allocate aligned Memory for the&quot;
l_string|&quot; Receive descriptor ring&bslash;n&quot;
)paren
suffix:semicolon
id|vfree
c_func
...
id|ERR
comma
l_string|&quot;skb align check failed: %u bytes at %p&bslash;n&quot;
comma
id|bufsz
comma
id|skb-&gt;data
...
r_break
suffix:semicolon
multiline_comment|/* while !buffer_info-&gt;skb */
)brace
r_else
(brace
multiline_comment|/* move on with the new one */
id|dev_kfree_skb
c_func
(paren
id|oldskb
...
id|ERR
comma
l_string|&quot;dma align check failed: %u bytes at %ld&bslash;n&quot;
comma
id|adapter-&gt;rx_buffer_len
comma
(paren

...
macro_line|#ifdef CONFIG_E1000_NAPI
multiline_comment|/* Don&squot;t disable interrupts - rely on h/w interrupt&n;&t; * moderation to keep interrupts low.  netif_rx_schedule&n;&t; * is NOP if already polling. */

...
DECL|variable|comp_free_list_lock
r_static
id|spinlock_t
id|comp_free_list_lock
op_assign
...
suffix:semicolon
DECL|function|z_comp_delayedfree
r_static
r_void
id|z_comp_delayedfree
c_func
(paren
r_void
op_star
...
suffix:semicolon
multiline_comment|/* Ensure that any deflate state pending free is actually freed */

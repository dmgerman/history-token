...
mdefine_line|#define TASKLET_IN_USE test_and_set_bit(0, &bslash;&n;&t;&t;&t;&t;(unsigned long *)(&amp;sp-&gt;tasklet_status))
DECL|macro|PANIC
...
suffix:semicolon
DECL|variable|rx_prio
r_static
id|u32
id|rx_prio
suffix:semicolon
DECL|variable|tx_prio
r_static
id|u32
id|tx_prio
suffix:semicolon
DECL|variable|lso_enable
r_static
r_int
r_int
id|lso_enable
...
suffix:semicolon
macro_line|#endif
DECL|variable|cksum_offload_enable
r_static
r_int
r_int
id|cksum_offload_enable
op_assign
l_int|1
suffix:semicolon
...
id|DEFAULT_FIFO_LEN
suffix:semicolon
DECL|variable|tx_fifo_len_1
r_static
r_int
r_int
id|tx_fifo_len_1
suffix:semicolon
DECL|variable|tx_fifo_len_2
r_static
r_int
r_int
id|tx_fifo_len_2
suffix:semicolon
DECL|variable|tx_fifo_len_3
r_static
r_int
r_int
id|tx_fifo_len_3
suffix:semicolon
DECL|variable|tx_fifo_len_4
r_static
r_int
r_int
id|tx_fifo_len_4
suffix:semicolon
DECL|variable|tx_fifo_len_5
r_static
r_int
r_int
id|tx_fifo_len_5
suffix:semicolon
DECL|variable|tx_fifo_len_6
r_static
r_int
r_int
id|tx_fifo_len_6
suffix:semicolon
DECL|variable|tx_fifo_len_7
r_static
r_int
r_int
id|tx_fifo_len_7
suffix:semicolon
DECL|variable|max_txds
r_static
r_int
r_int
id|max_txds
...
id|SMALL_BLK_CNT
suffix:semicolon
DECL|variable|rx_ring_sz_1
r_static
r_int
r_int
id|rx_ring_sz_1
suffix:semicolon
DECL|variable|rx_ring_sz_2
r_static
r_int
r_int
id|rx_ring_sz_2
suffix:semicolon
DECL|variable|rx_ring_sz_3
r_static
r_int
r_int
id|rx_ring_sz_3
suffix:semicolon
DECL|variable|rx_ring_sz_4
r_static
r_int
r_int
id|rx_ring_sz_4
suffix:semicolon
DECL|variable|rx_ring_sz_5
r_static
r_int
r_int
id|rx_ring_sz_5
suffix:semicolon
DECL|variable|rx_ring_sz_6
r_static
r_int
r_int
id|rx_ring_sz_6
suffix:semicolon
DECL|variable|rx_ring_sz_7
r_static
r_int
r_int
id|rx_ring_sz_7
...
DECL|variable|max_splits_trans
r_static
r_int
r_int
id|max_splits_trans
...
l_int|0xFFF
suffix:semicolon
DECL|variable|tx_utilz_periodic
r_static
r_int
r_int
id|tx_utilz_periodic
op_assign
l_int|1
suffix:semicolon
DECL|variable|rx_timer_val
r_static
r_int
r_int
id|rx_timer_val
...
l_int|0xFFF
suffix:semicolon
DECL|variable|rx_utilz_periodic
r_static
r_int
r_int
id|rx_utilz_periodic
op_assign
l_int|1
suffix:semicolon
DECL|variable|tx_urange_a
r_static
r_int
r_int
id|tx_urange_a
...
l_int|0xf8
suffix:semicolon
DECL|variable|max_read_byte_cnt
r_static
id|u8
id|max_read_byte_cnt
op_assign
l_int|2
suffix:semicolon
...
id|FALSE
suffix:semicolon
multiline_comment|/* Device is up and running. */
...
suffix:semicolon
multiline_comment|/*  Free the Registered IRQ */
id|free_irq
c_func
(paren
id|dev-&gt;irq
...
suffix:semicolon
multiline_comment|/* Flush all scheduled tasks */
r_if
c_cond
(paren
id|sp-&gt;task_flag
...
id|INFO_DBG
comma
l_string|&quot;%s: Calling close from a task&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
id|TX_DBG
comma
l_string|&quot;%s:s2io_xmit: Tx Queue stopped&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* Multi FIFO Tx is disabled for now. */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* &n;&t; * Reproducing eth_type_trans functionality and running&n;&t; * on the ethernet header &squot;eth&squot; stripped and given to us&n;&t; * by the hardware in 2Buff mode.&n;&t; */
r_if
c_cond
(paren
op_star
...
suffix:semicolon
multiline_comment|/* Set user specified value in Latency Timer */
r_if
c_cond
(paren
id|latency_timer
...
multiline_comment|/* Set MMRB count to 2048 in PCI-X Command register. */
id|sp-&gt;pcix_cmd
op_and_assign
l_int|0xFFF3
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*  Initialize the tasklet status flag */
id|atomic_set
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/**&n; * verify_load_parm -  verifies the module loadable parameters&n; * Descriptions: Verifies the module loadable parameters and initializes the&n; * Tx Fifo, Rx Ring and other paramters.&n; */
DECL|function|verify_load_parm
r_int
id|verify_load_parm
c_func
(paren
...
c_func
(paren
l_string|&quot;lso_enable can be either &squot;1&squot; or &squot;0&squot;&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;indicate_max_pkts can take value greater than zero but less than 2power(32)&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;cksum_offload_enable can be only &squot;0&squot; or &squot;1&squot; &bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;tx_fifo_num can take value from 1 to 8&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_7 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_6 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_5 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_4 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_3 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_2 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_1 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_fifo_len_0 can take value from 1 to 8192&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;max_txds can take value from 1 to 32&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;rx_ring_num can take value from 1 to 8&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_7 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_6 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_5 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_4 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_3 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_2 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_1 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_ring_sz_0 can take value greater than 0&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;Stats_refresh_time cannot be less than 1 second &bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rmac_pause_time can take value from 16 to 65535&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;max_splits_trans can take value from 0 to 7&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;mc_pause_threshold_q0q3 cannot exceed 254&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;mc_pause_threshold_q4q7 cannot exceed 254&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;latency_timer can take value from 8 to 255&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;max_read_byte_cnt can take value from 0 to 3&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;shared_splits cannot exceed 31&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;rmac_util_period cannot exceed 15&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
c_func
(paren
l_string|&quot;tmac_util_period cannot exceed 15&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_utilz_periodic &amp; rx_utilz_periodic can be either &quot;
l_string|&quot;&squot;0&squot; or &squot;1&squot;&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;tx_urange_a, tx_urange_b &amp; tx_urange_c can take value &quot;
l_string|&quot;from 0 to 100 and range_a can&squot;t exceed range_b &quot;
l_string|&quot;neither can range_b exceed range_c&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot;rx_urange_a, rx_urange_b &amp; rx_urange_c can take value &quot;
l_string|&quot;from 0 to 100 and range_a can&squot;t exceed range_b &quot;
l_string|&quot;neither can range_b exceed range_c&bslash;n&quot;
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot; tx_ufc_a, tx_ufc_b, tx_ufc_c, tx_ufc_d can take value&quot;
l_string|&quot;from 0 to 65535(0xFFFF)&bslash;n&quot;
)paren
suffix:semicolon
id|fail
op_assign
...
id|printk
(paren
l_string|&quot; rx_ufc_a, rx_ufc_b, rx_ufc_c, rx_ufc_d can take value&quot;
l_string|&quot;from 0 to 65535(0xFFFF)&bslash;n&quot;
)paren
suffix:semicolon
id|fail

...
suffix:semicolon
DECL|variable|fifo_num
r_static
id|u32
id|fifo_num
suffix:semicolon
DECL|variable|fifo_len
r_static
id|u32
id|fifo_len
(braket
...
id|queue_len
op_assign
id|sp-&gt;mac_control.tx_curr_put_info
(braket
id|i
)braket
dot
...
id|get_off
op_assign
id|sp-&gt;mac_control.tx_curr_get_info
(braket
id|i
)braket
dot
...
multiline_comment|/* Set MMRB count to 4096 in PCI-X Command register. */
id|pci_write_config_word
c_func
(paren
id|sp-&gt;pdev
...
(paren
id|KERN_ERR
l_string|&quot;Fifo Lens not specified for all FIFOs&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|init_failed
...
(paren
id|KERN_ERR
l_string|&quot;Fifo Lens not specified for &quot;
)paren
suffix:semicolon
id|printk
c_func

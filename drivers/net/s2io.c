...
comma
op_amp
id|mac_control-&gt;txd_list_mem_phy
)paren
suffix:semicolon
r_if
c_cond
...
id|mac_control-&gt;txd_list_mem_sz
op_assign
id|size
suffix:semicolon
id|tmp_v_addr
...
id|INIT_DBG
comma
l_string|&quot;%s:List Mem PHY: 0x%llx&bslash;n&quot;
comma
id|dev-&gt;name
comma
(paren

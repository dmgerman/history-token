...
id|nic-&gt;config
suffix:semicolon
multiline_comment|/* Initialize swapper control register */
r_if
c_cond
(paren
id|s2io_set_swapper
...
id|ERR_DBG
comma
l_string|&quot;ERROR: Setting Swapper failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/* TTI Initialization. Default Tx timer gets us about&n;&t; * 250 interrupts per sec. Continuous interrupts are enabled&n;&t; * by default.&n;&t; */
id|val64
op_assign
...
op_or
id|TTI_DATA1_MEM_TX_TIMER_CI_EN
suffix:semicolon
id|writeq
c_func
(paren
...
op_assign
(brace
l_int|0xC30000C3C30000C3ULL
comma
multiline_comment|/* FE=1, SE=1 */
l_int|0x8100008181000081ULL
comma
multiline_comment|/* FE=1, SE=0 */
l_int|0x4200004242000042ULL
comma
multiline_comment|/* FE=0, SE=1 */
l_int|0
)brace
suffix:semicolon
multiline_comment|/* FE=0, SE=0 */
r_while
c_loop
(paren
id|i
...
op_assign
(brace
l_int|0x00C3C30000C3C300ULL
comma
multiline_comment|/* FE=1, SE=1 */
l_int|0x0081810000818100ULL
comma
multiline_comment|/* FE=1, SE=0 */
l_int|0x0042420000424200ULL
comma
multiline_comment|/* FE=0, SE=1 */
l_int|0
)brace
...
id|ERR_DBG
comma
l_string|&quot;Write failed, Xmsi_addr &quot;
)paren
suffix:semicolon
id|DBG_PRINT
c_func
...
id|ERR_DBG
comma
l_string|&quot;reads:0x%llx&bslash;n&quot;
comma
id|val64
)paren
suffix:semicolon

...
DECL|function|ewrk3_ethtool_ioctl
r_static
r_int
id|ewrk3_ethtool_ioctl
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;** Port is only valid if autoneg is disabled&n;&t;&t;&t;** and even then we don&squot;t know if AUI is jumpered.&n;&t;&t;&t;*/
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Blink LED for identification */
r_case
id|ETHTOOL_PHYS_ID
suffix:colon
(brace
...
id|delay
suffix:semicolon
id|__wait_event_interruptible_timeout
c_func
(paren
id|wait
comma
...
id|tmp
suffix:semicolon
multiline_comment|/* ethtool IOCTLs are handled elsewhere */
r_if
c_cond
(paren
id|cmd
...
suffix:semicolon
multiline_comment|/* Other than ethtool, all we handle are private IOCTLs */
r_if
c_cond
(paren
id|cmd

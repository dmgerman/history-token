multiline_comment|/* Intel EtherExpress 16 device driver for Linux&n; *&n; * Written by John Sullivan, 1995&n; *  based on original code by Donald Becker, with changes by&n; *  Alan Cox and Pauline Middelink.&n; *&n; * Support for 8-bit mode by Zoltan Szilagyi &lt;zoltans@cs.arizona.edu&gt;&n; *&n; * Many modifications, and currently maintained, by&n; *  Philip Blundell &lt;philb@gnu.org&gt;&n; * Added the Compaq LTE  Alan Cox &lt;alan@redhat.com&gt;&n; * Added MCA support Adam Fritzler &lt;mid@auk.cx&gt;&n; *&n; * Note - this driver is experimental still - it has problems on faster&n; * machines. Someone needs to sit down and go through it line by line with&n; * a databook...&n; */
...
DECL|function|do_express_probe
r_static
r_int
id|__init
id|do_express_probe
...
(paren
id|KERN_WARNING
l_string|&quot;EtherExpress io port %x, is busy.&bslash;n&quot;
comma
id|ioaddr
)paren
suffix:semicolon

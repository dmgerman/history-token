...
macro_line|#if defined(CONFIG_PCI) &amp;&amp; defined(MODULE)
...
(brace
multiline_comment|/* This is harmless, it just means the system is&n;&t;&t; * quite loaded and the incoming packet rate was&n;&t;&t; * faster than the interrupt handler could keep up&n;&t;&t; * with.&n;&t;&t; */
id|printk
c_func
(paren
id|KERN_INFO
...
DECL|function|hme_get_settings
r_static
r_int
id|hme_get_settings
c_func
...
DECL|function|hme_set_settings
r_static
r_int
id|hme_set_settings
c_func
...
(paren
id|KERN_ERR
l_string|&quot;happymeal: Cannot allocate descriptors.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_iounmap
...
(paren
id|KERN_ERR
l_string|&quot;happymeal: Cannot register net device, &quot;
...
DECL|function|get_hme_mac_nonsparc
r_static
r_void
id|get_hme_mac_nonsparc
c_func
(paren
r_struct
id|pci_dev
...
(paren
id|KERN_ERR
l_string|&quot;happymeal(PCI): Cannot obtain PCI resources, &quot;
l_string|&quot;aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
(paren
id|KERN_ERR
l_string|&quot;happymeal(PCI): Unable to remap card memory.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_free_res
...
(paren
id|KERN_ERR
l_string|&quot;happymeal(PCI): Cannot register net device, &quot;
l_string|&quot;aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
id|hp-&gt;dev
suffix:semicolon
multiline_comment|/* Unregister netdev before unmapping registers as this&n;&t;&t; * call can end up trying to access those registers.&n;&t;&t; */
...
multiline_comment|/* Now cleanup the quattro lists. */
macro_line|#ifdef CONFIG_SBUS
r_while
c_loop
(paren

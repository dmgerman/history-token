...
id|nopnp
suffix:semicolon
multiline_comment|/* With the driver model introduction for EISA devices, both init&n; * and cleanup have been split :&n; * - EISA devices probe/remove starts in el3_eisa_probe/el3_eisa_remove&n; * - MCA/ISA still use el3_probe&n; *&n; * Both call el3_common_init/el3_common_remove. */
...
multiline_comment|/* EISA devices are not chained */
macro_line|#endif
(brace
id|lp-&gt;next_dev
op_assign
...
l_int|12
suffix:semicolon
macro_line|#if 0&t;&t;&t;&t;&t;&t;&t;/* Huh ?&n;&t;&t;&t;&t;&t;&t;&t;&t;   Can someone explain what is this for ? */
r_if
c_cond
(paren
id|dev
...
op_increment
suffix:semicolon
multiline_comment|/* Found an eisa card */
macro_line|#endif
r_return
id|el3_cards
ques

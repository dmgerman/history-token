...
id|version
op_assign
l_string|&quot;sis900.c: v1.07.09  2/9/2001&bslash;n&quot;
suffix:semicolon
...
comma
(brace
l_string|&quot;RTL 8201 10/100Mbps Phyceiver&quot;
comma
l_int|0x0000
comma
l_int|0x8201
...
multiline_comment|/**&n; *&t;rtl8201_read_mode: - read media mode for rtl8201 phy&n; *&t;@net_dev: the net device to read mode for&n; *&t;@phy_addr: mii phy address&n; *&t;@speed: the transmit speed to be determined&n; *&t;@duplex: the duplex mode to be determined&n; *&n; *&t;read MII_STATUS register from rtl8201 phy&n; *&t;to determine the speed and duplex mode for sis900&n; */
DECL|function|rtl8201_read_mode
r_static
r_void
id|rtl8201_read_mode
c_func

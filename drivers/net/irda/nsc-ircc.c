...
multiline_comment|/* Should use nsc_ircc_probe_39x properly */
(brace
l_string|&quot;PC8739x&quot;
comma
(brace
...
suffix:semicolon
multiline_comment|/* Read infos about SP2 */
id|outb
c_func
(paren
id|CFG_39X_BASEH
...
suffix:semicolon
multiline_comment|/* We should store those values in info ? Jean II */
id|IRDA_DEBUG
c_func
(paren
l_int|2
...
multiline_comment|/* Do we want to enable the device if not enabled ? */
multiline_comment|/* Enable UART bank switching (bit 7) */
id|outb
c_func
(paren
id|CFG_39X_SPC
...
multiline_comment|/*&n; * Function nsc_ircc_probe_39x (chip, info)&n; *&n; *    Test if we really have a &squot;39x chip at the given address&n; *&n; */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Why are we using the &squot;338 configuration registers in here ?&n;&t; * This probably need to be rewritten...&n;&t; * Jean II */
macro_line|#if 0
multiline_comment|/* Read funtion enable register (FER) */
id|outb
c_func

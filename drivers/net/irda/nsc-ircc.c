...
multiline_comment|/*&n; * Function nsc_ircc_init_39x (chip, info)&n; *&n; *    Now that we know it&squot;s a &squot;39x (see probe below), we need to&n; *    configure it so we can use it.&n; *&n; * The NSC &squot;338 chip is a Super I/O chip with a &quot;bank&quot; architecture,&n; * the configuration of the different functionality (serial, parallel,&n; * floppy...) are each in a different bank (Logical Device Number).&n; * The base address, irq and dma configuration registers are common&n; * to all functionalities (index 0x30 to 0x7F).&n; * There is only one configuration register specific to the&n; * serial port, CFG_39X_SPC.&n; * JeanII&n; *&n; * Note : this code was written by Jan Frey &lt;janfrey@web.de&gt;&n; */
DECL|function|nsc_ircc_init_39x
r_static
r_int
id|nsc_ircc_init_39x
c_func
...
id|enabled
suffix:semicolon
multiline_comment|/* User is shure about his config... accept it. */
id|IRDA_DEBUG
c_func
(paren
l_int|2
comma
l_string|&quot;%s(): nsc_ircc_init_39x (user settings): &quot;
l_string|&quot;io=0x%04x, irq=%d, dma=%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|info-&gt;fir_base
...
suffix:semicolon
multiline_comment|/* Access bank for SP2 */
id|outb
c_func
(paren
id|CFG_39X_LDN
...
suffix:semicolon
multiline_comment|/* Configure SP2 */
multiline_comment|/* We want to enable the device if not enabled */
id|outb
c_func
(paren
id|CFG_39X_ACT
...
suffix:semicolon
multiline_comment|/* May want to update info-&gt;enabled. Jean II */
)brace
multiline_comment|/* Enable UART bank switching (bit 7) ; Sets the chip to normal&n;&t; * power mode (wake up from sleep mode) (bit 1) */
id|outb
c_func
(paren
id|CFG_39X_SPC
...
multiline_comment|/*&n; * Function nsc_ircc_probe_39x (chip, info)&n; *&n; *    Test if we really have a &squot;39x chip at the given address&n; *&n; * Note : this code was written by Jan Frey &lt;janfrey@web.de&gt;&n; */
DECL|function|nsc_ircc_probe_39x
r_static
r_int
id|nsc_ircc_probe_39x
c_func
...
l_int|2
comma
l_string|&quot;%s(), nsc_ircc_probe_39x, base=%d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|cfg_base
...
suffix:semicolon
multiline_comment|/* This function should be executed with irq off to avoid&n;&t; * another driver messing with the Super I/O bank - Jean II */
multiline_comment|/* Access bank for SP2 */
id|outb
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Read infos about SP2 ; store in info struct */
id|outb
c_func
(paren
id|CFG_39X_BASEH
...
l_int|2
comma
l_string|&quot;%s(): io=0x%02x%02x, irq=%d (type %d), rxdma=%d, txdma=%d, enabled=%d (suspended=%d)&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|reg1
...
(brace
multiline_comment|/* There was a cli() there, but we now are already&n;&t;&t;&t; * under spin_lock_irqsave() - JeanII */
id|outb
c_func
(paren
l_int|0x81
...
multiline_comment|/* This is already protected */

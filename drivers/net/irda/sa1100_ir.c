multiline_comment|/*&n; *  linux/drivers/net/irda/sa1100_ir.c&n; *&n; *  Copyright (C) 2000-2001 Russell King&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; *&n; *  Infra-red driver for the StrongARM SA1100 embedded microprocessor&n; *&n; *  Note that we don&squot;t have to worry about the SA1111&squot;s DMA bugs in here,&n; *  so we use the straight forward dma_map_* functions with a null pointer.&n; *&n; *  This driver takes one kernel command line parameter, sa1100ir=, with&n; *  the following options:&n; *&t;max_rate:baudrate&t;- set the maximum baud rate&n; *&t;power_leve:level&t;- set the transmitter power level&n; *&t;tx_lpm:0|1&t;&t;- set transmit low power mode&n; */
...
macro_line|#else
DECL|macro|sa1100_irda_suspend
mdefine_line|#define sa1100_irda_suspend&t;NULL
DECL|macro|sa1100_irda_resume
mdefine_line|#define sa1100_irda_resume&t;NULL
macro_line|#endif
...
DECL|function|sa1100_irda_probe
r_static
r_int
id|sa1100_irda_probe
c_func
(paren
r_struct
id|device
...
DECL|function|sa1100_irda_remove
r_static
r_int
id|sa1100_irda_remove
c_func
(paren
r_struct
id|device

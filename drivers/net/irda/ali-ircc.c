...
singleline_comment|// IRDA_MESSAGE(&quot;%s, Found chip at base=0x%03x&bslash;n&quot;, driver_name, info-&gt;cfg_base);
...
multiline_comment|/*&n; * Function ali_ircc_fir_interrupt(irq, struct ali_ircc_cb *self)&n; *&n; *    Handle MIR/FIR interrupt&n; *&n; */

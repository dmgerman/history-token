...
multiline_comment|/* define this if you get errors about multiple defns of irda_crc16_table */
...
DECL|variable|toshoboe_pci_driver
r_static
r_struct
id|pci_driver
...
suffix:semicolon
DECL|variable|toshoboe_cleanup
id|module_exit
c_func
(paren
id|toshoboe_cleanup

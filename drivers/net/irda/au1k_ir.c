...
multiline_comment|/* &n; * Device has already been stopped at this point.&n; */
DECL|function|au1k_irda_net_uninit
r_static
r_void
id|au1k_irda_net_uninit
c_func
(paren
r_struct
id|net_device
...
(paren
id|KERN_ERR
l_string|&quot;%s: au1k_init_module failed.  Returns %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|retval
...
(paren
id|KERN_ERR
l_string|&quot;au1k_ircc no dev found&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

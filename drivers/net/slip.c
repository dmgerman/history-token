...
mdefine_line|#define SLIP_VERSION&t;&quot;0.8.4-NET3.019-NEWTTY&quot;
DECL|variable|slip_devs
r_static
r_struct
id|net_device
op_star
...
suffix:semicolon
macro_line|#if defined(SL_INCLUDE_CSLIP)
id|printk
c_func
(paren
id|KERN_INFO
...
(paren
id|KERN_ERR
l_string|&quot;SLIP: Can&squot;t allocate slip devices array!  Uaargh! (-&gt; No SLIP available)&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
r_return
suffix:semicolon
multiline_comment|/* First of all: check for active disciplines and hangup them.&n;&t; */
r_do
(brace
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;%s: tty discipline still running&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon

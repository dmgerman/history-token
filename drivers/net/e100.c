...
mdefine_line|#define DRV_COPYRIGHT&t;&t;&quot;Copyright(c) 1999-2003 Intel Corporation&quot;
DECL|macro|PFX
...
id|scb_status
(brace
DECL|enumerator|rus_idle
id|rus_idle
op_assign
l_int|0x00
comma
DECL|enumerator|rus_suspended
id|rus_suspended
op_assign
l_int|0x04
comma
DECL|enumerator|rus_no_resources
id|rus_no_resources
op_assign
l_int|0x08
comma
...
l_int|0x3C
comma
DECL|enumerator|cus_idle
id|cus_idle
op_assign
l_int|0x00
comma
DECL|enumerator|cus_suspended
id|cus_suspended
op_assign
l_int|0x40
comma
DECL|enumerator|cus_active
id|cus_active
op_assign
l_int|0x80
comma
DECL|enumerator|cus_mask
id|cus_mask
op_assign
l_int|0xC0
comma
...
(brace
multiline_comment|/* (Re)start RU if suspended or idle and RFA is fully allocated */
r_struct
id|rx_list
op_star
id|curr
...
DECL|function|e100_rx_rfa_add_tail
r_static
r_inline
r_void
id|e100_rx_rfa_add_tail
c_func
(paren
r_struct
id|nic
...
(brace
multiline_comment|/* Don&squot;t indicate if errors */
id|dev_kfree_skb_any
c_func
(paren
id|skb
...
id|jiffies
suffix:semicolon
macro_line|#ifdef CONFIG_E100_NAPI
...
multiline_comment|/* List is full, done */
r_if
c_cond
(paren
id|unlikely
...
(brace
multiline_comment|/* Hardware is ejected (cardbus, hotswap)  */
r_return
id|IRQ_NONE
suffix:semicolon
)brace

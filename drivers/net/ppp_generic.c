...
id|drop
suffix:semicolon
multiline_comment|/* need to have PPP header */
r_if
c_cond
(paren
op_logical_neg
...
(brace
op_increment
id|pch-&gt;ppp-&gt;stats.rx_length_errors
suffix:semicolon
id|ppp_receive_error
c_func
(paren

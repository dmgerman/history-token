...
id|new_skb
suffix:semicolon
multiline_comment|/* If this packet is byte aligned, fix that.  */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;PPP: no memory (bad aligned SKB)&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; * XXX race: the compressor module could get unloaded between&n;&t; * here and when we do the comp_alloc or decomp_alloc call below.&n;&t; */
id|err
op_assign
op_minus
id|ENOBUFS

...
id|intmask
suffix:semicolon
multiline_comment|/* Saved interrupt mask bits */
...
multiline_comment|/*&n; * Interrupt mask control&n; */
r_static
r_void
DECL|function|speedo_intrmask
id|speedo_intrmask
c_func
(paren
r_void
...
(brace
multiline_comment|/* get driver-specific version/etc. info */
r_case
id|ETHTOOL_GDRVINFO
suffix:colon
(brace

...
mdefine_line|#define NR_TX_DESC&t;64
...
multiline_comment|/* I hate the network stack sometimes */
macro_line|#ifdef __i386__
DECL|macro|skb_mangle_for_davem
mdefine_line|#define skb_mangle_for_davem(skb,len)&t;(skb)
macro_line|#else
DECL|function|skb_mangle_for_davem
r_static
r_inline
r_struct
id|sk_buff
op_star
id|skb_mangle_for_davem
c_func
(paren
r_struct
id|sk_buff
...
DECL|function|ns83820_ethtool_ioctl
r_static
r_int
id|ns83820_ethtool_ioctl
(paren
r_struct
id|ns83820
op_star
...
suffix:semicolon
multiline_comment|/* Set Rx to full duplex, don&squot;t accept runt, errored, long or length&n;&t; * range errored packets.  Set MXDMA to 0 =&gt; 1024 word burst&n;&t; */
id|writel
c_func
(paren
id|RXCFG_AEP

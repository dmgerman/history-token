...
suffix:semicolon
multiline_comment|/* hw.copy_from_card expects IRQ context so take the IRQ lock&n;&t;   to keep it single threaded */
r_if
c_cond
(paren
id|take_arcnet_lock
...
id|D_INIT
comma
l_string|&quot;arcnet_open: mtu: %d.&bslash;n&quot;
comma
id|dev-&gt;mtu
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Type is host order - ? */
r_if
c_cond
(paren
id|type
...
id|D_DEBUG
comma
l_string|&quot;arc_raw_proto used. proto=&squot;%c&squot;&bslash;n&quot;
comma
id|proto-&gt;suffix
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * if the dest addr isn&squot;t provided, we can&squot;t choose an encapsulation!&n;&t;&t; * Store the packet type (eg. ETH_P_IP) for now, and we&squot;ll push on a&n;&t;&t; * real header when we do rebuild_header.&n;&t;&t; */
op_star
(paren
r_uint16
op_star
...
id|D_DURING
comma
l_string|&quot;rebuild header for protocol %Xh&bslash;n&quot;
comma
id|type
)paren
suffix:semicolon
...
id|D_DURING
comma
l_string|&quot;transmit requested (status=%Xh, txbufs=%d/%d, len=%d, protocol %x)&bslash;n&quot;
comma
id|ASTATUS
c_func
(paren
...
(brace
multiline_comment|/* done right away and we don&squot;t want to acknowledge&n;&t;&t;&t;   the package later - forget about it now */
...
id|D_DEBUG
comma
l_string|&quot;%s: %d: %s, status: %x&bslash;n&quot;
comma
id|__FILE__
comma
id|__LINE__
...
op_increment
suffix:semicolon
multiline_comment|/* make sure we didn&squot;t miss a TX or a EXC NAK IRQ */
id|AINTMASK
c_func
(paren
l_int|0
...
id|D_DURING
comma
l_string|&quot;EXCNAK IRQ (diagstat=%Xh)&bslash;n&quot;
comma
id|diagstatus
)paren
suffix:semicolon

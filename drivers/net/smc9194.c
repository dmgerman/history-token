...
DECL|macro|insl
mdefine_line|#define insl(a,b,l)  io_insl_noswap(a,b,l)
DECL|macro|outsl
mdefine_line|#define outsl(a,b,l) io_outsl_noswap(a,b,l)
macro_line|#endif
...
suffix:semicolon
macro_line|#if defined(CONFIG_H8S_EDOSK2674)
...
id|base_address_register
suffix:semicolon
multiline_comment|/* Warning suppression */
macro_line|#endif

...
multiline_comment|/* miilib interface */
multiline_comment|/* FIXME FIXME: phy_id is ignored, bp-&gt;phy_addr use is unconditional&n; * due to code existing before miilib use was added to this driver.&n; * Someone should remove this artificial driver limitation in&n; * b44_{read,write}phy.  bp-&gt;phy_addr itself is fine (and needed).&n; */
DECL|function|b44_mii_read
r_static
r_int
id|b44_mii_read
c_func
...
suffix:semicolon
multiline_comment|/* Enable CRC32, set proper LED modes and power on PHY */
id|bw32
c_func
(paren
id|bp
...
DECL|function|b44_get_msglevel
r_static
id|u32
id|b44_get_msglevel
c_func
...
DECL|function|b44_set_msglevel
r_static
r_void
id|b44_set_msglevel
c_func
...
DECL|function|b44_get_settings
r_static
r_int
id|b44_get_settings
c_func
...
DECL|function|b44_set_settings
r_static
r_int
id|b44_set_settings
c_func
...
DECL|function|b44_get_ringparam
r_static
r_void
id|b44_get_ringparam
c_func
(paren
r_struct
id|net_device
...
DECL|function|b44_set_ringparam
r_static
r_int
id|b44_set_ringparam
c_func
(paren
r_struct
id|net_device
...
DECL|function|b44_get_pauseparam
r_static
r_void
id|b44_get_pauseparam
c_func
(paren
r_struct
id|net_device
...
DECL|function|b44_set_pauseparam
r_static
r_int
id|b44_set_pauseparam
c_func
(paren
r_struct
id|net_device
...
id|dev
suffix:semicolon
id|bp-&gt;mii_if.mdio_read
op_assign
id|b44_mii_read
suffix:semicolon
id|bp-&gt;mii_if.mdio_write
op_assign
id|b44_mii_write
suffix:semicolon
id|bp-&gt;mii_if.phy_id
...
id|bp-&gt;phy_addr
suffix:semicolon
id|bp-&gt;mii_if.phy_id_mask
op_assign
l_int|0x1f
suffix:semicolon
id|bp-&gt;mii_if.reg_num_mask
op_assign
l_int|0x1f
suffix:semicolon

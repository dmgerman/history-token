...
DECL|struct|mv643xx_mib_counters
r_struct
id|mv643xx_mib_counters
(brace
DECL|member|good_octets_received
id|u64
id|good_octets_received
suffix:semicolon
DECL|member|bad_octets_received
id|u32
id|bad_octets_received
suffix:semicolon
DECL|member|internal_mac_transmit_err
id|u32
id|internal_mac_transmit_err
suffix:semicolon
DECL|member|good_frames_received
id|u32
id|good_frames_received
suffix:semicolon
DECL|member|bad_frames_received
id|u32
id|bad_frames_received
suffix:semicolon
DECL|member|broadcast_frames_received
id|u32
id|broadcast_frames_received
suffix:semicolon
DECL|member|multicast_frames_received
id|u32
id|multicast_frames_received
suffix:semicolon
DECL|member|frames_64_octets
id|u32
id|frames_64_octets
suffix:semicolon
DECL|member|frames_65_to_127_octets
id|u32
id|frames_65_to_127_octets
suffix:semicolon
DECL|member|frames_128_to_255_octets
id|u32
id|frames_128_to_255_octets
suffix:semicolon
DECL|member|frames_256_to_511_octets
id|u32
id|frames_256_to_511_octets
suffix:semicolon
DECL|member|frames_512_to_1023_octets
id|u32
id|frames_512_to_1023_octets
suffix:semicolon
DECL|member|frames_1024_to_max_octets
id|u32
id|frames_1024_to_max_octets
suffix:semicolon
DECL|member|good_octets_sent
id|u64
id|good_octets_sent
suffix:semicolon
DECL|member|good_frames_sent
id|u32
id|good_frames_sent
suffix:semicolon
DECL|member|excessive_collision
id|u32
id|excessive_collision
suffix:semicolon
DECL|member|multicast_frames_sent
id|u32
id|multicast_frames_sent
suffix:semicolon
DECL|member|broadcast_frames_sent
id|u32
id|broadcast_frames_sent
suffix:semicolon
DECL|member|unrec_mac_control_received
id|u32
id|unrec_mac_control_received
suffix:semicolon
DECL|member|fc_sent
id|u32
id|fc_sent
suffix:semicolon
DECL|member|good_fc_received
id|u32
id|good_fc_received
suffix:semicolon
DECL|member|bad_fc_received
id|u32
id|bad_fc_received
suffix:semicolon
DECL|member|undersize_received
id|u32
id|undersize_received
suffix:semicolon
DECL|member|fragments_received
id|u32
id|fragments_received
suffix:semicolon
DECL|member|oversize_received
id|u32
id|oversize_received
suffix:semicolon
DECL|member|jabber_received
id|u32
id|jabber_received
suffix:semicolon
DECL|member|mac_receive_error
id|u32
id|mac_receive_error
suffix:semicolon
DECL|member|bad_crc_event
id|u32
id|bad_crc_event
suffix:semicolon

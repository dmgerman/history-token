...
id|if_ptr
suffix:semicolon
multiline_comment|/* Some drivers describe this as a&n;                                         * general purpose pointer. However if&n;                                         * using syncPPP it has a very specific&n;                                         * purpose: it must be the first item in&n;                                         * the structure pointed to by dev-&gt;priv&n;                                         * and must in turn point to the&n;                                         * associated ppp_device structure.&n;                                         */
DECL|member|card
r_struct
id|fst_card_info
op_star
...
id|proto
suffix:semicolon
multiline_comment|/* Protocol we are running */
DECL|member|hwif
r_int
id|hwif
suffix:semicolon
...
id|dev
suffix:semicolon
multiline_comment|/* Kernel network device entry */
DECL|member|stats
r_struct
id|net_device_stats
id|stats
suffix:semicolon
multiline_comment|/* Standard statistics */
DECL|member|pppdev
r_struct
id|ppp_device
id|pppdev
suffix:semicolon
multiline_comment|/* Link to syncPPP */
)brace
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Poke sPPP to renegotiate */
r_if
c_cond
(paren
id|port-&gt;proto
...
(brace
id|port-&gt;stats.rx_length_errors
op_increment
suffix:semicolon
)brace
...
(brace
multiline_comment|/* Mark for further processing by sPPP module */
id|skb-&gt;protocol
op_assign
id|htons
(paren
...
r_else
(brace
multiline_comment|/* DEC customer specific protocol (since nothing defined for&n;                 * marking raw data), at least one other driver uses this value&n;                 * for this purpose.&n;                 */
id|skb-&gt;protocol
op_assign
id|htons
(paren
...
multiline_comment|/* Sooner or later you can&squot;t avoid a forward declaration */
r_static
r_int
id|fst_ioctl
(paren
...
id|port-&gt;dev
suffix:semicolon
multiline_comment|/* Turn off sPPP module ? */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Reset some fields overwritten by sPPP */
id|dev-&gt;hard_header
op_assign
l_int|NULL
suffix:semicolon
...
multiline_comment|/* Turn on sPPP ? */
r_if
c_cond
(paren
(paren
...
id|dev-&gt;mtu
suffix:semicolon
multiline_comment|/* Attach to sync PPP module */
id|port-&gt;pppdev.dev
op_assign
id|dev
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Claw back the ioctl routine. We promise to be good and call&n;                 * the sync PPP routines once we&squot;ve eliminated our functions.&n;                 */
id|dev-&gt;do_ioctl
op_assign
id|fst_ioctl
suffix:semicolon
...
multiline_comment|/* Switch sPPP mode to that desired */
id|err
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* Anything else is switching from one raw mode to another which is&n;         * basically a NOP&n;         */
r_return
id|err
suffix:semicolon
)brace
...
id|err
suffix:semicolon
multiline_comment|/* Set things according to the user set valid flags */
id|err
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* Not one of ours. Pass it through to sPPP package */
r_if
c_cond
(paren
id|port-&gt;proto
...
id|DBG_OPEN
comma
l_string|&quot;open: Unknown proto %d&bslash;n&quot;
comma
id|port-&gt;proto
)paren
suffix:semicolon
...
id|DBG_OPEN
comma
l_string|&quot;close: Unknown proto %d&bslash;n&quot;
comma
id|port-&gt;proto
)paren
suffix:semicolon
...
op_increment
suffix:semicolon
id|port-&gt;stats.tx_aborted_errors
op_increment
suffix:semicolon
r_if
c_cond
...
id|port-&gt;card
suffix:semicolon
multiline_comment|/* Drop packet if in monitor (rx only) mode */
r_if
c_cond
(paren
id|port-&gt;proto
...
op_increment
suffix:semicolon
id|port-&gt;stats.tx_carrier_errors
op_increment
suffix:semicolon
r_return
l_int|0
...
id|printk_err
(paren
l_string|&quot;Cannot allocate net_device for port %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
multiline_comment|/* No point going any further */
id|card-&gt;nports
op_assign
id|i
suffix:semicolon
...
id|printk_err
(paren
l_string|&quot;Cannot allocate i/f name for port %d&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
multiline_comment|/* Fill in remainder of the net device info */
...
id|printk_err
(paren
l_string|&quot;Cannot register %s (errno %d)&bslash;n&quot;
comma
id|dev-&gt;name
comma
op_minus

...
mdefine_line|#define INTR_WORK 4
DECL|macro|get_msci
...
r_break
suffix:semicolon
multiline_comment|/* SCA-II updates CDA in 2 steps */
macro_line|#endif
id|desc
op_assign
id|desc_address
...
DECL|function|sca_set_loopback
r_static
r_inline
r_int
id|sca_set_loopback
...
DECL|function|sca_set_hdlc_mode
r_static
r_void
id|sca_set_hdlc_mode
c_func
(paren
id|port_t
op_star
...
multiline_comment|/* Setting than to larger value may cause Illegal Access */
id|sca_out
c_func
(paren
l_int|0x20
...
suffix:semicolon
multiline_comment|/* TX underrun IRQ */
id|sca_out
c_func
(paren
id|sca_in
...
suffix:semicolon
macro_line|#else
multiline_comment|/* MSCI TX INT and underrrun IRQ enable */
id|sca_outl
c_func
(paren
id|IE0_TXINT

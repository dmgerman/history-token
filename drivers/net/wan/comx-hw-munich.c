...
id|board-&gt;ccb
suffix:semicolon
multiline_comment|/* TOD: ez igy csunya egy kicsit hogy benn is meg kinn is beletoltom :( */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
id|EBUSY
suffix:semicolon
multiline_comment|/* TOD: lehet hogy valami mas errno kellene? */
)brace

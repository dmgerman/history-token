...
op_assign
l_string|&quot;$Id: dscc4.c,v 1.157 2002/01/28 01:54:19 romieu Exp $&bslash;n&quot;
suffix:semicolon
DECL|variable|debug
r_static
r_int
...
suffix:semicolon
macro_line|#endif
DECL|function|dscc4_patch_register
r_static
r_inline
r_void
...
suffix:semicolon
multiline_comment|/* No need for High PCI latency. Cf app. note. */
...
suffix:semicolon
multiline_comment|/* crc not forwarded */
id|writel
c_func
(paren
l_int|0x00050008
...
singleline_comment|//writel(0x00250008 &amp; ~RxActivate, ioaddr + CCR2);
...
multiline_comment|/* Posted write is flushed in the busy-waiting loop */
id|writel
c_func
(paren
id|TxSccRes
...
suffix:semicolon
multiline_comment|/* &n;&t; * FIXME: wait for the command ack before returning the memory&n;&t; * structures to the kernel.&n;&t; */
id|hdlc_close
c_func
(paren
id|hdlc
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: clock adjusted from %08d to %08d &bslash;n&quot;
comma
id|dev-&gt;name
comma

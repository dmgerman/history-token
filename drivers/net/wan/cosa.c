...
suffix:semicolon
multiline_comment|/* for class stuff*/
DECL|variable|cosa_class
r_static
r_struct
id|class_simple
op_star
...
multiline_comment|/* Update the name of the region now we know the type of card */
id|release_region
c_func
(paren
id|base
...
(paren
id|KERN_DEBUG
l_string|&quot;cosa: changing name at 0x%x failed.&bslash;n&quot;
comma
id|base
)paren
suffix:semicolon

...
id|dev
comma
l_string|&quot;lmc_setup out&quot;
)paren
suffix:semicolon
)brace
DECL|function|lmc_init_one
r_static
r_int
id|__devinit
id|lmc_init_one
...
multiline_comment|/* We name by type not by vendor */
r_static
r_const
r_char
id|lmcname
...
(paren
id|KERN_ERR
l_string|&quot;lmc:alloc_netdev for device failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out1
...
(paren
id|KERN_ERR
l_string|&quot;lmc: pci enable failed:%d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;lmc: pci_request_region failed&bslash;n&quot;
)paren
suffix:semicolon
id|err
op_assign
...
suffix:semicolon
multiline_comment|/*&n;     *&n;     * Check either the subvendor or the subdevice, some systems reverse&n;     * the setting in the bois, seems to be version and arch dependent?&n;     * Fix the error, exchange the two values &n;     */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; * Called from pci when removing module.&n; */
DECL|function|lmc_remove_one
r_static
r_void
id|__devexit
id|lmc_remove_one

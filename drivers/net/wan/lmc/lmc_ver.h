...
multiline_comment|/*&n;  * This file defines and controls all linux version&n;  * differences.&n;  *&n;  * This is being done to keep 1 central location where all linux&n;  * version differences can be kept and maintained.  as this code was&n;  * found version issues where pepered throughout the source code and&n;  * made the souce code not only hard to read but version problems hard&n;  * to track down.  If I&squot;m overiding a function/etc with something in&n;  * this file it will be prefixed by &quot;LMC_&quot; which will mean look&n;  * here for the version dependant change that&squot;s been done.&n;  *&n;  */

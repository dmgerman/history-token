...
multiline_comment|/* Wanpipe&squot;s own workqueue, used for all API&squot;s.&n; * All protocol specific tasks will be inserted&n; * into the &quot;wanpipe_wq&quot; workqueue. &n;&n; * The kernel workqueue mechanism will execute&n; * all pending tasks in the &quot;wanpipe_wq&quot; workqueue.&n; */
DECL|variable|wanpipe_wq
r_struct
id|workqueue_struct
op_star
id|wanpipe_wq
...
multiline_comment|/* Make sure I/O port region is available only if we are the&n;&t; * master device.  If we are running in piggybacking mode, &n;&t; * we will use the resources of the master card. */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * @work_pointer:&t;work_struct to be done;&n; * &t;&t;&t;should already have PREPARE_WORK() or&n; * &t;&t;&t;  INIT_WORK() done on it by caller;&n; */
DECL|function|wanpipe_queue_work
r_void
...
(paren
id|KERN_INFO
l_string|&quot;CRITICAL IN QUEUING WORK&bslash;n&quot;
)paren
suffix:semicolon
id|queue_work
c_func

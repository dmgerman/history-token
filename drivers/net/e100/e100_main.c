...
multiline_comment|/* Otherwise process may sleep forever */
id|netif_wake_queue
c_func
(paren
id|dev
...
multiline_comment|/* tcb list may be empty temporarily during releasing resources */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;e100: Invalid Ethernet address&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_bool|false
...
id|i
suffix:semicolon
multiline_comment|/* Return tx skbs */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* If not my interrupt, just return */
r_if
c_cond
(paren
op_logical_neg
...
dot
id|ipcb.ip_activation_high
op_or_assign
id|IPCB_INSERTVLAN_ENABLE
suffix:semicolon
(paren
id|tcb-&gt;tcbu
)paren
...
r_break
suffix:semicolon
macro_line|#ifdef&t;ETHTOOL_GRINGPARAM
r_case
...
macro_line|#endif
macro_line|#ifdef&t;ETHTOOL_SRINGPARAM
r_case
...
suffix:semicolon
multiline_comment|/* Use new values to open interface */
id|bdp-&gt;params.RxDescriptors
op_assign
id|ering.rx_pending
suffix:semicolon
...
macro_line|#endif
macro_line|#ifdef&t;ETHTOOL_GPAUSEPARAM
r_case
...
macro_line|#endif
macro_line|#ifdef&t;ETHTOOL_SPAUSEPARAM
r_case
...
macro_line|#endif
macro_line|#ifdef&t;ETHTOOL_GRXCSUM
r_case
id|ETHTOOL_GRXCSUM
suffix:colon
r_case
...
macro_line|#endif
macro_line|#ifdef&t;ETHTOOL_SRXCSUM
r_case
id|ETHTOOL_SRXCSUM
suffix:colon
r_case
...
r_static
r_void
DECL|function|e100_vlan_rx_register
id|e100_vlan_rx_register
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|e100_vlan_rx_add_vid
id|e100_vlan_rx_add_vid
c_func
(paren
r_struct
...
(brace
multiline_comment|/* We don&squot;t do Vlan filtering */
r_return
suffix:semicolon
)brace
r_static
r_void
DECL|function|e100_vlan_rx_kill_vid
id|e100_vlan_rx_kill_vid
c_func
(paren
r_struct
...
r_int
r_char
DECL|function|e100_asf_enabled
id|e100_asf_enabled
c_func
(paren
r_struct

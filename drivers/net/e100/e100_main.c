...
suffix:semicolon
DECL|variable|e100_driver_version
r_char
...
op_assign
l_string|&quot;Intel(R) PRO/100 Network Driver&quot;
suffix:semicolon
...
suffix:semicolon
DECL|variable|e100_notifier_netdev
r_struct
id|notifier_block
id|e100_notifier_netdev
op_assign
(brace
dot
id|notifier_call
...
multiline_comment|/* Check if checksum is valid */
id|cal_checksum
op_assign
id|e100_eeprom_calculate_chksum
c_func
...
id|i
suffix:semicolon
multiline_comment|/* Do software reset */
id|e100_sw_reset
c_func
(paren
id|bdp
...
suffix:semicolon
multiline_comment|/* Do a dummy LOAD CU BASE command. */
multiline_comment|/* This gets us out of pre-driver to post-driver. */
id|e100_exec_cmplx
c_func
(paren
id|bdp
...
suffix:semicolon
multiline_comment|/* Wait 20 msec for reset to take effect */
...
multiline_comment|/* after device reset                        */
id|e100_disable_clear_intr
c_func
(paren
id|bdp
...
suffix:semicolon
multiline_comment|/* Wait for command to be cleared up to 1 sec */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Wait for TCO request bit in PMDR register to be clear */
r_for
c_loop
(paren
id|i
...
(paren
op_amp
id|bdp-&gt;scb-&gt;scb_ext.d101m_scb.scb_pmdr
)paren
op_amp
id|BIT_1
)paren
...
r_else
(brace
multiline_comment|/* Initiate hwi, ie, cable diagnostic */
id|bdp-&gt;saved_open_circut
op_assign
l_int|0xffff
suffix:semicolon
id|bdp-&gt;saved_short_circut
op_assign
l_int|0xffff
suffix:semicolon
id|bdp-&gt;saved_distance
op_assign
l_int|0xffff
suffix:semicolon
id|bdp-&gt;saved_i
...
suffix:semicolon
multiline_comment|/* Set to 100 Full as required by hwi test */
id|e100_mdi_write
c_func
(paren
id|bdp
...
suffix:semicolon
multiline_comment|/* Enable and execute HWI test */
id|e100_mdi_write
c_func
(paren
id|bdp
...
suffix:semicolon
multiline_comment|/* Launch hwi timer in 1 msec */
id|mod_timer
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* If in middle of cable diag, */
r_if
c_cond
(paren
id|bdp-&gt;hwi_started
...
l_string|&quot; device configuration failed&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
id|ETHTOOL_GLINK
suffix:semicolon
multiline_comment|/* Consider both PHY link and netif_running */
id|info.data
op_assign
...
r_static
r_int
DECL|function|e100_ethtool_gregs
id|e100_ethtool_gregs
c_func
(paren
r_struct
...
(brace
multiline_comment|/* need modification of first changed EEPROM word */
...
(brace
multiline_comment|/* need modification of last changed EEPROM word */
...
r_static
r_void
DECL|function|e100_led_control
id|e100_led_control
c_func
(paren
r_struct
...
multiline_comment|/**&n; * e100_led_blink_callback&n; * @data: pointer to atapter&squot;s private data struct&n; *&n; * Blink timer callback function. Toggles ON/OFF led status bit and calls&n; * led hardware access function. &n; */
r_static
r_void
DECL|function|e100_led_blink_callback
id|e100_led_blink_callback
c_func
(paren
r_int
r_int
...
id|jiffies
op_plus
id|E100_BLINK_INTERVAL
)paren
suffix:semicolon
)brace
multiline_comment|/**&n; * e100_ethtool_led_blink&n; * @dev: pointer to atapter&squot;s net_device struct&n; * @ifr: pointer to ioctl request structure&n; *&n; * Blink led ioctl handler. Initialtes blink timer and sleeps until&n; * blink period expires. Than it kills timer and returns. The led control&n; * is returned back to hardware when blink timer is killed.&n; */
r_static
r_int
DECL|function|e100_ethtool_led_blink
id|e100_ethtool_led_blink
c_func
(paren
r_struct
...
DECL|function|e100_notify_netdev
r_int
id|e100_notify_netdev
c_func
(paren
...
r_static
r_int
DECL|function|e100_notify_reboot
id|e100_notify_reboot
c_func
(paren
r_struct
...
(brace
multiline_comment|/* If net_device struct is allocated? */
r_if
c_cond
(paren
id|pci_get_drvdata
...
r_static
r_void
DECL|function|e100_get_mdix_status
id|e100_get_mdix_status
c_func
(paren
r_struct
...
id|ctrl_reg
suffix:semicolon
multiline_comment|/* Read the MDIX control register */
id|e100_mdi_read
c_func
(paren
id|bdp
...
id|bdp-&gt;cable_status
op_assign
l_string|&quot;Open Circut Near End&quot;
suffix:semicolon
r_else
id|bdp-&gt;cable_status
op_assign
l_string|&quot;Open Circut Far End&quot;
suffix:semicolon
)brace
r_else
(brace
...
id|bdp-&gt;cable_status
op_assign
l_string|&quot;Short Circut Near End&quot;
suffix:semicolon
r_else
id|bdp-&gt;cable_status
op_assign
l_string|&quot;Short Circut Far End&quot;
suffix:semicolon
)brace
r_goto
id|done
...
id|bdp-&gt;cable_status
op_assign
l_string|&quot;Test failed&quot;
suffix:semicolon
r_goto
id|done
suffix:semicolon
)brace
multiline_comment|/* Do another hwi test */
id|e100_mdi_write
c_func
(paren
id|bdp
...
op_increment
suffix:semicolon
multiline_comment|/* relaunch hwi timer in 1 msec */
id|mod_timer
c_func
(paren
op_amp
...
DECL|function|e100_hwi_restore
r_static
r_void
id|e100_hwi_restore
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Restore speed, duplex and autoneg before */
multiline_comment|/* hwi test, i.e., cable diagnostic         */
multiline_comment|/* Reset hwi test */
id|e100_mdi_write
c_func
(paren
id|bdp
...
multiline_comment|/* Restore original speed/duplex */
id|e100_mdi_write
c_func
(paren
id|bdp

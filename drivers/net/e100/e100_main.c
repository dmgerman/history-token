...
mdefine_line|#define E100_VERSION  &quot;2.0.20-pre1&quot;
...
mdefine_line|#define E100_PARAM_INIT { [0 ... E100_MAX_NIC-1] = -1 }
...
macro_line|#ifdef ETHTOOL_GWOL
multiline_comment|/* Set up wol options and enable PME */
id|e100_do_wol
c_func
(paren
id|pcid
...
suffix:semicolon
singleline_comment|// we unmap using DMA_TODEVICE to avoid another memcpy from the 
singleline_comment|// bounce buffer
id|pci_unmap_single
c_func
(paren
id|bdp-&gt;pdev

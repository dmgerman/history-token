...
(paren
id|KERN_ERR
l_string|&quot;e100: MDI write timeout&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
(brace
multiline_comment|/* return the lower word */
op_star
id|data
op_assign
(paren
...
(paren
id|KERN_ERR
l_string|&quot;e100: MDI read timeout&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
r_void
DECL|function|e100_force_speed_duplex_to_phy
...
multiline_comment|/* Send speed/duplex command to PHY layer. */
id|e100_mdi_write
c_func
(paren
id|bdp
...
r_void
DECL|function|e100_phy_autoneg
id|e100_phy_autoneg
c_func
(paren
r_struct
...
r_void
DECL|function|e100_phy_set_loopback
...
multiline_comment|/* &n; * Procedure: e100_update_link_state&n; * &n; * Description: This routine updates the link status of the adapter,&n; * &t;&t;also considering netif_running&n; *&n; * Arguments:  bdp - Pointer to the e100_private structure for the board&n; *&t;&t;    &n; *&n; * Returns: true - If a link is found&n; *&t;&t;false - If there is no link&n; *&n; */
r_int
r_char
...
id|link
suffix:semicolon
multiline_comment|/* Logical AND PHY link &amp; netif_running */
id|link
op_assign
id|e100_get_link_state
c_func

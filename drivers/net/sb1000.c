...
macro_line|#include &lt;linux/if_cablemodem.h&gt; /* for SIOGCM/SIOSCM stuff */
...
r_static
r_int
DECL|function|sb1000_probe_one
id|sb1000_probe_one
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/*&n;&t; * The SB1000 is an rx-only cable modem device.  The uplink is a modem&n;&t; * and we do not want to arp on it.&n;&t; */
id|dev-&gt;flags
op_assign
id|IFF_POINTOPOINT
op_or
...
r_static
r_void
DECL|function|sb1000_remove_one
id|sb1000_remove_one
c_func
(paren
r_struct
id|pnp_dev

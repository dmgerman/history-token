...
multiline_comment|/* We have to ioremap every checked address, because isa_readb is &n; * going away. &n; */
...
DECL|function|ibmtr_cleanup_card
r_static
r_void
id|ibmtr_cleanup_card
c_func
(paren
r_struct
id|net_device
...
DECL|function|ibmtr_probe_card
r_int
id|ibmtr_probe_card
c_func
(paren

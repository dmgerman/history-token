...
op_assign
id|KERN_INFO
l_string|&quot;smctr.c: v1.4 7/12/00 by jschlst@samba.org&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/* Check for a network adapter of this type, &n; * and return device structure if one exists.&n; */

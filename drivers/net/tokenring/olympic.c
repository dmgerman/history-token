...
suffix:semicolon
multiline_comment|/* Change network_monitor to receive mac frames through the arb channel.&n; * Will also create a /proc/net/olympic_tr%d entry, where %d is the tr&n; * device, i.e. tr0, tr1 etc. &n; * Intended to be used to create a ring-error reporting network module &n; * i.e. it will give you the source address of beaconers on the ring &n; */
DECL|variable|network_monitor
r_static
r_int
id|network_monitor
(braket
...
c_func
(paren
l_string|&quot;Olympic: %s registered as: %s&bslash;n&quot;
comma
id|olympic_priv-&gt;olympic_card_name
comma
id|dev-&gt;name
...
(brace
multiline_comment|/* Must go after register_netdev as we need the device name */
r_char
id|proc_name
(braket
l_int|20
...
c_func
(paren
l_string|&quot;Olympic: Network Monitor information: /proc/%s&bslash;n&quot;
comma
id|proc_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s. I/O at %hx, MMIO at %p, LAP at %p, using irq %d&bslash;n&quot;
comma
id|olympic_priv-&gt;olympic_card_name
comma
(paren
...
suffix:semicolon
multiline_comment|/* Test OR of first 3 bytes as its totally possible for &n;&t;&t; * someone to set the first 2 bytes to be zero, although this &n;&t;&t; * is an error, the first byte must have bit 6 set to 1  */
r_if
c_cond
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Signal received in open.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;SISR=%x LISR=%x&bslash;n&quot;
comma
id|readl
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Invalid LAA: %02x:%02x:%02x:%02x:%02x:%02x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|olympic_priv-&gt;olympic_laa
...
suffix:semicolon
id|olympic_priv-&gt;rx_status_ring_dma_addr
op_assign
id|pci_map_single
c_func
(paren
...
id|OLYMPIC_TX_RING_SIZE
suffix:semicolon
id|olympic_priv-&gt;tx_ring_dma_addr
op_assign
id|pci_map_single
c_func
(paren
...
suffix:semicolon
id|olympic_priv-&gt;tx_status_ring_dma_addr
op_assign
id|pci_map_single
c_func
(paren
...
suffix:semicolon
multiline_comment|/* clean the eisr */
id|writel
c_func
(paren
l_int|0
...
suffix:semicolon
multiline_comment|/* enables most of the TX error interrupts */
id|writel
c_func
(paren
id|SISR_TX1_EOF
...
suffix:semicolon
multiline_comment|/* unmap buffer */
id|pci_unmap_single
c_func
(paren
id|olympic_priv-&gt;pdev
...
suffix:semicolon
multiline_comment|/* &n;&t; *  Read sisr but don&squot;t reset it yet. &n;&t; *  The indication bit may have been set but the interrupt latch&n;&t; *  bit may not be set, so we&squot;d lose the interrupt later. &n;&t; */
id|sisr
op_assign
id|readl
c_func
...
suffix:semicolon
multiline_comment|/* Read &amp; Reset sisr */
id|spin_lock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Hotswap gives us this on removal */
r_if
c_cond
(paren
id|sisr
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Hotswap adapter removal.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(brace
multiline_comment|/* If we ever get this the adapter is seriously dead. Only a reset is going to &n;&t;&t; * bring it back to life. We&squot;re talking pci bus errors and such like :( */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;Olympic: EISR Error, EISR=%08x&bslash;n&quot;
comma
id|readl
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;The adapter must be reset to clear this condition.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_ERR
l_string|&quot;Please report this error to the driver maintainer and/&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_ERR
l_string|&quot;or the linux-tr mailing list.&bslash;n&quot;
)paren
suffix:semicolon
id|olympic_freemem
c_func
...
multiline_comment|/* We shouldn&squot;t ever miss the Tx interrupt, but the you never know, hence the loop to ensure&n;&t;&t;   we get all tx completions. */
r_if
c_cond
(paren
id|sisr
...
(paren
id|KERN_WARNING
l_string|&quot;%s: SRB timed out. May not be fatal. &bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
id|buffer
comma
l_string|&quot;IBM Pit/Pit-Phy/Olympic Chipset Token Ring Adapter %s&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
DECL|function|olympic_remove_one
r_static
r_void
id|__devexit
...
DECL|function|olympic_pci_cleanup
r_static
r_void
id|__exit
id|olympic_pci_cleanup
c_func
(paren
r_void
)paren
...
DECL|variable|olympic_pci_init
id|module_init
c_func
(paren
id|olympic_pci_init
...
suffix:semicolon
DECL|variable|olympic_pci_cleanup
id|module_exit
c_func
(paren
id|olympic_pci_cleanup

...
multiline_comment|/* #define CONFIG_PROC_FS */
multiline_comment|/*&n; *  Allow or disallow ioctl&squot;s for debugging&n; */
DECL|macro|STREAMER_IOCTL
mdefine_line|#define STREAMER_IOCTL 0
...
l_string|&quot;              v0.5.1 03/04/02 - Kent Yoder&quot;
suffix:semicolon
...
macro_line|#endif
macro_line|#endif
DECL|function|streamer_init_one
r_static
r_int
id|__devinit
id|streamer_init_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;lanstreamer::streamer_init_one, entry pdev %p&bslash;n&quot;
comma
id|pdev
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;lanstreamer: unable to enable pci device&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
c_func
(paren
l_string|&quot;lanstreamer: pio_start %x pio_end %x pio_len %x pio_flags %x&bslash;n&quot;
comma
id|pio_start
comma
id|pio_end
...
c_func
(paren
l_string|&quot;lanstreamer: mmio_start %x mmio_end %x mmio_len %x mmio_flags %x&bslash;n&quot;
comma
id|mmio_start
comma
id|mmio_end
...
c_func
(paren
l_string|&quot;lanstreamer: Exit error %x&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
DECL|function|streamer_remove_one
r_static
r_void
id|__devexit
...
c_func
(paren
l_string|&quot;lanstreamer::streamer_remove_one entry pdev %p&bslash;n&quot;
comma
id|pdev
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;lanstreamer::streamer_remove_one, ERROR dev is NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;lanstreamer::streamer_remove_one, ERROR dev-&gt;priv is NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(brace
multiline_comment|/* According to the documentation, we don&squot;t have to do anything,  &n;                                 * but trapping it keeps it out of /var/log/messages.  &n;                                 */
)brace
...
suffix:semicolon
r_case
id|IOCTL_SPIN_LOCK_TEST
suffix:colon
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;spin_lock() called.&bslash;n&quot;
)paren
suffix:semicolon
id|spin_lock
c_func
...
(paren
id|KERN_INFO
l_string|&quot;spin_unlock() finished.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;bdas: RXBDA: %x RXLBDA: %x TX2FDA: %x TX2LFDA: %x&bslash;n&quot;
comma
id|readw
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;SISR: %04x MISR: %04x LISR: %04x BCTL: %04x BMCTL: %04x&bslash;nmask  %04x mask  %04x&bslash;n&quot;
comma
id|readw
c_func
(paren
...
suffix:semicolon
r_case
id|IOCTL_PRINT_RX_BUFS
suffix:colon
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;Print rx bufs:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(paren
id|KERN_INFO
l_string|&quot;rx_ring %d status: 0x%x&bslash;n&quot;
comma
id|i
comma
id|streamer_priv-&gt;streamer_rx_ring
...
suffix:semicolon
r_case
id|IOCTL_PRINT_TX_BUFS
suffix:colon
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;Print tx bufs:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(paren
id|KERN_INFO
l_string|&quot;tx_ring %d status: 0x%x&bslash;n&quot;
comma
id|i
comma
id|streamer_priv-&gt;streamer_tx_ring
...
(paren
id|KERN_INFO
l_string|&quot;Sent rx command.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
suffix:semicolon
DECL|function|streamer_init_module
r_static
r_int
id|__init
id|streamer_init_module
c_func
(paren
r_void
)paren
...
DECL|function|streamer_cleanup_module
r_static
r_void
id|__exit
id|streamer_cleanup_module
c_func
(paren
r_void
)paren
...
DECL|variable|streamer_init_module
id|module_init
c_func
(paren
id|streamer_init_module
...
suffix:semicolon
DECL|variable|streamer_cleanup_module
id|module_exit
c_func
(paren
id|streamer_cleanup_module

...
macro_line|#if 0 /* TMS380TR_DEBUG &gt; 0 */
r_static
r_int
id|madgemc_sifprobe
c_func
...
suffix:semicolon
multiline_comment|/* DMA buffer may be MMU driven */
id|tp-&gt;Tpl
(braket
id|i
)braket
...
(paren
id|KERN_INFO
l_string|&quot;%s: Adapter Download Failed&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: Hardware error&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: DMA failed&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: Status error: %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|Status
...
(paren
id|KERN_INFO
l_string|&quot;%s: Retry exceeded&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* Indicate the received frame to system the&n;&t;&t;&t; * adapter does the Source-Routing padding for &n;&t;&t;&t; * us. See: OpenOptions in tms380tr_init_opb()&n;&t;&t;&t; */
id|skb
op_assign
id|rpl-&gt;Skb
suffix:semicolon

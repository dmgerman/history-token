...
id|__devinitdata
op_assign
l_string|&quot;au1000eth.c:1.0 ppopov@mvista.com&bslash;n&quot;
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;au1000 eth: unknown Processor ID&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
singleline_comment|// check for valid entries, au1100 only has one entry
r_if
c_cond
(paren
id|base_addr
...
c_func
(paren
l_string|&quot;%s: Au1xxx ethernet found at 0x%lx, irq %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ioaddr

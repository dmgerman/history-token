...
id|options
comma
l_string|&quot;VIA Rhine: Bits 0-3: media type, bit 17: full duplex&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
suffix:semicolon
multiline_comment|/* Bits in ConfigD (select backoff algorithm (Ethernet capture effect)) */
DECL|enum|backoff_bits
r_enum
id|backoff_bits
(brace
DECL|enumerator|BackOpt
DECL|enumerator|BackAMD
DECL|enumerator|BackDEC
...
(paren
id|KERN_ERR
l_string|&quot;%s: reset did not complete in 10 ms.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: reset finished after %d microseconds.&bslash;n&quot;
comma
id|name
comma
l_int|5
...
id|byOrgValue
suffix:semicolon
multiline_comment|/* clear sticky bit before reset &amp; read ethernet address */
id|byOrgValue
op_assign
id|readb
c_func
...
suffix:semicolon
multiline_comment|/* (bits written are cleared?) */
...
suffix:semicolon
multiline_comment|/* clear power status (undocumented in vt6102 docs?) */
id|writeb
c_func
(paren
l_int|0xFF
...
suffix:semicolon
multiline_comment|/* Store &amp; forward */
...
DECL|function|via_rhine_ethtool_ioctl
r_static
r_int
id|via_rhine_ethtool_ioctl
(paren
r_struct
id|net_device
op_star

...
suffix:semicolon
macro_line|#ifndef USE_IO
multiline_comment|/* note this is ifdef&squot;d because the ioremap is ifdef&squot;d...&n; * so additional exit conditions above this must move&n; * pci_release_regions outside of the ifdef */
id|err_out_free_res
suffix:colon

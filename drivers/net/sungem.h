...
multiline_comment|/* Statistics Registers.  All of these registers are 16-bits and&n; * track occurrences of a specific event.  GEM can be configured&n; * to interrupt the host cpu when any of these counters overflow.&n; * They should all be explicitly initialized to zero when the interface&n; * is brought up.&n; */

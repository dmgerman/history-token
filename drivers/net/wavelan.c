...
id|range
suffix:semicolon
multiline_comment|/* Set the length (very important for backward&n;&t;&t;&t; * compatibility) */
...
suffix:semicolon
multiline_comment|/* Set all the info we don&squot;t care or don&squot;t know&n;&t;&t;&t; * about to zero */
id|memset
c_func
(paren
op_amp

...
id|phy_status
suffix:semicolon
multiline_comment|/* Should we enable that in generic mode ? */
id|lpar_ability
op_assign
id|mii_read
c_func
...
multiline_comment|/* Clear interrupts on 5201 */
r_if
c_cond
(paren
id|gm-&gt;phy_type
...
suffix:semicolon
multiline_comment|/* Drive MDIO high */
id|GM_OUT
c_func
(paren
id|GM_MIF_CFG
...
suffix:semicolon
multiline_comment|/* Unchanged, don&squot;t ask me why */
id|data
op_assign
id|mii_read
c_func
...
id|GM_MAC_RX_RESET
comma
id|GM_MAC_RX_RESET_NOW
)paren
suffix:semicolon
multiline_comment|/* Superisolate PHY */
r_if
c_cond
(paren
id|gm-&gt;phy_type
...
(paren
id|KERN_ERR
l_string|&quot;%s: Couldn&squot;t revive gmac ethernet !&bslash;n&quot;
comma
id|gm-&gt;dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* Early enable Tx and Rx so that we are clocked */
id|GM_BIS
c_func
(paren
id|GM_TX_CONF
...
(brace
multiline_comment|/* restart polling PHY */
id|mii_interrupt
c_func
(paren
id|gm
...
suffix:semicolon
multiline_comment|/* restart DMA operations */
id|gmac_start_dma
c_func
(paren
id|gm
...
r_else
(brace
multiline_comment|/* Driver not opened, just leave things off. Note that&n;&t;&t; * we could be smart and superisolate the PHY when the&n;&t;&t; * driver is closed, but I won&squot;t do that unless I have&n;&t;&t; * a better understanding of some electrical issues with&n;&t;&t; * this PHY chip --BenH&n;&t;&t; */
id|GM_OUT
c_func
(paren
id|GM_MAC_RX_CONFIG
...
r_static
r_void
DECL|function|mii_init_BCM5401
id|mii_init_BCM5401
c_func
(paren
r_struct
...
(paren
id|KERN_ERR
l_string|&quot;GMAC: failed to allocated dummy buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;GMAC: unable to map I/O registers&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_unreg

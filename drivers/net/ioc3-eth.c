...
multiline_comment|/*&n; * 32 RX buffers.  This is tunable in the range of 16 &lt;= x &lt; 512.  The&n; * value must be a power of two.&n; */
DECL|macro|RX_BUFFS
mdefine_line|#define RX_BUFFS 64
multiline_comment|/*&n; * Private ioctls that de facto are well known and used for examply&n; * by mii-tool.&n; */
...
(paren
id|KERN_CRIT
l_string|&quot;%s: Unable to map device I/O.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
id|ioc3_probe
comma
multiline_comment|/* remove:&t;&t;ioc3_remove_one, */
)brace
suffix:semicolon

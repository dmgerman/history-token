...
(paren
id|KERN_ERR
l_string|&quot;%s: parport_register failed&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: network register failed&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon

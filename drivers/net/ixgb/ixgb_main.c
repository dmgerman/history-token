...
DECL|macro|__IXGB_MAIN__
mdefine_line|#define __IXGB_MAIN__
...
comma
id|INTEL_SUBVENDOR_ID
comma
id|IXGB_SUBDEVICE_ID_A11F
comma
l_int|0
comma
l_int|0
...
op_assign
(brace
l_string|&quot;Intel(R) PRO/10GbE Network Connection&quot;
)brace
suffix:semicolon
...
c_func
(paren
l_string|&quot;ixgb_init_module&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;ixgb_exit_module&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/**&n; * ixgb_up - Driver ifconfig UP routine.&n; *&n; * ixgb_up is called to initialize and bring online an interface.&n; * @param adapter board private structure&n; **/
r_int
...
c_func
(paren
l_string|&quot;%s: request_irq failed&bslash;n&quot;
comma
id|netdev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* hardware was reset in probe/down, we need to reload some things */
id|ixgb_set_multi
c_func
(paren
id|netdev
...
c_func
(paren
l_string|&quot;ixgb_up: RAH_0 is &lt;%x&gt;&bslash;n&quot;
comma
id|IXGB_READ_REG
c_func
(paren
...
c_func
(paren
l_string|&quot;ixgb_up: RDBAL is &lt;%x&gt;&bslash;n&quot;
comma
id|IXGB_READ_REG
c_func
(paren
...
multiline_comment|/**&n; * ixgb_down - Driver ifconfig DOWN routine.&n; *&n; * ixgb_down is called to uninitialize and take offline an interface.&n; * @param adapter board private structure&n; * @param kill_watchdog&n; **/
r_void
...
multiline_comment|/**&n; * ixgb_reset - hardware reset.&n; *&n; * ixgb_reset is called to initialize hardware to a known state.&n; * @param adapter board private structure&n; **/
r_void
...
c_func
(paren
l_string|&quot;Failed to reserve PCI I/O and Memory resources.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|i
...
suffix:semicolon
multiline_comment|/* alloc_etherdev clears the memory for us */
id|netdev
op_assign
id|alloc_etherdev
c_func
...
c_func
(paren
l_string|&quot;Unable to allocate net_device struct&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
c_func
(paren
l_string|&quot;mmio_start&lt;%lx&gt; hw_addr&lt;%p&gt;&bslash;n&quot;
comma
id|mmio_start
comma
id|adapter-&gt;hw.hw_addr
...
c_func
(paren
l_string|&quot;Invalid EEPROM checksum.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_eeprom
...
c_func
(paren
l_string|&quot;Invalid MAC address in EEPROM.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_eeprom
...
suffix:semicolon
macro_line|#ifdef ETHTOOL_IDENTIFY
id|ixgb_identify_stop
c_func
(paren
id|adapter
)paren
...
multiline_comment|/**&n; * ixgb_sw_init - Initialize general software structures (struct ixgb_adapter).&n; * @param adapter board private structure to initialize&n; *&n; * ixgb_sw_init initializes the adapter private data structure.&n; * Fields are initialized based on PCI device information and&n; * OS network device settings (MTU size).&n; **/
r_static
r_void
id|__devinit
...
c_func
(paren
l_string|&quot;ixgb_sw_init&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* PCI config space info */
multiline_comment|/* FIXME: do not store, instead directly use struct pci_dev&n;&t; * where needed&n;&t; */
id|hw-&gt;vendor_id
op_assign
id|pdev-&gt;vendor
suffix:semicolon
...
c_func
(paren
l_string|&quot;ixgb_open: failed ixgb_setup_tx_resources.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_setup_tx
...
multiline_comment|/* allocate receive descriptors and buffers */
r_if
c_cond
(paren
id|ixgb_setup_rx_resources
...
c_func
(paren
l_string|&quot;ixgb_open: failed ixgb_setup_rx_resources.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_setup_rx
...
multiline_comment|/**&n; * ixgb_setup_tx_resources - allocate Tx resources (Descriptors).&n; * @param adapter board private structure&n; *&n; * Return 0 on success, negative on failure&n; **/
r_static
r_int
...
c_func
(paren
l_string|&quot;ixgb_setup_tx_resources&bslash;n&quot;
)paren
suffix:semicolon
id|size
op_assign
...
c_func
(paren
l_string|&quot;txdr-&gt;next_to_use = &lt;%p&gt;&bslash;n&quot;
comma
op_amp
id|txdr-&gt;next_to_use
)paren
...
c_func
(paren
l_string|&quot;txdr-&gt;next_to_clean = &lt;%p&gt;&bslash;n&quot;
comma
op_amp
...
c_func
(paren
l_string|&quot;ixgb_configure_tx&bslash;n&quot;
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_setup_rx_resources - allocate Rx resources (Descriptors).&n; * @param adapter board private structure&n; * &n; * Returns 0 on success, negative on failure&n; **/
r_static
r_int
...
c_func
(paren
l_string|&quot;ixgb_setup_rx_resources.&bslash;n&quot;
)paren
suffix:semicolon
id|size
op_assign
...
c_func
(paren
l_string|&quot;pci_alloc_consistent failed.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
c_func
(paren
l_string|&quot;rxdr-&gt;next_to_use = &lt;%p&gt;&bslash;n&quot;
comma
op_amp
id|rxdr-&gt;next_to_use
)paren
...
c_func
(paren
l_string|&quot;rxdr-&gt;next_to_clean = &lt;%p&gt;&bslash;n&quot;
comma
op_amp
...
multiline_comment|/**&n; * ixgb_setup_rctl - configure the receive control register.&n; * @param adapter Board private structure&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_setup_rctl&bslash;n&quot;
)paren
suffix:semicolon
id|rctl
op_and_assign
...
multiline_comment|/**&n; * ixgb_configure_rx - Configure 82597 Receive Unit after Reset.&n; * @param adapter board private structure&n; *&n; * Configure the Rx unit of the MAC after a reset.&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_configure_rx&bslash;n&quot;
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_free_tx_resources - Free Tx Resources.&n; * @param adapter board private structure&n; *&n; * Free all transmit software resources&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_free_tx_resources&bslash;n&quot;
)paren
suffix:semicolon
id|ixgb_clean_tx_ring
c_func
...
multiline_comment|/**&n; * ixgb_clean_tx_ring - Free Tx Buffers.&n; * @param adapter board private structure&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_clean_tx_ring&bslash;n&quot;
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_free_rx_resources - Free Rx Resources.&n; * @param adapter board private structure&n; *&n; * Free all receive software resources&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_free_rx_resources&bslash;n&quot;
)paren
suffix:semicolon
id|ixgb_clean_rx_ring
c_func
...
multiline_comment|/**&n; * ixgb_clean_rx_ring - Free Rx Buffers.&n; * @param adapter board private structure&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_free_rx_ring&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ixgb_set_multi &lt;%x&gt;&bslash;n&quot;
comma
id|netdev-&gt;flags
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_watchdog - Timer Call-back.&n; * @param data pointer to adapter cast into an unsigned long&n; **/
r_void
...
mdefine_line|#define IXGB_TX_FLAGS_CSUM&t;0x00000001
DECL|macro|IXGB_TX_FLAGS_VLAN
mdefine_line|#define IXGB_TX_FLAGS_VLAN&t;0x00000002
DECL|macro|IXGB_TX_FLAGS_TSO
mdefine_line|#define IXGB_TX_FLAGS_TSO&t;0x00000004
multiline_comment|/** Transmit Segmentation offload setup.&n; * ixgb_tso - (Large Send) setup where the initial descriptor is prepared&n; * @param adapter adapter specific information&n; * @param skb the skb we are trying to set up for segmentation&n; **/
r_static
r_inline
id|boolean_t
...
multiline_comment|/**&n; * ixgb_tx_csum - prepare context descriptor for checksum offload.&n; *&n; * ixgb_tx_csum is called to prepare for checksumming a packet in hw.&n; * @param adapter board private structure&n; * @param skb structure containing data to send&n; **/
r_static
r_inline
id|boolean_t
...
multiline_comment|/**&n; * ixgb_tx_map - private function for mapping send data to hardware addresses.&n; *&n; * @param adapter board private structure&n; * @param skb structure containing data to send&n; **/
r_static
r_inline
r_int
...
multiline_comment|/**&n; * ixgb_tx_queue - private function to start transmit on hardware.&n; *&n; * @param adapter board private structure&n; * @param count number of tx_descriptors to initialize (consume)&n; * @param vlan_id the vlan tag to insert (if necessary)&n; * @param tx_flags special handling for this transmit, if any&n; **/
r_static
r_inline
r_void
...
multiline_comment|/**&n; * ixgb_xmit_frame - hard_start_xmit linked function, transmit entry point.&n; *&n; * ixgb_xmit_frame is called to send an skb on the wire.&n; * @param skb contains data to send&n; * @param netdev network interface device structure &n; **/
r_static
r_int
...
multiline_comment|/**&n; * ixgb_tx_timeout - Respond to a Tx Hang by resetting the adapter.&n; * @param netdev network interface device structure&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_tx_timeout&bslash;n&quot;
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_tx_timeout_task - worker function to reset hardware and dump queues.&n; * This function is pointed to by adapter-&gt;tx_timeout_task&n; *&n; * @param netdev network interface device structure &n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;ixgb_tx_timeout_task&bslash;n&quot;
)paren
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_get_stats - Get System Network Statistics.&n; * @param netdev network interface device structure&n; *&n; * Returns the address of the device statistics structure.&n; * The statistics are actually updated from the timer callback.&n; **/
r_static
r_struct
id|net_device_stats
op_star
...
multiline_comment|/**&n; * ixgb_change_mtu - Change the Maximum Transfer Unit.&n; * @param netdev network interface device structure&n; * @param new_mtu new value for maximum frame size&n; *&n; * Returns 0 on success, negative on failure&n; **/
r_static
r_int
...
c_func
(paren
l_string|&quot;ixgb_change_mtu&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;%s: ixgb_change_mtu MFS is set to &lt;%x&gt;&bslash;n&quot;
comma
...
multiline_comment|/**&n; * ixgb_set_mac - Change the Ethernet Address of the NIC.&n; * @param netdev network interface device structure&n; * @param p pointer to an address structure&n; * &n; * Returns 0 on success, negative on failure&n; **/
r_static
r_int
...
c_func
(paren
l_string|&quot;ixgb_set_mac&bslash;n&quot;
)paren
suffix:semicolon
id|memcpy
c_func
...
multiline_comment|/**&n; * ixgb_update_stats - Update the board statistics counters.&n; * @param adapter board private structure&n; **/
r_static
r_void
...
multiline_comment|/**&n; * ixgb_irq_disable - Mask off interrupt generation on the NIC&n; * @param adapter board private structure&n; **/
r_static
r_inline
r_void
...
c_func
(paren
l_string|&quot;ixgb_irq_disable&bslash;n&quot;
)paren
suffix:semicolon
id|atomic_inc
c_func
...
multiline_comment|/**&n; * ixgb_irq_enable - Enable default interrupt generation settings.&n; * @param adapter board private structure&n; **/
r_static
r_inline
r_void
...
c_func
(paren
l_string|&quot;ixgb_irq_enable&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
multiline_comment|/**&n; * ixgb_intr - Interrupt Handler.&n; * @param irq interrupt number&n; * @param data pointer to a network interface device structure&n; * @param regs CPU registers structure&n; **/
r_static
id|irqreturn_t
...
id|IRQ_HANDLED
suffix:semicolon
multiline_comment|/* FIXME: check for shared interrupts */
macro_line|#else
r_struct
id|ixgb_hw
op_star
...
multiline_comment|/* adapter-&gt;generate_int = 0; */
id|ixgb_clean_rx_irq
c_func
(paren
id|adapter
...
r_static
r_int
DECL|function|ixgb_process_intr
...
macro_line|#endif
multiline_comment|/**&n; * ixgb_clean_tx_irq - Reclaim resources after transmit completes.&n; * @param adapter board private structure&n; **/
r_static
r_void
...
c_func
(paren
l_string|&quot;Receive Errors Reported by Hardware-%x.&bslash;n&quot;
comma
id|rx_desc-&gt;errors
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* NOTE: RAIDC will be automatically restarted by this enable */
id|ixgb_irq_enable
c_func
(paren
id|adapter
...
macro_line|#else
multiline_comment|/**&n; * ixgb_clean_rx_irq - Send received data up the network stack.&n; * @param adapter board private structure&n; **/
r_static
r_void
...
macro_line|#endif
multiline_comment|/**&n; * ixgb_alloc_rx_buffers - Replace used receive buffers.&n; * @param adapter address of board private structure&n; **/
r_static
r_void
...
suffix:semicolon
multiline_comment|/* allocate a new one */
id|skb
op_assign
id|dev_alloc_skb
c_func
...
(brace
multiline_comment|/* better luck next time around */
id|IXGB_DBG
c_func
(paren
l_string|&quot;Could not allocate SKB&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
multiline_comment|/**&n; * ixgb_ioctl - perform a command - e.g: ethtool:get_driver_info.&n; * @param netdev network interface device structure&n; * @param ifr data to be used/filled in by the ioctl command&n; * @param cmd ioctl command to execute&n; **/
r_int
DECL|function|ixgb_ioctl
id|ixgb_ioctl
c_func
(paren
r_struct
...
multiline_comment|/**&n; * ixgb_vlan_rx_add_vid - adds a vlan id to be tagged/stripped in packet data.&n; * @param netdev network interface device structure&n; * @param vid the vlan to be added&n; **/
r_static
r_void
...
multiline_comment|/**&n; * ixgb_vlan_rx_kill_vid - removes a vlan id from tag/strip tables.&n; * @param netdev network interface device structure&n; * @param vid the vlan to be deleted&n; **/
r_static
r_void
...
multiline_comment|/**&n; * ixgb_restore_vlan - restores vlan settings after adapter reset.&n; * @param adapter the address of the board private structure&n; **/
r_static
r_void
...
multiline_comment|/**&n; * ixgb_rx_checksum - Receive Checksum Offload for 82597.&n; * @param adapter board private structure&n; * @param rx_desc receive descriptor&n; * @param skb socket buffer with received data&n; **/
r_static
r_inline
r_void
...
multiline_comment|/* At this point we know the hardware did the TCP checksum &n;&t; * now look at the TCP checksum error bit&n;&t; */
r_if
c_cond
(paren
id|rx_desc-&gt;errors
...
multiline_comment|/**&n; * ixgb_write_pci_cfg - write PCI configuration space.&n; * @param hw board specific data structure&n; * @param reg PCI configuration space register to write to&n; * @param value Value to be written to reg&n; **/
r_void
DECL|function|ixgb_write_pci_cfg

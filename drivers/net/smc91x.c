...
id|lock
suffix:semicolon
macro_line|#ifdef SMC_CAN_USE_DATACS
DECL|member|datacs
id|u32
id|__iomem
op_star
...
multiline_comment|/*&n; * smc_phy_powerdown - powerdown phy&n; * @dev: net device&n; *&n; * Power down the specified PHY&n; */
...
r_return
suffix:semicolon
multiline_comment|/* We need to ensure that no calls to smc_phy_configure are&n;&t;   pending.&n;&n;&t;   flush_scheduled_work() cannot be called because we are&n;&t;   running with the netlink semaphore held (from&n;&t;   devinet_ioctl()) and the pending work queue contains&n;&t;   linkwatch_event() (scheduled by netif_carrier_off()&n;&t;   above). linkwatch_event() also wants the netlink semaphore.&n;&t;*/
r_while
c_loop
(paren
id|lp-&gt;work_pending
...
(brace
multiline_comment|/*XXX: WTF? */
id|printk
c_func
(paren
l_string|&quot;%s: IOADDR %p doesn&squot;t match configuration (%x).&bslash;n&quot;
comma
id|CARDNAME
comma
id|ioaddr
...
c_func
(paren
l_string|&quot;%s: IO %p: Unrecognized revision register 0x%04x&quot;
...
DECL|function|smc_request_attrib
r_static
r_int
id|smc_request_attrib
c_func
(paren
r_struct
id|platform_device
...
DECL|function|smc_release_attrib
r_static
r_void
id|smc_release_attrib
c_func
(paren
r_struct
id|platform_device
...
macro_line|#ifdef SMC_CAN_USE_DATACS
DECL|function|smc_request_datacs
r_static
r_void
id|smc_request_datacs
c_func
(paren
r_struct
id|platform_device
...
(paren
id|KERN_INFO
l_string|&quot;%s: failed to request datacs memory region.&bslash;n&quot;
comma
id|CARDNAME
)paren
suffix:semicolon
...
DECL|function|smc_release_datacs
r_static
r_void
id|smc_release_datacs
c_func
(paren
r_struct
id|platform_device

...
DECL|function|veth_stop_connection
r_static
r_void
id|veth_stop_connection
c_func
(paren
id|u8
id|rlp
...
suffix:semicolon
multiline_comment|/* Hypervisor callbacks may have scheduled more work while we&n;&t; * were destroying connections. Now that we&squot;ve disconnected from&n;&t; * the hypervisor make sure everything&squot;s finished. */
id|flush_scheduled_work
c_func
(paren
)paren

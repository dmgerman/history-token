...
id|max_interrupt_work
comma
l_string|&quot;8139too maximum events handled per interrupt&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
(paren
...
id|CSCR_LinkChangeBit
suffix:semicolon
multiline_comment|/* The chip takes special action when we clear RxAckBits,&n;&t;&t; * so we clear them later in rtl8139_rx_interrupt&n;&t;&t; */
id|ackstat
op_assign
id|status
op_amp
...
multiline_comment|/* Get the ethtool settings.  Assumes that eset points to kernel&n;   memory, *eset has been initialized as {ETHTOOL_GSET}, and other&n;   threads or interrupts aren&squot;t messing with the 8139.  */
DECL|function|netdev_get_eset
r_static
r_void
id|netdev_get_eset
(paren
...
l_int|100
suffix:semicolon
multiline_comment|/* (KON)FIXME: np-&gt;full_duplex is set or reset by the thread,&n;&t;   which means this always shows half duplex if the interface&n;&t;   isn&squot;t up yet, even if it has already autonegotiated.  */
id|eset-&gt;duplex
op_assign
id|np-&gt;full_duplex
ques
...
id|PORT_TP
suffix:semicolon
multiline_comment|/* (KON)FIXME: Is np-&gt;phys[0] correct?  starfire.c uses that.  */
id|eset-&gt;phy_address
op_assign
id|np-&gt;phys
(braket
...
multiline_comment|/* TODO: ETHTOOL_SSET */
r_case
id|ETHTOOL_GDRVINFO
suffix:colon
(brace
...
id|SIOCDEVPRIVATE
suffix:colon
multiline_comment|/* binary compat, remove in 2.5 */
id|data-&gt;phy_id
op_assign
id|phy
suffix:semicolon
...
l_int|4
suffix:colon
multiline_comment|/* tp-&gt;advertising = value; */
r_break
suffix:semicolon
)brace
)brace

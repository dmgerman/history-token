...
id|regs_len
suffix:semicolon
DECL|member|fifo_copy_timeout
r_int
r_int
id|fifo_copy_timeout
suffix:semicolon
)brace
suffix:semicolon
id|MODULE_AUTHOR
...
l_int|NULL
suffix:semicolon
multiline_comment|/* dev and priv zeroed in alloc_etherdev */
id|dev
op_assign
id|alloc_etherdev
(paren
...
id|pdev-&gt;irq
suffix:semicolon
multiline_comment|/* tp zeroed and aligned in alloc_etherdev */
id|tp
op_assign
id|netdev_priv
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: fifo copy in progress.&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
id|cur_rx
suffix:semicolon
multiline_comment|/*&n;&t; * The receive buffer should be mostly empty.&n;&t; * Tell NAPI to reenable the Rx irq.&n;&t; */
r_if
c_cond
(paren
id|tp-&gt;fifo_copy_timeout

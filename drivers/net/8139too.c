...
id|KERN_ERR
id|PFX
l_string|&quot;%s: Invalid PCI region size(s), aborting&bslash;n&quot;
comma
id|pdev-&gt;slot_name
)paren
suffix:semicolon
...
id|KERN_ERR
id|PFX
l_string|&quot;%s: PIO not enabled, Cfg1=%02X, aborting&bslash;n&quot;
comma
id|pdev-&gt;slot_name
comma
id|tmp8
...
id|KERN_ERR
id|PFX
l_string|&quot;%s: MMIO not enabled, Cfg1=%02X, aborting&bslash;n&quot;
comma
id|pdev-&gt;slot_name
comma
id|tmp8
...
l_int|0
suffix:semicolon
multiline_comment|/* This is check_duplex() */
r_if
c_cond
(paren
id|tp-&gt;phys

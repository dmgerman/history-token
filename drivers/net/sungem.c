multiline_comment|/* $Id: sungem.c,v 1.8 2001/03/22 22:48:51 davem Exp $&n; * sungem.c: Sun GEM ethernet driver.&n; *&n; * Copyright (C) 2000, 2001 David S. Miller (davem@redhat.com)&n; */
...
suffix:semicolon
multiline_comment|/* XXX Set up PCS MII Control and Serialink Control&n;&t;&t; * XXX registers.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_else
(brace
multiline_comment|/* XXX Code PCS support... XXX */
)brace
r_if
c_cond
(paren

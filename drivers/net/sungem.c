...
mdefine_line|#define DRV_VERSION&t;&quot;0.96&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&quot;11/17/01&quot;
...
(paren
id|KERN_INFO
l_string|&quot;%s: Got link after fallback, retrying autoneg&quot;
l_string|&quot; once...&bslash;n&quot;
comma
id|gp-&gt;dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* Hrm... we may walk on the reset task here... */
id|netif_wake_queue
c_func
(paren
id|dev
...
macro_line|#endif
multiline_comment|/* Non Apple hardware, we just reset the chip and check&n;&t; * for invariants&n;&t; */
r_if
c_cond
(paren
id|pdev-&gt;vendor

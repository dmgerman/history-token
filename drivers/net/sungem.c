multiline_comment|/* $Id: sungem.c,v 1.22 2001/10/09 02:24:33 davem Exp $&n; * sungem.c: Sun GEM ethernet driver.&n; *&n; * Copyright (C) 2000, 2001 David S. Miller (davem@redhat.com)&n; */

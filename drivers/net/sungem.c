multiline_comment|/* $Id: sungem.c,v 1.44.2.22 2002/03/13 01:18:12 davem Exp $&n; * sungem.c: Sun GEM ethernet driver.&n; *&n; * Copyright (C) 2000, 2001, 2002 David S. Miller (davem@redhat.com)&n; * &n; * Support for Apple GMAC and assorted PHYs by&n; * Benjamin Herrenscmidt (benh@kernel.crashing.org)&n; * &n; * TODO: &n; *  - Get rid of all those nasty mdelay&squot;s and replace them&n; * with schedule_timeout.&n; *  - Implement WOL&n; */
...
id|gp-&gt;phy_mii.advertising
suffix:semicolon
multiline_comment|/* If we started with a forced mode, we don&squot;t have a default&n;&t;&t;&t; * advertise set, we need to return something sensible so&n;&t;&t;&t; * userland can re-enable autoneg properly */
r_if
c_cond
(paren
id|ecmd.advertising

...
id|flags
suffix:semicolon
multiline_comment|/* Swallow interrupts when shutting the chip down */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Must be invoked under gp-&gt;lock and dev-&gt;xmit_lock. */
...
id|SPEED_10
suffix:semicolon
multiline_comment|/* If HW is down, we don&squot;t try to actually setup the PHY, we&n;&t; * just store the settings&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* A link-up condition has occurred, initialize and enable the&n; * rest of the chip.&n; *&n; * Must be invoked under gp-&gt;lock and dev-&gt;xmit_lock.&n; */
...
(brace
multiline_comment|/* Some PHYs used by apple have problem getting back to us,&n;&t;&t;&t; * we _know_ it&squot;s actually at addr 0 or 1, that&squot;s a hack, but&n;&t;&t;&t; * it helps to do that reset now. I suspect some motherboards&n;&t;&t;&t; * don&squot;t wire the PHY reset line properly, thus the PHY doesn&squot;t&n;&t;&t;&t; * come back with the above pmac_call_feature.&n;&t;&t;&t; */
id|gp-&gt;mii_phy_addr
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We should probably break some locks here and schedule... */
id|mdelay
c_func
(paren
l_int|10
...
suffix:semicolon
multiline_comment|/* On K2, we only probe the internal PHY at address 1, other&n;&t;&t;&t; * addresses tend to return garbage.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|gp-&gt;pdev-&gt;device
...
multiline_comment|/* Must be invoked under dev-&gt;xmit_lock. */
r_static
id|u32
...
(brace
multiline_comment|/* Make us not-running to avoid timers respawning&n;&t; * and swallow irqs &n;&t; */
id|gp-&gt;hw_running
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Detect &amp; init PHY, start autoneg */
id|spin_lock_irq
c_func
(paren
op_amp

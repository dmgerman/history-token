multiline_comment|/* $Id: sungem.c,v 1.30 2001/10/17 06:55:10 davem Exp $&n; * sungem.c: Sun GEM ethernet driver.&n; *&n; * Copyright (C) 2000, 2001 David S. Miller (davem@redhat.com)&n; */
...
id|__devinitdata
op_assign
l_string|&quot;sungem.c:v0.95 16/Oct/01 David S. Miller (davem@redhat.com)&bslash;n&quot;
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
...
comma
multiline_comment|/* These models only differ from the original GEM in&n;&t; * that their tx/rx fifos are of a different size and&n;&t; * they only support 10/100 speeds. -DaveM&n;&t; * &n;&t; * Apple&squot;s GMAC does support gigabit on machines with&n;&t; * the BCM5400 or 5401 PHYs. -BenH&n;&t; */
(brace
id|PCI_VENDOR_ID_SUN
comma
...
id|val
op_amp
id|PHY_BCM5400_AUXSTATUS_LINKMODE_MASK
)paren
op_rshift
id|PHY_BCM5400_AUXSTATUS_LINKMODE_SHIFT
suffix:semicolon
id|full_duplex
op_assign
id|phy_BCM5400_link_table
...
id|gp
comma
id|PHY_BCM5400_AUXCONTROL
)paren
suffix:semicolon
id|data
op_or_assign
id|PHY_BCM5400_AUXCONTROL_PWR10BASET
suffix:semicolon
id|phy_write
c_func
(paren
...
id|gp
comma
id|PHY_BCM5400_GB_CONTROL
)paren
suffix:semicolon
id|data
op_or_assign
id|PHY_BCM5400_GB_CONTROL_FULLDUPLEXCAP
suffix:semicolon
id|phy_write
c_func
(paren
...
id|data
op_or_assign
id|PHY_BCM5201_MULTIPHY_SERIALMODE
suffix:semicolon
id|__phy_write
c_func
(paren
...
suffix:semicolon
multiline_comment|/* XXX Why do I do this? -DaveM XXX */
id|cfg
op_or_assign
...
id|mif_cfg
suffix:semicolon
multiline_comment|/* On Apple&squot;s sungem, we can&squot;t realy on registers as the chip&n;&t; * was been powered down by the firmware. We do the PHY lookup&n;&t; * when the interface is opened and we configure the driver&n;&t; * with known values.&n;&t; */
r_if
c_cond
(paren
id|pdev-&gt;vendor
...
multiline_comment|/* On Apple&squot;s, we might not access the hardware at that point */
r_if
c_cond
(paren
id|pdev-&gt;vendor

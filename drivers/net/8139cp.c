...
id|rx_copybreak
comma
l_string|&quot;8139cp Breakpoint at which Rx packets are copied&quot;
)paren
suffix:semicolon
DECL|macro|PFX
...
DECL|macro|CP_CHIP_VERSION
mdefine_line|#define CP_CHIP_VERSION&t;&t;0x76

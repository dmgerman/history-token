...
multiline_comment|/* NIC register dump */
r_case
id|ETHTOOL_GREGS
suffix:colon
(brace
...
multiline_comment|/* get/set RX checksumming */
r_case
id|ETHTOOL_GRXCSUM
suffix:colon
(brace
...
multiline_comment|/* get/set TX checksumming */
r_case
id|ETHTOOL_GTXCSUM
suffix:colon
(brace
...
multiline_comment|/* get/set scatter-gather */
r_case
id|ETHTOOL_GSG
suffix:colon
(brace
...
multiline_comment|/* get string list(s) */
r_case
id|ETHTOOL_GSTRINGS
suffix:colon
(brace
...
multiline_comment|/* get NIC-specific statistics */
r_case
id|ETHTOOL_GSTATS
suffix:colon
(brace
...
multiline_comment|/* get/set Wake-on-LAN settings */
r_case
id|ETHTOOL_GWOL
suffix:colon
(brace
...
multiline_comment|/* we don&squot;t care about duplex change, fixup rc */
id|rc
op_assign
l_int|0
suffix:semicolon

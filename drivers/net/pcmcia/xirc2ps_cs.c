...
DECL|variable|xirc2ps_cs_driver
r_static
r_struct
id|pcmcia_driver
...
DECL|function|setup_xirc2ps_cs
r_static
r_int
id|__init
id|setup_xirc2ps_cs
...
(brace
multiline_comment|/* irq, irq_mask, if_port, full_duplex, do_sound, lockup_hack&n;&t; * [,irq2 [,irq3 [,irq4]]]&n;&t; */
r_int
id|ints
(braket
l_int|10
...
mdefine_line|#define MAYBE_SET(X,Y) if (ints[0] &gt;= Y &amp;&amp; ints[Y] != -1) { X = ints[Y]; }
id|MAYBE_SET
c_func
(paren
id|irq_list

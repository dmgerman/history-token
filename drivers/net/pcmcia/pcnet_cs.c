...
id|version
op_assign
l_string|&quot;pcnet_cs.c 1.153 2003/11/09 18:53:09 (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
c_func
(paren
l_string|&quot;NE2000 compatible PCMCIA ethernet driver&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
DECL|macro|AM79C9XX_HOME_PHY
mdefine_line|#define AM79C9XX_HOME_PHY&t;0x00006B90  /* HomePNA PHY */
DECL|macro|AM79C9XX_ETH_PHY
mdefine_line|#define AM79C9XX_ETH_PHY&t;0x00006B70  /* 10baseT PHY */
DECL|macro|MII_PHYID_REV_MASK
mdefine_line|#define MII_PHYID_REV_MASK&t;0xfffffff0
DECL|macro|MII_PHYID_REG1
mdefine_line|#define MII_PHYID_REG1&t;&t;0x02
DECL|macro|MII_PHYID_REG2
mdefine_line|#define MII_PHYID_REG2&t;&t;0x03
...
(paren
id|KERN_NOTICE
l_string|&quot;pcnet_cs: this is an AX88190 card!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_NOTICE
l_string|&quot;pcnet_cs: use axnet_cs instead.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
DECL|macro|DLINK_EEPROM
mdefine_line|#define DLINK_EEPROM&t;&t;0x1e
...
multiline_comment|/*======================================================================&n;&n;    EEPROM access routines for DL10019 and DL10022 based cards&n;&n;======================================================================*/
DECL|macro|EE_EEP
mdefine_line|#define EE_EEP&t;&t;0x40
DECL|macro|EE_ASIC
mdefine_line|#define EE_ASIC&t;&t;0x10
DECL|macro|EE_CS
mdefine_line|#define EE_CS&t;&t;0x08
DECL|macro|EE_CK
mdefine_line|#define EE_CK&t;&t;0x04
DECL|macro|EE_DO
mdefine_line|#define EE_DO&t;&t;0x02
DECL|macro|EE_DI
mdefine_line|#define EE_DI&t;&t;0x01
DECL|macro|EE_ADOT
mdefine_line|#define EE_ADOT&t;&t;0x01&t;/* DataOut for ASIC */
DECL|macro|EE_READ_CMD
mdefine_line|#define EE_READ_CMD&t;0x06
DECL|macro|DL19FDUPLX
mdefine_line|#define DL19FDUPLX&t;0x0400&t;/* DL10019 Full duplex mode */
...
multiline_comment|/*&n;    The internal ASIC registers can be changed by EEPROM READ access&n;    with EE_ASIC bit set.&n;    In ASIC mode, EE_ADOT is used to output the data to the ASIC.&n;*/
DECL|function|write_asic
r_static
r_void
id|write_asic
c_func
...
multiline_comment|/* Terminate the ASIC access. */
id|outb
c_func
(paren
id|EE_ASIC
...
l_int|0
comma
l_string|&quot;%s: MII at %d is 0x%08x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|i
...
(paren
id|KERN_INFO
l_string|&quot;%s: link partner did not &quot;
...
(brace
multiline_comment|/* isolate this MII and try flipping to the other one */
id|mdio_write
c_func
(paren
id|mii_addr
...
(paren
id|KERN_INFO
l_string|&quot;%s: switched to %s transceiver&bslash;n&quot;
comma
id|dev-&gt;name
comma
(paren

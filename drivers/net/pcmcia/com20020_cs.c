...
suffix:semicolon
multiline_comment|/*&n;&t; * this is necessary because we register our IRQ separately&n;&t; * from card services.&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;irq
...
suffix:semicolon
multiline_comment|/* calls register_netdev */
r_if
c_cond
(paren
id|i
...
DECL|variable|com20020_cs_driver
r_static
r_struct
id|pcmcia_driver
id|com20020_cs_driver
op_assign
(brace
dot
id|owner

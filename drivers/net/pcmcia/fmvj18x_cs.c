...
c_func
(paren
l_string|&quot;fmvj18x and compatible PCMCIA ethernet driver&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
suffix:semicolon
multiline_comment|/*&n;    LAN controller(MBH86960A) specific routines&n; */
r_static
r_int
id|fjn_config
c_func
...
mdefine_line|#define CONFIG0_RST          0xda /* Data Link Controller off (CONFIG_0) */
DECL|macro|CONFIG0_RST_1
mdefine_line|#define CONFIG0_RST_1        0xde /* Data Link Controller off (CONFIG_0) */
DECL|macro|BANK_0
...
DECL|macro|INTR_OFF
mdefine_line|#define INTR_OFF             0x0d /* LAN controller ignores interrupts */
DECL|macro|INTR_ON
mdefine_line|#define INTR_ON              0x1d /* LAN controller will catch interrupts */
...
(paren
id|KERN_NOTICE
l_string|&quot;fmvj18x_cs: out of resource for serial&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|ret
...
DECL|function|ungermann_try_io_port
r_static
r_int
id|ungermann_try_io_port
c_func
(paren
id|dev_link_t
op_star
...
id|ret
suffix:semicolon
multiline_comment|/* RequestIO failed */
)brace
...
l_int|33
suffix:semicolon
multiline_comment|/* inserted in 3.3V slot */
)brace
r_else
r_if
c_cond
...
op_eq
id|PRODID_TDK_GN3410
)paren
(brace
multiline_comment|/* MultiFunction Card */
id|link-&gt;conf.ConfigBase
op_assign
l_int|0x800
suffix:semicolon
...
id|XXX10304
suffix:semicolon
multiline_comment|/* MBH10304 with buggy CIS */
id|link-&gt;conf.ConfigIndex
op_assign
l_int|0x20
suffix:semicolon
...
id|XXX10304
suffix:colon
multiline_comment|/* Read MACID from Buggy CIS */
r_if
c_cond
(paren
id|fmvj18x_get_hwinfo
...
multiline_comment|/*====================================================================*/
DECL|function|fmvj18x_get_hwinfo
r_static
r_int
id|fmvj18x_get_hwinfo
c_func
...
suffix:semicolon
multiline_comment|/*&n;     *  MBH10304 CISTPL_FUNCE_LAN_NODE_ID format&n;     *  22 0d xx xx xx 04 06 yy yy yy yy yy yy ff&n;     *  &squot;xx&squot; is garbage.&n;     *  &squot;yy&squot; is MAC address.&n;    */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* fmvj18x_get_hwinfo */
multiline_comment|/*====================================================================*/
DECL|function|fmvj18x_setup_mfc
r_static
r_int
id|fmvj18x_setup_mfc
c_func
...
suffix:semicolon
multiline_comment|/* Config Option Register of LAN */
id|writeb
c_func
(paren
l_int|0x0
...
suffix:semicolon
multiline_comment|/* Config and Status Register */
id|writeb
c_func
(paren
id|ioaddr
...
suffix:semicolon
multiline_comment|/* I/O Base(Low) of LAN */
id|writeb
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* I/O Base(High) of LAN */
id|writeb
c_func
(paren
l_int|0x45
...
suffix:semicolon
multiline_comment|/* Config Option Register of Modem */
id|writeb
c_func
(paren
l_int|0x8
...
DECL|variable|fmvj18x_cs_driver
r_static
r_struct
id|pcmcia_driver
id|fmvj18x_cs_driver
op_assign
(brace
dot
id|owner
...
suffix:semicolon
multiline_comment|/* Turn on interrupts from LAN card controller */
r_if
c_cond
(paren
id|lp-&gt;cardtype

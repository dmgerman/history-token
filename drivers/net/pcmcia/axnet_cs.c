...
DECL|macro|dev_lock
mdefine_line|#define dev_lock(dev) (((struct ei_device *)netdev_priv(dev))-&gt;page_lock)
...
multiline_comment|/**&n; * axdev_setup - init rest of 8390 device struct&n; * @dev: network device structure to init&n; *&n; * Initialize the rest of the 8390 device structure.  Do NOT __init&n; * this, as it is used by 8390 based modular drivers too.&n; */
DECL|function|axdev_setup
r_static
r_void
id|axdev_setup
c_func

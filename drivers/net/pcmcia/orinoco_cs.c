...
id|version
op_assign
l_string|&quot;dldwd_cs.c 0.01 (David Gibson &lt;hermes@gibson.dropbear.id.au&gt;)&quot;
suffix:semicolon
id|MODULE_PARM
c_func
(paren
...
macro_line|#error &quot;dldwd_cs requires Wireless extensions v10 or later.&quot;
...
id|wep_type
suffix:semicolon
DECL|macro|WEP_TYPE_LUCENT
mdefine_line|#define WEP_TYPE_LUCENT 1
DECL|macro|WEP_TYPE_PRISM
mdefine_line|#define WEP_TYPE_PRISM 2
DECL|member|has_mwo
r_int
id|has_mwo
suffix:semicolon
...
l_int|0x1
suffix:colon
multiline_comment|/* Lucent Wavelan IEEE, Orinoco or Cabletron card */
id|vendor_str
op_assign
l_string|&quot;Lucent&quot;
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: Lucent ad-hoc demo mode supported.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|1024
suffix:semicolon
multiline_comment|/* TCP throughput measured with socklib.&n;&t;&t;&t;&t;&t;       I&squot;m hoping MB/s are the right units. */
id|range.min_nwid
op_assign
id|range.max_nwid
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;Unable to initialise /proc/dldwd.&bslash;n&quot;
)paren
suffix:semicolon
id|dldwd_proc_cleanup
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Unable to initialise /proc/dldwd/%s.&bslash;n&quot;
comma
id|dev-&gt;node.dev_name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Unable to initialise /proc/dldwd/%s/regs.&bslash;n&quot;
comma
id|dev-&gt;node.dev_name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Unable to initialise /proc/dldwd/%s/recs.&bslash;n&quot;
comma
id|dev-&gt;node.dev_name
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;dldwd_cs: detach postponed, &squot;%s&squot; &quot;
...
l_int|0
comma
l_string|&quot;dldwd_cs: detach: link=%p link-&gt;dev=%p&bslash;n&quot;
comma
id|link
comma
id|link-&gt;dev
...
l_int|0
comma
l_string|&quot;dldwd_cs: About to unregister net device %p&bslash;n&quot;
comma
op_amp
id|priv-&gt;ndev
)paren
...
(paren
id|KERN_ERR
l_string|&quot;dldwd_cs: Failed to create /proc node for %s&bslash;n&quot;
comma
id|priv-&gt;node.dev_name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;dldwd_cs: register_netdev() failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|failed
...
l_int|0
comma
l_string|&quot;dldwd_cs: release postponed, &squot;%s&squot; still open&bslash;n&quot;
comma
id|link-&gt;dev-&gt;dev_name
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;dldwd_cs: Card Services release &quot;
...
l_int|0
comma
l_string|&quot;dldwd_cs: Removing leftover devices.&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop

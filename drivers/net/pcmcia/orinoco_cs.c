...
id|version
op_assign
l_string|&quot;orinoco_cs.c 0.04 (David Gibson &lt;hermes@gibson.dropbear.id.au&gt;)&quot;
suffix:semicolon
id|MODULE_PARM
c_func
(paren
...
id|pm_timeout
suffix:semicolon
DECL|member|retry_short
DECL|member|retry_long
...
multiline_comment|/* Set retry settings - will fail on lot&squot;s of firmwares */
r_if
c_cond
(paren
id|priv-&gt;has_retry
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Can&squot;t set retry limit!&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
macro_line|#if WIRELESS_EXT &gt; 10
DECL|function|dldwd_ioctl_setretry
r_static
r_int
id|dldwd_ioctl_setretry
c_func
(paren
r_struct
id|net_device
...
l_int|2
comma
l_string|&quot;dldwd : dldwd_cor_reset() : cor=0x%lX&bslash;n&quot;
comma
id|default_cor
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;dldwd_config: Vcc mismatch (conf.Vcc = %d, CIS = %d)&bslash;n&quot;
comma
id|conf.Vcc
comma
id|cfg-&gt;vcc.param

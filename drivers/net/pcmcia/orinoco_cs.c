...
id|version
op_assign
l_string|&quot;orinoco_cs.c 0.03 (David Gibson &lt;hermes@gibson.dropbear.id.au&gt;)&quot;
suffix:semicolon
id|MODULE_PARM
c_func
(paren
...
mdefine_line|#define DEBUGMORE(n, args...) do { if (pc_debug&gt;(n)) printk(args); } while (0)
macro_line|#else
DECL|macro|DEBUG
...
suffix:semicolon
multiline_comment|/* Control device name allocation. 0 -&gt; dldwdX ; 1 -&gt; ethX */
DECL|variable|eth
r_static
r_int
id|eth
...
multiline_comment|/* Symbol cards : set the authentication :&n;&t;&t;&t; * 0 -&gt; no encryption, 1 -&gt; open,&n;&t;&t;&t; * 2 -&gt; shared key, 3 -&gt; shared key 128bit only */
r_if
c_cond
(paren
id|priv-&gt;firmware_type
...
l_int|3
comma
l_string|&quot;%s: dldwd_interrupt()  irq %d&bslash;n&quot;
comma
id|priv-&gt;ndev.name
comma
id|irq
...
multiline_comment|/* Handle decapsulation */
r_switch
c_cond
(paren
id|status
...
(brace
multiline_comment|/* These both indicate a SNAP within 802.2 LLC within&n;&t;&t;   802.3 within 802.11 frame which we&squot;ll need to&n;&t;&t;   de-encapsulate. IEEE and ISO OSI have a lot to&n;&t;&t;   answer for.  */
r_case
...
r_break
suffix:semicolon
multiline_comment|/* Otherwise, we just throw the whole thing in, and hope&n;&t;&t;   the protocol layer can deal with it as 802.3 */
r_default
suffix:colon
id|data_len
op_assign
...
suffix:semicolon
multiline_comment|/* Tested with Lucent firmware :&n;&t;&t; *&t;1.16 ; 4.08 ; 4.52 ; 6.04 ; 6.16 =&gt; Jean II&n;&t;&t; * Tested CableTron firmware : 4.32 =&gt; Anton */
r_break
suffix:semicolon
r_case
l_int|0x2
...
suffix:semicolon
multiline_comment|/* Note : my Intel card report this value, but I can&squot;t do&n;&t;&t; * much with it, so I guess it&squot;s broken - Jean II */
id|priv-&gt;firmware_type
op_assign
id|FIRMWARE_TYPE_PRISM2
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* FIXME: no idea if this is right */
id|priv-&gt;has_wep
op_assign
(paren
id|firmver
...
suffix:semicolon
multiline_comment|/* Tested with Intel firmware : 1.01 =&gt; Jean II */
multiline_comment|/* Note : firmware 1.01 is *seriously* broken */
r_break
suffix:semicolon
r_case
l_int|0x3
...
c_cond
suffix:colon
multiline_comment|/* Could someone help here ??? */
id|vendor_str
op_assign
l_string|&quot;Symbol&quot;
suffix:semicolon
multiline_comment|/* Symbol , 3Com AirConnect, Ericsson WLAN */
id|priv-&gt;firmware_type
op_assign
id|FIRMWARE_TYPE_SYMBOL
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* Probably RID_SYMBOL_KEY_LENGTH */
id|priv-&gt;has_mwo
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: Buggy firmware, please upgrade ASAP.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* Only for symbol cards (so far) - Jean II */
r_if
c_cond
(paren
id|erq-&gt;flags
...
l_int|2
suffix:semicolon
multiline_comment|/* If all key are 128 -&gt; should be 3 ??? */
multiline_comment|/* Agree with master wep setting */
r_if
c_cond
(paren
id|enable
...
multiline_comment|/* Encryption require some authentication */
r_if
c_cond
(paren
id|erq-&gt;pointer
...
multiline_comment|/*====================================================================*/
multiline_comment|/*&n; * From here on in, it&squot;s all PCMCIA junk, taken almost directly from&n; * dummy_cs.c&n; */
...
multiline_comment|/* dldwd_attach */
...
multiline_comment|/* dldwd_detach */
multiline_comment|/*======================================================================&n;  dldwd_config() is scheduled to run after a CARD_INSERTION event&n;  is received, to configure the PCMCIA socket, and to make the&n;  device available to the system.&n;  ======================================================================*/
DECL|macro|CS_CHECK
...
l_int|0
comma
l_string|&quot;dldwd_config: ConfigBase = 0x%x link-&gt;conf.Vcc = %d&bslash;n&quot;
comma
id|link-&gt;conf.ConfigBase
comma
id|link-&gt;conf.Vcc
...
l_int|0
comma
l_string|&quot;dldwd_config: index = 0x%x, flags = 0x%x&bslash;n&quot;
comma
id|cfg-&gt;index
comma
id|cfg-&gt;flags
...
l_int|0
comma
l_string|&quot;dldwd_config: We seem to have configured Vcc and Vpp&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Instance name : by default, use hermesX, on demand use the&n;&t; * regular ethX (less risky) - Jean II */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* dldwd_config */
multiline_comment|/*======================================================================&n;  After a card is removed, dldwd_release() will unregister the&n;  device, and release the PCMCIA configuration.  If the device is&n;  still open, this will be postponed until it is closed.&n;  ======================================================================*/
DECL|function|dldwd_release
r_static
r_void
id|dldwd_release
c_func
...
multiline_comment|/* dldwd_release */

...
suffix:semicolon
multiline_comment|/* Some third-party PHYs need to be reset on link going&n;&t; * down.&n;&t; *&n;&t; * XXX 5705 note: This workaround also applies to 5705_a0&n;&t; */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* XXX 5705 note: set MIN_DMA to zero here */
)brace
r_else
(brace
r_if

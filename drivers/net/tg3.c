...
(brace
multiline_comment|/* NOTE: This write is posted by the readback of&n;&t;&t; *       the mailbox register done by our caller.&n;&t;&t; */
id|tw32
c_func
(paren
id|TG3PCI_MISC_HOST_CTRL
...
multiline_comment|/* Use indirect register writes for this so that there are&n;&t; * no PCI write posting issues.&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp

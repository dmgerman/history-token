...
(brace
multiline_comment|/* NOTE: These writes are posted by the readback of&n;&t;&t; *       the mailbox register done by our caller.&n;&t;&t; */
id|tg3_mask_ints
c_func
(paren
id|tp

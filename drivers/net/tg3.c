...
mdefine_line|#define DRV_MODULE_VERSION&t;&quot;3.25&quot;
DECL|macro|DRV_MODULE_RELDATE
mdefine_line|#define DRV_MODULE_RELDATE&t;&quot;March 24, 2005&quot;
...
mdefine_line|#define TG3_RX_RCB_RING_SIZE(tp)&t;&bslash;&n;&t;((tp-&gt;tg3_flags2 &amp; TG3_FLG2_5705_PLUS) ?  512 : 1024)
...
multiline_comment|/* Set phy register 0x10 bit 0 to high fifo elasticity to support&n;&t; * jumbo frames transmission.&n;&t; */
r_if
c_cond
(paren
id|GET_ASIC_REV
...
id|phy_reg
op_or
id|MII_TG3_EXT_CTRL_FIFO_ELASTIC
)paren
suffix:semicolon
)brace
id|tg3_phy_set_wirespeed
...
suffix:semicolon
multiline_comment|/* Workaround for unstable PLL clock */
r_if
c_cond
(paren
(paren

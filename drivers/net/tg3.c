multiline_comment|/*&n; * tg3.c: Broadcom Tigon3 ethernet driver.&n; *&n; * Copyright (C) 2001, 2002, 2003, 2004 David S. Miller (davem@redhat.com)&n; * Copyright (C) 2001, 2002, 2003 Jeff Garzik (jgarzik@pobox.com)&n; * Copyright (C) 2004 Sun Microsystems Inc.&n; */
...
mdefine_line|#define DRV_MODULE_RELDATE&t;&quot;July 5, 2004&quot;
...
id|dig_status
op_amp
id|SG_DIG_PARTNER_PAUSE_CAPABLE
)paren
op_star
id|flags
op_or_assign
...
op_amp
(paren
id|SG_DIG_AUTONEG_ERROR
op_or
id|SG_DIG_PARTNER_FAULT_MASK
)paren
)paren
)paren
id|res
...
(brace
multiline_comment|/* Allow time for the hardware to auto-negotiate (195ms) */
r_int
r_int
id|tick
op_assign
...
id|KERN_INFO
id|PFX
l_string|&quot;%s: HW autoneg failed !&bslash;n&quot;
comma
id|tp-&gt;dev-&gt;name
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Enable hardware link auto-negotiation */
id|u32
id|digctrl
comma
id|txctrl
...
id|digctrl
op_assign
id|SG_DIG_USING_HW_AUTONEG
op_or
id|SG_DIG_CRC16_CLEAR_N
op_or
id|SG_DIG_LOCAL_DUPLEX_STATUS
op_or
id|SG_DIG_LOCAL_LINK_STATUS
op_or
(paren
l_int|2
op_lshift
id|SG_DIG_SPEED_STATUS_SHIFT
)paren
op_or
id|SG_DIG_FIBER_MODE
op_or
id|SG_DIG_GBIC_ENABLE
suffix:semicolon
id|txctrl
op_assign
id|tr32
...
suffix:semicolon
multiline_comment|/* Wait for done bit to clear. */
r_for
c_loop
(paren
id|i

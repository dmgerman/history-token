multiline_comment|/* $Id: tg3.c,v 1.43.2.74 2002/03/06 22:22:29 davem Exp $&n; * tg3.c: Broadcom Tigon3 ethernet driver.&n; *&n; * Copyright (C) 2001, 2002 David S. Miller (davem@redhat.com)&n; * Copyright (C) 2001, 2002 Jeff Garzik (jgarzik@mandrakesoft.com)&n; */
...
mdefine_line|#define DRV_MODULE_VERSION&t;&quot;0.96&quot;
DECL|macro|DRV_MODULE_RELDATE
mdefine_line|#define DRV_MODULE_RELDATE&t;&quot;Mar 6, 2002&quot;
...
DECL|macro|TG3_RX_RING_PENDING
mdefine_line|#define TG3_RX_RING_PENDING&t;&t;200
macro_line|#if TG3_MINI_RING_WORKS
DECL|macro|TG3_RX_MINI_RING_SIZE
mdefine_line|#define TG3_RX_MINI_RING_SIZE&t;&t;256 /* ??? */
DECL|macro|TG3_RX_MINI_RING_PENDING
mdefine_line|#define TG3_RX_MINI_RING_PENDING&t;100
macro_line|#endif
DECL|macro|TG3_RX_JUMBO_RING_SIZE
mdefine_line|#define TG3_RX_JUMBO_RING_SIZE&t;&t;256
DECL|macro|TG3_RX_JUMBO_RING_PENDING
mdefine_line|#define TG3_RX_JUMBO_RING_PENDING&t;100
...
mdefine_line|#define TX_BUFFS_AVAIL(TP)&t;&t;&t;&t;&t;&t;&bslash;&n;&t;(((TP)-&gt;tx_cons &lt;= (TP)-&gt;tx_prod) ?&t;&t;&t;&t;&bslash;&n;&t;  (TP)-&gt;tx_cons + (TG3_TX_RING_SIZE - 1) - (TP)-&gt;tx_prod :&t;&bslash;&n;&t;  (TP)-&gt;tx_cons - (TP)-&gt;tx_prod - 1)
DECL|macro|NEXT_TX
...
multiline_comment|/* Enable link change interrupt. */
id|tw32
c_func
(paren
id|MAC_EVENT
...
DECL|macro|RATE_SAMPLE_INTERVAL
mdefine_line|#define RATE_SAMPLE_INTERVAL&t;(1 * HZ)
...
id|tp-&gt;hw_stats
suffix:semicolon
multiline_comment|/* XXX Fix this... this is wrong because&n;&t; * XXX it means every open/close we lose the stats.&n;&t; */
r_if
c_cond
(paren
op_logical_neg

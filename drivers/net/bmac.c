...
suffix:semicolon
macro_line|#if 0 /* Move that to ethtool */
r_typedef
r_struct
id|bmac_reg_entry
(brace
...
suffix:semicolon
macro_line|#endif
DECL|variable|bmac_emergency_rxbuf
r_static
r_int
r_char
op_star
id|bmac_emergency_rxbuf
suffix:semicolon
...
r_static
r_void
DECL|function|bmac_enable_and_reset_chip
id|bmac_enable_and_reset_chip
c_func
(paren
r_struct
...
(brace
multiline_comment|/*&n;&t;&t;&t; * status field might not have been filled by DBDMA&n;&t;&t;&t; */
r_if
c_cond
(paren
id|cp
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * It seems that the bmac can&squot;t receive until it&squot;s transmitted&n;&t; * a packet.  So we give it a dummy packet to transmit.&n;&t; */
id|skb
op_assign
id|dev_alloc_skb
c_func
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: can&squot;t use, need 3 addrs and 3 intrs&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: Can&squot;t get mac-address&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: alloc_etherdev failed, out of memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: can&squot;t request IO resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_free
...
suffix:semicolon
multiline_comment|/* Enable chip without interrupts for now */
id|bmac_enable_and_reset_chip
c_func
(paren
id|dev
...
multiline_comment|/* Mask chip interrupts and disable chip, will be&n;&t; * re-enabled on open()&n;&t; */
id|disable_irq
c_func
(paren
id|dev-&gt;irq
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: Ethernet registration failed&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_irq2
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: can&squot;t allocate emergency RX buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus

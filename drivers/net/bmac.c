...
(paren
id|KERN_ERR
l_string|&quot;alloc_etherdev failed, out of memory for BMAC %s&bslash;n&quot;
comma
id|bmac-&gt;full_name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: can&squot;t request TX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out2
...
(paren
id|KERN_ERR
l_string|&quot;BMAC: can&squot;t request RX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out3
...
(paren
id|KERN_ERR
l_string|&quot;registration failed for BMAC %s&bslash;n&quot;
comma
id|bmac-&gt;full_name
)paren
suffix:semicolon

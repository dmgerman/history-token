...
multiline_comment|/* Auto-Negotiation is mandatory for 1000BASE-T,&n;&t;&t;&t;   IEEE 802.3ab Annex 28D page 14 */
r_else
r_if
c_cond
(paren
...
(paren
id|KERN_INFO
l_string|&quot;%s: %s, %2x:%2x:%2x:%2x:%2x:%2x, IRQ %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|np-&gt;name
...
multiline_comment|/* Chain the next pointer to the top */
id|np-&gt;rx_ring
(braket
id|i
op_minus
...
multiline_comment|/* Every interrupts go into here to see if any packet need to process, this&n;   ensure Rx rings keep full in a critical cases of Rx rings ran out */
r_static
r_int
...
(brace
multiline_comment|/* Auto-Negotiation mode */
id|mii_get_media
(paren
id|dev
)paren
...
DECL|macro|CRC_POLY
mdefine_line|#define CRC_POLY 0xedb88320
r_static
r_int
DECL|function|get_crc
id|get_crc
(paren
r_int
r_char
...
id|printk
(paren
l_string|&quot;tx_full=%x cur_tx=%x old_tx=%x cur_rx=%x old_rx=%x&bslash;n&quot;
comma
(paren
id|u32
)paren
...
(paren
id|KERN_INFO
l_string|&quot;Auto 1000BaseT, Full duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;Auto 1000BaseT, Half duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;Auto 100BaseT, Full duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;Auto 100BaseT, Half duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;Auto 10BaseT, Full duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_INFO
l_string|&quot;Auto 10BaseT, Half duplex.&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(brace
multiline_comment|/* Reset to enable Auto-Negotiation */
id|bmsr.image
op_assign
id|mii_read
(paren
...
suffix:semicolon
multiline_comment|/* Wait for Link up, link up need a certain time */
r_if
c_cond
(paren
id|mii_wait_link
...
(paren
id|KERN_INFO
l_string|&quot;Link time out&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|mdelay
...
suffix:semicolon
multiline_comment|/*&n; &n;Compile command: &n; &n;gcc -D__KERNEL__ -DMODULE -I/usr/src/linux/include -Wall -Wstrict-prototypes -O2 -c dl2x.c&n;&n;*/
eof

...
multiline_comment|/*&n; * given 6 bytes, view them as 8 6-bit numbers and return the XOR of those &n; * the code below is about seven times as fast as the original code &n; *&n; * The original code was:&n; *&n; * u32&t;xor( u32 a, u32 b ) {&t;return ( ( a &amp;&amp; ! b ) || ( ! a &amp;&amp; b ) ); }&n; *&n; * #define XOR8( a, b, c, d, e, f, g, h )&t;&bslash;&n; * &t;xor( a, xor( b, xor( c, xor( d, xor( e, xor( f, xor( g, h ) ) ) ) ) ) )&n; * #define DA( a, bit )&t;&t;( ( (u8) a[bit/8] ) &amp; ( (u8) ( 1 &lt;&lt; bit%8 ) ) )&n; *&n; * &t;hash  = XOR8( DA(a,0), DA(a, 6), DA(a,12), DA(a,18), DA(a,24), DA(a,30), DA(a,36), DA(a,42) );&n; * &t;hash |= XOR8( DA(a,1), DA(a, 7), DA(a,13), DA(a,19), DA(a,25), DA(a,31), DA(a,37), DA(a,43) ) &lt;&lt; 1;&n; * &t;hash |= XOR8( DA(a,2), DA(a, 8), DA(a,14), DA(a,20), DA(a,26), DA(a,32), DA(a,38), DA(a,44) ) &lt;&lt; 2;&n; * &t;hash |= XOR8( DA(a,3), DA(a, 9), DA(a,15), DA(a,21), DA(a,27), DA(a,33), DA(a,39), DA(a,45) ) &lt;&lt; 3;&n; * &t;hash |= XOR8( DA(a,4), DA(a,10), DA(a,16), DA(a,22), DA(a,28), DA(a,34), DA(a,40), DA(a,46) ) &lt;&lt; 4;&n; * &t;hash |= XOR8( DA(a,5), DA(a,11), DA(a,17), DA(a,23), DA(a,29), DA(a,35), DA(a,41), DA(a,47) ) &lt;&lt; 5;&n; *&n; */

...
suffix:semicolon
DECL|variable|velocity_notifier_registered
r_static
r_int
id|velocity_notifier_registered
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Init the RD ring entries */
r_for
c_loop
(paren
id|i
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Don&squot;t drop CE or RL error frame although RXOK is off&n;&t;&t; *&t;FIXME: need to handle copybreak&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
comma
id|KERN_ERR
l_string|&quot;%s: can not allocate rx buf&bslash;n&quot;
comma
id|vptr-&gt;dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;FIXME: need rx_copybreak handling&n;&t; */
id|stats-&gt;rx_bytes
op_add_assign
id|pkt_len
suffix:semicolon
...
multiline_comment|/**&n; *&t;ether_crc&t;-&t;ethernet CRC function&n; *&n; *&t;Compute an ethernet CRC hash of the data block provided. This&n; *&t;is not performance optimised but is not needed in performance&n; *&t;critical code paths.&n; *&n; *&t;FIXME: could we use shared code here ?&n; */
...
macro_line|#endif
multiline_comment|/*&n; * Purpose: Functions to set WOL.&n; */
...
suffix:semicolon
multiline_comment|/**&n; *&t;ether_crc16&t;-&t;compute ethernet CRC&n; *&t;@len: buffer length&n; *&t;@cp: buffer&n; *&t;@crc16: initial CRC&n; *&n; *&t;Compute a CRC value for a block of data. &n; *&t;FIXME: can we use generic functions ?&n; */
DECL|function|ether_crc16
r_static
id|u16
id|ether_crc16
c_func
...
multiline_comment|/**&n; *&t;bit_reverse&t;&t;-&t;16bit reverse&n; *&t;@data: 16bit data t reverse&n; *&n; *&t;Reverse the order of a 16bit value and return the reversed bits&n; */
DECL|function|bit_reverse
r_static
id|u16
id|bit_reverse
c_func

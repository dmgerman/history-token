...
multiline_comment|/*&n; * Cloned from ni52.h, copyright as above.  &n; *&n; * Modified for Sun3 OBIO i82586 by Sam Creasey (sammy@sammy.net)&n; */
multiline_comment|/* defines for the obio chip (not vme) */
DECL|macro|IEOB_NORSET
mdefine_line|#define IEOB_NORSET 0x80        /* don&squot;t reset the board */
DECL|macro|IEOB_ONAIR
mdefine_line|#define IEOB_ONAIR  0x40        /* put us on the air */
DECL|macro|IEOB_ATTEN
mdefine_line|#define IEOB_ATTEN  0x20        /* attention! */
DECL|macro|IEOB_IENAB
mdefine_line|#define IEOB_IENAB  0x10        /* interrupt enable */
DECL|macro|IEOB_XXXXX
mdefine_line|#define IEOB_XXXXX  0x08        /* free bit */
DECL|macro|IEOB_XCVRL2
mdefine_line|#define IEOB_XCVRL2 0x04        /* level 2 transceiver? */
DECL|macro|IEOB_BUSERR
mdefine_line|#define IEOB_BUSERR 0x02        /* bus error */
DECL|macro|IEOB_INT
mdefine_line|#define IEOB_INT    0x01        /* interrupt */
multiline_comment|/* where the obio one lives */
DECL|macro|IE_OBIO
mdefine_line|#define IE_OBIO 0xc0000
DECL|macro|IE_IRQ
mdefine_line|#define IE_IRQ 3

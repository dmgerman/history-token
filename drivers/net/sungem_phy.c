...
id|data
op_or
id|MII_BCM5221_SHDOW_AUX_MODE4_IDDQMODE
)paren
suffix:semicolon
r_return
l_int|0
...
(brace
multiline_comment|/* Init code borrowed from OF */
id|phy_write
c_func
(paren
id|phy
...
suffix:semicolon
multiline_comment|/* Broadcom BCM 5421 built-in K2 */
DECL|variable|bcm5421k2_phy_ops
r_static
r_struct
id|mii_phy_ops
id|bcm5421k2_phy_ops
op_assign
(brace
dot
id|init
...
suffix:semicolon
DECL|variable|bcm5421k2_phy_def
r_static
r_struct
id|mii_phy_def
id|bcm5421k2_phy_def
op_assign
(brace
dot
id|phy_id
...
(paren
id|KERN_DEBUG
l_string|&quot;PHY ID: %x, addr: %x&bslash;n&quot;
comma
id|id
comma
id|mii_id

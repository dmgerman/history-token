...
multiline_comment|/* ethtool commands */
r_if
c_cond
(paren
id|cmd
...
suffix:semicolon
multiline_comment|/* all other ioctls (the SIOC[GS]MIIxxx ioctls) */
r_else
(brace
id|spin_lock_irq
c_func
...
multiline_comment|/* don&squot;t care about duplex change, fixup rc */
id|rc
op_assign
l_int|0
suffix:semicolon

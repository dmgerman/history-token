...
mdefine_line|#define TX_TOTAL_SIZE&t;TX_RING_SIZE*sizeof(struct epic_tx_desc)
DECL|macro|RX_TOTAL_SIZE
mdefine_line|#define RX_TOTAL_SIZE&t;RX_RING_SIZE*sizeof(struct epic_rx_desc)
...
DECL|member|napi_lock
id|spinlock_t
id|napi_lock
suffix:semicolon
DECL|member|reschedule_in_poll
r_int
r_int
id|reschedule_in_poll
suffix:semicolon
DECL|member|cur_tx
...
id|mdio_read
suffix:semicolon
id|ep-&gt;mii.mdio_write
op_assign
id|mdio_write
suffix:semicolon
id|ep-&gt;mii.phy_id_mask
op_assign
l_int|0x1f
suffix:semicolon
id|ep-&gt;mii.reg_num_mask
op_assign
l_int|0x1f
suffix:semicolon
id|ring_space
...
multiline_comment|/* This magic is documented in SMSC app note 7.15 */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* Note: the &squot;175 does not have a serial EEPROM. */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Delay between EEPROM clock transitions.&n;   This serves to flush the operation to the PCI bus.&n; */
...
DECL|function|epic_disable_int
r_static
r_void
id|epic_disable_int
c_func
...
DECL|function|__epic_pci_commit
r_static
r_inline
r_void
id|__epic_pci_commit
c_func
(paren
r_int
id|ioaddr
...
DECL|function|epic_napi_irq_off
r_static
r_inline
r_void
id|epic_napi_irq_off
c_func
(paren
r_struct
id|net_device
...
DECL|function|epic_napi_irq_on
r_static
r_inline
r_void
id|epic_napi_irq_on
...
id|dev-&gt;base_addr
suffix:semicolon
multiline_comment|/* No need to commit possible posted write */
id|outl
c_func
(paren
id|ep-&gt;irq_mask
...
suffix:semicolon
multiline_comment|/* Typical operation takes 25 loops. */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* Work around read failure bug. */
r_if
c_cond
(paren
id|phy_id
...
suffix:semicolon
multiline_comment|/* Looks like EPII needs that if you want reliable RX init. FIXME: pci posting bug? */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* The ring is no longer full, allow new TX entries. */
id|ep-&gt;tx_full
op_assign
l_int|0
suffix:semicolon
...
id|more
suffix:semicolon
multiline_comment|/* A bit baroque but it avoids a (space hungry) spin_unlock */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
id|dev-&gt;base_addr
suffix:semicolon
multiline_comment|/* power-up, if interface is down */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|ethtool_complete
r_static
r_void
id|ethtool_complete
c_func
...
id|dev-&gt;base_addr
suffix:semicolon
multiline_comment|/* power-down, if interface is down */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* all non-ethtool ioctls (the SIOC[GS]MIIxxx ioctls) */
id|spin_lock_irq
c_func
(paren
op_amp

...
DECL|macro|ACE_TX_RING_ENTRIES
mdefine_line|#define ACE_TX_RING_ENTRIES(ap)&t;MAX_TX_RING_ENTRIES
macro_line|#else
DECL|macro|ACE_IS_TIGON_I
mdefine_line|#define ACE_IS_TIGON_I(ap)&t;(ap-&gt;version == 1)
DECL|macro|ACE_TX_RING_ENTRIES
mdefine_line|#define ACE_TX_RING_ENTRIES(ap)&t;ap-&gt;tx_ring_entries
macro_line|#endif
...
id|fail_free_netdev
suffix:semicolon
multiline_comment|/*&n;&t; * Enable master mode before we start playing with the&n;&t; * pci_command word since pci_set_master() will modify&n;&t; * it.&n;&t; */
id|pci_set_master
c_func
(paren
id|pdev
...
multiline_comment|/*&n;&t; * Remap the regs into kernel space - this is abuse of&n;&t; * dev-&gt;base_addr since it was means for I/O port&n;&t; * addresses but who gives a damn.&n;&t; */
id|dev-&gt;base_addr
op_assign
...
DECL|function|acenic_remove_one
r_static
r_void
id|__devexit
id|acenic_remove_one
c_func
(paren
r_struct
id|pci_dev
...
suffix:semicolon
multiline_comment|/*&n;&t; * This clears any pending interrupts&n;&t; */
id|writel
c_func
(paren
l_int|1
...
multiline_comment|/*&n;&t; * Make sure no other CPUs are processing interrupts&n;&t; * on the card before the buffers are being released.&n;&t; * Otherwise one might experience some `interesting&squot;&n;&t; * effects.&n;&t; *&n;&t; * Then release the RX buffers - jumbo buffers were&n;&t; * already released in ace_close().&n;&t; */
id|ace_sync_irq
c_func
(paren
id|dev-&gt;irq
...
DECL|variable|acenic_pci_driver
r_static
r_struct
id|pci_driver
id|acenic_pci_driver
op_assign
(brace
dot
id|name
...
id|fail
suffix:semicolon
multiline_comment|/*&n;&t; * Only allocate a host TX ring for the Tigon II, the Tigon I&n;&t; * has to use PCI registers for this ;-(&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_int|1
suffix:semicolon
id|ap-&gt;tx_ring_entries
op_assign
id|TIGON_I_TX_RING_ENTRIES
suffix:semicolon
r_break
suffix:semicolon
macro_line|#endif
...
multiline_comment|/* The ring is stuck full. */
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;%s: Transmit ring stuck full&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/*&n;&t; * Current struct ethtool_cmd is insufficient&n;&t; */
id|ecmd-&gt;trace
op_assign
id|readl
c_func
...
DECL|function|ace_set_settings
r_static
r_int
id|ace_set_settings
c_func

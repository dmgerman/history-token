...
suffix:semicolon
macro_line|#if CONFIG_NET_POLL_CONTROLLER
r_static
r_void
id|xircom_poll_controller
c_func
(paren
r_struct
id|net_device
...
r_static
r_void
id|investigate_read_descriptor
c_func
(paren
r_struct
id|net_device
...
r_static
r_void
id|investigate_write_descriptor
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/* Why isn&squot;t this done by pci_enable_device ?*/
...
multiline_comment|/* &n;&t;   Before changing the hardware, allocate the memory.&n;&t;   This way, we can fail gracefully if not enough memory&n;&t;   is available. &n;&t; */
id|dev
op_assign
id|alloc_etherdev
c_func
...
(paren
id|KERN_ERR
l_string|&quot;xircom_probe: netdevice registration failed.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|reg_fail
...
c_func
(paren
l_string|&quot;xircom_interrupt&bslash;n&quot;
)paren
suffix:semicolon
id|spin_lock
c_func
...
c_func
(paren
l_string|&quot;tx status 0x%08x 0x%08x &bslash;n&quot;
comma
id|card-&gt;tx_buffer
(braket
l_int|0
...
c_func
(paren
l_string|&quot;rx status 0x%08x 0x%08x &bslash;n&quot;
comma
id|card-&gt;rx_buffer
(braket
l_int|0
...
suffix:semicolon
macro_line|#endif&t;
multiline_comment|/* Handle shared irq and hotplug */
r_if
c_cond
(paren
id|status
...
multiline_comment|/* Clear all remaining interrupts */
id|status
op_or_assign
l_int|0xffffffff
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* First see if we can free some descriptors */
r_for
c_loop
(paren
id|desc
...
c_func
(paren
l_string|&quot;xircom-start_xmit - sent&quot;
)paren
suffix:semicolon
id|spin_unlock_irqrestore
c_func
...
suffix:semicolon
multiline_comment|/* we don&squot;t want new packets */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
macro_line|#ifdef CONFIG_NET_POLL_CONTROLLER
DECL|function|xircom_poll_controller
r_static
r_void
id|xircom_poll_controller
c_func
...
c_func
(paren
l_string|&quot;link_status_changed - nochange&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;link_status_changed - changed&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
c_func
(paren
l_string|&quot;transmit_active - inactive&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;transmit_active - active&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
c_func
(paren
l_string|&quot;receive_active - inactive&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;receive_active - active&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
multiline_comment|/* If the &quot;active&quot; bit is set and the receiver is already&n;&t;   active, no need to do the expensive thing */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;deactivate_transmitter&quot;
)paren
suffix:semicolon
id|val
op_assign
...
c_func
(paren
l_string|&quot;enable_transmit_interrupt&quot;
)paren
suffix:semicolon
id|val
op_assign
...
c_func
(paren
l_string|&quot;enable_receive_interrupt&quot;
)paren
suffix:semicolon
id|val
op_assign
...
c_func
(paren
l_string|&quot;enable_link_interrupt&quot;
)paren
suffix:semicolon
id|val
op_assign
...
c_func
(paren
l_string|&quot;enable_all_interrupts&quot;
)paren
suffix:semicolon
id|val
op_assign
...
c_func
(paren
l_string|&quot;disable_all_interrupts&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* &n;link_status() checks the the links status and will return 0 for no link, 10 for 10mbit link and 100 for.. guess what.&n;&n;Must be called in locked state with interrupts disabled&n;*/
...
multiline_comment|/* Bufferoffset is in BYTES */
DECL|function|investigate_read_descriptor
r_static
r_void
id|investigate_read_descriptor
c_func
...
c_func
(paren
l_string|&quot;investigate_read_descriptor&quot;
)paren
suffix:semicolon
id|status
op_assign
...
multiline_comment|/* Bufferoffset is in BYTES */
DECL|function|investigate_write_descriptor
r_static
r_void
id|investigate_write_descriptor
c_func
...
c_func
(paren
l_string|&quot;investigate_write_descriptor&quot;
)paren
suffix:semicolon
id|status
op_assign

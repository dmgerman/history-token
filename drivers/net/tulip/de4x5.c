...
DECL|variable|de4x5_signatures
r_static
id|c_char
op_star
id|de4x5_signatures
...
id|cfrv
suffix:semicolon
multiline_comment|/* Card CFRV copy */
DECL|member|rx_ovf
r_int
id|rx_ovf
suffix:semicolon
...
suffix:semicolon
DECL|function|de4x5_eisa_probe
r_static
r_int
id|__init
id|de4x5_eisa_probe
...
suffix:semicolon
macro_line|#ifdef CONFIG_ALPHA
multiline_comment|/* Looks like the Jensen firmware (rev 2.2) doesn&squot;t really&n;&t; * care about the EISA configuration, and thus doesn&squot;t&n;&t; * configure the PLX bridge properly. Oh well... Simply mimic&n;&t; * the EISA config file to sort it out. */
multiline_comment|/* EISA REG1: Assert DecChip 21040 HW Reset */
id|outb
(paren
id|ER1_IAM
op_or
...
suffix:semicolon
multiline_comment|/* EISA REG1: Deassert DecChip 21040 HW Reset */
id|outb
(paren
id|ER1_IAM
comma
...
suffix:semicolon
multiline_comment|/* EISA REG3: R/W Burst Transfer Enable */
id|outb
(paren
id|ER3_BWE
op_or
...
suffix:semicolon
multiline_comment|/* 32_bit slave/master, Preempt Time=23 bclks, Unlatched Interrupt */
id|outb
(paren
id|ER0_BSW
op_or
...
DECL|function|de4x5_eisa_remove
r_static
r_int
id|__devexit
id|de4x5_eisa_remove
(paren
r_struct
id|device
op_star
...
comma
multiline_comment|/* 0 is the board name index... */
(brace
l_string|&quot;&quot;
)brace
)brace
suffix:semicolon
DECL|variable|de4x5_eisa_driver
r_static
r_struct
id|eisa_driver
id|de4x5_eisa_driver
op_assign
(brace
dot
id|id_table
...
(brace
multiline_comment|/* probe a single PCI device */
id|pbus
op_assign
(paren
id|u_short
...
id|ENODEV
suffix:semicolon
multiline_comment|/* Ok, the device seems to be for us. */
r_if
c_cond
(paren
...
DECL|function|de4x5_pci_remove
r_static
r_void
id|__devexit
id|de4x5_pci_remove
...
suffix:semicolon
DECL|variable|de4x5_pci_driver
r_static
r_struct
id|pci_driver
id|de4x5_pci_driver
...
DECL|function|de4x5_module_init
r_static
r_int
id|__init
id|de4x5_module_init
(paren
r_void
)paren
(brace
...
DECL|function|de4x5_module_exit
r_static
r_void
id|__exit
id|de4x5_module_exit
(paren
r_void
)paren
(brace
...
DECL|variable|de4x5_module_init
id|module_init
(paren
id|de4x5_module_init
)paren
suffix:semicolon
DECL|variable|de4x5_module_exit
id|module_exit
(paren
id|de4x5_module_exit
)paren

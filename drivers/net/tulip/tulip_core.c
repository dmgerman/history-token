...
suffix:semicolon
multiline_comment|/* get a sane cache line size, if possible */
...
suffix:semicolon
multiline_comment|/* read back the result.  if zero, or if a buggy chip rev,&n;&t; * disable MWI&n;&t; */
id|pci_read_config_byte
c_func
(paren
id|pdev
...
l_int|0
suffix:semicolon
multiline_comment|/* re-clamp cache line values to ones supported by tulip */
multiline_comment|/* From this point forward, &squot;pci_cacheline&squot; is really&n;&t; * the value used for csr0 cache alignment and&n;&t; * csr0 programmable burst length&n;&t; */
r_switch
c_cond
(paren
id|pci_cacheline
...
id|MRM
suffix:semicolon
multiline_comment|/* if no PCI cache line size, bail out with minimal&n;&t; * burst size and cache alignment of 8 dwords.&n;&t; * We always want to have some sort of limit.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* finally, build the csr0 value */
r_if
c_cond
(paren
id|mwi
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: MWI config mwi=%d, cacheline=%d, csr0=%08x&bslash;n&quot;
comma
id|pdev-&gt;slot_name
comma
id|mwi

...
l_int|0xE000
suffix:semicolon
macro_line|#elif defined(__i386__) || defined(__powerpc__) || defined(__x86_64__)
DECL|variable|csr0
r_static
r_int
id|csr0
...
comma
multiline_comment|/* ULi526X */
(brace
l_string|&quot;ULi M5261/M5263&quot;
comma
l_int|128
comma
l_int|0x0001ebef
...
DECL|function|tulip_get_drvinfo
r_static
r_void
id|tulip_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
macro_line|#endif
multiline_comment|/*&n; *&t;Chips that have the MRM/reserved bit quirk and the burst quirk. That&n; *&t;is the DM910X and the on chip ULi devices&n; */
DECL|function|tulip_uli_dm_quirk
r_static
r_int
id|tulip_uli_dm_quirk
c_func
(paren
r_struct
id|pci_dev
...
multiline_comment|/* 1. Intel Saturn. Switch to 8 long words burst, 8 long word cache&n;&t;      aligned.  Aries might need this too. The Saturn errata are not &n;&t;      pretty reading but thankfully it&squot;s an old 486 chipset.&n;&n;&t;   2. The dreaded SiS496 486 chipset. Same workaround as Intel&n;&t;      Saturn.&n;&t;*/
r_if
c_cond
(paren
id|pci_dev_present
...
(brace
multiline_comment|/* pci_vendor_id and subsystem_id are swapped */
id|ee_data
(braket
l_int|0
)braket

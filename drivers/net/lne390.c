...
suffix:semicolon
multiline_comment|/*&n;&t;   BEWARE!! Some dain-bramaged EISA SCUs will allow you to put&n;&t;   the card mem within the region covered by `normal&squot; RAM  !!!&n;&n;&t;   ioremap() will fail in that case.&n;&t;*/
id|ei_status.mem
op_assign
id|ioremap
c_func
...
c_func
(paren
l_string|&quot;lne390.c: remapped %dkB card memory to virtual address %p&bslash;n&quot;
comma
id|LNE390_STOP_PG
op_div
l_int|4

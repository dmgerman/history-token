...
macro_line|#ifdef I_NEED_THIS_FEATURE
...
macro_line|#endif&t;/* IW_WIRELESS_SPY */
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : set ESSID (domain)&n; */
DECL|function|wavelan_set_essid
r_static
r_int
id|wavelan_set_essid
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : get ESSID (domain)&n; */
DECL|function|wavelan_get_essid
r_static
r_int
id|wavelan_get_essid
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : set mode&n; */
DECL|function|wavelan_set_mode
r_static
r_int
id|wavelan_set_mode
c_func
...
DECL|function|wavelan_get_mode
r_static
r_int
id|wavelan_get_mode
c_func
...
macro_line|#ifdef WAVELAN_ROAMING
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Private Handler : set roaming&n; */
DECL|function|wavelan_set_roam
r_static
r_int
id|wavelan_set_roam
c_func
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Private Handler : get quality threshold&n; */
DECL|function|wavelan_get_roam
r_static
r_int
id|wavelan_get_roam
c_func
...
macro_line|#else&t;/* WAVELAN_ROAMING */
l_int|NULL
comma
multiline_comment|/* SIOCSIWMODE */
l_int|NULL
...
macro_line|#else&t;/* WAVELAN_ROAMING_EXT */
l_int|NULL
comma
multiline_comment|/* SIOCSIWAP */
l_int|NULL
...
id|wavelan_set_histo
comma
multiline_comment|/* SIOCIWFIRSTPRIV + 4 */
id|wavelan_get_histo
comma
multiline_comment|/* SIOCIWFIRSTPRIV + 5 */
macro_line|#endif&t;/* HISTOGRAM */
)brace
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;wv_pcmcia_config: MEMSTART %p IRQ %d IOPORT 0x%x&bslash;n&quot;
comma
id|lp-&gt;mem
comma
id|dev-&gt;irq
...
(paren
id|KERN_DEBUG
l_string|&quot;wavelan_attach(): almost done, calling pcmcia_register_client&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|ret

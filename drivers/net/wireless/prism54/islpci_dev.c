...
mdefine_line|#define prism54_synchronize_irq(irq) synchronize_irq()
macro_line|#else
DECL|macro|prism54_synchronize_irq
...
multiline_comment|/* This is 2.6 specific, nicer, shorter, but not in 2.4 yet */
id|DEFINE_WAIT
c_func
(paren
id|wait
...
macro_line|#if LINUX_VERSION_CODE &gt;= KERNEL_VERSION(2,6,0)
multiline_comment|/* 2.6 specific too */
id|finish_wait
c_func
(paren
op_amp

multiline_comment|/*  $Header: /var/lib/cvs/prism54-ng/ksrc/isl_ioctl.c,v 1.140 2004/02/28 03:06:07 mcgrof Exp $&n; *  &n; *  Copyright (C) 2002 Intersil Americas Inc.&n; *            (C) 2003 Aurelien Alleaume &lt;slts@free.fr&gt;&n; *            (C) 2003 Herbert Valerio Riedel &lt;hvr@gnu.org&gt;&n; *            (C) 2003 Luis R. Rodriguez &lt;mcgrof@ruslug.rutgers.edu&gt;&n; *&n; *  This program is free software; you can redistribute it and/or modify&n; *  it under the terms of the GNU General Public License as published by&n; *  the Free Software Foundation; either version 2 of the License&n; *&n; *  This program is distributed in the hope that it will be useful,&n; *  but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *  GNU General Public License for more details.&n; *&n; *  You should have received a copy of the GNU General Public License&n; *  along with this program; if not, write to the Free Software&n; *  Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA&n; *&n; */
...
suffix:semicolon
DECL|variable|init_conformance
r_static
r_int
id|init_conformance
op_assign
...
id|init_mode
comma
l_string|&quot;Set card mode:&bslash;n0: Auto&bslash;n1: Ad-Hoc&bslash;n2: Managed Client (Default)&bslash;n3: Master / Access Point&bslash;n4: Repeater (Not supported yet)&bslash;n5: Secondary (Not supported yet)&bslash;n6: Monitor&quot;
)paren
suffix:semicolon
id|module_param
c_func
...
id|init_channel
comma
l_string|&quot;Check `iwpriv ethx channel` for available channels&quot;
)paren
suffix:semicolon
id|module_param
c_func
...
id|init_authen
comma
l_string|&quot;Authentication method. Can be of seven types:&bslash;n0 0x0000: None&bslash;n1 0x0001: DOT11_AUTH_OS (Default)&bslash;n2 0x0002: DOT11_AUTH_SK&bslash;n3 0x0003: DOT11_AUTH_BOTH&quot;
)paren
suffix:semicolon
id|module_param
c_func
...
id|init_dot1x
comma
l_string|&quot;&bslash;n0: None/not set&t;(Default)&bslash;n1: DOT11_DOT1X_AUTHENABLED&bslash;n2: DOT11_DOT1X_KEYTXENABLED&quot;
)paren
suffix:semicolon
id|module_param
c_func
...
id|init_mlme
comma
l_string|&quot;Sets the MAC layer management entity (MLME) mode of operation,&bslash;n0: DOT11_MLME_AUTO (Default)&bslash;n1: DOT11_MLME_INTERMEDIATE&bslash;n2: DOT11_MLME_EXTENDED&quot;
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Important: we are setting a default wireless mode and we are &n;&t; * forcing a valid one, so prism54_mib_mode_helper should just set&n;&t; * mib values depending on what the wireless mode given is. No need&n;&t; * for it save old values */
r_if
c_cond
(paren
id|init_mode
...
(paren
id|KERN_DEBUG
l_string|&quot;%s(): You passed a non-valid init_mode. &quot;
l_string|&quot;Using default mode&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
multiline_comment|/* structure value contains a channel indication */
id|c
op_assign
id|fwrq-&gt;m
suffix:semicolon
r_else
(brace
multiline_comment|/* structure contains a frequency indication and fwrq-&gt;e = 1 */
r_int
id|f
op_assign
id|fwrq-&gt;m
...
r_static
r_int
DECL|function|prism54_set_beacon
id|prism54_set_beacon
c_func
(paren
r_struct
id|net_device
...
r_static
r_int
DECL|function|prism54_get_beacon
id|prism54_get_beacon
c_func
(paren
r_struct
id|net_device
...
id|IW_CUSTOM_MAX
comma
l_string|&quot;%s %s %2.2X:%2.2X:%2.2X:%2.2X:%2.2X:%2.2X %s&quot;
comma
id|str
comma
(paren
...
suffix:semicolon
multiline_comment|/* little endian data length */
id|payload
op_assign
id|pos
op_plus
...
(brace
multiline_comment|/* should we really support this old stuff ? */
r_return
op_minus
id|EOPNOTSUPP
suffix:semicolon
...
multiline_comment|/* restart the card with new level. Needed ? */
id|mgt_commit
c_func
(paren
id|priv
...
DECL|macro|PRISM54_GET_BEACON
mdefine_line|#define PRISM54_GET_BEACON&t;SIOCIWFIRSTPRIV+1
DECL|macro|PRISM54_SET_BEACON
mdefine_line|#define PRISM54_SET_BEACON&t;SIOCIWFIRSTPRIV+2
DECL|macro|PRISM54_GET_POLICY
mdefine_line|#define PRISM54_GET_POLICY SIOCIWFIRSTPRIV+3
DECL|macro|PRISM54_SET_POLICY
mdefine_line|#define PRISM54_SET_POLICY SIOCIWFIRSTPRIV+4
DECL|macro|PRISM54_GET_MAC
mdefine_line|#define PRISM54_GET_MAC &t;   SIOCIWFIRSTPRIV+5
DECL|macro|PRISM54_ADD_MAC
mdefine_line|#define PRISM54_ADD_MAC &t;   SIOCIWFIRSTPRIV+6
DECL|macro|PRISM54_DEL_MAC
mdefine_line|#define PRISM54_DEL_MAC    SIOCIWFIRSTPRIV+8
DECL|macro|PRISM54_KICK_MAC
mdefine_line|#define PRISM54_KICK_MAC   SIOCIWFIRSTPRIV+10
DECL|macro|PRISM54_KICK_ALL
mdefine_line|#define PRISM54_KICK_ALL   SIOCIWFIRSTPRIV+12
DECL|macro|PRISM54_GET_WPA
mdefine_line|#define PRISM54_GET_WPA&t;   SIOCIWFIRSTPRIV+13
DECL|macro|PRISM54_SET_WPA
mdefine_line|#define PRISM54_SET_WPA&t;   SIOCIWFIRSTPRIV+14
DECL|macro|PRISM54_OID
mdefine_line|#define PRISM54_OID&t;   SIOCIWFIRSTPRIV+16
DECL|macro|PRISM54_GET_OID
mdefine_line|#define PRISM54_GET_OID&t;   SIOCIWFIRSTPRIV+17
DECL|macro|PRISM54_SET_OID
mdefine_line|#define PRISM54_SET_OID&t;   SIOCIWFIRSTPRIV+18

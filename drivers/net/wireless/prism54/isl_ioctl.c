...
suffix:semicolon
multiline_comment|/* These ioctls won&squot;t work with the new API */
r_int
...
(brace
multiline_comment|/*struct iwreq *wrq = (struct iwreq *) rq;&n;&t;   islpci_private *priv = netdev_priv(ndev);&n;&t;   int ret = 0;&n;&n;&t;   switch (cmd) {&n;&n;&t;   }&n;&t; */
r_return
op_minus
id|EOPNOTSUPP
suffix:semicolon

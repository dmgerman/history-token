...
id|__initdata
op_assign
l_string|&quot;orinoco_plx.c 0.13 (Daniel Barlow &lt;dan@telent.net&gt;, David Gibson &lt;hermes@gibson.dropbear.id.au&gt;)&quot;
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren

...
suffix:semicolon
multiline_comment|/* table of firmware file names */
r_static
r_struct
(brace
DECL|member|fw_type
...
id|fw_file
suffix:semicolon
DECL|member|fw_file_ext
r_const
r_char
op_star
id|fw_file_ext
suffix:semicolon
DECL|variable|fw_table
)brace
id|fw_table
(braket
)braket
...
op_assign
(paren
id|IW_QUAL_QUAL_INVALID
op_or
id|IW_QUAL_LEVEL_INVALID
)paren
suffix:semicolon
)brace
...
l_int|42
suffix:semicolon
multiline_comment|/* 502-rmfd-revd max by experiment, default for now */
r_switch
c_cond
(paren
id|priv-&gt;firmware_type
...
l_int|63
suffix:semicolon
multiline_comment|/* 502-rmfd-reve max by experiment */
r_break
suffix:semicolon
r_default
suffix:colon
...
l_int|0
suffix:semicolon
multiline_comment|/* get firmware filename entry based on firmware type ID */
r_while
c_loop
(paren
id|fw_table
...
op_increment
suffix:semicolon
multiline_comment|/* construct the actual firmware file name */
r_if
c_cond
(paren
id|fw_table

...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : set NWID&n; */
DECL|function|wavelan_set_nwid
r_static
r_int
id|wavelan_set_nwid
c_func
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : get NWID &n; */
DECL|function|wavelan_get_nwid
r_static
r_int
id|wavelan_get_nwid
c_func
...
DECL|function|wavelan_set_freq
r_static
r_int
id|wavelan_set_freq
c_func
...
DECL|function|wavelan_get_freq
r_static
r_int
id|wavelan_get_freq
c_func
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : set level threshold&n; */
DECL|function|wavelan_set_sens
r_static
r_int
id|wavelan_set_sens
c_func
...
multiline_comment|/* We should complain loudly if wrqu-&gt;sens.fixed = 0, because we&n;&t; * can&squot;t set auto mode... */
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Handler : get level threshold&n; */
DECL|function|wavelan_get_sens
r_static
r_int
id|wavelan_get_sens
c_func
...
DECL|function|wavelan_set_encode
r_static
r_int
id|wavelan_set_encode
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/* Check if capable of encryption */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|wavelan_get_encode
r_static
r_int
id|wavelan_get_encode
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
multiline_comment|/* Check if encryption is available */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|wavelan_get_range
r_static
r_int
id|wavelan_get_range
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Private Handler : get quality threshold&n; */
DECL|function|wavelan_get_qthr
r_static
r_int
id|wavelan_get_qthr
c_func
...
macro_line|#ifdef HISTOGRAM
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Private Handler : set histogram&n; */
DECL|function|wavelan_set_histo
r_static
r_int
id|wavelan_set_histo
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/* Disable histo while we copy the addresses.&n;&t; * As we don&squot;t disable interrupts, we need to do this */
id|lp-&gt;his_number
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Are there ranges to copy? */
r_if
c_cond
(paren
id|wrqu-&gt;data.length
...
multiline_comment|/* Reset result structure. */
id|memset
c_func
(paren
id|lp-&gt;his_sum
...
multiline_comment|/* Now we can set the number of ranges */
id|lp-&gt;his_number
op_assign
id|wrqu-&gt;data.length
suffix:semicolon
...
multiline_comment|/*------------------------------------------------------------------*/
multiline_comment|/*&n; * Wireless Private Handler : get histogram&n; */
DECL|function|wavelan_get_histo
r_static
r_int
id|wavelan_get_histo
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/* Bummer ! Why those are only at the end ??? */
id|wavelan_set_encode
comma
...
suffix:semicolon
DECL|variable|wavelan_private_handler
r_static
r_const
id|iw_handler
...
id|wavelan_set_histo
comma
multiline_comment|/* SIOCIWFIRSTPRIV + 2 */
id|wavelan_get_histo
comma
multiline_comment|/* SIOCIWFIRSTPRIV + 3 */
macro_line|#endif&t;/* HISTOGRAM */
)brace
suffix:semicolon
DECL|variable|wavelan_private_args
r_static
r_const
r_struct
id|iw_priv_args
...
suffix:semicolon
DECL|variable|wavelan_handler_def
r_static
r_const
r_struct
id|iw_handler_def
...
macro_line|#endif
multiline_comment|/* Prevent reentrancy. We need to do that because we may have&n;&t; * multiple interrupt handler running concurrently.&n;&t; * It is safe because interrupts are disabled before acquiring&n;&t; * the spinlock. */
id|spin_lock
c_func
(paren
op_amp
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: -&gt;wavelan_probe(dev=%p (base_addr=0x%x))&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|dev

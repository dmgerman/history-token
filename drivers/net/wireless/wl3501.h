...
DECL|macro|IW_MGMT_RATE_LABEL_MANDATORY
mdefine_line|#define IW_MGMT_RATE_LABEL_MANDATORY 128 /* MSB */
DECL|enum|iw_mgmt_rate_labels
r_enum
id|iw_mgmt_rate_labels
(brace
DECL|enumerator|IW_MGMT_RATE_LABEL_1MBIT
id|IW_MGMT_RATE_LABEL_1MBIT
op_assign
l_int|2
comma
DECL|enumerator|IW_MGMT_RATE_LABEL_2MBIT
id|IW_MGMT_RATE_LABEL_2MBIT
op_assign
l_int|4
comma
DECL|enumerator|IW_MGMT_RATE_LABEL_5_5MBIT
id|IW_MGMT_RATE_LABEL_5_5MBIT
op_assign
l_int|11
comma
DECL|enumerator|IW_MGMT_RATE_LABEL_11MBIT
id|IW_MGMT_RATE_LABEL_11MBIT
op_assign
l_int|22
comma
)brace
...
suffix:semicolon
multiline_comment|/*&n; * According to 802.11 Wireless Netowors, the definitive guide - O&squot;Reilly&n; * Pg 75&n; */
DECL|macro|IW_DATA_RATE_MAX_LABELS
mdefine_line|#define IW_DATA_RATE_MAX_LABELS 8
DECL|struct|iw_mgmt_data_rset
r_struct
id|iw_mgmt_data_rset
(brace
DECL|member|el
r_struct
id|iw_mgmt_info_element
id|el
suffix:semicolon
DECL|member|data_rate_labels
id|u8
id|data_rate_labels
(braket
id|IW_DATA_RATE_MAX_LABELS
)braket
suffix:semicolon
)brace
id|__attribute__
...
id|ssid
suffix:semicolon
DECL|member|bss_basic_rset
r_struct
id|iw_mgmt_data_rset
id|bss_basic_rset
suffix:semicolon
DECL|member|operational_rset
r_struct
id|iw_mgmt_data_rset
id|operational_rset
suffix:semicolon

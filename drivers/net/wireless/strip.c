...
multiline_comment|/*&n; * MTU has been changed by the IP layer. &n; * We could be in&n; * an upcall from the tty driver, or in an ip packet queue.&n; */
DECL|function|strip_change_mtu
r_static
r_int
id|strip_change_mtu
c_func
...
DECL|function|strip_seq_neighbours
r_static
r_void
id|strip_seq_neighbours
c_func
(paren
r_struct
id|seq_file
...
multiline_comment|/*&n; * This function prints radio status information via the seq_file&n; * interface.  The interface takes care of buffer size and over&n; * run issues. &n; *&n; * The buffer in seq_file is PAGESIZE (4K) &n; * so this routine should never print more or it will get truncated.&n; * With the maximum of 32 portables and 32 poletops&n; * reported, the routine outputs 3107 bytes into the buffer.&n; */
DECL|function|strip_seq_status_info
r_static
r_void
id|strip_seq_status_info
c_func
(paren
r_struct
id|seq_file
...
suffix:semicolon
multiline_comment|/*HexDump(&quot;strip_header&quot;, netdev_priv(dev), skb-&gt;data, skb-&gt;data + skb-&gt;len); */
r_if
c_cond
(paren
op_logical_neg
...
id|n
suffix:semicolon
multiline_comment|/* module ref count rules assure that all entries are unregistered */

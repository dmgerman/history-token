...
id|probe
comma
l_string|&quot;Arlan probe at initialization (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|numDevices
comma
l_string|&quot;Number of Arlan devices; ignored if &gt;1&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
(paren
id|KERN_ERR
l_string|&quot;ARLAN: init_etherdev failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_ERR
l_string|&quot;ARLAN: kmalloc of dev-&gt;priv failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0

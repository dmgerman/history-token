...
id|mem
comma
l_string|&quot;Arlan memory address for single device probing&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|arlan_debug
comma
l_string|&quot;Arlan debug enable (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|mdebug
comma
l_string|&quot;Arlan multicast debugging (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|retries
comma
l_string|&quot;Arlan maximum packet retransmisions&quot;
)paren
suffix:semicolon
...
id|arlan_entry_debug
comma
l_string|&quot;Arlan driver function entry debugging&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|arlan_exit_debug
comma
l_string|&quot;Arlan driver function exit debugging&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|arlan_entry_and_exit_debug
comma
l_string|&quot;Arlan driver function entry and exit debugging&quot;
)paren
suffix:semicolon
macro_line|#else
id|MODULE_PARM_DESC
...
(paren
id|KERN_DEBUG
l_string|&quot;arlan_command, %lx commandByte %x waiting %lx incoming %x &bslash;n&quot;
comma
id|jiffies
comma
id|READSHMB
...
(paren
id|KERN_ERR
l_string|&quot;card busy leaving command %lx&bslash;n&quot;
comma
id|priv-&gt;waiting_command_mask
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;%s registration is back after %ld milliseconds&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|lostTime
...
(brace
singleline_comment|// printk(KERN_WARNING &quot;arlan: memory region %lx excluded from probing &bslash;n&quot;,paddr);
r_return
op_minus
id|ENODEV
suffix:semicolon
...
DECL|function|arlan_setup_device
r_static
r_int
id|__init
id|arlan_setup_device
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
id|ap-&gt;Conf-&gt;pre_Command_Wait
op_assign
l_int|40
suffix:semicolon
id|ap-&gt;Conf-&gt;rx_tweak1
op_assign
l_int|30
suffix:semicolon
id|ap-&gt;Conf-&gt;rx_tweak2
op_assign
l_int|0
suffix:semicolon
id|err
...
suffix:semicolon
multiline_comment|/* &n;&t; * Reserve space for local data and a copy of the shared memory&n;&t; * that is used by the /proc interface.&n;&t; */
id|dev
op_assign
id|alloc_etherdev
c_func

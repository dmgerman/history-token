...
macro_line|#ifndef WAVELAN_CS_P_H
DECL|macro|WAVELAN_CS_P_H
mdefine_line|#define WAVELAN_CS_P_H
...
multiline_comment|/*&n; * wavelan_cs.c :&t;The actual code for the driver - C functions&n; *&n; * wavelan_cs.p.h :&t;Private header : local types / vars for the driver&n; *&n; * wavelan_cs.h :&t;Description of the hardware interface &amp; structs&n; *&n; * i82593.h :&t;&t;Description if the Ethernet controller&n; */
...
macro_line|#include &quot;wavelan_cs.h&quot;&t;/* Others bits of the hardware */
...
id|version
op_assign
l_string|&quot;wavelan_cs.c : v24 (SMP + wireless extensions) 11/1/02&bslash;n&quot;
suffix:semicolon
macro_line|#endif
...
mdefine_line|#define SIOCSIPHISTO&t;SIOCIWFIRSTPRIV + 4&t;/* Set histogram ranges */
DECL|macro|SIOCGIPHISTO
mdefine_line|#define SIOCGIPHISTO&t;SIOCIWFIRSTPRIV + 5&t;/* Get histogram values */
...
suffix:semicolon
macro_line|#endif&t;/* WAVELAN_CS_P_H */
eof

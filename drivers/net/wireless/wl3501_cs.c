...
macro_line|#else
DECL|macro|wl3501_loop
mdefine_line|#define wl3501_loop(__cmd) ({ __cmd; 0; })
macro_line|#endif
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Must drop this packet to ensure interrupt will come again&n;&t;&t; */
...
(brace
singleline_comment|//printk(KERN_ERR &quot;%s: Tx on stopped device!&bslash;n&quot;, dev-&gt;name);
r_return
l_int|1
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/*&n;&t; * Good! This packet owns the transmitter, block interrupt immediately.&n;&t; * wl3501_interrupt() has no chance to start the queue if it gets&n;&t; * ISR_Tx.&n;&t; */
multiline_comment|/*&n;&t; * Mask interrupts from the SUTRO!&n;&t; * We must mask interrupt from the same card, to prevent interrupt&n;&t; * routine from accessing data structure and I/O port while&n;&t; * wl3501_send_pkt is running. It&squot;s very important!&n;&t; */
id|enabled
op_assign
id|wl3501_block_interrupt
c_func

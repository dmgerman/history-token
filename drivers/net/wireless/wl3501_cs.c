...
macro_line|#endif
multiline_comment|/*&n; * Conversion from Channel (this-&gt;chan) to frequency, this information&n; * was obtained from the Planet WAP 1000 Access Point web interface. -acme&n; */
...
suffix:semicolon
r_case
id|WL3501_REG_DOMAIN_FCC
suffix:colon
r_case
id|WL3501_REG_DOMAIN_IC
suffix:colon
r_case
id|WL3501_REG_DOMAIN_ETSI
suffix:colon
r_default
suffix:colon
id|this-&gt;def_chan

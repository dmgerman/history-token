...
suffix:semicolon
multiline_comment|/*&n;     *  Allocate a 32K memory window.  Note that the dev_link_t&n;     *  structure provides space for one window handle -- if your&n;     *  device needs several windows, you&squot;ll need to keep track of&n;     *  the handles in your private data structure, dev-&gt;priv.&n;     */
id|DEBUG
c_func
(paren
l_int|1
...
multiline_comment|/*     netwave_private *priv = netdev_priv(dev); */

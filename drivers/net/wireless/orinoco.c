...
suffix:semicolon
multiline_comment|/* ioctl() routines */
r_static
r_int
...
(paren
id|KERN_ERR
l_string|&quot;%s: Error %d setting framentation&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|err
...
(paren
id|KERN_ERR
l_string|&quot;%s: Unable to disable port in orinco_reconfigure()&bslash;n&quot;
comma
id|priv-&gt;ndev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Unable to enable port in orinco_reconfigure()&bslash;n&quot;
comma
id|priv-&gt;ndev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* This must be called from user context, without locks held - use&n; * schedule_task() */
...
(paren
id|KERN_INFO
l_string|&quot;%s: orinoco_reset()&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: orinoco_reset: Error %d performing hard reset&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|err
...
multiline_comment|/********************************************************************/
multiline_comment|/* Hardware control functions                                       */
multiline_comment|/********************************************************************/
...
suffix:semicolon
multiline_comment|/* No need to lock, the resetting flag is already set in&n;&t; * alloc_orinocodev() */
id|priv-&gt;nicbuf_size
op_assign
...
id|__initdata
op_assign
l_string|&quot;orinoco.c 0.13 (David Gibson &lt;hermes@gibson.dropbear.id.au&gt; and others)&quot;
suffix:semicolon

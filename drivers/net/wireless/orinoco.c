...
multiline_comment|/* Change the WEP keys and/or the current keys.  Can be called&n; * either from __orinoco_hw_setup_wep() or directly from&n; * orinoco_ioctl_setiwencode().  In the later case the association&n; * with the AP is not broken (if the firmware can handle it),&n; * which is needed for 802.1x implementations. */
DECL|function|__orinoco_hw_setup_wepkeys
r_static
r_int
id|__orinoco_hw_setup_wepkeys
c_func
(paren
r_struct
id|orinoco_private
...
id|i
suffix:semicolon
multiline_comment|/* Force uniform key length to work around firmware bugs */
id|keylen
op_assign
id|le16_to_cpu
c_func
...
(brace
multiline_comment|/* Enable the shared-key authentication. */
id|err
op_assign
id|hermes_write_wordrec
c_func
...
id|USER_BAP
comma
id|HERMES_RID_CNFAUTHENTICATION_AGERE
comma
id|auth_flag
)paren
suffix:semicolon
...
id|master_wep_flag
op_assign
id|HERMES_WEP_PRIVACY_INVOKED
op_or
id|HERMES_WEP_EXCL_UNENCRYPTED
suffix:semicolon
r_else
id|master_wep_flag
op_assign
...
multiline_comment|/* Set priv-&gt;firmware type, determine firmware properties */
...
suffix:semicolon
multiline_comment|/* Get the hardware version */
id|err
op_assign
id|HERMES_READ_RECORD
c_func
...
(paren
id|KERN_ERR
l_string|&quot;%s: Cannot read hardware identity: error %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|err
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: Hardware identity %04x:%04x:%04x:%04x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|nic_id.id
...
(paren
id|KERN_ERR
l_string|&quot;%s: Cannot read station identity: error %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|err
...
(paren
id|KERN_ERR
l_string|&quot;%s: Primary firmware is active&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Tertiary firmware is active&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|0x1f
suffix:colon
multiline_comment|/* Intersil, Agere, Symbol Spectrum24 */
r_case
l_int|0x21
suffix:colon
multiline_comment|/* Symbol Spectrum24 Trilogy */
r_break
suffix:semicolon
r_default
suffix:colon
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: Unknown station ID, please report&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: Firmware determined as %s&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|priv-&gt;fw_name
...
(paren
id|KERN_ERR
l_string|&quot;%s: Incompatible firmware, aborting&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(brace
multiline_comment|/* We actually have a key to set - check its length */
r_if
c_cond
(paren
id|erq-&gt;length
...
id|setindex
suffix:semicolon
multiline_comment|/* Try fast key change if connected and only keys are changed */
r_if
c_cond
(paren
id|priv-&gt;wep_on
...
suffix:semicolon
multiline_comment|/* No need to commit if successful */
r_goto
id|out
suffix:semicolon
)brace

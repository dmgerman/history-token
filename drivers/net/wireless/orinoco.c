...
id|__initdata
op_assign
l_string|&quot;orinoco.c 0.07 (David Gibson &lt;hermes@gibson.dropbear.id.au&gt; and others)&quot;
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* FIXME: We need a better way of handling this */
multiline_comment|/* Set this flag to use 00:00:00 for the encapsulation oui instead of 00:00:F8 */
DECL|variable|use_alternate_encaps
r_static
r_int
id|use_alternate_encaps
suffix:semicolon
multiline_comment|/* =0 */
id|MODULE_PARM
c_func
...
suffix:semicolon
DECL|variable|alternate_encaps_hdr
r_struct
id|p8022_hdr
id|alternate_encaps_hdr
op_assign
(brace
l_int|0xaa
comma
...
suffix:semicolon
multiline_comment|/* How many times to retry if we get an EIO reading the BAP in the Rx path */
DECL|macro|RX_EIO_RETRY
mdefine_line|#define RX_EIO_RETRY&t;&t;10
DECL|struct|dldwd_commsqual
r_typedef
r_struct
id|dldwd_commsqual
(brace
...
id|err
suffix:semicolon
multiline_comment|/* Authentication is where Intersil and Symbol&n;&t;&t;&t; * firmware differ... */
r_if
c_cond
(paren
id|priv-&gt;firmware_type
...
(brace
multiline_comment|/* Symbol cards : set the authentication :&n;&t;&t;&t;&t; * 0 -&gt; no encryption, 1 -&gt; open,&n;&t;&t;&t;&t; * 2 -&gt; shared key&n;&t;&t;&t;&t; * 3 -&gt; shared key 128 -&gt; AP only */
r_if
c_cond
(paren
...
id|err
suffix:semicolon
multiline_comment|/* Master WEP setting is always 3 */
id|master_wep_flag
op_assign
l_int|3
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s: EIO reading frame header.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|2
comma
l_string|&quot;%s: BAP read suceeded: l=%d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|l
...
(brace
multiline_comment|/* Lucent Wavelan IEEE, Lucent Orinoco, Cabletron RoamAbout,&n;&t;&t;   ELSE, Meloc, HP, IBM, Dell 1150 */
id|printk
c_func
(paren
id|KERN_DEBUG
...
l_int|0x3
suffix:semicolon
multiline_comment|/* 11 Mb/s auto */
id|priv-&gt;need_card_reset
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME : we need to get Symbol firmware revision.&n;&t;&t; * I tried to use SYMBOL_***ARY_VER, but it didn&squot;t&n;&t;&t; * returned anything proper... */
id|priv-&gt;firmware_type
op_assign
id|FIRMWARE_TYPE_SYMBOL
suffix:semicolon
...
l_string|&quot;than v0.08 - several features not supported.&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* FIXME: ugh, what a hack for the 00:00:00 APs.  Need to find a better way */
r_if
c_cond
(paren
id|use_alternate_encaps
...
multiline_comment|/* We get these errors reported by the&n;&t;&t;&t;&t;   firmware every so often apparently at&n;&t;&t;&t;&t;   random.  Let the upper layers&n;&t;&t;&t;&t;   handle the retry */
id|DEBUG
c_func
(paren
l_int|1
comma
l_string|&quot;%s: DEBUG: EIO writing packet header to BAP&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Error %d writing packet header to BAP&quot;
comma
id|dev-&gt;name
comma
id|err
...
macro_line|#endif /* WIRELESS_EXT &gt; 10 */
DECL|function|dldwd_ioctl_setibssport
r_static
r_int
id|dldwd_ioctl_setibssport
c_func
(paren
r_struct
id|net_device
...
DECL|function|dldwd_ioctl_getibssport
r_static
r_int
id|dldwd_ioctl_getibssport
c_func
(paren
r_struct
id|net_device
...
l_int|1
comma
l_string|&quot;%s: SIOCDEVPRIVATE + 0x1 (card_reset)&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: Forcing card reset!&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s: SIOCDEVPRIVATE + 0x6 (set_ibssport)&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;%s: SIOCDEVPRIVATE + 0x7 (get_ibssport)&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon

multiline_comment|/* $Id: sunhme.h,v 1.33 2001/08/03 06:23:04 davem Exp $&n; * sunhme.h: Definitions for Sparc HME/BigMac 10/100baseT ethernet driver.&n; *           Also known as the &quot;Happy Meal&quot;.&n; *&n; * Copyright (C) 1996, 1999 David S. Miller (davem@redhat.com)&n; */
...
multiline_comment|/* Generic MII registers defined in linux/mii.h, these below&n; * are DP83840 specific.&n; */
...
suffix:semicolon
DECL|member|dma_sync_for_device
r_void
(paren
op_star
id|dma_sync_for_device
)paren
(paren
r_void
op_star

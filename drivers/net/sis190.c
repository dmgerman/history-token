...
id|dirty_tx
suffix:semicolon
DECL|member|tx_desc_raw
r_void
op_star
id|tx_desc_raw
suffix:semicolon
multiline_comment|/* Tx descriptor buffer */
DECL|member|tx_dma_raw
id|dma_addr_t
id|tx_dma_raw
suffix:semicolon
DECL|member|tx_dma_aligned
id|dma_addr_t
id|tx_dma_aligned
suffix:semicolon
DECL|member|rx_desc_raw
r_void
op_star
id|rx_desc_raw
suffix:semicolon
multiline_comment|/* Rx descriptor buffer */
DECL|member|rx_dma_raw
id|dma_addr_t
id|rx_dma_raw
suffix:semicolon
DECL|member|rx_dma_aligned
id|dma_addr_t
id|rx_dma_aligned
suffix:semicolon

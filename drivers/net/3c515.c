...
l_string|&quot; &quot;
id|DRV_RELDATE
l_string|&quot; becker@scyld.com and others&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/* we will need locking (and refcounting) if we ever use it for more */
r_static
id|LIST_HEAD
c_func
(paren

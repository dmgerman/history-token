...
multiline_comment|/* Chip rev needs workaround on HW &amp; multicast addr change */
DECL|macro|BROKEN_ADDRCHG_REV
mdefine_line|#define BROKEN_ADDRCHG_REV&t;0x0941
...
multiline_comment|/*&n;&t; * lazy allocate the driver-wide dummy buffer. (Note that we&n;&t; * never have more than one MACE in the system anyway)&n;&t; */
r_if
c_cond
(paren
id|dummy_buf
...
(paren
id|KERN_ERR
l_string|&quot;MACE: couldn&squot;t allocate dummy buffer&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t request IO resources !&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t allocate ethernet device !&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t map IO resources !&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t map TX DMA resources !&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t map RX DMA resources !&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
r_else
(brace
multiline_comment|/* Apple Network Server uses the AAUI port */
r_if
c_cond
(paren
...
r_else
(brace
macro_line|#ifdef CONFIG_MACE_AAUI_PORT
id|mp-&gt;port_aaui
op_assign
l_int|1
suffix:semicolon
...
id|mace_set_address
suffix:semicolon
multiline_comment|/*&n;&t; * Most of what is below could be moved to mace_open()&n;&t; */
id|mace_reset
c_func
(paren
id|dev
...
(paren
id|KERN_ERR
l_string|&quot;MACE: Cannot register net device, aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_free_rx_irq

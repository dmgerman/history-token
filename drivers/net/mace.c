...
multiline_comment|/*&n;&t; * lazy allocation - it&squot;s a driver-wide thing and it will live until&n;&t; * the unload, but we don&squot;t allocate it until it&squot;s needed&n;&t; */
r_if
c_cond
(paren
id|dummy_buf
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t request IO resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out1
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t request TX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out2
...
(paren
id|KERN_ERR
l_string|&quot;MACE: can&squot;t request RX DMA resource !&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out3

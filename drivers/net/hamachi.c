...
mdefine_line|#define TX_TOTAL_SIZE&t;TX_RING_SIZE*sizeof(struct hamachi_desc)
DECL|macro|RX_TOTAL_SIZE
mdefine_line|#define RX_TOTAL_SIZE&t;RX_RING_SIZE*sizeof(struct hamachi_desc)
...
mdefine_line|#define PRIV_ALIGN&t;15  &t;&t;&t;/* Required alignment mask */
DECL|macro|MII_CNT
...
id|ethtool_ops
suffix:semicolon
DECL|variable|ethtool_ops_no_mii
r_static
r_struct
id|ethtool_ops
id|ethtool_ops_no_mii
suffix:semicolon
...
id|dev
suffix:semicolon
id|hmp-&gt;mii_if.mdio_read
op_assign
id|mdio_read
suffix:semicolon
id|hmp-&gt;mii_if.mdio_write
op_assign
id|mdio_write
suffix:semicolon
id|hmp-&gt;mii_if.phy_id_mask
op_assign
l_int|0x1f
suffix:semicolon
id|hmp-&gt;mii_if.reg_num_mask
op_assign
l_int|0x1f
suffix:semicolon
id|ring_space
...
suffix:semicolon
macro_line|#if ADDRLEN == 64
multiline_comment|/* writellll anyone ? */
id|writel
c_func
(paren
id|cpu_to_le64
...
multiline_comment|/* Mark the last entry of the ring */
id|hmp-&gt;tx_ring
(braket
id|TX_RING_SIZE
op_minus
...
DECL|function|hamachi_get_drvinfo
r_static
r_void
id|hamachi_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
DECL|function|hamachi_get_settings
r_static
r_int
id|hamachi_get_settings
c_func
(paren
r_struct
id|net_device
...
DECL|function|hamachi_set_settings
r_static
r_int
id|hamachi_set_settings
c_func
(paren
r_struct
id|net_device
...
DECL|function|hamachi_nway_reset
r_static
r_int
id|hamachi_nway_reset
c_func
(paren
r_struct
id|net_device
...
DECL|function|hamachi_get_link
r_static
id|u32
id|hamachi_get_link
c_func

...
DECL|macro|desc_to_virt
mdefine_line|#define desc_to_virt(addr) bus_to_virt(le64_to_cpu(addr))
macro_line|#else 
DECL|macro|cpu_to_leXX
mdefine_line|#define cpu_to_leXX(addr)&t;cpu_to_le32(addr)
DECL|macro|desc_to_virt
mdefine_line|#define desc_to_virt(addr) bus_to_virt(le32_to_cpu(addr))
macro_line|#endif   

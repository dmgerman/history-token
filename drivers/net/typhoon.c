...
mdefine_line|#define DRV_MODULE_VERSION &t;&quot;1.5.3&quot;
DECL|macro|DRV_MODULE_RELDATE
mdefine_line|#define DRV_MODULE_RELDATE&t;&quot;03/12/15&quot;
DECL|macro|PFX
...
multiline_comment|/* 3Com&squot;s Linux driver uses txMultipleCollisions as it&squot;s&n;&t; * collisions value, but there is some other collision info as well...&n;&t; */
id|stats-&gt;tx_packets
op_assign
id|le32_to_cpu
c_func
...
r_inline
r_void
DECL|function|typhoon_ethtool_gdrvinfo
id|typhoon_ethtool_gdrvinfo
c_func
(paren
r_struct
id|typhoon
...
r_inline
r_void
DECL|function|typhoon_ethtool_gset
id|typhoon_ethtool_gset
c_func
(paren
r_struct
id|typhoon
...
r_inline
r_int
DECL|function|typhoon_ethtool_sset
id|typhoon_ethtool_sset
c_func
(paren
r_struct
id|typhoon
...
r_inline
r_int
DECL|function|typhoon_ethtool_ioctl
id|typhoon_ethtool_ioctl
c_func
(paren
r_struct
id|net_device
...
multiline_comment|/* If we transitioned from D3-&gt;D0 in pci_enable_device(),&n;&t; * we lost our configuration and need to restore it to the&n;&t; * conditions at boot.&n;&t; */
id|pci_restore_state
c_func
(paren
id|pdev

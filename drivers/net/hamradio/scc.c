...
multiline_comment|/*&n; * Please use z8530drv-utils-3.0 with this version.&n; *            ------------------&n; *&n; * You can find a subset of the documentation in &n; * Documentation/networking/z8530drv.txt.&n; */
...
DECL|function|__scc_start_tx_timer
r_static
r_void
id|__scc_start_tx_timer
c_func
(paren
r_struct
id|scc_channel
...
(paren
id|KERN_ERR
l_string|&quot;%s: can&squot;t register network device (%d)&bslash;n&quot;
comma
id|name
comma
id|err
...
DECL|function|scc_net_seq_start
r_static
r_void
op_star
id|scc_net_seq_start
c_func
(paren
r_struct
id|seq_file
...
DECL|function|scc_net_seq_next
r_static
r_void
op_star
id|scc_net_seq_next
...
DECL|function|scc_net_seq_stop
r_static
r_void
id|scc_net_seq_stop
c_func
...
DECL|function|scc_net_seq_show
r_static
r_int
id|scc_net_seq_show
c_func
...
suffix:semicolon
DECL|function|scc_net_seq_open
r_static
r_int
id|scc_net_seq_open
c_func
...
DECL|variable|scc_net_seq_fops
r_static
r_struct
id|file_operations
id|scc_net_seq_fops
...
multiline_comment|/* Guard against chip prattle */
...
multiline_comment|/* To unload the port must be closed so no real IRQ pending */
r_for
c_loop
(paren
id|k
...
suffix:semicolon
multiline_comment|/* Now clean up */
r_for
c_loop
(paren
id|k

...
multiline_comment|/* --------------------------------------------------------------------- */
multiline_comment|/*&n; * Initialize fields in hdlcdrv&n; */
DECL|function|hdlcdrv_setup
r_static
r_void
id|hdlcdrv_setup
c_func
...
multiline_comment|/* --------------------------------------------------------------------- */
DECL|function|hdlcdrv_register
r_struct
id|net_device
op_star
id|hdlcdrv_register
...
multiline_comment|/* --------------------------------------------------------------------- */
DECL|function|hdlcdrv_unregister
r_void
...
suffix:semicolon
DECL|variable|hdlcdrv_register
id|EXPORT_SYMBOL
c_func
(paren
id|hdlcdrv_register
...
suffix:semicolon
DECL|variable|hdlcdrv_unregister
id|EXPORT_SYMBOL
c_func
(paren
id|hdlcdrv_unregister

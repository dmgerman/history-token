...
mdefine_line|#define DRV_VERSION&t;&t;&quot;0.5.1&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&t;&quot;Nov 20, 2001&quot;
...
(paren
id|KERN_INFO
l_string|&quot;%s: set link %s, mode %x, sia %x,%x,%x,%x&bslash;n&quot;
id|KERN_INFO
l_string|&quot;                 set mode %x, set sia %x,%x,%x&bslash;n&quot;
comma
id|de-&gt;dev-&gt;name
comma
id|media_name
...
multiline_comment|/* move to next advertised media */
id|new_media
op_assign
id|de-&gt;media_type
suffix:semicolon
...
DECL|function|tulip_get_srom_info
r_static
r_void
id|__init
id|tulip_get_srom_info
(paren
r_struct
id|de_private
op_star
...
(paren
id|KERN_INFO
l_string|&quot;de%d: SROM-listed ports: %s%s%s&bslash;n&quot;
comma
id|de-&gt;board_idx
comma
id|de-&gt;media_supported
...
suffix:semicolon
multiline_comment|/* get MAC address, and some register values related to media types */
r_if
c_cond
(paren
id|de-&gt;de21040

...
suffix:semicolon
macro_line|#elif defined(CONFIG_SH_HICOSH4)
DECL|variable|__initdata
r_static
r_int
r_int
...
DECL|variable|g_cs89x0_media__force
r_static
r_int
id|g_cs89x0_media__force
suffix:semicolon
DECL|function|media_fn
r_static
r_int
id|__init
id|media_fn
...
c_func
(paren
l_string|&quot;cs89x0:cs89x0_probe(0x%x)&bslash;n&quot;
comma
id|io
)paren
suffix:semicolon
...
multiline_comment|/* WTF is going on here? */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* truely reset the chip */
id|outw
c_func
(paren
l_int|0x0114
...
(paren
id|KERN_INFO
l_string|&quot;%s: odd ioaddr 0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ioaddr
...
(paren
id|KERN_ERR
l_string|&quot;%s: bad signature 0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|inw
...
c_func
(paren
l_string|&quot;PP_addr=0x%x&bslash;n&quot;
comma
id|inw
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: incorrect signature 0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|inw
...
(brace
multiline_comment|/* For the HiCO.SH4 board, things are different: we don&squot;t&n;&t;&t;   have EEPROM, but there is some data in flash, so we go&n;&t;&t;   get it there directly (MAC). */
id|__u16
op_star
id|confd
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: PP_LineCTL=0x%x, adapter_cnf=0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|i
...
macro_line|#ifdef CONFIG_SH_HICOSH4 /* no EEPROM on HiCO, don&squot;t hazzle with it here */
r_if
c_cond
(paren
l_int|1
...
(paren
id|KERN_NOTICE
l_string|&quot;cs89x0: No EEPROM on HiCO.SH4&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: after force 0x%x, adapter_cnf=0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|lp-&gt;force

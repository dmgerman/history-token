...
(brace
multiline_comment|/* Nothing to do here ! it&squot;s not a removable module */
)brace
...
macro_line|#ifdef MDD_CUT
multiline_comment|/*&n; * ethernet_phy_set - Set the ethernet port PHY address.&n; *&n; * DESCRIPTION:&n; *       This routine set the ethernet port PHY address according to given &n; *       parameter.&n; *&n; * INPUT:&n; *&t;&t;unsigned int   eth_port_num   Ethernet Port number.&n; *&n; * OUTPUT:&n; *       Set PHY Address Register with given PHY address parameter.&n; *&n; * RETURN:&n; *       None.&n; */
...
macro_line|#ifdef MDD_CUT
multiline_comment|/*&n; * eth_b_copy - Copy bytes from source to destination&n; *&n; * DESCRIPTION:&n; *       This function supports the eight bytes limitation on Tx buffer size. &n; *       The routine will zero eight bytes starting from the destination address&n; *       followed by copying bytes from the source address to the destination.&n; *&n; * INPUT:&n; *       unsigned int src_addr    32 bit source address.&n; *       unsigned int dst_addr    32 bit destination address.&n; *       int        byte_count    Number of bytes to copy.&n; *&n; * OUTPUT:&n; *       See description.&n; *&n; * RETURN:&n; *       None.&n; *&n; */
DECL|function|eth_b_copy
r_static
r_void
id|eth_b_copy
c_func
...
(brace
multiline_comment|/* Zero the dst_addr area */
op_star
(paren
r_int
r_int

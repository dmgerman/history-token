...
DECL|macro|HP100_SIG_LEN
mdefine_line|#define HP100_SIG_LEN&t;&t;8&t;/* same as EISA_SIG_LEN */
...
l_string|&quot;HWPF150&quot;
comma
multiline_comment|/* HP J2573 rev A */
l_string|&quot;HWP1950&quot;
comma
multiline_comment|/* HP J2573 */
)brace
suffix:semicolon
macro_line|#ifdef CONFIG_EISA
DECL|variable|hp100_eisa_tbl
r_static
r_struct
id|eisa_device_id
id|hp100_eisa_tbl
...
comma
multiline_comment|/* HP J2577 rev A */
(brace
l_string|&quot;HWP1920&quot;
)brace
comma
multiline_comment|/* HP 27248B */
(brace
l_string|&quot;HWP1940&quot;
)brace
comma
multiline_comment|/* HP J2577 */
(brace
l_string|&quot;HWP1990&quot;
)brace
comma
...
comma
multiline_comment|/* ReadyLink ENET100-VG4 */
(brace
l_string|&quot;CPX0401&quot;
)brace
comma
...
comma
multiline_comment|/*&t;{PCI_VENDOR_ID_KTI, PCI_DEVICE_ID_KTI_DP200, PCI_ANY_ID, PCI_ANY_ID }, */
(brace
)brace
...
DECL|function|hp100_isa_probe1
r_static
id|__init
r_int
id|hp100_isa_probe1
...
multiline_comment|/*&n; * Probe for ISA board.&n; * EISA and PCI are handled by device infrastructure.&n; */
DECL|function|hp100_isa_probe
r_static
r_int
id|__init
id|hp100_isa_probe
...
id|ENODEV
suffix:semicolon
multiline_comment|/* Probe for a specific ISA address */
r_if
c_cond
(paren
id|addr
...
r_else
(brace
multiline_comment|/* Probe all ISA possible port regions */
r_for
c_loop
(paren
id|addr
...
(paren
id|KERN_WARNING
l_string|&quot;hp100_probe: bad ID checksum at base port 0x%x&bslash;n&quot;
comma
id|ioaddr
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;hp100_probe: bad lan address checksum at port 0x%x)&bslash;n&quot;
comma
id|ioaddr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;hp100: Memory area at 0x%lx-0x%lx&quot;
comma
id|mem_ptr_phys
comma
(paren
...
multiline_comment|/* received onto the card but have not been fully transferred of the card */
id|packets
op_assign
id|hp100_inb
c_func
...
id|lp-&gt;pci_dev
op_logical_and
id|lp-&gt;pci_dev-&gt;vendor
op_eq
id|PCI_VENDOR_ID
op_logical_and
(paren
id|lp-&gt;pci_dev-&gt;device
op_eq
id|PCI_DEVICE_ID_HP_J2970A
op_logical_or
id|lp-&gt;pci_dev-&gt;device
...
macro_line|#ifdef CONFIG_EISA
DECL|function|hp100_eisa_probe
r_static
r_int
id|__init
id|hp100_eisa_probe
...
c_func
(paren
l_string|&quot;hp100: %s: EISA adapter found at 0x%x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|dev-&gt;base_addr
...
DECL|function|hp100_eisa_remove
r_static
r_int
id|__devexit
id|hp100_eisa_remove
(paren
r_struct
id|device
op_star
...
DECL|variable|hp100_eisa_driver
r_static
r_struct
id|eisa_driver
id|hp100_eisa_driver
op_assign
(brace
dot
id|id_table
...
DECL|function|hp100_pci_remove
r_static
r_void
id|__devexit
id|hp100_pci_remove
...
DECL|variable|hp100_pci_driver
r_static
r_struct
id|pci_driver
id|hp100_pci_driver
...
suffix:semicolon
multiline_comment|/*&n; * Note: to register three isa devices, use:&n; * option hp100 hp100_port=0,0,0&n; *        to register one card at io 0x280 as eth239, use:&n; * option hp100 hp100_port=0x280&n; */
macro_line|#if defined(MODULE) &amp;&amp; defined(CONFIG_ISA)
...
l_int|0
suffix:semicolon
multiline_comment|/* Don&squot;t autoprobe ISA bus */
r_if
c_cond
(paren
id|hp100_port
...
(paren
id|KERN_WARNING
l_string|&quot;hp100: no memory for network device&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
DECL|function|hp100_isa_cleanup
r_static
r_void
id|__exit
id|hp100_isa_cleanup
c_func
(paren
r_void
)paren
...
macro_line|#else
DECL|macro|hp100_isa_init
mdefine_line|#define hp100_isa_init()&t;(0)
DECL|macro|hp100_isa_cleanup
mdefine_line|#define hp100_isa_cleanup()&t;do { } while(0)
macro_line|#endif

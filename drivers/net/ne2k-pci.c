...
mdefine_line|#define DRV_RELDATE&t;&quot;9/22/2003&quot;
...
suffix:semicolon
DECL|variable|ne2k_pci_ethtool_ops
r_static
r_struct
id|ethtool_ops
id|ne2k_pci_ethtool_ops
suffix:semicolon
"&f;"
...
multiline_comment|/* Allocate net_device, dev-&gt;priv; fill in 8390 specific dev fields. */
id|dev
op_assign
id|alloc_ei_netdev
c_func
...
multiline_comment|/* &n; * Magic incantation sequence for full duplex on the supported cards.&n; */
DECL|function|set_realtek_fdx
r_static
r_inline
r_int
id|set_realtek_fdx
...
suffix:semicolon
multiline_comment|/* Enable writes to CONFIG3 */
id|outb
c_func
(paren
l_int|0x40
...
suffix:semicolon
multiline_comment|/* Enable full duplex */
id|outb
c_func
(paren
l_int|0x00
...
suffix:semicolon
multiline_comment|/* Disable writes to CONFIG3 */
id|outb
c_func
(paren
id|E8390_PAGE0
...
DECL|function|ne2k_pci_set_fdx
r_static
r_int
id|ne2k_pci_set_fdx
c_func
...
DECL|function|ne2k_pci_get_drvinfo
r_static
r_void
id|ne2k_pci_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
DECL|function|ne2k_pci_suspend
r_static
r_int
id|ne2k_pci_suspend
(paren

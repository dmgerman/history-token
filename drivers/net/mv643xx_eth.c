...
r_static
r_char
id|mv643xx_driver_name
(braket
)braket
op_assign
l_string|&quot;mv643xx_eth&quot;
suffix:semicolon
DECL|variable|mv643xx_driver_version
r_static
r_char
id|mv643xx_driver_version
(braket
)braket
op_assign
l_string|&quot;1.0&quot;
...
DECL|function|eth_update_mib_counters
r_static
r_void
id|eth_update_mib_counters
c_func
(paren
r_struct
id|mv643xx_private
...
id|mp
comma
id|ETH_MIB_GOOD_OCTETS_RECEIVED_HIGH
)paren
op_lshift
l_int|32
suffix:semicolon
...
id|offset
op_assign
id|ETH_MIB_BAD_OCTETS_RECEIVED
suffix:semicolon
id|offset
op_le
id|ETH_MIB_FRAMES_1024_TO_MAX_OCTETS
suffix:semicolon
id|offset
op_add_assign
l_int|4
...
id|mp
comma
id|ETH_MIB_GOOD_OCTETS_SENT_LOW
)paren
suffix:semicolon
id|p-&gt;good_octets_sent
op_add_assign
...
id|mp
comma
id|ETH_MIB_GOOD_OCTETS_SENT_HIGH
)paren
op_lshift
l_int|32
suffix:semicolon
...
DECL|function|eth_port_autoneg_supported
r_static
r_int
id|eth_port_autoneg_supported
c_func
(paren
r_int
r_int
...
multiline_comment|/************* Begin ethtool support *************************/
DECL|struct|mv643xx_stats
r_struct
id|mv643xx_stats
(brace
...
suffix:semicolon
DECL|macro|MV643XX_STAT
mdefine_line|#define MV643XX_STAT(m) sizeof(((struct mv643xx_private *)0)-&gt;m), &bslash;&n;&t;&t;      offsetof(struct mv643xx_private, m)
DECL|variable|mv643xx_gstrings_stats
r_static
r_const
r_struct
id|mv643xx_stats
id|mv643xx_gstrings_stats
(braket
)braket
op_assign
(brace
...
comma
(brace
l_string|&quot;good_octets_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.good_octets_received
)paren
)brace
comma
(brace
l_string|&quot;bad_octets_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.bad_octets_received
)paren
)brace
comma
(brace
l_string|&quot;internal_mac_transmit_err&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.internal_mac_transmit_err
)paren
)brace
comma
(brace
l_string|&quot;good_frames_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.good_frames_received
)paren
)brace
comma
(brace
l_string|&quot;bad_frames_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.bad_frames_received
)paren
)brace
comma
(brace
l_string|&quot;broadcast_frames_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.broadcast_frames_received
)paren
)brace
comma
(brace
l_string|&quot;multicast_frames_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.multicast_frames_received
)paren
)brace
comma
(brace
l_string|&quot;frames_64_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_64_octets
)paren
)brace
comma
(brace
l_string|&quot;frames_65_to_127_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_65_to_127_octets
)paren
)brace
comma
(brace
l_string|&quot;frames_128_to_255_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_128_to_255_octets
)paren
)brace
comma
(brace
l_string|&quot;frames_256_to_511_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_256_to_511_octets
)paren
)brace
comma
(brace
l_string|&quot;frames_512_to_1023_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_512_to_1023_octets
)paren
)brace
comma
(brace
l_string|&quot;frames_1024_to_max_octets&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.frames_1024_to_max_octets
)paren
)brace
comma
(brace
l_string|&quot;good_octets_sent&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.good_octets_sent
)paren
)brace
comma
(brace
l_string|&quot;good_frames_sent&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.good_frames_sent
)paren
)brace
comma
(brace
l_string|&quot;excessive_collision&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.excessive_collision
)paren
)brace
comma
(brace
l_string|&quot;multicast_frames_sent&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.multicast_frames_sent
)paren
)brace
comma
(brace
l_string|&quot;broadcast_frames_sent&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.broadcast_frames_sent
)paren
)brace
comma
(brace
l_string|&quot;unrec_mac_control_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.unrec_mac_control_received
)paren
)brace
comma
(brace
...
c_func
(paren
id|mib_counters.fc_sent
)paren
)brace
comma
(brace
l_string|&quot;good_fc_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.good_fc_received
)paren
)brace
comma
(brace
l_string|&quot;bad_fc_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.bad_fc_received
)paren
)brace
comma
(brace
l_string|&quot;undersize_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.undersize_received
)paren
)brace
comma
(brace
l_string|&quot;fragments_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.fragments_received
)paren
)brace
comma
(brace
l_string|&quot;oversize_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.oversize_received
)paren
)brace
comma
(brace
l_string|&quot;jabber_received&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.jabber_received
)paren
)brace
comma
(brace
l_string|&quot;mac_receive_error&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.mac_receive_error
)paren
)brace
comma
(brace
l_string|&quot;bad_crc_event&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.bad_crc_event
)paren
)brace
comma
(brace
...
c_func
(paren
id|mib_counters.collision
)paren
)brace
comma
(brace
l_string|&quot;late_collision&quot;
comma
id|MV643XX_STAT
c_func
(paren
id|mib_counters.late_collision
)paren
)brace
comma
)brace
suffix:semicolon
DECL|macro|MV643XX_STATS_LEN
mdefine_line|#define MV643XX_STATS_LEN&t;&bslash;&n;&t;sizeof(mv643xx_gstrings_stats) / sizeof(struct mv643xx_stats)
r_static
r_int
DECL|function|mv643xx_get_settings
id|mv643xx_get_settings
c_func
(paren
r_struct
id|net_device
...
c_func
(paren
id|MV643XX_ETH_PORT_STATUS_REG
c_func
(paren
id|port_num
)paren
...
id|psr
op_amp
id|MV643XX_ETH_PORT_STATUS_MODE_10_BIT
suffix:semicolon
r_if
c_cond
(paren
...
id|pcs
op_amp
id|MV643XX_ETH_DISABLE_AUTO_NEG_FOR_DUPLX
)paren
suffix:semicolon
id|auto_speed
op_assign
...
id|pcs
op_amp
id|MV643XX_ETH_DISABLE_AUTO_NEG_SPEED_GMII
)paren
suffix:semicolon
id|ecmd-&gt;advertising
op_assign
...
id|pcs
op_amp
id|MV643XX_ETH_SET_FULL_DUPLEX_MODE
)paren
id|full_duplex
op_assign
l_int|1
...
id|pcs
op_amp
id|MV643XX_ETH_SET_MII_SPEED_TO_100
)paren
id|speed_100
op_assign
l_int|1
...
id|psr
op_amp
id|MV643XX_ETH_PORT_STATUS_GMII_1000
)paren
id|ecmd-&gt;speed
op_assign
id|SPEED_1000
...
id|psr
op_amp
id|MV643XX_ETH_PORT_STATUS_MII_100
)paren
id|ecmd-&gt;speed
op_assign
id|SPEED_100
...
id|psr
op_amp
id|MV643XX_ETH_PORT_STATUS_FULL_DUPLEX
)paren
id|ecmd-&gt;duplex
op_assign
id|DUPLEX_FULL
...
r_static
r_void
DECL|function|mv643xx_get_drvinfo
id|mv643xx_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
id|drvinfo-&gt;n_stats
op_assign
id|MV643XX_STATS_LEN
suffix:semicolon
)brace
r_static
r_int
DECL|function|mv643xx_get_stats_count
id|mv643xx_get_stats_count
c_func
(paren
r_struct
id|net_device
...
r_static
r_void
DECL|function|mv643xx_get_ethtool_stats
id|mv643xx_get_ethtool_stats
c_func
(paren
r_struct
id|net_device
...
r_static
r_void
DECL|function|mv643xx_get_strings
id|mv643xx_get_strings
c_func
(paren
r_struct
id|net_device

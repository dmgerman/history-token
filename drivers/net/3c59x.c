...
mdefine_line|#define DRV_VERSION&t;&quot;LK1.1.19&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&quot;10 Nov 2002&quot;
...
id|CH_3C982B
comma
DECL|enumerator|CH_905BT4
id|CH_905BT4
comma
DECL|enumerator|CH_920B_EMB_WNM
id|CH_920B_EMB_WNM
comma
)brace
suffix:semicolon
...
comma
(brace
l_string|&quot;3c920B-EMB-WNM (ATI Radeon 9100 IGP)&quot;
comma
id|PCI_USES_IO
op_or
id|PCI_USES_MASTER
...
comma
(brace
l_string|&quot;3c920B-EMB-WNM Tornado&quot;
comma
id|PCI_USES_IO
op_or
id|PCI_USES_MASTER
...
DECL|enumerator|Wn3_MaxPktSize
...
DECL|enumerator|Wn7_VlanEtherType
DECL|enumerator|Wn7_MasterLen
id|Wn7_MasterAddr
op_assign
l_int|0
comma
id|Wn7_VlanEtherType
op_assign
l_int|4
comma
id|Wn7_MasterLen
...
DECL|macro|DO_ZEROCOPY
mdefine_line|#define DO_ZEROCOPY 1
macro_line|#else
DECL|macro|DO_ZEROCOPY
mdefine_line|#define DO_ZEROCOPY 0
macro_line|#endif
...
suffix:semicolon
DECL|struct|vortex_extra_stats
r_struct
id|vortex_extra_stats
(brace
...
id|xstats
suffix:semicolon
multiline_comment|/* NIC-specific extra stats */
DECL|member|tx_skb
r_struct
id|sk_buff
op_star
...
multiline_comment|/* Some values here only for performance evaluation and path-coverage */
DECL|member|rx_nocopy
DECL|member|rx_copy
DECL|member|queued_packet
DECL|member|rx_csumhits
r_int
id|rx_nocopy
comma
id|rx_copy
...
DECL|member|large_frames
id|large_frames
suffix:colon
l_int|1
suffix:semicolon
multiline_comment|/* accept large frames */
DECL|member|drv_flags
r_int
id|drv_flags
suffix:semicolon
...
DECL|macro|DEVICE_PCI
mdefine_line|#define DEVICE_PCI(dev) (((dev)-&gt;bus == &amp;pci_bus_type) ? to_pci_dev((dev)) : NULL)
macro_line|#else
DECL|macro|DEVICE_PCI
mdefine_line|#define DEVICE_PCI(dev) NULL
macro_line|#endif
DECL|macro|VORTEX_PCI
mdefine_line|#define VORTEX_PCI(vp) (((vp)-&gt;gendev) ? DEVICE_PCI((vp)-&gt;gendev) : NULL)
macro_line|#ifdef CONFIG_EISA
DECL|macro|DEVICE_EISA
mdefine_line|#define DEVICE_EISA(dev) (((dev)-&gt;bus == &amp;eisa_bus_type) ? to_eisa_device((dev)) : NULL)
macro_line|#else
DECL|macro|DEVICE_EISA
mdefine_line|#define DEVICE_EISA(dev) NULL
macro_line|#endif
DECL|macro|VORTEX_EISA
mdefine_line|#define VORTEX_EISA(vp) (((vp)-&gt;gendev) ? DEVICE_EISA((vp)-&gt;gendev) : NULL)
...
comma
(brace
l_string|&quot;tx_multiple_collisions&quot;
)brace
comma
(brace
l_string|&quot;rx_bad_ssd&quot;
...
DECL|macro|VORTEX_NUM_STATS
mdefine_line|#define VORTEX_NUM_STATS     3
r_static
r_int
id|vortex_probe1
c_func
...
suffix:semicolon
DECL|variable|vortex_ethtool_ops
r_static
r_struct
id|ethtool_ops
id|vortex_ethtool_ops
suffix:semicolon
r_static
r_void
id|set_8021q_mode
...
l_int|1
suffix:semicolon
DECL|variable|global_full_duplex
r_static
r_int
id|global_full_duplex
op_assign
op_minus
l_int|1
suffix:semicolon
DECL|variable|global_enable_wol
r_static
r_int
id|global_enable_wol
op_assign
op_minus
l_int|1
suffix:semicolon
...
l_int|0x5900
suffix:semicolon
DECL|variable|compaq_net_device
r_static
r_struct
id|net_device
op_star
...
id|debug
comma
l_string|&quot;3c59x debug level (0-6)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|options
comma
l_string|&quot;3c59x: Bits 0-3: media type, bit 4: bus mastering, bit 9: full duplex&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|global_options
comma
l_string|&quot;3c59x: same as options, but applies to all NICs if options is unset&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|full_duplex
comma
l_string|&quot;3c59x full duplex setting(s) (1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|global_full_duplex
comma
l_string|&quot;3c59x: same as full_duplex, but applies to all NICs if options is unset&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|hw_checksums
comma
l_string|&quot;3c59x Hardware checksum checking by adapter(s) (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|flow_ctrl
comma
l_string|&quot;3c59x 802.3x flow control usage (PAUSE only) (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|enable_wol
comma
l_string|&quot;3c59x: Turn on Wake-on-LAN for adapter(s) (0-1)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|global_enable_wol
comma
l_string|&quot;3c59x: same as enable_wol, but applies to all NICs if options is unset&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|rx_copybreak
comma
l_string|&quot;3c59x copy breakpoint for copy-only-tiny-frames&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|max_interrupt_work
comma
l_string|&quot;3c59x maximum events handled per interrupt&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|compaq_ioaddr
comma
l_string|&quot;3c59x PCI I/O base address (Compaq BIOS problem workaround)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|compaq_irq
comma
l_string|&quot;3c59x PCI IRQ number (Compaq BIOS problem workaround)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|compaq_device_id
comma
l_string|&quot;3c59x PCI device ID (Compaq BIOS problem workaround)&quot;
)paren
suffix:semicolon
id|MODULE_PARM_DESC
c_func
...
id|watchdog
comma
l_string|&quot;3c59x transmit timeout in milliseconds&quot;
)paren
suffix:semicolon
macro_line|#ifdef CONFIG_NET_POLL_CONTROLLER
DECL|function|poll_vortex
r_static
r_void
id|poll_vortex
c_func
...
suffix:semicolon
DECL|variable|vortex_eisa_driver
r_static
r_struct
id|eisa_driver
...
suffix:semicolon
DECL|function|vortex_eisa_probe
r_static
r_int
id|vortex_eisa_probe
(paren
...
DECL|function|vortex_eisa_remove
r_static
r_int
id|vortex_eisa_remove
(paren
...
c_func
(paren
l_string|&quot;vortex_eisa_remove called for Compaq device!&bslash;n&quot;
)paren
suffix:semicolon
id|BUG
c_func
...
multiline_comment|/*&n; * Start up the PCI/EISA device which is described by *gendev.&n; * Return 0 on success.&n; *&n; * NOTE: pdev can be NULL, for the case of a Compaq device&n; */
...
id|card_idx
suffix:semicolon
multiline_comment|/* module list only for Compaq device */
r_if
c_cond
(paren
id|gendev
...
l_int|248
suffix:semicolon
multiline_comment|/* Check the PCI latency value.  On the 3c590 series the latency timer&n;&t;&t;&t;   must be set to the maximum value to avoid data corruption that occurs&n;&t;&t;&t;   when the timer expires during a transfer.  This bug exists the Vortex&n;&t;&t;&t;   chip only. */
...
id|mdio_read
suffix:semicolon
id|vp-&gt;mii.mdio_write
op_assign
id|mdio_write
suffix:semicolon
id|vp-&gt;mii.phy_id_mask
op_assign
l_int|0x1f
suffix:semicolon
id|vp-&gt;mii.reg_num_mask
op_assign
l_int|0x1f
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;  product code %02x%02x rev %02x.%d date %02d-&quot;
l_string|&quot;%02d-%02d&bslash;n&quot;
comma
id|eeprom
(braket
l_int|6
...
id|phyx
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * For the 3c905CX we look at index 24 first, because it bogusly&n;&t;&t;&t; * reports an external PHY at all indices&n;&t;&t;&t; */
r_if
c_cond
(paren
id|phy
...
(paren
id|KERN_INFO
l_string|&quot;%s: scatter/gather %sabled. h/w checksums %sabled&bslash;n&quot;
comma
id|print_name
comma
(paren
...
multiline_comment|/* OK, that didn&squot;t work.  Do it the slow way.  One second */
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_INFO
l_string|&quot;%s: command 0x%04x took %d usecs&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|cmd
...
(paren
id|KERN_INFO
l_string|&quot;%s: using NWAY device table, not %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|dev-&gt;if_port
...
l_string|&quot; info1 %04x, setting %s-duplex.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|vp-&gt;phys
...
suffix:semicolon
multiline_comment|/* enable 802.1q tagged frames */
id|set_8021q_mode
c_func
(paren
id|dev
...
(paren
id|KERN_EMERG
l_string|&quot;%s: no memory for rx ring&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Block interrupts because vortex_interrupt does a bare spin_lock()&n;&t;&t;&t; */
r_int
r_int
id|flags
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Probably a duplex mismatch.  See &quot;
l_string|&quot;Documentation/networking/vortex.txt&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|dump_tx_ring
...
suffix:semicolon
multiline_comment|/* 0x80000000 PCI master abort. */
multiline_comment|/* 0x40000000 PCI target abort. */
r_if
c_cond
(paren
id|vortex_debug
...
(paren
id|KERN_ERR
l_string|&quot;%s: PCI bus error, bus status %8.8x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|bus_status
...
multiline_comment|/* Must not enter D3 or we can&squot;t legally issue the reset! */
id|vortex_down
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* enable 802.1q VLAN tagged frames */
id|set_8021q_mode
c_func
(paren
id|dev
...
(paren
id|KERN_WARNING
l_string|&quot;%s: BUG! Tx Ring full, refusing to send buffer.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* Dubious. If in boomeang_interrupt &quot;faster&quot; cyclone ifdef&n;&t;&t; * were selected, this would corrupt DN_COMPLETE. No?&n;&t;&t; */
...
multiline_comment|/* h/w no longer present (hotplug)? */
r_goto
id|handler_exit
suffix:semicolon
r_if
...
suffix:semicolon
macro_line|#if DO_ZEROCOPY&t;&t;&t;&t;&t;
r_int
id|i
suffix:semicolon
r_for
...
(paren
id|KERN_DEBUG
l_string|&quot;boomerang_interrupt: wake queue&bslash;n&quot;
)paren
suffix:semicolon
id|netif_wake_queue
(paren
...
suffix:semicolon
multiline_comment|/* Disable receiving 802.1q tagged frames */
id|set_8021q_mode
c_func
(paren
id|dev
...
(paren
id|KERN_WARNING
l_string|&quot;%s supports hardware checksums, and we&squot;re not using them!&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;  Flags; bus-master %d, dirty %d(%d) current %d(%d)&bslash;n&quot;
comma
id|vp-&gt;full_bus_master_tx
comma
id|vp-&gt;dirty_tx
...
suffix:semicolon
multiline_comment|/* Extra stats for get_ethtool_stats() */
id|vp-&gt;xstats.tx_multiple_collisions
op_add_assign
id|inb
c_func
(paren
...
DECL|function|vortex_nway_reset
r_static
r_int
id|vortex_nway_reset
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_settings
r_static
r_int
id|vortex_get_settings
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_set_settings
r_static
r_int
id|vortex_set_settings
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_msglevel
r_static
id|u32
id|vortex_get_msglevel
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_set_msglevel
r_static
r_void
id|vortex_set_msglevel
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_stats_count
r_static
r_int
id|vortex_get_stats_count
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_ethtool_stats
r_static
r_void
id|vortex_get_ethtool_stats
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_strings
r_static
r_void
id|vortex_get_strings
c_func
(paren
r_struct
id|net_device
...
DECL|function|vortex_get_drvinfo
r_static
r_void
id|vortex_get_drvinfo
c_func
(paren
r_struct
id|net_device
...
suffix:semicolon
macro_line|#ifdef CONFIG_PCI
multiline_comment|/*&n; *&t;Must power the device up to do MDIO operations&n; */
...
multiline_comment|/* The kernel core really should have pci_get_power_state() */
r_if
c_cond
(paren
id|state
...
multiline_comment|/* Setup the card so that it can receive frames with an 802.1q VLAN tag.&n;   Note that this must be done after each RxReset due to some backwards&n;   compatibility logic in the Cyclone and Tornado ASICs */
multiline_comment|/* The Ethernet Type used for 802.1q tagged frames */
DECL|macro|VLAN_ETHER_TYPE
mdefine_line|#define VLAN_ETHER_TYPE 0x8100
DECL|function|set_8021q_mode
r_static
r_void
id|set_8021q_mode
c_func
...
(brace
multiline_comment|/* cyclone and tornado chipsets can recognize 802.1q&n;&t;&t; * tagged frames and treat them correctly */
r_int
id|max_pkt_size
op_assign
id|dev-&gt;mtu
...
l_int|14
suffix:semicolon
multiline_comment|/* MTU+Ethernet header */
r_if
c_cond
(paren
id|enable
...
l_int|4
suffix:semicolon
multiline_comment|/* 802.1Q VLAN tag */
id|EL3WINDOW
c_func
(paren
l_int|3
...
suffix:semicolon
multiline_comment|/* set VlanEtherType to let the hardware checksumming&n;&t;&t;   treat tagged frames correctly */
id|EL3WINDOW
c_func
(paren
l_int|7
...
r_else
(brace
multiline_comment|/* on older cards we have to enable large frames */
id|vp-&gt;large_frames
op_assign
id|dev-&gt;mtu
OG
...
c_func
(paren
l_string|&quot;vortex_remove_one called for Compaq device!&bslash;n&quot;
)paren
suffix:semicolon
id|BUG
c_func
...
suffix:semicolon
macro_line|#ifdef CONFIG_EISA
multiline_comment|/* Take care of the EISA devices */
...
id|vp
op_assign
id|compaq_net_device-&gt;priv
suffix:semicolon
id|ioaddr
op_assign
id|compaq_net_device-&gt;base_addr
suffix:semicolon
id|unregister_netdev
(paren
id|compaq_net_device

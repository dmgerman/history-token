...
id|__devinitdata
op_assign
l_string|&quot;3c59x.c:LK1.1.12 06 Jan 2000  Donald Becker and others. http://www.scyld.com/network/vortex.html &quot;
...
(paren
id|KERN_INFO
l_string|&quot;  product code &squot;%c%c&squot; rev %02x.%d date %02d-&quot;
...
l_int|1000
suffix:semicolon
singleline_comment|//&t;publish_netdev(dev);
r_return
l_int|0
suffix:semicolon
id|free_region
...
suffix:semicolon
singleline_comment|//&t;withdraw_netdev(dev);
...
(paren
id|KERN_INFO
l_string|&quot;%s: command 0x%04x took %d usecs! Please tell andrewm@uow.edu.au&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|cmd

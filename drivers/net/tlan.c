...
suffix:semicolon
multiline_comment|/* Set speed, duplex and aui settings */
DECL|variable|aui
r_static
r_int
id|aui
...
c_func
(paren
l_string|&quot;Maintainer: Samuel Chessman &lt;chessman@tux.org&gt;&quot;
)paren
suffix:semicolon
...
id|TLanPadBuffer
suffix:semicolon
DECL|variable|TLanPadBufferDMA
r_static
id|dma_addr_t
id|TLanPadBufferDMA
suffix:semicolon
...
op_assign
l_string|&quot;ThunderLAN driver v1.15&bslash;n&quot;
suffix:semicolon
...
l_int|31
suffix:semicolon
multiline_comment|/* &gt;&gt;= 32 is undefined for 32bit arch, stupid C */
id|addr
op_rshift_assign
l_int|1
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;TLAN: Could not reserve IO regions&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out
...
(paren
id|KERN_ERR
l_string|&quot;TLAN: No suitable PCI mapping available.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_free_dev
...
(paren
id|KERN_ERR
l_string|&quot;TLAN: No IO mappings available&bslash;n&quot;
)paren
suffix:semicolon
id|rc
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;TLAN: Could not set up device.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_free_dev
...
id|new_skb
suffix:semicolon
multiline_comment|/*&n;&t;&t; &t; *&t;I changed the algorithm here. What we now do&n;&t;&t; &t; *&t;is allocate the new frame. If this fails we&n;&t;&t; &t; *&t;simply recycle the frame.&n;&t;&t; &t; */
id|new_skb
op_assign
id|dev_alloc_skb
c_func
...
(paren
id|KERN_INFO
l_string|&quot;TLAN:  Please check that your adapter has&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;TLAN:  been properly connected to a HUB or Switch.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;TLAN:  Trying to establish link in the background...&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|TLan_SetTimer

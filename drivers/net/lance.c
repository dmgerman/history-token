...
id|card
(brace
DECL|member|id_offset14
r_char
id|id_offset14
suffix:semicolon
DECL|member|id_offset15
r_char
id|id_offset15
suffix:semicolon
DECL|variable|cards
...
comma
(brace
singleline_comment|//Racal InterLan EtherBlaster
dot
id|id_offset14
op_assign
l_int|0x52
...
(brace
multiline_comment|/* Detect the card with minimal I/O reads */
r_char
id|offset14
op_assign
id|inb
...
(brace
multiline_comment|/*yes, the first byte matches*/
r_char
id|offset15
op_assign
id|inb
...
(brace
multiline_comment|/*Signature OK*/
id|result
op_assign
id|lance_probe1
c_func
...
multiline_comment|/* We can&squot;t allocate dev-&gt;priv from alloc_etherdev() because it must&n;&t;   a ISA DMA-able region. */
id|SET_MODULE_OWNER
c_func
(paren
id|dev

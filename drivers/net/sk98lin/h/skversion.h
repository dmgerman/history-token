multiline_comment|/******************************************************************************&n; *&n; * Name:&t;version.h&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.2 $&n; * Date:&t;$Date: 2003/08/13 12:01:01 $&n; * Purpose:&t;SK specific Error log support&n; *&n; ******************************************************************************/
...
op_assign
l_string|&quot;@(#)SK-BUILD: 6.17 PL: 01&quot;
suffix:semicolon
macro_line|#endif&t;/* !defined(lint) */
DECL|macro|BOOT_STRING
mdefine_line|#define BOOT_STRING&t;&quot;sk98lin: Network Device Driver v6.17&bslash;n&quot; &bslash;&n;&t;&t;&t;&quot;(C)Copyright 1999-2003 Marvell(R).&quot;
DECL|macro|VER_STRING
mdefine_line|#define VER_STRING&t;&quot;6.17&quot;
eof

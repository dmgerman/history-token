multiline_comment|/******************************************************************************&n; *&n; * Name:&t;version.h&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.3 $&n; * Date:&t;$Date: 2003/08/25 13:34:48 $&n; * Purpose:&t;SK specific Error log support&n; *&n; ******************************************************************************/
...
op_assign
l_string|&quot;@(#)SK-BUILD: 6.18 PL: 01&quot;
suffix:semicolon
macro_line|#endif&t;/* !defined(lint) */
DECL|macro|BOOT_STRING
mdefine_line|#define BOOT_STRING&t;&quot;sk98lin: Network Device Driver v6.18&bslash;n&quot; &bslash;&n;&t;&t;&t;&quot;(C)Copyright 1999-2003 Marvell(R).&quot;
DECL|macro|VER_STRING
mdefine_line|#define VER_STRING&t;&quot;6.18&quot;
eof

multiline_comment|/******************************************************************************&n; *&n; * Name:&t;xmac_ii.h&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.28 $&n; * Date:&t;$Date: 2000/11/09 12:32:49 $&n; * Purpose:&t;Defines and Macros for XaQti&squot;s Gigabit Ethernet Controller&n; *&n; ******************************************************************************/
...
mdefine_line|#define XM_MMU_CMD&t;0x0000&t;&t;/* 16 bit r/w&t;MMU Command Register */
multiline_comment|/* 0x0004:&t;&t;reserved */
DECL|macro|XM_POFF
mdefine_line|#define XM_POFF&t;&t;0x0008&t;&t;/* 32 bit r/w&t;Packet Offset Register */
DECL|macro|XM_BURST
mdefine_line|#define XM_BURST&t;0x000c&t;&t;/* 32 bit r/w&t;Burst Register for half duplex*/
...
mdefine_line|#define XM_TX_CMD&t;0x0020&t;&t;/* 16 bit r/w&t;Transmit Command Register */
...
mdefine_line|#define XM_TX_STIME&t;0x0028&t;&t;/* 16 bit r/w&t;Transmit Slottime Register */
DECL|macro|XM_TX_IPG
mdefine_line|#define XM_TX_IPG&t;0x002c&t;&t;/* 16 bit r/w&t;Transmit Inter Packet Gap */
DECL|macro|XM_RX_CMD
mdefine_line|#define XM_RX_CMD&t;0x0030&t;&t;/* 16 bit r/w&t;Receive Command Register */
DECL|macro|XM_PHY_ADDR
mdefine_line|#define XM_PHY_ADDR&t;0x0034&t;&t;/* 16 bit r/w&t;PHY Address Register */
DECL|macro|XM_PHY_DATA
mdefine_line|#define&t;XM_PHY_DATA&t;0x0038&t;&t;/* 16 bit r/w&t;PHY Data Register */
multiline_comment|/* 0x003c: &t;&t;reserved */
DECL|macro|XM_GP_PORT
mdefine_line|#define XM_GP_PORT&t;0x0040&t;&t;/* 32 bit r/w&t;General Purpose Port Register */
DECL|macro|XM_IMSK
mdefine_line|#define XM_IMSK&t;&t;0x0044&t;&t;/* 16 bit r/w&t;Interrupt Mask Register */
DECL|macro|XM_ISRC
mdefine_line|#define XM_ISRC&t;&t;0x0048&t;&t;/* 16 bit ro&t;Interrupt Status Register */
DECL|macro|XM_HW_CFG
mdefine_line|#define XM_HW_CFG&t;0x004c&t;&t;/* 16 bit r/w&t;Hardware Config Register */
multiline_comment|/* 0x0050 - 0x005e:&t;reserved */
DECL|macro|XM_TX_LO_WM
mdefine_line|#define XM_TX_LO_WM&t;0x0060&t;&t;/* 16 bit r/w&t;Tx FIFO Low Water Mark */
DECL|macro|XM_TX_HI_WM
mdefine_line|#define XM_TX_HI_WM&t;0x0062&t;&t;/* 16 bit r/w&t;Tx FIFO High Water Mark */
DECL|macro|XM_TX_THR
mdefine_line|#define XM_TX_THR&t;0x0064&t;&t;/* 16 bit r/w&t;Tx Request Threshold */
DECL|macro|XM_HT_THR
mdefine_line|#define&t;XM_HT_THR&t;0x0066&t;&t;/* 16 bit r/w&t;Host Request Threshold */
DECL|macro|XM_PAUSE_DA
mdefine_line|#define&t;XM_PAUSE_DA&t;0x0068&t;&t;/* NA reg r/w&t;Pause Destination Address */
multiline_comment|/* 0x006e: &t;&t;reserved */
DECL|macro|XM_CTL_PARA
mdefine_line|#define XM_CTL_PARA&t;0x0070&t;&t;/* 32 bit r/w&t;Control Parameter Register */
...
mdefine_line|#define XM_TX_STAT&t;0x0078&t;&t;/* 32 bit ro&t;Tx Status LIFO Register */
...
mdefine_line|#define XM_DEV_ID&t;&t;0x0120&t;/* 32 bit ro&t;Device ID Register */
DECL|macro|XM_MODE
mdefine_line|#define XM_MODE&t;&t;&t;0x0124&t;/* 32 bit r/w&t;Mode Register */
DECL|macro|XM_LSA
mdefine_line|#define XM_LSA&t;&t;&t;0x0128&t;/* NA reg ro&t;Last Source Register */
multiline_comment|/* 0x012e:&t;&t;reserved */
DECL|macro|XM_TS_READ
mdefine_line|#define XM_TS_READ&t;&t;0x0130&t;/* 32 bit ro&t;TimeStamp Read Regeister */
DECL|macro|XM_TS_LOAD
mdefine_line|#define XM_TS_LOAD&t;&t;0x0134&t;/* 32 bit ro&t;TimeStamp Load Value */
...
mdefine_line|#define XM_TXF_OK&t;&t;0x0280&t;/* 32 bit ro&t;Frames Transmitted OK Conuter */
...
mdefine_line|#define XM_TXF_LONG&t;&t;0x0298&t;/* 32 bit ro&t;Tx Long Frame Counter */
...
mdefine_line|#define XM_TXF_DEF&t;&t;0x02b8&t;/* 32 bit ro&t;Tx Deferred Frame Counter */
...
mdefine_line|#define XM_TXP_UTIL&t;&t;0x02c8&t;/* 32 bit ro&t;Tx Utilization in % */
multiline_comment|/* 0x02cc - 0x02ce:&t;reserved */
DECL|macro|XM_TXF_64B
mdefine_line|#define XM_TXF_64B&t;&t;0x02d0&t;/* 32 bit ro&t;64 Byte Tx Frame Counter */
DECL|macro|XM_TXF_127B
mdefine_line|#define XM_TXF_127B&t;&t;0x02d4&t;/* 32 bit ro&t;65-127 Byte Tx Frame Counter */
DECL|macro|XM_TXF_255B
mdefine_line|#define XM_TXF_255B&t;&t;0x02d8&t;/* 32 bit ro&t;128-255 Byte Tx Frame Counter */
DECL|macro|XM_TXF_511B
mdefine_line|#define XM_TXF_511B&t;&t;0x02dc&t;/* 32 bit ro&t;256-511 Byte Tx Frame Counter */
...
mdefine_line|#define XM_RXF_OK&t;&t;0x0300&t;/* 32 bit ro&t;Frames Received OK */
...
mdefine_line|#define XM_RXE_RUNT&t;&t;0x034c&t;/* 32 bit ro&t;Rx Runt Event Counter */
...
mdefine_line|#define XM_RXP_UTIL&t;&t;0x0360&t;/* 32 bit ro&t;Rx Utilization in % */
multiline_comment|/* 0x0364 - 0x0366:&t;reserved */
DECL|macro|XM_RXF_64B
mdefine_line|#define XM_RXF_64B&t;&t;0x0368&t;/* 32 bit ro&t;64 Byte Rx Frame Counter */
DECL|macro|XM_RXF_127B
mdefine_line|#define XM_RXF_127B&t;&t;0x036c&t;/* 32 bit ro&t;65-127 Byte Rx Frame Counter */
DECL|macro|XM_RXF_255B
mdefine_line|#define XM_RXF_255B&t;&t;0x0370&t;/* 32 bit ro&t;128-255 Byte Rx Frame Counter */
DECL|macro|XM_RXF_511B
mdefine_line|#define XM_RXF_511B&t;&t;0x0374&t;/* 32 bit ro&t;256-511 Byte Rx Frame Counter */
...
mdefine_line|#define XM_TX_BK2BK&t;&t;(1&lt;&lt;6)&t;/* Bit&t;6:&t;Ignor Carrier Sense (tx Bk2Bk)*/
...
mdefine_line|#define XM_IPG_MSK&t;&t;0xff&t;/* Bit&t;7..0:&t;IPG value bits */
...
mdefine_line|#define XM_RX_TP_MD&t;&t;(1&lt;&lt;5)&t;/* Bit&t;5:&t;Enable transparent Mode */
...
mdefine_line|#define&t;XM_GP_ANIP&t;&t;(1L&lt;&lt;6)&t;/* Bit&t;6: (ro)&t;Auto Negotiation in Progress */
...
mdefine_line|#define XM_IS_AND&t;&t;(1&lt;&lt;7)&t;/* Bit&t;7:&t;Auto Negotiation Done */
...
mdefine_line|#define&t;XM_THR_MSK&t;&t;0x03ff&t;/* Bit 10.. 0&t;Tx FIFO Watermark bits */
...
mdefine_line|#define XM_ST_BURST&t;&t;(1L&lt;&lt;9)&t;&t;/* Bit&t;9:&t;p. xmitted in burst md*/
DECL|macro|XM_ST_DEFER
mdefine_line|#define XM_ST_DEFER&t;&t;(1L&lt;&lt;8)&t;&t;/* Bit&t;8:&t;packet was defered */
DECL|macro|XM_ST_BC
mdefine_line|#define XM_ST_BC&t;&t;(1L&lt;&lt;7)&t;&t;/* Bit&t;7:&t;Broadcast packet */
DECL|macro|XM_ST_MC
mdefine_line|#define XM_ST_MC&t;&t;(1L&lt;&lt;6)&t;&t;/* Bit&t;6:&t;Multicast packet */
DECL|macro|XM_ST_UC
...
mdefine_line|#define&t;XM_RX_WM_MSK&t;0x03ff&t;&t;/* Bit 11.. 0:&t;Rx FIFO Watermark bits */
...
mdefine_line|#define XM_MD_FTF&t;&t;(1L&lt;&lt;1)&t;&t;/* Bit&t;1: (sc)&t;Flush Tx FIFO */
DECL|macro|XM_MD_FRF
mdefine_line|#define XM_MD_FRF&t;&t;(1L&lt;&lt;0)&t;&t;/* Bit&t;0: (sc)&t;Flush Rx FIFO */
...
mdefine_line|#define XM_DEF_MODE&t;(XM_MD_RX_RUNT | XM_MD_RX_IRLE | XM_MD_RX_LONG |&bslash;&n;&t;&t;&t; XM_MD_RX_CRCE | XM_MD_RX_ERR | XM_MD_CSA | XM_MD_CAA)
...
mdefine_line|#define XMR_INV_MOC&t;&t;(1L&lt;&lt;9)&t;&t;/* Bit&t;9:&t;Rx with inv. MAC OC Ov*/
DECL|macro|XMR_INV_MP
mdefine_line|#define XMR_INV_MP&t;&t;(1L&lt;&lt;8)&t;&t;/* Bit&t;8:&t;Rx inv Pause Frame Ov */
...
mdefine_line|#define XMR_OK_OV&t;&t;(1L&lt;&lt;0)&t;&t;/* Bit&t;0:&t;Frames Received Ok Ov */
...
mdefine_line|#define XMT_MPAUSE&t;&t;(1L&lt;&lt;8)&t;&t;/* Bit&t;8:&t;Tx Pause MAC Ctrl-F Ov*/
DECL|macro|XMT_BURST
mdefine_line|#define XMT_BURST&t;&t;(1L&lt;&lt;7)&t;&t;/* Bit&t;7:&t;Tx Burst Event Cnt Ov */
DECL|macro|XMT_LONG
mdefine_line|#define XMT_LONG&t;&t;(1L&lt;&lt;6)&t;&t;/* Bit&t;6:&t;Tx Long Frame Cnt Ov */
...
mdefine_line|#define XMT_OK_OV&t;&t;(1L&lt;&lt;0)&t;&t;/* Bit&t;0:&t;Frames Tx Ok Ov */
...
mdefine_line|#define XMR_FS_RUNT&t;&t;(1L&lt;&lt;4)&t;&t;/* Bit&t;4:&t;Runt Error */
...
mdefine_line|#define XMR_FS_ERR&t;&t;(1L&lt;&lt;1)&t;&t;/* Bit&t;1:&t;Frame Error */
...
mdefine_line|#define&t;PHY_NAT_ID0&t;&t;&t;0x02&t;/* 16 bit ro&t;PHY ID0 Register */
DECL|macro|PHY_NAT_ID1
mdefine_line|#define&t;PHY_NAT_ID1&t;&t;&t;0x03&t;/* 16 bit ro&t;PHY ID1 Register */
...
mdefine_line|#define PHY_CT_ANE&t;&t;(1&lt;&lt;12)&t;/* Bit 12:&t;Autonegotiation Enabled */
...
mdefine_line|#define&t;PHY_I1_OUI&t;&t;(0x3f&lt;&lt;10)&t;/* Bit 15..10:&t;Organiz. Unique ID */
DECL|macro|PHY_I1_MOD_NUM
mdefine_line|#define PHY_I1_MOD_NUM&t;(0x3f&lt;&lt;4)&t;/* Bit&t;9.. 4:&t;Model Number */
DECL|macro|PHY_I1_REV
mdefine_line|#define PHY_I1_REV&t;&t;(0x0f&lt;&lt;0)&t;/* Bit&t;3.. 0:&t;Revision Number */
...
mdefine_line|#define PHY_X_AN_HD&t;&t;(1&lt;&lt;6)&t;/* Bit&t;6:&t;Half Duplex */
DECL|macro|PHY_X_AN_FD
mdefine_line|#define PHY_X_AN_FD&t;&t;(1&lt;&lt;5)&t;/* Bit&t;5:&t;Full Duplex */
...
multiline_comment|/*&t;PHY_AN_LP_NP&t;&t;(see XMAC) Bit&t;3:&t;Link Partner can Next Page */
multiline_comment|/*&t;PHY_AN_LOC_NP&t;&t;(see XMAC) Bit&t;2:&t;Local PHY can Next Page */
multiline_comment|/*&t;PHY_AN_RX_PG&t;&t;(see XMAC) Bit&t;1:&t;Page Received */
...
mdefine_line|#define PHY_L_AN_BP&t;&t;(1&lt;&lt;5)&t;/* Bit&t;5:&t;Base Page Indication */
...
mdefine_line|#define PHY_NP_ACK1&t;&t;(1&lt;&lt;14)&t;/* Bit 14: (ro)&t;Ack 1, for receiving a message*/
DECL|macro|PHY_NP_MSG_VAL
mdefine_line|#define PHY_NP_MSG_VAL&t;(1&lt;&lt;13)&t;/* Bit 13:&t;Message Page valid */
DECL|macro|PHY_NP_ACK2
mdefine_line|#define PHY_NP_ACK2&t;&t;(1&lt;&lt;12)&t;/* Bit 12:&t;Ack 2, comply with msg content*/
...
mdefine_line|#define PHY_X_RS_HD&t;&t;(1&lt;&lt;6)&t;/* Bit&t;6:&t;Half Duplex Mode selected */
DECL|macro|PHY_X_RS_FD
mdefine_line|#define PHY_X_RS_FD&t;&t;(1&lt;&lt;5)&t;/* Bit&t;5:&t;Full Duplex Mode selected */
...
DECL|macro|X_RFB_OK
mdefine_line|#define X_RFB_OK&t;&t;(0&lt;&lt;12)&t;/* Bit 12..13&t;No errors, Link OK */
DECL|macro|X_RFB_LF
mdefine_line|#define X_RFB_LF&t;&t;(1&lt;&lt;12)&t;/* Bit 12..13&t;Link Failure */
DECL|macro|X_RFB_OFF
mdefine_line|#define X_RFB_OFF&t;&t;(2&lt;&lt;12)&t;/* Bit 12..13&t;Offline */

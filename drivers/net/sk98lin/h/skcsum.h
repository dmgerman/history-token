...
macro_line|#ifndef SK_CS_CALCULATE_CHECKSUM
r_extern
r_int
...
suffix:semicolon
macro_line|#endif /* SK_CS_CALCULATE_CHECKSUM */
r_extern
r_int
id|SkCsEvent
c_func

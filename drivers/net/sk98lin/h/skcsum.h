multiline_comment|/******************************************************************************&n; *&n; * Name:&t;skcsum.h&n; * Project:&t;GEnesis - SysKonnect SK-NET Gigabit Ethernet (SK-98xx)&n; * Purpose:&t;Store/verify Internet checksum in send/receive packets.&n; *&n; ******************************************************************************/

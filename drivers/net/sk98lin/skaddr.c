multiline_comment|/******************************************************************************&n; *&n; * Name:&t;skaddr.c&n; * Project:&t;Gigabit Ethernet Adapters, ADDR-Module&n; * Purpose:&t;Manage Addresses (Multicast and Unicast) and Promiscuous Mode.&n; *&n; ******************************************************************************/

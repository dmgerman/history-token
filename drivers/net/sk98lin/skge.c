multiline_comment|/******************************************************************************&n; *&n; * Name:    skge.c&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.29.2.6 $&n; * Date:       &t;$Date: 2001/05/21 07:59:29 $&n; * Purpose:&t;The main driver source module&n; *&n; ******************************************************************************/
...
mdefine_line|#define DRV_MODULE_NAME&t;&t;&quot;sk98lin&quot;
DECL|macro|PFX
...
id|boards_found
suffix:semicolon
DECL|variable|SkInodeOps
r_struct
id|inode_operations
id|SkInodeOps
suffix:semicolon
singleline_comment|//static struct file_operations SkFileOps;  /* with open/relase */
...
suffix:semicolon
DECL|variable|sk_devs_lock
id|spinlock_t
id|sk_devs_lock
op_assign
id|SPIN_LOCK_UNLOCKED
suffix:semicolon
DECL|function|SkGeDevInit
r_static
r_int
id|SkGeDevInit
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Unable to register etherdev&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
multiline_comment|/*****************************************************************************&n; *&n; * &t;skge_init_one - init a single instance of a SK-98xx adapter&n; *&n; * Description:&n; *&t;This function allocates resources for an SK-98xx adapter and brings&n; *&t;it into Init 1 state.&n; *&n; * Returns:&n; *&t;0, if everything is ok&n; *&t;&lt;0, on error&n; */
DECL|function|skge_init_one
r_static
r_int
id|__devinit
id|skge_init_one
...
(paren
id|KERN_ERR
l_string|&quot;Unable to allocate etherdev structure!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_disable
...
(paren
id|KERN_ERR
l_string|&quot;Unable to allocate adapter structure!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out_free_dev
...
id|out_free_priv
suffix:semicolon
multiline_comment|/*&n;&t; * Dummy value.&n;&t; */
id|dev-&gt;base_addr
op_assign
l_int|42
suffix:semicolon
...
multiline_comment|/*&n;&t; * On big endian machines, we use the adapter&squot;s ability of&n;&t; * reading the descriptors as big endian.&n;&t; */
(brace
id|SK_U32
id|our2
suffix:semicolon
...
id|KERN_ERR
id|PFX
l_string|&quot;unable to map I/O register. &quot;
l_string|&quot;SK 98xx device disabled.&bslash;n&quot;
)paren
suffix:semicolon
id|ret
op_assign
...
multiline_comment|/* skge_init_one */
...
suffix:semicolon
multiline_comment|/* not used */
multiline_comment|/*****************************************************************************&n; *&n; * &t;skge_remove_one - remove a single instance of a SK-98xx adapter&n; *&n; * Description:&n; *&t;Disable adapter if it is still running, free resources,&n; *&t;free device struct.&n; *&n; * Returns: N/A&n; */
...
l_int|NULL
suffix:semicolon
multiline_comment|/* &n;&t; * otherwise unregister_netdev calls get_stats with&n;&t; * invalid IO ...  :-(&n;&t; */
id|unregister_netdev
c_func
(paren
id|dev
...
multiline_comment|/* skge_remove_one */
...
singleline_comment|// ReceiveIrq(pAC, &amp;pAC-&gt;RxPort[pAC-&gt;ActivePort]);
id|ReceiveIrq
c_func
(paren
id|pAC
...
multiline_comment|/* moderate only TX complete interrupts (these are not time critical) */
...
suffix:semicolon
multiline_comment|/* Found more than one port */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Stop both ports */
id|EvPara.Para32
(braket
l_int|0
)braket
...
(brace
singleline_comment|//&t;&t;pAC-&gt;JumboActivated = SK_TRUE; /* is never set back !!! */
id|pAC-&gt;GIni.GIPortUsage
op_assign
id|SK_JUMBO_LINK
suffix:semicolon
...
(brace
multiline_comment|/* Start both ports */
id|EvPara.Para32
(braket
l_int|0
)braket
...
c_func
(paren
l_string|&quot;MacFound = %d&bslash;nRlmtMode = %s&quot;
comma
id|pAC-&gt;GIni.GIMacsFound
comma
id|RlmtMode
...
suffix:semicolon
multiline_comment|/*****************************************************************************&n; *&n; * &t;skge_init - module initialization function&n; *&n; * Description:&n; *&t;root /proc directory allocation and pci driver invocation.&n; *&n; * Returns:&n; *&t;0, if everything is ok&n; *&t;!=0, on error&n; */
...
multiline_comment|/* skge_init */
DECL|function|skge_cleanup
r_static
r_void
id|__exit
id|skge_cleanup

multiline_comment|/******************************************************************************&n; *&n; * Name:    skge.c&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.63 $&n; * Date:       &t;$Date: 2003/07/15 09:26:23 $&n; * Purpose:&t;The main driver source module&n; *&n; ******************************************************************************/
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Invalid number of ports: %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|pAC-&gt;GIni.GIMacsFound

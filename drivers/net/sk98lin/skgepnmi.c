multiline_comment|/*****************************************************************************&n; *&n; * Name:&t;skgepnmi.c&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.111 $&n; * Date:&t;$Date: 2003/09/15 13:35:35 $&n; * Purpose:&t;Private Network Management Interface&n; *&n; ****************************************************************************/
...
op_assign
l_string|&quot;@(#) $Id: skgepnmi.c,v 1.111 2003/09/15 13:35:35 tschilli Exp $ (C) Marvell.&quot;
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Set value for physical ports */
id|PhysPortIndex
op_assign
id|SK_PNMI_PORT_LOG2PHYS
c_func
...
l_int|0
suffix:colon
multiline_comment|/* If LowPowerMode is active, we can leave it. */
r_if
c_cond
(paren
id|pAC-&gt;GIni.GP
...
l_int|4
suffix:colon
multiline_comment|/* If no LowPowerMode is active, we can enter it. */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:colon
multiline_comment|/* If we are in a LowPowerMode, we can leave it. */
r_if
c_cond
(paren
id|pAC-&gt;GIni.GP
...
l_int|4
suffix:colon
multiline_comment|/* If we are not already in LowPowerMode, we can enter it. */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Attach the DIAG to this adapter. */
r_case
id|SK_DIAG_ATTACHED
suffix:colon
multiline_comment|/* Check if we come from running */
r_if
c_cond
(paren
id|pAC-&gt;Pnmi.DiagAttached
...
id|SK_PNMI_ERR_OK
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t; * If DiagAttached is set, we can tell the driver&n;&t;&t;&t;&t;&t; * to enter the DIAG mode.&n;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|pAC-&gt;Pnmi.DiagAttached

...
mdefine_line|#define DRV_VERSION&t;&t;&quot;2.4.20-20021210&quot;
DECL|macro|DRV_RELDATE
mdefine_line|#define DRV_RELDATE&t;&t;&quot;December 10, 2002&quot;
DECL|macro|DRV_NAME
...
(paren
id|KERN_INFO
l_string|&quot;:: SIOCETHTOOL shows failure &bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
(brace
multiline_comment|/* if the network driver for the slave does not support&n;&t;&t; * ETHTOOL/MII link status reporting, warn the user of this&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Yes, the mii is overlaid on the&n;&t;&t;&t;&t;&t; * ifreq.ifr_ifru&n;&t;&t;&t;&t;&t; */
(paren
(paren
r_struct
id|mii_ioctl_data
...
(brace
multiline_comment|/* miimon is set but a bonded network driver does&n;&t;&t;&t; * not support ETHTOOL/MII and arp_interval is&n;&t;&t;&t; * not set&n;&t;&t;&t; */
id|printk
c_func
(paren
id|KERN_ERR
...
(brace
multiline_comment|/* no slaves in the bond, frame not sent */
id|dev_kfree_skb
c_func
(paren
id|skb
...
(brace
multiline_comment|/* currently, using a primary only makes sence &n;&t;&t; * in active backup mode &n;&t;&t; */
id|printk
c_func
(paren
id|KERN_WARNING
...
(paren
id|KERN_WARNING
l_string|&quot;bonding_init(): unknown multicast module &quot;
l_string|&quot;parameter (%d), multicast reset to %d&bslash;n&quot;
comma
id|multicast
comma
id|BOND_MULTICAST_ALL

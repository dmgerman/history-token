...
multiline_comment|/*#define MII_LINK_READY&t;(MII_LINK_UP | MII_ENDOF_NWAY)*/
DECL|macro|MII_LINK_READY
mdefine_line|#define MII_LINK_READY&t;(MII_LINK_UP)
DECL|macro|MAX_BOND_ADDR
mdefine_line|#define MAX_BOND_ADDR 256
...
multiline_comment|/* We need to unlock this because bond_release will re-lock it */
...
(brace
multiline_comment|/*&n;&t;bonding_t *bond = master-&gt;priv;&n;&t;slave_t *slave;&n;&n;&t;for (slave = bond-&gt;next; slave != (slave_t*)bond; slave = slave-&gt;next) {&n;&t;&t;slave-&gt;dev-&gt;mc_list = master-&gt;mc_list;&n;&t;&t;slave-&gt;dev-&gt;mc_count = master-&gt;mc_count;&n;&t;&t;slave-&gt;dev-&gt;flags = master-&gt;flags;&n;&t;&t;slave-&gt;dev-&gt;set_multicast_list(slave-&gt;dev);&n;&t;}&n; */
)brace
...
id|slave_dev
suffix:semicolon
multiline_comment|/* &n;&t; * queue to the end of the slaves list, make the first element its&n;&t; * successor, the last one its predecessor, and make it the bond&squot;s&n;&t; * predecessor. &n;&t; */
id|new_slave-&gt;prev
op_assign
id|bond-&gt;prev
suffix:semicolon
...
multiline_comment|/* if there&squot;s no active interface and we discovered that one&n;&t;   of the slaves could be activated earlier, so we do it.&n;&t;*/
id|read_lock
c_func
(paren
op_amp
...
(brace
multiline_comment|/*&n;&t;&t; * Clear the module reference that was added by dev_get_by_name&n;&t;&t; */
id|dev_put
c_func
(paren
id|slave_dev

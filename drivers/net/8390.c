...
id|flags
suffix:semicolon
macro_line|#if defined(CONFIG_M32R) &amp;&amp; defined(CONFIG_SMP)
r_int
r_int
id|icucr
suffix:semicolon
...
multiline_comment|/**&n; * ethdev_setup - init rest of 8390 device struct&n; * @dev: network device structure to init&n; *&n; * Initialize the rest of the 8390 device structure.  Do NOT __init&n; * this, as it is used by 8390 based modular drivers too.&n; */
DECL|function|ethdev_setup
r_static
r_void
id|ethdev_setup
c_func

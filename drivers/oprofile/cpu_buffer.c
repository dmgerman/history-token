...
mdefine_line|#define DEFAULT_TIMER_EXPIRE (HZ / 2)
...
multiline_comment|/* FIXME: not guaranteed to be on our CPU */
...
suffix:semicolon
multiline_comment|/* don&squot;t re-add the timer if we&squot;re shutting down */
r_if
c_cond
(paren
id|timers_enabled
...
multiline_comment|/* This serves to avoid cpu buffer overflow, and makes sure&n; * the task mortuary progresses&n; */
...
c_func
(paren
l_string|&quot;Timer on CPU%d, prefer CPU%d&bslash;n&quot;
comma
id|smp_processor_id
c_func
(paren
...
suffix:semicolon
multiline_comment|/* work will re-enable our timer */
)brace
eof

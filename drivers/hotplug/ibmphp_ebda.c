...
id|io_mem
suffix:semicolon
DECL|variable|chassis_str
DECL|variable|rxe_str
DECL|variable|str
r_char
op_star
id|chassis_str
...
DECL|function|convert_2digits_to_char
r_static
r_char
op_star
id|convert_2digits_to_char
(paren
r_int
id|var
)paren
...
l_int|0
suffix:colon
singleline_comment|//one digit number
op_star
id|str
op_assign
(paren
...
r_default
suffix:colon
singleline_comment|//2 digits number
op_star
id|str1
op_assign
(paren
...
multiline_comment|/* following 3 line: Now our driver only supports I2c/ISA ctlrType */
r_if
c_cond
(paren
(paren
...
id|err
(paren
l_string|&quot;Please run this driver on IBM xSeries440 or xSeries 235&bslash;n &quot;
)paren
suffix:semicolon
r_return
op_minus

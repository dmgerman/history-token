...
(brace
singleline_comment|//&t;&t;pci_insert_device (temp_func-&gt;pci_dev, bus);
singleline_comment|//&t;&t;pci_proc_attach_device(temp_func-&gt;pci_dev);
singleline_comment|//&t;&t;pci_announce_device_to_drivers(temp_func-&gt;pci_dev);
)brace
r_return
l_int|0
suffix:semicolon

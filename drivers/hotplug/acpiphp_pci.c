...
multiline_comment|/* enable pci_dev */
DECL|function|configure_pci_dev
r_static
r_int
id|configure_pci_dev
(paren
r_struct
id|pci_dev_wrapped
op_star
...
id|wrapped_dev-&gt;dev
suffix:semicolon
multiline_comment|/* TBD: support PCI-to-PCI bridge case */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
singleline_comment|//pci_proc_attach_device(dev);
...
multiline_comment|/* remove device driver */
DECL|function|unconfigure_pci_dev_driver
r_static
r_int
id|unconfigure_pci_dev_driver
(paren
r_struct
id|pci_dev_wrapped
op_star
...
multiline_comment|/* remove pci_dev itself from system */
DECL|function|unconfigure_pci_dev
r_static
r_int
id|unconfigure_pci_dev
(paren
r_struct
id|pci_dev_wrapped
op_star
...
id|wrapped_dev-&gt;dev
suffix:semicolon
multiline_comment|/* Now, remove the Linux Representation */
r_if
c_cond
(paren
id|dev
...
l_int|1
suffix:semicolon
multiline_comment|/* problems while freeing, abort visitation */
)brace
)brace
r_return
l_int|0
...
multiline_comment|/* remove pci_bus itself from system */
DECL|function|unconfigure_pci_bus
r_static
r_int
id|unconfigure_pci_bus
(paren
r_struct
id|pci_bus_wrapped
op_star
...
multiline_comment|/* for pci_visit_dev() */
...
id|func-&gt;pci_dev
suffix:semicolon
singleline_comment|//wrapped_dev.data = func;
id|wrapped_bus.bus
op_assign
id|func-&gt;slot-&gt;bridge-&gt;pci_bus
suffix:semicolon
singleline_comment|//wrapped_bus.data = func-&gt;slot-&gt;bridge;
id|retval
op_assign
id|pci_visit_dev
c_func

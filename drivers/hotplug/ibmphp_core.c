...
(brace
singleline_comment|//&t;&t;pci_proc_attach_device (temp_func-&gt;dev);
singleline_comment|//&t;&t;pci_announce_device_to_drivers (temp_func-&gt;dev);
)brace
r_return
l_int|0
suffix:semicolon
...
id|err
(paren
l_string|&quot;(i.e., &gt;1 133MHz cards running on same bus, or &gt;2 66 PCI cards running on same bus &bslash;n. Try hot-adding into another bus &bslash;n&quot;
)paren
suffix:semicolon
id|attn_off
(paren
...
id|slot_cur-&gt;flag
suffix:semicolon
multiline_comment|/* to see if got here from polling */
r_if
c_cond
(paren
id|flag
...
id|get_adapter_present
comma
multiline_comment|/*&t;.get_max_bus_speed_status =&t;get_max_bus_speed,&n;&t;.get_max_adapter_speed_status =&t;get_max_adapter_speed,&n;&t;.get_cur_bus_speed_status =&t;get_cur_bus_speed,&n;&t;.get_bus_name_status =&t;&t;get_bus_name,&n;*/
)brace
suffix:semicolon
...
multiline_comment|/* if no NVRAM module selected, lock ourselves into memory with a &n;&t; * module count of -1 so that no one can unload us. */

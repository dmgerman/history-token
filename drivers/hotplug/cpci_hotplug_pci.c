...
c_func
(paren
l_string|&quot;attempting removal of driver for device %02x:%02x.%x&quot;
comma
id|dev-&gt;bus-&gt;number
comma
id|PCI_SLOT
...
c_func
(paren
l_string|&quot;device is attached to a driver&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;%s - unconfigure phase 1&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon

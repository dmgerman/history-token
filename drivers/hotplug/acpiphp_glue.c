...
multiline_comment|/* callback routine to enumerate all the bridges in ACPI namespace */
r_static
id|acpi_status
DECL|function|find_host_bridge
id|find_host_bridge
(paren
id|acpi_handle
id|handle
...
suffix:semicolon
multiline_comment|/* TBD use acpi_get_devices() API */
r_if
c_cond
(paren

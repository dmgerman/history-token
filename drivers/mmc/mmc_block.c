...
multiline_comment|/*&n;&t; * Check for excessive requests.&n;&t; */
r_if
c_cond
(paren
id|req-&gt;sector
...
(paren
id|KERN_ERR
l_string|&quot;%s: bad request size&bslash;n&quot;
comma
id|req-&gt;rq_disk-&gt;disk_name
)paren
suffix:semicolon
...
id|req
suffix:semicolon
id|rq.data.timeout_ns
op_assign
id|card-&gt;csd.tacc_ns
op_star
l_int|10
suffix:semicolon
id|rq.data.timeout_clks
op_assign
id|card-&gt;csd.tacc_clks
op_star
l_int|10
suffix:semicolon
id|rq.data.blksz_bits
op_assign
id|md-&gt;block_bits
suffix:semicolon
id|rq.data.blocks

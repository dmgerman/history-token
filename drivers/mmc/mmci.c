...
(paren
id|KERN_ERR
l_string|&quot;MMCI: sinking excessive data&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|readl
...
id|count
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * If we run out of data, disable the data IRQs;&n;&t;&t;&t; * this prevents a race where the FIFO becomes&n;&t;&t;&t; * empty before the chip itself has disabled the&n;&t;&t;&t; * data path.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|host-&gt;size

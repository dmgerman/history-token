...
id|buffer
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check for data available.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Map the BIO buffer.&n;&t;&t; */
id|buffer
op_assign
id|bio_kmap_irq
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Ok, we&squot;ve completed that BIO, move on to next&n;&t;&t; * BIO in the chain.  Note: this doesn&squot;t actually&n;&t;&t; * complete the BIO!&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg

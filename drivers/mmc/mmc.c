...
suffix:semicolon
multiline_comment|/**&n; *&t;mmc_start_request - start a command on a host&n; *&t;@host: MMC host to start command on&n; *&t;@cmd: MMC command to start&n; *&n; *&t;Queue a command on the specified host.  We expect the&n; *&t;caller to be holding the host lock with interrupts disabled.&n; */
r_void

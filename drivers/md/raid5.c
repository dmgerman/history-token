...
macro_line|# define CHECK_DEVLOCK() assert_spin_locked(&amp;conf-&gt;device_lock)
macro_line|#else
DECL|macro|CHECK_DEVLOCK
...
(brace
multiline_comment|/* check if page is covered */
id|sector_t
id|sector
op_assign
id|sh-&gt;dev
...
multiline_comment|/*&t;&t;&t;&t;    &amp;&amp; !(!mddev-&gt;insync &amp;&amp; i == sh-&gt;pd_idx) */
)paren
id|rmw
op_increment
suffix:semicolon
...
DECL|function|raid5_issue_flush
r_static
r_int
id|raid5_issue_flush
c_func
(paren
id|request_queue_t
op_star
...
(brace
multiline_comment|/* Add failed due to overlap.  Flush everything&n;&t;&t;&t;&t; * and wait a while&n;&t;&t;&t;&t; */
id|raid5_unplug_device
c_func
(paren
id|mddev-&gt;queue
...
multiline_comment|/* if there is 1 or more failed drives and we are trying&n;&t; * to resync, then assert that we are finished, because there is&n;&t; * nothing we can do.&n;&t; */
r_if
c_cond
(paren
id|mddev-&gt;degraded
...
DECL|function|raid5_spare_active
r_static
r_int
id|raid5_spare_active
c_func
(paren
id|mddev_t
op_star
...
DECL|function|raid5_remove_disk
r_static
r_int
id|raid5_remove_disk
c_func
(paren
id|mddev_t
op_star
...
multiline_comment|/* no point adding a device */
r_return
l_int|0
suffix:semicolon

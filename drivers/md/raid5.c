...
suffix:semicolon
multiline_comment|/* There must be a spare_rdev, but there may not be a&n;&t; * failed_rdev.  That slot might be empty...&n;&t; */
...
DECL|function|raid5_spare_inactive
r_static
r_int
id|raid5_spare_inactive
c_func
(paren
id|mddev_t
op_star
...
DECL|function|raid5_spare_write
r_static
r_int
id|raid5_spare_write
c_func
(paren
id|mddev_t
op_star

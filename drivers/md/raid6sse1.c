...
multiline_comment|/*&n; * raid6sse1.c&n; *&n; * SSE-1/MMXEXT implementation of RAID-6 syndrome functions&n; *&n; * This is really an MMX implementation, but it requires SSE-1 or&n; * AMD MMXEXT for prefetch support and a few other features.  The&n; * support for nontemporal memory accesses is enough to make this&n; * worthwhile as a separate implementation.&n; */
macro_line|#if defined(__i386__)
macro_line|#include &quot;raid6.h&quot;
macro_line|#include &quot;raid6x86.h&quot;
multiline_comment|/* Defined in raid6mmx.c */
...
id|raid6_mmx_constants
suffix:semicolon
DECL|function|raid6_have_sse1_or_mmxext
r_static
r_int
id|raid6_have_sse1_or_mmxext
c_func
(paren
r_void
)paren
...
c_func
(paren
id|X86_FEATURE_MMXEXT
)paren
)paren
suffix:semicolon
macro_line|#else
multiline_comment|/* User space test code - this incorrectly breaks on some Athlons */
id|u32
id|features
op_assign
id|cpuid_features
...
multiline_comment|/*&n; * Plain SSE1 implementation&n; */
DECL|function|raid6_sse11_gen_syndrome
r_static
r_void
...
multiline_comment|/* This is really MMX code, not SSE */
id|raid6_before_mmx
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n; * Unrolled-by-2 SSE1 implementation&n; */
DECL|function|raid6_sse12_gen_syndrome
r_static
r_void
id|raid6_sse12_gen_syndrome
c_func
(paren
r_int
id|disks
...
suffix:semicolon
multiline_comment|/* Zero temp */
multiline_comment|/* We uniformly assume a single prefetch covers at least 16 bytes */
r_for
c_loop
(paren
id|d

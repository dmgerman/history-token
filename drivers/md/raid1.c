...
suffix:semicolon
DECL|function|check_all_w_bios_empty
r_static
r_inline
r_void
id|check_all_w_bios_empty
c_func
(paren
id|r1bio_t
op_star
...
DECL|function|check_all_bios_empty
r_static
r_inline
r_void
id|check_all_bios_empty
c_func
(paren
id|r1bio_t
op_star
...
DECL|function|raid_request_done
r_static
r_void
r_inline
id|raid_request_done
c_func
(paren
r_int
r_int
...
multiline_comment|/*&n; * Wait if the reconstruction state machine puts up a bar for&n; * new requests in this sector range:&n; */
DECL|function|new_request
r_static
r_inline
r_void
id|new_request
...
id|conf-&gt;mddev
suffix:semicolon
multiline_comment|/*&n;&t; * If reconstruction was interrupted, we need to close the &quot;active&quot;&n;&t; * and &quot;pending&quot; holes.&n;&t; * we know that there are no active rebuild requests,&n;&t; * os cnt_active == cnt_ready == 0&n;&t; */
id|spin_lock_irq
c_func
(paren
op_amp
...
DECL|function|wait_sync_pending
r_static
r_void
id|wait_sync_pending
c_func
(paren
id|conf_t
op_star
...
(brace
singleline_comment|//&t;&t;printk(&quot;wait .. sect=%lu start_active=%d ready=%d pending=%d future=%d, cnt_done=%d active=%d ready=%d pending=%d future=%d&bslash;n&quot;, sector_nr, conf-&gt;start_active, conf-&gt;start_ready, conf-&gt;start_pending, conf-&gt;start_future, conf-&gt;cnt_done, conf-&gt;cnt_active, conf-&gt;cnt_ready, conf-&gt;cnt_pending, conf-&gt;cnt_future);
id|wait_event_lock_irq
c_func
(paren
id|conf-&gt;wait_done

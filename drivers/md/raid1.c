...
(brace
multiline_comment|/* allocate cnt buffer_heads, possibly less if kmalloc fails */
r_int
id|i
op_assign
l_int|0
...
(brace
multiline_comment|/* discard all buffer_heads */
id|md_spin_lock_irq
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* don&squot;t need to wakeup wait_buffer because&n;&t;&t; *  raid1_free_bh below will do that&n;&t;&t; */
)brace
r_else
(brace
id|kfree
...
(brace
multiline_comment|/* Gag - all mirrors non-operational.. */
id|raid1_end_bh_io
c_func
(paren
id|r1_bh
...
id|i
suffix:semicolon
multiline_comment|/* Find the drive.&n;&t; * If it is not operational, then we have already marked it as dead&n;&t; * else if it is the last working disks, ignore the error, let the&n;&t; * next level up know.&n;&t; * else mark the drive as failed&n;&t; */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* Don&squot;t fail the drive, act as though we were just a&n;&t;&t; * normal single drive&n;&t;&t; */
r_return
l_int|1
suffix:semicolon
)brace
...
(brace
multiline_comment|/* nowhere to write this too... I guess we&n;&t;&t;&t;&t;&t; * must be done&n;&t;&t;&t;&t;&t; */
id|sync_request_done
c_func
(paren
id|bh-&gt;b_blocknr
...
r_else
(brace
multiline_comment|/* There is no point trying a read-for-reconstruct&n;&t;&t;&t;&t; * as reconstruct is about to be aborted&n;&t;&t;&t;&t; */
id|printk
(paren
id|IO_ERROR
comma

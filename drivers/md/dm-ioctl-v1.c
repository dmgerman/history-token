...
multiline_comment|/* suspend the device */
id|r
op_assign
id|dm_suspend
c_func
...
multiline_comment|/* swap in the table */
id|r
op_assign
id|dm_swap_table
c_func
...
multiline_comment|/* resume the device */
id|r
op_assign
id|dm_resume
c_func

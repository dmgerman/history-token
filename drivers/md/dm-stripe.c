...
multiline_comment|/*&n; * FIXME: Nasty function, only present because we can&squot;t link&n; * against __moddi3 and __divdi3.&n; *&n; * returns a == b * n&n; */
...
id|sc-&gt;stripes
suffix:semicolon
multiline_comment|/* 32bit modulus */
id|chunk
op_assign
id|chunk
op_div

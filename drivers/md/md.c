...
(paren
id|KERN_INFO
l_string|&quot;md: md%d in safe mode&bslash;n&quot;
comma
id|mdidx
c_func
(paren
...
(brace
multiline_comment|/* interrupted but no write errors */
id|printk
c_func
(paren
id|KERN_INFO

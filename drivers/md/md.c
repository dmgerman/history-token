...
multiline_comment|/* set rdev-&gt;desc_nr for each device.&n;&t; * for MULTIPATH, we just us sequential number as&n;&t; * nothing else is meaningful&n;&t; */
id|i
op_assign
l_int|0
suffix:semicolon

...
l_int|0
suffix:semicolon
multiline_comment|/* no recovery is running.&n;&t;&t; * remove any failed drives, then&n;&t;&t; * add spares if possible.&n;&t;&t; * Spare are also removed and re-added, to allow&n;&t;&t; * the personality to fail the re-add.&n;&t;&t; */
id|ITERATE_RDEV
c_func
(paren
id|mddev

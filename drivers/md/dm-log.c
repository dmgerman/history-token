...
multiline_comment|/*----------------------------------------------------------------&n; * constructor/destructor&n; *--------------------------------------------------------------*/
...
c_func
(paren
l_string|&quot;wrong number of arguments to log_c&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;wrong number of arguments to log_d&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|r
suffix:semicolon
multiline_comment|/* zero any new bits if the mirror has grown */
r_for
c_loop
(paren
id|i

...
multiline_comment|/*&n; * Different IV generation algorithms:&n; *&n; * plain: the initial vector is the 32-bit low-endian version of the sector&n; *        number, padded with zeros if neccessary.&n; */
...
id|tfm
suffix:semicolon
multiline_comment|/*&n;&t; * Choose ivmode. Valid modes: &quot;plain&quot;&n;&t; * See comments at iv code&n;&t; */
r_if
c_cond
(paren
id|ivmode

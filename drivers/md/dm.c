...
multiline_comment|/* FIXME: shouldn&squot;t suspended count a congested ? */
id|r
op_assign
id|bdi_bits
suffix:semicolon
...
DECL|function|dm_add_wait_queue
r_int
...
DECL|function|dm_remove_wait_queue
r_void

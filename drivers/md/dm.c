...
l_int|0
suffix:semicolon
DECL|macro|MINORS_SIZE
mdefine_line|#define MINORS_SIZE(minors) ((minors / BITS_PER_LONG) * sizeof(unsigned long))
DECL|function|realloc_minor_bits
r_static
r_int
id|realloc_minor_bits
c_func
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Round up the requested minor to the next power-of-2. */
id|max_minors
op_assign
l_int|1
op_lshift
...
suffix:semicolon
multiline_comment|/* Copy the existing bit-set to the new one. */
r_if
c_cond
(paren
id|_minor_bits

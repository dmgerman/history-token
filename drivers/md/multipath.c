...
suffix:semicolon
DECL|function|multipath_alloc_bh
r_struct
id|buffer_head
op_star
id|multipath_alloc_bh
c_func
(paren
id|multipath_conf_t
op_star
...
DECL|function|multipath_free_bh
r_static
r_inline
r_void
id|multipath_free_bh
c_func
(paren
id|multipath_conf_t
op_star
...
DECL|function|multipath_grow_bh
r_static
r_int
id|multipath_grow_bh
c_func
(paren
id|multipath_conf_t
op_star
...
DECL|function|multipath_shrink_bh
r_static
r_int
id|multipath_shrink_bh
c_func
(paren
id|multipath_conf_t
op_star
...
DECL|function|multipath_free_buf
r_static
r_inline
r_void
id|multipath_free_buf
c_func
(paren
r_struct
id|multipath_bh
...
(paren
id|KERN_ERR
l_string|&quot;multipath: %s: rescheduling block %lu&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
multiline_comment|/*&n; * This routine returns the disk from which the requested read should&n; * be done. It bookkeeps the last read position for every disk&n; * in array and when new read requests come, the disk which last&n; * position is nearest to the request, is chosen.&n; *&n; * TODO: now if there are 2 multipaths in the same 2 devices, performance&n; * degrades dramatically because position is multipath, not device based.&n; * This should be changed to be device based. Also atomic sequential&n; * reads should be somehow balanced.&n; */
...
id|mddev-&gt;sb
suffix:semicolon
singleline_comment|//&t;&t;&t;MD_BUG();
id|spare
op_assign
id|get_spare
c_func
...
suffix:semicolon
singleline_comment|//&t;&t;&t;&t;MD_BUG();
)brace
r_if
c_cond
(paren
...
suffix:semicolon
singleline_comment|//&t;&t;if (failed_rdev-&gt;alias_device)
singleline_comment|//&t;&t;&t;MD_BUG();
singleline_comment|//&t;&t;if (!spare_rdev-&gt;alias_device)
singleline_comment|//&t;&t;&t;MD_BUG();

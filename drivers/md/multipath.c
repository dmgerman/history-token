...
multiline_comment|/*&n; * Find the spare disk ... (can only be in the &squot;high&squot; area of the array)&n; */
...
DECL|function|multipath_spare_inactive
r_static
r_int
id|multipath_spare_inactive
c_func
(paren
id|mddev_t
op_star
...
DECL|function|multipath_spare_write
r_static
r_int
id|multipath_spare_write
c_func
...
DECL|function|multipath_spare_active
r_static
r_int
id|multipath_spare_active
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; * Find the failed disk within the MULTIPATH configuration ...&n;&t; * (this can only be in the first conf-&gt;working_disks part)&n;&t; */
r_for
c_loop
(paren
id|i

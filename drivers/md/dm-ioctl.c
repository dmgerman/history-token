...
id|md
suffix:semicolon
multiline_comment|/* I hate devfs */
...
l_int|0
suffix:semicolon
multiline_comment|/* devfs not present */
r_if
c_cond
(paren
id|r
...
c_func
(paren
l_string|&quot;devfs_generate_path failed for control device&quot;
)paren
suffix:semicolon
r_goto
id|failed
...
c_func
(paren
l_string|&quot;devfs_mk_symlink failed for control device&quot;
)paren
suffix:semicolon
r_goto
id|failed

...
c_func
(paren
l_string|&quot;block %d/%d not uptodate on parity calc&bslash;n&quot;
comma
id|i
comma
id|count
...
c_func
(paren
l_string|&quot;compute_2 with missing block %d/%d&bslash;n&quot;
comma
id|count
comma
id|i
...
multiline_comment|/* if there are 2 or more failed drives and we are trying&n;&t; * to resync, then assert that we are finished, because there is&n;&t; * nothing we can do.&n;&t; */
r_if
c_cond
(paren
id|mddev-&gt;degraded

...
mdefine_line|#define USE_HE_FIND_VCC
...
suffix:semicolon
macro_line|#ifndef USE_HE_FIND_VCC
id|he_dev-&gt;he_vcc_table
op_assign
id|kmalloc
c_func
(paren
...
suffix:semicolon
macro_line|#ifdef USE_HE_FIND_VCC
r_if
c_cond
(paren
id|cid
...
c_func
(paren
l_string|&quot;atm_find_ci err = %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon

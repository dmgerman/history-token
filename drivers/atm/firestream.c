...
id|atm_vcc-&gt;qos.rxtp
suffix:semicolon
multiline_comment|/* XXX Use VPI? How many bits? Which bits? */
id|uaddr
op_assign
id|atm_vcc-&gt;dev-&gt;number
op_minus
...
(brace
multiline_comment|/* -- RAS1 : FS155 and 50 differ. Default (0) should be OK for FS155, FS50/multiphy needs the maxPHY set... */
id|write_fs
(paren
id|dev
comma
...
multiline_comment|/* Enable selecting for Utopia address for multiphy configs. */
id|write_fs
(paren
id|dev
comma
...
multiline_comment|/* XXX if another device is registering atm devices at the same time&n;&t;   we get confusion.  */
id|fs_dev-&gt;start_number
op_assign
id|fs_dev-&gt;atm_dev
(braket
l_int|0

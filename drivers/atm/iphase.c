...
c_func
(paren
l_string|&quot;RECOVER run!! desc_tbl %d = %d  delta = %ld, time = %ld&bslash;n&quot;
comma
id|i
comma
id|dev-&gt;desc_tbl
...
id|iadev-&gt;pci
comma
id|iadev-&gt;rx_dle_q.write-&gt;sys_pkt_addr
comma
id|len
comma
id|PCI_DMA_FROMDEVICE
...
multiline_comment|/* Allocate 4k bytes - more aligned than needed (4k boundary) */
id|dle_addr
op_assign
...
r_break
suffix:semicolon
multiline_comment|/* Revenge of the 2 dle (skb + trailer) used in ia_pkt_tx() */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Allocate 4k (boundary aligned) bytes */
id|dle_addr
op_assign
id|pci_alloc_consistent
c_func
...
id|err_free_rx
suffix:semicolon
multiline_comment|/* &n;&t;&t; * Enable interrupt on loss of signal&n;&t;&t; * SUNI_RSOP_CIE - 0x10&n;&t;&t; * SUNI_RSOP_CIE_LOSE - 0x04&n;&t;&t; */
id|ia_phy_put
c_func
(paren
id|dev
...
id|CMPL_INT
suffix:semicolon
multiline_comment|/* Huh ? p.115 of users guide describes this as a read-only register */
id|writew
c_func
(paren
id|TRANSMIT_DONE
...
suffix:semicolon
multiline_comment|/* First fixes first. I don&squot;t want to think about this now. */
id|spin_lock_irqsave
c_func
(paren
op_amp

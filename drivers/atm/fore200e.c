...
mdefine_line|#define FORE200E_BSQ_DEBUG
macro_line|#endif
macro_line|#if 1 /* ensure correct handling of 52-byte AAL0 SDUs expected by atmdump-like apps */
...
mdefine_line|#define FORE200E_VERSION &quot;0.3e&quot;
DECL|macro|FORE200E
mdefine_line|#define FORE200E         &quot;fore200e: &quot;
macro_line|#if 0 /* override .config */
mdefine_line|#define CONFIG_ATM_FORE200E_DEBUG 1
macro_line|#endif
...
macro_line|#else
DECL|macro|DPRINTK
mdefine_line|#define DPRINTK(level, format, args...)  do {} while (0)
macro_line|#endif
...
r_static
r_void
DECL|function|fore200e_pca_dma_sync_for_cpu
id|fore200e_pca_dma_sync_for_cpu
c_func
(paren
r_struct
id|fore200e
...
r_static
r_void
DECL|function|fore200e_pca_dma_sync_for_device
id|fore200e_pca_dma_sync_for_device
c_func
(paren
r_struct
id|fore200e
...
suffix:semicolon
macro_line|#if defined(CONFIG_ATM_FORE200E_DEBUG) &amp;&amp; (CONFIG_ATM_FORE200E_DEBUG == 2)
r_if
c_cond
(paren
id|irq_posted
...
l_int|2
comma
l_string|&quot;FIFO OUT full, device %d&bslash;n&quot;
comma
...
op_or
id|PCA200E_CTRL_ENA_CONT_REQ_MODE
op_or
id|PCA200E_CTRL_2_CACHE_WRT_INVAL
macro_line|#endif
op_or
...
suffix:semicolon
multiline_comment|/* raise latency from 32 (default) to 192, as this seems to prevent NIC&n;       lockups (under heavy rx loads) due to continuous &squot;FIFO OUT full&squot; condition.&n;       this may impact the performances of other PCI devices on the same bus, though */
id|latency
op_assign
l_int|192
suffix:semicolon
...
r_static
r_void
DECL|function|fore200e_sba_dma_sync_for_cpu
id|fore200e_sba_dma_sync_for_cpu
c_func
(paren
r_struct
id|fore200e
...
r_static
r_void
DECL|function|fore200e_sba_dma_sync_for_device
id|fore200e_sba_dma_sync_for_device
c_func
(paren
r_struct
id|fore200e
...
l_int|3
comma
l_string|&quot;TX COMPLETED: entry = %p [tail = %d], vc_map = %p, skb = %p&bslash;n&quot;
comma
id|entry
comma
id|txq-&gt;tail
...
id|entry-&gt;vc_map
suffix:semicolon
multiline_comment|/* vcc closed since the time the entry was submitted for tx? */
r_if
c_cond
(paren
(paren
...
l_int|1
comma
l_string|&quot;no ready vcc found for PDU sent on device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* vcc closed then immediately re-opened? */
r_if
c_cond
(paren
id|vc_map-&gt;incarn
...
l_int|1
comma
l_string|&quot;vcc closed-then-re-opened; dropping PDU sent on device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
macro_line|#if 1
multiline_comment|/* race fixed by the above incarnation mechanism, but... */
r_if
c_cond
(paren
id|atomic_read
...
(paren
id|FORE200E
l_string|&quot;bsq_audit(%d): queue %d.%d, buffer %ld supplied but in free list!&bslash;n&quot;
comma
id|where
comma
id|scheme
...
(paren
id|FORE200E
l_string|&quot;bsq_audit(%d): queue %d.%d, buffer %ld, unexpected magn = %d&bslash;n&quot;
comma
id|where
comma
id|scheme
...
(paren
id|FORE200E
l_string|&quot;bsq_audit(%d): queue %d.%d, buffer %ld, unexpected scheme = %d&bslash;n&quot;
comma
id|where
comma
id|scheme
...
(paren
id|FORE200E
l_string|&quot;bsq_audit(%d): queue %d.%d, out of range buffer index = %ld !&bslash;n&quot;
comma
id|where
comma
id|scheme
...
(paren
id|FORE200E
l_string|&quot;bsq_audit(%d): queue %d.%d, %d bufs in free list, but freebuf_count = %d&bslash;n&quot;
comma
id|where
comma
id|scheme
...
l_int|2
comma
l_string|&quot;supplying %d rx buffers to queue %d / %d, freebuf_count = %d&bslash;n&quot;
comma
id|RBD_BLK_SIZE
comma
id|scheme
...
(brace
multiline_comment|/* take the first buffer in the free buffer list */
id|buffer
op_assign
id|bsq-&gt;freebuf
suffix:semicolon
...
(paren
id|FORE200E
l_string|&quot;no more free bufs in queue %d.%d, but freebuf_count = %d&bslash;n&quot;
comma
id|scheme
comma
id|magn
...
(paren
id|FORE200E
l_string|&quot;queue %d.%d, buffer %lu already supplied&bslash;n&quot;
comma
id|scheme
comma
id|magn
...
suffix:semicolon
multiline_comment|/* decrease accordingly the number of free rx buffers */
id|bsq-&gt;freebuf_count
op_sub_assign
id|RBD_BLK_SIZE
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Make device DMA transfer visible to CPU.  */
id|fore200e-&gt;bus
op_member_access_from_pointer
id|dma_sync_for_cpu
c_func
...
suffix:semicolon
multiline_comment|/* Now let the device get at it again.  */
id|fore200e-&gt;bus
op_member_access_from_pointer
...
(paren
id|FORE200E
l_string|&quot;queue %d.%d, buffer %ld was not supplied&bslash;n&quot;
comma
id|buffer-&gt;scheme
comma
id|buffer-&gt;magn
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* re-insert the buffer into the free buffer list */
id|buffer-&gt;next
op_assign
id|bsq-&gt;freebuf
suffix:semicolon
...
id|buffer
suffix:semicolon
multiline_comment|/* then increment the number of free rx buffers */
id|bsq-&gt;freebuf_count
op_increment
suffix:semicolon
)brace
...
l_int|1
comma
l_string|&quot;no ready VC found for PDU received on %d.%d.%d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
comma
id|entry-&gt;rpd-&gt;atm_header.vpi
...
l_int|3
comma
l_string|&quot;interrupt NOT triggered by device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;interrupt triggered by device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
r_static
r_void
DECL|function|fore200e_tx_tasklet
id|fore200e_tx_tasklet
c_func
(paren
r_int
r_int
...
l_int|3
comma
l_string|&quot;tx tasklet scheduled for device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
r_static
r_void
DECL|function|fore200e_rx_tasklet
id|fore200e_rx_tasklet
c_func
(paren
r_int
r_int
...
l_int|3
comma
l_string|&quot;rx tasklet scheduled for device %d&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
)paren
suffix:semicolon
...
(brace
multiline_comment|/* fairly balance the VCs over (identical) buffer schemes */
r_int
id|scheme
op_assign
id|vcc-&gt;vci
...
l_int|1
comma
l_string|&quot;VC %d.%d.%d uses buffer scheme %d&bslash;n&quot;
comma
id|vcc-&gt;itf
comma
id|vcc-&gt;vpi
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* the MTU is not used by the cp, except in the case of AAL0 */
id|fore200e-&gt;bus
op_member_access_from_pointer
id|write
c_func
...
(paren
id|FORE200E
l_string|&quot;unable to %s VC %d.%d.%d&bslash;n&quot;
comma
id|activate
ques
c_cond
...
l_int|1
comma
l_string|&quot;VC %d.%d.%d %sed&bslash;n&quot;
comma
id|vcc-&gt;itf
comma
id|vcc-&gt;vpi
...
(brace
multiline_comment|/* compute the data cells to idle cells ratio from the tx PCR */
id|rate-&gt;data_cells
op_assign
id|qos-&gt;txtp.max_pcr
op_star
...
(paren
id|FORE200E
l_string|&quot;VC %d.%d.%d already in use&bslash;n&quot;
comma
id|fore200e-&gt;atm_dev-&gt;number
comma
id|vpi
...
suffix:semicolon
multiline_comment|/* pseudo-CBR bandwidth requested? */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* reserve bandwidth */
id|fore200e-&gt;available_cell_rate
op_sub_assign
id|vcc-&gt;qos.txtp.max_pcr
suffix:semicolon
...
l_int|0
suffix:semicolon
id|fore200e_vcc-&gt;tx_pdu
op_assign
id|fore200e_vcc-&gt;rx_pdu
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* new incarnation of the vcc */
id|vc_map-&gt;incarn
op_assign
op_increment
id|fore200e-&gt;incarn_count
suffix:semicolon
multiline_comment|/* VC unusable before this flag is set */
id|set_bit
c_func
(paren
id|ATM_VF_READY
...
suffix:semicolon
multiline_comment|/* the vc is no longer considered as &quot;in use&quot; by fore200e_open() */
id|vc_map-&gt;vcc
op_assign
l_int|NULL
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* release reserved bandwidth, if any */
r_if
c_cond
(paren
(paren
...
l_int|1
comma
l_string|&quot;VC %d.%d.%d not ready for tx&bslash;n&quot;
comma
id|vcc-&gt;itf
comma
id|vcc-&gt;vpi
...
l_int|3
comma
l_string|&quot;user-supplied cell header = 0x%08x&bslash;n&quot;
comma
op_star
id|cell_header
)paren
...
(brace
multiline_comment|/* this simply NUKES the PCA board */
id|DPRINTK
c_func
(paren
l_int|2
...
op_increment
suffix:semicolon
multiline_comment|/* The dma_map call above implies a dma_sync so the device can use it,&n;     * thus no explicit dma_sync call is necessary here.&n;     */
id|DPRINTK
c_func
(paren
l_int|3
...
(brace
multiline_comment|/* struct fore200e* fore200e = FORE200E_DEV(vcc-&gt;dev); */
id|DPRINTK
c_func
(paren
l_int|2
...
l_int|2
comma
l_string|&quot;set OC-3 reg = 0x%02x, value = 0x%02x, mask = 0x%02x&bslash;n&quot;
comma
id|reg
comma
id|value
...
l_int|1
comma
l_string|&quot;VC %d.%d.%d not ready for QoS change&bslash;n&quot;
comma
id|vcc-&gt;itf
comma
id|vcc-&gt;vpi
...
multiline_comment|/* insert the buffer into the free buffer list */
id|buffer
(braket
id|i
)braket
...
multiline_comment|/* all the buffers are free, initially */
id|bsq-&gt;freebuf_count
op_assign
id|nbr
suffix:semicolon
...
multiline_comment|/* set the head and tail entries of the queue */
id|txq-&gt;head
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
macro_line|#if defined(__sparc_v9__)
multiline_comment|/* reported to be required by SBA cards on some sparc64 hosts */
id|fore200e_spin
c_func
(paren
l_int|100
...
DECL|function|fore200e_pca_remove_one
r_static
r_void
id|__devexit
id|fore200e_pca_remove_one
c_func
(paren
r_struct
id|pci_dev
...
macro_line|#ifdef CONFIG_ATM_FORE200E_PCA
DECL|variable|fore200e_pca_tbl
r_static
r_struct
id|pci_device_id
id|fore200e_pca_tbl
...
suffix:semicolon
DECL|variable|fore200e_pca_driver
r_static
r_struct
id|pci_driver
id|fore200e_pca_driver
op_assign
(brace
dot
id|name
...
id|page
comma
l_string|&quot;   free small bufs, scheme 1:&bslash;t%d&bslash;n&quot;
l_string|&quot;   free large bufs, scheme 1:&bslash;t%d&bslash;n&quot;
l_string|&quot;   free small bufs, scheme 2:&bslash;t%d&bslash;n&quot;
l_string|&quot;   free large bufs, scheme 2:&bslash;t%d&bslash;n&quot;
comma
id|fore200e-&gt;host_bsq
(braket
id|BUFFER_SCHEME_ONE
...
l_string|&quot;     TX PDUs:&bslash;t&bslash;t&bslash;t%10lu&bslash;n&quot;
comma
id|fore200e_swap
c_func
(paren
...
comma
l_string|&quot;&bslash;n&quot;
l_string|&quot; VCCs:&bslash;n  address   VPI VCI   AAL &quot;
l_string|&quot;TX PDUs   TX min/max size  RX PDUs   RX min/max size&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_for
...
id|page
comma
l_string|&quot;  %08x  %03d %05d %1d   %09lu %05d/%05d      %09lu %05d/%05d&bslash;n&quot;
comma
(paren
id|u32
)paren

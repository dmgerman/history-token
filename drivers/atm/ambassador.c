...
DECL|variable|command_timeouts
r_static
r_int
r_int
id|command_timeouts
...
suffix:semicolon
DECL|function|decode_loader_result
r_static
r_int
...
DECL|function|fixup_plx_window
r_static
r_void
id|fixup_plx_window
(paren
...
id|KERN_INFO
comma
l_string|&quot;Changing PCI latency timer from %hu to %hu&quot;
comma
id|lat
comma
id|pci_lat
...
id|NUM_VCI_BITS
suffix:semicolon
singleline_comment|// update linked list
id|dev-&gt;prev
op_assign
id|amb_devs
suffix:semicolon

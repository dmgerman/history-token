...
DECL|function|nicstar_init_one
r_static
r_int
id|__devinit
id|nicstar_init_one
...
DECL|function|nicstar_remove_one
r_static
r_void
id|__devexit
id|nicstar_remove_one
c_func
(paren
r_struct
id|pci_dev
...
suffix:semicolon
multiline_comment|/* Disable PCI device */
...
c_func
(paren
l_string|&quot;nicstar: nicstar_init() called.&bslash;n&quot;
)paren
suffix:semicolon
id|error
op_assign
...
c_func
(paren
l_string|&quot;nicstar: nicstar_init() returned.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;nicstar: nicstar_cleanup() called.&bslash;n&quot;
)paren
suffix:semicolon
id|del_timer
c_func
...
c_func
(paren
l_string|&quot;nicstar: nicstar_cleanup() returned.&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* remove all references to vcc before deleting it */
r_if
c_cond
(paren
id|vcc-&gt;qos.txtp.traffic_class
...
c_func
(paren
l_string|&quot;nicstar: deleted pending vcc mapping&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace

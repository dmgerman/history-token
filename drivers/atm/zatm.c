...
DECL|macro|ZATM_COPPER
mdefine_line|#define ZATM_COPPER&t;1
macro_line|#if 0
...
suffix:semicolon
DECL|function|zatm_init_module
r_static
r_int
id|__init
id|zatm_init_module
...
DECL|variable|zatm_init_module
id|module_init
c_func
(paren
id|zatm_init_module

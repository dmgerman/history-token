...
id|ch
suffix:semicolon
multiline_comment|/*&n;&t; * Look for a channel with matching io_base default value.  If chipset is&n;&t; * &quot;ide_unknown&quot;, then claim that channel slot.  Otherwise, some other&n;&t; * chipset has already claimed it..  :(&n;&t; */
r_for
c_loop
(paren
id|h
...
(paren
id|KERN_INFO
l_string|&quot;%s: too many ATA interfaces.&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t; * Setup DMA transfers on the channel.&n;&t; */
r_if
c_cond
(paren
id|d-&gt;flags
...
id|no_dma
suffix:semicolon
multiline_comment|/*&n;&t; * Fetch the DMA Bus-Master-I/O-Base-Address (BMIBA) from PCI space:&n;&t; */
id|dma_base
op_assign
...
multiline_comment|/* If we are on the second channel, the dma base address will&n;&t;&t; * be one entry away from the primary interface.&n;&t;&t; */
r_if
c_cond
(paren
id|ch-&gt;unit
...
r_else
(brace
multiline_comment|/* If the device claims &quot;simplex&quot; DMA, this means only&n;&t;&t;&t; * one of the two interfaces can be trusted with DMA at&n;&t;&t;&t; * any point in time.  So we should enable DMA only on&n;&t;&t;&t; * one of the two interfaces.&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/*&n;&t;&t; * Set up BM-DMA capability (PnP BIOS should have done this&n;&t;&t; * already).  Default to DMA off on the drive, if we had to&n;&t;&t; * configure it here.  This should most propably be enabled no&n;&t;&t; * all chipsets which can be expected to be used on systems&n;&t;&t; * without a BIOS equivalent.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * Fix crossover IRQ line setups between primary and secondary channel.  Quite&n; * a common bug apparently.&n; */

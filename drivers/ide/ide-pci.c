...
multiline_comment|/*&n; * Setup DMA transfers on the channel.&n; */
...
multiline_comment|/* The function below will check itself whatever there is something to&n;&t; * be done or not. We don&squot;t have therefore to care whatever it was&n;&t; * already enabled by the primary channel run.&n;&t; */
id|pci_set_master
c_func
(paren
id|dev

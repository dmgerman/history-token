...
id|hwif-&gt;pci_dev
suffix:semicolon
multiline_comment|/*&n;&t; * If we are on the second channel, the dma base address will be one&n;&t; * entry away from the primary interface.&n;&t; */
r_if
c_cond
(paren
id|hwif-&gt;mate
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * If the device claims &quot;simplex&quot; DMA, this means only one of&n;&t;&t; * the two interfaces can be trusted with DMA at any point in&n;&t;&t; * time.  So we should enable DMA only on one of the two&n;&t;&t; * interfaces.&n;&t;&t; */
r_if
c_cond
(paren
(paren

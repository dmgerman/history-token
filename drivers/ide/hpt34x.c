...
mdefine_line|#define HPT34X_MAX_DEVS&t;&t;&t;8
...
DECL|function|hpt34x_ratefilter
r_static
id|byte
id|hpt34x_ratefilter
(paren
id|ide_drive_t
op_star
id|drive
...
l_int|0x02
suffix:colon
singleline_comment|// while (speed &gt; XFER_UDMA_4) speed--; break;
r_case
l_int|0x01
suffix:colon
r_while
...
macro_line|# else /* !CONFIG_HPT34X_AUTODMA */
r_while
c_loop
(paren
id|speed
...
suffix:semicolon
singleline_comment|//&t;ide_task_t *args = HWGROUP(drive)-&gt;rq-&gt;special;
r_int
r_int
id|dma_base
op_assign
...
multiline_comment|/*&n;&t;&t;&t; * FIX ME to use only ACB ide_task_t args Struct&n;&t;&t;&t; */
macro_line|#if 0
(brace
id|ide_task_t
op_star
...
suffix:semicolon
DECL|function|fixup_device_hpt343
r_void
id|__init

...
DECL|function|ali15x3_ratefilter
r_static
id|byte
id|ali15x3_ratefilter
(paren
id|ide_drive_t
op_star
id|drive
...
macro_line|#endif /* CONFIG_BLK_DEV_IDEDMA */
DECL|macro|ALI_INIT_CODE_TEST
mdefine_line|#define ALI_INIT_CODE_TEST
...
suffix:semicolon
macro_line|#ifdef ALI_INIT_CODE_TEST
r_int
r_int
id|flags
suffix:semicolon
...
id|tmpbyte
suffix:semicolon
macro_line|#endif /* ALI_INIT_CODE_TEST */
id|pci_read_config_byte
c_func
(paren
id|dev
...
(brace
macro_line|#ifndef ALI_INIT_CODE_TEST
multiline_comment|/*&n;&t;&t; * 1543C-B?, 1535, 1535D, 1553&n;&t;&t; * Note 1: not all &quot;motherboard&quot; support this detection&n;&t;&t; * Note 2: if no udma 66 device, the detection may &quot;error&quot;.&n;&t;&t; *         but in this case, we will not set the device to&n;&t;&t; *         ultra 66, the detection result is not important&n;&t;&t; */
multiline_comment|/*&n;&t;&t; * enable &quot;Cable Detection&quot;, m5229, 0x4b, bit3&n;&t;&t; */
id|pci_read_config_byte
c_func
...
suffix:semicolon
DECL|function|fixup_device_ali15x3
r_void
id|__init

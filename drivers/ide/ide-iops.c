...
suffix:semicolon
singleline_comment|//&t;while (count--) { *(u32 *)addr = IN_LONG(port); addr += 4; }
)brace
DECL|function|ide_insl_p
r_static
r_inline
r_void
id|ide_insl_p
...
suffix:semicolon
singleline_comment|//&t;while (count--) { OUT_LONG(*(u32 *)addr, port); addr += 4; }
)brace
DECL|function|ide_outsl_p
r_static
r_inline
r_void
id|ide_outsl_p
...
suffix:semicolon
singleline_comment|//&t;while (count--) { OUT_LONG_P(*(u32 *)addr, port); addr += 4; }
)brace

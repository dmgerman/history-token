...
DECL|variable|ide_pci_host_proc_list
r_static
id|ide_pci_host_proc_t
op_star
id|ide_pci_host_proc_list
suffix:semicolon
...
DECL|variable|proc_ide_read_config
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_config
...
DECL|variable|proc_ide_read_imodel
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_imodel
...
DECL|variable|proc_ide_read_mate
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_mate
...
DECL|variable|proc_ide_read_channel
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_channel
...
DECL|variable|proc_ide_read_identify
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_identify
...
DECL|variable|proc_ide_read_settings
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_settings
...
DECL|variable|proc_ide_write_settings
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_write_settings
...
DECL|variable|proc_ide_read_dmodel
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_dmodel
...
DECL|variable|proc_ide_read_driver
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_driver
...
DECL|variable|proc_ide_write_driver
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_write_driver
...
DECL|variable|proc_ide_read_media
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_read_media
...
DECL|variable|create_proc_ide_drives
id|EXPORT_SYMBOL
c_func
(paren
id|create_proc_ide_drives
...
suffix:semicolon
DECL|function|recreate_proc_ide_device
r_void
...
suffix:semicolon
multiline_comment|/*&n; * assume that we have these already, however, should test FIXME!&n; * if (driver) {&n; *      ide_add_proc_entries(drive-&gt;proc, generic_subdriver_entries, drive);&n; *      ide_add_proc_entries(drive-&gt;proc, driver-&gt;proc, drive);&n; * }&n; *&n; */
id|sprintf
c_func
(paren
id|name
...
DECL|variable|destroy_proc_ide_drives
id|EXPORT_SYMBOL
c_func
(paren
id|destroy_proc_ide_drives
...
macro_line|#ifdef CONFIG_BLK_DEV_IDEPCI
DECL|function|ide_pci_register_host_proc
r_void
...
DECL|variable|ide_pci_register_host_proc
id|EXPORT_SYMBOL
c_func
(paren
id|ide_pci_register_host_proc
...
DECL|variable|proc_ide_destroy
id|EXPORT_SYMBOL
c_func
(paren
id|proc_ide_destroy

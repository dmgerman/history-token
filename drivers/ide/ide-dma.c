...
DECL|function|ide_dma_timeout_recovery
r_static
r_int
id|ide_dma_timeout_recovery
(paren
id|ide_drive_t
op_star
id|drive
...
(brace
multiline_comment|/* FIXME: Replace hard-coded 100, error handling? */
r_int
id|i
suffix:semicolon
r_for
...
suffix:semicolon
singleline_comment|//&t;ide_task_t *args&t;&t;= HWGROUP(drive)-&gt;rq-&gt;special;
r_int
r_int
id|dma_base
op_assign
...
macro_line|#ifdef __IDEDMA_TIMEOUT
...
suffix:semicolon
singleline_comment|//&t;&t;&t;OUT_BYTE(0x00, dma_base);
multiline_comment|/* get DMA status */
id|dma_stat
op_assign
id|IN_BYTE
...
c_func
(paren
l_string|&quot;ide_dmaproc: chipset supported %s &quot;
l_string|&quot;func only: %d&bslash;n&quot;
comma
id|ide_dmafunc_verbose
c_func
(paren

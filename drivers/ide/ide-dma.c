...
DECL|variable|__ide_dma_verbose
id|EXPORT_SYMBOL
c_func
(paren
id|__ide_dma_verbose
...
DECL|variable|__ide_dma_retune
id|EXPORT_SYMBOL
c_func
(paren
id|__ide_dma_retune
...
DECL|function|ide_release_mmio_dma
r_int
id|ide_release_mmio_dma
(paren
id|ide_hwif_t
op_star
id|hwif
...
c_func
(paren
l_string|&quot; -- Error, MMIO ports already in use.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
id|__ide_dma_lostirq
suffix:semicolon
multiline_comment|/*&n;&t; * dma queued ops. if tcq isn&squot;t set, queued on and off are just&n;&t; * dummy functions. cuts down on ifdef hell&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;, BIOS settings: %s:%s%s, %s:%s%s&quot;
comma
id|hwif-&gt;drives
(braket
l_int|0

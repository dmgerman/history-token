...
multiline_comment|/****************************************************************************&n; * UDMA function which should have architecture specific counterparts where&n; * neccessary.&n; *&n; * The intention is that at some point in time we will move this whole to&n; * architecture specific kernel sections. For now I would love the architecture&n; * maintainers to just #ifdef #endif this stuff directly here. I have for now&n; * tryed to update as much as I could in the architecture specific code.  But&n; * of course I may have done mistakes, so please bear with me and update it&n; * here the proper way.&n; *&n; * Thank you a lot in advance!&n; *&n; * Sat May  4 20:29:46 CEST 2002 Marcin Dalecki.&n; */
...
multiline_comment|/*&n; * Generic entry points for functions provided possibly by the host chip set&n; * drivers.&n; */
...
suffix:semicolon
multiline_comment|/* Invoke the chipset specific handler now. */
r_if
c_cond
(paren
id|drive-&gt;channel-&gt;udma_timeout
)paren
id|drive-&gt;channel
op_member_access_from_pointer
id|udma_timeout
...
c_cond
(paren
id|drive-&gt;channel-&gt;udma_irq_lost
)paren
id|drive-&gt;channel
op_member_access_from_pointer
id|udma_irq_lost

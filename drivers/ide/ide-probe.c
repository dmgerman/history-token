...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Some neccessary register area was already used. Skip this&n;&t;&t; * device.&n;&t;&t; */
r_if
c_cond
(paren
macro_line|#if CONFIG_BLK_DEV_PDC4030
...
(brace
multiline_comment|/* FIXME: We should be dealing properly with partial IO&n;&t;&t;&t; * region allocations here.&n;&t;&t;&t; */
id|ch-&gt;present
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/* Register this hardware interface within the global device tree.&n;&t;&t; */
id|sprintf
c_func
(paren
id|ch-&gt;dev.bus_id
...
DECL|function|init_device_queue
r_static
r_void
id|init_device_queue
c_func
(paren
r_struct
id|ata_device
...
c_func
(paren
l_string|&quot;%s : Adding missed channel to hwgroup!!&bslash;n&quot;
comma
id|ch-&gt;name
)paren
suffix:semicolon

...
suffix:semicolon
multiline_comment|/*&n;&t; * We should only tune the 1533 enable if we are using an ALi&n;&t; * North bridge&n;&t; */
r_if
c_cond
(paren
id|north-&gt;vendor
...
suffix:semicolon
multiline_comment|/**&n; *&t;init_setup_ali15x3&t;-&t;set up an ALi15x3 IDE controller&n; *&t;@dev: PCI device to set up&n; *&t;@d: IDE PCI structures&n; *&n; *&t;Perform the actual set up for the ALi15x3.&n; */
DECL|function|init_setup_ali15x3
r_static
r_void
id|__init
...
multiline_comment|/**&n; *&t;ali15x3_scan_pcidev&t;-&t;check for ali pci ide&n; *&t;@dev: device found by IDE ordered scan&n; *&n; *&t;If the device is a known ALi IDE controller we set it up and&n; *&t;then return 1. If we do not know it, or set up fails we return 0&n; *&t;and it will be offered to other drivers or taken generic&n; */
DECL|function|ali15x3_scan_pcidev
r_int
id|__init

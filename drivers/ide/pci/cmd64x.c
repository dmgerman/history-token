...
multiline_comment|/**&n; *&t;FIXME: not required ?&n; */
...
suffix:semicolon
multiline_comment|/**&n; *&t;FIXME: not required either ?&n; */
DECL|function|init_setup_cmd64x
r_static
r_void
id|__init
...
DECL|function|cmd64x_scan_pcidev
r_int
id|__init

...
multiline_comment|/**&n; *&t;it8172_remove_one&t;-&t;called with an IT8172 is unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an IT8172 device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|it8172_remove_one
r_static
r_void
id|it8172_remove_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;IT8172 removal not yet supported&quot;
)paren
suffix:semicolon
)brace

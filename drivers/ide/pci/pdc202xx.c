...
macro_line|#else
DECL|function|pdc202xx_ratefilter
r_static
id|byte
id|pdc202xx_ratefilter
(paren
...
id|drive-&gt;id
suffix:semicolon
singleline_comment|//&t;byte mode               = pdc202xx_ratemask(drive);
id|ide_hwif_t
op_star
id|hwif
op_assign
...
DECL|function|pdc202xx_reset_pci
r_void
id|pdc202xx_reset_pci
(paren
r_struct
id|pci_dev
op_star
...
suffix:semicolon
DECL|function|fixup_device_pdc20265
r_void
id|__init
...
DECL|function|fixup_device_pdc20270
r_void
id|__init

...
multiline_comment|/**&n; *&t;pdc202xx_remove_one&t;-&t;called with the IDE to be unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an IDE device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|pdc202xx_remove_one
r_static
r_void
id|pdc202xx_remove_one
c_func
(paren
r_struct
id|pci_dev
...
DECL|function|pdc202xx_ide_exit
r_static
r_void
id|pdc202xx_ide_exit
c_func
(paren
r_void
)paren
...
suffix:semicolon
DECL|variable|pdc202xx_ide_exit
id|module_exit
c_func
(paren
id|pdc202xx_ide_exit

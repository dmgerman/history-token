multiline_comment|/*&n; *  linux/drivers/ide/opti621.c&t;&t;Version 0.7&t;Sept 10, 2002&n; *&n; *  Copyright (C) 1996-1998  Linus Torvalds &amp; authors (see below)&n; */
...
DECL|function|opti621_init_one
r_static
r_int
id|__devinit
id|opti621_init_one
...
multiline_comment|/**&n; *&t;opti621_remove_one&t;-&t;called with an Opti621 is unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an Opti621 device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|opti621_remove_one
r_static
r_void
id|opti621_remove_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;Opti621 removal not yet supported&quot;
)paren
suffix:semicolon
)brace
...
suffix:semicolon
DECL|function|opti621_ide_init
r_static
r_int
id|opti621_ide_init
c_func
...
DECL|function|opti621_ide_exit
r_static
r_void
id|opti621_ide_exit
c_func
...
DECL|variable|opti621_ide_init
id|module_init
c_func
(paren
id|opti621_ide_init
...
suffix:semicolon
DECL|variable|opti621_ide_exit
id|module_exit
c_func
(paren
id|opti621_ide_exit
...
c_func
(paren
l_string|&quot;Jaromir Koutek, Jan Harkes, Mark Lord&quot;
)paren
suffix:semicolon
id|MODULE_DESCRIPTION
c_func
(paren
l_string|&quot;PCI driver module for Opti621 IDE&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func

multiline_comment|/*&n; *  linux/drivers/ide/pci/opti621.c&t;&t;Version 0.7&t;Sept 10, 2002&n; *&n; *  Copyright (C) 1996-1998  Linus Torvalds &amp; authors (see below)&n; */
...
multiline_comment|/* Uncomment for disable read prefetch.&n; * There is some readprefetch capatibility in hdparm,&n; * but when I type hdparm -P 1 /dev/hda, I got errors&n; * and till reset drive is inaccessible.&n; * This (hw) read prefetch is safe on my drive.&n; */

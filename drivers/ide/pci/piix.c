...
multiline_comment|/**&n; *&t;piix_scan_pcidev&t;-&t;Check for and initialize PIIX IDE&n; *&t;@dev: PCI device to check&n; *&n; *&t;Checks if the passed device is an Intel PIIX device. If so the&n; *&t;hardware is initialized and we return 1 to claim the device. If not&n; *&t;we return 0.&n; */
DECL|function|piix_scan_pcidev
r_int
id|__init
id|piix_scan_pcidev
(paren

...
multiline_comment|/**&n; *&t;siimage_remove_one&t;-&t;called when an SI IDE is unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an IDE device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|siimage_remove_one
r_static
r_void
id|siimage_remove_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;SiImage IDE removal not yet supported&quot;
)paren
suffix:semicolon
)brace

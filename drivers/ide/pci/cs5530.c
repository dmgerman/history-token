...
comma
l_string|&quot;&bslash;n                                &quot;
l_string|&quot;Cyrix 5530 Chipset.&bslash;n&quot;
)paren
suffix:semicolon
id|p
op_add_assign
...
multiline_comment|/**&n; *&t;cs5530_remove_one&t;-&t;called when a CS5530 is unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an Cyrix device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|cs5530_remove_one
r_static
r_void
id|cs5530_remove_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;Cyrix removal not yet supported&quot;
)paren
suffix:semicolon
)brace

...
DECL|function|init_dma_cy82c693
r_void
id|__init
...
multiline_comment|/**&n; *&t;cy82c693_remove_one&t;-&t;called with an Cypress is unplugged&n; *&t;@dev: the device that was removed&n; *&n; *&t;Disconnect an Cypress device that has been unplugged either by hotplug&n; *&t;or by a more civilized notification scheme. Not yet supported.&n; */
DECL|function|cy82c693_remove_one
r_static
r_void
id|cy82c693_remove_one
c_func
(paren
r_struct
id|pci_dev
...
c_func
(paren
l_string|&quot;Cypress removal not yet supported&quot;
)paren
suffix:semicolon
)brace
...
DECL|function|cy82c693_ide_exit
r_static
r_void
id|cy82c693_ide_exit
c_func
(paren
r_void
)paren
...
suffix:semicolon
DECL|variable|cy82c693_ide_exit
id|module_exit
c_func
(paren
id|cy82c693_ide_exit

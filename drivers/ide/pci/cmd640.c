multiline_comment|/*&n; *  linux/drivers/ide/pci/cmd640.c&t;&t;Version 1.02  Sep 01, 1996&n; *&n; *  Copyright (C) 1995-1996  Linus Torvalds &amp; authors (see below)&n; */
...
id|cmd640_key
suffix:semicolon
DECL|variable|__put_cmd640_reg
r_static
r_void
(paren
op_star
...
suffix:semicolon
DECL|variable|__get_cmd640_reg
r_static
id|u8
(paren
op_star

...
r_static
r_int
DECL|function|sgiioc4_ide_dma_off
id|sgiioc4_ide_dma_off
c_func
(paren
id|ide_drive_t
op_star
...
(paren
id|KERN_ERR
l_string|&quot;Error in %s(dev 0x%p | id 0x%p )&bslash;n&quot;
comma
id|__FUNCTION__
comma
(paren
...
r_static
r_void
DECL|function|sgiioc4_ide_exit
id|sgiioc4_ide_exit
c_func
(paren
r_void
...
suffix:semicolon
DECL|variable|sgiioc4_ide_exit
id|module_exit
c_func
(paren
id|sgiioc4_ide_exit

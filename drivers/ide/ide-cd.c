...
DECL|function|cdrom_merge_requests
r_static
r_inline
r_int
id|cdrom_merge_requests
c_func
(paren
r_struct
id|request
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * partitions not really working, but better check anyway...&n;&t; */
r_if
c_cond
(paren
id|rq-&gt;cmd
...
multiline_comment|/*&n; * the current request will always be the first one on the list&n; */
DECL|function|cdrom_attempt_remerge
r_static
r_void
id|cdrom_attempt_remerge
c_func
(paren
id|ide_drive_t
op_star

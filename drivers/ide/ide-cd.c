...
mdefine_line|#define IDECD_VERSION &quot;4.59-ac1&quot;
...
c_func
(paren
l_string|&quot;%s: %u residual after xfer&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|rq-&gt;data_len
...
id|CDS_DISC_OK
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If not using Mt Fuji extended media tray reports,&n;&t;&t; * just return TRAY_OPEN since ATAPI doesn&squot;t provide&n;&t;&t; * any other way to detect this...&n;&t;&t; */
r_if
c_cond
(paren
id|sense.sense_key

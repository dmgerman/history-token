...
(brace
multiline_comment|/* For REQ_SENSE, &quot;rq-&gt;buffer&quot; points to the original failed request */
r_struct
id|request
op_star
id|failed
...
multiline_comment|/* Handle differences between SCSI and ATAPI packet commands */
r_static
r_int
id|pre_transform_command
c_func
(paren
r_struct
id|request
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Fix up any SCSI command differences.. */
r_if
c_cond
(paren
id|rq-&gt;flags
...
DECL|function|pre_transform_command
r_static
r_int
id|pre_transform_command
c_func
...
id|req-&gt;cmd
suffix:semicolon
multiline_comment|/* Transform 6-byte read/write commands to the 10-byte version. */
r_if
c_cond
(paren
id|c
...
multiline_comment|/* These also need fixup, not done yet */
r_if
c_cond
(paren
id|c

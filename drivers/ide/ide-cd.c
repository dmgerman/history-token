...
suffix:semicolon
multiline_comment|/*&n; * Power Management state machine.&n; *&n; * We don&squot;t do much for CDs right now.&n; */
DECL|function|ide_cdrom_complete_power_step
r_static
r_void
id|ide_cdrom_complete_power_step
(paren
id|ide_drive_t
op_star
id|drive
...
DECL|function|ide_cdrom_start_power_step
r_static
id|ide_startstop_t
id|ide_cdrom_start_power_step
(paren
id|ide_drive_t
op_star
id|drive

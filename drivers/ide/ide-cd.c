...
c_func
(paren
l_string|&quot;%s: missing rq in %s&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|__FUNCTION__
...
id|printk
(paren
l_string|&quot;%s: %s: buffer botch (%ld)&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|__FUNCTION__
...
id|printk
(paren
l_string|&quot;%s: %s: buffer botch (%u)&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|__FUNCTION__
...
suffix:semicolon
multiline_comment|/* FIXME: This is making worng assumptions about register layout. */
id|stat
op_assign

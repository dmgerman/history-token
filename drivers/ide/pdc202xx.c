...
DECL|function|pdc202xx_info_new
r_static
r_char
op_star
id|pdc202xx_info_new
(paren
r_char
op_star
id|buf
...
id|buf
suffix:semicolon
singleline_comment|//&t;u32 bibma = pci_resource_start(dev, 4);
singleline_comment|//&t;u32 reg60h = 0, reg64h = 0, reg68h = 0, reg6ch = 0;
singleline_comment|//&t;u16 reg50h = 0, word88 = 0;
singleline_comment|//&t;int udmasel[4]={0,0,0,0}, piosel[4]={0,0,0,0}, i=0, hd=0;
r_switch
c_cond
(paren
id|dev-&gt;device
...
id|p
comma
l_string|&quot;&bslash;n                                PDC20275 Chipset.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
id|p
comma
l_string|&quot;&bslash;n                                PDC20269 TX2 Chipset.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
id|ultra
suffix:semicolon
singleline_comment|//&t;byte udma_33&t;&t;= ultra ? (IN_BYTE(high_16 + 0x001f) &amp; 1) : 0;
id|byte
id|udma_66
op_assign
(paren
...
DECL|function|pdc202xx_udma_timeout
r_static
r_void
id|pdc202xx_udma_timeout
c_func
(paren
r_struct
id|ata_device
...
DECL|function|pdc202xx_udma_irq_lost
r_static
r_void
id|pdc202xx_udma_irq_lost
c_func
(paren
r_struct
id|ata_device

...
multiline_comment|/* FIXME: Temporary - until we put in the hotplug interface logic&n;&t;   Check that the bits we want are not in use by someone else.&n;&t;   As someone else uses it, we do not (yuck) disable the device */
id|ret
op_assign

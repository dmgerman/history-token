multiline_comment|/**** vi:set ts=8 sts=8 sw=8:************************************************&n; *&n; * Version 0.11&t;March 27, 2002&n; *&n; * Copyright (C) 1999-2000&t;Andre Hedrick (andre@linux-ide.org)&n; *&n; */
...
id|bmide_dev
suffix:semicolon
DECL|function|aec6280_get_speed
r_static
r_const
r_char
op_star
id|aec6280_get_speed
c_func
(paren
id|u8
id|speed
...
id|p
comma
l_string|&quot;&bslash;n                                AEC6280 Chipset without ROM.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
id|p
comma
l_string|&quot;&bslash;n                                AEC6280 Chipset with ROM.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* FIXME: we need some locking here */
id|pci_read_config_byte
c_func
(paren
id|hwif-&gt;pci_dev

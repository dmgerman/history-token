...
id|REQ_DRIVE_CMD
suffix:semicolon
multiline_comment|/* If empty parameter file - wait for drive ready.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t; * Always make sure the transfer reate has been setup.&n;&t; *&n;&t; * FIXME: what about setting up the drive with -&gt;tuneproc?&n;&t; *&n;&t; * Backside of HDIO_DRIVE_CMD call of SETFEATURES_XFER.&n;&t; * 1 : Safe to update drive-&gt;id DMA registers.&n;&t; * 0 : OOPs not allowed.&n;&t; */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Verify that we are doing an approved SETFEATURES_XFER with&n;&t;&t; * respect to the hardware being able to support request.&n;&t;&t; * Since some hardware can improperly report capabilties, we&n;&t;&t; * check to see if the host adapter in combination with the&n;&t;&t; * device (usually a disk) properly detect and acknowledge each&n;&t;&t; * end of the ribbon.&n;&t;&t; */
r_if
c_cond
(paren
id|args.taskfile.sector_number
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Speed warnings UDMA &gt; 2 is not functional.&bslash;n&quot;
comma
...
id|drive
suffix:semicolon
singleline_comment|//&t;struct request rq;
id|kdev_t
id|dev
suffix:semicolon
id|dev

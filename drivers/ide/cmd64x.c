...
DECL|function|print_sii_get_info
r_static
r_char
op_star
id|print_sii_get_info
...
DECL|function|cmd64x_ratefilter
r_static
id|byte
id|cmd64x_ratefilter
(paren
id|ide_drive_t
op_star
id|drive
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* if 133 clock fails, switch to 2xbus clock */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;CMD64X: drive-&gt;media != ide_disk at double check,&quot;
l_string|&quot; inital check failed!!&bslash;n&quot;
)paren
suffix:semicolon
r_return
(paren
...
macro_line|#if defined(CONFIG_BLK_DEV_IDEDMA) &amp;&amp; defined(CONFIG_IDEDMA_AUTO)
r_if
c_cond
(paren
id|hwif-&gt;dma_base
...
l_int|1
suffix:semicolon
macro_line|#endif /* CONFIG_BLK_DEV_IDEDMA &amp;&amp; CONFIG_IDEDMA_AUTO*/
)brace
eof

...
multiline_comment|/*&n; * Attempts to set the interface PIO mode. Special cases are&n; * 8: prefetch off, 9: prefetch on, 255: auto-select best mode.&n; * Called with 255 at boot time.&n; */
...
(brace
multiline_comment|/* FIXME: b0rken  --bkz */
r_case
l_int|8
suffix:colon
...
multiline_comment|/* FIXME: verify it  --bkz */
id|T
op_assign
l_int|1000000000
op_div
...
suffix:semicolon
multiline_comment|/* FIXME: maybe switch to ata_timing_compute()  --bkz */
id|recover
op_assign
id|t-&gt;cycle
op_minus
...
suffix:semicolon
multiline_comment|/* unit 1 - 01000000b&t;unit 0 - 00100000b */
id|regD
op_and_assign
op_complement
(paren
...
suffix:semicolon
multiline_comment|/* unit 1 - 11001010b&t;unit 0 - 00110101b */
id|regU
op_and_assign
op_complement
(paren
...
(brace
multiline_comment|/* FIXME: use tables  --bkz */
r_case
id|XFER_UDMA_5
suffix:colon
id|U
...
suffix:semicolon
multiline_comment|/* FIXME: error checking  --bkz */
r_return
l_int|0
suffix:semicolon
r_default
...
DECL|function|cmd6xx_udma_setup
r_static
r_int
id|cmd6xx_udma_setup
c_func
(paren
r_struct
id|ata_device

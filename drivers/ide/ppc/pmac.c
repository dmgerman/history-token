...
DECL|enumerator|controller_sh_ata6
id|controller_sh_ata6
comma
multiline_comment|/* Shasta ATA-6 */
)brace
suffix:semicolon
...
l_string|&quot;Shasta ATA-6&quot;
comma
multiline_comment|/* Shasta ATA-6 (UDMA/133) */
)brace
suffix:semicolon
...
multiline_comment|/* 133Mhz cell, found in shasta.&n; * See comments about 100 Mhz Uninorth 2...&n; * Note that PIO_MASK and MDMA_MASK seem to overlap&n; */
DECL|macro|TR_133_PIOREG_PIO_MASK
mdefine_line|#define TR_133_PIOREG_PIO_MASK&t;&t;0xff000fff
DECL|macro|TR_133_PIOREG_MDMA_MASK
mdefine_line|#define TR_133_PIOREG_MDMA_MASK&t;&t;0x00fff800
DECL|macro|TR_133_UDMAREG_UDMA_MASK
mdefine_line|#define TR_133_UDMAREG_UDMA_MASK&t;0x0003ffff
DECL|macro|TR_133_UDMAREG_UDMA_EN
mdefine_line|#define TR_133_UDMAREG_UDMA_EN&t;&t;0x00000001
...
multiline_comment|/*&n; * FCR Register on Kauai. Not sure what bit 0x4 is  ...&n; */
DECL|macro|KAUAI_FCR_UATA_MAGIC
mdefine_line|#define KAUAI_FCR_UATA_MAGIC&t;&t;0x00000004
DECL|macro|KAUAI_FCR_UATA_RESET_N
mdefine_line|#define KAUAI_FCR_UATA_RESET_N&t;&t;0x00000002
DECL|macro|KAUAI_FCR_UATA_ENABLE
mdefine_line|#define KAUAI_FCR_UATA_ENABLE&t;&t;0x00000001
macro_line|#ifdef CONFIG_BLK_DEV_IDEDMA_PMAC
...
multiline_comment|/*&n; * Calculate Shasta ATA/133 UDMA timings&n; */
r_static
r_int
id|__pmac
DECL|function|set_timings_udma_shasta
id|set_timings_udma_shasta
c_func
(paren
id|u32
op_star
...
op_complement
(paren
id|KAUAI_FCR_UATA_RESET_N
op_or
id|KAUAI_FCR_UATA_ENABLE
)paren
suffix:semicolon
id|writel
c_func
...
multiline_comment|/* G5&squot;s seem to have incorrect cable type in device-tree. Let&squot;s assume&n;&t; * they have a 80 conductor cable, this seem to be always the case unless&n;&t; * the user mucked around&n;&t; */
r_if
c_cond
(paren
id|device_is_compatible
...
l_int|1
suffix:semicolon
multiline_comment|/* On Kauai-type controllers, we make sure the FCR is correct */
r_if
c_cond
(paren
id|pmif-&gt;kauai_fcr

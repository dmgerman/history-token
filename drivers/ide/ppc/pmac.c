...
(paren
id|KERN_ERR
l_string|&quot;pmac_ide_do_setfeature disk not ready &quot;
...
id|rq
suffix:semicolon
singleline_comment|//&t;ide_task_t *args = rq-&gt;special;
id|u8
id|unit
op_assign
(paren
...
r_static
r_int
DECL|function|pmac_ide_dma_count
id|pmac_ide_dma_count
(paren
id|ide_drive_t
op_star
id|drive
...
singleline_comment|//if (DRIVER(drive))
singleline_comment|//&t;check_disk_change(MKDEV(drive-&gt;disk-&gt;major, drive-&gt;disk-&gt;first_minor));
macro_line|#ifdef CONFIG_BLK_DEV_IDEDMA_PMAC

...
macro_line|#include &quot;ide-noise.h&quot;
multiline_comment|/*&n; * FIXME: We want to drop the the MACRO CRAP!&n; *&n; * ec-&gt;iops-&gt;in{b/w/l}&n; * ec-&gt;iops-&gt;in{b/w/l}_p&n; * ec-&gt;iops-&gt;out{b/w/l}&n; * ec-&gt;iops-&gt;out{b/w/l}_p&n; *&n; * the new core supports clean MMIO calls and other goodies&n; */
...
DECL|function|check_drive_good_lists
r_int
id|check_drive_good_lists
(paren
id|ide_drive_t
op_star
id|drive
...
DECL|function|check_drive_bad_lists
r_int
id|check_drive_bad_lists
(paren
id|ide_drive_t
op_star
id|drive
...
c_func
(paren
l_string|&quot;%s: Disabling DMA for %s&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|id-&gt;model
...
suffix:semicolon
singleline_comment|//&t;ide_task_t *args&t;= HWGROUP(drive)-&gt;rq-&gt;special;
r_int
id|count
op_assign
l_int|0
...
suffix:semicolon
multiline_comment|/* Route the DMA signals to&n;&t; * to the correct interface.&n;&t; */
id|HWIF
c_func
(paren
id|drive
...
suffix:semicolon
multiline_comment|/* Select the correct timing&n;&t; * for this drive&n;&t; */
id|set_dma_speed
c_func
(paren
id|hwif-&gt;hw.dma

...
r_enum
(brace
DECL|enumerator|ide_pm_flush_cache
id|ide_pm_flush_cache
op_assign
...
comma
DECL|enumerator|ide_pm_restore_dma
id|ide_pm_restore_dma
comma
)brace
suffix:semicolon
DECL|function|ide_complete_power_step
r_static
r_void
id|ide_complete_power_step
c_func
(paren
id|ide_drive_t
op_star
...
DECL|function|ide_start_power_step
r_static
id|ide_startstop_t
id|ide_start_power_step
c_func
(paren
id|ide_drive_t
op_star
...
(brace
multiline_comment|/* skip idedisk_pm_idle for ATAPI devices */
r_if
c_cond
(paren
id|rq-&gt;pm-&gt;pm_step
...
multiline_comment|/*&n;&t;&t; * Right now, all we do is call hwif-&gt;ide_dma_check(drive),&n;&t;&t; * we could be smarter and check for current xfer_speed&n;&t;&t; * in struct drive etc...&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
DECL|function|ide_init_specify_cmd
r_static
r_void
id|ide_init_specify_cmd
c_func
(paren
id|ide_drive_t
op_star
...
DECL|function|ide_init_restore_cmd
r_static
r_void
id|ide_init_restore_cmd
c_func
(paren
id|ide_drive_t
op_star
...
DECL|function|ide_init_setmult_cmd
r_static
r_void
id|ide_init_setmult_cmd
c_func
(paren
id|ide_drive_t
op_star
...
DECL|function|ide_disk_special
r_static
id|ide_startstop_t
id|ide_disk_special
c_func

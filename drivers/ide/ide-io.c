...
suffix:semicolon
multiline_comment|/**&n; *&t;restart_request&t;&t;-&t;reissue an IDE request&n; *&t;@drive: drive for request&n; *&t;@rq: request to reissue&n; *&n; *&t;Reissue a request. See start_request for details and for&n; *&t;FIXME&n; */
...
multiline_comment|/*&n;&t; *&t;FIXME: there should be a drive or hwif-&gt;special&n;&t; *&t;handler that points here by default, not hacks&n;&t; *&t;in the ide-io.c code&n;&t; */
r_if
c_cond
(paren
id|HWIF

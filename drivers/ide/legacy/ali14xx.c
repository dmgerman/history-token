multiline_comment|/*&n; *  linux/drivers/ide/legacy/ali14xx.c&t;&t;Version 0.03&t;Feb 09, 1996&n; *&n; *  Copyright (C) 1996  Linus Torvalds &amp; author (see below)&n; */
...
DECL|function|ali14xx_release_hwif
r_static
r_void
id|__exit
id|ali14xx_release_hwif
c_func
(paren
id|ide_hwif_t
op_star

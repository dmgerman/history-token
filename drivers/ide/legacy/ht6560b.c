multiline_comment|/*&n; *  linux/drivers/ide/legacy/ht6560b.c&t;&t;Version 0.07&t;Feb  1, 2000&n; *&n; *  Copyright (C) 1995-2000  Linus Torvalds &amp; author (see below)&n; */
...
macro_line|#ifdef CONFIG_BLK_DEV_HT6560B_MODULE
DECL|macro|_IDE_C
...
macro_line|#else
macro_line|# include &quot;ide_modes.h&quot;
macro_line|#endif /* CONFIG_BLK_DEV_HT6560B_MODULE */
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Setting default configurations for drives&n;&t; */
id|t
op_assign
(paren
id|HT_CONFIG_DEFAULT
...
multiline_comment|/*&n; * init_ht6560b:&n; *&n; * called by ide.c when parsing command line&n; */
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: HT_CONFIG_PORT not found&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: HBA not found&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;HT-6560B EIDE-controller support&quot;
)paren
suffix:semicolon
id|MODULE_LICENSE
c_func
...
DECL|variable|ht6560b_mod_init
id|module_init
c_func
(paren
id|ht6560b_mod_init
...
DECL|variable|ht6560b_mod_exit
id|module_exit
c_func
(paren
id|ht6560b_mod_exit

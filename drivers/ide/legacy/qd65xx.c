...
macro_line|#ifdef CONFIG_BLK_DEV_QD65XX_MODULE
DECL|macro|_IDE_C
...
macro_line|#else
macro_line|# include &quot;ide_modes.h&quot;
macro_line|#endif /* CONFIG_BLK_DEV_QD65XX_MODULE */
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: back to defaults&bslash;n&quot;
comma
id|hwif-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;Unknown qd65xx tuning fonction !&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
id|KERN_WARNING
l_string|&quot;keeping settings !&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace

...
suffix:semicolon
DECL|macro|ide_tape_f
mdefine_line|#define ide_tape_f(file) ((file)-&gt;private_data)
DECL|function|ide_tape_chrdev_get
r_static
r_struct
id|ide_tape_obj
op_star
id|ide_tape_chrdev_get
c_func
(paren
r_int
r_int
...
DECL|function|ide_tape_release
r_static
r_void
id|ide_tape_release
c_func

...
mdefine_line|#define IDETAPE_VERSION &quot;1.17b-ac1&quot;
...
DECL|macro|OS_EW
mdefine_line|#define OS_EW&t;&t;&t;300
DECL|macro|OS_ADR_MINREV
mdefine_line|#define OS_ADR_MINREV&t;&t;2
DECL|macro|OS_DATA_STARTFRAME1
mdefine_line|#define OS_DATA_STARTFRAME1&t;20
DECL|macro|OS_DATA_ENDFRAME1
mdefine_line|#define OS_DATA_ENDFRAME1&t;2980
...
id|format_id
suffix:semicolon
multiline_comment|/* hardware compatibility AUX is based on */
...
id|os_header_t
suffix:semicolon
multiline_comment|/*&n; *&t;OnStream Tape Parameters Page&n; */
r_typedef
r_struct
(brace
...
id|segtrk
suffix:semicolon
multiline_comment|/* segment of per track */
DECL|member|trks
id|__u16
id|trks
suffix:semicolon
multiline_comment|/* tracks per tape */
...
id|reserved10
suffix:semicolon
DECL|typedef|onstream_tape_paramtr_page_t
)brace
id|onstream_tape_paramtr_page_t
suffix:semicolon
...
multiline_comment|/*&n; * internal error codes for onstream&n; */
DECL|macro|OS_PART_ERROR
mdefine_line|#define OS_PART_ERROR    2
DECL|macro|OS_WRITE_ERROR
...
multiline_comment|/*&n;&t; * Measures number of frames:&n;&t; *&n;&t; * 1. written/read to/from the driver pipeline (pipeline_head).&n;&t; * 2. written/read to/from the tape buffers (bio).&n;&t; * 3. written/read by the tape to/from the media (tape_head).&n;&t; */
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: pc = %s, sense key = %x, &quot;
l_string|&quot;asc = %x, ascq = %x&bslash;n&quot;
comma
id|idetape_command_key_verbose
c_func
...
id|pc
comma
id|IDETAPE_BUFFER_FILLING_PAGE
)paren
suffix:semicolon
id|pc-&gt;callback
op_assign
...
suffix:semicolon
multiline_comment|/* effective page bh */
id|idetape_init_pc
c_func
(paren
id|pc
...
(paren
id|KERN_NOTICE
l_string|&quot;ide-tape: %s: Unsupported command in &quot;
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: postponing request, &quot;
l_string|&quot;cmd %ld, cur %d, max %d&bslash;n&quot;
comma
id|rq-&gt;flags
comma
id|tape-&gt;cur_frames
...
id|bio-&gt;bi_size
suffix:semicolon
singleline_comment|//&t;set_bit(BH_Lock, &amp;bio-&gt;bi_flags);
r_while
c_loop
(paren
op_decrement
...
l_int|NULL
suffix:semicolon
singleline_comment|//bio-&gt;bi_io_vec[0].bv_offset = b_data;
id|bio-&gt;bi_size
op_assign
id|PAGE_SIZE
suffix:semicolon
...
suffix:semicolon
singleline_comment|//&t;&t;set_bit(BH_Lock, &amp;bio-&gt;bi_flags);
id|prev_bio-&gt;bi_next
op_assign
id|bio
suffix:semicolon
...
id|write_filemark
suffix:semicolon
multiline_comment|/* not used for OnStream ?? */
id|set_bit
c_func
(paren
id|PC_WAIT_FOR_DSC
...
(brace
multiline_comment|/* AJN-4: Changed from 5 to 10 minutes;&n;&t;&t; * because retension takes approx.&n;&t;&t; * 8:20 with Onstream 30GB tape&n;&t;&t; */
id|rc
op_assign
id|idetape_wait_ready
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/* Immediate bit */
r_else
id|pc-&gt;c
(braket
l_int|1
...
multiline_comment|/*&n;                 * Set SKIP bit.&n;                 * In case of write error this will write buffered&n;                 * data in the drive to this new position!&n;                 */
id|pc-&gt;c
(braket
l_int|9
)braket
...
(paren
id|KERN_ERR
l_string|&quot;ide-tape: %s: onstream_write_error_recovery: detected physical bad block at %u, logical %u first frame %u last_frame %u bufblocks %u stages %u skipping %u frames&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|ntohl
...
c_func
(paren
id|tape-&gt;sense.command_specific
)paren
op_rshift
l_int|16
)paren
...
suffix:semicolon
macro_line|#if 0  /* isn&squot;t once enough ??? MM */
id|idetape_update_stats
c_func
(paren
id|drive
...
macro_line|#if 0     /* already done in idetape_position_tape MM */
id|idetape_read_position
c_func
(paren
id|drive
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, read error&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, eod&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, format_id %u&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, incorrect application signature&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, frame type %x&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, partition num %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, partition version %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, wrt_pass_cntr %d (expected %d)(logical_blk_num %u)&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, seq != logical&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: skipping frame %d, logical_blk_num %u (expected %d)&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: bug, bio NULL&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: blank block detected at %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: positioning tape to block %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|position
...
(paren
id|KERN_ERR
l_string|&quot;ide-tape: %s: unrecovered read error on &quot;
l_string|&quot;logical block number %d, skipping&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;logical_blk_num
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: current position (2) %d, &quot;
l_string|&quot;lblk %d&bslash;n&quot;
comma
id|position
comma
id|tape-&gt;logical_blk_num
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: current position (2) &quot;
l_string|&quot;tape block %d&bslash;n&quot;
comma
id|tape-&gt;last_frame_position
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: expected to find marker &quot;
l_string|&quot;at addr %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|last_mark_addr
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: couldn&squot;t write back marker &quot;
l_string|&quot;frame at %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|last_mark_addr
...
DECL|function|idetape_write_filler
r_static
r_void
...
(paren
id|KERN_INFO
l_string|&quot;write_filler: positioning failed it returned %d&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
multiline_comment|/* don&squot;t write fillers if we cannot position the tape. */
r_return
suffix:semicolon
id|strcpy
c_func
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: write_filler: &quot;
l_string|&quot;couldn&squot;t write header frame&bslash;n&quot;
comma
id|tape-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: couldn&squot;t write &quot;
l_string|&quot;header frame&bslash;n&quot;
comma
id|tape-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: locating back to eod &quot;
l_string|&quot;frame addr %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;eod_frame_addr
...
(paren
id|KERN_ERR
l_string|&quot;ide-tape: %s: chrdev_write: use %d &quot;
l_string|&quot;bytes as block size (%Zd used)&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;tape_block_size
...
id|KERN_INFO
comma
l_string|&quot;chrdev_write: Write truncated at &quot;
l_string|&quot;EOM early warning&quot;
)paren
suffix:semicolon
macro_line|#endif
r_if
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: logical block num 0, setting eod to %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|OS_DATA_STARTFRAME1
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: positioning &quot;
l_string|&quot;tape to eod at %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;eod_frame_addr
...
id|KERN_INFO
l_string|&quot;ide-tape: %s: &quot;
l_string|&quot;first_frame_position %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;first_frame_position
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: couldn&squot;t seek to logical block %d &quot;
l_string|&quot;(at %d), %d retries&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|logical_blk_num
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * write filler frames to the unused frames...&n;&t;&t;&t;&t; * REMOVE WHEN going to LIN4 application type...&n;&t;&t;&t;&t; */
id|idetape_write_filler
c_func
(paren
id|drive
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: warning: revision %d.%d &quot;
l_string|&quot;detected (up to 1.%d supported)&bslash;n&quot;
comma
id|header-&gt;major_rev
comma
id|header-&gt;minor_rev
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: Linux media version &quot;
l_string|&quot;%d detected (current 3)&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;linux_media_version
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: non Linux media detected &quot;
l_string|&quot;(%s)&bslash;n&quot;
comma
id|tape-&gt;name
comma
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s: detected write pass counter &quot;
l_string|&quot;%d, eod frame addr %d&bslash;n&quot;
comma
id|tape-&gt;name
comma
id|tape-&gt;wrt_pass_cntr
...
multiline_comment|/*&n; *&t;idetape_get_mode_sense_parameters asks the tape about its various&n; *&t;parameters. This may work for other drives to???&n; */
DECL|function|idetape_onstream_mode_sense_tape_parameter_page
r_static
r_void
id|idetape_onstream_mode_sense_tape_parameter_page
c_func
...
(paren
id|KERN_ERR
l_string|&quot;ide-tape: Can&squot;t get tape parameters page - probably no tape inserted in onstream drive&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ide-tape: %s &lt;-&gt; %s: Tape length %dMB (%d frames/track, %d tracks = %d blocks, density: %dKbpi)&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|tape-&gt;name

...
multiline_comment|/* Ignore disks for which handling by the legacy driver was requested&n;&t; * by the used.&n;&t; */
r_if
c_cond
(paren
id|ch-&gt;io_ports
...
multiline_comment|/* Look up whatever there is a subdriver, which will serve this&n;&t; * device and execute the attach method it is providing.&n;&t; */
(brace
r_struct
id|ata_operations
op_star
...
multiline_comment|/*&n; * This gets called VERY EARLY during initialization, to handle kernel &quot;command&n; * line&quot; strings beginning with &quot;hdx=&quot;.  It gets called even before the actual&n; * module gets initialized.&n; *&n; * Please look at Documentation/ide.txt to see the complete list of supported&n; * options.&n; */
DECL|function|ata_hd_setup
r_static
r_int
id|__init
id|ata_hd_setup
...
id|ch
suffix:semicolon
multiline_comment|/* FIXME:  Channel parms should not be accessed in ata_hd_setup */
r_struct
id|ata_device
op_star
id|drive
...
suffix:semicolon
multiline_comment|/* Look for hdx=ide-* */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/* FIXME:  Channel parm */
r_goto
id|done
suffix:semicolon
r_case
...
multiline_comment|/*&n; * This gets called VERY EARLY during initialization, to handle kernel &quot;command&n; * line&quot; strings beginning with &quot;ide&quot;.  It gets called even before the actual&n; * module gets initialized.&n; *&n; * Please look at Documentation/ide.txt to see the complete list of supported&n; * options.&n; */
...
multiline_comment|/*&n;&t;&t; * Check for specific chipset name&n;&t;&t; */
id|i
op_assign
id|match_parm
c_func

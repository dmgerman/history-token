...
multiline_comment|/*&n; * Look again for all drives in the system on all interfaces.&n; */
...
DECL|function|subdriver_interator
r_static
r_struct
id|ata_operations
op_star
id|subdriver_interator
c_func
(paren
r_struct
id|ata_operations

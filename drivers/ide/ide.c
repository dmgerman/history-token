...
macro_line|#ifndef __IDEDMA_TIMEOUT
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME or DELETE ME&n;&t; *&n;&t; * so what do we do if the device is left in an invalid state&n;&t; * and will not accept commands. SOFT RESET is the only chance.&n;&t; */
)brace
macro_line|#endif
...
suffix:semicolon
macro_line|#else /* __IDEDMA_TIMEOUT */
(paren
r_void
)paren
id|hwgroup-&gt;hwif
...
suffix:semicolon
macro_line|#endif /* __IDEDMA_TIMEOUT */
)brace
r_else
id|startstop
op_assign
...
suffix:semicolon
multiline_comment|/* temporary export */
DECL|variable|ata_drives_lock
id|EXPORT_SYMBOL
c_func
(paren

...
multiline_comment|/*&n; *&t;Check if we can unregister the subdriver. Called with the&n; *&t;request lock held.&n; */
DECL|function|default_shutdown
r_static
r_int
id|default_shutdown
c_func
...
multiline_comment|/*&n; *&t;Default function to use for the cache flush operation. This&n; *&t;must be replaced for disk devices (see ATA specification&n; *&t;documents on cache flush and drive suspend rules)&n; *&n; *&t;If we have no device attached or the device is not writable&n; *&t;this handler is sufficient.&n; */

...
suffix:semicolon
multiline_comment|/* This issues a special drive command.&n;&t; *&n;&t; * FIXME: move this down to idedisk_do_request().&n;&t; */
r_if
c_cond
(paren
id|rq-&gt;flags
...
multiline_comment|/*&n; * This is our timeout function for all drive operations.  But note that it can&n; * also be invoked as a result of a &quot;sleep&quot; operation triggered by the&n; * mod_timer() call in do_request.&n; *&n; * FIXME: this should take a drive context instead of a channel.&n; */

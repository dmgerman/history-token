...
id|io_32bit
suffix:semicolon
multiline_comment|/* first check if this controller has defined a special function&n;&t; * for handling polled ide transfers&n;&t; */
r_if
c_cond
(paren
id|HWIF
...
id|flags
suffix:semicolon
multiline_comment|/*&n;&t; * release queue lock, grab IDE global lock and restore when&n;&t; * we leave...&n;&t; */
id|spin_unlock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t; * just to make sure...&n;&t; */
r_if
c_cond
(paren
id|rq-&gt;bio
...
multiline_comment|/* Common for ide-floppy.c and ide-disk.c */
...
DECL|function|default_driver_reinit
r_static
r_int
id|default_driver_reinit
(paren
id|ide_drive_t
op_star
id|drive

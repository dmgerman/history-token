...
r_continue
suffix:semicolon
multiline_comment|/* This device still want&squot;s to remain idle.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|drive-&gt;PADAM_sleep
...
multiline_comment|/*&n; * Determine the longes sleep time for the devices in our hwgroup.&n; */
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * Take a short snooze, and then wake up again.&n;&t;&t;&t;&t; * Just in case there are big differences in&n;&t;&t;&t;&t; * relative throughputs.. don&squot;t want to hog the&n;&t;&t;&t;&t; * cpu too much.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
l_int|0
...
c_cond
(paren
id|hwgroup-&gt;XXX_drive-&gt;channel-&gt;sharing_irq
op_logical_and
id|ch
op_ne
id|hwgroup-&gt;XXX_drive-&gt;channel
op_logical_and
id|ch-&gt;io_ports
(braket
...
id|drive
suffix:semicolon
multiline_comment|/* Reset wait timeout.&n;&t;&t; */
id|drive-&gt;PADAM_sleep
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Just continuing an interrupted request maybe.&n;&t;&t; */
id|hwgroup-&gt;rq
op_assign
id|elv_next_request
c_func
...
id|ch-&gt;hwgroup
suffix:semicolon
multiline_comment|/*&n;&t; * Free the irq if we were the only channel using it.&n;&t; */
r_int
id|n
op_assign
l_int|0
...
id|d
suffix:semicolon
multiline_comment|/* Free the hwgroup if we were the only member.&n;&t; */
id|n
op_assign
l_int|0
suffix:semicolon

multiline_comment|/*&n; * Copyright (C) 1996 - 1999 Gadi Oxman &lt;gadio@netvision.net.il&gt;&n; * Copyright (C) 2000 - 2002 Paul Bristow &lt;paul@paulbristow.net&gt;&n; */
...
mdefine_line|#define IDEFLOPPY_VERSION &quot;0.99&quot;
...
(paren
id|KERN_ERR
l_string|&quot;%s: bio == NULL in %s, bcount == %d&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|__FUNCTION__
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;** Note, the bit will be cleared when the device is&n;&t;&t;&t;** closed.  This is the cleanest way to handle the&n;&t;&t;&t;** situation where the drive does not support&n;&t;&t;&t;** format progress reporting.&n;&t;&t;&t;*/
)brace
)brace
r_case
...
DECL|function|idefloppy_check_media_change
r_static
r_int
...
(paren
id|KERN_ERR
l_string|&quot;ide-floppy: %s: not supported by this version of driver&bslash;n&quot;
comma
id|drive-&gt;name
)paren
suffix:semicolon

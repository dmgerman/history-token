...
multiline_comment|/*&n; * write_intr() is the handler for disk write/multwrite interrupts&n; */
...
c_func
(paren
l_string|&quot;%s: write_intr error1: nr_sectors=%u, stat=0x%02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|hwif-&gt;nleft

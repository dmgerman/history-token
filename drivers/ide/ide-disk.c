...
suffix:semicolon
DECL|macro|to_ide_disk
mdefine_line|#define to_ide_disk(obj) container_of(obj, struct ide_disk_obj, kref)
DECL|macro|ide_disk_g
mdefine_line|#define ide_disk_g(disk) &bslash;&n;&t;container_of((disk)-&gt;private_data, struct ide_disk_obj, driver)
DECL|function|ide_disk_get
r_static
r_struct
id|ide_disk_obj
op_star
...
DECL|function|proc_idedisk_read_capacity
r_static
r_int
id|proc_idedisk_read_capacity
(paren
r_char
op_star
id|page
...
DECL|function|idedisk_end_flush
r_static
r_void
id|idedisk_end_flush
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|idedisk_prepare_flush
r_static
r_int
id|idedisk_prepare_flush
c_func
(paren
id|request_queue_t
op_star
...
suffix:semicolon
id|drive-&gt;queue-&gt;prepare_flush_fn
op_assign
id|idedisk_prepare_flush
suffix:semicolon
id|drive-&gt;queue-&gt;end_flush_fn
op_assign
id|idedisk_end_flush
suffix:semicolon
id|blk_queue_issue_flush_fn
...
DECL|function|ide_disk_release
r_static
r_void
id|ide_disk_release
c_func

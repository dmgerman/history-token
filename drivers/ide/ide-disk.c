...
multiline_comment|/*&n; * Determine the apriopriate hardware command correspnding to the action in&n; * question, depending upon the device capabilities and setup.&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/* Well, calculating the command in this variable may be an&n;&t; * overoptimization. */
id|u8
id|command
op_assign
id|WIN_NOP
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t; * 48-bit commands are pretty sanely laid out&n;&t; */
r_if
c_cond
(paren
id|lba48bit
...
op_increment
suffix:semicolon
multiline_comment|/* WIN_*DMA_EXT */
r_if
c_cond
(paren
id|drive-&gt;using_tcq
...
op_increment
suffix:semicolon
multiline_comment|/* WIN_*DMA_QUEUED_EXT */
)brace
r_else
r_if
c_cond
...
multiline_comment|/*&n;&t; * get a new command (push ar further down to avoid grabbing lock here&n;&t; */
id|spin_lock_irqsave
c_func
(paren
id|DRIVE_LOCK
...
suffix:semicolon
multiline_comment|/*&n;&t; * we&squot;ve reached maximum queue depth, bail&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|proc_idedisk_read_tcq
r_static
r_int
id|proc_idedisk_read_tcq
(paren
r_char
op_star
id|page
...
id|out
comma
l_string|&quot;TCQ currently on:&bslash;t%s&bslash;n&quot;
comma
id|drive-&gt;using_tcq
ques
c_cond
...
id|len
comma
l_string|&quot;Max queue depth:&bslash;t%d&bslash;n&quot;
comma
...
id|len
comma
l_string|&quot;Max achieved depth:&bslash;t%d&bslash;n&quot;
comma
...
id|len
comma
l_string|&quot;Max depth since last:&bslash;t%d&bslash;n&quot;
comma
...
id|len
comma
l_string|&quot;Current depth:&bslash;t&bslash;t%d&bslash;n&quot;
comma
id|drive-&gt;tcq-&gt;queued
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;Active tags:&bslash;t&bslash;t[ &quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|len
comma
l_string|&quot;tag masks differ (counted %lx != %lx&bslash;n&quot;
comma
id|tag_mask
comma
id|drive-&gt;tcq-&gt;tag_mask
...
id|len
comma
l_string|&quot;DMA status:&bslash;t&bslash;t%srunning&bslash;n&quot;
comma
id|test_bit
c_func
(paren

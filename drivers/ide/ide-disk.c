...
suffix:semicolon
multiline_comment|/* I hope that every freeze operation from the upper levels have&n;&t; * already been done...&n;&t; */
r_if
c_cond
(paren
id|level
...
c_func
(paren
l_string|&quot;Waiting for commands to finish&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
id|drive-&gt;disk-&gt;disk_dev.name
comma
l_string|&quot;ide-disk&quot;
)paren
suffix:semicolon
id|drive-&gt;disk-&gt;disk_dev.driver
op_assign
op_amp
id|idedisk_devdrv
suffix:semicolon
id|drive-&gt;disk-&gt;disk_dev.driver_data
op_assign
id|drive
suffix:semicolon
)brace

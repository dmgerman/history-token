...
id|len
comma
l_string|&quot;Queue:&bslash;t&bslash;t&bslash;treleased [ %lu ] - started [ %lu ]&bslash;n&quot;
comma
id|drive-&gt;immed_rel
comma
id|drive-&gt;immed_comp
...
macro_line|# define&t;idedisk_proc&t;NULL
macro_line|#endif
...
id|BAD_W_STAT
suffix:semicolon
multiline_comment|/* FIXME: I&squot;m less then sure that we are under the global request lock here!&n;&t; */
macro_line|#if 0
id|spin_unlock_irq
c_func
(paren

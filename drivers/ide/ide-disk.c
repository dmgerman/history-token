...
suffix:semicolon
multiline_comment|/* Don&squot;t try to transfer more sectors at once then one&n;&t;&t;&t; * multi sector command can swallow.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|nsect
...
singleline_comment|//&t;&t;printk(&quot;Read: rq-&gt;current_nr_sectors: %d %d %d&bslash;n&quot;, msect, nsect,  (int) rq-&gt;current_nr_sectors);
(brace
r_int
r_int
id|flags
...
multiline_comment|/* Segment of the request is complete. note that this does not&n;&t;&t; * necessarily mean that the entire request is done!! this is&n;&t;&t; * only true if ata_end_request() returns 0.&n;&t;&t; */
id|rq-&gt;errors
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n; * Issue a READ or WRITE command to a disk, using LBA if supported, or CHS&n; * otherwise, to address sectors.  It also takes care of issuing special&n; * DRIVE_CMDs.&n; *&n; * Channel lock should be held.&n; */
...
multiline_comment|/*&n;&t;&t; * 268435455  == 137439 MB or 28bit limit&n;&t;&t; * 320173056  == 163929 MB or 48bit addressing&n;&t;&t; * 1073741822 == 549756 MB or 48bit addressing fake drive&n;&t;&t; */
r_if
c_cond
(paren
id|sectors
...
id|drive-&gt;select.all
suffix:semicolon
multiline_comment|/*&n;&t; * Decode with physical ATA command to use and setup associated data.&n;&t; */
r_if
c_cond
(paren
id|rq_data_dir
...
multiline_comment|/*&n; * Small helper function used to execute simple commands.&n; */
DECL|function|simple_taskfile
r_static
r_int
id|simple_taskfile
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Ignore the return code from door_lock, since the open() has&n;&t;&t; * already succeeded once, and the door_lock is irrelevant at&n;&t;&t; * this time.&n;&t;&t; */
r_if
c_cond
(paren

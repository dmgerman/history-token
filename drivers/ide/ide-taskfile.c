...
suffix:semicolon
DECL|function|task_buffer_sectors
r_static
r_void
...
DECL|function|task_buffer_multi_sectors
r_static
r_inline
r_void
...
DECL|function|task_bio_multi_sectors
r_static
r_inline
r_void
...
DECL|function|task_multi_sectors
r_static
r_void
id|task_multi_sectors
c_func
(paren
id|ide_drive_t
op_star
...
macro_line|#else
DECL|macro|task_sectors
macro_line|# define task_sectors(d, rq, nsect, rw)&t;task_buffer_sectors(d, rq, nsect, rw)
DECL|macro|task_multi_sectors
macro_line|# define task_multi_sectors(d, rq, rw)&t;task_buffer_multi_sectors(d, rq, rw)
...
macro_line|# define task_error(d, rq, s, stat, cur_bad) drive-&gt;driver-&gt;error(d, s, stat)
macro_line|#endif

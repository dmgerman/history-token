...
id|startstop
suffix:semicolon
multiline_comment|/*&n;&t; * (ks/hs): Stuff the first sector(s)&n;&t; * by implicitly calling the handler&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t;&t; * (ks/hs): FIXME: Replace hard-coded&n;&t;&t; *               100, error handling?&n;&t;&t; */
r_for
c_loop
(paren
id|i

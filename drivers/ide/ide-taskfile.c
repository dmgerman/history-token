...
multiline_comment|/* Always make sure the transfer reate has been setup.&n;&t; * FIXME: what about setting up the drive with -&gt;tuneproc?&n;&t; */
r_if
c_cond
(paren
id|set_transfer
...
multiline_comment|/* FIXME: what about the setup for the drive?! */
r_if
c_cond
(paren

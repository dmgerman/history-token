...
multiline_comment|/*&n; * Quiet handler for commands without a data phase -- handy instead of&n; * task_no_data_intr() for commands we _know_ will fail (such as WIN_NOP)&n; */
DECL|function|task_no_data_quiet_intr
id|ide_startstop_t
id|task_no_data_quiet_intr
c_func
(paren
id|ide_drive_t
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * copy back status etc&n;&t; */
id|memcpy
c_func
(paren
id|args

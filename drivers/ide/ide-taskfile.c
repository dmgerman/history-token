...
suffix:semicolon
multiline_comment|/* FIXME: this should go possible as well */
id|byte
id|io_32bit
op_assign
id|drive-&gt;io_32bit
...
multiline_comment|/*&n; * Implement generic ioctls invoked from userspace to imlpement specific&n; * functionality.&n; *&n; * FIXME:&n; *&n; * 1. Rewrite hdparm to use the ide_task_ioctl function.&n; *&n; * 2. Publish it.&n; *&n; * 3. Kill this and HDIO_DRIVE_CMD alltogether.&n; */
...
id|rq
suffix:semicolon
multiline_comment|/*&n;&t; * First phase.&n;&t; */
r_if
c_cond
(paren
l_int|NULL
...
multiline_comment|/*&n;&t; * Second phase.&n;&t; */
r_if
c_cond
(paren
id|copy_from_user

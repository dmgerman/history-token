...
c_func
(paren
l_string|&quot;%s: (%s)  reg50h=0x%02x, reg52h=0x%02x,&quot;
l_string|&quot; reg5ah=0x%02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
...
l_int|0x50
suffix:semicolon
singleline_comment|//&t;byte reginfo&t;&t;= hwif-&gt;channel ? 0x56 : 0x52;
id|byte
id|dma_stat
suffix:semicolon
r_switch
...
suffix:semicolon
DECL|function|fixup_device_hpt374
r_void
id|__init
...
DECL|function|fixup_device_hpt366
r_void
id|__init
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/*&n;&t;&t;&t;&t; * This is the third undocumented detection&n;&t;&t;&t;&t; * method and is generally required for the&n;&t;&t;&t;&t; * ABIT-BP6 boards.&n;&t;&t;&t;&t; */
id|pci_write_config_byte
c_func
(paren
id|dev2
...
c_func
(paren
l_string|&quot;PCI: %s: Fixing interrupt %d pin %d &quot;
l_string|&quot;to ZERO &bslash;n&quot;
comma
id|d-&gt;name
comma
id|dev2-&gt;irq

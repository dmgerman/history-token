...
(brace
singleline_comment|//&t;struct pci_dev *dev&t;= HWIF(drive)-&gt;pci_dev;
id|byte
id|mode
op_assign
l_int|0x00
...
id|ATA_133
suffix:colon
singleline_comment|//&t;{ mode |= 0x04; break; }
r_case
id|ATA_100
suffix:colon
r_case
...
DECL|function|sis5513_ratefilter
r_static
id|byte
id|sis5513_ratefilter
(paren
id|ide_drive_t
op_star
id|drive
...
macro_line|#else
singleline_comment|//&t;drive_pci = (0x40 + ((drive-&gt;dn) *2));
singleline_comment|//&t;drive_pci = 0x40;
singleline_comment|//&t;drive_pci |= ((drive-&gt;dn) &lt;&lt; 1);
macro_line|#endif
...
suffix:semicolon
singleline_comment|//&t;return ((int) ide_dma_on);
r_return
(paren
(paren
r_int
...
suffix:semicolon
DECL|function|fixup_device_sis5513
r_void
id|__init

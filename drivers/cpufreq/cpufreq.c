...
suffix:semicolon
multiline_comment|/* internal prototype */
r_static
r_int
...
suffix:semicolon
multiline_comment|/**&n; *&t;cpufreq_resume - restore the CPU clock frequency after resume&n; *&n; *&t;Restore the CPU clock frequency so that our idea of the current&n; *&t;frequency reflects the actual hardware.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;cpufreq: resume failed in -&gt;setpolicy/target step on CPU %u&bslash;n&quot;
comma
id|cpu_policy-&gt;cpu
)paren
suffix:semicolon
...
r_return
suffix:semicolon
multiline_comment|/* Only valid if we&squot;re in the resume process where&n;&t;&t;&t;   * everyone knows what CPU frequency we are at */
id|down_read
c_func
(paren
op_amp

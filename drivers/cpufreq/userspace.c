multiline_comment|/*&n; *  drivers/cpufreq/userspace.c&n; *&n; *  Copyright (C)  2001 Russell King&n; *            (C)  2002 - 2003 Dominik Brodowski &lt;linux@brodo.de&gt;&n; *&n; * $Id:$&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License version 2 as&n; * published by the Free Software Foundation.&n; *&n; */
...
multiline_comment|/* on ARM SA1100 we need to rely on the values of cpufreq_get() - because &n; * of this, cpu_cur_freq[] needs to be set early.&n; */
macro_line|#if defined(CONFIG_ARM) &amp;&amp; defined(CONFIG_ARCH_SA1100)
r_extern
r_int
r_int
id|sa11x0_getspeed
...
suffix:semicolon
DECL|function|cpufreq_sa11x0_compat
r_static
r_void
id|cpufreq_sa11x0_compat
c_func
(paren
r_void
)paren
...
macro_line|#else
DECL|macro|cpufreq_sa11x0_compat

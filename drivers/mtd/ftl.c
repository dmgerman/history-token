multiline_comment|/* This version ported to the Linux-MTD system by dwmw2@infradead.org&n; * $Id: ftl.c,v 1.52 2003/08/11 09:00:44 dwmw2 Exp $&n; *&n; * Fixes: Arnaldo Carvalho de Melo &lt;acme@conectiva.com.br&gt;&n; * - fixes some leaks on failure in build_maps and ftl_notify_add, cleanups&n; *&n; * Based on:&n; */
...
mdefine_line|#define PART_BITS&t;4
...
(paren
id|KERN_INFO
l_string|&quot;ftl_cs: opening %d KiB FTL partition&bslash;n&quot;
comma
id|le32_to_cpu
c_func
(paren
...
l_int|0
comma
l_string|&quot;$Id: ftl.c,v 1.52 2003/08/11 09:00:44 dwmw2 Exp $&bslash;n&quot;
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;Support code for Flash Translation Layer, used on PCMCIA devices&quot;
)paren
suffix:semicolon
eof

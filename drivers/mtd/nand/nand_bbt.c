...
multiline_comment|/**&n; * read_bbt - [GENERIC] Read the bad block table starting from page&n; * @mtd:&t;MTD device structure&n; * @buf:&t;temporary buffer&n; * @page:&t;the starting page&n; * @num:&t;the number of bbt descriptors to read&n; * @bits:&t;number of bits per block&n; * @offs:&t;offset in the memory table&n; *&n; * Read the bad block table starting from page.&n; *&n; */

...
suffix:semicolon
DECL|function|mtdchar_devfs_init
r_static
r_inline
r_void
id|mtdchar_devfs_init
c_func
(paren
r_void
)paren
...
DECL|function|mtdchar_devfs_exit
r_static
r_inline
r_void
id|mtdchar_devfs_exit
c_func
(paren
r_void
)paren
...
macro_line|#else /* !DEVFS */
DECL|macro|mtdchar_devfs_init
mdefine_line|#define mtdchar_devfs_init() do { } while(0)
DECL|macro|mtdchar_devfs_exit
mdefine_line|#define mtdchar_devfs_exit() do { } while(0)
macro_line|#endif

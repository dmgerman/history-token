...
DECL|member|cardsize
r_int
r_int
id|cardsize
suffix:semicolon
multiline_comment|/* size of whole card */
DECL|member|offset
r_int
r_int
id|offset
...
id|force_size
comma
l_string|&quot;Force size of card in MB (1-64)&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
...
suffix:semicolon
multiline_comment|/* Find device in list */
...
l_int|1
comma
l_string|&quot;Cant find %p in dev_list&quot;
comma
id|link
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;mtd added @ %p mtd-&gt;priv = %p&quot;
comma
id|mtd
comma
id|mtd-&gt;priv
...
(brace
singleline_comment|//pcmciamtd_release((u_long)link);
id|DEBUG
c_func
(paren
l_int|3
comma
l_string|&quot;DEV_CONFIG set&quot;
)paren
suffix:semicolon
id|link-&gt;state
op_or_assign

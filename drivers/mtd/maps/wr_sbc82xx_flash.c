multiline_comment|/*&n; * $Id: wr_sbc82xx_flash.c,v 1.1 2004/06/07 10:21:32 dwmw2 Exp $&n; *&n; * Map for flash chips on Wind River PowerQUICC II SBC82xx board.&n; *&n; * Copyright (C) 2004 Red Hat, Inc.&n; *&n; * Author: David Woodhouse &lt;dwmw2@infradead.org&gt;&n; *&n; */
...
id|i
suffix:semicolon
multiline_comment|/* First, register the boot flash, whichever we&squot;re booting from */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;Bus Controller register BR0 is %08x. Cannot determine flash configuration&bslash;n&quot;
comma
id|mc-&gt;memc_br0
)paren
suffix:semicolon
...
multiline_comment|/* Set parameters for the big flash chip (CS6 or CS0) */
id|sbc82xx_flash_map
(braket
id|bigflash
)braket
...
l_int|0x4000000
suffix:semicolon
multiline_comment|/* Set parameters for the small flash chip (CS0 or CS6) */
id|sbc82xx_flash_map
(braket
op_logical_neg
id|bigflash
...
l_int|0x200000
suffix:semicolon
multiline_comment|/* Set parameters for the user flash chip (CS1) */
id|sbc82xx_flash_map
(braket
l_int|2
)braket

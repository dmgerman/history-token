multiline_comment|/*&n; * Linux driver for Disk-On-Chip Millennium&n; * (c) 1999 Machine Vision Holdings, Inc.&n; * (c) 1999, 2000 David Woodhouse &lt;dwmw2@infradead.org&gt;&n; *&n; * $Id: doc2001.c,v 1.45 2004/09/16 23:51:57 gleixner Exp $&n; */
...
multiline_comment|/* DoC_Command: Send a flash command to the flash chip through the CDSN IO register&n;   with the internal pipeline. Each of 4 delay cycles (read from the NOP register) is&n;   required after writing to CDSN Control register, see Software Requirement 11.4 item 3. */
...
multiline_comment|/* DoC_Address: Set the current address for the flash chip through the CDSN IO register&n;   with the internal pipeline. Each of 4 delay cycles (read from the NOP register) is&n;   required after writing to CDSN Control register, see Software Requirement 11.4 item 3. */
...
(paren
id|KERN_WARNING
l_string|&quot;Erase not right size (%x != %x)n&quot;
comma
id|len
comma
id|mtd-&gt;erasesize
...
id|MTD_ERASING
suffix:semicolon
multiline_comment|/* Read the status of the flash device through CDSN IO register&n;&t;   see Software Requirement 11.4 item 5.&n;&t;   FIXME: it seems that we are not wait long enough, some blocks are not&n;&t;   erased fully */
id|DoC_Command
c_func
(paren
id|docptr
...
c_func
(paren
l_string|&quot;Error Erasing at 0x%x&bslash;n&quot;
comma
id|ofs
)paren
suffix:semicolon

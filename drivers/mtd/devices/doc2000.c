multiline_comment|/*&n; * Linux driver for Disk-On-Chip 2000 and Millennium&n; * (c) 1999 Machine Vision Holdings, Inc.&n; * (c) 1999, 2000 David Woodhouse &lt;dwmw2@infradead.org&gt;&n; *&n; * $Id: doc2000.c,v 1.43 2001/06/02 14:30:43 dwmw2 Exp $&n; */
...
multiline_comment|/* according to 11.4.1, we need to wait for the busy line &n;         * drop if we read to the end of the page.  */
r_if
c_cond
(paren
l_int|0

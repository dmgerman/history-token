multiline_comment|/*&n; * Linux driver for Disk-On-Chip 2000 and Millennium&n; * (c) 1999 Machine Vision Holdings, Inc.&n; * (c) 1999, 2000 David Woodhouse &lt;dwmw2@infradead.org&gt;&n; *&n; * $Id: doc2000.c,v 1.60 2004/04/07 08:30:04 gleixner Exp $&n; */
...
DECL|macro|DOC_SUPPORT_2000TSOP
mdefine_line|#define DOC_SUPPORT_2000TSOP
...
macro_line|#endif
macro_line|#if defined(DOC_SUPPORT_2000TSOP) || defined(DOC_SUPPORT_MILLENNIUM)
...
(brace
multiline_comment|/* issue 2 read from NOP register after reading from CDSNControl register&n;&t;   &t;see Software Requirement 11.4 item 2. */
id|DoC_Delay
c_func
(paren
id|doc
...
r_else
(brace
multiline_comment|/* CDSN Slow IO register see Software Req 11.4 item 5. */
id|dummy
op_assign
id|ReadDOC
c_func
...
id|mtd-&gt;name
op_assign
l_string|&quot;DiskOnChip 2000 TSOP&quot;
suffix:semicolon
id|this-&gt;ioreg
op_assign
id|DoC_Mil_CDSN_IO
suffix:semicolon
multiline_comment|/* Pretend it&squot;s a Millennium */
id|this-&gt;ChipID
op_assign
...
c_func
(paren
l_string|&quot;Unknown ChipID 0x%02x&bslash;n&quot;
comma
id|this-&gt;ChipID
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Read the ECC syndrom through the DiskOnChip ECC logic.&n;&t;&t;&t;&t;   These syndrome will be all ZERO when there is no error */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* We return error, but have actually done the read. Not that&n;&t;&t;&t;&t;&t;   this can be told to user-space, via sys_read(), but at least&n;&t;&t;&t;&t;&t;   MTD-aware stuff can know about it by checking *retlen */
id|ret
op_assign
op_minus
id|EIO
...
multiline_comment|/* according to 11.4.1, we need to wait for the busy line &n;&t;         * drop if we read to the end of the page.  */
r_if
c_cond
(paren
l_int|0
...
multiline_comment|/* DBB-&n;&t;&t;if (len != 0x200 &amp;&amp; eccbuf)&n;&t;&t;&t;printk(KERN_WARNING&n;&t;&t;&t;       &quot;ECC needs a full sector write (adr: %lx size %lx)&bslash;n&quot;,&n;&t;&t;&t;       (long) to, (long) len);&n;   -DBB */
...
r_else
(brace
multiline_comment|/* Not enough to fill a page. Copy into buf */
id|memcpy
c_func
(paren
id|static_buf
...
id|len
suffix:semicolon
multiline_comment|/* Reading the full OOB data drops us off of the end of the page,&n;         * causing the flash device to go into busy mode, so we need&n;         * to wait until ready 11.4.1 and Toshiba TC58256FT docs */
id|ret
op_assign
id|DoC_WaitReady
c_func
...
DECL|function|doc_write_oob_nolock
r_static
r_int
id|doc_write_oob_nolock
c_func
...
c_func
(paren
l_string|&quot;MTD driver for DiskOnChip 2000 and Millennium&quot;
)paren
suffix:semicolon
eof

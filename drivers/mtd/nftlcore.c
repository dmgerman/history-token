...
id|EBUSY
suffix:semicolon
multiline_comment|/* &n;&t;&t; * We have to flush all buffers and invalidate caches,&n;&t;&t; * or we won&squot;t be able to re-use the partitions,&n;&t;&t; * if there was a change and we don&squot;t want to reboot&n;&t;&t; */
id|res
op_assign
id|wipe_partitions
c_func

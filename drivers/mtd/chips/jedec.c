...
l_int|1
suffix:semicolon
multiline_comment|/* This even could be eliminated, but new de-optimized read/write&n;&t;&t;&t; functions have to be written */
id|printk
c_func
(paren
...
suffix:semicolon
singleline_comment|//   printk(&quot;Part: &squot;%s&squot;&bslash;n&quot;,Part);
id|memset
c_func
(paren
id|MTD
...
suffix:semicolon
singleline_comment|//  Get the JEDEC numbers
id|Mfg
(braket
l_int|0
)braket
...
suffix:semicolon
singleline_comment|//   printk(&quot;Mfg is %x, Id is %x&bslash;n&quot;,Mfg[0],Id[0]);
id|Size
op_assign
id|handle_jedecs
c_func
...
suffix:semicolon
singleline_comment|//   printk(&quot;handle_jedecs Size is %x&bslash;n&quot;,(unsigned int)Size);
r_if
c_cond
(paren
id|Size
...
multiline_comment|/*      printk(&quot;todo: %x %x %x %x&bslash;n&quot;,(short)todo[0],(short)todo[1],&n;&t;      (short)todo[2],(short)todo[3]);&n;      */
r_while
c_loop
(paren
l_int|1
...
id|EIO
suffix:semicolon
singleline_comment|//printk(&quot;Here&quot;);
singleline_comment|//printk(&quot;flash_write: start is %x, len is %x&bslash;n&quot;,start,(unsigned long)len);
r_while
c_loop
(paren
id|len
...
id|boffset
suffix:semicolon
singleline_comment|//  printk(&quot;Flasing %X %X %X&bslash;n&quot;,base,chip-&gt;size,len);
singleline_comment|// printk(&quot;off is %x, compare with %x&bslash;n&quot;,off,chip-&gt;size &lt;&lt; chip-&gt;addrshift);
...
(brace
singleline_comment|//&t; printk(&quot;oldbyte and *buf is %x,len is %x&bslash;n&quot;,oldbyte,len);
r_continue
suffix:semicolon
)brace
r_if

...
(brace
multiline_comment|/*printk(&quot;reset unlock called %x %x &bslash;n&quot;,cfi-&gt;addr_unlock1,cfi-&gt;addr_unlock2);*/
id|cfi_send_gen_cmd
c_func
(paren
l_int|0xaa
...
id|MTD_DEBUG_LEVEL3
comma
l_string|&quot;MTD %s(): 0x%.4lx 0x%.4lx did not match&bslash;n&quot;
comma
id|__func__
comma
id|unlock_addrs
...
(paren
id|KERN_NOTICE
l_string|&quot;Probe at addr_unlock1(0x%08x + 0x%08x) past the end of the map(0x%08lx)&bslash;n&quot;
comma
id|base
comma
id|cfi-&gt;addr_unlock1
...
(paren
id|KERN_NOTICE
l_string|&quot;Probe at addr_unlock2(0x%08x + 0x%08x) past the end of the map(0x%08lx)&bslash;n&quot;
comma
id|base
comma
id|cfi-&gt;addr_unlock2

...
DECL|macro|ADDR_SECTOR_LOCK
mdefine_line|#define ADDR_SECTOR_LOCK&t;&t;0x0002
DECL|macro|ADDR_HANDSHAKE
mdefine_line|#define ADDR_HANDSHAKE&t;&t;&t;0x0003
...
DECL|macro|CMD_UNLOCK_SECTOR
mdefine_line|#define CMD_UNLOCK_SECTOR&t;&t;0x0060
...
(brace
multiline_comment|/* Sector lock address. A6 = 1 for unlock, A6 = 0 for lock */
r_int
id|SLA
op_assign
id|unlock
...
suffix:semicolon
multiline_comment|/* 1st cycle: write cmd to any address */
id|wide_write
c_func
(paren
id|map
...
suffix:semicolon
multiline_comment|/* 2nd cycle: write cmd to any address */
id|wide_write
c_func
(paren
id|map
...
suffix:semicolon
multiline_comment|/* 3rd cycle: write cmd to SLA */
)brace
DECL|function|is_sector_locked
r_static
r_inline
r_int
id|is_sector_locked
...
suffix:semicolon
multiline_comment|/* status is 0x0000 for unlocked and 0x0001 for locked */
id|status
op_assign
id|wide_read
c_func
...
DECL|function|amd_flash_do_unlock
r_static
r_int
id|amd_flash_do_unlock
c_func
(paren
r_struct
id|mtd_info
...
id|mtd-&gt;priv
suffix:semicolon
multiline_comment|/* Pass the whole chip through sector by sector and check for each&n;&t;   sector if the sector and the given interval overlap */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;Cannot unlock sector at address %x length %xx&bslash;n&quot;
comma
id|eraseoffset
comma
id|merip-&gt;erasesize
...
c_func
(paren
l_string|&quot;Cannot lock sector at address %x length %x&bslash;n&quot;
comma
id|eraseoffset
comma
id|merip-&gt;erasesize
...
DECL|function|amd_flash_unlock
r_static
r_int
id|amd_flash_unlock
c_func
...
c_func
(paren
l_string|&quot;Jonas Holmberg &lt;jonas.holmberg@axis.com&gt;&quot;
)paren
suffix:semicolon
id|MODULE_DESCRIPTION
c_func
(paren
l_string|&quot;Old MTD chip driver for AMD flash chips&quot;
)paren
suffix:semicolon
eof

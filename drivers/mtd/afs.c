...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Check the checksum.&n;&t; */
r_if
c_cond
(paren
id|word_sum
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Validate the name - it must be NUL terminated.&n;&t; */
r_for
c_loop
(paren
id|i

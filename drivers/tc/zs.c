multiline_comment|/*&n; * decserial.c: Serial port driver for IOASIC DECstations.&n; *&n; * Derived from drivers/sbus/char/sunserial.c by Paul Mackerras.&n; * Derived from drivers/macintosh/macserial.c by Harald Koerfgen.&n; *&n; * DECstation changes&n; * Copyright (C) 1998-2000 Harald Koerfgen&n; * Copyright (C) 2000, 2001, 2002, 2003, 2004  Maciej W. Rozycki&n; *&n; * For the rest of the code the original Copyright applies:&n; * Copyright (C) 1996 Paul Mackerras (Paul.Mackerras@cs.anu.edu.au)&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; *&n; * Note: for IOASIC systems the wiring is as follows:&n; *&n; * mouse/keyboard:&n; * DIN-7 MJ-4  signal        SCC&n; * 2     1     TxD       &lt;-  A.TxD&n; * 3     4     RxD       -&gt;  A.RxD&n; *&n; * EIA-232/EIA-423:&n; * DB-25 MMJ-6 signal        SCC&n; * 2     2     TxD       &lt;-  B.TxD&n; * 3     5     RxD       -&gt;  B.RxD&n; * 4           RTS       &lt;- ~A.RTS&n; * 5           CTS       -&gt; ~B.CTS&n; * 6     6     DSR       -&gt; ~A.SYNC&n; * 8           CD        -&gt; ~B.DCD&n; * 12          DSRS(DCE) -&gt; ~A.CTS  (*)&n; * 15          TxC       -&gt;  B.TxC&n; * 17          RxC       -&gt;  B.RxC&n; * 20    1     DTR       &lt;- ~A.DTR&n; * 22          RI        -&gt; ~A.DCD&n; * 23          DSRS(DTE) &lt;- ~B.RTS&n; *&n; * (*) EIA-232 defines the signal at this pin to be SCD, while DSRS(DCE)&n; *     is shared with DSRS(DTE) at pin 23.&n; */
...
macro_line|#ifdef CONFIG_SERIAL_DEC_CONSOLE
...
mdefine_line|#define BUS_PRESENT (DS_BUS_PRESENT)
...
suffix:semicolon
macro_line|#endif
macro_line|#if defined(CONFIG_SERIAL_DEC_CONSOLE) &amp;&amp; defined(CONFIG_MAGIC_SYSRQ) &amp;&amp; &bslash;&n;   !defined(MODULE)
...
suffix:semicolon
multiline_comment|/* Ignore the null char got when BREAK is removed.  */
r_if
c_cond
(paren
id|ch
...
c_func
(paren
l_string|&quot;DECstation Z8530 serial driver version 0.09&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
l_int|4
suffix:semicolon
macro_line|#ifndef CONFIG_SERIAL_DEC_CONSOLE
...
c_func
(paren
l_string|&quot;Couldn&squot;t register serial driver&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(brace
multiline_comment|/* Needed before interrupts are enabled. */
id|info-&gt;tty
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;ttyS%02d at 0x%08x (irq = %d) is a Z85C30 SCC&bslash;n&quot;
comma
id|info-&gt;line
comma
id|info-&gt;port
...
id|B9600
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Set this to a sane value to prevent a divide error.&n;&t;&t; */
id|baud
op_assign
l_int|9600
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Set up the baud rate generator.&n;&t; */
id|brg
op_assign
id|BPS_TO_BRG
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; * Set byte size and parity.&n;&t; */
r_if
c_cond
(paren
id|bits
...
suffix:semicolon
multiline_comment|/*&n;&t; * Load up the new values.&n;&t; */
id|load_zsregs
c_func
(paren
id|info-&gt;zs_channel
...
macro_line|#endif /* ifdef CONFIG_SERIAL_DEC_CONSOLE */
macro_line|#ifdef CONFIG_KGDB

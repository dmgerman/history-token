...
l_int|0
suffix:semicolon
multiline_comment|/* Detect whether a I801 can be found, and initialize it, where necessary.&n;   Note the differences between kernels with the old PCI BIOS interface and&n;   newer kernels with the real PCI interface. In compat.h some things are&n;   defined to make the transition easier. */
...
(paren
id|KERN_WARNING
l_string|&quot;i2c-i801.o: Error: No PCI-bus found!&bslash;n&quot;
)paren
suffix:semicolon
id|error_return
op_assign
...
multiline_comment|/* Look for each chip */
...
(paren
id|KERN_WARNING
l_string|&quot;i2c-i801.o: Error: Can&squot;t detect I801, function 3!&bslash;n&quot;
)paren
suffix:semicolon
id|error_return
op_assign

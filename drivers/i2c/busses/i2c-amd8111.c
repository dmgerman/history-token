...
op_or
id|I2C_FUNC_SMBUS_WORD_DATA_PEC
op_or
...
op_or
id|I2C_FUNC_SMBUS_PROC_CALL_PEC
op_or
id|I2C_FUNC_SMBUS_BLOCK_PROC_CALL
op_or
id|I2C_FUNC_SMBUS_BLOCK_PROC_CALL_PEC
op_or
...
id|smbus
suffix:semicolon
id|smbus-&gt;adapter.inc_use
op_assign
id|amd8111_inc
suffix:semicolon
id|smbus-&gt;adapter.dec_use
op_assign
id|amd8111_dec
suffix:semicolon
r_if
...
(paren
id|KERN_WARNING
l_string|&quot;i2c-amd8111.c: Failed to register adapter.&bslash;n&quot;
)paren
suffix:semicolon
id|release_region
c_func
...
(paren
id|KERN_INFO
l_string|&quot;i2c-amd8111.c: AMD8111 SMBus 2.0 adapter at %#x&bslash;n&quot;
comma
id|smbus-&gt;base
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;i2c-amd8111.c: Failed to unregister adapter.&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon

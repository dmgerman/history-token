...
DECL|macro|SMBBA1
mdefine_line|#define SMBBA1&t;    0x90
DECL|macro|SMBBA2
mdefine_line|#define SMBBA2      0x80
DECL|macro|SMBBA3
mdefine_line|#define SMBBA3      0xD0
multiline_comment|/* SMBus address offsets */
DECL|macro|SMBHSTSTS
mdefine_line|#define SMBHSTSTS (0 + vt596_smba)
DECL|macro|SMBHSLVSTS
mdefine_line|#define SMBHSLVSTS (1 + vt596_smba)
DECL|macro|SMBHSTCNT
mdefine_line|#define SMBHSTCNT (2 + vt596_smba)
DECL|macro|SMBHSTCMD
mdefine_line|#define SMBHSTCMD (3 + vt596_smba)
DECL|macro|SMBHSTADD
mdefine_line|#define SMBHSTADD (4 + vt596_smba)
DECL|macro|SMBHSTDAT0
mdefine_line|#define SMBHSTDAT0 (5 + vt596_smba)
DECL|macro|SMBHSTDAT1
mdefine_line|#define SMBHSTDAT1 (6 + vt596_smba)
DECL|macro|SMBBLKDAT
mdefine_line|#define SMBBLKDAT (7 + vt596_smba)
DECL|macro|SMBSLVCNT
mdefine_line|#define SMBSLVCNT (8 + vt596_smba)
DECL|macro|SMBSHDWCMD
mdefine_line|#define SMBSHDWCMD (9 + vt596_smba)
DECL|macro|SMBSLVEVT
mdefine_line|#define SMBSLVEVT (0xA + vt596_smba)
DECL|macro|SMBSLVDAT
mdefine_line|#define SMBSLVDAT (0xC + vt596_smba)
...
DECL|macro|SMBSLVC
mdefine_line|#define SMBSLVC     (SMBHSTCFG+1)
DECL|macro|SMBSHDW1
mdefine_line|#define SMBSHDW1    (SMBHSTCFG+2)
DECL|macro|SMBSHDW2
mdefine_line|#define SMBSHDW2    (SMBHSTCFG+3)
DECL|macro|SMBREV
mdefine_line|#define SMBREV      (SMBHSTCFG+4)
...
l_int|0
suffix:semicolon
multiline_comment|/* Detect whether a compatible device can be found, and initialize it. */
DECL|function|vt596_setup
r_int
id|vt596_setup
c_func
(paren
...
id|VT596_dev-&gt;dev
comma
l_string|&quot;Found Via %s device&bslash;n&quot;
comma
id|VT596_dev-&gt;dev.name
)paren
suffix:semicolon

...
suffix:semicolon
multiline_comment|/*&n; * Scan bus for valid 7-bit addresses (ie things that ACK on 1 byte read)&n; * We only scan range [0x08 - 0x77], all other addresses are reserved anyway&n; */
DECL|function|iic_scan_bus
r_static
r_void
id|__devinit
id|iic_scan_bus
...
(paren
id|KERN_INFO
l_string|&quot;ibm-iic%d: scanning bus...&bslash;n&quot;
id|KERN_INFO
comma
id|dev-&gt;idx
)paren
...
c_func
(paren
l_string|&quot;%sibm-iic%d: %d device(s) detected&bslash;n&quot;
comma
id|found
ques
c_cond
...
suffix:semicolon
multiline_comment|/* Scan bus if requested by user */
r_if
c_cond
(paren
id|iic_scan

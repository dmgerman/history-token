...
id|client
suffix:semicolon
id|tbl-&gt;sensors-&gt;ctl_name
op_assign
id|id
op_plus
l_int|256
suffix:semicolon
id|tbl-&gt;sensors-&gt;procname
op_assign
id|name
suffix:semicolon
id|tbl-&gt;sensors-&gt;mode
...
id|tbl-&gt;sensors
suffix:semicolon
id|tbl-&gt;root-&gt;ctl_name
op_assign
id|CTL_DEV
suffix:semicolon
id|tbl-&gt;root-&gt;procname
op_assign
l_string|&quot;dev&quot;
suffix:semicolon
id|tbl-&gt;root-&gt;mode
...
suffix:semicolon
multiline_comment|/* actually the whole anonymous struct */
)brace
id|i2c_entries
(braket
id|id

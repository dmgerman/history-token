...
suffix:semicolon
macro_line|#endif&t;&t;&t;/* LINUX_VERSION_CODE &lt; KERNEL_VERSION(2,3,1) */
...
suffix:semicolon
macro_line|#else
id|new_header-&gt;ctl_table-&gt;child-&gt;child-&gt;de-&gt;fill_inode
op_assign
op_amp
id|i2c_dir_fill_inode
suffix:semicolon
macro_line|#endif&t;/* (LINUX_VERSION_CODE &gt;= KERNEL_VERSION(2,3,27)) */
r_return
id|id
suffix:semicolon
)brace
...
suffix:semicolon
macro_line|#else
id|i2c_proc_header-&gt;ctl_table-&gt;child-&gt;de-&gt;fill_inode
op_assign
op_amp
id|i2c_fill_inode
suffix:semicolon

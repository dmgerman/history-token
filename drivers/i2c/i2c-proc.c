...
multiline_comment|/* This rather complex function must be called when you want to add an entry&n;   to /proc/sys/dev/sensors/chips. It also creates a new directory within &n;   /proc/sys/dev/sensors/.&n;   ctl_template should be a template of the newly created directory. It is&n;   copied in memory. The extra2 field of each file is set to point to client.&n;   If any driver wants subdirectories within the newly created directory,&n;   this function must be updated!  */
...
l_int|2
suffix:semicolon
multiline_comment|/* XX-chip-YY-ZZ/ */
...
l_int|2
suffix:semicolon
multiline_comment|/* Next the client sysctls. --km */
id|tbl
op_assign
id|client_tbl-&gt;child
suffix:semicolon

...
multiline_comment|/*&n;#include &lt;asm/io.h&gt;&n;*/
DECL|macro|LM85EXTENDEDFUNC
macro_line|#undef&t;LM85EXTENDEDFUNC&t;/* Extended functionality */
...
macro_line|#ifdef&t;LM85EXTENDEDFUNC&t;/* Extended functionality */
...
multiline_comment|/* These are the zone temperature range encodings */
...
comma
l_int|8
multiline_comment|/*    35.4 *    1/1, 1/2, 1/3, 1/5, 1/8, 1/12, 1/24, 1/48  */
)brace
suffix:semicolon
DECL|function|SMOOTH_TO_REG
r_static
r_int
id|SMOOTH_TO_REG
c_func
...
DECL|macro|SMOOTH_FROM_REG
mdefine_line|#define SMOOTH_FROM_REG(val) ((val)&amp;0x08?lm85_smooth_map[(val)&amp;0x07]:0)
multiline_comment|/* These are the fan spinup delay time encodings */
DECL|variable|lm85_spinup_map
r_static
r_int
id|lm85_spinup_map
(braket
...
DECL|macro|SPINUP_FROM_REG
mdefine_line|#define SPINUP_FROM_REG(val) (lm85_spinup_map[(val)&amp;0x07])
...
macro_line|#endif&t;&t;/* Extended functionality */
...
mdefine_line|#define HYST_TO_REG(val) (SENSORS_LIMIT((-(val)+5)/10,0,15))
DECL|macro|HYST_FROM_REG
mdefine_line|#define HYST_FROM_REG(val) (-(val)*10)
...
id|adapter-&gt;dev
comma
l_string|&quot;Internal error, invalid kind (%d)!&quot;
comma
id|kind
)paren
suffix:semicolon
...
DECL|function|lm85_update_client
r_void
id|lm85_update_client
c_func
(paren
...
c_func
(paren
l_string|&quot;Philip Pokorny &lt;ppokorny@penguincomputing.com&gt;, Margit Schubert-While &lt;margitsw@t-online.de&gt;&quot;
)paren
suffix:semicolon

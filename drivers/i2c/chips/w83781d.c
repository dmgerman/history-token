...
r_static
id|ssize_t
DECL|function|store_regs_fan_div_1
id|store_regs_fan_div_1
c_func
(paren
r_struct
id|device
...
r_static
id|ssize_t
DECL|function|store_regs_fan_div_2
id|store_regs_fan_div_2
c_func
(paren
r_struct
id|device
...
r_static
id|ssize_t
DECL|function|store_regs_fan_div_3
id|store_regs_fan_div_3
c_func
(paren
r_struct
id|device
...
mdefine_line|#define sysfs_fan_div(offset) &bslash;&n;static ssize_t show_regs_fan_div_##offset (struct device *dev, char *buf) &bslash;&n;{ &bslash;&n;&t;return show_fan_div_reg(dev, buf, offset); &bslash;&n;} &bslash;&n;static DEVICE_ATTR(fan##offset##_div, S_IRUGO | S_IWUSR, show_regs_fan_div_##offset, store_regs_fan_div_##offset)
id|sysfs_fan_div
c_func
(paren
l_int|1
...
mdefine_line|#define device_create_file_pwmenable(client, offset) &bslash;&n;do { &bslash;&n;device_create_file(&amp;client-&gt;dev, &amp;dev_attr_fan##offset##_pwm_enable); &bslash;&n;} while (0)
r_static
id|ssize_t

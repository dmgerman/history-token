...
DECL|macro|DEVREV
mdefine_line|#define&t;DEVREV&t;0x22&t;/* Register: Device Revision */
r_static
r_inline
r_int
...
DECL|macro|IT8705F_DEVID
mdefine_line|#define IT8705F_DEVID 0x8705
...
id|data-&gt;sensor
suffix:semicolon
multiline_comment|/* In case the value is updated while we use it */
r_if
c_cond
(paren
id|reg
...
c_func
(paren
l_string|&quot;it87: Device not activated, skipping&bslash;n&quot;
)paren
suffix:semicolon
r_goto
m_exit
...
c_func
(paren
l_string|&quot;it87: Base address not set, skipping&bslash;n&quot;
)paren
suffix:semicolon
r_goto
m_exit
...
c_func
(paren
l_string|&quot;it87: Found IT%04xF chip at 0x%x, revision %d&bslash;n&quot;
comma
id|chip_type
comma
op_star

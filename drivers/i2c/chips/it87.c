multiline_comment|/*&n;    it87.c - Part of lm_sensors, Linux kernel modules for hardware&n;             monitoring.&n;&n;    Supports: IT8705F  Super I/O chip w/LPC interface&n;              IT8712F  Super I/O chup w/LPC interface &amp; SMbus&n;              Sis950   A clone of the IT8705F&n;&n;    Copyright (c) 2001 Chris Gauthron &lt;chrisg@0-in.com&gt; &n;    Largely inspired by lm78.c of the same package&n;&n;    This program is free software; you can redistribute it and/or modify&n;    it under the terms of the GNU General Public License as published by&n;    the Free Software Foundation; either version 2 of the License, or&n;    (at your option) any later version.&n;&n;    This program is distributed in the hope that it will be useful,&n;    but WITHOUT ANY WARRANTY; without even the implied warranty of&n;    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n;    GNU General Public License for more details.&n;&n;    You should have received a copy of the GNU General Public License&n;    along with this program; if not, write to the Free Software&n;    Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n;*/
...
(brace
multiline_comment|/* to avoid floating point, we multiply everything by 100.&n;&t; val is guaranteed to be positive, so we can achieve the effect of &n;&t; rounding by (...*10+5)/10.  Note that the *10 is hidden in the &n;&t; /250 (which should really be /2500).&n;&t; At the end, we need to /100 because we *100 everything and we need&n;&t; to /10 because of the rounding thing, so we /1000.   */
r_if
c_cond
(paren
id|inNum
...
(brace
multiline_comment|/* to avoid floating point, we multiply everything by 100.&n;&t; val is guaranteed to be positive, so we can achieve the effect of&n;&t; rounding by adding 0.5.  Or, to avoid fp math, we do (...*10+5)/10.&n;&t; We need to scale with *100 anyway, so no need to /100 at the end. */
r_if
c_cond
(paren
id|inNum

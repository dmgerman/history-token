...
suffix:semicolon
multiline_comment|/* The LM83-specific data is placed right after the common I2C&n;&t; * client data. */
id|data
op_assign
(paren
r_struct
...
DECL|function|lm83_update_client
r_static
r_void
id|lm83_update_client
c_func

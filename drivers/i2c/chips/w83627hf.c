...
mdefine_line|#define W83627THF_REG_VRM_OVT_CFG &t;0x18&t;/* 637HF too, unused yet */
...
mdefine_line|#define IN_FROM_REG(val) ((val) * 16 + 5)
...
DECL|function|w83627hf_update_client
r_static
r_void
id|w83627hf_update_client
c_func

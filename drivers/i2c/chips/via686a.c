...
multiline_comment|/*&n;    Supports the Via VT82C686A, VT82C686B south bridges.&n;    Reports all as a 686A.&n;    See doc/chips/via686a for details.&n;    Warning - only supports a single device.&n;*/
...
mdefine_line|#define VIA686A_REG_TEMP(nr)&t;&t;(regtemp[(nr) - 1])
DECL|macro|VIA686A_REG_TEMP_OVER
mdefine_line|#define VIA686A_REG_TEMP_OVER(nr)&t;(regover[(nr) - 1])
DECL|macro|VIA686A_REG_TEMP_HYST
mdefine_line|#define VIA686A_REG_TEMP_HYST(nr)&t;(reghyst[(nr) - 1])
...
suffix:semicolon
multiline_comment|/* Converting temps to (8-bit) hyst and over registers &n; No interpolation here.  Just check the limits and go.&n; The +5 effectively rounds off properly and the +50 is because &n; the temps start at -50 */
...
multiline_comment|/* for 8-bit temperature hyst and over registers &n; The temp values are already *10, so we don&squot;t need to do that.&n; But we _will_ round these off to the nearest degree with (...*10+5)/10 */
DECL|macro|TEMP_FROM_REG
mdefine_line|#define TEMP_FROM_REG(val) ((tempLUT[(val)]*10+5)/10)
multiline_comment|/* for 10-bit temperature readings &n; You might _think_ this is too long to inline, but&squot;s it&squot;s really only&n; called once... */
...
(brace
multiline_comment|/* the temp values are already *10, so we don&squot;t need to do that. */
r_int
id|temp
suffix:semicolon
id|u16
...
l_int|3
suffix:semicolon
multiline_comment|/* handle the extremes first (they won&squot;t interpolate well! ;-) */
r_if
c_cond
(paren
id|val
...
r_else
(brace
multiline_comment|/* do some interpolation by multipying the lower and upper&n;&t;&t; bounds by 25, 50 or 75, then /100. */
id|temp
op_assign
(paren
(paren
...
suffix:semicolon
multiline_comment|/* increase the magnitude by 50 to achieve rounding. */
r_if
c_cond
(paren
id|temp
...
DECL|macro|VIA686A_INIT_IN_0
mdefine_line|#define VIA686A_INIT_IN_0 200
DECL|macro|VIA686A_INIT_IN_1
mdefine_line|#define VIA686A_INIT_IN_1 250
DECL|macro|VIA686A_INIT_IN_2
mdefine_line|#define VIA686A_INIT_IN_2 330
DECL|macro|VIA686A_INIT_IN_3
mdefine_line|#define VIA686A_INIT_IN_3 500
DECL|macro|VIA686A_INIT_IN_4
mdefine_line|#define VIA686A_INIT_IN_4 1200
DECL|macro|VIA686A_INIT_IN_PERCENTAGE
mdefine_line|#define VIA686A_INIT_IN_PERCENTAGE 10
DECL|macro|VIA686A_INIT_IN_MIN_0
mdefine_line|#define VIA686A_INIT_IN_MIN_0 (VIA686A_INIT_IN_0 - VIA686A_INIT_IN_0 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MAX_0
mdefine_line|#define VIA686A_INIT_IN_MAX_0 (VIA686A_INIT_IN_0 + VIA686A_INIT_IN_0 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MIN_1
mdefine_line|#define VIA686A_INIT_IN_MIN_1 (VIA686A_INIT_IN_1 - VIA686A_INIT_IN_1 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MAX_1
mdefine_line|#define VIA686A_INIT_IN_MAX_1 (VIA686A_INIT_IN_1 + VIA686A_INIT_IN_1 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MIN_2
mdefine_line|#define VIA686A_INIT_IN_MIN_2 (VIA686A_INIT_IN_2 - VIA686A_INIT_IN_2 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MAX_2
mdefine_line|#define VIA686A_INIT_IN_MAX_2 (VIA686A_INIT_IN_2 + VIA686A_INIT_IN_2 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MIN_3
mdefine_line|#define VIA686A_INIT_IN_MIN_3 (VIA686A_INIT_IN_3 - VIA686A_INIT_IN_3 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MAX_3
mdefine_line|#define VIA686A_INIT_IN_MAX_3 (VIA686A_INIT_IN_3 + VIA686A_INIT_IN_3 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MIN_4
mdefine_line|#define VIA686A_INIT_IN_MIN_4 (VIA686A_INIT_IN_4 - VIA686A_INIT_IN_4 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_IN_MAX_4
mdefine_line|#define VIA686A_INIT_IN_MAX_4 (VIA686A_INIT_IN_4 + VIA686A_INIT_IN_4 &bslash;&n;        * VIA686A_INIT_IN_PERCENTAGE / 100)
DECL|macro|VIA686A_INIT_FAN_MIN
mdefine_line|#define VIA686A_INIT_FAN_MIN&t;3000
DECL|macro|VIA686A_INIT_TEMP_OVER
mdefine_line|#define VIA686A_INIT_TEMP_OVER 600
DECL|macro|VIA686A_INIT_TEMP_HYST
mdefine_line|#define VIA686A_INIT_TEMP_HYST 500
multiline_comment|/* For the VIA686A, we need to keep some data in memory. That&n;   data is pointed to by via686a_list[NR]-&gt;data. The structure itself is&n;   dynamically allocated, at the same time when a new via686a client is&n;   allocated. */
...
suffix:semicolon
multiline_comment|/* The /proc/sys entries */
multiline_comment|/* -- SENSORS SYSCTL START -- */
...
multiline_comment|/* -- SENSORS SYSCTL END -- */
macro_line|#if 0
multiline_comment|/* These files are created for each detected VIA686A. This is just a template;&n;   though at first sight, you might think we could use a statically&n;   allocated list, we need some way to get back to the parent - which&n;   is done through one of the &squot;extra&squot; fields which are initialized &n;   when a new copy is allocated. */
r_static
id|ctl_table
id|via686a_dir_table_template
(braket
)braket
op_assign
(brace
(brace
id|VIA686A_SYSCTL_IN0
comma
l_string|&quot;in0&quot;
comma
l_int|NULL
...
suffix:semicolon
multiline_comment|/* Have to wait for reset to complete or else the following&n;&t;   initializations won&squot;t work reliably. The delay was arrived at&n;&t;   empirically, the datasheet doesn&squot;t tell you.&n;&t;   Waiting for the reset bit to clear doesn&squot;t work, it&n;&t;   clears in about 2-4 udelays and that isn&squot;t nearly enough. */
id|udelay
c_func
(paren
l_int|50
...
suffix:semicolon
multiline_comment|/* Cofigure temp interrupt mode for continuous-interrupt operation */
id|via686a_write_value
c_func
(paren
id|client
...
DECL|function|via686a_update_client
r_static
r_void
id|via686a_update_client
c_func
...
multiline_comment|/* The next few functions are the call-back functions of the /proc/sys and&n;   sysctl files. Which function is used is defined in the ctl_table in&n;   the extra1 field.&n;   Each function must return the magnitude (power of 10 to divide the date&n;   with) if it is called with operation==SENSORS_PROC_REAL_INFO. It must&n;   put a maximum of *nrels elements in results reflecting the data of this&n;   file, and set *nrels to the number it actually put in it, if operation==&n;   SENSORS_PROC_REAL_READ. Finally, it must get upto *nrels elements from&n;   results and write them to the chip, if operations==SENSORS_PROC_REAL_WRITE.&n;   Note that on SENSORS_PROC_REAL_READ, I do not check whether results is&n;   large enough (by checking the incoming value of *nrels). This is not very&n;   good practice, but as long as you put less than about 5 values in results,&n;   you can assume it is large enough. */
multiline_comment|/* FIXME, remove these functions, they are here to verify the sysfs conversion&n; * is correct, or not */
id|__attribute__
c_func
(paren
(paren

...
macro_line|#if 0
multiline_comment|/*&n;&t; * This is highly machine specific, and we should NOT touch&n;&t; * this register - we have no knowledge how the hardware&n;&t; * is actually wired.&n;&t; *&n;&t; * If we&squot;re going to do this, we should probably look into&n;&t; * using the subsystem IDs.&n;&t; *&n;&t; * On ThinkPad 380XD, this changes MFUNC0 from the ISA IRQ3&n;&t; * output (which it is) to IRQ2.  We also change MFUNC1&n;&t; * from ISA IRQ4 to IRQ6.&n;&t; */
id|irqmux
op_assign
id|config_readl
c_func

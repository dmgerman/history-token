...
suffix:semicolon
multiline_comment|/* temporary workaround */
id|p_dev-&gt;dev.driver
op_assign
op_amp
id|p_drv-&gt;drv
...
id|CLIENT_UNBOUND
suffix:semicolon
multiline_comment|/* Add to the list in pcmcia_bus_socket, but only if no device&n;&t; * with the same func _and_ driver exists */

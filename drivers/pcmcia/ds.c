...
multiline_comment|/* init_pcmcia_bus must be done early, init_pcmcia_ds late. If we load this &n; * as a module, we can only specify one initcall, though... &n; */
DECL|function|init_pcmcia_module
r_static
r_int
id|__init
id|init_pcmcia_module
c_func
(paren
r_void
)paren
...
DECL|variable|init_pcmcia_module
id|module_init
c_func
(paren
id|init_pcmcia_module

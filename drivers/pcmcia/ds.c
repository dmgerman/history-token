...
l_int|1
suffix:semicolon
multiline_comment|/* list of all sockets registered with the pcmcia bus driver */
r_static
id|DECLARE_RWSEM
c_func
(paren
id|bus_socket_list_rwsem
)paren
suffix:semicolon
r_static
id|LIST_HEAD
...
suffix:semicolon
multiline_comment|/* find the lowest, unused socket no. Please note that this is a&n;&t; * temporary workaround until &quot;struct pcmcia_socket&quot; is introduced&n;&t; * into cs.c which will include this number, and which will be&n;&t; * accessible to ds.c directly */
id|i
op_assign
l_int|0
suffix:semicolon
...
DECL|function|pcmcia_bus_add_socket_dev
r_static
r_int
id|__devinit
id|pcmcia_bus_add_socket_dev
c_func
(paren
r_struct
id|device
...
DECL|function|pcmcia_bus_remove_socket_dev
r_static
r_int
id|__devexit
id|pcmcia_bus_remove_socket_dev
c_func
(paren
r_struct
id|device

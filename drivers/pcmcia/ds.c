...
multiline_comment|/* if there&squot;s already a device registered, and it was registered&n;&t; * by userspace before, we need to return the &quot;instance&quot;. Therefore,&n;&t; * we need to set the cardmgr flag */
id|spin_lock_irqsave
c_func
(paren
op_amp

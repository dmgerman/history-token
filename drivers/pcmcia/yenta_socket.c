...
DECL|function|yenta_register_callback
r_static
r_int
id|yenta_register_callback
c_func
(paren
r_struct
id|pcmcia_socket
...
comma
multiline_comment|/* TBD: Check if these TI variants can use more&n;&t; * advanced overrides instead */
(brace
id|PD
c_func
(paren

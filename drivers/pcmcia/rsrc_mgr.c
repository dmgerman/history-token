...
(brace
multiline_comment|/* you can&squot;t use the old interface if the new&n;&t;&t;&t; * one was used before */
...
(brace
multiline_comment|/* as there&squot;s no way we know this is the&n;&t;&t;&t;&t; * last call to adjust_resource_info, we&n;&t;&t;&t;&t; * always need to assume this is the latest&n;&t;&t;&t;&t; * one... */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
id|flags
suffix:semicolon
multiline_comment|/* the good thing about SS_CAP_STATIC_MAP sockets is&n;&t; * that they don&squot;t need a resource database */
id|spin_lock_irqsave
c_func
(paren
op_amp

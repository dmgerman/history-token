...
multiline_comment|/*============================================================*/
multiline_comment|/*&n; * Interrupt handling routine.&n; */
...
(paren
id|KERN_INFO
l_string|&quot;HD64465 PCMCIA bridge socket %d at 0x%08lx irq %d&bslash;n&quot;
comma
id|i
comma
id|sp-&gt;mem_base

...
suffix:semicolon
multiline_comment|/* &n;&t;&t;SS_DETECT events need a small delay here. The reason for this is that &n;&t;&t;the &quot;is there a card&quot; electronics need time to see the card after the&n;&t;&t;&quot;we have a card coming in&quot; electronics have seen it. &n;&t;&t;*/
r_if
c_cond
(paren
id|events
...
l_int|0
suffix:semicolon
multiline_comment|/* Several sockets will send multiple &quot;new card detected&quot;&n;&t;       events in rapid succession. However, the rest of the pcmcia expects &n;&t;       only one such event. We just ignore these events by having a&n;               timeout */
r_if
c_cond
(paren
id|events
...
id|sockets
suffix:semicolon
id|i82365_device.dev.class_data
op_assign
op_amp
id|i82365_data
suffix:semicolon

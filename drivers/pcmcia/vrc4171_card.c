...
DECL|macro|IRQ_A
mdefine_line|#define IRQ_A&t;&t;&t;0x02
DECL|macro|IRQ_B
mdefine_line|#define IRQ_B&t;&t;&t;0x04
...
DECL|macro|CARD_CONTROLLER_START
mdefine_line|#define CARD_CONTROLLER_START&t;CARD_CONTROLLER_INDEX
DECL|macro|CARD_CONTROLLER_END
mdefine_line|#define CARD_CONTROLLER_END&t;CARD_CONTROLLER_DATA
...
id|SLOT_NOPROBE_ALL
comma
DECL|enumerator|SLOT_INITIALIZED
id|SLOT_INITIALIZED
comma
DECL|typedef|vrc4171_slot_t
)brace
id|vrc4171_slot_t
suffix:semicolon
r_typedef
...
id|SLOTB_IS_NONE
suffix:semicolon
DECL|variable|vrc4171_card_name
r_static
r_char
id|vrc4171_card_name
(braket
)braket
op_assign
...
l_int|0xdeb8
suffix:semicolon
DECL|variable|vrc4171_card_resource
r_static
r_struct
id|resource
id|vrc4171_card_resource
(braket
l_int|3
)braket
op_assign
...
id|start
op_assign
id|CARD_CONTROLLER_START
comma
dot
id|end
op_assign
id|CARD_CONTROLLER_END
comma
dot
id|flags
op_assign
...
suffix:semicolon
DECL|variable|vrc4171_card_device
r_static
r_struct
id|platform_device
id|vrc4171_card_device
op_assign
(brace
dot
id|name
...
DECL|function|vrc4171_add_sockets
r_static
r_int
id|__devinit
id|vrc4171_add_sockets
c_func
(paren
r_void
)paren
...
suffix:semicolon
id|socket-&gt;pcmcia_socket.dev.dev
op_assign
op_amp
id|vrc4171_card_device.dev
suffix:semicolon
...
DECL|function|vrc4171_remove_sockets
r_static
r_void
id|vrc4171_remove_sockets
c_func
(paren
r_void
)paren
...
suffix:semicolon
DECL|function|vrc4171_card_suspend
r_static
r_int
id|vrc4171_card_suspend
c_func
(paren
r_struct
id|device
...
DECL|function|vrc4171_card_resume
r_static
r_int
id|vrc4171_card_resume
c_func
(paren
r_struct
id|device
...
DECL|variable|vrc4171_card_driver
r_static
r_struct
id|device_driver
id|vrc4171_card_driver
op_assign
(brace
dot
id|name
...
(paren
id|KERN_INFO
l_string|&quot;%s, connected to IRQ %d&bslash;n&quot;
comma
id|vrc4171_card_driver.name
comma
id|vrc4171_irq
)paren
suffix:semicolon

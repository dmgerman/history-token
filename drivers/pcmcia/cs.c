...
multiline_comment|/* mask ofIRQs already reserved by other cards, we should avoid using them */
DECL|variable|pcmcia_used_irq
r_static
id|u8
id|pcmcia_used_irq
(braket
...
suffix:semicolon
DECL|function|pcmcia_get_socket
r_struct
id|pcmcia_socket
op_star
...
DECL|variable|pcmcia_get_socket
id|EXPORT_SYMBOL
c_func
(paren
id|pcmcia_get_socket
...
suffix:semicolon
DECL|function|pcmcia_put_socket
r_void
...
DECL|variable|pcmcia_put_socket
id|EXPORT_SYMBOL
c_func
(paren
id|pcmcia_put_socket
...
multiline_comment|/*======================================================================&n;&n;    The central event handler.  Send_event() sends an event to the&n;    16-bit subsystem, which then calls the relevant device drivers.&n;    Parse_events() interprets the event bits from&n;    a card status change report.  Do_shutdown() handles the high&n;    priority stuff associated with a card removal.&n;    &n;======================================================================*/
...
(brace
multiline_comment|/* If the interrupt is already assigned, it must be the same */
id|irq
op_assign
id|s-&gt;irq.AssignedIRQ
suffix:semicolon
...
l_int|32
suffix:semicolon
multiline_comment|/* marked as available by driver, and not blocked by userspace? */
r_if
c_cond
(paren
op_logical_neg
...
r_continue
suffix:semicolon
multiline_comment|/* avoid an IRQ which is already used by a PCMCIA card */
r_if
c_cond
(paren
(paren
...
r_continue
suffix:semicolon
multiline_comment|/* register the correct driver, if possible, of check whether&n;&t;&t;&t; * registering a dummy handle works, i.e. if the IRQ isn&squot;t&n;&t;&t;&t; * marked as used by the kernel resource management core */
id|ret
op_assign
id|request_irq
c_func

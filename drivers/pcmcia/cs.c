...
suffix:semicolon
DECL|macro|to_class_data
mdefine_line|#define to_class_data(dev) dev-&gt;class_data
DECL|function|pcmcia_add_socket
r_static
r_int
id|pcmcia_add_socket
c_func
(paren
r_struct
id|class_device
...
DECL|function|pcmcia_remove_socket
r_static
r_void
id|pcmcia_remove_socket
c_func
(paren
r_struct
id|class_device

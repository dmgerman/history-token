...
macro_line|#if !defined(CONFIG_M32R_CFC_NUM)
DECL|macro|M32R_MAX_PCC
mdefine_line|#define M32R_MAX_PCC&t;2
macro_line|#else
DECL|macro|M32R_MAX_PCC
mdefine_line|#define M32R_MAX_PCC&t;CONFIG_M32R_CFC_NUM
macro_line|#endif
...
DECL|macro|CFC_IOPORT_BASE
mdefine_line|#define CFC_IOPORT_BASE&t;&t;0x1000
macro_line|#if !defined(CONFIG_PLAT_USRV)
DECL|macro|CFC_ATTR_MAPBASE
mdefine_line|#define CFC_ATTR_MAPBASE        0x0c014000
DECL|macro|CFC_IO_MAPBASE_BYTE
mdefine_line|#define CFC_IO_MAPBASE_BYTE     0xac012000
DECL|macro|CFC_IO_MAPBASE_WORD
mdefine_line|#define CFC_IO_MAPBASE_WORD     0xac002000
macro_line|#else&t;/* CONFIG_PLAT_USRV */
DECL|macro|CFC_ATTR_MAPBASE
mdefine_line|#define CFC_ATTR_MAPBASE&t;0x04014000
DECL|macro|CFC_IO_MAPBASE_BYTE
mdefine_line|#define CFC_IO_MAPBASE_BYTE&t;0xa4012000
DECL|macro|CFC_IO_MAPBASE_WORD
mdefine_line|#define CFC_IO_MAPBASE_WORD&t;0xa4002000

...
suffix:semicolon
DECL|variable|sa1100_pcmcia_driver
r_static
r_struct
id|device_driver
id|sa1100_pcmcia_driver
op_assign
(brace
dot
id|name
...
suffix:semicolon
DECL|variable|sa1100_pcmcia_device
r_static
r_struct
id|platform_device
id|sa1100_pcmcia_device
op_assign
(brace
dot
id|name
...
suffix:semicolon
multiline_comment|/*&n;&t; * Don&squot;t fail if we don&squot;t find any on-board sockets.&n;&t; */
r_return
l_int|0
suffix:semicolon
)brace

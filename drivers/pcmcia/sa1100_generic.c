...
id|mecr
suffix:semicolon
multiline_comment|/*&n;     * When clients issue RequestMap, the access speed is not always&n;     * properly configured.  Choose some sensible defaults.&n;     */
r_if
c_cond
(paren
id|speed
...
suffix:semicolon
multiline_comment|/* Fixme: MECR is not pre-empt safe. */
id|mecr
op_assign
id|MECR
suffix:semicolon

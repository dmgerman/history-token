multiline_comment|/*&n; * drivers/pcmcia/sa1100_neponset.c&n; *&n; * Neponset PCMCIA specific routines&n; *&n; */
...
id|SA_INTERRUPT
comma
l_string|&quot;Neponset PCMCIA (0) BVD1&quot;
comma
l_int|NULL
)paren
suffix:semicolon
...
DECL|function|neponset_pcmcia_shutdown
r_static
r_int
(def_block
id|neponset_pcmcia_shutdown
c_func
(paren
r_void
)paren
...
DECL|function|neponset_pcmcia_socket_state
r_static
r_int
(def_block
id|neponset_pcmcia_socket_state
c_func
(paren
r_struct
...
DECL|function|neponset_pcmcia_get_irq_info
r_static
r_int
(def_block
id|neponset_pcmcia_get_irq_info
c_func
(paren
r_struct
id|pcmcia_irq_info

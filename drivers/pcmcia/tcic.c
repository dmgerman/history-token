...
c_func
(paren
l_string|&quot;could not allocate ports,&bslash;n &quot;
)paren
suffix:semicolon
...
id|sockets
suffix:semicolon
id|tcic_class_data.dev
op_assign
op_amp
id|tcic_device.dev
suffix:semicolon
id|tcic_class_data.class_data
op_assign
op_amp
id|tcic_data
suffix:semicolon

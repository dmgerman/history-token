...
c_func
(paren
l_string|&quot;unmask irq %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* EISA needs to be fixed at IRQ region #0 (EISA_IRQ_REGION) */
DECL|variable|eisa_irq_region
r_static
r_struct
id|irq_region
id|eisa_irq_region

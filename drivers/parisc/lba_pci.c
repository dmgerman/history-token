...
multiline_comment|/* if (!LBA_SKIP_PROBE(d)) */
(brace
...
suffix:semicolon
multiline_comment|/*&n; * The mercury_cfg_ops are slightly misnamed; they&squot;re also used for Elroy&n; * TR4.0 as no additional bugs were found in this areea between Elroy and&n; * Mercury&n; */
...
c_func
(paren
l_string|&quot;mercury_cfg_read(%x+%2x) -&gt; 0x%x&bslash;n&quot;
comma
id|tok
comma
id|pos
...
c_func
(paren
l_string|&quot;   claimed %s %d [%lx,%lx]/%lx&bslash;n&quot;
comma
id|pci_name
c_func
(paren
...
c_func
(paren
l_string|&quot;lba_fixup_bus(0x%p) bus %d platform_data 0x%p&bslash;n&quot;
comma
id|bus
comma
id|bus-&gt;secondary
...
c_func
(paren
l_string|&quot;lba_fixup_bus() %s [%lx/%lx]/%lx&bslash;n&quot;
comma
...
mdefine_line|#define LBA_PORT_IN(size, mask) &bslash;&n;static u##size lba_astro_in##size (struct pci_hba_data *d, u16 addr) &bslash;&n;{ &bslash;&n;&t;u##size t; &bslash;&n;&t;t = READ_REG##size(astro_iop_base + addr); &bslash;&n;&t;DBG_PORT(&quot; 0x%x&bslash;n&quot;, t); &bslash;&n;&t;return (t); &bslash;&n;}
id|LBA_PORT_IN
c_func
(paren
l_int|8
...
(paren
id|KERN_WARNING
l_string|&quot;Can&squot;t support LBA older than &quot;
l_string|&quot;TR2.1 - continuing under adversity.&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#if 0
multiline_comment|/* Elroy TR4.0 should work with simple algorithm.&n;   But it doesn&squot;t.  Still missing something. *sigh*&n;*/
r_if
c_cond
(paren
id|func_class
...
suffix:semicolon
multiline_comment|/* We could use one printk for both Elroy and Mercury,&n;                 * but for the mask for func_class.&n;                 */
id|printk
c_func
(paren
id|KERN_INFO
...
(paren
id|KERN_ERR
l_string|&quot;Unknown LBA found at 0x%lx&bslash;n&quot;
comma
id|dev-&gt;hpa
)paren
suffix:semicolon
...
multiline_comment|/* Make sure we aren&squot;t trying to set bits that aren&squot;t writeable. */
id|WARN_ON
c_func
(paren
(paren

...
multiline_comment|/**&n; * ccio_get_iommu - Find the iommu which controls this device&n; * @dev: The parisc device.&n; *&n; * This function searches through the registerd IOMMU&squot;s and returns the&n; * appropriate IOMMU for the device based upon the devices hardware path.&n; */
...
id|end
suffix:semicolon
multiline_comment|/* see if we can expand above */
id|end
op_assign
(paren
id|res-&gt;end
...
(brace
multiline_comment|/* now try below */
id|start
op_assign
(paren
(paren
...
id|end
suffix:semicolon
multiline_comment|/* This could be caused by some sort of race.  Basically, if&n;&t; * this tripped something stole the region we just reserved&n;&t; * and then released to check for expansion */
id|BUG_ON
c_func
(paren
id|request_resource
...
(brace
multiline_comment|/* no IOC, so nothing to expand */
r_return
suffix:semicolon
)brace
r_if
...
(paren
id|KERN_ERR
l_string|&quot;Unable to expand %s window by 0x%lx&bslash;n&quot;
comma
id|parent-&gt;name
comma
id|size
...
multiline_comment|/* OK, we have the memory, now expand the window */
r_if
c_cond
(paren
id|parent
...
r_else
(brace
multiline_comment|/* This should be impossible.  It means&n;&t;&t; * expand_ioc_area got called with a resource that&n;&t;&t; * didn&squot;t belong to the ioc&n;&t;&t; */
id|BUG
c_func
(paren
)paren
...
DECL|function|ccio_get_resource
r_static
r_struct
id|resource
op_star
id|ccio_get_resource
c_func
(paren
r_struct
id|ioc

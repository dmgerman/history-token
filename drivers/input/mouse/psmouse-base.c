...
suffix:semicolon
DECL|variable|psmouse_proto_abbrev
r_static
r_char
op_star
id|psmouse_proto_abbrev
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|macro|param_check_proto_abbrev
mdefine_line|#define param_check_proto_abbrev(name, p)&t;__param_check(name, p, unsigned int)
DECL|macro|param_set_proto_abbrev
mdefine_line|#define param_set_proto_abbrev&t;&t;&t;psmouse_set_maxproto
DECL|macro|param_get_proto_abbrev
mdefine_line|#define param_get_proto_abbrev&t;&t;&t;psmouse_get_maxproto
...
id|proto
comma
l_string|&quot;Highest protocol extension to probe (bare, imps, exps, any). Useful for KVM switches.&quot;
)paren
suffix:semicolon
...
DECL|variable|psmouse_serio_ids
r_static
r_struct
id|serio_device_id
id|psmouse_serio_ids
(braket
)braket
op_assign
(brace
...
DECL|function|psmouse_set_maxproto
r_static
r_int
id|psmouse_set_maxproto
c_func
...
DECL|function|psmouse_get_maxproto
r_static
r_int
id|psmouse_get_maxproto
c_func

...
suffix:semicolon
multiline_comment|/*&n;&t; * OK, the device is ready, we just need to activate it (turn the&n;&t; * stream mode on). But if mouse has a pass-through port we don&squot;t&n;&t; * want to do it yet to not disturb child detection.&n;&t; * The child will activate this port when it&squot;s ready.&n;&t; */
r_if
c_cond
(paren
id|serio-&gt;child

...
DECL|variable|toshiba_dmi_table
r_static
r_struct
id|dmi_system_id
id|toshiba_dmi_table
(braket
)braket
op_assign
(brace
...
(paren
id|KERN_INFO
l_string|&quot;synaptics: Toshiba Satellite detected, limiting rate to 40pps.&bslash;n&quot;
)paren
suffix:semicolon
id|psmouse-&gt;rate
op_assign

...
multiline_comment|/*&n; * Use the Synaptics extended ps/2 syntax to write a special command byte.&n; * special command: 0xE8 rr 0xE8 ss 0xE8 tt 0xE8 uu where (rr*64)+(ss*16)+(tt*4)+uu&n; *                  is the command. A 0xF3 or 0xE9 must follow (see synaptics_send_cmd&n; *                  and synaptics_mode_cmd)&n; */
...
DECL|function|synaptics_pt_open
r_static
r_int
id|synaptics_pt_open
c_func
(paren
r_struct
id|serio
...
DECL|function|synaptics_pt_close
r_static
r_void
id|synaptics_pt_close
c_func
(paren
r_struct
id|serio
...
DECL|function|synaptics_pt_init
r_int
...
(paren
id|KERN_ERR
l_string|&quot;synaptics: not enough memory to allocate serio port&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|priv
suffix:semicolon
macro_line|#ifndef CONFIG_MOUSE_PS2_SYNAPTICS
r_return
op_minus
l_int|1
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;Synaptics driver lost sync at 2nd byte&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|bad_sync
...
(paren
id|KERN_WARNING
l_string|&quot;Synaptics driver lost sync at 5th byte&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|bad_sync
...
r_break
suffix:semicolon
multiline_comment|/* Wait for full packet */
r_if
c_cond
(paren
id|priv-&gt;out_of_sync

multiline_comment|/*&n; * $Id: joydev.c,v 1.19 2001/01/10 19:49:40 vojtech Exp $&n; *&n; *  Copyright (c) 1999-2000 Vojtech Pavlik &n; *  Copyright (c) 1999 Colin Van Dyke &n; *&n; *  Joystick device driver for the input driver suite.&n; *&n; *  Sponsored by SuSE and Intel&n; */
...
suffix:semicolon
singleline_comment|//&t;printk(KERN_INFO &quot;js%d: Joystick device for input%d&bslash;n&quot;, minor, dev-&gt;number);
r_return
op_amp
id|joydev-&gt;handle
suffix:semicolon

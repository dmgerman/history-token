...
suffix:semicolon
DECL|macro|ATKBD_FLAG_ACK
mdefine_line|#define ATKBD_FLAG_ACK&t;&t;0&t;/* Waiting for ACK/NAK */
DECL|macro|ATKBD_FLAG_CMD
mdefine_line|#define ATKBD_FLAG_CMD&t;&t;1&t;/* Waiting for command to finish */
DECL|macro|ATKBD_FLAG_CMD1
mdefine_line|#define ATKBD_FLAG_CMD1&t;&t;2&t;/* First byte of command response */
DECL|macro|ATKBD_FLAG_ENABLED
mdefine_line|#define ATKBD_FLAG_ENABLED&t;3&t;/* Waining for init to finish */
...
id|write
suffix:semicolon
multiline_comment|/* Protected by FLAG_ACK */
DECL|member|nak
r_int
r_char
id|nak
suffix:semicolon
multiline_comment|/* Protected by FLAG_CMD */
DECL|member|cmdbuf
r_int
r_char
id|cmdbuf
...
multiline_comment|/*&n; * atkbd_sendbyte() sends a byte to the keyboard, and waits for&n; * acknowledge. It doesn&squot;t handle resends according to the keyboard&n; * protocol specs, because if these are needed, the keyboard needs&n; * replacement anyway, and they only make a mess in the protocol.&n; *&n; * atkbd_sendbyte() can only be called from a process context&n; */
...
multiline_comment|/*&n; * atkbd_command() sends a command, and its parameters to the keyboard,&n; * then waits for the response and puts it in the param array.&n; *&n; * atkbd_command() can only be called from a process context&n; */
...
multiline_comment|/*&n; * atkbd_execute_scheduled_command() sends a command, previously scheduled by&n; * atkbd_schedule_command(), to the keyboard.&n; */
DECL|function|atkbd_execute_scheduled_command
r_static
r_void
id|atkbd_execute_scheduled_command
c_func
(paren
r_void
op_star
...
multiline_comment|/*&n; * atkbd_schedule_command() allows to schedule delayed execution of a keyboard&n; * command and can be used to issue a command from an interrupt or softirq&n; * context.&n; */
DECL|function|atkbd_schedule_command
r_static
r_int
id|atkbd_schedule_command
c_func
(paren
r_struct
id|atkbd

...
DECL|macro|ATKBD_RET_EMULX
mdefine_line|#define ATKBD_RET_EMULX&t;&t;0x80
...
multiline_comment|/*&n;&t; * Here we probably should check if the keyboard has the same set that&n;         * it had before and bail out if it&squot;s different. But this will most likely&n;         * cause new keyboard device be created... and for the user it will look&n;         * like keyboard is lost&n;&t; */
r_if
c_cond
(paren
id|atkbd-&gt;translated
...
DECL|function|atkbd_setup_softrepeat
r_static
r_int
id|__init
id|atkbd_setup_softrepeat
c_func
(paren
r_char
op_star

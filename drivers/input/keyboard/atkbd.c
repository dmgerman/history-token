...
DECL|macro|ATKBD_FLAG_ID
mdefine_line|#define ATKBD_FLAG_ID&t;&t;3&t;/* First byte is not keyboard ID */
DECL|macro|ATKBD_FLAG_ENABLED
mdefine_line|#define ATKBD_FLAG_ENABLED&t;4&t;/* Waining for init to finish */

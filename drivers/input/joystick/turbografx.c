...
id|map
comma
l_string|&quot;Describes first set of devices (&lt;parport#&gt;,&lt;js1&gt;,&lt;js2&gt;,..&lt;js7&gt;&quot;
)paren
suffix:semicolon
DECL|variable|__initdata
r_static
...
id|map2
comma
l_string|&quot;Describes second set of devices&quot;
)paren
suffix:semicolon
DECL|variable|__initdata
r_static
...
(paren
id|KERN_ERR
l_string|&quot;turbografx.c: at least one joystick must be specified&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL

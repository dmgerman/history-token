...
mdefine_line|#define DRIVER_DESC&t;&quot;Logitech ADI joystick family driver&quot;
id|MODULE_AUTHOR
c_func
(paren
...
multiline_comment|/*&n; * adi_poll() repeatedly polls the Logitech joysticks.&n; */
DECL|function|adi_poll
r_static
r_void
id|adi_poll
c_func
...
id|adi-&gt;phys
suffix:semicolon
id|adi-&gt;dev.id.bustype
op_assign
id|BUS_GAMEPORT
suffix:semicolon
id|adi-&gt;dev.id.vendor
op_assign
id|GAMEPORT_ID_VENDOR_LOGITECH
suffix:semicolon
id|adi-&gt;dev.id.product
op_assign
id|adi-&gt;id
suffix:semicolon
id|adi-&gt;dev.id.version
op_assign
l_int|0x0100
suffix:semicolon
id|adi-&gt;dev

...
mdefine_line|#define DRIVER_DESC&t;&quot;Magellan and SpaceMouse 6dof controller driver&quot;
id|MODULE_AUTHOR
c_func
(paren
...
id|magellan-&gt;phys
suffix:semicolon
id|magellan-&gt;dev.id.bustype
op_assign
id|BUS_RS232
suffix:semicolon
id|magellan-&gt;dev.id.vendor
op_assign
id|SERIO_MAGELLAN
suffix:semicolon
id|magellan-&gt;dev.id.product
op_assign
l_int|0x0001
suffix:semicolon
id|magellan-&gt;dev.id.version
op_assign
l_int|0x0100
suffix:semicolon
id|magellan-&gt;dev.dev
...
DECL|variable|magellan_serio_ids
r_static
r_struct
id|serio_device_id
id|magellan_serio_ids
(braket
)braket
op_assign
(brace

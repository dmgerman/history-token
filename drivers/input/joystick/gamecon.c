multiline_comment|/*&n; * NES, SNES, N64, MultiSystem, PSX gamepad driver for Linux&n; *&n; *  Copyright (c) 1999-2004 &t;Vojtech Pavlik &lt;vojtech@suse.cz&gt;&n; *  Copyright (c) 2004 &t;&t;Peter Nelson &lt;rufus-kernel@hackish.org&gt;&n; *&n; *  Based on the work of:&n; *  &t;Andree Borrmann&t;&t;John Dahlstrom&n; *  &t;David Kuder&t;&t;Nathan Hand&n; */
...
id|map
comma
l_string|&quot;Describers first set of devices (&lt;parport#&gt;,&lt;pad1&gt;,&lt;pad2&gt;,..&lt;pad5&gt;)&quot;
)paren
suffix:semicolon
DECL|variable|__initdata
r_static
...
id|map2
comma
l_string|&quot;Describers second set of devices&quot;
)paren
suffix:semicolon
DECL|variable|__initdata
r_static
...
DECL|macro|GC_DDR
mdefine_line|#define GC_DDR&t;&t;8
DECL|macro|GC_MAX
mdefine_line|#define GC_MAX&t;&t;8
...
mdefine_line|#define GC_PSX_NEGCON&t;2&t;&t;/* NegCon */
DECL|macro|GC_PSX_NORMAL
mdefine_line|#define GC_PSX_NORMAL&t;4&t;&t;/* Digital / Analog or Rumble in Digital mode  */
DECL|macro|GC_PSX_ANALOG
mdefine_line|#define GC_PSX_ANALOG&t;5&t;&t;/* Analog in Analog mode / Rumble in Green mode */
DECL|macro|GC_PSX_RUMBLE
mdefine_line|#define GC_PSX_RUMBLE&t;7&t;&t;/* Rumble in Red mode */
DECL|macro|GC_PSX_CLOCK
mdefine_line|#define GC_PSX_CLOCK&t;0x04&t;&t;/* Pin 4 */
DECL|macro|GC_PSX_COMMAND
mdefine_line|#define GC_PSX_COMMAND&t;0x01&t;&t;/* Pin 2 */
DECL|macro|GC_PSX_POWER
mdefine_line|#define GC_PSX_POWER&t;0xf8&t;&t;/* Pins 5-9 */
DECL|macro|GC_PSX_SELECT
mdefine_line|#define GC_PSX_SELECT&t;0x02&t;&t;/* Pin 3 */
...
suffix:semicolon
multiline_comment|/* Deselect, begin command */
id|udelay
c_func
(paren
id|gc_psx_delay
...
suffix:semicolon
multiline_comment|/* Get device ids */
id|gc_psx_command
c_func
(paren
id|gc
...
multiline_comment|/* Find the longest pad */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Read in all the data */
id|gc_psx_command
c_func
(paren
id|gc
...
(brace
multiline_comment|/* Set id&squot;s to the real value */
id|id
(braket
id|i
)braket
...
suffix:semicolon
multiline_comment|/* for some reason if the extra axes are left unset they drift */
multiline_comment|/* for (j = 0; j &lt; 4; j++)&n;&t;&t;&t;&t;&t;&t;&t;input_report_abs(dev + i, gc_psx_abs[j+2], 128);&n;&t;&t;&t;&t;&t;&t; * This needs to be debugged properly,&n;&t;&t;&t;&t;&t;&t; * maybe fuzz processing needs to be done in input_sync()&n;&t;&t;&t;&t;&t;&t; *&t;&t;&t;&t; --vojtech&n;&t;&t;&t;&t;&t;&t; */
)brace
r_for
c_loop
(paren
...
l_int|0
suffix:colon
multiline_comment|/* not a pad, ignore */
r_break
suffix:semicolon
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;gamecon.c: at least one device must be specified&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL

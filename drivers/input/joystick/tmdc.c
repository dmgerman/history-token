...
mdefine_line|#define DRIVER_DESC&t;&quot;ThrustMaster DirectConnect joystick driver&quot;
id|MODULE_AUTHOR
c_func
(paren
...
multiline_comment|/*&n; * tmdc_poll() reads and analyzes ThrustMaster joystick data.&n; */
DECL|function|tmdc_poll
r_static
r_void
id|tmdc_poll
c_func

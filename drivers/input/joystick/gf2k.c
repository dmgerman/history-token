...
multiline_comment|/*&n; * gf2k_poll() reads and analyzes Genius joystick data.&n; */
DECL|function|gf2k_poll
r_static
r_void
id|gf2k_poll
c_func
...
id|gf2k-&gt;phys
suffix:semicolon
id|gf2k-&gt;dev.id.bustype
op_assign
id|BUS_GAMEPORT
suffix:semicolon
id|gf2k-&gt;dev.id.vendor
op_assign
id|GAMEPORT_ID_VENDOR_GENIUS
suffix:semicolon
id|gf2k-&gt;dev.id.product
op_assign
id|gf2k-&gt;id
suffix:semicolon
id|gf2k-&gt;dev.id.version
op_assign
l_int|0x0100
suffix:semicolon
r_for

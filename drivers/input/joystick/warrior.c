...
mdefine_line|#define DRIVER_DESC&t;&quot;Logitech WingMan Warrior joystick driver&quot;
id|MODULE_AUTHOR
c_func
(paren
...
DECL|variable|warrior_serio_ids
r_static
r_struct
id|serio_device_id
id|warrior_serio_ids
(braket
)braket
op_assign
(brace

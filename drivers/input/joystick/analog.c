...
mdefine_line|#define DRIVER_DESC&t;&quot;Analog joystick and gamepad driver&quot;
id|MODULE_AUTHOR
c_func
(paren
...
DECL|macro|DELTA
mdefine_line|#define DELTA(x,y)&t;(cpu_has_tsc ? ((y) - (x)) : ((x) - (y) + ((x) &lt; (y) ? CLOCK_TICK_RATE / HZ : 0)))
...
multiline_comment|/*&n; * analog_poll() repeatedly polls the Analog joysticks.&n; */
DECL|function|analog_poll
r_static
r_void
id|analog_poll
c_func
...
id|analog-&gt;phys
suffix:semicolon
id|analog-&gt;dev.id.bustype
op_assign
id|BUS_GAMEPORT
suffix:semicolon
id|analog-&gt;dev.id.vendor
op_assign
id|GAMEPORT_ID_VENDOR_ANALOG
suffix:semicolon
id|analog-&gt;dev.id.product
op_assign
id|analog-&gt;mask
op_rshift
l_int|4
suffix:semicolon
id|analog-&gt;dev.id.version
op_assign
l_int|0x0100
suffix:semicolon
id|analog-&gt;dev.open

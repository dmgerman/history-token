...
suffix:semicolon
DECL|macro|I8042_KBD_PORT_NO
mdefine_line|#define I8042_KBD_PORT_NO&t;0
DECL|macro|I8042_AUX_PORT_NO
mdefine_line|#define I8042_AUX_PORT_NO&t;1
DECL|macro|I8042_MUX_PORT_NO
mdefine_line|#define I8042_MUX_PORT_NO&t;2
DECL|macro|I8042_NUM_PORTS
mdefine_line|#define I8042_NUM_PORTS&t;&t;(I8042_NUM_MUX_PORTS + 2)
DECL|variable|i8042_ports
r_static
r_struct
id|i8042_port
id|i8042_ports
...
suffix:semicolon
multiline_comment|/*&n; * We still want to continue and free IRQ so if more data keeps coming in&n; * kernel will just ignore the irq.&n; */
)brace
id|free_irq
c_func
(paren
...
multiline_comment|/*&n; * i8042_start() is called by serio core when port is about to finish&n; * registering. It will mark port as existing so i8042_interrupt can&n; * start sending data through it.&n; */
DECL|function|i8042_start
r_static
r_int
id|i8042_start
c_func
...
multiline_comment|/*&n; * i8042_stop() marks serio port as non-existing so i8042_interrupt&n; * will not try to send data to the port that is about to go away.&n; * The function is called by serio core as part of unregister procedure.&n; */
DECL|function|i8042_stop
r_static
r_void
id|i8042_stop
c_func
...
ques
c_cond
id|I8042_AUX_PORT_NO
suffix:colon
id|I8042_KBD_PORT_NO
suffix:semicolon
)brace
id|port
op_assign
...
suffix:semicolon
DECL|function|i8042_create_kbd_port
r_static
r_void
id|__init
id|i8042_create_kbd_port
c_func
(paren
r_void
)paren
...
DECL|function|i8042_create_aux_port
r_static
r_void
id|__init
id|i8042_create_aux_port
c_func
(paren
r_void
)paren
...
DECL|function|i8042_create_mux_port
r_static
r_void
id|__init
id|i8042_create_mux_port
c_func
(paren
r_int
id|index

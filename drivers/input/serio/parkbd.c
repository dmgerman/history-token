...
multiline_comment|/*&n; * To connect an AT or XT keyboard to the parallel port, a fairly simple adapter&n; * can to be made:&n; * &n; *  Parallel port            Keyboard port&n; *&n; *     +5V --------------------- +5V&n; *  &n; *                 ______&n; *     +5V -------|______|--.&n; *                          |&n; *     ACK -----------------|&n; *                          |--- KBD CLOCK&n; *     STROBE -------|&lt;|----&squot;&n; *     &n; *                 ______&n; *     +5V -------|______|--.&n; *                          |&n; *     BUSY ----------------|&n; *                          |--- KBD DATA&n; *     AUTOFD -------|&lt;|----&squot;&n; *&n; *     GND --------------------- GND&n; *     &n; * The diodes can be fairly any type, and the resistors should be somewhere&n; * around 5 kOhm, but the adapter will likely work without the resistors,&n; * too.&n; *&n; * The +5V source can be taken either from USB, from mouse or keyboard ports,&n; * or from a joystick port. Unfortunately, the parallel port of a PC doesn&squot;t&n; * have a +5V pin, and feeding the keyboard from signal pins is out of question&n; * with 300 mA power reqirement of a typical AT keyboard.&n; */
...
id|port
comma
l_string|&quot;Parallel port the adapter is connected to (default is 0)&quot;
)paren
suffix:semicolon
...
id|mode
comma
l_string|&quot;Mode of operation: XT = 0/AT = 1 (default)&quot;
)paren
suffix:semicolon
...
DECL|function|parkbd_allocate_serio
r_static
r_struct
id|serio
op_star
id|__init
id|parkbd_allocate_serio
c_func
(paren
r_void
)paren

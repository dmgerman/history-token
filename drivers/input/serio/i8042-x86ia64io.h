...
(paren
id|KERN_WARNING
l_string|&quot;PNP: [%s] has invalid data port %#lx; default is %#x&bslash;n&quot;
comma
id|pnp_dev_name
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;PNP: [%s] has no data port; default is 0x%x&bslash;n&quot;
comma
id|pnp_dev_name
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;PNP: [%s] has invalid command port %#lx; default is %#x&bslash;n&quot;
comma
id|pnp_dev_name
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;PNP: [%s] has no command port; default is 0x%x&bslash;n&quot;
comma
id|pnp_dev_name
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;PNP: [%s] has no IRQ; default is %d&bslash;n&quot;
comma
id|pnp_dev_name
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;PNP: %s [%s,%s] at %#x,%#x irq %d&bslash;n&quot;
comma
...
l_int|1
suffix:semicolon
multiline_comment|/*&n; * Only fail if we&squot;re rather sure there is&n; * no AUX/KBD controller.&n; */

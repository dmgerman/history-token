...
suffix:semicolon
DECL|variable|__serio_register_driver
id|EXPORT_SYMBOL
c_func
(paren
...
id|SERIO_UNREGISTER_PORT
comma
DECL|enumerator|SERIO_REGISTER_DRIVER
...
DECL|function|__serio_register_driver
r_void
id|__serio_register_driver
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Driver re-probing can take a while, so better let kseriod&n;&t;&t; * deal with it.&n;&t;&t; */
id|serio_rescan
c_func
(paren
id|serio

multiline_comment|/*&n; * $Id: mousedev.c,v 1.24 2000/11/15 10:57:45 vojtech Exp $&n; *&n; *  Copyright (c) 1999-2000 Vojtech Pavlik&n; *&n; *  Input driver to ImExPS/2 device driver module.&n; *&n; *  Sponsored by SuSE&n; */
...
suffix:semicolon
singleline_comment|//&t;printk(KERN_INFO &quot;mouse%d: PS/2 mouse device for input%d&bslash;n&quot;, minor, dev-&gt;number);
r_return
op_amp
id|mousedev-&gt;handle
suffix:semicolon

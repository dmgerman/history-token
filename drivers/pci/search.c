...
multiline_comment|/**&n; * pci_present - determine if there are any pci devices on this system&n; *&n; * Returns 0 if no pci devices are present, 1 if pci devices are present.&n; */

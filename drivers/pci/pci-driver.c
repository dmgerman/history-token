...
DECL|macro|pci_device_probe_dynamic
mdefine_line|#define pci_device_probe_dynamic(drv,pci_dev) (-ENODEV)
DECL|macro|dynid_init
mdefine_line|#define dynid_init(dynid) do {} while (0)
DECL|macro|pci_init_dynids
mdefine_line|#define pci_init_dynids(dynids) do {} while (0)
DECL|macro|pci_free_dynids
mdefine_line|#define pci_free_dynids(drv) do {} while (0)
DECL|macro|pci_create_newid_file
mdefine_line|#define pci_create_newid_file(drv) (0)
DECL|macro|pci_bus_match_dynids
mdefine_line|#define pci_bus_match_dynids(pci_dev, pci_drv) (0)
macro_line|#endif

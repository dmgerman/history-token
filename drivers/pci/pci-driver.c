...
multiline_comment|/*&n; * If __pci_device_probe() returns 0, it matched at least one previously&n; * unclaimed device.  If it returns -ENODEV, it didn&squot;t match.  Both are&n; * alright in this case, just keep searching for new devices.&n; */
r_static
r_int

...
multiline_comment|/*&n; * shpchp_destroy_resource_list&n; *&n; * Puts node back in the resource list pointed to by head&n; */
...
multiline_comment|/*&n; * shpchp_destroy_board_resources&n; *&n; * Puts node back in the resource list pointed to by head&n; */

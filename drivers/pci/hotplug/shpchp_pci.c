...
macro_line|#endif
DECL|function|shpchp_configure_device
r_int
...
c_func
(paren
l_string|&quot;%s: subordiante %p number %x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ctrl-&gt;pci_dev-&gt;subordinate
...
DECL|function|shpchp_unconfigure_device
r_int
...
multiline_comment|/*&n; * shpchp_set_irq&n; *&n; * @bus_num: bus number of PCI device&n; * @dev_num: device number of PCI device&n; * @slot: pointer to u8 where slot number will be returned&n; */
DECL|function|shpchp_set_irq
r_int
id|shpchp_set_irq
(paren
id|u8
...
multiline_comment|/*&n; * shpchp_save_config&n; *&n; * Reads configuration for all slots in a PCI bus and saves info.&n; *&n; * Note:  For non-hot plug busses, the slot # saved is the device #&n; *&n; * returns 0 if success&n; */
DECL|function|shpchp_save_config
r_int
...
multiline_comment|/*&n; * shpchp_save_slot_config&n; *&n; * Saves configuration info for all PCI devices in a given slot&n; * including subordinate busses.&n; *&n; * returns 0 if success&n; */
DECL|function|shpchp_save_slot_config
r_int
...
multiline_comment|/*&n; * shpchp_return_board_resources&n; *&n; * this routine returns all resources allocated to a board to&n; * the available pool.&n; *&n; * returns 0 if success&n; */
DECL|function|shpchp_return_board_resources
r_int
...
multiline_comment|/**&n; * shpchp_destroy_resource_list: put node back in the resource list&n; * @resources: list to put nodes back&n; */
DECL|function|shpchp_destroy_resource_list
r_void
...
multiline_comment|/**&n; * shpchp_destroy_board_resources: put node back in the resource list&n; * @resources: list to put nodes back&n; */
DECL|function|shpchp_destroy_board_resources
r_void

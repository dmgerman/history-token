...
l_int|0x04
comma
DECL|enumerator|PCI_SPEED_66MHz_PCIX_ECC
id|PCI_SPEED_66MHz_PCIX_ECC
op_assign
l_int|0x05
comma
DECL|enumerator|PCI_SPEED_100MHz_PCIX_ECC
id|PCI_SPEED_100MHz_PCIX_ECC
op_assign
l_int|0x06
comma
DECL|enumerator|PCI_SPEED_133MHz_PCIX_ECC
...
suffix:semicolon
multiline_comment|/* These values come from the PCI Express Spec */
DECL|enum|pcie_link_width
r_enum
id|pcie_link_width
(brace
DECL|enumerator|PCIE_LNK_WIDTH_RESRV
id|PCIE_LNK_WIDTH_RESRV
op_assign
l_int|0x00
comma
DECL|enumerator|PCIE_LNK_X1
id|PCIE_LNK_X1
op_assign
l_int|0x01
comma
DECL|enumerator|PCIE_LNK_X2
id|PCIE_LNK_X2
op_assign
l_int|0x02
comma
DECL|enumerator|PCIE_LNK_X4
id|PCIE_LNK_X4
op_assign
l_int|0x04
comma
DECL|enumerator|PCIE_LNK_X8
id|PCIE_LNK_X8
op_assign
l_int|0x08
comma
DECL|enumerator|PCIE_LNK_X12
id|PCIE_LNK_X12
op_assign
l_int|0x0C
comma
DECL|enumerator|PCIE_LNK_X16
id|PCIE_LNK_X16
op_assign
l_int|0x10
comma
DECL|enumerator|PCIE_LNK_X32
id|PCIE_LNK_X32
op_assign
l_int|0x20
comma
DECL|enumerator|PCIE_LNK_WIDTH_UNKNOWN
...
suffix:semicolon
DECL|enum|pcie_link_speed
r_enum
id|pcie_link_speed
(brace
DECL|enumerator|PCIE_2PT5GB
id|PCIE_2PT5GB
op_assign
l_int|0x14
comma
DECL|enumerator|PCIE_LNK_SPEED_UNKNOWN
...
suffix:semicolon
multiline_comment|/**&n; * struct hotplug_slot_info - used to notify the hotplug pci core of the state of the slot&n; * @power: if power is enabled or not (1/0)&n; * @attention_status: if the attention light is enabled or not (1/0)&n; * @latch_status: if the latch (if any) is open or closed (1/0)&n; * @adapter_present: if there is a pci board present in the slot or not (1/0)&n; * @address: (domain &lt;&lt; 16 | bus &lt;&lt; 8 | dev)&n; *&n; * Used to notify the hotplug pci core of the status of a specific slot.&n; */

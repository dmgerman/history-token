...
macro_line|#if link_available
multiline_comment|/*&n; *  Links available memory, IO, and IRQ resources for programming&n; *  devices which may be added to the system&n; *&n; *  Returns 0 if success&n; */
r_static
r_int
DECL|function|link_available_resources
id|link_available_resources
(paren
r_struct
id|controller
op_star

...
suffix:semicolon
DECL|function|address_read_file
r_static
id|ssize_t
id|address_read_file
(paren
r_struct
id|hotplug_slot
op_star
...
DECL|variable|hotplug_slot_attr_address
r_static
r_struct
id|hotplug_slot_attribute
id|hotplug_slot_attr_address
op_assign
(brace
dot
id|attr
...
DECL|function|has_address_file
r_static
r_int
id|has_address_file
(paren
...
comma
op_amp
id|hotplug_slot_attr_address.attr
)paren
suffix:semicolon
r_if
c_cond

...
id|err
(paren
l_string|&quot;acpi_shpchprm: alloc for aps fail&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;acpi_shpchprm:   Slot sun(%x) at s:b:d:f=0x%02x:%02x:%02x:%02x&bslash;n&quot;
comma
id|aps-&gt;sun
comma
id|ab-&gt;seg
...
id|err
(paren
l_string|&quot;acpi_shpchprm:%s alloc for _HPP fail&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s _HPP fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
id|err
(paren
l_string|&quot;acpi_shpchprm:%s _HPP obj not a package&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
id|err
(paren
l_string|&quot;acpi_shpchprm:%s _HPP obj type incorrect&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
id|err
(paren
l_string|&quot;acpi_shpchprm:%s alloc for _HPP failed&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s _CRS not found&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
id|err
(paren
l_string|&quot;acpi_shpchprm:%s _CRS fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
id|err
(paren
l_string|&quot;acpi_shpchprm: alloc %ld bytes for %s _CRS fail&bslash;n&quot;
comma
(paren
id|ulong
)paren
...
DECL|function|shpchprm_delete_resource
r_static
r_int
id|shpchprm_delete_resource
c_func
(paren
r_struct
id|pci_resource
...
DECL|function|shpchprm_delete_resources
r_static
r_int
id|shpchprm_delete_resources
c_func
(paren
r_struct
id|pci_resource
...
DECL|function|shpchprm_add_resource
r_static
r_int
id|shpchprm_add_resource
c_func
(paren
r_struct
id|pci_resource
...
id|err
(paren
l_string|&quot;acpi_shpchprm: alloc for res fail&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
DECL|function|shpchprm_add_resources
r_static
r_int
id|shpchprm_add_resources
c_func
(paren
r_struct
id|pci_resource
...
c_func
(paren
l_string|&quot;acpi_shpchprm:16-Bit Address Space Resource&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|dbg
c_func
(paren
l_string|&quot;acpi_shpchprm:32-Bit Address Space Resource&bslash;n&quot;
)paren
suffix:semicolon
r_switch
c_cond
...
c_func
(paren
l_string|&quot;acpi_shpchprm: PCI bus 0x%x Resource structure %x.&bslash;n&quot;
comma
id|ab-&gt;bus
comma
id|count
...
DECL|function|shpchprm_acpi_register_a_bridge
r_static
r_void
id|shpchprm_acpi_register_a_bridge
(paren
r_struct
id|acpi_bridge
op_star
...
DECL|function|shpchprm_acpi_build_php_slots_callback
r_static
id|acpi_status
id|shpchprm_acpi_build_php_slots_callback
c_func
(paren
id|acpi_handle
id|handle
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s _SUN fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s _ADR fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s sun=0x%08x adr=0x%08x&bslash;n&quot;
comma
id|path_name
comma
(paren
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s get_parent fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm: alloc new P2P bridge(%x) for sun(%08x)&bslash;n&quot;
comma
(paren
id|u32
)paren
...
c_func
(paren
l_string|&quot;acpi_shpchprm: alloc for ab fail&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|AE_NO_MEMORY
...
c_func
(paren
l_string|&quot;acpi_shpchprm: found P2P bridge(%x) for sun(%08x)&bslash;n&quot;
comma
(paren
id|u32
)paren
...
DECL|function|shpchprm_acpi_build_php_slots
r_static
r_int
id|shpchprm_acpi_build_php_slots
c_func
(paren
r_struct
id|acpi_bridge
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s walk for _SUN on pci bridge seg:bus(%x:%x) fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|ab-&gt;seg
...
c_func
(paren
l_string|&quot;acpi_shpchprm: Registered PCI HOST Bridge(%02x)    on s:b:d:f(%02x:%02x:%02x:%02x) [%s]&bslash;n&quot;
comma
id|ab-&gt;bus
comma
id|ab-&gt;seg
...
c_func
(paren
l_string|&quot;acpi_shpchprm: Registered PCI  P2P Bridge(%02x-%02x) on s:b:d:f(%02x:%02x:%02x:%02x) [%s]&bslash;n&quot;
comma
id|ab-&gt;pbus
comma
id|ab-&gt;bus
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s is not a P2P Bridge&bslash;n&quot;
comma
id|path_name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;acpi_shpchprm: P2P(%x-%x) on pci=b:d:f(%x:%x:%x) acpi=b:d:f(%x:%x:%x) [%s]&bslash;n&quot;
comma
id|pab-&gt;bus
comma
id|ab-&gt;bus
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s find_p2p fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm: ROOT PCI seg(0x%x)bus(0x%x)dev(0x%x)func(0x%x) [%s]&bslash;n&quot;
comma
(paren
id|u32
)paren
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s evaluate _CRS fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s evaluate _SEG fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
c_func
(paren
l_string|&quot;acpi_shpchprm:%s evaluate _BBN fail=0x%x&bslash;n&quot;
comma
id|path_name
comma
id|status
...
DECL|function|shpchprm_acpi_scan_pci
r_static
r_int
id|shpchprm_acpi_scan_pci
(paren
r_void
)paren
(brace
...
c_func
(paren
l_string|&quot;acpi_shpchprm:get_device PCI ROOT HID fail=0x%x&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;shpchprm ACPI init &lt;enter&gt;&bslash;n&quot;
)paren
suffix:semicolon
id|acpi_bridges_head
op_assign
...
c_func
(paren
l_string|&quot;shpchprm ACPI init %s&bslash;n&quot;
comma
(paren
id|rc
)paren
...
DECL|function|shpchprm_free_bridges
r_static
r_void
id|shpchprm_free_bridges
(paren
r_struct
id|acpi_bridge
op_star
...
DECL|function|shpchprm_dump_ctrl_res
r_static
r_void
id|shpchprm_dump_ctrl_res
c_func
(paren
r_struct
id|controller
...
DECL|function|shpchprm_get_used_resources
r_static
r_int
id|shpchprm_get_used_resources
(paren
r_struct
id|controller
op_star

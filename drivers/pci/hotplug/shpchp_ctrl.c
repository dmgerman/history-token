...
multiline_comment|/* Do nothing if adapter_speed &gt;= bus_speed */
)brace
)brace
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* max_bus_speed != bus_speed. Note: max_bus_speed should be &gt; than bus_speed */
r_if
c_cond
(paren
id|adapter_speed

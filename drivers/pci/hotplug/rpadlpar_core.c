...
DECL|function|get_node_drc_name
r_static
r_char
op_star
id|get_node_drc_name
c_func
(paren
r_struct
id|device_node
...
DECL|function|find_php_slot_node
r_static
r_struct
id|device_node
op_star
id|find_php_slot_node
c_func
(paren
r_char
op_star
...
(paren
op_amp
id|pci_hotplug_slots_subsys.kset
comma
id|drc_name
)paren
suffix:semicolon
...
multiline_comment|/* Add hotplug slot for new bus */
r_if
c_cond
(paren
id|rpaphp_add_slot

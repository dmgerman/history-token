...
mdefine_line|#define DRIVER_DESC&t;&quot;PCI Express Hot Plug Controller Driver&quot;
...
suffix:semicolon
DECL|macro|PCIE_MODULE_NAME
mdefine_line|#define PCIE_MODULE_NAME &quot;pciehp&quot;
r_static
r_int
...
suffix:semicolon
DECL|variable|pciehp_hotplug_slot_ops
r_static
r_struct
id|hotplug_slot_ops
id|pciehp_hotplug_slot_ops
op_assign
(brace
dot
id|owner
...
id|num_ctlr_slots
suffix:semicolon
multiline_comment|/* Not needed; PCI Express has 1 slot per port*/
r_int
id|first_device_num
suffix:semicolon
...
id|num_ctlr_slots
suffix:semicolon
multiline_comment|/* PCI Express has 1 slot per port */
id|ctrl-&gt;slot_device_offset
op_assign
id|first_device_num
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* first PCI device number supported by this PCIE */
r_int
id|num_ctlr_slots
suffix:semicolon
multiline_comment|/* number of slots supported by this HPC */
id|u8
id|value
suffix:semicolon
r_struct
...
c_func
(paren
l_string|&quot;%s: Called by hp_drv&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: DRV_thread pid = %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|current-&gt;pid
...
c_func
(paren
l_string|&quot;%s: ctrl-&gt;pci_bus %p&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ctrl-&gt;pci_bus
...
id|pdev-&gt;bus-&gt;number
suffix:semicolon
multiline_comment|/* ctrl bus */
id|ctrl-&gt;slot_bus
op_assign
id|pdev-&gt;subordinate-&gt;number
suffix:semicolon
multiline_comment|/* bus controlled by this HPC */
id|ctrl-&gt;device
op_assign
id|PCI_SLOT
c_func
...
c_func
(paren
l_string|&quot;%s: ctrl bus=0x%x, device=%x, function=%x, irq=%x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ctrl-&gt;bus
...
c_func
(paren
l_string|&quot;%s: Before calling pciehp_save_config, ctrl-&gt;bus %x,ctrl-&gt;slot_bus %x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|ctrl-&gt;bus
...
c_func
(paren
l_string|&quot;pciehprm_find_available_resources = %#x&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&t;Finish setting up the hot plug ctrl device */
id|ctrl-&gt;next_event
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Check if slot is occupied */
id|dbg
c_func
(paren
l_string|&quot;%s: adpater value %x&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|value
...
c_func
(paren
l_string|&quot;pciehp_event_start_thread() failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|retval
...
DECL|variable|hpdriver_context
r_int
id|hpdriver_context
op_assign
l_int|0
suffix:semicolon
DECL|function|pciehp_remove
r_static
r_void
id|pciehp_remove
(paren
...
c_func
(paren
l_string|&quot;%s -&gt; Call free_irq for irq = %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|device-&gt;irq
...
l_string|&quot;hpdriver&quot;
suffix:semicolon
DECL|variable|hpdriver_portdrv
r_static
r_struct
...
l_int|0
suffix:semicolon
macro_line|#ifdef CONFIG_HOTPLUG_PCI_PCIE_POLL_EVENT_MODE
id|pciehp_poll_mode
op_assign
l_int|1
suffix:semicolon
...
c_func
(paren
l_string|&quot;pcie_port_service_register = %d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: Failure to register service&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;unload_pciehpd()&bslash;n&quot;
)paren
suffix:semicolon
id|unload_pciehpd
c_func
...
c_func
(paren
l_string|&quot;pcie_port_service_unregister&bslash;n&quot;
)paren
suffix:semicolon

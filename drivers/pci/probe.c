...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Link the device to both the global PCI device chain and&n;&t;&t; * the per-bus list of devices and add the /proc entry.&n;&t;&t; * Note: this also runs the hotplug notifiers (bad!) --rmk&n;&t;&t; */
id|device_register
c_func
(paren
op_amp

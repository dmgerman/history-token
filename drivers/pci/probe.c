...
multiline_comment|/**&n; * pci_create_legacy_files - create legacy I/O port and memory files&n; * @b: bus to create files under&n; *&n; * Some platforms allow access to legacy I/O port and ISA memory space on&n; * a per-bus basis.  This routine creates the files and ties them into&n; * their associated read, write and mmap files from pci-sysfs.c&n; */
DECL|function|pci_create_legacy_files
r_static
r_void
id|pci_create_legacy_files
c_func
(paren
r_struct
id|pci_bus
...
l_int|0xffff
suffix:semicolon
id|b-&gt;legacy_io-&gt;attr.mode
op_assign
id|S_IRUSR
op_or
id|S_IWUSR
suffix:semicolon
id|b-&gt;legacy_io-&gt;attr.owner
op_assign
id|THIS_MODULE
suffix:semicolon
id|b-&gt;legacy_io-&gt;read
...
suffix:semicolon
multiline_comment|/* Allocated above after the legacy_io struct */
id|b-&gt;legacy_mem
op_assign
id|b-&gt;legacy_io
op_plus
l_int|1
suffix:semicolon
id|b-&gt;legacy_mem-&gt;attr.name
op_assign
l_string|&quot;legacy_mem&quot;
suffix:semicolon
id|b-&gt;legacy_mem-&gt;size
op_assign
l_int|1024
op_star
l_int|1024
suffix:semicolon
id|b-&gt;legacy_mem-&gt;attr.mode
op_assign
id|S_IRUSR
op_or
id|S_IWUSR
suffix:semicolon
id|b-&gt;legacy_mem-&gt;attr.owner
op_assign
id|THIS_MODULE
suffix:semicolon
id|b-&gt;legacy_mem-&gt;mmap
op_assign
...
DECL|function|pci_remove_legacy_files
r_static
r_void
...
id|cap
op_amp
id|PCI_EXP_FLAGS_TYPE
)paren
op_rshift
l_int|4
)paren
op_ne
id|PCI_EXP_TYPE_ROOT_PORT
)paren
r_return
suffix:semicolon
id|pci_read_config_word
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Configuration request Retry Status */
r_while
c_loop
(paren
id|l
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Card hasn&squot;t responded in 60 seconds?  Must be stuck. */
r_if
c_cond
(paren
id|delay
...
(paren
id|KERN_WARNING
l_string|&quot;Device %04x:%02x:%02x.%d not &quot;
l_string|&quot;responding&bslash;n&quot;
comma
id|pci_domain_nr
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Create legacy_io and legacy_mem files for this bus */
id|pci_create_legacy_files
c_func
(paren
id|b

...
id|dev-&gt;id.vendor
op_assign
id|parent-&gt;port-&gt;vendor
suffix:semicolon
id|dev-&gt;id.device
op_assign
id|parent-&gt;port-&gt;device
suffix:semicolon
id|dev-&gt;id.port_type
op_assign
id|port_type
...
(paren
id|KERN_DEBUG
l_string|&quot;Allocate Port Device[%s]&bslash;n&quot;
comma
id|device-&gt;device.bus_id
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Allocate parent */
id|parent
op_assign
id|alloc_pcie_device
c_func
...
id|dev
comma
multiline_comment|/* Root/Upstream/Downstream */
id|type
comma

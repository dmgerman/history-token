...
id|parent-&gt;sysdata
suffix:semicolon
multiline_comment|/* init generic fields */
id|child-&gt;iobus.self
op_assign
op_amp
id|dev-&gt;dev
suffix:semicolon
id|child-&gt;iobus.parent
op_assign
op_amp
id|parent-&gt;iobus
suffix:semicolon
id|dev-&gt;dev.subordinate
op_assign
op_amp
id|child-&gt;iobus
suffix:semicolon
...
id|bus-&gt;secondary
suffix:semicolon
multiline_comment|/* we should know for sure what the bus number is, so set the bus ID&n;&t; * for the bus and make sure it&squot;s registered in the device tree */
id|sprintf
c_func
(paren
id|bus-&gt;iobus.bus_id

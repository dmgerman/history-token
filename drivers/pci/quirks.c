...
DECL|variable|via_interrupt_line_quirk
r_int
...
(paren
id|KERN_INFO
l_string|&quot;PCI: Via IRQ fixup&bslash;n&quot;
)paren
suffix:semicolon
id|via_interrupt_line_quirk
op_assign
...
suffix:semicolon
multiline_comment|/*&n; *&t;Intel 82801CAM ICH3-M datasheet says IDE modes must be the same&n; */
DECL|function|quirk_ide_samemode
r_static
r_void
id|__init
id|quirk_ide_samemode
c_func
(paren
r_struct
id|pci_dev
...
(paren
id|KERN_INFO
l_string|&quot;PCI: IDE mode mismatch; forcing legacy mode&bslash;n&quot;
)paren
suffix:semicolon
id|prog
op_and_assign
...
l_int|0x0001
suffix:colon
multiline_comment|/* Toshiba Satellite A40 */
id|asus_hides_smbus
op_assign
l_int|1
suffix:semicolon
...
l_int|0xC00C
suffix:colon
multiline_comment|/* Samsung P35 notebook */
id|asus_hides_smbus
op_assign
l_int|1
suffix:semicolon
...
l_int|0xf
suffix:semicolon
multiline_comment|/*&n;&t; * These Netmos parts are multiport serial devices with optional&n;&t; * parallel ports.  Even when parallel ports are present, they&n;&t; * are identified as class SERIAL, which means the serial driver&n;&t; * will claim them.  To prevent this, mark them as class OTHER.&n;&t; * These combo devices should be claimed by parport_serial.&n;&t; *&n;&t; * The subdevice ID is of the form 0x00PS, where &lt;P&gt; is the number&n;&t; * of parallel ports and &lt;S&gt; is the number of serial ports.&n;&t; */
r_switch
c_cond
(paren
id|dev-&gt;device
...
suffix:colon
r_case
id|PCI_DEVICE_ID_NETMOS_9745
suffix:colon
r_case
id|PCI_DEVICE_ID_NETMOS_9835
suffix:colon
r_case
id|PCI_DEVICE_ID_NETMOS_9845
suffix:colon
r_case
...
(paren
id|KERN_INFO
l_string|&quot;PCI: Netmos %04x (%u parallel, &quot;
l_string|&quot;%u serial); changing class SERIAL to OTHER &quot;
l_string|&quot;(use parport_serial)&bslash;n&quot;
comma
id|dev-&gt;device
comma
id|num_parallel

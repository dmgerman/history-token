...
comma
multiline_comment|/* Intel LPC interface bridges all have 128 bytes of magic ACPI/TCO regs and 64 bytes of GPIO */
(brace
id|PCI_FIXUP_HEADER
comma
id|PCI_VENDOR_ID_INTEL
...
comma
multiline_comment|/*&n;&t; * on Asus P4B boards, the i801SMBus device is disabled at startup.&n;&t; * this also goes for boards in HP Compaq nc6000 and nc8000 notebooks.&n;&t; */
(brace
id|PCI_FIXUP_HEADER
comma
id|PCI_VENDOR_ID_INTEL

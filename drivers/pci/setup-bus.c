...
suffix:semicolon
multiline_comment|/* Add bridge resources to the resource tree. */
r_if
c_cond
(paren
id|bus-&gt;resource
...
(paren
id|KERN_ERR
l_string|&quot;PCI: failed to reserve IO for bus %d&bslash;n&quot;
comma
id|bus-&gt;number
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;PCI: failed to reserve MEM for bus %d&bslash;n&quot;
comma
id|bus-&gt;number
)paren
suffix:semicolon

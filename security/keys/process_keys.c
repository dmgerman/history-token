...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * make sure a process keyring is installed&n; */
...
multiline_comment|/* attach or swap keyrings */
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * copy the keys in a thread group for fork without CLONE_THREAD&n; */
DECL|function|copy_thread_group_keys
r_int
...
c_func
(paren
id|current-&gt;thread_group-&gt;session_keyring
)paren
suffix:semicolon
id|key_check
c_func
(paren
id|current-&gt;thread_group-&gt;process_keyring
)paren
suffix:semicolon
multiline_comment|/* no process keyring yet */
id|tsk-&gt;signal-&gt;process_keyring
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/* same session keyring */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
c_func
(paren
id|current-&gt;signal-&gt;session_keyring
)paren
suffix:semicolon
id|spin_unlock_irqrestore
c_func
...
multiline_comment|/* end copy_thread_group_keys() */
multiline_comment|/*****************************************************************************/
...
suffix:semicolon
multiline_comment|/* no thread keyring yet */
id|tsk-&gt;thread_keyring
op_assign
l_int|NULL
suffix:semicolon
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * dispose of thread group keys upon thread group destruction&n; */
DECL|function|exit_thread_group_keys
r_void
...
c_func
(paren
id|tg-&gt;session_keyring
)paren
suffix:semicolon
id|key_put
c_func
(paren
id|tg-&gt;process_keyring
)paren
suffix:semicolon
)brace
multiline_comment|/* end exit_thread_group_keys() */
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; * dispose of keys upon thread exit&n; */
...
suffix:semicolon
multiline_comment|/* discard the process keyring from a newly exec&squot;d task */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
id|ret
op_assign
id|tsk-&gt;signal-&gt;session_keyring-&gt;serial
suffix:semicolon
id|spin_unlock_irqrestore
c_func
(paren

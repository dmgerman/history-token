multiline_comment|/* Updated: Karl MacMillan &lt;kmacmillan@tresys.com&gt;&n; *&n; * &t;Added conditional policy language extensions&n; *&n; * Copyright (C) 2003 - 2004 Tresys Technology, LLC&n; * Copyright (C) 2004 Red Hat, Inc., James Morris &lt;jmorris@redhat.com&gt;&n; *&t;This program is free software; you can redistribute it and/or modify&n; *  &t;it under the terms of the GNU General Public License as published by&n; *&t;the Free Software Foundation, version 2.&n; */
...
DECL|variable|selinux_checkreqprot
r_int
r_int
id|selinux_checkreqprot
op_assign
id|CONFIG_SECURITY_SELINUX_CHECKREQPROT_VALUE
suffix:semicolon
DECL|function|checkreqprot_setup
r_static
r_int
id|__init
id|checkreqprot_setup
c_func
(paren
r_char
op_star
...
DECL|enumerator|SEL_AVC
id|SEL_AVC
comma
multiline_comment|/* AVC management directory */
DECL|enumerator|SEL_MEMBER
id|SEL_MEMBER
comma
multiline_comment|/* compute polyinstantiation membership decision */
DECL|enumerator|SEL_CHECKREQPROT
id|SEL_CHECKREQPROT
comma
multiline_comment|/* check requested protection, not kernel-applied one */
)brace
suffix:semicolon
...
suffix:semicolon
DECL|function|sel_read_checkreqprot
r_static
id|ssize_t
id|sel_read_checkreqprot
c_func
(paren
r_struct
id|file
...
DECL|function|sel_write_checkreqprot
r_static
id|ssize_t
id|sel_write_checkreqprot
c_func
(paren
r_struct
id|file
...
DECL|variable|sel_checkreqprot_ops
r_static
r_struct
id|file_operations
id|sel_checkreqprot_ops
op_assign
(brace
dot
id|read
...
DECL|function|sel_write_member
r_static
id|ssize_t
id|sel_write_member
c_func
...
l_int|NULL
suffix:semicolon
DECL|function|sel_read_avc_cache_threshold
r_static
id|ssize_t
id|sel_read_avc_cache_threshold
c_func
(paren
r_struct
id|file
...
DECL|function|sel_write_avc_cache_threshold
r_static
id|ssize_t
id|sel_write_avc_cache_threshold
c_func
(paren
r_struct
id|file
...
DECL|function|sel_read_avc_hash_stats
r_static
id|ssize_t
id|sel_read_avc_hash_stats
c_func
(paren
r_struct
id|file
...
DECL|variable|sel_avc_cache_threshold_ops
r_static
r_struct
id|file_operations
id|sel_avc_cache_threshold_ops
op_assign
(brace
dot
id|read
...
suffix:semicolon
DECL|variable|sel_avc_hash_stats_ops
r_static
r_struct
id|file_operations
id|sel_avc_hash_stats_ops
op_assign
(brace
dot
id|read
...
DECL|function|sel_avc_get_stat_idx
r_static
r_struct
id|avc_cache_stats
op_star
id|sel_avc_get_stat_idx
c_func
(paren
id|loff_t
op_star
...
DECL|function|sel_avc_stats_seq_start
r_static
r_void
op_star
id|sel_avc_stats_seq_start
c_func
(paren
r_struct
id|seq_file
...
DECL|function|sel_avc_stats_seq_next
r_static
r_void
op_star
id|sel_avc_stats_seq_next
c_func
(paren
r_struct
id|seq_file
...
DECL|function|sel_avc_stats_seq_show
r_static
r_int
id|sel_avc_stats_seq_show
c_func
(paren
r_struct
id|seq_file
...
id|seq
comma
l_string|&quot;lookups hits misses allocations reclaims &quot;
l_string|&quot;frees&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|seq_printf
...
DECL|function|sel_avc_stats_seq_stop
r_static
r_void
id|sel_avc_stats_seq_stop
c_func
(paren
r_struct
id|seq_file
...
DECL|variable|sel_avc_cache_stats_seq_ops
r_static
r_struct
id|seq_operations
id|sel_avc_cache_stats_seq_ops
op_assign
(brace
dot
id|start
...
suffix:semicolon
DECL|function|sel_open_avc_cache_stats
r_static
r_int
id|sel_open_avc_cache_stats
c_func
(paren
r_struct
id|inode
...
DECL|variable|sel_avc_cache_stats_ops
r_static
r_struct
id|file_operations
id|sel_avc_cache_stats_ops
op_assign
(brace
dot
id|open
...
suffix:semicolon
macro_line|#endif
DECL|function|sel_make_avc_files
r_static
r_int
id|sel_make_avc_files
c_func
(paren
r_struct
id|dentry

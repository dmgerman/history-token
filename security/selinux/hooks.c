...
id|sb-&gt;s_type-&gt;name
suffix:semicolon
multiline_comment|/* Ignore these fileystems with binary mount option data. */
r_if
c_cond
(paren
op_logical_neg
...
id|ad
suffix:semicolon
multiline_comment|/* Only IPv4 is supported here at this stage */
r_if
c_cond
(paren
id|sk-&gt;sk_family
...
c_func
(paren
l_string|&quot;SELinux: nf_register_hook 0 error %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon

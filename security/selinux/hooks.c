...
multiline_comment|/* Create an open file that refers to the null device.&n;   Derived from the OpenWall LSM. */
DECL|function|open_devnull
r_struct
id|file
op_star
id|open_devnull
...
id|I_DIRTY
suffix:semicolon
multiline_comment|/* so that mark_inode_dirty won&squot;t touch us */
id|isec
op_assign
id|inode-&gt;i_security
suffix:semicolon

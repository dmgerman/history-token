...
multiline_comment|/*&n; * Copied from net/core/utils.c:net_ratelimit and modified for&n; * use by the AVC audit facility.&n; */
DECL|macro|AVC_MSG_COST
mdefine_line|#define AVC_MSG_COST&t;5*HZ
DECL|macro|AVC_MSG_BURST
mdefine_line|#define AVC_MSG_BURST&t;10*5*HZ
multiline_comment|/*&n; * This enforces a rate limit: not more than one kernel message&n; * every 5secs to make a denial-of-service attack impossible.&n; */
DECL|function|avc_ratelimit
r_static
r_int
id|avc_ratelimit
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;AVC: %d messages suppressed.&bslash;n&quot;
comma
id|lost
)paren
suffix:semicolon
...
DECL|function|check_avc_ratelimit
r_static
r_inline
r_int
id|check_avc_ratelimit
c_func
(paren
r_void
)paren
...
r_else
(brace
multiline_comment|/* If permissive, then never suppress messages. */
r_return
l_int|1
suffix:semicolon
)brace

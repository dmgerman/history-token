...
DECL|macro|DOTSYM_PFX
mdefine_line|#define DOTSYM_PFX &quot;__dot_&quot;
r_struct
id|symbol
op_star
...
suffix:semicolon
multiline_comment|/* .foo matches foo.  PPC64 needs this. */
r_if
c_cond
(paren
id|name
...
l_int|0
suffix:semicolon
multiline_comment|/* Sparc32 wants .foo to match __dot_foo, try this first. */
r_for
c_loop
(paren
id|s

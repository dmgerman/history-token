...
suffix:semicolon
singleline_comment|//dep = expr_alloc_one(E_CHOICE, dep);
singleline_comment|//dep-&gt;right.sym = menu-&gt;sym;
id|prop-&gt;dep
op_assign
id|expr_alloc_one
c_func

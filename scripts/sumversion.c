...
multiline_comment|/* Strictly illegal: file is not nul terminated. */
id|p
op_assign
id|strstr
c_func
...
id|stderr
comma
l_string|&quot;Warning: could not find deps_ line in %s&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;Warning: could not find := line in %s&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;Warning: could not find end line in %s&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
id|filelist
comma
l_string|&quot;.tmp_versions/%s&quot;
comma
id|basename
)paren
suffix:semicolon
multiline_comment|/* Truncate .o, add .mod */
id|strcpy
c_func
(paren
id|filelist
...
multiline_comment|/* sum is of form &bslash;0&lt;padding&gt;. */
id|md4_final_ascii
c_func
(paren
op_amp
...
multiline_comment|/* If the modinfo contains a &quot;version&quot; value, then set this. */
DECL|function|maybe_frob_version
r_void
...
r_return
suffix:semicolon
multiline_comment|/* RCS $Revision gets stripped out. */
id|strip_rcs_crap
c_func
(paren
id|version
...
suffix:semicolon
multiline_comment|/* Check against double sumversion */
r_if
c_cond
(paren
id|strchr
...
r_return
suffix:semicolon
multiline_comment|/* Version contains embedded NUL: second half has space for checksum */
id|csum
op_assign
id|version
op_plus

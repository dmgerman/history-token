...
multiline_comment|/*&n; * Find index of a specific variable in the symbol table.&n; * Create a new entry if it does not exist yet.&n; */
...
id|stderr
comma
l_string|&quot;tkparse realloc vartable failed&bslash;n&quot;
)paren
suffix:semicolon
m_exit
(paren

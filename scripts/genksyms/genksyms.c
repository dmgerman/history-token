multiline_comment|/* Generate kernel symbol version hashes.&n;   Copyright 1996, 1997 Linux International.&n;&n;   New implementation contributed by Richard Henderson &lt;rth@tamu.edu&gt;&n;   Based on original work by Bjorn Ekwall &lt;bj0rn@blox.se&gt;&n;&n;   This file was part of the Linux modutils 2.4.22: moved back into the&n;   kernel sources by Rusty Russell/Kai Germaschewski.&n;&n;   This program is free software; you can redistribute it and/or modify it&n;   under the terms of the GNU General Public License as published by the&n;   Free Software Foundation; either version 2 of the License, or (at your&n;   option) any later version.&n;&n;   This program is distributed in the hope that it will be useful, but&n;   WITHOUT ANY WARRANTY; without even the implied warranty of&n;   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU&n;   General Public License for more details.&n;&n;   You should have received a copy of the GNU General Public License&n;   along with this program; if not, write to the Free Software Foundation,&n;   Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
...
mdefine_line|#define HASH_BUCKETS  4096
...
suffix:semicolon
multiline_comment|/* Used as a linker script. */
id|printf
c_func
(paren
l_string|&quot;__crc_%s = 0x%08lx ;&bslash;n&quot;
comma
id|name
comma
id|crc
...
c_func
(paren
l_string|&quot;genksyms version 2.5.60&bslash;n&quot;
comma
id|stderr
)paren
suffix:semicolon

...
multiline_comment|/*&n; * Add a path to the list of include paths.&n; */
...
id|stderr
comma
l_string|&quot;realpath(%s) failed, %m&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;cannot expand path_arry&bslash;n&quot;
)paren
suffix:semicolon
m_exit
(paren
...
id|stderr
comma
l_string|&quot;cannot allocate path buffer&bslash;n&quot;
)paren
suffix:semicolon
m_exit
(paren
...
macro_line|#if defined(__alpha__) || defined(__i386__) || defined(__ia64__)  || defined(__x86_64__) || defined(__MIPSEL__)&t;&bslash;&n;    || defined(__arm__)
...
suffix:semicolon
multiline_comment|/* must be last entry, for config files */
r_while
c_loop
(paren
op_decrement

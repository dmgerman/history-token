...
r_break
suffix:semicolon
multiline_comment|/* no more domains to search or no more tasks to move */
id|cpu_group
op_assign
id|sd-&gt;groups
suffix:semicolon
r_do
(brace
multiline_comment|/* sched_groups should either use list_heads or be merged into the domains structure */
r_int
id|cpu
comma
id|target_cpu
...
id|next_group
suffix:semicolon
multiline_comment|/* failed to find a suitable target cpu in this domain */
id|target_rq
op_assign
id|cpu_rq
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * This condition is &quot;impossible&quot;, if it occurs we need to fix it&n;&t;&t;&t; * Reported by Bjorn Helgaas on a 128-cpu setup.&n;&t;&t;&t; */
id|BUG_ON
c_func
(paren
id|busiest_rq

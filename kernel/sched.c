...
mdefine_line|#define PRIO_INTERACTIVE&t;(MAX_RT_PRIO + MAX_USER_PRIO/4)
DECL|macro|PRIO_CPU_HOG
mdefine_line|#define PRIO_CPU_HOG&t;&t;(MAX_RT_PRIO + MAX_USER_PRIO*3/4)
DECL|macro|TASK_INTERACTIVE
mdefine_line|#define TASK_INTERACTIVE(p) (((p)-&gt;prio &lt;= PRIO_INTERACTIVE) ||&t;&t;&bslash;&n;&t;(((p)-&gt;prio &lt; PRIO_CPU_HOG) &amp;&amp;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;((p)-&gt;prio &lt;= NICE_TO_PRIO((p)-&gt;__nice)-3)))
...
multiline_comment|/*&n; * The SMP message passing code calls this function whenever&n; * the new task has arrived at the target CPU. We move the&n; * new task into the local runqueue.&n; *&n; * This function must be called with interrupts disabled.&n; */
DECL|function|sched_task_migrated
r_void

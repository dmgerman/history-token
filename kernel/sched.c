...
(brace
multiline_comment|/*&n;&t;&t; * New thread that is not a vfork.&n;&t;&t; * Find the largest domain that this CPU is part of that&n;&t;&t; * is willing to balance on clone:&n;&t;&t; */
id|for_each_domain
c_func
(paren
id|cpu

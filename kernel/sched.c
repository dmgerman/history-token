...
macro_line|#endif
multiline_comment|/*&n; * wake_idle() is useful especially on SMT architectures to wake a&n; * task onto an idle sibling if we would otherwise wake it onto a&n; * busy sibling.&n; *&n; * Returns the CPU we should wake onto.&n; */
...
multiline_comment|/*&n; * wake_up_forked_thread - wake up a freshly forked thread.&n; *&n; * This function will do some initial scheduler statistics housekeeping&n; * that must be done for every newly created context, and it also does&n; * runqueue balancing.&n; */
...
id|rq
suffix:semicolon
multiline_comment|/*&n;&t; * Find the largest domain that this CPU is part of that&n;&t; * is willing to balance on clone:&n;&t; */
id|for_each_domain
c_func
(paren
id|this_cpu
...
suffix:semicolon
multiline_comment|/*&n;&t; * We did find_idlest_cpu() unlocked, so in theory&n;&t; * the mask could have changed - just dont migrate&n;&t; * in this case:&n;&t; */
r_if
c_cond
(paren
id|unlikely
...
multiline_comment|/*&n; * sched_balance_exec(): find the highest-level, exec-balance-capable&n; * domain and try to migrate the task to the least loaded CPU.&n; *&n; * execve() is a valuable balancing opportunity, because at this point&n; * the task has the smallest effective memory and cache footprint.&n; */
...
suffix:semicolon
multiline_comment|/* domains were modified outside the lock */
id|for_each_cpu
c_func
(paren
id|i

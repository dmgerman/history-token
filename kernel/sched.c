...
mdefine_line|#define NODE_THRESHOLD          125
...
suffix:semicolon
multiline_comment|/*&n;&t; * Avoid rebalancing between nodes too often.&n;&t; * We rebalance globally once every NODE_BALANCE_RATE load balances.&n;&t; */
r_if
c_cond
(paren
op_increment
(paren
id|this_rq-&gt;nr_balanced
)paren
op_eq
id|NODE_BALANCE_RATE
)paren
(brace
r_int
id|node
...
mdefine_line|#define CAN_MIGRATE_TASK(p,rq,this_cpu)&t;&t;&t;&t;&t;&bslash;&n;&t;((jiffies - (p)-&gt;sleep_timestamp &gt; cache_decay_ticks) &amp;&amp;&t;&bslash;&n;&t;&t;!task_running(rq, p) &amp;&amp;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;((p)-&gt;cpus_allowed &amp; (1UL &lt;&lt; (this_cpu))))
id|curr
op_assign
id|curr-&gt;prev
suffix:semicolon

...
mdefine_line|#define PRIO_INTERACTIVE&t;(MAX_RT_PRIO + (MAX_PRIO - MAX_RT_PRIO) / 3)
...
multiline_comment|/* Rebalance every 250 msecs */
DECL|macro|REBALANCE_TICK
mdefine_line|#define REBALANCE_TICK (HZ/4)

...
(brace
multiline_comment|/*&n;&t;&t; * Fast-migrate the task if it&squot;s not running or runnable&n;&t;&t; * currently. Do not violate hard affinity.&n;&t;&t; */
r_if
c_cond
(paren
id|unlikely
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If sync is set, a resched_task() is a NOOP&n;&t;&t; */
r_if
c_cond
(paren
id|p-&gt;prio
...
id|current-&gt;array
suffix:semicolon
multiline_comment|/*&n;&t; * There are three levels of how a yielding task will give up&n;&t; * the current CPU:&n;&t; *&n;&t; *  #1 - it decreases its priority by one. This priority loss is&n;&t; *       temporary, it&squot;s recovered once the current timeslice&n;&t; *       expires.&n;&t; *&n;&t; *  #2 - once it has reached the lowest priority level,&n;&t; *       it will give up timeslices one by one. (We do not&n;&t; *       want to give them up all at once, it&squot;s gradual,&n;&t; *       to protect the casual yield()er.)&n;&t; *&n;&t; *  #3 - once all timeslices are gone we put the process into&n;&t; *       the expired array.&n;&t; *&n;&t; *  (special rule: RT tasks do not lose any priority, they just&n;&t; *  roundrobin on their current priority level.)&n;&t; */
r_if
c_cond
(paren
id|likely

...
mdefine_line|#define SCHEDSTAT_VERSION 11
...
id|seq
comma
l_string|&quot; %lu %lu %lu %lu %lu %lu %lu %lu&quot;
comma
id|sd-&gt;lb_cnt
(braket
id|itype
...
id|seq
comma
l_string|&quot; %lu %lu %lu %lu %lu %lu %lu %lu&bslash;n&quot;
comma
id|sd-&gt;alb_cnt
comma
id|sd-&gt;alb_failed
...
id|sd-&gt;sbe_attempts
comma
id|sd-&gt;ttwu_wake_remote
comma
id|sd-&gt;ttwu_move_affine
comma
id|sd-&gt;ttwu_move_balance
)paren
suffix:semicolon
)brace
macro_line|#endif
...
(brace
multiline_comment|/* Caller must always ensure &squot;now &gt;= p-&gt;timestamp&squot; */
r_int
r_int
r_int
id|__sleep_time
...
id|tmp
comma
id|busiest-&gt;timestamp_last_tick
comma
id|sd
)paren
)paren
...
id|SCHED_LOAD_SCALE
suffix:semicolon
multiline_comment|/* Move if we gain throughput */
r_if
c_cond
(paren
id|pwr_move
...
suffix:semicolon
multiline_comment|/*&n; * This is called on clock ticks and on context switches.&n; * Bank in p-&gt;sched_time the ns elapsed since the last tick or switch.&n; */
DECL|function|update_cpu_clock
r_static
r_inline
r_void
id|update_cpu_clock
...
multiline_comment|/*&n; * Return current-&gt;sched_time plus any more ns on the sched_clock&n; * that have not yet been banked.&n; */
DECL|function|current_sched_time
r_int
r_int
r_int

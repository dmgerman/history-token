...
(brace
multiline_comment|/* If someone else is tracing this thread, preserve the ptrace links.  */
r_if
c_cond
(paren
id|unlikely
...
c_func
(paren
id|current-&gt;ptrace_children.next
comma
r_struct
id|task_struct
comma

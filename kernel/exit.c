...
id|p-&gt;cnswap
suffix:semicolon
multiline_comment|/*&n;&t; * Potentially available timeslices are retrieved&n;&t; * here - this way the parent does not get penalized&n;&t; * for creating too many processes.&n;&t; *&n;&t; * (this cannot be used to artificially &squot;generate&squot;&n;&t; * timeslices, because any timeslice recovered here&n;&t; * was given away by the parent in the first place.)&n;&t; */
id|__save_flags
c_func
(paren
id|flags

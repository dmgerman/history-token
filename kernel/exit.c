...
(brace
multiline_comment|/* If we were tracing the thread, release it; otherwise preserve the&n;&t;   ptrace links.  */
r_if
c_cond
(paren
id|unlikely
...
suffix:semicolon
multiline_comment|/*&n;&t; * zap_thread might drop the tasklist lock, thus we could&n;&t; * have new children queued back from the ptrace list into the&n;&t; * child list:&n;&t; */
r_if
c_cond
(paren
id|unlikely

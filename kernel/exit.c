...
id|child_reaper
suffix:semicolon
multiline_comment|/*&n;&t; * There are only two places where our children can be:&n;&t; *&n;&t; * - in our child list&n;&t; * - in the global ptrace list&n;&t; *&n;&t; * Search them and reparent children.&n;&t; */
id|list_for_each
c_func
(paren
id|_p
...
suffix:semicolon
multiline_comment|/*&n;&t; * reparent_thread might drop the tasklist lock, thus we could&n;&t; * have new children queued back from the ptrace list into the&n;&t; * child list:&n;&t; */
r_if
c_cond
(paren
id|unlikely
...
multiline_comment|/*&n;&t;&t;&t; * Do not consider detached threads that are&n;&t;&t;&t; * not ptraced:&n;&t;&t;&t; */
r_if
c_cond
(paren
id|p-&gt;exit_signal

...
id|TASK_ZOMBIE
suffix:semicolon
multiline_comment|/* If this is a detached thread, this is where it goes away.  */
r_if
c_cond
(paren
id|p-&gt;exit_signal
...
(brace
multiline_comment|/* release_task takes the lock itself.  */
id|write_unlock_irq
c_func
(paren
op_amp

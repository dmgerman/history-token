...
suffix:semicolon
multiline_comment|/*&n;&t; * If we are the last non-leader member of the thread&n;&t; * group, and the leader is zombie, then notify the&n;&t; * group leader&squot;s parent process.&n;&t; */
r_if
c_cond
(paren
id|p-&gt;group_leader
...
DECL|function|__will_become_orphaned_pgrp
r_static
r_int
id|__will_become_orphaned_pgrp
c_func
(paren
r_int
id|pgrp
...
DECL|function|__has_stopped_jobs
r_static
r_inline
r_int
id|__has_stopped_jobs
c_func
(paren
r_int
id|pgrp
...
suffix:semicolon
multiline_comment|/* another thread was faster: */
id|do_exit
c_func
(paren

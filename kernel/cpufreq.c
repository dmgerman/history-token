...
id|driver_data
suffix:semicolon
multiline_comment|/* check for a default policy - if it exists, use it on _all_ CPUs*/
r_for
c_loop
(paren
id|i
...
multiline_comment|/* set default policy on all CPUs. Must be called per-CPU and not&n;&t; * with CPUFREQ_ALL_CPUs as there might be no common policy for all&n;&t; * CPUs (UltraSPARC etc.)&n;&t; */
r_for
c_loop
(paren
id|i

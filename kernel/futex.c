...
id|offset
suffix:semicolon
multiline_comment|/* the virtual =&gt; physical cache */
DECL|member|vcache
id|vcache_t
id|vcache
suffix:semicolon
...
comma
l_int|0
multiline_comment|/* not writable */
comma
l_int|0
...
suffix:semicolon
multiline_comment|/*&n;&t; * Has the mapping changed meanwhile?&n;&t; */
id|tmp
op_assign
id|follow_page
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We register a futex callback to this virtual address,&n;&t;&t; * to make sure a COW properly rehashes the futex-queue.&n;&t;&t; */
id|__attach_vcache
c_func
(paren
op_amp

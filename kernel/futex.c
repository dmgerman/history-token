...
multiline_comment|/* Waiter either waiting in FUTEX_WAIT or poll(), or expecting signal */
...
DECL|function|futex_wait_utime
r_static
r_inline
r_int
id|futex_wait_utime

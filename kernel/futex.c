...
suffix:semicolon
multiline_comment|/* Everyone needs a dentry and inode */
DECL|variable|futex_dentry
r_static
r_struct
id|dentry
op_star
...
multiline_comment|/* Initialize queue structure, and add to hash table. */
id|filp-&gt;private_data
op_assign
id|q
suffix:semicolon
...
multiline_comment|/* Leave page pinned (attached to fd). */
r_return
id|ret
suffix:semicolon
r_break
...
multiline_comment|/* FIXME: Oh yeah, makes sense to write a filesystem... */
DECL|variable|futexfs_ops
r_static
r_struct
id|super_operations
id|futexfs_ops
...
suffix:semicolon
multiline_comment|/* Don&squot;t check error returns: we&squot;re dead if they happen */
DECL|function|futexfs_fill_super
r_static
r_int
id|futexfs_fill_super
c_func
(paren
r_struct
id|super_block
...
suffix:semicolon
multiline_comment|/* We never let this drop to zero. */
id|futex_dentry
op_assign
id|dget
c_func

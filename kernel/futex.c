...
DECL|function|get_futex_value_locked
r_static
r_inline
r_int
id|get_futex_value_locked
c_func
(paren
r_int
op_star
...
(brace
multiline_comment|/* If we would have faulted, release mmap_sem, fault&n;&t;&t;&t; * it in and start all over again.&n;&t;&t;&t; */
id|up_read
c_func
(paren
op_amp
...
(brace
multiline_comment|/* If we would have faulted, release mmap_sem, fault it in and&n;&t;&t; * start all over again.&n;&t;&t; */
id|up_read
c_func
(paren
op_amp
...
multiline_comment|/* There&squot;s a chance we got woken already */
r_return
l_int|0
suffix:semicolon
id|ret

...
suffix:semicolon
multiline_comment|/* sysfs holds one reference. */
r_return
id|sprintf
c_func
(paren
...
DECL|function|sysfs_unload_setup
r_static
r_inline
r_int
id|sysfs_unload_setup
c_func
(paren
r_struct
id|module
...
(brace
id|mod-&gt;refcnt_param.name
op_assign
l_string|&quot;refcnt&quot;
suffix:semicolon
id|mod-&gt;refcnt_param.perm
op_assign
l_int|0444
suffix:semicolon
id|mod-&gt;refcnt_param.get
op_assign
id|refcnt_get_fn
suffix:semicolon
r_return
...
DECL|function|module_sect_attrs_release
r_static
r_void
id|module_sect_attrs_release
c_func
(paren
r_struct
id|kobject
...
suffix:semicolon
DECL|variable|module_sect_ktype
r_static
r_struct
id|kobj_type
id|module_sect_ktype
op_assign
(brace
dot
id|sysfs_ops
...
r_return
suffix:semicolon
multiline_comment|/* sections entry setup */
id|memset
c_func
(paren
id|mod-&gt;sect_attrs
...
id|out
suffix:semicolon
id|mod-&gt;sect_attrs-&gt;kobj.parent
op_assign
op_amp
id|mod-&gt;mkobj-&gt;kobj
suffix:semicolon
id|mod-&gt;sect_attrs-&gt;kobj.ktype
op_assign
op_amp
id|module_sect_ktype
suffix:semicolon
...
id|out
suffix:semicolon
multiline_comment|/* And the section attributes. */
id|sattr
op_assign
op_amp
id|mod-&gt;sect_attrs-&gt;attrs
...
id|err
suffix:semicolon
multiline_comment|/* We overallocate: not every param is in sysfs, and maybe no refcnt */
id|mod-&gt;mkobj
op_assign
id|kmalloc
c_func
...
suffix:semicolon
multiline_comment|/* Calls module_kobj_release */
id|kobject_unregister
c_func
(paren
op_amp

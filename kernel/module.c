...
multiline_comment|/*&n; * unlink the module with the whole machine is stopped with interrupts off&n; * - this defends against kallsyms not taking locks&n; */
DECL|function|__unlink_module
r_static
r_int
id|__unlink_module
c_func
...
multiline_comment|/*&n; * link the module with the whole machine is stopped with interrupts off&n; * - this defends against kallsyms not taking locks&n; */
DECL|function|__link_module
r_static
r_int
id|__link_module
c_func

...
(paren
id|KERN_ERR
l_string|&quot;Parameter %s length must be %u-%u characters&bslash;n&quot;
comma
id|name
comma
id|min
...
c_func
(paren
l_string|&quot;Module %s has %u obsolete params&bslash;n&quot;
comma
id|name
comma
id|num
...
c_func
(paren
l_string|&quot;Param %i: %s type %s&bslash;n&quot;
comma
id|num
comma
id|obsparm
...
id|ptr
suffix:semicolon
multiline_comment|/* Have we just copied __this_module across? */
r_if
c_cond
(paren
id|i

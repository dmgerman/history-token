...
(brace
multiline_comment|/* Exported symbols. (GPL) */
id|DEBUGP
c_func
(paren
...
(brace
multiline_comment|/* Exported symbols CRCs. */
id|DEBUGP
c_func
(paren
l_string|&quot;CRC table in section %u&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Exported symbols CRCs. (GPL)*/
id|DEBUGP
c_func
(paren
l_string|&quot;CRC table in section %u&bslash;n&quot;
...
(brace
multiline_comment|/* Module version info (both exported and needed) */
id|DEBUGP
c_func
(paren
l_string|&quot;Versions found in section %u&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon

...
multiline_comment|/* Called by the /proc file system to return a current list of&n;   modules.  Al Viro came up with this interface as an &quot;improvement&quot;.&n;   God save us from any more such interface improvements. */

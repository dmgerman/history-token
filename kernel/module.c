...
DECL|function|try_stop_module_local
r_static
r_int
id|try_stop_module_local
c_func
(paren
r_struct
id|module
...
suffix:semicolon
multiline_comment|/* One high-prio thread per cpu.  We&squot;ll do one (any one). */
id|set_cpus_allowed
c_func
(paren
id|current
...
suffix:semicolon
multiline_comment|/* Atomically disable module if possible */
id|ret
op_assign
id|try_stop_module_local
c_func

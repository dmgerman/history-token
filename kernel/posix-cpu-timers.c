...
suffix:semicolon
DECL|macro|UPDATE_CLOCK
mdefine_line|#define UPDATE_CLOCK(WHICH, c, n)&t;&t;&t;      &t;&t;      &bslash;&n;&t;&t;&t;case CPUCLOCK_##WHICH: &t;&t;&t;&t;      &bslash;&n;&t;&t;&t;&t;if (p-&gt;it_##c##_expires == 0 ||&t;&t;      &bslash;&n;&t;&t;&t;&t;    p-&gt;it_##c##_expires &gt; nt-&gt;expires.n) {    &bslash;&n;&t;&t;&t;&t;&t;p-&gt;it_##c##_expires = nt-&gt;expires.n;  &bslash;&n;&t;&t;&t;&t;}&t;&t;&t;&t;&t;      &bslash;&n;&t;&t;&t;&t;break
id|UPDATE_CLOCK
c_func
(paren
id|PROF
...
mdefine_line|#define UNEXPIRED(clock) &bslash;&n;&t;&t;(tsk-&gt;it_##clock##_expires == 0 || &bslash;&n;&t;&t; cputime_lt(clock##_ticks(tsk), tsk-&gt;it_##clock##_expires))
r_if
c_cond
(paren
id|UNEXPIRED
...
multiline_comment|/*&n; * Set one of the process-wide special case CPU timers.&n; * The tasklist_lock and tsk-&gt;sighand-&gt;siglock must be held by the caller.&n; */

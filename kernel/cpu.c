...
multiline_comment|/* Notify userspace when a cpu event occurs, by running &squot;/sbin/hotplug&n; * cpu&squot; with certain environment variables set.  */
DECL|function|cpu_run_sbin_hotplug
r_static
r_int

...
multiline_comment|/*&n; * The per-CPU workqueue:&n; */
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Increase nr_queued so that the flush function&n;&t;&t; * knows that there&squot;s something pending.&n;&t;&t; */
id|atomic_inc
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We only wake up &squot;work done&squot; waiters (flush) when&n;&t;&t; * the last function has been fully processed.&n;&t;&t; */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Wait for helper thread(s) to finish up&n;&t;&t;&t; * the queue:&n;&t;&t;&t; */
id|set_task_state
c_func
(paren
id|current
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Initiate an exit and wait for it:&n;&t;&t; */
id|init_completion
c_func
(paren
op_amp

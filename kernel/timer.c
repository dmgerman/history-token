...
multiline_comment|/*&n; * mod_timer() has subtle locking semantics because parallel&n; * calls to it must happen serialized.&n; */
...
multiline_comment|/*&n;&t;&t; * Subtle, we rely on timer-&gt;base being always&n;&t;&t; * valid and being updated atomically.&n;&t;&t; */
r_if
c_cond
(paren
id|timer-&gt;base

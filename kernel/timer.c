...
suffix:semicolon
multiline_comment|/*&n;&t; * First do a lighter but racy check, whether the&n;&t; * timer is running on any other CPU:&n;&t; */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*&n;&t; * Do a heavy but race-free re-check to make sure both that&n;&t; * the timer is neither running nor pending:&n;&t; */
id|again
op_assign
l_int|0
suffix:semicolon

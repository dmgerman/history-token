...
suffix:semicolon
multiline_comment|/* Fake initialization needed to avoid compiler breakage */
r_static
id|DEFINE_PER_CPU
c_func
(paren
...
multiline_comment|/*&n;&t;&t; * The timer base might have changed while we were&n;&t;&t; * trying to take the lock(s):&n;&t;&t; */
r_if
c_cond
(paren
id|timer-&gt;base
...
c_func
(paren
l_string|&quot;Bad: timer %p has NULL fn. (data: %08lx)&bslash;n&quot;
comma
id|timer
comma
id|data
...
id|last_time_offset
suffix:semicolon
multiline_comment|/*&n; * This function runs timers and the timer-tq in softirq context.&n; */
DECL|function|run_timer_tasklet
r_static
r_void
id|run_timer_tasklet
c_func
(paren
r_int
r_int

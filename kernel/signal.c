...
DECL|function|__remove_thread_group
r_static
r_inline
r_void
...
DECL|function|remove_thread_group
r_void
...
multiline_comment|/*&n; * Dequeue a signal and return the element to the caller, which is &n; * expected to free it.&n; *&n; * All callers have to hold the siglock and the sigmask_lock.&n; */
...
r_static
r_int
DECL|function|__force_sig_info
id|__force_sig_info
c_func
(paren
r_int
...
l_int|0
suffix:semicolon
multiline_comment|/* send a signal to the head of the list */
id|err
op_assign
id|__force_sig_info
c_func
...
suffix:semicolon
multiline_comment|/* send a signal to all members of the list */
id|list_for_each
c_func
(paren
id|entry
...
id|out_unlock
suffix:semicolon
multiline_comment|/* blocked (or ptraced) signals get posted */
id|spin_lock
c_func
(paren
op_amp

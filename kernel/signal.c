...
mdefine_line|#define SIG_KERNEL_COREDUMP_MASK (&bslash;&n;        M(SIGQUIT)   |  M(SIGILL)    |  M(SIGTRAP)   |  M(SIGABRT)   | &bslash;&n;        M(SIGFPE)    |  M(SIGSEGV)   |  M(SIGBUS)    |  M(SIGSYS)    | &bslash;&n;        M(SIGXCPU)   |  M(SIGXFSZ)                                   )
DECL|macro|T

...
id|PF_SIGNALED
suffix:semicolon
multiline_comment|/* Propagate the signal to all the tasks in&n;&t; *  our thread group&n;&t; */
r_if
c_cond
(paren
id|info
...
multiline_comment|/*&n; *  Kill only one task, even if it&squot;s a CLONE_THREAD task.&n; */
id|asmlinkage
r_int

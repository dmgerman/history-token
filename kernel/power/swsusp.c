...
(paren
id|KERN_WARNING
l_string|&quot;swsusp does not support SMP.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;swsusp: %s: Unable to find suspended-data signature (%.10s - misspelled?&bslash;n&quot;
comma
id|name_resume
comma
id|cur-&gt;swh.magic.magic
...
multiline_comment|/**&n; *&t;software_resume - Check and load saved image from swap.&n; *&n; *&t;Defined as a late_initcall, so it gets called after all devices&n; *&t;have been probed and initialized, but before we&squot;ve mounted anything.&n; */
...
c_func
(paren
l_string|&quot;swsusp: resuming from %s&bslash;n&quot;
comma
id|resume_file
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;swsusp: Resume failed. Continuing.&bslash;n&quot;
)paren
suffix:semicolon
id|read_failure
suffix:colon
...
multiline_comment|/**&n; *&t;swsusp_write - Write saved memory image to swap.&n; */

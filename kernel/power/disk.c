...
suffix:semicolon
DECL|variable|swsusp_resume_device
id|dev_t
...
DECL|function|prepare_processes
r_static
r_int
id|prepare_processes
c_func
(paren
r_void
)paren
...
DECL|function|unprepare_processes
r_static
r_void
id|unprepare_processes
c_func
(paren
r_void
)paren
...
c_func
(paren
l_string|&quot;PM: Checking swsusp image.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;PM: Preparing processes for restore.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;PM: Preparing devices for restore.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;Attempting manual resume&bslash;n&quot;
)paren
suffix:semicolon
id|noresume
op_assign

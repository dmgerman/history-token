...
suffix:semicolon
DECL|struct|module_param_attrs
r_struct
...
mdefine_line|#define to_param_attr(n) container_of(n, struct param_attribute, mattr);
...
id|param_attr_show
suffix:semicolon
id|pattr-&gt;mattr.store
op_assign
id|param_attr_store
suffix:semicolon
id|pattr-&gt;mattr.attr.name
op_assign
(paren
r_char
op_star
...
suffix:semicolon
id|pattr-&gt;mattr.attr.owner
op_assign
id|mk-&gt;mod
suffix:semicolon
id|pattr-&gt;mattr.attr.mode
op_assign
id|kp-&gt;perm
suffix:semicolon
op_star
...
comma
op_amp
id|mod-&gt;param_attrs-&gt;grp
)paren
suffix:semicolon
multiline_comment|/* We are positive that no one is using any param&n;&t;&t; * attrs at this point.  Deallocate immediately. */
id|kfree
c_func
(paren
id|mod-&gt;param_attrs
...
DECL|function|module_attr_store
r_static
id|ssize_t
id|module_attr_store
c_func
(paren
r_struct
id|kobject

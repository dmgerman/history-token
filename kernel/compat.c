...
multiline_comment|/*&n; * for maximum compatability, we allow programs to use a single (compat)&n; * unsigned long bitmask if all cpus will fit. If not, you have to have&n; * at least the kernel size available.&n; */
DECL|macro|USE_COMPAT_ULONG_CPUMASK
mdefine_line|#define USE_COMPAT_ULONG_CPUMASK (NR_CPUS &lt;= BITS_PER_COMPAT_LONG)

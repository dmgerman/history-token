...
suffix:semicolon
DECL|macro|acct_lock
mdefine_line|#define&t;acct_lock&t;acct_globals.lock
DECL|macro|acct_active
mdefine_line|#define&t;acct_active&t;acct_globals.active
DECL|macro|acct_needcheck
mdefine_line|#define&t;acct_needcheck&t;acct_globals.needcheck
DECL|macro|acct_file
mdefine_line|#define&t;acct_file&t;acct_globals.file
DECL|macro|acct_timer
mdefine_line|#define&t;acct_timer&t;acct_globals.timer
...
multiline_comment|/*&n; *  acct_common() is the main routine that implements process accounting.&n; *  It takes the name of the file where accounting records should be&n; *  written. If the filename is NULL, accounting will be shutdown.&n; */
DECL|function|acct_common
r_int
id|acct_common
c_func
(paren
...
id|error
suffix:semicolon
multiline_comment|/*&n;&t; * Should only have locked set when name is NULL (enforce this).&n;&t; */
id|BUG_ON
c_func
(paren
id|locked

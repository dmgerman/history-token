...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Check whether we need to allocate a larger fd array or fd set.&n;&t; * Note: we&squot;re not a clone task, so the open count won&squot;t  change.&n;&t; */
r_if
c_cond
(paren
id|open_files
...
multiline_comment|/* if the old fdset gets grown now, we&squot;ll only copy up to &quot;size&quot; fds */
r_if
c_cond
(paren
id|expand
...
suffix:semicolon
id|sig-&gt;it_real_value
op_assign
id|sig-&gt;it_real_incr
op_assign
l_int|0
suffix:semicolon
id|sig-&gt;real_timer.function
op_assign
id|it_real_fn
suffix:semicolon
id|sig-&gt;real_timer.data
op_assign
(paren
r_int
r_int
...
(brace
multiline_comment|/*&n;&t;&t; * New sole thread in the process gets an expiry time&n;&t;&t; * of the whole CPU time limit.&n;&t;&t; */
...
c_func
(paren
id|current-&gt;signal-&gt;it_virt_expires
comma
id|cputime_zero
)paren
op_logical_or
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Have child wake up on its first tick to check&n;&t;&t;&t; * for process CPU timers.&n;&t;&t;&t; */
id|p-&gt;it_prof_expires
op_assign

...
multiline_comment|/*&n; * Protects next_safe, last_pid and pid_max:&n; */
...
multiline_comment|/*&n; * A per-CPU task cache - this relies on the fact that&n; * the very last portion of sys_exit() is executed with&n; * preemption turned off.&n; */
DECL|variable|__cacheline_aligned
r_static
id|task_t
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * Thread groups must share signals as well:&n;&t; */
r_if
c_cond
(paren
id|clone_flags

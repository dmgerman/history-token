...
macro_line|#if defined(CONFIG_PRINTK_TIME)
DECL|variable|printk_time
r_static
r_int
id|printk_time
op_assign
...
suffix:semicolon
macro_line|#endif
DECL|function|printk_time_setup
r_static
r_int
id|__init
id|printk_time_setup
c_func
(paren
r_char
op_star
...
(brace
multiline_comment|/* log_level_unknown signals the start of a new line */
r_if
c_cond
(paren
id|printk_time
...
id|nanosec_rem
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * force the log level token to be&n;&t;&t;&t;&t; * before the time output.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|p
...
suffix:semicolon
DECL|function|try_acquire_console_sem
r_int
...
DECL|variable|try_acquire_console_sem
id|EXPORT_SYMBOL
c_func
(paren
id|try_acquire_console_sem

...
DECL|function|do_proc_dointvec_ms_jiffies_conv
r_static
r_int
id|do_proc_dointvec_ms_jiffies_conv
c_func
(paren
r_int
op_star
...
multiline_comment|/**&n; * proc_dointvec_ms_jiffies - read a vector of integers as 1 milliseconds&n; * @table: the sysctl table&n; * @write: %TRUE if this is a write to the sysctl file&n; * @filp: the file structure&n; * @buffer: the user buffer&n; * @lenp: the size of the user buffer&n; *&n; * Reads/writes up to table-&gt;maxlen/sizeof(unsigned int) integer&n; * values from/to the user buffer, treated as an ASCII string. &n; * The values read are assumed to be in 1/1000 seconds, and &n; * are converted into jiffies.&n; *&n; * Returns 0 on success.&n; */
DECL|function|proc_dointvec_ms_jiffies
r_int
...
multiline_comment|/* Strategy function to convert jiffies to seconds */
DECL|function|sysctl_ms_jiffies
r_int
...
suffix:semicolon
DECL|variable|proc_dointvec_ms_jiffies
id|EXPORT_SYMBOL
c_func
(paren
id|proc_dointvec_ms_jiffies
...
suffix:semicolon
DECL|variable|sysctl_ms_jiffies
id|EXPORT_SYMBOL
c_func
(paren
id|sysctl_ms_jiffies

...
suffix:semicolon
DECL|macro|AUDIT_AUX_IPCPERM
mdefine_line|#define AUDIT_AUX_IPCPERM&t;0
DECL|struct|audit_aux_data_ipcctl
r_struct
id|audit_aux_data_ipcctl
(brace
DECL|member|d
r_struct
id|audit_aux_data
...
id|context-&gt;loginuid
op_assign
id|current-&gt;audit_context-&gt;loginuid
suffix:semicolon
id|tsk-&gt;audit_context
op_assign
id|context
...
id|ab
comma
l_string|&quot; qbytes=%lx uid=%d gid=%d mode=%x&quot;
comma
id|axi-&gt;qbytes
comma
id|axi-&gt;uid
...
id|ab
comma
l_string|&quot; inode=%lu dev=%02x:%02x mode=%#o&quot;
l_string|&quot; uid=%d gid=%d rdev=%02x:%02x&quot;
comma
id|context-&gt;names
(braket
id|i
...
id|ab
comma
l_string|&quot;login pid=%d uid=%u &quot;
l_string|&quot;old loginuid=%u new loginuid=%u&quot;
comma
id|ctx-&gt;pid
comma
id|ctx-&gt;uid
...
DECL|function|audit_get_loginuid
id|uid_t

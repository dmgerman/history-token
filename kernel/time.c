...
multiline_comment|/* singleshot must not be used with any other mode bits */
r_if
c_cond
(paren
id|txc-&gt;modes
...
suffix:semicolon
macro_line|#else
multiline_comment|/*&n; * Simulate gettimeofday using do_gettimeofday which only allows a timeval&n; * and therefore only yields usec accuracy&n; */
DECL|function|getnstimeofday
r_void
id|getnstimeofday
c_func

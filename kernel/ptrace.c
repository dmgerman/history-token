...
(brace
multiline_comment|/*&n;&t;&t; * Turn a tracing stop into a normal stop now,&n;&t;&t; * since with no tracer there would be no way&n;&t;&t; * to wake it up with SIGCONT or SIGKILL.&n;&t;&t; * If there was a signal sent that would resume the child,&n;&t;&t; * but didn&squot;t because it was in TASK_TRACED, resume it now.&n;&t;&t; */
id|spin_lock
c_func
(paren
op_amp

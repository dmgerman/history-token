...
(brace
multiline_comment|/* Don&squot;t undo the undo */
id|sop-&gt;sem_flg
op_and_assign
op_complement
id|SEM_UNDO
...
op_assign
op_amp
id|current-&gt;sysvsem.undo_list-&gt;proc_list
suffix:semicolon
(paren
id|u
op_assign
...
multiline_comment|/* returns without sem_lock and semundo list locks on error! */
...
id|saved_add_count
op_assign
id|current-&gt;sysvsem.undo_list-&gt;add_count
suffix:semicolon
id|sem_unlock
c_func
(paren
...
multiline_comment|/* alloc_undo has just&n;&t; * released all locks and reacquired them. &n;&t; * But, another thread may have&n;&t; * added the semundo we were looking for&n;&t; * during that time.&n;&t; * So, we check for it again.&n;&t; * only initialize and add the new one&n;&t; * if we don&squot;t discover one.&n;&t; */
id|new_un
op_assign
l_int|NULL
suffix:semicolon

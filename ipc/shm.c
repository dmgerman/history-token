...
c_func
(paren
id|shp-&gt;shm_file-&gt;f_dentry-&gt;d_inode-&gt;i_size
comma
id|shp-&gt;mlock_user
)paren
suffix:semicolon
...
(brace
multiline_comment|/* hugetlb_zero_setup takes care of mlock user accounting */
id|file
op_assign
...
id|vma-&gt;vm_next
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check if the starting address would match, i.e. it&squot;s&n;&t;&t; * a fragment created by mprotect() and/or munmap(), or it&n;&t;&t; * otherwise it starts at this address with no hassles.&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|size
op_assign
id|vma-&gt;vm_file-&gt;f_dentry-&gt;d_inode-&gt;i_size
suffix:semicolon
id|do_munmap
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * We discovered the size of the shm segment, so&n;&t;&t;&t; * break out of here and fall through to the next&n;&t;&t;&t; * loop that uses the size information to stop&n;&t;&t;&t; * searching for matching vma&squot;s.&n;&t;&t;&t; */
id|retval
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n;&t; * We need look no further than the maximum address a fragment&n;&t; * could possibly have landed at. Also cast things to loff_t to&n;&t; * prevent overflows and make comparisions vs. equal-width types.&n;&t; */
r_while
c_loop
(paren
id|vma
...
id|vma-&gt;vm_next
suffix:semicolon
multiline_comment|/* finding a matching vma now does not alter retval */
r_if
c_cond
(paren
(paren
